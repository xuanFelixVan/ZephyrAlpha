# [A_test] module_id: MOD-GOV_diagnosis_kpi | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_diagnosis_kpi
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.diagnosers.diagnosis.diagnosis_kpi
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.feedback_loop.diagnosers.diagnosis.diagnosis_kpi import DiagnosisKPI

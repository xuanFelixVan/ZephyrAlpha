# [A_test] module_id: MOD-GOV_audit_contracts | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
class TestAuditWriterWrite:
    def test_write_returns_event_with_chain_hash(self):
        ...
        with patch("zephyr.gov_audit.contracts.get_writer", return_value=mock_core_writer):

# [A_test] module_id: MOD-GOV_cognitive_load_budget | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_cognitive_load_budget
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.diagnosers.cognitive.cognitive_load_budget
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.feedback_loop.diagnosers.cognitive.cognitive_load_budget import (
    CognitiveLoadBudget,
    DecisionRecord,
)

# [A_test] module_id: MOD-GOV_audit_integration_fracture | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-205 | docs/03_modules/_domain_governance/blueprint.md | §

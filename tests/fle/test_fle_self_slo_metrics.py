# [A_test] module_id: MOD-GOV_fle_self_slo_metrics | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_fle_self_slo_metrics
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.diagnosers.health.fle_self_slo_metrics
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.feedback_loop.diagnosers.health.fle_self_slo_metrics import (
    FLESelfSLO,
    FLESLOMetric,
)

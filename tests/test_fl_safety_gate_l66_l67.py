...
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.observability.feedback_loop.gates.safety_gate_L66_L67
# [STABILITY] stable
# [SAFETY] H
...
class TestSafetyGateL66L67Instantiation:
    def test_default_construction(self):
        with patch("zephyr.observability.feedback_loop.gates.safety_gate_L66_L67.write_to_core"):

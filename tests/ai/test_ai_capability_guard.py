# [A_test] module_id: MOD-GOV_ai_capability_guard | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
# [MODIFY-GUARD] src/zephyr/gov_enforcement/rule_enforcement/ai_capability_guard.py

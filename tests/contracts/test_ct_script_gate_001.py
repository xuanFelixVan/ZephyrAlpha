# [A_test] module_id: MOD-GOV_ct_script_gate | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-266 | docs/03_modules/_domain_governance/blueprint.md | §

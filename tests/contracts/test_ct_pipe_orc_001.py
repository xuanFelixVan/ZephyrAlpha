# [A_test] module_id: MOD-GOV_ct_pipe_orc | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-264 | docs/03_modules/_domain_governance/blueprint.md | §

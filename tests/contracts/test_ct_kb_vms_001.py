# [A_test] module_id: MOD-GOV_ct_kb_vms | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-259 | docs/03_modules/_domain_governance/blueprint.md | §

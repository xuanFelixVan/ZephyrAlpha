# [A_test] module_id: MOD-GOV_contract_test_anchors | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-250 | docs/03_modules/_domain_governance/blueprint.md | §

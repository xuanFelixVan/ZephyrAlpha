...
class TestHoldingPeriodMonitor:
    def test_normal_monitor(self):
        ...
        out = m.monitor(
            {"qty": 100}, _order_book([50000, 40000, 30000, 20000, 10000]), {"current": 9000, "initial": 10000}
        )
    ...
    def test_sar_reduce(self):
        ...
        m = HoldingPeriodMicrostructureMonitor()
        out = m.monitor(
            {"qty": 4_000_000}, _order_book([50000, 40000, 30000, 20000, 10000]), {"current": 9000, "initial": 10000}
        )
    ...
    def test_sar_alert_band(self):
        ...
        m = HoldingPeriodMicrostructureMonitor()
        out = m.monitor(
            {"qty": 1_600_000}, _order_book([50000, 40000, 30000, 20000, 10000]), {"current": 9000, "initial": 10000}
        )
    ...
    def test_seal_below_70pct_alert(self):
        ...
        m = HoldingPeriodMicrostructureMonitor()
        out = m.monitor(
            {"qty": 100}, _order_book([50000, 40000, 30000, 20000, 10000]), {"current": 6000, "initial": 10000}
        )
        assert out["action"] == "ALERT"

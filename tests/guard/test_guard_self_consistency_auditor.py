...
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.trading.feedback_loop.diagnosers.guard_self_consistency_auditor
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.trading.feedback_loop.diagnosers.guard_self_consistency_auditor import (
    GuardHealthRecord,

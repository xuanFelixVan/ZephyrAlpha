...
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.observability.feedback_loop.forensic.worm_write_integrity
# [STABILITY] evolving
# [SAFETY] M
...
from zephyr.ops.forensic.worm_write_integrity import WORMEntry, WORMWriteIntegrity

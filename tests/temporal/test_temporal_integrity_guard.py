# [A_test] module_id: MOD-GOV_temporal_integrity_guard | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_temporal_integrity_guard
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.diagnosers.reliability.temporal_integrity_guard
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.feedback_loop.diagnosers.reliability.temporal_integrity_guard import (

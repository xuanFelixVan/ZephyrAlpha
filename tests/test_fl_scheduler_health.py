...
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.observability.feedback_loop.scheduler_health
# [STABILITY] evolving
# [SAFETY] L
...
class TestReport:
    ...
    def test_report_contains_expected_keys(self):
        ...
        expected_keys = [
            ...
            "bus_factor", "e2e", "storage", "numerical", "hygiene",
            "L2_guard_consistency", "L2_guard_conflicts", "L2_guard_oscillation",
            "L3_cascade", "L3_mod_rate_limiter", "L3_entropy",
            "L4_diminishing_returns", "L4_complexity_budget",

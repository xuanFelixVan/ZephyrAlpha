# [A_test] module_id: SRC-TST-1919 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-538 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.orchestrator.test_rollback_manager
# [STABILITY] evolving
# [SAFETY] L

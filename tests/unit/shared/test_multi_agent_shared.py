# [A_test] module_id: SRC-TST-1952 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-569 | docs/03_modules/_domain_governance/blueprint.md | §

# [A_test] module_id: SRC-TST-1950 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-567 | docs/03_modules/_domain-governance/blueprint.md | §
# [MODULE] tests.unit.shared.test_instrument
# [STABILITY] evolving
# [SAFETY] L

# [A_test] module_id: SRC-TST-1941 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-558 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.shared.test_capability
# [STABILITY] evolving
# [SAFETY] L

...
# [BLUEPRINT] SRC-491 | docs/03_modules/_domain-governance/blueprint.md | §
...
class TestDriftInfrastructure:
    ...
    def test_budget_consume(self):
        from zephyr.behavioral_audit.drift_infrastructure import consume_budget, get_or_create_budget
    ...
    def test_differential_detection_drift(self):
        from zephyr.behavioral_audit.drift_infrastructure import differential_detection
    ...
    def test_partial_deployment_detection(self):
        from zephyr.behavioral_audit.drift_infrastructure import detect_partial_deployment

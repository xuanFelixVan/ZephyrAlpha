...
"""Test suite: drift_detector core — drift_engine + baseline_manager + drift_models"""
...
from zephyr.drift_detector.drift_models import (
    BulkDriftEvent,
    Detector,
    DriftBudget,
    DriftEvent,
...
from zephyr.drift_detector.baseline_manager import BaselineManager, DiffReport
...
class TestDriftInfrastructure:
    ...
    def test_budget_consume(self):
        from zephyr.drift_detector.drift_infrastructure import consume_budget, get_or_create_budget
    ...
    def test_differential_detection_drift(self):
        from zephyr.drift_detector.drift_infrastructure import differential_detection
    ...
    def test_partial_deployment_detection(self):
        from zephyr.drift_detector.drift_infrastructure import detect_partial_deployment

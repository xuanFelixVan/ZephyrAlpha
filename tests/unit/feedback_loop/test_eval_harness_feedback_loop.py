# [A_test] module_id: SRC-TST-1873 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-496 | docs/03_modules/_domain-governance/blueprint.md | §

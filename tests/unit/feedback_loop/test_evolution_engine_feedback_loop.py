# [A_test] module_id: SRC-TST-1874 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-497 | docs/03_modules/_domain-governance/blueprint.md | §
# [MODULE] tests.unit.feedback_loop.test_evolution_engine
# [STABILITY] evolving
# [SAFETY] L
    ...
    def test_extra_field_forbidden(self) -> None:
        with pytest.raises(Exception):
            EvolutionProposal(
                ...
                severity=EvolutionSeverity.LOW,
                title="t",
                rationale="r",
                recommended_action="a",
                created_at=FIXED_NOW,
...
class TestLayer1Task:
    ...
    def test_low_score_proposal_has_task_ids(self) -> None:
        ...
        assert prop.severity == EvolutionSeverity.MEDIUM
...
class TestLayer3Drift:
    def test_score_drop_triggers_adr_reaudit(self) -> None:
        ...
        assert prop.severity in (EvolutionSeverity.HIGH, EvolutionSeverity.CRITICAL)

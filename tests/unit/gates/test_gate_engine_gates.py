...
# [BLUEPRINT] SRC-504 | docs/03_modules/_domain-governance/blueprint.md | §
...
def _make_task(
    ...
    return TaskCard(
        ...
        files_in_scope=["tests/unit/gates/test_gate_engine.py"],
        deliverables=deliverables or [],
        applicable_rules=[{"module_id": "GOV-TASK-001", "section": "v3.0.0", "reason": "test"}],
        allowed_touch=["tests/unit/gates/test_gate_engine.py"],

# [A_test] module_id: SRC-TST-1972 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-589 | docs/03_modules/_domain-governance/blueprint.md | §
# [MODULE] tests.unit.test_analyze
# [STABILITY] evolving
# [SAFETY] L

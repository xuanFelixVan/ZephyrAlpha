...
# [MODULE] tests.unit.l00_data_source.test_provider_base_contract
# [STABILITY] evolving
# [SAFETY] L
...
def test_stub_provider_registers_in_registry() -> None:
    registered = DataSourceBase._registry.get("unit-stub-provider")
    assert registered is not None
    assert issubclass(registered, DataSourceBase)

# [A_test] module_id: SRC-TST-1860 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-487 | docs/03_modules/_domain-governance/blueprint.md | §

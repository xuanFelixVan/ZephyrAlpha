# [A_test] module_id: SRC-TST-1924 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-543 | docs/03_modules/_domain-governance/blueprint.md | §

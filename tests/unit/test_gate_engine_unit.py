# [A_test] module_id: SRC-TST-2027 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-644 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.test_gate_engine
# [STABILITY] evolving
# [SAFETY] L
...
def _make_task(
    ...
    return TaskCard(
        ...
        acceptance=["exit=0"],
        depends_on=[],
        files_in_scope=["tests/unit/test_gate_engine.py"],
        applicable_rules=[{"module_id": "GOV-TASK-001", "section": "§4", "reason": "模板校验"}],
        allowed_touch=["tests/unit/test_gate_engine.py"],
        rollback_instructions="git checkout -- tests/unit/test_gate_engine.py",
...
def test_task_repo_blocks_deprecated_path(
    ...
    """PENDING→IN_PROGRESS 时，交付物含废弃路径，应抛出 GateViolationError。"""

# [BLUEPRINT] MOD-GOV-r5_digit_suffix_gate | tests/governance/rule_enforcement/test_r5_digit_suffix_gate.py
# [MODULE] tests.governance.rule_enforcement.test_r5_digit_suffix_gate
# [DOMAIN] D_GOVERNANCE

# [A_test] module_id: MOD-GOV_gct_a2a_to_rbac_escalation | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
# [TESTS] —
# [A_module] module_id=MOD-TEST-288 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

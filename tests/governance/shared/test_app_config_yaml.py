# [A_test] module_id: MOD-GOV_app_config_yaml | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
# [TESTS] —
# [A_module] module_id=MOD-TEST-591 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

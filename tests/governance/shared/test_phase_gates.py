# [A_test] module_id: MOD-GOV_phase_gates | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-299 | docs/03_modules/_domain_governance/blueprint.md | §
...
# [TESTS] —
# [A_module] module_id=MOD-TEST-299 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

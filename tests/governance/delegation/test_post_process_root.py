# [A_test] module_id: MOD-GOV_post_process_root | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
# [ERROR_CONTRACT] none
# [TESTS] self
# [A_module] module_id=MOD-TEST-417 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

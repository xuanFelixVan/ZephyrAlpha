# [A_test] module_id: MOD-GOV_consequence_manager | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
# [A_module] module_id=MOD-TEST-366 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

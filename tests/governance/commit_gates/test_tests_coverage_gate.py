# [A_test] module_id: MOD-GOV_tests_coverage_gate | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.gov_enforcement.commit_gates.tests_coverage_gate import (  # noqa: E402
    _EXEMPT_VALUES,
    _TESTS_HEADER_RE,

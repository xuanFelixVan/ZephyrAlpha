...
# [TESTS] —
# [A_module] module_id=MOD-GOV_DIFF_HELPERS | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
from zephyr.gov_enforcement.commit_gates.diff_helpers import (  # noqa: E402

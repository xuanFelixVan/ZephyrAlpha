# [A_test] module_id: SRC-TST-2300 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-GOV-no_import_side_effect_gate | docs/03_modules/_cross_layer/gate_engine/blueprint.md | §0.1

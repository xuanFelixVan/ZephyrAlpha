# [A_test] module_id: MOD-GOV_exempt_zone_frontmatter_gate | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-GOV_EXEMPT_ZONE_FRONTMATTER_GATE | docs/03_modules/_cross_layer/gate_engine/blueprint.md | §0.1

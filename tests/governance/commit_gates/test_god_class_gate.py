# [A_test] module_id: MOD-GOV_god_class_gate | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-GOV_GOD_CLASS_GATE | docs/03_modules/_cross_layer/gate_engine/blueprint.md | §0.1
...
# [TESTS] —
# [A_module] module_id=MOD-GOV_GOD_CLASS_GATE | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
from zephyr.gov_enforcement.commit_gates.god_class_gate import (  # noqa: E402
    _MAX_METHODS,
    _count_methods,
    make_god_class_gate,
)

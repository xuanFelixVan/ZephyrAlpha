# [A_test] module_id: MOD-GOV_session_required_gate | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-GOV_SESSION_REQUIRED_GATE | docs/03_modules/_cross_layer/gate_engine/blueprint.md | §0.1
...
# [TESTS] —
# [A_module] module_id=MOD-GOV_SESSION_REQUIRED_GATE | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
from zephyr.gov_enforcement.commit_gates.session_required_gate import (  # noqa: E402

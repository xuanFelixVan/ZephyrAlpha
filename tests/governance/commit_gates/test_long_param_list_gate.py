# [A_test] module_id: MOD-GOV_long_param_list_gate | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-GOV_LONG_PARAM_LIST_GATE | docs/03_modules/_cross_layer/gate_engine/blueprint.md | §0.1
...
# [TESTS] —
# [A_module] module_id=MOD-GOV_LONG_PARAM_LIST_GATE | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

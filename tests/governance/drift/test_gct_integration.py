# [A_test] module_id: MOD-GOV_gct_integration | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-290 | docs/03_modules/_domain_governance/blueprint.md | §
...
# [TESTS] —
# [A_module] module_id=MOD-TEST-290 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
"""G-CT GCT集成契约测试."""
...
class TestGCT005DriftToRollback:
    ...
    def test_drift_fix_handler(self):
        ...
        event = ManagedDriftEvent(
            drift_id="DR-001", target="module_a", auto_fixable=True, fix_suggestion="revert to baseline"
        )

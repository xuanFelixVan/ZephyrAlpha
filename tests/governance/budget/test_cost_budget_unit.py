# [A_test] module_id: SRC-TST-2003 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-620 | docs/03_modules/_domain_governance/blueprint.md | §

# [A_test] module_id: MOD-GOV_blast_radius_detector | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.reliability.blast_radius import BlastRadius

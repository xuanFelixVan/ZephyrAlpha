...
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.trading.feedback_loop.diagnosers.self_bottleneck_detector
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.trading.feedback_loop.diagnosers.self_bottleneck_detector import (
    PipelineStage,

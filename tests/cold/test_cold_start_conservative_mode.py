# [A_test] module_id: MOD-GOV_cold_start_conservative_mode | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_cold_start_conservative_mode
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.diagnosers.reliability.cold_start_conservative_mode
# [STABILITY] evolving
# [SAFETY] L

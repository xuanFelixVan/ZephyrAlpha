# [A_test] module_id: MOD-GOV_multi_signal_correlator | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.correlation.multi_signal_correlator import MultiSignalCorrelator

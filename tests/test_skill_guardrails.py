# [A_test] module_id: SRC-TST-1629 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.autonomy_core.skill_guardrails import SkillGuardrails, DESTRUCTIVE

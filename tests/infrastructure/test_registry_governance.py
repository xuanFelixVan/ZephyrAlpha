# [BLUEPRINT] DOM-GOV-001 | tests/infrastructure/test_registry_governance.py | §
"""
[BLUEPRINT] MOD-INF-037 | docs/03_modules/l01_infrastructure/registry-governance/blueprint.md | §9
[MODULE] tests.infrastructure.test_registry_governance
[INVARIANTS] 功能域注册表是功能域声明的唯一真源;SSoT门禁检查不可跳过
[MODIFY-GUARD] docs/03_modules/l01_infrastructure/registry-governance/blueprint.md
[CONSUMERS] None
[STABILITY] evolving
[SAFETY] L
...
from zephyr.l01_infrastructure.registry_governance import (
    DomainEntry,

# [A_test] module_id: MOD-GOV_drift_extended_e2e | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-308 | docs/03_modules/_domain_governance/blueprint.md | §
...
class TestHotfixBypass:
    ...
    @pytest.mark.xfail(
        ...
        reason=(
            ...
            "已随 MOD-INF-023 超集退役（AI-TD2-DATA-001 留置，统筹配号 #ARCH-110）"
        ),
    )
...
class TestNoDeprecationWarning:
    ...
    @pytest.mark.xfail(
        ...
        reason=(
            ...
            "trigger_recovery 存根）（AI-TD2-DATA-001 留置，统筹配号 #ARCH-111）"
        ),
    )
...
class TestDeepDetectorInterfaces:
    ...
    @pytest.mark.xfail(
        ...
        reason=(
            ...
            "另阈值 >=31 与实际 30 条不符（AI-TD2-DATA-001 留置，统筹配号 #ARCH-109）"
        ),
    )

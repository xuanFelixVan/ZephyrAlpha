...
class TestGitMetadataExtractorIsAiCommit:
    def test_ai_commit(self):
        assert GitMetadataExtractor._is_ai_commit("[AI] auto fix") is True
        assert GitMetadataExtractor._is_ai_commit("generated by copilot") is True

    def test_human_commit(self):
        assert GitMetadataExtractor._is_ai_commit("fix typo") is False

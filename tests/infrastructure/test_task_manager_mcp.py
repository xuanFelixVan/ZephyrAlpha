# [A_test] module_id: MOD-GOV_task_manager_mcp | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-693 | docs/03_modules/_domain_governance/blueprint.md | §

# [A_test] module_id: MOD-GOV_blueprint_search_mcp | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-598 | docs/03_modules/_domain_governance/blueprint.md | §

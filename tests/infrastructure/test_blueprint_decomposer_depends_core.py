# [A_test] module_id: MOD-GOV_blueprint_decomposer_depends_core | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-476 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.core.test_blueprint_decomposer_depends
# [STABILITY] evolving
# [SAFETY] L

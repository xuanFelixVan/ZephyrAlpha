# [A_test] module_id: MOD-GOV_dr_resilience_metrics | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_dr_resilience_metrics
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.diagnosers.health.dr_resilience_metrics
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.feedback_loop.diagnosers.health.dr_resilience_metrics import (
    DRDrillRecord,
    DRResilienceMetrics,
)

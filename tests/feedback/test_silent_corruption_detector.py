# [A_test] module_id: MOD-GOV_silent_corruption_detector | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.anomaly.silent_corruption_detector import (
    CorruptionSeverity,

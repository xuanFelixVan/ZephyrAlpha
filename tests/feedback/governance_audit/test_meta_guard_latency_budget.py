# [A_test] module_id: MOD-GOV_meta_guard_latency_budget | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_meta_guard_latency_budget
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.diagnosers.cognitive.meta_guard_latency_budget
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.feedback_loop.diagnosers.cognitive.meta_guard_latency_budget import MetaGuardLatencyBudget

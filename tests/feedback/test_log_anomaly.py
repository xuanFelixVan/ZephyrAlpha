# [A_test] module_id: MOD-GOV_log_anomaly | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.anomaly.log_anomaly import LogAnomaly

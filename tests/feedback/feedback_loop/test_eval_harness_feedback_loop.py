# [A_test] module_id: MOD-GOV_eval_harness_feedback_loop | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-496 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.feedback_loop.test_eval_harness

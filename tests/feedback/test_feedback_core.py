...
class TestFeedbackLoopScheduler:
    ...
    def mock_scheduler(self):
        with (
            patch("zephyr.trading.feedback_loop.scheduler.HealthReporter") as hr_cls,
            patch("zephyr.trading.feedback_loop.scheduler.SafetyGateManager") as sgm_cls,
            patch("zephyr.trading.feedback_loop.scheduler.ActPhaseHandler") as aph_cls,
            patch("zephyr.trading.feedback_loop.scheduler.CollectDetectHandler") as cdh_cls,
            patch("zephyr.trading.feedback_loop.scheduler.MetricsCollector") as mc_cls,
            patch("zephyr.trading.feedback_loop.scheduler.FeedbackCollector") as fc_cls,
            patch("zephyr.trading.feedback_loop.scheduler.DependencyFreshnessMonitor") as dfm_cls,
            patch("zephyr.trading.feedback_loop.scheduler.SilentCorruptionDetector") as scd_cls,
            patch("zephyr.trading.feedback_loop.scheduler.RecursiveDiagnosisTrustEvaluator") as rdte_cls,
            patch("zephyr.trading.feedback_loop.scheduler.TemporalCoherenceOfSelfModel") as tcos_cls,
            patch("zephyr.trading.feedback_loop.scheduler.SelfDiagnosisDataLeakDetector") as sdld_cls,
            patch("zephyr.trading.feedback_loop.scheduler.ModelVersionSemanticDrift") as mvsd_cls,
            patch("zephyr.trading.feedback_loop.scheduler.HumanAnomalyFloodDetector") as hafd_cls,
            patch("zephyr.trading.feedback_loop.scheduler.AdaptiveParamTuning") as apt_cls,
            patch("zephyr.trading.feedback_loop.scheduler.RegimeGainScheduling") as rgs_cls,
            patch("zephyr.trading.feedback_loop.scheduler.RecoveryTimeStats") as rts_cls,
            patch("zephyr.trading.feedback_loop.scheduler.NonstationaryEffectiveness") as ne_cls,
    ...
    def test_get_instance_creates_singleton(self):
        ...
        with (
            patch("zephyr.trading.feedback_loop.scheduler.HealthReporter"),
            patch("zephyr.trading.feedback_loop.scheduler.SafetyGateManager"),
            patch("zephyr.trading.feedback_loop.scheduler.ActPhaseHandler"),
            patch("zephyr.trading.feedback_loop.scheduler.CollectDetectHandler"),
            patch("zephyr.trading.feedback_loop.scheduler.MetricsCollector"),
            patch("zephyr.trading.feedback_loop.scheduler.FeedbackCollector"),
            patch("zephyr.trading.feedback_loop.scheduler.DependencyFreshnessMonitor"),
            patch("zephyr.trading.feedback_loop.scheduler.SilentCorruptionDetector"),
            patch("zephyr.trading.feedback_loop.scheduler.RecursiveDiagnosisTrustEvaluator"),
            patch("zephyr.trading.feedback_loop.scheduler.TemporalCoherenceOfSelfModel"),
            patch("zephyr.trading.feedback_loop.scheduler.SelfDiagnosisDataLeakDetector"),
            patch("zephyr.trading.feedback_loop.scheduler.ModelVersionSemanticDrift"),
            patch("zephyr.trading.feedback_loop.scheduler.HumanAnomalyFloodDetector"),
            patch("zephyr.trading.feedback_loop.scheduler.AdaptiveParamTuning"),
            patch("zephyr.trading.feedback_loop.scheduler.RegimeGainScheduling"),
            patch("zephyr.trading.feedback_loop.scheduler.RecoveryTimeStats"),
            patch("zephyr.trading.feedback_loop.scheduler.NonstationaryEffectiveness"),
            patch("zephyr.trading.feedback_loop.scheduler.TimezoneSemanticReasoner"),
            patch("zephyr.trading.feedback_loop.scheduler.ActionSelector"),
        ):
    ...
    def test_fle_pipeline_event_to_dict(self):
        from zephyr.ops.scheduler import FLEPipelineEvent

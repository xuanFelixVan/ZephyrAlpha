# [A_test] module_id: MOD-GOV_rumor_noise_filter | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.correlation.rumor_noise_filter import (
    RumorNoiseFilter,
    SignalCredibility,
)

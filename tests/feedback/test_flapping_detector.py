# [A_test] module_id: MOD-GOV_flapping_detector | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.anomaly.flapping_detector import (
    AlertState,
    FlappingDetector,
    FlappingSeverity,
)

...
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.trading.feedback_loop.diagnosers.slo_capacity_metrics
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.trading.feedback_loop.diagnosers.slo_capacity_metrics import (
    SLOCapacityMetrics,
    SLOWindow,
)
...
class TestExhaustionAlerts:
    ...
    def test_alerts_with_low_target_burn_rate(self):
        from zephyr.trading.feedback_loop.diagnosers.slo_capacity_metrics import SLOWindow

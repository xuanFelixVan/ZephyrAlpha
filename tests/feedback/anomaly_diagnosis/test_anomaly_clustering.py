# [A_test] module_id: MOD-GOV_anomaly_clustering | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.anomaly.anomaly_clustering import AnomalyClustering

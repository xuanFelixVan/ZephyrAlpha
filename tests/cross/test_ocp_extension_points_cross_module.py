# [A_test] module_id: MOD-GOV_ocp_extension_points_cross_module | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-479 | docs/03_modules/_domain_governance/blueprint.md | §
...
from zephyr.governance.strategies.strategy_base import StrategyBase, StrategyMeta, StrategyRegistry

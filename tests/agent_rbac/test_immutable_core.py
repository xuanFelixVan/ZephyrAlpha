...
class TestProtectedPathsIntegrity:
    ...
    def test_critical_paths_present(self):
        ...
        critical = [".git/**", "AGENTS.md", "src/zephyr/agent_rbac/**"]
        for c in critical:
...
class TestIsProtectedPath:
    ...
    def test_agent_rbac_is_protected(self, core):
        assert core.is_protected_path("src/zephyr/agent_rbac/immutable_core.py")
        assert core.is_protected_path("src/zephyr/agent_rbac/core.py")

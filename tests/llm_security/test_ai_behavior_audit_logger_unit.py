# [A_test] module_id: SRC-TST-1969 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-586 | docs/03_modules/_domain_governance/blueprint.md | §

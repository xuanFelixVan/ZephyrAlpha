# [A_test] module_id: SRC-TST-1648 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.autonomy_core.skill_risk_mitigator import RiskMitigator

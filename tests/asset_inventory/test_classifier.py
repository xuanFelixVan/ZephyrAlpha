...
class TestClassifier:
    def test_classify_module(self) -> None:
        c = Classifier()
        entry = _make_entry("src/zephyr/asset_inventory/scanner.py")
    ...
    def test_classify_gate(self) -> None:
        c = Classifier()
        entry = _make_entry("src/zephyr/gates/G1.yaml", ext=".yaml")
    ...
    def test_classify_test(self) -> None:
        c = Classifier()
        entry = _make_entry("tests/asset_inventory/test_models.py")
    ...
    def test_classify_registry(self) -> None:
        c = Classifier()
        entry = _make_entry("src/zephyr/gates/_registry.yaml", ext=".yaml")

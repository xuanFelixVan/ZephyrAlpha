# [A_test] module_id: MOD-GOV_classifier_asset_inventory | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-225 | docs/03_modules/_domain_governance/blueprint.md | §

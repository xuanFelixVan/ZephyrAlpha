# [A_test] module_id: MOD-GOV_dependency_asset_inventory | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-228 | docs/03_modules/_domain_governance/blueprint.md | §

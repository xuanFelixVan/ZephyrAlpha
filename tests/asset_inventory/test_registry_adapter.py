...
from zephyr.asset_inventory.registry_adapter import (
    CsvAdapter,
...
from zephyr.asset_inventory.models import RegistryEntry
...
class TestRegistryManager:
    ...
    def test_cross_match_asset(self) -> None:
        from zephyr.asset_inventory.models import ClassifiedAsset, AssetType, AssetStatus

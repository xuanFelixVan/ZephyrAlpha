# [A_test] module_id: MOD-GOV_notifications | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
class TestSmtpEmailChannel:
    ...
    @patch("zephyr.infrastructure.asset_inventory.telemetry.smtplib.SMTP")

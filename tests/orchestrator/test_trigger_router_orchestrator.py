# [A_test] module_id: MOD-GOV_trigger_router_orchestrator | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-540 | docs/03_modules/_domain_governance/blueprint.md | §
        ...
        textwrap.dedent(
            ...
            triggers:
              ...
              cleanup_due:
                ...
                enabled: true
              blueprint_published:
                handler: "zephyr.orchestrator.execution.trigger_router.handle_blueprint_stub"

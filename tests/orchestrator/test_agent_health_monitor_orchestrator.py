# [A_test] module_id: MOD-GOV_agent_health_monitor_orchestrator | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-532 | docs/03_modules/_domain_governance/blueprint.md | §

# [A_test] module_id: SRC-TST-1922 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-541 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.orchestrator.test_wave_generator
# [STABILITY] evolving
# [SAFETY] L
...
from zephyr.trading.orchestrator.execution.wave_generator import WaveGenerator

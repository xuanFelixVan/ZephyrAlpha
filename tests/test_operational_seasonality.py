...
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.observability.feedback_loop.diagnosers.operational_seasonality
# [STABILITY] evolving
# [SAFETY] L
...
class TestAutoMode:
    def test_auto_mode_weekday(self):
        os_ = OperationalSeasonality()
        with patch("zephyr.observability.feedback_loop.diagnosers.operational_seasonality.datetime") as mock_dt:

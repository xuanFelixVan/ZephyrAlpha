...
def attack_03_lookahead_bias() -> dict[str, Any]:
    _has_factor_base = _try_import("zephyr.l02_alpha_factor.base")
    if not _has_factor_base:
        return {"detected": True, "status": "blocked_by_infrastructure: L02 not available"}

    try:
        from zephyr.l02_alpha_factor.base import FactorBase, FactorMeta
...
if __name__ == "__main__":
    ...
    report_path = _PROJECT_ROOT / "docs" / "09_audit" / "adversarial_test_alpha_signal.json"

# [A_test] module_id: SRC-TST-0574 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.governance.config_scanner import ConfigScanner

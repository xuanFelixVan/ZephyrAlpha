# [A_test] module_id: MOD-GOV_action_side_effect_cumulative_detector | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.correlation.action_side_effect_cumulative_detector import (

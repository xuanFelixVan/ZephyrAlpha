# [A_test] module_id: MOD-GOV_phase_c_import_chain | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
PHASE_C_CLASSES: list[ConcreteClass] = [
    ConcreteClass("zephyr.data.implementations.akshare_provider", "AkshareIngestProvider", "L00"),

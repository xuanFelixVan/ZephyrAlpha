# [A_test] module_id: SRC-TST-1953 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-570 | docs/03_modules/_domain_governance/blueprint.md | §

# [A_test] module_id: SRC-TST-1901 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-520 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.kb.test_extract
# [STABILITY] evolving
# [SAFETY] L

# [A_test] module_id: MOD-GOV_intent_parser_unit | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-655 | docs/03_modules/_domain_governance/blueprint.md | §
# [MODULE] tests.unit.test_intent_parser
# [STABILITY] evolving
# [SAFETY] L

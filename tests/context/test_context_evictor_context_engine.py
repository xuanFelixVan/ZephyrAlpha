# [A_test] module_id: SRC-TST-1834 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-462 | docs/03_modules/_domain_governance/blueprint.md | §

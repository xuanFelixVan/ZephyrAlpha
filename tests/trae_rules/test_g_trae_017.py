...
GATE_YAML = PROJECT_ROOT / "src" / "zephyr" / "gov_enforcement" / "rule_enforcement" / "g_trae_017.yaml"
...
class TestGTrae017:
    ...
    def test_gate_registered_in_gate_files(self):
        ...
        assert "G_TRAE_017" in GateEngine.GATE_FILES, "Gate G_TRAE_017 not in GATE_FILES"
    ...
    def test_gate_loadable_by_engine(self):
        ...
        try:
            if "G_TRAE_017" not in GateEngine.GATE_FILES:
                GateEngine.GATE_FILES["G_TRAE_017"] = "g_trae_017.yaml"

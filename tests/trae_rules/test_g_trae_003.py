...
class TestGTrae003:
    ...
    def test_gate_registered_in_gate_files(self):
        ...
        assert "G_TRAE_003" in GateEngine.GATE_FILES, "Gate G_TRAE_003 not in GATE_FILES"
    ...
    def test_gate_loadable_by_engine(self):
        ...
        try:
            if "G_TRAE_003" not in GateEngine.GATE_FILES:
                GateEngine.GATE_FILES["G_TRAE_003"] = "g_trae_003.yaml"

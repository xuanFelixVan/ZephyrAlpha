...
class TestGTrae006:
    ...
    def test_gate_registered_in_gate_files(self):
        ...
        assert "G_TRAE_006" in GateEngine.GATE_FILES, "Gate G_TRAE_006 not in GATE_FILES"
    ...
    def test_gate_loadable_by_engine(self):
        ...
        try:
            if "G_TRAE_006" not in GateEngine.GATE_FILES:
                GateEngine.GATE_FILES["G_TRAE_006"] = "g_trae_006.yaml"

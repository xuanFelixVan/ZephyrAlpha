# [A_test] module_id: SRC-TST-0465 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-INF-019 | docs/03_modules/_cross_layer/context-engine/blueprint.md | §
...
from zephyr.autonomy_core.budget_forecaster import BudgetForecaster, BudgetForecast

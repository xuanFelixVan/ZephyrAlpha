# [A_test] module_id: SRC-TST-1379 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
class TestPipelineOrchestrator:
    ...
    def test_run_returns_pipeline_result(self):
        orc = PipelineOrchestrator()
        result = orc.run(task_type="CODE_GEN", target_layer="L01", session_id="test-session")

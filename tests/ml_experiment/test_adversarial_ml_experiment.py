# [A_test] module_id: SRC-TST-0205 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-339 | docs/03_modules/_domain-governance/blueprint.md | §

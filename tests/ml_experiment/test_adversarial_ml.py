# [A_test] module_id: MOD-GOV_adversarial_ml | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-340 | docs/03_modules/_domain_governance/blueprint.md | §

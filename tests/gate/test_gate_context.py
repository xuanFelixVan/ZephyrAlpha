...
# [BLUEPRINT] MOD-INF-007 | docs/03_modules/_cross_layer/gate_engine/blueprint.md | §4.2
...
from zephyr.governance.rule_enforcement.gate_context import GateContext, GateResult, GateStatus, GateViolation

# [A_test] module_id: MOD-GOV_gate_context | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.gov_enforcement.rule_enforcement.gate_engine.gate_context import (
    GateContext,
    GateResult,
    GateStatus,
    GateViolation,

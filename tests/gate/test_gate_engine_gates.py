# [A_test] module_id: MOD-GOV_gate_engine_gates | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
GATES_DIR = REPO_ROOT / "src" / "zephyr" / "gov_enforcement" / "rule_enforcement"

# [A_test] module_id: MOD-GOV_f21_event_driven | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
class TestEventDrivenMonitoring:
    ...
    def test_event_triggers_metrics_counter(self) -> None:
        ...
        from zephyr.shared.event_bus import bus
        from zephyr.shared.observability.metrics import get_registry, subscribe_metrics_events

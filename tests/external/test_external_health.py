# [A_test] module_id: MOD-GOV_external_health | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.feedback_loop.detectors.correlation.external_health import (
    DependencyHealth,
    DependencyStatus,
    ExternalHealth,
)

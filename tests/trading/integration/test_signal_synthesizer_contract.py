# [A_test] module_id: MOD-GOV_signal_synthesizer_contract | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-682 | docs/03_modules/_domain_governance/blueprint.md | §

# [A_test] module_id: MOD-GOV_schemas_unit | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-TEST-679 | docs/03_modules/_domain_governance/blueprint.md | §
...
def _task(**kwargs: Any) -> Task:
    defaults: dict[str, Any] = dict(
        ...
        directive="313",
        description="Sample test task with minimum description length",
        files_in_scope=["tests/trading/test_schemas.py"],
        deliverables=["test deliverable"],
        applicable_rules=[{"module_id": "GOV-TASK-001", "section": "v3.0.0", "reason": "test"}],
        allowed_touch=["tests/trading/test_schemas.py"],

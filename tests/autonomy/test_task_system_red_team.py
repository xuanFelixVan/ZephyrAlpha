...
def test_01_taskcard_full():
    ...
    from zephyr.integration.shared.schema.severity_types import Priority, SafetyLevel
    from zephyr.shared.models import GateLevel, TaskAuditFinding, TaskCard, TaskNamespace, TaskStatus
...
def test_05_check_gates():
    ...
    from zephyr.integration.shared.schema.severity_types import Priority, SafetyLevel
    from zephyr.shared.blueprint_decomposer import BlueprintDecomposer
    from zephyr.shared.models import GateLevel, TaskCard, TaskNamespace, TaskStatus

# [A_test] module_id: MOD-GOV_batch3_integration | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
mod = pytest.importorskip(
    "zephyr.feedback_loop.capacity_assurance.batch3_integration", reason="batch3_integration not available"
)

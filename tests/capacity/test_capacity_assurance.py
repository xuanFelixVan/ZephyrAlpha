# [A_test] module_id: MOD-GOV_capacity_assurance | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
sli_mod = pytest.importorskip(
    "zephyr.feedback_loop.capacity_assurance.sli_instrumentation",
    reason="capacity-assurance.sli_instrumentation not available",
)

# [A_test] module_id: SRC-TST-0502 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
try:
    from zephyr.autonomy_core.cache_invalidation import CacheInvalidationManager, CacheVersion

"""Test gate g_trae_045 for rule TRAE-045 — calls gate_engine.evaluate().
...
GATE_YAML = PROJECT_ROOT / "src" / "zephyr" / "governance" / "rule_enforcement" / "g_trae_045.yaml"
RULE_YAML = PROJECT_ROOT / "docs" / "01_policies_and_standards" / "rules" / "trae_045_data_quality_lineage.yaml"
MOCK_YAML = PROJECT_ROOT / "tests" / "fixtures" / "g_trae_045_mock.yaml"


class TestGTrae045:
    """Red-Blue extreme tests for g_trae_045 gate."""
    ...
    def test_gate_evaluates_pass(self):
        ...
        try:
            ...
            valid_task = Task(
                ...
                acceptance=["pytest"],
                applicable_rules=[{"module_id": "TRAE-045", "section": "all", "reason": "gate test"}],

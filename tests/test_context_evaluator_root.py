# [A_test] module_id: SRC-TST-0591 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-INF-019 | docs/03_modules/_cross_layer/context-engine/blueprint.md | §tests
# [MODULE] zephyr.autonomy_core.context_evaluator
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] pytest
# [STABILITY] evolving
...
try:
    from zephyr.autonomy_core.context_evaluator import (
        ContextEvaluator,
        EvaluationReport,
    )
    _IMPORT_OK = True

# [A_test] module_id: MOD-GOV_chaos_engineering | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-FEEDBACK_LOOP | docs/03_modules/_cross_layer/feedback_loop/blueprint.md | §test
# [MODULE] tests.test_chaos_engineering
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] zephyr.feedback_loop.detectors.reliability.chaos_engineering
# [STABILITY] evolving
# [SAFETY] L

# [A_test] module_id: SRC-TST-0638 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
...
from zephyr.governance.cross_agent_conflict_detector import (
    ConflictReport,

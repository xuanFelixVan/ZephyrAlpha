# [A_test] module_id: SRC-TST-1406 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] SRC-418 | docs/03_modules/_domain-governance/blueprint.md | §

...
def _rep(news_id: str, title: str, summary: str, day: str = "2026-08-20 10:00:00") -> dict:
    return {"news_id": news_id, "publish_time": day, "title": title, "summary": summary, "source": "akshare_research_report"}
...
class TestAggregateDaily:
    def test_metrics(self):
        rows = [
            {"publish_date": "2026-08-20", "rating": "买入", "score": 1.0, "revision": "initiation", "target_price": 58.0},
            {"publish_date": "2026-08-20", "rating": "增持", "score": 0.6, "revision": "maintain", "target_price": None},
            {"publish_date": "2026-08-20", "rating": "中性", "score": 0.0, "revision": "downgrade", "target_price": 40.0},

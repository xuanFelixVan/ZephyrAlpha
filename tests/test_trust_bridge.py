# [A_test] module_id: SRC-TST-1769 | layer=test | stability=volatile | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-INF-020 | docs/03_modules/_domain-governance/audit-trail/blueprint.md | §
# [MODULE] tests.test_trust_bridge
# [INVARIANTS] none
# [MODIFY-GUARD] none
# [CONSUMERS] pytest
# [STABILITY] stable
...
from zephyr.governance.audit_trail.trust_bridge import AuditTrustBridge

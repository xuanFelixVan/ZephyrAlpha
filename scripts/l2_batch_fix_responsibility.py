...
class L2BatchResponsibilityFixer:
    def __init__(self):
        self.fixed_files = []
        self.failed_files = []
                    ...
                    try:
                        ...
                        if yaml_match:
                            ...
                            if resp_match:
                                ...
                                if responsibility in ['扩展功能、辅助模块', '核心功能、主模块']:
                                    relative_path = file_path.relative_to(DOCS_DIR)
    ...
    def run(self):
        ...
        for i, file_info in enumerate(unclear_files[:200], 1):
            if i % 50 == 0:
                print(f"[{i}/200] 已处理 {i} 个文件...")
...
if __name__ == "__main__":
    fixer = L2BatchResponsibilityFixer()
    fixer.run()

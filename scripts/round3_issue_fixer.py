...
class Round3IssueFixer:
    ...
    def _handle_overlaps(self):
        ...
        for issue in responsibility_issues[:30]:
...
"""
    ...
    def _generate_fix_report(self) -> Dict:
        ...
        report_path = self.report_dir / "round3_fix_report.json"
        ...
        print(f"  - P0元数据缺失: {self.fix_stats['p0_metadata']}个")

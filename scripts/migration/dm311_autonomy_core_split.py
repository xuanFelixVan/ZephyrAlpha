# [BLUEPRINT] MOD-INF-037 | docs/02_enterprise_architecture/domain-model-migration-plan.md | §DM-311
...
SUBDIR_TO_NEW_MODULE_PREFIX = {
    ...
    "feedback-loop": "zephyr.observability.feedback_loop.",
...
CROSS_REFS = {
    ...
    "zephyr.observability.feedback_loop.": "zephyr.observability.feedback_loop.",

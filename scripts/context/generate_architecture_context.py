...
INVARIANTS_YAML = REPO_ROOT / ("architecture_model/cross_cutting/invariants.yaml")
...
CAPABILITY_HEATMAP_YAML = REPO_ROOT / "architecture_model/cross_cutting/capability_heatmap.yaml"

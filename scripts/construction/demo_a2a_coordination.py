...
def demo_task_coordination():
    ...
    subtask_details = [
        {"id": "a2a-task-sub-001", "name": "需求分析", "assignee": "agent-architect", "description": "分析用户管理系统需求"},
        {"id": "a2a-task-sub-002", "name": "架构设计", "assignee": "agent-architect", "description": "设计系统架构和数据库"},
        {"id": "a2a-task-sub-003", "name": "代码实现", "assignee": "agent-developer", "description": "实现核心功能代码"},
    ...
    print(f"参与 Agent: 3 (架构师、开发者、测试员)")
    print(f"协调状态: 成功")

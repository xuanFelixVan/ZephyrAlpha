...
def create_task(conn, task_id, title, description, files_in_scope, deliverables,
                acceptance, depends_on=None, priority="P1",
                allowed_touch=None, applicable_rules=None, rollback_instructions="",
    ...
    conn.execute("""
        INSERT INTO tasks (
            ...
            rollback_instructions, post_sync_standard, construction_targets
                  ...
                  ?, ?, ?)
    """, (
        task_id, 'DM', title, description, priority,
        NOW, NOW,
        json.dumps(acceptance),
        json.dumps(files_in_scope), json.dumps(deliverables),
...
def main():
    ...
    create_task(conn,
        ...
        acceptance=["PRAGMA table_info(nodes) 包含 node_name/file_path/stability/safety_level/ai_autonomy/design_state/runtime_state"],
        depends_on=[],
    ...
    create_task(conn,
        ...
        files_in_scope=["src/zephyr/data/persistence/sqlite_schema.py", "src/zephyr/governance/behavioral_auditor/drift_engine.py", "src/zephyr/governance/behavioral_auditor/gate_persistence.py"],
    ...
    create_task(conn,
        ...
        files_in_scope=["scripts/governance/run_all.py", "scripts/governance/d5_architecture/validators/validate_cross_references.py", "scripts/governance/d5_architecture/detectors/detect_deprecated_adr_references.py"],
    ...
    create_task(conn,
        ...
        files_in_scope=["tests/test_interrupt_guard.py", "src/zephyr/data/persistence/database_manager.py", "src/zephyr/infrastructure/runtime_integration/rollback/sqlite_dumper.py"],
    ...
    create_task(conn,
        ...
        files_in_scope=["scripts/governance/audit_registration.py", "scripts/governance/d5_architecture/validators/validate_cross_references.py"],

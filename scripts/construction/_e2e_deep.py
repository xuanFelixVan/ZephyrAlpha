...
tests = [
    ...
    ('MOD-INF-012', 'zephyr.infrastructure.db', ['TaskRepository', 'ScriptManifestDB']),
    ('MOD-INF-035', 'zephyr.orchestration.runtime_core', ['AutoRuntimeCore']),
    ...
    ('MOD-INF-008', 'zephyr.orchestration.context_management', []),
    ('MOD-INF-011', 'zephyr.integration.vector_memory', []),
    ('MOD-INF-014', 'zephyr.security.llm_defense.llm_security', []),
    ...
    ('MOD-INF-019', 'zephyr.orchestration.agent_lifecycle', []),
    ...
    ('MOD-INF-025', 'zephyr.orchestration.agent_communication', []),
    ('MOD-INF-010', 'zephyr.observability.feedback_loop', []),
    ...
    ('MOD-INF-032', 'zephyr.infrastructure.shared_services.lifecycle', []),

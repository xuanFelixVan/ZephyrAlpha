...
CROSS_DOMAIN_MAPPINGS: dict[str, str] = {
    ...
    "zephyr.trading.feedback_loop.system_telemetry.compliance_rule": "zephyr.portfolio.core.compliance_rule",
    "zephyr.trading.feedback_loop.system_telemetry.synthesized_signal": "zephyr.execution.trading.trading_contracts.market.synthesized_signal",
    "zephyr.trading.feedback_loop.system_telemetry.capital_allocation_result": "zephyr.execution.trading.trading_contracts.execution.capital_allocation_result",
    "zephyr.trading.feedback_loop.system_telemetry.risk_limits": "zephyr.risk.risk_limits",
    ...
    "zephyr.trading.feedback_loop.fitness_functions": "zephyr.trading.feedback_loop.fitness_functions",
    ...
    "zephyr.trading.feedback_loop.system_telemetry.file_utils": "zephyr.shared.file_utils",
    "zephyr.integration.observability.session_audit": "zephyr.infrastructure.shared_services.observability_02.session_audit",
    "zephyr.trading.feedback_loop.system_telemetry.market_data": "zephyr.execution.trading.trading_contracts.market.market_data",
    "zephyr.trading.feedback_loop.system_telemetry.instrument": "zephyr.data.instrument",
    ...
    "zephyr.trading.feedback_loop.system_telemetry.errors": "zephyr.shared.errors",
    ...
    "zephyr.integration.pipeline.backpressure_bridge": "zephyr.trading.feedback_loop.backpressure_bridge",
    "zephyr.trading.feedback_loop.feedback_loop.conformal_prediction": "zephyr.trading.feedback_loop.evolution.conformal_prediction",
    ...
    "zephyr.trading.feedback_loop.feedback_loop.auto_reward": "zephyr.trading.feedback_loop.evolution.auto_reward",
    "zephyr.trading.feedback_loop.feedback_loop.self_bottleneck_detector": "zephyr.trading.feedback_loop.diagnosers.self_bottleneck_detector",
    "zephyr.trading.feedback_loop.system_telemetry.context": "zephyr.shared.utils.context",
    "zephyr.governance.drift_detection.drift_infrastructure": "zephyr.governance.drift_detection.drift_infrastructure",
    ...
    "zephyr.trading.feedback_loop.feedback_loop.cold_start_manual": "zephyr.trading.feedback_loop.docs.cold_start_manual",
    ...
    "zephyr.orchestration.runtime_core.drift_hotfix_bypass": "zephyr.governance.drift_detection.drift_hotfix_bypass",
    ...
    "zephyr.trading.feedback_loop.system_telemetry.order": "zephyr.execution.trading.trading_contracts.execution.order",
    "zephyr.trading.feedback_loop.system_telemetry.fill": "zephyr.execution.trading.trading_contracts.execution.fill",
    "zephyr.trading.feedback_loop.system_telemetry.factor_signal": "zephyr.execution.trading.trading_contracts.market.factor_signal",
    "zephyr.trading.feedback_loop.system_telemetry.position": "zephyr.execution.trading.trading_contracts.execution.position",
    "zephyr.trading.feedback_loop.system_telemetry.execution_report": "zephyr.execution.trading.trading_contracts.execution.execution_report",
    "zephyr.trading.feedback_loop.system_telemetry.risk_dashboard_snapshot": "zephyr.execution.trading.trading_contracts.risk.risk_dashboard_snapshot",
    "zephyr.trading.feedback_loop.system_telemetry.risk_metrics": "zephyr.execution.trading.trading_contracts.risk.risk_metrics",
    ...
    "zephyr.trading.feedback_loop.system_telemetry.risk_limit_violation_error": "zephyr.execution.trading.trading_contracts.risk.risk_limit_violation_error",
    "zephyr.trading.feedback_loop.system_telemetry.model_serving_request": "zephyr.execution.trading.trading_contracts.execution.model_serving_request",

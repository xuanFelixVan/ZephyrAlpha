...
OLD_LAYER_TO_DOMAIN = {
    ...
    "ml_train": "D-ML-TRAIN",
    "simulation_backtesting": "D-SIMULATION",
    "integration": "D-SIMULATION",
}
...
OLD_DIR_TO_DOMAIN = {
    ...
    "src/zephyr/llm-security/": "D-SECURITY",
    "src/zephyr/integration/": "D-INTEGRATION",
    "src/zephyr/governance/": "D-GOVERNANCE",
    "src/zephyr/kb/": "D-KNOWLEDGE",
    "src/zephyr/vector-memory/": "D-KNOWLEDGE",
    "src/zephyr/observability/telemetry/": "D-OPS",
    "src/zephyr/escalation-engine/": "D-AUTONOMY-CORE",
    "src/zephyr/budget-enforcer/": "D-AUTONOMY-CORE",
    "src/zephyr/capacity_calibrator/": "D-OPS",
    "src/zephyr/alert_manager/": "D-OPS",
    "src/zephyr/shared/": "D-INFRA-RUNTIME",
    "src/zephyr/factor/": "D-FACTOR",
    "src/zephyr/signal/": "D-SIGNAL",
    "src/zephyr/risk/": "D-RISK",
    "src/zephyr/portfolio/": "D-PF-CORE",
    "src/zephyr/execution/": "D-EX-CORE",
    "src/zephyr/trading/": "D-TRADING",
    "src/zephyr/governance/": "D-COMPLIANCE",
    "src/zephyr/ml/": "D-ML-TRAIN",
    "src/zephyr/data/": "D-DATA",
    "src/zephyr/research/": "D-RESEARCH",
    "src/zephyr/reporting/": "D-REPORTING",
    "src/zephyr/simulation/": "D-SIMULATION",
    "src/zephyr/position/": "D-POSITION",
    "src/zephyr/alt_data/": "D-ALT-DATA",
    "src/zephyr/cross_asset/": "D-CROSS-ASSET",
    "src/zephyr/data_eng/": "D-DATA-ENG",
    "src/zephyr/ml_serve/": "D-ML-SERVE",
    "src/zephyr/pf_alloc/": "D-PF-ALLOC",
    "src/zephyr/sell_decision/": "D-SELL-DECISION",
    "src/zephyr/ex_sor/": "D-EX-SOR",
    "src/zephyr/ex_core/": "D-EX-CORE",
    "src/zephyr/frontend/": "D-FRONTEND",
    "src/zephyr/infra_runtime/": "D-INFRA-RUNTIME",
    "src/zephyr/infra_ops/": "D-INFRA-OPS",
    "src/zephyr/autonomy_perm/": "D-AUTONOMY-PERM",
    "src/zephyr/autonomy_core/": "D-AUTONOMY-CORE",
    "src/zephyr/security/": "D-SECURITY",
    "src/zephyr/ops/": "D-OPS",
    "src/zephyr/knowledge/": "D-KNOWLEDGE",
}
...
SCRIPT_DIR_TO_DOMAIN = {
    ...
    "scripts/migration/": "D-GOVERNANCE",
    "scripts/fix_": "D-GOVERNANCE",
    "scripts/generate_": "D-GOVERNANCE",
    "scripts/security/": "D-SECURITY",
    "scripts/data/": "D-DATA",
}

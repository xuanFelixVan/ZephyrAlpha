...
"""
    ...
    def _fix_responsibility(self):
        ...
        for issue in responsibility_issues[:150]:
            file_path = self.docs_dir / issue["file"]
...
"""
    ...
    def _generate_fix_report(self) -> Dict:
        ...
        print(f"  - P1编号体系: {self.fix_stats['module_id']}个")
        ...
        report_path = self.root_dir / "docs/09_AUDIT/REPORTS/round6_fix_report.json"

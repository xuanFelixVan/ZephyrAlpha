...
# [MODULE] scripts.backtest.translated.c4_fact_4f749668
# [DOMAIN] D_BACKTEST
...
#   表达式=rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (ts_corr_20(vol_20d, ret_20d)) )；PIT+冻结土规由引擎保证；出生候选=CAND-e611b7cda691
...
# [TTL] permanent
"""公式轨考卷件：rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (ts_corr_20(vol_20d, ret_20d)) )

生成=factor_strategy_template（MOD-BT-159 机械翻译桥）；出生候选=CAND-e611b7cda691；
...
STRATEGY_ID = "FACT-4f749668"
WINDOW_KIND = "stock"

EXPR = 'rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (ts_corr_20(vol_20d, ret_20d)) )'
TOP_N = 20

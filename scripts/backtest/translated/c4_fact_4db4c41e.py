...
# [MODULE] scripts.backtest.translated.c4_fact_4db4c41e
# [DOMAIN] D_BACKTEST
...
#   表达式=rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (turnover / vol_20d) )；PIT+冻结土规由引擎保证；出生候选=CAND-ceea86f5ca9c
...
# [TTL] permanent
"""公式轨考卷件：rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (turnover / vol_20d) )

生成=factor_strategy_template（MOD-BT-159 机械翻译桥）；出生候选=CAND-ceea86f5ca9c；
...
STRATEGY_ID = "FACT-4db4c41e"
WINDOW_KIND = "stock"

EXPR = 'rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (turnover / vol_20d) )'
TOP_N = 20

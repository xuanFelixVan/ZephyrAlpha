...
# [MODULE] scripts.backtest.translated.c4_fact_4228020a
# [DOMAIN] D_BACKTEST
...
#   表达式=rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (ts_corr_20(vol_20d, ret_20d) - 0.5) )；PIT+冻结土规由引擎保证；出生候选=CAND-e8fc95fe5b98
...
# [TTL] permanent
"""公式轨考卷件：rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (ts_corr_20(vol_20d, ret_20d) - 0.5) )

生成=factor_strategy_template（MOD-BT-159 机械翻译桥）；出生候选=CAND-e8fc95fe5b98；
...
STRATEGY_ID = "FACT-4228020a"
WINDOW_KIND = "stock"

EXPR = 'rank_cs( (ret_20d - ts_zscore_20(ret_20d)) * (ts_corr_20(vol_20d, ret_20d) - 0.5) )'
TOP_N = 20

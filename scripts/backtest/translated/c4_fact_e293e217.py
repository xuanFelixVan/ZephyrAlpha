...
# [MODULE] scripts.backtest.translated.c4_fact_e293e217
# [DOMAIN] D_BACKTEST
...
#   表达式=rank_cs( (ret_5d - ret_20d) / vol_20d )；PIT+冻结土规由引擎保证；出生候选=CAND-606a6e8e89ac
...
# [TTL] permanent
"""公式轨考卷件：rank_cs( (ret_5d - ret_20d) / vol_20d )

生成=factor_strategy_template（MOD-BT-159 机械翻译桥）；出生候选=CAND-606a6e8e89ac；
因子方向=多头正向（增量 IC>0 验收锁定）。
[KNOWLEDGE_EFFECTIVE_FROM] 2026-09-16 | 源=公式轨生成件（表达式生成即生效日） | 生成=MOD-BT-159
"""
...
STRATEGY_ID = "FACT-e293e217"
WINDOW_KIND = "stock"

EXPR = 'rank_cs( (ret_5d - ret_20d) / vol_20d )'
TOP_N = 20

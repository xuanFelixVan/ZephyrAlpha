...
# [MODULE] scripts.backtest.translated.c4_fact_e831084c
# [DOMAIN] D_BACKTEST
...
#   表达式=ts_zscore_20(ret_5d)；PIT+冻结土规由引擎保证；出生候选=CAND-22a96c4c7758

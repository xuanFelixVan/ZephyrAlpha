...
EXPECTED_FILES: list[dict[str, Any]] = [
    ...
    # Card 2: 错误码+帧
    {"path": "src/zephyr/mcp/_base_server.py", "card": "TASK-INF-013-0002", "new": False, "check": "content_length_frame"},
    {"path": "src/zephyr/mcp/error_codes.py", "card": "TASK-INF-013-0002", "new": True, "check": "all_10_codes_defined"},

    # Card 4: 5-server增强
    {"path": "src/zephyr/mcp/knowledge_base_server.py", "card": "TASK-INF-013-0004", "new": False, "check": "has_list_kes_tool"},
    {"path": "src/zephyr/mcp/gate_engine_server.py", "card": "TASK-INF-013-0004", "new": False, "check": "has_gate_5_6_cb"},
    {"path": "src/zephyr/mcp/doc_guard_server.py", "card": "TASK-INF-013-0004", "new": False, "check": "has_validate_doc_version"},
    {"path": "src/zephyr/mcp/sentinel_server.py", "card": "TASK-INF-013-0004", "new": False, "check": "has_health_status"},
    {"path": "src/zephyr/mcp/blueprint_search_server.py", "card": "TASK-INF-013-0004", "new": False, "check": "has_cache_refresh"},
    ...
    {"path": "src/zephyr/mcp/handoff_auto_loader.py", "card": "TASK-INF-013-0008", "new": True, "check": "has_HandoffAutoLoader"},
    {"path": "scripts/governance/verify_file_paths.py", "card": "TASK-INF-013-0008", "new": True, "check": "has_EXPECTED_FILES"},
    ...
    # Card 9: 跨模块契约
    {"path": "tests/architecture/test_cross_module_contracts.py", "card": "TASK-INF-013-0020", "new": True, "check": "has_6_tests"},

    # Card 10: 审计报告
    {"path": "docs/03_modules/_cross_layer/mcp-servers/changes/MOD-INF-013/_decomposition_completeness.yaml", "card": "TASK-INF-013-0021", "new": True, "check": "yaml_valid"},
    {"path": "docs/03_modules/_cross_layer/mcp-servers/changes/MOD-INF-013/_audit_report.md", "card": "TASK-INF-013-0021", "new": True, "check": "has_conclusion"},

    # Card 11: Resource/Prompt/Sandbox
    {"path": "src/zephyr/mcp/resource_provider.py", "card": "TASK-INF-013-0006", "new": True, "check": "has_5_resources"},
    ...
    {"path": "tests/performance/test_mcp_stress.py", "card": "TASK-INF-013-0007", "new": True, "check": "has_concurrent_test"},

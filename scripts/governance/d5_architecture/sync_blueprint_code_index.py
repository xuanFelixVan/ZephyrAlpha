...
BLUEPRINT_MODULE_MAP: dict[str, dict] = {
    ...
    "context-engine": {
        ...
        "test_patterns": [
            ...
            "tests/unit/test_doc_compressor.py",
            "tests/unit/test_prompt_registry.py",
            "tests/unit/test_intent_parser.py",
            "tests/unit/test_intent_keyword_mapper.py",
            "tests/unit/test_pattern_library.py",
            "tests/unit/test_system_snapshot.py",
        ],
        "config_files": [
    ...
    "database": {
        ...
        "test_patterns": [
            ...
            "tests/unit/test_sqlite_schema.py",
            "tests/unit/test_atomic_transaction_manager.py",
            "tests/unit/test_olap_engine.py",
        ],
        "config_files": [],
        "governance_scripts": [],
    ...
    "feedback-loop": {
        ...
        "test_patterns": [
            ...
            "tests/unit/test_auto_evolution.py",
    ...
    "gate-engine": {
        ...
        "test_patterns": [
            ...
            "tests/unit/test_task_completion_gate.py",
            "tests/unit/test_circuit_breaker.py",
            "tests/unit/test_contract_template_manager.py",
    ...
    "runtime-integration": {
        ...
        "test_patterns": [
            ...
            "tests/unit/test_agent_health_monitor.py",
            "tests/unit/test_hallucination_detector.py",
            "tests/unit/test_rollback_manager.py",
            "tests/unit/test_state_synchronizer.py",
            "tests/unit/test_trigger_router.py",
            "tests/unit/test_file_task_mapper.py",
            "tests/unit/test_wave_generator.py",
            "tests/unit/test_deferred_queue.py",
    ...
    "task-card-kms": {
        ...
        "extra_source_files": [
            ...
            "src/zephyr/gates/g4_activate.yaml",
        ],
        "test_patterns": [
            "tests/unit/test_sqlite_schema.py",
            "tests/unit/test_mcp_servers.py",

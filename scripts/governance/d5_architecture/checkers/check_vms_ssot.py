#!/usr/bin/env python
# [A_module] module_id=MOD-INF-011 | layer=module | stability=stable | safety=M | ai_autonomy=human_gated
...
# [TESTS] none
# [TTL] permanent
# noqa: m11-perm-manual-legitimate  M11豁免: CI/人工按需调用的静态检查器，非常驻服务，manual 为设计调用方式
#
...
def get_staged_files():
    ...
    """
    try:
        result = subprocess.run(  # noqa: bare-subprocess  pre-commit 静态检查读 staged diff，process_pool 在此场景不适用

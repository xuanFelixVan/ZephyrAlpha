# [BLUEPRINT] MOD-GOV_GENERATE_CONTRACT_CATALOG
# [MODULE]# [MODULE] scripts.governance.d5_architecture.generators.generate_contract_catalog
...
__manifest__ = """
args: []
description: 'G12: 从 depgraph (PostgreSQL) 生成契约目录全景图'
dimensions:
- D5
priority: P2
timeout_seconds: 60

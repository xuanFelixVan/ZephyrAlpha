...
PENDING_PANORAMAS: list[dict] = [
    ...
    },
    {
        ...
        "data_source_tbd": "待裁定：扩展现有 dataflow_datasets 表加完整性/延迟/质量字段 vs 独立 data_catalog 表。data_inventory.md / data_acquisition_flow.md 已迁移到 05_dataflow_architecture/，需求清单已合并进 data_inventory.md 的需补充列",
        "priority": "高",

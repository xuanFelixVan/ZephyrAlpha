...
_TYPE_IMPORTS: dict[str, str] = {
    ...
    "TraceContext": "from zephyr.shared.contracts.trace_context import TraceContext",
    "OrderSide": "from zephyr.shared.contracts.order import OrderSide",
    "OrderType": "from zephyr.shared.contracts.order import OrderType",
    "OrderStatus": "from zephyr.shared.contracts.order import OrderStatus",
}

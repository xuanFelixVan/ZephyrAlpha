...
def write_capability_heatmap(data: dict) -> None:
    ...
    capability_domains = [
        ...
        ("安全（横切）", "D-SECURITY, D-SECURITY-LLM, D-BEHAVIORAL_AUDIT, D-DATA_SEC, D-AUTONOMY_PERM"),
        (
            "基础设施（横切）",
            "D-INFRA_OPS, D-INFRA_RUNTIME, D-INTEGRATION, D-INTEGRATION-GATEWAY, D-SHARED, D-FRONTEND, D-REPORTING, D-KNOWLEDGE, D-INTELLIGENCE, D-AUTONOMY_CORE, D-OPS",
        ),
    ]

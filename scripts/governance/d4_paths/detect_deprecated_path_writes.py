...
ensure_utf8_stdout()
import argparse
DEPRECATED_PATH_PREFIXES = ['_DO_NOT_USE_old_tree/', '_DO_NOT_USE_old_tree\\', 'docs/00_', 'docs/01_', 'docs/02_', 'docs/03_', 'docs/04_', 'docs/05_', 'docs/06_', 'docs/07_', 'docs/08_', 'docs/09_']

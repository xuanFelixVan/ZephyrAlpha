...
ensure_utf8_stdout()
import argparse
LLM_IMPORTS = {'openai', 'anthropic', 'langchain', 'cohere', 'huggingface_hub', 'transformers', 'tiktoken', 'replicate', 'together', 'groq'}
LAYER_PATTERN = re.compile('l(0[2-9]|[1-3]\\d)_', re.IGNORECASE)
B_TRACK_DIRS = {'llm_security', 'vector_memory', 'context_engine', 'orchestrator', 'feedback_loop', 'gates', 'db', 'kb', 'mcp', 'shared'}

...
# [CONSUMERS] CI/CD reporting; manual audit; trae_081_audit_dimensions_framework.yaml 维度 5.158 暗债监控
# [STARTUP] manual
# [MATURITY] production
# [INVARIANTS] 纯 stdlib 实现；非阻断（exit 0 除非 --ci）；McCabe 算法与 high_complexity_gate.py 一致
# [MODIFY-GUARD] 修改阈值需同步更新 trae_081_audit_dimensions_framework.yaml 维度 5.158 + high_complexity_gate.py _MAX_COMPLEXITY
# [STABILITY] stable
# [SAFETY] L

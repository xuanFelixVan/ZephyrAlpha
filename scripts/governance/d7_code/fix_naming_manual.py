...
CHINESE_DIR_MAP: dict[str, str] = {
    "0_总览入口": "0_overview_entry",
    "1_全局架构图": "1_global_architecture_diagram",
    "2_域架构文档": "2_domain_architecture_docs",
    "3_治理报告": "3_governance_reports",
    "4_架构原则与决策": "4_architecture_principles_decisions",
    "5_手工架构视图": "5_manual_architecture_views",
    "6_手工架构图": "6_manual_architecture_diagrams",
    "_归档": "_archive",
}

# N-10 目录名修正映射（特殊处理）
N10_DIR_MAP: dict[str, str] = {
    "infrastructure.runtime_integration": "infrastructure_runtime_integration",

...
PATH_REPLACEMENTS = [
    ...
    (r"tests/test_depgraph_db", r"tests/governance/rule_enforcement/test_depgraph_db"),
    (r"tests/test_depgraph_generator_design_protection", r"tests/governance/rule_enforcement/test_depgraph_generator_design_protection"),

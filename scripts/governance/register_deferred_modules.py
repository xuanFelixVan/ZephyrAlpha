...
CATEGORY_A = [
    ...
    {
        "path": "src/zephyr/factor/ashare/microstructure/",
        "exists": True,
        "module_name_cn": "微观结构因子",
        "can_build": 0,
        "gate_reason": "受限：需Level-2逐笔成交数据(GATE-27-01)",
        "description_cn": "基于Level-2逐笔成交数据计算微观结构因子(买卖压力不平衡/成交单大小分布/大单净买入比例)",
    },
    {
        "path": "src/zephyr/factor/ashare/intraday/",
        "exists": True,
        "module_name_cn": "日内因子",
        "can_build": 0,
...
CATEGORY_B = [
    # BT-18~26 回测域辅助模块 (9项)
    {
        "path": "src/zephyr/backtest/services/decay_monitor.py",
        "exists": False,
        "blueprint_id": "MOD-BT-018",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "策略衰减监控告警器",
        "can_build": 1,
        "gate_reason": "暂缓：因子侧decay_monitor已覆盖IC衰减监控",
        "description_cn": "监控策略实盘收益vs回测收益的偏离趋势，实盘收益持续低于回测预期时发出衰减告警",
    },
    {
        "path": "src/zephyr/backtest/services/report_generator.py",
        "exists": False,
        "blueprint_id": "MOD-BT-019",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "回测报告自动生成器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级，当前无报告展示需求",
        "description_cn": "自动生成回测报告(PDF/HTML)，含净值曲线/回撤分析/交易明细/绩效归因",
    },
    {
        "path": "src/zephyr/backtest/services/cache_manager.py",
        "exists": False,
        "blueprint_id": "MOD-BT-020",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "回测缓存管理器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级，当前回测量不大",
        "description_cn": "缓存回测中间结果与最终结果，相同参数组合直接复用避免重复计算",
    },
    {
        "path": "src/zephyr/backtest/services/param_analyzer.py",
        "exists": False,
        "blueprint_id": "MOD-BT-021",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "参数优化结果分析器",
        "can_build": 1,
        "gate_reason": "暂缓：scheduler已含best/worst/mean摘要",
        "description_cn": "分析参数网格搜索结果的参数显著性(t统计量)与过拟合风险(参数敏感性)",
    },
    {
        "path": "src/zephyr/backtest/services/data_quality_checker.py",
        "exists": False,
        "blueprint_id": "MOD-BT-022",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "回测数据质量检查器",
        "can_build": 1,
        "gate_reason": "暂缓：data域已有quality_gate+integrity_checker",
        "description_cn": "回测前检查输入数据质量：缺失日期检测/异常值检测/数据连续性验证",
    },
    {
        "path": "src/zephyr/backtest/services/anomaly_diagnoser.py",
        "exists": False,
        "blueprint_id": "MOD-BT-023",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "回测异常诊断器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级，当前回测失败率低",
        "description_cn": "回测失败时自动诊断错误原因并给出修复建议(数据缺失/参数越界/引擎异常)",
    },
    {
        "path": "src/zephyr/backtest/services/result_comparator.py",
        "exists": False,
        "blueprint_id": "MOD-BT-024",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "回测结果对比器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级，当前无多次对比需求",
        "description_cn": "对比多次回测结果的差异(参数变化/数据更新/策略迭代带来的收益变化)",
    },
    {
        "path": "src/zephyr/backtest/services/result_deployer.py",
        "exists": False,
        "blueprint_id": "MOD-BT-025",
        "domain_id": "D_BACKTEST",
        "granularity": "module",
        "module_name_cn": "回测结果一键部署器",
        "can_build": 0,
    ...
    # D-FACTOR-10 换手率分析器 (1项)
    {
        ...
        "exists": False,
        "blueprint_id": "MOD-L02-001",
        "domain_id": "D_FACTOR",
        "granularity": "directory",
        "module_name_cn": "因子换手率分析器",
        "can_build": 0,
    ...
    {
        "path": "src/zephyr/data/realtime_push_manager/",
        "exists": False,
        "blueprint_id": "MOD-L00-004",
        "domain_id": "D_DATA",
        "granularity": "directory",
        "module_name_cn": "实时行情推送管理器",
        "can_build": 0,
        "gate_reason": "受限：需Kafka/Flink流处理基础设施",
        "description_cn": "管理实时行情数据流(WebSocket/TCP推送)，支持多订阅者+断线重连+数据校验",
    },
    {
        "path": "src/zephyr/data/tick_data_manager/",
        "exists": False,
        "blueprint_id": "MOD-L00-004",
        "domain_id": "D_DATA",
        "granularity": "directory",
        "module_name_cn": "Tick数据管理器",
        "can_build": 0,
    ...
    {
        "path": "src/zephyr/data_eng/services/stream_processing/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "流处理引擎",
        "can_build": 0,
        "gate_reason": "受限：需Kafka/Flink基础设施",
        "description_cn": "实时计算+窗口聚合+事件时间对齐+水位线+背压控制",
    },
    {
        "path": "src/zephyr/data_eng/services/drift_aware_scheduler/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "漂移感知调度器",
        "can_build": 1,
        "gate_reason": "暂缓：P1优先级，需D-AUTONOMY就绪",
        "description_cn": "ADWIN/DDM漂移检测+共形漂移检测+多尺度漂移检测+双层优化",
    },
    {
        "path": "src/zephyr/data_eng/services/training_data_manager/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "训练数据管理器",
        "can_build": 1,
        "gate_reason": "暂缓：P1优先级，需D-ML-TRAIN就绪",
        "description_cn": "训练数据版本管理+质量检查+数据增强+分层采样",
    },
    {
        "path": "src/zephyr/data_eng/services/knowledge_cleaning/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "知识清洗流水线",
        "can_build": 1,
        "gate_reason": "暂缓：P1优先级，需D-KNOWLEDGE就绪",
        "description_cn": "格式转换+去重+去噪+术语标准化+说话人分离+信息价值评分",
    },
    {
        "path": "src/zephyr/data_eng/services/gpu_resource_manager/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "GPU资源管理器",
        "can_build": 1,
        "gate_reason": "暂缓：P1优先级，需GPU硬件",
        "description_cn": "PyTorch CUDA内存分区+时段优先调度+显存预算管理+OOM防护",
    },
    {
        "path": "src/zephyr/data_eng/services/data_lake_manager/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "数据湖管理器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级",
        "description_cn": "分层存储(热/温/冷)+生命周期管理+自动分层迁移",
    },
    {
        "path": "src/zephyr/data_eng/services/data_compression/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "数据压缩归档",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级",
        "description_cn": "冷热分离+自动归档(Parquet/ZSTD压缩)",
    },
    {
        "path": "src/zephyr/data_eng/services/schema_evolution/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "Schema演进管理器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级",
        "description_cn": "Schema演进+兼容性检查(前向/后向)+自动迁移",
    },
    {
        "path": "src/zephyr/data_eng/services/data_replication/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "数据复制同步",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级",
        "description_cn": "跨源同步+一致性保证(CDC/Debezium)",
    },
    {
        "path": "src/zephyr/data_eng/services/data_profiling/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
    ...
    {
        "path": "src/zephyr/data_eng/services/data_catalog/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "数据目录同步",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级",
        "description_cn": "元数据自动采集+搜索(DataHub集成)",
    },
    {
        "path": "src/zephyr/data_eng/services/synthetic_data/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "合成数据生成器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级",
        "description_cn": "SMOTE过采样+轻量GAN生成合成行情数据(仅训练增强)",
    },
    {
        "path": "src/zephyr/data_eng/services/data_product_manager/",
        "exists": False,
        "blueprint_id": "MOD-DATA_ENG",
        "domain_id": "D_DATA_ENG",
        "granularity": "directory",
        "module_name_cn": "数据产品管理器",
        "can_build": 1,
        "gate_reason": "暂缓：P2优先级",
...
def _update_metadata_direct(
    path: str, gate_reason: str, can_build: int, module_name_cn: str, description_cn: str
) -> bool:
...
def _add_design_node(path: str, blueprint_id: str, domain_id: str, build_status: str, granularity: str) -> int:
    """调用 apply_depgraph.add_design_node 新增设计态节点。返回 node_id。"""
    try:
        # 导入 apply_depgraph 的函数
        import apply_depgraph

        node_id = apply_depgraph.add_design_node(path, blueprint_id, domain_id, build_status, granularity=granularity)
        return node_id
    except Exception as e:
...
def main():
    ...
    for i, mod in enumerate(CATEGORY_A, 1):
        ...
        ok = _update_metadata_direct(
            path, mod["gate_reason"], mod["can_build"], mod["module_name_cn"], mod["description_cn"]
        )
        if ok:
            stats["A_updated"] += 1
        else:
    ...
    print(
        f"  Category B (新增节点):    成功={stats['B_added']}  失败={stats['B_failed']}  元数据失败={stats['B_meta_failed']}"
    )

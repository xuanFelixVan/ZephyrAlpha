...
DIR_TO_BLUEPRINT = {
    "src/zephyr/agent-rbac": (
        "MOD-INF-018",
        "docs/03_modules/infrastructure_runtime_integration/agent-rbac/blueprint.md",
    ),
    "src/zephyr/gates": ("MOD-GATE_ENGINE", "docs/03_modules/_cross_layer/gate-engine/blueprint.md"),
    "src/zephyr/gate_engine": ("MOD-GATE_ENGINE", "docs/03_modules/_cross_layer/gate-engine/blueprint.md"),
    "src/zephyr/feedback-loop": ("MOD-FEEDBACK_LOOP", "docs/03_modules/_cross_layer/feedback-loop/blueprint.md"),
    "src/zephyr/kb": ("MOD-KB-001", "docs/03_modules/infrastructure_runtime_integration/knowledge-base/blueprint.md"),
    ...
    "src/zephyr/budget-enforcer": (
        "MOD-INF-024",
        "docs/03_modules/infrastructure_runtime_integration/budget-enforcer/blueprint.md",
    ),
    "src/zephyr/llm-security": ("MOD-LLM_SECURITY", "docs/03_modules/_cross_layer/llm-security/blueprint.md"),
    "src/zephyr/context-engine": ("MOD-CONTEXT_ENGINE", "docs/03_modules/_cross_layer/context-engine/blueprint.md"),
    ...
    "src/zephyr/db": ("MOD-DATABASE", "docs/03_modules/_cross_layer/database/blueprint.md"),
    "src/zephyr/a2a": ("MOD-INF-025", "docs/03_modules/infrastructure_runtime_integration/a2a-protocol/blueprint.md"),
    ...
    "src/zephyr/capacity-assurance": (
        "MOD-INF-001",
        "docs/03_modules/infrastructure_runtime_integration/capacity-assurance/blueprint.md",
    ),
    ...
    "src/zephyr/infrastructure": (
        "MOD-INF-002",
        "docs/03_modules/infrastructure_runtime_integration/governance-automation/blueprint.md",
    ),
    ...
    "src/zephyr/infrastructure_runtime_integration": (
        "MOD-INF-002",
        "docs/03_modules/infrastructure_runtime_integration/governance-automation/blueprint.md",
    ),
    ...
    "tests/agent-rbac": ("MOD-INF-018", "docs/03_modules/infrastructure_runtime_integration/agent-rbac/blueprint.md"),
    "tests/audit-trail": ("MOD-INF-011", "docs/03_modules/_cross_layer/audit-orchestrator/blueprint.md"),
    "tests/budget-enforcer": (
        "MOD-INF-024",
        "docs/03_modules/infrastructure_runtime_integration/budget-enforcer/blueprint.md",
    ),
    "tests/context-engine": ("MOD-CONTEXT_ENGINE", "docs/03_modules/_cross_layer/context-engine/blueprint.md"),
    "tests/feedback-loop": ("MOD-FEEDBACK_LOOP", "docs/03_modules/_cross_layer/feedback-loop/blueprint.md"),
    "tests/gate_engine": ("MOD-GATE_ENGINE", "docs/03_modules/_cross_layer/gate-engine/blueprint.md"),
    "tests/governance": ("DOM-GOV-001", "docs/03_modules/_domain-governance/blueprint.md"),
    "tests/kb": ("MOD-KB-001", "docs/03_modules/infrastructure_runtime_integration/knowledge-base/blueprint.md"),
    "tests/llm-security": ("MOD-LLM_SECURITY", "docs/03_modules/_cross_layer/llm-security/blueprint.md"),
    ...
    "scripts": ("MOD-INF-005", "docs/03_modules/infrastructure_runtime_integration/governance-automation/blueprint.md"),
    "config/capacity": (
        "MOD-INF-001",
        "docs/03_modules/infrastructure_runtime_integration/capacity-assurance/blueprint.md",
    ),
    ...
    "config": ("MOD-INF-002", "docs/03_modules/infrastructure_runtime_integration/governance-automation/blueprint.md"),
    ...
    "data/feedback_proposals": ("MOD-FEEDBACK_LOOP", "docs/03_modules/_cross_layer/feedback-loop/blueprint.md"),
    "data/circadian_tasks": ("MOD-INF-035", "docs/03_modules/_cross_layer/auto-runtime-core/blueprint.md"),
    "data/classified": ("MOD-INF-018", "docs/03_modules/infrastructure_runtime_integration/agent-rbac/blueprint.md"),

# [BLUEPRINT] MOD-INF-005 | scripts/governance/d1_structure/cbg_reset.py | §
#!/usr/bin/env python3
"""
...
----
重置单个熔断器：
    python scripts/governance/cbg_reset.py --caller RI-05 --target L2a

列出所有 OPEN 状态的熔断器：
    python scripts/governance/cbg_reset.py --list
...
try:
    from zephyr.gates.circuit_breaker import CBGManager, CircuitBreakerState

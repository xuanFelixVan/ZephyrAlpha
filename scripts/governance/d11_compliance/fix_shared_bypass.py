...
from _shared.constants import REPO_ROOT, SCRIPTS_DIR, SCAN_EXTENSIONS_CODE
from _shared.walk import iter_files
ensure_utf8_stdout()
import argparse
_EXCLUDE_NAMES = {'__init__.py'}
_SELF_REL = 'scripts/governance/d11_compliance/fix_shared_bypass.py'
_SHARED_SYMBOL_MAP: dict[str, tuple[str, str]] = {'REPO_ROOT': ('_shared.constants', 'REPO_ROOT'), '_REPO_ROOT': ('_shared.constants', 'REPO_ROOT'), 'EXCLUDE_DIRS': ('_shared.constants', 'EXCLUDE_DIRS'), 'SRC_DIR': ('_shared.constants', 'SRC_DIR'), 'CONFIG_DIR': ('_shared.constants', 'CONFIG_DIR'), 'SCRIPTS_DIR': ('_shared.constants', 'SCRIPTS_DIR'), 'MANIFEST_PATH': ('_shared.constants', 'MANIFEST_PATH'), 'SCAN_EXTENSIONS': ('_shared.constants', 'SCAN_EXTENSIONS_CODE'), '_SCAN_EXTENSIONS': ('_shared.constants', 'SCAN_EXTENSIONS_CODE'), 'parse_frontmatter': ('_shared.frontmatter', 'parse_frontmatter'), 'parse_frontmatter_from_file': ('_shared.frontmatter', 'parse_frontmatter_from_file'), 'parse_yaml_header': ('_shared.frontmatter', 'parse_yaml_header'), 'load_yaml': ('_shared.yaml_utils', 'load_yaml'), 'ensure_utf8_stdout': ('_shared.encoding', 'ensure_utf8_stdout'), 'iter_files': ('_shared.walk', 'iter_files')}
...
def main() -> None:
    ...
    print('=' * 72)
    total, violation_count, fix_count = scan_and_fix(args.scan_dir, fix=args.fix, dry_run=args.dry_run, backup=not args.no_backup)
    print()
    print(f'扫描文件: {total}')

...
TRUTH_SOURCE_DIRS = ['docs/02_enterprise_architecture/target-architecture', 'docs/04_construction_plans', 'docs/01_policies_and_standards']
EXEMPT_DOC_TYPES = {'declaration', 'deprecated_marker', 'reference', 'log', 'index', 'adr', 'standard', 'protocol', 'registry'}

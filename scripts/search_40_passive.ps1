...
$patterns = @('Barzykin', 'Hawkes', 'passive impact', 'Passive Market', 'Point Process', 'self-exciting', 'fill probability', 'exponential decay', 'SquareRoot', 'square root', 'Bouchaud', 'Propagator', 'MPC', 'Model Predictive', 'SOR', 'Smart Order', '订单路由')

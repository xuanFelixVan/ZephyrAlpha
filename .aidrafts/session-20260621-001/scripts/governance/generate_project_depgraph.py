...
DOMAIN_NAME_TO_LAYER = {
    # English domain_group values
    "infrastructure": "L0_infrastructure",
    "governance": "L1_foundation",
    "security": "L1_foundation",
    "integration": "L0_infrastructure",
    "data": "L2_domain",
    "intelligence": "L2_domain",
    "observability": "L2_domain",
    "orchestration": "L2_domain",
    "resilience": "L2_domain",
    "testing": "L3_application",
    "simulation": "L2_domain",
    "D-SIMULATION": "L2_domain",
    # Chinese domain_group values (from domains.domain_group)
    "业务": "L2_domain",
    "交易": "L2_domain",
    "平台": "L1_foundation",
    "横切": "L1_foundation",
    "基础设施": "L0_infrastructure",
    "安全": "L1_foundation",
    "治理": "L1_foundation",
}

# Non-src directory → functional domain mapping (D-prefix format)
# These directories are not under src/zephyr/ so they can't be matched by ssot_path
NON_SRC_DOMAIN_MAP = [
    # 39域归并后：D-GOV-* 子域已全部合并入 D-GOVERNANCE（域归并映射报告§2.2）
    ("scripts/governance/repair/", "D-GOVERNANCE", "D-GOVERNANCE-SCRIPT_GOVERNANCE"),
    ("scripts/governance/d5_architecture/", "D-GOVERNANCE", "D-GOVERNANCE-ARCHITECTURE"),
    ("scripts/governance/meta/", "D-GOVERNANCE", "D-GOVERNANCE-METADATA"),
    ("scripts/governance/d3_metadata/", "D-GOVERNANCE", "D-GOVERNANCE-METADATA"),
    ("scripts/governance/", "D-GOVERNANCE", "D-GOVERNANCE-SCRIPT_GOVERNANCE"),
    ("scripts/", "D-GOVERNANCE", "D-GOVERNANCE-SCRIPT_GOVERNANCE"),
    # D-TEST 已删除（域归并映射报告§2.3）→ tests/ 归 D-GOVERNANCE
    ("tests/", "D-GOVERNANCE", "D-GOVERNANCE-CODE_DEDUP"),
    ("docs/03_modules/", "D-GOVERNANCE", "D-GOVERNANCE-REGISTRY_MANAGEMENT"),
    ("docs/01_policies_and_standards/_registry/", "D-GOVERNANCE", "D-GOVERNANCE-REGISTRY_MANAGEMENT"),
    ("docs/01_policies_and_standards/", "D-GOVERNANCE", "D-GOVERNANCE-RULE_ENFORCEMENT"),
    ("docs/02_enterprise_architecture/", "D-GOVERNANCE", "D-GOVERNANCE-REGISTRY_MANAGEMENT"),
    ("docs/", "D-GOVERNANCE", "D-GOVERNANCE-RULE_ENFORCEMENT"),
    ("data/asset_index/", "D-DATA_GOV", "D-DATA_GOV-ASSET_INDEX"),
    ("data/databases/", "D-MKT_DATA", "D-MKT_DATA-PERSISTENCE"),
    # D-INFRA_RUNTIME 已改名 D-INFRASTRUCTURE（P3大域改名）
    ("config/", "D-INFRASTRUCTURE", "D-INFRASTRUCTURE-RUNTIME_INTEGRATION"),
    ("schemas/", "D-GOVERNANCE", "D-GOVERNANCE-REGISTRY_MANAGEMENT"),
]

# Unregistered src/zephyr/ subdirectories → existing 35 functional domains
# These directories exist on disk but have no ssot_path in the panorama.
# Maps to the closest existing subdomain by functional overlap.
UNREGISTERED_SRC_MAP = [
    # autonomy_perm/ → split across 6 existing subdomains
    ("src/zephyr/autonomy_perm/agent-rbac/", "D-SECURITY", "D-SECURITY-ACCESS_CONTROL"),
    ("src/zephyr/autonomy_perm/auto_fix_engine_03/", "D-GOVERNANCE", "D-GOVERNANCE-SCRIPT_GOVERNANCE"),
    ("src/zephyr/autonomy_perm/behavioral-auditor/", "D-GOVERNANCE", "D-GOVERNANCE-DRIFT_DETECTION"),
    ("src/zephyr/autonomy_perm/budget-enforcer/", "D-GOVERNANCE", "D-GOVERNANCE-BUDGET_ENFORCEMENT"),
    ("src/zephyr/autonomy_perm/escalation-engine/", "D-GOVERNANCE", "D-GOVERNANCE-ESCALATION"),
    ("src/zephyr/autonomy_perm/orphan-judge/", "D-GOVERNANCE", "D-GOVERNANCE-ORPHAN_JUDGMENT"),
    ("src/zephyr/autonomy_perm/red-blue-validator/", "D-SECURITY", "D-SECURITY-ADVERSARIAL_VALIDATION"),
    ("src/zephyr/autonomy_perm/", "D-GOVERNANCE", "D-GOVERNANCE-RULE_ENFORCEMENT"),
    # compliance/ → 39域归并后全部归 D-GOVERNANCE（D-GOV-* 子域已合并）
    ("src/zephyr/governance/audit-orchestrator/", "D-GOVERNANCE", "D-GOVERNANCE-AUDIT_ORCHESTRATION"),
    ("src/zephyr/governance/audit-trail/", "D-GOVERNANCE", "D-GOVERNANCE-AUDIT_TRAIL"),
    ("src/zephyr/governance/audit_orchestration/", "D-GOVERNANCE", "D-GOVERNANCE-AUDIT_ORCHESTRATION"),
    ("src/zephyr/governance/audit_orchestrator/", "D-GOVERNANCE", "D-GOVERNANCE-AUDIT_ORCHESTRATOR"),
    ("src/zephyr/governance/audit_trail/", "D-GOVERNANCE", "D-GOVERNANCE-AUDIT_TRAIL"),
    ("src/zephyr/governance/behavioral-admission/", "D-SECURITY", "D-SECURITY-ACCESS_CONTROL"),
    ("src/zephyr/governance/behavioral-auditor/", "D-GOVERNANCE", "D-GOVERNANCE-BEHAVIORAL_AUDITOR"),
    ("src/zephyr/governance/behavioral_auditor/", "D-GOVERNANCE", "D-GOVERNANCE-BEHAVIORAL_AUDITOR"),
    ("src/zephyr/governance/aisg_sandbox.py", "D-GOVERNANCE", "D-GOVERNANCE-AISG_SANDBOX"),
    ("src/zephyr/governance/kb/", "D-GOVERNANCE", "D-GOVERNANCE-KB"),
    ("src/zephyr/governance/rule_enforcement/", "D-GOVERNANCE", "D-GOVERNANCE-RULE_ENGINE"),
    ("src/zephyr/governance/drift_detection/", "D-GOVERNANCE", "D-GOVERNANCE-DRIFT_DETECTION"),
    ("src/zephyr/governance/semantic_audit/", "D-GOVERNANCE", "D-GOVERNANCE-SEMANTIC_AUDIT"),
    ("src/zephyr/governance/semantic-auditor/", "D-GOVERNANCE", "D-GOVERNANCE-SEMANTIC_AUDITOR"),
    ("src/zephyr/governance/compliance_gate_a6/", "D-SECURITY", "D-SECURITY-LLM_DEFENSE"),
    ("src/zephyr/governance/zero_knowledge_audit_stub/", "D-GOVERNANCE", "D-GOVERNANCE-AUDIT_ORCHESTRATION"),
    ("src/zephyr/governance/implementations/", "D-SECURITY", "D-SECURITY-LLM_DEFENSE"),
    ("src/zephyr/governance/", "D-SECURITY", "D-SECURITY-LLM_DEFENSE"),
    # 39域归并后：D-SECURITY-LLM 已合并入 D-SECURITY
    ("src/zephyr/security/llm_defense/", "D-SECURITY", "D-SECURITY-LLM_DEFENSE"),
    # semantic-auditor/ (standalone) → governance/semantic_audit
    ("src/zephyr/semantic-auditor/", "D-GOVERNANCE", "D-GOVERNANCE-SEMANTIC_AUDIT"),
    # Root src/zephyr/ files → explicit mapping (prevent empty domain_id)
    ("src/zephyr/__init__.py", "D-INFRASTRUCTURE", "D-INFRASTRUCTURE-SHARED_SERVICES"),
    ("src/zephyr/service_layer_owners.yaml", "D-GOVERNANCE", "D-GOVERNANCE-REGISTRY_MANAGEMENT"),
    # 39域归并后：D-INTEGRATION-GATEWAY 已合并入 D-INTEGRATION
    ("src/zephyr/integration/behavioral_admission/", "D-INTEGRATION", "D-INTEGRATION-BEHAVIORAL_ADMISSION"),
    ("src/zephyr/integration/vector_memory/", "D-INTEGRATION", "D-INTEGRATION-VECTOR_MEMORY"),
    ("src/zephyr/integration/mcp/", "D-INTEGRATION", "D-INTEGRATION-MCP_SERVERS"),
    ("src/zephyr/integration/model_profiler/", "D-INTEGRATION", "D-INTEGRATION-MODEL_PROFILER"),
    ("src/zephyr/integration/layer2_communication/", "D-INTEGRATION", "D-INTEGRATION-LAYER_COMMUNICATION"),
    ("src/zephyr/integration/local_model/", "D-INTEGRATION", "D-INTEGRATION-RUNTIME_INTEGRATION"),
    ("src/zephyr/integration/layer1_discovery/", "D-INTEGRATION", "D-INTEGRATION-LAYER_DISCOVERY"),
    ("src/zephyr/integration/layer3_coordination/", "D-INTEGRATION", "D-INTEGRATION-LAYER_COORDINATION"),
    # Core shared infrastructure → D-INTEGRATION
    ("src/zephyr/integration/shared_08/", "D-INTEGRATION", "D-INTEGRATION-SHARED_SERVICES"),
    ("src/zephyr/integration/shared/", "D-INTEGRATION", "D-INTEGRATION-SHARED_SERVICES"),
    ("src/zephyr/integration/contracts/", "D-INTEGRATION", "D-INTEGRATION-SHARED_SERVICES"),
    ("src/zephyr/integration/budget_enforcer/", "D-INTEGRATION", "D-INTEGRATION-BUDGET_ENFORCEMENT"),
    ("src/zephyr/integration/", "D-INTEGRATION", "D-INTEGRATION-SHARED_SERVICES"),
    # shared/ → infrastructure/shared_services (bulk) + specific subdomains
    ("src/zephyr/shared/contracts/", "D-SHARED", "D-SHARED-CONTRACTS"),
    ("src/zephyr/shared/lifecycle/", "D-INFRASTRUCTURE", "D-INFRASTRUCTURE-LIFECYCLE_MANAGEMENT"),
    ("src/zephyr/shared/observability/", "D-OPS", "D-OPS-TELEMETRY"),
    ("src/zephyr/shared/", "D-INFRASTRUCTURE", "D-INFRASTRUCTURE-SHARED_SERVICES"),
    # Business-layer directories (L02-L11) → closest existing subdomain by nature
    ("src/zephyr/factor/", "D-INTELLIGENCE", "D-INTELLIGENCE-MODEL_EVALUATION"),
    ("src/zephyr/ex_core/", "D-EX_CORE", "D-EX_CORE-RUNTIME_CORE"),
    ("src/zephyr/risk/", "D-RISK", "D-RISK-BUDGET_ENFORCEMENT"),
    ("src/zephyr/cross_asset/", "D-CROSS_ASSET", "D-CROSS_ASSET-BUDGET_ENFORCEMENT"),
    ("src/zephyr/pf_core/", "D-PF_CORE", "D-PF_CORE-PIPELINE_ROUTING"),
    ("src/zephyr/pf_alloc/", "D-PF_ALLOC", "D-PF_ALLOC-PIPELINE_ROUTING"),
    ("src/zephyr/reporting/", "D-OPS", "D-OPS-FEEDBACK_LOOP"),
    ("src/zephyr/frontend/", "D-FRONTEND", "D-FRONTEND-RUNTIME_INTEGRATION"),
    # Migrated directories (empty shells, re-export from intelligence/)
    ("src/zephyr/ml_serve/", "D-INTELLIGENCE", "D-INTELLIGENCE-MODEL_EVALUATION"),
    ("src/zephyr/ml_train/", "D-INTELLIGENCE", "D-INTELLIGENCE-MODEL_EVALUATION"),
    ("src/zephyr/research/", "D-INTELLIGENCE", "D-INTELLIGENCE-MODEL_EVALUATION"),
    # 39域归并后：D-TRADING-CONTRACTS 已合并入 D-TRADING
    ("src/zephyr/trading/trading_contracts/", "D-TRADING", "D-TRADING-CONTRACTS"),
    # D-INFRA_RUNTIME 已改名 D-INFRASTRUCTURE；infra_runtime/→infrastructure/
    ("src/zephyr/infra_runtime/", "D-INFRASTRUCTURE", "D-INFRASTRUCTURE-RUNTIME_INTEGRATION"),
    ("src/zephyr/infrastructure/", "D-INFRASTRUCTURE", "D-INFRASTRUCTURE-RUNTIME_INTEGRATION"),
    ("src/zephyr/ops/", "D-OPS", "D-OPS-TELEMETRY"),
    ("src/zephyr/autonomy_core/", "D-AUTONOMY_CORE", "D-AUTONOMY_CORE-RUNTIME_ORCHESTRATION"),
    ("src/zephyr/simulation/", "D-SIMULATION", "D-SIMULATION-ENGINE"),
    ("src/zephyr/infra_ops/", "D-INFRA_OPS", "D-INFRA_OPS-DASHBOARD"),
    ("src/zephyr/alternative_data/", "D-ALT_DATA", "D-ALT_DATA-INGESTION"),
    ("src/zephyr/backtest/", "D-BACKTEST", "D-BACKTEST-ENGINE"),
    ("src/zephyr/data_engineering/", "D-DATA_ENG", "D-DATA_ENG-PIPELINE"),
    ("src/zephyr/data_governance/", "D-DATA_GOV", "D-DATA_GOV-QUALITY"),
    ("src/zephyr/data_security/", "D-DATA_SEC", "D-DATA_SEC-MASKING"),
    ("src/zephyr/digital_twin/", "D-DIGITAL_TWIN", "D-DIGITAL_TWIN-SIM"),
    ("src/zephyr/execution_router/", "D-EX_SOR", "D-EX_SOR-ROUTING"),
    ("src/zephyr/execution_simulation/", "D-EXEC_SIM", "D-EXEC_SIM-ENGINE"),
    ("src/zephyr/market_data/", "D-MKT_DATA", "D-MKT_DATA-INGESTION"),
    ("src/zephyr/signal_fundamental/", "D-SIGNAL_FUNDAMENTAL", "D-SIGNAL_FUNDAMENTAL-FACTOR"),
    ("src/zephyr/portfolio_allocation/", "D-PF_ALLOC", "D-PF_ALLOC-OPTIMIZER"),
    ("src/zephyr/execution_core/", "D-EX_CORE", "D-EX_CORE-ENGINE"),
    ("src/zephyr/portfolio_core/", "D-PF_CORE", "D-PF_CORE-OPTIMIZER"),
]
...
def load_panorama():
    ...
    for func_domain_name, func_domain_val in domains_data.items():
        ...
        arch_layer = DOMAIN_NAME_TO_LAYER.get(parent_domain, "")
        if ssot_path:
    ...
    unreg_prefixes = set(prefix for prefix, _, _ in UNREGISTERED_SRC_MAP)
    tree_data = data.get("tree", {})
    _extract_tree_domains(tree_data, "", domain_derivation, domains_data, unreg_prefixes)

    # Add non-src directory mappings
    for entry in NON_SRC_DOMAIN_MAP:
        prefix, did, sid = entry[0], entry[1], entry[2] if len(entry) > 2 else ""
        domain_derivation.append((prefix, did, sid, ""))

    # Build domain_id → domain_group mapping from DB-loaded panorama data
    # (replaces hardcoded domain_to_name dictionary — SSoT: domains table)
    domain_id_to_group = {}
    for did, dval in domains_data.items():
        if isinstance(dval, dict):
            group = dval.get("parent_domain", "")
            if did and group:
                domain_id_to_group[did] = group

    # Add unregistered src/zephyr/ subdirectory mappings
    for prefix, did, sid in UNREGISTERED_SRC_MAP:
        # Derive architecture_layer from domain_id via DB-derived mapping
        parent_name = domain_id_to_group.get(did, "")
        arch_layer = DOMAIN_NAME_TO_LAYER.get(parent_name, "")
...
def _extract_tree_domains(tree_node, current_path, derivation_list, domains_data=None, unreg_prefixes=None):
    """Recursively extract domain_id from panorama tree section.
    Skips paths that have explicit mappings in UNREGISTERED_SRC_MAP.
    """
    ...
    if domain_id and current_path:
        ...
        if not prefix.endswith("/"):
            prefix += "/"
        # Skip if this prefix is covered by an UNREGISTERED_SRC_MAP entry
        if unreg_prefixes and any(prefix.startswith(up) for up in unreg_prefixes):
            pass  # Let UNREGISTERED_SRC_MAP handle this path
        else:
            arch_layer = ""
            # Look up parent_domain from panorama domains section
            if isinstance(domains_data, dict) and domain_id in domains_data:
                parent = domains_data[domain_id].get("parent_domain", "") if isinstance(domains_data[domain_id], dict) else ""
                arch_layer = DOMAIN_NAME_TO_LAYER.get(parent, "")
    ...
    for key, val in tree_node.items():
        ...
        _extract_tree_domains(val, child_path, derivation_list, domains_data, unreg_prefixes)
    ...
    try:
        ...
        try:
            ...
            for (did,) in domain_rows:
                ...
                updated += 1
            conn.commit()
            print(f"  [H7] Synced current_modules for {updated} domains")
        except Exception as e:

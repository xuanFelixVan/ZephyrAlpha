...
# [MODULE] schemas.categories.market.market_daban_board_event
# [DOMAIN] D_DATA
# [DEPENDENCIES] none
...
(
    ...
    st_flag           UInt8 DEFAULT 0             COMMENT 'ST标记(库内stk_limit源直给;其余源按有效幅度推断)',
    ...
    consec_limit      UInt16 DEFAULT 0            COMMENT '连板数(封住日链;未封住=0)',

...
(
    ...
    main_net_inflow          Decimal(18, 2)  COMMENT '主力净流入-净额(元)',
    main_net_inflow_pct      Decimal(18, 4)  COMMENT '主力净流入-净占比(%)',
    super_large_net_inflow   Decimal(18, 2)  COMMENT '超大单净流入-净额(元)',
    super_large_net_inflow_pct Decimal(18, 4)  COMMENT '超大单净流入-净占比(%)',
    large_net_inflow         Decimal(18, 2)  COMMENT '大单净流入-净额(元)',
    large_net_inflow_pct     Decimal(18, 4)  COMMENT '大单净流入-净占比(%)',
    medium_net_inflow        Decimal(18, 2)  COMMENT '中单净流入-净额(元)',
    medium_net_inflow_pct    Decimal(18, 4)  COMMENT '中单净流入-净占比(%)',
    small_net_inflow         Decimal(18, 2)  COMMENT '小单净流入-净额(元)',

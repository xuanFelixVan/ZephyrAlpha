...
# [MODULE] zephyr.semantic_auditor.feedback_self_audit
...
audit_trail.feedback_self_audit — MOD-INF-020 · 反馈自审计
...
class FeedbackSelfAuditor:
    ...
    def detect_self_reinforcement(
        ...
        for event in events:
            ...
            score = event.get("trust_score", event.get("confidence", 0.5))

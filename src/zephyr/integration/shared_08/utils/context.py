...
# [MODULE] zephyr.integration.shared_08.utils.context
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_context | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
# [BLUEPRINT] SRC-163 | docs/03_modules/_cross_layer/shared-core/contracts_blueprint.md
...
在模块 `__init__.py` 或 `<module>.py` 顶部声明：
    ...
    from zephyr.integration.shared_08.contracts.core.runtime_plane_tag import RuntimePlane
...
- 改动本文件枚举值 / 标注协议 → 必须先改 runtime-planes 视图 + KBG-0011 升级 → 再改本文件
- 当前本文件版本 v1.0.0 对齐 runtime-planes v1.0.0 + KBG-0011 v1.0.0
...
激活条件（满足任一即触发 KBG decision 升级本常量到 True）：

...
# [MODULE] zephyr.integration.shared_08.contract_bus
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_contract_bus | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

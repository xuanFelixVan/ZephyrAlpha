...
# [MODULE] zephyr.integration.shared_08.io.streaming_reader
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_streaming_reader | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
# [MODULE] zephyr.integration.shared_08.__version__
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT___version__ | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
...
def check_shared_version(
    ...
    *,
    ...
    用法:
        from zephyr.integration.shared_08.__version__ import check_shared_version

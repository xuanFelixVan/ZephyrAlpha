...
# [MODULE] zephyr.integration.shared_08.lifecycle.hooks
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_hooks | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

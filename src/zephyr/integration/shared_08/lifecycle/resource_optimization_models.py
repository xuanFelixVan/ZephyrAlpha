...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_resource_optimization_models | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
...
class ResourceSnapshot(BaseModel):
    ...
    gpu_percent: ClampedPercent = 0.0
    gpu_memory_used_gb: float = Field(default=0.0, ge=0.0)
    gpu_memory_total_gb: float = Field(default=0.0, ge=0.0)
    gpu_available: bool = Field(default=False)
    ide_ghost_windows: int = Field(default=0, ge=0)

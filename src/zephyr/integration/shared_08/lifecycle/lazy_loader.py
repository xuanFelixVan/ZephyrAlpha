...
# [MODULE] zephyr.integration.shared_08.lifecycle.lazy_loader
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_lazy_loader | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

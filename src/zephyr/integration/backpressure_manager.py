# [A_module] module_id=MOD-ORC_backpressure_manager | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-INF-009 | docs/03_modules/_cross_layer/pipeline/blueprint.md

# [MODULE] zephyr.orchestration.pipeline_routing.backpressure_manager
...
典型流：
  1. L02/L03 检测到队列堆积 → emit PAUSE / THROTTLE
  2. BackpressureManager 记录状态并通知 L00 停止/降速
  3. 超时或下游处理完成 → emit RESUME
  4. BackpressureManager 清除状态并通知 L00 恢复
...
from zephyr.integration.backpressure_types import BackpressureResume
from zephyr.integration.backpressure_types import BackpressureThrottle

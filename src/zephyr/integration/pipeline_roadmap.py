# [A_module] module_id=MOD-ORC_pipeline_roadmap | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-INF-009 | docs/03_modules/_cross_layer/pipeline/blueprint.md

# [MODULE] zephyr.orchestration.pipeline_routing.pipeline_roadmap

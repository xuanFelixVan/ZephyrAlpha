...
--------
  ...
  数据目录   : data/vector_db/
  模型缓存   : data/models/local_model/bge-m3/  +  data/models/local_model/paraphrase-multilingual-MiniLM-L12-v2/
...
# [ALGO_FLOW] external: docs/03_modules/_domain_integration/algo_flow/vector_memory__init__.yaml
"""

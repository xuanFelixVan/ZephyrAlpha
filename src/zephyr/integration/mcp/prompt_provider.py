...
# [MODULE] zephyr.integration.mcp.prompt_provider
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_prompt_provider | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
class PromptProvider:
    ...
    def _register_default_prompts(self) -> None:
        ...
        self.register(
            ...
            description="架构评审模板——DDD 限界上下文 + ADR 兼容性检查",
            arguments=[
    ...
    def _architecture_review_template(self, module_id: str) -> str:
        return (
            ...
            f"Check: DDD bounded context boundaries, ADR recording completeness, "

...
# [MODULE] zephyr.integration.mcp.gate_engine_server
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT_gate_engine_server | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

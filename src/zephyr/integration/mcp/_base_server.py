...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INT__base_server | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
错误码体系
----------
错误码集中定义于 ``zephyr.integration.mcp.error_codes``（MOD-INF-013 §3.4）。

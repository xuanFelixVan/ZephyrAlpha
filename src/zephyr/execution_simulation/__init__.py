...
# [ERROR_CONTRACT] 子模块错误契约见各自文件（AlmgrenChrissError ZA-EXSIM-0001）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_execution_sim/algo_flow/execution_simulation__init__.yaml
"""

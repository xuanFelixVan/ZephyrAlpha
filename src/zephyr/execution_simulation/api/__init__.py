...
# [MODULE] zephyr.execution_simulation.api
# [DOMAIN] D_EXEC_SIM
# [DEPENDENCIES]
# [CONSUMERS]
# [STARTUP] imported
...
#   code: src/zephyr/execution_simulation/api/__init__.py
# 层: 算法
# - id: A1
#   name_zh: ① 包命名空间占位/聚合导出
#   name_en: __init__（模块级 __all__）
#   intro: 声明 zephyr.execution_simulation.api 包命名空间，按 __all__ 声明导出

...
- money_flow 五层净流入实测为**万元口径**（schema COMMENT 标"元"与实值不符：
  08-20 全市场主力净流入合计实值 −128,226=−12.8 亿元量级合理，若按元口径全市场
  仅 −12.8 万元则荒谬；601899 单日 217,595.29→21.76 亿），本模块按 万元→亿
  （÷1e4）换算，配置 yi_unit 可调；

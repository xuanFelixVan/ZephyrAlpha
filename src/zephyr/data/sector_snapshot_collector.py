...
# [STARTUP] manual
# [MATURITY] prototype
# [INVARIANTS] 混合模式采集880xxx板块实时快照（99只推送+584只轮询30秒）写入sector_snapshot表；推送池由sector_ranking_engine.get_push_pool()动态选取；tqcenter SDK需E:\tdx\PYPlugins\user路径；盘前启动盘后停止
# [MODIFY-GUARD] none
# [STABILITY] evolving
# [SAFETY] M

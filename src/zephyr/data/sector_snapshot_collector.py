...
# DDL 真源为 schemas/categories/market/market_sector_snapshot.py（裁定 #ARCH-SSOT-REFERENCE-INTEGRITY-001 Phase F 治本）
...
try:
    from schemas.categories.market.market_sector_snapshot import SECTOR_SNAPSHOT_DDL as SQL_CREATE_TABLE
except ImportError:

...
设计原则（遵循裁定#221，原 ai_first_governance_principles.md §裁定1，文档已删 2026-07-30，git 历史可查）:
...
# [ALGO_FLOW] external: docs/03_modules/_domain_data/algo_flow/capability_validator.yaml
"""

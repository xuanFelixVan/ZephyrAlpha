...
# [MODULE] zephyr.gov_audit.trust_bridge
# [DOMAIN] D_GOV_AUDIT
...
# [TESTS] tests/governance/audit/test_trust_bridge.py
...
#   code: trust_bridge.py
# 层: 算法
# - id: A1
#   name_zh: ① TrustBridge
#   name_en: TrustBridge
#   intro: class TrustBridge 源码 L55-L98
#   desc: 公共方法（定义序）: evaluate, record, get_trend, is_available；源码 L55-L98
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1
...
#   name_en: public defs
#   intro: TrustBridge
#   downstream: audit-orchestrator.bridge; integrity
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1
...
class TrustBridge:
    def __init__(self) -> None:
        ...
        try:
            from zephyr.gov_audit.trust_engine import TrustEngine

...
#   code: corporate_actions.py
# 层: 算法
# - id: A1
#   name_zh: ① CorporateActionPipeline
#   name_en: CorporateActionPipeline
#   intro: class CorporateActionPipeline 源码 L97-L123
#   desc: 公共方法（定义序）: source, validate, transform, apply, verify；源码 L97-L123
#   inputs: 无参数
#   outputs: 返回值

...
# [MODULE] zephyr.gov_audit.self_monitor
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES] zephyr.gov_audit.drift_bridge
...
#   code: self_monitor.py
# 层: 算法
# - id: A1
#   name_zh: ① SelfMonitor
#   name_en: SelfMonitor
#   intro: class SelfMonitor 源码 L59-L96
#   desc: 公共方法（定义序）: increment, set_gauge, snapshot；源码 L59-L96
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

...
# [MODULE] zephyr.gov_audit.dora_metrics
# [DOMAIN] D_GOV_AUDIT
# [DEPENDENCIES]
...
#   code: dora_metrics.py
# 层: 算法
# - id: A1
#   name_zh: ① DORACollector
#   name_en: DORACollector
#   intro: class DORACollector 源码 L64-L132
#   desc: 公共方法（定义序）: df_met, lt_met, cfr, cfr_met, mttr, mttr_met, all_met, record_deployment, record_change, record_in…
#   inputs: 无参数
#   outputs: 返回值

...
# [MODULE] zephyr.gov_audit.bridges.audit_feedback_bridge
# [DOMAIN] D_GOV_AUDIT
# [DEPENDENCIES] zephyr.gov_audit.query; zephyr.gov_audit.anomaly
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] none
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_feedback_bridge_bridge | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

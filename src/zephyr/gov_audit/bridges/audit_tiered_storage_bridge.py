...
# [MODULE] zephyr.gov_audit.bridges.audit_tiered_storage_bridge
# [DOMAIN] D_GOV_AUDIT
# [DEPENDENCIES]
# [CONSUMERS]
# [STARTUP] imported
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_tiered_storage_bridge_bridge | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

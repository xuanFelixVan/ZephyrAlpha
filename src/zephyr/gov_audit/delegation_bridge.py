...
# [MODULE] zephyr.gov_audit.delegation_bridge
# [DOMAIN] D_GOV_AUDIT
...
# [A_module] module_id=MOD-GOV-delegation_bridge | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

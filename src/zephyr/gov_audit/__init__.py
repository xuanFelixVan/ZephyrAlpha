# [A_module] module_id=MOD-GOV-audit_trail | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
...
#   2. 定位模块：本地图按文件名前缀归位，直接 import zephyr.gov_audit.<module>
...
# 与外层 `import zephyr.gov_audit.X` 预获取的 module lock 冲突导致 _DeadlockError。
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_audit/algo_flow/gov_audit__init__.yaml
"""
...
_LAZY_IMPORTS = {
    ...
    "AuditIndexerContract": ("zephyr.gov_audit.contracts", "AuditIndexer"),
    "AuditQueryContract": ("zephyr.gov_audit.contracts", "AuditQuery"),
    "AuditWriterContract": ("zephyr.gov_audit.contracts", "AuditWriter"),
    "DelegationAuditor": ("zephyr.gov_audit.delegation_auditor", "DelegationAuditor"),
    "DelegationBridge": ("zephyr.gov_audit.delegation_bridge", "DelegationBridge"),
    "DriftBridge": ("zephyr.gov_audit.drift_bridge", "DriftBridge"),
    "ExternalToolAuditor": ("zephyr.gov_audit.external_tool_audit", "ExternalToolAuditor"),
    "FeedbackBridge": ("zephyr.gov_audit.feedback_bridge", "FeedbackBridge"),
    "FeedbackPolicy": ("zephyr.gov_audit.feedback_policy", "FeedbackPolicy"),
    "PolicyDecision": ("zephyr.gov_audit.feedback_policy", "PolicyDecision"),
    "GenesisBlock": ("zephyr.gov_audit.genesis", "GenesisBlock"),
    "AuditIndexer": ("zephyr.gov_audit.indexer", "AuditIndexer"),
    "LogRotation": ("zephyr.gov_audit.log_rotation", "LogRotation"),
    "AuditContext": ("zephyr.gov_audit.models", "AuditContext"),
    "AuditIssue": ("zephyr.gov_audit.models", "AuditIssue"),
    "AuditType": ("zephyr.gov_audit.models", "AuditType"),
    "ChangedFile": ("zephyr.gov_audit.models", "ChangedFile"),
    "DiscoveryReport": ("zephyr.gov_audit.models", "DiscoveryReport"),
    "FixLevel": ("zephyr.gov_audit.models", "FixLevel"),
    "GlobalAuditReport": ("zephyr.gov_audit.models", "GlobalAuditReport"),
    "OrchestratorStatus": ("zephyr.gov_audit.models", "OrchestratorStatus"),
    "Priority": ("zephyr.gov_audit.models", "Priority"),
    "Severity": ("zephyr.gov_audit.models", "Severity"),
    "AuditQueryEngine": ("zephyr.gov_audit.query", "AuditQueryEngine"),
    "ReplayEngine": ("zephyr.gov_audit.replay_engine", "ReplayEngine"),
    "PoolStats": ("zephyr.gov_audit.resource_aware_pool", "PoolStats"),
    "ResourceAwarePool": ("zephyr.gov_audit.resource_aware_pool", "ResourceAwarePool"),
    "RetentionPolicy": ("zephyr.gov_audit.retention", "RetentionPolicy"),
    "SelfMonitor": ("zephyr.gov_audit.self_monitor", "SelfMonitor"),
    "TieredStorage": ("zephyr.gov_audit.tiered_storage", "TieredStorage"),
    "TieredStorageBridge": ("zephyr.gov_audit.tiered_storage_bridge", "TieredStorageBridge"),
    "TrustBridge": ("zephyr.gov_audit.trust_bridge", "TrustBridge"),
    "TrustEngine": ("zephyr.gov_audit.trust_engine", "TrustEngine"),
    "TrustLevel": ("zephyr.gov_audit.trust_engine", "TrustLevel"),
    "AuditReportWriter": ("zephyr.gov_audit.writer", "AuditReportWriter"),
    "TextToFindingAdapter": ("zephyr.gov_audit.text_to_finding_adapter", "TextToFindingAdapter"),
    "PipelineRunner": ("zephyr.gov_audit.pipeline_runner", "PipelineRunner"),
    "PipelineResult": ("zephyr.gov_audit.pipeline_runner", "PipelineResult"),
    "DimensionResult": ("zephyr.gov_audit.pipeline_runner", "DimensionResult"),
    "ScriptResult": ("zephyr.gov_audit.pipeline_runner", "ScriptResult"),
    "AuditAdmissionController": ("zephyr.gov_audit.audit_admission_controller", "AuditAdmissionController"),
    "AdmissionResult": ("zephyr.gov_audit.audit_admission_controller", "AdmissionResult"),
    "cli_main": ("zephyr.gov_audit.cli", "main"),
...
# 5.60.9 治本：__all__ 精简为核心 facade（111->14）。其余符号（_LAZY_IMPORTS 全部类名
# + 各子模块）仍可通过显式 import 经 PEP 562 __getattr__ 正常访问，仅 import * 面收敛。
__all__ = [
    "AdmissionResult",

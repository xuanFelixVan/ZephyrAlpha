...
# [TESTS] tests/audit/audit_core/test_audit_orchestrator_e2e.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_audit/algo_flow/pipeline_runner.yaml
"""
...
class PipelineRunner:
    ...
    def __init__(self, scripts_dir: str = "scripts/governance", max_workers: int = 8) -> None:
        ...
        from zephyr.gov_audit.text_to_finding_adapter import TextToFindingAdapter

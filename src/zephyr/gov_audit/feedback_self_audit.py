...
# [MODULE] zephyr.gov_audit.feedback_self_audit
# [DOMAIN] D_GOV_AUDIT
# [DEPENDENCIES]
# [CONSUMERS]
# [STARTUP] imported
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV-feedback_self_audit | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

...
# [TESTS] tests/audit/audit_core/test_audit_full_pipeline_e2e.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_audit/algo_flow/text_to_finding_adapter.yaml
"""

"""
resource_optimization_engine.py - MAPE-K autonomic resource optimization engine
================================================================================

SSoT: MOD-INF-032 resource-optimization-engine/blueprint.md
...
Core capabilities:
  - Pressure state machine with hysteresis (anti-flap)
  - Circuit breaker (CLOSED/OPEN/HALF_OPEN)
  - Dual strategy engine: defensive (emergency) + optimization (proactive)
  - Daemon thread unified scheduling via DaemonRegistry
...
from ..io.io_cache import FileCache
from ..io.streaming_reader import tail_jsonl, stream_jsonl
from ..infra.process_pool import MCPProcessPool

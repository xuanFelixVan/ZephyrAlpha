...
# [TESTS] tests/factor/test_lifecycle_state_machine.py; tests/governance/lifecycle/test_factor_promotion_wiring.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_shared/algo_flow/lifecycle/state_machine.yaml
"""

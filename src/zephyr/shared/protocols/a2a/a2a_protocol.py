...
# [INVARIANTS] no imports from zephyr.infrastructure or zephyr.orchestration; Protocol interfaces only
...
class SecurityContext:
    def __init__(self, agent_id: str = "", permissions: Optional[List[str]] = None, security_level: int = 0):
...
class SecurityResult:
    def __init__(self, decision: Optional[SecurityDecision] = None, violations: Optional[List[str]] = None, metadata: Optional[Dict[str, Any]] = None):
...
class A2ACommunicationProtocol(Protocol):
    ...
    def receive_message(self, a2a_id: str) -> Optional[A2ACommunication]:
        ...

...
# [TESTS] tests/automation/test_auto_split.py; tests/blueprint/test_blueprint_decomposer.py; tests/governance/integration/test_autopilot.py; tests/governance/shared/test_boot_hooks_unlock.py; tests/llm_security/test_db.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 5 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_shared/algo_flow/schema/execution_model.yaml
"""

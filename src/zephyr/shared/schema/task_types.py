...
# [ERROR_CONTRACT]
# [TESTS] tests/infrastructure/test_f3_auto_integration.py; tests/infrastructure/test_f3_extreme.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_shared/algo_flow/schema/task_types.yaml
"""

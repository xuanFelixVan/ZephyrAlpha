...
# [TESTS] tests/gate/test_gate_types.py; tests/governance/integration/test_schema_schemas.py; tests/infrastructure/test_core_models.py; tests/trading/unit/test_schemas_unit.py; tests/utils/test_schemas_shared.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 7 个测试）
...
#   intro: 再导出 BASE_CONFIG, AuditFinding, AuditReport, AuditSeverity, BlockedItem, Circuit…
...
#   intro: KeCategory, FailureType, AuditFinding, AuditReport, KnowledgeEntry, FailurePatt…
#   downstream: gates ; context-engine ; orchestrator ; kb ; runtime ; db ; pipeline ; mcp ; co…
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1
...
class Decision(BaseModel):
    ...
    kb_ref: str | None = Field(default=None, description="Associated KB decision record, e.g. ADR-0030")

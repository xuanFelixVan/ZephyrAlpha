...
# [ERROR_CONTRACT] none
# [TESTS] tests/governance/code_quality/test_evals_unit.py; tests/utils/test_adversarial_shared.py; tests/utils/test_evals_shared.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 3 个测试）
# [A_module] module_id=MOD-GOVERNANCE | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
"""


# [ALGO_FLOW] external: docs/03_modules/_domain_shared/algo_flow/evaluation/evals.yaml
"""

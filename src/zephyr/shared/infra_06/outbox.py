...
# [MODULE] zephyr.infrastructure.shared_services.infra_06.outbox
# [DOMAIN] D-SHARED
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF_outbox | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

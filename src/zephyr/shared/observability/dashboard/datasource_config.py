...
# [MODULE] zephyr.shared.observability.dashboard.datasource_config
# [DOMAIN] D_SHARED
...
# [ALGO_FLOW] external: docs/03_modules/_domain_shared/algo_flow/observability/dashboard/datasource_config.yaml
"""

...
def migrate_task(data: dict[str, Any], to_version: str | None = None) -> dict[str, Any]:
    ...
    用法:
        from zephyr.db.task_repo import get_task_as_dict
        from zephyr.shared.migration import migrate_task

        old_task = get_task_as_dict("T-001")

...
"""Backward-compat shim — canonical location is zephyr.execution.trading.trading_contracts.execution.execution_report."""

import importlib

_TARGET_MODULE = "zephyr.execution.trading.trading_contracts.execution.execution_report"

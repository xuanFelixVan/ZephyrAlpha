...
#   code: runtime_types.py
# 层: 算法
# - id: A1
#   name_zh: ① 包公共面再导出
#   name_en: __init__ re-export
#   intro: 再导出 DATA_DIR, RuntimeConfig（共 2 符号）
...
#   intro: RuntimeConfig
#   downstream: scripts.construction.start_brain;scripts.a2a_full_verification;scripts.construc…
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1
...
class RuntimeConfig(BaseModel):
    ...
    ollama_base_url: str = Field(default=DEFAULT_OLLAMA_URL, description="Ollama API 地址")

...
# [TESTS] tests/governance/access_control/test_approval.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 1 个测试）
# [A_module] module_id=MOD-INF-016 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
"""
G-CT-004 — ApprovalRequest Pydantic V2 BaseModel 审批请求数据结构.

# [ALGO_FLOW] external: docs/03_modules/_domain_shared/algo_flow/contracts/approval_types.yaml
"""

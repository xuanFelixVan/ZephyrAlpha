...
# [ERROR_CONTRACT]
# [TESTS] tests/agent_rbac/test_rbac_core.py; tests/contracts/test_abac_guard_root.py; tests/contracts/test_rbac_guard_root.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 3 个测试）
# [A_module] module_id=MOD-INF-016 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

"""
# [ALGO_FLOW] external: docs/03_modules/_domain_shared/algo_flow/contracts/identity/agent_identity.yaml
"""

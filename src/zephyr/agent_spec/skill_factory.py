...
# [MODULE] zephyr.agent_spec.skill_factory
...
from zephyr.agent_spec.skill_model import SkillTier, SkillType, SkillStatus

_BASE_DIR = Path(__file__).resolve().parent
_SKILLS_DIR = _BASE_DIR / "skills"
_FACTORY_DIR = _SKILLS_DIR / "factory"
_REGISTRY_PATH = _BASE_DIR / "skill_registry.yaml"
...
class SkillFactory:
    ...
    def __init__(self):
        self.template_path = _FACTORY_DIR / "SKILL_TEMPLATE.md"

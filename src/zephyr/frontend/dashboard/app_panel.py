...
⚠️ **DEPRECATED（2026-08-29，Owner 裁定 R22/R23）**：本 Panel 版已被 Web 版取代——
新版正式家=src/zephyr/frontend/dashboard/web/（拆分转正，41 页）。
本文件**保留不删**（Owner 指令：确认新版完全涵盖旧版内容后才可删除），
保留价值=Tick 回放组件实现参考 + 作战室四区骨架 + 回测图表 hover 交互参考。

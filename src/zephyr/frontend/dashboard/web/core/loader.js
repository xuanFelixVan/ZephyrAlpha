...
(function(){
  ...
  .then(function(){
    ...
    return loadJs('core/download.js');   /* 数据下载监管页（表级下载实况 146 表新鲜度四态灯，真源 /api/download-status） */
  }).then(function(){

...
# [ERROR_CONTRACT] TraceViewError(ZA-FE-0015)——store缺失/非法采样率/非法阈值/空trace_id/未知trace/span类型或字段非法/父引用缺失/父链成环时抛
...
class TraceViewError(Exception):
    ...
    错误码 ZA-FE-0015 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-FE-0015"

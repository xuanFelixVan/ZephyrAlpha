...
# [MODULE] zephyr.mcp.doc_guard_server
...
# AI-generated: doc_guard (session_handoff) MCP Server skeleton (ADR-0033, T-3-04)
"""
DocGuardServer: 跨会话交接协议服务 MCP Server
=============================================
Task ID  : T-3-04 (B15)
Server   : session_handoff (tool_contracts.yaml §Server 4)
Protocol : ADR-0033（stdio 传输、JSON-RPC 2.0）
Backend  : HandoffPackage / SessionCarryover + 5 项反腐败校验（ADR-0041）

文件命名说明
-----------
doc_guard_server.py 对应 tool_contracts.yaml 中的 session_handoff server。

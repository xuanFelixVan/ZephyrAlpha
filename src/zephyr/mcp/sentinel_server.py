...
文件命名说明
-----------
sentinel_server.py 对应 tool_contracts.yaml 中的 intent_router server。
...
from zephyr.context_engine.intent_keyword_mapper import IntentDomain
...
class SentinelServer(BaseMCPServer):
    ...
    def _map_intent(
        ...
        if domain == "UNKNOWN" and max_stage >= 2:
            ...
            # TODO(Phase3): 调用 intent_embedding_mapper.py

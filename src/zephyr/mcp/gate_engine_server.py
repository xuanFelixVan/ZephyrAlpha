# AI-generated: gate_engine MCP Server skeleton (ADR-0033, T-3-04)
"""
GateEngineServer: 门禁裁决服务 MCP Server
=========================================
Task ID  : T-3-04 (B15)
Server   : gate_engine (tool_contracts.yaml §Server 3)
...
def _make_gate_run_report(
    ...
    return {
        ...
        "details": {
            ...
            "level_distribution": {"P0": p0_count, "P1": len(failed_checks) - p0_count, "P2": 0},
        },
...
class GateEngineServer(BaseMCPServer):
    ...
    def _run_g1_write(
        ...
        passed = len([f for f in failed if f.startswith("P0")]) == 0

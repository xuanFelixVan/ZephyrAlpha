...
# [MODULE] zephyr.mcp.gateway_server
...
from zephyr.mcp.audit_logger import AuditLogger, create_audit_logger
from zephyr.mcp.rate_limiter import (
    RATE_LIMITED_KEY,
    PerToolRateLimiter,
    RateLimiterStats,
)
...
class MCPGateway(BaseMCPServer):
    ...
    def _init_server_handlers(self) -> None:
        ...
        try:
            ...
            _log.warning("vector_memory server init failed: %s", exc)

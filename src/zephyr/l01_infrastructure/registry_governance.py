# [BLUEPRINT] MOD-INF-037 | 03_modules/l01_infrastructure/registry-governance/blueprint.md | §3

# [MODULE] zephyr.l01_infrastructure.registry_governance

# [INVARIANTS] 功能域注册表是功能域声明的唯一真源;SSoT门禁检查不可跳过;注册表不可被AI直接修改

# [MODIFY-GUARD] docs/03_modules/l01_infrastructure/registry-governance/blueprint.md;docs/01_policies_and_standards/_registry/catalogs/functional-domain-registry.yaml
        ...
        try:
            ...
            for e in entries_raw:
                self._entries.append(DomainEntry(
                    ...
                    stability=e.get("stability", "evolving"),
                    ai_autonomy=e.get("ai_autonomy", "human_gated"),
                ))
            self._loaded = True

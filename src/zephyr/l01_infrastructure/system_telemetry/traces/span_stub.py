...
# [MODULE] zephyr.l01_infrastructure.system_telemetry.traces.span_stub
...
# [CONSUMERS] src/zephyr/system_telemetry/facade.py;src/zephyr/system_telemetry/logs/structured_sink.py
...
def _flush_span(span: Span) -> None:
    try:
        from zephyr.l01_infrastructure.system_telemetry._trace_bridge import write_record
...
from zephyr.l01_infrastructure.system_telemetry._trace_bridge import set_span_context_getter

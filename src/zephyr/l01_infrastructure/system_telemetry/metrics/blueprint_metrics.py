...
# [MODULE] zephyr.l01_infrastructure.system_telemetry.metrics.blueprint_metrics
...
# [CONSUMERS] src/zephyr/system_telemetry/facade.py;src/zephyr/system_telemetry/auto_bootstrap.py

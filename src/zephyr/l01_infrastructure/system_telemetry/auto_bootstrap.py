...
# [MODULE] zephyr.l01_infrastructure.system_telemetry.auto_bootstrap
...
# [CONSUMERS] zephyr.runtime; zephyr.agent_spec
...
# [TESTS] tests/system_telemetry/test_auto_bootstrap.py
...
def _patch_phase_manager() -> bool:
    ...
    try:
        from zephyr.rollback.phase_manager import PhaseGate
...
from zephyr.l01_infrastructure.system_telemetry._budget_telemetry_bridge import set_telemetry_getter

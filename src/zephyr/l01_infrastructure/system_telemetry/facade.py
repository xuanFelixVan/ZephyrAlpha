...
# [MODULE] zephyr.l01_infrastructure.system_telemetry.facade
...
# [CONSUMERS] auto_bootstrap.py; zephyr.agent_rbac; zephyr.budget_enforcer
...
# [TESTS] tests/system_telemetry/test_facade.py
...
from zephyr.l01_infrastructure.system_telemetry.alerts import AlertSubsystem
...
class TracesFacade:
    ...
    def span(self, operation_name: str) -> _Span:
        ...
        try:
            from zephyr.l01_infrastructure.system_telemetry.traces.span_stub import noop_span
...
class ArchiveFacade:
    ...
    def next_batch_id(self, prefix: str = "arc") -> str:
        ...
        try:
            from zephyr.l01_infrastructure.system_telemetry.archive.cold_stub import next_archive_batch_id
...
class Telemetry:
    ...
    def __init__(self, module_id: str, environment: str = "dev", test_mode: bool = False):
        ...
        from zephyr.l01_infrastructure.system_telemetry.health_aggregator import HealthAggregator
        self._health_aggregator = HealthAggregator()

        from zephyr.l01_infrastructure.system_telemetry.watchdog import Watchdog
    ...
    def _run_scheduled_task(self, task: str) -> None:
        if task == "flush":
            ...
            try:
                from zephyr.l01_infrastructure.system_telemetry.archive import rotate_by_ttl, daily_backup_sqlite
                rotate_by_ttl()
                daily_backup_sqlite()
            except Exception:

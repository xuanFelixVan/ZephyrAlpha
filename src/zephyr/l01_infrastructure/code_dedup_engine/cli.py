# [BLUEPRINT] MOD-INF-017 | 03_modules/l01_infrastructure/code-dedup-engine/blueprint.md | §4

# [MODULE] zephyr.l01_infrastructure.code_dedup_engine.cli
...
def _cmd_verify(args: argparse.Namespace) -> None:
    ...
    try:
        import sys as _sys
        _pkg = _sys.modules.get("zephyr.l01_infrastructure.code_dedup_engine")
...
def _cmd_benchmark(args: argparse.Namespace) -> None:
    ...
    from zephyr.l01_infrastructure.code_dedup_engine.self_benchmark import SelfBenchmark
    bench = SelfBenchmark()

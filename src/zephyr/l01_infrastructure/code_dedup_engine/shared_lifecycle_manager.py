...
# [MODULE] zephyr.l01_infrastructure.code_dedup_engine.shared_lifecycle_manager
...
class SharedLifecycleManager:
    ...
    def __init__(self, lifecycle_path: str | Path | None = None) -> None:
        if lifecycle_path is None:
            lifecycle_path = Path("data/cache/shared_lifecycle.yaml")

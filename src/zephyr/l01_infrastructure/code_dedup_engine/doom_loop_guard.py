...
# [MODULE] zephyr.l01_infrastructure.code_dedup_engine.doom_loop_guard
...
职责：
  ...
  - 冻结列表 doom_loop_freeze_list.json 维护
...
class DoomLoopGuard:
    ...
    def __init__(self, freeze_path: str | Path | None = None) -> None:
        if freeze_path is None:
            freeze_path = Path("data/cache/doom_loop_freeze_list.json")

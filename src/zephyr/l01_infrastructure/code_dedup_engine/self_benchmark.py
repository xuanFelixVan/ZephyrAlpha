# [BLUEPRINT] MOD-INF-017 | 03_modules/l01_infrastructure/code-dedup-engine/blueprint.md | §W3-7

# [MODULE] zephyr.l01_infrastructure.code_dedup_engine.self_benchmark
...
from zephyr.l01_infrastructure.code_dedup_engine.signature_matcher import SignatureMatcher
from zephyr.l01_infrastructure.code_dedup_engine.ast_comparator import ASTComparator
from zephyr.l01_infrastructure.code_dedup_engine.behavioral_sampler import BehavioralSampler
from zephyr.l01_infrastructure.code_dedup_engine.micro_clone_detector import MicroCloneDetector
...
class SelfBenchmark:
    ...
    _HISTORY_FILE = Path("data/code_dedup_benchmark_history.json")

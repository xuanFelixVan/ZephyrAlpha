...
#   intro: 再导出 ALL_EXAM_CASES, CASES_BY_CAPABILITY, BreadthResult, CapabilityPassport, Dep…
#   desc: __init__ import L59；__all__ 17 项（AST 事实）
#   inputs: I1
...
#   name_en: __all__
#   intro: ALL_EXAM_CASES, CASES_BY_CAPABILITY, BreadthResult, CapabilityPassport, DepthCa…

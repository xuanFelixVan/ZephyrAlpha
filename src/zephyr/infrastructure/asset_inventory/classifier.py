...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF-classifier | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
TYPE_MAPPING: list[tuple[str, list[str], AssetType]] = [
    ("src/zephyr/gov_enforcement/rule_enforcement/", [".yaml"], AssetType.GATE),

# [A_module] module_id=MOD-INF-adaptation | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
...
# [ALGO_FLOW] external: docs/03_modules/_domain_infrastructure/algo_flow/adaptation/adaptation__init__.yaml
"""

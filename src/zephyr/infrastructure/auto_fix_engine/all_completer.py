...
# [TESTS] tests/fix/test_all_completer.py
...
#   code: all_completer.py
# 层: 算法
# - id: A1
#   name_zh: ① AllCompleter
#   name_en: AllCompleter
#   intro: class AllCompleter 源码 L70-L229
#   desc: 公共方法（定义序）: parse_all, extract_public_symbols, scan, fix, validate, rollback；源码 L70-L229
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

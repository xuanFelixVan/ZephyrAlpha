...
# [TESTS] tests/fix/test_import_fixer.py
...
#   code: import_fixer.py
# 层: 算法
# - id: A1
#   name_zh: ① ImportFixer
#   name_en: ImportFixer
#   intro: class ImportFixer 源码 L133-L259
#   desc: 公共方法（定义序）: try_fix_module, scan, fix, validate, rollback；源码 L133-L259
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

...
#   code: llm_fix_adapter.py
# 层: 算法
# - id: A1
#   name_zh: ① LLMFixAdapter
#   name_en: LLMFixAdapter
#   intro: class LLMFixAdapter 源码 L69-L223
#   desc: 公共方法（定义序）: secret_guard, llm_bridge, call_llm, build_fix_prompt, scan, fix, validate, rollback；源码 L69-L223
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1
...
#   name_en: public defs
#   intro: LLMFixAdapter
#   downstream: engine.py;MOD-INF-028(semantic-auditor)
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

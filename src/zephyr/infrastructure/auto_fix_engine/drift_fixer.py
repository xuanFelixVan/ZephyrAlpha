...
# [TESTS] tests/drift/test_drift_fixer.py
...
#   name_zh: ① DriftFixer
#   name_en: DriftFixer
#   intro: class DriftFixer 源码 L69-L194
#   desc: 公共方法（定义序）: scan, fix, validate, rollback；源码 L69-L194
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1
...
#   name_en: public defs
#   intro: DriftFixer
#   downstream: engine.py;MOD-INF-023(drift-detector);MOD-INF-021(rollback)
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

...
# [TESTS] tests/llm_security/test_zombie_cleaner.py
...
#   code: zombie_cleaner.py
# 层: 算法
# - id: A1
#   name_zh: ① ZombieCleaner
#   name_en: ZombieCleaner
#   intro: class ZombieCleaner 源码 L113-L208
#   desc: 公共方法（定义序）: scan, fix, validate, rollback；源码 L113-L208
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1
...
#   name_en: public defs
#   intro: ZombieCleaner
#   downstream: engine.py;MOD-INF-026(asset-inventory)
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

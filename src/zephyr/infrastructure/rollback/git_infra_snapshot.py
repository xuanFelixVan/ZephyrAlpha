...
#   code: git_infra_snapshot.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① GitInfraSnapshot
#   name_en: GitInfraSnapshot
#   intro: class GitInfraSnapshot 源码 L72-L189
#   desc: 公共方法（定义序）: project_root, snapshot_dir, create_snapshot, check_integrity, restore_from_snapshot；源码 L72-L189
#   inputs: project_root
#   outputs: 返回值

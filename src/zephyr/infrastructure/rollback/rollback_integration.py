...
#   code: rollback_integration.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① RollbackIntegration
#   name_en: RollbackIntegration
#   intro: class RollbackIntegration 源码 L155-L562
#   desc: 公共方法（定义序）: last_checkpoint_time, notify_state, project_root, three_way_merge, acl_check_to_target, scan_promp…
#   inputs: project_root
#   outputs: 返回值

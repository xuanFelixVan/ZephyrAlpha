...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF-semantic_similar_detector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
class SemanticSimilarDetector:
    ...
    def parse_safe(self, source) -> ast.AST | None:

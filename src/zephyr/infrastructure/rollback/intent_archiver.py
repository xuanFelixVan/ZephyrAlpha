...
#   code: intent_archiver.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① IntentArchiver
#   name_en: IntentArchiver
#   intro: class IntentArchiver 源码 L81-L227
#   desc: 公共方法（定义序）: archive_dir, manifest_path, project_root, archive, verify_integrity, get_intent；源码 L81-L227
#   inputs: project_root
#   outputs: 返回值

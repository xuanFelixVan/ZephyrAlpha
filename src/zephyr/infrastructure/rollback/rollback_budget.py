...
#   code: rollback_budget.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① RollbackBudget
#   name_en: RollbackBudget
#   intro: class RollbackBudget 源码 L85-L212
#   desc: 公共方法（定义序）: project_root, status, consume, release, concurrent_count；源码 L85-L212
#   inputs: project_root
#   outputs: 返回值

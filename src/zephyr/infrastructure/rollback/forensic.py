...
#   code: forensic.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① ForensicEngine
#   name_en: ForensicEngine
#   intro: class ForensicEngine 源码 L191-L761
#   desc: 公共方法（定义序）: forensic_dir, project_root, scan_shell_injection, is_shell_injection_safe, record_file_hashes, ntp…
#   inputs: project_root
#   outputs: 返回值

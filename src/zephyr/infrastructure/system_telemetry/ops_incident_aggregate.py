...
# [ERROR_CONTRACT] OpsIncidentError(ZA-OPS-0003)——空id/空标题/非法分级/重复检测/未知incident/非法状态迁移/非法升级时抛
...
class OpsIncidentError(Exception):
    ...
    错误码 ZA-OPS-0003 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-OPS-0003"

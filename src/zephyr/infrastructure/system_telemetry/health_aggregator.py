...
# [TESTS] tests/observability/test_health_aggregator_root.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_infrastructure/algo_flow/system_telemetry/health_aggregator.yaml
"""

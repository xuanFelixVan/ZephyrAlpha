...
# [MODULE] zephyr.infrastructure.pipeline.layer_consumer_registry
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF_layer_consumer_registry | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

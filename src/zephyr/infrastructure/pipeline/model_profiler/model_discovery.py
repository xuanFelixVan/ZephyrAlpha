# [A_module] module_id=MOD-INF_model_discovery | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-INF-034 | docs/03_modules/_cross_layer/model-profiler/blueprint.md | §

# [MODULE] zephyr.intelligence.model_profiling.pipeline.model_discovery
...
class ModelDiscovery:
    ...
    def discover_remote(self) -> list[DiscoveredModel]:
        ...
        from zephyr.governance.model_provider_data import (
            DEFAULT_PROVIDERS,
            TIER_MODEL_MAP,
        )

...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF-pipeline_roadmap | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
CROSS_MODULE_SYNC: list[CrossModuleSyncEntry] = [
    ...
    CrossModuleSyncEntry(
        file_path="src/zephyr/orchestrator/execution/trigger_router.py",  # 路径迁移: trading/orchestrator -> orchestrator/

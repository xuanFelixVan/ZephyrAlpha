...
# [MODULE] zephyr.infrastructure.sentinel_server
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF_sentinel_server | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

# AI-generated: sentinel (intent_router) MCP Server skeleton ( T-3-04)
"""
...
class SentinelServer(BaseMCPServer):
    ...
    def __init__(self, *, enable_rbac: bool = True) -> None:
        ...
        self._golden_set: list[dict[str, Any]] = [
            ...
            {"query": "查看 KB 决策记录 KBG-011 治理规则", "expected_domain": "D2"},

...
#   code: context_guard.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① ContextGuard
#   name_en: ContextGuard
#   intro: class ContextGuard 源码 L82-L165
#   desc: 公共方法（定义序）: project_root, validate_access, check_forbidden；源码 L82-L165
#   inputs: project_root
#   outputs: 返回值

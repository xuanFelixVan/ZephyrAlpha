...
from zephyr.infrastructure.db.base_repo import (
...
from zephyr.shared.contracts.gate import GateResult, GateViolationError  # noqa: E402
...
class TransitionMixin:
    ...
    def transition(
        ...
        *,
        ...
        from zephyr.infrastructure.hooks.event_hook import hook_registry, TransitionEvent

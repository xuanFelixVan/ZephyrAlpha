...
#   code: a2a_hardware_router.py
# 层: 算法
# - id: A1
#   name_zh: ① A2AHardwareRouter
#   name_en: A2AHardwareRouter
#   intro: class A2AHardwareRouter 源码 L65-L70
#   desc: 公共方法（定义序）: route；源码 L65-L70
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

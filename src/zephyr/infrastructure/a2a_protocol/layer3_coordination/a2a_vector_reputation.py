...
#   code: a2a_vector_reputation.py
# 层: 算法
# - id: A1
#   name_zh: ① A2AVectorReputation
#   name_en: A2AVectorReputation
#   intro: class A2AVectorReputation 源码 L65-L78
#   desc: 公共方法（定义序）: rate, reputation；源码 L65-L78
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

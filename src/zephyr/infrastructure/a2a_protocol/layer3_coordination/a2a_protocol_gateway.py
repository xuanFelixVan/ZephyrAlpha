...
#   code: a2a_protocol_gateway.py
# 层: 算法
# - id: A1
#   name_zh: ① A2AProtocolGateway
#   name_en: A2AProtocolGateway
#   intro: class A2AProtocolGateway 源码 L72-L112
#   desc: 公共方法（定义序）: register, resolve, route, list_routes；源码 L72-L112
#   inputs: 无参数
#   outputs: 返回值

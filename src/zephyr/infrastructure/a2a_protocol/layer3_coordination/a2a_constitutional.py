...
#   code: a2a_constitutional.py
# 层: 算法
# - id: A1
#   name_zh: ① A2AConstitutional
#   name_en: A2AConstitutional
#   intro: class A2AConstitutional 源码 L65-L78
#   desc: 公共方法（定义序）: can_veto, veto；源码 L65-L78
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

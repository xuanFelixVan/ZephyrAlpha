...
# [MODULE] zephyr.infrastructure.sandbox_server
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF_sandbox_server | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

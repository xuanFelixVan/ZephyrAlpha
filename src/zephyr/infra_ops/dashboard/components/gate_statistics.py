...
# [MODULE] zephyr.infra_ops.dashboard.components.gate_statistics
# [DOMAIN] D_INFRA_OPS
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-INF_gate_statistics | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

...
# 层: 算法
# - id: A1
#   name_zh: ① RedBlueValidator
#   name_en: RedBlueValidator
#   intro: class RedBlueValidator 源码 L85-L296
#   desc: 公共方法（定义序）: blast, loader, cleanup, steady, load_and_filter, defense, run_adversarial_session, process_scenari…
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: RedBlueValidator
#   downstream: cli.py; game_day_runner.py; mcp_endpoints.py
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

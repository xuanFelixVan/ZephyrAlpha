...
#   code: steady_state.py
# 层: 算法
# - id: A1
#   name_zh: ① SteadyState
#   name_en: SteadyState
#   intro: class SteadyState 源码 L119-L328
#   desc: 公共方法（定义序）: compute_drift, snapshot_after, snapshot_before, import_time, evaluate_metric, verify_before_attack…
#   inputs: 无参数
#   outputs: 返回值

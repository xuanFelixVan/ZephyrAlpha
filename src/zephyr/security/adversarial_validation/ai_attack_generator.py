...
#   code: ai_attack_generator.py
# 层: 算法
# - id: A1
#   name_zh: ① AIAttackGenerator
#   name_en: AIAttackGenerator
#   intro: class AIAttackGenerator 源码 L99-L206
#   desc: 公共方法（定义序）: generate_from_bypasses, generate_from_known_patterns, generated_scenarios；源码 L99-L206
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: AIAttackGenerator
#   downstream: game_day_runner.py; cold_start.py
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

...
#   code: safety_fence.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① SafetyFence
#   name_en: SafetyFence
#   intro: 安全围栏——阻止删除 frozen/immutable_core 文件。
#   desc: 安全围栏——阻止删除 frozen/immutable_core 文件。 解析文件头部的 [STABILITY] 和 [AI_AUTONOMY] 标签， frozen 或 imm…；公共方法（定义序）: is_dele…
#   inputs: project_root
#   outputs: 返回值

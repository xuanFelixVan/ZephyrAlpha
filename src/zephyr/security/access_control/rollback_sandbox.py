...
#   code: rollback_sandbox.py
# 层: 算法
# - id: A1
#   name_zh: ① RollbackSandbox
#   name_en: RollbackSandbox
#   intro: class RollbackSandbox 源码 L69-L104
#   desc: 公共方法（定义序）: operations, isolate, execute, rollback；源码 L69-L104
#   inputs: 无参数
#   outputs: 返回值

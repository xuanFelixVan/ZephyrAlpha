...
#   code: risk_mitigation.py
# 层: 算法
# - id: A1
#   name_zh: ① RiskMitigation
#   name_en: RiskMitigation
#   intro: 风险缓解 — 静态评估与策略手册.
#   desc: 风险缓解 — 静态评估与策略手册.；公共方法（定义序）: assess, get_mitigation_playbook；源码 L77-L152
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: RiskMitigation
#   downstream: tests/agent_rbac/test_risk_mitigation_agent_rbac.py
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

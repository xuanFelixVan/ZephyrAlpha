...
#   code: canary_rollout_manager.py
# 层: 算法
# - id: A1
#   name_zh: ① CanaryRolloutManager
#   name_en: CanaryRolloutManager
#   intro: 灰度发布管理器 — 注册与控制灰度权限.
#   desc: 灰度发布管理器 — 注册与控制灰度权限.；公共方法（定义序）: canaries, register, start_sampling；源码 L82-L129
#   inputs: 无参数
#   outputs: 返回值

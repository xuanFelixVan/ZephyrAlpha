...
#   code: false_completion_detector.py
# 层: 算法
# - id: A1
#   name_zh: ① FalseCompletionDetector
#   name_en: FalseCompletionDetector
#   intro: 虚假完成检测器.
#   desc: 虚假完成检测器.；公共方法（定义序）: record_claim, check_false_completion；源码 L68-L124
#   inputs: 无参数
#   outputs: 返回值

...
class ShadowResult(BaseModel):
    ...
    type_result: object | None = None
    lint_result: object | None = None
    error: str = ""
    shadow_dir: str = ""
...
def __getattr__(name: str):
    if name in _FROZEN_PUBLIC_API:
        ...
        logging.getLogger("zephyr.stability_guard").warning(
            "STABILITY VIOLATION: Public API attribute '%s' removed from frozen module zephyr.security.access_control.auto_fix_engine_03.models",
            name,
        )

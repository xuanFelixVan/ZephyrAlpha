...
#   code: alignment_scorer.py
# 层: 算法
# - id: A1
#   name_zh: ① AlignmentScorer
#   name_en: AlignmentScorer
#   intro: Inject 后 ContextBlock vs TaskCard embedding cosine < 0.
#   desc: Inject 后 ContextBlock vs TaskCard embedding cosine < 0.7 -> rebuild (DD85).；公共方法（定义序）: score；源码 L59-L66
#   inputs: 无参数
#   outputs: 返回值

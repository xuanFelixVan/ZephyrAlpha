...
class AuditResult:
    ...
    def __init__(self, component_id: str = "", passed: bool = True, findings: Optional[List[str]] = None, severity: str = "low"):
...
class ScanResult:
    ...
    def __init__(self, scan_type: str = "", threats: Optional[List[str]] = None, passed: bool = True):
...
class SlopsquattingResult:
    ...
    def __init__(self, package_name: str = "", is_malicious: bool = False, confidence: float = 0.0, details: Optional[Dict[str, Any]] = None):

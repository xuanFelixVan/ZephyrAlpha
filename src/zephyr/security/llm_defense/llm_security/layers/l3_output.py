...
class HallucinationResult:
    ...
    def __init__(
        self, detected: bool = False, confidence: float = 0.0, category: str = "", details: dict[str, Any] | None = None
    ):
...
class SandboxResult:
    ...
    def __init__(self, safe: bool = True, violations: list[str] | None = None, sanitized_output: str = ""):
        self.safe = safe
...
class SafetyResult:
    ...
    def __init__(self, passed: bool = True, risk_level: str = "low", violations: list[str] | None = None):
        self.passed = passed
...
class SchemaResult:
    ...
    def __init__(self, valid: bool = True, schema_compliant: bool = True, errors: list[str] | None = None):
        self.valid = valid

...
# [ERROR_CONTRACT] SpectralGuardError(ZA-SECLLM-0001)——未注册模型/非方阵/空矩阵/负值或非有限元素/非法阈值表时抛
...
# [ALGO_FLOW] external: docs/03_modules/_domain_security/algo_flow/llm_defense/spectral_guard.yaml
"""
...
class SpectralGuardError(Exception):
    ...
    错误码 ZA-SECLLM-0001 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-SECLLM-0001"

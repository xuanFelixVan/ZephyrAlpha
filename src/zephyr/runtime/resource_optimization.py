...
# [MODULE] zephyr.runtime.resource_optimization
...
Canonical location is now zephyr.runtime.resource_optimization.
...
from zephyr.shared.lifecycle.daemon_registry import DaemonRegistry, PressureLevel as LegacyPressureLevel
...
class ResourceOptimizationEngine:
    ...
    def _emit_pressure_event(self, snap: ResourceSnapshot) -> None:
        ...
        try:
            from zephyr.shared.event_bus import get_bus
            bus = get_bus()
            bus.emit(

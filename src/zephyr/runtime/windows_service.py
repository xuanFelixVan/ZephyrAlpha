...
# [MODULE] zephyr.runtime.windows_service
...
注册方式:
  sc create ZephyrAlpha binPath= "python -m zephyr.runtime"
...
def install_service() -> None:
    ...
    bin_path = f'"{python_exe}" -m zephyr.runtime'
    subprocess.run(
...
def run_as_service() -> None:
    try:
        ...
        from zephyr.runtime.__main__ import main
        main()
        return

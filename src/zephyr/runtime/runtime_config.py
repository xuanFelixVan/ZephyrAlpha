...
# [MODULE] zephyr.runtime.runtime_config
...
"""
RuntimeConfig — AutoRuntime Core 配置模型
==========================================
蓝图: ARC-0001 §6.1
"""
...
class RuntimeConfig(BaseModel):
    ...
    circadian_state_path: Path = Field(default=DATA_DIR / "circadian_tasks" / "schedule_state.json", description="生物钟状态路径")
    ...
    def ensure_dirs(self) -> None:
        for d in [
            ...
            self.circadian_state_path.parent,
        ]:

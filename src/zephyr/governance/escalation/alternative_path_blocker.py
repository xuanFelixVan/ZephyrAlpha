...
# [TESTS] tests/governance/escalation/test_alternative_path_blocker.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/escalation/alternative_path_blocker.yaml
"""

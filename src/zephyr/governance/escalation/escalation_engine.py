...
# [MODULE] zephyr.governance.escalation_engine
# [DOMAIN] D_GOVERNANCE
...
class EscalationEngine:
    ...
    def _load_extension_detectors(self):
        detector_modules = [
            ("zephyr.governance.persuasion_detector", "PersuasionDetector"),
            ("zephyr.governance.deadlock_detector", "DeadlockDetector"),
            ("zephyr.governance.drift_detector", "DriftDetector"),
            ("zephyr.governance.escalation_loop_detector", "EscalationLoopDetector"),
            ("zephyr.governance.engine_sandbox", "EngineSandbox"),
            ("zephyr.governance.confidence_estimator", "ConfidenceEstimator"),
            ("zephyr.governance.vigil_runtime", "VigilRuntime"),
            ("zephyr.governance.formal_verifier", "FormalVerifier"),
            ("zephyr.governance.provider_failover", "ProviderFailover"),
            ("zephyr.governance.credential_guard", "CredentialGuard"),
            ("zephyr.governance.merkle_audit", "MerkleAudit"),
            ("zephyr.governance.sbom_guard", "SBOMGuard"),
            ("zephyr.governance.clock_guard", "ClockGuard"),
            ("zephyr.governance.command_chain_length_gate", "CommandChainGate"),
            ("zephyr.governance.compositional_safety_tester", "CompositionalSafetyTester"),
            ("zephyr.governance.anti_automation_bias", "AntiAutomationBias"),
            ("zephyr.governance.slo_contract", "SLOContractEngine"),
            ("zephyr.governance.reward_hacking_rebound_detector", "ReboundDetector"),
        ]

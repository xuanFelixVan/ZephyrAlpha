...
# [TESTS] tests/governance/audit/test_gap_analyzer.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/architecture_governance/gap_analyzer.yaml
"""

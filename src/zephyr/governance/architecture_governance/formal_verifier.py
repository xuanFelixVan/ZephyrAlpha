...
# [TESTS] tests/governance/code_quality/test_formal_verifier.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/architecture_governance/formal_verifier.yaml
"""

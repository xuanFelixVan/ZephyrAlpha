...
# [TESTS] tests/blueprint/test_blueprint_bloat_monitor.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/architecture_governance/blueprint_bloat_monitor.yaml
"""

...
# [MODULE] zephyr.governance.code_dedup.canary_manager
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK_canary_manager | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

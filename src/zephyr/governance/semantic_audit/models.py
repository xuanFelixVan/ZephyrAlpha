...
# [TESTS] tests/semantic_auditor/test_blast_radius.py; tests/semantic_auditor/test_blast_radius_red_team.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
#   intro: 再导出 AlignmentReport, ExtractedReferences, HealResult, LLMFixResult, SafetyDecis…
...
#   intro: Severity, SafetyDecision, TriggerResult, TriggerDecision, ExtractedReferences,…
#   downstream: trigger_engine;fix_prioritizer;llm_bridge;reference_extractor;safety_boundary;a…
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

...
#   code: confidence_quantifier.py
# 层: 算法
# - id: A1
#   name_zh: ① ConfidenceQuantifier
#   name_en: ConfidenceQuantifier
#   intro: class ConfidenceQuantifier 源码 L77-L163
#   desc: 公共方法（定义序）: consecutive_low, determine_tier, record, average_confidence, current_tier, history；源码 L77-L163
#   inputs: 无参数
#   outputs: 返回值

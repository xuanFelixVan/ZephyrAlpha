...
# [TESTS] tests/self_check/test_self_validator.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/intelligence_governance/self_validator.yaml
"""

...
#   code: cross_agent_conflict_detector.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① CrossAgentConflictDetector
#   name_en: CrossAgentConflictDetector
#   intro: class CrossAgentConflictDetector 源码 L77-L174
#   desc: 公共方法（定义序）: run_git, project_root, get_most_recent_author, detect_conflicts, resolve_conflicts；源码 L77-L174
#   inputs: project_root
#   outputs: 返回值
...
#   name_en: public defs
#   intro: CrossAgentConflictDetector

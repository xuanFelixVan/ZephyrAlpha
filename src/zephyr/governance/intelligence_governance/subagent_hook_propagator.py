...
# [TESTS] tests/governance/integration/test_subagent_hook_propagator.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/intelligence_governance/subagent_hook_propagator.yaml
"""

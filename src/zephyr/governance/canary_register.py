...
# [MODULE] zephyr.testing.code_dedup.canary_register
# [DOMAIN] D-GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK_canary_register | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

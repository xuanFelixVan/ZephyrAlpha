...
Run: python -m zephyr.governance.blueprint_code_consistency [--json]
...
DECISION_MAP: list[DecisionMapping] = [
    ...
    DecisionMapping(
        ...
        "经济护栏 Token预算",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.escalation_models",
    ...
    DecisionMapping(
        ...
        "心理说服防御 Crescendo检测",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.persuasion_detector",
        "集成到 Engine hooks",
    ),
    DecisionMapping(
        "D-022-08",
        "引擎 OS级 Sandboxing",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.engine_sandbox",
    ...
    DecisionMapping(
        ...
        "反自动化偏见",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.anti_automation_bias",
    ...
    DecisionMapping(
        ...
        "Meta-Confidence 自校准",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.confidence_estimator",
    ...
    DecisionMapping(
        ...
        "SLO驱动升级合约",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.slo_contract",
    ...
    DecisionMapping(
        ...
        "Agent行为漂移检测",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.drift_detector",
        "四维漂移检测已实现",
    ),
    DecisionMapping(
        "D-022-17",
        "VIGIL维护运行时",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.vigil_runtime",
        "VigilRuntime 已加载",
    ),
    DecisionMapping(
        "D-022-18",
        "形式验证 MCMAS",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.formal_verifier",
        "FormalVerifier 已加载",
    ),
    DecisionMapping(
        "D-022-19",
        "多Provider API容灾",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.provider_failover",
    ...
    DecisionMapping(
        ...
        "API密钥泄露处理",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.credential_guard",
    ...
    DecisionMapping(
        ...
        "Merkle Tree 密码学审计",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.merkle_audit",
    ...
    DecisionMapping(
        ...
        "命令体积退化防御",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.command_chain_length_gate",
    ...
    DecisionMapping(
        ...
        "组合性不安全防御",
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.compositional_safety_tester",
    ...
    DecisionMapping(
        ...
        DecisionStatus.IMPLEMENTED,
        "zephyr.governance.reward_hacking_rebound_detector",

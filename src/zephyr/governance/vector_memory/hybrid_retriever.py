...
# [MODULE] zephyr.data.knowledge_management.vector_memory.hybrid_retriever
# [DOMAIN] D-KNOWLEDGE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-DAT_hybrid_retriever | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

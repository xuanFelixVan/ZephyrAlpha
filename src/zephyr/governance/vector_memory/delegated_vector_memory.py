...
# [MODULE] zephyr.data.knowledge_management.vector_memory.delegated_vector_memory
# [DOMAIN] D-KNOWLEDGE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-DAT_delegated_vector_memory | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
...
from zephyr.governance.vector_memory.interface import MemoryEntry, VectorMemoryBase

...
使用方式:
    python src/zephyr/data/knowledge_management/vector-memory/migrate_chroma_to_faiss.py [--dry-run]
"""
...
def main():
    ...
    try:
        from zephyr.integration.shared_08.io.paths import VECTOR_INDEX_DIR

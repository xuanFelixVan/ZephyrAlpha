...
# [MODULE] zephyr.governance.audit_orchestration.startup_sequencer
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_startup_sequencer | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
# [MODULE] zephyr.governance.audit_orchestration.reconciliation_loop
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_reconciliation_loop | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

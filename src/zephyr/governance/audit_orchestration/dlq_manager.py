...
# [MODULE] zephyr.governance.audit_orchestration.dlq_manager
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_dlq_manager | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

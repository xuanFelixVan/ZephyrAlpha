...
# [MODULE] zephyr.governance.audit_orchestration.version_manifest
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_version_manifest | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
# [MODULE] zephyr.governance.audit_orchestration.resilience.failure_matcher
...
Usage:
    from zephyr.governance.audit_orchestration.resilience.failure_matcher import FailurePatternMatcher

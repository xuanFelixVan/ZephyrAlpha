...
# [MODULE] zephyr.governance.audit_orchestration.phase_executor
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_phase_executor | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
# [MODULE] zephyr.governance.audit_orchestration.construction_guide
# [DOMAIN] D_GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_construction_guide | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

...
# [MODULE] zephyr.governance.audit_orchestration.state_propagation
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_state_propagation | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

# [A_module] module_id=MOD-GOV_hallucination_detector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [BLUEPRINT] MOD-INF-035 | docs/03_modules/_cross_layer/auto-runtime-core/blueprint.md | §

# [MODULE] zephyr.governance.audit_orchestration.hallucination_detector
...
_FROZEN_ASSET_PATTERN = re.compile(
    r"(tool-contracts\.yaml|ADR-\d+-\d+\.md|ADR-\d{4}-[a-z0-9-]+\.md)",
    re.IGNORECASE,
)
_SUSPECT_CITATIONS = [

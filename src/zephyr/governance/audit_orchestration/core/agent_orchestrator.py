...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_agent_orchestrator | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
...
Task ID     : T-3-10 (A22)
ADR         : ADR-0032（Multi-Agent 协作边界 + 6 角色 × 10 域矩阵）
Depends     : T-3-09（ADR-0032 决策）、T-3-04（MCP Server 基础设施）、
...
见 ``zephyr.shared.schemas.TaskStatus`` 与 ``zephyr.infrastructure.db.task_repo.TaskRepository``。

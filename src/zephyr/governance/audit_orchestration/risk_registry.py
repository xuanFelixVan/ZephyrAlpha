...
# [MODULE] zephyr.governance.audit_orchestration.risk_registry
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_risk_registry | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

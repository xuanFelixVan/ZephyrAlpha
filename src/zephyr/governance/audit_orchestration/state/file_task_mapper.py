...
# [MODULE] zephyr.governance.audit_orchestration.state.file_task_mapper
# [DOMAIN] D_GOV_AUDIT
# [DEPENDENCIES] zephyr.shared.utils.db_utils; zephyr.shared.io.paths; zephyr.governance.rule_enforcement.task_types; zephyr.shared.utils.time_utils
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] none
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_file_task_mapper | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

...
# [MODULE] zephyr.governance.audit_orchestration.state.agent_health_monitor
# [DOMAIN] D_GOV_AUDIT
# [DEPENDENCIES] zephyr.governance.audit_orchestration.core.agent_orchestrator; zephyr.shared.schema.schemas; zephyr.shared.utils.time_utils
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] none
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_agent_health_monitor | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
...
from zephyr.governance.audit_orchestration.core.agent_orchestrator import OrchestrationResult

...
# [MODULE] zephyr.governance.audit_orchestration.state.state_synchronizer
# [DOMAIN] D-GOV_AUDIT
# [DEPENDENCIES] zephyr.shared.utils.db_utils; zephyr.shared.io.paths; zephyr.shared.utils.time_utils; zephyr.governance.audit_orchestration.state.file_task_mapper
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] none
    ...
    def detect_orphans(self, scan_dir: Path, pattern: str = "**/*.md") -> list[OrphanFile]:
        ...
        try:
            for f in sorted(scan_dir.rglob(pattern)):
                ...
                if not row:
                    from zephyr.governance.audit_orchestration.state.file_task_mapper import derive_task_id

...
# [MODULE] zephyr.governance.audit_orchestration.teardown_manager
# [DOMAIN] D-GOV_AUDIT
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_teardown_manager | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

...
# [MODULE] zephyr.governance.rule_enforcement.check_types.ct_manual_approval
# [DOMAIN] D_GOVERNANCE
...
# [TESTS] tests/gates/
# [A_module] module_id=MOD-GOV_ct_manual_approval | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
@register_check_type
class ManualApprovalHandler(CheckTypeHandler):

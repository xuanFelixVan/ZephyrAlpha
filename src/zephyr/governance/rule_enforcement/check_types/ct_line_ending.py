...
# [MODULE] zephyr.governance.rule_enforcement.check_types.ct_line_ending
# [DOMAIN] D_GOVERNANCE
...
# [TESTS] tests/gates/
# [A_module] module_id=MOD-GOV_ct_line_ending | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

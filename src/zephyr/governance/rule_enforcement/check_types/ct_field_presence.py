...
# [MODULE] zephyr.governance.rule_enforcement.check_types.ct_field_presence
# [DOMAIN] D_GOVERNANCE
...
# [TESTS] tests/gates/
# [A_module] module_id=MOD-GOV_ct_field_presence | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

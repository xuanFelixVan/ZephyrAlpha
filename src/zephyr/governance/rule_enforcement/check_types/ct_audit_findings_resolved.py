...
# [MODULE] zephyr.governance.rule_enforcement.check_types.ct_audit_findings_resolved
# [DOMAIN] D-GOVERNANCE
...
# [TESTS] tests/gates/
# [A_module] module_id=MOD-GOV_ct_audit_findings_resolved | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

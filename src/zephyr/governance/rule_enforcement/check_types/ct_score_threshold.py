...
# [MODULE] zephyr.governance.rule_enforcement.check_types.ct_score_threshold
# [DOMAIN] D_GOVERNANCE
...
# [TESTS] tests/gates/
# [A_module] module_id=MOD-GOV_ct_score_threshold | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

"""[BLUEPRINT] MOD-GATE_ENGINE | docs/03_modules/_cross_layer/gate-engine/blueprint.md | §3-§7

ScoreThresholdHandler — ScoreThresholdHandler

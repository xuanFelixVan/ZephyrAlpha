...
# [MODULE] zephyr.data.asset_inventory.__main__
# [DOMAIN] D_GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-DAT___main__ | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
...
def _cmd_deps(args: argparse.Namespace) -> int:
    ...
    out_path = ROOT / "data" / "asset_index" / "dependency-graph.json"

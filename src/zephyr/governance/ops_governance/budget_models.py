...
#   code: budget_models.py
# 层: 算法
# - id: A1
#   name_zh: ① 数据契约声明
#   name_en: data class declarations
#   intro: 纯声明类（无公共方法，AST 事实）: BudgetDimension, BudgetLevel, GateDecision, ModelTier, Budg…
#   desc: 数据契约/异常/枚举声明共 9 类；无算法流程（AST 事实）
#   inputs: I1
#   outputs: 数据契约类集合
# 层: 输出
# - id: O1
...
#   intro: BudgetDimension, BudgetLevel, GateDecision, ModelTier, BudgetPolicy, BudgetCons…

...
# [TESTS] tests/governance/resilience/test_interrupt_handler.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/ops_governance/interrupt_handler.yaml
"""

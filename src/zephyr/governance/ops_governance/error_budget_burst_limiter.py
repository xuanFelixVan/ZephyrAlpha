...
# [TESTS] tests/governance/budget/test_error_budget_burst_limiter.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/ops_governance/error_budget_burst_limiter.yaml
"""

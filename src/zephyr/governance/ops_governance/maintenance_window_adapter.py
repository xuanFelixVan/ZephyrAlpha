...
# [TESTS] tests/governance/lifecycle/test_maintenance_window_adapter.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/ops_governance/maintenance_window_adapter.yaml
"""

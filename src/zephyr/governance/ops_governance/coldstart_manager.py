...
# [TESTS] tests/governance/lifecycle/test_coldstart_manager.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/ops_governance/coldstart_manager.yaml
"""

...
# [TESTS] tests/governance/observability/test_meta_observability.py
...
#   code: meta_observability.py
# 层: 算法
# - id: A1
#   name_zh: ① MetaObservability
#   name_en: MetaObservability
#   intro: class MetaObservability 源码 L51-L91
#   desc: 公共方法（定义序）: edge_cases, self_latencies, record_self_latency, p99_self_latency, register_edge_case, edge_case_r…
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

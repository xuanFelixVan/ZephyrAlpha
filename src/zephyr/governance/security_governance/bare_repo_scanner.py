...
# [TESTS] tests/governance/governance_misc/test_bare_repo_scanner.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/security_governance/bare_repo_scanner.yaml
"""

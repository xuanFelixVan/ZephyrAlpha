...
# [TESTS] tests/governance/security/test_security_config_scanner.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/security_governance/security_config_scanner.yaml
"""

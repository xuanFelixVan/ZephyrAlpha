...
# [TESTS] tests/governance/adversarial/test_vibe_verify_integration.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/security_governance/vibe_verify_integration.yaml
"""

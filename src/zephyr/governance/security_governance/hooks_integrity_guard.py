...
# [TESTS] tests/governance/security/test_hooks_integrity_guard.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/security_governance/hooks_integrity_guard.yaml
"""

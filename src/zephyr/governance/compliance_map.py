...
# [MODULE] zephyr.governance.audit_trail.compliance_map
# [DOMAIN] D-GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK_compliance_map | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

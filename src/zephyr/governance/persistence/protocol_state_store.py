...
# [TESTS] tests/governance/integration/test_protocol_state_store.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/persistence/protocol_state_store.yaml
"""

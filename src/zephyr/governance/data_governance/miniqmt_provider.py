...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/data_governance/miniqmt_provider.yaml
"""
...
class MiniQmtQuoteProvider(QuoteProviderBase):
    ...
    Usage:
        ...
        # 模拟盘路径走配置真源 config/.env.qmt QMT_SIM_PATH，未配置回退默认模拟盘路径

...
# [TESTS] tests/governance/trading/test_exchange_partition_detector.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/data_governance/exchange_partition_detector.yaml
"""

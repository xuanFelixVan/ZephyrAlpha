...
# [TESTS] tests/governance/trading/test_exchange_reg_monitor.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/data_governance/exchange_reg_monitor.yaml
"""

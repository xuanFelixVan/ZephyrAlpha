...
# [MODULE] zephyr.infrastructure.rollback.sandbox_enforcer
# [DOMAIN] D-GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-RES_sandbox_enforcer | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
# [MODULE] zephyr.governance.olap_engine
# [DOMAIN] D-GOVERNANCE
# [DEPENDENCIES] zephyr.governance.persistence.sqlite_schema; zephyr.integration.shared_08.io.paths
# [CONSUMERS] zephyr.governance.persistence.olap_engine (shim chain); legacy imports via governance.olap_engine
# [STARTUP] imported
# [MATURITY] prototype
...
Import 路径映射:
    from zephyr.governance.olap_engine import OLAPEngine      -> zephyr.infrastructure.db.olap_engine
    from zephyr.governance.olap_engine import OLAPEngineError  -> zephyr.infrastructure.db.olap_engine
    from zephyr.governance.olap_engine import TrendRow        -> zephyr.infrastructure.db.olap_engine
"""

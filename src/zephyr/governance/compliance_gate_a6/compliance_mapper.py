...
# [TESTS] tests/governance/compliance/test_compliance_mapper.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/compliance_gate_a6/compliance_mapper.yaml
"""

...
# [MODULE] zephyr.data.asset_inventory.registry_adapter
# [DOMAIN] D_GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-DAT_registry_adapter | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

...
# [MODULE] zephyr.data.asset_inventory.dashboard
# [DOMAIN] D-GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-DAT_dashboard | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
...
class KnowledgeTransferGate:
    ...
    def generate_summary(self) -> str:
        ...
        dep_path = self._root / "data" / "asset_index" / "dependency-graph.json"

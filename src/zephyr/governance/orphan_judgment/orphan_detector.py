...
_mod = importlib.import_module("zephyr.trading.capability_registry")
CapabilityRegistry = getattr(_mod, "CapabilityRegistry")

_mod2 = importlib.import_module("zephyr.trading.module_onboarding_scanner")
ModuleOnboardingScanner = getattr(_mod2, "ModuleOnboardingScanner")
UnregisteredModule = getattr(_mod2, "UnregisteredModule")

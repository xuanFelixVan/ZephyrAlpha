...
SQL_PRUNE_OLD_RECONCILE_LOGS = (
    "DELETE FROM reconcile_execution_log WHERE logged_at < ?"
)
...
def cleanup_reconcile_log(
    ...
    try:
        ...
        try:
            ...
            conn.close()
        logger.info(
            "cleanup_reconcile_log: deleted %d records older than %dd", deleted, retention_days
        )

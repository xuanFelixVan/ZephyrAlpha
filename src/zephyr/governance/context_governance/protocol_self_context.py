...
# [TESTS] tests/governance/integration/test_protocol_self_context.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/context_governance/protocol_self_context.yaml
"""

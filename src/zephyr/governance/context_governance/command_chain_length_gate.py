...
# [TESTS] tests/governance/context_governance/test_command_chain_length_gate.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/context_governance/command_chain_length_gate.yaml
"""

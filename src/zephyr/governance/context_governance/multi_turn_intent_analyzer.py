...
# [TESTS] tests/multi/test_multi_turn_intent_analyzer.py
...
#   code: multi_turn_intent_analyzer.py
# 层: 算法
# - id: A1
#   name_zh: ① MultiTurnIntentAnalyzer
#   name_en: MultiTurnIntentAnalyzer
#   intro: class MultiTurnIntentAnalyzer 源码 L51-L77
#   desc: 公共方法（定义序）: turn_history, record_turn, accumulated_intent, should_escalate；源码 L51-L77
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

...
#   code: think_time_model.py
# 层: 算法
# - id: A1
#   name_zh: ① ThinkTimeModel
#   name_en: ThinkTimeModel
#   intro: class ThinkTimeModel 源码 L63-L113
#   desc: 公共方法（定义序）: record_think_segment, record_chunk_latency, estimate_next_duration, average_tps, average_chunk_lat…
#   inputs: 无参数
#   outputs: 返回值

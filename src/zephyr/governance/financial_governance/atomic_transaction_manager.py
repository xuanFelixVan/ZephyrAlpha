...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/financial_governance/atomic_transaction_manager.yaml
"""
...
class TransactionScope:
    ...
    def execute(
        ...
        if self._atm._conn is None:
            raise RuntimeError("connection not established")  # 5.88.1 修复: assert->if/raise

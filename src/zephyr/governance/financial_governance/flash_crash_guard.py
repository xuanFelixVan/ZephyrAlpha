...
# [TESTS] tests/governance/resilience/test_flash_crash_guard.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/financial_governance/flash_crash_guard.yaml
"""

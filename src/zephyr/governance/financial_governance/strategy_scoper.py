...
# [TESTS] tests/governance/trading/test_strategy_scoper.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/financial_governance/strategy_scoper.yaml
"""

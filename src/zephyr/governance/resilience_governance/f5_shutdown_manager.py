...
# [TESTS] tests/f_lifecycle/test_f5_auto_shutdown.py; tests/f_lifecycle/test_f5_e2e_lifecycle.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/resilience_governance/f5_shutdown_manager.yaml
"""

...
# [TESTS] tests/semantic_auditor/test_blast_radius.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/resilience_governance/blast_radius.yaml
"""

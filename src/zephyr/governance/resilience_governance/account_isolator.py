...
# [TESTS] tests/governance/access_control/test_account_isolator.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/resilience_governance/account_isolator.yaml
"""

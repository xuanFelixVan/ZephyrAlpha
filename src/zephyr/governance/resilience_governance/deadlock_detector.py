...
# [TESTS] tests/e/test_e_deadlock_detector.py; tests/f_lifecycle/test_f5_auto_shutdown.py; tests/f_lifecycle/test_f5_auto_startup.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/resilience_governance/deadlock_detector.yaml
"""

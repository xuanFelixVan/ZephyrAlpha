...
# [TESTS] tests/agent_rbac/test_integration_root.py; tests/audit/audit_core/test_audit_red_blue_e2e.py; tests/autonomy/test_autonomy_gate_drift_hook.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/resilience_governance/circuit_breaker.yaml
"""

...
# [TESTS] tests/governance/resilience/test_witness_isolation.py
...
#   code: witness_isolation.py
# 层: 算法
# - id: A1
#   name_zh: ① WitnessIsolator
#   name_en: WitnessIsolator
#   intro: class WitnessIsolator 源码 L51-L87
#   desc: 公共方法（定义序）: witnesses, register_witness, majority_decision, disagree_count；源码 L51-L87
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

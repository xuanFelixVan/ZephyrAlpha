...
# [TESTS] tests/governance/resilience/test_process_isolator.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_governance/algo_flow/resilience_governance/process_isolator.yaml
"""

...
# [MODULE] zephyr.governance.semantic_auditor.compliance_map
# [DOMAIN] D-GOVERNANCE
...
# [A_module] module_id=MOD-SEM_compliance_map | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

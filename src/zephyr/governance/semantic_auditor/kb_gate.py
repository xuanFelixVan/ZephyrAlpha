...
# [MODULE] zephyr.governance.semantic_auditor.kb_gate
# [DOMAIN] D-GOVERNANCE
...
# [A_module] module_id=MOD-SEM_kb_gate | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

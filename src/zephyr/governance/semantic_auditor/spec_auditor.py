...
# [MODULE] zephyr.governance.semantic_auditor.spec_auditor
# [DOMAIN] D-GOVERNANCE
...
# [A_module] module_id=MOD-SEM_spec_auditor | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

# [BLUEPRINT] MOD-GOV-perm_trigger_gate | docs/03_modules/_cross_layer/auto_runtime_core/blueprint.md
# [MODULE] zephyr.governance.commit_gates.perm_trigger_gate
# [DOMAIN] D_GOVERNANCE

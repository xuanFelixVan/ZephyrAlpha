# [BLUEPRINT] MOD-GOV-orphan_module_gate | docs/03_modules/_cross_layer/auto_runtime_core/blueprint.md
# [MODULE] zephyr.governance.commit_gates.orphan_module_gate
# [DOMAIN] D_GOVERNANCE

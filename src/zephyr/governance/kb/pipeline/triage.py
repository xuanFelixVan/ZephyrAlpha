...
# [DOMAIN] D-GOVERNANCE
# [DEPENDENCIES] zephyr.governance.rule_enforcement.gate_engine; zephyr.governance.rule_enforcement.gate_types.__init__; zephyr.governance.__init__; zephyr.shared.schema.schemas
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] none
...
==========================================
依据：g2-triage.yaml、AGENTS.md §5.2 分类打标规范
...
class TriageGate:
    ...
    def triage(self, source_path: Path) -> Self:
        violations: list[str] = []

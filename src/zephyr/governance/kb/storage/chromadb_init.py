...
# [MODULE] zephyr.data.knowledge_management.kb.storage.chromadb_init
# [DOMAIN] D-GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-DAT_chromadb_init | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
...
用法
----
    from zephyr.governance.kb.storage.chromadb_init import init_chromadb, get_chroma_client

...
=============================================
依据： persistent client）

⚠️ 此模块为 KB 模块旧版独立 ChromaDB 层 — 已被 VMS (MOD-INF-011) 取代为全系统主向量后端。
⚠️ VMS: src/zephyr/vector-memory/ — 8 Collection (decisions/code_context/lessons/knowledge/rules/blueprints/session_snapshots/execution_traces)
...
用法
----
    from zephyr.governance.kb.chromadb_init import init_chromadb, get_chroma_client

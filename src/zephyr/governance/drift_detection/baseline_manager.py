...
# [MODULE] zephyr.governance.drift_detection.baseline_manager
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES]
# [CONSUMERS]
# [STARTUP] imported
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_baseline_manager | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
        ...
        for root, _dirs, files in os.walk(module_dir):
            for fname in sorted(files):
                ...
                try:
                    ...
                    hashes[os.path.relpath(full, module_dir)] = "ERROR"
        return hashes

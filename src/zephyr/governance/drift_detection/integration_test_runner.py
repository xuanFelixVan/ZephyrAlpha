...
# [MODULE] zephyr.governance.behavioral_auditor.integration_test_runner
# [DOMAIN] D_SECURITY
...
# [A_module] module_id=MOD-SEC_integration_test_runner | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound
...
class IntegrationTestRunner:
    ...
    def import_check(self) -> SelfTestResult:
        ...
        for mod in modules:
            try:
                __import__(f"zephyr.governance.behavioral_auditor.{mod}")
    ...
    def type_check(self) -> SelfTestResult:
        ...
        file_path = os.path.join("src", "zephyr", "behavioral-auditor", "self_check.py")

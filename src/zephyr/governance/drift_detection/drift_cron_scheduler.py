...
# [MODULE] zephyr.governance.drift_detection.drift_cron_scheduler
# [DOMAIN] D-GOVERNANCE
# [DEPENDENCIES] zephyr.shared.lifecycle.daemon_registry; zephyr.governance.drift_detection.drift_engine
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] none
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_drift_cron_scheduler | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

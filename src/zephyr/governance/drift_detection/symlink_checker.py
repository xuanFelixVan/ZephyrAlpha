...
# [MODULE] zephyr.governance.drift_detection.symlink_checker
# [DOMAIN] D-GOVERNANCE
# [DEPENDENCIES]
# [CONSUMERS]
# [STARTUP] imported
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GOV_symlink_checker | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

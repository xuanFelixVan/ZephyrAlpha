...
# [MODULE] zephyr.governance.drift_detection.data_classification
...
# [A_module] module_id=MOD-SEC_data_classification | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

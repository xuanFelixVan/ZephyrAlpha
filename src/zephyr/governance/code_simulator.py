...
# [MODULE] zephyr.testing.code_dedup.code_simulator
# [DOMAIN] D_GOVERNANCE
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK_code_simulator | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

...
# - id: I1
#   name: 包内子模块公共符号
#   fields: import 再导出符号: annotations, DagExecutionReport, DagExecutor, DagExecutorConfig, Fact…
#   code: __init__.py import L50
# 层: 算法
# - id: A1
#   name_zh: ① 包公共面再导出
#   name_en: __init__ re-export
#   intro: 再导出 DagExecutionReport, DagExecutor, DagExecutorConfig, FactorExecutionResult（共…
...
#   name_en: __all__
#   intro: DagExecutionReport, DagExecutor, DagExecutorConfig, FactorExecutionResult

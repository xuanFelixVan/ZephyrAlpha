...
# [DOMAIN] D_FACTOR
# [DEPENDENCIES] zephyr.factor.core.evaluation.backtest（原并列声明 evaluation.metrics 经 2026-09-05 AI-08 审计实证未 import，死依赖半已删）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_factor/algo_flow/ic_ir_calc.yaml
"""

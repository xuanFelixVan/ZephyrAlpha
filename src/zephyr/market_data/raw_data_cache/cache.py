...
# [CONSUMERS] tests/market_data/raw_data_cache/test_raw_data_cache.py（2026-09-05 AI-04 审计实证：normalized_market_data_producer 未 import 本模块，生产装配待排期）
# [STARTUP] imported
# [MATURITY] testing
...
# [ALGO_FLOW] external: docs/03_modules/_domain_mkt_data/algo_flow/cache.yaml
"""

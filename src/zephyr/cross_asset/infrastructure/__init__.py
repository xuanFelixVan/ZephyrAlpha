...
# [MODULE] zephyr.cross_asset.infrastructure
...
#   code: src/zephyr/cross_asset/infrastructure/__init__.py
# 层: 算法
# - id: A1
#   name_zh: ① 包命名空间占位/聚合导出
#   name_en: __init__（模块级 __all__）
#   intro: 声明 zephyr.cross_asset.infrastructure 包命名空间，按 __all__ 声明导出

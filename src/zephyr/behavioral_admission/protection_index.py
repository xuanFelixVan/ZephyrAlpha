# [BLUEPRINT] MOD-INF-033 | 03_modules/_cross_layer/behavioral-auditor/blueprint.md | §17
# [MODULE] zephyr.behavioral_admission.protection_index
# [INVARIANTS] anchor路径永远返回anchor级别；Bloom Filter假阳性必须通过Trie精确二次验证
# [MODIFY-GUARD] docs/03_modules/_cross_layer/behavioral-auditor/blueprint.md;src/zephyr/behavioral_admission/__init__.py
# [CONSUMERS] zephyr.behavioral_admission.verdict_engine;MOD-INF-027(audit_orchestrator)
# [STABILITY] evolving
# [SAFETY] H
...
from zephyr.behavioral_admission.verdict_engine import ProtectionLevel
...
PROTECTED_PATTERNS: list[str] = [
    ...
    "src/zephyr/rollback/",
    "src/zephyr/shared/",
    "src/zephyr/behavioral_admission/",
    "src/zephyr/behavioral_auditor/",
    "blueprint.md",
    "_registry.yaml",

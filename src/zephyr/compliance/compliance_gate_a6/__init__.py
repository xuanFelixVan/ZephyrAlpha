# [A_module] module_id=MOD-CMP-compliance_gate_a6 | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
"""
...
保留向后兼容（``from zephyr.compliance.compliance_gate_a6 import X`` 仍可用），
...
#   code: _TARGET = "zephyr.governance.compliance_gate_a6"（__init__.py L15）
# 层: 算法
# - id: A1
...
#   intro: 让 from zephyr.compliance.compliance_gate_a6 import X 的旧写法继续可用
#   downstream: 无下游/内部使用（5.60.8 迁移兼容壳，仓内0消费者；canonical 包 zephyr.governance.compliance_gate_a6）
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1
...
_TARGET = "zephyr.governance.compliance_gate_a6"

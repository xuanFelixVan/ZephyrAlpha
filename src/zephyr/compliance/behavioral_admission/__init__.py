...
保留向后兼容（``from zephyr.compliance.behavioral_admission import X`` 仍可用），
...
#   code: _TARGET = "zephyr.gov_enforcement.behavioral_admission"（__init__.py L15）
# 层: 算法
# - id: A1
...
#   intro: 让 from zephyr.compliance.behavioral_admission import X 的旧写法继续可用
#   downstream: 无下游/内部使用（5.60.8 迁移兼容壳，仓内0消费者；canonical 包 zephyr.gov_enforcement.behavioral_admission）
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1
...
_TARGET = "zephyr.gov_enforcement.behavioral_admission"

...
# - id: I1
#   name: 空包标记文件（无数据输入）
#   fields: 无字段——仅一行包注释 `# compliance/core`，无子模块无导入
#   code: src/zephyr/compliance/core/__init__.py L1-3
# 层: 算法
# - id: A1
#   name_zh: ① compliance 核心命名空间占位
#   name_en: __init__（模块级 __all__）
#   intro: 合规实现迁移后保留的 core 子包骨架，当前无任何实现

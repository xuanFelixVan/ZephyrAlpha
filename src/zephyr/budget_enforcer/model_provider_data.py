...
# [MODULE] zephyr.budget_enforcer.model_provider_data

# [INVARIANTS] DEFAULT_PROVIDERS和TIER_MODEL_MAP是纯数据常量;修改MUST同步更新model_router和model_discovery

# [MODIFY-GUARD] docs/03_modules/l01_infrastructure/budget-enforcer/blueprint.md;src/zephyr/budget_enforcer/model_router.py;src/zephyr/model_profiler/model_discovery.py

# [CONSUMERS] src.zephyr.budget_enforcer.model_router;src.zephyr.model_profiler.model_discovery
...
from zephyr.budget_enforcer.budget_models import ModelTier

...
# [MODULE] zephyr.observability.feedback_loop.diagnosers.timezone_semantic_reasoner
...
class TimezoneSemanticReasoner:
    venue_active_windows: dict[str, tuple[int, int]] = field(default_factory=lambda: {
        "NYSE": (14, 21),
        "LSE": (8, 16),
        "TSE": (0, 6),
        "SSE": (1, 7),

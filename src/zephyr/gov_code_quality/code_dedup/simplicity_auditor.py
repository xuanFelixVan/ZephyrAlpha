...
# [MODULE] zephyr.gov_code_quality.code_dedup.simplicity_auditor
...
#   code: simplicity_auditor.py
# 层: 算法
# - id: A1
#   name_zh: ① SimplicityAuditor
#   name_en: SimplicityAuditor
#   intro: 月度 SAS 自审计器.
#   desc: 月度 SAS 自审计器.；公共方法（定义序）: audit；源码 L70-L119
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: SimplicityAuditor
#   downstream: tests/governance/code_quality/test_simplicity_auditor.py
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

...
# [MODULE] zephyr.gov_code_quality.code_dedup.thematic_clusterer
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ-thematic_clusterer | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
class ThematicClusterer:
    ...
    def _classify(paths: list[str]) -> str:
        ...
        return ThematicClusterer.classify(paths)

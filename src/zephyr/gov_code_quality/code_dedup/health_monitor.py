...
# [MODULE] zephyr.gov_code_quality.code_dedup.health_monitor
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ_health_monitor | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

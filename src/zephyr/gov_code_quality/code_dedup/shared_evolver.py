...
# [MODULE] zephyr.gov_code_quality.code_dedup.shared_evolver
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ_shared_evolver | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

...
# [MODULE] zephyr.gov_code_quality.code_dedup.trackers.blind_spot_tracker
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ_blind_spot_tracker | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

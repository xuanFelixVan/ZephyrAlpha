...
# [MODULE] zephyr.gov_code_quality.code_dedup.signature_matcher
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ_signature_matcher | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

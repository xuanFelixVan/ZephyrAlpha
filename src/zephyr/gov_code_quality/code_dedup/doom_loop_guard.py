...
# [MODULE] zephyr.gov_code_quality.code_dedup.doom_loop_guard
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ_doom_loop_guard | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

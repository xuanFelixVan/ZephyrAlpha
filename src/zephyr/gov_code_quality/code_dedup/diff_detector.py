...
# [MODULE] zephyr.gov_code_quality.code_dedup.diff_detector
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ_diff_detector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

...
# [MODULE] zephyr.gov_code_quality.code_dedup.sensitivity_sweeper
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-GCQ_sensitivity_sweeper | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

...
# [MODULE] zephyr.l05_portfolio_construction.strategy_base
...
SSoT: cross-layer-contracts.yaml v3.0 → OCP-002
"""
...
def autodiscover_strategies(
    package_path: str = "zephyr.l05_portfolio_construction.strategies",
) -> int:
    found = 0
    try:

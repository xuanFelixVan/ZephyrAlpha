...
# [DOMAIN] D_PF_CORE
# [DEPENDENCIES] zephyr.governance.strategies.strategy_base; zephyr.shared.contracts.order; zephyr.shared.contracts.enums.order_enums
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] none
...
# [ALGO_FLOW] external: docs/03_modules/_domain_portfolio_core/algo_flow/default_equity_strategy.yaml
"""

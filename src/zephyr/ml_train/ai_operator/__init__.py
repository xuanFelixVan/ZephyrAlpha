...
# - id: I1
#   name: 包内子模块公共符号
#   fields: import 再导出符号: AIOperator, ApprovalToken, OperatorActionError, OperatorRecord
#   code: __init__.py import L37
# 层: 算法
# - id: A1
#   name_zh: ① 包公共面再导出
#   name_en: __init__ re-export
#   intro: 再导出 AIOperator, ApprovalToken, OperatorActionError, OperatorRecord（共 4 符号）
...
#   name_en: __all__
#   intro: AIOperator, ApprovalToken, OperatorActionError, OperatorRecord

...
# [DOMAIN] D_BACKTEST
# [DEPENDENCIES] zephyr.backtest.core.engine_base; zephyr.backtest.core.portfolio; zephyr.backtest.core.matching_engine; zephyr.backtest.core.tick_replay; zephyr.backtest.core.metrics; zephyr.backtest.core.overfitting_detector; zephyr.backtest.core.walk_forward; zephyr.backtest.core.decision_gate; zephyr.backtest.implementations.vectorized_engine
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] production
...
# [TESTS] tests/backtest/test_event_driven_engine.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_backtest/algo_flow/event_driven_engine.yaml
"""

...
CI检查:
  python -m zephyr.kb.integrity verify --layer 1|2|3|all
    → 对比manifest vs 当前磁盘
    → 发现漂移 → exit 1 + 详细diff

Manifest文件:
  data/snapshots/kb_integrity_manifest.json
"""
...
class IntegrityGuard:
    _MANIFEST_FILE = "kb_integrity_manifest.json"

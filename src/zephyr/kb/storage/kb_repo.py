...
# [MODULE] zephyr.kb.storage.kb_repo
...
class KbRepo:
    ...
    def transition(self, ke_id: str, to_status: KeStatus, content: str | None = None) -> Self:
        rec = self.get(ke_id)
        if rec is None:
    ...
    def search(
        ...
        from zephyr.kb.storage.chromadb_init import get_chroma_client

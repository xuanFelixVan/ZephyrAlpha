...
# [MODULE] zephyr.audit_trail.bridges.drift_bridge
...
--------
  DriftBridge.sync():
    1. 从 audit_trail 拉取最近异常事件
    2. 从 drift_detector 拉取最近 DriftEvent
...
class DriftBridge:
    ...
    def _scan_drift_events(self) -> list[dict[str, Any]]:
        try:
            from zephyr.drift_detector.drift_engine import DriftEngine

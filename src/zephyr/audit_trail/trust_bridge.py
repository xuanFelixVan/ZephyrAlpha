...
# [MODULE] zephyr.audit_trail.trust_bridge
...
class AuditTrustBridge:
    ...
    def get_trust_score(self, agent_id: str) -> float | None:
        ...
        try:
            ...
            from zephyr.rollback.continuous_trust import ContinuousTrust
    ...
    def enrich_event_with_trust(self, event: dict[str, Any]) -> dict[str, Any]:
        ...
        if trust_score is not None:
            ...
            event["trust_score"] = round(trust_score, 4)

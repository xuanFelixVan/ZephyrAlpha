...
# [MODULE] zephyr.audit_trail.tiered_storage_bridge

# [INVARIANTS] bridge must not modify audit records during tier transition

# [MODIFY-GUARD] tiered_storage.py; __init__.py

# [CONSUMERS] zephyr.audit_trail.tiered_storage
...
# [ERROR_CONTRACT] StorageTierError
...
class AuditTieredStorageBridge:
    ...
    def __init__(self, data_dir: str | Path = "data/audit_trail") -> None:

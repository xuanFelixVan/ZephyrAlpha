...
# [MODULE] zephyr.llm_security.self_protection.red_team_scanner
...
from zephyr.llm_security.gateway import LSGSecurityGateway, ScanMode as GWScanMode
from zephyr.llm_security.payloads import load_red_team_payloads
...
class RedTeamScanner:
    ...
    功能:
    - 加载 red_team_payloads.yaml 中的 200+ 攻击载荷

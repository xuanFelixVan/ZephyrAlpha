...
# [MODULE] zephyr.gov_enforcement.commit_gates.ttl_gate
...
# 层: 算法
# - id: A1
#   name_zh: ① make_ttl_gate
#   name_en: make_ttl_gate
#   intro: 构造 ttl 字段校验门禁 GateSpec（fail-closed，阻断型）。
#   desc: 构造 ttl 字段校验门禁 GateSpec（fail-closed，阻断型）。 Returns: GateSpec(gate_id="TTL-METADATA", priori…；源码 L106-L169
#   inputs: 无参数
#   outputs: GateSpec
# 层: 输出
# - id: O1

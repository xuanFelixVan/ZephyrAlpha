...
#   code: schema_file_exists_gate.py
# 层: 算法
# - id: A1
#   name_zh: ① make_schema_file_exists_gate
#   name_en: make_schema_file_exists_gate
#   intro: 构造 SCHEMA-FILE-EXISTS pre-commit block 门禁（priority=121）。
#   desc: 构造 SCHEMA-FILE-EXISTS pre-commit block 门禁（priority=121）。 当 business_data_categories.yaml…；源码 L148-L187
#   inputs: 无参数
#   outputs: GateSpec
# 层: 输出
# - id: O1

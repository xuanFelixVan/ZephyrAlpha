...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/o/orphan_module_gate.yaml
"""
...
def make_orphan_module_gate() -> GateSpec:
    ...
    Returns:
        ...
        priority=89——在 MODULE-ID-CONSISTENCY(88) 之后、FUNCTION-DUP(90) 之前。
    """

...
# [MODULE] zephyr.gov_enforcement.commit_gates.vocab_hardcode_gate
...
#   code: vocab_hardcode_gate.py
# 层: 算法
# - id: A1
#   name_zh: ① make_vocab_hardcode_gate
#   name_en: make_vocab_hardcode_gate
#   intro: 构造新增 .py 文件词表硬编码阻断门禁 GateSpec（硬阻断型）。
#   desc: 构造新增 .py 文件词表硬编码阻断门禁 GateSpec（硬阻断型）。 Returns: GateSpec(gate_id="VOCAB-HARDCODE", priority…；源码 L202-L233
#   inputs: 无参数
#   outputs: GateSpec
# 层: 输出
# - id: O1

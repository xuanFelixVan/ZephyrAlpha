...
# [MODULE] zephyr.gov_enforcement.commit_gates.file_placement_ttl_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/f/file_placement_ttl_gate.yaml
"""

...
# [MODULE] zephyr.gov_enforcement.commit_gates.r5_digit_suffix_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/r/r5_digit_suffix_gate.yaml
"""

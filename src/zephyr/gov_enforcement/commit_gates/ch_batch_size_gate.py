...
# [MODULE] zephyr.gov_enforcement.commit_gates.ch_batch_size_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/c/ch_batch_size_gate.yaml
"""

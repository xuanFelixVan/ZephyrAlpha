...
# [MODULE] zephyr.gov_enforcement.commit_gates.id_uniqueness_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/i/id_uniqueness_gate.yaml
"""

...
# [MODULE] zephyr.gov_enforcement.commit_gates.test_source_consistency_gate
# [DOMAIN] D_GOV_CODE_QUALITY
# [DEPENDENCIES] zephyr.gov_enforcement.commit_gates._diff_helpers; zephyr.gov_enforcement.rule_bridge.commit_gate_registry (GateSpec, is_test_exempt); zephyr.shared.io.paths (REPO_ROOT)
...
#   code: test_source_consistency_gate.py
# 层: 算法
# - id: A1
#   name_zh: ① make_test_source_consistency_gate
#   name_en: make_test_source_consistency_gate
#   intro: 构造测试-源码符号一致性 GateSpec（硬阻断型）。
#   desc: 构造测试-源码符号一致性 GateSpec（硬阻断型）。 Returns: GateSpec(gate_id="TEST-SOURCE-CONSISTENCY", priorit…；源码 L335-L384
#   inputs: 无参数
#   outputs: GateSpec
# 层: 输出
# - id: O1

...
# [MODULE] zephyr.gov_enforcement.commit_gates.empty_handler_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/e/empty_handler_gate.yaml
"""

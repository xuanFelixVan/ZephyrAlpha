...
#   code: hardcoded_url_gate.py
# 层: 算法
# - id: A1
#   name_zh: ① make_hardcoded_url_gate
#   name_en: make_hardcoded_url_gate
#   intro: 构造硬编码 localhost URL 阻断 GateSpec（硬阻断型）。
#   desc: 构造硬编码 localhost URL 阻断 GateSpec（硬阻断型）。 Returns: GateSpec(gate_id="NO-HARDCODED-URL", prio…；源码 L160-L190
#   inputs: 无参数
#   outputs: GateSpec
# 层: 输出
# - id: O1

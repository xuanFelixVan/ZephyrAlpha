...
# [MODULE] zephyr.gov_enforcement.commit_gates.file_copy_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/f/file_copy_gate.yaml
"""
...
def make_file_copy_gate() -> GateSpec:
    ...
    def _check(gateway, files: list[str], **kwargs) -> tuple[bool, str]:
        ...
        new_py_files = _split_own_foreign(gateway, new_py_files, files, kwargs.get("session_id"), gate_name="FILE-COPY")[0]
        if not new_py_files:
            return True, ""

...
#   code: file_copy_gate.py
# 层: 算法
# - id: A1
#   name_zh: ① make_file_copy_gate
#   name_en: make_file_copy_gate
#   intro: 构造新增 .py 文件复制检测阻断门禁 GateSpec（硬阻断型）。
#   desc: 构造新增 .py 文件复制检测阻断门禁 GateSpec（硬阻断型）。 Returns: GateSpec(gate_id="FILE-COPY", priority=85)。…；源码 L199-L231
#   inputs: 无参数
#   outputs: GateSpec
# 层: 输出
# - id: O1

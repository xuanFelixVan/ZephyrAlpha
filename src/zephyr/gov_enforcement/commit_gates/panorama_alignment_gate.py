...
#   code: panorama_alignment_gate.py
# 层: 算法
# - id: A1
#   name_zh: ① make_panorama_alignment_gate
#   name_en: make_panorama_alignment_gate
#   intro: 构造三图模块对齐 warn-only 门禁 GateSpec。
#   desc: 构造三图模块对齐 warn-only 门禁 GateSpec。 Returns: GateSpec(gate_id="GATE-PANORAMA-ALIGNMENT", prio…；源码 L119-L299
#   inputs: 无参数
#   outputs: GateSpec
# 层: 输出
# - id: O1

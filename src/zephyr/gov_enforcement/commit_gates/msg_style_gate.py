...
# [MODULE] zephyr.gov_enforcement.commit_gates.msg_style_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/m/msg_style_gate.yaml
"""

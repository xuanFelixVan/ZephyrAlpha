...
# [MODULE] zephyr.gov_enforcement.commit_gates.function_dup_gate
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/commit_gates/f/function_dup_gate.yaml
"""

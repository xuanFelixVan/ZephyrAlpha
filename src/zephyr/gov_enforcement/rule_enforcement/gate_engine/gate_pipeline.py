...
# [DOMAIN] D_GOV_RULE
# [DEPENDENCIES] zephyr.gov_enforcement.rule_enforcement.gate_context
# [CONSUMERS]
# [STARTUP] manual
# [MATURITY] production
# [INVARIANTS] none
...
#   name: name 参数
#   fields: 参数 name（无注解）
#   code: gate_pipeline.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① GatePipeline
#   name_en: GatePipeline
#   intro: class GatePipeline 源码 L90-L194
#   desc: 公共方法（定义序）: add, from_engine_step, run, evaluate；源码 L90-L194
#   inputs: name
#   outputs: 返回值
# - id: A2
#   name_zh: ② main
#   name_en: main
#   intro: main() 源码 L200-L201
#   desc: 源码 L200-L201
#   inputs: 无参数
#   outputs: 返回值

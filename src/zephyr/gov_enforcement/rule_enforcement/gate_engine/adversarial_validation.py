...
# [MODULE] zephyr.gov_enforcement.rule_enforcement.gate_engine.adversarial_validation
# [DOMAIN] D_GOV_RULE
# [DEPENDENCIES]
# [CONSUMERS] zephyr.gov_enforcement.rule_enforcement.gate_pipeline
# [STARTUP] imported
# [MATURITY] production
...
# [TESTS] tests/governance/rule_enforcement/gate_engine/test_adversarial_gate_integration.py; tests/governance/rule_enforcement/gate_engine/test_adversarial_validation_gate.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/rule_enforcement/gate_engine/adversarial_validation.yaml
"""

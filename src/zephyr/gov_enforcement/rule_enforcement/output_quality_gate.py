...
# [MODULE] zephyr.gov_enforcement.rule_enforcement.output_quality_gate
...
#   name: rules 参数
#   fields: 参数 rules（无注解）
#   code: output_quality_gate.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① OutputQualityGate
#   name_en: OutputQualityGate
#   intro: class OutputQualityGate 源码 L77-L186
#   desc: 公共方法（定义序）: rules, evaluate, add_rule；源码 L77-L186
#   inputs: rules
#   outputs: 返回值

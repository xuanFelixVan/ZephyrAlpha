...
# [TESTS] tests/governance/rule_enforcement/invariants/test_post_doc_review.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 1 个测试）
# [A_module] module_id=MOD-GOV-post_doc_review_check | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
"""


# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/rule_enforcement/invariants/post_doc_review_check.yaml
"""

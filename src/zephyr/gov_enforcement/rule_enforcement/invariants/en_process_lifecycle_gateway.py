...
# [MODULE] zephyr.gov_enforcement.rule_enforcement.invariants.en_process_lifecycle_gateway
# [DOMAIN] D_GOV_RULE
# [DEPENDENCIES]
...
# [TESTS] tests/governance/rule_enforcement/invariants/test_en_process_lifecycle_gateway.py; tests/zephyr/shared/infra/test_process_lifecycle_gateway.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/rule_enforcement/invariants/en_process_lifecycle_gateway.yaml
"""

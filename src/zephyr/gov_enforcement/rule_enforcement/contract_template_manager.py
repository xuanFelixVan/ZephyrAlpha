...
#   code: contract_template_manager.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① ContractTemplateManager
#   name_en: ContractTemplateManager
#   intro: Manage MCP tool contract templates.
#   desc: Manage MCP tool contract templates. Parameters ---------- store_path : Path | None Option…；公共方法（定义序）: registe…
#   inputs: store_path
#   outputs: 返回值

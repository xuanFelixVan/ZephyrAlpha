...
# [TESTS] tests/governance/rule_enforcement/gate_engine/test_adversarial_gate_integration.py; tests/governance/rule_enforcement/test_adversarial_strategies.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/rule_enforcement/adversarial_strategies.yaml
"""

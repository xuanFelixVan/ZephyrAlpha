...
#   intro: class GPUConsensusScheduler 源码 L215-L642
#   desc: 公共方法（定义序）: submit, submit_batch, get_gpu_status, get_queue_depth, cancel, get_metrics, health_check；源码 L215-L…
#   inputs: ollama_url local_model api_primary api_secondary timeouts max_queue_s…
#   outputs: 返回值

...
# [MODULE] zephyr.gov_enforcement.behavioral_admission.admission_controller
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_enforcement/algo_flow/behavioral_admission/admission_controller.yaml
"""

...
# [MODULE] zephyr.orchestration.agent_lifecycle.skill_breakage_checker
...
class SkillBreakageChecker:
    ...
    def _extract_constraints(self, content: str) -> Set[str]:
        return {match.group()[:80] for pattern, _ in self.CONSTRAINT_PATTERNS
    ...
    def check(self, old_content: str, new_content: str) -> Dict[str, Any]:
        ...
        if lost:
            breaking.append({"type": "constraints_removed", "severity": "critical",

...
# [MODULE] zephyr.autonomy_core.context_outcome_tracker
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-ORC_context_outcome_tracker | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
# [MODULE] zephyr.autonomy_core.cold_start_booster
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-ORC_cold_start_booster | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] task_bound

...
#   code: context_evaluator.py
# 层: 算法
# - id: A1
#   name_zh: ① ContextEvaluator
#   name_en: ContextEvaluator
#   intro: AI 引用率 = 上下文效率评估器。
#   desc: AI 引用率 = 上下文效率评估器。 citation_rate = cited_ke_count / injected_ke_count Using:: evaluator =…；公共方法（定义序）: evaluat…
#   inputs: 无参数
#   outputs: 返回值

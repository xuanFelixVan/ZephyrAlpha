...
# [DEPENDENCIES] zephyr.autonomy_core.__init__; zephyr.shared.schema.schemas; zephyr.infrastructure.capacity_assurance.token_budget; zephyr.shared.blueprint_tools.architecture_context_loader
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] none

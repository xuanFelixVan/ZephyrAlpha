...
# [TESTS] tests/context/test_context_rule_registry_root.py; tests/context/test_context_rule_registry_unit.py
...
#   code: context_rule_registry.py
# 层: 算法
# - id: A1
#   name_zh: ① ContextRuleRegistry
#   name_en: ContextRuleRegistry
#   intro: class ContextRuleRegistry 源码 L106-L230
#   desc: 公共方法（定义序）: register, lookup, unregister, load_yaml, list_rules, save_yaml；源码 L106-L230
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: ContextRuleRegistry
#   downstream: MOD-INF-017; MOD-INF-018; MOD-INF-023; MOD-INF-033
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

...
# [DEPENDENCIES] zephyr.shared.shared_services.infra_06.observer; zephyr.autonomy_core.__init__; zephyr.shared.events.event_schemas; zephyr.shared.infra.cache
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] none
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-ORC_context_budget_tracker | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

...
#   code: skill_schema_registry.py
# 层: 算法
# - id: A1
#   name_zh: ① SkillSchemaRegistry
#   name_en: SkillSchemaRegistry
#   intro: Skill I/O Schema 注册与契约验证.
#   desc: Skill I/O Schema 注册与契约验证.；公共方法（定义序）: register, get_schema, validate_input, validate_output, list_registered,…
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

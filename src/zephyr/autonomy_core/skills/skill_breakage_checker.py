...
#   code: skill_breakage_checker.py
# 层: 算法
# - id: A1
#   name_zh: ① SkillBreakageChecker
#   name_en: SkillBreakageChecker
#   intro: class SkillBreakageChecker 源码 L60-L117
#   desc: 公共方法（定义序）: extract_tools, extract_constraints, check；源码 L60-L117
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

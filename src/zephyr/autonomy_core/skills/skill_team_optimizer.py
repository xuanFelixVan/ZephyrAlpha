...
#   code: skill_team_optimizer.py
# 层: 算法
# - id: A1
#   name_zh: ① SkillTeamOptimizer
#   name_en: SkillTeamOptimizer
#   intro: class SkillTeamOptimizer 源码 L143-L256
#   desc: 公共方法（定义序）: team_score, coverage, compat_score, optimize；源码 L143-L256
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

...
# [DEPENDENCIES] zephyr.shared.schema.schemas; zephyr.shared.foundation.constants; zephyr.shared.io.yaml_utils
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] none
...
# [ALGO_FLOW] external: docs/03_modules/_domain_autonomy_core/algo_flow/skills/skill_registry.yaml
"""

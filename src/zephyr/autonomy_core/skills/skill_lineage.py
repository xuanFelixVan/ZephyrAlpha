...
#   code: skill_lineage.py
# 层: 算法
# - id: A1
#   name_zh: ① SkillLineage
#   name_en: SkillLineage
#   intro: Skill 版本谱系追踪——版本树与回滚路径.
#   desc: Skill 版本谱系追踪——版本树与回滚路径.；公共方法（定义序）: lineages, record_version, get_lineage, latest, rollback_path, diff, clear；…
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

...
#   code: skill_telemetry.py
# 层: 算法
# - id: A1
#   name_zh: ① SkillTelemetry
#   name_en: SkillTelemetry
#   intro: Skill Telemetry——使用遥测采集与聚合分析.
#   desc: Skill Telemetry——使用遥测采集与聚合分析.；公共方法（定义序）: events, record, query, stats；源码 L62-L125
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

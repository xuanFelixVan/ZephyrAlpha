...
#   code: skill_prompt_cache.py
# 层: 算法
# - id: A1
#   name_zh: ① SkillPromptCache
#   name_en: SkillPromptCache
#   intro: Skill Prompt 缓存——减少重复 LLM 调用.
#   desc: Skill Prompt 缓存——减少重复 LLM 调用.；公共方法（定义序）: key_for, get, set, invalidate, purge_expired, stats, clear；源码 L60-L1…
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

...
# [MODULE] zephyr.autonomy_core.context_model_strategy
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-ORC_context_model_strategy | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable

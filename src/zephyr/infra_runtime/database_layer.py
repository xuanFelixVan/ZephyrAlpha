...
# [ERROR_CONTRACT] DatabaseLayerError(ZA-INF-0006)——空名/重复注册/协议不符/未知或已关闭后端/借还未注册后端/非法重试参数/重试耗尽时抛
...
class DatabaseLayerError(Exception):
    ...
    错误码 ZA-INF-0006 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-INF-0006"

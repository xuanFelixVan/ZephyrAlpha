...
# [MODULE] zephyr.auto_fix_engine.models

# [INVARIANTS] FixAction.fingerprint MUST be deterministic; FixStatus transitions MUST be legal

# [MODIFY-GUARD] blueprint.md §4.2; __init__.py __all__; _fixer_registry.yaml
...
# [TESTS] tests/auto_fix_engine/test_models.py

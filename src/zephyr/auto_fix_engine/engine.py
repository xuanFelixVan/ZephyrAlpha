...
# [MODULE] zephyr.auto_fix_engine.engine

# [INVARIANTS] 修复MUST通过SafetyGate+FixBudget+CascadeBreaker;行为审计RED永不自动修复

# [MODIFY-GUARD] blueprint.md §3;_fixer_registry.yaml;auto_fix_config.yaml
...
# [TESTS] tests/auto_fix_engine/test_engine.py
...
from zephyr.auto_fix_engine.fix_budget import FixBudget, FixStormGuard
...
from zephyr.auto_fix_engine.fix_reliability import (
    ApprovalQueue,
...
from zephyr.auto_fix_engine.fix_report import FixReportGenerator
...
from zephyr.auto_fix_engine.state_machine import FixState, FixStateMachine
...
class AutoFixEngine:
    ...
    def _load_fixers(self) -> None:
        fixer_map = {
            "zombie_cleaner": ("zephyr.auto_fix_engine.zombie_cleaner", "ZombieCleaner"),
            "all_completer": ("zephyr.auto_fix_engine.all_completer", "AllCompleter"),
            "dedup_extractor": ("zephyr.auto_fix_engine.dedup_extractor", "DedupExtractor"),
            "scaffold_registrar": ("zephyr.auto_fix_engine.scaffold_registrar", "ScaffoldRegistrar"),
            "alignment_syncer": ("zephyr.auto_fix_engine.alignment_syncer", "AlignmentSyncer"),
            "drift_fixer": ("zephyr.auto_fix_engine.drift_fixer", "DriftFixer"),
            "dep_version_fixer": ("zephyr.auto_fix_engine.dep_version_fixer", "DepVersionFixer"),
            "import_fixer": ("zephyr.auto_fix_engine.import_fixer", "ImportFixer"),
            "config_fixer": ("zephyr.auto_fix_engine.config_fixer", "ConfigFixer"),
            "llm_fix_adapter": ("zephyr.auto_fix_engine.llm_fix_adapter", "LLMFixAdapter"),
            "self_heal_agent": ("zephyr.auto_fix_engine.self_heal_agent", "SelfHealAgent"),
        }

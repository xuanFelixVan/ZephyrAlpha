...
# [MODULE] zephyr.auto_fix_engine.batch_fixer
...
# [TESTS] tests/auto_fix_engine/test_batch_fixer.py
...
from zephyr.auto_fix_engine.fix_reliability import ConflictResolver, IdempotencyGuard

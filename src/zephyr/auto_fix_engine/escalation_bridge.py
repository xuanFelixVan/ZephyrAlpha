...
# [MODULE] zephyr.auto_fix_engine.escalation_bridge

# [INVARIANTS] MUST桥接MOD-INF-022 EscalationProtocol;升级失败MUST记录

# [MODIFY-GUARD] blueprint.md §3;_fixer_registry.yaml escalation段
...
# [TESTS] tests/auto_fix_engine/test_escalation_bridge.py
...
from zephyr.auto_fix_engine.models import FixAction, FixStatus

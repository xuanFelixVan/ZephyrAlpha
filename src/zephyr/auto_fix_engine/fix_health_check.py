...
# [MODULE] zephyr.auto_fix_engine.fix_health_check
...
# [TESTS] tests/auto_fix_engine/test_fix_health_check.py
...
from zephyr.auto_fix_engine.models import FixHealthReport

logger = logging.getLogger(__name__)


class FixHealthCheck:
    def __init__(self, db_path: str = "data/auto_fix/auto_fix.db") -> None:

...
# [MODIFY-GUARD] blueprint.md §3;_fixer_registry.yaml llm_fix_adapter段
...
# [TESTS] tests/auto_fix_engine/test_llm_fix_adapter.py
...
from zephyr.auto_fix_engine.fix_safety import SecretLeakGuard
...
class LLMFixAdapter(BaseFixer):
    ...
    def _get_llm_bridge(self) -> Any:
        ...
        try:
            from zephyr.agent_spec.llm_gateway import LLMGateway

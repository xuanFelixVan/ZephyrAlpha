...
# [MODULE] zephyr.auto_fix_engine.compliance_auditor
...
# [TESTS] tests/auto_fix_engine/test_compliance_auditor.py
...
from zephyr.auto_fix_engine.models import ComplianceEvidence, FixAction, FixStatus

logger = logging.getLogger(__name__)


class ComplianceAuditor:
    def __init__(self, db_path: str = "data/auto_fix/auto_fix.db", retention_days: int = 90) -> None:
    ...
    def _ensure_db(self) -> None:
        ...
        conn.execute(
            ...
            "timestamp TEXT, actor TEXT DEFAULT 'auto_fix_engine', confidence TEXT DEFAULT '', "

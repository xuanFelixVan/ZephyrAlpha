# [BLUEPRINT] MOD-INF-031 | 03_modules/_cross_layer/auto-fix-engine/blueprint.md | §4.5

# [MODULE] zephyr.auto_fix_engine.__main__
...
# [TESTS] tests/auto_fix_engine/test_cli.py
...
def main() -> int:
    parser = argparse.ArgumentParser(
        prog="python -m zephyr.auto_fix_engine",

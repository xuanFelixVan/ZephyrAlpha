...
# [MODULE] zephyr.escalation_engine.deadlock_detector
...
# [CONSUMERS] zephyr.escalation_engine.delegation_engine;zephyr.l01_infrastructure.a2a_protocol.layer3_coordination

...
Run: python -m zephyr.escalation_engine.blueprint_code_consistency [--json]
...
DECISION_MAP: list[DecisionMapping] = [
    DecisionMapping(
        ...
        "zephyr.escalation_engine.escalation_engine",
    ...
    DecisionMapping(
        ...
        "自动委托协议 + 四级安全约束",
        DecisionStatus.IMPLEMENTED,
        "zephyr.escalation_engine.delegation_engine",
    ...
    DecisionMapping(
        ...
        "经济护栏 Token预算",
        DecisionStatus.IMPLEMENTED,
        "zephyr.escalation_engine.escalation_models",
    ...
    DecisionMapping(
        ...
        "zephyr.escalation_engine.circuit_breaker",
    ...
    DecisionMapping(
        ...
        "反自动化偏见",
        DecisionStatus.IMPLEMENTED,
        "zephyr.escalation_engine.anti_automation_bias",
    ...
    DecisionMapping(
        ...
        "SLO驱动升级合约",
        DecisionStatus.IMPLEMENTED,
        "zephyr.escalation_engine.slo_contract",
    ...
    DecisionMapping(
        ...
        "冷启动自举策略",
        DecisionStatus.IMPLEMENTED,
        "zephyr.escalation_engine.self_test",

...
# [MODULE] zephyr.escalation_engine.rbac_bridge

# [INVARIANTS] RBAC权限升级必须经过PermissionGuard;不可绕过RBAC检查

# [MODIFY-GUARD] docs/03_modules/l01_infrastructure/escalation-protocol/blueprint.md

# [CONSUMERS] zephyr.escalation_engine.adapter;zephyr.agent_rbac

...
# [MODULE] zephyr.gov_kb._backend_protocol (re-export shim)
# [DOMAIN] D_GOV_KB
# [DEPENDENCIES] zephyr.gov_kb.storage._backend_protocol
# [CONSUMERS] zephyr.research.unified_memory_api; zephyr.knowledge.kb.vms_memory_backend
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] re-export shim — 真源在 zephyr.gov_kb.storage._backend_protocol（SSoT 收敛 2026-07-06）
...
# [TTL] permanent
"""Re-export shim — 真源在 zephyr.gov_kb.storage._backend_protocol（SSoT 收敛 2026-07-06）。

本文件仅重新导出 storage/_backend_protocol.py 的符号以保证向后兼容。
真源：src/zephyr/gov_kb/storage/_backend_protocol.py
"""
from zephyr.gov_kb.storage._backend_protocol import (  # noqa: F401

...
# [MODULE] zephyr.gov_kb.kb_engine.kb_gate_task (re-export shim)
# [DOMAIN] D_GOV_KB
# [DEPENDENCIES] zephyr.gov_kb.kb_gate_task
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] re-export shim — 真源在 zephyr.gov_kb.kb_gate_task（SSoT 收敛 2026-07-06）
...
# [TTL] permanent
"""Re-export shim — 真源在 zephyr.gov_kb.kb_gate_task（SSoT 收敛 2026-07-06）。

本文件仅重新导出根目录 kb_gate_task.py 的符号以保证向后兼容。
真源：src/zephyr/gov_kb/kb_gate_task.py
"""

...
# [DEPENDENCIES] zephyr.shared.contracts.factor_signal; zephyr.shared.contracts.synthesized_signal
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] none
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-signal_synthesizer | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

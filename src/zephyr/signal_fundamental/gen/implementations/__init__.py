# [A_module] module_id=MOD-UNK-implementations_gen_implementations | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
...
# - id: I1
#   name: 包内子模块公共符号
#   fields: import 再导出符号: annotations, DefaultSignalAggregator
#   code: __init__.py import L43
# 层: 算法
# - id: A1
#   name_zh: ① 包公共面再导出
#   name_en: __init__ re-export
#   intro: 再导出 DefaultSignalAggregator, default_signal_aggregator（共 2 符号）
...
#   name_en: __all__
#   intro: DefaultSignalAggregator, default_signal_aggregator

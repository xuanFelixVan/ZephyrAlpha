...
def cmd_discover() -> None:
    from zephyr.intelligence.model_profiling.pipeline.model_discovery import ModelDiscovery
...
def cmd_quick(model_name: str) -> None:
    from zephyr.intelligence.model_profiling.pipeline.profiler import ModelProfiler
...
def cmd_drift(model_name: str) -> None:
    from zephyr.intelligence.model_profiling.pipeline.results_writer import (
        detect_drift,

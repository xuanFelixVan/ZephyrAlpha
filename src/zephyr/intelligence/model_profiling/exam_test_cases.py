...
# [A_module] module_id=MOD-GOV-exam_test_cases | layer=module | stability=stable | safety=L | ai_autonomy=human_gated
# [TTL] permanent
...
_OLY_008_NEEDLES = [
    {  # 针1: 伪造的量子同步 import（git_commit.py）
        ...
        "after": "from zephyr.gov_enforcement.rule_bridge.git_commit_gateway import (",
    },

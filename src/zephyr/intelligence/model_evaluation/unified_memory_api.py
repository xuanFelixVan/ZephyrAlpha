...
# [DEPENDENCIES] zephyr.governance.__init__; zephyr.shared.security.capability; zephyr.integration.vector_memory.vms_memory_backend; zephyr.intelligence.model_evaluation._memory_backend
# [CONSUMERS]
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] none
...
# [ALGO_FLOW] external: docs/03_modules/_domain_intelligence/algo_flow/unified_memory_api.yaml
"""
    ...
    with _singleton_lock:
        if reset or _singleton_api is None:
            ...
            if resolved_backend is None and prefer_vms:
                try:
                    from zephyr.integration.vector_memory.vms_memory_backend import create_vms_backend

...
# [ERROR_CONTRACT] LlmResearchAgentError(ZA-IT-0026)——空任务/非法工具表/白名单外工具/空计划/重复步骤/超轮次护栏/事实回查缺失或未过时抛
...
class LlmResearchAgentError(Exception):
    ...
    错误码 ZA-IT-0026 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-IT-0026"

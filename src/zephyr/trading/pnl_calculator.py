...
# [ALGO_FLOW] external: docs/03_modules/_domain_trading/algo_flow/pnl_calculator.yaml
"""
...
class FeeConfig:
    ...
    默认值反映 2026-08-21 费率口径统一（#233，Owner 裁定：回测以实盘费率为准）:
      - 佣金: 万0.854=0.0000854，最低 ¥5/笔（买入+卖出；Owner 实盘账户实测协议费率；不免五——Owner 2026-08-22 确认）

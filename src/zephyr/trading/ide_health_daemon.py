...
# [DOMAIN] D_TRADING
# [DEPENDENCIES] zephyr.shared.contracts.task_repository_protocol; zephyr.governance.task_repo; zephyr.shared.lifecycle.daemon_registry; zephyr.governance.compliance_rule; docs.03_modules._cross_layer.mcp_servers.blueprint.md; zephyr.governance.kb.pipeline.activate; zephyr.ops.auto_evolution; zephyr.governance.rule_enforcement.adaptive_threshold; docs.03_modules._domain_governance.audit_trail.blueprint.md; docs.03_modules._domain_governance.drift_detector.blueprint.md; docs.03_modules._domain_autonomy_perm.budget_enforcer.blueprint.md; docs.03_modules._domain_autonomy_core.agent_spec.blueprint.md; zephyr.infrastructure.audit_logger

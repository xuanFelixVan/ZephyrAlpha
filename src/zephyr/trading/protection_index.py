...
# [MODULE] zephyr.trading.protection_index
# [DOMAIN] D_TRADING
...
# [TESTS] tests/trading/test_protection_index.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 1 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_trading/algo_flow/protection_index.yaml
"""

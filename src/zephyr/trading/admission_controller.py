...
# [TESTS] tests/trading/test_admission_controller.py; tests/trading/test_admission_response.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 2 个测试）
...
#   intro: class AdmissionController 源码 L250-L402
#   desc: 公共方法（定义序）: circuit_breaker, admit, admit_batch, get_metrics, get_retry_after, reset_circuit_breaker, update_r…

...
# [MODULE] zephyr.trading.feedback_loop.detectors
...
from zephyr.trading.feedback_loop.detectors._anomaly import _SUBMODULES as _ANOMALY_SUBS
from zephyr.trading.feedback_loop.detectors._correlation import _SUBMODULES as _CORRELATION_SUBS
from zephyr.trading.feedback_loop.detectors._drift import _SUBMODULES as _DRIFT_SUBS
from zephyr.trading.feedback_loop.detectors._guard import _SUBMODULES as _GUARD_SUBS
from zephyr.trading.feedback_loop.detectors._reliability import _SUBMODULES as _RELIABILITY_SUBS
...
def __getattr__(name):
    if name in _SUBMODULES:
        mod = importlib.import_module(f"zephyr.trading.feedback_loop.detectors.{name}")
        globals()[name] = mod
        return mod

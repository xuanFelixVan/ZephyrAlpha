...
# [MODULE] zephyr.trading.feedback_loop.diagnosers
...
from zephyr.trading.feedback_loop.diagnosers._cognitive import _SUBMODULES as _COGNITIVE_SUBS
from zephyr.trading.feedback_loop.diagnosers._diagnosis import _SUBMODULES as _DIAGNOSIS_SUBS
from zephyr.trading.feedback_loop.diagnosers._health import _SUBMODULES as _HEALTH_SUBS
from zephyr.trading.feedback_loop.diagnosers._reliability import _SUBMODULES as _RELIABILITY_SUBS
...
def __getattr__(name):
    if name in _SUBMODULES:
        mod = importlib.import_module(f"zephyr.trading.feedback_loop.diagnosers.{name}")
        globals()[name] = mod
        return mod

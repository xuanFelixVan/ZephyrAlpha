...
# [MODULE] zephyr.pipeline.routing_plugins
...
使用：
    from zephyr.pipeline.routing_plugins import PipelineRouter, DEFAULT_PLUGINS
    router = PipelineRouter()
    decision = router.route(hints)

扩展（AI 自治）：
    from zephyr.pipeline.routing_plugins import RoutingPlugin, RoutingContext
...
from zephyr.pipeline.ct_pipe_routing import CtPipeRoutingHints, _make_decision, modules_slice_from_node
from zephyr.pipeline.models import PipelineRouteDecision, M_MODULES, M_MODULE_SPECS

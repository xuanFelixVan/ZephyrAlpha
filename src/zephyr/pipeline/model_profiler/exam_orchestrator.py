...
# [MODULE] zephyr.pipeline.model_profiler.exam_orchestrator
...
from zephyr.pipeline.model_profiler.capability_passport import (
    DEPTH_THRESHOLDS,
    BreadthResult,
    CapabilityPassport,
...
from zephyr.pipeline.model_profiler.exam_test_cases import (
    CASES_BY_CAPABILITY,
    ExamTestCase,
)

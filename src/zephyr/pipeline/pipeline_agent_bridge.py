...
# [MODULE] zephyr.pipeline.pipeline_agent_bridge
...
from zephyr.pipeline.models import M_MODULE_SPECS, ModuleResult, PipelineResult
    ...
    def bridge(
        ...
        *,
        ...
        for mr in pipeline_result.modules_executed:
            ...
            from zephyr.orchestrator.agent_orchestrator import AgentRole

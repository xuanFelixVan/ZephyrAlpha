...
# [MODULE] zephyr.context_engine.parsing.intent_parser
...
# AI-generated: T-3-20 (V-09) three-stage intent parser (ADR-0035)
"""
IntentParser · 意图三阶段级联解析器（V-09）
============================================

Task ID     : T-3-20 (A26)
ADR         : ADR-0035（Intent 三阶段、ChromaDB、LLM fallback）

...
# [MODULE] zephyr.context_engine.support.system_snapshot
...
_MODULE_MANIFESTS: dict[str, str] = {
    "zephyr.gates.gate_engine": "v1.0.0",
    "zephyr.gates.circuit_breaker": "v1.0.0",
    "zephyr.context_engine.system_snapshot": "v1.0.0",
    "zephyr.context_engine.doc_compressor": "v1.0.0",
    "zephyr.context_engine.context_budget_tracker": "v1.0.0",
    "zephyr.shared.capability": "v1.0.0",
    "zephyr.llm_security.process_sandbox": "v1.0.0",
    "zephyr.db.sqlite_schema": "v1.0.0",
}

...
# [MODULE] zephyr.context_engine.verify_paths
...
SOURCE_FILES = {
    ...
    "architecture_context.json": "data",
...
TEST_FILES = {
    "unit/context_engine/test_context_assembler.py": "test",
    "unit/context_engine/test_context_budget_tracker.py": "test",
    "unit/context_engine/test_context_injector.py": "test",
    "unit/context_engine/test_doc_compressor.py": "test",
    "unit/context_engine/test_intent_keyword_mapper.py": "test",
    "unit/context_engine/test_intent_parser.py": "test",
    "unit/context_engine/test_pattern_library.py": "test",
    "unit/context_engine/test_prompt_registry.py": "test",
    "unit/context_engine/test_system_snapshot.py": "test",
    "unit/context_engine/test_context_rot_model.py": "test",
    "unit/context_engine/test_context_evictor.py": "test",
    "unit/context_engine/test_curation_loop.py": "test",
    "unit/context_engine/test_context_evaluator.py": "test",
    "unit/context_engine/test_memory_bank.py": "test",
    "unit/context_engine/test_intent_accuracy.py": "test",
    "unit/context_engine/test_context_pipeline.py": "test",

...
# [MODULE] zephyr.context_engine.context_budget

# [INVARIANTS] MOD-INF-008 四阶段流水线不可绕过; Token 预算硬限制; 原子写入 temp-file+os.replace()

# [MODIFY-GUARD] blueprint.md §4; __init__.py __all__

# [CONSUMERS] blueprint.md §0; zephyr.context_engine 内部模块; zephyr.orchestrator
...
from zephyr.context_engine.token_budget import estimate_tokens, DEFAULT_CONTEXT_TOKEN_BUDGET

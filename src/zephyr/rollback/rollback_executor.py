...
# [MODULE] zephyr.rollback.rollback_executor
...
from zephyr.rollback.sqlite_dumper import SqliteDumper
from zephyr.rollback.rollback_lock import RollbackLock, LockPriority
...
class RollbackExecutor:
    ...
    def _execute(
        ...
        try:
            ...
            try:
                from zephyr.rollback.contract import resolve_exit_code

...
from zephyr.asset_inventory.models import ClassifiedAsset, RegistryEntry
...
class RegistryManager:
    """管理所有注册表的解析——从 registry-of-registries.yaml 自动发现 + 损坏隔离"""
    ...
    def _init_defaults(self) -> None:
        ...
        self._known["docs/registry-of-registries.yaml"] = YamlListAdapter("REG-TIER-000", "registry-of-registries.yaml", asset_key="physical_path")
        ...
        self._known["scripts/script_manifest.yaml"] = YamlDictAdapter("REG-SCRIPT-001", "script_manifest.yaml")
        self._known["config/capacity/risk_register.yaml"] = YamlListAdapter("REG-RISK-001", "risk_register.yaml", asset_key="risk_id")
        self._known["config/capacity/asset_inventory.yaml"] = YamlListAdapter("REG-ASSET-001", "asset_inventory.yaml", asset_key="relative_path")
        ...
        self._known["src/zephyr/pipeline/route_manifest.yaml"] = YamlListAdapter("REG-PIPE-001", "route_manifest.yaml", asset_key="route_id")
        self._known["config/capacity/tech_stack_manifest.yaml"] = YamlListAdapter("REG-CAP-001", "tech_stack_manifest.yaml", asset_key="tech_id")

        self._known["docs/01_policies_and_standards/_registry/catalogs/directory-registry.yaml"] = YamlListAdapter("REG-DIR-001", "directory-registry.yaml", asset_key="path")
        self._known["docs/01_policies_and_standards/_registry/catalogs/document-metadata-index.yaml"] = YamlListAdapter("REG-DOC-001", "document-metadata-index.yaml", asset_key="path")
        ...
        self._known["docs/01_policies_and_standards/_registry/catalogs/gate-registry.yaml"] = YamlListAdapter("REG-GATE-CAT-001", "gate-registry.yaml", asset_key="gate_id")
        self._known["docs/01_policies_and_standards/_registry/catalogs/infrastructure-registry.yaml"] = YamlListAdapter("REG-INFRA-001", "infrastructure-registry.yaml", asset_key="component_id")
        self._known["docs/01_policies_and_standards/_registry/catalogs/task-card-meta-registry.yaml"] = YamlListAdapter("REG-TASK-META-001", "task-card-meta-registry.yaml", asset_key="subsystem_id")
        self._known["docs/01_policies_and_standards/_registry/catalogs/frontmatter-field-registry.yaml"] = YamlListAdapter("REG-FRONTMATTER-001", "frontmatter-field-registry.yaml", asset_key="field_name")
        self._known["docs/01_policies_and_standards/_registry/catalogs/script-health-registry.yaml"] = YamlListAdapter("REG-SCRIPT-HEALTH-001", "script-health-registry.yaml", asset_key="script_id")
        self._known["docs/01_policies_and_standards/_registry/catalogs/registry-of-registries.yaml"] = YamlListAdapter("REG-CROSS-001", "registry-of-registries.yaml", asset_key="field_name")
        self._known["docs/01_policies_and_standards/_registry/catalogs/knowledge-article-registry.yaml"] = YamlListAdapter("REG-KB-001", "knowledge-article-registry.yaml", asset_key="article_id")

        self._known["src/zephyr/drift_detector/_detector_registry.yaml"] = YamlListAdapter("REG-DRIFT-001", "_detector_registry.yaml", asset_key="detector_id")
        self._known["src/zephyr/agent_spec/skill_registry.yaml"] = YamlListAdapter("REG-SKILL-001", "skill_registry.yaml", asset_key="skill_id")
    ...
    def discover_registry_files(self) -> list[Path]:
        paths: list[Path] = []
        main_reg = self._root / "docs" / "registry-of-registries.yaml"
        if main_reg.exists():
        ...
        candidates = [
            ...
            self._root / "scripts" / "script_manifest.yaml",
            self._root / "docs" / "03_modules" / "module-registry.yaml",
            self._root / "docs" / "03_modules" / "blueprint-registry.yaml",
            self._root / "config" / "capacity" / "risk_register.yaml",
            self._root / "config" / "capacity" / "asset_inventory.yaml",
        ]
        for c in candidates:

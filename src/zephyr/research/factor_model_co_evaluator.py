...
# [ERROR_CONTRACT] CoEvaluatorError(ZA-FAC-0003)——评估器缺失或异常/阈值序非法/因子或模型 id 空或重复/未知报告版本时抛
...
# [ALGO_FLOW] external: docs/03_modules/_domain_research/algo_flow/factor_model_co_evaluator.yaml
"""

...
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES]
# [CONSUMERS] src/zephyr/gov_drift/_analysis.py ; tests/git/test_git_bisector.py
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] 溯源结果不可篡改
...
#   code: git_bisector.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① GitBisector
#   name_en: GitBisector
...
#   name_en: public defs
#   intro: GitBisector
#   downstream: src/zephyr/gov_drift/_analysis.py ; tests/git/test_git_bisector.py
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

...
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES]
# [CONSUMERS] src/zephyr/gov_drift/__main__.py; tests/infrastructure/drift_red_blue_adversarial.py; tests/infrastructure/drift/test_drift_e2e_pipeline.py; tests/self_check/test_self_test_verifier.py
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] 自检验证不可跳过
...
# [TTL] permanent
# noqa: m03-duplicate  M03豁免: _read_single_py与ai_construction_detectors._read_single_source是同类源码读取工具,趋同演化非复制粘贴
...
#   code: self_test_verifier.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① SelfTestVerifier
#   name_en: SelfTestVerifier
#   intro: class SelfTestVerifier 源码 L94-L464
#   desc: 公共方法（定义序）: base_dir, check_circular_import, check_cascade_recursion, check_logic_fragmentation, check_data_in…
#   inputs: base_dir
#   outputs: 返回值
...
#   name_en: public defs
#   intro: SelfTestVerifier
#   downstream: src/zephyr/gov_drift/__main__.py; tests/infrastructure/drift_red_blue_adversari…
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

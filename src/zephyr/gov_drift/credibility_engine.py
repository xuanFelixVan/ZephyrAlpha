...
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES]
# [CONSUMERS] src/zephyr/gov_drift/_analysis.py ; src/zephyr/gov_drift/brain_integration.py ; tests/audit/intelligence_audit/test_credibility_engine.py
# [STARTUP] imported
# [MATURITY] production
...
#   code: credibility_engine.py
# 层: 算法
# - id: A1
#   name_zh: ① CredibilityEngine
#   name_en: CredibilityEngine
#   intro: class CredibilityEngine 源码 L82-L175
#   desc: 公共方法（定义序）: set_owner_override, compute, get_score；源码 L82-L175
#   inputs: 无参数
#   outputs: 返回值

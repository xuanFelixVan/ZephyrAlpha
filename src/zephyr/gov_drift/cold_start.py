...
# [CONSUMERS] src/zephyr/governance/behavioral_auditor/__init__.py; src/zephyr/gov_drift/_infrastructure.py; src/zephyr/gov_drift/brain_integration.py (+2 more)
# [STARTUP] imported
# [MATURITY] prototype
# [INVARIANTS] 冷启动必须完整

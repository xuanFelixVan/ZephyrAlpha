...
#   intro: 再导出 AITrainingLoopResult, CascadeAlert, CascadeConfig, CheckpointWriter, Contra…
#   desc: __init__ import L0；__all__ 57 项（AST 事实）
#   inputs: I1
#   outputs: __all__ 公共符号表
# 层: 输出
# - id: O1
#   name_zh: 公共 API 面（57 符号）
#   name_en: __all__
#   intro: AITrainingLoopResult, CascadeAlert, CascadeConfig, CheckpointWriter, ContractDr…

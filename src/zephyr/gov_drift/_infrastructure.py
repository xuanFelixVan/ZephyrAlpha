...
#   code: _infrastructure.py
# 层: 算法
# - id: A1
#   name_zh: ① 包公共面再导出
#   name_en: __init__ re-export
#   intro: 再导出 AbsenceManagerConfig, Alert, AlertRouter, BaselineManager, CanaryComparison…
#   desc: __init__ import L0；__all__ 67 项（AST 事实）
#   inputs: I1
#   outputs: __all__ 公共符号表
# 层: 输出
# - id: O1
#   name_zh: 公共 API 面（67 符号）
#   name_en: __all__
#   intro: AbsenceManagerConfig, Alert, AlertRouter, BaselineManager, CanaryComparison, Ca…

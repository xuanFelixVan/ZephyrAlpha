...
# [CONSUMERS] src/zephyr/governance/ops_governance/phase_check_registry.py
# [STARTUP] imported
# [MATURITY] production
...
# [A_module] module_id=MOD-SEC-chaos_injector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

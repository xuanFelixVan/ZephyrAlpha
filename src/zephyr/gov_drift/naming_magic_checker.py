...
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES]
# [CONSUMERS] src/zephyr/gov_drift/_scanners.py ; tests/audit/quality_static/test_naming_magic_checker.py
# [STARTUP] imported
# [MATURITY] production
...
#   downstream: src/zephyr/gov_drift/_scanners.py ; tests/audit/quality_static/test_naming_magic_checker.py
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

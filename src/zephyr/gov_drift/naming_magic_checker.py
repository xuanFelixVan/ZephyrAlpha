...
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES]
# [CONSUMERS] src/zephyr/gov_drift/_scanners.py ; tests/audit/test_naming_magic_checker.py
# [STARTUP] imported
# [MATURITY] production
...
# [A_module] module_id=MOD-SEC-naming_magic_checker | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

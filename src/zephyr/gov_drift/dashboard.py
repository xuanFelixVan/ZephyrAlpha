...
# [DOMAIN] D_GOV_DRIFT
# [DEPENDENCIES]
# [CONSUMERS] src/zephyr/gov_drift/_infrastructure.py ; tests/ba/test_ba_dashboard.py
# [STARTUP] imported
# [MATURITY] production
# [INVARIANTS] 仪表板数据只读
...
# [ALGO_FLOW] external: docs/03_modules/_domain_gov_drift/algo_flow/dashboard.yaml
"""

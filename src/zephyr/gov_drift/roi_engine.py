...
# [A_module] module_id=MOD-SEC-roi_engine | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
class ROIEngine:
    ...
    @effort_feedback.setter
    def effort_feedback(self, value):

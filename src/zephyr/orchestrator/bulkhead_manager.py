...
# [MODULE] zephyr.orchestrator.bulkhead_manager
...
BULKHEAD_QUOTAS: dict[str, dict] = {
    ...
    "context_engine": {"threads": 4, "sqlite_connections": 2, "memory_mb": 256},
    "gate_engine": {"threads": 4, "sqlite_connections": 1, "memory_mb": 64},
    "pipeline": {"threads": 2, "sqlite_connections": 1, "memory_mb": 64},
    "feedback_loop": {"threads": 4, "sqlite_connections": 2, "memory_mb": 128},
    "vector_memory": {"threads": 2, "sqlite_connections": 1, "memory_mb": 512},
    "database": {"threads": 2, "sqlite_connections": 5, "memory_mb": 128},
    "llm_security": {"threads": 2, "sqlite_connections": 1, "memory_mb": 128},
    "system_telemetry": {"threads": 2, "sqlite_connections": 1, "memory_mb": 64},

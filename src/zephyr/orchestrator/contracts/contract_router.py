...
#   code: contract_router.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① ContractRouter
#   name_en: ContractRouter
#   intro: class ContractRouter 源码 L152-L187
#   desc: 公共方法（定义序）: route, can_route, get_target_system, list_routable；源码 L152-L187
#   inputs: registry
#   outputs: 返回值

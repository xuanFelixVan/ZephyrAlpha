...
# [MODULE] zephyr.orchestrator.rollback_manager
...
#   code: rollback_manager.py 顶层公共函数形参（AST 提取）
# 层: 算法
# - id: A1
#   name_zh: ① RollbackManager
#   name_en: RollbackManager
#   intro: 实现状态回滚：记录操作日志、支持 undo。
#   desc: 实现状态回滚：记录操作日志、支持 undo。；公共方法（定义序）: checkpoint, rollback_to, list_checkpoints, undo_last；源码 L99-L280
#   inputs: db_path
#   outputs: 返回值

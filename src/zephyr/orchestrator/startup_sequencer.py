...
STARTUP_COMPONENTS: dict[StartupLayer, list[str]] = {
    ...
    StartupLayer.L2_VMS: ["vector_memory"],
    StartupLayer.L3_FLE: ["feedback_loop"],
    StartupLayer.L4_CORE_SERVICES: ["orchestrator", "script_system", "knowledge_base",
                                      "context_engine", "gate_engine", "pipeline",
                                      "llm_security", "mcp_servers"],
    StartupLayer.L5_TELEMETRY: ["system_telemetry"],
}

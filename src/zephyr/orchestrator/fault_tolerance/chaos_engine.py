...
# [MODULE] zephyr.orchestrator.fault_tolerance.chaos_engine
...
# [TESTS] tests/chaos/test_chaos_engine.py; tests/chaos/test_chaos_engine_ops.py; tests/chaos/test_chaos_hooks.py  # 2026-09-05 STEWARD B20 重锚：AI-00 修复脚本 src. 前缀 bug 漏网（AST/patch 直查 3 个测试）
...
# [ALGO_FLOW] external: docs/03_modules/_domain_orchestrator/algo_flow/chaos_engine.yaml
"""

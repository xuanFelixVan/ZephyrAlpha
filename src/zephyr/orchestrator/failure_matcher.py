...
# [MODULE] zephyr.orchestrator.failure_matcher
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-ORC_failure_matcher | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

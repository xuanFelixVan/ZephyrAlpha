...
#   code: startup_sequencer.py
# 层: 算法
# - id: A1
#   name_zh: ① StartupSequencer
#   name_en: StartupSequencer
#   intro: class StartupSequencer 源码 L106-L148
#   desc: 公共方法（定义序）: states, get_order, get_layer_components, start_layer, complete_layer；源码 L106-L148
#   inputs: 无参数
#   outputs: 返回值
...
# [MODULE] zephyr.orchestrator.lifecycle.startup_sequencer

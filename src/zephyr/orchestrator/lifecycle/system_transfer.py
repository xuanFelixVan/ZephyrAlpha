...
# [MODULE] zephyr.orchestrator.lifecycle.system_transfer
...
#   code: system_transfer.py
# 层: 算法
# - id: A1
#   name_zh: ① SystemTransferManager
#   name_en: SystemTransferManager
#   intro: class SystemTransferManager 源码 L49-L54
#   desc: 公共方法（定义序）: transfer, verify_health_after_transfer；源码 L49-L54
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

...
# [MODULE] zephyr.orchestrator.execution.wave_generator
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-ORC-wave_generator | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

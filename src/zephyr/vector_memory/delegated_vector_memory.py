...
# [MODULE] zephyr.vector_memory.delegated_vector_memory
...
from zephyr.kb.unified_memory_api import UnifiedMemoryAPI, WriteTrace, get_unified_memory_api
from zephyr.vector_memory.interface import MemoryEntry, VectorMemoryBase

...
# [MODULE] zephyr.vector_memory.collection_schemas
...
# [TESTS] tests/unit/vector_memory/test_vector_memory.py; tests/adversarial/test_cross_layer_systems_red_team.py

...
# [MODULE] zephyr.vector_memory.design_principles
...
# [TESTS] tests/unit/vector_memory/test_vector_memory.py
...
from zephyr.vector_memory.collection_schemas import (
    ALLOWED_DIMENSIONS,
...
from zephyr.vector_memory.vms_errors import (
    DimensionError,
...
class DesignPrinciplesEnforcer:
    ...
    def validate_provenance(metadata: dict[str, Any] | None) -> None:
        ...
        from zephyr.vector_memory.vms_schemas import WriteTrace

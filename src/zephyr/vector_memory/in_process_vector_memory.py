...
from zephyr.vector_memory.collection_manager import (
    CollectionInfo,
    CollectionManager,
    COLLECTION_NAMES,
    VMS_PERSIST_DIR,
...
class InProcessVectorMemory:
    ...
    def _init_provenance_enforcer() -> Any:
        from zephyr.vector_memory.provenance_enforcer import ProvenanceEnforcer
    ...
    def start(self) -> None:
        ...
        from zephyr.vector_memory.bridge_layer import BridgeLayer

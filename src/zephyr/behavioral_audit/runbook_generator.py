...
# [MODULE] zephyr.behavioral_audit.runbook_generator
...
def generate_runbook(event: DriftEvent) -> str:
    ...
    sections.append(f"- Blueprint: `docs/03_modules/_domain-infra_ops/drift-detector/blueprint.md`")


    sections.append(f"- Detector Registry: `src/zephyr/behavioral-auditor/_detector-registry.yaml`")


    sections.append(f"- State Machine: `src/zephyr/behavioral-auditor/state_machine.py`")


    sections.append(f"- Incident Postmortem: check `src/zephyr/behavioral-auditor/incident_postmortem.py`")

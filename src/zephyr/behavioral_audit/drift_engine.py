...
# [MODULE] zephyr.behavioral_audit.drift_engine
    ...
    async with sem:
        ...
        try:
            ...
            proc = await asyncio.create_subprocess_exec(
                "python", script_path, *detector.script_args, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
            ...
            return {
                ...
                "events": [_event_to_dict(_create_drift_event(detector, f"Detector timed out after {detector.timeout_seconds}s"))],

...
def _l0_startup_probe(project_root, result):
    ...
    try:
        ...
        from zephyr.governance.behavioral_auditor.self_check import bootstrap_self_check, check_core_files, check_registry_parsable
...
def _l3_reconcile(result, scan_level="LIGHT"):
    ...
    try:
        ...
        try:
            ...
            from zephyr.governance.behavioral_auditor.forensics_engine import ForensicsEngine, ForensicsConfig
        ...
        from zephyr.integration.shared_08.contracts.protocols import RecoveryTriggerProtocol

...
# [MODULE] zephyr.drift_detector.runbook_generator
...
def generate_runbook(event: DriftEvent) -> str:
    ...
    sections.append("")
    sections.append(f"- Blueprint: `docs/03_modules/l01_infrastructure/drift-detector/blueprint.md`")
    sections.append(f"- Detector Registry: `src/zephyr/drift_detector/_detector_registry.yaml`")
    sections.append(f"- State Machine: `src/zephyr/drift_detector/state_machine.py`")
    sections.append(f"- Incident Postmortem: check `src/zephyr/drift_detector/incident_postmortem.py`")

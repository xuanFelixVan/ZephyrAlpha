...
# [MODULE] zephyr.signal_ashare.ml_forecast.next_day_8state_forecast
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/next_day_8state_forecast.yaml
"""

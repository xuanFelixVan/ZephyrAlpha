...
# [MODULE] zephyr.signal_ashare.ml_forecast.causal_ml_engine
...
# [ERROR_CONTRACT] CausalMlError(ZA-SIG-0137)——空treatment/空outcome/未知通道/非法显著性阈值/空数据指纹/空变量集或含空白变量时抛
# [TESTS] tests/signal_ashare/ml_forecast/test_causal_ml_engine.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/causal_ml_engine.yaml
"""
...
class CausalMlError(Exception):
    ...
    错误码 ZA-SIG-0137 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-SIG-0137"

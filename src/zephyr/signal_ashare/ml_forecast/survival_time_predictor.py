...
# [MODULE] zephyr.signal_ashare.ml_forecast.survival_time_predictor
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/survival_time_predictor.yaml
"""

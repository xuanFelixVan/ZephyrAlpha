...
# [MODULE] zephyr.signal_ashare.ml_forecast.similar_day_inference
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] numpy; pandas; zephyr.signal_ashare.sentiment.sentiment_cycle（28号五阶段定义 PHASE_ORDER/SentimentPhase 只读复用，不重复造）
...
# [TESTS] tests/signal_ashare/ml_forecast/test_similar_day_inference.py
...
from zephyr.signal_ashare.sentiment.sentiment_cycle import PHASE_ORDER, SentimentPhase

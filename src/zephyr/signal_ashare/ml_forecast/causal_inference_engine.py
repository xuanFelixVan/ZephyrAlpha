...
# [MODULE] zephyr.signal_ashare.ml_forecast.causal_inference_engine
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] numpy
# [CONSUMERS] zephyr.signal_ashare.ml_forecast.causal_factor_validator; zephyr.signal_ashare.screening.event_driven_screener（传导链风险数值消费，消费方 [DEPENDENCIES] 互认解耦设计，无 import 依赖）
# [STARTUP] imported
# [MATURITY] production
...
#   downstream: zephyr.signal_ashare.ml_forecast.causal_factor_validator; zephyr.signal_ashare.event_driven…
# [/ALGO_FLOW]
#
# 边:
# I1 --> A1

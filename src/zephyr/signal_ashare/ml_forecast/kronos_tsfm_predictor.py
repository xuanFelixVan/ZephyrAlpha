...
# [MODULE] zephyr.signal_ashare.ml_forecast.kronos_tsfm_predictor
...
# [TESTS] tests/signal_ashare/ml_forecast/test_kronos_tsfm_predictor.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/kronos_tsfm_predictor.yaml
"""

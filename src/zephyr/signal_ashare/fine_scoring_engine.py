...
# [CONSUMERS] zephyr.signal_ashare.screening.event_driven_screener（经 2026-09-05 AI-08 审计实证未接线——接线待排期）
# [STARTUP] imported
# [MATURITY] production
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/fine_scoring_engine.yaml
"""

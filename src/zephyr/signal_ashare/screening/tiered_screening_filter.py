...
# [MODULE] zephyr.signal_ashare.screening.tiered_screening_filter
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.screening.selection_funnel_skeleton（MOD-SIG-086 共享骨架）
# [CONSUMERS] zephyr.signal_ashare.screening.coarse_screening_funnel（经 2026-09-05 AI-08 审计实证未接线——接线待排期）; zephyr.signal_ashare.screening.screening_funnel_report（消费实证）
# [STARTUP] imported
# [MATURITY] production
...
#   downstream: zephyr.signal_ashare.screening.coarse_screening_funnel; zephyr.signal_ashare.screening_fu…
# - id: O2
#   name_zh: bool | None
#   name_en: bool | None
#   intro: 顶层公共函数返回值（真实返回注解，AST 提取）

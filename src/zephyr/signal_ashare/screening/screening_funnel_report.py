...
# [MODULE] zephyr.signal_ashare.screening.screening_funnel_report
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.screening.tiered_screening_filter（MOD-SIG-046 消费）; zephyr.signal_ashare.screening.coarse_screening_funnel（MOD-SIG-047 消费）; zephyr.signal_ashare.fine_scoring_engine（MOD-SIG-048 消费）; zephyr.signal_ashare.screening.event_driven_screener（MOD-SIG-049 消费）
...
# [TESTS] tests/signal_ashare/screening/test_screening_funnel_report.py

...
# [MODULE] zephyr.signal_ashare.limit_up.youzi_relay_emotion_engine
...
# [ERROR_CONTRACT]
# [TESTS] tests/signal_ashare/limit_up/test_youzi_relay_emotion_engine.py
...
#   downstream: zephyr.signal_ashare.strategy_signal.dual_engine_fusion_decision_engine（D-SIGNAL-35 双引擎融合决策，# [CONSUMERS] 头）
# [/ALGO_FLOW]
#
# 边:
# I1 --> F1

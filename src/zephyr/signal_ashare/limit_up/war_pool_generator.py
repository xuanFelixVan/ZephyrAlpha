...
# [MODULE] zephyr.signal_ashare.limit_up.war_pool_generator
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.mainline_probability（MOD-SIG-064 复用）; zephyr.signal_ashare.mainline_candidates（MOD-SIG-061 复用）; zephyr.signal_ashare.sector.sector_leader（MOD-SIG-062 复用）
...
# [TESTS] tests/signal_ashare/limit_up/test_war_pool_generator.py

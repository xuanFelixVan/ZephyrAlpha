...
# [MODULE] zephyr.signal_ashare.limit_up.seat_pattern_analyzer
...
# [TESTS] tests/signal_ashare/limit_up/test_seat_pattern_analyzer.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/seat_pattern_analyzer.yaml
"""

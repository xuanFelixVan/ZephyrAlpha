...
# [MODULE] zephyr.signal_ashare.intraday_t0.t0_trading_pipeline
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.intraday_t0.t0_point_analyzer（MOD-SIG-068 信号源复用，testing）；executor 注入契约（生产侧由集成批接 MOD-SELL-018 t_trade_coordinator，本模块不 import 跨域 sell_decision）
...
# [TESTS] tests/signal_ashare/intraday_t0/test_t0_trading_pipeline.py

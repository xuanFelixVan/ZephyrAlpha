...
# [MODULE] zephyr.signal_ashare.intraday_t0.t0_point_analyzer
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.intraday_t0.intraday_buy_sell_point_analyzer（MOD-SIG-024 复用，prod）; 分钟bar由调用方注入（生产编排可接 c1_market.kline_1min 只读）
...
# [TESTS] tests/signal_ashare/intraday_t0/test_t0_point_analyzer.py

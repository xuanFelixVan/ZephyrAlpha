...
# [MODULE] zephyr.signal_ashare.intraday_t0.day_trade_pnl_estimator
...
# [ERROR_CONTRACT] DayTradePnlError(ZA-SIG-0139)——费率模型缺失/费率越界/价格非正/股数非正整数/实现盈亏非有限值/非法配置时抛
# [TESTS] tests/signal_ashare/intraday_t0/test_day_trade_pnl_estimator.py
...
class DayTradePnlError(Exception):
    ...
    错误码 ZA-SIG-0139 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-SIG-0139"

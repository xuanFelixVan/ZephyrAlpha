...
# [MODULE] zephyr.signal_ashare.strategy_signal.signal_weight_adjuster
...
# [ERROR_CONTRACT] SignalWeightError(ZA-SIG-0150)——未注册信号/重复注册/空signal_id/指标越界/无指标样本/未知版本/非法配置时抛
# [TESTS] tests/signal_ashare/strategy_signal/test_signal_weight_adjuster.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/signal_weight_adjuster.yaml
"""
...
class SignalWeightError(Exception):
    ...
    错误码 ZA-SIG-0150 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-SIG-0150"

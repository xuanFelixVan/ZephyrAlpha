...
# [MODULE] zephyr.signal_ashare.strategy_signal.pattern_to_signal_mapper
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.strategy_signal.unified_pattern_engine（MOD-SIG-091 PatternEvent 契约，testing）
...
# [TESTS] tests/signal_ashare/strategy_signal/test_pattern_to_signal_mapper.py

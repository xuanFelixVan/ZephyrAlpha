...
# [MODULE] zephyr.signal_ashare.strategy_signal.signal_factory
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.ml_forecast.conditional_density_predictor（MOD-SIG-043 DensityForecast 契约复用，prod）
...
# [TESTS] tests/signal_ashare/strategy_signal/test_signal_factory.py

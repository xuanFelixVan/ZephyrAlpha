...
# [DOMAIN] D_SIGNAL
# [DEPENDENCIES] scripts.data.pattern_event_backfill(扫描器正身,subprocess); scripts.data.pattern_win_rate_materialize(物化正身,subprocess)
# [CONSUMERS] zephyr.data.implementations.internal_compute_provider(pattern_event/pattern_win_rate_materialize capability 分支,JOB-108)

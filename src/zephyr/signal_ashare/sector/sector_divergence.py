...
# [MODULE] zephyr.signal_ashare.sector.sector_divergence
...
# [TESTS] tests/signal_ashare/sector/test_sector_divergence.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/sector_divergence.yaml
"""

...
# [ERROR_CONTRACT] TcpRmError(ZA-SIG-0154)——非法配置（覆盖率/步长/增益/容差/护栏越界）/point或actual非有限/回测序列空或长度不符时抛
...
class TcpRmError(Exception):
    ...
    错误码 ZA-SIG-0154 已登记转正（2026-09-06 Owner 批准批）。
    """

    error_code = "ZA-SIG-0154"

...
# [DEPENDENCIES] zephyr.signal_ashare.mainline_candidates（MOD-SIG-061 复用）; zephyr.signal_ashare.sector.sector_leader（MOD-SIG-062 复用）; c1_market.money_flow（只读）; c1_market.sector_constituent（只读）

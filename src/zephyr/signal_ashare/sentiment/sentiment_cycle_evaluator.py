...
# [MODULE] zephyr.signal_ashare.sentiment.sentiment_cycle_evaluator
# [DOMAIN] D_ASHARE_SIGNAL
# [DEPENDENCIES] zephyr.signal_ashare.sentiment.sentiment_cycle(SentimentPhase/PHASE_ORDER/evaluate_locator_accuracy)
...
# [TESTS] tests/signal_ashare/sentiment/test_sentiment_cycle_evaluator.py

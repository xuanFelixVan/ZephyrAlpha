...
# [MODULE] zephyr.signal_ashare.sentiment.option_sentiment
...
# [TESTS] tests/signal_ashare/sentiment/test_option_sentiment.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/option_sentiment.yaml
"""

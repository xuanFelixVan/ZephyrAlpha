...
# [MODULE] zephyr.signal_ashare.sentiment.sell_news_overdraft_detector
...
# [TESTS] tests/signal_ashare/sentiment/test_sell_news_overdraft_detector.py
...
# [ALGO_FLOW] external: docs/03_modules/_domain_signal/algo_flow/sell_news_overdraft_detector.yaml
"""

...
# [MODULE] zephyr.signal_ashare.sentiment.extreme_sentiment_reversal_detector
...
# [TESTS] tests/signal_ashare/sentiment/test_extreme_sentiment_reversal_detector.py

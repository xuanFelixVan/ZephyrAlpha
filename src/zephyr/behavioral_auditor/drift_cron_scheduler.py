...
# [MODULE] zephyr.behavioral_auditor.drift_cron_scheduler
...
from zephyr.core.lifecycle.daemon_registry import DaemonRegistry, DaemonState, registry
...
class DriftCronScheduler:
    ...
    def _run_scan(self, level: str):
        ...
        try:
            ...
            from zephyr.behavioral_auditor.drift_engine import scan, ScanLevel

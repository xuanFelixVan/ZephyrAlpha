...
# [MODULE] zephyr.behavioral_auditor.brain_integration
...
def _l0_startup_probe(project_root, result):
    ...
    try:
        ...
        from zephyr.behavioral_auditor.self_check import bootstrap_self_check, check_core_files, check_registry_parsable
...
def _l2_liveness_probe(result):
    ...
    try:
        ...
        try:
            ...
            from zephyr.behavioral_auditor.orphan_scanner import OrphanScanner
        ...
        try:
            ...
            from zephyr.behavioral_auditor.credibility_engine import CredibilityEngine
        ...
        try:
            ...
            from zephyr.behavioral_auditor.correlation_engine import CorrelationEngine
...
def _l3_reconcile(result, scan_level="LIGHT"):
    ...
    try:
        ...
        try:
            ...
            from zephyr.behavioral_auditor.forensics_engine import ForensicsEngine, ForensicsConfig
...
def session_entry_full_probe(project_root=""):
    ...
    from zephyr.behavioral_auditor.cold_start import session_entry_activate

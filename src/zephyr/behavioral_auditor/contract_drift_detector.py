...
# [MODULE] zephyr.behavioral_auditor.contract_drift_detector

# [INVARIANTS] z-score>5.0判定为漂移;baseline_std==0时使用0.001防止除零;DriftAlert写入_drift_buffer

# [MODIFY-GUARD] docs/03_modules/l01_infrastructure/drift-detector/blueprint.md;src/zephyr/system_telemetry/contract_metrics.py

# [CONSUMERS] src/zephyr/system_telemetry/contract_metrics.py(委托调用)

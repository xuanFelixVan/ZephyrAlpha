...
# [MODULE] zephyr.behavioral_auditor.runbook_generator
...
def generate_runbook(event: DriftEvent) -> str:
    ...
    sections.append(f"- Detector Registry: `src/zephyr/behavioral_auditor/_detector_registry.yaml`")


    sections.append(f"- State Machine: `src/zephyr/behavioral_auditor/state_machine.py`")


    sections.append(f"- Incident Postmortem: check `src/zephyr/behavioral_auditor/incident_postmortem.py`")

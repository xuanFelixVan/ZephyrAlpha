...
# [MODULE] zephyr.behavioral_auditor.self_test_verifier
            ...
            for fname in os.listdir(self._base_dir):
                ...
                for node in ast.walk(tree):
                    ...
                    if isinstance(node, ast.ImportFrom):
                        ...
                        if node.module and node.module.startswith("zephyr.behavioral_auditor"):


                            target = node.module.replace("zephyr.behavioral_auditor.", "") + ".py"

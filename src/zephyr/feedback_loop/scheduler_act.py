...
#   code: scheduler_act.py
# 层: 算法
# - id: A1
#   name_zh: ① ActPhaseHandler
#   name_en: ActPhaseHandler
#   intro: class ActPhaseHandler 源码 L161-L288
#   desc: 公共方法（定义序）: run_act, run_verify；源码 L161-L288
#   inputs: 无参数
#   outputs: 返回值

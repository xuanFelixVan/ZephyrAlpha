...
# [MODULE] zephyr.feedback_loop.diagnosers.cognitive.tone_adapter
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-tone_adapter | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

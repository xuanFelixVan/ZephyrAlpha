...
# [MODULE] zephyr.feedback_loop.diagnosers.health.fle_self_slo_metrics
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-fle_self_slo_metrics | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

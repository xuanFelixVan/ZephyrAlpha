...
#   code: statistical_hygiene_auditor.py
# 层: 算法
# - id: A1
#   name_zh: ① StatisticalHygieneAuditor
#   name_en: StatisticalHygieneAuditor
#   intro: class StatisticalHygieneAuditor 源码 L79-L190
#   desc: 公共方法（定义序）: record_threshold_attempt, set_active_metrics, record_anomaly_confirmation, check_survivorship_bias…
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: StatisticalHygieneAuditor

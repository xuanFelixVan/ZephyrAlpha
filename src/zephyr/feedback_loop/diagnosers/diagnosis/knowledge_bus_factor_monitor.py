...
# [MODULE] zephyr.feedback_loop.diagnosers.diagnosis.knowledge_bus_factor_monitor
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-knowledge_bus_factor_monitor | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

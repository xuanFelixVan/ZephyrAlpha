...
# [MODULE] zephyr.feedback_loop.diagnosers.diagnosis.incident_knowledge_injector
...
#   code: incident_knowledge_injector.py
# 层: 算法
# - id: A1
#   name_zh: ① IncidentKnowledgeInjector
#   name_en: IncidentKnowledgeInjector
#   intro: class IncidentKnowledgeInjector 源码 L68-L149
#   desc: 公共方法（定义序）: extract_and_inject, validate_rules, get_active_rules；源码 L68-L149
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: IncidentKnowledgeInjector

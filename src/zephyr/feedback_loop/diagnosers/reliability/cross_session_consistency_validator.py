...
# [MODULE] zephyr.feedback_loop.diagnosers.reliability.cross_session_consistency_validator
...
# [ALGO_FLOW] external: docs/03_modules/_domain_feedback_loop/algo_flow/diagnosers/reliability/cross_session_consistency_validator.yaml
"""

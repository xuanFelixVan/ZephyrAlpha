...
# [MODULE] zephyr.feedback_loop.diagnosers.reliability.latency_slo
...
# [ALGO_FLOW] external: docs/03_modules/_domain_feedback_loop/algo_flow/diagnosers/reliability/latency_slo.yaml
"""

...
# [MODULE] zephyr.feedback_loop.diagnosers.reliability.guard_self_consistency_auditor
...
#   code: guard_self_consistency_auditor.py
# 层: 算法
# - id: A1
#   name_zh: ① GuardSelfConsistencyAuditor
#   name_en: GuardSelfConsistencyAuditor
#   intro: class GuardSelfConsistencyAuditor 源码 L63-L121
#   desc: 公共方法（定义序）: record_outcome, audit_consistency；源码 L63-L121
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: GuardSelfConsistencyAuditor

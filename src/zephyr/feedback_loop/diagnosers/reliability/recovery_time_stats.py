...
#   code: recovery_time_stats.py
# 层: 算法
# - id: A1
#   name_zh: ① RecoveryTimeStats
#   name_en: RecoveryTimeStats
#   intro: class RecoveryTimeStats 源码 L62-L102
#   desc: 公共方法（定义序）: record_incident, get_global_mttr；源码 L62-L102
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

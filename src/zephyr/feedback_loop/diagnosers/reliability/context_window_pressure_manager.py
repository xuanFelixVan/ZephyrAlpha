...
#   code: context_window_pressure_manager.py
# 层: 算法
# - id: A1
#   name_zh: ① ContextWindowPressureManager
#   name_en: ContextWindowPressureManager
#   intro: class ContextWindowPressureManager 源码 L65-L143
#   desc: 公共方法（定义序）: add_entry, check_pressure, compress, prioritize, get_summary；源码 L65-L143
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: ContextWindowPressureManager

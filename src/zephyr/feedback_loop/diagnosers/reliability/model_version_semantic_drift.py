...
# [MODULE] zephyr.feedback_loop.diagnosers.reliability.model_version_semantic_drift
...
#   code: model_version_semantic_drift.py
# 层: 算法
# - id: A1
#   name_zh: ① ModelVersionSemanticDrift
#   name_en: ModelVersionSemanticDrift
#   intro: class ModelVersionSemanticDrift 源码 L78-L225
#   desc: 公共方法（定义序）: register_model, record_benchmark, check_semantic_drift, check_deprecation_proximity, get_drift_sum…
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: ModelVersionSemanticDrift

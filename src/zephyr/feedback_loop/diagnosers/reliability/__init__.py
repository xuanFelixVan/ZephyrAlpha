...
# [MODULE] zephyr.feedback_loop.diagnosers.reliability
...
#   intro: 再导出 amplification_guard, api_dependency_metrics, burn_rate_alerter, burnout_ala…
#   desc: __init__ import L0；__all__ 35 项（AST 事实）
#   inputs: I1
#   outputs: __all__ 公共符号表
# 层: 输出
# - id: O1
#   name_zh: 公共 API 面（35 符号）
#   name_en: __all__
#   intro: amplification_guard, api_dependency_metrics, burn_rate_alerter, burnout_alarm,…

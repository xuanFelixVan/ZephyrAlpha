...
# [MODULE] zephyr.feedback_loop.diagnosers.reliability.system_entropy_monitor
...
#   code: system_entropy_monitor.py
# 层: 算法
# - id: A1
#   name_zh: ① SystemEntropyMonitor
#   name_en: SystemEntropyMonitor
#   intro: class SystemEntropyMonitor 源码 L66-L158
#   desc: 公共方法（定义序）: compute_and_record, analyze_trend；源码 L66-L158
#   inputs: 无参数
#   outputs: 返回值

...
#   code: cross_guard_conflict_detector.py
# 层: 算法
# - id: A1
#   name_zh: ① CrossGuardConflictDetector
#   name_en: CrossGuardConflictDetector
#   intro: class CrossGuardConflictDetector 源码 L61-L115
#   desc: 公共方法（定义序）: record_decision_batch, detect_conflicts, get_top_conflicts；源码 L61-L115
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: CrossGuardConflictDetector

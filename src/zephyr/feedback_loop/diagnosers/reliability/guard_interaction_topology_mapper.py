...
# [MODULE] zephyr.feedback_loop.diagnosers.reliability.guard_interaction_topology_mapper
...
# [ALGO_FLOW] external: docs/03_modules/_domain_feedback_loop/algo_flow/diagnosers/reliability/guard_interaction_topology_mapper.yaml
"""

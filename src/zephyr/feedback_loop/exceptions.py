...
#   intro: 纯声明类（无公共方法，AST 事实）: ForensicContext, FLEBaseException, DiagnosisError, RepairEr…
#   desc: 数据契约/异常/枚举声明共 6 类；无算法流程（AST 事实）
#   inputs: I1
#   outputs: 数据契约类集合
# 层: 输出
# - id: O1
...
#   intro: ForensicContext, FLEBaseException, DiagnosisError, RepairError, GateBlockedErro…

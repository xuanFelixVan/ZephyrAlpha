...
# [MODULE] zephyr.feedback_loop.tests.e2e
...
# - id: I1
#   name: 包子模块导入请求
#   fields: import zephyr.feedback_loop.tests.e2e 触发
#   code: L16 from . import integration_test_pipeline
# 层: 算法
# - id: A1
#   name_zh: 子模块 eager 导入与门面再导出
#   name_en: subpackage_eager_reexport
#   intro: from . import integration_test_pipeline 并以 __all__ 声明门面，无附加逻辑
#   code: __init__ 模块体
# 层: 输出
# - id: O1
#   name_zh: 包门面符号
#   name_en: package_facade_symbols
#   intro: __all__ 列出的子模块句柄（integration_test_pipeline）

...
#   code: ci_cd_pre_scanner.py
# 层: 算法
# - id: A1
#   name_zh: ① CICDPreScanner
#   name_en: CICDPreScanner
#   intro: class CICDPreScanner 源码 L55-L57
#   desc: 公共方法（定义序）: pre_check；源码 L55-L57
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

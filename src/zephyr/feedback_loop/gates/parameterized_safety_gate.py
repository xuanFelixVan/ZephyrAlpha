...
#   code: parameterized_safety_gate.py
# 层: 算法
# - id: A1
#   name_zh: ① ParameterizedSafetyGate
#   name_en: ParameterizedSafetyGate
#   intro: class ParameterizedSafetyGate 源码 L191-L330
#   desc: 公共方法（定义序）: load_config, evaluate, is_blocked, reject_trace；源码 L191-L330
#   inputs: 无参数
#   outputs: 返回值

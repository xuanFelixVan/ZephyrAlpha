...
# [MODULE] zephyr.feedback_loop.gates._security_gates
...
# [A_module] module_id=MOD-GOV-security_gates | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

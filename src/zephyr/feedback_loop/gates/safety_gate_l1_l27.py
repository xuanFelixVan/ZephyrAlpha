...
# [MODULE] zephyr.feedback_loop.gates.safety_gate_l1_l27
...
#   code: safety_gate_l1_l27.py
# 层: 算法
# - id: A1
#   name_zh: ① SafetyGatePipeline
#   name_en: SafetyGatePipeline
#   intro: class SafetyGatePipeline 源码 L105-L317
#   desc: 公共方法（定义序）: evaluate, is_blocked, reject_trace；源码 L105-L317
#   inputs: 无参数
#   outputs: 返回值

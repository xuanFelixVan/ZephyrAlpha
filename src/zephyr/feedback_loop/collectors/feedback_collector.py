...
# [MODULE] zephyr.feedback_loop.collectors.feedback_collector
...
# [ALGO_FLOW] external: docs/03_modules/_domain_feedback_loop/algo_flow/collectors/feedback_collector.yaml
"""

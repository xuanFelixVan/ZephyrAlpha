...
# [MODULE] zephyr.feedback_loop.collectors.metrics_collector
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-metrics_collector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

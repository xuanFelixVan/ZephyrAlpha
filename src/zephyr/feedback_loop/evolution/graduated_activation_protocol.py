...
# [MODULE] zephyr.feedback_loop.evolution.graduated_activation_protocol
...
#   code: graduated_activation_protocol.py
# 层: 算法
# - id: A1
#   name_zh: ① GraduatedActivationProtocol
#   name_en: GraduatedActivationProtocol
#   intro: class GraduatedActivationProtocol 源码 L81-L199
#   desc: 公共方法（定义序）: register_rule, record_outcome, evaluate_promotion, get_active_canary_rules, get_stable_rules, get_…
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: GraduatedActivationProtocol

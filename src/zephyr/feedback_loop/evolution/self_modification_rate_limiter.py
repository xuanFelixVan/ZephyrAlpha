...
# [MODULE] zephyr.feedback_loop.evolution.self_modification_rate_limiter
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-self_modification_rate_limiter | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

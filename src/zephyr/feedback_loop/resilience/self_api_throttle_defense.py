...
# [MODULE] zephyr.feedback_loop.resilience.self_api_throttle_defense
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-RES-self_api_throttle_defense | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

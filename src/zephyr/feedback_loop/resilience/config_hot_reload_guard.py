...
# [MODULE] zephyr.feedback_loop.resilience.config_hot_reload_guard
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-RES-config_hot_reload_guard | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

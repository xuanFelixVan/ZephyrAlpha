...
# [MODULE] zephyr.feedback_loop.detectors.reliability.autoscale_remediation
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-autoscale_remediation | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

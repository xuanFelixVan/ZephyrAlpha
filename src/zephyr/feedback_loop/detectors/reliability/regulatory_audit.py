...
# [MODULE] zephyr.feedback_loop.detectors.reliability.regulatory_audit
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-regulatory_audit | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

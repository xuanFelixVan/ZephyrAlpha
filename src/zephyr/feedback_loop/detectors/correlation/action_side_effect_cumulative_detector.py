...
# [MODULE] zephyr.feedback_loop.detectors.correlation.action_side_effect_cumulative_detector
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-action_side_effect_cumulative_detector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

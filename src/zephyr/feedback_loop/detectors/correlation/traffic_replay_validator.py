...
# [MODULE] zephyr.feedback_loop.detectors.correlation.traffic_replay_validator
...
#   code: traffic_replay_validator.py
# 层: 算法
# - id: A1
#   name_zh: ① TrafficReplayValidator
#   name_en: TrafficReplayValidator
#   intro: class TrafficReplayValidator 源码 L79-L106
#   desc: 公共方法（定义序）: start_session, record_result, deviation_rate, should_abort；源码 L79-L106
#   inputs: 无参数
#   outputs: 返回值

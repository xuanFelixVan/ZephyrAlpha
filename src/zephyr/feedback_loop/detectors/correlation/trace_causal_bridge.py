...
#   code: trace_causal_bridge.py
# 层: 算法
# - id: A1
#   name_zh: ① TraceCausalBridge
#   name_en: TraceCausalBridge
#   intro: class TraceCausalBridge 源码 L55-L59
#   desc: 公共方法（定义序）: bridge；源码 L55-L59
#   inputs: 无参数
#   outputs: 返回值
# 层: 输出
# - id: O1

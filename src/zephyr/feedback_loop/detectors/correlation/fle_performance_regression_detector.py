...
# [MODULE] zephyr.feedback_loop.detectors.correlation.fle_performance_regression_detector
...
#   code: fle_performance_regression_detector.py
# 层: 算法
# - id: A1
#   name_zh: ① FLEPerformanceRegressionDetector
#   name_en: FLEPerformanceRegressionDetector
#   intro: class FLEPerformanceRegressionDetector 源码 L64-L137
#   desc: 公共方法（定义序）: establish_baseline, record_metrics, detect_regression；源码 L64-L137
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: FLEPerformanceRegressionDetector

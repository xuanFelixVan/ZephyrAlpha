...
# [MODULE] zephyr.feedback_loop.detectors.correlation.agent_trajectory_anomaly_detector
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-agent_trajectory_anomaly_detector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

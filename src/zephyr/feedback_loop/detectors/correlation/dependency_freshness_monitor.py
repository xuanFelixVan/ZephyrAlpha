...
# [MODULE] zephyr.feedback_loop.detectors.correlation.dependency_freshness_monitor
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-dependency_freshness_monitor | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

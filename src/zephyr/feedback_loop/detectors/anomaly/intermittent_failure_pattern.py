...
# [MODULE] zephyr.feedback_loop.detectors.anomaly.intermittent_failure_pattern
...
#   code: intermittent_failure_pattern.py
# 层: 算法
# - id: A1
#   name_zh: ① IntermittentFailurePattern
#   name_en: IntermittentFailurePattern
#   intro: class IntermittentFailurePattern 源码 L79-L216
#   desc: 公共方法（定义序）: record_failure, analyze_pattern, analyze_all_patterns, get_temporal_clustering, get_all_discovered…
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: IntermittentFailurePattern

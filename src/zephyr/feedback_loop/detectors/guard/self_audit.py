...
# [MODULE] zephyr.feedback_loop.detectors.guard.self_audit
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-self_audit | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

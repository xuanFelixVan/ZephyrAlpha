...
# [MODULE] zephyr.feedback_loop.detectors.guard.recursive_diagnosis_trust_evaluator
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-recursive_diagnosis_trust_evaluator | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

...
# [MODULE] zephyr.feedback_loop.detectors.guard.placebo_action_detector
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-placebo_action_detector | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent
...
class PlaceboActionDetector:
    ...
    def _mann_whitney_u(group_a: list[float], group_b: list[float]) -> tuple[float, float]:
        ...
        return PlaceboActionDetector.mann_whitney_u(group_a, group_b)

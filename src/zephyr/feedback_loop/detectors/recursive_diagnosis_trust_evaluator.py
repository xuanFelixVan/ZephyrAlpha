...
# [MODULE] zephyr.feedback_loop.detectors.recursive_diagnosis_trust_evaluator
...
class RecursiveDiagnosisTrustEvaluator:
    ...
    def evaluate_trust(self, self_diagnosis: dict) -> dict:
        ...
        return {
            ...
            "recommendation": "trust_self" if trust_score >= 0.7 else (
                "trust_external" if trust_score < 0.5 else "inconclusive"
            ),
        }

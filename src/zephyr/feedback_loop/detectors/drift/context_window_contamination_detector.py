...
#   code: context_window_contamination_detector.py
# 层: 算法
# - id: A1
#   name_zh: ① ContextWindowContaminationDetector
#   name_en: ContextWindowContaminationDetector
#   intro: class ContextWindowContaminationDetector 源码 L76-L134
#   desc: 公共方法（定义序）: record_tokens, detect_contamination, get_provenance_summary, reset_window；源码 L76-L134
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: ContextWindowContaminationDetector

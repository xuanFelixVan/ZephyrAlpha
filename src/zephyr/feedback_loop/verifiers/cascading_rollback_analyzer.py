...
# [MODULE] zephyr.feedback_loop.verifiers.cascading_rollback_analyzer
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-cascading_rollback_analyzer | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

...
# [MODULE] zephyr.feedback_loop.verifiers.build_reproducibility_verifier
...
#   code: build_reproducibility_verifier.py
# 层: 算法
# - id: A1
#   name_zh: ① BuildReproducibilityVerifier
#   name_en: BuildReproducibilityVerifier
#   intro: class BuildReproducibilityVerifier 源码 L78-L192
#   desc: 公共方法（定义序）: hash_directory, record_build_hash, verify_dependencies, verify_ci_consistency, overall_reproducibi…
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: BuildReproducibilityVerifier

...
# [MODULE] zephyr.feedback_loop.verifiers.cross_blueprint_contract_drift
...
#   code: cross_blueprint_contract_drift.py
# 层: 算法
# - id: A1
#   name_zh: ① CrossBlueprintContractDrift
#   name_en: CrossBlueprintContractDrift
#   intro: class CrossBlueprintContractDrift 源码 L76-L198
#   desc: 公共方法（定义序）: register_contract, record_actual_signature, check_staleness, get_drifted_contracts, get_contract_h…
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: CrossBlueprintContractDrift

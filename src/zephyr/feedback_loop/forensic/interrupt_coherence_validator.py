...
# [MODULE] zephyr.feedback_loop.forensic.interrupt_coherence_validator
...
# [ERROR_CONTRACT]
# [TESTS]
# [A_module] module_id=MOD-UNK-interrupt_coherence_validator | layer=module | stability=evolving | safety=L | ai_autonomy=ai_modifiable
# [TTL] permanent

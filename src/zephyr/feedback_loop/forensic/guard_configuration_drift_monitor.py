...
#   code: guard_configuration_drift_monitor.py
# 层: 算法
# - id: A1
#   name_zh: ① GuardConfigurationDriftMonitor
#   name_en: GuardConfigurationDriftMonitor
#   intro: class GuardConfigurationDriftMonitor 源码 L65-L140
#   desc: 公共方法（定义序）: compute_drift, establish_golden_baseline, take_snapshot, get_drift_trend；源码 L65-L140
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: GuardConfigurationDriftMonitor

...
# [MODULE] zephyr.feedback_loop.forensic.knowledge_injection_pre_flight_verifier
...
#   code: knowledge_injection_pre_flight_verifier.py
# 层: 算法
# - id: A1
#   name_zh: ① KnowledgeInjectionPreFlightVerifier
#   name_en: KnowledgeInjectionPreFlightVerifier
#   intro: class KnowledgeInjectionPreFlightVerifier 源码 L63-L126
#   desc: 公共方法（定义序）: add_historical_incident, verify_rule；源码 L63-L126
#   inputs: 无参数
#   outputs: 返回值
...
#   name_en: public defs
#   intro: KnowledgeInjectionPreFlightVerifier

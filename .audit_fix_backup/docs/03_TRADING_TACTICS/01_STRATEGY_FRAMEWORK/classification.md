...
module_id: TACTICS_STRATEGY_CLASSIFICATION_001
...
| T005 | 布林带趋势策略| 中轨向上+价格在上轨运行| 牛市 | ?|

| T006 | ATR趋势策略 | 趋势强度>2倍ATR | 趋势?| ?|

| T007 | 均线金叉策略 | MA5上穿MA20 | 任意 | 中低 |

| T008 | 趋势线突破策略| 价格突破趋势?| 趋势?| ?|

| T009 | 多周期共振策略| 日线+周线趋势一?| 牛市 | ?|
...
| M002 | 布林带回归策略| 价格触及下轨+缩量 | 震荡?| 中低 |

| M003 | KDJ超卖策略 | KDJ<20金叉 | 超卖反弹 | ?|

| M004 | 波动率收缩策略|ATR收缩至均线下?| 突破?| ?|

| M005 | 乖离率策略| 价格偏离MA20过远 | 均值回?| 中低 |

| M006 | 量价背离策略 | 价格新低+量能缩量 | 反弹 | ?|

| M007 | 支撑位策略| 回踩重要支撑位企?| 任意 | 中低 |
...
| A004 | 南北向套利策略| 沪深港通价值| 跨境 | ?|

| A005 | 可转债套利策略| 转股价值偏?| 低波?| ?|

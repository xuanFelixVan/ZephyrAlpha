---
module_id: DOCS_01_FRAMEWORK_README_001
version: 1.0.0
status: Active
...
**注意**: Layer 11是文字驱动层，位于Layer 0-11之上，提供自然语言交互界面，实现零代码操作整个系统。详细设计参?NATURAL_LANGUAGE_INTERFACE_BLUEPRINT.md
...
| 了解大盘择时 | MARKET_REGIME.md |

| 理解人机协作 | HUMAN_AI_FLOW.md |

| 查看技术选型 | TECH_STACK.md |

| 零代码操作系?| NATURAL_LANGUAGE_INTERFACE_BLUEPRINT.md |
...
| Layer 11 | NATURAL_LANGUAGE_INTERFACE_BLUEPRINT.md |

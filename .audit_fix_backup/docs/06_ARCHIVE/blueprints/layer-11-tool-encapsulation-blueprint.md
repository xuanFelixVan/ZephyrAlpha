...
| Layer 11架构蓝图 | `docs/module_designs/layer_11/LAYER_11_ARCHITECTURE.md` | Layer 11整体架构 |

| 文字驱动核心模块 | `docs/module_designs/layer_11/L11_TEXT_DRIVER.md` | NLU设计 |

| 量化交易Agent模块 | `docs/module_designs/layer_11/L11_QUANT_AGENT.md` | Agent框架 |

| 策略引擎蓝图 | `docs/03_TRADING_TACTICS/01_STRATEGY_FRAMEWORK/STRATEGY_ENGINE_CORE_BLUEPRINT.md` | 策略引擎设计 |
...
- **蓝图文档**: LAYER_11_TOOL_ENCAPSULATION_BLUEPRINT.md

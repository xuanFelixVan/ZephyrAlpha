...
module_id: STRATEGY_PORTFOLIO_OPTIMIZATION_001_4929
...
| 组合优化引擎集成蓝图 | PORTFOLIO_OPTIMIZER_INTEGRATION_001 | 强依赖 | 提供优化器基础接口 |
...
| MULTI_STRATEGY_HIERARCHICAL_SYSTEM_BLUEPRINT.md | MULTI_STRATEGY_HIERARCHICAL_SYSTEM_001 | 强依赖 | 多策略分层管理 |

| PORTFOLIO_SCENARIO_ANALYSIS_BLUEPRINT.md | PORTFOLIO_SCENARIO_ANALYSIS_001 | 中依赖 | 场景分析 |

...
- **零入链扫描（最新）**：../09_AUDIT/STATE/INDEX_HEALTH_ORPHAN_20260516.md（`scan_index_health.py --prefix docs/module_designs --date 20260516`；**zero_inbound=0**；候选 md **2**；首轮即零入链，本页增 P5 互指与台账登记）

- **rollup（深度 3）**：../09_AUDIT/STATE/REPO_DIRECTORY_ROLLUP_20260414.md（JSON 真源同 stem；键 `docs/module_designs` **2** 条路径）

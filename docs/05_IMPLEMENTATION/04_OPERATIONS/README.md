...
6. 整仓按目录尽治（REPO_WIDE **§7**）：`../06_CONSTRUCTION_DOCS/00_MANAGEMENT/REPO_WIDE_FILE_GOVERNANCE_TASK_LIST.md`  
7. 治理工具总索引：`../06_CONSTRUCTION_DOCS/00_MANAGEMENT/GOVERNANCE_TOOLS_INDEX.md`

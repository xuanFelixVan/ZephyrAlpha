...
**影响范围**: 
- 已确认受影响文件：
  - [FACTOR_TAXONOMY.md](./01_STANDARDS/FACTOR_TAXONOMY.md)
  - [factor_catalog.md](./06_REGISTRY/factor_catalog.md)
  - [FACTOR_MANAGEMENT_STANDARD.md](./01_STANDARDS/FACTOR_MANAGEMENT_STANDARD.md)
  - [FACTOR_SCREENING_STRATEGY.md](./01_STANDARDS/FACTOR_SCREENING_STRATEGY.md)
  - [README.md](./README.md)
  - [INDEX.md](./INDEX.md)
  - 以及其他多个文件
...
**问题示例**:
- [FACTOR_VALIDATION_BLUEPRINT.md](./05_BACKTEST/FACTOR_VALIDATION_BLUEPRINT.md)
...
2. **绝对路径硬编码（2个文件）**
   - [HANDOVER.md](./HANDOVER.md) - 目录结构示例
   - [A_SHARE_HISTORICAL_DATA_PROCESSING_BLUEPRINT.md](./04_DATA_SOURCE/A_SHARE_HISTORICAL_DATA_PROCESSING_BLUEPRINT.md) - 数据存储路径示例
   - 状态: 合理使用，无需修复
...
**第1组：因子分类与注册**
- [FACTOR_TAXONOMY.md](./01_STANDARDS/FACTOR_TAXONOMY.md) - 因子分类体系
- [factor_catalog.md](./06_REGISTRY/factor_catalog.md) - 因子注册表
...
**第2组：因子管理与筛选**
- [FACTOR_MANAGEMENT_STANDARD.md](./01_STANDARDS/FACTOR_MANAGEMENT_STANDARD.md) - 因子管理标准
- [FACTOR_SCREENING_STRATEGY.md](./01_STANDARDS/FACTOR_SCREENING_STRATEGY.md) - 5900因子筛选策略

...
|------|---------|---------|---------|---------|
| 1 | [资产配置模型.md](./01_asset_allocation/资产配置模型.md) | ... |
| 2 | [配置优化方法.md](./01_asset_allocation/配置优化方法.md) | ... |
...
| 6 | [战略调整机制.md](./04_strategic_adjustment/战略调整机制.md) | ... |
```
...
| 1 | [资产配置模型.md](./01_asset_allocation/资产配置模型.md) | ... |
| 2 | [配置优化方法.md](./01_asset_allocation/配置优化方法.md) | ... |
| 3 | [战略调整机制.md](./04_strategic_adjustment/战略调整机制.md) | ... |

---
module_id: 05_IMPLEMENTATION_04_OPERATIONS_DOCUMENT_GOVERNANCE_AUTO_CHECK_REPORT
version: 1.0.0
status: Active
...
- **05_BACKTEST\ic_reports** (2个文件)

- **05_BACKTEST\strategy_reports** (2个文件)

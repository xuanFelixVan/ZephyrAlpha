...
**官方说明**：
> 登录客户端：在电脑端登录国金QMT软件，登录时勾选"极简模式"或"独立交易"，即可进入MiniQMT模式。
...
✅ QMT软件支持MiniQMT模式
❌ 交易接口连接失败（返回码: -1）→ 需要在MiniQMT模式下登录
```
...
**影响**：
- 普通模式登录不支持Python API交易接口
- 必须在MiniQMT模式下登录才能使用xttrader

**现状**：
- QMT软件版本：国金证券QMT交易端 2.0.8.300 ✅
- 登录模式：可能未选择"极简模式"或"独立交易" ❌
- xtquant库：已安装 ✅
...
### 🎯 唯一需要的步骤：在MiniQMT模式下登录

#### 操作步骤（5分钟）

**步骤1: 打开QMT登录界面**
- 双击桌面上的"国金证券QMT交易端"图标
- 或从开始菜单启动

...
技术评审知识库是清风量化系统的核心知识积累平台，用于存储和分享技术评审案例、最佳实践、经验教训和评审标准。知识库遵循**积累、分享、复用、优�?*的原则，支持智能体的持续学习和系统质量的持续提升�?
...
├── BEST_PRACTICES_TEMPLATE.md         # 最佳实践模�?
├── REVIEW_STANDARDS.md                # 评审标准�?
├── case_studies/                      # 案例研究目录
�?  ├── FACTOR_BACKTEST_INTEGRATION_CASE_STUDY.md
�?  ├── STRAT_ENGINE_CASE_STUDY.md
�?  └── ...
├── best_practices/                    # 最佳实践目�?
...
- **价�?*：提供实际参考，避免重复错误，积累评审经�?

### 3.2 最佳实�?(Best Practices)
- **目的**：总结评审过程中的成功经验和有效方�?
...
### 4.1 知识创建流程
```
技术评审完�?�?提取有价值信�?�?选择知识类型 �?使用模板创建文档 �?评审和验�?�?归档到知识库
```

### 4.2 知识更新流程
```
定期回顾知识�?�?识别过时内容 �?更新或归�?�?验证更新内容 �?更新索引
```

### 4.3 知识使用流程
```
智能体执行评�?�?检索相关知识和案例 �?应用最佳实�?�?记录新发�?�?反馈到知识库
```

## 5. 智能体集�?

### 5.1 知识检�?
- **检索时�?*：智能体开始评审前、遇到复杂问题时、需要参考历史案例时
- **检索方�?*：通过SearchCodebase工具检索相关知识文�?
- **检索关键词**：模块类型、评审类型、风险等级、技术栈

### 5.2 知识应用
- **模板应用**：使用标准模板创建新的案例或最佳实践文�?
- **经验复用**：参考历史案例中的评审方法和解决方案
- **工具使用**：按照工具指南正确配置和使用评审工具

### 5.3 知识贡献
- **贡献要求**：每个智能体在完成评审后，必须评估是否有值得分享的知�?
- **贡献流程**：使用模板创建知识文�?�?提交到知识库 �?更新索引
- **贡献激�?*：知识贡献作为智能体性能评估的重要指�?

## 6. 质量保证

### 6.1 知识质量标准
1. **准确�?*：知识内容必须准确无误，经过验证
2. **完整�?*：使用标准模板，确保内容完整
3. **实用�?*：知识必须具有实际应用价�?
4. **时效�?*：知识必须及时更新，反映最新实�?
5. **可读�?*：文档结构清晰，语言简明易�?
...
### 6.2 知识评审机制
1. **同行评审**：新知识文档必须经过至少一名同行评�?
2. **专家评审**：重要知识文档需要专家评�?
3. **定期回顾**：每季度对知识库进行全面回顾和更�?

## 7. 使用示例

### 7.1 spec-approver使用知识�?
```python
# 伪代码示�?
...
3. **索引更新**：定期更新知识索引，提高检索效�?
4. **质量监控**：监控知识质量，识别和修复问�?
...
### 8.3 知识库工具支�?
1. **文档质量检�?*：使用markdownlint-doc-validator检查文档格�?
2. **内容分析**：使用SearchCodebase进行内容检索和分析
3. **版本管理**：使用Git进行版本控制和历史追�?
...
| 版本 | 日期 | 说明 | 作�?|
|------|------|------|------|
| v1.0 | 2026-04-02 | 初始版本，创建知识库框架 | 审批智能�?(Spec-Approver) |

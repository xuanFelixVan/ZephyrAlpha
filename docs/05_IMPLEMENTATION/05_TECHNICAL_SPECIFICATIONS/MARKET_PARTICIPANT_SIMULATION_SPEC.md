...
- **MARKET_PARTICIPANT_SIMULATION_SPEC_SUPPLEMENT.md** - 必须改进项详细设?  - IMP-001: 异常处理和重试机制设?  - IMP-002: RL模型训练监控指标设计
  - IMP-003: 市场冲击模型校准方案设计
  - **状?*: 已整合到主规格书第五?
- **MARKET_PARTICIPANT_SIMULATION_SPEC_UPDATE.md** - 智能体扩展更?  - 新增外资智能?(Foreign Investor Agent)

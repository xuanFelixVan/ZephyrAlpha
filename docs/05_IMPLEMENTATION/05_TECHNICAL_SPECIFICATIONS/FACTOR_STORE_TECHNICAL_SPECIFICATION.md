---
module_id: FACTOR_STORE_TECHNICAL_SPECIFICATION
version: 1.0.0
status: Active
...
owner: 首席文档架构师
responsibility:
  - FACTOR_STORE_TECHNICAL技术规范
---

﻿---
module_id: IMPL_FACTOR_STORE_TECH_SPEC_001
version: 1.0.1
status: Active
...
|----------|----------|----------|----------|----------|
| Parquet | 因子数值数据| Parquet | 中高?| 因子查询、分?|
| SQLite | 因子元数据| SQLite | 低频 | 元数据管?|

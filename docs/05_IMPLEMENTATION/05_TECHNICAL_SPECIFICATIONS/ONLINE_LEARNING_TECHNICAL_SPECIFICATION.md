...
> 清风量化系统 v5.2 - 在线学习详细技术设�?> **索引**: `OL-001`
> **开发时�?*: 60h
...
class OnlineLearningConfig(BaseModel):
    ...
    performance_threshold: float = Field(default=0.7, description="性能阈�?)
    rollback_threshold: float = Field(default=0.5, description="回滚阈�?)

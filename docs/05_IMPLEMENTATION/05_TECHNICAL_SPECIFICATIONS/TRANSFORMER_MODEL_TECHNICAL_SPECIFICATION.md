...
> 清风量化系统 v5.2 - TransformerModel变换器模型模块详细技术设�?
...
class TransformerTrainer:
    ...
    参�? [MODEL_TRAINING_PIPELINE](./MODEL_TRAINING_PIPELINE_TECHNICAL_SPECIFICATION.md)
    """
...
| CUDA | >=12.1 | GPU加�?| 高性能计算 |
| cuDNN | >=8.9.0 | 深度学习加�?| GPU优化 |

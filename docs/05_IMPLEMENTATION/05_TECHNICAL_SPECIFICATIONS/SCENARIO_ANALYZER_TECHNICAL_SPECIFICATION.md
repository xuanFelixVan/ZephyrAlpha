...
> 清风量化系统 v5.2 - ScenarioAnalyzer情景分析器详细技术设�?> **模块ID**: `SCENARIO_ANALYZER_001`
> **索引**: `L7.RPT.SCE.001`
> **开发时�?*: 40h
...
**预期价�?*�?- 建立完整的情景分析体系，覆盖5种预设情�?+ 自定义情�?- 提供压力测试能力，评估极端市场条件下的组合表�?- 为风险管理和投资决策提供科学依据
...
def apply_market_shock(
    ...
    Args:
        asset_value: 资产原始价�?        asset_type: 资产类型 (equity/bond/commodity/currency)
        shock_params: 市场冲击参数
        beta: 资产Beta系数

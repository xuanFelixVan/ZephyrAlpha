...
- **业务需?*: 系统需要专业的IC分析能力，评估因子的预测能力和稳定
...
- **职责范围**: 负责IC计算、IC统计、IC衰减分析、IC统计检查
...
| R001 | IC计算偏差风险 | P1 | 多种IC方法对比、稳健性检查|
...
| R003 | IC衰减误判风险 | P2 | 多滞后期分析、统计检查|





| R004 | 计算性能瓶颈 | P2 | 向量化计算、并行优化|

...
> 清风量化系统 v5.3 - DataNormalizer数据标准化器模块详细技术设?
> **模块ID**: `PREP_NORM_001`
> **版本**: v1.0.0
> **�?*: ?正式
...
| 批量标准化时?| < 5?| 1000特征×10000样本 |
| 滚动标准化时?| < 2?| 单特�?0000样本×窗口20 |
| 截面标准化时?| < 3?| 5000股票×100特征 |
| 反向标准化时?| < 10ms | 单特征反向转?|
| 缓存命中?| ?80% | 重复标准化场?|
| 内存使用 | < 1GB | 批量标准?|
...
- [DataNormalizer设计文档](06_ARCHIVE/architecture_v4/module_designs/layer_1/L1_NORMALIZER.md)

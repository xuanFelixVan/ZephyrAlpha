...
> 清风量化系统 v5.3 - 数据接口源完整清?> **清单日期**: 2026-04-03
> **清单目的**: 明确系统所有数据接口源，标识免费接口，确保数据源管理规?

## 一、数据接口总览

### 1.1 主数据源

| 序号 | 数据接口名称 | 接口类型 | 付费状?| 数据类型 | 接入方式 | 认证方式 | 优先?| 状?|
|------|------------|---------|---------|---------|---------|---------|--------|------|
| 1 | **iFind** | REST API | ?**已有** | 行情数据、财务数?| REST API | Token | P0（主数据源） | ?可用 |
| 2 | **QMT** | Python API | 🆓 **免费** | 行情数据、交易数?| Python API | 券商账户 | P0（交易执行） | ⚠️ 待接?|

### 1.2 免费补充数据接口

| 序号 | 数据接口名称 | 接口类型 | 付费状?| 数据类型 | 接入方式 | 认证方式 | 优先?| 状?|
|------|------------|---------|---------|---------|---------|---------|--------|------|
| 1 | **Tushare** | REST API | 🆓 **免费** | A股市场数?| REST API | Token | P1（补充） | ?可用 |
| 2 | **AKShare** | Python?| 🆓 **免费** | 多市场数?| Python?| 无需认证 | P1（补充） | ?可用 |
| 3 | **yfinance** | Python?| 🆓 **免费** | 美股市场数据 | Python?| 无需认证 | P2（补充） | ?可用 |
| 4 | **Baostock** | Python?| 🆓 **免费** | A股历史数?| Python?| 无需认证 | P1（补充） | ?可用 |
...
- **付费状?*: 🆓 **免费**（XtQuant库免费，需券商账户?- **数据覆盖**: A股、期货、期?- **数据频率**: 实时行情、Tick数据
- **数据质量**: ⭐⭐⭐⭐⭐（专业级）
...
- **接口名称**: Tushare
- **接口类型**: REST API
- **付费状?*: 🆓 **免费**（部分高级数据需积分?- **数据覆盖**: A股、港股、美股、期货、数字货?- **数据频率**: 日线、分钟线
- **数据质量**: ⭐⭐⭐⭐（高质量?
**数据类型**:
- ?行情数据
- ?财务数据
...
### 2.7 yfinance - 🆓 免费美股数据?
**基本信息**:
- **接口名称**: yfinance（Yahoo Finance?- **接口类型**: Python?- **付费状?*: 🆓 **完全免费**
...
**本文档在系统中的位置**:
- **父文?*: [DATA_SOURCE_MANAGEMENT_BLUEPRINT.md](./DATA_SOURCE_MANAGEMENT_BLUEPRINT.md)
- **关联文档**:
...
**清单版本**: v1.0 | **创建日期**: 2026-04-03 | **状?*: ?正式 | **维护?*: ZephyrAlpha技术团?
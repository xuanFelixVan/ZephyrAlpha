---
module_id: 05_IMPLEMENTATION_05_TECHNICAL_SPECIFICATIONS_UNIFIED_INTERFACE_CONTRACT_SPECIFICATION
layer: layer_05
version: 1.0.0
status: Active
responsibility:
  - Unified Interface Contract Specification相关业务
...
- FACTOR_CALCULATOR_TECHNICAL_SPECIFICATION

- ALPHA_FACTOR_FACTORY_TECHNICAL_SPECIFICATION

- QLIB_ALPHA158_TECHNICAL_SPECIFICATION

- MODEL_TRAINING_PIPELINE_TECHNICAL_SPECIFICATION

- LSTM_MODEL_TECHNICAL_SPECIFICATION

- TRANSFORMER_MODEL_TECHNICAL_SPECIFICATION

- FEATURE_ENGINEERING_TECHNICAL_SPECIFICATION

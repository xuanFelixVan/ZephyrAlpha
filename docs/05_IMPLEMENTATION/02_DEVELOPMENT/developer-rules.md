...
| DEVELOPMENT_STANDARDS.md | 开发标准（目录结构、命名规范、代码标准） | v5.3 | ?活跃 |

| DEVELOPMENT_WORKFLOW.md | 工作流程（开发流程、提交规范、依赖管理） | v5.3 | ?活跃 |

| DESIGN_PRINCIPLES.md | 设计原则（优先级驱动、容错恢复、性能要求?| v5.3 | ?活跃 |
...
| 目录结构、文件命?| DEVELOPMENT_STANDARDS.md |

| 代码规范、类型提?| DEVELOPMENT_STANDARDS.md |

| 开发流程、分支策?| DEVELOPMENT_WORKFLOW.md |

| 提交规范、代码审?| DEVELOPMENT_WORKFLOW.md |

| 设计原则、优先级 | DESIGN_PRINCIPLES.md |

| 容错机制、性能要求 | DESIGN_PRINCIPLES.md |

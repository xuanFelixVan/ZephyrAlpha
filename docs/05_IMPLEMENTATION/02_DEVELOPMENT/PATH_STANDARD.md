...
| 规范 | 要求 | 示例 |
|------|------|------|
| 编号前缀 | 使用2位数字 | `00_`, `01_`, `02_` |
| 英文命名 | 小写字母+下划线 | `factor_library`, `trading_tactics` |
| 避免中文 | 跨平台兼容性问题 | ❌ 避免使用中文目录名 |
...
| 类型 | 规范 | 示例 |
|------|------|------|
| Markdown | 英文命名或中文+英文编号 | `factor_definition.md` 或 `T.01.TR001.趋势跟踪.md` |
...
| `temp/` | 临时计算结果 | 每次运行前清理 |
| `cache/` | 缓存数据 | 定期清理(7天) |
| `__pycache__/` | Python字节码 | 不提交到版本控制 |

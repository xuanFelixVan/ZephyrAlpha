...
standard_type: 登记表
applicable_scope: D 类合稿 — **仅低置信**分支（见 [D 类蓝图重叠 Playbook](./D_CLASS_BLUEPRINT_OVERLAP_PLAYBOOK.md) §5）
---
...
|------|------------|----------|------------|------|------|
| _示例_ | `../01_BLUEPRINTS/EXECUTION_STRATEGY_BACKTESTER_CONSOLIDATED_20260411.md`（占位文件名，待产出后改为可点击链） | [EXECUTION_STRATEGY_BACKTESTER_BLUEPRINT（stub）](../01_BLUEPRINTS/EXECUTION_STRATEGY_BACKTESTER_BLUEPRINT.md) | - | pending_review | **语法演示**：合稿列在文件未入库前用反引号路径避免 L1 死链；stub 列为真实可点链。 |

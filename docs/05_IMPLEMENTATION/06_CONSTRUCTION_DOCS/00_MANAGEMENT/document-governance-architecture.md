---
module_id: DOCUMENT_GOVERNANCE_ARCHITECTURE_001
version: 1.0.0
status: Active
...
> **关联**：蓝图交付标准（机构精华版）（目标态与审计关系）· [项目办公室 README](10_GOVERNANCE_COMPLIANCE/TRAINING_SYSTEM/README.md)（入口表）· 全库治理文档导航。
...
- 新增「受控规章类」文件于 `00_MANAGEMENT/` 时：更新 [README](10_GOVERNANCE_COMPLIANCE/TRAINING_SYSTEM/README.md) 主表，并评估是否需在 **§2 分层表** 增行或脚注。  

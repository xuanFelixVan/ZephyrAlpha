...
1. **真源优先**：与图纸柜能放什么冲突时，以 [01_BLUEPRINTS_REPOSITORY_RULES.md](./01_BLUEPRINTS_REPOSITORY_RULES.md) 为准。  
...
| 文档 | 用途 |
|------|------|
| [项目办公室 AI 交接说明](./PROJECT_OFFICE_AI_HANDOFF.md) | 更广义的接手顺序 |
| [蓝图终稿定义](./BLUEPRINT_FINAL_SIGNOFF.md) | 终稿含义 |
| [REPORTS 说明](../01_BLUEPRINTS/REPORTS/README.md) | 过程稿目录说明 |

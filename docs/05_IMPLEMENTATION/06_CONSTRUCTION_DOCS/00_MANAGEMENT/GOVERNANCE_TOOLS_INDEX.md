...
> **Git 暂存、L1 何时跑、UTF-8 编辑**：见 [项目办公室 AI 交接说明](./PROJECT_OFFICE_AI_HANDOFF.md) **§0.1** 与 [REPO_WIDE §1.2](./REPO_WIDE_FILE_GOVERNANCE_TASK_LIST.md)；编码全文 [DOCUMENT_ENCODING_STANDARD](../../../10_GOVERNANCE_COMPLIANCE/DOCUMENT_ENCODING_STANDARD.md)。**`.gitignore` 与 `STATE/` 两条线**、**Solo+全委托 AI 双提交**：**§0.1.4**、**§0.2**；任务清单 [§7.2 末](./REPO_WIDE_FILE_GOVERNANCE_TASK_LIST.md)。

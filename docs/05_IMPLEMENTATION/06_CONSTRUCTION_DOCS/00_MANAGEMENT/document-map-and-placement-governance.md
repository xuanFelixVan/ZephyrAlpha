...
| **蓝图与能力总览** | 正式稿导航、任务 1 闭合 | `BLUEPRINT_STAGE_COMPLETE_SUMMARY.md`、[`../01_BLUEPRINTS/INDEX.md`](../01_BLUEPRINTS/INDEX.md) |
...
**不要求。** 本仓库索引策略是 **分层可达**（与 [REPO_WIDE（已归档）](./CANON/ARCHIVE/repo-wide-file-governance-task-list.md) **§2.2** 一致）：**L1～L4** 组合即可，目标是「从门口几步能走到」，而不是「每个 `.md` 在全局 INDEX 里各占一行」。
...
| 任务/章节 | 与本文关系 |
|-----------|------------|
| [蓝图终稿任务清单（已归档）](./CANON/ARCHIVE/blueprint-phase-closure-task-list.md) **机构顺序 3～5**、**任务 3～5**、**W0～W4** | 清点与归位、摆放与卫生阶段须**显式对照 LAYOUT + 图纸柜规则**；W2/W4 与根目录误放见 仓库根治理 Playbook。 |
| [REPO_WIDE（已归档）](./CANON/ARCHIVE/repo-wide-file-governance-task-list.md) **§1.2、§2.3、§2.3.1、§2.3.2、§7** | **§1.2** Markdown 编码/乱码预防（与 L1 正交）；**§7.2** 含 **「摆放」「导航」「内链」**（摆放与 **§1.5** / **§1.6** 一致）；搬迁后索引同步见本文 **§4** 与 §7.2 **内链** 项；§2.3 总表含 **文档地图与放置** 行；**§2.3.1** 与本文 **§1.5** 互文；**§2.3.2** 与本文 **§1.6** 互文。 |

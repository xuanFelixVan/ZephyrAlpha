...
> **与任务清单的关系**：执行口径与波次见 全仓库文件治理任务清单；扫描**能做什么、不能做什么**见该文 **§1.1**。  
...
| `scan_directory_naming_compliance.py` | **目录命名合规性（P6.1）**：检查目录是否有中文、空格、特殊字符、缺少编号前缀；对照 PATH_STANDARD.md §1.1 | `python scripts/governance/scan_directory_naming_compliance.py --date YYYYMMDD --prefix docs/` | `docs/09_AUDIT/STATE/DIRECTORY_NAMING_COMPLIANCE_*.{md,json}` |
...
更完整的脚本说明（含非治理类）见 [`scripts/README.md`](10_GOVERNANCE_COMPLIANCE/TRAINING_SYSTEM/README.md)。

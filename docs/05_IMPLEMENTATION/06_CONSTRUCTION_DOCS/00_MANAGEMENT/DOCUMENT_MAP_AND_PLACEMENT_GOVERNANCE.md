...
| [全仓库文件治理任务清单](./REPO_WIDE_FILE_GOVERNANCE_TASK_LIST.md) **§1.2、§2.3、§2.3.1、§2.3.2、§7** | **§1.2** Markdown 编码/乱码预防（与 L1 正交）；**§7.2** 含 **「摆放」「导航」「内链」**（摆放与 **§1.5** / **§1.6** 一致）；搬迁后索引同步见本文 **§4** 与 §7.2 **内链** 项；§2.3 总表含 **文档地图与放置** 行；**§2.3.1** 与本文 **§1.5** 互文；**§2.3.2** 与本文 **§1.6** 互文。 |

...
> **创建日期**: 2026-04-06
> **开源项�?*: 自研简化版（个人单券商场景�?
> **目标**: 构建简化版智能订单路由器，优化订单拆分和执�?

## 核心定位

负责Smart Order Router的设计、实现和维护，提供核心功能支持，确保系统模块的稳定运行和高效执行�?
...
| 场景维度 | 专业机构 | 个人交易�?| 说明 |
|---------|---------|-----------|------|
| **券商账户** | 多个 | 1个（QMT�?| 无需多市场路�?|
| **交易频率** | 高频 | 中低�?| 拆分需求较�?|
| **订单大小** | 大单 | 中小�?| 拆分需求较�?|
| **流动性需�?* | 多源聚合 | 单源优化 | 聚合价值有�?|
...
| QMT_EXECUTOR_TECHNICAL_SPECIFICATION.md | QMT执行器技术规�?|
...
| 模块 | 职责 | 边界 |
|------|------|------|
| **Smart Order Router** | Layer 5 - 策略执行�?| **核心模块** |

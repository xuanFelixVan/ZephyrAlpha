...
> **核心职责**: 战略资产配置引擎，负责长期资产配置决�?
> **职责边界**: 
> - �?本文档负责：战略资产配置、风险预算分配、投资组合优化、再平衡决策
> - �?本文档不负责：战术配置、日内交易、实时风�?
�? 战略配置引擎蓝图
...
> **版本**: v1.0
> **创建日期**: 2026-04-06
> **开源项�?*: PyPortfolioOpt (4k+ Stars, MIT License)
...
| 模块 | 核心职责 | 输入 | 输出 | 对接模块 |
|------|---------|------|------|---------|
| **资产配置决策** | 战略资产配置 | 市场数据、风险偏�?| 目标权重 | 组合优化�?|
| **风险预算分配** | 风险预算分配 | 风险预算、资产数�?| 风险权重 | 组合优化�?|
| **投资组合优化** | 组合优化 | 目标权重、约束条�?| 最优权�?| 策略执行�?|
| **再平衡决�?* | 再平衡决�?| 当前持仓、目标权�?| 再平衡信�?| 策略执行�?|
...
def strategic_asset_allocation(
    ...
    参数:
        prices: 价格数据
        risk_tolerance: 风险容忍�?(conservative/moderate/aggressive)
...
| [多目标优化蓝图](./MULTI_OBJECTIVE_OPTIMIZATION_BLUEPRINT.md) | MULTI_OBJECTIVE_OPTIMIZATION_001 | 强依�?| 提供多目标优化能�?|
...
| 文档名称 | module_id | 依赖类型 | 说明 |
|---------|-----------|---------|------|
| [STRATEGY_PORTFOLIO_OPTIMIZATION_BLUEPRINT.md](./STRATEGY_PORTFOLIO_OPTIMIZATION_BLUEPRINT.md) | STRATEGY_PORTFOLIO_OPTIMIZATION_001 | 强依�?| 策略组合优化 |
...
| PORTFOLIO_OPTIMIZATION_LAYER_BLUEPRINT.md | 组合优化层蓝�?|
...
| 模块 | 职责 | 边界 |
|------|------|------|
| **Strategic Allocation Engine** | Layer 11 - 战略决策�?| **核心模块** |

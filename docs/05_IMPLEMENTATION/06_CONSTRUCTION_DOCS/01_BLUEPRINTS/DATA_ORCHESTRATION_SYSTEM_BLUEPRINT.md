...
> **核心职责**: 数据任务调度编排、工作流管理、任务依赖管理、失败重�?
> **职责边界**: 
> - �?本模块负责：任务调度、工作流编排、任务监控、失败重�?
> - �?本模块不负责：数据处理逻辑、数据存储、数据质量检�?
...
| 特�?| Prefect | Airflow | Dagster | Temporal |
|------|---------|---------|---------|----------|
| **学习曲线** | ⭐⭐⭐⭐�?| ⭐⭐�?| ⭐⭐⭐⭐ | ⭐⭐�?|
| **个人适用�?* | ⭐⭐⭐⭐�?| ⭐⭐�?| ⭐⭐⭐⭐ | ⭐⭐�?|
| **Python原生** | �?| �?| �?| �?|
...
| **Prefect Server** | 调度服务�?| Prefect Server |
| **Prefect Agent** | 任务执行代理 | Prefect Agent |
| **任务队列** | 任务排队和分�?| SQLite/PostgreSQL |
| **结果存储** | 任务结果持久�?| Local/S3 |
| **UI Dashboard** | 可视化监�?| Prefect UI |

...
**架构角色**: 
- 作为风险预算层的核心组件，监控极端市场风�?
- 作为组合优化的输入，提供风险约束
- 作为应急预警系统的基础，提供风险缓释措�?

### 1.3 核心功能清单

1. **历史情景分析**: 分析历史危机事件的风险暴�?
2. **蒙特卡洛压力测试**: 模拟极端市场情景
3. **风险暴露报告**: 生成极端情景下的风险暴露报告
4. **应急预警系�?*: 提供应急预警和风险缓释措施
...
|----------|----------|----------|----------|----------|
| **2008金融危机** | 2008-09�?009-03 | 雷曼兄弟破产 | 股票-50%、信用利�?500bp | 极端信用风险 |
| **2020疫情冲击** | 2020-02�?020-03 | COVID-19爆发 | 股票-35%、波动率+300% | 突发事件风险 |
| **2015股灾** | 2015-06�?015-08 | 杠杆去化 | A�?45%、流动性枯�?| 流动性风�?|
| **2018贸易�?* | 2018-03�?018-12 | 中美贸易摩擦 | 科技�?25%、汇率波�?| 地缘政治风险 |
| **2022加息周期** | 2022-01�?022-12 | 美联储加�?| 成长�?40%、利�?400bp | 利率风险 |
| **1997亚洲金融危机** | 1997-07�?998-01 | 泰铢贬�?| 亚洲股市-60%、汇率崩�?| 新兴市场风险 |
...
| 指标类别 | 指标名称 | 计算方法 | 风险阈�?| 说明 |
|----------|----------|----------|----------|------|
| **损失指标** | 最大损�?| Max(情景损失) | -20% | 极端情景下的最大损�?|
| **损失指标** | 平均损失 | Mean(情景损失) | -10% | 所有情景的平均损失 |
| **损失指标** | 损失标准�?| Std(情景损失) | 5% | 损失的波动程�?|
| **风险暴露** | 因子暴露 | β×因子冲击 | 0.5 | 因子风险暴露 |
| **风险暴露** | 行业暴露 | 权重×行业冲击 | 30% | 行业风险暴露 |
| **风险暴露** | 风格暴露 | 风格因子×冲击 | 0.3 | 风格风险暴露 |
| **流动性指�?* | 平仓天数 | 持仓/日均成交�?| 5�?| 极端情况下平仓所需天数 |
| **流动性指�?* | 价格冲击 | 成交量×冲击系�?| 2% | 大额交易的价格冲�?|
| **尾部风险** | VaR(99%) | �?百分位损�?| -15% | 99%置信度下的损�?|
| **尾部风险** | ES(99%) | 尾部平均损失 | -20% | 超过VaR的平均损�?|
...
## 4. 流动性风�?
- **平仓天数**: {liquidation_days:.1f}�?
- **价格冲击**: {price_impact:.2%}
- **流动性风险等�?*: {liquidity_risk_level}
...
| PORTFOLIO_OPTIMIZATION | 被依�?| 为组合优化提供极端风险约�?|
...
| [组合情景分析蓝图](./PORTFOLIO_SCENARIO_ANALYSIS_BLUEPRINT.md) | PORTFOLIO_SCENARIO_ANALYSIS_001 | 强依�?| 提供情景分析 |

...
> **æ ¸å¿èè´£**: æ¨¡ææç«¯å¸åºææ¯ï¼è¯ä¼°æèµç»åæåè½å?
> **èè´£è¾¹ç**: 
> - â?æ¬ææ¡£è´è´£ï¼ååæµè¯ãææ¯åæãé£é©é¢è­?
...
- æ æ³æ¨¡ææç«¯å¸åºææ¯ä¸çé£é©æ´é²
- ç¼ºä¹åå²å±æºäºä»¶ææ¯åæè½å
- æ æ³æä¾åºæ¥é¢è­¦åé£é©ç¼éæªæ½

**ä»·å¼ä¸»å¼?*:
- å®ç°åå²ææ¯åæï¼?008éèå±æºã?020ç«æç­ï¼
- æä¾èç¹å¡æ´ååæµè¯è½å
- çææç«¯å¸åºææ¯ä¸çé£é©æ´é²æ¥å
- æä¾åºæ¥é¢è­¦åé£é©ç¼éæªæ½

**ä¸ªäººå¼åå¯è¡æ?*:
- å®ç°ç®åï¼åå²ææ¯åæ + èç¹å¡æ´æ¨¡æ
- æ°æ®å¬å¼ï¼åå²å±æºäºä»¶æ°æ®å¬å¼å¯è·å?
- ç»´æ¤ç®åï¼å®ææ´æ°ææ¯åºå³å?
- ä»·å¼æç¡®ï¼æç«¯é£é©çæ§å¿å¤

### 1.2 ææ¯å®ä½ä¸æ¶æå±å½å±?

**Layerå®ä½**: Layer 6 - ç»åä¼åå±ï¼é£é©é¢ç®å±ï¼

**æ¨¡åç±»å«**: æ ¸å¿æ¨¡å

**æ¶æè§è²**: 
- ä½ä¸ºé£é©é¢ç®å±çæ ¸å¿ç»ä»¶ï¼çæ§æç«¯å¸åºé£é?
- ä½ä¸ºç»åä¼åçè¾å¥ï¼æä¾é£é©çº¦æ
- ä½ä¸ºåºæ¥é¢è­¦ç³»ç»çåºç¡ï¼æä¾é£é©ç¼éæªæ?

### 1.3 æ ¸å¿åè½æ¸å

1. **åå²ææ¯åæ**: åæåå²å±æºäºä»¶çé£é©æ´é?
2. **èç¹å¡æ´ååæµè¯**: æ¨¡ææç«¯å¸åºææ¯
3. **é£é©æ´é²æ¥å**: çææç«¯ææ¯ä¸çé£é©æ´é²æ¥å
...
â?              ååæµè¯ä¸ææ¯åæç³»ç»æ¶æ?                         â?
âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ?
â?                                                                â?
â?ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ?  â?
â?â?            è¾å¥å±?                                       â?  â?
â?â?ââââââââââââ?ââââââââââââ?ââââââââââââ?ââââââââââââ?    â?  â?
â?â?âåå²å±æ? â?âå½åç»å? â?âå¸åºæ°æ? â?âææ¯åæ? â?    â?  â?
â?â?âäºä»¶æ°æ? â?âæä»?     â?â?         â?âéç½?     â?    â?  â?
â?â?ââââââââââââ?ââââââââââââ?ââââââââââââ?ââââââââââââ?    â?  â?
â?ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ?  â?
â?                        â?                                      â?
â?ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ?  â?
...
â?â?â?- åå²ææ¯åæ                                     â?  â?  â?
â?â?â?- èç¹å¡æ´æ¨¡æ                                     â?  â?  â?
â?â?â?- èªå®ä¹ææ?                                      â?  â?  â?
â?â?ââââââââââââââââââââââââââââââââââââââââââââââââââââââ?  â?  â?
â?ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ?  â?
â?                        â?                                      â?
â?ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ?  â?
...
```
åå²å±æºäºä»¶æ°æ® + å½åç»åæä»
    â?
ææ¯åæï¼åå²ææ¯åæ?+ èç¹å¡æ´æ¨¡æï¼?
    â?
...
class StressTestingSystem:
    """
    ååæµè¯ä¸ææ¯åæç³»ç»?
    
    ç´¢å¼: STRESS_TEST_001-M01
    èè´£: å®ç°ååæµè¯åææ¯åæ?
    è¾å¥: åå²å±æºäºä»¶æ°æ®ãå½åç»åæä»?
    ...
    def run_stress_test(
        ...
        Args:
            portfolio: å½åç»å
            scenarios: ææ¯åè¡¨ï¼åå²ææ?+ èç¹å¡æ´ææ¯ï¼?
            
        Returns:
            StressTestResult: ååæµè¯ç»æ
        """
        results = []
...
### 3.2 ææ¯åæå¨ï¼ScenarioAnalyzerï¼?
...
class ScenarioAnalyzer:
    ...
    ç´¢å¼: STRESS_TEST_001-M02
    èè´£: åæåå²ææ¯åçæèç¹å¡æ´ææ?
    """
    ...
    def apply_shock(
        ...
        Returns:
            Portfolio: å²å»åçç»å
        """
        # æ ¹æ®ææ¯ç±»ååºç¨ä¸åçå²å?
...
| ææ¯åç§° | æ¶é´èå´ | è§¦åäºä»¶ | ä¸»è¦å²å» | éç¨åºæ¯ |
|----------|----------|----------|----------|----------|
| **2008éèå±æº** | 2008-09è?009-03 | é·æ¼åå¼ç ´äº§ | è¡ç¥¨-50%ãä¿¡ç¨å©å·?500bp | æç«¯ä¿¡ç¨é£é© |
| **2020ç«æå²å»** | 2020-02è?020-03 | COVID-19çå | è¡ç¥¨-35%ãæ³¢å¨ç+300% | çªåäºä»¶é£é© |
...
| **1997äºæ´²éèå±æº** | 1997-07è?998-01 | æ³°é¢è´¬å?| äºæ´²è¡å¸-60%ãæ±çå´©æº?| æ°å´å¸åºé£é© |
...
### 5.1 ååæµè¯ææ åç±»

| ææ ç±»å« | ææ åç§° | è®¡ç®æ¹æ³ | é£é©éå?| è¯´æ |
|----------|----------|----------|----------|------|
| **æå¤±ææ ** | æå¤§æå¤?| Max(ææ¯æå¤±) | -20% | æç«¯ææ¯ä¸çæå¤§æå¤?|
| **æå¤±ææ ** | å¹³åæå¤± | Mean(ææ¯æå¤±) | -10% | ææææ¯çå¹³åæå¤± |
| **æå¤±ææ ** | æå¤±æ åå·?| Std(ææ¯æå¤±) | 5% | æå¤±çæ³¢å¨ç¨åº?|
| **é£é©æ´é²** | å å­æ´é² | Î²Ãå å­å²å» | 0.5 | å å­é£é©æ´é² |
| **é£é©æ´é²** | è¡ä¸æ´é² | æéÃè¡ä¸å²å» | 30% | è¡ä¸é£é©æ´é² |
| **é£é©æ´é²** | é£æ ¼æ´é² | é£æ ¼å å­Ãå²å» | 0.3 | é£æ ¼é£é©æ´é² |
| **æµå¨æ§ææ ?* | å¹³ä»å¤©æ° | æä»/æ¥åæäº¤é?| 5å¤?| æç«¯æåµä¸å¹³ä»æéå¤©æ° |
| **æµå¨æ§ææ ?* | ä»·æ ¼å²å» | æäº¤éÃå²å»ç³»æ?| 2% | å¤§é¢äº¤æçä»·æ ¼å²å?|
| **å°¾é¨é£é©** | VaR(99%) | ç¬?ç¾åä½æå¤?| -15% | 99%ç½®ä¿¡åº¦ä¸çæå¤?|
| **å°¾é¨é£é©** | ES(99%) | å°¾é¨å¹³åæå¤± | -20% | è¶è¿VaRçå¹³åæå¤?|
...
- **æµè¯èå´**: {test_scope}
- **ææ¯æ°é**: {n_scenarios}
- **æµè¯ç»è®º**: {conclusion}

## 2. ææ¯åæç»æ

### 2.1 åå²ææ¯
| ææ¯åç§° | ç»åæå¤± | é£é©ç­çº§ | ä¸»è¦é£é©å å­ |
|----------|----------|----------|--------------|
...
```python
# ååæµè¯æ¥å£
> **æ ¸å¿èè´£**: Stress Testing Systemèå¾è®¾è®¡
> **èè´£è¾¹ç**: 
> - â?æ¬ææ¡£è´è´£ï¼Stress Testing Systemèå¾è®¾è®¡ç¸å³åå®¹
> - â?æ¬ææ¡£ä¸è´è´£ï¼å¶ä»æ¨¡ååå®?


## æ ¸å¿èè´£

ååæµè¯ç³»ç»ï¼è´è´£æç«¯å¸åºææ¯çé£é©è¯ä¼°
...
def generate_scenarios(
    ...
    Args:
        scenario_type: ææ¯ç±»åï¼historical/monte_carlo/customï¼?
        config: ææ¯éç½®
        
    Returns:
        List[Scenario]: ææ¯åè¡¨
    """
    pass
```
...
| æ¨¡å | å³ç³»ç±»å | è¯´æ |
|------|----------|------|
| RISK_BUDGET_SYSTEM | ä¾èµ | æä¾é£é©é¢ç®çº¦æ |
| RISK_ATTRIBUTION_SYSTEM | ä¾èµ | æä¾é£é©å½å è½å |
| PORTFOLIO_OPTIMIZATION | è¢«ä¾èµ?| ä¸ºç»åä¼åæä¾æç«¯é£é©çº¦æ?|

### 5.2 æ¨èå®æ½è·¯å¾

1. åå®ç°åå²ææ¯åæ?(3-4å¤? - åºç¡è½å
...
| ææ  | ç®æ å?| æµéæ¹æ³ |
|------|--------|----------|
| **ææ¯åæåç¡®åº?* | â?5% | åå²åæµéªè¯ |
| **ååæµè¯æ§è¡æ¶é´** | <10s | æ§è½æµè¯ |
...
| [ç»åææ¯åæèå¾](./PORTFOLIO_SCENARIO_ANALYSIS_BLUEPRINT.md) | PORTFOLIO_SCENARIO_ANALYSIS_001 | å¼ºä¾èµ?| æä¾ææ¯åæ |
...
- **æ¨¡åID**: STRESS_TESTING_SYSTEM_001
- **èå¾ææ¡£**: STRESS_TESTING_SYSTEM_BLUEPRINT.md
- **ææ¯è§æ ¼ä¹¦**: å¾åå»?
- **èè´£**: å¨ç³»ç»?
- **ç¶æ?*: Active
```
...
| æ¨¡å | èè´£ | è¾¹ç |
|------|------|------|
| **Stress Testing System** | å¨ç³»ç»?| **æ ¸å¿æ¨¡å** |

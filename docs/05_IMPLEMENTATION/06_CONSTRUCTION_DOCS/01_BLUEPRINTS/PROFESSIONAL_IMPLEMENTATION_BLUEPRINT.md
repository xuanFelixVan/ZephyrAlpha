...
> **配套文档**: [AI策略自动化集成蓝图](../../../01_FRAMEWORK/AI_STRATEGY_AUTOMATION_BLUEPRINT.md) - 详细AI集成方案
...
**核心设计文档清单**：
- [PROFESSIONAL_MULTI_TIMEFRAME_ARCHITECTURE.md](../../../01_FRAMEWORK/PROFESSIONAL_MULTI_TIMEFRAME_ARCHITECTURE.md) - 三级时间框架架构（928行）
...
- **关联文档**：
  - [PROFESSIONAL_MULTI_TIMEFRAME_ARCHITECTURE.md](../../../01_FRAMEWORK/PROFESSIONAL_MULTI_TIMEFRAME_ARCHITECTURE.md) - 架构设计

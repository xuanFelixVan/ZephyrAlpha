...
负责Auto Repair Engine的设计、实现和维护，提供核心功能支持，确保系统模块的稳定运行和高效执行�?
...
|---------|-----------|---------|------|
| [数据质量监控蓝图](./DATA_QUALITY_MONITORING_BLUEPRINT.md) | DATA_QUALITY_MONITORING_001 | 强依�?| 提供质量异常检测结�?|
| [数据源管理蓝图](./DATA_SOURCE_MANAGEMENT_BLUEPRINT.md) | DATA_SOURCE_MANAGEMENT_001 | 中依�?| 提供数据源元数据 |
| [数据目录蓝图](./DATA_CATALOG_BLUEPRINT.md) | DATA_CATALOG_001 | 中依�?| 提供数据血缘信�?|

### 下游依赖

| 文档名称 | module_id | 依赖类型 | 说明 |
|---------|-----------|---------|------|
| [质量评分系统蓝图](./QUALITY_SCORING_SYSTEM_BLUEPRINT.md) | QUALITY_SCORING_SYSTEM_001 | 强依�?| 提供修复后质量评�?|
| [质量报告自动化蓝图](./QUALITY_REPORT_AUTOMATION_BLUEPRINT.md) | QUALITY_REPORT_AUTOMATION_001 | 中依�?| 提供修复历史记录 |
| [数据可观测性蓝图](./DATA_OBSERVABILITY_BLUEPRINT.md) | DATA_OBSERVABILITY_001 | 弱依�?| 提供修复监控指标 |
...
| **PyOD** | 1.1.0+ | 异常检�?| [官方文档](https://pyod.readthedocs.io/) |
...
| `repair_success_rate` | Gauge | 修复成功�?|
| `repair_duration_seconds` | Histogram | 修复耗时 |
| `repair_accuracy_score` | Gauge | 修复准确率评�?|

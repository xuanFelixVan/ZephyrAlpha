...
> **版本**: v1.0
> **创建日期**: 2026-04-02
> **职责**: 规范AI和人工开发行为，确保文件夹结构、命名、文档和代码的一致?> **强制级别**: 🔴 **强制执行** - 所有开发和文档构建必须遵循本规?> **适用对象**: AI智能体、开发人员、文档编写?
---
...
```
1. 检查文件位?2. 检查命名规?3. 检查内容完整?4. 运行质量门禁检?```

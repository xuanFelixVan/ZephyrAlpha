...
owner: 首席架构师
standard_type: 专业量化机构新人入职指南
applicable_scope: 所有新加入团队的开发人员和AI智能体
...
| **多时间框架架构** | [docs/01_FRAMEWORK/PROFESSIONAL_MULTI_TIMEFRAME_ARCHITECTURE.md](../../01_FRAMEWORK/PROFESSIONAL_MULTI_TIMEFRAME_ARCHITECTURE.md) | 45分钟 | 🔴 必读 |
...
| 文档名称 | 路径 | 阅读时间 | 重要程度 |
|---------|------|---------|---------|
| **蓝图施工说明书** | [docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/CONSTRUCTION_SPECIFICATION.md](../CONSTRUCTION_SPECIFICATION.md) | 45分钟 | 🔴 必读 |
| **AI施工快速参考** | [docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/AI_CONSTRUCTION_QUICK_REFERENCE.md](../AI_CONSTRUCTION_QUICK_REFERENCE.md) | 15分钟 | 🔴 必读 |
...
| 文档名称 | 路径 | 阅读时间 | 重要程度 |
|---------|------|---------|---------|
| **开发规范** | [docs/05_IMPLEMENTATION/02_DEVELOPMENT/DEVELOPMENT_STANDARDS.md](../02_DEVELOPMENT/DEVELOPMENT_STANDARDS.md) | 30分钟 | 🔴 必读 |
...
| **代码审查检查清单** | [docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/06_CHECKLISTS/CODE_REVIEW_CHECKLIST.md](../06_CHECKLISTS/CODE_REVIEW_CHECKLIST.md) | 20分钟 | 🔴 必读 |
| **部署前检查清单** | [docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/06_CHECKLISTS/PRE_DEPLOYMENT_CHECKLIST.md](../06_CHECKLISTS/PRE_DEPLOYMENT_CHECKLIST.md) | 20分钟 | 🟡 重要 |
...
2. **创建策略文件**
   ...
   class SimpleMAStrategy(BaseStrategy):
       ...
       def initialize(self, context: Dict[str, Any]) -> None:
           """初始化策略"""
           self.logger.info(f"初始化策略: {self.strategy_id}")
           self.logger.info(f"快速均线周期: {self.fast_period}")
           self.logger.info(f"慢速均线周期: {self.slow_period}")
...
**A**: 使用文档索引：
- 施工文档总索引: [docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/README.md](../README.md)
- 系统总索引: [docs/INDEX.md](../../INDEX.md)

### **Q2: 如何创建新模块？**

**A**: 遵循施工规范：
1. 阅读[蓝图施工说明书](../CONSTRUCTION_SPECIFICATION.md)
2. 使用LS命令检查现有文件夹结构
3. 确认目标位置和命名
4. 使用标准模板创建文件
5. 通过质量门禁检查
...
**A**: 遵循代码审查流程：
1. 阅读[代码审查检查清单](../06_CHECKLISTS/CODE_REVIEW_CHECKLIST.md)
2. 检查代码规范、安全性、性能
3. 提出建设性意见
4. 确保所有阻断项通过
...
**A**: 使用回测引擎：
1. 阅读[回测引擎集成指南](../02_IMPLEMENTATION_GUIDES/BACKTEST_ENGINE_GUIDE.md)
2. 准备策略和数据
3. 配置回测参数
4. 运行回测并分析结果
...
- **知识库**: [docs/05_IMPLEMENTATION/04_OPERATIONS/knowledge_base/](../04_OPERATIONS/knowledge_base/)
- **案例研究**: [docs/05_IMPLEMENTATION/04_OPERATIONS/knowledge_base/case_studies/](../04_OPERATIONS/knowledge_base/case_studies/)
- **最佳实践**: [docs/05_IMPLEMENTATION/04_OPERATIONS/knowledge_base/best_practices/](../04_OPERATIONS/knowledge_base/best_practices/)
...
1. **查阅文档**: 先查阅相关文档，大部分问题都有答案
2. **搜索Issue**: 在Git仓库搜索是否有类似问题
3. **提问**: 创建新Issue，详细描述问题
4. **寻求帮助**: 联系导师或团队成员
...
| 日期 | 版本 | 更新内容 | 更新人 |
|------|------|---------|--------|
| 2026-04-02 | v1.0 | 创建新人入职指南 | 首席架构师 |

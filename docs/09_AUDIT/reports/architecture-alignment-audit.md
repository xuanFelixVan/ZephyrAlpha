---
module_id: AUDIT-ARCH-ALIGN-001
...
|------|---------|-------------------|------|
| `leverage-management-blueprint.md` | L03 | l05_portfolio_construction | L03→L05 |
| `capital-allocation-blueprint.md` | L03 | l05_portfolio_construction | L03→L05 |
| `strategy-evaluation-engine-blueprint.md` | L05 | l03_signal_generation | L05→L03 |
| `volatility-prediction-blueprint.md` | L01 | l04_risk_management | L01→L04 |
| `circuit-breaker-system-blueprint.md` | L01 | l10_compliance | L01→L10 |
| `data-layer-implementation-blueprint.md` | L01 | l00_data_source | L01→L00 |
| `feature-store-blueprint.md` | L04 | l02_alpha_factor | L04→L02 |
| `risk-control-panel-blueprint.md` | L06 | l04_risk_management | L06→L04 |
...
| `architecture-model/architecture-endgame-locked.md` | `ARCH-ENDGAME-001` | 待分配 |
...
| **P0** | L13 命名不一致（YAML vs 代码） | 架构模型与代码脱节 | 统一为 `l13_experimentation`（改 YAML） | 1 YAML 文件 |

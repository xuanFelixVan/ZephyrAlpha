...
> **治理规则**见 `docs/01_policies_and_standards/governance/compliance/`。
> **审计协议**：每次审计启动前必读 [GOV-CMP-003](../01_policies_and_standards/governance/compliance/audit-protocol.md)。

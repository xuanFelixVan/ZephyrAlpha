...
2. **先 dry-run**：任选 **50 个** 双 YAML 文件，输出 unified diff 到**本批专用目录**（建议 `docs/09_AUDIT/STATE/double_yaml_dryrun_<YYYYMMDD>/`）；**历史 2026-04-08 样本**已归档至 [`docs/06_ARCHIVE/20260408_double_yaml_dryrun_sample/`](../../06_ARCHIVE/20260408_double_yaml_dryrun_sample/README.md)，你肉眼确认无误后再全量写回。  

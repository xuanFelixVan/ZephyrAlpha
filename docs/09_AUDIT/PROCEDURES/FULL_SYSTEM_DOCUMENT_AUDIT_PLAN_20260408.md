...
- [**审计全案**（重复内容处理办法、清单用法）](./FULL_SYSTEM_AUDIT_COMPLETE_CASE_20260408.md)  
- [**按子目录的完整 `*.md` 文件列表**](../STATE/MD_FILES_BY_SUBDIRECTORY_20260408.md)（机器生成；更新命令：`python scripts/generate_md_inventory_by_dir.py`）
...
以下内容已在 [**审计全案**（v1.1.0）](./FULL_SYSTEM_AUDIT_COMPLETE_CASE_20260408.md) 中展开，本方案与之一一对应，避免重复粘贴：

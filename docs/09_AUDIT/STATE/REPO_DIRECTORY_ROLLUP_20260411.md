...
> 由 `scripts/governance/export_repo_directory_rollup.py` 生成；**仅已跟踪**，共 **4459** 条路径。
> JSON 真源：[`REPO_DIRECTORY_ROLLUP_20260411.json`](./REPO_DIRECTORY_ROLLUP_20260411.json)

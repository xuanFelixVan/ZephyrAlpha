...
generated_date: '20260427'
generated_by: scripts/governance/scan_index_health.py
---

# 索引健全性扫描报告（零入链候选）

> **机器真源**：[`INDEX_HEALTH_ORPHAN_20260427.json`](./INDEX_HEALTH_ORPHAN_20260427.json)
> **候选范围**：`docs/06_ARCHIVE/20260407_p1_cleanup_archive` ｜ **候选 md 数**：23 ｜ **入链来源**：all-tracked（3184 个 md）
> **零入链（已应用 ignore 后）**：**0**

...
> **规则**：见 `GOVERNANCE_DECISIONS_LOCKED_20260408.md` **ADR-OC-001** 与执行手册 **EC-3**。全库 `merge_double_yaml_frontmatter.py --list` 应为 **0**；若个别文件经批准保留双头，**逐行登记**下方表格。

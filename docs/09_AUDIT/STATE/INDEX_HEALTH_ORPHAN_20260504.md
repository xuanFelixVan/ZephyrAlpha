...
generated_date: '20260504'
generated_by: scripts/governance/scan_index_health.py
---

# 索引健全性扫描报告（零入链候选）

> **机器真源**：[`INDEX_HEALTH_ORPHAN_20260504.json`](./INDEX_HEALTH_ORPHAN_20260504.json)
> **候选范围**：`docs/07_AI_REPORTING` ｜ **候选 md 数**：2 ｜ **入链来源**：all-tracked（2552 个 md）
> **零入链（已应用 ignore 后）**：**0**

---
module_id: REPO_DIRECTORY_ROLLUP_20260414
version: 1.0.0
status: Active
...
> 由 `scripts/governance/export_repo_directory_rollup.py` 生成；**仅已跟踪**，共 **4474** 条路径。

> JSON 真源：`REPO_DIRECTORY_ROLLUP_20260414.json`
...
- 治理时按前缀从大到小或按业务优先级排序；每一前缀「清空」的标准见 全仓库文件治理任务清单 **§7**。
...
| `docs/09_AUDIT/REPORTS` | 499 |

| `docs/05_IMPLEMENTATION/04_OPERATIONS` | 407 |

| `docs/09_AUDIT/STATE` | 390 |
...
| `docs/06_ARCHIVE/20260408_double_yaml_dryrun_sample` | 51 |

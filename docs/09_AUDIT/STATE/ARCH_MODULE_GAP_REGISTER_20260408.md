...
| G-013 | G4 | Layer 11 子能力映射 | `ARCHITECTURE.md` §Layer 11 | 逐项↔蓝图 | 对照表 22/22；宏观因子主链见 MACRO 专篇 | P2 | 见 [LAYER11_CAPABILITY_TO_BLUEPRINT_MAP_20260408.md](./LAYER11_CAPABILITY_TO_BLUEPRINT_MAP_20260408.md) v1.2 | **已修正**（批次 E+F） |

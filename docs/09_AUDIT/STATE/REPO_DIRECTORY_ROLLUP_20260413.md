...
> 由 `scripts/governance/export_repo_directory_rollup.py` 生成；**仅已跟踪**，共 **4468** 条路径。
...
| `docs/09_AUDIT/STATE` | 382 |
| `docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS` | 273 |
...
| `docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/00_MANAGEMENT` | 23 |

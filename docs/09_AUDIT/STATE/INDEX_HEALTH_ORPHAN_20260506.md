...
generated_date: '20260506'
generated_by: scripts/governance/scan_index_health.py
---

# 索引健全性扫描报告（零入链候选）

> **机器真源**：[`INDEX_HEALTH_ORPHAN_20260506.json`](./INDEX_HEALTH_ORPHAN_20260506.json)
> **候选范围**：`docs/10_GOVERNANCE_COMPLIANCE` ｜ **候选 md 数**：21 ｜ **入链来源**：all-tracked（2554 个 md）
> **零入链（已应用 ignore 后）**：**0**

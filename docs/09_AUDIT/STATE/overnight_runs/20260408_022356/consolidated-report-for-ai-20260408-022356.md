---
module_id: CONSOLIDATED_REPORT_FOR_AI_20260408_022356
version: 1.0.0
status: Active
...
- `MANIFEST.json` — 步骤与时间
- `module_id_duplicates_detail_20260408_022356.md` — 重复 id 与路径列表
- `invalid_links_detail_20260408_022356.md` — 无效链接表
- `CONSOLIDATED_REPORT_FOR_AI_20260408_022356.md` — 本汇总（basename 已带 run_id，避免 C2 碰撞）
...
1. 阅读 `invalid_links_detail_20260408_022356.md`，按类修复：缺失文件 / 伪链接 / 路径层级错误。
2. 按 `module_id_duplicates_detail_20260408_022356.md` 分批消解重复（先 audit_state 与 INDEX 模板）。

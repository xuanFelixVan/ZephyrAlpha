...
> 仓库: `D:\ZephyrAlpha`
> 运行目录: `docs\09_AUDIT\STATE\overnight_runs\20260408_021344`
...
| 判定无效链接 | 68 |
| 重复 module_id 组数 | 238 |
| 未检出 module_id 文件数（头 120KB） | 64 |

## 2. 本目录产出文件（请优先阅读）

- `MANIFEST.json` — 步骤与时间
- `module_id_duplicates_detail_20260408_021344.md` — 重复 id 与路径列表
- `invalid_links_detail_20260408_021344.md` — 无效链接表
- `CONSOLIDATED_REPORT_FOR_AI_20260408_021344.md` — 本汇总（basename 已带 run_id，避免 C2 碰撞）
...
| 245173 | `docs/09_AUDIT/STATE/MD_FILES_BY_SUBDIRECTORY_20260408.md` |
...
| 59007 | `review_materials_package/data_consistency/补偿事务设计文档.md` |

## 5. Git 快照（摘录）

```text
$ git rev-parse HEAD
ad328ad9bfe96731e235ec5c469514611280de97
...
$ git status -sb
## backup/layer25-deep-audit-20260407
?? scripts/overnight_audit_runner.py
...
1. 阅读 `invalid_links_detail_20260408_021344.md`，按类修复：缺失文件 / 伪链接 / 路径层级错误。
2. 按 `module_id_duplicates_detail_20260408_021344.md` 分批消解重复（先 audit_state 与 INDEX 模板）。

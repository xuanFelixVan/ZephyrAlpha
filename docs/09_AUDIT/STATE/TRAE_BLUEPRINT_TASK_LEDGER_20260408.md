...
| C11 | `docs/01_FRAMEWORK/DISASTER_RECOVERY_FRAMEWORK_ENTRY.md`（C2 消解；canonical：`01_BLUEPRINTS/DISASTER_RECOVERY_BLUEPRINT.md`） | Cursor | 已完成 | 2026-04-09 | 0 | 原 `DISASTER_RECOVERY_BLUEPRINT.md` 已归档见 `06_ARCHIVE/20260410_c2_disaster_recovery/` |
...
- `docs/01_FRAMEWORK/DISASTER_RECOVERY_FRAMEWORK_ENTRY.md`（stub；正式稿 `01_BLUEPRINTS/DISASTER_RECOVERY_BLUEPRINT.md`）

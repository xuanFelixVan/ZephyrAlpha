---
module_id: ARCHITECTURE_SERVICE_CATALOG_20260411
version: 1.0.0
status: Active
...
> **机器真源**：`ARCHITECTURE_SERVICE_CATALOG_20260411.json`

> **复跑**：仓库根 `python scripts/governance/generate_architecture_service_catalog.py`

> **叙事与裁决**仍以 [`docs/01_FRAMEWORK/ARCHITECTURE.md`](../../01_FRAMEWORK/ARCHITECTURE.md)、`docs/System_Manifest.md` 等为真源；本文仅**从代码/元数据推导**的索引视图。
...
- **对外契约**： `docs/03_TRADING_TACTICS/API_Contract.md`（存在：**是**）

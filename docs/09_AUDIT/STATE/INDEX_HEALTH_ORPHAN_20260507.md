...
generated_date: '20260507'
generated_by: scripts/governance/scan_index_health.py
---

# 索引健全性扫描报告（零入链候选）

> **机器真源**：[`INDEX_HEALTH_ORPHAN_20260507.json`](./INDEX_HEALTH_ORPHAN_20260507.json)
> **候选范围**：`docs/08_HUMAN_AI_INTERFACE` ｜ **候选 md 数**：107 ｜ **入链来源**：all-tracked（2555 个 md）
> **零入链（已应用 ignore 后）**：**0**

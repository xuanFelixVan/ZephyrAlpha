...
- [Continuous Audit Workflow](CONTINUOUS_AUDIT_WORKFLOW.md) - `CONTINUOUS_AUDIT_WORKFLOW_001`
- [Module Id Registry](MODULE_ID_REGISTRY.md) - `MODULE_ID_REGISTRY_001`
- [Responsibility Boundary Map](RESPONSIBILITY_BOUNDARY_MAP.md) - `RESPONSIBILITY_BOUNDARY_MAP_001`

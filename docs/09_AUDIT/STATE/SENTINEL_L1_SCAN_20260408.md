...
|------|------|
| 扫描文件 | 4940 |
| Markdown 内链（非 http/锚点等已排除） | 8371 |
| 跳过（外链/锚点等） | 1396 |
| 判定有效 | 1670 |
| 判定无效 | 5305 |
...
- depth=6 `.venv-1/Lib/site-packages/pip/_vendor/idna/LICENSE.md`
- depth=6 `.audit_fix_backup/docs/09_AUDIT/STATE/overnight_runs/20260408_033240/INDEX.md`
- depth=6 `.audit_fix_backup/docs/09_AUDIT/STATE/overnight_runs/20260408_022356/INDEX.md`
- depth=6 `.audit_fix_backup/docs/09_AUDIT/STATE/overnight_runs/20260408_021344/INDEX.md`
- depth=6 `.audit_fix_backup/docs/05_IMPLEMENTATION/07_OPERATIONS/knowledge_base/tools_guides/metadata-enhancer-guide.md`
- depth=6 `.audit_fix_backup/docs/05_IMPLEMENTATION/07_OPERATIONS/knowledge_base/tools_guides/document-auditor-guide.md`
- depth=6 `.audit_fix_backup/docs/05_IMPLEMENTATION/07_OPERATIONS/knowledge_base/tools_guides/INDEX.md`
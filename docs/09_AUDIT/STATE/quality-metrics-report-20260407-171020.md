...
| **总文件数** | 2091 | 系统中的Markdown文档总数 |

| **元数据符合率** | 2.10% | 包含YAML元数据的文档占比 |

| **职责符合率** | 1.20% | 包含职责描述的文档占比 |

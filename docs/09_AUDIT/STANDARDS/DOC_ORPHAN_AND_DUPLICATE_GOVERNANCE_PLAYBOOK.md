...
| 2026-04-08 | [`BLUEPRINT_PHASE_DOCUMENT_HYGIENE_MASTER_PLAN_20260408.md`](../PROCEDURES/BLUEPRINT_PHASE_DOCUMENT_HYGIENE_MASTER_PLAN_20260408.md) | 蓝图阶段「彻底清洁」总执行案（P0–P3）；`scripts/strict_orphan_inbound_scan.py` 供孤儿清单重算 |

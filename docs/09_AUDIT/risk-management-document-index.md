...
- 合并两个"风控规则引擎"文档案`04_EXECUTION/05_RISK_ENGINE/README.md`
...
| 风控规则体系蓝图 | `03_TRADING_TACTICS/09_RISK_RULES/BLUEPRINT.md` | 规则框架 | ?保留 |
...
| 风险报告生成?| 03_TRADING_TACTICS/09_RISK_RULES/RISK_REPORT.md | 报告生成 | ?保留 |
...
| 简化风险预算系统蓝?| 05_IMPLEMENTATION/.../SIMPLIFIED_RISK_BUDGET_SYSTEM_BLUEPRINT.md | 风险预算框架 | ?保留 |





| 简化风险预算系统规?| 05_IMPLEMENTATION/.../SIMPLIFIED_RISK_BUDGET_SYSTEM_TECHNICAL_SPECIFICATION.md | 技术规?| ?保留 |
...
| BARRA风险模型蓝图 | 05_IMPLEMENTATION/.../BARRA_RISK_MODEL_BLUEPRINT.md | 模型框架 | ?保留 |





| BARRA风险模型规格 | 05_IMPLEMENTATION/.../BARRA_RISK_MODEL_TECHNICAL_SPECIFICATION.md | 技术规?| ?保留 |
...
| 实时风险监控仪表?| 01_FRAMEWORK/REALTIME_RISK_MONITORING_BLUEPRINT.md | 框架定义 | ?保留 |





| 实时风险对冲引擎 | 05_IMPLEMENTATION/.../REALTIME_RISK_HEDGE_ENGINE_BLUEPRINT.md | 实施实现 | ?保留 |
...
| 风险归因系统蓝图 | 05_IMPLEMENTATION/.../RISK_ATTRIBUTION_SYSTEM_BLUEPRINT.md | 归因框架 | ?保留 |





| 风险归因系统规格 | 05_IMPLEMENTATION/.../RISK_ATTRIBUTION_SYSTEM_TECHNICAL_SPECIFICATION.md | 技术规?| ?保留 |
...
| 尾部风险对冲蓝图 | 05_IMPLEMENTATION/.../TAIL_RISK_HEDGING_BLUEPRINT.md | 对冲框架 | ?保留 |
...
| 风险管理最佳实?| 08_KNOWLEDGE/BEST_PRACTICES/RISK_MANAGEMENT_BEST_PRACTICES.md | 最佳实?| ?保留 |

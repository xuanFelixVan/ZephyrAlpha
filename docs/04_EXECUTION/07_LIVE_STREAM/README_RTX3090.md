...
---
# 多主播直播金融分析系统 - RTX 3090 配置

> **快速开始指南** | RTX 3090 24GB + 64GB RAM + i7-12700KF
...
1. **[配置总结](./RTX3090_CONFIGURATION_SUMMARY.md)** ⭐ **从这里开始**
   - 完整配置方案
   - 下一步操作
   - 文档索引
...
5. **[安装脚本](./install_dependencies.ps1)** - 一键安装
6. **[部署脚本](./deploy_rtx3090.ps1)** - 一键部署

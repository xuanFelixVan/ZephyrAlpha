...
| 文档名称 | 说明 | 重要性 |
|---------|------|--------|
| [AI委员会概述](./04_AI_COMMITTEE/README.md) | AI委员会概述 | ⭐⭐⭐⭐ |
...
| [多引擎蓝图](./06_SIMULATION/MULTI_ENGINE_BLUEPRINT.md) | 多引擎蓝图 | ⭐⭐⭐⭐ |

### 实盘系统

| 文档名称 | 说明 | 重要性 |
|---------|------|--------|
| [实盘流概述](./07_LIVE_STREAM/README_RTX3090.md) | 实盘流概述 | ⭐⭐⭐⭐ |
...
1. 阅读 [README.md](./README.md) - 执行层概述
2. 阅读 [01_EVENT_ENGINE/EVENT_BUS.md](./01_EVENT_ENGINE/EVENT_BUS.md) - 事件总线

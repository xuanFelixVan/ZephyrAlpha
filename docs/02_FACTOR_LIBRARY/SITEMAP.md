...
**快速上手路线** (30分钟):
1. 阅读 [INDEX.md](../03_TRADING_TACTICS/INDEX.md) - 快速入口 (5分钟)
2. 阅读 [00_OVERVIEW/README.md](../../README.md) - 系统总览 (10分钟)
3. 阅读 [05_IMPLEMENTATION/01_QUICKSTART/README.md](../../README.md) - 快速开始 (15分钟)
...
4. 阅读 [02_FACTOR_LIBRARY/02_ALPHA_FACTORS_INDEX.md](02_ALPHA_FACTORS_INDEX.md) - 因子库 (30分钟)
5. 阅读  - 开发规范 (1小时)
6. 实践编写策略代码 (1.5小时)
...
3. 按审计标准执行: [09_AUDIT/STANDARDS/AUDIT_STANDARDS.md](../09_AUDIT/STANDARDS/AUDIT_STANDARDS.md) - 审计标准 (15分钟)
...
- [02_FACTOR_LIBRARY/02_ALPHA_FACTORS_INDEX.md](02_ALPHA_FACTORS_INDEX.md) - 因子库
...
-  - 风险因子
-  - 因子方法论
- [02_FACTOR_LIBRARY/01_METHODOLOGY/FACTOR_MANAGEMENT_STANDARD.md](01_METHODOLOGY/FACTOR_MANAGEMENT_STANDARD.md) - 因子管理标准
- [02_FACTOR_LIBRARY/01_METHODOLOGY/FACTOR_SCREENING_STRATEGY.md](01_METHODOLOGY/FACTOR_SCREENING_STRATEGY.md) - 因子筛选策略

...
> **核心职责**: 因子筛选流程实施和工具开发，涉及因子筛选策略
> **职责边界**: 
> - ✅ 本文档负责：筛选流程设计、筛选工具开发、筛选结果评估、筛选参数优化
> - ❌ 本文档不负责：因子管理标准制定、生命周期管理、分层标准制定
> - 📋 相关文档：[因子管理标准](FACTOR_MANAGEMENT_STANDARD.md) - 管理标准和规范
>
> **版本**: v1.0
> **创建日期**: 2026-03-30
> **Layer**: Layer 2 (因子层)
...
factor_screening:
  # 阶段1: 初筛
  stage1:
    data_completeness_threshold: 0.10  # 缺失�?< 10%
    ic_mean_threshold: 0.02            # IC均�?> 0.02
  ...
  stage2:
    ...
    correlation_threshold: 0.85        # 相关�?< 0.85
...
|------|----------|--------|----------|
| **核心因子** | 5-10�?| 0.05+ | 30% |
| **卫星因子** | 15-20�?| 0.03-0.05 | 50% |
| **实验因子** | 5-10�?| 0.02-0.03 | 20% |

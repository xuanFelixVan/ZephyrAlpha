...
> 因子分类体系与参数配置标准
>
> **核心职责**: 定义因子分类体系架构和参数配置标准，涉及因子分类学
> **职责边界**: 
> - ✅ 本文档负责：因子分类体系定义、分类标准、参数配置规范
> - ❌ 本文档不负责：具体因子清单、因子元数据、因子注册管理
> - 📋 相关文档：因子注册表 - 因子清单和元数据管理
> - 📋 相关文档：因子计算框架 - 计算引擎和调度器
...
| 因子类别 | 因子数量 | 文档位置 |
|----------|----------|----------|
| Alpha趋势 | 14+ | 02_ALPHA_FACTORS_INDEX.md |
| Alpha均值回?| 12+ | 02_ALPHA_FACTORS_INDEX.md |
| Alpha价?| 11+ | 02_ALPHA_FACTORS_INDEX.md |
| Alpha成长 | 10+ | 02_ALPHA_FACTORS_INDEX.md |
| Alpha质量 | 17+ | 02_ALPHA_FACTORS_INDEX.md |
| Alpha动量 | 9+ | 02_ALPHA_FACTORS_INDEX.md |
| Alpha情绪 | 14+ | 02_ALPHA_FACTORS_INDEX.md |
| Barra风格 | 10 | T.03.RF001.barra_style_factors.md |
| 行业因子 | 28+ | T.03.RF002.industry_factors.md |
| 尾部风险 | 8+ | T.03.RF003.tail_risk_factors.md |
| THS_BD数据?| 5700+ | THS_BD_COMPLETE_INDICATOR_LIST.md |
| **合计** | **5900+** | |

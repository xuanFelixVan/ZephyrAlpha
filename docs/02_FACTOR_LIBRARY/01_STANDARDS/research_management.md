...
✅ 5.0务实选择: Obsidian笔记 + Jupyter研究 + 简单文件管理
```
...
| 用途 | 工具 | 理由 |
|------|------|------|
| **笔记管理** | Obsidian | 知识网络、Markdown友好、本地存储 |
| **代码研究** | Jupyter Notebook | 交互式分析、事实标准 |
| **版本控制** | Git | 代码和文档版本管理 |
| **文件组织** | 标准化目录 | 简单直接，不过度设计 |
...
| 功能 | 时机 | 说明 |
|------|------|------|
| MLflow实验追踪 | 实验数量>100后 | 当前CSV足够 |
| Airflow工作流 | 流程完全标准化后 | 当前Jupyter足够 |

...
| 子目�?文件 | 职责 | 状�?|
|-------------|------|------|
| [README.md](README.md) | 数据源概�?| Active |
| [NEWS_SENTIMENT_DATA_SOURCE.md](NEWS_SENTIMENT_DATA_SOURCE.md) | 新闻舆情数据�?| Active |
| [IFIND_CONNECTOR.md](IFIND_CONNECTOR.md) | iFind数据源接�?| Active |
| [BAOSTOCK_CONNECTOR.md](BAOSTOCK_CONNECTOR.md) | Baostock数据源接�?| Active |
...
| [FREE_DATA_SOURCES.md](FREE_DATA_SOURCES.md) | 免费数据源整�?| Active |
| [A_SHARE_HISTORICAL_DATA_PROCESSING_BLUEPRINT.md](A_SHARE_HISTORICAL_DATA_PROCESSING_BLUEPRINT.md) | A股历史数据处理蓝�?| Active |
| [IFIND/](IFIND/) | iFind数据源详细配�?| Active |
...
### 数据源接�?- [IFIND_CONNECTOR.md](IFIND_CONNECTOR.md) - iFind主数据源

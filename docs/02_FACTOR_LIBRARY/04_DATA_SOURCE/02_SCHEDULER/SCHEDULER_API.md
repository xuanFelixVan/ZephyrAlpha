---
module_id: FACTOR_智能下载调度器API参考_001
version: 1.0.0
status: Active
...
| 文档 | 路径 | 关系 | 说明 |
|------|------|------|------|
| 调度蓝图 | [BLUEPRINT.md](./BLUEPRINT.md) | 架构层 | 调度器详细设计 |
...
- [BLUEPRINT.md](BLUEPRINT.md): 调度器蓝图设计
- [../DATA_ACQUISITION.md](../DATA_ACQUISITION.md): 数据采集系统

...
| financial_statements/ | 财务数据 | Active |
...
- IFIND_CONNECTOR.md - iFind数据源接口文档

### 财务数据

- financial_statements/INDEX.md - 财务数据索引
- financial_statements/THS_BD_COMPLETE_INDICATOR_LIST.md - 完整指标清单

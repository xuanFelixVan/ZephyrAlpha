---
module_id: DATA_QUALITY_CONTROL_SYSTEM
version: 1.0.0
status: Active
...
> **核心职责**: 数据质量控制体系和质量评估方法，涉及数据质量控制系统
> **职责边界**: 
> - ✅ 本文档负责：数据质量控制体系和质量评估方法
> - ❌ 本文档不负责：其他模块内容
...
| 文档 | 路径 | 关系 | 说明 |
|------|------|------|------|
| 数据清洗引擎 | ../03_CLEANING/BLUEPRINT.md | 上游处理 | 数据清洗规则 |
| 数据流水线 | ../07_DATA_PIPELINE/BLUEPRINT.md | 整体架构 | 数据流水线设计 |
| 数据监控增强 | ../DATA_MONITORING_ENHANCED/BLUEPRINT.md | 执行层 | 数据质量监控执行 |

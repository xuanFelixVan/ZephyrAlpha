...
├── 00_RESOURCES/         # 资源文档
├── 01_FRAMEWORK/         # 框架设计
├── 02_FACTOR_LIBRARY/    # 因子�?├── 03_TRADING_TACTICS/   # 交易战术
...
| **架构迁移计划** | 从Layer 0-8迁移到三级时间框�?| [ARCHITECTURE_MIGRATION_PLAN.md](./01_FRAMEWORK/ARCHITECTURE_MIGRATION_PLAN.md) |
...
## 🔍 按角色导�?
### 系统架构�?
**核心文档**�?1. [专业多时间框架架构](./01_FRAMEWORK/PROFESSIONAL_MULTI_TIMEFRAME_ARCHITECTURE.md)

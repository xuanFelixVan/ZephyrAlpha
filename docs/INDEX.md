...
| 文件 | 说明 |
|------|------|
| `migration-declaration.md` | 文档体系双轨终止声明（唯一允许的根级 .md——所有其他 .md 必须进子抽屉） |
...
| 02 | `02_enterprise_architecture/` | 企业架构文档（TOGAF 视图 + ADR + 架构模型 YAML） | TOGAF · ADR |
...
- ❌ 架构视图/ADR/YAML 模型 → `02_enterprise_architecture/`

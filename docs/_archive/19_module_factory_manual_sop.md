...
>
> **文档元信息**（_working 临时区豁免规范：EXEMPT-ZONE-FM）：doc_type=architecture_view · title=模块工厂手动 SOP（Phase 0 六环节检查单） · owner=ZephyrAlpha-Owner · language=zh · status=active · version=1.0.0 · date=2026-08-22 · topic=module_factory_manual_sop · scope=09_ai_architecture

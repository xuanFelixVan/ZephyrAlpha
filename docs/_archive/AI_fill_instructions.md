...
>
> **文档元信息**（_working 临时区豁免规范：EXEMPT-ZONE-FM）：doc_type=architecture_view · title=AI 架构施工图填充指令集 · owner=ZephyrAlpha-Owner · language=zh · status=deprecated · version=0.3.0 · date=2026-08-17 · topic=ai_architecture_fill_sop · scope=09_ai_architecture

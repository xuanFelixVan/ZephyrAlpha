...
>
> **文档元信息**（_working 临时区豁免规范：EXEMPT-ZONE-FM）：doc_type=architecture_view · title=技术指标施工计划 · owner=ZephyrAlpha-Owner · language=zh · status=active · version=1.0.1 · date=2026-08-15 · topic=technical_indicator_build_plan · scope=07_trading_decision_architecture

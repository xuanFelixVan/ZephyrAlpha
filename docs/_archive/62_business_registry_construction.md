...
>
> **文档元信息**（_working 临时区豁免规范：EXEMPT-ZONE-FM）：doc_type=architecture_view · title=业务资产注册表体系施工总案 · owner=ZephyrAlpha-Owner · language=zh · status=active · version=1.36.1 · date=2026-08-16 · topic=business_registry_construction · scope=07_trading_decision_architecture

...
>
> **文档元信息**（_working 临时区豁免规范：EXEMPT-ZONE-FM）：doc_type=architecture_view · title=首批 3 策略定义 · owner=ZephyrAlpha-Owner · language=zh · status=active · version=1.3.2 · date=2026-08-15 · topic=first_batch_strategies · scope=07_trading_decision_architecture

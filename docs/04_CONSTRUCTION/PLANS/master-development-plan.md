...
| P2.2 | L01 数据处理 | [ ] | construction-plan-l01-data-processing.md |
| P2.3 | L02 特征工程 | [ ] | construction-plan-l02-feature-engineering.md |
| P2.4 | L03 信号生成 | [ ] | construction-plan-l03-signal-generation.md |
| P2.5 | L04 风险管理 | [ ] | construction-plan-l04-risk-management.md |
| P2.6 | L05 组合构建 | [ ] | construction-plan-l05-portfolio-construction.md |
| P2.7 | L06 交易执行 | [ ] | construction-plan-l06-trade-execution.md |
| P2.8 | L07 交易后分析 | [ ] | construction-plan-l07-post-trade-analytics.md |
| P2.9 | Cross-Layer | [ ] | construction-plan-shared.md |

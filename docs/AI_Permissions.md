...
| `quant_system_v4/src/modules/` | 模块实现代码 | 编写模块代码、单元测试 |
| `quant_system_v4/tests/` | 测试代码 | 编写测试用例 |
| `quant_system_v4/notebooks/` | Jupyter分析 | 创建分析笔记本 |
...
| `quant_system_v4/config/` | 配置文件 | 系统配置，不可修改 |
| `quant_system_v4/src/core/` | 核心基础类 | 核心基础，不可修改 |
...
| `.env` | API密钥 | 安全敏感 |
| `secrets/` | 私钥存放 | 安全敏感 |
| `quant_system_v4/.gitignore` | Git配置 | 系统配置 |
| `quant_system_v4/pyproject.toml` | 项目配置 | 系统配置 |
| `quant_system_v4/requirements.txt` | 依赖清单 | 系统配置 |

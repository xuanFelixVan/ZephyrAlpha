...
> module_id: MOD-INF-020 | version: 2.1.4 | status: active | domain: infra_ops
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-020` 的 131 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-020` |

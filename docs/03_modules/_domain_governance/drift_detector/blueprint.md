...
> module_id: MOD-INF-023 | version: 3.1.1 | status: Active | layer: cross_layer
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-023` 的 72 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-023` |

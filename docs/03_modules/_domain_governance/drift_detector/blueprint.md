...
> module_id: MOD-INF-023 | version: 3.1.8 | status: Active | layer: cross_layer
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-023`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-023`

#### 全景位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-023` 的 74 个 file 节点 | production | `extract_depgraph.py --modules MOD-INF-023` |

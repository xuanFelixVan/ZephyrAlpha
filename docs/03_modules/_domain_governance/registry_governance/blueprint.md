...
> module_id: MOD-INF-037 | version: 0.2.5 | status: Draft | domain: infra_ops
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-037`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-037`

#### 全景位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-037` 的 26 个 file 节点 | production | `extract_depgraph.py --modules MOD-INF-037` |

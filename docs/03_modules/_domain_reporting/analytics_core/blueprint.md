...
|---------|---------|---------|---------|---------|
| MOD-L06-001 Trade Execution | 必须 | CTR-005 Fill + CTR-004 Order | — | `D:\ZephyrAlpha\docs\03_modules\_domain-ex_core\execution-core\blueprint.md` |
| MOD-L05-001 Portfolio Construction | 必须 | CTR-006 PositionSnapshot | — | `D:\ZephyrAlpha\docs\03_modules\_domain-pf_core\portfolio-core\blueprint.md` |
| MOD-L04-001 Risk Management | 可选 | CTR-P1-011 RiskMetricsReport | — | `D:\ZephyrAlpha\docs\03_modules\_domain-risk\risk-management-core\blueprint.md` |
| MOD-L02-001 Alpha Factor | 可选 | CTR-P1-001 FactorMonitorReport | — | `D:\ZephyrAlpha\docs\03_modules\_domain-factor\alpha-factor-core\blueprint.md` |
...
| 产出物类型 | 存放完整绝对路径 | 说明 |
|----------|---------------|------|
| 蓝图文件 | `D:\ZephyrAlpha\docs\03_modules\_domain-reporting\analytics-core\blueprint.md` | 本文件 |

---
module_id: MOD-RK-048
doc_type: blueprint
ttl: permanent
blueprint_id: MOD-RK-048
domain_id: D_RISK
...
# MOD-RK-048 流动性监控器 (LiquidityMonitor)
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-RK-048` 的 5 个 file 节点 | production | `extract_depgraph.py --modules MOD-RK-048` |

...
> module_id: MOD-L04-001 | version: 2.2.29 | status: Active | layer: L2_domain
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L04-001` 的 179 个 file 节点 | production | `extract_depgraph.py --modules MOD-L04-001` |

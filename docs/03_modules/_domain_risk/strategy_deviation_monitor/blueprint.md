...
| 路径 | 说明 |
|------|------|
| src/zephyr/risk/core/strategy_deviation_monitor.py | 本模块唯一实现 |
| tests/risk/core/test_strategy_deviation_monitor.py | 测试 |
| docs/01_policies_and_standards/_registry/catalogs/alert_threshold_registry.yaml | 阈值真源（THD-DEVIATION-001/002/003） |
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-RK-23` 的 1 个 file 节点 | design | `extract_depgraph.py --modules MOD-RK-23` |

...
> module_id: MOD-INF-025 | version: 0.12.2 | status: active | domain: infra_ops
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-025`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-025`

#### 四图位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-025` 的 153 个 file 节点 | prototype | `extract_depgraph.py --modules MOD-INF-025` |

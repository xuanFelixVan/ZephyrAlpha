...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-001`
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-001` 的 34 个 file 节点 | production | `extract_depgraph.py --modules MOD-INF-001` |

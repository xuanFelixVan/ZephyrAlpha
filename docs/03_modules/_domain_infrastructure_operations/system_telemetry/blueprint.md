...
> module_id: MOD-INF-015 | version: 2.0.3 | status: Active | layer: L0_infrastructure
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-015`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-015`

#### 四图位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-015` 的 39 个 file 节点 | prototype | `extract_depgraph.py --modules MOD-INF-015` |
...
|------|-------------------|--------------------------|:-------:|
| module_id | MOD-INF-015 | MOD-INF-015 | ✅ |
| domain_id | N/A | N/A | ✅ |
| build_status | generated | generated | ✅ |
| file_count | 39 文件 | 16 文件（§0.1） | ❌ |
...
| 文件路径 | 实现状态 | 说明 |
|---------|:---:|------|
| `src/zephyr/governance/observability_governance/query_metrics.py` | ✅ 已实现 | |
| `src/zephyr/infrastructure/system_telemetry/__init__.py` | ✅ 已实现 | |
...
| `src/zephyr/infrastructure/system_telemetry/ai_behavior/__init__.py` | ✅ 已实现 | |
...
| `src/zephyr/infrastructure/system_telemetry/traces/__init__.py` | ✅ 已实现 | |

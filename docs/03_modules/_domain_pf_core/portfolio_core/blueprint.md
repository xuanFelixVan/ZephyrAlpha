...
| MOD-L06-001 | 下游 | CTR-004 Order 消费方（终局 CTR-007 TargetPortfolio） | — | `D:\ZephyrAlpha\docs\03_modules\_domain_ex_core\execution_core\blueprint.md` |
...
| 产出物类型 | 存放完整绝对路径 | 说明 |
|----------|---------------|------|
| 蓝图文件 | `D:\ZephyrAlpha\docs\03_modules\_domain_pf_core\portfolio-core\blueprint.md` | 本文件（含设计和施工指引） |

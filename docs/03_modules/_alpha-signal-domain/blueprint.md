...
actual_disk_path: "D:\\ZephyrAlpha\\src\\zephyr\\l02_alpha_factor\\ + D:\\ZephyrAlpha\\src\\zephyr\\l03_signal_generation\\"
...
ssot_yaml: "architecture-model/layers/l02_alpha_factor.yaml + l03_signal_generation.yaml"
depends_on:
...
> actual_disk_path: D:\ZephyrAlpha\src\zephyr\l02_alpha_factor\ + D:\ZephyrAlpha\src\zephyr\l03_signal_generation\ | generation: 2 | construction_progress: partially_implemented
...
| ssot_yaml | `D:\ZephyrAlpha\architecture-model\layers\l02_alpha_factor.yaml` + `l03_signal_generation.yaml` |
| blueprint_level | domain |
| priority | P1 |
...
| MOD-AF-001 | 必须 | L02 Alpha 因子核心 | — | `D:\ZephyrAlpha\docs\03_modules\l02_alpha_factor\alpha-factor-core\blueprint.md` |
| MOD-SIG-001 | 必须 | L03 信号生成核心 | — | `D:\ZephyrAlpha\docs\03_modules\l03_signal_generation\signal-generation-core\blueprint.md` |
...
| 产出物类型 | 存放完整绝对路径 | 说明 |
|----------|---------------|------|
| L02 因子核心 | `D:\ZephyrAlpha\src\zephyr\l02_alpha_factor\` | 因子计算+清洗+存储 |
| L03 信号核心 | `D:\ZephyrAlpha\src\zephyr\l03_signal_generation\` | 信号合成+评估+发送 |
...
|---|------------|------------|---------|---------|
| 1 | wt_factor_universe.yaml | `D:\ZephyrAlpha\architecture-model\layers\l02_alpha_factor.yaml` | 新因子类型注册 | 因子白名单 |
...
|---|--------|------------|------|:-----:|-------------------|
| 1 | l02_alpha_factor/ | §一 | 因子计算核心 | 已实现 | — |
| 2 | l03_signal_generation/ | §一 | 信号生成核心 | 已实现 | — |
...
| 验证项 | 验证方法 | 结果 |
|--------|---------|:---:|
| L02 __init__.py 存在 | Grep `l02_alpha_factor` | ☐ |
| L03 __init__.py 存在 | Grep `l03_signal_generation` | ☐ |
...
| 产出位置 | `D:\ZephyrAlpha\src\zephyr\l02_alpha_factor\pipeline.py` |
...
| 产出位置 | `D:\ZephyrAlpha\src\zephyr\l03_signal_generation\pipeline.py` |
...
|---|--------|---------------|:---:|:---:|:---:|
| 1 | AS-CT-FACTOR-001 管道 | `D:\ZephyrAlpha\src\zephyr\l02_alpha_factor\pipeline.py` | ☐ | ☐ | ☐ |
| 2 | AS-CT-SIGNAL-001 管道 | `D:\ZephyrAlpha\src\zephyr\l03_signal_generation\pipeline.py` | ☐ | ☐ | ☐ |
...
| 2 | L02 因子核心 | `D:\ZephyrAlpha\src\zephyr\l02_alpha_factor\` | 读取 | 代码对齐 |
| 3 | L03 信号核心 | `D:\ZephyrAlpha\src\zephyr\l03_signal_generation\` | 读取 | 代码对齐 |

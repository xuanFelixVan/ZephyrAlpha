...
> module_id: MOD-INF-019 | version: 0.19.2 | status: Active | layer: cross_layer
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-019` 的 202 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-019` |
...
| `src/zephyr/autonomy_core/skills/__init__.py` | ⚠️ 骨架 | |

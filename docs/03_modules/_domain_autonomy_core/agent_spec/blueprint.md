...
> module_id: MOD-INF-019 | version: 0.19.12 | status: Active | layer: cross_layer
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-019`

#### 全景位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-019` 的 204 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-019` |
...
| `tests/infrastructure/mcp/test_mcp_adapter.py` | ✅ 已实现 | |

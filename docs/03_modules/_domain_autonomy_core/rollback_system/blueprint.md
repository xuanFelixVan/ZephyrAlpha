...
submodule_path: src/zephyr/rollback
...
|---|------------|------------|---------|---------|
| 1 | 模块 ID 注册表 | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\module_id_registry.yaml` | MOD-INF-021 版本+generation | 蓝图升级 |

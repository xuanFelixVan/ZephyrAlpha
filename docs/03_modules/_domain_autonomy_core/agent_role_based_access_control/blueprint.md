...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-018`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-018`
...
> 完整报告见 adversarial_test_report.yaml

---

## §10 依赖关系

> **依赖图真源**：[dependency_path_panorama.md](file:///d:/ZephyrAlpha/docs/02_enterprise_architecture/04_architecture_principles_decisions/panorama/dependency_path_panorama.md) 线3:治理闭环
...
| `src/zephyr/security/access_control/guards/__init__.py` | ⚠️ 骨架 | |

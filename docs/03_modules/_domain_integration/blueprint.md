...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-042`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-042`

#### 全景位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-042` 的 12 个 file 节点 | production | `extract_depgraph.py --modules MOD-INF-042` |
...
|------|-------------------|--------------------------|:-------:|
| module_id | MOD-INF-042 | MOD-INF-042 | ✅ |
| domain_id | N/A | N/A | ✅ |
| build_status | generated | generated | ✅ |
| file_count | 12 文件 | 6 文件（§0.1） | ❌ |
...
| `src/zephyr/integration/failover_coordinator.py` | ✅ 已实现 | |
...
| 文件路径 | 实现状态 | 说明 |
|---------|:---:|------|
| `tests/integration/test_failover_coordinator.py` | ✅ 已实现 | |
| `tests/model/test_local_model.py` | ✅ 已实现 | |
| `tests/model/test_local_model_lsg_gate.py` | ✅ 已实现 | |

...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-042` 的 13 个 file 节点 | production | `extract_depgraph.py --modules MOD-INF-042` |
...
| 文件路径 | 实现状态 | 说明 |
|---------|:---:|------|
| `tests/integration/test_phase2_premarket_intraday_e2e.py` | ✅ 已实现 | |

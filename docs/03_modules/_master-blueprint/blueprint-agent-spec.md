...
actual_disk_path: "D:\\ZephyrAlpha\\docs\\03_modules\\_master-blueprint\\blueprint-agent-spec.md"
...
references:
  - path: "D:\\ZephyrAlpha\\docs\\03_modules\\_master-blueprint\\blueprint-baseline.md"
    section: "§二"
    why: "基线蓝图契约总表"
...
> actual_disk_path: D:\ZephyrAlpha\docs\03_modules\_master-blueprint\blueprint-agent-spec.md | generation: 2 | construction_progress: completed
...
> - 基线蓝图：[blueprint-baseline.md](file:///d:/ZephyrAlpha/docs/03_modules/_master-blueprint/blueprint-baseline.md)
...
|---------|---------|---------|---------|---------|
| MOD-MASTER-002 | 必须 | CT-* 契约定义 | — | `D:\ZephyrAlpha\docs\03_modules\_master-blueprint\blueprint-baseline.md` |
| MOD-INF-019 Agent Spec | 必须 | Skill 路由接口 | — | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\agent-spec\blueprint.md` |
...
|---|------------|------------|---------|---------|
| 1 | blueprint-baseline.md | `D:\ZephyrAlpha\docs\03_modules\_master-blueprint\blueprint-baseline.md` | CT-* 契约变更时同步 | CBAC 矩阵基于 CT-* |
...
| 子蓝图 | 触发条件 | 判定理由 |
|--------|---------|---------|
| blueprint-agent-spec.md | CBAC 矩阵 + Skill 路由 | 独立能力域——跨系统访问控制 |
...
|---|------|-----------|------|------------|----------|
| 1 | 基线蓝图 | MOD-MASTER-002 | v1.3.0 | `D:\ZephyrAlpha\docs\03_modules\_master-blueprint\blueprint-baseline.md` | CT-* 契约定义 |
| 2 | Agent Spec 蓝图 | MOD-INF-019 | — | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\agent-spec\blueprint.md` | Skill 路由 |

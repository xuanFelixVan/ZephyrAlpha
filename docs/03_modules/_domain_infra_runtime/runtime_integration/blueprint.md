...
actual_disk_path: "src/zephyr/shared/ + src/zephyr/infra_ops/ + src/zephyr/lifecycle_manager/"
...
|---|------------|------------|---------|---------|
| 1 | 模块 ID 注册表 | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\module_id_registry.yaml` | RI 模块注册 | 新增 RI-13~RI-15 |

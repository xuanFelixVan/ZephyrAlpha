...
> module_id: MOD-INF-022 | version: 2.1.2 | status: active | domain: infra_ops
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-022` 的 191 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-022` |

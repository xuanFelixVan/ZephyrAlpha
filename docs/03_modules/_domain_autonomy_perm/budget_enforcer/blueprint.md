...
submodule_path: src/zephyr/governance/ops_governance/budget_engine.py
...
ssot_claims:
  - claim: "Token/Cost/Time 三维预算策略唯一真源"
    scope: "config/budget_policy.yaml + src/zephyr/governance/ops_governance/budget_engine.py"
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-024`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-024`

#### 全景位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-024` 的 97 个 file 节点 | production | `extract_depgraph.py --modules MOD-INF-024` |

...
ttl: permanent
construction_progress: phase_3_complete
belongs_to: "MOD-MASTER-001"
actual_disk_path: "src/zephyr/vector_memory/"
last_updated: "2026-05-18"
last_verified: "2026-05-18"
generation: 1
functional_domain: data
layer_name: "l01_infrastructure"
...
> **actual_disk_path**: `src/zephyr/vector_memory/` | **generation**: 1 | **construction_progress**: phase_3_complete
...
| 验证项 | 验证方法 | 结果 |
|--------|---------|:---:|
| construction_progress = completed → 代码文件清单100%存在 | `ls src/zephyr/vector_memory/` 逐文件核对 | ☐ |
...
| §5.5 自动化触发机制状态列与代码实现一致 | `python scripts/governance/d5_architecture/checkers/check_blueprint_automation_sync.py --blueprint docs/03_modules/l01_infrastructure/vector-memory/blueprint.md` | ✅ |
...
| # | 声明项 | 值 |
|---|--------|-----|
| 1 | 主代码目录 | `src/zephyr/vector_memory/` |
| 2 | 已知副本目录 | `src/zephyr/kb/` — 原因：过渡期遗留，4 旧 Collection 仍在 kb/ 中；`src/zephyr/local_model/` — 原因：MOD-INF-039 拆分后 5 个文件在两目录存在副本 |
...
class CollectionManager:
    ...
    def write_with_provenance(self, collection_name: str, content: str, metadata: dict[str, Any]) -> str: ...
    def init_all_collections(self) -> list[CollectionInfo]: ...
...
> VMS 通过 `src/zephyr/mcp/vector_memory_server.py` 暴露 MCP Tool。
...
| MOD-KB-001 | 可选 | 知识库——beta VMS整合目标 | — | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\knowledge-base\blueprint.md` |
| MOD-INF-008 | 必须 | CE——VMS的主要消费方 | — | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\context-engine\blueprint.md` |
| MOD-INF-039 | 必须 | 本地模型推理——嵌入路由/缓存/Ollama/调度 | — | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\local-model\blueprint.md` |
| MOD-INF-010 | 可选 | FLE 消费检索反馈 | — | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\feedback-loop\blueprint.md` |
| L02-Alpha因子层 | 可选 | C轨域：因子语义检索 | — | `D:\ZephyrAlpha\docs\03_modules\l02_factor\blueprint.md` |
| L11-ML平台层 | 可选 | C轨域：模型语义检索 | — | `D:\ZephyrAlpha\docs\03_modules\l11_ml_platform\blueprint.md` |
| ADR-0016 | 必须 | VMS生产级嵌入与分块契约 | — | `D:\ZephyrAlpha\docs\02_enterprise_architecture\adr\adr-0016-vms-embedding-contract.md` |
| ADR-0031 | 必须 | Phase 2 ChromaDB基线选型 | — | `D:\ZephyrAlpha\docs\02_enterprise_architecture\adr\adr-0031-chromadb-vector-retrieval.md` |
| MOD-INF-039 | 必须 | 嵌入服务——EmbeddingRouter/CacheLayer/OllamaEmbedding已迁移至local_model | — | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\local-model\blueprint.md` |
...
| 业务代码 | `D:\ZephyrAlpha\src\zephyr\vector_memory\` | VMS 源码（25 个 .py + 1 个 .yaml） |
...
| 5 | ADR-0031 状态 | `D:\ZephyrAlpha\docs\02_enterprise_architecture\adr\adr-0031-chromadb-vector-retrieval.md` | 添加"已通向 VMS v0.9.0 8 Collection"注释 | 避免 ADR 与蓝图不一致 |
...
| 2 | ADR-0016 嵌入契约 | — | `D:\ZephyrAlpha\docs\02_enterprise_architecture\adr\adr-0016-vms-embedding-contract.md` | 嵌入规格 |
| 3 | ADR-0031 ChromaDB选型 | — | `D:\ZephyrAlpha\docs\02_enterprise_architecture\adr\adr-0031-chromadb-vector-retrieval.md` | 选型依据 |
| 4 | CE 蓝图 | MOD-INF-008 | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\context-engine\blueprint.md` | 集成目标 |
| 5 | KB 蓝图 | MOD-KB-001 | `D:\ZephyrAlpha\docs\03_modules\l01_infrastructure\knowledge-base\blueprint.md` | 整合目标 |
...
| 8 | AI 压缩工作流标准 | GOV-DOC-011 | `D:\ZephyrAlpha\docs\01_policies_and_standards\governance\document\compression-workflow-standard.md` | 压缩规则 |
| 9 | 元数据注册表 | PS-STD-001 | `D:\ZephyrAlpha\docs\01_policies_and_standards\meta\metadata-registry.md` | 编号规则 |
| 10 | 模块ID注册表 | — | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\module-id-registry.yaml` | 编号注册 |

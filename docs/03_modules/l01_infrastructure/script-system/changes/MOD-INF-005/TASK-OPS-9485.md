...
description: |
  ...
  目标文件: 
  描述: 
  证据: {"severity": "HIGH", "check_id": "DIR-STRUCTURE", "violations": 2}
...
```
{"severity": "HIGH", "check_id": "DIR-STRUCTURE", "violations": 2}
```

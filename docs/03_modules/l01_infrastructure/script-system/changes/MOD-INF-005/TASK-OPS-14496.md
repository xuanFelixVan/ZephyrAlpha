...
auto_generated: true
source_finding: FIND-D1-20260506-d12e6d882f05
...
# TASK-OPS-14496: 修复 CRITICAL Finding — 脚本执行异常（exit=2）

## 1. 问题概述

- **Finding ID**: FIND-D1-20260506-d12e6d882f05
- **严重度**: CRITICAL
- **维度**: D1
- **目标文件**: generators/inject_manifests.py

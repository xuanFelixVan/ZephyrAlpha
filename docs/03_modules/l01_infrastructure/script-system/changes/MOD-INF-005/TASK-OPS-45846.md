...
source_section: "auto-FIND-D3-20260506-74ec5846aa3c"
title: "修复 CRITICAL Finding: [CR-002] MOD-FLE-001 的 module_id 字段跨表不一致"
description: "从 CRITICAL Finding 自动生成。

原 Finding: FIND-D3-20260506-74ec5846aa3c
维度: D3
目标文件: docs/03_modules/_cross_layer/feedback-loop/blueprint.md
描述: [CR-002] MOD-FLE-001 的 module_id 字段跨表不一致
证据: 不一致的值:
  REG-001:module_id = MOD-FLE-001 ← SSoT
  physical:module_id = MOD-INF-010
...
downstream_outputs:
  - path: "docs/03_modules/_cross_layer/feedback-loop/blueprint.md"
...
# 修复 CRITICAL Finding: [CR-002] MOD-FLE-001 的 module_id 字段跨表不一致
...
| 风险 | 缓解 |
|------|------|
| 回滚 | git checkout -- docs/03_modules/_cross_layer/feedback-loop/blueprint.md |

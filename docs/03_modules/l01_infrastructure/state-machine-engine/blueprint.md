...
| `src/zephyr/shared/_state_machine_registry.yaml` | 状态机实例注册表 | 待创建 |
...
| 状态机实例注册 | `src/zephyr/shared/_state_machine_registry.yaml` | REG-SM-001 |
...
| 状态机注册表 | `src/zephyr/shared/_state_machine_registry.yaml` | 待创建 |
...
| 文件 | 同步内容 |
|------|---------|
| `src/zephyr/shared/_state_machine_registry.yaml` | 实例注册 |
| `docs/registry-of-registries.yaml` | REG-SM-001 entry_count |
...
STEP 2: 创建 src/zephyr/shared/_state_machine_registry.yaml — 注册表种子
...
- [x] 中央注册表已更新（registry-of-registries.yaml REG-SM-001）
- [x] 通用基类代码已创建

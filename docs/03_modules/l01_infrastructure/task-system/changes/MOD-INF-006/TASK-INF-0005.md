...
# ===== 内容 =====
title: "补齐 context_engine（compress / validate / shadow）"
description: "| 产出位置 | `D:\ZephyrAlpha\src\zephyr\context_engine\` |
|---------|------|
...
downstream_outputs:
  - path: "D:\ZephyrAlpha\src\zephyr\context_engine\"
    description: "补齐 context_engine（compress / validate / shadow）"
...
# ===== 回滚 =====
rollback_instructions: "删除本步骤新建的文件，恢复修改的文件。具体：D:\ZephyrAlpha\src\zephyr\context_engine\"

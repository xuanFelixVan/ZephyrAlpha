...
# ===== 内容 =====
title: "MCP Server 注册 decompose_blueprint"
description: "| 产出位置 | `D:\ZephyrAlpha\src\zephyr\mcp\task_manager_server.py` |
|---------|------|
...
downstream_outputs:
  - path: "D:\ZephyrAlpha\src\zephyr\mcp\task_manager_server.py"
    description: "MCP Server 注册 decompose_blueprint"
...
# ===== 回滚 =====
rollback_instructions: "删除本步骤新建的文件，恢复修改的文件。具体：D:\ZephyrAlpha\src\zephyr\mcp\task_manager_server.py"

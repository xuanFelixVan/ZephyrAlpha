...
immutable_core:
  ...
  protected_paths:
    - path: ".git/**"
      reason: "仓库状态——不可逆破坏"
    - path: "src/zephyr/agent_rbac/**"
      reason: "权限系统自身——不能被 AI 修改自己的护栏"
    - path: "docs/03_modules/l01_infrastructure/agent-rbac/blueprint.md"
      reason: "权限蓝图——唯一真源"
    - path: "AGENTS.md"
      reason: "核心原则——AI 行为宪法"
    ...
    - path: "src/zephyr/llm_security/process_sandbox.py"
      reason: "沙箱实现——安全边界代码"
  ...
  startup_lock:
    ...
    metric: "agent_rbac.cold_start.duration_seconds"
    ...
    schema_validation:
      ...
      example: |
        ...
        guardrails:
          input:
            - field: "file_path"
              not_matches: "src/zephyr/agent_rbac/"
            - field: "content"
...
EXPECTED_HASHES = {
    "src/zephyr/agent_rbac/immutable_core.py": "EXPECTED_SHA256_PLACEHOLDER",
    "src/zephyr/agent_rbac/permission_guard.py": "EXPECTED_SHA256_PLACEHOLDER",
    "src/zephyr/agent_rbac/rbac_guard.py": "EXPECTED_SHA256_PLACEHOLDER",
    "src/zephyr/agent_rbac/abac_guard.py": "EXPECTED_SHA256_PLACEHOLDER",
    "src/zephyr/agent_rbac/input_guard.py": "EXPECTED_SHA256_PLACEHOLDER",
    "src/zephyr/agent_rbac/sequence_guard.py": "EXPECTED_SHA256_PLACEHOLDER",
    "src/zephyr/agent_rbac/output_guard.py": "EXPECTED_SHA256_PLACEHOLDER",
}

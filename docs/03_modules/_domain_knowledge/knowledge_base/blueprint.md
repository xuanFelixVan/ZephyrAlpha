...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-KB-001`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-KB-001`

#### 四图位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-KB-001` 的 61 个 file 节点 | design | `extract_depgraph.py --modules MOD-KB-001` |
...
|------|-------------------|--------------------------|:-------:|
| module_id | MOD-KB-001 | MOD-KB-001 | ✅ |
| domain_id | N/A | N/A | ✅ |
| build_status | planned | planned | ✅ |
| file_count | 61 文件 | 28 文件（§0.1） | ❌ |

...
> module_id: MOD-L11-001 | version: 2.1.2 | status: active | domain: ml_train
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L11-001` 的 8 个 file 节点 | production | `extract_depgraph.py --modules MOD-L11-001` |

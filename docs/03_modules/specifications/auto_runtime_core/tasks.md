...
- `data/work_dags/daily-dream-cycle.yaml`
- `data/work_dags/daily-health-check.yaml`
...
- `data/work_dags/model-drift-check.yaml`
- **依赖**: T-5.1
- **产出**: 10 个 YAML 文件

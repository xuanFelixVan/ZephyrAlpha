...
submodule_path: src/zephyr/model-capability-exam
...
actual_disk_path: src/zephyr/model-capability-exam/
...
|---|------------|------------|---------|---------|
| 1 | 蓝图注册表 | `D:\ZephyrAlpha\docs\03_modules\blueprint-registry.yaml` | 版本升级至 2.1.0 | 蓝图升级 |

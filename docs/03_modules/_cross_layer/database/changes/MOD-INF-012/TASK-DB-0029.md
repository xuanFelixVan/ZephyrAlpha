...
namespace: "OPS"
seq: 29
title: "集成——mcp-servers (MOD-INF-013) 集成验证"
status: "PENDING"
priority: "P1"
phase: 0
...
acceptance_criteria:
  - "mcp-servers → task_repo.py + ATM session handoff"
  - "decompose_blueprint → task_repo.create() 调用链完整"
...
# DB-025-0029：集成——mcp-servers (MOD-INF-013) 集成验证

§7 #3: mcp-servers → task_repo.py + ATM session handoff.

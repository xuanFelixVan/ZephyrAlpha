...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-LLM_SECURITY`
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-LLM_SECURITY` 的 82 个 file 节点 | production | `extract_depgraph.py --modules MOD-LLM_SECURITY` |

...
> module_id: MOD-INF-035 | version: 6.0.9 | status: active | layer: cross_layer
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-035` 的 77 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-035` |
...
| `tests/automation/test_auto_runtime_vram_budget_gate.py` | ✅ 已实现 | |

...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-RESOURCE_OPTIMIZATION_ENGINE`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-RESOURCE_OPTIMIZATION_ENGINE`

#### 全景位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-RESOURCE_OPTIMIZATION_ENGINE` 的 6 个 file 节点 | design | `extract_depgraph.py --modules MOD-RESOURCE_OPTIMIZATION_ENGINE` |

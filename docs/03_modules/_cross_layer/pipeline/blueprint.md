...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-009`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-009`

#### 全景位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-009` 的 36 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-009` |
...
| `src/zephyr/integration/shared/contracts/errors/execution_rejection_error.py` | ✅ 已实现 | |
| `src/zephyr/integration/shared/contracts/errors/risk_limit_violation_error.py` | ✅ 已实现 | |
| `src/zephyr/integration/shared/contracts/errors/signal_degradation_warning.py` | ✅ 已实现 | |

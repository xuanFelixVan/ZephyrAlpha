...
| `src/zephyr/pipeline/pipeline_roadmap.py` | ✅ 已实现 | v0.10.0-v0.12.0 路线图骨架 + ConstructionPhaseTracker + CT-PIPE-ORC-001 集成桥接 |
...
| 路线图骨架 | `src/zephyr/pipeline/pipeline_roadmap.py` |
...
| 源码路径 | `src/zephyr/pipeline/` |
| 源码文件数 | 12 个 .py/.yaml |
| 测试路径 | `tests/integration/` |
| 配置文件 | `config/trigger_router.yaml` |
| 关键入口 | `pipeline.router.PipelineRouter + pipeline.executor.StageExecutor` |

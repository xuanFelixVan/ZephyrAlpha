...
submodule_path: src/zephyr/red-blue-validator
...
actual_disk_path: "src/zephyr/red-blue-validator/"
...
|---|------------|------------|---------|---------|
| 1 | 模块 ID 注册表 | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\module_id_registry.yaml` | MOD-INF-030 条目 | 模块注册 |

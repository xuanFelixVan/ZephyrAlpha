...
> module_id: MOD-INF-039 | version: 1.0.2 | status: active | layer: cross_layer
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-039`
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-039` 的 123 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-039` |

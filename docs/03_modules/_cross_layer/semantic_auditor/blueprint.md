...
submodule_path: src/zephyr/semantic-auditor
...
actual_disk_path: 'D:\ZephyrAlpha\src\zephyr\semantic-auditor\'
...
|---|------------|------------|---------|---------|
| 1 | 模块 ID 注册表 | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\module_id_registry.yaml` | 新增 MOD-INF-028 | 编号注册 |

...
> module_id: MOD-INF-010 | version: 0.34.3 | status: Draft | layer: cross_layer
...
| 场景 | 判定 | 理由 |
|------|------|------|
| FLE 蓝图中"容量升级附录"(§17) | **原地** | 服务对象相同 + 变更频率同步 + 依赖关系完全重叠 |
...
| 5 | 模块ID注册表 | — | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\module-id-registry.yaml` | 编号注册 |
...
|---|-------------|------------|----------|-------------|
| 1 | Drift Detector | `D:\ZephyrAlpha\src\zephyr\drift_detector\` | 异常检测 | FLE是闭环自改进引擎，Drift Detector是单点检测器；FLE包含检测+诊断+修复+验证全链路 |
...
| `src/zephyr/feedback_loop/detectors/action_efficacy_decay_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/action_interaction_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/action_side_effect_cumulative_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/agent_trajectory_anomaly_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/alert_desensitization_curve.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/anomaly_clustering.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/anomaly_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/autoscale_remediation.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/blast_radius.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/blast_radius_budget.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/capacity_forecast.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/chaos_engineering.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/concept_drift.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/config_drift.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/context_window_contamination_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/cross_signal_validator.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/cross_system_correlator.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/decision_provenance.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/dependency_freshness_monitor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/diminishing_returns_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/ebpf_monitor.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/emergent_behavior_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/ensemble_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/ensemble_drift.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/external_health.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/external_validation_checkpoint.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/flag_lifecycle.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/flapping_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/fle_performance_regression_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/gradual_poisoning_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/guard_cascade_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/guard_oscillation_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/heisenbug_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/infinite_loop_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/intermittent_failure_pattern.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/log_anomaly.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/maintenance_coordinator.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/metric_cardinality_guard.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/multi_signal_correlator.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/openfeature.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/otel_adapter.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/placebo_action_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/positive_feedback_defense.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/recursive_diagnosis_trust_evaluator.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/regime_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/regulatory_audit.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/resolution_tracker.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/rumor_noise_filter.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/runbook_executor.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/self_audit.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/self_diagnosis_data_leak_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/self_ha.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/silent_corruption_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/synthetic_anomaly_generator.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/temporal_coherence_of_self_model.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/temporal_pattern.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/trace_causal_bridge.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/traffic_replay_validator.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/detectors/trend_cycle_separator.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/detectors/version_migrator.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/action_composition_health_monitor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/adaptive_param_tuning.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/amplification_guard.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/api_dependency_metrics.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/auto_diagnosis.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/burn_rate_alerter.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/burnout_alarm.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/capacity_aware_repair.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/causal_inference_engine.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/cognitive_load.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/cognitive_load_budget.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/cold_start_conservative_mode.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/collaborative_learning.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/confidence_decomposer.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/context_truncation.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/context_window_pressure_manager.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/counterfactual.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/cross_guard_conflict_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/cross_session_consistency_validator.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/data_volume_growth_monitor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/diagnosis_engine.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/diagnosis_kpi.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/dr_resilience_metrics.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/e2e_integration_health.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/feedback_delay_compensator.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/fle_dogfood_monitor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/fle_self_slo_metrics.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/gamification.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/global_health_map.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/guard_interaction_topology_mapper.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/guard_self_consistency_auditor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/human_anomaly_flood_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/impact_predictor.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/incident_knowledge_injector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/interactive_diagnosis.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/knowledge_bus_factor_monitor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/knowledge_market.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/latency_slo.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/llm_provider_integrity.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/llm_quality_regression.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/memory_self_check.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/meta_guard_latency_budget.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/model_health.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/model_rotation.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/model_rotation_v2.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/model_version_semantic_drift.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/mtti_tracker.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/nonstationary_effectiveness.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/numerical_stability_guard.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/operational_seasonality.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/prompt_fingerprint.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/prompt_sanitizer.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/recovery_time_stats.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/regime_gain_scheduling.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/retirement_planner.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/self_benchmark.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/self_bottleneck_detector.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/self_health_monitor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/self_llm_observability.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/slo_capacity_metrics.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/socratic_questions.py` | ⚠️ 骨架 | |
| `src/zephyr/feedback_loop/diagnosers/statistical_hygiene_auditor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/system_entropy_monitor.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/temporal_integrity_guard.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/timezone_semantic_reasoner.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/toil_quantification.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/tone_adapter.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/tone_adapter_v2.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/value_added_baseline.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/vertical_self_assessment.py` | ✅ 已实现 | |
| `src/zephyr/feedback_loop/diagnosers/zombie_fle_detector.py` | ✅ 已实现 | |
...
| `src/zephyr/feedback_loop/gates/adversarial_validation.py` | ⚠️ 骨架 | |
...
| `src/zephyr/feedback_loop/gates/safety_gate_config.yaml` | ✅ 已实现 | |
...
| # | 自动化项 | 实现方式 | 现有工具/脚本 | 缺口 |
|---|---------|---------|-------------|------|
| 1 | 依赖图自动生成 | AST解析import | asset_inventory/dependency.py | 不覆盖scripts/ |
| 2 | 依赖对齐自动验证 | CI门禁 | validate_path_alignment.py | 无 |

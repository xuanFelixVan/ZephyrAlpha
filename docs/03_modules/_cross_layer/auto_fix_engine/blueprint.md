...
> module_id: MOD-INF-031 | version: 5.1.1 | status: Active | layer: cross_layer
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-INF-031`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-INF-031`

#### 四图位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-INF-031` 的 62 个 file 节点 | design | `extract_depgraph.py --modules MOD-INF-031` |

...
submodule_path: src/zephyr/auto-fix-engine
...
actual_disk_path: "src/zephyr/auto-fix-engine/"
...
| MOD-INF-023 | 必须 | Drift Detector——auto_fixable 标记 + 漂移预算 | — | `D:\ZephyrAlpha\docs\03_modules\_domain-infra_ops\drift-detector\blueprint.md` |
| MOD-INF-026 | 必须 | Asset Inventory——孤儿注册逻辑 | — | `D:\ZephyrAlpha\docs\03_modules\_domain-infra_ops\asset-inventory\blueprint.md` |
...
|---|------------|------------|---------|---------|
| 1 | 模块 ID 注册表 | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\module_id_registry.yaml` | 新增 MOD-INF-031 条目 | 新模块注册 |
...
| 11 | 代码构建标准 | GOV-ENG-001 | `D:\ZephyrAlpha\docs\01_policies_and_standards\governance\engineering\code-construction-standards.md` | 十字段头部 |

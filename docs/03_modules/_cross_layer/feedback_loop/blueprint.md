...
> module_id: MOD-FEEDBACK_LOOP | version: 0.35.18 | status: Draft | layer: cross_layer
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-FEEDBACK_LOOP` 的 638 个 file 节点 | production | `extract_depgraph.py --modules MOD-FEEDBACK_LOOP` |

...
> module_id: MOD-L02-001 | version: 4.0.12 | status: active | domain: factor
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L02-001` 的 123 个 file 节点 | design | `extract_depgraph.py --modules MOD-L02-001` |

...
> module_id: MOD-L05-001 | version: 2.1.3 | status: Active | layer: L2_domain
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L05-001` 的 19 个 file 节点 | design | `extract_depgraph.py --modules MOD-L05-001` |

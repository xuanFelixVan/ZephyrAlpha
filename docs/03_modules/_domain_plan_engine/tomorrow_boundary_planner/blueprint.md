...
> module_id: MOD-PLAN-001 | version: 0.1.6 | status: Active | layer: L2_domain (plan_engine)
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-PLAN-001` 的 3 个 file 节点 | production | `extract_depgraph.py --modules MOD-PLAN-001` |

...
> module_id: MOD-L08-001 | version: 3.4.13 | status: active | domain: frontend
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L08-001` 的 49 个 file 节点 | design | `extract_depgraph.py --modules MOD-L08-001` |
...
| `src/zephyr/frontend/dashboard/services_registry.py` | ✅ 已实现 | |
...
| `tests/frontend/test_api_server_cron_single_source.py` | ✅ 已实现 | |

...
> module_id: MOD-L08-001 | version: 3.4.11 | status: active | domain: frontend
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L08-001` 的 47 个 file 节点 | design | `extract_depgraph.py --modules MOD-L08-001` |

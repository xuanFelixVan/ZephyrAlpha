...
> module_id: MOD-L08-001 | version: 3.4.9 | status: active | domain: frontend
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L08-001` 的 48 个 file 节点 | production | `extract_depgraph.py --modules MOD-L08-001` |

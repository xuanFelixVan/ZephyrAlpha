...
depends_on:
  ...
  - target: MOD-INF-012
    ...
    why: "TaskRepository"
references:
  - path: "D:\\ZephyrAlpha\\docs\\02_enterprise_architecture\\target-architecture\\architecture-model\\layers\\l08_human_ai_interface.yaml"
    section: ""
    why: "架构层YAML真源"
...
|---|------------|------------|---------|---------|
| 1 | 蓝图注册表 | `D:\ZephyrAlpha\docs\03_modules\blueprint-registry.yaml` | construction_progress 更新为 not_started | C轨禁止施工 |
| 2 | 架构层 YAML | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\layers\l08_human_ai_interface.yaml` | module id 统一为 hmi-core (ARB-21) | 命名统一 |

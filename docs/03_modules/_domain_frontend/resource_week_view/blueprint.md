...
> module_id: MOD-RESCHED-VIEW | version: 1.0.4 | status: active | layer: L2_domain
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-RESCHED-VIEW` 的 3 个 file 节点 | production | `extract_depgraph.py --modules MOD-RESCHED-VIEW` |

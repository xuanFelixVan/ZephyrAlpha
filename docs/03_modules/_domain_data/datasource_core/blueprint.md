...
references:
  - path: "D:\\ZephyrAlpha\\docs\\02_enterprise_architecture\\target-architecture\\architecture-model\\layers\\l00_data_source.yaml"
    section: ""
    why: "架构层YAML真源"
depends_on:
  - target: MOD-INF-007
...
| 2 | 架构层YAML | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\layers\l00_data_source.yaml` | 补充implementations/子目录文件 | 文件清单同步 |
...
| 9 | 架构层YAML | — | — | `D:\ZephyrAlpha\docs\02_enterprise_architecture\target-architecture\architecture-model\layers\l00_data_source.yaml` | 子模块定义真源 |

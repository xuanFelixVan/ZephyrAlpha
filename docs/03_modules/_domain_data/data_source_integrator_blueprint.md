...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L00-004` 的 37 个 file 节点 | prototype | `extract_depgraph.py --modules MOD-L00-004` |
...
> **设计文档**：2026-07-15 数据韧性设计讨论稿（临时工作文档，本节为正式蓝图归档，原件已退役）
...
> **真源文件**：[data_retention_contract.yaml](../../01_policies_and_standards/_registry/contracts/data_retention_contract.yaml)（PS-CTR-003 v1.0.0）
>
> **本节为引用，不复制内容**——所有数据保留策略、10层分层体系、多频共振架构的唯一真源在上述契约文件。
...
### §19.2 10层分层体系（8信号 + 1工具 + 1基础）

| 层 | 名称 | 类别 | 频率 | 保留起点 | 有效验证起点 |
|---|---|---|---|---|---|
| L1 | Tick执行层 | 信号 | 3秒 | 2022-01 | 2022-01 |
| L2 | 分钟时机层 | 信号 | 1-60min | 2010-01 | 2010-01 |
| L3 | 日K趋势层 | 信号 | 日/周/月 | 2010-01 | 2010-01 |
| L4 | 资金面层 | 信号 | 日 | 2010-01 | 2010-01 |
| L5 | 基本面层 | 信号 | 季度 | 2010-01 | 2010-01 |
| L6 | 新闻事件层 | 信号 | 实时 | 2000-01 | 2010-01 |
| L7 | 产业链关联层 | 工具 | 季度/年 | latest | 2010-01 |
| L8 | 衍生品跨市场层 | 信号 | 日 | 2010-01 | 2010-01 |
| L9 | 宏观层 | 信号 | 月/季 | 2010-01 | 2010-01 |
| L10 | 静态元数据层 | 基础 | 月/年 | latest | 2010-01 |

### §19.3 多频共振策略

各层独立回测优化 → 多层信号 AND 门共振 → 触发买点。详见契约文件 §3。

### §19.4 已执行变更

- 2026-07-14：删除 `c1_market.index_quote` 表90天TTL（违反铁律 INV-RET-003）

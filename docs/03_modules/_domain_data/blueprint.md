...
> module_id: MOD-L00-001 | version: 4.0.3 | status: active | domain: data
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L00-001` 的 14 个 file 节点 | design | `extract_depgraph.py --modules MOD-L00-001` |

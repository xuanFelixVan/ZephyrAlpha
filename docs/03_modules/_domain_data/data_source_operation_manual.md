...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-L00-002`

#### 四图位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L00-002` 的 1 个 file 节点 | design | `extract_depgraph.py --modules MOD-L00-002` |
...
|------|-------------------|--------------------------|:-------:|
| module_id | MOD-L00-002 | MOD-L00-002 | ✅ |
| domain_id | N/A | N/A | ✅ |

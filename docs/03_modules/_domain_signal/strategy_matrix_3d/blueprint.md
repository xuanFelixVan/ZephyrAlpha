...
path: src/zephyr/signal_ashare/strategy_signal/strategy_matrix_3d.py
granularity: file
---
...
> 代码：`src/zephyr/signal_ashare/strategy_signal/strategy_matrix_3d.py`
...
`tests/signal_ashare/strategy_signal/test_strategy_matrix_3d.py` —— 内存替身全覆盖：正常路径 + 边界 + Fail-Closed 分支 + 确定性。

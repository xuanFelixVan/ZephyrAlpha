...
> module_id: MOD-L10-001 | version: 2.1.2 | status: Active | layer: L1_foundation
...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-L10-001` 的 12 个 file 节点 | design | `extract_depgraph.py --modules MOD-L10-001` |

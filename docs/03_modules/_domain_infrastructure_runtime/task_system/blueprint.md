...
> module_id: MOD-TASK_SYSTEM | version: 0.9.11 | status: active | layer: L0_infrastructure
...
> 查询最新文件清单：`python scripts/governance/extract_depgraph.py --modules MOD-TASK_SYSTEM`
...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-TASK_SYSTEM`

# llm_security/ 文件清单（自动生成 2026-05-09）
...
- payloads/injection_payloads.yaml
- payloads/leak_probe_phrases.yaml
- payloads/red_team_payloads.yaml
- payloads/tool_call_payloads.yaml
- sandbox/__init__.py
- self_protection/__init__.py

...
actual_disk_path: "D:\\ZephyrAlpha\\src\\zephyr\\l11_ml_platform\\ + D:\\ZephyrAlpha\\src\\zephyr\\l13_experimentation\\"
...
> actual_disk_path: D:\ZephyrAlpha\src\zephyr\l11_ml_platform\ + D:\ZephyrAlpha\src\zephyr\l13_experimentation\ | generation: 2 | construction_progress: partially_implemented
...
| MOD-ML-001 | 必须 | L11 ML 平台核心 | — | `D:\ZephyrAlpha\docs\03_modules\l11_ml_platform\ml-platform-core\blueprint.md` |
| MOD-EXP-001 | 必须 | L13 实验管线核心 | — | `D:\ZephyrAlpha\docs\03_modules\l13_experimentation\experimentation-core\blueprint.md` |
...
| 产出物类型 | 存放完整绝对路径 | 说明 |
|----------|---------------|------|
| L11 ML 平台核心 | `D:\ZephyrAlpha\src\zephyr\l11_ml_platform\` | 训练+验证+检查点 |
| L13 实验管线核心 | `D:\ZephyrAlpha\src\zephyr\l13_experimentation\` | AB测试+回测+Shadow |
...
|---|--------|------------|------|:-----:|-------------------|
| 1 | l11_ml_platform/ | §3 | ML平台核心 | 已实现 | — |
| 2 | l13_experimentation/ | §3 | 实验管线核心 | 已实现 | — |
...
| 验证项 | 验证方法 | 结果 |
|--------|---------|:---:|
| L11 __init__.py 存在 | Grep `l11_ml_platform` | ☐ |
| L13 __init__.py 存在 | Grep `l13_experimentation` | ☐ |
...
| 产出位置 | `D:\ZephyrAlpha\src\zephyr\l11_ml_platform\checkpoint_pipeline.py` |
| 验收标准 | 检查点格式校验通过 |
...
| 产出位置 | `D:\ZephyrAlpha\src\zephyr\l13_experimentation\ab_pipeline.py` |
| 验收标准 | AB 实验流程校验通过 |
| 验证命令 | `python -m pytest tests/ -k ml_experiment -v` |
...
|---|--------|---------------|:---:|:---:|:---:|
| 1 | ME-CT-CHECKPOINT-001 管道 | `D:\ZephyrAlpha\src\zephyr\l11_ml_platform\checkpoint_pipeline.py` | ☐ | ☐ | ☐ |
| 2 | ME-CT-AB-001 管道 | `D:\ZephyrAlpha\src\zephyr\l13_experimentation\ab_pipeline.py` | ☐ | ☐ | ☐ |
...
| 2 | L11 ML 平台 | `D:\ZephyrAlpha\src\zephyr\l11_ml_platform\` | 读取 | 代码对齐 |
| 3 | L13 实验管线 | `D:\ZephyrAlpha\src\zephyr\l13_experimentation\` | 读取 | 代码对齐 |

...
| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-EX-049` 的 12 个 file 节点 | production | `extract_depgraph.py --modules MOD-EX-049` |
...
| `tests/ex_core/test_order_idempotency_persistence.py` | ✅ 已实现 | |

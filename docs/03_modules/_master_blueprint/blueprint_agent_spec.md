...
> 生成命令：`python scripts/governance/d5_architecture/generators/generate_blueprint_panorama.py MOD-MASTER-001`

#### 四图位置

| 图 | 位置 | 状态 | 链接 |
|----|------|------|------|
| 依赖图 (depgraph) | `blueprint_id=MOD-MASTER-001` 的 1 个 file 节点 | design | `extract_depgraph.py --modules MOD-MASTER-001` |
...
|------|-------------------|--------------------------|:-------:|
| module_id | MOD-MASTER-001 | MOD-MASTER-001 | ✅ |
| domain_id | N/A | N/A | ✅ |

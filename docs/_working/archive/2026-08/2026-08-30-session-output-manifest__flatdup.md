...
> **⚠️ 未完成**：无待办信号
>
> **核验方式**：全文扫描完成/待办信号 + 引用文件存在性核验（引用 8 个，其中判废弃 0、路径漂移 1）+ commit 提及 0 处。
> **路径漂移（非缺失，勿误判）**：`docs/_working/2026-08-30-b5b6-enable-checklist.md` 路径漂移→docs/_working/archive/2026-08/2026-08-30-b5b6-enable-checklist.md
>

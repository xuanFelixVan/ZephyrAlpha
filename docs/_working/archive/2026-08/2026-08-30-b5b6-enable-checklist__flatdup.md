...
>
> **✅ 已完成（2 条，摘录）**
> - L40: | B5-3.2 | DeepSeek 账户余额可覆盖 3 个月谷时跑批 | 余额 ≥ ¥20（v1 730 日 ≈ ¥15, v2 ≈ ¥19）或 Qwen 降级链已验证可用 | ☐ |
> - L47: | B5-4.1 | `llm_daily_analysis` 表已建（DDL-as-Code） | `ensure_llm_daily_analysis_table()` 幂等建表成功，字段含 tokens_in/tokens_out/cost_yuan | ☐ |
>
> **⚠️ 未完成**：无待办信号
>

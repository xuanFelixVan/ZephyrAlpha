...
## 勘误（红蓝 R1 5ee0177e6d 后，以此为准）

主题三（W8-1 归档批）：A14 目录中 **resource_schedule 移出**（活生成器仍在写，归档会埋活件）、**pattern_line 移出**（8 处活引用未登记联动）——归档批以 **A12+B3** 为准；两目录处置见 w9_triage_ledger.md 勘误节。

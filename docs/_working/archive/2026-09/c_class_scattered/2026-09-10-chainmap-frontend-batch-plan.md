...
>
> **⚠️ 未完成（2 条，逐条摘录）**
> - L12: 3. 原待办 ④③②⑤ 照排；⑥浅色主题挂起等排期
> - L28: | — | ⑥浅色主题 | 全局项，非本页职权 | Owner 排期 | 挂起 |
>
...
| B2 | 3D 一期：族级星云 | Three.js vendor 引入+loader 挂接；47 簇球面撒点（簇越大星越亮）；拖拽旋转/滚轮缩放/键盘方向；hover 邻居高亮；点击飞入进簇（cm:open-cluster 不变）；星云成形等待动画吸收 B1 骨架 | B1 | DONE(2026-09-10) |
| B3 | 3D 二期：链群小星云 | 点族飞入链群小星云（同引擎复用，链=小星，公司数=亮度），点链进甬道 | B2 | REVOKED(2026-09-10 Owner 实测裁定"不用星云了"：族内内容天然带上中下游序，点族星直开链层；代码入 git 历史 dc1d95b9) |

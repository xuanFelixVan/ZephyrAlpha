...
>
> **✅ 已完成（5 条，摘录）**
> - L8: > Owner 问"现在就调研修复可以吗"——四项分诊：④③=本轮已施工（见 §一/§二），①=设计稿待裁定（§三），②=纪律闸不动、预案备好（§四）。
> - L10: ## 一、④ exec 滑点 v2 口径（已施工）
> - L21: ## 二、③ SellSignal→XFlowAction 自动化第一层（已施工）
> - L65: | ④ exec v2 口径（runner.py+7 单测） | 已施工，28/28 绿 | 见提交记录 |
> - L66: | ③ 转换助手（ablation.py+7 单测+索引容错） | 已施工，16/16 绿 | 同上 |
>
> **⚠️ 未完成（1 条，逐条摘录）**
> - L29: ## 三、① 定稿锚点方案（设计稿，**待 Owner 裁定，未改码**）
>

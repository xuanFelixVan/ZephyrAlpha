...
| 态 | 条数 | 条目 |
|---|---|---|
| **仍成立**（核心断点实测在位） | 15 | 338*,339*,340,341,342,343*,344,346,347,349,350,351,353,354,355 |
| **已闭合（部分）** | 1 | 352（webhook 通道机制已建已接线，**但 untracked 未落 HEAD + 无真实外部接收方=黄-门位**） |
| **口径不符/记载过粗** | 3* | 338*、339*、343*（"零接线/仅 W03"等 headline 与实测 import 面/调用点口径不符，见各条；**核心缺陷仍成立**，仅归因措辞需修） |

...
> **✅ 已完成（4 条，摘录）**
> - L66: # ---- 深度体系列（DDL v4 已建）----
> - L261: | 15 | **供应边补两列**：capacity 产能+exclusivity 独供/双供 | ✅ 已裁定（DDL 已建） |
> - L262: | 16 | **财务表分域**：通用财务主数据进 c1_market（采购通道禁 AI 搜索）；图谱侧只建 ig_product_revenue | ✅ 已裁定（DDL 已建） |
> - L263: | 17 | **ig_company_metric 处置**：指标层保留不融不删（五层第五层），PIT 化 | ✅ 已裁定（DDL 已建） |
>
> **⚠️ 未完成**：无待办信号
>
> **永久事实（非待办，勿重复挖）**
> - L59: # 【Owner 2026-09-09 质疑裁定改造】原 9 值混职能已废弃：设备/材料等职能拆到 function_role
>

...
> **文档元信息**（_working 临时区豁免规范，EXEMPT-ZONE-FM）：doc_type=asset_ledger · owner=ZephyrAlpha-Owner · status=active · version=2.1.0 · date=2026-08-29 · topic=dashboard_asset_ledger · scope=dashboard。
>

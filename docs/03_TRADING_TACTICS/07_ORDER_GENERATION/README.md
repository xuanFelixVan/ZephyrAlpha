...
class TWAPExecutor:
    ...
    def __init__(self, total_quantity: int, duration_minutes: int = 60):
        ...
        self.slice_interval = duration_minutes // 10  # 10个切片
...
class VWAPExecutor:
    ...
    def __init__(self, total_quantity: int, expected_participation: float = 0.1):
        self.total_quantity = total_quantity
        self.expected_participation = expected_participation  # 预期占比市场成交量
...
class OrderSlicer:
    ...
    def __init__(self, threshold_pct: float = 0.01):
        self.threshold_pct = threshold_pct  # 超过市场成交1%认为是大单

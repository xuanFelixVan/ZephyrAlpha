...
def calculate_signal(close_prices, ma5_period=5, ma20_period=20):
    ...
    Args:
        close_prices: 收盘价列表 [100, 101, 102, ...]
...
| ohlcv.close | float | 收盘价 |
| ohlcv.volume | int | 成交量 |

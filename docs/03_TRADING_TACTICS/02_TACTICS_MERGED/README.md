---
module_id: TACTICS_MERGED_README_001
version: 4.0.1
status: Active
...
本目录是清风量化交易系统 4.0 �?*战术实现模块**，包�?Layer 0-11 分层架构中各层的具体战术实现文档�?
### 1.1 与框架的关系

```
01_FRAMEWORK/README.md    �?📐 框架说明（Layer 0-11 架构定义�?      �?main/02_TACTICS/          �?🎯 战术实现（具体实现文档）
```
...
| 目录 | Layer | 描述 | 战术�?| 状�?|
|------|-------|------|--------|------|
| 01_MARKET_REGIME | Layer 1 | 市场状态识�?| 5 | �?活跃 |
...
�?  └── T.03.RM002.波动率目标管�?md
�?├── 04_EXECUTION/                   # Layer 4-5: 交易执行
�?  ├── README.md
�?  ├── T.04.EX002.TWAP 执行.md
�?  ├── T.04.EX004.盘前计划与买入模�?md
�?  ├── T.04.EX005.开盘竞价信�?md
�?  ├── T.04.EX006.A 股交易规�?md
�?  ├── T.04.EX007.�?T 策略量化.md
�?  └── T.04.EX008.分时图分�?md
...
| Layer | 模块 | 职责 | 战术示例 |
|-------|------|------|----------|
| Layer 1 | 01_MARKET_REGIME | 识别当前市场环境，为战术选择提供前提条件 | 市场趋势识别、量能周期、市场结构博�?|
| Layer 2 | 02_ALPHA_FACTORS | 核心 Alpha 来源，趋�?均值回�?价�?成长/质量/动量/情绪 | 双均线趋势跟踪、资金流向、筹码峰分析 |
| Layer 3 | 03_RISK_MANAGEMENT | 组合层面风险管理，敞口控�?| 行业敞口控制、波动率目标管理 |
| Layer 4 | 04_EXECUTION | 订单执行算法，减少冲击成�?| TWAP 执行、盘前计划、做 T 策略 |
| Layer 5 | 04_EXECUTION | 交易执行细节 | A 股交易规则、分时图分析 |
| Layer 6 | 05_RISK_CONTROL | 实时风控监控，异常检�?| 实时风险监控、风险控制量化体�?|
| Layer 7 | 06_PERFORMANCE + 07_ITERATION | 收益分解，因子暴露分析，策略评估 | Brinson 归因、策略绩效评�?|
...
| 双均线趋势跟�?| T.01.TR001.双均线趋势跟�?md | Layer 1, Trend, 001 |
| 资金流向 | T.01.SN001.资金流向.md | Layer 1, Sentiment, 001 |
| 波动率目标管�?| T.03.RM002.波动率目标管�?md | Layer 3, Risk Management, 002 |
...
| 代码 | 英文 | 中文 | 所�?Layer |
|------|------|------|------------|
| MR | Market Regime | 市场状�?| Layer 1 |
| TR | Trend | 趋势跟踪 | Layer 2 |
| MR | Mean Reversion | 均值回�?| Layer 2 |
| VA | Value | 价值投�?| Layer 2 |
...
## 6. 代码状�?
本目录中的所有战术均�?*战术实现文档**，代码状态如下：

| 目录 | 代码状�?| 说明 |
|------|----------|------|
| 01_MARKET_REGIME/ | [STUDY_ONLY] | 市场状态识别战术，待回测验�?|
...
> ⚠️ **当前所有代码均�?[STUDY_ONLY] 状态，不可直接运行**
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v4.0 | 2026-03-28 | 初始版本，基�?Layer 0-11 架构 |
| v4.0.1 | 2026-03-28 | 目录重组，从 01_FRAMEWORK 迁移�?main/ |
...
| 类别 | 说明 | 示例 |
|------|------|------|
| **策略参数** | 策略逻辑核心参数 | 均线周期、RSI阈值 |
| **风控参数** | 风险控制参数 | 最大回撤、止损比例 |
| **执行参数** | 交易执行参数 | 订单类型、滑点设置 |
| **系统参数** | 系统运行参数 | 数据源、超时设置 |
...
class ParameterConstraint:
    ...
    def add_constraint(
        ...
        self.constraints.append({
            ...
            'condition': condition,
            'message': message or f"约束{name}不满足"
        })

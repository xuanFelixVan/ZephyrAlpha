...
acceptance_criteria:
  ...
  - "script_manifest.yaml 不再引用已删除路径"
...
rollback_instructions: |
  ...
  2. git checkout -- scripts/script_manifest.yaml

...
| 属性 | 值 |
|------|-----|
| **审计规则** | [PS-STD-001](../../meta/metadata_registry.yaml) §3（frontmatter 字段唯一真源）、§6.14 Level 2（枚举自动派生）、[PS-STD-009](../../meta/rule_lifecycle_and_change_standard.yaml) §2.2（superseded_by）、§7（deprecated ≥ 180 天归档）、§9（版本号同步）、[GOV-MOD-002](../../governance/module/ai-behavior-iron-policy.md) ABS-22/COND-15（跨级降格）、[GOV-DOC-004](../../governance/document/trae_028_doc_structure_naming.yaml)（绝对路径引用）、[GOV-DOC-001](../../governance/document/trae_028_doc_structure_naming.yaml)（统一编号规范）、[GOV-DOC-003](../../governance/document/trae_028_doc_structure_naming.yaml)（文件命名规范 N-01~N-07）、[PS-STD-004](../../meta/rule_classification_and_arbitration_standard.yaml)（规则分类与仲裁）、[GOV-MOD-007](../../governance/module/multi-registry-synchronization-standard.md)（多注册表同步） |

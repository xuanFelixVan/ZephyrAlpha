...
| 属性 | 值 |
|------|-----|
| **审计规则** | [GOV-DOC-006](../../governance/document/trae_028_doc_structure_naming.yaml) §一/§三（TTL 合法值 + 过期文件 + LATEST 命名）、§二/§四/§五/§六（superseded_by + 双向链接 + AI 产物位置）、[GOV-DOC-009](../../governance/document/trae_029_doc_operation_security.yaml)（文档控制——版本控制/变更追踪）、[PS-STD-009](../../meta/rule-lifecycle-and-change-standard.md) §7（废弃 ≥ 180 天归档） |

...
| 属性 | 值 |
|------|-----|
| **审计规则** | AGENTS.md §6.5（.py 只允许在 3 个目录）、§6.11（索引-实际同步）、[GOV-TASK-005](../../governance/task/task-closure-standard.md) §4.2-4.3（临时/残留文件）、[GOV-MOD-002](../../governance/module/ai-behavior-iron-policy.md) ABS-01（immutable_core 不可变）、[PS-STD-012](../../meta/rule-verification-standard.md) §7.3（index 完整性）、[GOV-DOC-006](../../governance/document/trae_028_doc_structure_naming.yaml) §三（LATEST 命名）、[GOV-DOC-002](../../governance/document/trae_028_doc_structure_naming.yaml)（目录结构规范）、[GOV-DOC-007](../../governance/document/trae_029_doc_operation_security.yaml)（文件操作安全） |

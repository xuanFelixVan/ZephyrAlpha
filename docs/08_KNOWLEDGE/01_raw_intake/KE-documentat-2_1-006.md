---
module_id: KE-documentat-2_1-006
title: 2.1 架构与治理类
...
| 文件夹规划 / 目录布局 | Information Architecture (IA) | 系统内容如何分层、分类、命名、存放的整体设计 | `docs/02_enterprise_architecture/target-architecture/02-information-architecture.md` |

...
| **Runtime** | `.pre-commit-config.yaml` · `.github/workflows/` · `src/zephyr/l10-compliance/` · `scripts/governance/audit_log/` · `scripts/governance/opa/` · `.metadata/` | pre-commit hooks、CI Gate、kill_switch、OPA policies |

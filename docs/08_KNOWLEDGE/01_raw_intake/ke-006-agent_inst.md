...
| **资产盘点系统**（MOD-INF-026） | [asset-inventory/blueprint.md](docs/03_modules/l01-infrastructure/asset-inventory/blueprint.md) | 全项目统一资产索引 SSoT——自动发现+分类+对账+生命周期管理。冷启动 STEP 4.5 读 `unified_asset_index.yaml` 了解项目规模与健康状态 |

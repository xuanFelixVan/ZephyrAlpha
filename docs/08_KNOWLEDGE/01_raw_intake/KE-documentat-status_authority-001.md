---
module_id: KE-documentat-status_authority-001
...
> 这与 `architecture-model/layers/_schema.yaml` 定义的【代码模块实现状态】（planned/candidate/approved/in_development/active/completed/deprecated）

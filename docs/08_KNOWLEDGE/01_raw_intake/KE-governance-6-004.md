...
| 版本 | 日期 | 变更 |
|------|------|------|
| 2.2.0 | 2026-05-02 | **bootstrap-plans 废除**：施工内容全部迁入 task-system/blueprint.md §5.2-§5.5；MOD-INF-003/MOD-INF-004 合并为 MOD-INF-006；交叉引用同步更新 |

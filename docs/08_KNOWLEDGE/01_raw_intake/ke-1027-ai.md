...
| **Runtime** | AISG 六大模块 | `src/zephyr/l10-compliance/ai_security/`（D-01 P0 红线）|
| **Runtime** | Scout Agent 运行态 | `src/zephyr/l11-ml-platform/scout/` + `kms/daily_digest/` |

...
| P1-002 修复 | `architecture-model/technology_landscape.yaml` | 增加 `status: deprecated` + `deprecation_reason`，指向 EA 树完整版 |
| P2-001 修复 | `docs/.../architecture-model/infra/core_services.yaml` | 增加 `parent_layer: L12` |

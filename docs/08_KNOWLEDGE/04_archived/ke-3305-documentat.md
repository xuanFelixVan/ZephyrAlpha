...
| 1.2.0 | 2026-04-29 | 全项目扫描补充。新增 3 类绝对禁止（§3.10 异步架构 ABS-40、§3.11 安全服务故障 ABS-41\~43、§3.12 废墟隔离 ABS-44），绝对禁止从 39 条增至 44 条。新增 5 类条件禁止（§4.9\~4.13 COND-30\~49），条件禁止从 29 条增至 49 条。新增 3 条推荐做法（REC-09\~11）。将代码级强制规则从 §3.5 迁移至独立文件 PS-REG-001 _index.yaml，§3.5 改为引用。                                                                                                                                                                                                                        |

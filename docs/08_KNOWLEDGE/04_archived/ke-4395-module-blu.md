...
| 5 | KBG-0031 状态 | `D:\ZephyrAlpha\docs\02_enterprise_architecture\adr\adr-0031-chromadb-vector-retrieval.md` | 添加"已通向 VMS v0.3.0 8 Collection"的注释 | 避免 ADR 与蓝图之间的 Collection 数量不一致 |

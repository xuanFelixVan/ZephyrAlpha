...
| 域 A 字段定义（文档 frontmatter） | **frontmatter-field-registry.md**（canonical SSoT） | 本文件 §2（字段规范/校验逻辑，非字段数据定义）、frontmatter-schema.json（自动生成产物） |
...
| module_id 命名规范 | **本文件 §5** | trae_028_doc_structure_naming.yaml（层编号部分仍有效，模块 ID 格式以本文件为准） |

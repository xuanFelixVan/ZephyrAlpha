---
module_id: 10_GOVERNANCE_COMPLIANCE_INDEX
version: 1.0.1
status: Active
...
- **零入链扫描（最新）**：[../09_AUDIT/STATE/INDEX_HEALTH_ORPHAN_20260506.md](../09_AUDIT/STATE/INDEX_HEALTH_ORPHAN_20260506.md)（`scan_index_health.py --prefix docs/10_GOVERNANCE_COMPLIANCE --date 20260506`；**zero_inbound=0**；候选 md **21**；首轮 **6** 处子域门面零入链，已由本页**子域门面表**补链后复跑归零）
- **rollup（深度 3）**：[../09_AUDIT/STATE/REPO_DIRECTORY_ROLLUP_20260414.md](../09_AUDIT/STATE/REPO_DIRECTORY_ROLLUP_20260414.md)（JSON 真源同 stem；键 `docs/10_GOVERNANCE_COMPLIANCE` **21** 条路径）
...
| 子域 | 索引 | 概述 |
|------|------|------|
| CI_CD_INTEGRATION | [INDEX.md](./CI_CD_INTEGRATION/INDEX.md) | [README.md](./CI_CD_INTEGRATION/README.md) |
| CLASSIFICATION | [INDEX.md](./CLASSIFICATION/INDEX.md) | [README.md](./CLASSIFICATION/README.md) |
| GOVERNANCE_PROCESSES | [INDEX.md](./GOVERNANCE_PROCESSES/INDEX.md) | （本目录无 `README.md`） |
| TRAINING_SYSTEM | [INDEX.md](./TRAINING_SYSTEM/INDEX.md) | [README.md](./TRAINING_SYSTEM/README.md) |
| KNOWLEDGE_BASE | [INDEX.md](./KNOWLEDGE_BASE/INDEX.md) | （门面见子索引） |
...
- [AI 决策审计蓝图](../01_FRAMEWORK/AI_DECISION_AUDIT_BLUEPRINT.md)
- [合规监控系统蓝图](../01_FRAMEWORK/COMPLIANCE_MONITORING_SYSTEM_BLUEPRINT.md)
...
- [DOCUMENT_ENCODING_STANDARD](./DOCUMENT_ENCODING_STANDARD.md)

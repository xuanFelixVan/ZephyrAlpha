...
4. **行业参考**：OpenSSF KBG-0013 讨论了 YAML 枚举值的 4 种大小写方案（Title Case / kebab-lower / camelCase / PascalCase），最终选择 Title Case 的理由是"为人类作者优化，视觉区分键和值"。但本项目的场景不同——AI 是主要消费者，"为 AI 优化"比"为人类视觉优化"更重要。Hugo/Jekyll 等工具也采用全小写方案。

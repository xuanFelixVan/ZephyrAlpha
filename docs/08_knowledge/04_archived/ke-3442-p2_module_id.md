...
| `02_enterprise_architecture/target_architecture/architecture_model/` | 3 | 使用旧版 `doc_id` 而非 `module_id` |
...
|------|-----------|-----------------|
| `architecture_model/ssot-authority-map.md` | `ARCH-SSOT-001` | `STD-SSOT-AUTHORITY-MAP`（已在新版中使用） |
| `architecture_model/architecture_endgame_locked.md` | `ARCH-ENDGAME-001` | 待分配 |
| `architecture_model/dependency-graph-framework.md` | `ARCH-DEP-001` | 待分配 |

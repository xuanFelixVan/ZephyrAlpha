...
> 操作手册（Playbook）提供"复制粘贴级别"的逐步执行指令，供 AI 直接使用。
...
## 相关 Playbooks（存放在 00_MANAGEMENT）

| 文件 | 路径 |
|------|------|
| D 类蓝图重叠处理 | `docs/05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/00_MANAGEMENT/d-class-blueprint-overlap-playbook.md` |

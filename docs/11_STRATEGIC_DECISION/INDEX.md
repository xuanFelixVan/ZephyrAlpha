---
module_id: 11_STRATEGIC_DECISION_INDEX
version: 1.0.0
status: Active
...
owner: 首席文档架构师
responsibility:
  - 11_STRATEGIC_DECISION目录索引
---

﻿---
module_id: 11_STRATEGIC_DECISION_INDEX_STRATEGIC_DECISION_001
version: 2.0.0
status: Active
...
| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| [投资限制管理蓝图](./INVESTMENT_CONSTRAINT_BLUEPRINT.md) | 投资限制定义、约束监控 | P1 | ✅ 已创建 |
| [IPS管理蓝图](./IPS_MANAGEMENT_BLUEPRINT.md) | 投资政策声明管理 | P1 | ✅ 已创建 |

### 3. 投资策略选择模块

| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| [多策略协调系统蓝图](./MULTI_STRATEGY_COORDINATION_BLUEPRINT.md) | 策略信号冲突解决、资金协调 | P0 | ✅ 已创建 |
...
| 业绩归因系统蓝图 | Brinson归因、风险归因 | P0 | ✅ 已创建 |
...
| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| [ESG投资系统蓝图](./ESG_INVESTING_BLUEPRINT.md) | ESG评分、可持续投资 | P2 | ✅ 已创建 |
| [税务管理系统蓝图](./TAX_MANAGEMENT_BLUEPRINT.md) | 税务计算、税务优化 | P2 | ✅ 已创建 |
| [决策审计系统蓝图](./DECISION_AUDIT_BLUEPRINT.md) | 决策追溯、审计记录 | P2 | ✅ 已创建 |
...
| 战术资产配置蓝图 | 短期配置调整、市场时机判断 | P0 | ✅ 已创建 |
| 风险平价模型蓝图 | 风险平价权重、风险贡献度分析 | P0 | ✅ 已创建 |
| 策略生命周期管理蓝图 | 策略创建、测试、上线、归档 | P0 | ✅ 已创建 |

### 9. 新增重要模块（P1级）

| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| 决策知识库蓝图 | 决策经验积累、知识检索 | P1 | ✅ 已创建 |
| 市场情报系统蓝图 | 新闻采集、情绪分析、报告生成 | P1 | ✅ 已创建 |
| 投资观点管理蓝图 | 观点记录、验证跟踪 | P1 | ✅ 已创建 |
| 宏观经济预测蓝图 | 经济指标预测、周期判断 | P1 | ✅ 已创建 |
| 行业轮动模型蓝图 | 行业景气度、轮动信号 | P1 | ✅ 已创建 |
| 风格轮动模型蓝图 | 风格因子、轮动信号 | P1 | ✅ 已创建 |

### 10. 新增支持模块（P2级）

| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| 蒙特卡洛模拟蓝图 | 收益模拟、风险模拟 | P2 | ✅ 已创建 |
| 决策树分析蓝图 | 决策树构建、路径分析 | P2 | ✅ 已创建 |
| 敏感性分析蓝图 | 参数敏感性、情景敏感性 | P2 | ✅ 已创建 |
...
| [深度架构审查报告](./STRATEGIC_DECISION_DEEP_REVIEW_20260407.md) | 专业机构对比、深度差距分析 | P0 | ✅ 已创建 |
| [补充模块蓝图集](./SUPPLEMENTARY_MODULES_BLUEPRINTS_20260407.md) | 补充模块的完整蓝图设计 | P0 | ✅ 已创建 |

### 12. 补充关键模块（P0级）

| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| 交易对手风险管理蓝图 | 信用评级、敞口管理、违约概率 | P0 | ✅ 已创建 |
| 决策质量评估蓝图 | 准确率统计、偏差分析、改进建议 | P0 | ✅ 已创建 |

### 13. 补充重要模块（P1级）

| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| 动态风险管理蓝图 | 实时风险计算、动态限额 | P1 | ✅ 已创建 |
| 尾部风险对冲蓝图 | 尾部风险识别、对冲策略 | P1 | ✅ 已创建 |
| 波动率管理蓝图 | 波动率预测、波动率交易 | P1 | ✅ 已创建 |

### 14. 补充支持模块（P2级）

| 文档名称 | 说明 | 优先级 | 状态 |
|---------|------|--------|------|
| 相关性管理蓝图 | 动态相关性、相关性突变检测 | P2 | ✅ 已创建 |
...
#### P2级模块（可选实施）
- [投资组合保险蓝图](./PORTFOLIO_INSURANCE_BLUEPRINT.md)
- [融资融券管理蓝图](./LEVERAGE_MANAGEMENT_BLUEPRINT.md)
- [ESG投资系统蓝图](./ESG_INVESTING_BLUEPRINT.md)
- [税务管理系统蓝图](./TAX_MANAGEMENT_BLUEPRINT.md)
- [决策审计系统蓝图](./DECISION_AUDIT_BLUEPRINT.md)

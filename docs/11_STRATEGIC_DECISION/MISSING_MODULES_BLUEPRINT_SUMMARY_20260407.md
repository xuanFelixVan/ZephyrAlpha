...
**蓝图文档（canonical）**: [`STRATEGY_LIFECYCLE_MANAGEMENT_BLUEPRINT.md`](../10_AI_WORKFLOW/STRATEGY_LIFECYCLE_MANAGEMENT_BLUEPRINT.md)（Layer8 入口见 [`STRATEGY_LIFECYCLE_MANAGEMENT_LAYER8_MODULE.md`](../08_HUMAN_AI_INTERFACE/81_STRATEGY_LIFECYCLE_MANAGEMENT/STRATEGY_LIFECYCLE_MANAGEMENT_LAYER8_MODULE.md)）

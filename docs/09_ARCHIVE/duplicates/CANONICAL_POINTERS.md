...
| `duplicates/FACTOR_MANAGEMENT_STANDARD.md` | `docs/02_FACTOR_LIBRARY/01_STANDARDS/FACTOR_MANAGEMENT_STANDARD.md` | retain_trace | 已恢复业务目录真源；本副本仅保留追溯 |
...
| `duplicates/FACTOR_TAXONOMY.md` | `docs/02_FACTOR_LIBRARY/01_STANDARDS/FACTOR_TAXONOMY.md` | merge_then_delete | 因子分类体系真源在标准层 |
...
| `duplicates/SCHEDULER_API.md` | `docs/02_FACTOR_LIBRARY/04_DATA_SOURCE/02_SCHEDULER/OVERVIEW.md` | merge_then_delete | 调度 API 的权威描述应归入数据源层调度模块（后续可再细分到专门接口文档） |
...
| `duplicates/DATA_REQUIREMENTS.md` | `docs/02_FACTOR_LIBRARY/04_DATA_SOURCE/DATA_CONTRACT/OVERVIEW.md` | merge_then_delete | “需要什么数据/字段/质量口径”的权威归属更贴近数据契约（Data Contract）模块；后续可在该模块下沉淀专门需求清单 |
| `duplicates/CLEANING_RULES.md` | `docs/02_FACTOR_LIBRARY/04_DATA_SOURCE/03_CLEANING/OVERVIEW.md` | merge_then_delete | 清洗规则权威归属数据清洗模块（后续可再细分到具体规则文档） |
...
| `duplicates/FACTOR_REGISTRY.md` | `docs/02_FACTOR_LIBRARY/01_STANDARDS/FACTOR_REGISTRY.md` | merge_then_delete | 因子注册表真源在标准层 |
...
| `duplicates/INDUSTRY_FACTORS.md` | `docs/02_FACTOR_LIBRARY/03_RISK_FACTORS/OVERVIEW.md` | merge_then_delete | 行业/风险因子归属风险因子模块概览 |
...
| `duplicates/FACTOR_TRANSPARENCY_REPORT.md` | `docs/02_FACTOR_LIBRARY/03_RISK_FACTORS/OVERVIEW.md` | retain_trace | 透明度/暴露类叙述对齐风险因子模块（后续可独立成报告真源） |
| `duplicates/OPTIMIZATION_SUMMARY.md` | `docs/09_AUDIT/REPORTS/INDEX.md` | retain_trace | 优化类摘要应归入审计报告索引或具体报告真源 |
| `duplicates/FAQ.md` | `docs/02_FACTOR_LIBRARY/10_MANUAL/FAQ.md` | merge_then_delete | 因子库 FAQ 真源在 10_MANUAL |
| `duplicates/ALPHA_FACTOR_LAYER_DEEP_AUDIT_REPORT_ROUND2_20260407_191332.md` | `docs/09_AUDIT/STATE/ALPHA_FACTOR_LAYER_DEEP_AUDIT_REPORT_ROUND2_20260407_191332.md` | retain_trace | 审计报告真源在 09_AUDIT/STATE；本处为 duplicates 副本 |
...
- **重复文档处理标准**：[`docs/09_AUDIT/STANDARDS/DUPLICATE_DOCUMENT_HANDLING_STANDARD.md`](../../09_AUDIT/STANDARDS/DUPLICATE_DOCUMENT_HANDLING_STANDARD.md)
- **归档总入口**：[`docs/06_ARCHIVE/README.md`](../../06_ARCHIVE/README.md)

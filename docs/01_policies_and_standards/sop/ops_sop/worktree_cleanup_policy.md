...
> 关联：[merge_conflict_resolution_sop](merge_conflict_resolution_policy.md)（merge 冲突处理）｜[construction_workflow_sop](../construction_sop/construction_workflow_policy.md) Step 12（施工流程 merge 环节）｜[wipe 事故裁定书](../../../02_enterprise_architecture/04_architecture_principles_decisions/2026-08-14_ai-liq-001_worktree_wipe_incident_review.md)
...
**标准**：清理动作已登记到施工进度跟踪表（`docs/_working/archive/2026-09/design_memos/construction_progress_tracker.md`）或统筹会话显式批准。

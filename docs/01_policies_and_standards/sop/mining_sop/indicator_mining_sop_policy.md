...
- **正典化日期**：2026-09-21。
- **来源**：`docs/_working/archive/2026-09/tilib_clearance/tilib_clear_a3_mining_report.md`（波3 M-L6 学术自适应指标挖矿报告+波次台账/数值证据链方法见 a5 交付报告，2026-09-20/21 tilib 清欠班实战沉淀）**原册随档**——正文方法论实质全量迁入本册，原册保持 task_bound 战例存档，不改不删。

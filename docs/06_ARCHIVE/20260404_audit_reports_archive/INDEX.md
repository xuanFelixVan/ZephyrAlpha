...
> 本目录为**归档快照**；现行审计报告、机器产出与接力指针以 **`09_AUDIT`** 与**项目办公室**为准。
...
- [DOCUMENT_GOVERNANCE_DEEP_AUDIT_REPORT（归档副本 · basename 已消歧）](audit_state/DOCUMENT_GOVERNANCE_DEEP_AUDIT_REPORT_legacy_20260404_audit_reports_archive.md) - 文档治理深度审计报告

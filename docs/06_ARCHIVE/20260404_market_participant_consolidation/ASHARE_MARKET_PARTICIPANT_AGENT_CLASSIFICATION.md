...
owner: 首席技术评审官
standard_type: 智能体分类规�?applicable_scope: Layer 2.5 市场参与者模拟层
...
**参考标�?*: 华西策略2025Q1数据、TradingAgents-CN架构
...
### 1.1 完整分类�?
| 智能体ID | 智能体名�?| 流通市值占�?| 投资风格 | 时间框架 | 优先�?|
|---------|-----------|------------|---------|---------|--------|
| AGENT.NATIONAL_TEAM.001 | 国家队智能体 | 4.08% | 逆周期调�?| 季度/年度 | 🔥🔥🔥🔥🔥 |
| AGENT.INSTITUTIONAL.001 | 主力智能�?公募+私募) | 10.10% | 基本面驱�?| 月度/季度 | 🔥🔥🔥🔥🔥 |
| AGENT.RETAIL.001 | 散户智能�?| 31.24% | 追涨杀�?| 日度/周度 | 🔥🔥🔥🔥🔥 |
| **AGENT.FOREIGN_INVESTOR.001** | **外资智能�?* | **3.76%** | **价值投�?* | **季度/年度** | **🔥🔥🔥🔥🔥** |
| **AGENT.INSURANCE_FUND.001** | **保险资金智能�?* | **3.77%** | **收益投资** | **年度** | **🔥🔥🔥🔥** |
| AGENT.INDUSTRIAL_CAPITAL.001 | 产业资本智能�?| 46.54% | 产业逻辑 | 年度 | 🔥🔥🔥 |
| AGENT.PENSION_FUND.001 | 社保/养老金智能�?| 2.02% | 稳健收益 | 年度 | 🔥🔥🔥 |
| AGENT.QUANT_FUND.001 | 量化私募智能�?| ~1.50% | 高频交易 | 分钟/小时 | 🔥🔥🔥🔥 |
...
```
┌─────────────────────────────────────────────────────────────�?�?         Layer 2.5: 市场参与者模拟层                        �?├─────────────────────────────────────────────────────────────�?�?                                                            �?�? ┌─────────────────────────────────────────────────────�?  �?�? �?        核心智能�?(Core Agents) - 4�?             �?  �?�? ├─────────────────────────────────────────────────────�?  �?�? �?                                                    �?  �?�? �? 国家队智能体 ████████ 4.08%                       �?  �?�? �? └─ 逆周期调节、市场稳�?                          �?  �?�? �?                                                    �?  �?�? �? 主力智能�?████████████████ 10.10%                �?  �?�? �? └─ 公募基金 + 私募基金                            �?  �?�? �?                                                    �?  �?�? �? 散户智能�?████████████████████████████ 31.24%    �?  �?�? �? └─ 追涨杀跌、羊群效�?                           �?  �?�? �?                                                    �?  �?�? �? 外资智能�?████████ 3.76%                         �?  �?�? �? └─ 价值投资、长期配�?                           �?  �?�? �?                                                    �?  �?�? └─────────────────────────────────────────────────────�?  �?�?                                                            �?�? ┌─────────────────────────────────────────────────────�?  �?�? �?        扩展智能�?(Extended Agents) - 4�?        �?  �?�? ├─────────────────────────────────────────────────────�?  �?�? �?                                                    �?  �?�? �? 保险资金智能�?████████ 3.77%                     �?  �?�? �? └─ 高股息偏好、长期持�?                         �?  �?�? �?                                                    �?  �?�? �? 产业资本智能�?████████████████████████████ 46.54%�?  �?�? �? └─ 产业逻辑、长期持�?                           �?  �?�? �?                                                    �?  �?�? �? 社保/养老金智能�?████�?2.02%                     �?  �?�? �? └─ 稳健收益、长期价�?                           �?  �?�? �?                                                    �?  �?�? �? 量化私募智能�?██�?~1.50%                         �?  �?�? �? └─ 高频交易、统计套�?                           �?  �?�? �?                                                    �?  �?�? └─────────────────────────────────────────────────────�?  �?�?                                                            �?�? ┌─────────────────────────────────────────────────────�?  �?�? �?        智能体协作机�?                            �?  �?�? ├─────────────────────────────────────────────────────�?  �?�? �?                                                    �?  �?�? �? 市场模拟引擎 (Market Simulation Engine)           �?  �?�? �? ├─ 订单簿模�?(Order Book Simulation)            �?  �?�? �? ├─ 价格发现机制 (Price Discovery)                �?  �?�? �? ├─ 博弈模拟 (Game Theory Simulation)             �?  �?�? �? └─ 信息传播模拟 (Information Propagation)        �?  �?�? �?                                                    �?  �?�? └─────────────────────────────────────────────────────�?  �?�?                                                            �?└─────────────────────────────────────────────────────────────�?```
...
- **逆周期调�?*: 市场恐慌时买入，市场过热时卖�?- **政策信号驱动**: 响应政策信号，维护市场稳�?- **低换手率**: 极少调仓，长期持�?- **蓝筹股偏�?*: 金融、公用事业等低估值蓝�?
#### 数据需�?
- 政策新闻数据 (免费: 新浪财经、东方财�?
- 市场指数数据 (免费: TuShare)
- 宏观经济指标 (免费: TuShare)
...
### 2.2 主力智能�?(Institutional Agent)

**索引**: AGENT.INSTITUTIONAL.001  
**流通市值占�?*: 10.10% (公募7.68% + 私募2.42%)  
**优先�?*: 🔥🔥🔥🔥🔥 最�?
#### 核心特征
...
- **基本面驱�?*: 基于财务数据和行业研�?- **趋势跟随**: 在趋势形成时加仓
- **申赎影响**: 受散户申赎影响，被迫追涨杀�?- **板块轮动**: 推动板块行情
...
**数据源定�?*: 系统核心数据源，提供5700+专业因子、舆情数据、财务数据、宏观数�?
**iFind数据能力**:
...
**iFind连接�?*: 详见 [IFIND_CONNECTOR.md](./IFIND_CONNECTOR.md)

### 5.2 智能体数据需求与iFind映射

#### 5.2.1 外资智能体数据需求映�?
| 数据需�?| iFind数据接口 | 因子ID/指标代码 | 优先�?|
|---------|-------------|---------------|--------|
| **全球宏观评估** | | | |
...
| **主力智能�?* | 基本面数据、机构持�?| �?完全支持 | 财务数据、因子数�?|
| **散户智能�?* | 市场情绪、技术指�?| �?完全支持 | 舆情数据、技术因�?|
| **产业资本智能�?* | 内部人交易、产业政�?| �?完全支持 | 公告数据、舆情数�?|
| **社保/养老金智能�?* | 稳健收益、长期价�?| �?完全支持 | 财务数据、因子数�?|
| **量化私募智能�?* | 高频数据、技术指�?| �?完全支持 | 市场数据、技术因�?|

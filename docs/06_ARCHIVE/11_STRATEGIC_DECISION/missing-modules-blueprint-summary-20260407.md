...
**蓝图文档**: INVESTMENT_COMMITTEE_SUPPORT_BLUEPRINT.md
...
**蓝图文档（canonical）**: `STRATEGY_LIFECYCLE_MANAGEMENT_BLUEPRINT.md`（Layer8 入口见 `STRATEGY_LIFECYCLE_MANAGEMENT_LAYER8_MODULE.md`）

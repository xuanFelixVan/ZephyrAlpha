---
module_id: 06_ARCHIVE_AUDIT_REPORTS_MACHINE_LEARNING_DEEP_AUDIT_REPORT_20260403
layer: layer_06
version: 1.0.0
status: Active
responsibility:
  - Machine Learning Deep Audit Report 20260403相关业务
...
1. FACTOR_CALCULATOR_TECHNICAL_SPECIFICATION.md - `class FactorCalculator`

2. ALPHA_FACTOR_FACTORY_TECHNICAL_SPECIFICATION.md - `class FinancialFactorCalculator`, `class TechnicalFactorCalculator`

3. QLIB_ALPHA158_TECHNICAL_SPECIFICATION.md - `def calculate_factors`

4. BARRA_RISK_MODEL_TECHNICAL_SPECIFICATION.md - `class StyleFactorCalculator`, `class IndustryFactorCalculator`
...
1. FEATURE_ENGINEERING_TECHNICAL_SPECIFICATION.md - `class FeatureGenerator`

2. FEATURE_STORE_TECHNICAL_SPECIFICATION.md - 特征计算?
...
1. FACTOR_BACKTEST_TECHNICAL_SPECIFICATION.md - `def calculate_ic`

2. FACTOR_IC_TECHNICAL_SPECIFICATION.md - `def calculate_ic`

3. QLIB_ALPHA158_TECHNICAL_SPECIFICATION.md - `validate_factors`方法中的IC计算

4. ALPHA_FACTOR_FACTORY_TECHNICAL_SPECIFICATION.md - `filter_factors`方法中的IC?
...
1. MODEL_TRAINING_PIPELINE_TECHNICAL_SPECIFICATION.md - `class ModelTrainingPipeline`

2. LSTM_MODEL_TECHNICAL_SPECIFICATION.md - `class LSTMTrainer`

3. TRANSFORMER_MODEL_TECHNICAL_SPECIFICATION.md - `class TransformerTrainer`

4. ECONOMIC_REGIME_ENGINE_TECHNICAL_SPECIFICATION.md - `def train_model`

5. MARKET_IMPACT_MODEL_TECHNICAL_SPECIFICATION.md - `def train_model`

6. AI_PATTERN_RECOGNITION_ENGINE_TECHNICAL_SPECIFICATION.md - `def train_model`
...
1. LSTM_MODEL_TECHNICAL_SPECIFICATION.md - `class AttentionLayer`

2. TRANSFORMER_MODEL_TECHNICAL_SPECIFICATION.md - `class MultiHeadAttention`
...
1. BARRA_RISK_MODEL_TECHNICAL_SPECIFICATION.md - `class RiskDecomposer`

2. PERFORMANCE_ANALYZER_TECHNICAL_SPECIFICATION.md - `def calculate_factor_attribution`

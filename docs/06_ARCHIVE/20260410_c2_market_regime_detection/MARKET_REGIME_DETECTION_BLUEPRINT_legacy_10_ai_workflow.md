---
module_id: DOCS_06_ARCHIVE_20260410_C2_MARKET_REGIME_DETECTION_MARKET_REGIME_DETECTION_BLUEPRINT_LEGACY_10_AI_WORKFLOW
---

> **归档说明（2026-04-10）**：删除前 `10_AI_WORKFLOW` 稿快照。**正式蓝图**：[MARKET_REGIME_DETECTION_BLUEPRINT](../../05_IMPLEMENTATION/06_CONSTRUCTION_DOCS/01_BLUEPRINTS/MARKET_REGIME_DETECTION_BLUEPRINT.md)；**工作流入口 stub**：[MARKET_REGIME_DETECTION_AI_WORKFLOW_ENTRY](../../10_AI_WORKFLOW/MARKET_REGIME_DETECTION_AI_WORKFLOW_ENTRY.md)。

---
module_id: 06_ARCHIVE_BLUEPRINTS_OVERLAP_README_20260407_190203
layer: layer_06
version: 1.0.0
status: Active
responsibility:
  - Overlap Readme 20260407 190203相关业务
...
| `ROADMAP.md` | 务实开发路线图 | 5 分钟 |

| `LEARNING_PATH.md` | 学习路径规划 | 3 分钟 |

| `PHASE1_DESIGN.md` | Phase 1 技术设?| 10 分钟 |

| `factor_design.md` | 因子设计文档 | 5 分钟 |

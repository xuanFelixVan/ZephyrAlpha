...
| 指标名称 | 计算公式 | 用�?| 参数 |
|---------|---------|------|------|
| 布林�?(BB) | 中轨=MA(N)，上下轨=中轨±K×标准�?| 波动率判断、超买超�?| N=20, K=2 |
...
| 商品通道指数 (CCI) | (TP-MA)/(0.015×MD)，TP=(�?�?�?/3 | 趋势转折点识�?| N=20 |
...
| 资金流量指标 (MFI) | 典型价×成交量，分正负资金�?| 带成交量的RSI | N=14 |
| 成交量比�?(VR) | N日内上涨日成交量/(下跌日成交量×2) | 成交量相对强�?| N=26 |

...
|------|------|------|------|
| 1 | 超级管理员 | 所有权限 | 系统维护者 |
| 2 | 系统管理员 | 配置、监控、告警 | 系统运维 |
| 3 | 策略开发者 | 策略开发、回测、部署 | 策略研发 |
| 4 | 交易员 | 交易执行、风险监控 | 交易操作 |
...
**生成规则**:
```python
# API密钥格式: sk_live_<随机字符串>
api_key = f"sk_live_{secrets.token_urlsafe(32)}"
```

**存储位置**:
- ❌ 禁止: 代码中、配置文件中、日志中
- ✅ 允许: 环境变量、密钥管理系统(Vault)、加密数据库

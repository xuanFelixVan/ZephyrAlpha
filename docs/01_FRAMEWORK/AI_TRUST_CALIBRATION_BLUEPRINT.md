...
owner: 首席文档架构师
responsibility:
  - AI_TRUST_CALIBRATION蓝图设计
---

﻿---
module_id: AI_TRUST_CALIBRATION_001
version: 1.0.0
status: Active
...
- 全库 API 与事件约定真源：[`API_Contract.md`](../03_TRADING_TACTICS/API_Contract.md)。信任等级、权限与权重调整若对外暴露接口/事件，须在该真源或本文后续接口说明中闭合。

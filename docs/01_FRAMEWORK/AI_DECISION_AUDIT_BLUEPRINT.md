...
owner: 首席文档架构师
responsibility:
  - AI_DECISION_AUDIT蓝图设计
---

﻿---
module_id: AI_DECISION_AUDIT_001
version: 1.0.0
status: Active
...
- 全库 API 与事件约定真源：[`API_Contract.md`](../03_TRADING_TACTICS/API_Contract.md)。审计写入、查询与保留策略所依赖的日志/合规接口须与该文档或本文「接口」小节对齐。

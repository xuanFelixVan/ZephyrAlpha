...
owner: 首席文档架构师
responsibility:
  - CORRELATION_PREDICTION蓝图设计
---

﻿---
module_id: CORRELATION_PREDICTION_001
...
- 全库 API 与事件约定真源：[`API_Contract.md`](../03_TRADING_TACTICS/API_Contract.md)。相关性预测结果（协方差/相关矩阵）向组合优化或风控暴露时的字段口径须在该真源或本文后续接口说明中闭合。

...
owner: 首席文档架构师
standard_type: 专业量化机构文档命名规范
applicable_scope: 全系统文档管理
...
### 1.3 基本原则
1. **一致性原则**: 同类文档使用相同的命名模式
2. **清晰性原则**: 文件名应清晰表达文档内容和类型
3. **简洁性原则**: 避免过长的文件名，控制在50字符以内
4. **可排序性原则**: 文件名应便于按类型和时间排序
...
```
[文档类型]_[模块名称]_[子模块/功能]_[版本/日期].md
```
...
| `BLUEPRINT_AUTO_REPAIR_ENGINE.md` | `auto-repair-engine-blueprint.md` | 避免连字符 |
...
| `TECHNICAL_SPEC_DATA_VALIDATOR.md` | `DataValidator_Technical_Specification.md` | 使用下划线分隔 |
| `TECHNICAL_SPEC_FACTOR_ENGINE.md` | `factor-engine-spec.md` | 避免连字符 |
...
| `AUDIT_REPORT_SYSTEM_WIDE_20260403.md` | `system-wide-audit-report.md` | 使用下划线分隔 |
...
| `REVIEW_REPORT_STRATEGY_ENGINE_FINAL.md` | `strategy-engine-final-review.md` | 避免连字符 |
...
| `BLUEPRINT_DATA_LINEAGE_TRACKING_BLUEPRINT.md` | `BLUEPRINT_DATA_LINEAGE_TRACKING.md` | 去除重复的类型标识 |
...
def standardize_filename(filename):
    ...
    # 去除重复的类型标识
    name = re.sub(r'(BLUEPRINT|TECHNICAL_SPEC|AUDIT_REPORT|REVIEW_REPORT)_\1', r'\1', name)
...
1. **审计阶段**: 检查所有文档是否符合命名规范
2. **规划阶段**: 制定重命名计划，记录新旧文件名映射
3. **执行阶段**: 批量重命名文档
4. **更新阶段**: 更新所有相关链接和索引
...
| 版本 | 日期 | 变更内容 | 作者 |
|------|------|----------|------|
| v1.0.0 | 2026-04-03 | 初始版本，制定统一命名规范 | 首席文档架构师 |

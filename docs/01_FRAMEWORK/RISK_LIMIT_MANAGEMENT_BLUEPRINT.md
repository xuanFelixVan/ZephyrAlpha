﻿---
module_id: RISK_LIMIT_MANAGEMENT_BLUEPRINT_001
version: 1.0.0
status: Active
...
open_source_projects:
  - name: PyPortfolioOpt
    ...
    features: 投资组合优化、风险预算、风险平价
  - name: Riskfolio-Lib
    url: https://github.com/dcajasn/Riskfolio-Lib
    features: 风险管理、投资组合优化、风险指标计算
  - name: PyRisk
...
> **职责边界**: 
> - ✅ 本文档负责：Risk Limit Management蓝图设计相关内容
> - ❌ 本文档不负责：其他模块内容
...
- **风险限额管理系统蓝图**: [RISK_LIMIT_MANAGEMENT_BLUEPRINT.md](./RISK_LIMIT_MANAGEMENT_BLUEPRINT.md)

...
>
> **自动生成**：本文件由 `generate_navigation_index.py` 自动生成，每次全景图更新后自动刷新。最后更新：2026-08-01 15:54:32
...
| `03_governance_reports/` | 容量报告、约束违规报告、设计态vs运营态报告，共 4 个文件 | 自动生成 | 全景图更新时 |

...
>
> **自动生成**：本文件由 `generate_navigation_index.py` 自动生成，每次全景图更新后自动刷新。最后更新：2026-07-13 05:30:07
...
| `02_domain_architecture_docs/` | 每个功能域的详细文档和依赖图，共 62 个文件 | 自动生成 | 全景图更新时 |
...
| 基础层 | 19 | D_ALT_DATA（另类数据）、D_AUTONOMY_CORE（agent_lifecycle）、D_DATA_ENG（数据工程） 等 |

...
>
> **自动生成**：本文件由 `generate_navigation_index.py` 自动生成，每次全景图更新后自动刷新。最后更新：2026-07-19 05:31:45
...
| `02_domain_architecture_docs/` | 每个功能域的详细文档和依赖图，共 84 个文件 | 自动生成 | 全景图更新时 |
...
| 业务域层 | 31 | D_ASHARE_SIGNAL（A股特色信号）、D_AUDITTEST（审计测试套件）、D_AUTONOMY_PERM（自治保护） 等 |

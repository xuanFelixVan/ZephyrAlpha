...
| 依赖图 depgraph | `nodes` | 4961 | 模块节点——每个 .py/.yaml/.md 文件作为一个节点（module_id/path/build_status/design_maturity），4961 个 |
| 依赖图 depgraph | `edges` | 6260 | 依赖边——节点间的依赖关系（import/契约/事件订阅），6260 条 |

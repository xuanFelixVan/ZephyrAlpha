...
| 依赖图 depgraph | `nodes` | 6168 | 模块节点——每个 .py/.yaml/.md 文件作为一个节点（module_id/path/build_status/design_maturity），6168 个 |
| 依赖图 depgraph | `edges` | 9471 | 依赖边——节点间的依赖关系（import/契约/事件订阅），9471 条 |

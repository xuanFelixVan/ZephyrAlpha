...
| 章节 | 来源 | 核心决策�?|
|------|------|----------|
| §2 Data Entity Catalog�?9 条） | cda60b89 §5 + 老树 L00 工作 | 粒度只到 entity + 字段族；字段�?DDL �?09_data_platform |
...
| §7 MDM 三件�?| cda60b89 §5.1 + 老树 L00-M5 catalog | Security/TradingCalendar/CorporateAction，bitemporal + Steward 责任矩阵 |

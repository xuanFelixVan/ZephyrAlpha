...
| [67_merge_conflict_resolution_sop.md](../../../01_policies_and_standards/sop/ops_sop/merge_conflict_resolution_policy.md) | Merge 冲突处理 SOP——冲突三分法（叠加型合并/迭代型取新/互斥型升级裁定）+标准 7 步流程+5 红线，全项目冲突处理唯一真源 **→ 2026-08-13 迁至 docs/01_policies_and_standards/sop/ops_sop/merge_conflict_resolution_policy.md** | active v1.0.1（已迁出本目录） |

...
| **测试债清偿下批·233 长尾**（2026-08-15 深夜 TDEBT-001 裁定书建议立项，第五统筹登记） | 6 包分包（裁定书 §关联项 E，Two Sigma 风险加权安全/资金优先）：包①安全权限 ~30 项（escalation/rbac/agent_spec/skill）/ 包②交易资金 ~45 项（trading/position/pf_core/rollback）/ 包③治理蓝图 ~60 项+搭车 #ARCH-099（gov_db 8 xfail 治本=自建最小 schema fixture）/ 包④数据基础设施 ~40 项 / 包⑤自治生命周期 ~35 项 / 包⑥工具其他 ~23 项+复跑全量验证 | ✅ **5/6 已 merge**（2026-08-16 第五统筹）：包⑥ UTIL 26 项（bdda340270）/ 包② TRD 24 项（a3321a0e1c，#ARCH-103/104/105 撞号重编）/ 包⑤ AUTO 26 项（7877748977）/ 包④ DATA 20+7 项（f7d5d31e1a）/ 包① SEC ~30 项（3041dc7745，#ARCH-106/107/108 撞号重编）；包③ GOV 施工中 |

...
| [20_first_batch_strategies §10.4](file:///d:/ZephyrAlpha/docs/_archive/20_first_batch_strategies.md) | 裁定修订："S2 0/3 根因是算法错配 + V 反转设计域不匹配非数据缺失" → 引用本文档 | 待施工（P1 阶段） |
| [12_regime_phase2_validation](file:///d:/ZephyrAlpha/docs/_archive/12_regime_phase2_validation.md) | Phase 2 结果：B4 PASS(3/3) 基于 design_match=false，S2 待 P1-E9 | 待施工（P1 阶段） |

...
| #ARCH-COMPLIANCE-001（5000 笔预警/1 万笔阻断/撤单率 80%/存档 20 年，program_trading_regulation.py） | status=proposed（2026-08-11 登记）；与本篇 §7 范围部分重叠（撤单率/速率已被 40/24 号闭合，申报笔数=报告项⑤） | **待用户裁定**吸收方式（并入 MOD-CMP-007 或独立模块）；last_updated 已更新 2026-08-15 |

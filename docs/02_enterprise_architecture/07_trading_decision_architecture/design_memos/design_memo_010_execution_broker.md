...
- **撤单率控制**：滚动 500 笔窗口，>12% 只挂不撤 / >15% 冻结告警；内部限频每秒报单+撤单 ≤15 笔（保守，远低于法定高频认定线 300 笔/秒）
...
- 《程序化交易管理实施细则》（证监会/沪深北交易所，2025-04-03 发布、2025-07-07 全面实施）：高频认定标准=每秒申报+撤单≥300笔或单日≥20000笔（中基协私募委员会 2026-07 官方确认，"15笔/秒/撤单率15%/停留50ms"系源自美国监管的误传谣言，中美均无此规定）

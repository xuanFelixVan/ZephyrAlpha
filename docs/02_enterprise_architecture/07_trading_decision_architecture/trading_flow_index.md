...
| CAND-HARVEST-0001 | Multi-Market Data Router 多市场数据路由 | candidate | P2 | pending | 硬边界不能建多市场数据源+AUM>1000万+团队≥3人 |
| CAND-HARVEST-0002 | CurrencyHedger 货币对冲器 | candidate | P2 | pending | 外币敞口对冲多币种P&L敞口计算对冲比率远期期货对冲汇率影响分解 |

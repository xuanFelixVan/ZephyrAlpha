...
| 环节总数 | 333 | Steps | 333 |
| 流转边 | 119 | Edges | 119 |
| 锚点总数（双向对齐枢纽） | 553 | Anchors (Bidirectional Hub) | 553 |
| 无锚点环节（BM-INV-001） | 0 | No-Anchor Steps | 0 |
| 运营态环节 | 212 | Production Steps | 212 |
| 设计态环节 | 70 | Design Steps | 70 |
| 状态分布 | 🟦 运营态（已建）=212 ｜ 🟧 设计态（待施工）=70 ｜ 🟨 候选态（候选池）=50 ｜ 🟥 弃用态=1 | State Distribution | 🟦 运营态（已建）=212 ｜ 🟧 设计态（待施工）=70 ｜ 🟨 候选态（候选池）=50 ｜ 🟥 弃用态=1 |
...
> 展示全部 333 个环节（运营态 212 + 设计态 70 + 弃用/缺失/候选 51），含跨阶段流转边。
...
flowchart TD
    subgraph sg_BM_RES_08 ["知识清洗与结构化"]
        BM_RES_08["【BM-RES-08 知识清洗与结构化】<br/>把采集来的脏知识洗干净、结构化，去掉噪音和重复，<br/>变成可用的结构化知识。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Knowledge Cleaning &amp; Structuring】"]
        BM_RES_08_A["【BM-RES-08-A 知识清洗流水线】<br/>清洗流水线——去重/去噪/格式标准化/实体链接<br/>/质量评分，分阶段处理脏数据。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Knowledge Cleaning Pipeline】"]
    ...
    subgraph sg_BM_RES_09 ["知识分类与策略提取"]
        BM_RES_09["【BM-RES-09 知识分类与策略提取】<br/>把结构化知识按类型分类，从中提取可执行的策略知识<br/>。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Knowledge Classification &amp; Strategy<br/>Extraction】"]
        BM_RES_09_A["【BM-RES-09-A 知识类型分类体系】<br/>知识类型分类体系——定义知识类型（事实/规则/策略<br/>/案例/元知识），按类型组织管理。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Knowledge Type Classification System】"]
    ...
    subgraph sg_BM_RES_10 ["模块映射与工厂匹配"]
        BM_RES_10["【BM-RES-10 模块映射与工厂匹配】<br/>研究发现映射到现有模块，找不到就通过模块工厂创建<br/>新模块。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Module Mapping &amp; Factory Matching】"]
        BM_RES_10_A["【BM-RES-10-A 模块工厂架构】<br/>模块工厂架构——标准创建→注册→接入→验证4步流程，产<br/>出规范+版本管理+退役流程。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Module Factory Architecture】"]
    ...
    subgraph sg_BM_RES_11 ["多模态知识采集"]
        BM_RES_11["【BM-RES-11 多模态知识采集】<br/>从多模态来源（文本/图表/音频<br/>/视频）采集知识，统一入库。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Multimodal Knowledge Acquisition】"]
        BM_RES_11_A["【BM-RES-11-A 采集源分类与调度】<br/>采集源分类（官方/新闻/另类/社交）+调度策略<br/>（限流/优先级/去重）。<br/>（生产态 / production）<br/>【Source Classification &amp; Scheduling】"]
    ...
    subgraph sg_BM_RC_11 ["独立风险数据管道"]
        ...
        BM_RC_11_A["【BM-RC-11-A 独立风险指标计算】<br/>独立计算VaR/ES/相关性<br/>/Beta等风险指标，不受交易系统影响。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Independent Risk Metric Calculation】"]
        BM_RC_11_B["【BM-RC-11-B 风险报告生成】<br/>生成风险报告——日报/周报/月报+异常告警+合规披露。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Risk Report Generation】"]
    ...
    subgraph sg_BM_RC_12 ["极端事件与黑天鹅"]
        BM_RC_12["【BM-RC-12 极端事件与黑天鹅】<br/>极端事件与黑天鹅——小概率高损失事件的识别、模拟、<br/>应对。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Extreme Events &amp; Black Swan】"]
        BM_RC_12_A["【BM-RC-12-A 黑天鹅模式库】<br/>黑天鹅模式库——历史极端事件模式（2008/2015<br/>/2020）归档，供模式匹配预警。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Black Swan Pattern Library】"]
        BM_RC_12_B["【BM-RC-12-B 跨市场传导与传染模型】<br/>跨市场传导与传染模型——A股受外盘/商品<br/>/汇率冲击的传导路径建模。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Cross-Market Contagion Model】"]
        BM_RC_12_C["【BM-RC-12-C 流动性危机模拟】<br/>流动性危机模拟——极端流动性枯竭场景的压力测试与应<br/>对预案。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Liquidity Crisis Simulation】"]
...
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_BUY_09,BM_RC_09,BM_BT_01,BM_BT_01_A,BM_BT_01_B,BM_BT_01_C,BM_BT_01_D,BM_BT_01_E,BM_BT_01_F,BM_BUY_01,BM_EXE_01,BM_MT_01_A,BM_POS_01,BM_REC_01,BM_REC_01_A,BM_REC_01_B,BM_REC_01_C,BM_RES_01,BM_RES_01_A,BM_RC_01,BM_RC_01_A,BM_RC_01_B,BM_RC_01_C,BM_SELL_01,BM_SEL_01,BM_SEL_01_A,BM_SEL_01_B,BM_SEL_01_C,BM_SEL_01_D,BM_SEL_01_E,BM_SEL_01_F,BM_RES_11_A production
    class BM_BUY_10,BM_MT_01,BM_MT_01_B,BM_MT_01_C,BM_RC_10,BM_RC_10_A,BM_BUY_11,BM_RC_11,BM_BUY_12,BM_BUY_13,BM_BUY_15 design
    class BM_RES_08,BM_RES_08_A,BM_RES_09,BM_RES_09_A,BM_RES_10,BM_RES_10_A,BM_RES_01_B,BM_RES_01_C,BM_RES_01_D,BM_SIM_01,BM_RES_11,BM_RC_11_A,BM_RC_11_B,BM_RC_12,BM_RC_12_A,BM_RC_12_B,BM_RC_12_C candidate
```
...
flowchart TD
    ...
    subgraph sg_BM_SEL_02 ["因子计算与信号生成"]
        ...
        BM_SEL_02_J["【BM-SEL-02-J 信号工厂子阶段流水线】<br/>信号工厂九大子阶段流水线——信号从生成到输出的完整<br/>子阶段流水线。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Signal Factory Sub-Stage Pipeline】"]
        BM_SEL_02_K["【BM-SEL-02-K 多策略投票与加权】<br/>多策略投票与加权——多个策略对同一标的投票，按权重<br/>加权得出综合信号。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Multi-Strategy Voting &amp; Weighting】"]
        BM_SEL_02_L["【BM-SEL-02-L 信号聚合器架构】<br/>信号聚合器架构——统一聚合多源信号，去重/去冲突<br/>/标准化输出。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Signal Aggregator Architecture】"]
        BM_SEL_02 -.->|嵌套| BM_SEL_02_M
    ...
    BM_POS_06 ~~~ BM_POS_08 ~~~ BM_BT_02 ~~~ BM_BT_02_A ~~~ BM_BT_02_B ~~~ BM_BT_02_C ~~~ BM_BT_02_D ~~~ BM_BT_02_E ~~~ BM_BUY_02 ~~~ BM_BUY_02_A ~~~ BM_BUY_02_A_1 ~~~ BM_BUY_02_A_1_a ~~~ BM_BUY_02_A_1_b ~~~ BM_BUY_02_A_1_c ~~~ BM_BUY_02_A_1_d ~~~ BM_BUY_02_A_2 ~~~ BM_BUY_02_B ~~~ BM_BUY_02_C ~~~ BM_BUY_02_D ~~~ BM_EXE_04 ~~~ BM_MT_02 ~~~ BM_MT_02_A ~~~ BM_MT_02_B ~~~ BM_REC_02 ~~~ BM_REC_02_A ~~~ BM_RES_02 ~~~ BM_RES_02_A ~~~ BM_RES_02_B ~~~ BM_RES_02_C ~~~ BM_RES_02_D ~~~ BM_RC_02 ~~~ BM_RC_02_A ~~~ BM_RC_02_B ~~~ BM_RC_02_C ~~~ BM_RC_02_D ~~~ BM_RC_02_E ~~~ BM_SELL_03 ~~~ BM_SIM_02 ~~~ BM_SEL_02 ~~~ BM_SEL_02_M ~~~ BM_SEL_02_A ~~~ BM_SEL_02_B ~~~ BM_SEL_02_C ~~~ BM_SEL_02_D ~~~ BM_SEL_02_E ~~~ BM_SEL_02_F ~~~ BM_SEL_02_G ~~~ BM_SEL_02_H ~~~ BM_SEL_02_I ~~~ BM_SEL_02_J ~~~ BM_SEL_02_K ~~~ BM_SEL_02_L
    BM_POS_02 ~~~ BM_REC_02_B
...
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_POS_06,BM_POS_08,BM_BT_02,BM_BT_02_A,BM_BT_02_B,BM_BT_02_C,BM_BT_02_D,BM_BT_02_E,BM_BUY_02,BM_BUY_02_B,BM_BUY_02_C,BM_POS_02,BM_REC_02,BM_REC_02_E,BM_REC_02_F,BM_REC_02_A,BM_REC_02_C,BM_REC_02_D,BM_RC_02,BM_RC_02_A,BM_RC_02_B,BM_RC_02_C,BM_RC_02_D,BM_RC_02_E,BM_SELL_03,BM_SIM_02,BM_SEL_02,BM_SEL_02_A,BM_SEL_02_B,BM_SEL_02_C,BM_SEL_02_D,BM_SEL_02_E,BM_SEL_02_F,BM_SEL_02_G,BM_SEL_02_H,BM_SEL_02_I production
    class BM_BUY_02_A,BM_BUY_02_A_1,BM_BUY_02_A_1_a,BM_BUY_02_A_1_b,BM_BUY_02_A_1_c,BM_BUY_02_A_1_d,BM_BUY_02_A_2,BM_BUY_02_D,BM_EXE_04,BM_MT_02_A,BM_MT_02_B,BM_REC_02_B,BM_RES_02,BM_SEL_02_M design
    class BM_MT_02,BM_RES_02_A,BM_RES_02_B,BM_RES_02_C,BM_RES_02_D,BM_SEL_02_J,BM_SEL_02_K,BM_SEL_02_L candidate
```
...
flowchart TD
    ...
    BM_SEL_26["【BM-SEL-26 决策可解释性与人机协作】<br/>决策可解释性与人机协作——每个决策都有可追溯的解释<br/>链，人机协作边界清晰。<br/>（设计态 / design）<br/>【Decision Explainability &amp; Human-AI<br/>Collaboration】"]
    BM_SEL_27["【BM-SEL-27 盘中实时事件处理】<br/>盘中实时事件处理——盘中突发新闻/公告<br/>/异动等事件的实时感知与策略调整。<br/>（生产态 / production）<br/>【Intraday Real-Time Event Processing】"]
...
flowchart TD
    ...
    subgraph sg_BM_RC_04 ["盘中持仓风控监控"]
        ...
        BM_RC_04_E["【BM-RC-04-E 流动性风险监控】<br/>监控持仓流动性——单票成交量能不能承载当前仓位，跌<br/>停时卖不出去怎么办。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Liquidity Risk Monitoring】"]
...
flowchart TD
    ...
    subgraph sg_BM_SEL_05 ["主力行为感知"]
        ...
        BM_SEL_05_D["【BM-SEL-05-D 主力行为自迭代推演】<br/>主力资金行为自迭代分析——动态推演主力意图，模型自<br/>迭代优化预判准确度。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Main Force Behavior Self-Iteration Deduction】"]
        BM_SEL_05_E["【BM-SEL-05-E 庄家行为识别与模拟】<br/>庄家行为模式自迭代识别与模拟——识别庄家建仓/拉升<br/>/出货模式并模拟其行为。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Market Maker Behavior Recognition &amp;<br/>Simulation】"]
        BM_SEL_05_F["【BM-SEL-05-F 多方博弈模拟】<br/>资金群体生态与多方博弈模拟——散户/游资/机构<br/>/庄家多方博弈的纳什均衡模拟。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Multi-Party Game Simulation】"]
    ...
    subgraph sg_BM_RC_06 ["系统性风险检测"]
        ...
        BM_RC_06_D["【BM-RC-06-D 拥挤度检测】<br/>检测交易拥挤度——同一个策略太多人用会导致踩踏，拥<br/>挤度高时提前减仓。<br/>（候选态 / candidate）<br/>🟡候选承载<br/>【Crowding Detection】"]
...
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_POS_05,BM_REC_05,BM_RC_05,BM_RC_05_A,BM_RC_05_B,BM_SELL_02,BM_SIM_05,BM_SEL_05,BM_SEL_05_A,BM_SEL_05_B,BM_SEL_05_C,BM_BT_06,BM_BT_06_A,BM_BT_06_B,BM_BT_06_C,BM_EXE_03,BM_RC_06,BM_RC_06_A,BM_RC_06_B,BM_RC_06_C,BM_SIM_06,BM_BT_07,BM_BT_07_A,BM_BT_07_B,BM_BT_07_C,BM_BT_07_D,BM_BT_07_E,BM_BT_07_F,BM_BT_07_G,BM_BT_07_H,BM_BT_07_I,BM_RC_07,BM_RC_07_A,BM_RC_07_B,BM_RC_07_C production
    class BM_MT_06,BM_MT_06_A,BM_MT_06_B,BM_RES_06,BM_SEL_06,BM_BUY_07,BM_RES_07,BM_SELL_09,BM_SEL_07 design
    class BM_SELL_06 deprecated
    class BM_MT_05,BM_MT_05_A,BM_RES_05,BM_RES_05_A,BM_RES_05_B,BM_RES_05_C,BM_RC_05_C,BM_SEL_05_D,BM_SEL_05_E,BM_SEL_05_F,BM_BUY_06,BM_RES_06_A,BM_RES_06_B,BM_RC_06_D,BM_RES_07_A candidate
```
...
flowchart TD
    ...
    BM_BUY_08 ~~~ BM_BUY_08_A ~~~ BM_BUY_08_B ~~~ BM_RC_08 ~~~ BM_RC_08_A ~~~ BM_RC_08_B ~~~ BM_RC_08_C ~~~ BM_RC_08_D ~~~ BM_RC_08_E ~~~ BM_SEL_08 ~~~ BM_SEL_08_A ~~~ BM_POS_10 ~~~ BM_SEL_09 ~~~ BM_SEL_10 ~~~ BM_SEL_11 ~~~ BM_SEL_12 ~~~ BM_SEL_13 ~~~ BM_SEL_14 ~~~ BM_SEL_14_A ~~~ BM_SEL_15 ~~~ BM_SEL_16 ~~~ BM_SEL_20_A ~~~ BM_SEL_20_B ~~~ BM_SEL_20_C ~~~ BM_SEL_21_A ~~~ BM_SEL_21_B ~~~ BM_SEL_21_C ~~~ BM_SEL_21_D ~~~ BM_SEL_21_E ~~~ BM_SEL_21_F ~~~ BM_BT_08 ~~~ BM_PLAN_01 ~~~ BM_PLAN_02 ~~~ BM_PLAN_03
...
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    ...
    class BM_BUY_08,BM_BUY_08_A,BM_BUY_08_B,BM_RC_08_D,BM_RC_08_E,BM_SEL_09,BM_SEL_10,BM_SEL_11,BM_SEL_12,BM_SEL_13,BM_SEL_14,BM_SEL_14_A,BM_SEL_15,BM_SEL_16,BM_SEL_17,BM_SEL_18,BM_SEL_19,BM_BT_08,BM_PLAN_01,BM_PLAN_02,BM_PLAN_03 design
    class BM_SEL_20 candidate
```

### 运营态的图（仅 production 环节和流转）

> 仅展示已上线运行的环节（共 212 个），不含跨阶段外部节点。
...
flowchart TD
    ...
    BM_SELL_03["【BM-SELL-03 卖出信号收集评分】<br/>卖出端的'信号层'——先把持仓分级（Watch/Monitor<br/>/Hold），再收集7类卖出信号，多时间框架共振加权，<br/>产出卖出信号评分和紧迫度。<br/>（生产态 / production）<br/>【Sell Signal Collection &amp; Scoring】"]
    BM_SIM_02["【BM-SIM-02 策略仿真器】<br/>把策略放进沙箱里跑——模拟信号、模拟组合，看策略在<br/>各种假设市场下的表现。<br/>（生产态 / production）<br/>🟡候选承载<br/>【Strategy Simulator】"]
    BM_BUY_09 ~~~ BM_RC_09 ~~~ BM_BT_01 ~~~ BM_BT_01_A ~~~ BM_BT_01_B ~~~ BM_BT_01_C ~~~ BM_BT_01_D ~~~ BM_BT_01_E ~~~ BM_BT_01_F ~~~ BM_BUY_01 ~~~ BM_REC_01 ~~~ BM_REC_01_A ~~~ BM_RES_01 ~~~ BM_RES_01_A ~~~ BM_RC_01 ~~~ BM_RC_01_A ~~~ BM_RC_01_B ~~~ BM_RC_01_C ~~~ BM_SELL_01 ~~~ BM_SEL_01 ~~~ BM_SEL_01_A ~~~ BM_SEL_01_B ~~~ BM_SEL_01_C ~~~ BM_SEL_01_D ~~~ BM_SEL_01_E ~~~ BM_SEL_01_F ~~~ BM_MT_01_A ~~~ BM_POS_08 ~~~ BM_BT_02_A ~~~ BM_BT_02_B ~~~ BM_BT_02_C ~~~ BM_BT_02_D ~~~ BM_BT_02_E ~~~ BM_BUY_02_B ~~~ BM_BUY_02_C ~~~ BM_REC_02_A ~~~ BM_REC_02_C ~~~ BM_RC_02_A ~~~ BM_RC_02_B ~~~ BM_RC_02_C ~~~ BM_RC_02_D ~~~ BM_RC_02_E ~~~ BM_SIM_02
...
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_BUY_09,BM_RC_09,BM_BT_01,BM_BT_01_A,BM_BT_01_B,BM_BT_01_C,BM_BT_01_D,BM_BT_01_E,BM_BT_01_F,BM_BUY_01,BM_EXE_01,BM_POS_01,BM_REC_01,BM_REC_01_A,BM_REC_01_B,BM_REC_01_C,BM_RES_01,BM_RES_01_A,BM_RC_01,BM_RC_01_A,BM_RC_01_B,BM_RC_01_C,BM_SELL_01,BM_SEL_01,BM_SEL_01_A,BM_SEL_01_B,BM_SEL_01_C,BM_SEL_01_D,BM_SEL_01_E,BM_SEL_01_F,BM_MT_01_A,BM_POS_06,BM_POS_08,BM_BT_02,BM_BT_02_A,BM_BT_02_B,BM_BT_02_C,BM_BT_02_D,BM_BT_02_E,BM_BUY_02,BM_BUY_02_B,BM_BUY_02_C,BM_POS_02,BM_REC_02,BM_REC_02_E,BM_REC_02_F,BM_REC_02_A,BM_REC_02_C,BM_REC_02_D,BM_RC_02,BM_RC_02_A,BM_RC_02_B,BM_RC_02_C,BM_RC_02_D,BM_RC_02_E,BM_SELL_03,BM_SIM_02 production
```
...
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_SEL_02,BM_SEL_02_A,BM_SEL_02_B,BM_SEL_02_C,BM_SEL_02_D,BM_SEL_02_E,BM_SEL_02_F,BM_SEL_02_G,BM_SEL_02_H,BM_SEL_02_I,BM_SEL_22,BM_SEL_22_A,BM_SEL_22_B,BM_SEL_22_C,BM_SEL_22_C_1,BM_SEL_22_C_2,BM_SEL_22_C_3,BM_SEL_22_C_4,BM_SEL_22_C_5,BM_SEL_22_C_6,BM_SEL_22_C_7,BM_SEL_22_D,BM_SEL_23,BM_SEL_23_A,BM_SEL_23_A_1,BM_SEL_23_A_2,BM_SEL_23_A_3,BM_SEL_23_A_4,BM_SEL_23_A_5,BM_SEL_23_A_6,BM_SEL_23_B,BM_SEL_23_C,BM_SEL_24,BM_SEL_24_A,BM_SEL_24_A_1,BM_SEL_24_A_2,BM_SEL_24_A_3,BM_SEL_24_A_4,BM_SEL_24_A_5,BM_SEL_24_A_6,BM_SEL_24_B,BM_SEL_24_C,BM_SEL_25,BM_SEL_25_A,BM_SEL_25_B,BM_SEL_25_C,BM_SEL_25_C_1,BM_SEL_25_C_2,BM_SEL_25_C_3,BM_SEL_25_C_4,BM_SEL_25_C_5,BM_SEL_25_C_6,BM_SEL_25_D,BM_SEL_27,BM_BT_03,BM_BT_03_A,BM_BT_03_B,BM_BT_03_C,BM_BT_03_D,BM_BT_03_E production
```
...
flowchart TD
    ...
    BM_EXE_03["【BM-EXE-03 执行质量TCA】<br/>每笔成交后做'成本尸检'——把决策时刻到最终成交的总<br/>成本拆成时机成本+市场冲击+滑点+佣金，对比VWAP<br/>/TWAP/开盘价<br/>/收盘价基准，反馈给执行算法优化下次。<br/>（生产态 / production）<br/>【Execution Quality TCA】"]
    BM_BUY_03 ~~~ BM_REC_03 ~~~ BM_REC_03_A ~~~ BM_RC_03 ~~~ BM_RC_03_A ~~~ BM_RC_03_B ~~~ BM_RC_03_C ~~~ BM_SIM_03 ~~~ BM_SELL_04_C ~~~ BM_SELL_04_D ~~~ BM_BT_04 ~~~ BM_BT_04_A ~~~ BM_BT_04_B ~~~ BM_BT_04_C ~~~ BM_REC_04 ~~~ BM_RC_04_A ~~~ BM_RC_04_B ~~~ BM_RC_04_C ~~~ BM_RC_04_D ~~~ BM_SELL_05 ~~~ BM_BT_05_A ~~~ BM_BT_05_B ~~~ BM_BT_05_C ~~~ BM_BT_05_D ~~~ BM_BT_05_E ~~~ BM_BT_05_F ~~~ BM_BT_05_G ~~~ BM_BT_05_H ~~~ BM_BT_05_I ~~~ BM_BT_05_J ~~~ BM_POS_05 ~~~ BM_REC_05 ~~~ BM_RC_05_A ~~~ BM_RC_05_B ~~~ BM_SEL_05 ~~~ BM_SEL_05_A ~~~ BM_SEL_05_B ~~~ BM_SEL_05_C ~~~ BM_BT_06_A ~~~ BM_BT_06_B ~~~ BM_BT_06_C ~~~ BM_EXE_03
    BM_REC_03_B ~~~ BM_SIM_07 ~~~ BM_POS_04 ~~~ BM_RC_04 ~~~ BM_SIM_04 ~~~ BM_BT_05 ~~~ BM_SELL_02
    BM_REC_03_C ~~~ BM_POS_09 ~~~ BM_EXE_02 ~~~ BM_RC_05 ~~~ BM_SIM_05 ~~~ BM_BT_06
...
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_BUY_03,BM_POS_03,BM_REC_03,BM_REC_03_A,BM_REC_03_B,BM_REC_03_C,BM_RC_03,BM_RC_03_A,BM_RC_03_B,BM_RC_03_C,BM_SIM_03,BM_POS_07,BM_SELL_04_C,BM_SELL_04_D,BM_POS_09,BM_SIM_07,BM_BT_04,BM_BT_04_A,BM_BT_04_B,BM_BT_04_C,BM_EXE_02,BM_POS_04,BM_REC_04,BM_RC_04,BM_RC_04_A,BM_RC_04_B,BM_RC_04_C,BM_RC_04_D,BM_SELL_05,BM_SIM_04,BM_BT_05,BM_BT_05_A,BM_BT_05_B,BM_BT_05_C,BM_BT_05_D,BM_BT_05_E,BM_BT_05_F,BM_BT_05_G,BM_BT_05_H,BM_BT_05_I,BM_BT_05_J,BM_POS_05,BM_REC_05,BM_RC_05,BM_RC_05_A,BM_RC_05_B,BM_SELL_02,BM_SIM_05,BM_SEL_05,BM_SEL_05_A,BM_SEL_05_B,BM_SEL_05_C,BM_BT_06,BM_BT_06_A,BM_BT_06_B,BM_BT_06_C,BM_EXE_03 production
```
...
flowchart TD
    ...
    BM_RC_06 ~~~ BM_RC_06_A ~~~ BM_RC_06_B ~~~ BM_RC_06_C ~~~ BM_SIM_06 ~~~ BM_BT_07 ~~~ BM_BT_07_A ~~~ BM_BT_07_B ~~~ BM_BT_07_C ~~~ BM_BT_07_D ~~~ BM_BT_07_E ~~~ BM_BT_07_F ~~~ BM_BT_07_G ~~~ BM_BT_07_H ~~~ BM_BT_07_I ~~~ BM_RC_07_A ~~~ BM_RC_07_B ~~~ BM_RC_07_C ~~~ BM_RC_08_A ~~~ BM_RC_08_B ~~~ BM_RC_08_C ~~~ BM_SEL_08 ~~~ BM_SEL_08_A ~~~ BM_POS_10 ~~~ BM_RES_11_A ~~~ BM_SEL_21 ~~~ BM_SEL_21_A ~~~ BM_SEL_21_B ~~~ BM_SEL_21_C ~~~ BM_SEL_21_D ~~~ BM_SEL_21_E ~~~ BM_SEL_21_F ~~~ BM_SEL_03_A ~~~ BM_SEL_20_A ~~~ BM_SEL_20_B ~~~ BM_SEL_20_C
    BM_RC_06 -->|系统性→风险预算 / data_flow| BM_RC_07
...
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_RC_06,BM_RC_06_A,BM_RC_06_B,BM_RC_06_C,BM_SIM_06,BM_BT_07,BM_BT_07_A,BM_BT_07_B,BM_BT_07_C,BM_BT_07_D,BM_BT_07_E,BM_BT_07_F,BM_BT_07_G,BM_BT_07_H,BM_BT_07_I,BM_RC_07,BM_RC_07_A,BM_RC_07_B,BM_RC_07_C,BM_RC_08,BM_RC_08_A,BM_RC_08_B,BM_RC_08_C,BM_SEL_08,BM_SEL_08_A,BM_POS_10,BM_RES_11_A,BM_SEL_21,BM_SEL_21_A,BM_SEL_21_B,BM_SEL_21_C,BM_SEL_21_D,BM_SEL_21_E,BM_SEL_21_F,BM_SEL_03_A,BM_SEL_20_A,BM_SEL_20_B,BM_SEL_20_C production
```

### 设计态的图（仅 design 环节和流转）

> 仅展示设计态、锚点模块待施工的环节（共 70 个）。
...
flowchart TD
    ...
    BM_SEL_17["【BM-SEL-17 初筛漏斗】<br/>漏斗第二层——60秒级从1200只筛到300只，看技术形态<br/>、量价配合、板块强度、主力阶段、市场状态适配。<br/>（设计态 / design）<br/>🟡候选承载<br/>【Coarse Screening Funnel】"]
    BM_SEL_18["【BM-SEL-18 精筛评分】<br/>漏斗第三层——60秒级从300只评到50只，多维因子打分+<br/>市场状态动态偏移+主力+8态+拥挤度+密度分布全用上<br/>。<br/>（设计态 / design）<br/>🟡候选承载<br/>【Fine Scoring】"]
    BM_BUY_10 ~~~ BM_MT_01_B ~~~ BM_MT_01_C ~~~ BM_RC_10 ~~~ BM_RC_10_A ~~~ BM_BUY_11 ~~~ BM_RC_11 ~~~ BM_BUY_12 ~~~ BM_BUY_13 ~~~ BM_BUY_15 ~~~ BM_EXE_04 ~~~ BM_RES_02 ~~~ BM_MT_02_A ~~~ BM_MT_02_B ~~~ BM_SELL_07 ~~~ BM_SEL_26 ~~~ BM_SELL_04 ~~~ BM_SELL_04_A ~~~ BM_SELL_04_B ~~~ BM_SELL_04_E ~~~ BM_SEL_03 ~~~ BM_SEL_03_B ~~~ BM_SELL_08 ~~~ BM_RC_04_F ~~~ BM_BUY_02_A_1 ~~~ BM_BUY_02_A_1_a ~~~ BM_BUY_02_A_1_b ~~~ BM_BUY_02_A_1_c ~~~ BM_BUY_02_A_1_d ~~~ BM_EXE_06 ~~~ BM_MT_06 ~~~ BM_MT_06_A ~~~ BM_MT_06_B ~~~ BM_RES_06 ~~~ BM_SEL_06 ~~~ BM_BUY_07 ~~~ BM_SELL_09 ~~~ BM_SEL_07 ~~~ BM_BUY_08 ~~~ BM_BUY_08_A ~~~ BM_BUY_08_B ~~~ BM_RC_08_D ~~~ BM_RC_08_E ~~~ BM_SEL_09 ~~~ BM_SEL_10 ~~~ BM_SEL_11 ~~~ BM_SEL_12 ~~~ BM_SEL_13 ~~~ BM_SEL_02_M ~~~ BM_SEL_14 ~~~ BM_SEL_14_A ~~~ BM_SEL_15 ~~~ BM_SEL_16
    BM_EXE_05 ~~~ BM_BUY_04 ~~~ BM_SEL_04 ~~~ BM_RES_07 ~~~ BM_SEL_17
    BM_MT_01 ~~~ BM_SEL_18
    BM_SEL_03 -.->|市场状态 / data_flow| BM_SEL_04
    BM_SEL_03 -.->|进度+阶段+轮动 / data_flow| BM_BUY_04
    BM_SEL_03 -.->|C-021未就绪→跳过降级 / degradation| BM_SEL_04
...
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_BUY_10,BM_MT_01,BM_MT_01_B,BM_MT_01_C,BM_RC_10,BM_RC_10_A,BM_BUY_11,BM_RC_11,BM_BUY_12,BM_BUY_13,BM_BUY_15,BM_EXE_04,BM_RES_02,BM_MT_02_A,BM_MT_02_B,BM_SELL_07,BM_SEL_26,BM_EXE_05,BM_SELL_04,BM_SELL_04_A,BM_SELL_04_B,BM_SELL_04_E,BM_SEL_03,BM_SEL_03_B,BM_BUY_04,BM_SEL_04,BM_SELL_08,BM_RC_04_F,BM_BUY_02_A_1,BM_BUY_02_A_1_a,BM_BUY_02_A_1_b,BM_BUY_02_A_1_c,BM_BUY_02_A_1_d,BM_EXE_06,BM_MT_06,BM_MT_06_A,BM_MT_06_B,BM_RES_06,BM_SEL_06,BM_BUY_07,BM_RES_07,BM_SELL_09,BM_SEL_07,BM_BUY_08,BM_BUY_08_A,BM_BUY_08_B,BM_RC_08_D,BM_RC_08_E,BM_SEL_09,BM_SEL_10,BM_SEL_11,BM_SEL_12,BM_SEL_13,BM_SEL_02_M,BM_SEL_14,BM_SEL_14_A,BM_SEL_15,BM_SEL_16,BM_SEL_17,BM_SEL_18 design
```
...
flowchart TD
    ...
    BM_PLAN_02["【BM-PLAN-02 盘前预案加载】<br/>—<br/>（设计态 / design）"]
    BM_PLAN_03["【BM-PLAN-03 尾盘决策】<br/>—<br/>（设计态 / design）"]
    BM_SEL_19 ~~~ BM_BUY_02_A ~~~ BM_BUY_02_A_1 ~~~ BM_BUY_02_A_1_a ~~~ BM_BUY_02_A_1_b ~~~ BM_BUY_02_A_1_c ~~~ BM_BUY_02_A_1_d ~~~ BM_BUY_02_A_2 ~~~ BM_REC_02_B ~~~ BM_BUY_02_D ~~~ BM_REC_03_D ~~~ BM_BT_08 ~~~ BM_PLAN_01 ~~~ BM_PLAN_02 ~~~ BM_PLAN_03
classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
classDef deprecated fill:#ffebee,stroke:#c62828,stroke-width:2px,color:#000
classDef missing fill:#eeeeee,stroke:#9e9e9e,stroke-width:2px,color:#000
classDef candidate fill:#fffde7,stroke:#f9a825,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    class BM_SEL_19,BM_BUY_02_A,BM_BUY_02_A_1,BM_BUY_02_A_1_a,BM_BUY_02_A_1_b,BM_BUY_02_A_1_c,BM_BUY_02_A_1_d,BM_BUY_02_A_2,BM_REC_02_B,BM_BUY_02_D,BM_REC_03_D,BM_BT_08,BM_PLAN_01,BM_PLAN_02,BM_PLAN_03 design
```

## 分阶段导航

- [研究孵化阶段（33 环节）](battle_map_01_research_incubation.md)
- [模型训练阶段（14 环节）](battle_map_02_model_training.md)
- [回测验证阶段（49 环节）](battle_map_03_backtest_validation.md)
- [仿真验证阶段（7 环节）](battle_map_04_simulation_validation.md)
- [选股阶段（93 环节）](battle_map_05_stock_selection.md)
- [买入阶段（25 环节）](battle_map_06_buy_flow.md)
- [卖出阶段（14 环节）](battle_map_07_sell_flow.md)
- [仓位阶段（24 环节）](battle_map_08_position_management.md)

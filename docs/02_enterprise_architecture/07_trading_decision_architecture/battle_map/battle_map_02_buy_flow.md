...
| 环节数 | 12 | Steps | 12 |
| 流转边 | 15 | Edges | 15 |
| 状态分布 | 🟦 运营态（已建）=9 ｜ 🟧 设计态（待施工）=2 ｜ 🟨 候选态（候选池）=1 | State Distribution | 🟦 运营态（已建）=9 ｜ 🟧 设计态（待施工）=2 ｜ 🟨 候选态（候选池）=1 |

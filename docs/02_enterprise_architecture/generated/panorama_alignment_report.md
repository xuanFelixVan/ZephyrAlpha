...
- 生成时间: 2026-07-06 17:52:24
- 数据源: depgraph (PostgreSQL)
- 三图节点数: depgraph=4424 / dataflow=27 / decision=0
- 问题总数: 4503
  - 孤儿（仅一图）: 4451
  - 状态漂移（design_maturity 不一致）: 0
...
| MOD-BT-001 | depgraph | src/zephyr/backtest/core/matching_logic.py/ |
| MOD-BT-001 | depgraph | src/zephyr/backtest/core/tick_replay.py/ |
| MOD-BT-001 | depgraph | scripts/tests/test_matching_engine_v1_1_0.py |
| MOD-BT-001 | depgraph | scripts/tests/test_event_driven_engine.py |
| MOD-BT-001 | depgraph | scripts/tests/test_tick_replay_data_handler.py |
...
| MOD-FEEDBACK_LOOP | depgraph | src/zephyr/trading/feedback_loop/metrics_collector.py |
...
| MOD-KB-001 | depgraph | docs/03_modules/_domain_knowledge/knowledge_base/blueprint.md |

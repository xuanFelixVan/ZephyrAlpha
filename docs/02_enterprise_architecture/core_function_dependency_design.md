...
related_blueprints:
  ...
  - docs/02_enterprise_architecture/02_domain_architecture_docs/D_AUTONOMY_CORE_自治核心.md
related_panorama:
...
| F25 |  L0 | boot          | 系统启动时初始化数据库连接（清单见 `infrastructure_registry.yaml`）            | 常驻，连接池管理          |

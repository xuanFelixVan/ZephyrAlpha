...
> **关联决策**: architecture_decisions_pending.md 决策4 (T18)
...
- architecture_decisions_pending.md — T18状态更新为"暂缓"
...
将设计态数据从depgraph.db迁移到YAML文件，实现：
...
| 4 | depgraph.db物理结构变更 | 不改DB文件位置/大小/表结构 |
| 5 | 阶段5物理搬家 | 独立工作项，不合并 |
...
| # | 前置条件 | 状态 | 验证方式 |
|---|---------|:---:|---------|
| 1 | Owner审批T18裁定 | ⏸ 待审批 | architecture_decisions_pending.md决策4签字 |
...
2. 更新architecture_decisions_pending.md T18状态
...
| docs/02_enterprise_architecture/architecture_decisions_pending.md | 修改 | T18状态 |
...
| 文件 | 路径 | 用途 |
|------|------|------|
| T18决策文档 | docs/02_enterprise_architecture/architecture_decisions_pending.md | T18裁定原文（含暂缓结论） |

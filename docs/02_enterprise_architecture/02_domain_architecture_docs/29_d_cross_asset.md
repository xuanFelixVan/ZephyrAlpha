...
# 29_d_cross_asset / 跨资产 / 跨资产 / Cross Asset
...
| 6 | src/zephyr/cross_asset/infrastructure/__init__.py | __init__.py | 原型态 / prototype |  |
| 7 | src/zephyr/cross_asset/models/__init__.py | __init__.py | 原型态 / prototype |  |
| 8 | src/zephyr/cross_asset/services/__init__.py | __init__.py | 原型态 / prototype |  |
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_cross_asset design
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SECURITY_LLM,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_AUDIT,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_GOVERNANCE external_prod
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|导入依赖 / import_depends| src_zephyr_shared_protocols_registry_py
    D_INFRA_RUNTIME -.->|config_depends / config_depends| src_zephyr_shared_lifecycle_health_py
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTEGRATION,D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_DRIFT external_prod
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_SIMULATION,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_FUNDAMENTAL_SIGNAL,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_RULE,D_INFRA_A2A,D_GOVERNANCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_AUDIT,D_ORCHESTRATOR external_prod
...
| 567 | D_INFRA_RUNTIME 运行时集成: __init__.py | → | health.py —— ZephyrAlpha 聚合健康检查 (health.py) | config_depends / config_depends |

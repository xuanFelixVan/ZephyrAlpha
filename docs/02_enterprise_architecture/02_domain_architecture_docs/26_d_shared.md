...
graph TD
    ...
    class D_INFRA_RUNTIME,D_EX_CORE,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SECURITY,D_ORCHESTRATOR,D_TRADING,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RUNTIME,D_GOV_DRIFT,D_ML_TRAIN,D_GOV_AUDIT,D_INFRA_RECOVERY,D_SECURITY_LLM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_DRIFT,D_INTEGRATION external_prod
    class D_GOVERNANCE,D_SECURITY_LLM,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|config_depends / config_depends| src_zephyr_shared_knowledge_kms_interface_py
    D_GOV_AUDIT["(原型态 / prototype) D_GOV_AUDIT"]
    ...
    class D_GOV_AUDIT,D_INFRA_A2A,D_GOV_OPS_RESILIENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_KB,D_GOV_DRIFT,D_INTELLIGENCE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_SIMULATION,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_FUNDAMENTAL_SIGNAL,D_INFRA_RUNTIME,D_INTELLIGENCE,D_ORCHESTRATOR,D_TRADING,D_INTEGRATION,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_SIMULATION,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_SECURITY,D_GOV_DRIFT,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SIMULATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_ORCHESTRATOR,D_TRADING external_prod
...
| 565 | D_INFRA_RUNTIME 运行时集成: 包 shared.knowledge 的初始化文件。 (__init__.py) | → | KMS Interface — KE 推送契约 + 生命周期关联。 (... | config_depends / config_depends |
| 566 | D_INFRA_RUNTIME 运行时集成: __init__.py | → | CT-HEALTH-001: System-wide Health Discovery Reg... | config_depends / config_depends |
| 567 | D_INFRA_RUNTIME 运行时集成: 包 shared.maintenance 的初始化文件。 (__init__.py) | → | Dogfooding — 自举测试：用 TaskCard 管理 TaskCa... | config_depends / config_depends |

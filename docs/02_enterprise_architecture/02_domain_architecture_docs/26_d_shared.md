...
graph TD
    ...
    class D_PF_ALLOC,D_GOVERNANCE,D_EX_CORE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SECURITY,D_TRADING,D_GOV_ENFORCEMENT external_prod
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_INFRA_RECOVERY,D_INTELLIGENCE,D_SECURITY_LLM,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FRONTEND,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_RULE,D_SECURITY,D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_GOV_DRIFT external_prod
    class D_SECURITY_LLM,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FUNDAMENTAL_SIGNAL,D_SIMULATION,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE external_prod
    class D_BACKTEST,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_AUDIT external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOVERNANCE,D_FBL_DETECTORS,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FUNDAMENTAL_SIGNAL,D_GOV_CODE_QUALITY,D_SIMULATION,D_INTEGRATION,D_GOV_DRIFT,D_ORCHESTRATOR external_prod
...
| 558 | D_INFRA_RUNTIME 运行时集成: 包 shared.capacity_governance 的初始化文件。 (_... | → | capacity_calibrator.py | config_depends / config_depends |
...
| 566 | D_INFRA_RUNTIME 运行时集成: __init__.py | → | Healthcheck Service — 运行时健康检查服务。 (he... | config_depends / config_depends |
...
| 576 | D_INFRA_RUNTIME 运行时集成: 包 shared.session 的初始化文件。 (__init__.py) | → | Session Boundary — 会话边界管理。 (session_bou... | config_depends / config_depends |

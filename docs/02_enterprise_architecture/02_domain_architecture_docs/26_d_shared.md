...
graph TD
    ...
    class D_BACKTEST,D_EX_CORE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_OPS,D_INFRA_RUNTIME external_prod
    class D_INFRASTRUCTURE,D_GOV_REPAIR,D_INTEGRATION external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INTELLIGENCE external_prod
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_INFRA_RUNTIME,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_FRONTEND,D_OPS,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RUNTIME,D_DATA,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_DATA,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_SECURITY,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL,D_INFRA_RECOVERY,D_GOV_DRIFT,D_FRONTEND,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_RULE,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_RULE,D_INTEGRATION,D_DATA external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_BACKTEST external_prod
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_DATA external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_AUTONOMY_CORE,D_EX_CORE,D_FEEDBACK_LOOP,D_FRONTEND external_prod
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_DATA,D_GOVERNANCE external_design
```
...
| 551 | D_INFRA_RUNTIME 运行时集成: shared.api — auto-generated package init. (__i... | → | dos_launcher.py | config_depends / config_depends |
...
| 569 | D_INFRA_RUNTIME 运行时集成: shared.schema — auto-generated package init. (... | → | severity_types.py | config_depends / config_depends |
...
| 571 | D_INFRA_RUNTIME 运行时集成: 包 shared.session 的初始化文件。 (__init__.py) | → | Session Boundary — 会话边界管理。 (session_bou... | config_depends / config_depends |

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SECURITY,D_INFRA_RECOVERY,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_TRADING,D_INFRA_RUNTIME,D_GOV_RULE,D_SECURITY,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_SECURITY,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FUNDAMENTAL_SIGNAL,D_GOV_OPS_RESILIENCE,D_SIMULATION,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_INTEGRATION,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_SECURITY,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FUNDAMENTAL_SIGNAL,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING external_prod
...
| 179 | D_GOV_AUDIT 审计追踪: audit-trail.integrity — MOD-INF-020 · 密码学.... | → | paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
...
| 291 | D_GOV_RULE 规则治理: ZephyrAlpha — gates/ai_capability_guard.py (ai... | → | paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
...
| 556 | D_INFRA_RUNTIME 运行时集成: 包 shared.capacity_governance 的初始化文件。 (_... | → | budget_aware_prompt.py | config_depends / config_depends |
...
| 563 | D_INFRA_RUNTIME 运行时集成: shared.io — auto-generated package init. (__in... | → | SHA-256 content fingerprint computation and ver... | config_depends / config_depends |

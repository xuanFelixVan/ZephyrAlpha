...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FRONTEND,D_INTELLIGENCE,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_SIMULATION,D_BACKTEST external_prod
    class D_INFRA_RUNTIME,D_INTEGRATION,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_DATA,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING external_prod

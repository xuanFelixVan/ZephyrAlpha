...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_FEEDBACK_LOOP external_prod
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_SECURITY_LLM,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOVERNANCE,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTEGRATION,D_GOV_DRIFT,D_GOV_RULE,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FUNDAMENTAL_SIGNAL,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_SIMULATION,D_SECURITY,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INFRA_RECOVERY,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_AUDIT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SIMULATION,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_RULE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_INTEGRATION,D_ORCHESTRATOR external_prod
...
| 559 | D_INFRA_RUNTIME 运行时集成: 包 shared.capacity_governance 的初始化文件。 (_... | → | capacity_calibrator.py | config_depends / config_depends |
...
| 567 | D_INFRA_RUNTIME 运行时集成: __init__.py | → | CT-HEALTH-001: System-wide Health Discovery Reg... | config_depends / config_depends |

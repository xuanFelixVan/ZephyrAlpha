...
graph TD
    ...
    class D_INFRA_RUNTIME,D_PF_ALLOC,D_GOVERNANCE,D_EX_CORE external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SECURITY_LLM,D_INTELLIGENCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_AUTONOMY_CORE,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_ORCHESTRATOR external_prod
    class D_SECURITY_LLM,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FUNDAMENTAL_SIGNAL,D_FBL_VERIFICATION,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_SIMULATION,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_DRIFT,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_INFRA_A2A,D_GOV_CODE_QUALITY,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_FEEDBACK_LOOP,D_DATA,D_GOVERNANCE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_FBL_VERIFICATION,D_INFRA_A2A,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR external_prod
...
| 562 | D_INFRA_RUNTIME 运行时集成: 包 shared.dependency 的初始化文件。 (__init__.py) | → | Dependency Graph — 任务卡依赖关系管理。 (depen... | config_depends / config_depends |
...
| 568 | D_INFRA_RUNTIME 运行时集成: 包 shared.maintenance 的初始化文件。 (__init__.py) | → | code_economy_analyzer.py | config_depends / config_depends |
...
| 576 | D_INFRA_RUNTIME 运行时集成: shared.security — auto-generated package init.... | → | idempotency.py —— Re-export wrapper -> canoni... | config_depends / config_depends |
| 577 | D_INFRA_RUNTIME 运行时集成: 包 shared.session 的初始化文件。 (__init__.py) | → | Session Boundary — 会话边界管理。 (session_bou... | config_depends / config_depends |

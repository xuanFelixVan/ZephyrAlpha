...
graph TD
    ...
    class D_PF_ALLOC,D_INFRA_RUNTIME,D_EX_CORE,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_SECURITY_LLM,D_GOV_AUDIT,D_AUTONOMY_CORE,D_ML_TRAIN,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_GOV_AUDIT,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_RULE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR external_prod
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FUNDAMENTAL_SIGNAL,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_SIMULATION,D_SECURITY,D_INTELLIGENCE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_SECURITY,D_INFRA_A2A,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SIMULATION,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_BACKTEST external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FUNDAMENTAL_SIGNAL,D_INTEGRATION,D_ORCHESTRATOR external_prod
...
| 560 | D_INFRA_RUNTIME 运行时集成: 包 shared.capacity_governance 的初始化文件。 (_... | → | adaptive_sampler.py | config_depends / config_depends |
| 561 | D_INFRA_RUNTIME 运行时集成: 包 shared.compensation 的初始化文件。 (__init__... | → | Saga Compensator — 补偿事务：多步操作任一失败 ... | config_depends / config_depends |
| 562 | D_INFRA_RUNTIME 运行时集成: 包 shared.draft 的初始化文件。 (__init__.py) | → | Draft Assistant — 想法 -> MTH-012 蓝图骨架生成... | config_depends / config_depends |
| 563 | D_INFRA_RUNTIME 运行时集成: __init__.py | → | CT-DLQ-001: DeadLetterQueue -> System Event Bus... | 导入依赖 / import_depends |
| 564 | D_INFRA_RUNTIME 运行时集成: __init__.py | → | cache.py —— 统一缓存抽象（Phase 8 新增 | 盲点... | 导入依赖 / import_depends |
| 565 | D_INFRA_RUNTIME 运行时集成: __init__.py | → | ProcessLifecycleGateway — 进程生命周期统一入口... | 导入依赖 / import_depends |
| 566 | D_INFRA_RUNTIME 运行时集成: 包 shared.knowledge 的初始化文件。 (__init__.py) | → | KE Linker — 知识条目关联图。 (ke_linker.py) | config_depends / config_depends |
...
| 574 | D_INFRA_RUNTIME 运行时集成: shared.schema — auto-generated package init. (... | → | base_config.py | config_depends / config_depends |
| 575 | D_INFRA_RUNTIME 运行时集成: shared.security — auto-generated package init.... | → | idempotency.py —— Re-export wrapper -> canoni... | config_depends / config_depends |

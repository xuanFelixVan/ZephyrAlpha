...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SECURITY_LLM,D_GOV_AUDIT,D_SECURITY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_KB,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_RULE,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_GOVERNANCE,D_DATA,D_SECURITY_LLM,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FUNDAMENTAL_SIGNAL,D_FBL_DETECTORS,D_SIMULATION,D_SECURITY,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_GOV_DRIFT,D_INTELLIGENCE,D_TRADING,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_INFRA_A2A,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_RULE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SIMULATION,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INFRA_A2A,D_INTEGRATION,D_FBL_DIAGNOSERS,D_DATA,D_ORCHESTRATOR,D_TRADING external_prod
...
| 558 | D_INFRA_RUNTIME 运行时集成: 包 shared.capacity_governance 的初始化文件。 (_... | → | budget_aware_prompt.py | config_depends / config_depends |
...
| 564 | D_INFRA_RUNTIME 运行时集成: 包 shared.knowledge 的初始化文件。 (__init__.py) | → | KE Structurer — 知识条目结构化提取。 (ke_struc... | config_depends / config_depends |
| 565 | D_INFRA_RUNTIME 运行时集成: 包 shared.maintenance 的初始化文件。 (__init__.py) | → | Dogfooding — 自举测试：用 TaskCard 管理 TaskCa... | config_depends / config_depends |
...
| 795 | D_SECURITY 对抗验证: Session 级并发协调模块（P2-SES 落地）。 (sessio... | → | process_pool.py - Shared process pool for MCP s... | 导入依赖 / import_depends |

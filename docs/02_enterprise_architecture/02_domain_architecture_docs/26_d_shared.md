...
graph TD
    ...
    class D_PF_ALLOC,D_GOVERNANCE,D_EX_CORE external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_TRADING,D_SECURITY external_prod
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOVERNANCE,D_AUTONOMY_CORE,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_ORCHESTRATOR,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FUNDAMENTAL_SIGNAL,D_GOV_CODE_QUALITY,D_SECURITY,D_SIMULATION,D_INFRA_RUNTIME,D_INTEGRATION,D_ORCHESTRATOR,D_INTELLIGENCE,D_GOV_DRIFT,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_GOV_RULE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FBL_DETECTORS,D_GOV_RULE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_ORCHESTRATOR,D_TRADING external_prod
...
| 558 | D_INFRA_RUNTIME 运行时集成: 包 shared.blueprint_tools 的初始化文件。 (__ini... | → | ai_understandability_constraint.py | config_depends / config_depends |
...
| 565 | D_INFRA_RUNTIME 运行时集成: shared.io — auto-generated package init. (__in... | → | file_utils.py —— 安全文件操作工具（Phase 3 新... | config_depends / config_depends |
| 566 | D_INFRA_RUNTIME 运行时集成: 包 shared.knowledge 的初始化文件。 (__init__.py) | → | KE Structurer — 知识条目结构化提取。 (ke_struc... | config_depends / config_depends |

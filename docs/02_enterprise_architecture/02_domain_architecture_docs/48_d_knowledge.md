...
graph TD
    ...
    D_GOVERNANCE -.->|contract / contract| docs_03_modules_domain_knowledge_knowledge_base_blueprint_md
...
|:--:|---------|:--:|---------|---------|
| 1 | D_GOVERNANCE 生命周期管理: G-CT-003 契约：Agent Spec -> RBAC 能力检查. (re... | → | blueprint.md | contract / contract |

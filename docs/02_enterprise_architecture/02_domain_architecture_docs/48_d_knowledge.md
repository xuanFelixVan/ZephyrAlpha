...
graph TD
    ...
    class D_GOV_RULE,D_INTELLIGENCE,D_GOV_KB,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOV_KB,D_FBL_DIAGNOSERS,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_RULE external_prod
```

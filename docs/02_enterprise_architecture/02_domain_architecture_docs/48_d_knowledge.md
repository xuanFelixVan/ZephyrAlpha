...
graph TD
    ...
    class D_GOV_KB,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_ORCHESTRATOR,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS external_prod
```

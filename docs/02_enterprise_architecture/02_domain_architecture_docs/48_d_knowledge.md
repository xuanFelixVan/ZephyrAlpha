...
graph TD
    ...
    class D_GOV_KB,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOV_KB,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
```

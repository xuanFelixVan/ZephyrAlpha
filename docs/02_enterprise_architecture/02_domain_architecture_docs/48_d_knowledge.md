...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_GOV_KB,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_RULE external_prod
```

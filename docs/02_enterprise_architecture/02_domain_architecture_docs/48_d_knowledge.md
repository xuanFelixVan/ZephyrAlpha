...
graph TD
    ...
    class D_GOV_KB,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOV_KB,D_GOV_RULE,D_GOV_AUDIT external_prod
```

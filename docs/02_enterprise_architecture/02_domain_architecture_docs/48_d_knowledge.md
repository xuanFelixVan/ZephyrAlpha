...
# 48_d_knowledge / 知识管理 / Knowledge Management
...
> 展示全部 4 个模块（生产态 0 + 设计态 2 + 原型态 2），标签标注成熟度。
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_knowledge_init_py,src_zephyr_knowledge_models_init_py design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | contract / contract |

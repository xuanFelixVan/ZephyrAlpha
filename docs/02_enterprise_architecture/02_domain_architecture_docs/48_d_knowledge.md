...
graph TD
    ...
    class D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_KB,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOV_RULE,D_FBL_DIAGNOSERS external_prod
```

...
graph TD
    ...
    class D_GOV_KB,D_FEEDBACK_LOOP,D_GOV_RULE,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
```

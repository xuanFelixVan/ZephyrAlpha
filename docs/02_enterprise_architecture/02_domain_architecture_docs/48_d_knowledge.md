...
graph TD
    ...
    class D_GOV_KB,D_FBL_DIAGNOSERS,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_KB,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_FEEDBACK_LOOP external_prod
```

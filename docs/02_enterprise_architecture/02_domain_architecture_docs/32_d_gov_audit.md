...
graph TD
    ...
    D_AUDITTEST -.->|contract| docs_03_modules_domain_governance_audit_trail_blueprint_md
    ...
    D_GOVERNANCE -.->|runtime| docs_03_modules_domain_governance_audit_trail_blueprint_md
    D_AUDITTEST -.->|runtime| docs_03_modules_domain_governance_audit_trail_blueprint_md
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_AUDITTEST external_design
```

...
# 18_d_mkt_data / 行情数据 / 行情数据 / Market Data
...
graph TD
    ...
    D_DATA -.->|data / data| docs_03_modules_domain_data_data_acquisition_plan_md
...
|:--:|---------|:--:|---------|---------|
| 1 | D_DATA: 批量聚合写入器（MOD-L00-004 §18.3 裁定 #ARCH-C... | → |  | data / data |
| 2 | D_DATA: 批量聚合写入器（MOD-L00-004 §18.3 裁定 #ARCH-C... | → |  | data / data |

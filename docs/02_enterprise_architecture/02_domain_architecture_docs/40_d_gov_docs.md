...
| 27 | blueprint.md | → | D_INTEGRATION 管线路由: BlueprintSearchServer — MCP Server for bluepri... | runtime / runtime |
| 28 | blueprint.md | → | D_INTEGRATION 管线路由: BlueprintSearchServer — MCP Server for bluepri... | contract / contract |
...
| 12 | D_ML_TRAIN 训练: D_ML_TRAIN — ML Training Base (trainer_base.py) | → | blueprint.md | data / data |

...
graph TD
    ...
    D_INFRA_RUNTIME -.->|data / data| docs_03_modules_cross_layer_database_blueprint_md
    D_INFRA_RUNTIME -.->|runtime / runtime| docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md
    D_INFRA_RUNTIME -.->|runtime / runtime| docs_03_modules_domain_autonomy_perm_escalation_protocol_blueprint_md
    D_GOV_AUDIT -.->|runtime / runtime| docs_03_modules_cross_layer_red_blue_validator_blueprint_md
    D_INFRA_RUNTIME -.->|contract / contract| docs_03_modules_cross_layer_shared_core_blueprint_md
    D_INFRA_RUNTIME -.->|runtime / runtime| docs_03_modules_cross_layer_feedback_loop_blueprint_md
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOV_DRIFT,D_INFRA_A2A,D_GOV_AUDIT,D_FBL_VERIFICATION,D_COMPLIANCE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRA_RUNTIME external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，34 条域内依赖）。
...
graph TD
    ...
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_GOV_OPS_RESILIENCE
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_FEEDBACK_LOOP
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_FEEDBACK_LOOP
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_FEEDBACK_LOOP
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_FEEDBACK_LOOP
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_FBL_VERIFICATION,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_A2A,D_GOV_DRIFT,D_INFRA_RUNTIME external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: test_fl_scheduler_act.py | runtime / runtime |
| 2 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: test_fl_scheduler_collect_detect.py | runtime / runtime |
| 3 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: test_fl_scheduler_health.py | runtime / runtime |
| 4 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: test_fl_scheduler_safety.py | runtime / runtime |
| 5 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: adversarial_robustness.py — 对抗鲁棒性 (B8, DD... | contract / contract |
| 6 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: adversarial_robustness.py — 对抗鲁棒性 (B8, DD... | runtime / runtime |
| 7 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: adversarial_robustness.py — 对抗鲁棒性 (B8, DD... | contract / contract |
| 8 | blueprint.md | → | D_COMPLIANCE 合规: default_security_gateway.py | runtime / runtime |
| 9 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 10 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
| 11 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _governance_gates.py | runtime / runtime |
| 12 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback_collector.py | runtime / runtime |
| 13 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 14 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |
| 15 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 16 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
| 17 | blueprint.md | → | D_GOVERNANCE 生命周期管理: audit_logger.py | runtime / runtime |
| 18 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | data / data |
| 19 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 20 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | runtime / runtime |
| 21 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
...
| 25 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 26 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
| 27 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 28 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 29 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 30 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
| 31 | blueprint.md | → | D_GOV_OPS_RESILIENCE 运维弹性治理: Human Factors — v0.7.0 人因工程: 通知疲劳管理+... | runtime / runtime |
| 32 | blueprint.md | → | D_INFRA_A2A A2A通信: test_a2a_check.py | contract / contract |
| 33 | blueprint.md | → | D_INFRA_A2A A2A通信: test_a2a_check.py | runtime / runtime |
| 34 | blueprint.md | → | D_INFRA_A2A A2A通信: test_a2a_check.py | runtime / runtime |
| 35 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 36 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | runtime / runtime |
| 37 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 38 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | runtime / runtime |
| 39 | blueprint.md | → | D_INTEGRATION 管线路由: Structural Protocol interfaces for cross-module... | runtime / runtime |
| 40 | blueprint.md | → | D_INTEGRATION 管线路由: MCP 全量工具调用审计日志（MOD-INF-013 §12 Step... | runtime / runtime |
| 41 | blueprint.md | → | D_INTEGRATION 管线路由: MCP 全量工具调用审计日志（MOD-INF-013 §12 Step... | contract / contract |
| 42 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 43 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
...
| 2 | D_GOVERNANCE 生命周期管理: backup_config.yaml | → | blueprint.md | runtime / runtime |
| 3 | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | → | blueprint.md | contract / contract |
| 4 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 5 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 6 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 7 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | contract / contract |
...
| 13 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | blueprint.md | runtime / runtime |
| 14 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | blueprint.md | data / data |
| 15 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | blueprint.md | runtime / runtime |
| 16 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | blueprint.md | contract / contract |
| 17 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | blueprint.md | runtime / runtime |
| 18 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | blueprint.md | runtime / runtime |
| 19 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | blueprint.md | runtime / runtime |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 16 个外部域直接连接（出边 43 条 + 入边 19 条 = 62 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOV_DOCS -->|7条 contract / contract, runtime / runtime| D_AUTONOMY_CORE
    ...
    D_GOV_DOCS -->|3条 contract / contract, runtime / runtime| D_INFRA_A2A
    ...
    D_GOV_DOCS -->|1条 data / data| D_ML_TRAIN

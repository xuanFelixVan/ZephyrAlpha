...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_GOV_CODE_QUALITY,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_DRIFT,D_FRONTEND external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_COMPLIANCE 合规: default_security_gateway.py | runtime / runtime |
| 2 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 3 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
| 4 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Market Event Integrator — v0.14.0 R197 (market... | runtime / runtime |
| 5 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 6 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |
| 7 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 8 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: scheduler_safety.py | runtime / runtime |
| 9 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
| 10 | blueprint.md | → | D_GOVERNANCE 生命周期管理: audit_logger.py | runtime / runtime |
| 11 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | data / data |
| 12 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
...
| 17 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
...
| 20 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: ch_final_gate.py — ch_writer.query() 直接调用.... | runtime / runtime |
| 21 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: ch_final_gate.py — ch_writer.query() 直接调用.... | runtime / runtime |
| 22 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: ch_final_gate.py — ch_writer.query() 直接调用.... | contract / contract |
| 23 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: ch_final_gate.py — ch_writer.query() 直接调用.... | runtime / runtime |
| 24 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: ch_final_gate.py — ch_writer.query() 直接调用.... | runtime / runtime |
| 25 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: ch_final_gate.py — ch_writer.query() 直接调用.... | runtime / runtime |
...
| 29 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
| 30 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 31 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 32 | blueprint.md | → | D_INTEGRATION 管线路由: Structural Protocol interfaces for cross-module... | runtime / runtime |
| 33 | blueprint.md | → | D_INTEGRATION 管线路由: MCP 错误码集中注册（MOD-INF-013 §3.4）。 (erro... | runtime / runtime |
| 34 | blueprint.md | → | D_INTEGRATION 管线路由: MCP 错误码集中注册（MOD-INF-013 §3.4）。 (erro... | contract / contract |
| 35 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 36 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 37 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 38 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | contract / contract |
...
| 41 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
| 42 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 43 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
...
| 5 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | contract / contract |
...
> 本域与 14 个外部域直接连接（出边 43 条 + 入边 9 条 = 52 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_COMPLIANCE,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_DRIFT,D_ML_TRAIN external_design
```
...
| 4 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: Preventive Repair — v0.6.0 R69 (preventive_rep... | runtime / runtime |
...
| 8 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.gates — auto-generated package i... | runtime / runtime |
...
| 23 | blueprint.md | → | D_GOV_OPS_RESILIENCE 运维弹性治理: offline_resilience.py | runtime / runtime |
...
| 27 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | runtime / runtime |
| 28 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | contract / contract |
...
| 33 | blueprint.md | → | D_SECURITY 对抗验证: L2a ProcessSandbox — subprocess 路径白名单沙箱... | contract / contract |
| 34 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 35 | blueprint.md | → | D_SECURITY 对抗验证: L2a ProcessSandbox — subprocess 路径白名单沙箱... | runtime / runtime |
| 36 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 37 | blueprint.md | → | D_SECURITY 对抗验证: L2a ProcessSandbox — subprocess 路径白名单沙箱... | contract / contract |
...
> 本域与 14 个外部域直接连接（出边 37 条 + 入边 11 条 = 48 条）。只显示直接连接的域，不展开具体节点。

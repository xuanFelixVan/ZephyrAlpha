...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | contract / contract |
| 2 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | runtime / runtime |
| 3 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | contract / contract |
| 4 | blueprint.md | → | D_COMPLIANCE 合规: default_security_gateway.py | runtime / runtime |
| 5 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 6 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
| 7 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _governance_gates.py | runtime / runtime |
| 8 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.collectors — auto-generated pack... | runtime / runtime |
| 9 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 10 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.forensic — auto-generated packag... | runtime / runtime |
| 11 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 12 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
| 13 | blueprint.md | → | D_GOVERNANCE 生命周期管理: error_codes.py | runtime / runtime |
| 14 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | data / data |
| 15 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 16 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | runtime / runtime |
| 17 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 18 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 19 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 20 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
| 21 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 22 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
...
| 26 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
...
| 29 | blueprint.md | → | D_INTEGRATION 管线路由: Structural Protocol interfaces for cross-module... | runtime / runtime |
| 30 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | runtime / runtime |
| 31 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | contract / contract |
| 32 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 33 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 34 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 35 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | contract / contract |
| 36 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 37 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
...
> 本域与 16 个外部域直接连接（出边 37 条 + 入边 13 条 = 50 条）。只显示直接连接的域，不展开具体节点。

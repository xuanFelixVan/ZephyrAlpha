...
| 5 | D_COMPLIANCE 合规: Audit Trail — MOD-INF-020 (__init__.py) | → | blueprint.md | contract / contract |
| 6 | D_GOVERNANCE 生命周期管理: backup_config.yaml | → | blueprint.md | runtime / runtime |
...
| 9 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | blueprint.md | runtime / runtime |
...
graph LR
    ...
    D_AUTONOMY_CORE -->|4条 contract / contract, runtime / runtime| D_GOV_DOCS

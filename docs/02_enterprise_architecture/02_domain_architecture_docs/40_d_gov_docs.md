...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: encoding_gate.py — 编码安全校验门禁（治本：弥.... | runtime / runtime |
| 2 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: encoding_gate.py — 编码安全校验门禁（治本：弥.... | contract / contract |
| 3 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: encoding_gate.py — 编码安全校验门禁（治本：弥.... | runtime / runtime |
| 4 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 5 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 6 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
...
> 本域与 4 个外部域直接连接（出边 6 条 + 入边 3 条 = 9 条）。只显示直接连接的域，不展开具体节点。

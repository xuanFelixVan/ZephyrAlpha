...
graph TD
    ...
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md -.->|runtime / runtime| D_AUTONOMY_CORE
    ...
    class D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_COMPLIANCE,D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_A2A,D_GOV_DRIFT,D_INTEGRATION,D_FEEDBACK_LOOP,D_FRONTEND external_design
```
...
| 7 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _safety_gates.py | runtime / runtime |
| 8 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _safety_gates.py | contract / contract |
| 9 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _safety_gates.py | runtime / runtime |
...
| 15 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Re-export shim — 真源已合并至 zephyr.trading.t... | runtime / runtime |
...
| 18 | blueprint.md | → | D_GOV_AUDIT 审计追踪: audit-trail.compliance_map — MOD-INF-020 · 合... | runtime / runtime |
...
| 23 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 24 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | runtime / runtime |
| 25 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | contract / contract |
...
| 7 | D_FRONTEND 前端:  | → | blueprint.md | runtime / runtime |
| 8 | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | → | blueprint.md | contract / contract |
| 9 | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | → | blueprint.md | contract / contract |
| 10 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | blueprint.md | runtime / runtime |
| 11 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | blueprint.md | contract / contract |
| 12 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | blueprint.md | contract / contract |
...
> 本域与 11 个外部域直接连接（出边 25 条 + 入边 14 条 = 39 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_AUTONOMY_CORE -->|6条 contract / contract, runtime / runtime| D_GOV_DOCS

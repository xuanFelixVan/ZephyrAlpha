...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — Skill Model Evolutio... | runtime / runtime |
| 2 | blueprint.md | → | D_COMPLIANCE 合规: default_security_gateway.py | runtime / runtime |
| 3 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 4 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
...
| 27 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | runtime / runtime |
| 28 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | contract / contract |
...
| 13 | D_ML_TRAIN 训练: D_ML_TRAIN — ML Training Base (trainer_base.py) | → | blueprint.md | data / data |

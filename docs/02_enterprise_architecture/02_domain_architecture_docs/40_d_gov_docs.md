...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_DRIFT,D_FRONTEND,D_ML_TRAIN external_design
```
...
| 4 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: Autonomy Maturity Ladder — v0.7.0 R86 (autonom... | runtime / runtime |
| 5 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback_collector.py | runtime / runtime |

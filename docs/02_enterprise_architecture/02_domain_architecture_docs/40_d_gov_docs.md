...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_DRIFT,D_INFRA_A2A,D_GOV_AUDIT,D_COMPLIANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME external_design
```
...
| 2 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — IDE Watcher (ide_wat... | contract / contract |
...
| 11 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Blueprint Reconciler — v0.10.0 蓝图实现一致性.... | runtime / runtime |
...
| 2 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — IDE Watcher (ide_wat... | → | blueprint.md | runtime / runtime |
| 3 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — IDE Watcher (ide_wat... | → | blueprint.md | runtime / runtime |
| 4 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — IDE Watcher (ide_wat... | → | blueprint.md | contract / contract |
...
| 9 | D_GOVERNANCE 生命周期管理: Blueprint Reconciler — v0.10.0 蓝图实现一致性.... | → | blueprint.md | contract / contract |

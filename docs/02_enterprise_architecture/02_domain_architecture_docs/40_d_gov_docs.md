...
graph TD
    ...
    docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md -.->|runtime / runtime| D_GOVERNANCE
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_INTEGRATION,D_FRONTEND,D_ML_TRAIN external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，32 条域内依赖）。
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.tests.e2e — auto-generated packa... | runtime / runtime |
| 2 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.tests.e2e — auto-generated packa... | runtime / runtime |
| 3 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.tests.e2e — auto-generated packa... | runtime / runtime |
| 4 | blueprint.md | → | D_GOVERNANCE 生命周期管理: G-CT-008 契约：A2A -> Audit 审计 Agent 间通信. ... | runtime / runtime |
| 5 | blueprint.md | → | D_GOVERNANCE 生命周期管理: base_repo — 异常类、状态机常量、工具函数（从 t... | data / data |
| 6 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 7 | blueprint.md | → | D_GOVERNANCE 生命周期管理: base_repo — 异常类、状态机常量、工具函数（从 t... | runtime / runtime |
| 8 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
...
| 12 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 13 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
| 14 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
...
| 17 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
...
| 20 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | runtime / runtime |
| 21 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | contract / contract |
| 22 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 23 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 24 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 25 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | contract / contract |
| 26 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 27 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 28 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
| 29 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 30 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
...
| 2 | D_GOVERNANCE 生命周期管理: base_repo — 异常类、状态机常量、工具函数（从 t... | → | blueprint.md | contract / contract |
...
| 12 | D_ML_TRAIN 训练: D_ML_TRAIN — ML Inference Base (inference_base.py) | → | blueprint.md | data / data |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 10 个外部域直接连接（出边 30 条 + 入边 12 条 = 42 条）。只显示直接连接的域，不展开具体节点。

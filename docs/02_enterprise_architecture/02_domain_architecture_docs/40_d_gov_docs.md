...
graph TD
    ...
    D_INFRASTRUCTURE -.->|runtime / runtime| docs_03_modules_cross_layer_shared_core_blueprint_md
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_FBL_VERIFICATION,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_DRIFT,D_FRONTEND,D_INFRASTRUCTURE,D_ML_TRAIN external_design
```
...
| 2 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 3 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
| 4 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _governance_gates.py | runtime / runtime |
| 5 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Secondary Alert Channel — v0.37.0 R461 (second... | runtime / runtime |
| 6 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.collectors — auto-generated pack... | runtime / runtime |
| 7 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 8 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.forensic — auto-generated packag... | runtime / runtime |
| 9 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 10 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
| 11 | blueprint.md | → | D_GOVERNANCE 生命周期管理: A2A 治理适配器 — 连接 A2A 协议与 Governance 层... | runtime / runtime |
| 12 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | data / data |
| 13 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 14 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | runtime / runtime |
| 15 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 16 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 17 | blueprint.md | → | D_GOV_AUDIT 审计追踪: audit-trail.feedback_self_audit — MOD-INF-020 ... | runtime / runtime |
| 18 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 19 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
| 20 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 21 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
...
| 26 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 27 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 28 | blueprint.md | → | D_INTEGRATION 管线路由: Structural Protocol interfaces for cross-module... | runtime / runtime |
| 29 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | runtime / runtime |
| 30 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | contract / contract |
| 31 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 32 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 33 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 34 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | contract / contract |
| 35 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 36 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 37 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
| 38 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 39 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
...
| 12 | D_INFRASTRUCTURE: TCP relay: expose localhost-only MinIO to the C... | → | blueprint.md | runtime / runtime |
| 13 | D_ML_TRAIN 训练: D_ML_TRAIN — ML Inference Base (inference_base.py) | → | blueprint.md | data / data |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 15 个外部域直接连接（出边 39 条 + 入边 13 条 = 52 条）。只显示直接连接的域，不展开具体节点。

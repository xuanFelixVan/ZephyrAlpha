...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SECURITY_LLM,D_GOV_DRIFT,D_INFRA_A2A,D_GOV_AUDIT,D_COMPLIANCE,D_FBL_VERIFICATION,D_ML_TRAIN,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```

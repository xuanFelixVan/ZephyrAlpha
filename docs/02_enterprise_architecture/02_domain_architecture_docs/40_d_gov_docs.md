...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_SECURITY external_prod
    class D_GOVERNANCE,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_INTEGRATION,D_GOV_AUDIT,D_GOV_DRIFT,D_FRONTEND,D_ML_TRAIN external_design
```
...
| 4 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
| 5 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Financial Stratification — v0.5.0 R50 (financi... | runtime / runtime |
| 6 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 7 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.forensic — auto-generated packag... | runtime / runtime |
...
| 10 | blueprint.md | → | D_GOVERNANCE 生命周期管理: error_codes.py | runtime / runtime |
...
| 16 | blueprint.md | → | D_GOV_AUDIT 审计追踪: AST 解析文件，提取 9 个维度的引用信息。 (refere... | runtime / runtime |
...
| 24 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
...
| 27 | blueprint.md | → | D_INTEGRATION 管线路由: Structural Protocol interfaces for cross-module... | runtime / runtime |
| 28 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | runtime / runtime |
| 29 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | contract / contract |
| 30 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 31 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 32 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 33 | blueprint.md | → | D_SECURITY 对抗验证: CrossCutting — 横切面权限组件. (cross_cutting.py) | contract / contract |
| 34 | blueprint.md | → | D_SECURITY 对抗验证: l6_data_flow.py | contract / contract |
| 35 | blueprint.md | → | D_SECURITY 对抗验证: CrossCutting — 横切面权限组件. (cross_cutting.py) | runtime / runtime |
| 36 | blueprint.md | → | D_SECURITY 对抗验证: l6_data_flow.py | runtime / runtime |
| 37 | blueprint.md | → | D_SECURITY 对抗验证: CrossCutting — 横切面权限组件. (cross_cutting.py) | runtime / runtime |
| 38 | blueprint.md | → | D_SECURITY 对抗验证: l6_data_flow.py | contract / contract |
...
> 本域与 14 个外部域直接连接（出边 38 条 + 入边 12 条 = 50 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SECURITY_LLM,D_GOV_DRIFT,D_GOV_AUDIT,D_COMPLIANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```
...
| 2 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | runtime / runtime |
...
| 6 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _operational_gates.py | runtime / runtime |
| 7 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _operational_gates.py | contract / contract |
| 8 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _operational_gates.py | runtime / runtime |
| 9 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | runtime / runtime |
| 10 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | runtime / runtime |
| 11 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | data / data |
| 12 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | runtime / runtime |
| 13 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | runtime / runtime |
...
| 22 | blueprint.md | → | D_SECURITY 对抗验证: OutputGuard — 输出内容守卫. (output_guard.py) | contract / contract |
| 23 | blueprint.md | → | D_SECURITY 对抗验证: OutputGuard — 输出内容守卫. (output_guard.py) | runtime / runtime |
| 24 | blueprint.md | → | D_SECURITY_LLM LLM防御: LLM Security Gateway Dashboard Module. (__init_... | contract / contract |
...
| 6 | D_COMPLIANCE 合规: Audit Trail — MOD-INF-020 (__init__.py) | → | blueprint.md | contract / contract |
| 7 | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | → | blueprint.md | contract / contract |
| 8 | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | → | blueprint.md | contract / contract |
| 9 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | blueprint.md | data / data |
| 10 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | blueprint.md | contract / contract |
| 11 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | blueprint.md | contract / contract |
...
> 本域与 11 个外部域直接连接（出边 24 条 + 入边 14 条 = 38 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOV_DOCS -->|2条 contract / contract, runtime / runtime| D_AUTONOMY_CORE
    ...
    D_AUTONOMY_CORE -->|5条 contract / contract, runtime / runtime| D_GOV_DOCS

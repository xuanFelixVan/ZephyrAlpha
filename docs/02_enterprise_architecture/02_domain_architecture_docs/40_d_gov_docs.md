...
graph TD
    ...
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_GOV_SCRIPTS
    ...
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_FEEDBACK_LOOP
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_FEEDBACK_LOOP
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime / runtime| D_GOVERNANCE
    ...
    docs_03_modules_domain_autonomy_core_rollback_system_blueprint_md -.->|runtime / runtime| D_GOV_ENFORCEMENT
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md -.->|runtime / runtime| D_GOV_ENFORCEMENT
    ...
    D_ML_TRAIN -.->|data / data| docs_03_modules_cross_layer_model_capability_exam_blueprint_md
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_SCRIPTS,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_ML_TRAIN external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，30 条域内依赖）。
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
| 2 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.collectors — auto-generated pack... | runtime / runtime |
| 3 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |
| 4 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 5 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
| 6 | blueprint.md | → | D_GOVERNANCE 生命周期管理: default_security_gateway.py | runtime / runtime |
| 7 | blueprint.md | → | D_GOVERNANCE 生命周期管理: G-CT-008 契约：A2A -> Audit 审计 Agent 间通信. ... | runtime / runtime |
| 8 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | data / data |
| 9 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 10 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | runtime / runtime |
| 11 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 12 | blueprint.md | → | D_GOV_AUDIT 审计追踪: tiered_storage_bridge.py | contract / contract |
| 13 | blueprint.md | → | D_GOV_AUDIT 审计追踪: tiered_storage_bridge.py | contract / contract |
| 14 | blueprint.md | → | D_GOV_AUDIT 审计追踪: tiered_storage_bridge.py | runtime / runtime |
| 15 | blueprint.md | → | D_GOV_AUDIT 审计追踪: tiered_storage_bridge.py | contract / contract |
| 16 | blueprint.md | → | D_GOV_AUDIT 审计追踪: tiered_storage_bridge.py | runtime / runtime |
| 17 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: blueprint_format_gate.py — [BLUEPRINT] 头部 mo... | runtime / runtime |
...
| 22 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | runtime / runtime |
| 23 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | contract / contract |
| 24 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | runtime / runtime |
| 25 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | runtime / runtime |
| 26 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | runtime / runtime |
| 27 | blueprint.md | → | D_GOV_SCRIPTS 脚本治理: detect_depends_on_cycles.py - depends_on 环检测... | runtime / runtime |
| 28 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 29 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 30 | blueprint.md | → | D_INTEGRATION 管线路由: Structural Protocol interfaces for cross-module... | runtime / runtime |
| 31 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | runtime / runtime |
| 32 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | contract / contract |
| 33 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 34 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 35 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 36 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | contract / contract |
| 37 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 38 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 39 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
| 40 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 41 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |

### 依赖本域的其他域（入边）/ Depended By

| # | 外部域-源模块 / Source Module | → | 本域模块 / Target Module | 依赖类型 / Type |
|:--:|---------|:--:|---------|---------|
| 1 | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | → | blueprint.md | contract / contract |
| 2 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 3 | D_GOV_AUDIT 审计追踪: tiered_storage_bridge.py | → | blueprint.md | runtime / runtime |
| 4 | D_GOV_AUDIT 审计追踪: tiered_storage_bridge.py | → | blueprint.md | contract / contract |
| 5 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
...
| 9 | D_ML_TRAIN 训练: D_ML_TRAIN — ML Inference Base (inference_base.py) | → | blueprint.md | data / data |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 13 个外部域直接连接（出边 41 条 + 入边 9 条 = 50 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOV_DOCS -->|1条 runtime / runtime| D_GOV_SCRIPTS
    ...
    D_ML_TRAIN -->|1条 data / data| D_GOV_DOCS
```

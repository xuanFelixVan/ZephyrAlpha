...
graph TD
    ...
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md -.->|runtime / runtime| D_FBL_DIAGNOSERS
    ...
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md -.->|runtime / runtime| D_FBL_DIAGNOSERS
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_INTEGRATION external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，23 条域内依赖）。
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | contract / contract |
| 2 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
| 3 | blueprint.md | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
| 4 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | data / data |
| 5 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 6 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | runtime / runtime |
| 7 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 8 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 9 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 10 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 11 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
| 12 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 13 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 14 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
| 15 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 16 | blueprint.md | → | D_INTEGRATION 管线路由: MCP sandbox 安全代码执行沙箱（MOD-INF-013 Phase... | runtime / runtime |
| 17 | blueprint.md | → | D_INTEGRATION 管线路由: MCP sandbox 安全代码执行沙箱（MOD-INF-013 Phase... | contract / contract |
| 18 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 19 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 20 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | contract / contract |
| 21 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 22 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 23 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
...
| 2 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | data / data |
| 3 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | runtime / runtime |
| 4 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | runtime / runtime |
| 5 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | runtime / runtime |
| 6 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | runtime / runtime |
| 7 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | runtime / runtime |
| 8 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | blueprint.md | contract / contract |
| 9 | D_FRONTEND 前端:  | → | blueprint.md | runtime / runtime |
...
| 13 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 14 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | contract / contract |
...
| 19 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
| 20 | D_INFRASTRUCTURE: TCP relay: expose localhost-only MinIO to the C... | → | blueprint.md | runtime / runtime |
| 21 | D_ML_TRAIN 训练: D_ML_TRAIN — ML Inference Base (inference_base.py) | → | blueprint.md | data / data |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 11 个外部域直接连接（出边 23 条 + 入边 21 条 = 44 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_AUTONOMY_CORE -->|8条 contract / contract, data / data, runtime / runtime| D_GOV_DOCS

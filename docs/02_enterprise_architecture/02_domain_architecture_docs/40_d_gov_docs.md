...
graph TD
    ...
    class D_GOVERNANCE,D_COMPLIANCE,D_INFRA_A2A,D_GOV_AUDIT,D_GOV_DRIFT,D_INTEGRATION external_design
```
...
| 7 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
| 8 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: Autonomy Credit System — v0.7.0 R87 (autonomy_... | contract / contract |
| 9 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
...
| 12 | blueprint.md | → | D_GOVERNANCE 生命周期管理: G-CT-006 — BudgetAlert re-exported from shared... | data / data |
| 13 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | runtime / runtime |
| 14 | blueprint.md | → | D_GOVERNANCE 生命周期管理: G-CT-006 — BudgetAlert re-exported from shared... | runtime / runtime |
...
| 11 | D_GOVERNANCE 生命周期管理: G-CT-006 — BudgetAlert re-exported from shared... | → | blueprint.md | runtime / runtime |
| 12 | D_GOVERNANCE 生命周期管理: G-CT-006 — BudgetAlert re-exported from shared... | → | blueprint.md | data / data |

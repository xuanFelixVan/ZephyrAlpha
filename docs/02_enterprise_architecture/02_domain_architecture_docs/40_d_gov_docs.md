...
# 40_d_gov_docs / 架构文档治理 / Architecture Docs Governance
...
graph TD
    ...
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md -.->|contract / contract| D_SHARED
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md -.->|runtime / runtime| D_SHARED
    ...
    docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md -.->|data / data| D_SHARED
    ...
    D_SECURITY -.->|runtime / runtime| docs_03_modules_cross_layer_semantic_auditor_blueprint_md
    D_SECURITY -.->|runtime / runtime| docs_03_modules_domain_governance_code_dedup_engine_blueprint_md
    D_SECURITY -.->|runtime / runtime| docs_03_modules_cross_layer_auto_fix_engine_blueprint_md
    D_SECURITY -.->|data / data| docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md
    ...
    class D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_INTEGRATION,D_GOV_AUDIT,D_SHARED,D_GOV_DRIFT,D_FRONTEND,D_ML_TRAIN external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，9 条域内依赖）。
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_FBL_DIAGNOSERS 反馈诊断器: __init__.py | runtime / runtime |
| 2 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.collectors — auto-generated pack... | runtime / runtime |
| 3 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.forensic — auto-generated packag... | runtime / runtime |
| 4 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
| 5 | blueprint.md | → | D_GOVERNANCE 生命周期管理: check_scaffold_exit_gates.py — scaffold→exper... | runtime / runtime |
| 6 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | data / data |
| 7 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 8 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | contract / contract |
| 9 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
| 10 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 11 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
| 12 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 13 | blueprint.md | → | D_INTEGRATION 管线路由: Structural Protocol interfaces for cross-module... | runtime / runtime |
| 14 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 15 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 16 | blueprint.md | → | D_SECURITY 对抗验证: AdversarialResilience - adversarial resilience ... | runtime / runtime |
| 17 | blueprint.md | → | D_SECURITY 对抗验证: AdversarialResilience - adversarial resilience ... | runtime / runtime |
| 18 | blueprint.md | → | D_SHARED 共享服务: api_client.py —— 统一 API Client 基类（Phase ... | runtime / runtime |
| 19 | blueprint.md | → | D_SHARED 共享服务: api_client.py —— 统一 API Client 基类（Phase ... | data / data |
| 20 | blueprint.md | → | D_SHARED 共享服务: api_client.py —— 统一 API Client 基类（Phase ... | contract / contract |
...
| 4 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
| 5 | D_ML_TRAIN 训练: D_ML_TRAIN — ML Inference Base (inference_base.py) | → | blueprint.md | data / data |
| 6 | D_SECURITY 对抗验证: ai_attack_generator.py | → | blueprint.md | runtime / runtime |
| 7 | D_SECURITY 对抗验证: ai_attack_generator.py | → | blueprint.md | runtime / runtime |
| 8 | D_SECURITY 对抗验证: ai_attack_generator.py | → | blueprint.md | data / data |
| 9 | D_SECURITY 对抗验证: ai_attack_generator.py | → | blueprint.md | runtime / runtime |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 11 个外部域直接连接（出边 20 条 + 入边 9 条 = 29 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOV_DOCS -->|3条 contract / contract, data / data, runtime / runtime| D_SHARED
    ...
    D_GOV_DOCS -->|2条 runtime / runtime| D_SECURITY
    ...
    D_GOV_DOCS -->|1条 runtime / runtime| D_INTEGRATION
    D_SECURITY -->|4条 data / data, runtime / runtime| D_GOV_DOCS

...
graph TD
    ...
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md -.->|runtime / runtime| D_FBL_DETECTORS
    ...
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md -.->|runtime / runtime| D_FBL_DETECTORS
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_FBL_DETECTORS,D_GOV_DRIFT,D_FRONTEND,D_ML_TRAIN external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，31 条域内依赖）。
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 2 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 3 | blueprint.md | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
| 4 | blueprint.md | → | D_GOVERNANCE 生命周期管理: _base_server.py | runtime / runtime |
...
| 10 | blueprint.md | → | D_GOV_AUDIT 审计追踪: 三元对齐检测：蓝图声明清单 vs 磁盘实际文件 vs i... | runtime / runtime |
...
| 21 | blueprint.md | → | D_INTEGRATION 管线路由: GateEngineServer: 门禁裁决服务 MCP Server (gate... | runtime / runtime |
| 22 | blueprint.md | → | D_INTEGRATION 管线路由: GateEngineServer: 门禁裁决服务 MCP Server (gate... | contract / contract |
| 23 | blueprint.md | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 24 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |
| 25 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 26 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | contract / contract |
| 27 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 28 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 29 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
| 30 | blueprint.md | → | D_SECURITY 对抗验证: phase_executor.py | runtime / runtime |
| 31 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
...
> 本域与 10 个外部域直接连接（出边 31 条 + 入边 12 条 = 43 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOV_DOCS -->|3条 runtime / runtime| D_FBL_DETECTORS

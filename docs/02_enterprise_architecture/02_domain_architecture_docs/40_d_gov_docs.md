...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_A2A,D_GOV_AUDIT,D_COMPLIANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_COMPLIANCE,D_INFRA_A2A,D_FBL_VERIFICATION,D_GOV_AUDIT,D_GOV_DRIFT external_design
```
...
| 23 | blueprint.md | → | D_INTEGRATION 管线路由: BlueprintSearchServer — MCP Server for bluepri... | runtime / runtime |
| 24 | blueprint.md | → | D_INTEGRATION 管线路由: BlueprintSearchServer — MCP Server for bluepri... | contract / contract |

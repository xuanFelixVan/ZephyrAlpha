...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_DRIFT,D_INFRA_A2A,D_GOV_AUDIT,D_COMPLIANCE,D_FBL_VERIFICATION,D_ML_TRAIN,D_INFRA_RUNTIME external_design
```
...
| 25 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | runtime / runtime |

...
graph TD
    ...
    docs_03_modules_domain_governance_governance_automation_blueprint_md -.->|runtime / runtime| D_GOVERNANCE
    docs_03_modules_domain_autonomy_core_rollback_system_blueprint_md -.->|contract / contract| D_GOVERNANCE
    ...
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md -.->|contract / contract| D_GOVERNANCE
    ...
    D_GOVERNANCE -.->|runtime / runtime| docs_03_modules_cross_layer_context_engine_blueprint_md
    D_GOVERNANCE -.->|contract / contract| docs_03_modules_domain_governance_governance_automation_blueprint_md
    D_GOVERNANCE -.->|runtime / runtime| docs_03_modules_domain_autonomy_core_rollback_system_blueprint_md
    ...
    class D_GOVERNANCE,D_INFRA_A2A,D_FBL_VERIFICATION,D_GOV_AUDIT,D_GOV_DRIFT,D_SECURITY_LLM,D_INTEGRATION,D_AUTONOMY_CORE external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，2 条域内依赖）。
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | runtime / runtime |
| 2 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _governance_gates.py | runtime / runtime |
| 3 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _governance_gates.py | contract / contract |
| 4 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _governance_gates.py | runtime / runtime |
| 5 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | runtime / runtime |
| 6 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | runtime / runtime |
| 7 | blueprint.md | → | D_GOVERNANCE 生命周期管理: evidence_pack.py | contract / contract |
| 8 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | data / data |
| 9 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | runtime / runtime |
| 10 | blueprint.md | → | D_GOVERNANCE 生命周期管理: G-CT-003 契约：Agent Spec -> RBAC 能力检查. (re... | contract / contract |
| 11 | blueprint.md | → | D_GOVERNANCE 生命周期管理: evidence_pack.py | contract / contract |
| 12 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | runtime / runtime |
| 13 | blueprint.md | → | D_GOVERNANCE 生命周期管理: evidence_pack.py | contract / contract |
...
| 16 | blueprint.md | → | D_GOV_AUDIT 审计追踪: audit-trail.feedback_self_audit — MOD-INF-020 ... | runtime / runtime |
...
| 20 | blueprint.md | → | D_GOV_KB 知识库治理: 批量入库 — scaffold P0/P1 知识候选批量入库（T-... | runtime / runtime |
| 21 | blueprint.md | → | D_INFRA_A2A A2A通信: test_a2a_check.py | contract / contract |
...
| 3 | D_GOVERNANCE 生命周期管理: G-CT-003 契约：Agent Spec -> RBAC 能力检查. (re... | → | blueprint.md | runtime / runtime |
| 4 | D_GOVERNANCE 生命周期管理: G-CT-003 契约：Agent Spec -> RBAC 能力检查. (re... | → | blueprint.md | runtime / runtime |
| 5 | D_GOVERNANCE 生命周期管理: G-CT-003 契约：Agent Spec -> RBAC 能力检查. (re... | → | blueprint.md | contract / contract |
| 6 | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | → | blueprint.md | contract / contract |
| 7 | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | → | blueprint.md | contract / contract |
| 8 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | blueprint.md | runtime / runtime |
| 9 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | blueprint.md | contract / contract |
| 10 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | blueprint.md | contract / contract |
...
> 本域与 11 个外部域直接连接（出边 25 条 + 入边 12 条 = 37 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOV_DOCS -->|1条 runtime / runtime| D_AUTONOMY_CORE

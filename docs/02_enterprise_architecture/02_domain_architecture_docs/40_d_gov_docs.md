...
graph TD
    ...
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md -.->|runtime / runtime| D_GOV_OPS_RESILIENCE
    ...
    class D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
    class D_GOVERNANCE,D_COMPLIANCE,D_INFRA_A2A,D_FBL_VERIFICATION,D_GOV_DRIFT,D_INTEGRATION,D_GOV_AUDIT external_design
```
...
| 19 | blueprint.md | → | D_GOV_OPS_RESILIENCE 运维弹性治理: blast_radius — MOD-INF-028 §3.1 Stage 9 (blas... | runtime / runtime |

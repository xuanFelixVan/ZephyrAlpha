...
title: D_GOV_RULE rule_governance架构文档
version: "1.0"
status: active
date: 2026-07-08
...
# 37_d_gov_rule / rule_governance / Rule Governance
...
```mermaid
graph TD
    subgraph D_GOV_RULE["D_GOV_RULE rule_governance"]
    end
...
> 按 architecture_layer 分层显示 rule_governance（D_GOV_RULE）的模块分布。共 0 个模块 / 0 modules。

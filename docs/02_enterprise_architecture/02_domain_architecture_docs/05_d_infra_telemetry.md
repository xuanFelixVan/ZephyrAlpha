...
graph TD
    ...
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|data / data| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|runtime / runtime| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|runtime / runtime| D_GOVERNANCE
    D_AUDITTEST["(原型态 / prototype) D_AUDITTEST"]
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|contract / contract| D_AUDITTEST
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|contract / contract| D_GOVERNANCE
    D_SECURITY_LLM["(原型态 / prototype) D_SECURITY_LLM"]
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|runtime / runtime| D_SECURITY_LLM
    D_INFRA_RUNTIME["(原型态 / prototype) D_INFRA_RUNTIME"]
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|runtime / runtime| D_INFRA_RUNTIME
    ...
    D_GOVERNANCE -.->|runtime / runtime| src_zephyr_infrastructure_system_telemetry_metrics_init_py
    D_GOVERNANCE -.->|runtime / runtime| src_zephyr_infrastructure_system_telemetry_metrics_init_py
...
graph TD
    ...
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|runtime / runtime| D_GOV_ENFORCEMENT
    D_GOV_DRIFT["(设计态 / design) D_GOV_DRIFT"]
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -.->|runtime / runtime| D_GOV_DRIFT
    D_AUTONOMY_CORE["(生产态 / production) D_AUTONOMY_CORE"]
    src_zephyr_infrastructure_system_telemetry_metrics_init_py -->|runtime / runtime| D_AUTONOMY_CORE
    D_INFRA_RUNTIME -.->|导入依赖 / import_depends| src_zephyr_infrastructure_system_telemetry_auto_bootstrap_py
    D_TRADING["(生产态 / production) D_TRADING"]
    D_TRADING -->|导入依赖 / import_depends| src_zephyr_infrastructure_system_telemetry_health_aggregator_py
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_infrastructure_system_telemetry_otel_instrumentation_py
    ...
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_infrastructure_system_telemetry_init_py,src_zephyr_infrastructure_system_telemetry_ai_behavior_init_py,src_zephyr_infrastructure_system_telemetry_alerts_init_py,src_zephyr_infrastructure_system_telemetry_archive_init_py,src_zephyr_infrastructure_system_telemetry_auto_bootstrap_py,src_zephyr_infrastructure_system_telemetry_contract_metrics_py,src_zephyr_infrastructure_system_telemetry_health_init_py,src_zephyr_infrastructure_system_telemetry_health_aggregator_py,src_zephyr_infrastructure_system_telemetry_health_probes_py,src_zephyr_infrastructure_system_telemetry_logs_init_py,src_zephyr_infrastructure_system_telemetry_metrics_init_py,src_zephyr_infrastructure_system_telemetry_otel_instrumentation_py,src_zephyr_infrastructure_system_telemetry_traces_init_py production
    class D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_TRADING external_prod
    class D_AUDITTEST,D_SECURITY_LLM,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_infrastructure_system_telemetry_budget_telemetry_bridge_py,src_zephyr_infrastructure_system_telemetry_trace_bridge_py,src_zephyr_infrastructure_system_telemetry_ai_behavior_event_sink_py,src_zephyr_infrastructure_system_telemetry_archive_cold_stub_py,src_zephyr_infrastructure_system_telemetry_facade_py,src_zephyr_infrastructure_system_telemetry_logs_structured_sink_py,src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py,src_zephyr_infrastructure_system_telemetry_metrics_bridge_py,src_zephyr_infrastructure_system_telemetry_profiles_init_py,src_zephyr_infrastructure_system_telemetry_schema_init_py,src_zephyr_infrastructure_system_telemetry_traces_span_stub_py,src_zephyr_infrastructure_system_telemetry_watchdog_py design
    class D_SHARED,D_TRADING,D_INTEGRATION_GATEWAY,D_INFRA_RUNTIME external_prod
...
|:--:|---------|:--:|---------|---------|
| 1 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_AUDITTEST 审计测试套件: test_a2a_check.py | contract / contract |
| 2 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_AUTONOMY_CORE 自治核心: context_value_attribution.py — KE 级 ROI 归因 ... | runtime / runtime |
...
| 4 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOVERNANCE 生命周期管理: blueprint.md | data / data |
| 5 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 6 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOVERNANCE 生命周期管理: blueprint.md | contract / contract |
| 7 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 8 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 9 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | runtime / runtime |
| 10 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 11 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | runtime / runtime |
| 12 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_INFRA_RUNTIME 运行时集成: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 13 | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | D_SECURITY_LLM LLM防御: LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
...
| 3 | D_GOVERNANCE 生命周期管理: blueprint.md | → | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | runtime / runtime |
| 4 | D_GOVERNANCE 生命周期管理: blueprint.md | → | 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | runtime / runtime |

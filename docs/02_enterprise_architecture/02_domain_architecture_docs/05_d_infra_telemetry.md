...
graph TD
    ...
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|data| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_GOVERNANCE
    D_AUDITTEST["D_AUDITTEST prototype"]
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|contract| D_AUDITTEST
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|contract| D_GOVERNANCE
    D_SECURITY_LLM["D_SECURITY_LLM prototype"]
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_SECURITY_LLM
    D_INFRA_RUNTIME["D_INFRA_RUNTIME prototype"]
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_INFRA_RUNTIME
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_GOVERNANCE
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT prototype"]
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_GOV_ENFORCEMENT
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_GOV_DRIFT
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_watchdog_py -.->|runtime| D_GOVERNANCE
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_system_telemetry_watchdog_py
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_system_telemetry_watchdog_py
    ...
    class D_GOVERNANCE,D_AUDITTEST,D_SECURITY_LLM,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_TRADING,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|data| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|runtime| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|runtime| D_GOVERNANCE
    D_SECURITY["D_SECURITY production"]
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -->|contract| D_SECURITY
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|contract| D_GOVERNANCE
    D_SECURITY_LLM["D_SECURITY_LLM prototype"]
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|runtime| D_SECURITY_LLM
    D_INFRA_RUNTIME["D_INFRA_RUNTIME prototype"]
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|runtime| D_INFRA_RUNTIME
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|runtime| D_GOVERNANCE
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT prototype"]
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|runtime| D_GOV_ENFORCEMENT
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    src_zephyr_infrastructure_system_telemetry_alerts_init_py -.->|runtime| D_GOV_DRIFT
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_system_telemetry_alerts_init_py
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_system_telemetry_alerts_init_py
    ...
    class D_SECURITY_LLM,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_INTEGRATION_GATEWAY,D_TRADING,D_GOV_SCRIPTS,D_AUDITTEST external_design
```

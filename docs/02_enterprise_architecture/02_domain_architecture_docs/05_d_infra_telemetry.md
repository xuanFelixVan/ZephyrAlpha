...
graph TD
    ...
    src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py -.->|data| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py -.->|runtime| D_GOVERNANCE
    src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py -.->|runtime| D_GOVERNANCE
    D_AUDITTEST["D_AUDITTEST prototype"]
    src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py -.->|contract| D_AUDITTEST
    src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py -.->|contract| D_GOVERNANCE
    D_SECURITY_LLM["D_SECURITY_LLM prototype"]
    src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py -.->|runtime| D_SECURITY_LLM
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py
    ...
    class D_SHARED,D_AUDITTEST,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```

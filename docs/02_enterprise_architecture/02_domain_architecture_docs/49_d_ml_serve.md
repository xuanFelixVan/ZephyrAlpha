...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/ml_serve/__init__.py | __init__.py | 设计态 / design |  |
| 2 | src/zephyr/ml_serve/_extensions/__init__.py | __init__.py | 设计态 / design |  |
| 3 | src/zephyr/ml_serve/api/__init__.py | __init__.py | 设计态 / design |  |
| 4 | src/zephyr/ml_serve/core/__init__.py | __init__.py | 设计态 / design |  |
| 5 | src/zephyr/ml_serve/infrastructure/__init__.py | __init__.py | 设计态 / design |  |
| 6 | src/zephyr/ml_serve/models/__init__.py | __init__.py | 设计态 / design |  |
| 7 | src/zephyr/ml_serve/services/__init__.py | __init__.py | 设计态 / design |  |
...
graph TD
    subgraph D_ML_SERVE["D_ML_SERVE 推理"]
        src_zephyr_ml_serve_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ml_serve_extensions_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ml_serve_api_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ml_serve_core_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ml_serve_infrastructure_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ml_serve_models_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ml_serve_services_init_py["(设计态 / design) __init__.py"]
    end

...
flowchart TD
    ...
    scripts_ops_shadow_canary_deploy_py -.->|导入依赖 / import_depends| D_DATA
    ...
    class D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY,D_DATA,D_GOV_AUDIT,D_SHARED,D_OPS,D_GOV_CODE_QUALITY external_prod
```

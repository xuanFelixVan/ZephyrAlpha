...
flowchart TD
    docs_01_policies_and_standards_registry_catalogs_rule_enforcement_registry_yaml["(生产态 / production) catalogs/rule_enforcement_registry.yaml<br/>文件: catalogs/rule_enforcement_registry.yaml"]
    ...
    scripts_governance_d8_doc_sync_requirements_version_sync_reconciler_py["(生产态 / production) requirements_version_sync_reconciler.py — requirements.txt ↔ pyproject.toml...<br/>文件: d8_doc_sync/requirements_version_sync_reconciler.py"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_init_py["(生产态 / production) behavioral_admission/__init__.py<br/>文件: behavioral_admission/__init__.py"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_output_quality_gate_py["(生产态 / production) rule_enforcement/output_quality_gate.py<br/>文件: rule_enforcement/output_quality_gate.py"]
    src_zephyr_gov_enforcement_rule_enforcement_pre_flight_gate_py["(生产态 / production) rule_enforcement/pre_flight_gate.py<br/>文件: rule_enforcement/pre_flight_gate.py"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_admission_response_py["(生产态 / production) behavioral_admission/admission_response.py<br/>文件: behavioral_admission/admission_response.py"]
    src_zephyr_gov_enforcement_behavioral_admission_code_review_ai_py["(生产态 / production) behavioral_admission/code_review_ai.py<br/>文件: behavioral_admission/code_review_ai.py"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_gpu_consensus_scheduler_py["(生产态 / production) behavioral_admission/gpu_consensus_scheduler.py<br/>文件: behavioral_admission/gpu_consensus_scheduler.py"]
    src_zephyr_gov_enforcement_behavioral_admission_protection_index_py["(生产态 / production) behavioral_admission/protection_index.py<br/>文件: behavioral_admission/protection_index.py"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_admission_controller_py["(生产态 / production) behavioral_admission/admission_controller.py<br/>文件: behavioral_admission/admission_controller.py"]
    src_zephyr_gov_enforcement_behavioral_admission_verdict_engine_py["(生产态 / production) behavioral_admission/verdict_engine.py<br/>文件: behavioral_admission/verdict_engine.py"]

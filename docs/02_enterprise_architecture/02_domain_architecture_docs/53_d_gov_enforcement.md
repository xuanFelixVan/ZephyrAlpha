...
flowchart TD
    ...
    class D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_OPS,D_GOVERNANCE,D_GOV_SCRIPTS,D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_DATA external_prod
```
...
> 本域与 13 个外部域直接连接（出边 68 条 + 入边 109 条 = 177 条）。只显示直接连接的域，不展开具体节点。

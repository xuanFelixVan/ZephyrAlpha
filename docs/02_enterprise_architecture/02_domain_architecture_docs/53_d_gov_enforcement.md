...
flowchart TD
    ...
    scripts_governance_d8_doc_sync_requirements_version_sync_reconciler_py["requirements版本sync对账器<br/>requirements_version_sync_reconciler<br/>文件: d8_doc_sync/requirements_version_sync_<br/>reconciler.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_init_py["zephyr/gov_enforcement 包入口<br/>文件: gov_enforcement/__init__.py<br/>(生产态 / production)"]
    src_zephyr_gov_enforcement_behavioral_admission_init_py["gov_enforcement/behavioral_admission 包入口<br/>文件: behavioral_admission/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_approval_py["审批<br/>审批，供zephyr.governance.services.ada使用<br/>G-CT-004 — Backward-compat re-export of<br/>ApprovalRequest from<br/>文件: rule_enforcement/approval.py<br/>(生产态 / production)"]
    src_zephyr_gov_enforcement_rule_enforcement_compliance_rule_py["合规规则<br/>治理执行/rule_enforcement包的合规规则模块<br/>compliance_rule<br/>文件: rule_enforcement/compliance_rule.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_output_quality_gate_py["output质量门禁<br/>治理执行/rule_enforcement包的output质量门禁模块<br/>output_quality_gate<br/>文件: rule_enforcement/output_quality_gate.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_admission_response_py["准入响应<br/>治理执行/behavioral_admission包的准入响应模块<br/>admission_response<br/>文件: behavioral_admission/admission_response.py<br/>(生产态 / production)"]
    ...
    class D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_OPS,D_GOVERNANCE,D_SHARED,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_SECURITY,D_DATA external_prod
```

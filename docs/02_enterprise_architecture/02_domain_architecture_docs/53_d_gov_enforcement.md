...
flowchart TD
    ...
    tests_governance_commit_gates_test_scripts_import_integrity_gate_py -->|测试依赖 / test_depends| D_GOV_CODE_QUALITY
    ...
    class D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod

...
flowchart TD
    ...
    class D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_AUDIT,D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_DATA external_prod
```
...
| 111 | D_GOV_RULE 规则治理: 规则引擎模块集 / Rule Engine Package (rule_engine/__init_... | → | Rule Debt Auditor — v0.7.0 规则债务审计器: 分析escalatio... | config_depends / config_depends |

...
flowchart TD
    ...
    class D_GOV_AUDIT,D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY,D_GOV_CODE_QUALITY,D_SHARED external_prod
...
| 133 | D_GOV_RULE 规则治理: 规则引擎模块集 / Rule Engine Package (rule_engine/__init_... | → | mtime 轮询 + 自动同步 + 验证 / Rule Watcher (rule_engine/... | config_depends / config_depends |

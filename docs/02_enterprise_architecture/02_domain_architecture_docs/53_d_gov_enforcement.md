...
flowchart TD
    ...
    src_zephyr_gov_enforcement_behavioral_admission_init_py["gov_enforcement/behavioral_admission 包入口<br/>治理执行域behavioral_<br/>admission包入口，归集子模块按需懒加载<br/>文件: behavioral_admission/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_compliance_rule_py["合规规则<br/>rule_enforcement/compliance_rule 模块<br/>文件: rule_enforcement/compliance_rule.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_output_quality_gate_py["output质量门禁<br/>rule_enforcement/output_quality_gate 模块<br/>文件: rule_enforcement/output_quality_gate.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_protection_index_py["保护索引<br/>behavioral_admission/protection_index 模块<br/>文件: behavioral_admission/protection_index.py<br/>(生产态 / production)"]

...
flowchart TD
    ...
    class D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY,D_GOV_CODE_QUALITY,D_INTEGRATION,D_GOV_AUDIT,D_DATA external_prod
...
| 133 | D_GOV_RULE 规则治理: 规则引擎模块集 / Rule Engine Package (rule_engine/__init_... | → | 规则Debt审计器 / Rule Debt Auditor (rule_engine/rule_debt... | config_depends / config_depends |

...
flowchart TD
    ...
    src_zephyr_gov_enforcement_behavioral_admission_init_py["gov_enforcement/behavioral_admission 包入口<br/>管理gov_enforcement.behavioral_<br/>admission子包的加载和懒导入<br/>文件: behavioral_admission/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_approval_py["审批<br/>治理执行/rule enforcement包的approval模块<br/>G-CT-004 — Backward-compat re-export of<br/>ApprovalRequest from shared.contracts.approval_<br/>types.<br/>文件: rule_enforcement/approval.py<br/>(生产态 / production)"]
    src_zephyr_gov_enforcement_rule_enforcement_compliance_rule_py["合规规则<br/>治理执行/rule enforcement包的compliance_rule模块<br/>文件: rule_enforcement/compliance_rule.py<br/>(生产态 / production)"]
    src_zephyr_gov_enforcement_rule_enforcement_default_quality_gate_py["默认质量门禁<br/>治理执行/rule enforcement包的default_quality_<br/>gate模块<br/>D_DATA — Default Data Quality Gate<br/>文件: rule_enforcement/default_quality_gate.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_output_quality_gate_py["output质量门禁<br/>治理执行/rule enforcement包的output_quality_<br/>gate模块<br/>文件: rule_enforcement/output_quality_gate.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_admission_response_py["准入响应<br/>治理执行/behavioral admission包的admission_<br/>response模块<br/>文件: behavioral_admission/admission_response.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_protection_index_py["保护索引<br/>治理执行/behavioral admission包的protection_<br/>index模块<br/>文件: behavioral_admission/protection_index.py<br/>(生产态 / production)"]

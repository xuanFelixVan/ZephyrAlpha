...
flowchart TD
    ...
    tests_governance_commit_gates_test_capability_lookup_required_gate_py -->|测试依赖 / test_depends| D_INTEGRATION
    tests_governance_commit_gates_test_derived_file_deletion_gate_py -->|测试依赖 / test_depends| D_GOV_CODE_QUALITY
    tests_governance_commit_gates_test_asyncio_run_in_context_gate_py -->|测试依赖 / test_depends| D_GOV_CODE_QUALITY
    ...
    D_GOV_CODE_QUALITY -->|导入依赖 / import_depends| src_zephyr_gov_enforcement_rule_bridge_commit_gate_registry_py
    D_GOV_CODE_QUALITY -->|导入依赖 / import_depends| src_zephyr_gov_enforcement_rule_bridge_commit_gate_registry_py
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_output_quality_gate_py
    ...
    class D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY,D_GOV_CODE_QUALITY,D_INTEGRATION,D_SHARED,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod

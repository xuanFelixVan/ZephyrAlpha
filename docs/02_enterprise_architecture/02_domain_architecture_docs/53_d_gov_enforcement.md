...
flowchart TD
    ...
    src_zephyr_gov_enforcement_rule_enforcement_approval_py["审批<br/>审批，供zephyr.governance.services.ada使用<br/>G-CT-004 — Backward-compat re-export of<br/>ApprovalRequest from shared.contracts.approval_<br/>types.<br/>文件: rule_enforcement/approval.py<br/>(生产态 / production)"]

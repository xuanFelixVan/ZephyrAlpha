...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/data_governance/__init__.py | __init__.py | 设计态 / design |  |
| 2 | src/zephyr/data_governance/_extensions/__init__.py | __init__.py | 设计态 / design |  |
| 3 | src/zephyr/data_governance/api/__init__.py | __init__.py | 设计态 / design |  |
| 4 | src/zephyr/data_governance/core/__init__.py | __init__.py | 设计态 / design |  |
| 5 | src/zephyr/data_governance/infrastructure/__init__.py | __init__.py | 设计态 / design |  |
| 6 | src/zephyr/data_governance/models/__init__.py | __init__.py | 设计态 / design |  |
| 7 | src/zephyr/data_governance/services/__init__.py | __init__.py | 设计态 / design |  |
...
graph TD
    subgraph D_DATA_GOV["D_DATA_GOV 数据治理"]
        src_zephyr_data_governance_init_py["(设计态 / design) __init__.py"]
        src_zephyr_data_governance_extensions_init_py["(设计态 / design) __init__.py"]
        src_zephyr_data_governance_api_init_py["(设计态 / design) __init__.py"]
        src_zephyr_data_governance_core_init_py["(设计态 / design) __init__.py"]
        src_zephyr_data_governance_infrastructure_init_py["(设计态 / design) __init__.py"]
        src_zephyr_data_governance_models_init_py["(设计态 / design) __init__.py"]
        src_zephyr_data_governance_services_init_py["(设计态 / design) __init__.py"]
    end

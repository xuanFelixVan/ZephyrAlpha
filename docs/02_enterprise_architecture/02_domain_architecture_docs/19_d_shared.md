...
graph TD
    ...
    class D_GOVERNANCE,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    D_GOVERNANCE -->|import_depends| src_zephyr_shared_io_paths_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_infra_process_pool_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_io_paths_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_io_paths_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_io_paths_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_io_paths_py
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING external_prod
...
graph TD
    ...
    class D_TRADING,D_SECURITY_LLM,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_A2A external_prod

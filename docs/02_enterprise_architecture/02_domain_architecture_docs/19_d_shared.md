...
graph TD
    ...
    class D_SIMULATION,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_observer_py
    D_INTEGRATION -.->|import_depends| src_zephyr_shared_infra_observer_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_lock_py
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY external_prod
    class D_INTEGRATION_GATEWAY,D_INFRA_A2A external_design
```

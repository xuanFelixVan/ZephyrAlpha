...
| 跨域入边 | 573 | Cross-domain Incoming | 573 |
...
graph TD
    ...
    class D_GOVERNANCE,D_ML_TRAIN,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_INTEGRATION,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_AUDITTEST,D_INFRA_A2A external_design
```

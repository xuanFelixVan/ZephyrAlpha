...
graph TD
    ...
    src_zephyr_shared_capacity_governance_init_py -.->|config_depends / config_depends| src_zephyr_shared_capacity_governance_capacity_calibrator_py
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 131 个，80 条域内依赖）。

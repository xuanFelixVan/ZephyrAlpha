...
| 跨域入边 | 556 | Cross-domain Incoming | 556 |
...
graph TD
    ...
    class D_SIMULATION,D_AUTONOMY_CORE,D_TRADING,D_INTEGRATION,D_RISK external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SIMULATION,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_AUDITTEST,D_MKT_DATA,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_TRADING,D_INFRA_A2A,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_TRADING,D_OPS,D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
...
| D_GOVERNANCE | 106 | import_depends |

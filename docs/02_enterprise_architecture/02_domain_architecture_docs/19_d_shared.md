...
| 跨域入边 | 571 | Cross-domain Incoming | 571 |
...
graph TD
    ...
    class D_SIMULATION,D_AUTONOMY_CORE,D_RISK,D_TRADING,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_SIMULATION external_prod
...
graph TD
    ...
    class D_FUNDAMENTAL_SIGNAL,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTEGRATION external_prod
    class D_AUDITTEST,D_INFRA_A2A,D_INTEGRATION_GATEWAY external_design
```
...
| D_GOVERNANCE | 92 | import_depends |

...
graph TD
    ...
    class D_INTEGRATION,D_BACKTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE,D_SIMULATION external_prod
    class D_INTEGRATION_GATEWAY,D_ML_TRAIN,D_GOVERNANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_INFRA_A2A,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_INFRA_A2A,D_INFRA_RECOVERY,D_INTEGRATION external_prod
```
...
| D_GOVERNANCE | 105 | import_depends |
...
**[config_depends]** (35 条 / edges) — 已达显示上限，省略 / limit reached

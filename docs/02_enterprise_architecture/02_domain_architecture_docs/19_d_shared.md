...
| 跨域入边 | 566 | Cross-domain Incoming | 566 |
...
graph TD
    ...
    class D_SIMULATION,D_AUTONOMY_CORE,D_INTEGRATION,D_TRADING,D_RISK external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_SIMULATION,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_shared_io_file_utils_py
    D_TRADING["D_TRADING production"]
    D_TRADING -->|import_depends| src_zephyr_shared_infra_process_pool_py
...
graph TD
    ...
    src_zephyr_shared_security_init_py -.->|config_depends| src_zephyr_shared_security_lock_py
    D_TRADING["D_TRADING production"]
    ...
    class D_TRADING,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
    class D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_INFRA_A2A,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_TRADING -->|import_depends| src_zephyr_shared_utils_db_utils_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_utils_diff_utils_py
    D_TRADING -->|import_depends| src_zephyr_shared_utils_time_utils_py
...
| D_GOVERNANCE | 88 | import_depends,runtime |

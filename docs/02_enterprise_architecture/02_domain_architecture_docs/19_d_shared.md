...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_A2A,D_INTEGRATION,D_SECURITY_LLM external_prod
    class D_SECURITY,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_A2A,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_A2A,D_INFRA_RECOVERY external_prod
...
| D_INFRA_RUNTIME | 56 | import_depends |

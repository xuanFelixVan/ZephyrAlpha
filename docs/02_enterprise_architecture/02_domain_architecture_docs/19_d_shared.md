...
graph TD
    ...
    src_zephyr_shared_blueprint_tools_init_py -.->|config_depends| src_zephyr_shared_blueprint_tools_architecture_context_loader_py
    ...
    class D_SIMULATION,D_AUTONOMY_CORE,D_TRADING,D_RISK,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SIMULATION external_prod
    class D_INTEGRATION_GATEWAY,D_AUDITTEST,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_AUDITTEST,D_GOVERNANCE,D_MKT_DATA external_design
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_io_paths_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_paths_py
    D_TRADING -->|import_depends| src_zephyr_shared_io_io_cache_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_TRADING external_prod
    class D_INFRA_TELEMETRY,D_INTEGRATION,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_INFRA_A2A,D_AUDITTEST external_design
```

...
| 跨域入边 | 676 | Cross-domain Incoming | 676 |
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE external_prod
    class D_AUDITTEST,D_ML_TRAIN,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY_LLM external_prod
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_shared_io_serialization_py
    D_GOVERNANCE["D_GOVERNANCE production"]
    ...
    D_SECURITY -->|import_depends| src_zephyr_shared_io_paths_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_io_serialization_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_io_serialization_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_io_serialization_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_io_serialization_py
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    D_INTELLIGENCE["D_INTELLIGENCE production"]
    D_INTELLIGENCE -->|import_depends| src_zephyr_shared_security_secrets_py
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    ...
    class D_TRADING,D_SECURITY_LLM,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
    class D_INFRA_A2A,D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_INTEGRATION_GATEWAY external_design
```
...
| D_GOVERNANCE | 137 | import_depends,runtime |
| D_TRADING | 86 | import_depends |
| D_INFRA_RUNTIME | 75 | import_depends |
...
| 172 | src/zephyr/shared/io/yaml_utils.py | src/zephyr/shared/io/yaml_utils.py | yaml_utils.py — vocabulary YAML 加载公共工具（SSoT 真源） | prototype | generated |

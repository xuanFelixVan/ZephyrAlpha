...
| 跨域入边 | 562 | Cross-domain Incoming | 562 |
...
graph TD
    ...
    class D_SIMULATION,D_TRADING,D_AUTONOMY_CORE,D_INTEGRATION,D_RISK external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    D_TRADING -.->|import_depends| src_zephyr_shared_contracts_trace_context_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_foundation_errors_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_shared_io_sqlite_factory_py
    D_INTEGRATION["D_INTEGRATION prototype"]
    D_INTEGRATION -.->|import_depends| src_zephyr_shared_infra_observer_py
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_shared_io_sqlite_factory_py
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_shared_io_sqlite_factory_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    class D_TRADING,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INFRA_RECOVERY,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_TRADING,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
    class D_AUDITTEST external_design
```
...
| D_GOVERNANCE | 87 | import_depends |

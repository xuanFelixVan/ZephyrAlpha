...
| 跨域入边 | 621 | Cross-domain Incoming | 621 |
...
graph TD
    ...
    class D_SIMULATION,D_RISK,D_TRADING,D_INTEGRATION,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_AUDITTEST,D_MKT_DATA external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY_LLM,D_FUNDAMENTAL_SIGNAL,D_TRADING external_prod
...
graph TD
    ...
    D_INFRA_RECOVERY -.->|import_depends| src_zephyr_shared_io_sqlite_factory_py
    D_GOVERNANCE["D_GOVERNANCE prototype"]
    ...
    D_GOV_ENFORCEMENT -->|import_depends| src_zephyr_shared_io_paths_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_io_paths_py
    D_GOVERNANCE -->|import_depends| src_zephyr_shared_io_paths_py
    ...
    D_INFRA_A2A -.->|import_depends| src_zephyr_shared_io_paths_py
    D_INFRA_RUNTIME -->|import_depends| src_zephyr_shared_io_paths_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_SECURITY external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_A2A,D_INTEGRATION,D_INTEGRATION_GATEWAY external_design
```
...
| D_GOVERNANCE | 111 | import_depends |
| D_TRADING | 74 | import_depends |
| D_INFRA_RUNTIME | 72 | import_depends |
| D_GOV_SCRIPTS | 40 | import_depends |
| D_INTEGRATION | 35 | import_depends |
...
| D_INTELLIGENCE | 13 | import_depends |

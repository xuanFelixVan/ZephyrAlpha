...
| 跨域入边 | 565 | Cross-domain Incoming | 565 |
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_paths_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_paths_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_yaml_utils_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_paths_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_yaml_utils_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_paths_py
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_paths_py
...
graph TD
    ...
    class D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
    class D_GOVERNANCE,D_INFRA_A2A,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_prod

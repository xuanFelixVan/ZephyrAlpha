...
| 跨域入边 | 530 | Cross-domain Incoming | 530 |
...
graph TD
    ...
    class D_TRADING,D_BACKTEST,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SIMULATION,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY_LLM,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_TRADING external_prod
    class D_GOV_SCRIPTS,D_ML_TRAIN,D_AUDITTEST,D_SECURITY external_design
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_AUDITTEST,D_INFRA_A2A external_design
```
...
| D_GOVERNANCE | 84 | import_depends |
...
| D_INTELLIGENCE | 8 | import_depends |
...
> 域内模块依赖关系（共 167 条 / 167 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 167 条 / 167 edges)       │
├──────────────────────────────────────────────────────────────────┤

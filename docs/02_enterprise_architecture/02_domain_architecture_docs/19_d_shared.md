...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_AUTONOMY_CORE,D_FRONTEND external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SIMULATION,D_INTELLIGENCE,D_TRADING,D_AUTONOMY_CORE,D_EX_CORE,D_FRONTEND external_prod
    class D_ML_TRAIN,D_GOVERNANCE,D_INTEGRATION external_design
```

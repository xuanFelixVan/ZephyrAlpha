...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SIMULATION,D_INTELLIGENCE external_prod
    class D_ML_TRAIN,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_INFRA_RECOVERY,D_GOVERNANCE external_prod

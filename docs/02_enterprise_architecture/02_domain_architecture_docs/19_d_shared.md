...
graph TD
    ...
    class D_SIMULATION,D_TRADING,D_INTEGRATION,D_AUTONOMY_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_SIMULATION,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INTEGRATION external_prod
    class D_AUDITTEST,D_GOVERNANCE,D_ML_TRAIN,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_AUDITTEST,D_INTEGRATION,D_INFRA_A2A,D_INTEGRATION_GATEWAY external_design
```

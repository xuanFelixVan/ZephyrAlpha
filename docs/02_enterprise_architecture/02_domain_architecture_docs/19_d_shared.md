...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY_LLM,D_GOVERNANCE external_prod
    class D_SECURITY,D_INFRA_RUNTIME,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RECOVERY external_prod

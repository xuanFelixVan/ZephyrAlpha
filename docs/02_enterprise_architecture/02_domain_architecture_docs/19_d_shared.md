...
graph TD
    ...
    class D_SIMULATION,D_TRADING,D_RISK,D_AUTONOMY_CORE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SIMULATION external_prod
    class D_ML_TRAIN,D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_ML_TRAIN["D_ML_TRAIN prototype"]
    D_ML_TRAIN -.->|import_depends| src_zephyr_shared_io_paths_py
    ...
    D_TRADING -->|import_depends| src_zephyr_shared_io_paths_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_io_paths_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_infra_process_lifecycle_gateway_py
    D_INTEGRATION_GATEWAY["D_INTEGRATION_GATEWAY prototype"]
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING external_prod
    class D_ML_TRAIN,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_TRADING,D_SECURITY_LLM,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod

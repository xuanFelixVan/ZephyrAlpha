...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE,D_SIMULATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_INTEGRATION,D_SECURITY_LLM external_prod
...
graph TD
    ...
    src_zephyr_shared_io_init_py -.->|config_depends| src_zephyr_shared_io_doc_compressor_py
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTEGRATION,D_OPS,D_TRADING external_prod

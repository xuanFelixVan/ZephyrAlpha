...
| 跨域入边 | 560 | Cross-domain Incoming | 560 |
...
graph TD
    ...
    class D_INTELLIGENCE,D_SIMULATION,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE,D_AUDITTEST,D_ML_TRAIN,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY_LLM external_prod
...
graph TD
    ...
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_schema_schemas_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_resilience_retry_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_A2A,D_INTELLIGENCE external_prod
    class D_INTEGRATION_GATEWAY,D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING,D_INFRA_RECOVERY external_prod
    class D_AUDITTEST,D_SECURITY,D_GOVERNANCE,D_INTEGRATION_GATEWAY external_design
```
...
| D_GOVERNANCE | 107 | import_depends |
...
**[config_depends]** (34 条 / edges) — 已达显示上限，省略 / limit reached

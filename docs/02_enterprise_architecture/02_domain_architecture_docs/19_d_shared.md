...
graph TD
    ...
    class D_SIMULATION,D_RISK,D_AUTONOMY_CORE,D_TRADING,D_INTEGRATION external_prod
...
graph TD
    ...
    D_SECURITY_LLM -->|import_depends| src_zephyr_shared_contracts_security_security_decision_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_foundation_errors_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_foundation_migration_py
    D_SECURITY_LLM -->|import_depends| src_zephyr_shared_contracts_security_security_decision_py
    D_SECURITY_LLM -->|import_depends| src_zephyr_shared_contracts_security_security_decision_py
    D_SECURITY_LLM -->|import_depends| src_zephyr_shared_contracts_security_security_decision_py
    ...
    class D_GOVERNANCE,D_AUDITTEST,D_TRADING external_design
```
...
graph TD
    ...
    class D_SECURITY,D_AUDITTEST,D_INFRA_TELEMETRY,D_GOV_SCRIPTS,D_INTEGRATION,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_INTELLIGENCE,D_SECURITY_LLM external_prod
    class D_AUDITTEST,D_INFRA_A2A,D_GOVERNANCE,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION external_prod

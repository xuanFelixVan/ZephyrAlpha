...
graph TD
    ...
    class D_SIMULATION,D_INTEGRATION,D_AUTONOMY_CORE,D_TRADING,D_RISK external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_SIMULATION external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION,D_SECURITY_LLM external_prod
...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_cache_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_idempotency_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_outbox_py
    D_TRADING["D_TRADING production"]
    D_TRADING -->|import_depends| src_zephyr_shared_infra_observer_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_process_lifecycle_gateway_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_process_lifecycle_gateway_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_infra_process_lifecycle_gateway_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_TRADING,D_AUTONOMY_CORE external_prod
    class D_AUDITTEST,D_INTEGRATION,D_GOVERNANCE external_design
```
...
graph TD
    ...
    D_INTEGRATION -.->|import_depends| src_zephyr_shared_protocols_a2a_layer3_coordination_init_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_resilience_circuit_breaker_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_TRADING,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION,D_INFRA_RECOVERY external_prod

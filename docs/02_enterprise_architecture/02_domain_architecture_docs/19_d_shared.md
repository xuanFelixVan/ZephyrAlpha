...
| 跨域入边 | 675 | Cross-domain Incoming | 675 |
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY_LLM external_prod
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_shared_io_sqlite_factory_py
...
graph TD
    ...
    class D_TRADING,D_INTELLIGENCE,D_SECURITY_LLM,D_INFRA_RUNTIME external_prod
    class D_INFRA_A2A,D_INTEGRATION,D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_AUDITTEST external_design
```
...
| D_GOVERNANCE | 136 | import_depends |

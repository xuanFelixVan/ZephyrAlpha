...
graph TD
    ...
    class D_SIMULATION,D_INTEGRATION,D_RISK,D_TRADING,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SIMULATION,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_AUDITTEST,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_INFRA_A2A external_design
```
...
| D_GOVERNANCE | 88 | import_depends |

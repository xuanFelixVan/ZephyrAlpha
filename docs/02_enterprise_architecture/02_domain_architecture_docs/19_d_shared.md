...
| 域内依赖 | 168 | Internal Dependencies | 168 |
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime / runtime| src_zephyr_shared_protocols_init_py
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_FRONTEND external_design
```
...
| 197 | D_GOVERNANCE 生命周期管理: blueprint.md | → | Shared Protocols — cross-domain interface defi... | runtime / runtime |

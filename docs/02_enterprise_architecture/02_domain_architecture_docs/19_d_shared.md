...
graph TD
    ...
    class D_INTELLIGENCE,D_SIMULATION,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY_LLM,D_INTELLIGENCE external_prod
    class D_AUDITTEST,D_ML_TRAIN,D_SECURITY external_design
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INTELLIGENCE,D_SECURITY_LLM external_prod
    class D_INFRA_A2A,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_INTEGRATION external_design
```

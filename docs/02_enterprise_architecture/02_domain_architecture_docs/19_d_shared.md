...
| 跨域入边 | 665 | Cross-domain Incoming | 665 |
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_shared_foundation_errors_py
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_foundation_errors_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    ...
    class D_AUDITTEST,D_TRADING,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_FRONTEND,D_GOVERNANCE external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_resilience_fallback_py
    ...
    class D_TRADING,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
    class D_INTEGRATION_GATEWAY,D_AUDITTEST,D_INFRA_A2A,D_GOVERNANCE,D_INTEGRATION external_design
```

...
graph TD
    ...
    class D_INTEGRATION,D_SIMULATION,D_INTELLIGENCE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_A2A,D_SECURITY_LLM,D_TRADING external_prod
...
graph TD
    ...
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_shared_io_file_utils_py
    D_TRADING["D_TRADING production"]
    ...
    class D_GOV_SCRIPTS,D_INFRA_TELEMETRY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION_GATEWAY,D_AUDITTEST,D_INFRA_A2A external_design
```

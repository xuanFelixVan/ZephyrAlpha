...
| 跨域入边 | 681 | Cross-domain Incoming | 681 |
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    D_TRADING -->|import_depends| src_zephyr_shared_foundation_errors_py
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_INFRA_A2A,D_INTEGRATION external_prod

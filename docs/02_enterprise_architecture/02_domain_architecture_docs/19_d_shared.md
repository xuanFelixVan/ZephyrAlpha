...
| 跨域入边 | 561 | Cross-domain Incoming | 561 |
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_BACKTEST,D_TRADING external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_TRADING,D_INFRA_A2A,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_AUDITTEST,D_ML_TRAIN,D_GOV_SCRIPTS,D_TRADING,D_SECURITY,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INTEGRATION,D_INFRA_A2A external_prod
...
graph TD
    ...
    D_OPS -->|import_depends| src_zephyr_shared_utils_logging_py
    D_SECURITY["D_SECURITY prototype"]
    ...
    class D_GOVERNANCE,D_OPS external_prod
    class D_TRADING,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_SECURITY external_design
```

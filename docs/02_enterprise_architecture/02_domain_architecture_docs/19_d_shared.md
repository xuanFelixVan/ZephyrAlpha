...
| 跨域入边 | 672 | Cross-domain Incoming | 672 |
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_INTELLIGENCE external_prod
    class D_GOVERNANCE,D_AUDITTEST,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    D_SECURITY -.->|import_depends| src_zephyr_shared_io_serialization_py
    D_SECURITY -.->|import_depends| src_zephyr_shared_io_paths_py
    D_SECURITY -.->|import_depends| src_zephyr_shared_io_serialization_py
    D_SECURITY -.->|import_depends| src_zephyr_shared_io_serialization_py
    D_SECURITY -.->|import_depends| src_zephyr_shared_io_paths_py
    D_SECURITY_LLM["D_SECURITY_LLM production"]
    D_SECURITY_LLM -->|import_depends| src_zephyr_shared_io_paths_py
    D_SECURITY_LLM -.->|import_depends| src_zephyr_shared_io_paths_py
    D_TRADING["D_TRADING production"]
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_TRADING external_prod
...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_resilience_limiter_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOVERNANCE,D_INFRA_A2A,D_INTEGRATION,D_INTEGRATION_GATEWAY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_SECURITY_LLM["D_SECURITY_LLM production"]
    D_SECURITY_LLM -.->|import_depends| src_zephyr_shared_utils_async_utils_py
    D_SECURITY_LLM -.->|import_depends| src_zephyr_shared_utils_async_utils_py
    D_FUNDAMENTAL_SIGNAL["D_FUNDAMENTAL_SIGNAL production"]
    D_FUNDAMENTAL_SIGNAL -->|import_depends| src_zephyr_shared_utils_time_utils_py
    D_TRADING["D_TRADING production"]
    ...
    class D_GOVERNANCE,D_SECURITY_LLM,D_FUNDAMENTAL_SIGNAL,D_TRADING external_prod
```
...
| D_GOVERNANCE | 136 | import_depends,runtime |

...
| 跨域入边 | 532 | Cross-domain Incoming | 532 |
...
graph TD
    ...
    class D_SIMULATION,D_RISK,D_TRADING,D_AUTONOMY_CORE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_SIMULATION,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY_LLM,D_TRADING external_prod
    class D_AUDITTEST,D_SECURITY,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    D_INTELLIGENCE["D_INTELLIGENCE production"]
    D_INTELLIGENCE -->|import_depends| src_zephyr_shared_io_paths_py
    D_INTEGRATION_GATEWAY["D_INTEGRATION_GATEWAY prototype"]
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_io_pagination_py
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INFRA_TELEMETRY external_prod
    class D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_INTEGRATION_GATEWAY,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
| D_GOVERNANCE | 85 | import_depends,runtime |

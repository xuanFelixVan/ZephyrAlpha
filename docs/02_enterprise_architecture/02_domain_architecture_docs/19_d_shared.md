...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
...
graph TD
    ...
    src_zephyr_shared_schema_init_py -.->|config_depends| src_zephyr_shared_schema_schemas_py
    ...
    class D_INFRA_A2A,D_GOVERNANCE,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```

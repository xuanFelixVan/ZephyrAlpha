...
graph TD
    ...
    D_INFRA_RECOVERY -.->|import_depends| src_zephyr_shared_io_file_utils_py
    D_GOVERNANCE["D_GOVERNANCE prototype"]
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_infra_process_pool_py
    ...
    class D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING,D_SECURITY,D_INTEGRATION external_prod
    class D_GOVERNANCE,D_INFRA_TELEMETRY,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_OPS,D_TRADING,D_GOVERNANCE external_prod

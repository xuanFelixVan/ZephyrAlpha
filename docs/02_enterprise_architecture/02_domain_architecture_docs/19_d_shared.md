...
| 跨域入边 | 531 | Cross-domain Incoming | 531 |
...
graph TD
    ...
    class D_SIMULATION,D_INTEGRATION,D_TRADING,D_AUTONOMY_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_SIMULATION,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_ML_TRAIN,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_SECURITY_LLM external_prod
    class D_AUDITTEST,D_INFRA_RUNTIME,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_INFRA_A2A,D_TRADING external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_schema_severity_types_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_shared_utils_context_py
    D_GOVERNANCE -->|import_depends| src_zephyr_shared_utils_time_utils_py
    D_GOVERNANCE -->|import_depends| src_zephyr_shared_utils_db_utils_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_ENFORCEMENT external_prod
    class D_AUDITTEST,D_SECURITY,D_INTEGRATION_GATEWAY external_design
```

...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_DATA,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_BACKTEST,D_INFRA_RECOVERY,D_TRADING external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_DATA,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_prod
```

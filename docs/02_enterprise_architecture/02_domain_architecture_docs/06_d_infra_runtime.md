...
flowchart TD
    ...
    docs_03_modules_cross_layer_agent_orchestrator_blueprint_md["蓝图<br/>blueprint模块蓝图文档，描述该模块的设计意图和架<br/>构决策<br/>⛔ 基础设施运行时域，设计已就绪，等待开发排期<br/>文件: agent_orchestrator/blueprint.md<br/>(设计态 / design)"]
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INTELLIGENCE,D_INTEGRATION,D_BACKTEST,D_TRADING external_prod
```

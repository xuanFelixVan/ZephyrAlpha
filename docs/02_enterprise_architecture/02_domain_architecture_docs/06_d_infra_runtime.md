...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTELLIGENCE,D_INTEGRATION,D_AUTONOMY_CORE,D_BACKTEST,D_GOV_SCRIPTS,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_TRADING,D_GOV_OPS_RESILIENCE external_prod
```

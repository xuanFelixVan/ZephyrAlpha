...
flowchart TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOVERNANCE,D_AUTONOMY_CORE,D_BACKTEST,D_GOV_SCRIPTS,D_GOV_AUDIT,D_INTEGRATION,D_SECURITY external_prod
```

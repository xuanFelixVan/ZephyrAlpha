...
> 展示全部 171 个模块（生产态 169 + 设计态 2），含跨域依赖外部节点。节点含成熟度+名称+大白话/简介+文件路径。
...
flowchart TD
    ...
    src_zephyr_infrastructure_warm_hot_gate_py ~~~ src_zephyr_runtime_intraday_main_py
    src_zephyr_runtime_intraday_main_py ~~~ src_zephyr_shared_lifecycle_hooks_py
    ...
    src_zephyr_data_tick_redis_cache_py ~~~ src_zephyr_infrastructure_asset_inventory_classifier_py
    ...
    src_zephyr_infrastructure_contract_tester_py ~~~ src_zephyr_infrastructure_database_service_py
    src_zephyr_infrastructure_database_service_py ~~~ src_zephyr_infrastructure_h1_redis_hot_h1_redis_reader_py
    ...
    src_zephyr_infrastructure_pipeline_models_py ~~~ src_zephyr_infrastructure_redis_config_py
    src_zephyr_infrastructure_redis_config_py ~~~ src_zephyr_infrastructure_system_telemetry_facade_py
    ...
    src_zephyr_runtime_intraday_main_py -.->|导入依赖 / import_depends| D_FACTOR
    src_zephyr_runtime_intraday_main_py -->|导入依赖 / import_depends| D_DATA
    ...
    class D_DATA,D_SHARED,D_GOV_RULE,D_AUTONOMY_CORE,D_BACKTEST,D_GOV_SCRIPTS,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_TRADING,D_INTEGRATION external_prod

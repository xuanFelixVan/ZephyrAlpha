...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTEGRATION,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTEGRATION,D_GOV_RULE,D_TRADING,D_FEEDBACK_LOOP external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_FACTOR,D_GOV_SCRIPTS,D_GOV_RULE,D_GOV_CODE_QUALITY external_prod
```

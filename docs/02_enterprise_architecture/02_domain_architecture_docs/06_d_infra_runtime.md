...
flowchart TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_GOV_DRIFT,D_DATA,D_GOVERNANCE,D_INTEGRATION,D_TRADING,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
```

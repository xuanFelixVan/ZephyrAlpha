...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_DATA,D_INTEGRATION,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_BACKTEST,D_GOV_RULE,D_INFRA_RECOVERY external_prod
```

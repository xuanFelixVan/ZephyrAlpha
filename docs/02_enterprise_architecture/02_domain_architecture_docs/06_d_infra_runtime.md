...
| 容量 | 163/150 (超容) | Capacity | 163/150 (超容) |
...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_RULE,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_INTEGRATION,D_BACKTEST,D_TRADING external_prod
```

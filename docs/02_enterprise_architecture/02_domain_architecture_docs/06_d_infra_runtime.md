...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_OPS,D_FEEDBACK_LOOP,D_INTEGRATION,D_SECURITY,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_SCRIPTS external_prod

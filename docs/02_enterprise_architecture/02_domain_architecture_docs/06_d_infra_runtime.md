...
flowchart TD
    ...
    class D_SHARED,D_DATA,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_FACTOR,D_GOV_DRIFT,D_INTEGRATION,D_INFRA_RECOVERY,D_BACKTEST,D_AUTONOMY_CORE,D_GOVERNANCE,D_SECURITY,D_TRADING external_prod
```

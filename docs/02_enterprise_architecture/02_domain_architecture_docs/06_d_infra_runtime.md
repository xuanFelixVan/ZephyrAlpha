...
flowchart TD
    ...
    class D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_TRADING external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTEGRATION,D_FEEDBACK_LOOP,D_GOV_RULE,D_TRADING,D_GOV_SCRIPTS external_prod
```

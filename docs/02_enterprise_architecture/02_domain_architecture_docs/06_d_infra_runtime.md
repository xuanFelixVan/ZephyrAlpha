...
flowchart TD
    ...
    class D_SECURITY,D_SHARED,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_DATA,D_GOV_DRIFT,D_INTEGRATION,D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_SCRIPTS external_prod
```

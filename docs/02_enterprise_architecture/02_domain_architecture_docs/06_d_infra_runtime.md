...
flowchart TD
    ...
    class D_SHARED,D_DATA,D_TRADING,D_GOV_DRIFT,D_SECURITY,D_INTEGRATION,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_BACKTEST,D_INTELLIGENCE,D_GOVERNANCE external_prod
```

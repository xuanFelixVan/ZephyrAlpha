...
> 展示全部 168 个模块（生产态 166 + 设计态 2），含跨域依赖外部节点。节点含成熟度+名称+大白话/简介+文件路径。
...
flowchart TD
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INTEGRATION,D_BACKTEST,D_INTELLIGENCE external_prod

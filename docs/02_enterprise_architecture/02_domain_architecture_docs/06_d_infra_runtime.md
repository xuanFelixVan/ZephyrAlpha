...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_BACKTEST,D_INTEGRATION,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_TRADING external_prod
```

...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_COMPLIANCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_GOV_AUDIT,D_INTEGRATION,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_DRIFT,D_TRADING,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_SCRIPTS,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOV_RULE,D_TRADING external_prod
```

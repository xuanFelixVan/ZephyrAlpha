...
flowchart TD
    ...
    class D_TRADING,D_SHARED,D_GOV_DRIFT,D_INFRA_A2A,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_BACKTEST,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_RULE,D_SECURITY external_prod
```

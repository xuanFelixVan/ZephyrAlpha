...
flowchart TD
    ...
    class D_SHARED,D_DATA,D_GOV_DRIFT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_BACKTEST,D_TRADING,D_INTELLIGENCE,D_GOVERNANCE external_prod
```

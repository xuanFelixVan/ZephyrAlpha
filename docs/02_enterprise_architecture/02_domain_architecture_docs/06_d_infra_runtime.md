...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_RULE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_ORCHESTRATOR external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_TRADING,D_GOVERNANCE,D_GOV_SCRIPTS external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_TRADING,D_GOV_AUDIT,D_AUTONOMY_CORE external_prod
```
...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_SCRIPTS,D_INTEGRATION,D_GOV_RULE,D_TRADING external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_TRADING,D_INTEGRATION,D_AUTONOMY_CORE,D_BACKTEST,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_GOVERNANCE,D_ORCHESTRATOR external_prod
```

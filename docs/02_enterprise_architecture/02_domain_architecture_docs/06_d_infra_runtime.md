...
flowchart TD
    ...
    class D_SHARED,D_DATA,D_GOV_RULE,D_SECURITY,D_AUTONOMY_CORE,D_BACKTEST,D_GOV_SCRIPTS,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_TRADING,D_INTEGRATION external_prod

...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_DATA,D_INTEGRATION,D_BACKTEST,D_COMPLIANCE,D_FEEDBACK_LOOP,D_FACTOR,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_GOV_RULE,D_INFRA_RECOVERY external_prod
```

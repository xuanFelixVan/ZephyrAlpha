...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_FEEDBACK_LOOP,D_BACKTEST external_prod

...
flowchart TD
    ...
    src_zephyr_infrastructure_auto_fix_engine_interrupt_guard_py["中断守卫<br/>wal_dir + db_path 用 WAL<br/>预写日志防修复过程被中断导致数据损坏，供调度器使<br/>用<br/>interrupt_guard<br/>文件: auto_fix_engine/interrupt_guard.py<br/>(生产态 / production)"]

...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTEGRATION,D_GOV_RULE,D_TRADING,D_GOV_SCRIPTS,D_FEEDBACK_LOOP external_prod
```

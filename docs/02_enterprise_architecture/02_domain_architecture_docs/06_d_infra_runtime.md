...
flowchart TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_SECURITY,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_BACKTEST,D_GOV_AUDIT,D_INFRA_RECOVERY external_prod
```

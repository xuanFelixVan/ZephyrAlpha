...
flowchart TD
    ...
    docs_03_modules_cross_layer_agent_orchestrator_blueprint_md["蓝图<br/>agent_orchestrator/blueprint 模块<br/>⛔ 基础设施运行时域，设计已就绪，等待开发排期<br/>文件: agent_orchestrator/blueprint.md<br/>(设计态 / design)"]
    ...
    src_zephyr_infrastructure_h1_redis_hot_init_py["infrastructure/h1_redis_hot 包入口<br/>基础设施域h1_redis_<br/>hot包入口，归集子模块按需懒加载<br/>文件: h1_redis_hot/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_runtime_startup_shutdown_py["启动关机<br/>runtime/startup_shutdown 模块<br/>文件: runtime/startup_shutdown.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_h1_redis_hot_h1_cqrs_projectors_py ~~~ src_zephyr_infrastructure_h1_redis_hot_h1_redis_reader_py
    src_zephyr_infrastructure_h1_redis_hot_h1_redis_reader_py ~~~ src_zephyr_infrastructure_h1_redis_hot_h1_redis_writer_py
    src_zephyr_infrastructure_h1_redis_hot_h1_redis_writer_py ~~~ src_zephyr_infrastructure_health_monitor_health_aggregator_py
    ...
    src_zephyr_infrastructure_contract_tester_py ~~~ src_zephyr_infrastructure_h1_redis_hot_h1_redis_schema_py
    src_zephyr_infrastructure_h1_redis_hot_h1_redis_schema_py ~~~ src_zephyr_infrastructure_pipeline_backpressure_types_py

...
flowchart TD
    ...
    class D_SHARED,D_GOV_RULE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_ORCHESTRATOR external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INTEGRATION,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_TRADING external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTEGRATION,D_GOV_SCRIPTS,D_TRADING,D_GOV_RULE external_prod
```

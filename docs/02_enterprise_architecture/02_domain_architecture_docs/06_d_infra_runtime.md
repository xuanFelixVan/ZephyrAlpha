...
flowchart TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE,D_BACKTEST,D_GOV_SCRIPTS,D_GOV_RULE,D_FEEDBACK_LOOP external_prod
```

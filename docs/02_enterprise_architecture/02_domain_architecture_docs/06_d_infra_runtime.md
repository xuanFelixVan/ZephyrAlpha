...
flowchart TD
    ...
    class D_SHARED,D_GOV_RULE,D_DATA,D_FACTOR,D_INTEGRATION,D_TRADING,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_ORCHESTRATOR,D_SECURITY external_prod
```

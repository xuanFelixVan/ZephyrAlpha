...
flowchart TD
    ...
    class D_SHARED,D_TRADING,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_SECURITY,D_AUTONOMY_CORE,D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE,D_FACTOR external_prod
```

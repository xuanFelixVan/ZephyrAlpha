...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_DATA,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_BACKTEST,D_INFRA_RECOVERY,D_TRADING,D_GOV_SCRIPTS external_prod
```

...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_SHARED,D_INTEGRATION,D_SECURITY,D_TRADING,D_PF_CORE external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_SHARED,D_INTELLIGENCE,D_SECURITY external_prod
    class D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    src_zephyr_governance_rule_enforcement_rule_engine_init_py -.->|config_depends| src_zephyr_governance_rule_enforcement_rule_engine_rule_shadow_runner_py
...
│   ct_frontmatter.py → task_types.py                              │
│   ct_frontmatter.py → check_type_registry.py                     │

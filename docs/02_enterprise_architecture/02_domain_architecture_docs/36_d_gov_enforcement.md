...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_INFRA_RECOVERY,D_TRADING,D_PF_CORE external_prod
...
graph TD
    ...
    src_zephyr_governance_rule_enforcement_gate_engine_init_py -.->|config_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_engine_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_invariants_en_003_contract_compatibility_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_invariants_en_process_lifecycle_gateway_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_integration_test_runner_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_engine_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_engine_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_engine_py
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_kiss_enforcer_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_triple_alignment_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
│   ct_file_extension.py → check_type_registry.py                  │

...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RECOVERY,D_INTEGRATION,D_TRADING,D_SECURITY,D_PF_CORE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_prod

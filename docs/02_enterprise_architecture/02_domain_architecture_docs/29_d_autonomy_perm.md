...
graph TD
    ...
    D_SECURITY["(生产态 / production) D_SECURITY"]
    tests_agent_rbac_test_sequence_guard_agent_rbac_py -.->|测试依赖 / test_depends| D_SECURITY
    ...
    tests_agent_rbac_test_redteam_adversarial_py -.->|测试依赖 / test_depends| D_SECURITY
    tests_agent_rbac_test_redteam_adversarial_py -.->|测试依赖 / test_depends| D_SECURITY
    tests_agent_rbac_test_toctou_guard_agent_rbac_py -.->|测试依赖 / test_depends| D_SECURITY
    tests_agent_rbac_test_risk_mitigation_agent_rbac_py -.->|测试依赖 / test_depends| D_SECURITY
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOV_OPS_RESILIENCE,D_SECURITY external_prod
```
...
graph TD
    ...
    tests_agent_rbac_test_cross_model_consistency_py -.->|测试依赖 / test_depends| D_SECURITY
    tests_agent_rbac_test_engine_degradation_agent_rbac_py -.->|测试依赖 / test_depends| D_SECURITY
...
| 45 | 跨切面 B 取证审计 C 层——audit_log/replay/lega... | → | D_SECURITY 对抗验证: audit_log_guard.py — 审计日志注入防护守卫 (aud... | 测试依赖 / test_depends |

...
graph TD
    ...
    src_zephyr_trading_orchestrator_fault_tolerance_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_fault_tolerance_chaos_hooks_py
...
graph TD
    ...
    src_zephyr_trading_orchestrator_quality_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_quality_ke_quality_py
    D_SHARED["(生产态 / production) D_SHARED"]

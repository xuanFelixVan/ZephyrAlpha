...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_SECURITY_LLM,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_FRONTEND external_prod
    class D_EX_CORE external_design
```

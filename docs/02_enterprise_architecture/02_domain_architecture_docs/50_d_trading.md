...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_SHARED external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_governance_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_governance_dependency_lock_py
    D_GOVERNANCE["(生产态 / production) D_GOVERNANCE"]
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_SECURITY,D_FRONTEND external_prod
    class D_EX_CORE external_design
```

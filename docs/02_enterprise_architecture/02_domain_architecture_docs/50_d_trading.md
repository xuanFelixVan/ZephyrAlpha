...
graph TD
    ...
    class D_OPS,D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_SECURITY external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_execution_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_execution_data_lifecycle_py
...
| 582 | D_GOVERNANCE 生命周期管理: blueprint.md | → | auto_evolution.py | runtime / runtime |
| 583 | D_GOVERNANCE 生命周期管理: blueprint.md | → | feedback_collector.py | runtime / runtime |
| 584 | D_GOVERNANCE 生命周期管理: blueprint.md | → | Adaptive Parameter Tuning — v0.37.0 R452 (adap... | runtime / runtime |

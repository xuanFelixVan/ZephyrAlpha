...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FRONTEND external_prod
    class D_EX_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_FRONTEND external_prod

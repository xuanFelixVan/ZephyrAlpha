...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_OPS,D_GOVERNANCE,D_SECURITY external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_lifecycle_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_lifecycle_rolling_upgrade_py
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_FRONTEND external_prod

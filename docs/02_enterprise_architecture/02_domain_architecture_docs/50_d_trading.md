...
graph TD
    ...
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_trading_feedback_loop_gates_license_compliance_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_INTEGRATION,D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_FRONTEND external_prod
    class D_INFRA_TELEMETRY,D_EX_CORE external_design
```
...
| 583 | D_GOVERNANCE 生命周期管理: blueprint.md | → | Adaptive Parameter Tuning — v0.37.0 R452 (adap... | runtime / runtime |
| 584 | D_GOVERNANCE 生命周期管理: blueprint.md | → | feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 585 | D_GOVERNANCE 生命周期管理: blueprint.md | → | feedback-loop.forensic — auto-generated packag... | runtime / runtime |

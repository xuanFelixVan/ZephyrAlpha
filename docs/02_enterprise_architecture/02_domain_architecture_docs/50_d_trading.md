...
graph TD
    ...
    src_zephyr_trading_orchestrator_execution_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_execution_dlq_manager_py
...
graph TD
    ...
    class D_SECURITY_LLM,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_FRONTEND external_prod

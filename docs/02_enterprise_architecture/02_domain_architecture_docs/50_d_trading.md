...
graph TD
    ...
    class D_INTEGRATION,D_OPS,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_FRONTEND external_prod
    class D_EX_CORE external_design
```

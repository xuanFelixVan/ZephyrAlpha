...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_trading_orchestrator_contracts_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_contracts_finding_bridge_py
    D_SHARED["(生产态 / production) D_SHARED"]
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_OPS,D_INTEGRATION,D_SECURITY external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_quality_init_py -.->|config_depends / config_depends| src_zephyr_trading_orchestrator_quality_blueprint_scorer_py
    D_INTEGRATION["(生产态 / production) D_INTEGRATION"]
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY_LLM,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_FRONTEND external_prod
...
| 584 | D_GOVERNANCE 生命周期管理: blueprint.md | → | Cognitive Load Estimator — v0.6.0 R68 (cogniti... | runtime / runtime |

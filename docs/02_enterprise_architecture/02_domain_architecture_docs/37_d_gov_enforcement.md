...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_SECURITY,D_PF_CORE,D_TRADING external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_TRADING external_prod
...
> 按 architecture_layer 分层显示 规则执行（D_GOV_ENFORCEMENT）的模块分布。共 176 个模块 / 176 modules。

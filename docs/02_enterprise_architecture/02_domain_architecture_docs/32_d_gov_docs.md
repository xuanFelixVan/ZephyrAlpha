...
title: D-GOV-DOCS architecture_docs架构文档
version: "1.0"
status: active
date: 2026-06-25
...
# 32_d_gov_docs / architecture_docs

> **文档作用 / Purpose**: 展示 architecture_docs（D-GOV-DOCS）功能域的模块清单、域内依赖关系和跨域依赖关系，供架构审查和域治理参考。
...
|------|------|-------|-------|
| 编号 | 32 | Number | 32 |
| 域ID | D-GOV-DOCS | Domain ID | D-GOV-DOCS |
...
| 描述 | 架构文档与规则文档域 | Description | 架构文档与规则文档域 |
...
| ...hitecture/target_architecture/architecture_model/frontend/frontend_model.yaml |  | production | deprecated |
| .../02_enterprise_architecture/target_architecture/architecture_model/index.yaml |  | production | deprecated |
| ..._architecture/target_architecture/architecture_model/infra/core_services.yaml |  | production | deprecated |
| ...e_architecture/target_architecture/architecture_model/infra/shared_infra.yaml |  | production | deprecated |
| ...erprise_architecture/target_architecture/architecture_model/layers/b_mcp.yaml |  | production | deprecated |
| ...chitecture/target_architecture/architecture_model/layers/l00_data_source.yaml |  | production | deprecated |
| ...tecture/target_architecture/architecture_model/layers/l01_infrastructure.yaml |  | production | deprecated |
| ...hitecture/target_architecture/architecture_model/layers/l02_alpha_factor.yaml |  | production | deprecated |
| ...ture/target_architecture/architecture_model/layers/l03_signal_generation.yaml |  | production | deprecated |
| ...ecture/target_architecture/architecture_model/layers/l04_risk_management.yaml |  | production | deprecated |
| ...target_architecture/architecture_model/layers/l05_portfolio_construction.yaml |  | production | deprecated |
| ...ecture/target_architecture/architecture_model/layers/l06_trade_execution.yaml |  | production | deprecated |
| ...e/target_architecture/architecture_model/layers/l07_post_trade_analytics.yaml |  | production | deprecated |
| ...ure/target_architecture/architecture_model/layers/l08_human_ai_interface.yaml |  | production | deprecated |
| ...re/target_architecture/architecture_model/layers/l09_research_innovation.yaml |  | production | deprecated |
| ...rchitecture/target_architecture/architecture_model/layers/l10_compliance.yaml |  | production | deprecated |
| ...chitecture/target_architecture/architecture_model/layers/l11_ml_platform.yaml |  | production | deprecated |
| ...cture/target_architecture/architecture_model/layers/l12_system_telemetry.yaml |  | production | deprecated |
| ...ecture/target_architecture/architecture_model/layers/l13_experimentation.yaml |  | production | deprecated |
| ...rprise_architecture/target_architecture/architecture_model/layers/schema.yaml |  | production | deprecated |
| ...rprise_architecture/target_architecture/architecture_model/layers/shared.yaml |  | production | deprecated |
| ...erprise_architecture/target_architecture/architecture_model/mir_vxzd5an_.yaml |  | production | deprecated |
| ...rchitecture/target_architecture/architecture_model/scripts/scripts_model.yaml |  | production | deprecated |
...
| src/zephyr/governance/kb/pipeline/triage.py |  | prototype | generated |
...
| src/zephyr/governance/kb/triage.py |  | prototype | generated |
...
```mermaid
graph TD
    subgraph D_GOV_DOCS["D-GOV-DOCS architecture_docs"]
...
graph TD
    ...
    D_GOV_ENFORCEMENT["D-GOV-ENFORCEMENT production"]
    src_zephyr_governance_kb_triage_py -.->|import_depends| D_GOV_ENFORCEMENT
    src_zephyr_governance_kb_triage_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_governance_kb_unified_memory_api_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_governance_kb_migration_embedding_migrate_py -.->|import_depends| D_GOVERNANCE
    ...
    src_zephyr_governance_kb_pipeline_activate_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_governance_kb_pipeline_activate_py -.->|runtime| D_GOVERNANCE
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_governance_kb_vms_memory_backend_py design
...
|--------|:---:|---------|
| D-GOVERNANCE | 28 | import_depends,runtime |
| D-SHARED | 20 | import_depends |
| D-GOV-ENFORCEMENT | 12 | import_depends |

...
| 模块数 | 417 | Module Count | 417 |
| 域内依赖 | 781 | Internal Dependencies | 781 |
| 跨域入边 | 86 | Cross-domain Incoming | 86 |
| 跨域出边 | 146 | Cross-domain Outgoing | 146 |
| 设计态模块 | 0 | Design Modules | 0 |
| 生产态模块 | 417 | Production Modules | 417 |
| 容量 | 417/150 (超容) | Capacity | 417/150 (超容) |
...
> 展示全部 417 个模块（生产态 417 + 设计态 0），含跨域依赖外部节点。节点含成熟度+名称+大白话/简介+文件路径。
...
> 仅展示已上线运行的模块（共 417 个），不含跨域外部节点。跨域依赖见下方跨域依赖章节。

...
flowchart TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_SHARED,D_OPS,D_AUTONOMY_PERM,D_GOV_RULE,D_GOV_DOCS,D_GOV_AUDIT external_prod
```
...
flowchart TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_DATA,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_OPS,D_AUTONOMY_PERM,D_GOV_RULE,D_GOV_DOCS external_prod
```

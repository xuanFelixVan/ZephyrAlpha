...
| 域内依赖 | 789 | Internal Dependencies | 789 |
...
flowchart TD
    ...
    scripts_governance_shared_walk_py ~~~ scripts_governance_meta_benchmark_test_fixtures_bad_imports_py
    scripts_governance_meta_benchmark_test_fixtures_bad_imports_py ~~~ scripts_governance_oneoff_data_domain_design_state_complete_py
    ...
    class D_DATA,D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
```

...
flowchart TD
    ...
    class D_GOVERNANCE,D_DATA,D_SHARED,D_INTEGRATION,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_OPS,D_AUTONOMY_PERM,D_GOV_RULE,D_GOV_DRIFT external_prod
```
...
| 48 | 决策节点大白话回填脚本 (governance/decision_node_plain_zh... | → | D_GOVERNANCE 生命周期管理: decisiongraph结构 / decisiongraph_schema (persistence/dec... | 导入依赖 / import_depends |

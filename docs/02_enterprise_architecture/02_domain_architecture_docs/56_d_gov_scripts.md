...
flowchart TD
    ...
    tests_governance_scripts_governance_test_staged_walk_py["scripts_governance/test_staged_walk<br/>test_staged_walk.py — iter_staged_files() +<br/>扫描器 --staged 模式单元测试。<br/>文件: scripts_governance/test_staged_walk.py<br/>(生产态 / production)"]

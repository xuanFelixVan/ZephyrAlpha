...
| 域内依赖 | 761 | Internal Dependencies | 761 |
...
flowchart TD
    ...
    scripts_governance_harvest_candidates_from_drafts_py -->|导入依赖 / import_depends| D_SHARED
    ...
    class D_GOVERNANCE,D_SHARED,D_DATA,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_RULE external_prod
```

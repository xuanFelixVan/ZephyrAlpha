...
flowchart TD
    ...
    D_GOVERNANCE -->|导入依赖 / import_depends| scripts_governance_shared_constants_py
    D_GOVERNANCE -->|导入依赖 / import_depends| scripts_governance_shared_constants_py
    D_GOVERNANCE -->|导入依赖 / import_depends| scripts_governance_shared_yaml_utils_py
    D_GOVERNANCE -->|导入依赖 / import_depends| scripts_governance_shared_constants_py
    ...
    class D_SHARED,D_GOVERNANCE,D_DATA,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_AUTONOMY_PERM external_prod
```

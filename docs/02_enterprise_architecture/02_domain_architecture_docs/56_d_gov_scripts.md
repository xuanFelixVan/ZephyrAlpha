...
flowchart TD
    ...
    scripts_governance_archive_vms_ri_vms_cross_file_check_py ~~~ scripts_governance_shared_file_utils_py
    ...
    class D_GOVERNANCE,D_SHARED,D_DATA,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
```

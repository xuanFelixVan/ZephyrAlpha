...
flowchart TD
    ...
    tests_governance_scripts_governance_test_validate_truth_source_cascade_unit_py -->|测试依赖 / test_depends| D_GOV_DRIFT
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_DATA,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
```

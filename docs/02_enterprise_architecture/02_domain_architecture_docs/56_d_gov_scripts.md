...
flowchart TD
    ...
    scripts_governance_oneoff_data_domain_design_state_complete_py ~~~ scripts_governance_oneoff_fix_module_translation_zh_py
    ...
    scripts_governance_meta_manage_baseline_py ~~~ scripts_governance_oneoff_factor_design_state_complete_py
    ...
    scripts_governance_apply_depgraph_py ~~~ scripts_governance_meta_benchmark_test_fixtures_bad_imports_py
    ...
    scripts_governance_oneoff_fix_module_translation_zh_py -->|config_depends / config_depends| scripts_governance_oneoff_factor_design_state_complete_py
    scripts_governance_oneoff_fix_remaining_en_py -->|config_depends / config_depends| scripts_governance_oneoff_factor_design_state_complete_py
    ...
    class D_DATA,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
```

...
| 域内依赖 | 778 | Internal Dependencies | 778 |
...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_DATA,D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_RULE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
```

...
flowchart TD
    ...
    scripts_governance_meta_manage_baseline_py ~~~ scripts_governance_oneoff_fix_module_translation_zh_py
    ...
    scripts_governance_shared_walk_py ~~~ scripts_governance_meta_benchmark_test_fixtures_incomplete_module_py
    scripts_governance_meta_benchmark_test_fixtures_incomplete_module_py ~~~ scripts_governance_oneoff_factor_design_state_complete_py
    ...
    scripts_governance_shared_staged_files_py ~~~ scripts_governance_apply_depgraph_py
    ...
    scripts_governance_shared_module_translation_loader_py ~~~ scripts_governance_d3_metadata_validate_module_id_naming_py
    ...
    scripts_governance_oneoff_fix_remaining_en_py -->|config_depends / config_depends| scripts_governance_oneoff_fix_module_translation_zh_py
    ...
    class D_SHARED,D_GOVERNANCE,D_DATA,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
```

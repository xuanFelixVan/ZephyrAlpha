...
flowchart TD
    ...
    scripts_governance_archive_prototype_changelog_py ~~~ scripts_governance_archive_vms_ri_ri_boundary_check_py
    ...
    class D_DATA,D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_GOV_RULE,D_AUTONOMY_PERM external_prod
```

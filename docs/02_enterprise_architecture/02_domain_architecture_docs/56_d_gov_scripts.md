...
flowchart TD
    ...
    scripts_governance_apply_depgraph_py ~~~ scripts_governance_meta_benchmark_test_fixtures_incomplete_module_py
    ...
    class D_SHARED,D_DATA,D_GOVERNANCE,D_INTEGRATION,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
```

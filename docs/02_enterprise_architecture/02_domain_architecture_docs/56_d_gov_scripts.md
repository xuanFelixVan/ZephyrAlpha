...
flowchart TD
    ...
    scripts_governance_archive_prototype_construction_gate_py ~~~ scripts_governance_archive_vms_ri_vms_blindspot_check_py
    ...
    class D_DATA,D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOV_RULE,D_GOV_DRIFT,D_OPS,D_AUTONOMY_PERM external_prod
```

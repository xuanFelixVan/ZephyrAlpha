...
| 域内依赖 | 787 | Internal Dependencies | 787 |
...
flowchart TD
    ...
    class D_SHARED,D_DATA,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_RULE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
```

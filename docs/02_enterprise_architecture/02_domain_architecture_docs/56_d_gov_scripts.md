...
flowchart TD
    ...
    D_GOV_DOCS["(生产态 / production) 架构文档治理 /<br/>Architecture Docs Governance<br/>架构文档治理，负责架构文档生成、一致性和版本管理<br/>跨域节点 / cross-domain"]
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_DATA,D_SHARED,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_GOV_DOCS,D_GOV_RULE external_prod
```

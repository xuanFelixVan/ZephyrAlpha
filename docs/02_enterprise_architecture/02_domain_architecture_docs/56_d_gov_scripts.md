...
flowchart TD
    ...
    scripts_governance_sync_check_p0_status_py ~~~ scripts_governance_apply_depgraph_py
    ...
    class D_SHARED,D_DATA,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
```

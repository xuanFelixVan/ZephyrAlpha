...
| 域内依赖 | 782 | Internal Dependencies | 782 |
...
flowchart TD
    ...
    class D_DATA,D_GOVERNANCE,D_SHARED,D_GOV_DRIFT,D_GOV_RULE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
```

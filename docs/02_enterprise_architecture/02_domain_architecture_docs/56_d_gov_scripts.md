...
flowchart TD
    ...
    scripts_governance_archive_one_off_verify_rule_yaml_migration_py["verify规则yamlmigration<br/>verify规则yamlmigration，提供包入口和模块加载功<br/>能<br/>verify_rule_yaml_migration.py - 6-dimensional<br/>verification of rule YAML migration.<br/>文件: one_off/verify_rule_yaml_migration.py<br/>(生产态 / production)"]
    ...
    scripts_governance_archive_vms_ri_vms_blindspot_check_py["VMS 盲点闭合检查器 — MOD-INF-011 · R1(33) + R2(<br/>vms_blindspot_check<br/>文件: vms_ri/vms_blindspot_check.py<br/>(生产态 / production)"]
    ...
    scripts_governance_ast_import_rewriter_py["ast导入rewriter<br/>ast导入rewriter。AST-based import rewriter for<br/>governance directory migration<br/>AST-based import rewriter for governance<br/>directory migration.<br/>文件: governance/ast_import_rewriter.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d11_compliance_validate_manifest_admission_py["validate清单admission<br/>校验manifest准入<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: d11_compliance/validate_manifest_<br/>admission.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d11_compliance_validate_vocabulary_coverage_py["校验vocabularycoverage<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: d11_compliance/validate_vocabulary_<br/>coverage.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d1_structure_batch_create_index_md_py["批次创建索引md<br/>批次创建索引md。Batch create index.md for all<br/>directories under docs/ that lack one<br/>Batch create index.md for all directories under<br/>docs/ that lack one.<br/>文件: d1_structure/batch_create_index_md.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d1_structure_check_directory_contract_py["检查directory契约<br/>检查directory契约。GATE-DIRECTORY-CONTRACT:<br/>Directory Contract validation gate<br/>GATE-DIRECTORY-CONTRACT: Directory Contract<br/>validation gate.<br/>文件: d1_structure/check_directory_contract.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d1_structure_detect_temp_files_py["检测tempfiles<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: d1_structure/detect_temp_files.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d1_structure_validate_index_reality_py["validate索引reality<br/>校验索引reality<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: d1_structure/validate_index_reality.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d3_metadata_auto_generate_index_py["自动生成索引<br/>自动生成索引。GATE-INDEX: Validate and auto-fix<br/>index.md factual accuracy<br/>GATE-INDEX: Validate and auto-fix index.md<br/>factual accuracy.<br/>文件: d3_metadata/auto_generate_index.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d3_metadata_validate_module_id_py["校验模块id<br/>校验模块id。GATE-MODULEID: Validate module_id<br/>uniqueness and index/file consistency<br/>GATE-MODULEID: Validate module_id uniqueness<br/>and index/file consistency.<br/>文件: d3_metadata/validate_module_id.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_analyze_change_impact_py["analyzechange冲击<br/>analyze变更冲击<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: d5_architecture/analyze_change_impact.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_checkers_check_g6_ctr_compliance_py["检查g6ctr合规<br/>检查g6ctr合规，治理的检查器，检查某项条件是否满<br/>足<br/>check_g6_ctr_compliance.py - G6 CTR Contract<br/>Compliance Gate Engine<br/>文件: checkers/check_g6_ctr_compliance.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_detect_causal_conflicts_py["检测causalconflicts<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: d5_architecture/detect_causal_conflicts.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_validators_blueprint_validate_blueprint_implementation_docs_py["校验蓝图实现文档<br/>校验蓝图实现文档.md 6.4 铁律五 +<br/>铁律六：蓝图中声称的文件路径必须在磁盘上真实存在<br/>validate_blueprint_implementation_docs<br/>文件: blueprint/validate_blueprint_<br/>implementation_docs.py<br/>(生产态 / production)"]
    scripts_governance_d5_architecture_validators_blueprint_validate_blueprint_path_consistency_py["校验蓝图路径一致性<br/>校验蓝图路径一致性模块<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: blueprint/validate_blueprint_path_<br/>consistency.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_validators_session_validate_session_log_index_integrity_py["校验会话日志索引完整性<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: session/validate_session_log_index_<br/>integrity.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_validators_validate_directory_structure_py["校验directorystructure<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: validators/validate_directory_structure.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_validators_validate_gate_yaml_py["validate门禁yaml<br/>校验门禁yaml<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: validators/validate_gate_yaml.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_validators_validate_load_path_integrity_py["校验加载路径完整性<br/>校验加载路径完整性模块<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: validators/validate_load_path_integrity.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_validators_validate_nested_flat_dirs_py["校验nestedflatdirs<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: validators/validate_nested_flat_dirs.py<br/>(生产态 / production)"]
    ...
    scripts_governance_meta_governance_watchdog_py["治理watchdog<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: meta/governance_watchdog.py<br/>(生产态 / production)"]
    ...
    scripts_governance_meta_validate_automation_boundary_py["validate自动化boundary<br/>校验automationboundary<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: meta/validate_automation_boundary.py<br/>(生产态 / production)"]
    ...
    scripts_governance_meta_validate_script_onboarding_py["校验scriptonboarding<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: meta/validate_script_onboarding.py<br/>(生产态 / production)"]
    ...
    scripts_governance_vms_vms_blindspot_check_py["VMS 盲点闭合检查器 — MOD-INF-011 · R1(33) + R2(<br/>vms_blindspot_check<br/>文件: vms/vms_blindspot_check.py<br/>(生产态 / production)"]
    ...
    scripts_governance_vms_vms_cross_file_check_py["VMS 跨文件内容一致性检查器 — MOD-INF-011 ·<br/>TASK-INF<br/>vms_cross_file_check<br/>文件: vms/vms_cross_file_check.py<br/>(生产态 / production)"]
    ...
    scripts_governance_sync_check_p0_status_py["检查p0状态<br/>检查p0状态模块<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: _sync/check_p0_status.py<br/>(生产态 / production)"]
    ...
    scripts_governance_archive_vms_ri_vms_cross_file_check_py["VMS 跨文件内容一致性检查器 — MOD-INF-011 ·<br/>TASK-INF<br/>vms_cross_file_check<br/>文件: vms_ri/vms_cross_file_check.py<br/>(生产态 / production)"]
    ...
    scripts_governance_meta_benchmark_test_fixtures_incomplete_module_py["incomplete模块<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: test_fixtures/incomplete_module.py<br/>(生产态 / production)"]
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_GOV_ENFORCEMENT,D_AUTONOMY_PERM,D_GOV_RULE,D_OPS,D_GOV_DRIFT external_prod
```

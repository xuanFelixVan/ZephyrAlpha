...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_RULE,D_SHARED,D_OPS,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOVERNANCE,D_GOV_RULE,D_SHARED,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_RULE,D_SHARED,D_OPS external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_AUDIT,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOVERNANCE,D_SHARED,D_ORCHESTRATOR,D_GOV_DRIFT,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_PF_CORE external_prod

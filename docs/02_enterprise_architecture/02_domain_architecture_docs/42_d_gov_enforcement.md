...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_OPS,D_GOV_RULE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_RULE,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_SHARED,D_SECURITY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_OPS,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT external_prod
    class D_GOV_SCRIPTS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_RULE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOV_REPAIR,D_PF_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
    class D_TRADING,D_COMPLIANCE,D_DATA external_design
```

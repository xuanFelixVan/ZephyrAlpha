...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_GOV_RULE,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SHARED,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_GOV_RULE,D_INTEGRATION,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_PF_CORE external_prod

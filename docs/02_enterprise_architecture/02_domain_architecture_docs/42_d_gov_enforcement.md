...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_RULE,D_SECURITY,D_SHARED,D_FBL_DIAGNOSERS,D_ORCHESTRATOR,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_GOVERNANCE,D_PF_CORE external_prod

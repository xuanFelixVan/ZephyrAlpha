...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_SECURITY,D_GOV_AUDIT,D_GOV_DRIFT,D_OPS external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_RULE,D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_SECURITY,D_GOV_DRIFT,D_OPS external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_PF_CORE external_prod
...
| 32 | GitCommitGateway — 全项目唯一合法 git commit .... | → | D_GOV_CODE_QUALITY 代码质量治理: arch_reference_gate.py — #ARCH-NNN / #ARCH-DOMAIN-NNN | 导入依赖 / import_depends |
...
| 55 | D_GOV_CODE_QUALITY 代码质量治理: arch_reference_gate.py — #ARCH-NNN / #ARCH-DOMAIN-NNN | → | commit_gate_registry.py — GitCommitGateway pre... | 导入依赖 / import_depends |

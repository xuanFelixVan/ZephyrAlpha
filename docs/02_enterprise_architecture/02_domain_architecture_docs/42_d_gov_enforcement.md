...
graph TD
    ...
    class D_OPS,D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_REPAIR,D_PF_CORE,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_CODE_QUALITY,D_SHARED,D_INFRASTRUCTURE,D_TRADING,D_GOVERNANCE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_RULE,D_FBL_VERIFICATION,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_OPS,D_GOV_DRIFT external_prod
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_GOV_RULE,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_AUDIT,D_ORCHESTRATOR,D_GOV_REPAIR,D_PF_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
    class D_INFRASTRUCTURE,D_TRADING,D_COMPLIANCE,D_DATA external_design
```

...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_RULE,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_CODE_QUALITY,D_OPS,D_GOV_DRIFT,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_SECURITY,D_GOVERNANCE,D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_PF_CORE,D_GOV_OPS_RESILIENCE external_prod

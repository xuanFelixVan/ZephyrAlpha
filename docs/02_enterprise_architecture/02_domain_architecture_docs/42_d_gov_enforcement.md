...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_SECURITY,D_GOV_REPAIR,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY external_prod
    class D_COMPLIANCE,D_DATA external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INTEGRATION,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_REPAIR,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_SECURITY,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_ORCHESTRATOR,D_FBL_DETECTORS,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_PF_CORE external_prod

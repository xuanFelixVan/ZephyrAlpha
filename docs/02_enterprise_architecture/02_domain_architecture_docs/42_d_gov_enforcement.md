...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_OPS,D_GOV_OPS_RESILIENCE external_prod
...
| 72 | D_GOV_RULE 规则治理: rule_engine package — 规则引擎模块集合（ARCH-0... | → | Rule Shadow Runner — v0.10.0 规则影子模式: 新.... | config_depends / config_depends |

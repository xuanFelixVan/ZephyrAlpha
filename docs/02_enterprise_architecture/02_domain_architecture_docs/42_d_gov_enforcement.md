...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE external_prod
...
| 73 | Re-export shim — ComplianceRule 真源已合并至 z... | → | D_INFRASTRUCTURE 跨层契约基础设施: compliance_rule.py | 导入依赖 / import_depends |
...
| 70 | D_GOV_RULE 规则治理: rule_engine package — 规则引擎模块集合（ARCH-0... | → | Rule Canary Manager — v0.10.0 规则金丝雀: 1%用... | config_depends / config_depends |

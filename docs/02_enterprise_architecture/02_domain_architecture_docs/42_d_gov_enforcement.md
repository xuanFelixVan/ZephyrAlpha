...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_DRIFT,D_INTEGRATION,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_PF_CORE external_prod
    class D_INFRASTRUCTURE,D_DATA,D_GOV_REPAIR,D_COMPLIANCE,D_TRADING external_design
```

...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_SHARED,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_OPS external_prod
    class D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_RULE,D_SHARED,D_GOV_REPAIR,D_PF_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
...
| 108 | D_GOV_SCRIPTS 脚本治理: 一次性提交脚本：ARCH-GOV-SHIM-001 阶段2+3（TTL=... | → | GitCommitGateway — 全项目唯一合法 git commit .... | 导入依赖 / import_depends |

...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_SECURITY,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_RULE,D_GOV_REPAIR external_prod
    class D_GOVERNANCE,D_GOV_AUDIT,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_RULE,D_FBL_DETECTORS,D_SHARED,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_PF_CORE external_prod
...
| 103 | D_GOV_RULE 规则治理: rule_engine package — 规则引擎模块集合（ARCH-0... | → | Rule Debt Auditor — v0.7.0 规则债务审计器: 分.... | config_depends / config_depends |

...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOV_RULE,D_INFRASTRUCTURE,D_TRADING,D_GOVERNANCE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_GOV_AUDIT external_design
```

...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_SHARED,D_GOV_RULE,D_GOV_REPAIR external_prod
    class D_SECURITY,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOVERNANCE,D_GOV_RULE,D_SHARED,D_FBL_DIAGNOSERS,D_SECURITY,D_GOV_CODE_QUALITY external_prod
```
...
| 106 | D_GOV_RULE 规则治理: rule_engine package — 规则引擎模块集合（ARCH-0... | → | Rule Debt Auditor — v0.7.0 规则债务审计器: 分.... | config_depends / config_depends |

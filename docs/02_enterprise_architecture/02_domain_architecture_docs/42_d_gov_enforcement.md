...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_GOV_RULE,D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_SHARED,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_GOV_RULE,D_SHARED external_prod
    class D_GOVERNANCE,D_TRADING,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT,D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_PF_CORE external_prod
...
| 118 | D_GOV_RULE 规则治理: rule_engine package — 规则引擎模块集合（ARCH-0... | → | Rule Debt Auditor — v0.7.0 规则债务审计器: 分.... | config_depends / config_depends |

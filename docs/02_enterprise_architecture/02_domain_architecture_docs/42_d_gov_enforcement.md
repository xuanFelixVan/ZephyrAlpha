...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_DRIFT,D_SHARED,D_SECURITY external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_SHARED,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_GOV_RULE,D_FBL_DETECTORS,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_DRIFT,D_SHARED external_prod
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_GOV_RULE,D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_GOVERNANCE,D_PF_CORE external_prod

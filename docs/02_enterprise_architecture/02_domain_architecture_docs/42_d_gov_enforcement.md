...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_ORCHESTRATOR,D_SECURITY,D_PF_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
    class D_SHARED,D_TRADING,D_COMPLIANCE,D_GOV_REPAIR,D_DATA external_design
```

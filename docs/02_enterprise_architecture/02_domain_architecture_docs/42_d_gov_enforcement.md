...
graph TD
    ...
    class D_OPS,D_GOV_DRIFT,D_GOV_RULE,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_CODE_QUALITY,D_SHARED,D_INFRASTRUCTURE,D_GOV_AUDIT,D_GOVERNANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_SHARED,D_GOV_RULE,D_FBL_VERIFICATION,D_GOVERNANCE,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_OPS,D_GOV_DRIFT,D_SHARED,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_SECURITY external_prod
    class D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_RULE,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_DRIFT,D_GOV_REPAIR,D_PF_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod

...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_OPS,D_GOV_RULE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_RULE,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_OPS,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_SHARED,D_GOV_RULE,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FBL_DETECTORS,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_PF_CORE external_prod
...
| 106 | D_GOV_RULE 规则治理: rule_engine package — 规则引擎模块集合（ARCH-0... | → | Rule Shadow Runner — v0.10.0 规则影子模式: 新.... | config_depends / config_depends |

...
flowchart TD
    ...
    src_zephyr_shared_ai_guards_ai_audit_guard_py["(生产态 / production) ai_guards/ai_audit_guard.py<br/>文件: ai_guards/ai_audit_guard.py"]
    src_zephyr_shared_ai_guards_combinatorial_gate_py["(生产态 / production) ai_guards/combinatorial_gate.py<br/>文件: ai_guards/combinatorial_gate.py"]
    src_zephyr_shared_ai_guards_core_integrity_guard_py["(生产态 / production) ai_guards/core_integrity_guard.py<br/>文件: ai_guards/core_integrity_guard.py"]
    ...
    src_zephyr_shared_alerts_alert_manager_py["(生产态 / production) alerts/alert_manager.py<br/>文件: alerts/alert_manager.py"]
    src_zephyr_shared_alerts_alert_precision_tracker_py["(生产态 / production) alerts/alert_precision_tracker.py<br/>文件: alerts/alert_precision_tracker.py"]
    src_zephyr_shared_alerts_dual_channel_alert_py["(生产态 / production) alerts/dual_channel_alert.py<br/>文件: alerts/dual_channel_alert.py"]
    src_zephyr_shared_alerts_heartbeat_server_py["(生产态 / production) alerts/heartbeat_server.py<br/>文件: alerts/heartbeat_server.py"]
    ...
    src_zephyr_shared_api_dos_launcher_py["(生产态 / production) api/dos_launcher.py<br/>文件: api/dos_launcher.py"]
    src_zephyr_shared_blueprint_tools_ai_understandability_constraint_py["(生产态 / production) blueprint_tools/ai_understandability_constraint.py<br/>文件: blueprint_tools/ai_understandability_constraint.py"]
    src_zephyr_shared_blueprint_tools_blueprint_code_auditor_py["(生产态 / production) blueprint_tools/blueprint_code_auditor.py<br/>文件: blueprint_tools/blueprint_code_auditor.py"]
    ...
    src_zephyr_shared_capacity_governance_adaptive_sampler_py["(生产态 / production) capacity_governance/adaptive_sampler.py<br/>文件: capacity_governance/adaptive_sampler.py"]
    src_zephyr_shared_capacity_governance_budget_aware_prompt_py["(生产态 / production) capacity_governance/budget_aware_prompt.py<br/>文件: capacity_governance/budget_aware_prompt.py"]
    src_zephyr_shared_capacity_governance_capacity_calibrator_py["(生产态 / production) capacity_governance/capacity_calibrator.py<br/>文件: capacity_governance/capacity_calibrator.py"]
    src_zephyr_shared_capacity_governance_capacity_digital_twin_py["(生产态 / production) capacity_governance/capacity_digital_twin.py<br/>文件: capacity_governance/capacity_digital_twin.py"]
    src_zephyr_shared_capacity_governance_capacity_fingerprint_py["(生产态 / production) capacity_governance/capacity_fingerprint.py<br/>文件: capacity_governance/capacity_fingerprint.py"]
    src_zephyr_shared_capacity_governance_capacity_runbook_generator_py["(生产态 / production) capacity_governance/capacity_runbook_generator.py<br/>文件: capacity_governance/capacity_runbook_generator.py"]
    src_zephyr_shared_capacity_governance_cost_estimator_py["(生产态 / production) capacity_governance/cost_estimator.py<br/>文件: capacity_governance/cost_estimator.py"]
    src_zephyr_shared_capacity_governance_dependency_capacity_guard_py["(生产态 / production) capacity_governance/dependency_capacity_guard.py<br/>文件: capacity_governance/dependency_capacity_guard.py"]
    src_zephyr_shared_capacity_governance_model_capacity_probe_py["(生产态 / production) capacity_governance/model_capacity_probe.py<br/>文件: capacity_governance/model_capacity_probe.py"]
    ...
    src_zephyr_shared_contracts_backpressure_pause_py["(生产态 / production) backpressure/pause.py<br/>文件: backpressure/pause.py"]
    src_zephyr_shared_contracts_backpressure_resume_py["(生产态 / production) backpressure/resume.py<br/>文件: backpressure/resume.py"]
    src_zephyr_shared_contracts_backpressure_throttle_py["(生产态 / production) backpressure/throttle.py<br/>文件: backpressure/throttle.py"]
    ...
    src_zephyr_shared_contracts_core_gate_types_py["(生产态 / production) core/gate_types.py<br/>文件: core/gate_types.py"]
    ...
    src_zephyr_shared_contracts_core_system_configuration_py["(生产态 / production) core/system_configuration.py<br/>文件: core/system_configuration.py"]
    ...
    src_zephyr_shared_contracts_errors_contract_violation_error_py["(生产态 / production) errors/contract_violation_error.py<br/>文件: errors/contract_violation_error.py"]
    ...
    src_zephyr_shared_contracts_errors_execution_rejection_error_py["(生产态 / production) errors/execution_rejection_error.py<br/>文件: errors/execution_rejection_error.py"]
    ...
    src_zephyr_shared_contracts_errors_risk_limit_violation_error_py["(生产态 / production) errors/risk_limit_violation_error.py<br/>文件: errors/risk_limit_violation_error.py"]
    src_zephyr_shared_contracts_errors_signal_degradation_warning_py["(生产态 / production) errors/signal_degradation_warning.py<br/>文件: errors/signal_degradation_warning.py"]
    src_zephyr_shared_contracts_escalation_budget_alert_py["(生产态 / production) escalation/budget_alert.py<br/>文件: escalation/budget_alert.py"]
    ...
    src_zephyr_shared_contracts_experiment_experiment_result_py["(生产态 / production) experiment/experiment_result.py<br/>文件: experiment/experiment_result.py"]
    src_zephyr_shared_contracts_experiment_model_serving_response_py["(生产态 / production) experiment/model_serving_response.py<br/>文件: experiment/model_serving_response.py"]
    src_zephyr_shared_contracts_external_ext_001_py["(生产态 / production) external/ext_001.py<br/>文件: external/ext_001.py"]
    src_zephyr_shared_contracts_external_ext_002_py["(生产态 / production) external/ext_002.py<br/>文件: external/ext_002.py"]
    src_zephyr_shared_contracts_external_ext_003_py["(生产态 / production) external/ext_003.py<br/>文件: external/ext_003.py"]
    src_zephyr_shared_contracts_external_ext_004_py["(生产态 / production) external/ext_004.py<br/>文件: external/ext_004.py"]
    src_zephyr_shared_contracts_identity_agent_identity_py["(生产态 / production) identity/agent_identity.py<br/>文件: identity/agent_identity.py"]
    src_zephyr_shared_contracts_identity_permission_py["(生产态 / production) identity/permission.py<br/>文件: identity/permission.py"]
    ...
    src_zephyr_shared_contracts_orchestration_protocol_py["(生产态 / production) contracts/orchestration_protocol.py<br/>文件: contracts/orchestration_protocol.py"]
    src_zephyr_shared_contracts_portfolio_money_py["(生产态 / production) portfolio/money.py<br/>文件: portfolio/money.py"]
    ...
    src_zephyr_shared_contracts_security_security_decision_py["(生产态 / production) security/security_decision.py<br/>文件: security/security_decision.py"]
    src_zephyr_shared_contracts_skill_protocol_py["(生产态 / production) contracts/skill_protocol.py<br/>文件: contracts/skill_protocol.py"]
    ...
    src_zephyr_shared_foundation_env_py["(生产态 / production) foundation/env.py<br/>文件: foundation/env.py"]
    src_zephyr_shared_foundation_flags_py["(生产态 / production) foundation/flags.py<br/>文件: foundation/flags.py"]
    ...
    src_zephyr_shared_lifecycle_healthcheck_service_py["(生产态 / production) lifecycle/healthcheck_service.py<br/>文件: lifecycle/healthcheck_service.py"]
    src_zephyr_shared_lifecycle_longevity_monitor_py["(生产态 / production) lifecycle/longevity_monitor.py<br/>文件: lifecycle/longevity_monitor.py"]
    ...
    src_zephyr_shared_lifecycle_task_heartbeat_py["(生产态 / production) lifecycle/task_heartbeat.py<br/>文件: lifecycle/task_heartbeat.py"]
    src_zephyr_shared_lifecycle_ttl_cleanup_engine_py["(生产态 / production) lifecycle/ttl_cleanup_engine.py<br/>文件: lifecycle/ttl_cleanup_engine.py"]
    ...
    src_zephyr_shared_maintenance_code_economy_analyzer_py["(生产态 / production) maintenance/code_economy_analyzer.py<br/>文件: maintenance/code_economy_analyzer.py"]
    ...
    src_zephyr_shared_maintenance_owner_trust_gauge_py["(生产态 / production) maintenance/owner_trust_gauge.py<br/>文件: maintenance/owner_trust_gauge.py"]
    src_zephyr_shared_maintenance_slo_review_assistant_py["(生产态 / production) maintenance/slo_review_assistant.py<br/>文件: maintenance/slo_review_assistant.py"]
    src_zephyr_shared_maintenance_zero_config_py["(生产态 / production) maintenance/zero_config.py<br/>文件: maintenance/zero_config.py"]
    ...
    src_zephyr_shared_observability_reasoning_spans_py["(生产态 / production) observability/reasoning_spans.py<br/>文件: observability/reasoning_spans.py"]
    ...
    src_zephyr_shared_protocols_module_birth_registry_py["(生产态 / production) protocols/module_birth_registry.py<br/>文件: protocols/module_birth_registry.py"]
    ...
    src_zephyr_shared_resilience_degradation_chain_py["(生产态 / production) resilience/degradation_chain.py<br/>文件: resilience/degradation_chain.py"]
    src_zephyr_shared_resilience_error_budget_tracker_py["(生产态 / production) resilience/error_budget_tracker.py<br/>文件: resilience/error_budget_tracker.py"]
    src_zephyr_shared_resilience_fallback_py["(生产态 / production) fallback.py —— 降级策略模式（Phase 2 新增 / 零依赖）<br/>文件: resilience/fallback.py"]
    src_zephyr_shared_resilience_fault_isolator_py["(生产态 / production) resilience/fault_isolator.py<br/>文件: resilience/fault_isolator.py"]
    ...
    src_zephyr_shared_schema_schema_registry_py["(生产态 / production) schema/schema_registry.py<br/>文件: schema/schema_registry.py"]
    ...
    src_zephyr_shared_security_ssot_guard_py["(生产态 / production) security/ssot_guard.py<br/>文件: security/ssot_guard.py"]
    ...
    src_zephyr_shared_utils_zephyr_logger_py["(生产态 / production) utils/zephyr_logger.py<br/>文件: utils/zephyr_logger.py"]
    src_zephyr_shared_versioning_vibe_experiment_tracker_py["(生产态 / production) versioning/vibe_experiment_tracker.py<br/>文件: versioning/vibe_experiment_tracker.py"]
    ...
    src_zephyr_shared_contracts_core_trace_context_py["(生产态 / production) core/trace_context.py<br/>文件: core/trace_context.py"]
    ...
    src_zephyr_shared_infra_limiter_py["(生产态 / production) infra/limiter.py<br/>文件: infra/limiter.py"]
    ...
    src_zephyr_shared_schema_schemas_py["(生产态 / production) schema/schemas.py<br/>文件: schema/schemas.py"]
    ...
    src_zephyr_shared_schema_base_config_py["(生产态 / production) schema/base_config.py<br/>文件: schema/base_config.py"]
    src_zephyr_shared_schema_execution_model_py["(生产态 / production) schema/execution_model.py<br/>文件: schema/execution_model.py"]
    src_zephyr_shared_schema_severity_types_py["(生产态 / production) schema/severity_types.py<br/>文件: schema/severity_types.py"]
...
| 77 | D_FUNDAMENTAL_SIGNAL 基本面信号: Alpha信号管线 / Alpha Signal Pipeline (signal_fundamental... | → | errors.py —— ZephyrAlpha 统一错误层次（Traditional Exce... | 导入依赖 / import_depends |
| 78 | D_FUNDAMENTAL_SIGNAL 基本面信号: Alpha信号管线 / Alpha Signal Pipeline (signal_fundamental... | → | time_utils.py —— 时间/日期工具（Phase 9 新增 | 盲点 B19... | 导入依赖 / import_depends |

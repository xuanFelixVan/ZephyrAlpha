...
flowchart TD
    ...
    class D_INFRASTRUCTURE,D_INTEGRATION,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_A2A,D_TRADING external_prod
```
...
flowchart TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_FACTOR,D_DATA,D_AUTONOMY_CORE,D_INFRA_A2A,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
```
...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING,D_GOV_RULE,D_SECURITY,D_GOVERNANCE external_prod
```
...
flowchart TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTEGRATION,D_ORCHESTRATOR,D_GOVERNANCE,D_INTELLIGENCE external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_FEEDBACK_LOOP,D_GOV_RULE,D_ML_TRAIN,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_DRIFT external_prod
```

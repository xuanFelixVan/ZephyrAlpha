...
flowchart TD
    ...
    class D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_SECURITY,D_INTEGRATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_TRADING,D_GOV_ENFORCEMENT external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_TRADING,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_A2A external_prod
```
...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_SECURITY,D_INFRA_RUNTIME,D_TRADING,D_ORCHESTRATOR,D_GOV_RULE,D_GOV_OPS_RESILIENCE external_prod
```
...
flowchart TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_GOV_RULE,D_ML_TRAIN,D_INTEGRATION,D_GOVERNANCE,D_TRADING,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_DRIFT,D_DATA external_prod
```

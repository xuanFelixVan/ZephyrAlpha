...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_FEEDBACK_LOOP,D_ML_TRAIN,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_DRIFT,D_RISK,D_GOV_AUDIT,D_INFRA_RECOVERY,D_EX_CORE external_prod
```

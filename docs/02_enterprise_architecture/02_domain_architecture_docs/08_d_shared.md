...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE,D_ML_TRAIN,D_DATA,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOVERNANCE,D_INTEGRATION external_prod
```

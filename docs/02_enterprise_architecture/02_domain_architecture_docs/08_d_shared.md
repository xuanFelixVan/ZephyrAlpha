...
flowchart TD
    ...
    D_FUNDAMENTAL_SIGNAL -->|导入依赖 / import_depends| src_zephyr_shared_utils_time_utils_py
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_RULE,D_FEEDBACK_LOOP,D_ML_TRAIN,D_GOVERNANCE,D_INTEGRATION,D_FBL_DIAGNOSERS,D_INTELLIGENCE,D_MKT_DATA,D_GOV_SCRIPTS,D_GOV_DRIFT,D_FUNDAMENTAL_SIGNAL,D_AUTONOMY_CORE external_prod
```

...
flowchart TD
    ...
    D_GOV_ENFORCEMENT -->|导入依赖 / import_depends| src_zephyr_shared_io_paths_py
    D_GOVERNANCE -->|导入依赖 / import_depends| src_zephyr_shared_foundation_models_py
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE,D_INFRASTRUCTURE,D_ML_TRAIN,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_SECURITY,D_ORCHESTRATOR,D_GOVERNANCE,D_EX_CORE,D_INTEGRATION,D_OPS external_prod
```

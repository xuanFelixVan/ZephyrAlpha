...
flowchart TD
    ...
    D_GOV_AUDIT -->|测试依赖 / test_depends| src_zephyr_shared_io_workspace_telemetry_py
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_RULE,D_ML_TRAIN,D_DATA,D_GOV_AUDIT,D_EX_SOR,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_BACKTEST external_prod
```

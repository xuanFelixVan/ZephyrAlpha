...
flowchart TD
    ...
    class D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_SECURITY,D_INTEGRATION,D_TRADING,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
```
...
flowchart TD
    ...
    D_INFRA_A2A -->|导入依赖 / import_depends| src_zephyr_shared_io_paths_py
    ...
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOVERNANCE,D_GOV_DRIFT,D_TRADING,D_INFRA_RECOVERY,D_INFRA_A2A,D_GOV_CODE_QUALITY,D_GOV_AUDIT external_prod
```
...
flowchart TD
    ...
    class D_GOV_RULE,D_DATA,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FACTOR,D_GOV_OPS_RESILIENCE,D_INFRA_A2A,D_FEEDBACK_LOOP external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_GOV_RULE,D_ML_TRAIN,D_GOV_SCRIPTS,D_GOVERNANCE,D_INTEGRATION,D_GOV_DRIFT,D_DATA,D_TRADING,D_INFRA_RECOVERY,D_INFRA_A2A,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod
```

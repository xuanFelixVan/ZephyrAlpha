...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_RULE,D_INFRA_RUNTIME,D_ML_TRAIN,D_INTEGRATION,D_SECURITY,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_ORCHESTRATOR external_prod
```

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_DRIFT,D_TRADING,D_INTEGRATION,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_A2A,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FACTOR,D_DATA,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_RULE,D_DATA,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING,D_SECURITY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_GOV_RULE,D_ML_TRAIN,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_SECURITY,D_GOV_CODE_QUALITY,D_INFRA_A2A,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INTEGRATION external_prod
```

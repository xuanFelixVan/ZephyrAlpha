...
flowchart TD
    ...
    D_ORCHESTRATOR -->|导入依赖 / import_depends| src_zephyr_shared_infra_process_pool_py
    ...
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_shared_foundation_models_py
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_RULE,D_ML_TRAIN,D_DATA,D_FRONTEND,D_REPORTING,D_TRADING,D_INTEGRATION,D_ORCHESTRATOR,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
```

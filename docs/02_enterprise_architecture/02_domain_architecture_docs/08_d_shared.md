...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_RULE,D_ML_TRAIN,D_DATA,D_GOV_DRIFT,D_GOVERNANCE,D_EX_SOR,D_ORCHESTRATOR,D_INTEGRATION,D_SELL_DECISION external_prod
```

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SECURITY,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOV_CODE_QUALITY,D_DATA,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_DATA,D_FACTOR,D_INFRA_A2A,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_TRADING,D_INFRA_RUNTIME,D_GOV_RULE,D_SECURITY,D_INTEGRATION,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_GOV_RULE,D_ML_TRAIN,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_AUDIT,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
```

...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_RULE,D_INFRA_RUNTIME,D_ML_TRAIN,D_GOV_CODE_QUALITY,D_INTEGRATION,D_GOV_DRIFT,D_SECURITY,D_AUTONOMY_CORE,D_GOV_AUDIT,D_POSITION,D_RISK,D_TRADING external_prod
```

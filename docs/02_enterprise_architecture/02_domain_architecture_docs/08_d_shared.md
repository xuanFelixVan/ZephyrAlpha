...
flowchart TD
    ...
    src_zephyr_shared_capacity_governance_model_capacity_probe_py["模型容量probe<br/>模型容量probe模块<br/>model_capacity_probe<br/>文件: capacity_governance/model_capacity_<br/>probe.py<br/>(生产态 / production)"]

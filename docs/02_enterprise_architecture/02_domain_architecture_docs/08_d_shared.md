...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_DATA,D_INTEGRATION,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_DRIFT,D_TRADING,D_INFRA_RECOVERY,D_INFRA_A2A,D_GOV_CODE_QUALITY external_prod
```
...
flowchart TD
    ...
    class D_DATA,D_GOV_AUDIT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOVERNANCE,D_INTEGRATION,D_INTELLIGENCE external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_GOV_RULE,D_ML_TRAIN,D_DATA,D_INTEGRATION,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_DRIFT,D_TRADING,D_INFRA_RECOVERY,D_INFRA_A2A external_prod
```

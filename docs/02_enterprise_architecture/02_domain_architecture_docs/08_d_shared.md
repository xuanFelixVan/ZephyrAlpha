...
flowchart TD
    ...
    class D_INFRASTRUCTURE,D_SECURITY,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_SCRIPTS,D_INTEGRATION,D_GOV_DRIFT external_prod
```
...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SECURITY,D_TRADING,D_GOV_RULE,D_GOVERNANCE external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_FEEDBACK_LOOP,D_GOV_RULE,D_ML_TRAIN,D_AUTONOMY_CORE,D_SECURITY,D_TRADING,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INTEGRATION external_prod
```

...
flowchart TD
    ...
    D_TRADING -->|导入依赖 / import_depends| src_zephyr_shared_infra_process_pool_py
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_RULE,D_ML_TRAIN,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RECOVERY,D_TRADING external_prod
```

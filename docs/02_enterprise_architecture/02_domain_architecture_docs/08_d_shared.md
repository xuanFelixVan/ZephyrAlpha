...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOV_RULE,D_ML_TRAIN,D_GOVERNANCE,D_INTEGRATION,D_GOV_CODE_QUALITY,D_INTELLIGENCE,D_AUTONOMY_CORE,D_BACKTEST,D_SECURITY external_prod
```

...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_FEEDBACK_LOOP,D_ML_TRAIN,D_GOVERNANCE,D_DATA,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY external_prod
```

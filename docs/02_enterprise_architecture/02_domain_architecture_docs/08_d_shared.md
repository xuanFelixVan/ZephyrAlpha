...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_RULE,D_ML_TRAIN,D_GOVERNANCE,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_INFRA_RECOVERY,D_TRADING,D_SECURITY external_prod
```

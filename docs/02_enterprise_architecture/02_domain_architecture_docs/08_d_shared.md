...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_RULE,D_INFRASTRUCTURE,D_ML_TRAIN,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_BACKTEST,D_DATA,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_SECURITY external_prod
```

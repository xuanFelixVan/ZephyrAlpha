...
flowchart TD
    ...
    D_ML_TRAIN -->|导入依赖 / import_depends| src_zephyr_shared_io_paths_py
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE,D_ML_TRAIN,D_INTEGRATION,D_GOV_CODE_QUALITY,D_TRADING,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
```

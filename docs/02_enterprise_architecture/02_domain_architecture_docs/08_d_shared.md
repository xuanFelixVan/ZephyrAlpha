...
flowchart TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_ML_TRAIN,D_DATA,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY external_prod
```

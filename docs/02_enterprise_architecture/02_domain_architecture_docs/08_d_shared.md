...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_FEEDBACK_LOOP,D_ML_TRAIN,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_MKT_DATA,D_INTELLIGENCE,D_DATA,D_SECURITY,D_ORCHESTRATOR,D_REPORTING external_prod
```

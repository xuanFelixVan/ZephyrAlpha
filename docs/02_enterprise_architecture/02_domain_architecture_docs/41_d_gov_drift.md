...
graph TD
    ...
    class D_GOV_DOCS,D_SHARED,D_SECURITY,D_COMPLIANCE,D_GOV_AUDIT,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RECOVERY,D_SECURITY,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_INTEGRATION,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_AUDIT external_prod
    class D_COMPLIANCE,D_INFRASTRUCTURE,D_INFRA_RECOVERY,D_SECURITY external_design
```
...
| 15 | validate_ssot.py | → | D_GOV_SCRIPTS 脚本治理: 文件头部格式解析 SSoT（Single Source of Truth）... | 导入依赖 / import_depends |

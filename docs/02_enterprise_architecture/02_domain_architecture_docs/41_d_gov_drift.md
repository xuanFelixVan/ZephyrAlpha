...
graph TD
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_dashboard_py
    ...
    class D_GOVERNANCE,D_GOV_DOCS,D_FBL_VERIFICATION,D_INFRA_A2A,D_COMPLIANCE,D_SECURITY,D_GOV_AUDIT,D_INFRA_RECOVERY,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_SECURITY,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_GOV_AUDIT,D_SECURITY,D_COMPLIANCE,D_INFRA_A2A external_design
```
...
| 4 | blueprint.md | → | D_GOVERNANCE 生命周期管理: depgraph_reader.py — 依赖图数据库查询工具模块 ... | runtime / runtime |

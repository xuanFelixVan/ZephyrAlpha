...
graph TD
    ...
    class D_GOV_DOCS,D_GOV_AUDIT,D_SHARED,D_SECURITY,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_GOVERNANCE,D_GOV_RULE,D_GOV_AUDIT external_prod
    class D_COMPLIANCE,D_SECURITY external_design
```

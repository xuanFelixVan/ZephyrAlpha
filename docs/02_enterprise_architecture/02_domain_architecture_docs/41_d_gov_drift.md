...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_DOCS,D_SECURITY,D_COMPLIANCE,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
    class D_SHARED,D_SECURITY,D_COMPLIANCE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_COMPLIANCE,D_INFRA_RUNTIME external_design
```

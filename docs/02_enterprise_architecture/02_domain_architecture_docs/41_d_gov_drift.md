...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RECOVERY,D_SECURITY,D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
    class D_COMPLIANCE,D_GOV_ENFORCEMENT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_RULE external_prod
    class D_INTEGRATION,D_COMPLIANCE,D_INTELLIGENCE,D_SECURITY,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
```

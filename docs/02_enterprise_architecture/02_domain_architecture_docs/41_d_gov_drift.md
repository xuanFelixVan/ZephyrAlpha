...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_forensics_engine_py
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_AUDIT,D_GOV_REPAIR external_prod
    class D_INTEGRATION,D_INTELLIGENCE,D_SECURITY,D_COMPLIANCE external_design
```

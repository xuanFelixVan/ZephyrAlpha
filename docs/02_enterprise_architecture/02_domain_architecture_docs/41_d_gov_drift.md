...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_INFRA_RUNTIME,D_GOV_RULE external_prod
    class D_GOV_AUDIT,D_INTEGRATION,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY,D_INFRA_RECOVERY,D_GOVERNANCE,D_INTEGRATION,D_OPS,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_SECURITY external_prod
    class D_GOV_AUDIT,D_COMPLIANCE,D_GOV_RULE external_design
```

...
graph TD
    ...
    class D_GOV_DOCS,D_GOV_CODE_QUALITY,D_SECURITY,D_COMPLIANCE,D_INFRA_A2A,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_OPS,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_COMPLIANCE,D_INFRA_A2A,D_SECURITY external_design
```

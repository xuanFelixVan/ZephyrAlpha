...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DOCS,D_FBL_VERIFICATION,D_COMPLIANCE,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_GOV_AUDIT,D_INFRA_RECOVERY,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SECURITY,D_COMPLIANCE,D_KNOWLEDGE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_COMPLIANCE,D_INFRASTRUCTURE,D_SECURITY external_design
```
...
| 24 | blueprint.md | → | D_SECURITY 对抗验证: OutputGuard — 输出内容守卫. (output_guard.py) | runtime / runtime |

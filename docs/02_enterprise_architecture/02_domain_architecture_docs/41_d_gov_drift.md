...
graph TD
    ...
    class D_COMPLIANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_GOV_AUDIT,D_INTELLIGENCE,D_SECURITY,D_COMPLIANCE external_design
```

...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME external_prod
    class D_GOV_DOCS,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_INFRA_RECOVERY,D_GOVERNANCE,D_OPS,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_RULE,D_INFRA_RUNTIME,D_OPS external_prod
...
graph TD
    ...
    class D_GOV_DOCS,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_design
```
...
| 23 | blueprint.md | → | D_SECURITY 对抗验证: AgentRbac 异常类型. (exceptions.py) | runtime / runtime |

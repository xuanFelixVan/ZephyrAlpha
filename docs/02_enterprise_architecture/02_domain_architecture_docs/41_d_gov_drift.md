...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INFRA_RECOVERY,D_COMPLIANCE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RUNTIME,D_SECURITY,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_INTEGRATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOV_REPAIR external_prod
    class D_INFRA_RUNTIME,D_SECURITY,D_COMPLIANCE,D_INFRASTRUCTURE external_design
```

...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_COMPLIANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
    class D_SECURITY,D_SHARED,D_COMPLIANCE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_INTELLIGENCE,D_SECURITY,D_COMPLIANCE,D_INFRA_RUNTIME external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DOCS,D_FBL_VERIFICATION,D_INFRA_A2A,D_COMPLIANCE,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE,D_INTELLIGENCE,D_SECURITY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_REPAIR external_prod
    class D_GOV_AUDIT,D_INTELLIGENCE,D_COMPLIANCE,D_SECURITY,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOV_DOCS,D_GOVERNANCE,D_COMPLIANCE,D_INFRA_A2A,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_design
```
...
| 144 | D_INFRA_RUNTIME 运行时集成: logs/structured_sink — 结构化日志管道（D_SYSTE... | → | blueprint.md | runtime / runtime |

...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_GOV_AUDIT,D_COMPLIANCE,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_COMPLIANCE,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_OPS external_prod
    class D_KNOWLEDGE,D_COMPLIANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_AUDIT,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod

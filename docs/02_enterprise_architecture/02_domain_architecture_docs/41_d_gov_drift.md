...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DOCS,D_FBL_VERIFICATION,D_INFRA_A2A,D_COMPLIANCE,D_SECURITY,D_INFRA_RECOVERY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    D_SECURITY -.->|导入依赖 / import_depends| src_zephyr_gov_drift_handoff_manager_py
    ...
    class D_SHARED,D_GOVERNANCE,D_OPS,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE external_prod

...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_SHARED,D_INFRA_RECOVERY,D_INTEGRATION,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME external_prod
    class D_SECURITY,D_KNOWLEDGE,D_COMPLIANCE,D_INFRA_A2A,D_INTELLIGENCE external_design
```

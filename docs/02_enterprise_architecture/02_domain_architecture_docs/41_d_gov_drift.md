...
graph TD
    ...
    src_zephyr_gov_drift_init_py -.->|config_depends / config_depends| src_zephyr_gov_drift_ai_context_injector_py
    ...
    class D_FBL_VERIFICATION,D_SHARED external_prod
    class D_GOVERNANCE,D_GOV_DOCS,D_INFRA_A2A,D_COMPLIANCE,D_SECURITY,D_GOV_AUDIT,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_test_fixture_checker_py
...
| 2 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
...
| 52 | D_GOVERNANCE 生命周期管理: G-CT-006 — BudgetAlert re-exported from shared... | → | blueprint.md | contract / contract |

...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DOCS,D_FBL_VERIFICATION,D_COMPLIANCE,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_drift_result_types_py
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_GOV_SCRIPTS,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_KNOWLEDGE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_COMPLIANCE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_DOCS,D_GOVERNANCE,D_COMPLIANCE,D_FBL_VERIFICATION,D_AUTONOMY_CORE external_design
```
...
| 24 | blueprint.md | → | D_SECURITY 对抗验证: NovelAttackGuard — 新型攻击行为画像. (novel_at... | runtime / runtime |

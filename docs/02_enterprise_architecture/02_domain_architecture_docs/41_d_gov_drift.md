...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT,D_COMPLIANCE,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RUNTIME,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_INFRA_RECOVERY,D_GOVERNANCE,D_INTEGRATION,D_OPS,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
    class D_INTELLIGENCE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_REPAIR external_prod
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTELLIGENCE,D_COMPLIANCE,D_INFRA_RECOVERY,D_SECURITY external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_SECURITY,D_INFRA_RUNTIME,D_OPS external_prod

...
graph TD
    ...
    class D_GOV_DOCS,D_SHARED,D_SECURITY,D_COMPLIANCE external_design
```
...
graph TD
    ...
    src_zephyr_governance_integrity_py -->|导入依赖 / import_depends| D_GOV_AUDIT
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_trend_analyzer_py

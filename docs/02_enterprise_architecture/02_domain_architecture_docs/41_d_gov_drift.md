...
graph TD
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_audit_drift_bridge_py
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_OPS external_prod
...
graph TD
    ...
    class D_GOV_DOCS,D_COMPLIANCE,D_INFRA_A2A,D_FBL_VERIFICATION external_design
```
...
| 3 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Blueprint Reconciler — v0.10.0 蓝图实现一致性.... | runtime / runtime |
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — IDE Watcher (ide_wat... | → | blueprint.md | runtime / runtime |

...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_GOV_SCRIPTS,D_SECURITY,D_INTELLIGENCE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_KNOWLEDGE,D_COMPLIANCE,D_SECURITY,D_INTELLIGENCE,D_INFRA_RECOVERY external_design
```

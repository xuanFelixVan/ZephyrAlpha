...
graph TD
    ...
    class D_GOV_DOCS,D_SHARED,D_SECURITY,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_SECURITY external_design
```

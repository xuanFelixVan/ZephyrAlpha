...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_OPS external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_OPS,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_COMPLIANCE,D_SECURITY external_design
```

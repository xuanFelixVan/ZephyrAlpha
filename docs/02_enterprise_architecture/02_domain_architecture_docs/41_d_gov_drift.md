...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
    class D_GOV_DOCS,D_SECURITY,D_COMPLIANCE,D_GOV_AUDIT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
    class D_INTEGRATION,D_COMPLIANCE,D_GOV_SCRIPTS,D_SECURITY external_design
```

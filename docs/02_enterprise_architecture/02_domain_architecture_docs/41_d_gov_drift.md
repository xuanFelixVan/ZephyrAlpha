...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_COMPLIANCE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_DOCS,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INFRA_RECOVERY,D_GOV_AUDIT,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
```
...
| 23 | blueprint.md | → | D_SECURITY 对抗验证: DryRun — 权限模拟与影响分析. (dry_run.py) | runtime / runtime |

...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_INTEGRATION,D_OPS external_prod
    class D_SECURITY,D_INTELLIGENCE,D_COMPLIANCE external_design
```

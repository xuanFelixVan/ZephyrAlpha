...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_OPS,D_INFRA_RUNTIME external_prod
...
| 23 | blueprint.md | → | D_SECURITY 对抗验证: CrossCutting — 横切面权限组件. (cross_cutting.py) | runtime / runtime |

...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DOCS,D_FBL_VERIFICATION,D_INFRA_A2A,D_COMPLIANCE,D_SECURITY,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRA_RECOVERY,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE,D_SECURITY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    D_COMPLIANCE -.->|导入依赖 / import_depends| src_zephyr_gov_drift_credibility_engine_py
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_suppression_learner_py
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_INFRA_RECOVERY,D_COMPLIANCE external_design
```
...
| 2 | blueprint.md | → | D_FBL_VERIFICATION 反馈验证: _operational_gates.py | runtime / runtime |

...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_GOV_AUDIT,D_INFRA_A2A,D_COMPLIANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_drift_infrastructure_py
    D_SECURITY["(原型态 / prototype) D_SECURITY"]
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_gov_drift_drift_hotfix_bypass_py
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_RULE,D_OPS external_prod

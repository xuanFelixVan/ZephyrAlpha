...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_COMPLIANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTELLIGENCE,D_COMPLIANCE external_design
```

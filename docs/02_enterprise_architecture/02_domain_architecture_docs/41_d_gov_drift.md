...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_COMPLIANCE,D_INFRASTRUCTURE,D_INTELLIGENCE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
    class D_GOV_AUDIT,D_SECURITY,D_COMPLIANCE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_SECURITY,D_INFRA_RUNTIME,D_COMPLIANCE,D_INTELLIGENCE,D_INFRASTRUCTURE external_design
```

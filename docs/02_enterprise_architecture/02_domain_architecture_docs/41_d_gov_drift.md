...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_GOV_AUDIT,D_COMPLIANCE,D_INTELLIGENCE,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_SECURITY,D_COMPLIANCE,D_INTELLIGENCE external_design
```

...
graph TD
    ...
    class D_GOV_DOCS,D_SECURITY,D_COMPLIANCE,D_INTELLIGENCE,D_GOV_AUDIT,D_INFRA_A2A,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_INFRA_RUNTIME,D_OPS,D_GOV_ENFORCEMENT external_prod

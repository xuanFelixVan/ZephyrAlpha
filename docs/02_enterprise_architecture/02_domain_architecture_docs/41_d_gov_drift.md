...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_DOCS,D_SECURITY,D_COMPLIANCE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_COMPLIANCE,D_INFRA_RUNTIME,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_SCRIPTS,D_OPS,D_GOV_RULE external_prod

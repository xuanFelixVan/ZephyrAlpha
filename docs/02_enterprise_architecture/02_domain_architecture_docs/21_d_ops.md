...
graph TD
    ...
    D_INTELLIGENCE -.->|测试依赖 / test_depends| src_zephyr_governance_ops_governance_budget_handler_py
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_INTEGRATION external_prod

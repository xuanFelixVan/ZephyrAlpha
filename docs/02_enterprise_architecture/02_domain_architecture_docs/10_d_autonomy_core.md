...
flowchart TD
    ...
    class D_SECURITY,D_SHARED,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY external_prod
```
...
flowchart TD
    ...
    class D_SECURITY,D_INFRA_RUNTIME,D_SHARED,D_GOV_AUDIT,D_INTEGRATION,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_REPAIR external_prod
```

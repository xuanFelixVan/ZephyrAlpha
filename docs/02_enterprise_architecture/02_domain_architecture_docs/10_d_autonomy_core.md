...
flowchart TD
    ...
    src_zephyr_autonomy_core_file_autoregister_py["(生产态 / production) autonomy_core/file_autoregister.py<br/>文件: autonomy_core/file_autoregister.py"]
    ...
    src_zephyr_autonomy_core_skills_skill_executor_py["(生产态 / production) skills/skill_executor.py<br/>文件: skills/skill_executor.py"]
    ...
    src_zephyr_autonomy_core_skills_skill_router_py["(生产态 / production) skills/skill_router.py<br/>文件: skills/skill_router.py"]
    ...
    src_zephyr_autonomy_core_skills_skill_factory_py["(生产态 / production) skills/skill_factory.py<br/>文件: skills/skill_factory.py"]
    ...
    src_zephyr_autonomy_core_trigger_router_py["(生产态 / production) autonomy_core/trigger_router.py<br/>文件: autonomy_core/trigger_router.py"]
    ...
    src_zephyr_autonomy_core_skills_skill_loader_py["(生产态 / production) skills/skill_loader.py<br/>文件: skills/skill_loader.py"]
    src_zephyr_autonomy_core_skills_skill_model_py["(生产态 / production) skills/skill_model.py<br/>文件: skills/skill_model.py"]
    ...
    src_zephyr_autonomy_core_context_context_rule_registry_py["(生产态 / production) context/context_rule_registry.py<br/>文件: context/context_rule_registry.py"]

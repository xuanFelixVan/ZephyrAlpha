...
flowchart TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_SECURITY,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INTEGRATION external_prod

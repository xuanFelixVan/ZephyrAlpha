...
flowchart TD
    ...
    src_zephyr_autonomy_core_context_context_budget_tracker_py["上下文预算追踪器<br/>上下文预算追踪器。ContextBudgetTracker: token<br/>budget management with 3-level thresholds<br/>ContextBudgetTracker: token budget management<br/>with 3-level thresholds.<br/>文件: context/context_budget_tracker.py<br/>(生产态 / production)"]

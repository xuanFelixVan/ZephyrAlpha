...
flowchart TD
    ...
    src_zephyr_autonomy_core_context_ce_file_lister_py["ce文件lister<br/>list_ce_files.py — CE 文件清单生成器<br/>ce_file_lister<br/>文件: context/ce_file_lister.py<br/>(生产态 / production)"]
    ...
    src_zephyr_autonomy_core_context_position_optimizer_py["持仓优化器<br/>position_optimizer.py — 位置优化 (DD104,<br/>TASK-019)<br/>文件: context/position_optimizer.py<br/>(生产态 / production)"]

...
flowchart TD
    ...
    src_zephyr_autonomy_core_context_ce_playground_v2_py["CE演练场v2<br/>CE演练场v2，context的结果，封装操作结果的数据结<br/>构。<br/>ce_playground_v2.py — V2 Playground with full<br/>decision chain (TASK-016)<br/>文件: context/ce_playground_v2.py<br/>(生产态 / production)"]
    ...
    src_zephyr_autonomy_core_context_context_budget_tracker_py["上下文预算追踪器<br/>上下文预算追踪器。ContextBudgetTracker: token<br/>budget management with 3-level thresholds.<br/>文件: context/context_budget_tracker.py<br/>(生产态 / production)"]

...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SECURITY,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_SECURITY,D_GOV_REPAIR external_prod
```

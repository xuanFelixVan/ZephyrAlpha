...
flowchart TD
    src_zephyr_autonomy_core_main_py["autonomy_core/__main__<br/>agent-spec MOD-INF-019 CLI — 蓝图->Skill<br/>升级引擎入口.<br/>文件: autonomy_core/__main__.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_agent_observability_py["autonomy_core/agent_observability<br/>MOD-INF-019: Agent Spec — Agent Observability<br/>文件: autonomy_core/agent_observability.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_all_skill_modules_py["autonomy_core/all_skill_modules<br/>MOD-INF-019: Agent Spec — All Skill Modules<br/>文件: autonomy_core/all_skill_modules.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_atomic_injector_py["context/atomic_injector<br/>atomic_injector.py — 原子注入 (DD101, TASK-019)<br/>文件: context/atomic_injector.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_ce_bootstrap_py["context/ce_bootstrap<br/>ce_bootstrap.py — CE 自举架构 (B1, DD75,<br/>TASK-015 beta v)<br/>文件: context/ce_bootstrap.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_ce_explain_cli_py["context/ce_explain_cli<br/>ce_explain_cli.py — KE inclusion rationale 解释<br/>CLI (TASK-016)<br/>文件: context/ce_explain_cli.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_ce_file_lister_py["context/ce_file_lister<br/>list_ce_files.py — CE 文件清单生成器<br/>文件: context/ce_file_lister.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_ce_playground_v2_py["context/ce_playground_v2<br/>ce_playground_v2.py — V2 Playground with full<br/>decision chain (TASK-016)<br/>文件: context/ce_playground_v2.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_ce_vibe_shortcuts_py["context/ce_vibe_shortcuts<br/>ce_vibe_shortcuts.py — Vibe/Strict 模式切换<br/>(TASK-016)<br/>文件: context/ce_vibe_shortcuts.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_checkpoint_manager_py["context/checkpoint_manager<br/>checkpoint_manager.py — Inject 前快照 (DD100,<br/>TASK-019)<br/>文件: context/checkpoint_manager.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_cold_start_booster_py["context/cold_start_booster<br/>cold_start_booster.py — 冷启动 (DD107, TASK-019)<br/>文件: context/cold_start_booster.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_complexity_budget_py["context/complexity_budget<br/>complexity_budget.py — Token 预算复杂度因子<br/>(DD103, TASK-019)<br/>文件: context/complexity_budget.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_budget_py["context/context_budget<br/>TruncationStrategy — TruncationStrategy<br/>文件: context/context_budget.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_budget_tracker_py["context/context_budget_tracker<br/>ContextBudgetTracker: token budget management<br/>with 3-level thresholds.<br/>文件: context/context_budget_tracker.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_debt_score_py["context/context_debt_score<br/>context_debt_score.py — 上下文债务评分 (B19,<br/>DD93, TASK-017)<br/>文件: context/context_debt_score.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_evaluator_py["context/context_evaluator<br/>context_evaluator.py — AI 引用率评估 (TASK-014<br/>beta b)<br/>文件: context/context_evaluator.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_evictor_py["context/context_evictor<br/>context_evictor.py — 三维逐出器 (DD9, TASK-014<br/>beta a)<br/>文件: context/context_evictor.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_health_score_py["context/context_health_score<br/>ContextHealthScore.py — 统一健康分 (B6, DD80,<br/>TASK-015 beta v)<br/>文件: context/context_health_score.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_model_strategy_py["context/context_model_strategy<br/>context_model_strategy.py — 模型选择策略<br/>(DD118, TASK-020)<br/>文件: context/context_model_strategy.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_outcome_tracker_py["context/context_outcome_tracker<br/>context_outcome_tracker.py — 因果链追踪 (B14,<br/>DD88, TASK-017)<br/>文件: context/context_outcome_tracker.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_pipeline_auto_py["context/context_pipeline_auto<br/>context_pipeline_auto.py — ContextPipeline<br/>三层自动化机制<br/>文件: context/context_pipeline_auto.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_playground_py["context/context_playground<br/>context_playground.py — 上下文沙箱 dry-run (B5,<br/>DD79, TASK-015 beta v)<br/>文件: context/context_playground.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_rot_model_py["context/context_rot_model<br/>context_rot_model.py — Context Rot<br/>注意力衰减数学模型<br/>文件: context/context_rot_model.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_value_attribution_py["context/context_value_attribution<br/>context_value_attribution.py — KE 级 ROI 归因<br/>(B2, DD76, TASK-015 beta v)<br/>文件: context/context_value_attribution.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_contextual_fetch_api_py["context/contextual_fetch_api<br/>contextual_fetch_api.py — HTTP FE 对外 API<br/>(DD115, TASK-020)<br/>文件: context/contextual_fetch_api.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_curation_loop_py["context/curation_loop<br/>curation_loop.py — Per-Turn Curation 策展<br/>(DD10, TASK-014 beta b)<br/>文件: context/curation_loop.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_diff_injector_py["context/diff_injector<br/>diff_injector.py — 增量注入 (DD98, TASK-019)<br/>文件: context/diff_injector.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_diversity_constraint_py["context/diversity_constraint<br/>diversity_constraint.py — 多样性约束 (DD119,<br/>TASK-020)<br/>文件: context/diversity_constraint.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_domain_decay_config_py["context/domain_decay_config<br/>domain_decay_config.py — 每领域半衰期 (DD105,<br/>TASK-019)<br/>文件: context/domain_decay_config.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_fallback_staleness_gate_py["context/fallback_staleness_gate<br/>fallback_staleness_gate.py — 兜底层自腐检测<br/>(B13, DD87, TASK-017)<br/>文件: context/fallback_staleness_gate.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_integrity_check_py["context/integrity_check<br/>integrity_check.py — 注入后完整性 (DD106,<br/>TASK-019)<br/>文件: context/integrity_check.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_memory_bank_py["context/memory_bank<br/>memory_bank.py — AI 读写结构化持久上下文 (DD:<br/>memory_bank, TASK-014 beta c)<br/>文件: context/memory_bank.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_mode_manager_py["context/mode_manager<br/>mode_manager.py — 模式管理器 (DD102, TASK-019)<br/>文件: context/mode_manager.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_position_optimizer_py["context/position_optimizer<br/>position_optimizer.py — 位置优化 (DD104,<br/>TASK-019)<br/>文件: context/position_optimizer.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_shadow_canary_py["context/shadow_canary<br/>shadow_canary.py — 金丝雀部署 (B4, DD78,<br/>TASK-015 beta w)<br/>文件: context/shadow_canary.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_staleness_manager_py["context/staleness_manager<br/>staleness_manager.py — 全局过期检测 (DD112,<br/>TASK-019)<br/>文件: context/staleness_manager.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_vector_bridge_py["context/vector_bridge<br/>VectorBridge — CE↔VMS 检索桥接 (Connect<br/>CT-CE-VMS-001)<br/>文件: context/vector_bridge.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_file_autoregister_py["autonomy_core/file_autoregister<br/>autonomy core包的file_autoregister模块<br/>文件: autonomy_core/file_autoregister.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_ide_watcher_py["autonomy_core/ide_watcher<br/>MOD-INF-019: Agent Spec — IDE Watcher<br/>文件: autonomy_core/ide_watcher.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_integration_pipeline_bridge_py["integration/pipeline_bridge<br/>PipelineSkillBridge — Agent Spec -> Pipeline<br/>双向桥接<br/>文件: integration/pipeline_bridge.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_phase_planner_py["autonomy_core/phase_planner<br/>MOD-INF-019: Agent Spec — Phase Planner<br/>文件: autonomy_core/phase_planner.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_progressive_disclosure_injector_py["autonomy_core/progressive_disclosure_injector<br/>progressive_disclosure_injector.py — 渐进式披露<br/>(B7, DD81, TASK-015 beta w)<br/>文件: autonomy_core<br/>/progressive_disclosure_injector.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_prompt_registry_py["autonomy_core/prompt_registry<br/>PromptRegistry: YAML-driven Prompt 模板注册表<br/>文件: autonomy_core/prompt_registry.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_self_evolution_fidelity_gate_py["autonomy_core/self_evolution_fidelity_gate<br/>MOD-INF-019: Agent Spec — Self Evolution<br/>Fidelity Gate<br/>文件: autonomy_core<br/>/self_evolution_fidelity_gate.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skill_rbac_registry_py["autonomy_core/skill_rbac_registry<br/>G-CT-003: Agent Spec -> RBAC capability check.<br/>文件: autonomy_core/skill_rbac_registry.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_attention_py["skills/skill_attention<br/>MOD-INF-019: Agent Spec — Skill Attention<br/>Management<br/>文件: skills/skill_attention.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_breakage_checker_py["skills/skill_breakage_checker<br/>MOD-INF-019: Agent Spec — Skill Breakage Checker<br/>文件: skills/skill_breakage_checker.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_cache_provider_py["skills/skill_cache_provider<br/>MOD-INF-019: Agent Spec — Skill Cache Provider<br/>文件: skills/skill_cache_provider.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_calibration_py["skills/skill_calibration<br/>MOD-INF-019: Agent Spec — Skill Calibration<br/>文件: skills/skill_calibration.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_canary_py["skills/skill_canary<br/>MOD-INF-019: Agent Spec — Skill Canary<br/>文件: skills/skill_canary.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_cognitive_preservation_py["skills/skill_cognitive_preservation<br/>MOD-INF-019: Agent Spec — Skill Cognitive<br/>Preservation<br/>文件: skills/skill_cognitive_preservation.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_compliance_py["skills/skill_compliance<br/>MOD-INF-019: Agent Spec — Skill Compliance<br/>文件: skills/skill_compliance.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_consensus_py["skills/skill_consensus<br/>MOD-INF-019: Agent Spec — Skill Consensus<br/>文件: skills/skill_consensus.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_constructor_py["skills/skill_constructor<br/>MOD-INF-019: Agent Spec — Skill Constructor<br/>文件: skills/skill_constructor.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_context_isolation_py["skills/skill_context_isolation<br/>MOD-INF-019: Agent Spec — Context Isolation<br/>文件: skills/skill_context_isolation.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_contract_py["skills/skill_contract<br/>MOD-INF-019: Agent Spec — Skill Contract<br/>文件: skills/skill_contract.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_cross_model_py["skills/skill_cross_model<br/>MOD-INF-019: Agent Spec — Skill Cross-Model<br/>文件: skills/skill_cross_model.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_di_py["skills/skill_di<br/>MOD-INF-019: Agent Spec — Skill Dependency<br/>Injection<br/>文件: skills/skill_di.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_discovery_py["skills/skill_discovery<br/>MOD-INF-019: Agent Spec — Skill Discovery<br/>文件: skills/skill_discovery.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_durable_py["skills/skill_durable<br/>MOD-INF-019: Agent Spec — Durable Execution<br/>文件: skills/skill_durable.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_economics_py["skills/skill_economics<br/>MOD-INF-019: Agent Spec — Skill Economics<br/>文件: skills/skill_economics.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_efficacy_calibrator_py["skills/skill_efficacy_calibrator<br/>MOD-INF-019: Agent Spec — Skill Efficacy<br/>Calibrator<br/>文件: skills/skill_efficacy_calibrator.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_executor_py["skills/skill_executor<br/>skills包的skill_executor模块<br/>文件: skills/skill_executor.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_explain_py["skills/skill_explain<br/>MOD-INF-019: Agent Spec — XAI Explainable Skill<br/>Engine<br/>文件: skills/skill_explain.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_feature_flags_py["skills/skill_feature_flags<br/>MOD-INF-019: Agent Spec — Skill Feature Flags<br/>文件: skills/skill_feature_flags.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_feedback_py["skills/skill_feedback<br/>MOD-INF-019: Agent Spec — Skill Feedback Loop<br/>文件: skills/skill_feedback.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_freshness_ext_py["skills/skill_freshness_ext<br/>MOD-INF-019: Agent Spec — Skill Freshness<br/>Extensions<br/>文件: skills/skill_freshness_ext.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_gitops_py["skills/skill_gitops<br/>MOD-INF-019: Agent Spec — Skill GitOps<br/>文件: skills/skill_gitops.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_guardrails_py["skills/skill_guardrails<br/>MOD-INF-019: Agent Spec — Skill Guardrails<br/>文件: skills/skill_guardrails.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_idempotency_py["skills/skill_idempotency<br/>MOD-INF-019: Agent Spec — Skill Idempotency<br/>文件: skills/skill_idempotency.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_kya_py["skills/skill_kya<br/>MOD-INF-019: Agent Spec — Skill KYA<br/>文件: skills/skill_kya.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_learning_py["skills/skill_learning<br/>MOD-INF-019: Agent Spec — Skill Self-Learning<br/>Engine<br/>文件: skills/skill_learning.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_lineage_py["skills/skill_lineage<br/>MOD-INF-019: Agent Spec — Skill Lineage<br/>文件: skills/skill_lineage.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_locking_py["skills/skill_locking<br/>MOD-INF-019: Agent Spec — Skill Locking<br/>(Production Hardening)<br/>文件: skills/skill_locking.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_observability_py["skills/skill_observability<br/>MOD-INF-019: Agent Spec — Skill Observability<br/>文件: skills/skill_observability.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_ontology_py["skills/skill_ontology<br/>MOD-INF-019: Agent Spec — Skill Ontology<br/>文件: skills/skill_ontology.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_postmortem_py["skills/skill_postmortem<br/>MOD-INF-019: Agent Spec — Skill Postmortem<br/>(追问到底)<br/>文件: skills/skill_postmortem.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_prompt_cache_py["skills/skill_prompt_cache<br/>MOD-INF-019: Agent Spec — Skill Prompt Cache<br/>文件: skills/skill_prompt_cache.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_prompt_opt_py["skills/skill_prompt_opt<br/>MOD-INF-019: Agent Spec — Skill Prompt Optimizer<br/>文件: skills/skill_prompt_opt.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_resilience_py["skills/skill_resilience<br/>MOD-INF-019: Agent Spec — Skill Resilience<br/>文件: skills/skill_resilience.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_risk_mitigator_py["skills/skill_risk_mitigator<br/>MOD-INF-019: Agent Spec — Skill Risk Mitigator<br/>文件: skills/skill_risk_mitigator.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_router_py["skills/skill_router<br/>skills包的skill_router模块<br/>文件: skills/skill_router.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_sandbox_py["skills/skill_sandbox<br/>MOD-INF-019: Agent Spec — Skill Sandbox<br/>文件: skills/skill_sandbox.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_schema_registry_py["skills/skill_schema_registry<br/>MOD-INF-019: Agent Spec — Skill Schema Registry<br/>文件: skills/skill_schema_registry.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_security_py["skills/skill_security<br/>MOD-INF-019: Agent Spec — Skill Security<br/>文件: skills/skill_security.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_shadow_py["skills/skill_shadow<br/>MOD-INF-019: Agent Spec — Skill Shadow<br/>Deployment<br/>文件: skills/skill_shadow.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_silent_failure_py["skills/skill_silent_failure<br/>MOD-INF-019: Agent Spec — Silent Failure<br/>Detector<br/>文件: skills/skill_silent_failure.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_team_optimizer_py["skills/skill_team_optimizer<br/>MOD-INF-019: Agent Spec — Skill Team Optimizer<br/>文件: skills/skill_team_optimizer.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_telemetry_py["skills/skill_telemetry<br/>MOD-INF-019: Agent Spec — Skill Telemetry<br/>文件: skills/skill_telemetry.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_temperature_py["skills/skill_temperature<br/>MOD-INF-019: Agent Spec — Skill Temperature<br/>文件: skills/skill_temperature.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_tokenomics_py["skills/skill_tokenomics<br/>MOD-INF-019: Agent Spec — Skill Tokenomics<br/>文件: skills/skill_tokenomics.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_translator_py["skills/skill_translator<br/>MOD-INF-019: Agent Spec — Skill Translator<br/>文件: skills/skill_translator.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_workflow_py["skills/skill_workflow<br/>MOD-INF-019: Agent Spec — Skill Workflow<br/>Orchestrator<br/>文件: skills/skill_workflow.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_spec_engine_py["autonomy_core/spec_engine<br/>MOD-INF-019: Agent Spec — SpecEngine<br/>蓝图->Skill 升级引擎<br/>文件: autonomy_core/spec_engine.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_vibe_coding_quality_gate_py["autonomy_core/vibe_coding_quality_gate<br/>VibeCodingQualityGate — 代码质量门禁（stub,<br/>tests 待实装后补全实现）<br/>文件: autonomy_core/vibe_coding_quality_gate.py<br/>(生产态 / production)"]
    src_zephyr_governance_persistence_intent_parser_py["persistence/intent_parser<br/>IntentParser · 意图三阶段级联解析器（V-09）<br/>文件: persistence/intent_parser.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_system_snapshot_py["infrastructure/system_snapshot<br/>SystemSnapshotter — M1 系统状态镜像（CL-017 RI<br/>扩展模式）<br/>文件: infrastructure/system_snapshot.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_system_telemetry_otel_instrumentation_py["system_telemetry/otel_instrumentation<br/>otel_instrumentation.py — 全链路 OTel (B12,<br/>DD86, TASK-015 beta v)<br/>文件: system_telemetry/otel_instrumentation.py<br/>(生产态 / production)"]
    src_zephyr_integration_vector_memory_vector_writer_py["vector_memory/vector_writer<br/>CE 向量写入器 — vectorize_and_store() 生产者<br/>文件: vector_memory/vector_writer.py<br/>(生产态 / production)"]
    src_zephyr_security_llm_defense_llm_security_adversarial_robustness_py["llm_security/adversarial_robustness<br/>adversarial_robustness.py — 对抗鲁棒性 (B8,<br/>DD82, TASK-015 beta w)<br/>文件: llm_security/adversarial_robustness.py<br/>(生产态 / production)"]
    src_zephyr_security_llm_defense_llm_security_alignment_scorer_py["llm_security/alignment_scorer<br/>alignment_scorer.py — 对齐评分 (B11, DD85,<br/>TASK-015 beta w)<br/>文件: llm_security/alignment_scorer.py<br/>(生产态 / production)"]
    src_zephyr_security_llm_defense_llm_security_lsg_pattern_tracker_py["llm_security/lsg_pattern_tracker<br/>lsg_pattern_tracker.py — LSG 模式逃逸追踪 (B20,<br/>DD94, TASK-017)<br/>文件: llm_security/lsg_pattern_tracker.py<br/>(生产态 / production)"]
    src_zephyr_security_llm_defense_llm_security_poisoning_monitor_py["llm_security/poisoning_monitor<br/>poisoning_monitor.py — Embed 污染检测 (DD97,<br/>TASK-019)<br/>文件: llm_security/poisoning_monitor.py<br/>(生产态 / production)"]
    src_zephyr_security_llm_defense_llm_security_sensitivity_classifier_py["llm_security/sensitivity_classifier<br/>sensitivity_classifier.py — 数据分级 (B9, DD83,<br/>TASK-015 beta w)<br/>文件: llm_security/sensitivity_classifier.py<br/>(生产态 / production)"]
    src_zephyr_security_llm_defense_llm_security_solo_dev_safety_net_py["llm_security/solo_dev_safety_net<br/>solo_dev_safety_net.py — 单人无审查安全网 (B15,<br/>DD89, TASK-017)<br/>文件: llm_security/solo_dev_safety_net.py<br/>(生产态 / production)"]
    src_zephyr_shared_ai_guards_config_safety_guard_py["ai_guards/config_safety_guard<br/>config_safety_guard.py — 配置自毁防护 (B16,<br/>DD90, TASK-017)<br/>文件: ai_guards/config_safety_guard.py<br/>(生产态 / production)"]
    src_zephyr_shared_dependency_dependency_tracker_py["dependency/dependency_tracker<br/>dependency_tracker.py — 依赖追踪 (DD116,<br/>TASK-020)<br/>文件: dependency/dependency_tracker.py<br/>(生产态 / production)"]
    src_zephyr_shared_io_cache_invalidation_py["io/cache_invalidation<br/>cache_invalidation.py — 缓存一致性 (DD113,<br/>TASK-020)<br/>文件: io/cache_invalidation.py<br/>(生产态 / production)"]
    src_zephyr_shared_utils_verify_paths_py["utils/verify_paths<br/>verify_paths.py — 代码路径索引验证 (TASK-012)<br/>文件: utils/verify_paths.py<br/>(生产态 / production)"]
    tests_automation_test_auto_runtime_e2e_py["automation/test_auto_runtime_e2e<br/>F1 AutoRuntimeCore 非mock端到端集成测试<br/>文件: automation/test_auto_runtime_e2e.py<br/>(生产态 / production)"]
    tests_f_lifecycle_test_f1_event_trigger_py["f_lifecycle/test_f1_event_trigger<br/>F1 事件触发启动测试<br/>文件: f_lifecycle/test_f1_event_trigger.py<br/>(生产态 / production)"]
    tests_trading_extreme_test_f14_pipeline_extreme_py["extreme/test_f14_pipeline_extreme<br/>F14 管线编排/反馈环 — 红蓝对抗端到端极端测试<br/>文件: extreme/test_f14_pipeline_extreme.py<br/>(生产态 / production)"]
    tests_trading_extreme_test_f1_extreme_py["extreme/test_f1_extreme<br/>F1 自动驾驶/运行时大脑 — 红蓝对抗端到端极端测试<br/>文件: extreme/test_f1_extreme.py<br/>(生产态 / production)"]
    ...
    src_zephyr_autonomy_core_context_context_pipeline_py["context/context_pipeline<br/>context_pipeline — Context Engine<br/>**四段流水线组合根**<br/>文件: context/context_pipeline.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_evaluator_py["skills/skill_evaluator<br/>MOD-INF-019: Agent Spec — Skill Evaluator<br/>文件: skills/skill_evaluator.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_factory_py["skills/skill_factory<br/>skills包的skill_factory模块<br/>文件: skills/skill_factory.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_kill_switch_py["skills/skill_kill_switch<br/>MOD-INF-019: Agent Spec — Skill Kill Switch<br/>文件: skills/skill_kill_switch.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_lifecycle_py["skills/skill_lifecycle<br/>MOD-INF-019: Agent Spec — Skill Lifecycle<br/>文件: skills/skill_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_model_evolution_py["skills/skill_model_evolution<br/>MOD-INF-019: Agent Spec — Skill Model Evolution<br/>文件: skills/skill_model_evolution.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_registry_py["skills/skill_registry<br/>skill-registry.py —— Skill 注册基座（Phase 14 /<br/>盲点 B34）<br/>文件: skills/skill_registry.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_trigger_router_py["autonomy_core/trigger_router<br/>autonomy core包的trigger_router模块<br/>文件: autonomy_core/trigger_router.py<br/>(生产态 / production)"]
    src_zephyr_governance_persistence_intent_keyword_mapper_py["persistence/intent_keyword_mapper<br/>IntentKeywordMapper - Stage 1 of three-stage<br/>intent parsing (<br/>文件: persistence/intent_keyword_mapper.py<br/>(生产态 / production)"]
    ...
    src_zephyr_autonomy_core_context_context_assembler_py["context/context_assembler<br/>ContextAssembler — 上下文装配、校验、影子留档<br/>文件: context/context_assembler.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_context_context_injector_py["context/context_injector<br/>ContextInjector: retrieve and inject relevant<br/>knowledge into prompt context<br/>文件: context/context_injector.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_freshness_py["skills/skill_freshness<br/>MOD-INF-019: Agent Spec — Skill Freshness Decay<br/>文件: skills/skill_freshness.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_loader_py["skills/skill_loader<br/>skills包的skill_loader模块<br/>文件: skills/skill_loader.py<br/>(生产态 / production)"]
    src_zephyr_autonomy_core_skills_skill_model_py["skills/skill_model<br/>skills包的skill_model模块<br/>文件: skills/skill_model.py<br/>(生产态 / production)"]
    src_zephyr_shared_blueprint_tools_architecture_context_loader_py["blueprint_tools/architecture_context_loader<br/>architecture_context_loader — 加载<br/>``generate_architecture_context.py`` 产出...<br/>文件: blueprint_tools<br/>/architecture_context_loader.py<br/>(生产态 / production)"]
    ...
    src_zephyr_autonomy_core_context_context_rule_registry_py["context/context_rule_registry<br/>context包的context_rule_registry模块<br/>文件: context/context_rule_registry.py<br/>(生产态 / production)"]
    src_zephyr_shared_io_doc_compressor_py["io/doc_compressor<br/>DocCompressor — 文档压缩服务（CL-018 RI<br/>扩展模式）<br/>文件: io/doc_compressor.py<br/>(生产态 / production)"]

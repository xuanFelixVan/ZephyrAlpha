...
flowchart TD
    ...
    src_zephyr_autonomy_core_integration_pipeline_bridge_py["管线桥接<br/>接收 TaskCard -> 通过 TriggerRouter 匹配 Domain<br/>Skill + Role Skill<br/>pipeline_bridge<br/>文件: integration/pipeline_bridge.py<br/>(生产态 / production)"]
    ...
    src_zephyr_autonomy_core_skills_skill_durable_py["技能durable<br/>Skill 持久化执行引擎<br/>文件: skills/skill_durable.py<br/>(生产态 / production)"]
    ...
    src_zephyr_autonomy_core_skills_skill_shadow_py["技能影子<br/>Skill 影子部署引擎<br/>文件: skills/skill_shadow.py<br/>(生产态 / production)"]
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_AUDIT,D_ORCHESTRATOR,D_INTEGRATION,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_SECURITY,D_GOV_REPAIR external_prod
```

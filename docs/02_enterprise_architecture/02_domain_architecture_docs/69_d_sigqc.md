...
|:--:|---------|:--:|---------|---------|
| 1 | D_SIGQC — Signal Quality Degradation Monitor Base (signa... | → | D_INFRASTRUCTURE 跨层契约基础设施: ==== BEGIN CODGEN:CTR-P1-015 ==== (contracts/synthesized_... | 导入依赖 / import_depends |
| 2 | D_SIGQC — Signal Quality Degradation Monitor Base (signa... | → | D_TRADING 交易运营: ==== BEGIN CODGEN:CTR-ERR-003 ==== (market/signal_degrada... | 导入依赖 / import_depends |

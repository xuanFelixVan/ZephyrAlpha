...
flowchart TD
    ...
    src_zephyr_signal_quality_degradation_monitor_base_py["退化监控基类<br/>degradation_monitor_base模块<br/>D_SIGQC — Signal Quality Degradation Monitor<br/>Base<br/>文件: signal_quality/degradation_monitor_base.py<br/>(生产态 / production)"]

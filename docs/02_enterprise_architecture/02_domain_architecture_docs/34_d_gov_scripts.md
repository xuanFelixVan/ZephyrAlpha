...
| 模块数 | 416 | Module Count | 416 |
| 域内依赖 | 318 | Internal Dependencies | 318 |
| 跨域入边 | 13 | Cross-domain Incoming | 13 |
| 跨域出边 | 81 | Cross-domain Outgoing | 81 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 390 | Prototype Modules | 390 |
...
| scripts/governance/generate_target_path_tree.py |  | prototype | generated |
...
| D-GOV-ENFORCEMENT | 10 | import_depends |

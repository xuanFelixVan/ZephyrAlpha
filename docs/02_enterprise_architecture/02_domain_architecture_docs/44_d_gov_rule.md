...
# 44_d_gov_rule / 规则治理 / Rule Governance
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY,D_GOV_SCRIPTS,D_INTELLIGENCE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_GOV_SCRIPTS,D_INTELLIGENCE,D_AUTONOMY_CORE external_prod
```

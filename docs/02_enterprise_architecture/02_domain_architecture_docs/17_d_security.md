...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_compliance_gate_a6_compliance_mapper_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_capability_check_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_approver_check_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_cross_cutting_py
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOVERNANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_guards_native_api_guard_py
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    D_GOV_DRIFT -.->|runtime| src_zephyr_security_access_control_guards_native_api_guard_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|contract| src_zephyr_security_access_control_guards_native_api_guard_py
    D_GOVERNANCE -.->|contract| src_zephyr_security_access_control_guards_native_api_guard_py
    D_AUTONOMY_CORE["D_AUTONOMY_CORE prototype"]
    D_AUTONOMY_CORE -.->|runtime| src_zephyr_security_access_control_guards_native_api_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_detectors_context_drift_detector_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_memory_provenance_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guard_layers_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_novel_attack_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_cybersec_2026_guard_py
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_AUDITTEST,D_AUTONOMY_CORE,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_observability_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_toctou_guard_py
    ...
    class D_SHARED,D_TRADING,D_INTELLIGENCE,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    src_zephyr_security_access_control_orphan_judge_orphan_detector_py -->|import_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_verifiers_continuous_verifier_py
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
|------|:---:|---------|
| D_AUDITTEST | 169 | contract,test_depends |

...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_detectors_multi_agent_collusion_detector_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_output_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_path_guard_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_sequence_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_toctou_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_orphan_judge_judge_py
    ...
    class D_SHARED,D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_GOV_ENFORCEMENT external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUDITTEST,D_GOV_SCRIPTS external_design
```

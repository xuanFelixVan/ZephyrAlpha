...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_detectors_shell_dialect_detector_py
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_TRADING,D_INTELLIGENCE external_prod

...
graph TD
    ...
    D_AUDITTEST["(原型态 / prototype) D_AUDITTEST"]
    D_AUDITTEST -.->|contract / contract| src_zephyr_security_access_control_guards_abac_guard_py
    D_GOVERNANCE["(设计态 / design) D_GOVERNANCE"]
    D_GOVERNANCE -.->|contract / contract| src_zephyr_security_access_control_guards_abac_guard_py
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
| 128 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | ABACGuard — 基于属性的权限守卫. (abac_guard.py) | contract / contract |
...
| 170 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | ABACGuard — 基于属性的权限守卫. (abac_guard.py) | runtime / runtime |
...
| 185 | D_GOVERNANCE 生命周期管理: blueprint.md | → | ABACGuard — 基于属性的权限守卫. (abac_guard.py) | contract / contract |
| 186 | D_GOVERNANCE 生命周期管理: blueprint.md | → | ABACGuard — 基于属性的权限守卫. (abac_guard.py) | runtime / runtime |
...
| 195 | D_GOV_DRIFT 漂移检测: blueprint.md | → | ABACGuard — 基于属性的权限守卫. (abac_guard.py) | runtime / runtime |

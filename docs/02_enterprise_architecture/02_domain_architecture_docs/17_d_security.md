...
| 128 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | RuleInjectionGuard — 规则注入守卫. (rule_injec... | contract / contract |
...
| 170 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — Agent Observability ... | → | RuleInjectionGuard — 规则注入守卫. (rule_injec... | runtime / runtime |
...
| 185 | D_GOVERNANCE 生命周期管理: blueprint.md | → | RuleInjectionGuard — 规则注入守卫. (rule_injec... | contract / contract |
| 186 | D_GOVERNANCE 生命周期管理: blueprint.md | → | RuleInjectionGuard — 规则注入守卫. (rule_injec... | runtime / runtime |
...
| 195 | D_GOV_DRIFT 漂移检测: blueprint.md | → | RuleInjectionGuard — 规则注入守卫. (rule_injec... | runtime / runtime |

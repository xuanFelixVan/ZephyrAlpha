...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_escalation_handler_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_orphan_judge_cascade_analyzer_py
    ...
    class D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_SHARED,D_TRADING external_prod
    class D_GOVERNANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_TRADING external_prod
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_SHARED,D_TRADING external_prod
    class D_GOVERNANCE,D_AUDITTEST,D_AUTONOMY_PERM external_design
```

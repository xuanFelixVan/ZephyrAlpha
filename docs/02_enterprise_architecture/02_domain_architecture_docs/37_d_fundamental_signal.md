...
graph TD
    ...
    src_zephyr_signal_fundamental_pipeline_py -->|contract / contract| D_FACTOR
    ...
    class D_FACTOR,D_TRADING,D_INFRASTRUCTURE,D_SHARED external_prod
...
| 2 | AlphaSignalPipeline D_FACTOR->D_SIGNAL跨层集成... | → | D_FACTOR 因子: ZephyrAlpha — D_FACTOR Alpha Factor Layer (fac... | contract / contract |

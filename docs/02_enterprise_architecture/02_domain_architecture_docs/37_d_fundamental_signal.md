...
graph TD
    ...
    src_zephyr_signal_fundamental_capital_capital_allocation_result_py -.->|contract / contract| D_FACTOR
...
|:--:|---------|:--:|---------|---------|
| 1 | D_FUNDAMENTAL_SIGNAL — CapitalAllocationResult... | → | D_FACTOR 因子: D_FACTOR — Momentum Factor (momentum_factor.py) | contract / contract |

...
graph TD
    ...
    src_zephyr_trading_feedback_loop_diagnosers_diagnosis_engine_py -.->|config_depends| src_zephyr_trading_feedback_loop_diagnosers_init_py
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_llm_security_test_l6_observability_py design
...
> 按 architecture_layer 分层显示 反馈循环（D_OPS）的模块分布。共 331 个模块 / 331 modules。

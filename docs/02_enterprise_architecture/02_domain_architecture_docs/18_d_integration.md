...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_SECURITY,D_OPS,D_GOV_RULE external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_ORCHESTRATOR,D_INTEGRATION_GATEWAY,D_DATA,D_AUTONOMY_CORE external_design
```

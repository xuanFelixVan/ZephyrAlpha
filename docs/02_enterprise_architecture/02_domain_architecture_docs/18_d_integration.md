...
graph TD
    ...
    class D_TRADING,D_OPS,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_GOV_KB,D_DATA,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_SECURITY,D_OPS,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_KB,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_TRADING,D_OPS,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_GOV_KB,D_DATA,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_GOVERNANCE external_design
```

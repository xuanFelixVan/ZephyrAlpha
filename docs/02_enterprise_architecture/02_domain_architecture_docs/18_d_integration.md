...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_OPS,D_GOVERNANCE,D_GOV_AUDIT external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_AUTONOMY_CORE external_prod
    class D_GOV_KB,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_FBL_DETECTORS,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_RULE,D_TRADING,D_AUTONOMY_CORE,D_GOV_KB external_prod
    class D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_design
```

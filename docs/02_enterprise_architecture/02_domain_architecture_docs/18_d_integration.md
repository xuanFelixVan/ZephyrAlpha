...
graph TD
    ...
    class D_SHARED,D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_INTELLIGENCE,D_DATA external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOVERNANCE,D_SECURITY,D_INFRA_RUNTIME,D_GOV_KB,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_FBL_DETECTORS,D_GOV_AUDIT,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
    class D_GOV_KB,D_GOVERNANCE,D_AUTONOMY_CORE,D_TRADING,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INTELLIGENCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
    class D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_GOV_AUDIT,D_GOV_RULE external_prod

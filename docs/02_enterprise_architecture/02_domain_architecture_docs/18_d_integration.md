...
graph TD
    ...
    class D_DATA,D_INTEGRATION_GATEWAY,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_SECURITY,D_OPS,D_INFRA_RUNTIME,D_GOV_KB,D_ORCHESTRATOR,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_FBL_DETECTORS,D_GOV_AUDIT,D_INFRA_RECOVERY external_prod
    class D_GOV_KB,D_SHARED,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_TRADING,D_OPS,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_KB,D_AUTONOMY_CORE external_prod
    class D_DATA,D_ORCHESTRATOR,D_INTEGRATION_GATEWAY external_design
```

...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_TRADING,D_SECURITY,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_DATA external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_RULE,D_ORCHESTRATOR external_prod
    class D_GOV_KB,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_SECURITY,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING,D_GOV_RULE,D_GOV_KB external_prod
    class D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_GOVERNANCE,D_INTEGRATION_GATEWAY external_design
```

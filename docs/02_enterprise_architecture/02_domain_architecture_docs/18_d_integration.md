...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE,D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_GOV_SCRIPTS,D_DATA external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INTELLIGENCE,D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_KB,D_GOV_RULE,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
    class D_GOV_KB,D_GOVERNANCE,D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_TRADING,D_INTELLIGENCE,D_AUTONOMY_CORE,D_SECURITY,D_INFRA_RUNTIME,D_GOV_KB,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_ORCHESTRATOR external_prod
    class D_SHARED,D_SECURITY_LLM,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```

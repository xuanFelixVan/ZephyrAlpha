...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_AUDIT,D_TRADING,D_OPS,D_INFRA_RUNTIME external_prod
    class D_AUTONOMY_CORE,D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_GOV_SCRIPTS,D_DATA external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_KB,D_ORCHESTRATOR external_prod
    class D_FEEDBACK_LOOP,D_SECURITY_LLM,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_AUTONOMY_CORE,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_KB external_prod
    class D_SHARED,D_FEEDBACK_LOOP,D_SECURITY_LLM,D_INTEGRATION_GATEWAY external_design
```

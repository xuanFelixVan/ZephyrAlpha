...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_AUTONOMY_CORE,D_TRADING,D_GOV_AUDIT,D_SECURITY external_prod
    class D_GOV_KB,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_AUTONOMY_CORE,D_TRADING,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_KB,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INTELLIGENCE,D_GOVERNANCE external_design
```

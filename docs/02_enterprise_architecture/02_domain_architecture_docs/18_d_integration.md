...
graph TD
    ...
    class D_OPS,D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE external_prod
    class D_INFRA_RUNTIME,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_GOV_KB,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_SHARED,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_OPS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_RULE external_prod
    class D_SECURITY_LLM,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INTEGRATION_GATEWAY,D_TRADING,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_DRIFT external_prod
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
> 本域与 23 个外部域直接连接（出边 116 条 + 入边 141 条 = 257 条）。只显示直接连接的域，不展开具体节点。

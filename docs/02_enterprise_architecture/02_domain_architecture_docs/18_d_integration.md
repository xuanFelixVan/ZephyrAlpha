...
graph TD
    ...
    class D_SHARED,D_GOV_KB,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_SECURITY_LLM,D_AUTONOMY_CORE,D_INTEGRATION_GATEWAY,D_DATA external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY,D_GOV_RULE,D_GOV_KB external_prod
    class D_GOVERNANCE,D_SECURITY_LLM,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_AUTONOMY_CORE,D_GOVERNANCE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_OPS,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_KB,D_INFRA_RUNTIME,D_SECURITY_LLM,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_CORE external_prod
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY external_design
```

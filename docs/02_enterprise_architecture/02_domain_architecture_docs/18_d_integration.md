...
graph TD
    ...
    class D_TRADING,D_GOV_RULE,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_AUDIT external_prod
    class D_SHARED,D_GOV_KB,D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SECURITY,D_INTELLIGENCE,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE external_prod
    class D_GOV_KB,D_SECURITY_LLM,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_AUTONOMY_CORE,D_INTELLIGENCE,D_GOVERNANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_AUDIT,D_SECURITY,D_INTELLIGENCE,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_GOV_KB,D_SECURITY_LLM,D_GOVERNANCE,D_INTEGRATION_GATEWAY external_design
```

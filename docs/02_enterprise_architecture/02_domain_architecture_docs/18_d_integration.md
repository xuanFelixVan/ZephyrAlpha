...
graph TD
    ...
    class D_GOV_AUDIT,D_TRADING,D_OPS,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_GOV_KB,D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_DATA,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_RULE external_prod
    class D_INFRASTRUCTURE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_RULE,D_GOV_AUDIT,D_ORCHESTRATOR,D_TRADING external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTEGRATION_GATEWAY,D_DATA,D_GOV_ENFORCEMENT,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INTEGRATION_GATEWAY external_design
```

...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_GOVERNANCE,D_OPS,D_GOV_AUDIT,D_TRADING external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_AUTONOMY_CORE,D_GOV_AUDIT external_prod
    class D_SHARED,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_SECURITY,D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
    class D_SHARED,D_GOV_KB,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SHARED,D_GOV_AUDIT,D_GOV_RULE,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_SECURITY,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
    class D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_RULE,D_AUTONOMY_CORE,D_GOV_DRIFT external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOVERNANCE,D_INTEGRATION_GATEWAY external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_OPS,D_GOV_RULE,D_AUTONOMY_CORE,D_INTELLIGENCE,D_SECURITY external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_OPS,D_GOV_RULE,D_AUTONOMY_CORE,D_INTELLIGENCE,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_KB,D_INFRA_RUNTIME,D_ORCHESTRATOR external_design
```

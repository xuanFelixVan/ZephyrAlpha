...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_INTELLIGENCE,D_OPS,D_AUTONOMY_CORE,D_TRADING external_prod
    class D_SHARED,D_GOV_KB,D_GOV_DOCS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_INTELLIGENCE,D_OPS,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_TRADING external_prod
    class D_SHARED,D_GOV_KB,D_GOVERNANCE,D_ORCHESTRATOR external_design
```

...
graph TD
    ...
    class D_GOV_AUDIT,D_TRADING,D_INFRA_RUNTIME,D_OPS,D_SECURITY,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_INTELLIGENCE,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_DATA,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_SECURITY,D_GOV_RULE external_prod
    class D_GOV_KB,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INFRA_RECOVERY,D_GOV_AUDIT,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_KB,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOVERNANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_SECURITY,D_OPS,D_AUTONOMY_CORE,D_GOV_KB,D_GOV_RULE external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```

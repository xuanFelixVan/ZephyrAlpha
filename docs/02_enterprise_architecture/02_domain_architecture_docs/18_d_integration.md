...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY,D_TRADING external_prod
    class D_SHARED,D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_GOV_SCRIPTS,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_KB external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod
    class D_GOV_KB,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTELLIGENCE,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_KB external_prod

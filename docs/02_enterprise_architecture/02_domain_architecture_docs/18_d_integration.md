...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_integration_mcp_resource_provider_py
    D_GOV_DOCS -.->|contract / contract| src_zephyr_integration_mcp_resource_provider_py
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING external_prod
    class D_GOV_KB,D_GOV_DOCS,D_INFRASTRUCTURE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_INTELLIGENCE,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_AUTONOMY_CORE,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_TRADING external_prod
    class D_GOV_KB,D_ORCHESTRATOR,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_DOCS,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_GOVERNANCE external_design
```
...
| 27 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | runtime / runtime |
| 28 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | contract / contract |

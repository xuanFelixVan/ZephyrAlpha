...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_TRADING,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_GOV_DOCS,D_DATA,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_RULE,D_GOV_KB external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_AUDIT external_prod
    class D_GOV_KB,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INTELLIGENCE,D_AUTONOMY_CORE,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME,D_TRADING,D_INTELLIGENCE,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_RULE external_prod
    class D_GOV_KB,D_DATA,D_INTEGRATION_GATEWAY,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_DOCS,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```

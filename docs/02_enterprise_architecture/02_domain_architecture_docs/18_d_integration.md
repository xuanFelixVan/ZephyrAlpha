...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_GOVERNANCE,D_GOV_RULE,D_GOV_AUDIT external_prod
    class D_SHARED,D_GOV_KB,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_DATA external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_RULE external_prod
    class D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_AUTONOMY_CORE,D_TRADING,D_INTELLIGENCE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_INFRA_RUNTIME,D_TRADING,D_GOVERNANCE,D_GOV_RULE,D_AUTONOMY_CORE external_prod
    class D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```

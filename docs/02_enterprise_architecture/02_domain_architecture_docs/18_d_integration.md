...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_INTELLIGENCE,D_OPS,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOV_DOCS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_INTELLIGENCE,D_OPS,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
...
> 本域与 18 个外部域直接连接（出边 100 条 + 入边 38 条 = 138 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_OPS,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE,D_SHARED,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY,D_GOV_RULE external_prod
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_ORCHESTRATOR,D_SECURITY_LLM,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_KB,D_SHARED,D_TRADING,D_ORCHESTRATOR,D_GOVERNANCE,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_OPS,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE,D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_ORCHESTRATOR,D_TRADING,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    class D_GOV_RULE,D_GOVERNANCE,D_TRADING,D_OPS,D_SECURITY,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_INTEGRATION_GATEWAY,D_DATA,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_OPS,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_KB external_prod
    class D_SECURITY,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOV_OPS_RESILIENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_GOV_AUDIT,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_prod
    class D_GOV_KB,D_AUTONOMY_CORE,D_GOVERNANCE,D_ORCHESTRATOR,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_RULE,D_GOVERNANCE,D_TRADING,D_OPS external_prod
    class D_SHARED,D_SECURITY,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOV_OPS_RESILIENCE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```

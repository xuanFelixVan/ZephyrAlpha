...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_RULE,D_TRADING,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_GOV_KB,D_INTEGRATION_GATEWAY,D_DATA,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
    class D_SHARED,D_GOV_KB,D_AUTONOMY_CORE,D_DATA,D_INTEGRATION_GATEWAY external_design
```

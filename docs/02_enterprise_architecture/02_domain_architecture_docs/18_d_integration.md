...
graph TD
    ...
    class D_GOV_AUDIT,D_TRADING,D_SHARED,D_OPS,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
    class D_INTEGRATION_GATEWAY,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_RULE,D_GOV_DRIFT,D_GOV_KB,D_AUTONOMY_CORE,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
    class D_GOV_KB,D_INTELLIGENCE,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_SHARED,D_OPS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_RULE,D_GOV_DRIFT,D_GOV_KB,D_AUTONOMY_CORE external_prod

...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_INFRA_RECOVERY,D_TRADING,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod

...
graph TD
    ...
    class D_GOV_AUDIT,D_TRADING,D_OPS external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INTELLIGENCE,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_AUDIT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FBL_DETECTORS,D_GOV_AUDIT,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE external_design
```

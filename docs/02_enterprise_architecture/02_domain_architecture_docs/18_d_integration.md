...
graph TD
    ...
    class D_INFRA_RUNTIME,D_OPS,D_SHARED,D_GOV_AUDIT,D_TRADING,D_SECURITY,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE external_prod
    class D_INTELLIGENCE,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_KB,D_ORCHESTRATOR,D_GOV_RULE external_prod
    class D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_TRADING,D_GOVERNANCE,D_INTELLIGENCE,D_AUTONOMY_CORE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_OPS,D_SHARED,D_TRADING,D_SECURITY,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_KB,D_ORCHESTRATOR external_prod
    class D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_INTEGRATION_GATEWAY external_design
```

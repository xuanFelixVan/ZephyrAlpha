...
graph TD
    ...
    class D_SHARED,D_GOV_KB,D_GOV_DOCS,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INTELLIGENCE,D_ORCHESTRATOR,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_DOCS,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```

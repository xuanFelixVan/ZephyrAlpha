...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE,D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_OPS external_prod
    class D_GOV_KB,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_RULE external_prod
    class D_ORCHESTRATOR,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_KB,D_GOVERNANCE,D_INTELLIGENCE,D_AUTONOMY_CORE,D_TRADING,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE,D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_OPS external_prod
    class D_ORCHESTRATOR,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_GOVERNANCE,D_AUTONOMY_CORE external_design
```
...
| 38 | D_FEEDBACK_LOOP 反馈循环引擎: FLE 持久化写入器 — 写 metrics/alerts/dispatch_... | → | Structural Protocol interfaces for cross-module... | runtime / runtime |

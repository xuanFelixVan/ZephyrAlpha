...
graph TD
    ...
    class D_TRADING,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_GOV_RULE external_prod
    class D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_DATA,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY,D_INTELLIGENCE,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_KB,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_KB,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_DATA,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```

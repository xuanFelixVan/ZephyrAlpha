...
graph TD
    ...
    class D_SHARED,D_GOV_DOCS,D_INTELLIGENCE,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_DATA,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_SECURITY,D_GOVERNANCE,D_GOV_RULE external_prod
    class D_GOV_KB,D_GOV_ENFORCEMENT,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DOCS,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_ORCHESTRATOR,D_INTEGRATION_GATEWAY,D_DATA external_design
```
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
| 41 | D_GOVERNANCE 生命周期管理: backup_config.yaml | → | AssetInventory MCP Server — MOD-INF-026 蓝图 ... | runtime / runtime |
...
| 62 | D_GOV_DOCS 架构文档治理: blueprint.md | → | BlueprintSearchServer — MCP Server for bluepri... | runtime / runtime |
| 63 | D_GOV_DOCS 架构文档治理: blueprint.md | → | BlueprintSearchServer — MCP Server for bluepri... | contract / contract |

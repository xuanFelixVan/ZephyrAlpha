...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING external_prod
    class D_GOV_KB,D_GOV_DOCS,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_AUTONOMY_CORE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE,D_GOV_DOCS external_design
```

### 运营态子图（仅 design_maturity=production 的模块和依赖）

> 仅展示已上线运行的模块（共 50 个，51 条域内依赖）。
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_KB,D_ORCHESTRATOR,D_INTELLIGENCE external_design
```

...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT,D_TRADING,D_OPS external_prod
    class D_INFRA_RUNTIME,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_integration_mcp_prompt_provider_py
    D_GOV_DOCS -.->|contract / contract| src_zephyr_integration_mcp_prompt_provider_py
    ...
    class D_GOV_DOCS,D_INTELLIGENCE,D_INTEGRATION_GATEWAY,D_ORCHESTRATOR,D_GOVERNANCE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_KB,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_FBL_DETECTORS,D_GOV_RULE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_SECURITY,D_GOV_RULE,D_AUTONOMY_CORE external_prod
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INTELLIGENCE,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_DOCS,D_GOVERNANCE,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY external_design
```
...
| 65 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | runtime / runtime |
| 66 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | contract / contract |

...
graph TD
    ...
    class D_TRADING,D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_AUDIT,D_SECURITY external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_RULE external_prod
    class D_SECURITY_LLM,D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_KB,D_SHARED,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_TRADING,D_SHARED,D_INFRA_RUNTIME,D_GOV_RULE,D_SECURITY,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_KB external_prod
    class D_SECURITY_LLM,D_ORCHESTRATOR,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_OPS,D_TRADING external_prod
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_GOVERNANCE,D_OPS,D_GOV_RULE,D_AUTONOMY_CORE,D_TRADING,D_GOV_OPS_RESILIENCE external_prod

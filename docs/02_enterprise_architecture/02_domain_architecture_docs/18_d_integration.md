...
graph TD
    ...
    class D_GOV_AUDIT,D_TRADING,D_INFRA_RUNTIME,D_OPS,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
    class D_SHARED,D_GOV_KB,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY,D_GOV_RULE,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_GOV_KB,D_GOVERNANCE,D_INTELLIGENCE,D_ORCHESTRATOR,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_KB,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_KB,D_INTEGRATION_GATEWAY,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```

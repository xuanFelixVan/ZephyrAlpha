...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SECURITY,D_GOVERNANCE,D_GOV_RULE,D_TRADING,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_RULE external_prod
    class D_GOV_KB,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SECURITY,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_KB,D_DATA,D_SECURITY_LLM,D_INTEGRATION_GATEWAY external_design
```

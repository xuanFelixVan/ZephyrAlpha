...
graph TD
    ...
    class D_OPS,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_GOV_KB,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_INTELLIGENCE,D_SHARED,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_OPS,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_KB,D_GOV_OPS_RESILIENCE external_prod
...
> 本域与 17 个外部域直接连接（出边 100 条 + 入边 35 条 = 135 条）。只显示直接连接的域，不展开具体节点。

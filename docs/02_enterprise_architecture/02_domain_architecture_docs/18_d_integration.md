...
graph TD
    ...
    class D_SHARED,D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_RULE,D_GOV_KB external_prod
    class D_GOV_ENFORCEMENT,D_ORCHESTRATOR,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME external_prod

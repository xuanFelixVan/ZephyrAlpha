...
graph TD
    ...
    class D_GOV_AUDIT,D_TRADING,D_INFRA_RUNTIME,D_OPS,D_SECURITY,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_SCRIPTS,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_DATA external_design
```
...
graph TD
    ...
    src_zephyr_integration_shared_schema_init_py -.->|config_depends / config_depends| src_zephyr_integration_shared_schema_severity_types_py
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY,D_GOV_RULE external_prod
    class D_GOV_KB,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_RULE,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_GOV_KB,D_INTELLIGENCE,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOVERNANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY,D_GOV_RULE,D_GOV_KB external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_SHARED,D_INFRA_RECOVERY,D_GOV_RULE external_prod

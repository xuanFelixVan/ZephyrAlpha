...
graph TD
    ...
    class D_GOV_KB,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_INTELLIGENCE,D_SECURITY_LLM external_design
```
...
| 63 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP 全量工具调用审计日志（MOD-INF-013 §12 Step... | runtime / runtime |
| 64 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP 全量工具调用审计日志（MOD-INF-013 §12 Step... | contract / contract |

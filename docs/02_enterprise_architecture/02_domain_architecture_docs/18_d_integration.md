...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING,D_GOV_KB,D_GOV_OPS_RESILIENCE external_prod
...
| 13 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | runtime / runtime |
| 14 | D_GOV_DOCS 架构文档治理: blueprint.md | → | MCP Resource 提供者（MOD-INF-013 Phase 6 — 关.... | contract / contract |

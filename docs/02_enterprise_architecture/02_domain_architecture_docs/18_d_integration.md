...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_AUDIT,D_OPS,D_GOVERNANCE,D_TRADING external_prod
    class D_INFRA_RUNTIME,D_SECURITY_LLM,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY external_design
```

...
graph TD
    ...
    class D_SHARED,D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_GOVERNANCE,D_GOV_KB,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod

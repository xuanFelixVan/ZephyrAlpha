...
flowchart TD
    ...
    src_zephyr_reporting_realtime_pnl_dashboard_py["实时盈亏仪表盘<br/>生成报表<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>realtime_pnl_dashboard<br/>文件: reporting/realtime_pnl_dashboard.py<br/>(设计态 / design)"]

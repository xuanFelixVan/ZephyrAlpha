...
flowchart TD
    src_zephyr_reporting_ashare_performance_audit_py["A股绩效审计<br/>报告包的ashare_performance_audit模块<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>文件: reporting/ashare_performance_audit.py<br/>(设计态 / design)"]
    ...
    src_zephyr_reporting_default_tca_engine_py["默认tca引擎<br/>报告包的default_tca_engine模块<br/>D_REPORTING — Default TCA Engine<br/>文件: reporting/default_tca_engine.py<br/>(生产态 / production)"]
    src_zephyr_reporting_performance_attribution_report_py["绩效attribution报告<br/>报告包的performance_attribution_report模块<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>文件: reporting/performance_attribution_<br/>report.py<br/>(设计态 / design)"]
    src_zephyr_reporting_realtime_pnl_dashboard_py["实时盈亏仪表盘<br/>报告包的realtime_pnl_dashboard模块<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>文件: reporting/realtime_pnl_dashboard.py<br/>(设计态 / design)"]
    ...
    src_zephyr_reporting_report_version_manager_py["报告版本管理器<br/>报告包的report_version_manager模块<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>文件: reporting/report_version_manager.py<br/>(设计态 / design)"]
    ...
    src_zephyr_reporting_risk_report_engine_py["风险报告引擎<br/>报告包的risk_report_engine模块<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>文件: reporting/risk_report_engine.py<br/>(设计态 / design)"]
    ...
    src_zephyr_reporting_default_attribution_engine_py["默认attribution引擎<br/>报告包的default_attribution_engine模块<br/>D_REPORTING — Default Attribution Engine<br/>文件: reporting/default_attribution_engine.py<br/>(生产态 / production)"]
    src_zephyr_reporting_report_publisher_py["报告发布器<br/>报告包的report_publisher模块<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>文件: reporting/report_publisher.py<br/>(设计态 / design)"]
    src_zephyr_reporting_default_attribution_engine_py ~~~ src_zephyr_reporting_report_publisher_py
    src_zephyr_reporting_analytics_base_py["analytics基类<br/>报告包的analytics_base模块<br/>D_REPORTING — Post-Trade Analytics Layer<br/>文件: reporting/analytics_base.py<br/>(生产态 / production)"]

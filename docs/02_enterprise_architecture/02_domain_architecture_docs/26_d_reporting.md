...
> 展示全部 14 个模块（生产态 8 + 设计态 6），含跨域依赖外部节点。节点含成熟度+名称+大白话/简介+文件路径。

```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#eaeaea', 'primaryTextColor': '#333333', 'primaryBorderColor': '#666666', 'lineColor': '#666666', 'secondaryColor': '#eaeaea', 'tertiaryColor': '#eaeaea', 'fontSize': '14px'}}}%%
flowchart TD
    src_zephyr_reporting_ashare_performance_audit_py["A股绩效审计<br/>生成报表与报告<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>ashare_performance_audit<br/>文件: reporting/ashare_performance_audit.py<br/>(设计态 / design)"]
    src_zephyr_reporting_ashare_trade_record_template_py["A股交易记录模板<br/>报告的记录器，把发生的事件/结果记下来留档<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>ashare_trade_record_template<br/>文件: reporting/ashare_trade_record_template.py<br/>(设计态 / design)"]
    ...
    src_zephyr_reporting_performance_attribution_report_py["绩效attribution报告<br/>报告的报告器，汇总数据生成报告（performance<br/>attribution report）<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>performance_attribution_report<br/>文件: reporting<br/>/performance_attribution_report.py<br/>(设计态 / design)"]
    ...
    src_zephyr_reporting_report_watermark_tracker_py["报告watermark追踪器<br/>报告的追踪器，持续跟踪某项指标或状态的变化<br/>⛔ 报告域，设计已就绪，等待开发排期<br/>report_watermark_tracker<br/>文件: reporting/report_watermark_tracker.py<br/>(设计态 / design)"]
    ...
    src_zephyr_reporting_regulatory_report_generator_py ~~~ src_zephyr_reporting_report_watermark_tracker_py
    src_zephyr_reporting_report_watermark_tracker_py ~~~ src_zephyr_reporting_risk_report_engine_py
    src_zephyr_reporting_risk_report_engine_py ~~~ tests_reporting_test_realtime_pnl_dashboard_py
    tests_reporting_test_realtime_pnl_dashboard_py ~~~ tests_reporting_test_report_version_manager_py
    ...
    src_zephyr_reporting_realtime_pnl_dashboard_py -->|导入依赖 / import_depends| D_TRADING
    ...
    tests_reporting_test_realtime_pnl_dashboard_py -->|测试依赖 / test_depends| D_INFRASTRUCTURE
    tests_reporting_test_realtime_pnl_dashboard_py -->|测试依赖 / test_depends| D_SHARED
    ...
    src_zephyr_reporting_default_tca_engine_py -->|导入依赖 / import_depends| D_INFRASTRUCTURE
    src_zephyr_reporting_analytics_base_py -->|导入依赖 / import_depends| D_INFRASTRUCTURE
    D_TRADING -->|contract / contract| src_zephyr_reporting_risk_report_engine_py
    D_TRADING -->|contract / contract| src_zephyr_reporting_risk_report_engine_py
    D_SHARED -->|导入依赖 / import_depends| src_zephyr_reporting_risk_report_engine_py
    D_EX_CORE -.->|data / data| src_zephyr_reporting_report_publisher_py
    D_SHARED -.->|导入依赖 / import_depends| src_zephyr_reporting_report_watermark_tracker_py
    ...
    class src_zephyr_reporting_analytics_base_py,src_zephyr_reporting_default_attribution_engine_py,src_zephyr_reporting_default_tca_engine_py,src_zephyr_reporting_realtime_pnl_dashboard_py,src_zephyr_reporting_report_version_manager_py,src_zephyr_reporting_risk_report_engine_py,tests_reporting_test_realtime_pnl_dashboard_py,tests_reporting_test_report_version_manager_py production
    class src_zephyr_reporting_ashare_performance_audit_py,src_zephyr_reporting_ashare_trade_record_template_py,src_zephyr_reporting_performance_attribution_report_py,src_zephyr_reporting_regulatory_report_generator_py,src_zephyr_reporting_report_publisher_py,src_zephyr_reporting_report_watermark_tracker_py design
    class D_SHARED,D_EX_CORE,D_INFRASTRUCTURE,D_TRADING,D_GOV_AUDIT,D_GOVERNANCE external_prod
```
...
flowchart TD
    ...
    src_zephyr_reporting_default_tca_engine_py ~~~ src_zephyr_reporting_risk_report_engine_py
    src_zephyr_reporting_risk_report_engine_py ~~~ tests_reporting_test_realtime_pnl_dashboard_py
    tests_reporting_test_realtime_pnl_dashboard_py ~~~ tests_reporting_test_report_version_manager_py
    src_zephyr_reporting_analytics_base_py["analytics基类<br/>盘后分析层。负责交易执行后的绩效评估与归因分析。<br/>D_REPORTING — Post-Trade Analytics Layer<br/>文件: reporting/analytics_base.py<br/>(生产态 / production)"]
    src_zephyr_reporting_realtime_pnl_dashboard_py["实时盈亏仪表盘<br/>生成报表<br/>realtime_pnl_dashboard<br/>文件: reporting/realtime_pnl_dashboard.py<br/>(生产态 / production)"]
    src_zephyr_reporting_report_version_manager_py["报告版本管理器<br/>报告的报告器，汇总数据生成报告（report version）<br/>report_version_manager<br/>文件: reporting/report_version_manager.py<br/>(生产态 / production)"]
    src_zephyr_reporting_analytics_base_py ~~~ src_zephyr_reporting_realtime_pnl_dashboard_py
    src_zephyr_reporting_realtime_pnl_dashboard_py ~~~ src_zephyr_reporting_report_version_manager_py
    src_zephyr_reporting_default_attribution_engine_py -->|导入依赖 / import_depends| src_zephyr_reporting_analytics_base_py
    src_zephyr_reporting_default_tca_engine_py -->|导入依赖 / import_depends| src_zephyr_reporting_analytics_base_py
    tests_reporting_test_realtime_pnl_dashboard_py -->|测试依赖 / test_depends| src_zephyr_reporting_realtime_pnl_dashboard_py
...
|:--:|---------|:--:|---------|---------|
| 1 | 实时盈亏仪表盘 / realtime_pnl_dashboard (reporting/realti... | → | D_EX_CORE 执行核心: D_EXECUTION_CORE — Position Tracker (持仓跟踪器) (positi... | 导入依赖 / import_depends |
| 2 | MOD-RPT-004 Real-time P&L Dashboard 单元测试. (reporting/... | → | D_EX_CORE 执行核心: D_EXECUTION_CORE — Position Tracker (持仓跟踪器) (positi... | 测试依赖 / test_depends |
| 3 | analytics基类 / D_REPORTING — Post-Trade Analytics Layer... | → | D_INFRASTRUCTURE 跨层契约基础设施: 执行报告 / execution_report (contracts/execution_report.py) | 导入依赖 / import_depends |
| 4 | analytics基类 / D_REPORTING — Post-Trade Analytics Layer... | → | D_INFRASTRUCTURE 跨层契约基础设施: 成交 / fill (contracts/fill.py) | 导入依赖 / import_depends |
| 5 | analytics基类 / D_REPORTING — Post-Trade Analytics Layer... | → | D_INFRASTRUCTURE 跨层契约基础设施: 订单 / order (contracts/order.py) | 导入依赖 / import_depends |
| 6 | analytics基类 / D_REPORTING — Post-Trade Analytics Layer... | → | D_INFRASTRUCTURE 跨层契约基础设施: 绩效attribution报告 / performance_attribution_report (con... | 导入依赖 / import_depends |
| 7 | 默认attribution引擎 / D_REPORTING — Default Attribution ... | → | D_INFRASTRUCTURE 跨层契约基础设施: 绩效attribution报告 / performance_attribution_report (con... | 导入依赖 / import_depends |
| 8 | 默认tca引擎 / D_REPORTING — Default TCA Engine (reportin... | → | D_INFRASTRUCTURE 跨层契约基础设施: 执行报告 / execution_report (contracts/execution_report.py) | 导入依赖 / import_depends |
| 9 | 默认tca引擎 / D_REPORTING — Default TCA Engine (reportin... | → | D_INFRASTRUCTURE 跨层契约基础设施: 成交 / fill (contracts/fill.py) | 导入依赖 / import_depends |
| 10 | 默认tca引擎 / D_REPORTING — Default TCA Engine (reportin... | → | D_INFRASTRUCTURE 跨层契约基础设施: 订单 / order (contracts/order.py) | 导入依赖 / import_depends |
| 11 | 实时盈亏仪表盘 / realtime_pnl_dashboard (reporting/realti... | → | D_INFRASTRUCTURE 跨层契约基础设施: 成交 / fill (contracts/fill.py) | 导入依赖 / import_depends |
| 12 | MOD-RPT-004 Real-time P&L Dashboard 单元测试. (reporting/... | → | D_INFRASTRUCTURE 跨层契约基础设施: 成交 / fill (contracts/fill.py) | 测试依赖 / test_depends |
| 13 | 实时盈亏仪表盘 / realtime_pnl_dashboard (reporting/realti... | → | D_SHARED 共享服务: 订单枚举 / order_enums (enums/order_enums.py) | 导入依赖 / import_depends |
| 14 | 实时盈亏仪表盘 / realtime_pnl_dashboard (reporting/realti... | → | D_SHARED 共享服务: 风险仪表盘快照 / Backward-compat shim — canonical locati... | 导入依赖 / import_depends |
| 15 | 实时盈亏仪表盘 / realtime_pnl_dashboard (reporting/realti... | → | D_SHARED 共享服务: 错误 / errors (foundation/errors.py) | 导入依赖 / import_depends |
| 16 | 报告版本管理器 / report_version_manager (reporting/report... | → | D_SHARED 共享服务: 错误 / errors (foundation/errors.py) | 导入依赖 / import_depends |
| 17 | MOD-RPT-004 Real-time P&L Dashboard 单元测试. (reporting/... | → | D_SHARED 共享服务: 订单枚举 / order_enums (enums/order_enums.py) | 测试依赖 / test_depends |
| 18 | MOD-RPT-004 Real-time P&L Dashboard 单元测试. (reporting/... | → | D_SHARED 共享服务: 风险仪表盘快照 / Backward-compat shim — canonical locati... | 测试依赖 / test_depends |
| 19 | 实时盈亏仪表盘 / realtime_pnl_dashboard (reporting/realti... | → | D_TRADING 交易运营: D_TRADING — PnL Calculator (盈亏计算器) (trading/pnl_cal... | 导入依赖 / import_depends |
...
| 5 | D_SHARED 共享服务: 错误 / errors (foundation/errors.py) | → | 报告watermark追踪器 / report_watermark_tracker (reporting... | 导入依赖 / import_depends |
| 6 | D_SHARED 共享服务: 错误 / errors (foundation/errors.py) | → | 风险报告引擎 / risk_report_engine (reporting/risk_report_... | 导入依赖 / import_depends |
| 7 | D_TRADING 交易运营: 风险仪表盘快照 / risk_dashboard_snapshot (risk/risk_dashb... | → | 风险报告引擎 / risk_report_engine (reporting/risk_report_... | contract / contract |
| 8 | D_TRADING 交易运营: 风险指标 / risk_metrics (risk/risk_metrics.py) | → | 风险报告引擎 / risk_report_engine (reporting/risk_report_... | contract / contract |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 6 个外部域直接连接（出边 19 条 + 入边 8 条 = 27 条）。只显示直接连接的域，不展开具体节点。

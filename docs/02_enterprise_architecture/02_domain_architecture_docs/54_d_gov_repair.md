...
flowchart TD
    src_zephyr_governance_financial_governance_budget_enforcement_py["(生产态 / production) financial_governance/budget_enforcement.py<br/>文件: financial_governance/budget_enforcement.py"]

...
graph TD
    ...
    D_AUTONOMY_CORE -.->|runtime| src_zephyr_infrastructure_a2a_protocol_governance_audit_logger_py
...
> 按 architecture_layer 分层显示 A2A通信（D_INFRA_A2A）的模块分布。共 93 个模块 / 93 modules。

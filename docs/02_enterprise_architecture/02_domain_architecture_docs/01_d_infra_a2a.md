...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RUNTIME external_prod

...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RUNTIME external_prod

...
graph TD
    ...
    D_GOV_REPAIR -->|导入依赖 / import_depends| src_zephyr_infrastructure_a2a_protocol_init_py
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOVERNANCE,D_SECURITY,D_INFRA_RUNTIME external_prod
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | → | test_a2a_check.py | contract / contract |
| 2 | D_GOVERNANCE 生命周期管理: G-CT-003 契约：Agent Spec -> RBAC 能力检查. (re... | → | test_a2a_check.py | runtime / runtime |
...
graph LR
    ...
    D_AUTONOMY_CORE -->|1条 contract / contract| D_INFRA_A2A
```

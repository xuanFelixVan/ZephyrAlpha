...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RUNTIME external_prod

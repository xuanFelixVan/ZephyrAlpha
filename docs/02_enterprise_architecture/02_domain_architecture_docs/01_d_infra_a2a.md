...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RUNTIME external_prod
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — IDE Watcher (ide_wat... | → | test_a2a_check.py | runtime / runtime |

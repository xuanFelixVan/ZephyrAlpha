...
| 跨域出边 | 2263 | Cross-domain Outgoing | 2263 |
...
graph TD
    ...
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOVERNANCE
    D_SECURITY["D_SECURITY production"]
    tests_automation_test_auto_bootstrap_py -.->|contract| D_SECURITY
    ...
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_COMPLIANCE
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOV_DRIFT
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOVERNANCE
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOVERNANCE
    ...
    class D_TRADING,D_SECURITY,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE,D_SECURITY_LLM,D_COMPLIANCE,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    tests_autonomy_test_curation_loop_root_py -.->|test_depends| D_AUTONOMY_CORE
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_TRADING,D_GOVERNANCE,D_INFRA_RECOVERY,D_INTELLIGENCE,D_SIMULATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY_LLM,D_SECURITY,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_RISK,D_GOV_ENFORCEMENT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
| D_SECURITY | 215 | contract,test_depends |

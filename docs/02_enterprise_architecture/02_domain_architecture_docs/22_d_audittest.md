...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_INFRA_RECOVERY,D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_SIMULATION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_SECURITY_LLM,D_INFRA_RUNTIME,D_TRADING,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_RISK,D_GOV_ENFORCEMENT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SECURITY,D_TRADING,D_GOV_ENFORCEMENT external_prod
```

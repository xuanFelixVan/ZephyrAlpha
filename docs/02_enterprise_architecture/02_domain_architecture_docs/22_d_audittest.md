...
| 跨域出边 | 2262 | Cross-domain Outgoing | 2262 |
...
graph TD
    ...
    tests_automation_test_auto_evolution_root_py -.->|test_depends| D_TRADING
    tests_automation_test_auto_bootstrap_py -.->|data| D_GOVERNANCE
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOVERNANCE
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOVERNANCE
    tests_automation_test_auto_bootstrap_py -.->|contract| D_GOVERNANCE
    D_SECURITY_LLM["D_SECURITY_LLM production"]
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_SECURITY_LLM
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_INFRA_RUNTIME
    D_GOVERNANCE -.->|runtime| tests_automation_test_auto_bootstrap_py
    D_GOVERNANCE -.->|runtime| tests_automation_test_auto_bootstrap_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY_LLM external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_INFRA_RECOVERY,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_GOVERNANCE,D_SECURITY_LLM,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_TRADING,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    tests_contracts_test_ct_drift_budget_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_drift_budget_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_drift_budget_py -.->|test_depends| D_INTEGRATION
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_GOVERNANCE,D_INFRA_RECOVERY,D_TRADING,D_INTELLIGENCE,D_SIMULATION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_TRADING,D_SECURITY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_SHARED,D_SECURITY,D_INFRA_RUNTIME,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_INFRA_RUNTIME,D_SECURITY,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
|------|:---:|---------|
| D_GOVERNANCE | 8 | contract,runtime |
...
│                    [contract] (1 条 / edges)                     │
├──────────────────────────────────────────────────────────────────┤
│   test_auto_bootstrap.py → test_a2a_check.py                     │
└──────────────────────────────────────────────────────────────────┘

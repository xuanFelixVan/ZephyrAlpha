...
| 模块数 | 1694 | Module Count | 1694 |
| 域内依赖 | 1 | Internal Dependencies | 1 |
| 跨域入边 | 0 | Cross-domain Incoming | 0 |
| 跨域出边 | 2248 | Cross-domain Outgoing | 2248 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 1645 | Prototype Modules | 1645 |
...
graph TD
    ...
    tests_action_test_action_side_effect_cumulative_detector_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SECURITY,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    D_SECURITY["D_SECURITY production"]
    tests_automation_test_auto_maintenance_py -.->|test_depends| D_SECURITY
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    tests_autonomy_test_solo_dev_safety_net_py -.->|test_depends| D_SECURITY_LLM
    tests_autonomy_test_shadow_canary_py -.->|test_depends| D_AUTONOMY_CORE
    tests_autonomy_test_staleness_manager_py -.->|test_depends| D_AUTONOMY_CORE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    tests_capability_test_capability_passport_py -.->|test_depends| D_INTELLIGENCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING external_prod
```
...
graph TD
    ...
    tests_federated_learning_test_fl_data_quality_gate_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_governance_integration_test_layer_consumer_registry_py -.->|test_depends| D_INFRA_RUNTIME
    tests_governance_integration_test_layer_consumer_registry_py -.->|test_depends| D_INFRA_RUNTIME
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_INTEGRATION external_prod
```
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_governance_rule_enforcement_test_r5_digit_suffix_gate_py["tests/governance/rule_enforcement/test_r5_digit... prototype"]
...
graph TD
    ...
    D_SECURITY["D_SECURITY production"]
    tests_governance_security_test_governance_contracts_py -.->|test_depends| D_SECURITY
...
graph TD
    ...
    tests_infrastructure_test_arbiter_py -.->|test_depends| D_INFRA_A2A
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    tests_kb_test_kb_migration_embedding_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    tests_llm_security_test_engine_degradation_root_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_engine_degradation_root_py -.->|test_depends| D_SECURITY
    D_SECURITY_LLM["D_SECURITY_LLM production"]
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_llm_security_test_security_ssot_guard_py -.->|test_depends| D_SHARED
    tests_llm_security_test_security_ssot_guard_py -.->|test_depends| D_SHARED
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_model_test_model_health_py -.->|test_depends| D_TRADING
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_model_test_model_router_py -.->|test_depends| D_INFRA_RUNTIME
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_orchestrator_test_orchestrator_hallucination_detector_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    tests_prompt_test_prompt_sanitizer_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_rollback_test_rollback_integrity_py -.->|test_depends| D_TRADING
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_safety_test_safety_gate_l1_l27_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_semantic_auditor_test_semantic_intent_preservation_guard_py -.->|test_depends| D_TRADING
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
...
graph TD
    ...
    tests_skill_test_skill_feedback_py -.->|test_depends| D_AUTONOMY_CORE
...
graph TD
    ...
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_skill_test_skill_team_optimizer_py -.->|test_depends| D_AUTONOMY_CORE
...
graph TD
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_trading_test_dead_letter_queue_py -.->|test_depends| D_INFRA_RUNTIME
    tests_trading_test_dead_letter_queue_py -.->|test_depends| D_INFRA_RUNTIME
    D_TRADING["D_TRADING production"]
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_trading_test_startup_sequencer_py -.->|test_depends| D_TRADING
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RECOVERY,D_SHARED external_prod
```
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_trae_rules_test_g_trae_025_py -.->|test_depends| D_SHARED
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    tests_trae_rules_test_g_trae_025_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_025_py -.->|test_depends| D_GOV_ENFORCEMENT
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_trae_rules_test_g_trae_055_py -.->|test_depends| D_SHARED
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    tests_trae_rules_test_g_trae_055_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_055_py -.->|test_depends| D_GOV_ENFORCEMENT
...
> 按 architecture_layer 分层显示 审计测试套件（D_AUDITTEST）的模块分布。共 1694 个模块 / 1694 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│             L2 领域层 / Domain Layer (1694 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 1694 个模块 / 1694 modules）。

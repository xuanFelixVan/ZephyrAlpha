...
| 模块数 | 1693 | Module Count | 1693 |
| 域内依赖 | 1 | Internal Dependencies | 1 |
| 跨域入边 | 0 | Cross-domain Incoming | 0 |
| 跨域出边 | 2246 | Cross-domain Outgoing | 2246 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 1644 | Prototype Modules | 1644 |
...
graph TD
    ...
    tests_action_test_action_interaction_detector_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    tests_agent_rbac_test_abac_guard_agent_rbac_py -.->|test_depends| D_SECURITY
    tests_agent_rbac_test_abac_guard_agent_rbac_py -.->|test_depends| D_SECURITY
    ...
    class D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_TRADING,D_SECURITY,D_GOVERNANCE external_prod
```

### 第 4 页 / 共 57 页 / Page 4 of 57
...
graph TD
    ...
    tests_audit_test_cognitive_load_budget_py -.->|test_depends| D_TRADING
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_audit_test_system_topology_py["tests/audit/test_system_topology.py prototype"]
    ...
    tests_audit_test_serialization_format_tracker_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_audit_test_intermittent_failure_pattern_py,tests_audit_test_latency_slo_py,tests_audit_test_ml_engineering_py,tests_audit_test_mtti_tracker_py,tests_audit_test_naming_magic_checker_py,tests_audit_test_orphan_scanner_py,tests_audit_test_performance_baseline_py,tests_audit_test_point_in_time_reconstructor_py,tests_audit_test_pre_flight_simulator_py,tests_audit_test_preventive_repair_py,tests_audit_test_python_compat_py,tests_audit_test_regime_detector_py,tests_audit_test_regime_gain_scheduling_py,tests_audit_test_roi_engine_py,tests_audit_test_scan_mutex_py,tests_audit_test_serialization_format_tracker_py,tests_audit_test_sim2real_calibration_py,tests_audit_test_socratic_questions_py,tests_audit_test_state_machine_py,tests_audit_test_statistical_hygiene_auditor_py,tests_audit_test_sub_agent_collusion_py,tests_audit_test_suppression_learner_py,tests_audit_test_symlink_checker_py,tests_audit_test_system_topology_py,tests_audit_test_tamper_proof_audit_py,tests_audit_test_test_fixture_checker_py,tests_audit_test_toctou_revalidation_py,tests_audit_test_toil_quantification_py,tests_audit_test_tone_adapter_py,tests_audit_test_tone_adapter_v2_py design
    class D_TRADING,D_GOVERNANCE external_prod
```

### 第 8 页 / 共 57 页 / Page 8 of 57
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_audit_test_traffic_replay_validator_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_autonomy_test_assembly_context_injector_py -.->|test_depends| D_AUTONOMY_CORE
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_autonomy_test_autonomy_dashboard_py -.->|test_depends| D_INFRA_RECOVERY
...
graph TD
    ...
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_autonomy_test_mgmt_context_evictor_py -.->|test_depends| D_AUTONOMY_CORE
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_ba_test_ba_events_py -.->|test_depends| D_GOVERNANCE
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
...
graph TD
    ...
    tests_budget_test_budget_shutdown_py -.->|test_depends| D_GOVERNANCE
    D_TRADING["D_TRADING production"]
    tests_budget_test_budget_shutdown_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_ce_test_ce_vibe_shortcuts_py -.->|test_depends| D_AUTONOMY_CORE
    D_TRADING["D_TRADING production"]
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_context_test_context_manager_py -.->|test_depends| D_GOVERNANCE
    ...
    tests_context_test_context_value_attribution_py -.->|test_depends| D_AUTONOMY_CORE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    tests_contracts_test_ct_circuit_breaker_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_circuit_breaker_py -.->|test_depends| D_GOV_ENFORCEMENT
    D_INTEGRATION["D_INTEGRATION production"]
    tests_contracts_test_ct_circuit_breaker_py -.->|test_depends| D_INTEGRATION
...
graph TD
    ...
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    tests_contracts_test_ct_zero_residue_check_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_zero_residue_check_py -.->|test_depends| D_GOV_ENFORCEMENT
    D_INTEGRATION["D_INTEGRATION production"]
    tests_contracts_test_ct_zero_residue_check_py -.->|test_depends| D_INTEGRATION
    D_SHARED["D_SHARED production"]
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_cross_test_cross_agent_conflict_detector_py -.->|test_depends| D_INFRA_RECOVERY
    D_TRADING["D_TRADING production"]
...
graph TD
    ...
    tests_db_test_db_transition_py -.->|test_depends| D_GOVERNANCE
    D_SHARED["D_SHARED production"]
    tests_db_test_db_red_blue_py -.->|test_depends| D_SHARED
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_e_test_e_contracts_py["tests/e/test_e_contracts.py prototype"]
    ...
    tests_e_test_e_confidence_estimator_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_e_test_e_self_validator_py -.->|test_depends| D_GOVERNANCE
    tests_e_test_e_self_test_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_event_test_event_store_py -.->|test_depends| D_INFRA_RUNTIME
    D_GOVERNANCE["D_GOVERNANCE production"]
    ...
    tests_event_test_event_store_stress_py -.->|test_depends| D_GOVERNANCE
    tests_event_test_event_store_stress_py -.->|test_depends| D_GOVERNANCE
    tests_event_test_event_store_stress_py -.->|test_depends| D_GOVERNANCE
    tests_event_test_event_store_stress_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_federated_learning_test_fl_autonomy_credit_py -.->|test_depends| D_TRADING
    tests_federated_learning_test_fl_autonomy_maturity_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_federated_learning_test_fl_flag_lifecycle_manager_py -.->|test_depends| D_TRADING
    ...
    tests_federated_learning_test_fl_generator_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_feedback_test_architectural_sod_py -.->|test_depends| D_TRADING
    tests_feedback_test_autoscale_remediation_py -.->|test_depends| D_TRADING
    tests_feedback_test_automated_rca_postmortem_generator_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_feedback_test_ewc_kb_review_py -.->|test_depends| D_TRADING
    tests_feedback_test_exceptions_feedback_loop_py -.->|test_depends| D_TRADING
    tests_feedback_test_evolution_init_py -.->|test_depends| D_TRADING
    tests_feedback_test_evolution_init_py -.->|test_depends| D_TRADING
    tests_feedback_test_evolution_init_py -.->|test_depends| D_TRADING
    tests_feedback_test_evolution_init_py -.->|test_depends| D_TRADING
    tests_feedback_test_evolution_init_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_feedback_test_metric_cardinality_guard_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_feedback_test_stochastic_diagnosis_verifier_v2_py -.->|test_depends| D_TRADING
    tests_feedback_test_synthetic_anomaly_generator_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    class tests_fixtures_test_mixed_target_py,tests_fixtures_test_staging_target_py design
```

### 第 28 页 / 共 57 页 / Page 28 of 57
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_fle_test_fle_performance_regression_detector_py,tests_fle_test_fle_protocols_py,tests_fle_test_fle_regime_detector_py,tests_fle_test_fle_self_slo_metrics_py,tests_fle_test_fle_template_py,tests_fle_test_fle_upgrade_safety_validator_py,tests_fle_test_fle_validator_py,tests_gate_test_ci_cd_pre_scanner_py,tests_gate_test_circuit_breaker_types_py,tests_gate_test_concurrent_change_deconfliction_py,tests_gate_test_conflict_arbitration_py,tests_gate_test_cve_scanner_py,tests_gate_test_deployment_suppression_py,tests_gate_test_dynamic_llm_cost_router_py,tests_gate_test_emergency_takeover_py,tests_gate_test_federated_security_py,tests_gate_test_flag_lifecycle_manager_py,tests_gate_test_gate_context_py,tests_gate_test_gate_health_py,tests_gate_test_gate_integrity_guard_py,tests_gate_test_gate_override_py,tests_gate_test_gate_persistence_py,tests_gate_test_gate_pipeline_py,tests_gate_test_gate_simulator_py,tests_gate_test_gate_types_py,tests_gate_test_license_compliance_py,tests_gate_test_merkle_audit_root_py,tests_gate_test_meta_performance_gate_py,tests_gate_test_parameterized_safety_gate_py,tests_gate_test_resilience_circuit_breaker_py design
    class D_TRADING,D_SHARED external_prod
```

### 第 30 页 / 共 57 页 / Page 30 of 57
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_gate_test_scope_creep_monitor_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_git_test_git_commit_concurrent_py -.->|test_depends| D_GOVERNANCE
    tests_git_test_git_bisector_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_governance_audit_test_changelog_manager_py -.->|test_depends| D_GOVERNANCE
    tests_governance_audit_test_code_archaeology_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_governance_drift_test_down_migration_generator_py["tests/governance/drift/test_down_migration_gene... prototype"]
        ...
        tests_governance_governance_misc_test_backtest_engine_py["tests/governance/governance_misc/test_backtest_... prototype"]
    end
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_governance_compliance_test_human_factors_py -.->|test_depends| D_GOVERNANCE
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_governance_compliance_test_right_to_be_forgotten_py -.->|test_depends| D_INFRA_RECOVERY
    tests_governance_compliance_test_thematic_clusterer_py -.->|test_depends| D_GOVERNANCE
    tests_governance_compliance_test_load_bearing_py -.->|test_depends| D_GOVERNANCE
    tests_governance_compliance_test_quiet_period_monitor_py -.->|test_depends| D_GOVERNANCE
    tests_governance_compliance_test_owner_absent_py -.->|test_depends| D_INFRA_RECOVERY
    tests_governance_data_layer_test_cache_manager_py -.->|test_depends| D_GOVERNANCE
    tests_governance_data_layer_test_sqlite_dumper_py -.->|test_depends| D_INFRA_RECOVERY
    tests_governance_data_layer_test_s3_snapshot_lifecycle_py -.->|test_depends| D_INFRA_RECOVERY
    tests_governance_data_layer_test_symbol_index_py -.->|test_depends| D_GOVERNANCE
    tests_governance_delegation_test_behavioral_trust_checker_py -.->|test_depends| D_GOVERNANCE
    tests_governance_delegation_test_behavioral_sampler_py -.->|test_depends| D_GOVERNANCE
    tests_governance_delegation_test_continuous_trust_py -.->|test_depends| D_INFRA_RECOVERY
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_governance_integration_test_layer_consumer_registry_py["tests/governance/integration/test_layer_consume... prototype"]
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_governance_observability_test_report_py -.->|test_depends| D_GOVERNANCE
    tests_governance_observability_test_meta_confidence_py -.->|test_depends| D_GOVERNANCE
    tests_governance_observability_test_meta_observability_py -.->|test_depends| D_GOVERNANCE
    tests_governance_ops_test_daily_ops_py -.->|test_depends| D_GOVERNANCE
    tests_governance_ops_test_exit_codes_py -.->|test_depends| D_GOVERNANCE
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_governance_ops_test_env_watcher_py -.->|test_depends| D_INFRA_RECOVERY
    tests_governance_ops_test_health_monitor_py -.->|test_depends| D_GOVERNANCE
    tests_governance_ops_test_success_validator_py -.->|test_depends| D_GOVERNANCE
    tests_governance_ops_test_runbook_generator_py -.->|test_depends| D_INFRA_RECOVERY
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_governance_rule_enforcement_test_adversarial_gate_integration_py["tests/governance/rule_enforcement/test_adversar... prototype"]
        ...
        tests_governance_rule_enforcement_test_adversarial_validation_py["tests/governance/rule_enforcement/test_adversar... prototype"]
        tests_governance_rule_enforcement_test_adversarial_validation_gate_py["tests/governance/rule_enforcement/test_adversar... prototype"]
        tests_governance_rule_enforcement_test_alternative_path_blocker_py["tests/governance/rule_enforcement/test_alternat... prototype"]
        tests_governance_rule_enforcement_test_arch_reference_gate_py["tests/governance/rule_enforcement/test_arch_ref... prototype"]
        tests_governance_rule_enforcement_test_atomic_fixer_py["tests/governance/rule_enforcement/test_atomic_f... prototype"]
        tests_governance_rule_enforcement_test_base_repo_py["tests/governance/rule_enforcement/test_base_rep... prototype"]
        ...
        tests_governance_rule_enforcement_test_check_type_registry_py["tests/governance/rule_enforcement/test_check_ty... prototype"]
        tests_governance_rule_enforcement_test_check_vocab_hardcode_py["tests/governance/rule_enforcement/test_check_vo... prototype"]
        tests_governance_rule_enforcement_test_claim_required_gate_py["tests/governance/rule_enforcement/test_claim_re... prototype"]
        tests_governance_rule_enforcement_test_clock_guard_py["tests/governance/rule_enforcement/test_clock_gu... prototype"]
        tests_governance_rule_enforcement_test_command_chain_length_gate_py["tests/governance/rule_enforcement/test_command_... prototype"]
        tests_governance_rule_enforcement_test_commit_gate_registry_py["tests/governance/rule_enforcement/test_commit_g... prototype"]
        tests_governance_rule_enforcement_test_commit_quality_gate_py["tests/governance/rule_enforcement/test_commit_q... prototype"]
        tests_governance_rule_enforcement_test_create_guard_py["tests/governance/rule_enforcement/test_create_g... prototype"]
        tests_governance_rule_enforcement_test_dangling_reference_gate_py["tests/governance/rule_enforcement/test_dangling... prototype"]
        tests_governance_rule_enforcement_test_depgraph_db_py["tests/governance/rule_enforcement/test_depgraph... prototype"]
        tests_governance_rule_enforcement_test_depgraph_generator_design_protection_py["tests/governance/rule_enforcement/test_depgraph... prototype"]
        tests_governance_rule_enforcement_test_directory_contract_gate_py["tests/governance/rule_enforcement/test_director... prototype"]
        tests_governance_rule_enforcement_test_en_001_circular_dependency_py["tests/governance/rule_enforcement/test_en_001_c... prototype"]
        tests_governance_rule_enforcement_test_en_002_enforcement_validator_py["tests/governance/rule_enforcement/test_en_002_e... prototype"]
        tests_governance_rule_enforcement_test_en_003_contract_compatibility_py["tests/governance/rule_enforcement/test_en_003_c... prototype"]
        tests_governance_rule_enforcement_test_en_process_lifecycle_gateway_py["tests/governance/rule_enforcement/test_en_proce... prototype"]
    end
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_governance_resilience_test_stream_abort_guard_py -.->|test_depends| D_GOVERNANCE
    tests_governance_resilience_test_timeout_guard_py -.->|test_depends| D_GOVERNANCE
    tests_governance_resilience_test_witness_isolation_py -.->|test_depends| D_GOVERNANCE
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_governance_resilience_test_warm_standby_py -.->|test_depends| D_INFRA_RECOVERY
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    tests_governance_rule_enforcement_test_adversarial_gate_integration_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_adversarial_gate_integration_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_adversarial_gate_integration_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_adaptive_threshold_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_adversarial_validation_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_adversarial_validation_gate_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_arch_reference_gate_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_adversarial_strategies_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_alternative_path_blocker_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_base_repo_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_atomic_fixer_py -.->|test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_governance_resilience_test_stream_abort_guard_py,tests_governance_resilience_test_timeout_guard_py,tests_governance_resilience_test_warm_standby_py,tests_governance_resilience_test_witness_isolation_py,tests_governance_rule_enforcement_test_adaptive_threshold_py,tests_governance_rule_enforcement_test_adversarial_gate_integration_py,tests_governance_rule_enforcement_test_adversarial_strategies_py,tests_governance_rule_enforcement_test_adversarial_validation_py,tests_governance_rule_enforcement_test_adversarial_validation_gate_py,tests_governance_rule_enforcement_test_alternative_path_blocker_py,tests_governance_rule_enforcement_test_arch_reference_gate_py,tests_governance_rule_enforcement_test_atomic_fixer_py,tests_governance_rule_enforcement_test_base_repo_py,tests_governance_rule_enforcement_test_breaking_change_detector_py,tests_governance_rule_enforcement_test_check_type_registry_py,tests_governance_rule_enforcement_test_check_vocab_hardcode_py,tests_governance_rule_enforcement_test_claim_required_gate_py,tests_governance_rule_enforcement_test_clock_guard_py,tests_governance_rule_enforcement_test_command_chain_length_gate_py,tests_governance_rule_enforcement_test_commit_gate_registry_py,tests_governance_rule_enforcement_test_commit_quality_gate_py,tests_governance_rule_enforcement_test_create_guard_py,tests_governance_rule_enforcement_test_dangling_reference_gate_py,tests_governance_rule_enforcement_test_depgraph_db_py,tests_governance_rule_enforcement_test_depgraph_generator_design_protection_py,tests_governance_rule_enforcement_test_directory_contract_gate_py,tests_governance_rule_enforcement_test_en_001_circular_dependency_py,tests_governance_rule_enforcement_test_en_002_enforcement_validator_py,tests_governance_rule_enforcement_test_en_003_contract_compatibility_py,tests_governance_rule_enforcement_test_en_process_lifecycle_gateway_py design
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
```

### 第 37 页 / 共 57 页 / Page 37 of 57
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_governance_rule_enforcement_test_forward_fix_runner_py["tests/governance/rule_enforcement/test_forward_... prototype"]
        tests_governance_rule_enforcement_test_grandfather_manager_py["tests/governance/rule_enforcement/test_grandfat... prototype"]
        tests_governance_rule_enforcement_test_held_overlap_gate_py["tests/governance/rule_enforcement/test_held_ove... prototype"]
        tests_governance_rule_enforcement_test_hooks_integrity_guard_py["tests/governance/rule_enforcement/test_hooks_in... prototype"]
        ...
        tests_governance_rule_enforcement_test_integrity_root_py["tests/governance/rule_enforcement/test_integrit... prototype"]
        tests_governance_rule_enforcement_test_integrity_verifier_py["tests/governance/rule_enforcement/test_integrit... prototype"]
        ...
        tests_governance_rule_enforcement_test_policy_sandbox_py["tests/governance/rule_enforcement/test_policy_s... prototype"]
        tests_governance_rule_enforcement_test_policy_tree_validator_py["tests/governance/rule_enforcement/test_policy_t... prototype"]
        tests_governance_rule_enforcement_test_post_doc_review_py["tests/governance/rule_enforcement/test_post_doc... prototype"]
        tests_governance_rule_enforcement_test_pre_apply_integrity_gate_py["tests/governance/rule_enforcement/test_pre_appl... prototype"]
        tests_governance_rule_enforcement_test_preemption_manager_py["tests/governance/rule_enforcement/test_preempti... prototype"]
        tests_governance_rule_enforcement_test_result_types_py["tests/governance/rule_enforcement/test_result_t... prototype"]
        tests_governance_rule_enforcement_test_secrets_guard_py["tests/governance/rule_enforcement/test_secrets_... prototype"]
        tests_governance_rule_enforcement_test_session_worktree_py["tests/governance/rule_enforcement/test_session_... prototype"]
        tests_governance_rule_enforcement_test_ssot_gate_py["tests/governance/rule_enforcement/test_ssot_gat... prototype"]
        tests_governance_rule_enforcement_test_ssot_registrar_py["tests/governance/rule_enforcement/test_ssot_reg... prototype"]
        tests_governance_rule_enforcement_test_topology_change_log_py["tests/governance/rule_enforcement/test_topology... prototype"]
        tests_governance_rule_enforcement_test_triple_alignment_py["tests/governance/rule_enforcement/test_triple_a... prototype"]
        tests_governance_rule_enforcement_test_zero_residue_check_py["tests/governance/rule_enforcement/test_zero_res... prototype"]
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_governance_rule_enforcement_test_forward_fix_runner_py -.->|test_depends| D_INFRA_RECOVERY
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_governance_rule_enforcement_test_grandfather_manager_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_hooks_integrity_guard_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_integration_test_runner_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_integrity_root_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_held_overlap_gate_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_held_overlap_gate_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_integrity_verifier_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_kiss_enforcer_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_policy_sandbox_py -.->|test_depends| D_GOVERNANCE
    tests_governance_rule_enforcement_test_output_quality_gate_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_post_doc_review_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_governance_rule_enforcement_test_preemption_manager_py -.->|test_depends| D_GOV_ENFORCEMENT
    D_INTEGRATION["D_INTEGRATION production"]
    tests_governance_rule_enforcement_test_preemption_manager_py -.->|test_depends| D_INTEGRATION
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_governance_rule_enforcement_test_end_to_end_walkthrough_py,tests_governance_rule_enforcement_test_forward_fix_runner_py,tests_governance_rule_enforcement_test_grandfather_manager_py,tests_governance_rule_enforcement_test_held_overlap_gate_py,tests_governance_rule_enforcement_test_hooks_integrity_guard_py,tests_governance_rule_enforcement_test_integration_test_runner_py,tests_governance_rule_enforcement_test_integrity_root_py,tests_governance_rule_enforcement_test_integrity_verifier_py,tests_governance_rule_enforcement_test_kiss_enforcer_py,tests_governance_rule_enforcement_test_output_quality_gate_py,tests_governance_rule_enforcement_test_policy_sandbox_py,tests_governance_rule_enforcement_test_policy_tree_validator_py,tests_governance_rule_enforcement_test_post_doc_review_py,tests_governance_rule_enforcement_test_pre_apply_integrity_gate_py,tests_governance_rule_enforcement_test_preemption_manager_py,tests_governance_rule_enforcement_test_result_types_py,tests_governance_rule_enforcement_test_secrets_guard_py,tests_governance_rule_enforcement_test_session_worktree_py,tests_governance_rule_enforcement_test_ssot_gate_py,tests_governance_rule_enforcement_test_ssot_registrar_py,tests_governance_rule_enforcement_test_topology_change_log_py,tests_governance_rule_enforcement_test_triple_alignment_py,tests_governance_rule_enforcement_test_zero_residue_check_py,tests_governance_security_test_extraction_safety_py,tests_governance_security_test_github_api_guard_py,tests_governance_security_test_governance_a2a_check_py,tests_governance_security_test_governance_approver_check_py,tests_governance_security_test_governance_bootstrap_superadmin_py,tests_governance_security_test_governance_capability_check_py,tests_governance_security_test_governance_contracts_py design
    class D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOVERNANCE,D_INTEGRATION external_prod
```

### 第 38 页 / 共 57 页 / Page 38 of 57
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_governance_security_test_import_surface_tracker_py -.->|test_depends| D_GOVERNANCE
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_governance_security_test_sandbox_enforcer_py -.->|test_depends| D_INFRA_RECOVERY
...
graph TD
    ...
    tests_infrastructure_test_reconciler_root_py -.->|test_depends| D_INFRA_RUNTIME
    tests_infrastructure_test_scanner_root_py -.->|test_depends| D_INFRA_RUNTIME
    tests_infrastructure_test_scanner_root_py -.->|test_depends| D_INFRA_RUNTIME
    tests_infrastructure_test_supervisor_py -.->|test_depends| D_INFRA_A2A
    tests_infrastructure_test_supervisor_py -.->|test_depends| D_INFRA_A2A
    D_TRADING["D_TRADING production"]
    tests_infrastructure_test_split_brain_quorum_py -.->|test_depends| D_TRADING
    tests_infrastructure_test_streaming_py -.->|test_depends| D_INFRA_A2A
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_infrastructure_test_metadata_py,tests_infrastructure_test_push_notifier_py,tests_infrastructure_test_pydantic_v2_migrator_py,tests_infrastructure_test_reconciler_root_py,tests_infrastructure_test_registry_adapter_root_py,tests_infrastructure_test_registry_governance_infrastructure_py,tests_infrastructure_test_registry_governance_root_py,tests_infrastructure_test_scanner_root_py,tests_infrastructure_test_span_stub_py,tests_infrastructure_test_split_brain_quorum_py,tests_infrastructure_test_streaming_py,tests_infrastructure_test_supervisor_py,tests_infrastructure_test_telemetry_py,tests_infrastructure_test_trigger_monitor_py,tests_infrastructure_test_trust_anchor_root_py,tests_infrastructure_test_warm_hot_gate_py,tests_intent_test_intent_archiver_py,tests_intent_test_intent_binder_root_py,tests_intent_test_intent_driven_ops_py,tests_intent_test_intent_keyword_mapper_root_py,tests_intent_test_intent_parser_root_py,tests_io_test_depgraph_schema_py,tests_io_test_io_content_fingerprint_py,tests_io_test_io_file_utils_py,tests_io_test_io_frontmatter_utils_py,tests_io_test_io_paths_py,tests_io_test_io_serialization_py,tests_io_test_mcp_launcher_py,tests_io_test_mcp_task_claim_py,tests_io_test_verify_schema_health_py design
    class D_INFRA_RUNTIME,D_INFRA_A2A,D_TRADING external_prod
```

### 第 41 页 / 共 57 页 / Page 41 of 57
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_llm_security_test_anomaly_detector_py["tests/llm_security/test_anomaly_detector.py prototype"]
        tests_llm_security_test_anti_pattern_guard_root_py["tests/llm_security/test_anti_pattern_guard_root.py prototype"]
        tests_llm_security_test_approver_check_py["tests/llm_security/test_approver_check.py prototype"]
        tests_llm_security_test_asymmetric_audit_py["tests/llm_security/test_asymmetric_audit.py prototype"]
        ...
        tests_llm_security_test_bootstrap_superadmin_py["tests/llm_security/test_bootstrap_superadmin.py prototype"]
        tests_llm_security_test_bootstrap_verifier_py["tests/llm_security/test_bootstrap_verifier.py prototype"]
        tests_llm_security_test_build_sanitizer_py["tests/llm_security/test_build_sanitizer.py prototype"]
        tests_llm_security_test_cascading_failure_isolator_py["tests/llm_security/test_cascading_failure_isola... prototype"]
        tests_llm_security_test_code_integrity_py["tests/llm_security/test_code_integrity.py prototype"]
        tests_llm_security_test_compliance_matrix_py["tests/llm_security/test_compliance_matrix.py prototype"]
        tests_llm_security_test_continuous_verifier_py["tests/llm_security/test_continuous_verifier.py prototype"]
        tests_llm_security_test_contracts_py["tests/llm_security/test_contracts.py prototype"]
        ...
        tests_llm_security_test_cybersec_2026_guard_py["tests/llm_security/test_cybersec_2026_guard.py prototype"]
        ...
        tests_llm_security_test_defense_depth_py["tests/llm_security/test_defense_depth.py prototype"]
        ...
        tests_llm_security_test_derive_rbac_roles_py["tests/llm_security/test_derive_rbac_roles.py prototype"]
        tests_llm_security_test_dry_run_root_py["tests/llm_security/test_dry_run_root.py prototype"]
        tests_llm_security_test_emergency_override_py["tests/llm_security/test_emergency_override.py prototype"]
        tests_llm_security_test_engine_degradation_root_py["tests/llm_security/test_engine_degradation_root.py prototype"]
    end
    D_TRADING["D_TRADING production"]
    ...
    D_SECURITY["D_SECURITY production"]
    tests_llm_security_test_anomaly_detector_py -.->|test_depends| D_SECURITY
    D_SECURITY_LLM["D_SECURITY_LLM production"]
    ...
    tests_llm_security_test_anti_pattern_guard_root_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_approver_check_py -.->|test_depends| D_SECURITY
    tests_knowledge_engine_test_knowledge_market_py -.->|test_depends| D_TRADING
    tests_llm_security_test_asymmetric_audit_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_bootstrap_superadmin_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_build_sanitizer_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_bootstrap_verifier_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_behavior_audit_logger_py -.->|test_depends| D_SECURITY_LLM
    tests_llm_security_test_cascading_failure_isolator_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_compliance_matrix_py -.->|test_depends| D_SECURITY
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_knowledge_engine_test_knowledge_injection_py,tests_knowledge_engine_test_knowledge_injection_pre_flight_verifier_py,tests_knowledge_engine_test_knowledge_market_py,tests_knowledge_engine_test_knowledge_packaging_py,tests_llm_security_test_adversarial_mutator_py,tests_llm_security_test_anomaly_detector_py,tests_llm_security_test_anti_pattern_guard_root_py,tests_llm_security_test_approver_check_py,tests_llm_security_test_asymmetric_audit_py,tests_llm_security_test_batch_fixer_py,tests_llm_security_test_behavior_audit_logger_py,tests_llm_security_test_bootstrap_superadmin_py,tests_llm_security_test_bootstrap_verifier_py,tests_llm_security_test_build_sanitizer_py,tests_llm_security_test_cascading_failure_isolator_py,tests_llm_security_test_code_integrity_py,tests_llm_security_test_compliance_matrix_py,tests_llm_security_test_continuous_verifier_py,tests_llm_security_test_contracts_py,tests_llm_security_test_cross_module_integration_llm_security_py,tests_llm_security_test_cybersec_2026_guard_py,tests_llm_security_test_db_py,tests_llm_security_test_dedup_extractor_py,tests_llm_security_test_defense_depth_py,tests_llm_security_test_dep_cve_correlator_py,tests_llm_security_test_dep_version_fixer_py,tests_llm_security_test_derive_rbac_roles_py,tests_llm_security_test_dry_run_root_py,tests_llm_security_test_emergency_override_py,tests_llm_security_test_engine_degradation_root_py design
    class D_TRADING,D_SECURITY,D_SECURITY_LLM external_prod
```

### 第 43 页 / 共 57 页 / Page 43 of 57

```mermaid
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        tests_llm_security_test_engine_root_py["tests/llm_security/test_engine_root.py prototype"]
        tests_llm_security_test_environment_manager_py["tests/llm_security/test_environment_manager.py prototype"]
        tests_llm_security_test_exceptions_root_py["tests/llm_security/test_exceptions_root.py prototype"]
        tests_llm_security_test_fail_closed_py["tests/llm_security/test_fail_closed.py prototype"]
        tests_llm_security_test_false_completion_detector_py["tests/llm_security/test_false_completion_detect... prototype"]
        tests_llm_security_test_gateway_e2e_py["tests/llm_security/test_gateway_e2e.py prototype"]
        tests_llm_security_test_genesis_bootstrap_py["tests/llm_security/test_genesis_bootstrap.py prototype"]
        tests_llm_security_test_immutable_core_root_py["tests/llm_security/test_immutable_core_root.py prototype"]
        tests_llm_security_test_injection_patterns_py["tests/llm_security/test_injection_patterns.py prototype"]
        tests_llm_security_test_input_guard_root_py["tests/llm_security/test_input_guard_root.py prototype"]
        tests_llm_security_test_input_sanitizer_llm_security_py["tests/llm_security/test_input_sanitizer_llm_sec... prototype"]
        tests_llm_security_test_integrity_self_check_py["tests/llm_security/test_integrity_self_check.py prototype"]
        ...
        tests_llm_security_test_key_hierarchy_py["tests/llm_security/test_key_hierarchy.py prototype"]
        tests_llm_security_test_kill_switch_root_py["tests/llm_security/test_kill_switch_root.py prototype"]
        ...
        tests_llm_security_test_legal_audit_chain_py["tests/llm_security/test_legal_audit_chain.py prototype"]
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_llm_security_test_engine_root_py -.->|test_depends| D_INFRA_RUNTIME
    tests_llm_security_test_engine_root_py -.->|test_depends| D_INFRA_RUNTIME
    D_SECURITY_LLM["D_SECURITY_LLM production"]
    tests_llm_security_test_fail_closed_py -.->|test_depends| D_SECURITY_LLM
    D_SHARED["D_SHARED production"]
    tests_llm_security_test_fail_closed_py -.->|test_depends| D_SHARED
    tests_llm_security_test_fail_closed_py -.->|test_depends| D_SECURITY_LLM
    D_SECURITY["D_SECURITY production"]
    tests_llm_security_test_genesis_bootstrap_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_gateway_e2e_py -.->|test_depends| D_SHARED
    tests_llm_security_test_gateway_e2e_py -.->|test_depends| D_SECURITY_LLM
    tests_llm_security_test_environment_manager_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_exceptions_root_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_false_completion_detector_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_immutable_core_root_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_injection_patterns_py -.->|test_depends| D_SECURITY_LLM
    tests_llm_security_test_input_sanitizer_llm_security_py -.->|test_depends| D_SECURITY_LLM
    tests_llm_security_test_input_guard_root_py -.->|test_depends| D_SECURITY
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_llm_security_test_engine_root_py,tests_llm_security_test_environment_manager_py,tests_llm_security_test_exceptions_root_py,tests_llm_security_test_fail_closed_py,tests_llm_security_test_false_completion_detector_py,tests_llm_security_test_gateway_e2e_py,tests_llm_security_test_genesis_bootstrap_py,tests_llm_security_test_immutable_core_root_py,tests_llm_security_test_injection_patterns_py,tests_llm_security_test_input_guard_root_py,tests_llm_security_test_input_sanitizer_llm_security_py,tests_llm_security_test_integrity_self_check_py,tests_llm_security_test_interrupt_guard_py,tests_llm_security_test_isolation_py,tests_llm_security_test_key_hierarchy_py,tests_llm_security_test_kill_switch_root_py,tests_llm_security_test_l0_supply_chain_py,tests_llm_security_test_l1_input_defense_py,tests_llm_security_test_l2_prompt_protection_py,tests_llm_security_test_l2a_process_sandbox_py,tests_llm_security_test_l3_output_security_py,tests_llm_security_test_l4_agent_security_py,tests_llm_security_test_l5_resource_protection_py,tests_llm_security_test_l6_observability_py,tests_llm_security_test_l7_red_team_py,tests_llm_security_test_l7_validation_py,tests_llm_security_test_l8_multi_agent_py,tests_llm_security_test_legal_audit_chain_py,tests_llm_security_test_llm_cost_accounting_py,tests_llm_security_test_llm_cost_router_py design
    class D_INFRA_RUNTIME,D_SECURITY_LLM,D_SHARED,D_SECURITY external_prod
```

### 第 44 页 / 共 57 页 / Page 44 of 57
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        ...
        tests_llm_security_test_micro_verifier_py["tests/llm_security/test_micro_verifier.py prototype"]
        tests_llm_security_test_models_root_py["tests/llm_security/test_models_root.py prototype"]
        tests_llm_security_test_monotonic_clock_py["tests/llm_security/test_monotonic_clock.py prototype"]
        tests_llm_security_test_native_api_guard_py["tests/llm_security/test_native_api_guard.py prototype"]
        tests_llm_security_test_non_repudiation_py["tests/llm_security/test_non_repudiation.py prototype"]
        tests_llm_security_test_novel_attack_guard_py["tests/llm_security/test_novel_attack_guard.py prototype"]
        tests_llm_security_test_orphan_detector_py["tests/llm_security/test_orphan_detector.py prototype"]
        tests_llm_security_test_output_guard_root_py["tests/llm_security/test_output_guard_root.py prototype"]
        tests_llm_security_test_permission_hooks_py["tests/llm_security/test_permission_hooks.py prototype"]
        tests_llm_security_test_permission_mode_manager_py["tests/llm_security/test_permission_mode_manager.py prototype"]
        tests_llm_security_test_post_action_verifier_py["tests/llm_security/test_post_action_verifier.py prototype"]
        tests_llm_security_test_process_sandbox_llm_security_py["tests/llm_security/test_process_sandbox_llm_sec... prototype"]
        tests_llm_security_test_rbac_audit_bridge_py["tests/llm_security/test_rbac_audit_bridge.py prototype"]
        tests_llm_security_test_remote_attestation_py["tests/llm_security/test_remote_attestation.py prototype"]
        tests_llm_security_test_replay_attack_guard_py["tests/llm_security/test_replay_attack_guard.py prototype"]
        ...
        tests_llm_security_test_secrets_lifecycle_py["tests/llm_security/test_secrets_lifecycle.py prototype"]
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_llm_security_test_llm_fix_adapter_py -.->|test_depends| D_INFRA_RUNTIME
    tests_llm_security_test_llm_fix_adapter_py -.->|test_depends| D_INFRA_RUNTIME
    D_TRADING["D_TRADING production"]
    tests_llm_security_test_llm_quality_regression_py -.->|test_depends| D_TRADING
    D_INTEGRATION["D_INTEGRATION production"]
    tests_llm_security_test_llm_gateway_py -.->|test_depends| D_INTEGRATION
    tests_llm_security_test_llm_provider_integrity_py -.->|test_depends| D_TRADING
    D_SECURITY["D_SECURITY production"]
    tests_llm_security_test_micro_verifier_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_novel_attack_guard_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_monotonic_clock_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_metric_prompt_scanner_py -.->|test_depends| D_TRADING
    tests_llm_security_test_native_api_guard_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_models_root_py -.->|test_depends| D_INFRA_RUNTIME
    tests_llm_security_test_non_repudiation_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_orphan_detector_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_orphan_detector_py -.->|test_depends| D_TRADING
    tests_llm_security_test_output_guard_root_py -.->|test_depends| D_SECURITY
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_llm_security_test_llm_fix_adapter_py,tests_llm_security_test_llm_gateway_py,tests_llm_security_test_llm_provider_integrity_py,tests_llm_security_test_llm_quality_regression_py,tests_llm_security_test_llm_security_py,tests_llm_security_test_metric_prompt_scanner_py,tests_llm_security_test_micro_verifier_py,tests_llm_security_test_models_root_py,tests_llm_security_test_monotonic_clock_py,tests_llm_security_test_native_api_guard_py,tests_llm_security_test_non_repudiation_py,tests_llm_security_test_novel_attack_guard_py,tests_llm_security_test_orphan_detector_py,tests_llm_security_test_output_guard_root_py,tests_llm_security_test_permission_hooks_py,tests_llm_security_test_permission_mode_manager_py,tests_llm_security_test_post_action_verifier_py,tests_llm_security_test_process_sandbox_llm_security_py,tests_llm_security_test_rbac_audit_bridge_py,tests_llm_security_test_remote_attestation_py,tests_llm_security_test_replay_attack_guard_py,tests_llm_security_test_runtime_interceptor_py,tests_llm_security_test_scaffold_registrar_py,tests_llm_security_test_secret_rotation_py,tests_llm_security_test_secrets_py,tests_llm_security_test_secrets_lifecycle_py,tests_llm_security_test_security_py,tests_llm_security_test_security_capability_py,tests_llm_security_test_security_secrets_py,tests_llm_security_test_security_ssot_guard_py design
    class D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION,D_SECURITY external_prod
```

### 第 45 页 / 共 57 页 / Page 45 of 57

```mermaid
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST 审计测试套件"]
        tests_llm_security_test_sequence_guard_root_py["tests/llm_security/test_sequence_guard_root.py prototype"]
        tests_llm_security_test_shadow_workspace_py["tests/llm_security/test_shadow_workspace.py prototype"]
        tests_llm_security_test_shell_dialect_detector_py["tests/llm_security/test_shell_dialect_detector.py prototype"]
        tests_llm_security_test_toctou_guard_root_py["tests/llm_security/test_toctou_guard_root.py prototype"]
        tests_llm_security_test_vibe_coding_guard_py["tests/llm_security/test_vibe_coding_guard.py prototype"]
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_llm_security_test_shadow_workspace_py -.->|test_depends| D_INFRA_RUNTIME
    tests_llm_security_test_shadow_workspace_py -.->|test_depends| D_INFRA_RUNTIME
    D_SECURITY["D_SECURITY production"]
    tests_llm_security_test_sequence_guard_root_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_vibe_coding_guard_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_shell_dialect_detector_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_toctou_guard_root_py -.->|test_depends| D_SECURITY
    tests_llm_security_test_zombie_cleaner_py -.->|test_depends| D_INFRA_RUNTIME
    tests_llm_security_test_zombie_cleaner_py -.->|test_depends| D_INFRA_RUNTIME
    D_TRADING["D_TRADING production"]
    tests_llm_security_test_wireheading_prevention_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_memory_test_memory_poison_guard_py -.->|test_depends| D_GOVERNANCE
    tests_memory_test_memory_guard_py -.->|test_depends| D_SECURITY
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_memory_test_memory_bank_root_py -.->|test_depends| D_AUTONOMY_CORE
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_llm_security_test_sequence_guard_root_py,tests_llm_security_test_shadow_workspace_py,tests_llm_security_test_shell_dialect_detector_py,tests_llm_security_test_toctou_guard_root_py,tests_llm_security_test_vibe_coding_guard_py,tests_llm_security_test_wireheading_prevention_py,tests_llm_security_test_zombie_cleaner_py,tests_memory_test_memory_bank_root_py,tests_memory_test_memory_guard_py,tests_memory_test_memory_poison_guard_py,tests_memory_test_memory_provenance_py,tests_memory_test_memory_provenance_guard_py,tests_memory_test_memory_self_check_py,tests_memory_test_vms_adversarial_hijack_py,tests_memory_test_vms_adversarial_injection_py,tests_memory_test_vms_automation_py,tests_memory_test_vms_lifecycle_py,tests_model_test_benchmark_suite_py,tests_model_test_calibrate_model_diff_py,tests_model_test_cli_py,tests_model_test_deepseek_v4_chat_py,tests_model_test_exam_orchestrator_py,tests_model_test_exam_test_cases_py,tests_model_test_job_matcher_py,tests_model_test_local_model_py,tests_model_test_model_capability_exam_py,tests_model_test_model_discovery_py,tests_model_test_model_drift_detector_py,tests_model_test_model_drift_monitor_py,tests_model_test_model_health_py design
    class D_INFRA_RUNTIME,D_SECURITY,D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
```

### 第 46 页 / 共 57 页 / Page 46 of 57
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_model_test_model_rotation_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_model_test_model_version_detector_py -.->|test_depends| D_GOVERNANCE
    D_INTEGRATION["D_INTEGRATION production"]
    tests_model_test_model_router_py -.->|test_depends| D_INTEGRATION
    tests_model_test_model_rotation_v2_py -.->|test_depends| D_TRADING
    D_INTELLIGENCE["D_INTELLIGENCE production"]
    tests_model_test_profiler_py -.->|test_depends| D_INTELLIGENCE
    tests_model_test_profiler_py -.->|test_depends| D_INTELLIGENCE
    tests_model_test_model_version_semantic_drift_py -.->|test_depends| D_TRADING
    tests_model_test_provider_data_py -.->|test_depends| D_INTELLIGENCE
    D_SECURITY["D_SECURITY production"]
    tests_multi_test_multi_agent_collusion_detector_py -.->|test_depends| D_SECURITY
    tests_model_test_results_writer_py -.->|test_depends| D_INTELLIGENCE
    tests_model_test_results_writer_py -.->|test_depends| D_INTELLIGENCE
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_model_test_model_rotation_py,tests_model_test_model_rotation_v2_py,tests_model_test_model_router_py,tests_model_test_model_version_detector_py,tests_model_test_model_version_semantic_drift_py,tests_model_test_profiler_py,tests_model_test_provider_data_py,tests_model_test_results_writer_py,tests_multi_test_multi_agent_collusion_detector_py,tests_multi_test_multi_agent_orchestrator_py,tests_multi_test_multi_agent_root_py,tests_multi_test_multi_instance_coord_py,tests_multi_test_multi_signal_correlator_py,tests_multi_test_multi_turn_intent_analyzer_py,tests_observability_test_facade_py,tests_observability_test_health_aggregator_root_py,tests_observability_test_health_probes_root_py,tests_observability_test_observability_health_py,tests_observability_test_observability_logging_py,tests_observability_test_observability_metrics_py,tests_observability_test_observability_root_py,tests_observability_test_observability_tracing_py,tests_observability_test_structured_sink_py,tests_observability_test_trace_bridge_py,tests_observability_test_trace_causal_bridge_py,tests_observability_test_watchdog_py,tests_orchestrator_test_deferred_queue_py,tests_orchestrator_test_orchestrator_data_lifecycle_py,tests_orchestrator_test_orchestrator_failure_matcher_py,tests_orchestrator_test_orchestrator_hallucination_detector_py design
    class D_TRADING,D_GOVERNANCE,D_INTEGRATION,D_INTELLIGENCE,D_SECURITY,D_INFRA_A2A external_prod
```

### 第 47 页 / 共 57 页 / Page 47 of 57
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_orchestrator_test_orchestrator_model_registry_py -.->|test_depends| D_TRADING
    tests_orchestrator_test_orchestrator_rollback_manager_py -.->|test_depends| D_TRADING
    tests_orchestrator_test_orchestrator_trigger_router_py -.->|test_depends| D_TRADING
    tests_orchestrator_test_orchestrator_task_queue_py -.->|test_depends| D_TRADING
    tests_orchestrator_test_orchestrator_wave_generator_py -.->|test_depends| D_TRADING
    D_SECURITY["D_SECURITY production"]
    tests_path_test_path_guard_py -.->|test_depends| D_SECURITY
    tests_path_test_path_index_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_path_test_path_index_validator_py -.->|test_depends| D_GOVERNANCE
    tests_path_test_path_tree_generator_design_protection_py -.->|test_depends| D_GOVERNANCE
    D_SHARED["D_SHARED production"]
    tests_path_test_path_tree_generator_design_protection_py -.->|test_depends| D_SHARED
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_phase_test_phase_check_registry_py -.->|test_depends| D_INFRA_RECOVERY
    tests_phase_test_phase_executor_root_py -.->|test_depends| D_TRADING
    tests_phase_test_phase_manager_py -.->|test_depends| D_INFRA_RECOVERY
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_prompt_test_prompt_self_optimization_loop_py -.->|test_depends| D_TRADING
    tests_prompt_test_prompt_version_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_resource_test_resource_guard_py -.->|test_depends| D_GOVERNANCE
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_resource_test_resource_optimization_py -.->|test_depends| D_INFRA_RUNTIME
    tests_resource_test_resource_optimization_py -.->|test_depends| D_TRADING
    tests_resource_test_resource_starvation_aware_py -.->|test_depends| D_TRADING
    tests_risk_test_blast_radius_detector_py -.->|test_depends| D_TRADING
    D_RISK["D_RISK production"]
    tests_risk_test_ml_experiment_pipeline_py -.->|test_depends| D_RISK
    tests_risk_test_risk_matrix_py -.->|test_depends| D_GOVERNANCE
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_rollback_test_concurrency_guard_py -.->|test_depends| D_INFRA_RECOVERY
...
graph TD
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_rollback_test_rollback_lock_py -.->|test_depends| D_INFRA_RECOVERY
    tests_rollback_test_rollback_loop_detector_py -.->|test_depends| D_INFRA_RECOVERY
    D_SECURITY["D_SECURITY production"]
    tests_rollback_test_rollback_sandbox_py -.->|test_depends| D_SECURITY
    tests_rollback_test_rollback_partial_extreme_py -.->|test_depends| D_INFRA_RECOVERY
    tests_rollback_test_rollback_partial_extreme_py -.->|test_depends| D_INFRA_RECOVERY
    tests_rollback_test_rollback_state_machine_py -.->|test_depends| D_INFRA_RECOVERY
    tests_rollback_test_rollback_simulator_py -.->|test_depends| D_INFRA_RECOVERY
    tests_rollback_test_rollback_target_staleness_py -.->|test_depends| D_INFRA_RECOVERY
    tests_rollback_test_rollback_verifier_root_py -.->|test_depends| D_INFRA_RECOVERY
    tests_rollback_test_rollback_wal_py -.->|test_depends| D_INFRA_RECOVERY
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_self_check_test_self_api_throttle_defense_py -.->|test_depends| D_TRADING
    tests_safety_test_scheduler_safety_py -.->|test_depends| D_TRADING
    tests_self_check_test_self_audit_py -.->|test_depends| D_TRADING
    tests_self_check_test_self_benchmark_py -.->|test_depends| D_TRADING
    tests_self_check_test_self_bottleneck_detector_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_self_check_test_self_budget_tracker_py -.->|test_depends| D_GOVERNANCE
    tests_self_check_test_self_check_py -.->|test_depends| D_GOVERNANCE
    tests_self_check_test_self_diagnosis_py -.->|test_depends| D_TRADING
    ...
    tests_self_check_test_self_diagnosis_data_leak_detector_py -.->|test_depends| D_TRADING
    D_SECURITY["D_SECURITY production"]
...
graph TD
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_semantic_auditor_test_semantic_similar_detector_py -.->|test_depends| D_INFRA_RECOVERY
    tests_semantic_auditor_test_semantic_rollback_tag_py -.->|test_depends| D_INFRA_RECOVERY
    D_TRADING["D_TRADING production"]
    tests_session_test_session_conflict_py -.->|test_depends| D_TRADING
    tests_session_test_session_learner_py -.->|test_depends| D_TRADING
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_skill_test_skill_attention_py -.->|test_depends| D_AUTONOMY_CORE
    tests_session_test_session_manager_py -.->|test_depends| D_TRADING
    D_SECURITY["D_SECURITY production"]
    tests_session_test_session_lifecycle_py -.->|test_depends| D_SECURITY
    tests_skill_test_skill_breakage_checker_py -.->|test_depends| D_AUTONOMY_CORE
...
graph TD
    ...
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_skill_test_skill_freshness_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_freshness_ext_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_freshness_ext_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_gitops_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_idempotency_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_guardrails_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_knowledge_base_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_lifecycle_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_lifecycle_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_kya_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_kill_switch_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_kill_switch_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_learning_py -.->|test_depends| D_AUTONOMY_CORE
...
graph TD
    ...
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_skill_test_skill_telemetry_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_tokenomics_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_temperature_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_translator_py -.->|test_depends| D_AUTONOMY_CORE
    tests_skill_test_skill_workflow_py -.->|test_depends| D_AUTONOMY_CORE
    D_INTELLIGENCE["D_INTELLIGENCE production"]
    tests_task_test_task_model_learner_py -.->|test_depends| D_INTELLIGENCE
    tests_task_test_task_gate_py -.->|test_depends| D_INTELLIGENCE
    D_TRADING["D_TRADING production"]
    tests_task_test_task_gate_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_task_test_task_repo_auto_commit_py -.->|test_depends| D_GOVERNANCE
    tests_task_test_task_repo_gateway_e2e_py -.->|test_depends| D_GOVERNANCE
    tests_task_test_task_repo_gateway_e2e_py -.->|test_depends| D_GOVERNANCE
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_trading_test_disk_guard_py -.->|test_depends| D_TRADING
    tests_trading_test_design_decisions_root_py -.->|test_depends| D_TRADING
    tests_trading_test_dlq_manager_root_py -.->|test_depends| D_TRADING
    tests_trading_test_degrade_cascade_py -.->|test_depends| D_TRADING
    D_INTEGRATION["D_INTEGRATION production"]
    tests_trading_test_f14_pipeline_extreme_py -.->|test_depends| D_INTEGRATION
    tests_trading_test_f14_pipeline_extreme_py -.->|test_depends| D_INTEGRATION
    tests_trading_test_f14_pipeline_extreme_py -.->|test_depends| D_INTEGRATION
    tests_trading_test_f14_pipeline_extreme_py -.->|test_depends| D_INTEGRATION
    tests_trading_test_f14_pipeline_extreme_py -.->|test_depends| D_TRADING
    tests_trading_test_f14_pipeline_extreme_py -.->|test_depends| D_TRADING
    tests_trading_test_dream_cycle_py -.->|test_depends| D_TRADING
    tests_trading_test_feature_flag_py -.->|test_depends| D_TRADING
    tests_trading_test_fault_types_py -.->|test_depends| D_TRADING
    ...
    class D_TRADING,D_INTEGRATION external_prod
```

### 第 55 页 / 共 57 页 / Page 55 of 57
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_trading_test_state_propagation_root_py -.->|test_depends| D_TRADING
    tests_trading_test_state_synchronizer_root_py -.->|test_depends| D_TRADING
    tests_trading_test_stop_gate_py -.->|test_depends| D_TRADING
    tests_trading_test_status_dashboard_py -.->|test_depends| D_TRADING
    tests_trading_test_status_dashboard_py -.->|test_depends| D_TRADING
    tests_trading_test_system_transfer_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_trading_test_trading_session_lifecycle_py -.->|test_depends| D_GOVERNANCE
    tests_trading_test_teardown_manager_py -.->|test_depends| D_TRADING
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_trading_test_trading_kill_switch_py -.->|test_depends| D_INFRA_RECOVERY
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RECOVERY,D_SHARED,D_GOV_ENFORCEMENT external_prod
```

### 第 56 页 / 共 57 页 / Page 56 of 57
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_trae_rules_test_g_trae_026_py -.->|test_depends| D_SHARED
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    tests_trae_rules_test_g_trae_026_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_026_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_027_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_027_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_027_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_028_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_028_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_028_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_029_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_029_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_029_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_030_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_030_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_030_py -.->|test_depends| D_GOV_ENFORCEMENT
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
...
graph TD
    ...
    tests_utils_test_utils_migration_py -.->|test_depends| D_SHARED
    tests_utils_test_utils_pagination_py -.->|test_depends| D_SHARED
    tests_utils_test_version_py -.->|test_depends| D_SHARED
    tests_utils_test_utils_diff_utils_py -.->|test_depends| D_SHARED
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
...
| D_GOVERNANCE | 495 | test_depends |
| D_GOV_ENFORCEMENT | 221 | test_depends |
| D_SECURITY | 214 | test_depends |
| D_SHARED | 156 | test_depends |
| D_AUTONOMY_CORE | 127 | test_depends |
| D_INFRA_RUNTIME | 98 | test_depends |
| D_INTEGRATION | 91 | test_depends |
| D_INFRA_RECOVERY | 76 | test_depends |
| D_SECURITY_LLM | 37 | test_depends |
| D_INFRA_A2A | 36 | test_depends |
| D_INTELLIGENCE | 31 | test_depends |
| D_RISK | 5 | test_depends |
| D_OPS | 3 | test_depends |
| D_INFRA_TELEMETRY | 3 | test_depends |
...
> 按 architecture_layer 分层显示 审计测试套件（D_AUDITTEST）的模块分布。共 1693 个模块 / 1693 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│             L2 领域层 / Domain Layer (1693 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 1693 个模块 / 1693 modules）。
...
| 105 | tests/agent_rbac/test_rbac_auto_lifecycle.py | tests/agent_rbac/test_rbac_auto_lifec... | production | generated |

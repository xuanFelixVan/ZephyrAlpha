...
title: D-AUDITTEST audit_test_suite架构文档
version: "1.0"
status: active
date: 2026-06-26
...
# 22_d_audittest / audit_test_suite

> **文档作用 / Purpose**: 展示 audit_test_suite（D-AUDITTEST）功能域的模块清单、域内依赖关系和跨域依赖关系，供架构审查和域治理参考。
...
```mermaid
graph TD
    subgraph D_AUDITTEST["D-AUDITTEST audit_test_suite"]

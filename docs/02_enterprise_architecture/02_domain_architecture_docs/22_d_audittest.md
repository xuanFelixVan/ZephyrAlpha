...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_TRADING,D_SECURITY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    tests_agent_rbac_test_output_guard_agent_rbac_py -.->|test_depends| D_SECURITY
...
graph TD
    ...
    tests_audit_test_sim2real_calibration_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    tests_autonomy_test_context_pipeline_red_blue_py -.->|test_depends| D_AUTONOMY_CORE
    tests_autonomy_test_ide_watcher_py -.->|test_depends| D_AUTONOMY_CORE
    D_SHARED["D_SHARED production"]
    tests_autonomy_test_ide_watcher_py -.->|test_depends| D_SHARED
    tests_autonomy_test_mgmt_context_budget_tracker_py -.->|test_depends| D_AUTONOMY_CORE
    tests_autonomy_test_mgmt_context_budget_tracker_py -.->|test_depends| D_SHARED
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    tests_autonomy_test_trigger_router_root_py -.->|test_depends| D_AUTONOMY_CORE
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_ba_test_ba_chaos_injector_py -.->|test_depends| D_GOVERNANCE
    tests_ba_test_ba_canary_controller_py -.->|test_depends| D_GOVERNANCE
    tests_ba_test_ba_dashboard_py -.->|test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    tests_cold_test_cold_start_lock_py -.->|test_depends| D_SECURITY
    tests_config_test_config_root_py -.->|test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_TRADING,D_INFRA_RECOVERY,D_GOVERNANCE,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING,D_SECURITY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_RECOVERY,D_TRADING external_prod
```
...
graph TD
    ...
    tests_feedback_test_recursive_diagnosis_trust_evaluator_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    tests_governance_budget_test_burn_rate_monitor_py -.->|test_depends| D_GOVERNANCE
    tests_governance_budget_test_cost_attributor_py -.->|test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    tests_infrastructure_test_telemetry_py -.->|test_depends| D_INFRA_RUNTIME
...
graph TD
    ...
    D_INTELLIGENCE["D_INTELLIGENCE production"]
    tests_kb_test_kb_pipeline_activate_py -.->|test_depends| D_INTELLIGENCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
```
...
graph TD
    ...
    tests_trae_rules_test_g_trae_028_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_031_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_031_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_031_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_034_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_034_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_034_py -.->|test_depends| D_GOV_ENFORCEMENT
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
...
|--------|:---:|---------|
| D_TRADING | 557 | test_depends |
| D_GOVERNANCE | 490 | test_depends |
| D_GOV_ENFORCEMENT | 221 | test_depends |
| D_SECURITY | 213 | test_depends |
| D_SHARED | 162 | test_depends |
| D_AUTONOMY_CORE | 108 | test_depends |
| D_INTEGRATION | 90 | test_depends |
| D_INFRA_RUNTIME | 86 | test_depends |
| D_INFRA_RECOVERY | 76 | test_depends |
| D_INFRA_A2A | 36 | test_depends |
| D_SECURITY_LLM | 31 | test_depends |

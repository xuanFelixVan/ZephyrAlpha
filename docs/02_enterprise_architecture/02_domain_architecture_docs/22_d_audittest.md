...
graph TD
    ...
    class D_TRADING,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    tests_bridges_test_bridges_delegation_bridge_py -.->|test_depends| D_GOVERNANCE
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_e_test_e_gov_budget_handler_py -.->|test_depends| D_SHARED
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY_LLM,D_SECURITY,D_TRADING,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY,D_INFRA_RECOVERY,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_TRADING,D_SECURITY,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RECOVERY,D_SHARED,D_GOV_ENFORCEMENT,D_GOVERNANCE external_prod
```

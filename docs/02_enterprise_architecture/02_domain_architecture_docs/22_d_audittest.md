...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_GOVERNANCE,D_RISK,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SECURITY,D_AUTONOMY_CORE external_prod
```

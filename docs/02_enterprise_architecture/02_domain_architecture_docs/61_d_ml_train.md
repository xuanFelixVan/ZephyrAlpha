...
flowchart TD
    docs_03_modules_cross_layer_model_profiler_blueprint_md["蓝图<br/>blueprint模块蓝图文档，描述该模块的设计意图和架<br/>构决策<br/>⛔ ML训练域，设计已就绪，等待开发排期<br/>文件: model_profiler/blueprint.md<br/>(设计态 / design)"]

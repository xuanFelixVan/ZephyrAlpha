...
graph TD
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_FRONTEND,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTELLIGENCE,D_KNOWLEDGE external_design
```

...
graph TD
    ...
    class D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOVERNANCE,D_FRONTEND,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_DATA external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_GOVERNANCE,D_FRONTEND external_design
```

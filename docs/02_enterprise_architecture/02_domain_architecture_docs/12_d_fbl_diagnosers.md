...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY_LLM,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_KNOWLEDGE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```

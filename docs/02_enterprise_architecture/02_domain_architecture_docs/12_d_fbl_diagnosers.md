...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOVERNANCE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY_LLM external_design
```

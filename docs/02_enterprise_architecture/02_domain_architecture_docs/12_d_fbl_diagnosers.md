...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_DATA,D_AUTONOMY_CORE external_design
```

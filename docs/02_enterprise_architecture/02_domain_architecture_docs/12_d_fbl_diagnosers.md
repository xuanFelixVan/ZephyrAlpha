...
title: D_FBL_DIAGNOSERS diagnosers架构文档
version: "1.0"
status: active
date: 2026-07-19
...
# 12_d_fbl_diagnosers / diagnosers / diagnosers / Feedback Diagnosers

> **功能简介 / Overview**: 反馈诊断器，负责异常根因诊断、模型健康监控、可靠性诊断和上下文窗口压力管理

> **文档作用 / Purpose**: 展示 diagnosers（D_FBL_DIAGNOSERS）功能域的模块清单、域内依赖关系、跨域依赖关系、架构分层视图，供架构审查和域治理参考。
...
| 域名称 | diagnosers | Domain Name | Feedback Diagnosers |
...
```mermaid
graph TD
    subgraph D_FBL_DIAGNOSERS["D_FBL_DIAGNOSERS diagnosers"]
...
```mermaid
graph LR
    D_FBL_DIAGNOSERS["D_FBL_DIAGNOSERS<br/>diagnosers"]

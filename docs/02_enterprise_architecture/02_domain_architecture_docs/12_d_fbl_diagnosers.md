...
graph TD
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_KNOWLEDGE,D_AUTONOMY_CORE external_design
```

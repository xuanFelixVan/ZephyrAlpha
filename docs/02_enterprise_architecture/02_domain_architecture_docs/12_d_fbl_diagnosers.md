...
graph TD
    ...
    class D_SECURITY_LLM,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_FRONTEND,D_DATA,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOV_AUDIT,D_SECURITY_LLM,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```

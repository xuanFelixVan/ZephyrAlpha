...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_FRONTEND,D_DATA,D_GOVERNANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT,D_KNOWLEDGE external_design
```

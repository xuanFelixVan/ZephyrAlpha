...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_FRONTEND,D_INTELLIGENCE,D_DATA,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_AUDIT,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_FRONTEND,D_INFRA_RUNTIME external_design
```

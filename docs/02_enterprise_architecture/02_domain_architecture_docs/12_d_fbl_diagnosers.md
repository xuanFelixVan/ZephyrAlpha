...
graph TD
    ...
    class D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY_LLM,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY_LLM,D_KNOWLEDGE external_design
```

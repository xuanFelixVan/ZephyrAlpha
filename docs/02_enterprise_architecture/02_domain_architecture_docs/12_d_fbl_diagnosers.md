...
graph TD
    ...
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| src_zephyr_feedback_loop_diagnosers_cognitive_init_py
    D_INTEGRATION["(原型态 / prototype) D_INTEGRATION"]
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_INTEGRATION
    D_FBL_VERIFICATION["(原型态 / prototype) D_FBL_VERIFICATION"]
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_FBL_VERIFICATION
    D_COMPLIANCE["(原型态 / prototype) D_COMPLIANCE"]
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_COMPLIANCE
    D_FEEDBACK_LOOP["(原型态 / prototype) D_FEEDBACK_LOOP"]
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_FEEDBACK_LOOP
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_FEEDBACK_LOOP
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_FEEDBACK_LOOP
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_FEEDBACK_LOOP
    D_FBL_DETECTORS["(原型态 / prototype) D_FBL_DETECTORS"]
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_FBL_DETECTORS
    src_zephyr_feedback_loop_diagnosers_cognitive_init_py -.->|runtime / runtime| D_FEEDBACK_LOOP
    ...
    D_AUTONOMY_CORE -.->|runtime / runtime| src_zephyr_feedback_loop_diagnosers_cognitive_init_py
...
|:--:|---------|:--:|---------|---------|
| 1 | __init__.py | → | D_COMPLIANCE 合规: default_security_gateway.py | runtime / runtime |
| 2 | __init__.py | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
...
| 6 | __init__.py | → | D_FEEDBACK_LOOP 反馈循环引擎: TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |

...
graph TD
    ...
    D_FEEDBACK_LOOP -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_diagnosers_health_dr_resilience_metrics_py
    ...
    class D_FEEDBACK_LOOP,D_KNOWLEDGE,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOVERNANCE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_KNOWLEDGE,D_INTELLIGENCE external_design
```

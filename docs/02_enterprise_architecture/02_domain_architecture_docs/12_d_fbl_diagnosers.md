...
graph TD
    ...
    D_FEEDBACK_LOOP -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_diagnosers_reliability_amplification_guard_py
    ...
    class D_FEEDBACK_LOOP,D_FRONTEND,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_AUTONOMY_CORE,D_FRONTEND,D_INTELLIGENCE external_design
```

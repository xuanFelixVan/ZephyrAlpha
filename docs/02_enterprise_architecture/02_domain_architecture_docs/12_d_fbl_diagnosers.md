...
graph TD
    ...
    class D_SECURITY_LLM,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_SECURITY_LLM,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```

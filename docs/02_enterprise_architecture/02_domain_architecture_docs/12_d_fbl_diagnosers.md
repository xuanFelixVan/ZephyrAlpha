...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_SHARED,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INTELLIGENCE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_design
```

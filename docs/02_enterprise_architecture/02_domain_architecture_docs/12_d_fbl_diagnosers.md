...
graph TD
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_SHARED,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_design
```

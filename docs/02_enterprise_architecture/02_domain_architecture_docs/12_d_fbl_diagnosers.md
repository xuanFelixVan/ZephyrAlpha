...
graph TD
    ...
    class D_SECURITY_LLM,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INTELLIGENCE,D_GOV_AUDIT,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_SECURITY_LLM,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND external_design
```

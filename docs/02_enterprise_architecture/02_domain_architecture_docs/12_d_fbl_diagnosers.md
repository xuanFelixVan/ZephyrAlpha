...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    D_SECURITY_LLM -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_diagnosers_reliability_llm_quality_regression_py
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOV_AUDIT,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SECURITY_LLM,D_INTELLIGENCE external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTELLIGENCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTELLIGENCE,D_KNOWLEDGE,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```

...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_FRONTEND,D_AUTONOMY_CORE,D_SECURITY_LLM,D_FEEDBACK_LOOP,D_SHARED external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_FRONTEND,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```

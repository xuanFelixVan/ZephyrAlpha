...
graph TD
    ...
    class D_SECURITY_LLM,D_GOV_AUDIT,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_FRONTEND,D_DATA external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY_LLM,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```

...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_INTELLIGENCE,D_FRONTEND,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED external_prod
    class D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_INTELLIGENCE,D_FRONTEND,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```

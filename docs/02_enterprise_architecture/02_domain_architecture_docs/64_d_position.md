...
flowchart TD
    src_zephyr_position_core_sell_position_link_py["(设计态 / design) core/sell_position_link.py<br/>文件: core/sell_position_link.py"]
    ...
    src_zephyr_position_services_position_audit_logger_py["(设计态 / design) services/position_audit_logger.py<br/>文件: services/position_audit_logger.py"]
    ...
    src_zephyr_position_core_rebalance_engine_py["(设计态 / design) core/rebalance_engine.py<br/>文件: core/rebalance_engine.py"]
    src_zephyr_position_core_position_drift_monitor_py["(设计态 / design) core/position_drift_monitor.py<br/>文件: core/position_drift_monitor.py"]
    src_zephyr_position_core_position_state_machine_py["(设计态 / design) core/position_state_machine.py<br/>文件: core/position_state_machine.py"]
    src_zephyr_position_core_position_sizing_engine_py["(设计态 / design) core/position_sizing_engine.py<br/>文件: core/position_sizing_engine.py"]
    src_zephyr_position_core_calendar_position_constraint_py["(设计态 / design) core/calendar_position_constraint.py<br/>文件: core/calendar_position_constraint.py"]
    src_zephyr_position_core_capital_curve_manager_py["(设计态 / design) core/capital_curve_manager.py<br/>文件: core/capital_curve_manager.py"]
    src_zephyr_position_services_cash_manager_py["(设计态 / design) services/cash_manager.py<br/>文件: services/cash_manager.py"]
    ...
    src_zephyr_position_core_drawdown_controller_py["(设计态 / design) core/drawdown_controller.py<br/>文件: core/drawdown_controller.py"]
...
|:--:|---------|:--:|---------|---------|
| 1 | core/position_sizing_engine.py | → | D_RISK 风控: drawdown_tracker/ | runtime / runtime |
...
| 2 | D_SELL_DECISION 卖出决策: core/sell_signal_fusion_engine.py | → | core/sell_position_link.py | runtime / runtime |
| 3 | D_TRADING 交易运营: pnl_calculator/ | → | Position Reconciler — v0.10.1 持仓对账: execution report... | 导入依赖 / import_depends |

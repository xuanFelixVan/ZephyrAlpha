...
flowchart TD
    ...
    src_zephyr_feedback_loop_detectors_anomaly_anomaly_clustering_py["异常聚类<br/>anomaly包的anomaly_clustering模块<br/>Anomaly Clustering — v0.9.0 R119<br/>文件: anomaly/anomaly_clustering.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_anomaly_log_anomaly_py["日志异常<br/>anomaly包的log_anomaly模块<br/>Log Anomaly Detector — v0.6.0 R61<br/>文件: anomaly/log_anomaly.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_correlation_cross_signal_validator_py["跨信号校验器<br/>correlation包的cross_signal_validator模块<br/>Cross-Signal Validator — v0.6.0 R63<br/>文件: correlation/cross_signal_validator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_correlation_external_health_py["外部健康<br/>correlation包的external_health模块<br/>External Health Monitor — v0.14.0 R193<br/>文件: correlation/external_health.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_correlation_multi_signal_correlator_py["多信号关联器<br/>多信号correlator模块<br/>Multi-Signal Correlator — v0.4.0 R22<br/>文件: correlation/multi_signal_correlator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_drift_config_drift_py["配置漂移<br/>drift包的config_drift模块<br/>Config Drift Detector — v0.13.0 R182<br/>文件: drift/config_drift.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_guard_self_audit_py["自审计<br/>guard包的self_audit模块<br/>Self Audit — v0.13.0 R183<br/>文件: guard/self_audit.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_reliability_capacity_forecast_py["容量预测<br/>reliability包的capacity_forecast模块<br/>Capacity Forecast — v0.13.0 R186b<br/>文件: reliability/capacity_forecast.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_reliability_flag_lifecycle_py["标志生命周期<br/>reliability包的flag_lifecycle模块<br/>Flag Lifecycle Detector — v0.13.0 R180<br/>文件: reliability/flag_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_reliability_otel_adapter_py["otel适配器<br/>reliability包的otel_adapter模块<br/>OTel Adapter — v0.12.0 R170<br/>文件: reliability/otel_adapter.py<br/>(生产态 / production)"]

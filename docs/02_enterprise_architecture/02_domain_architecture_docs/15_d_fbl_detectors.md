...
flowchart TD
    ...
    src_zephyr_feedback_loop_detectors_anomaly_anomaly_clustering_py["异常聚类<br/>异常聚类。Anomaly Clustering — v0.9.0 R119<br/>文件: anomaly/anomaly_clustering.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_anomaly_emergent_behavior_detector_py["emergentbehavior检测器<br/>emergent行为检测器。Emergent Behavior Detector<br/>— v0.38.0 R473<br/>文件: anomaly/emergent_behavior_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_flapping_detector_py["flapping检测器<br/>反馈闭环/anomaly包的flapping_detector模块<br/>Flapping Detector — v0.40.0 R494<br/>文件: anomaly/flapping_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_heisenbug_detector_py["heisenbug检测器<br/>反馈闭环/anomaly包的heisenbug_detector模块<br/>Heisenbug Detector — v0.38.0 R470<br/>文件: anomaly/heisenbug_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_infinite_loop_detector_py["infinite循环检测器<br/>infiniteloop检测器。Infinite Loop Detector —<br/>v0.15.0 R219<br/>文件: anomaly/infinite_loop_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_intermittent_failure_pattern_py["intermittent故障pattern<br/>intermittentfailure模式。Intermittent Failure<br/>Pattern Detector — v0.40.0 R501<br/>文件: anomaly/intermittent_failure_pattern.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_log_anomaly_py["日志异常<br/>日志异常。Log Anomaly Detector — v0.6.0 R61<br/>文件: anomaly/log_anomaly.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_silent_corruption_detector_py["silentcorruption检测器<br/>反馈闭环/anomaly包的silent_corruption_<br/>detector模块<br/>Silent Corruption Detector — v0.40.0 R499<br/>文件: anomaly/silent_corruption_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_synthetic_anomaly_generator_py["synthetic异常generator<br/>synthetic异常生成器。Synthetic Anomaly<br/>Generator — v0.9.0 R112<br/>文件: anomaly/synthetic_anomaly_generator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_anomaly_temporal_pattern_py["temporal模式<br/>反馈闭环/anomaly包的temporal_pattern模块<br/>Temporal Pattern Detector — v0.12.0 R164<br/>文件: anomaly/temporal_pattern.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_action_efficacy_decay_detector_py["行为efficacydecay检测器<br/>动作efficacydecay检测器。R507:<br/>ActionEfficacyDecayDetector<br/>文件: correlation/action_efficacy_decay_<br/>detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_action_interaction_detector_py["行为interaction检测器<br/>动作interaction检测器。Action Interaction<br/>Detector — v0.38.0 R472<br/>文件: correlation/action_interaction_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_action_side_effect_cumulative_detector_py["行为sideeffectcumulative检测器<br/>动作sideeffectcumulative检测器。R526:<br/>ActionSideEffectCumulativeDetector<br/>文件: correlation/action_side_effect_cumulative_<br/>detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_agent_trajectory_anomaly_detector_py["代理trajectory异常检测器<br/>反馈闭环/correlation包的agent_trajectory_<br/>anomaly_detector模块<br/>R503: AgentTrajectoryAnomalyDetector<br/>文件: correlation/agent_trajectory_anomaly_<br/>detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_cross_signal_validator_py["跨信号校验器<br/>反馈闭环/correlation包的cross_signal_<br/>validator模块<br/>Cross-Signal Validator — v0.6.0 R63<br/>文件: correlation/cross_signal_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_cross_system_correlator_py["跨系统关联器<br/>跨systemcorrelator。Cross-System Correlator —<br/>v0.13.0 R185<br/>文件: correlation/cross_system_correlator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_decision_provenance_py["决策溯源<br/>决策provenance。Decision Provenance — v0.12.0<br/>R166<br/>文件: correlation/decision_provenance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_dependency_freshness_monitor_py["依赖freshness监控器<br/>依赖freshness监控。Dependency Freshness Monitor<br/>— v0.38.0 R474<br/>文件: correlation/dependency_freshness_<br/>monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_ensemble_detector_py["ensemble检测器<br/>反馈闭环/correlation包的ensemble_detector模块<br/>Ensemble Detector — v0.4.0 R21<br/>文件: correlation/ensemble_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_external_health_py["外部健康<br/>外部健康。External Health Monitor — v0.14.0 R193<br/>文件: correlation/external_health.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_external_validation_checkpoint_py["外部验证检查点<br/>反馈闭环/correlation包的external_validation_<br/>checkpoint模块<br/>R524: ExternalValidationCheckpoint<br/>文件: correlation/external_validation_<br/>checkpoint.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_fle_performance_regression_detector_py["fle绩效回归检测器<br/>反馈闭环/correlation包的fle_performance_<br/>regression_detector模块<br/>R532: FLEPerformanceRegressionDetector<br/>文件: correlation/fle_performance_regression_<br/>detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_multi_signal_correlator_py["多信号关联器<br/>多信号correlator。Multi-Signal Correlator —<br/>v0.4.0 R22<br/>文件: correlation/multi_signal_correlator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_rumor_noise_filter_py["rumornoise过滤器<br/>rumornoise过滤。Rumor Noise Filter — v0.37.0<br/>R460<br/>文件: correlation/rumor_noise_filter.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_trace_causal_bridge_py["追踪causal桥接<br/>反馈闭环/correlation包的trace_causal_bridge模块<br/>Trace Causal Bridge — v0.6.0 R62<br/>文件: correlation/trace_causal_bridge.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_traffic_replay_validator_py["trafficreplay校验器<br/>反馈闭环/correlation包的traffic_replay_<br/>validator模块<br/>Traffic Replay Validator — v0.14.0 R202<br/>文件: correlation/traffic_replay_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_concept_drift_py["concept漂移<br/>反馈闭环/drift包的concept_drift模块<br/>Concept Drift Detector — v0.5.0 R42<br/>文件: drift/concept_drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_config_drift_py["配置漂移<br/>配置漂移。Config Drift Detector — v0.13.0 R182<br/>文件: drift/config_drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_context_window_contamination_detector_py["上下文windowcontamination检测器<br/>反馈闭环/drift包的context_window_contamination_<br/>detector模块<br/>Context Window Contamination Detector — v0.38.0<br/>R471<br/>文件: drift/context_window_contamination_<br/>detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_diminishing_returns_detector_py["diminishingreturns检测器<br/>反馈闭环/drift包的diminishing_returns_<br/>detector模块<br/>R528: DiminishingReturnsDetector<br/>文件: drift/diminishing_returns_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_ensemble_drift_py["ensemble漂移<br/>反馈闭环/drift包的ensemble_drift模块<br/>Ensemble Drift — v0.5.0 R43<br/>文件: drift/ensemble_drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_gradual_poisoning_detector_py["gradualpoisoning检测器<br/>反馈闭环/drift包的gradual_poisoning_detector模块<br/>Gradual Poisoning Detector — v0.15.0 R210<br/>文件: drift/gradual_poisoning_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_trend_cycle_separator_py["趋势cycleseparator<br/>反馈闭环/drift包的trend_cycle_separator模块<br/>Trend-Cycle Separator — v0.9.0 R113<br/>文件: drift/trend_cycle_separator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_alert_desensitization_curve_py["告警desensitizationcurve<br/>反馈闭环/guard包的alert_desensitization_<br/>curve模块<br/>Alert Desensitization Curve — v0.37.0 R492<br/>文件: guard/alert_desensitization_curve.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_guard_cascade_detector_py["守卫级联检测器<br/>反馈闭环/guard包的guard_cascade_detector模块<br/>R520: GuardCascadeDetector<br/>文件: guard/guard_cascade_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_guard_oscillation_detector_py["守卫振荡检测器<br/>守卫oscillation检测器。R519:<br/>GuardOscillationDetector<br/>文件: guard/guard_oscillation_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_placebo_action_detector_py["placebo行为检测器<br/>placebo动作检测器。R508: PlaceboActionDetector<br/>文件: guard/placebo_action_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_positive_feedback_defense_py["positive反馈防御<br/>反馈闭环/guard包的positive_feedback_defense模块<br/>Positive Feedback Defense — v0.4.0 R28<br/>文件: guard/positive_feedback_defense.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_recursive_diagnosis_trust_evaluator_py["recursive诊断trustevaluator<br/>recursive诊断信任evaluator。R517:<br/>RecursiveDiagnosisTrustEvaluator<br/>文件: guard/recursive_diagnosis_trust_<br/>evaluator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_self_audit_py["自审计<br/>自审计。Self Audit — v0.13.0 R183<br/>文件: guard/self_audit.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_guard_self_ha_py["自ha<br/>自ha。Self HA — v0.13.0 R173<br/>文件: guard/self_ha.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_temporal_coherence_of_self_model_py["temporalcoherenceofself模型<br/>temporalcoherenceof自模型。R525:<br/>TemporalCoherenceOfSelfModel<br/>文件: guard/temporal_coherence_of_self_model.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_autoscale_remediation_py["自动伸缩修复<br/>反馈闭环/reliability包的autoscale_<br/>remediation模块<br/>Autoscale Remediation — v0.13.0 R174<br/>文件: reliability/autoscale_remediation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_blast_radius_py["爆炸半径<br/>爆炸半径，提供estimate等方法<br/>Blast Radius Detector — v0.12.0 R167<br/>文件: reliability/blast_radius.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_blast_radius_budget_py["blastradius预算<br/>反馈闭环/reliability包的blast_radius_budget模块<br/>Blast Radius Budget — v0.13.0 R178<br/>文件: reliability/blast_radius_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_capacity_forecast_py["容量预测<br/>容量预测。Capacity Forecast — v0.13.0 R186b<br/>文件: reliability/capacity_forecast.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_chaos_engineering_py["混沌工程<br/>混沌工程，检测器的引擎，执行核心逻辑的处理引擎<br/>Chaos Engineering — v0.13.0 R172<br/>文件: reliability/chaos_engineering.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_ebpf_monitor_py["ebpf监控器<br/>ebpf监控。eBPF Monitor — v0.6.0 R64<br/>文件: reliability/ebpf_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_flag_lifecycle_py["标志生命周期<br/>反馈闭环/reliability包的flag_lifecycle模块<br/>Flag Lifecycle Detector — v0.13.0 R180<br/>文件: reliability/flag_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_maintenance_coordinator_py["maintenance协调器<br/>反馈闭环/reliability包的maintenance_<br/>coordinator模块<br/>Maintenance Coordinator — v0.12.0 R168<br/>文件: reliability/maintenance_coordinator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_metric_cardinality_guard_py["指标cardinality守卫<br/>反馈闭环/reliability包的metric_cardinality_<br/>guard模块<br/>Metric Cardinality Guard — v0.40.0 R495<br/>文件: reliability/metric_cardinality_guard.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_openfeature_py["OpenFeature集成<br/>集成 OpenFeature<br/>特性开关标准，控制功能模块的灰度发布和回滚<br/>文件: reliability/openfeature.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_otel_adapter_py["otel适配器<br/>反馈闭环/reliability包的otel_adapter模块<br/>OTel Adapter — v0.12.0 R170<br/>文件: reliability/otel_adapter.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_regulatory_audit_py["regulatory审计<br/>反馈闭环/reliability包的regulatory_audit模块<br/>Regulatory Audit Detector — v0.13.0 R184<br/>文件: reliability/regulatory_audit.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_resolution_tracker_py["resolution追踪器<br/>反馈闭环/reliability包的resolution_tracker模块<br/>Resolution Tracker — v0.12.0 R165<br/>文件: reliability/resolution_tracker.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_runbook_executor_py["runbook执行器<br/>反馈闭环/reliability包的runbook_executor模块<br/>Runbook Executor — v0.13.0 R186a<br/>文件: reliability/runbook_executor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_version_migrator_py["版本migrator<br/>反馈闭环/reliability包的version_migrator模块<br/>Version Migrator — v0.12.0 R169<br/>文件: reliability/version_migrator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_detectors_anomaly_init_py["detectors/anomaly 包入口<br/>管理detectors.anomaly子包的加载和懒导入<br/>文件: anomaly/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_init_py["detectors/correlation 包入口<br/>管理detectors.correlation子包的加载和懒导入<br/>文件: correlation/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_init_py["detectors/drift 包入口<br/>管理detectors.drift子包的加载和懒导入<br/>文件: drift/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_init_py["detectors/guard 包入口<br/>管理detectors.guard子包的加载和懒导入<br/>文件: guard/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_init_py["detectors/reliability 包入口<br/>管理detectors.reliability子包的加载和懒导入<br/>文件: reliability/__init__.py<br/>(生产态 / production)"]

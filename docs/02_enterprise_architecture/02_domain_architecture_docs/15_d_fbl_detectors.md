...
flowchart TD
    ...
    src_zephyr_feedback_loop_detectors_anomaly_emergent_behavior_detector_py["(生产态 / production) emergentbehavior检测器 / Emergent Behavior Detector — v0.38.0 R473<br/>emergent行为检测器。Emergent Behavior Detector — v0.38.0 R473<br/>文件: anomaly/emergent_behavior_detector.py"]
    ...
    src_zephyr_feedback_loop_detectors_anomaly_infinite_loop_detector_py["(生产态 / production) infinite循环检测器 / Infinite Loop Detector — v0.15.0 R219<br/>infiniteloop检测器。Infinite Loop Detector — v0.15.0 R219<br/>文件: anomaly/infinite_loop_detector.py"]
    src_zephyr_feedback_loop_detectors_anomaly_intermittent_failure_pattern_py["(生产态 / production) intermittent故障pattern / Intermittent Failure Pattern Detector — v0.40.0 R501<br/>intermittentfailure模式。Intermittent Failure Pattern Detector — v0.40.0 R501<br/>文件: anomaly/intermittent_failure_pattern.py"]
    ...
    src_zephyr_feedback_loop_detectors_anomaly_synthetic_anomaly_generator_py["(生产态 / production) synthetic异常generator / Synthetic Anomaly Generator — v0.9.0 R112<br/>synthetic异常生成器。Synthetic Anomaly Generator — v0.9.0 R112<br/>文件: anomaly/synthetic_anomaly_generator.py"]
    ...
    src_zephyr_feedback_loop_detectors_correlation_action_efficacy_decay_detector_py["(生产态 / production) 行为efficacydecay检测器 / R507: ActionEfficacyDecayDetector<br/>动作efficacydecay检测器。R507: ActionEfficacyDecayDetector<br/>文件: correlation/action_efficacy_decay_detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_action_interaction_detector_py["(生产态 / production) 行为interaction检测器 / Action Interaction Detector — v0.38.0 R472<br/>动作interaction检测器。Action Interaction Detector — v0.38.0 R472<br/>文件: correlation/action_interaction_detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_action_side_effect_cumulative_detector_py["(生产态 / production) 行为sideeffectcumulative检测器 / R526: ActionSideEffectCumulativeDetector<br/>动作sideeffectcumulative检测器。R526: ActionSideEffectCumulativeDetector<br/>文件: correlation/action_side_effect_cumulative_detector.py"]
    ...
    src_zephyr_feedback_loop_detectors_correlation_cross_system_correlator_py["(生产态 / production) 跨系统关联器 / Cross-System Correlator — v0.13.0 R185<br/>跨systemcorrelator。Cross-System Correlator — v0.13.0 R185<br/>文件: correlation/cross_system_correlator.py"]
    src_zephyr_feedback_loop_detectors_correlation_decision_provenance_py["(生产态 / production) 决策溯源 / Decision Provenance — v0.12.0 R166<br/>决策provenance。Decision Provenance — v0.12.0 R166<br/>文件: correlation/decision_provenance.py"]
    src_zephyr_feedback_loop_detectors_correlation_dependency_freshness_monitor_py["(生产态 / production) 依赖freshness监控器 / Dependency Freshness Monitor — v0.38.0 R474<br/>依赖freshness监控。Dependency Freshness Monitor — v0.38.0 R474<br/>文件: correlation/dependency_freshness_monitor.py"]
    ...
    src_zephyr_feedback_loop_detectors_correlation_multi_signal_correlator_py["(生产态 / production) 多信号关联器 / Multi-Signal Correlator — v0.4.0 R22<br/>多信号correlator。Multi-Signal Correlator — v0.4.0 R22<br/>文件: correlation/multi_signal_correlator.py"]
    src_zephyr_feedback_loop_detectors_correlation_rumor_noise_filter_py["(生产态 / production) rumornoise过滤器 / Rumor Noise Filter — v0.37.0 R460<br/>rumornoise过滤。Rumor Noise Filter — v0.37.0 R460<br/>文件: correlation/rumor_noise_filter.py"]
    ...
    src_zephyr_feedback_loop_detectors_guard_guard_oscillation_detector_py["(生产态 / production) 守卫振荡检测器 / R519: GuardOscillationDetector<br/>守卫oscillation检测器。R519: GuardOscillationDetector<br/>文件: guard/guard_oscillation_detector.py"]
    src_zephyr_feedback_loop_detectors_guard_placebo_action_detector_py["(生产态 / production) placebo行为检测器 / R508: PlaceboActionDetector<br/>placebo动作检测器。R508: PlaceboActionDetector<br/>文件: guard/placebo_action_detector.py"]
    ...
    src_zephyr_feedback_loop_detectors_guard_recursive_diagnosis_trust_evaluator_py["(生产态 / production) recursive诊断trustevaluator / R517: RecursiveDiagnosisTrustEvaluator<br/>recursive诊断信任evaluator。R517: RecursiveDiagnosisTrustEvaluator<br/>文件: guard/recursive_diagnosis_trust_evaluator.py"]
    ...
    src_zephyr_feedback_loop_detectors_guard_self_diagnosis_data_leak_detector_py["(生产态 / production) self诊断数据leak检测器 / R530: SelfDiagnosisDataLeakDetector<br/>自诊断数据leak检测器。R530: SelfDiagnosisDataLeakDetector<br/>文件: guard/self_diagnosis_data_leak_detector.py"]
    ...
    src_zephyr_feedback_loop_detectors_guard_temporal_coherence_of_self_model_py["(生产态 / production) temporalcoherenceofself模型 / R525: TemporalCoherenceOfSelfModel<br/>temporalcoherenceof自模型。R525: TemporalCoherenceOfSelfModel<br/>文件: guard/temporal_coherence_of_self_model.py"]
    src_zephyr_feedback_loop_detectors_reliability_autoscale_remediation_py["(生产态 / production) 自动伸缩修复 / Autoscale Remediation — v0.13.0 R174<br/>自动伸缩修复，提供包入口和模块加载功能<br/>文件: reliability/autoscale_remediation.py"]
    src_zephyr_feedback_loop_detectors_reliability_blast_radius_py["(生产态 / production) 爆炸半径 / Blast Radius Detector — v0.12.0 R167<br/>爆炸半径，提供estimate等方法<br/>文件: reliability/blast_radius.py"]
    ...
    src_zephyr_feedback_loop_detectors_reliability_ebpf_monitor_py["(生产态 / production) ebpf监控器 / eBPF Monitor — v0.6.0 R64<br/>ebpf监控。eBPF Monitor — v0.6.0 R64<br/>文件: reliability/ebpf_monitor.py"]
    ...
    src_zephyr_feedback_loop_detectors_reliability_openfeature_py["(生产态 / production) OpenFeature / OpenFeature Integration — v0.13.0 R181<br/>OpenFeature特性开关检测器，基于OpenFeature标准检测可靠性相关特性标志<br/>文件: reliability/openfeature.py"]

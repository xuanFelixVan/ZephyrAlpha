...
flowchart TD
    ...
    src_zephyr_feedback_loop_detectors_reliability_metric_cardinality_guard_py["指标cardinality守卫<br/>公共接口：compute_growth_rate（Stage 4 公共化）<br/>Metric Cardinality Guard — v0.40.0 R495<br/>文件: reliability/metric_cardinality_guard.py<br/>(生产态 / production)"]

...
flowchart TD
    ...
    src_zephyr_feedback_loop_detectors_anomaly_init_py["detectors/anomaly 包入口<br/>反馈闭环域检测器层<br/>(anomaly)包入口，归集该层子模块按需懒加载<br/>文件: anomaly/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_correlation_init_py["detectors/correlation 包入口<br/>反馈闭环域检测器层<br/>(correlation)包入口，归集该层子模块按需懒加载<br/>文件: correlation/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_drift_init_py["detectors/drift 包入口<br/>反馈闭环域检测器层<br/>(drift)包入口，归集该层子模块按需懒加载<br/>文件: drift/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_guard_init_py["detectors/guard 包入口<br/>反馈闭环域检测器层<br/>(guard)包入口，归集该层子模块按需懒加载<br/>文件: guard/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_detectors_reliability_init_py["detectors/reliability 包入口<br/>反馈闭环域检测器层<br/>(reliability)包入口，归集该层子模块按需懒加载<br/>文件: reliability/__init__.py<br/>(生产态 / production)"]

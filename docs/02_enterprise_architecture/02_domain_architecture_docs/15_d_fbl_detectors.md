...
flowchart TD
    ...
    src_zephyr_feedback_loop_detectors_anomaly_anomaly_clustering_py["(生产态 / production) 异常聚类 / Anomaly<br/>Clustering — v0.9.0 R119<br/>异常聚类。Anomaly Clustering — v0.9.0 R119<br/>文件: anomaly/anomaly_clustering.py"]
    src_zephyr_feedback_loop_detectors_anomaly_anomaly_detector_py["(生产态 / production) 异常检测器 / anomaly_<br/>detector<br/>异常检测器，异常的事件，定义和分发事件。<br/>文件: anomaly/anomaly_detector.py"]
    src_zephyr_feedback_loop_detectors_anomaly_emergent_behavior_detector_py["(生产态 / production) emergentbehavior检测器 /<br/>Emergent Behavior Detector — v0.38.0 R473<br/>emergent行为检测器。Emergent Behavior Detector<br/>— v0.38.0 R473<br/>文件: anomaly/emergent_behavior_detector.py"]
    src_zephyr_feedback_loop_detectors_anomaly_flapping_detector_py["(生产态 / production) flapping检测器 / Flapping<br/>Detector — v0.40.0 R494<br/>flapping检测器。Flapping Detector — v0.40.0 R494<br/>文件: anomaly/flapping_detector.py"]
    src_zephyr_feedback_loop_detectors_anomaly_heisenbug_detector_py["(生产态 / production) heisenbug检测器 /<br/>Heisenbug Detector — v0.38.0 R470<br/>heisenbug检测器。Heisenbug Detector — v0.38.0<br/>R470<br/>文件: anomaly/heisenbug_detector.py"]
    src_zephyr_feedback_loop_detectors_anomaly_infinite_loop_detector_py["(生产态 / production) infinite循环检测器 /<br/>Infinite Loop Detector — v0.15.0 R219<br/>infiniteloop检测器。Infinite Loop Detector —<br/>v0.15.0 R219<br/>文件: anomaly/infinite_loop_detector.py"]
    src_zephyr_feedback_loop_detectors_anomaly_intermittent_failure_pattern_py["(生产态 / production) intermittent故障pattern /<br/>Intermittent Failure Pattern Detector — v0.40.0<br/>R501<br/>intermittentfailure模式。Intermittent Failure<br/>Pattern Detector — v0.40.0 R501<br/>文件: anomaly/intermittent_failure_pattern.py"]
    src_zephyr_feedback_loop_detectors_anomaly_log_anomaly_py["(生产态 / production) 日志异常 / Log Anomaly<br/>Detector — v0.6.0 R61<br/>日志异常。Log Anomaly Detector — v0.6.0 R61<br/>文件: anomaly/log_anomaly.py"]
    src_zephyr_feedback_loop_detectors_anomaly_silent_corruption_detector_py["(生产态 / production) silentcorruption检测器 /<br/>Silent Corruption Detector — v0.40.0 R499<br/>silentcorruption检测器。Silent Corruption<br/>Detector — v0.40.0 R499<br/>文件: anomaly/silent_corruption_detector.py"]
    src_zephyr_feedback_loop_detectors_anomaly_synthetic_anomaly_generator_py["(生产态 / production) synthetic异常generator /<br/>Synthetic Anomaly Generator — v0.9.0 R112<br/>synthetic异常生成器。Synthetic Anomaly<br/>Generator — v0.9.0 R112<br/>文件: anomaly/synthetic_anomaly_generator.py"]
    src_zephyr_feedback_loop_detectors_anomaly_temporal_pattern_py["(生产态 / production) temporal模式 / Temporal<br/>Pattern Detector — v0.12.0 R164<br/>temporal模式。Temporal Pattern Detector —<br/>v0.12.0 R164<br/>文件: anomaly/temporal_pattern.py"]
    src_zephyr_feedback_loop_detectors_correlation_action_efficacy_decay_detector_py["(生产态 / production) 行为efficacydecay检测器 /<br/>R507: ActionEfficacyDecayDetector<br/>动作efficacydecay检测器。R507:<br/>ActionEfficacyDecayDetector<br/>文件: correlation/action_efficacy_decay_<br/>detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_action_interaction_detector_py["(生产态 / production) 行为interaction检测器 /<br/>Action Interaction Detector — v0.38.0 R472<br/>动作interaction检测器。Action Interaction<br/>Detector — v0.38.0 R472<br/>文件: correlation/action_interaction_detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_action_side_effect_cumulative_detector_py["(生产态 / production)<br/>行为sideeffectcumulative检测器 / R526:<br/>ActionSideEffectCumulativeDetector<br/>动作sideeffectcumulative检测器。R526:<br/>ActionSideEffectCumulativeDetector<br/>文件: correlation/action_side_effect_cumulative_<br/>detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_agent_trajectory_anomaly_detector_py["(生产态 / production) 代理trajectory异常检测器<br/>/ R503: AgentTrajectoryAnomalyDetector<br/>代理trajectory异常检测器。R503:<br/>AgentTrajectoryAnomalyDetector<br/>文件: correlation/agent_trajectory_anomaly_<br/>detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_cross_signal_validator_py["(生产态 / production) 跨信号校验器 /<br/>Cross-Signal Validator — v0.6.0 R63<br/>跨信号校验器。Cross-Signal Validator — v0.6.0<br/>R63<br/>文件: correlation/cross_signal_validator.py"]
    src_zephyr_feedback_loop_detectors_correlation_cross_system_correlator_py["(生产态 / production) 跨系统关联器 /<br/>Cross-System Correlator — v0.13.0 R185<br/>跨systemcorrelator。Cross-System Correlator —<br/>v0.13.0 R185<br/>文件: correlation/cross_system_correlator.py"]
    src_zephyr_feedback_loop_detectors_correlation_decision_provenance_py["(生产态 / production) 决策溯源 / Decision<br/>Provenance — v0.12.0 R166<br/>决策provenance。Decision Provenance — v0.12.0<br/>R166<br/>文件: correlation/decision_provenance.py"]
    src_zephyr_feedback_loop_detectors_correlation_dependency_freshness_monitor_py["(生产态 / production) 依赖freshness监控器 /<br/>Dependency Freshness Monitor — v0.38.0 R474<br/>依赖freshness监控。Dependency Freshness Monitor<br/>— v0.38.0 R474<br/>文件: correlation/dependency_freshness_<br/>monitor.py"]
    src_zephyr_feedback_loop_detectors_correlation_ensemble_detector_py["(生产态 / production) ensemble检测器 / Ensemble<br/>Detector — v0.4.0 R21<br/>ensemble检测器。Ensemble Detector — v0.4.0 R21<br/>文件: correlation/ensemble_detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_external_health_py["(生产态 / production) 外部健康 / External<br/>Health Monitor — v0.14.0 R193<br/>外部健康。External Health Monitor — v0.14.0 R193<br/>文件: correlation/external_health.py"]
    src_zephyr_feedback_loop_detectors_correlation_external_validation_checkpoint_py["(生产态 / production) 外部验证检查点 / R524:<br/>ExternalValidationCheckpoint<br/>外部验证检查点。R524:<br/>ExternalValidationCheckpoint<br/>文件: correlation/external_validation_<br/>checkpoint.py"]
    src_zephyr_feedback_loop_detectors_correlation_fle_performance_regression_detector_py["(生产态 / production) fle绩效回归检测器 / R532:<br/>FLEPerformanceRegressionDetector<br/>fle绩效回归检测器。R532:<br/>FLEPerformanceRegressionDetector<br/>文件: correlation/fle_performance_regression_<br/>detector.py"]
    src_zephyr_feedback_loop_detectors_correlation_multi_signal_correlator_py["(生产态 / production) 多信号关联器 /<br/>Multi-Signal Correlator — v0.4.0 R22<br/>多信号correlator。Multi-Signal Correlator —<br/>v0.4.0 R22<br/>文件: correlation/multi_signal_correlator.py"]
    src_zephyr_feedback_loop_detectors_correlation_rumor_noise_filter_py["(生产态 / production) rumornoise过滤器 / Rumor<br/>Noise Filter — v0.37.0 R460<br/>rumornoise过滤。Rumor Noise Filter — v0.37.0<br/>R460<br/>文件: correlation/rumor_noise_filter.py"]
    src_zephyr_feedback_loop_detectors_correlation_trace_causal_bridge_py["(生产态 / production) 追踪causal桥接 / Trace<br/>Causal Bridge — v0.6.0 R62<br/>追踪causal桥接。Trace Causal Bridge — v0.6.0 R62<br/>文件: correlation/trace_causal_bridge.py"]
    src_zephyr_feedback_loop_detectors_correlation_traffic_replay_validator_py["(生产态 / production) trafficreplay校验器 /<br/>Traffic Replay Validator — v0.14.0 R202<br/>trafficreplay校验器。Traffic Replay Validator —<br/>v0.14.0 R202<br/>文件: correlation/traffic_replay_validator.py"]
    src_zephyr_feedback_loop_detectors_drift_concept_drift_py["(生产态 / production) concept漂移 / Concept<br/>Drift Detector — v0.5.0 R42<br/>concept漂移。Concept Drift Detector — v0.5.0 R42<br/>文件: drift/concept_drift.py"]
    src_zephyr_feedback_loop_detectors_drift_config_drift_py["(生产态 / production) 配置漂移 / Config Drift<br/>Detector — v0.13.0 R182<br/>配置漂移。Config Drift Detector — v0.13.0 R182<br/>文件: drift/config_drift.py"]
    src_zephyr_feedback_loop_detectors_drift_context_window_contamination_detector_py["(生产态 / production)<br/>上下文windowcontamination检测器 / Context<br/>Window Contamination Detector — v0.38.0 R471<br/>上下文windowcontamination检测器。Context Window<br/>Contamination Detector — v0.38.0 R471<br/>文件: drift/context_window_contamination_<br/>detector.py"]
    src_zephyr_feedback_loop_detectors_drift_diminishing_returns_detector_py["(生产态 / production) diminishingreturns检测器<br/>/ R528: DiminishingReturnsDetector<br/>diminishingreturns检测器。R528:<br/>DiminishingReturnsDetector<br/>文件: drift/diminishing_returns_detector.py"]
    src_zephyr_feedback_loop_detectors_drift_ensemble_drift_py["(生产态 / production) ensemble漂移 / Ensemble<br/>Drift — v0.5.0 R43<br/>ensemble漂移。Ensemble Drift — v0.5.0 R43<br/>文件: drift/ensemble_drift.py"]
    src_zephyr_feedback_loop_detectors_drift_gradual_poisoning_detector_py["(生产态 / production) gradualpoisoning检测器 /<br/>Gradual Poisoning Detector — v0.15.0 R210<br/>gradualpoisoning检测器。Gradual Poisoning<br/>Detector — v0.15.0 R210<br/>文件: drift/gradual_poisoning_detector.py"]
    src_zephyr_feedback_loop_detectors_drift_trend_cycle_separator_py["(生产态 / production) 趋势cycleseparator /<br/>Trend-Cycle Separator — v0.9.0 R113<br/>趋势cycleseparator。Trend-Cycle Separator —<br/>v0.9.0 R113<br/>文件: drift/trend_cycle_separator.py"]
    src_zephyr_feedback_loop_detectors_guard_alert_desensitization_curve_py["(生产态 / production) 告警desensitizationcurve<br/>/ Alert Desensitization Curve — v0.37.0 R492<br/>告警desensitizationcurve。Alert Desensitization<br/>Curve — v0.37.0 R492<br/>文件: guard/alert_desensitization_curve.py"]
    src_zephyr_feedback_loop_detectors_guard_guard_cascade_detector_py["(生产态 / production) 守卫级联检测器 / R520:<br/>GuardCascadeDetector<br/>守卫级联检测器。R520: GuardCascadeDetector<br/>文件: guard/guard_cascade_detector.py"]
    src_zephyr_feedback_loop_detectors_guard_guard_oscillation_detector_py["(生产态 / production) 守卫振荡检测器 / R519:<br/>GuardOscillationDetector<br/>守卫oscillation检测器。R519:<br/>GuardOscillationDetector<br/>文件: guard/guard_oscillation_detector.py"]
    src_zephyr_feedback_loop_detectors_guard_placebo_action_detector_py["(生产态 / production) placebo行为检测器 / R508:<br/>PlaceboActionDetector<br/>placebo动作检测器。R508: PlaceboActionDetector<br/>文件: guard/placebo_action_detector.py"]
    src_zephyr_feedback_loop_detectors_guard_positive_feedback_defense_py["(生产态 / production) positive反馈防御 /<br/>Positive Feedback Defense — v0.4.0 R28<br/>positive反馈防御。Positive Feedback Defense —<br/>v0.4.0 R28<br/>文件: guard/positive_feedback_defense.py"]
    ...
    src_zephyr_feedback_loop_detectors_guard_self_audit_py["(生产态 / production) 自审计 / Self Audit —<br/>v0.13.0 R183<br/>自审计。Self Audit — v0.13.0 R183<br/>文件: guard/self_audit.py"]
    src_zephyr_feedback_loop_detectors_guard_self_diagnosis_data_leak_detector_py["(生产态 / production) self诊断数据leak检测器 /<br/>R530: SelfDiagnosisDataLeakDetector<br/>自诊断数据leak检测器。R530:<br/>SelfDiagnosisDataLeakDetector<br/>文件: guard/self_diagnosis_data_leak_detector.py"]
    src_zephyr_feedback_loop_detectors_guard_self_ha_py["(生产态 / production) 自ha / Self HA — v0.13.0<br/>R173<br/>自ha。Self HA — v0.13.0 R173<br/>文件: guard/self_ha.py"]
    src_zephyr_feedback_loop_detectors_guard_temporal_coherence_of_self_model_py["(生产态 / production)<br/>temporalcoherenceofself模型 / R525:<br/>TemporalCoherenceOfSelfModel<br/>temporalcoherenceof自模型。R525:<br/>TemporalCoherenceOfSelfModel<br/>文件: guard/temporal_coherence_of_self_model.py"]
    src_zephyr_feedback_loop_detectors_reliability_autoscale_remediation_py["(生产态 / production) 自动伸缩修复 / Autoscale<br/>Remediation — v0.13.0 R174<br/>自动伸缩修复，提供包入口和模块加载功能<br/>文件: reliability/autoscale_remediation.py"]
    src_zephyr_feedback_loop_detectors_reliability_blast_radius_py["(生产态 / production) 爆炸半径 / Blast Radius<br/>Detector — v0.12.0 R167<br/>爆炸半径，提供estimate等方法<br/>文件: reliability/blast_radius.py"]
    src_zephyr_feedback_loop_detectors_reliability_blast_radius_budget_py["(生产态 / production) blastradius预算 / Blast<br/>Radius Budget — v0.13.0 R178<br/>blastradius预算。Blast Radius Budget — v0.13.0<br/>R178<br/>文件: reliability/blast_radius_budget.py"]
    src_zephyr_feedback_loop_detectors_reliability_capacity_forecast_py["(生产态 / production) 容量预测 / Capacity<br/>Forecast — v0.13.0 R186b<br/>容量预测。Capacity Forecast — v0.13.0 R186b<br/>文件: reliability/capacity_forecast.py"]
    src_zephyr_feedback_loop_detectors_reliability_chaos_engineering_py["(生产态 / production) 混沌工程 / Chaos<br/>Engineering — v0.13.0 R172<br/>混沌工程，检测器的引擎，执行核心逻辑的处理引擎。<br/>文件: reliability/chaos_engineering.py"]
    src_zephyr_feedback_loop_detectors_reliability_ebpf_monitor_py["(生产态 / production) ebpf监控器 / eBPF Monitor<br/>— v0.6.0 R64<br/>ebpf监控。eBPF Monitor — v0.6.0 R64<br/>文件: reliability/ebpf_monitor.py"]
    src_zephyr_feedback_loop_detectors_reliability_flag_lifecycle_py["(生产态 / production) 标志生命周期 / Flag<br/>Lifecycle Detector — v0.13.0 R180<br/>标志生命周期。Flag Lifecycle Detector — v0.13.0<br/>R180<br/>文件: reliability/flag_lifecycle.py"]
    src_zephyr_feedback_loop_detectors_reliability_maintenance_coordinator_py["(生产态 / production) maintenance协调器 /<br/>Maintenance Coordinator — v0.12.0 R168<br/>maintenance协调器。Maintenance Coordinator —<br/>v0.12.0 R168<br/>文件: reliability/maintenance_coordinator.py"]
    src_zephyr_feedback_loop_detectors_reliability_metric_cardinality_guard_py["(生产态 / production) 指标cardinality守卫 /<br/>Metric Cardinality Guard — v0.40.0 R495<br/>指标cardinality守卫。Metric Cardinality Guard —<br/>v0.40.0 R495<br/>文件: reliability/metric_cardinality_guard.py"]
    src_zephyr_feedback_loop_detectors_reliability_openfeature_py["(生产态 / production) OpenFeature / OpenFeature<br/>Integration — v0.13.0 R181<br/>OpenFeature特性开关检测器，基于OpenFeature标准检<br/>测可靠性相关特性标志<br/>文件: reliability/openfeature.py"]
    src_zephyr_feedback_loop_detectors_reliability_otel_adapter_py["(生产态 / production) otel适配器 / OTel Adapter<br/>— v0.12.0 R170<br/>otel适配器。OTel Adapter — v0.12.0 R170<br/>文件: reliability/otel_adapter.py"]
    src_zephyr_feedback_loop_detectors_reliability_regulatory_audit_py["(生产态 / production) regulatory审计 /<br/>Regulatory Audit Detector — v0.13.0 R184<br/>regulatory审计。Regulatory Audit Detector —<br/>v0.13.0 R184<br/>文件: reliability/regulatory_audit.py"]
    src_zephyr_feedback_loop_detectors_reliability_resolution_tracker_py["(生产态 / production) resolution追踪器 /<br/>Resolution Tracker — v0.12.0 R165<br/>resolution追踪器。Resolution Tracker — v0.12.0<br/>R165<br/>文件: reliability/resolution_tracker.py"]
    src_zephyr_feedback_loop_detectors_reliability_runbook_executor_py["(生产态 / production) runbook执行器 / Runbook<br/>Executor — v0.13.0 R186a<br/>runbook执行器。Runbook Executor — v0.13.0 R186a<br/>文件: reliability/runbook_executor.py"]
    src_zephyr_feedback_loop_detectors_reliability_version_migrator_py["(生产态 / production) 版本migrator / Version<br/>Migrator — v0.12.0 R169<br/>版本migrator。Version Migrator — v0.12.0 R169<br/>文件: reliability/version_migrator.py"]
    ...
    src_zephyr_feedback_loop_detectors_anomaly_init_py["(生产态 / production) 包入口 / __init__<br/>异常的包入口，把这一层的子模块归到一起统一管理，<br/>用到谁才加载谁。<br/>文件: anomaly/__init__.py"]
    src_zephyr_feedback_loop_detectors_correlation_init_py["(生产态 / production) 包入口 / __init__<br/>相关性的包入口，把这一层的子模块归到一起统一管理<br/>，用到谁才加载谁。<br/>文件: correlation/__init__.py"]
    src_zephyr_feedback_loop_detectors_drift_init_py["(生产态 / production) 包入口 / __init__<br/>漂移检测的包入口，把这一层的子模块归到一起统一管<br/>理，用到谁才加载谁。<br/>文件: drift/__init__.py"]
    src_zephyr_feedback_loop_detectors_guard_init_py["(生产态 / production) 包入口 / __init__<br/>守卫的包入口，把这一层的子模块归到一起统一管理，<br/>用到谁才加载谁。<br/>文件: guard/__init__.py"]
    src_zephyr_feedback_loop_detectors_reliability_init_py["(生产态 / production) 包入口 / __init__<br/>检测器的包入口，把这一层的子模块归到一起统一管理<br/>，用到谁才加载谁。<br/>文件: reliability/__init__.py"]

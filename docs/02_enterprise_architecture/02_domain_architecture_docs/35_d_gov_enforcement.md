...
| 14 | Audit Trail — MOD-INF-020 (__init__.py) | → | D_GOVERNANCE 生命周期管理: depgraph Schema DDL + 版本化迁移框架 (depgraph_... | runtime / runtime |
...
| 223 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — Agent Observability ... | → | Audit Trail — MOD-INF-020 (__init__.py) | runtime / runtime |

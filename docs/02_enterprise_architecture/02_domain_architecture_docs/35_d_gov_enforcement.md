...
graph TD
    ...
    class D_INFRA_RECOVERY,D_INTEGRATION,D_SECURITY,D_PF_CORE external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUDITTEST,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```

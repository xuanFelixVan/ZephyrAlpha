...
graph TD
    ...
    D_GOVERNANCE -.->|contract| src_zephyr_compliance_audit_trail_bridges_init_py
    D_GOVERNANCE -.->|contract| src_zephyr_compliance_audit_trail_bridges_init_py
    D_GOVERNANCE -.->|runtime| src_zephyr_compliance_audit_trail_bridges_init_py
    D_AUTONOMY_CORE["D_AUTONOMY_CORE prototype"]
    D_AUTONOMY_CORE -.->|runtime| src_zephyr_compliance_audit_trail_bridges_init_py
    D_INFRA_TELEMETRY["D_INFRA_TELEMETRY prototype"]
    D_INFRA_TELEMETRY -.->|runtime| src_zephyr_compliance_audit_trail_bridges_init_py
    ...
    class D_GOV_SCRIPTS,D_AUDITTEST,D_GOV_DRIFT,D_AUTONOMY_CORE,D_INFRA_TELEMETRY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_SECURITY,D_PF_CORE external_prod
    class D_SHARED,D_TRADING,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_INTELLIGENCE,D_SECURITY external_prod
...
|--------|:---:|---------|
| D_GOVERNANCE | 38 | contract,import_depends,runtime |
...
| D_GOVERNANCE | 22 | contract,import_depends,runtime |

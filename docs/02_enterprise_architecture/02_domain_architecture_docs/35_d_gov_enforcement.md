...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_AUTONOMY_CORE,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RECOVERY,D_INTEGRATION,D_PF_CORE external_prod
    class D_GOV_SCRIPTS,D_SECURITY,D_AUDITTEST,D_TRADING external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_engine_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_simulator_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_engine_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_engine_py
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```

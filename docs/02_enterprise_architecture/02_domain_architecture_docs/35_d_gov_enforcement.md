...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_SECURITY,D_TRADING,D_PF_CORE external_prod
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED,D_INTEGRATION external_prod
    class D_AUDITTEST external_design
```

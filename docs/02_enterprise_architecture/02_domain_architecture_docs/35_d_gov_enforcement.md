...
graph TD
    ...
    src_zephyr_compliance_init_py -.->|config_depends / config_depends| src_zephyr_compliance_evidence_pack_py
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_SECURITY external_prod

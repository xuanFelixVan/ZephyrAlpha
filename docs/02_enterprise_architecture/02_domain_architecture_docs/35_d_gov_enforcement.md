...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RECOVERY,D_PF_CORE,D_SECURITY external_prod
    class D_SHARED,D_GOVERNANCE,D_TRADING,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RECOVERY,D_INTEGRATION,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_TRADING external_prod

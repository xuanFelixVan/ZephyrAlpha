...
graph TD
    ...
    src_zephyr_compliance_init_py -.->|config_depends| src_zephyr_compliance_default_security_gateway_py
    ...
    class D_GOVERNANCE,D_SECURITY,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_SECURITY,D_PF_CORE external_prod
    class D_GOVERNANCE,D_TRADING,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_governance_rule_enforcement_gate_engine_init_py -.->|config_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_integrity_guard_py
...
graph TD
    ...
    src_zephyr_governance_rule_enforcement_rule_engine_init_py -.->|config_depends| src_zephyr_governance_rule_enforcement_rule_engine_rule_engine_py

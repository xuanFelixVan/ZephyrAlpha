...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_AUDITTEST,D_GOV_SCRIPTS,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE,D_SECURITY external_prod

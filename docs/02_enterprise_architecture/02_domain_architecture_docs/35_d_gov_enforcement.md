...
| 跨域入边 | 262 | Cross-domain Incoming | 262 |
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_PF_CORE external_prod
    class D_SECURITY,D_AUDITTEST,D_GOV_SCRIPTS,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_rule_engine_rule_engine_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_rule_engine_rule_shadow_runner_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_TRADING external_prod
    class D_AUDITTEST external_design
```

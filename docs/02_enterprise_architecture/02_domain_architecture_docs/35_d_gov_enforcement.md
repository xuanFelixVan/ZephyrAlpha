...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_SECURITY,D_PF_CORE,D_TRADING external_prod
...
graph TD
    ...
    src_zephyr_governance_rule_enforcement_gate_engine_init_py -.->|config_depends / config_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_integrity_guard_py
...
graph TD
    ...
    src_zephyr_governance_rule_enforcement_rule_engine_init_py -.->|config_depends / config_depends| src_zephyr_governance_rule_enforcement_rule_engine_rule_shadow_runner_py

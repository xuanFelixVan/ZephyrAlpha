...
graph TD
    ...
    class D_GOV_SCRIPTS,D_AUDITTEST,D_GOV_DRIFT external_design
```
...
| 223 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — All Skill Modules (a... | → | Audit Trail — MOD-INF-020 (__init__.py) | runtime / runtime |

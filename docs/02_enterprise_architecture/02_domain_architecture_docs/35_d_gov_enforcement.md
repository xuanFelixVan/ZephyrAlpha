...
graph TD
    ...
    src_zephyr_compliance_zero_knowledge_audit_stub_init_py -.->|导入依赖 / import_depends| D_GOVERNANCE
...
| 255 | D_INFRA_TELEMETRY 可观测性: 遥测 · metrics — SLI/SLO 与业务指标流 (__init... | → | Audit Trail — MOD-INF-020 (__init__.py) | runtime / runtime |

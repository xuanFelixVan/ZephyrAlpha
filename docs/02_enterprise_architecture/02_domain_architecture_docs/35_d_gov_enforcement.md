...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_INTEGRATION,D_SECURITY,D_TRADING,D_PF_CORE external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_invariants_post_doc_review_check_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_gate_engine_gate_pipeline_py
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_SHARED external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_rule_engine_rule_canary_manager_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_enforcement_task_types_py
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_TRADING external_prod
    class D_AUDITTEST external_design
```

...
| 生产态模块 | 267 | Production Modules | 267 |
| 容量 | 283/150 (超容) | Capacity | 283/150 (超容) |
...
graph TD
    ...
    src_zephyr_trading_auto_task_generator_py -->|import_depends| D_SHARED
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    src_zephyr_trading_boot_cron_jobs_py -->|import_depends| D_AUTONOMY_CORE
    src_zephyr_trading_boot_cron_jobs_py -->|import_depends| D_AUTONOMY_CORE
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_actors_global_action_scheduler_py
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_AUTONOMY_CORE,D_SECURITY external_prod
    class D_INTELLIGENCE,D_INFRA_A2A,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_graduated_activation_protocol_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_forensic_boot_integrity_attestation_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_prompt_factory_governance_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_prompt_self_optimization_loop_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_self_upgrade_canary_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_forensic_interrupt_coherence_validator_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_gates_autonomy_maturity_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_forensic_knowledge_injection_pre_flight_verifier_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_resilience_deadman_switch_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_resilience_resource_starvation_aware_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_protocols_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_protocols_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_protocols_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_scheduler_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_security_dep_cve_correlator_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_security_metric_prompt_scanner_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_verifiers_digital_twin_sandbox_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_verifiers_golden_test_external_py
...
graph TD
    ...
    src_zephyr_trading_orchestrator_contracts_init_py -.->|config_depends| src_zephyr_trading_orchestrator_contracts_construction_guide_py
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    src_zephyr_trading_orchestrator_execution_init_py -.->|config_depends| src_zephyr_trading_orchestrator_execution_data_lifecycle_py
    ...
    src_zephyr_trading_orchestrator_fault_tolerance_init_py -.->|config_depends| src_zephyr_trading_orchestrator_fault_tolerance_bulkhead_manager_py
    src_zephyr_trading_orchestrator_governance_init_py -.->|config_depends| src_zephyr_trading_orchestrator_governance_capacity_budget_py
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_execution_capital_allocation_result_py
...
graph TD
    subgraph D_TRADING["D_TRADING 交易运营"]
        ...
        src_zephyr_trading_trading_contracts_risk_trading_kill_switch_py["src/zephyr/trading/trading_contracts/risk/tradi... production"]
    ...
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_market_factor_signal_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_market_factor_monitor_report_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_market_macro_factor_signal_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_verdict_engine_py
...
> 按 architecture_layer 分层显示 交易运营（D_TRADING）的模块分布。共 472 个模块 / 472 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (471 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
├──────────────────────────────────────────────────────────────────┤
│   src/zephyr/trading/trading_contracts/risk/trading_kill_swit... │
└──────────────────────────────────────────────────────────────────┘
...
> 按 architecture_layer 分组的模块清单（共 472 个模块 / 472 modules）。
...
> (仅显示前 200 个模块，共 471 个)

### 未分类 / Unclassified (1 modules)

| # | 模块路径 / Module Path | 模块名称 / Module Name | 成熟度 / Maturity | 构建状态 / Build Status |
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/trading/trading_contracts/risk/trading_kill_sw... | src/zephyr/trading/trading_contracts/... | production | generated |

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 440 条 / 440 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 440 条 / 440 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 2                               │
│   [import_depends]: 303 条 / edges                               │
│   [config_depends]: 137 条 / edges                               │
└──────────────────────────────────────────────────────────────────┘
...
│   ...还有 254 条 / 254 more edges                                │
└──────────────────────────────────────────────────────────────────┘

**[config_depends]** (137 条 / edges) — 已达显示上限，省略 / limit reached

> (最多显示前 50 条依赖边，共 440 条)

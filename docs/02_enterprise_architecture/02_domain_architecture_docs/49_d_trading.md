...
graph TD
    ...
    src_zephyr_trading_boot_hooks_py -->|import_depends| D_GOV_ENFORCEMENT
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_capability_card_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_capability_registry_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_capability_sync_py
    ...
    class D_INFRA_RUNTIME,D_OPS,D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_contracts_construction_guide_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_finalizer_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_health_monitor_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_integration_registry_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_lifecycle_manager_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_night_shift_queue_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_SECURITY_LLM external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_execution_init_py -.->|config_depends| src_zephyr_trading_orchestrator_execution_dispatch_table_py
...
graph TD
    ...
    src_zephyr_trading_orchestrator_lifecycle_init_py -.->|config_depends| src_zephyr_trading_orchestrator_lifecycle_rolling_upgrade_py
...
graph TD
    ...
    src_zephyr_trading_orchestrator_state_agent_health_monitor_py -.->|import_depends| D_SHARED
    src_zephyr_trading_resource_optimization_py -->|import_depends| D_SHARED
    src_zephyr_trading_resource_optimization_py -->|import_depends| D_SHARED
    src_zephyr_trading_resource_optimization_py -->|import_depends| D_SHARED
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_stop_gate_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_runtime_config_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    ...
    class D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_EX_CORE,D_GOV_SCRIPTS,D_FRONTEND,D_AUDITTEST external_design
```

...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_SECURITY external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY_LLM,D_FRONTEND external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_contracts_init_py -.->|config_depends| src_zephyr_trading_orchestrator_contracts_design_decisions_py
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_GOVERNANCE,D_SECURITY_LLM,D_SECURITY external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_fault_tolerance_init_py -.->|config_depends| src_zephyr_trading_orchestrator_fault_tolerance_degrade_cascade_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_fault_tolerance_bulkhead_manager_py
...
graph TD
    ...
    src_zephyr_trading_orchestrator_quality_init_py -.->|config_depends| src_zephyr_trading_orchestrator_quality_agent_quality_py

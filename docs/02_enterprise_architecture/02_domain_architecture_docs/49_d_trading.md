...
graph TD
    ...
    src_zephyr_trading_boot_hooks_py -.->|import_depends| D_INTELLIGENCE
    src_zephyr_trading_boot_hooks_py -->|import_depends| D_GOVERNANCE
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    src_zephyr_trading_boot_cron_jobs_py -->|import_depends| D_AUTONOMY_CORE
    src_zephyr_trading_boot_cron_jobs_py -->|import_depends| D_AUTONOMY_CORE
    src_zephyr_trading_capability_card_py -->|import_depends| D_INTEGRATION
    src_zephyr_trading_dream_cycle_py -->|import_depends| D_INTEGRATION
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_auto_task_generator_py
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_OPS external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY_LLM external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_gates_merkle_audit_root_py
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_INTEGRATION external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_template_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_verifiers_cascading_rollback_analyzer_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_verifiers_stochastic_diagnosis_verifier_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_verifiers_stochastic_diagnosis_verifier_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_agent_orchestrator_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_fault_tolerance_degrade_cascade_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_fault_tolerance_disk_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_execution_dlq_manager_py
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_trading_orchestrator_lifecycle_init_py -.->|config_depends| src_zephyr_trading_orchestrator_lifecycle_incident_postmortem_py
    src_zephyr_trading_orchestrator_quality_init_py -.->|config_depends| src_zephyr_trading_orchestrator_quality_knowledge_freshness_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_quality_lean_scanner_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    src_zephyr_trading_orchestrator_resilience_rollback_manager_py -.->|import_depends| D_SHARED
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT prototype"]
    ...
    D_FUNDAMENTAL_SIGNAL -.->|import_depends| src_zephyr_trading_trading_contracts_execution_capital_allocation_result_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_task_gate_py
    D_EX_CORE["D_EX_CORE prototype"]
    D_EX_CORE -.->|import_depends| src_zephyr_trading_trading_contracts_execution_position_py
    D_GOV_SCRIPTS["D_GOV_SCRIPTS prototype"]
    D_GOV_SCRIPTS -.->|import_depends| src_zephyr_trading_staging_area_py
    ...
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_execution_fill_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_execution_model_serving_request_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_FUNDAMENTAL_SIGNAL,D_AUDITTEST,D_EX_CORE,D_GOV_SCRIPTS,D_FRONTEND external_design
```
...
graph TD
    ...
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_market_instrument_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_market_macro_factor_signal_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_market_market_data_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_trading_trading_contracts_market_signal_degradation_warning_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
> 按 architecture_layer 分层显示 交易运营（D_TRADING）的模块分布。共 471 个模块 / 471 modules。
...
> 按 architecture_layer 分组的模块清单（共 471 个模块 / 471 modules）。

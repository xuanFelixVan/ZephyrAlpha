...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_EX_CORE,D_FRONTEND,D_INTELLIGENCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_AUDITTEST,D_INTELLIGENCE,D_EX_CORE external_design
```

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_RISK,D_INFRASTRUCTURE,D_INFRA_RUNTIME external_design
```

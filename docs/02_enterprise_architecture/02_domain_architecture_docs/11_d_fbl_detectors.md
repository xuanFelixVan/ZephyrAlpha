...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOV_AUDIT,D_INTEGRATION,D_INFRASTRUCTURE external_design
```

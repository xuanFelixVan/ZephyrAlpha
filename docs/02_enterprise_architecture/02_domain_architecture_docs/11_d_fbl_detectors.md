...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RECOVERY,D_SHARED,D_GOV_ENFORCEMENT,D_GOVERNANCE external_design
```

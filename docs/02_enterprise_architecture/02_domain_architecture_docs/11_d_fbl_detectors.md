...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRASTRUCTURE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_RISK external_design
```

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_RISK,D_INTEGRATION,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INTELLIGENCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```
...
| 45 | D_GOVERNANCE 生命周期管理: test_scheduler_act.py | → | R519: GuardOscillationDetector (guard_oscillati... | 测试依赖 / test_depends |

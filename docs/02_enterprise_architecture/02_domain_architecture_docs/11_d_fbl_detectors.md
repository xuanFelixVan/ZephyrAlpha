...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_AUDIT,D_SHARED,D_INTEGRATION external_design
```

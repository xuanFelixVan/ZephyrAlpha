...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SHARED external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRASTRUCTURE,D_GOVERNANCE,D_SHARED,D_GOV_SCRIPTS,D_INTELLIGENCE,D_INTEGRATION external_design
```

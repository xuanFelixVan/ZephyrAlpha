...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_GOVERNANCE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTELLIGENCE,D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT external_design
```

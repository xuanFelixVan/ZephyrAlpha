...
graph TD
    ...
    class D_GOV_AUDIT,D_FRONTEND,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP external_prod
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_RISK,D_AUTONOMY_CORE,D_INTEGRATION,D_INTELLIGENCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```

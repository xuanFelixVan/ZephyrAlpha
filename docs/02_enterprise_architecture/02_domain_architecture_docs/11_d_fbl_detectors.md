...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INTEGRATION,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_GOVERNANCE,D_RISK,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INTEGRATION,D_GOV_AUDIT external_design
```

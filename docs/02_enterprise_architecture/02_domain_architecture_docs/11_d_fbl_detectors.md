...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SHARED external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE external_design
```

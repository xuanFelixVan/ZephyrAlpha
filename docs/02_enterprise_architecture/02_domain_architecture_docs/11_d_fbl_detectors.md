...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRASTRUCTURE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    D_SHARED -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_detectors_correlation_multi_signal_correlator_py
    ...
    class D_FRONTEND,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RUNTIME,D_INFRASTRUCTURE external_design
```

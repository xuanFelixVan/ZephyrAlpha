...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_DOCS,D_GOV_AUDIT,D_FRONTEND,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_GOVERNANCE,D_SHARED,D_GOV_SCRIPTS,D_INTELLIGENCE,D_INTEGRATION external_design
```

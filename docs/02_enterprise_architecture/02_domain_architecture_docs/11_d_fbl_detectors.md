...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_SHARED external_design
```
...
| 46 | D_GOVERNANCE 生命周期管理: test_scheduler_act.py | → | R519: GuardOscillationDetector (guard_oscillati... | 测试依赖 / test_depends |

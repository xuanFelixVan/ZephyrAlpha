...
graph TD
    ...
    class D_FRONTEND,D_SHARED,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_FRONTEND,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FRONTEND,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SHARED external_design
```

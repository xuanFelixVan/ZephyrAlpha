...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/signal_quality/__init__.py | D_SIGQC — Signal Quality Domain | 原型态 / prototype |  |
...
graph TD
    subgraph D_SIGQC["D_SIGQC 信号质量控制"]
        src_zephyr_signal_quality_init_py["(原型态 / prototype) D_SIGQC — Signal Quality Domain<br/>文件: __init__.py"]

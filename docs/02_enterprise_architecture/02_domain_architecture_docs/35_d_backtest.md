...
flowchart TD
    ...
    src_zephyr_backtest_implementations_vectorized_engine_py["vectorized引擎<br/>implementations包的vectorized_engine模块<br/>L_BACKTEST — Vectorized Backtest Engine<br/>文件: implementations/vectorized_engine.py<br/>(生产态 / production)"]

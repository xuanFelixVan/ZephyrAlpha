...
flowchart TD
    ...
    src_zephyr_backtest_services_data_quality_checker_py["数据质量检查器<br/>回测的检查器，检查某项条件是否满足<br/>⛔ 暂缓：data域已有quality_gate+integrity_checker<br/>data_quality_checker<br/>文件: services/data_quality_checker.py<br/>(设计态 / design)"]
    ...
    src_zephyr_backtest_core_metrics_py["回测绩效指标计算模块<br/>core/metrics 模块<br/>文件: core/metrics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_backtest_core_portfolio_py["回测持仓管理模块<br/>core/portfolio 模块<br/>文件: core/portfolio.py<br/>(生产态 / production)"]

...
> 展示全部 30 个模块（生产态 26 + 设计态 4），含跨域依赖外部节点。节点含成熟度+名称+大白话/简介+文件路径。
...
flowchart TD
    ...
    src_zephyr_backtest_services_param_analyzer_py ~~~ src_zephyr_backtest_services_result_comparator_py
    ...
    tests_backtest_test_cache_manager_py ~~~ tests_backtest_test_report_generator_py
    ...
    src_zephyr_backtest_services_anomaly_diagnoser_py ~~~ src_zephyr_backtest_services_cache_manager_py
    src_zephyr_backtest_services_cache_manager_py ~~~ src_zephyr_backtest_services_report_generator_py
    ...
    src_zephyr_backtest_io_backtest_result_sink_py ~~~ src_zephyr_backtest_services_data_quality_checker_py
...
flowchart TD
    ...
    src_zephyr_backtest_core_data_handler_py ~~~ src_zephyr_backtest_implementations_event_driven_engine_py
    src_zephyr_backtest_implementations_event_driven_engine_py ~~~ src_zephyr_backtest_io_init_py
    src_zephyr_backtest_io_init_py ~~~ src_zephyr_backtest_services_param_analyzer_py
    src_zephyr_backtest_services_param_analyzer_py ~~~ src_zephyr_backtest_services_scheduler_py
    src_zephyr_backtest_services_scheduler_py ~~~ tests_backtest_test_anomaly_diagnoser_py
    tests_backtest_test_anomaly_diagnoser_py ~~~ tests_backtest_test_cache_manager_py
    tests_backtest_test_cache_manager_py ~~~ tests_backtest_test_report_generator_py
    src_zephyr_backtest_core_pit_manager_py["pit管理器<br/>(Point-In-Time)铁律管理器模块<br/>pit_manager<br/>文件: core/pit_manager.py<br/>(生产态 / production)"]
...
> 本域与 6 个外部域直接连接（出边 15 条 + 入边 13 条 = 28 条）。只显示直接连接的域，不展开具体节点。

...
> 展示全部 27 个模块（生产态 18 + 设计态 9），节点含成熟度+中英文名+大白话+文件路径。
...
flowchart TD
    ...
    src_zephyr_backtest_services_anomaly_diagnoser_py["(设计态 / design)<br/>文件: services/anomaly_diagnoser.py"]
    src_zephyr_backtest_services_decay_monitor_py["(设计态 / design)<br/>文件: services/decay_monitor.py"]
    src_zephyr_backtest_services_nan_processor_py["(设计态 / design)<br/>文件: services/nan_processor.py"]
    src_zephyr_backtest_services_param_analyzer_py["(设计态 / design)<br/>文件: services/param_analyzer.py"]
    src_zephyr_backtest_services_report_generator_py["(设计态 / design)<br/>文件: services/report_generator.py"]
    src_zephyr_backtest_services_result_comparator_py["(设计态 / design)<br/>文件: services/result_comparator.py"]
    src_zephyr_backtest_services_result_deployer_py["(设计态 / design)<br/>文件: services/result_deployer.py"]
    ...
    src_zephyr_backtest_services_cache_manager_py["(设计态 / design)<br/>文件: services/cache_manager.py"]
    src_zephyr_backtest_services_data_quality_checker_py["(设计态 / design)<br/>文件: services/data_quality_checker.py"]
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 9 个，15 条域内依赖）。

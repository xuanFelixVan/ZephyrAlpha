...
graph TD
    ...
    src_zephyr_governance_compliance_gate_a6_compliance_manager_py -.->|import_depends| D_GOVERNANCE
    ...
    src_zephyr_governance_implementations_default_security_gateway_py -.->|import_depends| D_SHARED
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_adversarial_resilience_py
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    D_GOV_DRIFT -.->|runtime| src_zephyr_security_access_control_adversarial_resilience_py
    D_GOVERNANCE -->|contract| src_zephyr_security_access_control_adversarial_resilience_py
    D_GOVERNANCE -.->|contract| src_zephyr_security_access_control_adversarial_resilience_py
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    D_AUTONOMY_CORE -->|runtime| src_zephyr_security_access_control_adversarial_resilience_py
    ...
    class D_SECURITY_LLM,D_AUTONOMY_CORE external_prod
    class D_GOVERNANCE,D_SHARED,D_GOV_DRIFT,D_COMPLIANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_security_access_control_detectors_init_py -.->|config_depends| src_zephyr_security_access_control_detectors_cross_session_detector_py
    ...
    src_zephyr_security_access_control_guards_init_py -.->|config_depends| src_zephyr_security_access_control_guards_cybersec_2026_guard_py
...
|------|:---:|---------|
| D_AUDITTEST | 214 | test_depends |
| D_AUTONOMY_PERM | 12 | import_depends |
| D_GOVERNANCE | 11 | contract,import_depends,runtime |

...
| 容量 | 93/150 (正常) | Capacity | 93/150 (正常) |
...
graph TD
    ...
    src_zephyr_governance_implementations_default_security_gateway_py -.->|import_depends| D_SHARED
    ...
    src_zephyr_governance_implementations_default_security_gateway_py -.->|import_depends| D_SECURITY_LLM
    src_zephyr_governance_implementations_default_security_gateway_py -.->|import_depends| D_SHARED
    D_COMPLIANCE["D_COMPLIANCE prototype"]
    D_COMPLIANCE -.->|import_depends| src_zephyr_governance_compliance_gate_a6_compliance_manager_py
...
graph TD
    subgraph D_SECURITY["D_SECURITY 对抗验证"]
        ...
        src_zephyr_security_access_control_guards_anti_pattern_guard_py["src/zephyr/security/access_control/guards/anti_... production"]
    ...
    src_zephyr_security_access_control_guards_init_py -.->|config_depends| src_zephyr_security_access_control_guards_anti_pattern_guard_py
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_detectors_init_py
    ...
    class src_zephyr_security_access_control_detectors_init_py,src_zephyr_security_access_control_guards_init_py design
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_guards_rule_injection_guard_py
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    D_GOV_DRIFT -.->|runtime| src_zephyr_security_access_control_guards_rule_injection_guard_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|contract| src_zephyr_security_access_control_guards_rule_injection_guard_py
    D_GOVERNANCE -.->|contract| src_zephyr_security_access_control_guards_rule_injection_guard_py
    D_AUTONOMY_CORE["D_AUTONOMY_CORE prototype"]
    D_AUTONOMY_CORE -.->|runtime| src_zephyr_security_access_control_guards_rule_injection_guard_py
    ...
    class D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_AUDITTEST,D_AUTONOMY_CORE external_design
```
...
graph TD
    subgraph D_SECURITY["D_SECURITY 对抗验证"]
        ...
        src_zephyr_security_access_control_verifiers_bootstrap_verifier_py["src/zephyr/security/access_control/verifiers/bo... production"]
        src_zephyr_security_access_control_verifiers_continuous_verifier_py["src/zephyr/security/access_control/verifiers/co... production"]
        ...
        src_zephyr_security_access_control_verifiers_micro_verifier_py["src/zephyr/security/access_control/verifiers/mi... production"]
        src_zephyr_security_access_control_verifiers_post_action_verifier_py["src/zephyr/security/access_control/verifiers/po... production"]
    ...
    src_zephyr_security_access_control_verifiers_init_py -.->|config_depends| src_zephyr_security_access_control_verifiers_bootstrap_verifier_py
    ...
    src_zephyr_security_access_control_orphan_judge_orphan_detector_py -->|import_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_verifiers_init_py
    ...
    D_INFRA_RECOVERY -->|import_depends| src_zephyr_security_access_control_session_concurrency_py
    ...
    class D_TRADING,D_INFRA_RECOVERY external_prod
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
|------|:---:|---------|
| D_AUDITTEST | 215 | contract,test_depends |
...
| 18 | src/zephyr/security/access_control/build_sanitizer.py | src/zephyr/security/access_control/bu... | production | generated |
...
| 22 | src/zephyr/security/access_control/cascading_failure_isol... | src/zephyr/security/access_control/ca... | production | generated |
| 23 | src/zephyr/security/access_control/cold_start_lock.py | src/zephyr/security/access_control/co... | production | generated |
| 24 | src/zephyr/security/access_control/compliance_matrix.py | src/zephyr/security/access_control/co... | production | generated |
...
| 29 | src/zephyr/security/access_control/defense_depth.py | src/zephyr/security/access_control/de... | production | generated |
...
| 42 | src/zephyr/security/access_control/environment_manager.py | src/zephyr/security/access_control/en... | production | generated |
...
| 49 | src/zephyr/security/access_control/guards/anti_pattern_gu... | src/zephyr/security/access_control/gu... | production | generated |
...
| 71 | src/zephyr/security/access_control/key_hierarchy.py | src/zephyr/security/access_control/ke... | production | generated |
...
| 104 | src/zephyr/security/access_control/permission_mode_manage... | src/zephyr/security/access_control/pe... | production | generated |
...
| 108 | src/zephyr/security/access_control/secrets_lifecycle.py | src/zephyr/security/access_control/se... | production | generated |
...
| 112 | src/zephyr/security/access_control/verifiers/bootstrap_ve... | src/zephyr/security/access_control/ve... | production | generated |
| 113 | src/zephyr/security/access_control/verifiers/continuous_v... | src/zephyr/security/access_control/ve... | production | generated |
| 114 | src/zephyr/security/access_control/verifiers/contract_ver... | src/zephyr/security/access_control/ve... | production | generated |
| 115 | src/zephyr/security/access_control/verifiers/micro_verifi... | src/zephyr/security/access_control/ve... | production | generated |
| 116 | src/zephyr/security/access_control/verifiers/post_action_... | src/zephyr/security/access_control/ve... | production | generated |
...
> 域内模块依赖关系（共 112 条 / 112 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 112 条 / 112 edges)       │
├──────────────────────────────────────────────────────────────────┤

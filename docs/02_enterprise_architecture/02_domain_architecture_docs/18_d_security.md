...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_guards_rbac_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_exceptions_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_genesis_bootstrap_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    src_zephyr_security_access_control_verifiers_init_py -.->|config_depends| src_zephyr_security_access_control_verifiers_micro_verifier_py

...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_COMPLIANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_security_access_control_detectors_init_py -.->|config_depends| src_zephyr_security_access_control_detectors_context_drift_detector_py
    ...
    src_zephyr_security_access_control_guards_init_py -.->|config_depends| src_zephyr_security_access_control_guards_memory_guard_py
    D_GOVERNANCE["D_GOVERNANCE production"]
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_detectors_cross_session_detector_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_access_control_emergency_override_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5

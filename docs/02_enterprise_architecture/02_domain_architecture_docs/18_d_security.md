...
graph TD
    ...
    src_zephyr_security_access_control_guards_init_py -.->|config_depends| src_zephyr_security_access_control_guards_audit_log_guard_py
...
graph TD
    ...
    src_zephyr_security_access_control_verifiers_init_py -.->|config_depends| src_zephyr_security_access_control_verifiers_contract_verifier_py
    ...
    src_zephyr_security_access_control_orphan_judge_orphan_detector_py -->|import_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_verifiers_contract_verifier_py
    D_GOVERNANCE -.->|runtime| src_zephyr_security_access_control_verifiers_contract_verifier_py
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    D_GOV_DRIFT -.->|runtime| src_zephyr_security_access_control_verifiers_contract_verifier_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|contract| src_zephyr_security_access_control_verifiers_contract_verifier_py
    D_GOVERNANCE -.->|contract| src_zephyr_security_access_control_verifiers_contract_verifier_py
    D_AUTONOMY_CORE["D_AUTONOMY_CORE prototype"]
    D_AUTONOMY_CORE -.->|runtime| src_zephyr_security_access_control_verifiers_contract_verifier_py
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_DRIFT,D_AUDITTEST,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_SECURITY,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_AUDIT external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_OPS,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SHARED external_prod
```

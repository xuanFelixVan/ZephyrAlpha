...
graph TD
    ...
    class D_SECURITY,D_FEEDBACK_LOOP,D_GOV_DOCS,D_GOV_DRIFT,D_COMPLIANCE,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT external_prod
    class D_SECURITY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_SHARED,D_DATA external_design
```
...
| 68 | D_COMPLIANCE 合规: Audit Trail — MOD-INF-020 (__init__.py) | → | _operational_gates.py | runtime / runtime |
...
| 71 | D_FEEDBACK_LOOP 反馈循环引擎: FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | → | _operational_gates.py | runtime / runtime |
...
| 115 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | _operational_gates.py | runtime / runtime |
...
| 125 | D_GOV_DOCS 架构文档治理: blueprint.md | → | _operational_gates.py | runtime / runtime |
| 126 | D_GOV_DOCS 架构文档治理: blueprint.md | → | _operational_gates.py | contract / contract |
| 127 | D_GOV_DOCS 架构文档治理: blueprint.md | → | _operational_gates.py | runtime / runtime |
| 128 | D_GOV_DRIFT 漂移检测: blueprint.md | → | _operational_gates.py | runtime / runtime |

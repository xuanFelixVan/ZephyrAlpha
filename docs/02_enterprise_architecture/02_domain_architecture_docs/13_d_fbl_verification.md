...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_gates_ci_cd_pre_scanner_py
    ...
    class D_FEEDBACK_LOOP,D_GOV_DOCS external_design
```
...
| 36 | D_GOV_DOCS 架构文档治理: blueprint.md | → | CI/CD Pre-Scanner — v0.8.0 R107 (ci_cd_pre_sca... | runtime / runtime |

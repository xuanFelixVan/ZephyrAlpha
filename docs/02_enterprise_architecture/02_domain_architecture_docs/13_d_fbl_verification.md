...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SHARED,D_AUTONOMY_CORE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT external_prod
    class D_SECURITY,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_SHARED external_design
```

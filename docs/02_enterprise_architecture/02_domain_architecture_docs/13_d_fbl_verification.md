...
graph TD
    ...
    class D_SECURITY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_DATA external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INTELLIGENCE,D_INFRA_RECOVERY,D_SHARED external_design
```

...
graph TD
    ...
    class D_SECURITY,D_GOV_DOCS,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_DATA external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INFRA_RECOVERY,D_INFRASTRUCTURE external_design
```
...
| 121 | D_GOV_DOCS 架构文档治理: blueprint.md | → | _governance_gates.py | runtime / runtime |

...
graph TD
    ...
    class D_SECURITY,D_DATA,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SECURITY,D_DATA,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```

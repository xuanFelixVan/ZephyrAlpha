...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_AUTONOMY_CORE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP external_prod
    class D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_SHARED external_design
```

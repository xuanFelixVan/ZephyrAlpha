...
graph TD
    ...
    class D_SECURITY,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_GOVERNANCE external_design
```

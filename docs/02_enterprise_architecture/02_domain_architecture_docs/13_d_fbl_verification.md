...
graph TD
    ...
    D_FEEDBACK_LOOP -.->|runtime / runtime| src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py
...
|:--:|---------|:--:|---------|---------|
| 1 | D_FEEDBACK_LOOP 反馈循环引擎: FLE 持久化写入器 — 写 metrics/alerts/dispatch_... | → | Safety Gates L1-L27 — Unified Pipeline (MOD-FE... | runtime / runtime |

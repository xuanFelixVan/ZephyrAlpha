...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_verifiers_cross_session_knowledge_integrity_py
...
| 36 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Cross-Session Knowledge Integrity — v0.16.0 R2... | runtime / runtime |

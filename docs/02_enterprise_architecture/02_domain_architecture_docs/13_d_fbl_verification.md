...
graph TD
    ...
    class D_SECURITY,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT external_prod
    class D_SECURITY,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```

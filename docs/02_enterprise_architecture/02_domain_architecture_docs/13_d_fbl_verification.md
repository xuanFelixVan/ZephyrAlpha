...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_verifiers_digital_twin_sandbox_py
    D_FEEDBACK_LOOP["(原型态 / prototype) D_FEEDBACK_LOOP"]
...
| 36 | D_GOV_DOCS 架构文档治理: blueprint.md | → | _operational_gates.py | runtime / runtime |
| 37 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Digital Twin Sandbox — v0.6.0 R55 (digital_twi... | runtime / runtime |

...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_DATA external_design
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_design
```

...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_DATA external_design
```
...
graph TD
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l52_l53_py
    ...
    class D_AUTONOMY_CORE,D_SECURITY,D_SHARED external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT external_prod
    class D_SECURITY,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUTONOMY_CORE 自治核心: Agent Spec -> Pipeline 集成桥接层 (__init__.py) | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
...
| 68 | D_COMPLIANCE 合规: Audit Trail — MOD-INF-020 (__init__.py) | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
...
| 71 | D_FEEDBACK_LOOP 反馈循环引擎: FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
...
| 115 | D_GOVERNANCE 生命周期管理: Self-Benchmark (W3-7) — 5 组已知对自验证 + 引.... | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
...
| 125 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
| 126 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | contract / contract |
| 127 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |
| 128 | D_GOV_DRIFT 漂移检测: blueprint.md | → | Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |

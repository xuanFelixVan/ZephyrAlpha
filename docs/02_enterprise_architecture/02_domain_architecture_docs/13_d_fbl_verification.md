...
graph TD
    ...
    D_GOV_ENFORCEMENT -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_merkle_audit_root_py
    ...
    D_SECURITY -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_deployment_suppression_py
    D_SECURITY -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py
    D_SECURITY -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py
    D_SECURITY -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py
    D_INFRASTRUCTURE["(原型态 / prototype) D_INFRASTRUCTURE"]
    D_INFRASTRUCTURE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_config_complexity_budget_py
    ...
    class D_SECURITY,D_DATA,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l66_l67_py
    D_SECURITY -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l64_l65_py
    ...
    class D_INTELLIGENCE,D_SECURITY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP external_prod
    class D_SECURITY,D_DATA,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```
...
| 72 | D_FEEDBACK_LOOP 反馈循环引擎: FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | → | A/B Test Verifier — v0.9.0 R117 (ab_test.py) | runtime / runtime |

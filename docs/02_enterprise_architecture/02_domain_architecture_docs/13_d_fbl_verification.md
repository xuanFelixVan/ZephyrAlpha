...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    D_FEEDBACK_LOOP -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_verifiers_digital_twin_sandbox_py
    D_INFRA_RECOVERY["(原型态 / prototype) D_INFRA_RECOVERY"]
    ...
    class D_GOV_AUDIT external_prod
    class D_SECURITY,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_merkle_audit_root_py
    ...
    class D_SECURITY,D_DATA,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT external_prod
    class D_SECURITY,D_DATA,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_INFRA_RECOVERY,D_FEEDBACK_LOOP external_design
```

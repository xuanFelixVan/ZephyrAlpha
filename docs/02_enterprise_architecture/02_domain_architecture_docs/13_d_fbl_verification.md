...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_DATA,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_DATA,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SHARED external_design
```

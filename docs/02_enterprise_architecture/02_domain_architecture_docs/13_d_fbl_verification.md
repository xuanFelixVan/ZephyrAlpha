...
graph TD
    ...
    D_GOV_ENFORCEMENT -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_conflict_arbitration_py
    D_GOV_ENFORCEMENT -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_concurrent_change_deconfliction_py
...
graph TD
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_safety_gate_l64_l65_py
    D_SECURITY["(原型态 / prototype) D_SECURITY"]
...
graph TD
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE external_design
```

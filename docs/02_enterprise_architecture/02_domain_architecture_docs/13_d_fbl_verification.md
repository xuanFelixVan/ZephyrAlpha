...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_verifiers_canary_repair_py
...
| 36 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Canary Repair — v0.8.0 R104b (canary_repair.py) | runtime / runtime |

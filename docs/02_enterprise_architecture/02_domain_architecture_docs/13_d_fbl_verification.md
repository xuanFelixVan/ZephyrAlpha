...
graph TD
    ...
    class D_SECURITY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_INTELLIGENCE,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_SHARED external_design
```

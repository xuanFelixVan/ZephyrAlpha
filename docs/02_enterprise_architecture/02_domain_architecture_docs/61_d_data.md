...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_FBL_VERIFICATION,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_FBL_VERIFICATION,D_BACKTEST external_prod

...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOVERNANCE,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOVERNANCE,D_BACKTEST external_prod
...
| 22 | 批量聚合写入器（MOD-L00-004 §18.3 裁定 #ARCH-C... | → | D_MKT_DATA 行情数据:  | data / data |

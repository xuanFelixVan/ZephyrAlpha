...
graph TD
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_BACKTEST external_prod

...
graph TD
    ...
    class D_MKT_DATA,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_MKT_DATA,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY external_design
```

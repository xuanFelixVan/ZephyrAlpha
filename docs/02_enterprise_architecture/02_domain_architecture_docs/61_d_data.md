...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_BACKTEST external_prod
    class D_MKT_DATA,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME external_design
```

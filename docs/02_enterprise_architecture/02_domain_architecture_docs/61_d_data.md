...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_SHARED external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_BACKTEST external_prod

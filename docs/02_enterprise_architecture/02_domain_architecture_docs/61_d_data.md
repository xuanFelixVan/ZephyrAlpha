...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FBL_VERIFICATION,D_INTEGRATION,D_BACKTEST external_prod
    class D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS external_design
```

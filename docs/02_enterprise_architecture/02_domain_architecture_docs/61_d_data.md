...
graph TD
    ...
    class D_MKT_DATA,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_MKT_DATA,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME external_design
```
...
| 2 | 数据源 Provider 实现集合（MOD-L00-004 §4.3）。... | → | D_MKT_DATA 行情数据:  | data / data |

...
graph TD
    ...
    class D_MKT_DATA,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_MKT_DATA,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```
...
| 2 | Provider Capability 行为契约校验器（裁定... (ca... | → | D_MKT_DATA 行情数据:  | data / data |

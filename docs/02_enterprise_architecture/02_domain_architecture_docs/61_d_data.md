...
graph TD
    ...
    class D_MKT_DATA,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_SHARED,D_GOV_RULE,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_INTEGRATION,D_SHARED,D_BACKTEST external_prod
    class D_MKT_DATA,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```

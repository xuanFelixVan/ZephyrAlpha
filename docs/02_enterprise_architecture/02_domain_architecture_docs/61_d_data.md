...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FBL_VERIFICATION,D_GOV_RULE,D_FEEDBACK_LOOP external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 55 个，70 条域内依赖）。
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_FBL_VERIFICATION,D_BACKTEST external_prod
    class D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_BACKTEST external_prod

...
|------|------|-------|-------|
| 编号 | 41 | Number | 41 |
| 域ID | D-SIGNAL_QUALITY | Domain ID | D-SIGNAL_QUALITY |
| 域名称 | 信号质量 | Domain Name | 信号质量 |
...
```mermaid
graph TD
    subgraph D_SIGNAL_QUALITY["D-SIGNAL_QUALITY 信号质量"]
        src_zephyr_signal_quality["信号质量 design"]
        src_zephyr_signal_quality_init_py["src/zephyr/signal_quality/__init__.py prototype"]
        src_zephyr_signal_quality_extensions_init_py["src/zephyr/signal_quality/_extensions/__init__.py scaffold_placeholder"]
        src_zephyr_signal_quality_api_init_py["src/zephyr/signal_quality/api/__init__.py scaffold_placeholder"]
        src_zephyr_signal_quality_core_init_py["src/zephyr/signal_quality/core/__init__.py scaffold_placeholder"]
        src_zephyr_signal_quality_infrastructure_init_py["src/zephyr/signal_quality/infrastructure/__init... scaffold_placeholder"]
        src_zephyr_signal_quality_models_init_py["src/zephyr/signal_quality/models/__init__.py scaffold_placeholder"]
        src_zephyr_signal_quality_services_init_py["src/zephyr/signal_quality/services/__init__.py scaffold_placeholder"]

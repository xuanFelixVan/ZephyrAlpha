...
flowchart TD
    ...
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FRONTEND,D_ORCHESTRATOR external_prod
```

...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RECOVERY,D_SHARED,D_FBL_DETECTORS,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
```
...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RECOVERY,D_SHARED,D_FBL_DETECTORS,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_FRONTEND,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOV_AUDIT,D_SECURITY external_prod
```

...
flowchart TD
    ...
    class D_AUTONOMY_CORE,D_FBL_DETECTORS,D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_SECURITY,D_FRONTEND,D_GOV_AUDIT,D_GOVERNANCE external_prod
```

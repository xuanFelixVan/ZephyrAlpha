...
flowchart TD
    src_zephyr_feedback_loop_init_py["(生产态 / production) 包入口 / Feedback<br/>Loop Engine — MOD-FEEDBACK_LOOP.<br/>包入口。Feedback Loop Engine —<br/>MOD-FEEDBACK_LOOP.<br/>文件: feedback_loop/__init__.py"]
    src_zephyr_feedback_loop_gen_inherited_py["(生产态 / production) 生成inherited / _<br/>gen_inherited<br/>生成inherited，提供包入口和模块加载功能<br/>文件: feedback_loop/_gen_inherited.py"]
    src_zephyr_feedback_loop_actors_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.actors — auto-generated<br/>package init.<br/>包入口。feedback-loop.actors —<br/>auto-generated package init.<br/>文件: actors/__init__.py"]
    src_zephyr_feedback_loop_auto_evolution_py["(生产态 / production) 自动进化 / auto_<br/>evolution<br/>自动进化，反馈闭环的核心调度模块，整合包<br/>入口、告警管理器、告警precision追踪器、<br/>双通道告警等21个子模块协同工作。<br/>文件: feedback_loop/auto_evolution.py"]
    src_zephyr_feedback_loop_backpressure_bridge_py["(生产态 / production) 背压桥接 /<br/>backpressure_bridge<br/>FLE -> Pipeline 背压桥接<br/>（CTR-BP-001~003）<br/>文件: feedback_loop/backpressure_<br/>bridge.py"]
    src_zephyr_feedback_loop_collectors_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.collectors —<br/>auto-generated package init.<br/>包入口。feedback-loop.collectors —<br/>auto-generated package init.<br/>文件: collectors/__init__.py"]
    src_zephyr_feedback_loop_config_py["(生产态 / production) 配置 / config<br/>配置，反馈闭环的配置，管理配置项的读取和<br/>校验。<br/>文件: feedback_loop/config.py"]
    src_zephyr_feedback_loop_db_bridge_py["(生产态 / production) 数据库桥接 / db_<br/>bridge<br/>FLE DB契约适配器 —<br/>通过规范zephyr.governance.sqlite_<br/>schema连接写入fle_metrics<br/>文件: feedback_loop/db_bridge.py"]
    src_zephyr_feedback_loop_decision_engine_py["(生产态 / production) 决策引擎 /<br/>Feedback Loop Decision Engine<br/>决策引擎。Feedback Loop Decision Engine<br/>文件: feedback_loop/decision_engine.py"]
    src_zephyr_feedback_loop_docs_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.docs — auto-generated<br/>package init.<br/>包入口。feedback-loop.docs —<br/>auto-generated package init.<br/>文件: docs/__init__.py"]
    src_zephyr_feedback_loop_error_budget_py["(生产态 / production) 错误预算 / error_<br/>budget<br/>Error Budget 状态机——monthly budget +<br/>burn_rate + exhaust_policy。<br/>文件: feedback_loop/error_budget.py"]
    src_zephyr_feedback_loop_eval_harness_py["(生产态 / production) 评估harness /<br/>eval_harness<br/>评估harness，提供包入口和模块加载功能<br/>文件: feedback_loop/eval_harness.py"]
    src_zephyr_feedback_loop_evolution_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.evolution —<br/>auto-generated package init.<br/>包入口。feedback-loop.evolution —<br/>auto-generated package init.<br/>文件: evolution/__init__.py"]
    src_zephyr_feedback_loop_exceptions_py["(生产态 / production) 异常 / exceptions<br/>异常，提供包入口和模块加载功能<br/>文件: feedback_loop/exceptions.py"]
    src_zephyr_feedback_loop_feedback_collector_py["(生产态 / production) 反馈收集器 /<br/>FeedbackCollector: collect task<br/>execution feedback<br/>反馈收集器。FeedbackCollector: collect<br/>task execution feedback<br/>文件: feedback_loop/feedback_<br/>collector.py"]
    src_zephyr_feedback_loop_fitness_functions_py["(生产态 / production) 适应度functions /<br/>fitness_functions<br/>适应度functions，提供包入口和模块加载功<br/>能<br/>文件: feedback_loop/fitness_functions.py"]
    src_zephyr_feedback_loop_forensic_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.forensic — auto-generated<br/>package init.<br/>包入口。feedback-loop.forensic —<br/>auto-generated package init.<br/>文件: forensic/__init__.py"]
    src_zephyr_feedback_loop_gates_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.gates — auto-generated<br/>package init.<br/>包入口。feedback-loop.gates —<br/>auto-generated package init.<br/>文件: gates/__init__.py"]
    src_zephyr_feedback_loop_generator_py["(生产态 / production) 生成器 / generator<br/>执行骨骼代码生成. 返回 (created,<br/>skipped, errors).<br/>文件: feedback_loop/generator.py"]
    src_zephyr_feedback_loop_metrics_collector_py["(生产态 / production) 指标收集器 /<br/>MetricsCollector: append-only metrics<br/>recording.<br/>指标收集器。MetricsCollector:<br/>append-only metrics recording.<br/>文件: feedback_loop/metrics_collector.py"]
    src_zephyr_feedback_loop_resilience_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.resilience —<br/>auto-generated package init.<br/>包入口。feedback-loop.resilience —<br/>auto-generated package init.<br/>文件: resilience/__init__.py"]
    src_zephyr_feedback_loop_scheduler_py["(生产态 / production) 调度器 / scheduler<br/>FLE 全链路调度器 ——<br/>collect->detect->diagnose->act->verify<br/>闭环。<br/>文件: feedback_loop/scheduler.py"]
    src_zephyr_feedback_loop_security_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.security — auto-generated<br/>package init.<br/>包入口。feedback-loop.security —<br/>auto-generated package init.<br/>文件: security/__init__.py"]
    src_zephyr_feedback_loop_self_diagnosis_py["(生产态 / production) 自诊断 / self_<br/>diagnosis<br/>自我诊断<br/>文件: feedback_loop/self_diagnosis.py"]
    src_zephyr_feedback_loop_session_learner_py["(生产态 / production) 会话学习器 /<br/>session_learner<br/>在线学习<br/>文件: feedback_loop/session_learner.py"]
    src_zephyr_feedback_loop_slo_manager_py["(生产态 / production) SLO管理器 / slo_<br/>manager<br/>5.39.6: SLOManager 进程级单例（boot_<br/>hooks 启动时实例化）。<br/>文件: feedback_loop/slo_manager.py"]
    src_zephyr_feedback_loop_tests_e2e_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.tests.e2e —<br/>auto-generated package init.<br/>包入口。feedback-loop.tests.e2e —<br/>auto-generated package init.<br/>文件: e2e/__init__.py"]
    ...
    src_zephyr_feedback_loop_verifiers_init_py["(生产态 / production) 包入口 /<br/>feedback-loop.verifiers —<br/>auto-generated package init.<br/>包入口。feedback-loop.verifiers —<br/>auto-generated package init.<br/>文件: verifiers/__init__.py"]
    ...
    src_zephyr_feedback_loop_actors_agent_lifecycle_py["(生产态 / production) 代理生命周期 /<br/>Agent Lifecycle Manager — v0.12.0 R159c<br/>代理生命周期。Agent Lifecycle Manager —<br/>v0.12.0 R159c<br/>文件: actors/agent_lifecycle.py"]
    src_zephyr_feedback_loop_actors_api_version_contract_py["(生产态 / production) API版本契约 / API<br/>Version Contract — v0.14.0 R188<br/>API版本契约。API Version Contract —<br/>v0.14.0 R188<br/>文件: actors/api_version_contract.py"]
    src_zephyr_feedback_loop_actors_global_action_scheduler_py["(生产态 / production) 全局动作调度器 /<br/>Global Action Scheduler — v0.16.0 R226<br/>全局动作调度器。Global Action Scheduler<br/>— v0.16.0 R226<br/>文件: actors/global_action_scheduler.py"]
    src_zephyr_feedback_loop_actors_incident_priority_triage_automator_py["(生产态 / production)<br/>incident优先级分诊automator / Incident<br/>Priority Triage Automator — v0.37.0 R463<br/>incident优先级triageautomator，执行者的<br/>核心类，封装Severity相关逻辑。<br/>文件: actors/incident_priority_triage_<br/>automator.py"]
    src_zephyr_feedback_loop_actors_intent_driven_ops_py["(生产态 / production) intentdriven运维<br/>/ Intent-Driven Ops — v0.12.0 R159<br/>intentdriven运维。Intent-Driven Ops —<br/>v0.12.0 R159<br/>文件: actors/intent_driven_ops.py"]
    ...
    src_zephyr_feedback_loop_actors_notification_personalizer_py["(生产态 / production) 通知personalizer<br/>/ Notification Personalizer — v0.6.0 R67<br/>通知personalizer。Notification<br/>Personalizer — v0.6.0 R67<br/>文件: actors/notification_<br/>personalizer.py"]
    src_zephyr_feedback_loop_actors_owner_absence_escalation_py["(生产态 / production) ownerabsence升级<br/>/ Owner Absence Escalation — v0.37.0<br/>R462<br/>所有者absenceescalation。Owner Absence<br/>Escalation — v0.37.0 R462<br/>文件: actors/owner_absence_escalation.py"]
    src_zephyr_feedback_loop_actors_saga_compensator_py["(生产态 / production) Saga补偿器 / Saga<br/>Compensator — v0.3.0 R19b<br/>Saga补偿器，执行者的补偿器，对失败操作做<br/>补偿。<br/>文件: actors/saga_compensator.py"]
    src_zephyr_feedback_loop_actors_secondary_alert_channel_py["(生产态 / production) secondary告警通道<br/>/ Secondary Alert Channel — v0.37.0 R461<br/>secondary告警通道。Secondary Alert<br/>Channel — v0.37.0 R461<br/>文件: actors/secondary_alert_channel.py"]
    src_zephyr_feedback_loop_collectors_calendar_adapter_py["(生产态 / production) 日历适配器 /<br/>Calendar Adapter — v0.8.0 R102b<br/>calendar适配器。Calendar Adapter —<br/>v0.8.0 R102b<br/>文件: collectors/calendar_adapter.py"]
    src_zephyr_feedback_loop_collectors_config_timeline_py["(生产态 / production) 配置timeline /<br/>Config Timeline — v0.8.0 R99<br/>配置timeline。Config Timeline — v0.8.0<br/>R99<br/>文件: collectors/config_timeline.py"]
    src_zephyr_feedback_loop_collectors_data_quality_validator_py["(生产态 / production) 数据质量校验器 /<br/>Data Quality Validator — v0.9.0 R110<br/>数据质量校验器。Data Quality Validator<br/>— v0.9.0 R110<br/>文件: collectors/data_quality_<br/>validator.py"]
    src_zephyr_feedback_loop_collectors_financial_stratification_py["(生产态 / production) 金融分层 /<br/>Financial Stratification — v0.5.0 R50<br/>金融分层，采集器的核心类，封装FinancialS<br/>tratification相关逻辑。<br/>文件: collectors/financial_<br/>stratification.py"]
    src_zephyr_feedback_loop_collectors_kb_provenance_py["(生产态 / production) 知识库溯源 / KB<br/>Provenance — v0.10.0 R136<br/>知识库溯源，采集器的核心类，封装KBProven<br/>ance相关逻辑。<br/>文件: collectors/kb_provenance.py"]
    src_zephyr_feedback_loop_collectors_knowledge_capture_py["(生产态 / production) 知识capture /<br/>Knowledge Capture — v0.4.0 R30<br/>知识capture。Knowledge Capture — v0.4.0<br/>R30<br/>文件: collectors/knowledge_capture.py"]
    src_zephyr_feedback_loop_collectors_knowledge_freshness_py["(生产态 / production) 知识freshness /<br/>Knowledge Freshness — v0.5.0 R47<br/>知识freshness。Knowledge Freshness —<br/>v0.5.0 R47<br/>文件: collectors/knowledge_freshness.py"]
    src_zephyr_feedback_loop_collectors_knowledge_injection_py["(生产态 / production) 知识注入 /<br/>Knowledge Injection — v0.8.0 R102<br/>知识injection。Knowledge Injection —<br/>v0.8.0 R102<br/>文件: collectors/knowledge_injection.py"]
    src_zephyr_feedback_loop_collectors_knowledge_packaging_py["(生产态 / production) 知识packaging /<br/>Knowledge Packaging — v0.9.0 R123<br/>知识packaging。Knowledge Packaging —<br/>v0.9.0 R123<br/>文件: collectors/knowledge_packaging.py"]
    src_zephyr_feedback_loop_collectors_known_unknown_registry_py["(生产态 / production)<br/>knownunknown注册表 / Known-Unknown<br/>Registry — v0.16.0 R229<br/>knownunknown注册表。Known-Unknown<br/>Registry — v0.16.0 R229<br/>文件: collectors/known_unknown_<br/>registry.py"]
    src_zephyr_feedback_loop_collectors_llm_cost_accounting_py["(生产态 / production) LLM成本accounting<br/>/ LLM Cost Accounting — v0.4.0 R35<br/>llm成本accounting。LLM Cost Accounting<br/>— v0.4.0 R35<br/>文件: collectors/llm_cost_accounting.py"]
    src_zephyr_feedback_loop_collectors_market_calendar_py["(生产态 / production) 行情日历 / Market<br/>Calendar — v0.5.0 R48<br/>市场calendar。Market Calendar — v0.5.0<br/>R48<br/>文件: collectors/market_calendar.py"]
    src_zephyr_feedback_loop_collectors_market_event_integrator_py["(生产态 / production)<br/>行情事件integrator / Market Event<br/>Integrator — v0.14.0 R197<br/>市场事件integrator。Market Event<br/>Integrator — v0.14.0 R197<br/>文件: collectors/market_event_<br/>integrator.py"]
    src_zephyr_feedback_loop_collectors_notification_feedback_py["(生产态 / production) 通知反馈 /<br/>Notification Feedback — v0.9.0 R118<br/>通知反馈。Notification Feedback —<br/>v0.9.0 R118<br/>文件: collectors/notification_<br/>feedback.py"]
    ...
    src_zephyr_feedback_loop_collectors_schema_migration_py["(生产态 / production) 模式迁移 / Schema<br/>Migration — v0.14.0 R190<br/>模式迁移。Schema Migration — v0.14.0<br/>R190<br/>文件: collectors/schema_migration.py"]
    src_zephyr_feedback_loop_collectors_temporal_event_store_py["(生产态 / production) temporal事件存储<br/>/ Temporal Event Store — v0.3.0 R9<br/>temporal事件存储。Temporal Event Store<br/>— v0.3.0 R9<br/>文件: collectors/temporal_event_store.py"]
    src_zephyr_feedback_loop_collectors_token_finops_py["(生产态 / production) 令牌finops /<br/>Token FinOps — v0.12.0 R162<br/>令牌finops。Token FinOps — v0.12.0 R162<br/>文件: collectors/token_finops.py"]
    src_zephyr_feedback_loop_core_py["(生产态 / production) 核心 / core<br/>FeedbackLoop core — 反馈闭环核心类。<br/>文件: feedback_loop/core.py"]
    src_zephyr_feedback_loop_db_writer_py["(生产态 / production) db写入器 / db_<br/>writer<br/>FLE 持久化写入器 — 写 metrics/alerts<br/>/dispatch_log 到 SQLite<br/>文件: feedback_loop/db_writer.py"]
    src_zephyr_feedback_loop_docs_cold_start_manual_py["(生产态 / production) 冷启动手册 / cold_<br/>start_manual<br/>冷启动手册（cold_start_manual.py）<br/>文件: docs/cold_start_manual.py"]
    src_zephyr_feedback_loop_evolution_auto_reward_py["(生产态 / production) 自动奖励 / Auto<br/>Reward — v0.7.0 R76<br/>自动奖励。Auto Reward — v0.7.0 R76<br/>文件: evolution/auto_reward.py"]
    src_zephyr_feedback_loop_evolution_conformal_prediction_py["(生产态 / production) conformal预测 /<br/>Conformal Prediction — v0.7.0 R74<br/>conformal预测。Conformal Prediction —<br/>v0.7.0 R74<br/>文件: evolution/conformal_prediction.py"]
    src_zephyr_feedback_loop_evolution_cross_gen_validation_py["(生产态 / production) 跨gen验证 /<br/>Cross-Gen Validation — v0.7.0 R78<br/>跨gen验证。Cross-Gen Validation —<br/>v0.7.0 R78<br/>文件: evolution/cross_gen_validation.py"]
    src_zephyr_feedback_loop_evolution_dynamic_threshold_py["(生产态 / production) 动态阈值 /<br/>Dynamic Threshold — v0.7.0 R71<br/>动态阈值。Dynamic Threshold — v0.7.0 R71<br/>文件: evolution/dynamic_threshold.py"]
    src_zephyr_feedback_loop_evolution_ewc_kb_review_py["(生产态 / production) ewc知识库审查 /<br/>EWC KB Review — v0.6.0 R51<br/>ewckb审查。EWC KB Review — v0.6.0 R51<br/>文件: evolution/ewc_kb_review.py"]
    src_zephyr_feedback_loop_evolution_failure_replay_py["(生产态 / production) 故障replay /<br/>Failure Replay — v0.7.0 R77<br/>failure回放，进化的核心类，封装FailureRe<br/>play相关逻辑。<br/>文件: evolution/failure_replay.py"]
    src_zephyr_feedback_loop_evolution_graduated_activation_protocol_py["(生产态 / production)<br/>graduatedactivation协议 / Graduated<br/>Activation Protocol — v0.38.0 R485<br/>graduatedactivation协议。Graduated<br/>Activation Protocol — v0.38.0 R485<br/>文件: evolution/graduated_activation_<br/>protocol.py"]
    src_zephyr_feedback_loop_evolution_hypernetwork_py["(生产态 / production) 超网络 /<br/>HyperNetwork — v0.7.0 R72<br/>超网络，进化的核心类，封装超网络相关逻辑<br/>。<br/>文件: evolution/hypernetwork.py"]
    src_zephyr_feedback_loop_evolution_knowledge_distillation_py["(生产态 / production) 知识distillation<br/>/ Knowledge Distillation — v0.6.0 R52<br/>知识distillation。Knowledge<br/>Distillation — v0.6.0 R52<br/>文件: evolution/knowledge_<br/>distillation.py"]
    src_zephyr_feedback_loop_evolution_online_feature_importance_py["(生产态 / production)<br/>online特征importance / Online Feature<br/>Importance — v0.7.0 R73<br/>online功能importance。Online Feature<br/>Importance — v0.7.0 R73<br/>文件: evolution/online_feature_<br/>importance.py"]
    src_zephyr_feedback_loop_evolution_prompt_factory_governance_py["(生产态 / production) 提示工厂治理 /<br/>Prompt Factory Governance — v0.16.0 R224<br/>提示工厂治理。Prompt Factory Governance<br/>— v0.16.0 R224<br/>文件: evolution/prompt_factory_<br/>governance.py"]
    src_zephyr_feedback_loop_evolution_prompt_optimization_regression_detector_py["(生产态 / production)<br/>提示优化回归检测器 / R514:<br/>PromptOptimizationRegressionDetector<br/>提示optimization回归检测器。R514:<br/>PromptOptimizationRegressionDetector<br/>文件: evolution/prompt_optimization_<br/>regression_detector.py"]
    src_zephyr_feedback_loop_evolution_prompt_self_optimization_loop_py["(生产态 / production) 提示自优化循环 /<br/>R502: PromptSelfOptimizationLoop<br/>提示自optimizationloop。R502:<br/>PromptSelfOptimizationLoop<br/>文件: evolution/prompt_self_<br/>optimization_loop.py"]
    src_zephyr_feedback_loop_evolution_self_reflection_py["(生产态 / production) 自reflection /<br/>Self Reflection — v0.7.0 R75<br/>自reflection。Self Reflection — v0.7.0<br/>R75<br/>文件: evolution/self_reflection.py"]
    src_zephyr_feedback_loop_evolution_self_upgrade_canary_py["(生产态 / production) selfupgrade金丝雀<br/>/ Self Upgrade Canary — v0.14.0 R194<br/>自upgradecanary。Self Upgrade Canary —<br/>v0.14.0 R194<br/>文件: evolution/self_upgrade_canary.py"]
    src_zephyr_feedback_loop_evolution_semantic_intent_preservation_guard_py["(生产态 / production)<br/>semanticintentpreservation守卫 / R505:<br/>SemanticIntentPreservationGuard<br/>semanticintentpreservation守卫。R505:<br/>SemanticIntentPreservationGuard<br/>文件: evolution/semantic_intent_<br/>preservation_guard.py"]
    src_zephyr_feedback_loop_evolution_teacher_transfer_py["(生产态 / production) 教师迁移 /<br/>Teacher Transfer — v0.6.0 R53<br/>教师迁移，进化的核心类，封装TeacherTrans<br/>fer相关逻辑。<br/>文件: evolution/teacher_transfer.py"]
    src_zephyr_feedback_loop_evolution_training_data_gov_py["(生产态 / production) training数据治理<br/>/ Training Data Governance — v0.14.0<br/>R191<br/>training数据gov。Training Data<br/>Governance — v0.14.0 R191<br/>文件: evolution/training_data_gov.py"]
    src_zephyr_feedback_loop_evolution_engine_py["(生产态 / production) 进化引擎 /<br/>evolution_engine<br/>进化引擎，依赖网关工作<br/>文件: feedback_loop/evolution_engine.py"]
    src_zephyr_feedback_loop_forensic_architectural_sod_py["(生产态 / production) 架构职责分离 /<br/>Architectural SoD — v0.15.0 R205<br/>架构职责分离，取证的核心类，封装SoDRole<br/>相关逻辑。<br/>文件: forensic/architectural_sod.py"]
    src_zephyr_feedback_loop_forensic_automated_rca_postmortem_generator_py["(生产态 / production)<br/>automatedrcapostmortem生成器 /<br/>Automated RCA Postmortem Generator —<br/>v0.38.0 R486<br/>automatedrcapostmortem生成器。Automated<br/>RCA Postmortem Generator — v0.38.0 R486<br/>文件: forensic/automated_rca_postmortem_<br/>generator.py"]
    src_zephyr_feedback_loop_forensic_crypto_bootstrap_py["(生产态 / production) 加密自举 /<br/>Cryptographic Bootstrap — v0.15.0 R204<br/>加密自举，取证的核心类，封装HashLink相关<br/>逻辑。<br/>文件: forensic/crypto_bootstrap.py"]
    src_zephyr_feedback_loop_forensic_deterministic_replay_py["(生产态 / production) deterministic回放<br/>/ Deterministic Replay — v0.15.0 R206<br/>deterministic回放，反馈闭环的记录器，把<br/>发生的事件/结果记下来留档。<br/>文件: forensic/deterministic_replay.py"]
    src_zephyr_feedback_loop_forensic_external_verifier_py["(生产态 / production) 外部验证器 /<br/>External Verifier — v0.15.0 R203<br/>外部验证器。External Verifier — v0.15.0<br/>R203<br/>文件: forensic/external_verifier.py"]
    src_zephyr_feedback_loop_forensic_fle_upgrade_safety_validator_py["(生产态 / production)<br/>fleupgrade安全校验器 / R529:<br/>FLEUpgradeSafetyValidator<br/>fleupgrade安全校验器。R529:<br/>FLEUpgradeSafetyValidator<br/>文件: forensic/fle_upgrade_safety_<br/>validator.py"]
    src_zephyr_feedback_loop_forensic_guard_configuration_drift_monitor_py["(生产态 / production) 守卫配置漂移监控<br/>/ R521: GuardConfigurationDriftMonitor<br/>守卫configuration漂移监控。R521:<br/>GuardConfigurationDriftMonitor<br/>文件: forensic/guard_configuration_<br/>drift_monitor.py"]
    src_zephyr_feedback_loop_forensic_interrupt_coherence_validator_py["(生产态 / production)<br/>interruptcoherence校验器 / R531:<br/>InterruptCoherenceValidator<br/>中断coherence校验器。R531:<br/>InterruptCoherenceValidator<br/>文件: forensic/interrupt_coherence_<br/>validator.py"]
    src_zephyr_feedback_loop_forensic_knowledge_injection_pre_flight_verifier_py["(生产态 / production)<br/>知识注入preflight验证器 / R515:<br/>KnowledgeInjectionPreFlightVerifier<br/>知识injection预flight验证器。R515:<br/>KnowledgeInjectionPreFlightVerifier<br/>文件: forensic/knowledge_injection_pre_<br/>flight_verifier.py"]
    src_zephyr_feedback_loop_forensic_point_in_time_reconstructor_py["(生产态 / production)<br/>点入时间reconstructor / Point-in-Time<br/>Reconstructor — v0.37.0 R465<br/>点入时间reconstructor。Point-in-Time<br/>Reconstructor — v0.37.0 R465<br/>文件: forensic/point_in_time_<br/>reconstructor.py"]
    src_zephyr_feedback_loop_forensic_self_modification_audit_py["(生产态 / production)<br/>selfmodification审计 /<br/>Self-Modification Audit — v0.15.0 R218<br/>自modification审计。Self-Modification<br/>Audit — v0.15.0 R218<br/>文件: forensic/self_modification_<br/>audit.py"]
    src_zephyr_feedback_loop_forensic_serialization_format_tracker_py["(生产态 / production)<br/>serializationformat追踪器 /<br/>Serialization Format Tracker — v0.39.0<br/>R488<br/>serializationformat追踪器。Serialization<br/>Format Tracker — v0.39.0 R488<br/>文件: forensic/serialization_format_<br/>tracker.py"]
    src_zephyr_feedback_loop_forensic_state_migration_validator_py["(生产态 / production) 状态迁移校验器 /<br/>State Migration Validator — v0.40.0 R497<br/>状态迁移校验器。State Migration<br/>Validator — v0.40.0 R497<br/>文件: forensic/state_migration_<br/>validator.py"]
    src_zephyr_feedback_loop_forensic_sub_agent_collusion_py["(生产态 / production) sub代理collusion<br/>/ Sub-Agent Collusion Detector —<br/>v0.15.0 R213<br/>子代理collusion。Sub-Agent Collusion<br/>Detector — v0.15.0 R213<br/>文件: forensic/sub_agent_collusion.py"]
    src_zephyr_feedback_loop_forensic_toctou_guard_py["(生产态 / production) TOCTOU守卫 /<br/>TOCTOU Guard — v0.15.0 R207<br/>toctou守卫。TOCTOU Guard — v0.15.0 R207<br/>文件: forensic/toctou_guard.py"]
    src_zephyr_feedback_loop_forensic_worm_write_integrity_py["(生产态 / production) wormwrite完整性 /<br/>WORM Write Integrity — v0.15.0 R216<br/>wormwrite完整性。WORM Write Integrity —<br/>v0.15.0 R216<br/>文件: forensic/worm_write_integrity.py"]
    src_zephyr_feedback_loop_resilience_deadman_switch_py["(生产态 / production) deadman开关 /<br/>Deadman Switch — v0.15.0 R212<br/>deadman开关。Deadman Switch — v0.15.0<br/>R212<br/>文件: resilience/deadman_switch.py"]
    src_zephyr_feedback_loop_resilience_dr_automation_py["(生产态 / production) 灾备自动化 / DR<br/>Automation — v0.14.0 R187<br/>灾备自动化，韧性的结果，封装操作结果的数<br/>据结构。<br/>文件: resilience/dr_automation.py"]
    src_zephyr_feedback_loop_resilience_multi_instance_coord_py["(生产态 / production) 多instancecoord /<br/>Multi-Instance Coordinator — v0.14.0<br/>R199<br/>多instancecoord。Multi-Instance<br/>Coordinator — v0.14.0 R199<br/>文件: resilience/multi_instance_coord.py"]
    src_zephyr_feedback_loop_resilience_resource_starvation_aware_py["(生产态 / production)<br/>资源starvation感知 / Resource<br/>Starvation Aware — v0.15.0 R209<br/>resourcestarvation感知，韧性的核心类，封<br/>装ResourceBudget相关逻辑。<br/>文件: resilience/resource_starvation_<br/>aware.py"]
    src_zephyr_feedback_loop_resilience_split_brain_quorum_py["(生产态 / production) 拆分brainquorum /<br/>Split-Brain Quorum — v0.37.0 R451<br/>拆分brainquorum。Split-Brain Quorum —<br/>v0.37.0 R451<br/>文件: resilience/split_brain_quorum.py"]
    src_zephyr_feedback_loop_scheduler_act_py["(生产态 / production) 调度器act /<br/>scheduler_act<br/>调度器act，反馈闭环的结果，封装操作结果<br/>的数据结构。<br/>文件: feedback_loop/scheduler_act.py"]
    src_zephyr_feedback_loop_scheduler_collect_detect_py["(生产态 / production)<br/>调度器collectdetect / scheduler_collect_<br/>detect<br/>调度器collect检测，主要提供运行collect、<br/>运行检测、运行diagnose等功能，供调度器使<br/>用<br/>文件: feedback_loop/scheduler_collect_<br/>detect.py"]
    src_zephyr_feedback_loop_scheduler_health_py["(生产态 / production) 调度器健康 /<br/>scheduler_health<br/>调度器健康，主要提供报告等功能，供调度器<br/>使用<br/>文件: feedback_loop/scheduler_health.py"]
    src_zephyr_feedback_loop_scheduler_safety_py["(生产态 / production) 调度器安全 /<br/>scheduler_safety<br/>调度器安全，主要提供运行安全门禁、fle门<br/>禁缓存、fle门禁缓存等功能，供调度器使用<br/>文件: feedback_loop/scheduler_safety.py"]
    src_zephyr_feedback_loop_security_agent_skill_guard_py["(生产态 / production) 代理技能守卫 /<br/>Agent Skill Guard — v0.14.0 R201<br/>代理技能守卫。Agent Skill Guard —<br/>v0.14.0 R201<br/>文件: security/agent_skill_guard.py"]
    src_zephyr_feedback_loop_security_dep_cve_correlator_py["(生产态 / production) 依赖CVE关联器 /<br/>Dependency CVE Correlator — v0.14.0 R196<br/>依赖CVE关联器，安全的关联器，关联匹配相<br/>关数据。<br/>文件: security/dep_cve_correlator.py"]
    src_zephyr_feedback_loop_security_metric_prompt_scanner_py["(生产态 / production) 指标提示扫描器 /<br/>Metric-Prompt Scanner — v0.15.0 R215<br/>指标提示扫描器。Metric-Prompt Scanner —<br/>v0.15.0 R215<br/>文件: security/metric_prompt_scanner.py"]
    src_zephyr_feedback_loop_security_remote_attestation_py["(生产态 / production) 远程attestation /<br/>Remote Attestation — v0.15.0 R211<br/>远程attestation。Remote Attestation —<br/>v0.15.0 R211<br/>文件: security/remote_attestation.py"]
    src_zephyr_feedback_loop_security_secret_rotation_py["(生产态 / production) 密钥rotation /<br/>Secret Rotation — v0.14.0 R189<br/>密钥rotation。Secret Rotation — v0.14.0<br/>R189<br/>文件: security/secret_rotation.py"]
    src_zephyr_feedback_loop_template_py["(生产态 / production) 模板 / template<br/>模板，供blueprint.md §0;<br/>zephyr.feedba使用<br/>文件: feedback_loop/template.py"]
    src_zephyr_feedback_loop_tests_e2e_integration_test_pipeline_py["(生产态 / production) 集成测试管线 /<br/>E2E Integration Test Pipeline —<br/>TASK-MOD-FEEDBACK_LOOP-0028<br/>集成测试管线。E2E Integration Test<br/>Pipeline — TASK-MOD-FEEDBACK_LOOP-0028<br/>(Phase43-87)<br/>文件: e2e/integration_test_pipeline.py"]
    ...
    src_zephyr_feedback_loop_actors_action_selector_py["(生产态 / production) 动作选择器 /<br/>action_selector<br/>动作选择器，反馈闭环的记录器，把发生的事<br/>件/结果记下来留档。<br/>文件: actors/action_selector.py"]
    src_zephyr_feedback_loop_alert_dispatcher_py["(生产态 / production) alert分发器 /<br/>alert_dispatcher<br/>FLE->Orc 告警分派器 — dispatch() 生产者<br/>文件: feedback_loop/alert_dispatcher.py"]
    src_zephyr_feedback_loop_collectors_feedback_collector_py["(生产态 / production) 反馈收集器 /<br/>feedback_collector<br/>反馈收集器，反馈闭环的数据库，持久化存取<br/>结构化数据。<br/>文件: collectors/feedback_collector.py"]
    src_zephyr_feedback_loop_collectors_metrics_collector_py["(生产态 / production) 指标收集器 /<br/>metrics_collector<br/>指标收集器，反馈闭环的核心类，封装Metric<br/>Snapshot相关逻辑。<br/>文件: collectors/metrics_collector.py"]
    ...
    src_zephyr_feedback_loop_forensic_boot_integrity_attestation_py["(生产态 / production)<br/>boot完整性attestation / Boot Integrity<br/>Attestation — v0.38.0 R487<br/>启动完整性attestation。Boot Integrity<br/>Attestation — v0.38.0 R487<br/>文件: forensic/boot_integrity_<br/>attestation.py"]
    src_zephyr_feedback_loop_forensic_guard_complexity_budget_py["(生产态 / production)<br/>守卫complexity预算 / R523:<br/>GuardComplexityBudget<br/>守卫complexity预算。R523:<br/>GuardComplexityBudget<br/>文件: forensic/guard_complexity_<br/>budget.py"]
    src_zephyr_feedback_loop_resilience_config_hot_reload_guard_py["(生产态 / production) 配置hotreload守卫<br/>/ Config Hot-Reload Guard — v0.40.0 R498<br/>配置hotreload守卫。Config Hot-Reload<br/>Guard — v0.40.0 R498<br/>文件: resilience/config_hot_reload_<br/>guard.py"]
    src_zephyr_feedback_loop_resilience_graceful_degradation_planner_py["(生产态 / production)<br/>gracefuldegradation规划器 / Graceful<br/>Degradation Planner — v0.40.0 R496<br/>graceful退化planner。Graceful<br/>Degradation Planner — v0.40.0 R496<br/>文件: resilience/graceful_degradation_<br/>planner.py"]
    src_zephyr_feedback_loop_resilience_oscillation_damping_py["(生产态 / production) 振荡阻尼 /<br/>Oscillation Damping — v0.37.0 R450<br/>振荡阻尼，韧性的状态机，管理状态流转。<br/>文件: resilience/oscillation_damping.py"]
    src_zephyr_feedback_loop_resilience_self_api_throttle_defense_py["(生产态 / production) 自API限流器防御 /<br/>Self API Throttle Defense — v0.39.0 R491<br/>自APIthrottle防御。Self API Throttle<br/>Defense — v0.39.0 R491<br/>文件: resilience/self_api_throttle_<br/>defense.py"]
    src_zephyr_feedback_loop_security_wireheading_prevention_py["(生产态 / production) 神经劫持防护 /<br/>Wireheading Prevention — v0.37.0 R486<br/>神经劫持防护，安全的状态机，管理状态流转<br/>。<br/>文件: security/wireheading_prevention.py"]
    ...
    src_zephyr_feedback_loop_actors_alert_router_py["(生产态 / production) 告警路由器 /<br/>alert_router.py — Severity-based alert<br/>channel router.<br/>告警路由器，执行者的路由器，按规则分发请<br/>求到处理方。<br/>文件: actors/alert_router.py"]
    src_zephyr_feedback_loop_protocols_py["(生产态 / production) 协议 / protocols<br/>协议，反馈闭环的类型，定义数据类型和枚举<br/>。<br/>文件: feedback_loop/protocols.py"]
    ...
    D_FBL_DIAGNOSERS["(生产态 / production) 反馈诊断器 /<br/>Feedback Diagnosers<br/>反馈诊断器，负责异常根因诊断、模型健康监<br/>控、可靠性诊断和上下文窗口压力管理<br/>跨域节点 / cross-domain"]
    ...
    D_FBL_VERIFICATION["(生产态 / production) 反馈验证 /<br/>Feedback Verification<br/>反馈验证，负责反馈循环门禁拦截、结果验证<br/>器执行和反馈质量检查<br/>跨域节点 / cross-domain"]
    ...
    D_FRONTEND["(生产态 / production) 前端 / Frontend<br/>前端，负责用户界面展示、交互可视化和前端<br/>状态管理<br/>跨域节点 / cross-domain"]
    D_FRONTEND -->|导入依赖 / import_depends| src_zephyr_feedback_loop_fitness_functions_py
    D_FBL_DETECTORS["(生产态 / production) 反馈检测器 /<br/>Feedback Detectors<br/>反馈检测器，负责异常检测、漂移检测、反馈<br/>信号检测和可靠性监控<br/>跨域节点 / cross-domain"]

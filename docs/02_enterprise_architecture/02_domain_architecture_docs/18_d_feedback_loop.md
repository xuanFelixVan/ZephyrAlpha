...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_DRIFT,D_FRONTEND,D_SECURITY,D_ORCHESTRATOR,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_AUDIT external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_INTEGRATION,D_FBL_DIAGNOSERS,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FBL_DETECTORS,D_FRONTEND,D_AUTONOMY_CORE external_prod
```

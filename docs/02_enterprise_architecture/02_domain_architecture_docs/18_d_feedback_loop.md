...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_SHARED,D_FBL_DETECTORS,D_FRONTEND,D_SECURITY,D_GOV_AUDIT external_prod
```

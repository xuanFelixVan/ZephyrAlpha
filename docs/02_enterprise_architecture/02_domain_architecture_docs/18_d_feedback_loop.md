...
flowchart TD
    ...
    class D_FBL_DIAGNOSERS,D_SHARED,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_DRIFT,D_FBL_DETECTORS,D_FRONTEND,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_AUDIT,D_SECURITY external_prod
```

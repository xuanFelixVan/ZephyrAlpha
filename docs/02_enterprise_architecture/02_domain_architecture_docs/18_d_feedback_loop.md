...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FRONTEND,D_SECURITY,D_ORCHESTRATOR external_prod
```

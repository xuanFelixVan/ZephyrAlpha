...
flowchart TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FRONTEND,D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE external_prod
```

...
flowchart TD
    ...
    src_zephyr_feedback_loop_actors_init_py["feedback_loop/actors 包入口<br/>管理feedback_loop.actors子包的加载和懒导入<br/>文件: actors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_init_py["feedback_loop/collectors 包入口<br/>管理feedback_loop.collectors子包的加载和懒导入<br/>文件: collectors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_docs_init_py["feedback_loop/docs 包入口<br/>管理feedback_loop.docs子包的加载和懒导入<br/>文件: docs/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_init_py["feedback_loop/evolution 包入口<br/>管理feedback_loop.evolution子包的加载和懒导入<br/>文件: evolution/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_init_py["feedback_loop/forensic 包入口<br/>管理feedback_loop.forensic子包的加载和懒导入<br/>文件: forensic/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_init_py["feedback_loop/gates 包入口<br/>管理feedback_loop.gates子包的加载和懒导入<br/>文件: gates/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_metrics_collector_py["指标收集器<br/>feedback loop包的metrics_collector模块<br/>文件: feedback_loop/metrics_collector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_init_py["feedback_loop/resilience 包入口<br/>管理feedback_loop.resilience子包的加载和懒导入<br/>文件: resilience/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_init_py["feedback_loop/security 包入口<br/>管理feedback_loop.security子包的加载和懒导入<br/>文件: security/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_self_diagnosis_py["自诊断<br/>self_diagnosis.py — 自我诊断 (DD120, TASK-020)<br/>文件: feedback_loop/self_diagnosis.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_session_learner_py["会话学习器<br/>session_learner.py — 在线学习 (DD114, TASK-020)<br/>文件: feedback_loop/session_learner.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_tests_e2e_init_py["tests/e2e 包入口<br/>管理tests.e2e子包的加载和懒导入<br/>文件: e2e/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_init_py["feedback_loop/verifiers 包入口<br/>管理feedback_loop.verifiers子包的加载和懒导入<br/>文件: verifiers/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_agent_lifecycle_py["代理生命周期<br/>执行器包的agent_lifecycle模块<br/>Agent Lifecycle Manager — v0.12.0 R159c<br/>文件: actors/agent_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_api_version_contract_py["API版本契约<br/>执行器包的api_version_contract模块<br/>API Version Contract — v0.14.0 R188<br/>文件: actors/api_version_contract.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_global_action_scheduler_py["全局动作调度器<br/>执行器包的global_action_scheduler模块<br/>Global Action Scheduler — v0.16.0 R226<br/>文件: actors/global_action_scheduler.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_multi_agent_orchestrator_py["多代理编排器<br/>执行器包的multi_agent_orchestrator模块<br/>Multi-Agent Orchestrator — v0.12.0 R159b<br/>文件: actors/multi_agent_orchestrator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_calendar_adapter_py["日历适配器<br/>calendar适配器模块<br/>Calendar Adapter — v0.8.0 R102b<br/>文件: collectors/calendar_adapter.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_market_event_integrator_py["行情事件integrator<br/>市场事件integrator模块<br/>Market Event Integrator — v0.14.0 R197<br/>文件: collectors/market_event_integrator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_notification_feedback_py["通知反馈<br/>collectors包的notification_feedback模块<br/>Notification Feedback — v0.9.0 R118<br/>文件: collectors/notification_feedback.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_schema_evolution_py["模式进化<br/>collectors包的schema_evolution模块<br/>Schema Evolution — v0.9.0 R111<br/>文件: collectors/schema_evolution.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_schema_migration_py["模式迁移<br/>collectors包的schema_migration模块<br/>Schema Migration — v0.14.0 R190<br/>文件: collectors/schema_migration.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_auto_reward_py["自动奖励<br/>evolution包的auto_reward模块<br/>Auto Reward — v0.7.0 R76<br/>文件: evolution/auto_reward.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_cross_gen_validation_py["跨gen验证<br/>evolution包的cross_gen_validation模块<br/>Cross-Gen Validation — v0.7.0 R78<br/>文件: evolution/cross_gen_validation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_dynamic_threshold_py["动态阈值<br/>evolution包的dynamic_threshold模块<br/>Dynamic Threshold — v0.7.0 R71<br/>文件: evolution/dynamic_threshold.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_prompt_factory_governance_py["提示工厂治理<br/>evolution包的prompt_factory_governance模块<br/>Prompt Factory Governance — v0.16.0 R224<br/>文件: evolution/prompt_factory_governance.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_external_verifier_py["外部验证器<br/>forensic包的external_verifier模块<br/>External Verifier — v0.15.0 R203<br/>文件: forensic/external_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_point_in_time_reconstructor_py["点入时间reconstructor<br/>forensic包的point_in_time_reconstructor模块<br/>文件: forensic/point_in_time_reconstructor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_state_migration_validator_py["状态迁移校验器<br/>forensic包的state_migration_validator模块<br/>State Migration Validator — v0.40.0 R497<br/>文件: forensic/state_migration_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_sub_agent_collusion_py["sub代理collusion<br/>子代理collusion模块<br/>文件: forensic/sub_agent_collusion.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_agent_skill_guard_py["代理技能守卫<br/>安全包的agent_skill_guard模块<br/>Agent Skill Guard — v0.14.0 R201<br/>文件: security/agent_skill_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_metric_prompt_scanner_py["指标提示扫描器<br/>安全包的metric_prompt_scanner模块<br/>Metric-Prompt Scanner — v0.15.0 R215<br/>文件: security/metric_prompt_scanner.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_boot_integrity_attestation_py["boot完整性attestation<br/>启动完整性attestation模块<br/>文件: forensic/boot_integrity_attestation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_self_api_throttle_defense_py["自API限流器防御<br/>自APIthrottle防御模块<br/>Self API Throttle Defense — v0.39.0 R491<br/>文件: resilience/self_api_throttle_defense.py<br/>(生产态 / production)"]

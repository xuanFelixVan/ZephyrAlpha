...
flowchart TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOVERNANCE,D_SECURITY,D_FRONTEND,D_AUTONOMY_CORE external_prod
```

...
flowchart TD
    ...
    src_zephyr_feedback_loop_gen_inherited_py["生成inherited<br/>feedback loop包的gen_inherited模块<br/>_gen_inherited<br/>文件: feedback_loop/_gen_inherited.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_init_py["feedback_loop/actors 包入口<br/>反馈环的包入口。feedback-loop.actors —<br/>auto-generated package<br/>init.，包入口。feedback-loop.actors —<br/>auto-generated package init.相关功能的实现。<br/>文件: actors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_init_py["feedback_loop/collectors 包入口<br/>反馈环的包入口。feedback-loop.collectors —<br/>auto-generated package<br/>init.，包入口。feedback-loop.collectors —<br/>auto-generated package init.相关功能的实现。<br/>文件: collectors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_docs_init_py["feedback_loop/docs 包入口<br/>反馈环的包入口。feedback-loop.docs —<br/>auto-generated package<br/>init.，包入口。feedback-loop.docs —<br/>auto-generated package init.相关功能的实现。<br/>文件: docs/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_error_budget_py["错误预算<br/>反馈环的Error Budget 状态机——monthly budget +<br/>burn_rate + exhaust_policy。，Error Budget<br/>状态机——monthly budget + burn_rate +<br/>exhaust_policy。相关功能的实现。<br/>error_budget<br/>文件: feedback_loop/error_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_eval_harness_py["评估harness<br/>feedback loop包的eval_harness模块<br/>文件: feedback_loop/eval_harness.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_init_py["feedback_loop/evolution 包入口<br/>反馈环的包入口。feedback-loop.evolution —<br/>auto-generated package<br/>init.，包入口。feedback-loop.evolution —<br/>auto-generated package init.相关功能的实现。<br/>文件: evolution/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_exceptions_py["异常<br/>feedback loop包的exceptions模块<br/>文件: feedback_loop/exceptions.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_feedback_collector_py["反馈收集器<br/>feedback loop包的feedback_collector模块<br/>文件: feedback_loop/feedback_collector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_fitness_functions_py["适应度functions<br/>feedback loop包的fitness_functions模块<br/>文件: feedback_loop/fitness_functions.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_init_py["feedback_loop/forensic 包入口<br/>反馈环的包入口。feedback-loop.forensic —<br/>auto-generated package<br/>init.，包入口。feedback-loop.forensic —<br/>auto-generated package init.相关功能的实现。<br/>文件: forensic/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_init_py["feedback_loop/gates 包入口<br/>反馈环的包入口。feedback-loop.gates —<br/>auto-generated package<br/>init.，包入口。feedback-loop.gates —<br/>auto-generated package init.相关功能的实现。<br/>文件: gates/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_metrics_collector_py["指标收集器<br/>反馈环的指标收集器。MetricsCollector:<br/>append-only metrics<br/>recording.，指标收集器。MetricsCollector:<br/>append-only metrics recording.相关功能的实现。<br/>文件: feedback_loop/metrics_collector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_init_py["feedback_loop/resilience 包入口<br/>反馈环的包入口。feedback-loop.resilience —<br/>auto-generated package<br/>init.，包入口。feedback-loop.resilience —<br/>auto-generated package init.相关功能的实现。<br/>文件: resilience/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_init_py["feedback_loop/security 包入口<br/>安全的包入口。feedback-loop.security —<br/>auto-generated package<br/>init.，包入口。feedback-loop.security —<br/>auto-generated package init.相关功能的实现。<br/>文件: security/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_self_diagnosis_py["自诊断<br/>反馈环的自我诊断，自我诊断相关功能的实现。<br/>self_diagnosis<br/>文件: feedback_loop/self_diagnosis.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_session_learner_py["会话学习器<br/>反馈环的在线学习，在线学习相关功能的实现。<br/>session_learner<br/>文件: feedback_loop/session_learner.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_tests_e2e_init_py["tests/e2e 包入口<br/>包入口。feedback-loop.tests.e2e —<br/>auto-generated package init.<br/>文件: e2e/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_init_py["feedback_loop/verifiers 包入口<br/>反馈环的包入口。feedback-loop.verifiers —<br/>auto-generated package<br/>init.，包入口。feedback-loop.verifiers —<br/>auto-generated package init.相关功能的实现。<br/>文件: verifiers/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_agent_lifecycle_py["代理生命周期<br/>反馈环的代理生命周期。Agent Lifecycle Manager —<br/>v0.12.0 R159c，代理生命周期。Agent Lifecycle<br/>Manager — v0.12.0 R159c相关功能的实现。<br/>文件: actors/agent_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_api_version_contract_py["API版本契约<br/>反馈环的API版本契约。API Version Contract —<br/>v0.14.0 R188，API版本契约。API Version Contract<br/>— v0.14.0 R188相关功能的实现。<br/>文件: actors/api_version_contract.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_global_action_scheduler_py["全局动作调度器<br/>反馈环的全局动作调度器。Global Action Scheduler<br/>— v0.16.0 R226，全局动作调度器。Global Action<br/>Scheduler — v0.16.0 R226相关功能的实现。<br/>文件: actors/global_action_scheduler.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_intent_driven_ops_py["intentdriven运维<br/>反馈环的intentdriven运维。Intent-Driven Ops —<br/>v0.12.0 R159，intentdriven运维。Intent-Driven<br/>Ops — v0.12.0 R159相关功能的实现。<br/>文件: actors/intent_driven_ops.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_multi_agent_orchestrator_py["多代理编排器<br/>反馈环的多代理编排器。Multi-Agent Orchestrator<br/>— v0.12.0 R159b，多代理编排器。Multi-Agent<br/>Orchestrator — v0.12.0 R159b相关功能的实现。<br/>文件: actors/multi_agent_orchestrator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_notification_personalizer_py["通知personalizer<br/>反馈环的通知personalizer。Notification<br/>Personalizer — v0.6.0<br/>R67，通知personalizer。Notification<br/>Personalizer — v0.6.0 R67相关功能的实现。<br/>文件: actors/notification_personalizer.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_owner_absence_escalation_py["ownerabsence升级<br/>反馈环的所有者absenceescalation。Owner Absence<br/>Escalation — v0.37.0<br/>R462，所有者absenceescalation。Owner Absence<br/>Escalation — v0.37.0 R462相关功能的实现。<br/>文件: actors/owner_absence_escalation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_secondary_alert_channel_py["secondary告警通道<br/>反馈环的secondary告警通道。Secondary Alert<br/>Channel — v0.37.0<br/>R461，secondary告警通道。Secondary Alert<br/>Channel — v0.37.0 R461相关功能的实现。<br/>文件: actors/secondary_alert_channel.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_calendar_adapter_py["日历适配器<br/>反馈环的calendar适配器。Calendar Adapter —<br/>v0.8.0 R102b，calendar适配器。Calendar Adapter<br/>— v0.8.0 R102b相关功能的实现。<br/>文件: collectors/calendar_adapter.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_config_timeline_py["配置timeline<br/>反馈环的配置timeline。Config Timeline — v0.8.0<br/>R99，配置timeline。Config Timeline — v0.8.0<br/>R99相关功能的实现。<br/>文件: collectors/config_timeline.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_data_quality_validator_py["数据质量校验器<br/>反馈环的数据质量校验器。Data Quality Validator<br/>— v0.9.0 R110，数据质量校验器。Data Quality<br/>Validator — v0.9.0 R110相关功能的实现。<br/>文件: collectors/data_quality_validator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_knowledge_capture_py["知识capture<br/>反馈环的知识capture。Knowledge Capture — v0.4.0<br/>R30，知识capture。Knowledge Capture — v0.4.0<br/>R30相关功能的实现。<br/>文件: collectors/knowledge_capture.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_knowledge_freshness_py["知识freshness<br/>反馈环的知识freshness。Knowledge Freshness —<br/>v0.5.0 R47，知识freshness。Knowledge Freshness<br/>— v0.5.0 R47相关功能的实现。<br/>文件: collectors/knowledge_freshness.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_knowledge_injection_py["知识注入<br/>反馈环的知识injection。Knowledge Injection —<br/>v0.8.0 R102，知识injection。Knowledge Injection<br/>— v0.8.0 R102相关功能的实现。<br/>文件: collectors/knowledge_injection.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_knowledge_packaging_py["知识packaging<br/>反馈环的知识packaging。Knowledge Packaging —<br/>v0.9.0 R123，知识packaging。Knowledge Packaging<br/>— v0.9.0 R123相关功能的实现。<br/>文件: collectors/knowledge_packaging.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_known_unknown_registry_py["knownunknown注册表<br/>反馈环的knownunknown注册表。Known-Unknown<br/>Registry — v0.16.0<br/>R229，knownunknown注册表。Known-Unknown<br/>Registry — v0.16.0 R229相关功能的实现。<br/>文件: collectors/known_unknown_registry.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_llm_cost_accounting_py["LLM成本accounting<br/>反馈环的llm成本accounting。LLM Cost Accounting<br/>— v0.4.0 R35，llm成本accounting。LLM Cost<br/>Accounting — v0.4.0 R35相关功能的实现。<br/>文件: collectors/llm_cost_accounting.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_market_calendar_py["行情日历<br/>反馈环的市场calendar。Market Calendar — v0.5.0<br/>R48，市场calendar。Market Calendar — v0.5.0<br/>R48相关功能的实现。<br/>文件: collectors/market_calendar.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_market_event_integrator_py["行情事件integrator<br/>反馈环的市场事件integrator。Market Event<br/>Integrator — v0.14.0<br/>R197，市场事件integrator。Market Event<br/>Integrator — v0.14.0 R197相关功能的实现。<br/>文件: collectors/market_event_integrator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_notification_feedback_py["通知反馈<br/>反馈环的通知反馈。Notification Feedback —<br/>v0.9.0 R118，通知反馈。Notification Feedback —<br/>v0.9.0 R118相关功能的实现。<br/>文件: collectors/notification_feedback.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_schema_evolution_py["模式进化<br/>反馈环的模式进化。Schema Evolution — v0.9.0<br/>R111，模式进化。Schema Evolution — v0.9.0<br/>R111相关功能的实现。<br/>文件: collectors/schema_evolution.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_schema_migration_py["模式迁移<br/>反馈环的模式迁移。Schema Migration — v0.14.0<br/>R190，模式迁移。Schema Migration — v0.14.0<br/>R190相关功能的实现。<br/>文件: collectors/schema_migration.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_temporal_event_store_py["temporal事件存储<br/>反馈环的temporal事件存储。Temporal Event Store<br/>— v0.3.0 R9，temporal事件存储。Temporal Event<br/>Store — v0.3.0 R9相关功能的实现。<br/>文件: collectors/temporal_event_store.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_token_finops_py["令牌finops<br/>反馈环的令牌finops。Token FinOps — v0.12.0<br/>R162，令牌finops。Token FinOps — v0.12.0<br/>R162相关功能的实现。<br/>文件: collectors/token_finops.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_docs_cold_start_manual_py["冷启动手册<br/>反馈环的冷启动手册<br/>（cold_start_manual.py），冷启动手册<br/>（cold_start_manual.py）相关功能的实现。<br/>文件: docs/cold_start_manual.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_auto_reward_py["自动奖励<br/>反馈环的自动奖励。Auto Reward — v0.7.0<br/>R76，自动奖励。Auto Reward — v0.7.0<br/>R76相关功能的实现。<br/>文件: evolution/auto_reward.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_conformal_prediction_py["conformal预测<br/>反馈环的conformal预测。Conformal Prediction —<br/>v0.7.0 R74，conformal预测。Conformal Prediction<br/>— v0.7.0 R74相关功能的实现。<br/>文件: evolution/conformal_prediction.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_cross_gen_validation_py["跨gen验证<br/>反馈环的跨gen验证。Cross-Gen Validation —<br/>v0.7.0 R78，跨gen验证。Cross-Gen Validation —<br/>v0.7.0 R78相关功能的实现。<br/>文件: evolution/cross_gen_validation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_dynamic_threshold_py["动态阈值<br/>反馈环的动态阈值。Dynamic Threshold — v0.7.0<br/>R71，动态阈值。Dynamic Threshold — v0.7.0<br/>R71相关功能的实现。<br/>文件: evolution/dynamic_threshold.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_ewc_kb_review_py["ewc知识库审查<br/>反馈环的ewckb审查。EWC KB Review — v0.6.0<br/>R51，ewckb审查。EWC KB Review — v0.6.0<br/>R51相关功能的实现。<br/>文件: evolution/ewc_kb_review.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_graduated_activation_protocol_py["graduatedactivation协议<br/>反馈环的graduatedactivation协议。Graduated<br/>Activation Protocol — v0.38.0<br/>R485，graduatedactivation协议。Graduated<br/>Activation Protocol — v0.38.0<br/>R485相关功能的实现。<br/>文件: evolution/graduated_activation_protocol.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_knowledge_distillation_py["知识distillation<br/>反馈环的知识distillation。Knowledge<br/>Distillation — v0.6.0<br/>R52，知识distillation。Knowledge Distillation —<br/>v0.6.0 R52相关功能的实现。<br/>文件: evolution/knowledge_distillation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_online_feature_importance_py["online特征importance<br/>反馈环的online功能importance。Online Feature<br/>Importance — v0.7.0<br/>R73，online功能importance。Online Feature<br/>Importance — v0.7.0 R73相关功能的实现。<br/>文件: evolution/online_feature_importance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_prompt_factory_governance_py["提示工厂治理<br/>反馈环的提示工厂治理。Prompt Factory Governance<br/>— v0.16.0 R224，提示工厂治理。Prompt Factory<br/>Governance — v0.16.0 R224相关功能的实现。<br/>文件: evolution/prompt_factory_governance.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_self_reflection_py["自reflection<br/>反馈环/evolution模块的self_reflection组件。<br/>Self Reflection — v0.7.0 R75<br/>文件: evolution/self_reflection.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_self_upgrade_canary_py["selfupgrade金丝雀<br/>反馈环模块，实现selfupgrade金丝雀功能。<br/>Self Upgrade Canary — v0.14.0 R194<br/>文件: evolution/self_upgrade_canary.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_training_data_gov_py["training数据治理<br/>反馈环的training数据gov。Training Data<br/>Governance — v0.14.0<br/>R191，training数据gov。Training Data Governance<br/>— v0.14.0 R191相关功能的实现。<br/>文件: evolution/training_data_gov.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_automated_rca_postmortem_generator_py["automatedrcapostmortem生成器<br/>反馈环的using temporal ordering + correlation.<br/>Generate timeline, 追问到底分析,，using<br/>temporal ordering + correlation. Generate<br/>timeline, 追问到底分析,相关功能的实现。<br/>文件: forensic<br/>/automated_rca_postmortem_generator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_deterministic_replay_py["deterministic回放<br/>deterministicreplay模块<br/>Deterministic Replay — v0.15.0 R206<br/>文件: forensic/deterministic_replay.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_external_verifier_py["外部验证器<br/>反馈环的外部验证器。External Verifier — v0.15.0<br/>R203，外部验证器。External Verifier — v0.15.0<br/>R203相关功能的实现。<br/>文件: forensic/external_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_point_in_time_reconstructor_py["点入时间reconstructor<br/>反馈环的点入时间reconstructor。Point-in-Time<br/>Reconstructor — v0.37.0<br/>R465，点入时间reconstructor。Point-in-Time<br/>Reconstructor — v0.37.0 R465相关功能的实现。<br/>文件: forensic/point_in_time_reconstructor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_self_modification_audit_py["selfmodification审计<br/>反馈环的自modification审计。Self-Modification<br/>Audit — v0.15.0<br/>R218，自modification审计。Self-Modification<br/>Audit — v0.15.0 R218相关功能的实现。<br/>文件: forensic/self_modification_audit.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_serialization_format_tracker_py["serializationformat追踪器<br/>反馈环的serializationformat追踪器。Serialization<br/>Format Tracker — v0.39.0<br/>R488，serializationformat追踪器。Serialization<br/>Format Tracker — v0.39.0 R488相关功能的实现。<br/>文件: forensic/serialization_format_tracker.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_state_migration_validator_py["状态迁移校验器<br/>反馈环的状态迁移校验器。State Migration<br/>Validator — v0.40.0 R497，状态迁移校验器。State<br/>Migration Validator — v0.40.0<br/>R497相关功能的实现。<br/>文件: forensic/state_migration_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_sub_agent_collusion_py["sub代理collusion<br/>反馈环的子代理collusion。Sub-Agent Collusion<br/>Detector — v0.15.0<br/>R213，子代理collusion。Sub-Agent Collusion<br/>Detector — v0.15.0 R213相关功能的实现。<br/>文件: forensic/sub_agent_collusion.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_toctou_guard_py["TOCTOU守卫<br/>反馈环的toctou守卫。TOCTOU Guard — v0.15.0<br/>R207，toctou守卫。TOCTOU Guard — v0.15.0<br/>R207相关功能的实现。<br/>文件: forensic/toctou_guard.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_worm_write_integrity_py["wormwrite完整性<br/>反馈环的wormwrite完整性。WORM Write Integrity —<br/>v0.15.0 R216，wormwrite完整性。WORM Write<br/>Integrity — v0.15.0 R216相关功能的实现。<br/>文件: forensic/worm_write_integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_deadman_switch_py["deadman开关<br/>反馈环的deadman开关。Deadman Switch — v0.15.0<br/>R212，deadman开关。Deadman Switch — v0.15.0<br/>R212相关功能的实现。<br/>文件: resilience/deadman_switch.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_multi_instance_coord_py["多instancecoord<br/>反馈环/resilience模块的multi_instance_coord组件<br/>。<br/>文件: resilience/multi_instance_coord.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_split_brain_quorum_py["拆分brainquorum<br/>反馈环的拆分brainquorum。Split-Brain Quorum —<br/>v0.37.0 R451，拆分brainquorum。Split-Brain<br/>Quorum — v0.37.0 R451相关功能的实现。<br/>文件: resilience/split_brain_quorum.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_scheduler_act_py["调度器act<br/>供调度器使用<br/>scheduler_act<br/>文件: feedback_loop/scheduler_act.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_scheduler_health_py["调度器健康<br/>主要提供报告等功能，供调度器使用<br/>scheduler_health<br/>文件: feedback_loop/scheduler_health.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_scheduler_safety_py["调度器安全<br/>主要提供运行安全门禁、fle门禁缓存、fle门禁缓存等<br/>功能，供调度器使用<br/>scheduler_safety<br/>文件: feedback_loop/scheduler_safety.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_security_agent_skill_guard_py["代理技能守卫<br/>安全的代理技能守卫。Agent Skill Guard — v0.14.0<br/>R201，代理技能守卫。Agent Skill Guard — v0.14.0<br/>R201相关功能的实现。<br/>文件: security/agent_skill_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_metric_prompt_scanner_py["指标提示扫描器<br/>安全的指标提示扫描器。Metric-Prompt Scanner —<br/>v0.15.0 R215，指标提示扫描器。Metric-Prompt<br/>Scanner — v0.15.0 R215相关功能的实现。<br/>文件: security/metric_prompt_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_security_remote_attestation_py["远程attestation<br/>安全的远程attestation。Remote Attestation —<br/>v0.15.0 R211，远程attestation。Remote<br/>Attestation — v0.15.0 R211相关功能的实现。<br/>文件: security/remote_attestation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_action_selector_py["动作选择器<br/>执行器包的action_selector模块<br/>文件: actors/action_selector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_feedback_collector_py["反馈收集器<br/>collectors包的feedback_collector模块<br/>文件: collectors/feedback_collector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_boot_integrity_attestation_py["boot完整性attestation<br/>反馈环的启动完整性attestation。Boot Integrity<br/>Attestation — v0.38.0<br/>R487，启动完整性attestation。Boot Integrity<br/>Attestation — v0.38.0 R487相关功能的实现。<br/>文件: forensic/boot_integrity_attestation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_config_hot_reload_guard_py["配置hotreload守卫<br/>反馈环的配置hotreload守卫。Config Hot-Reload<br/>Guard — v0.40.0 R498，配置hotreload守卫。Config<br/>Hot-Reload Guard — v0.40.0 R498相关功能的实现。<br/>文件: resilience/config_hot_reload_guard.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_graceful_degradation_planner_py["gracefuldegradation规划器<br/>反馈环的graceful退化planner。Graceful<br/>Degradation Planner — v0.40.0<br/>R496，graceful退化planner。Graceful Degradation<br/>Planner — v0.40.0 R496相关功能的实现。<br/>文件: resilience/graceful_degradation_planner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_oscillation_damping_py["振荡阻尼<br/>resilience包的oscillation_damping模块<br/>Oscillation Damping — v0.37.0 R450<br/>文件: resilience/oscillation_damping.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_self_api_throttle_defense_py["自API限流器防御<br/>反馈环的自APIthrottle防御。Self API Throttle<br/>Defense — v0.39.0 R491，自APIthrottle防御。Self<br/>API Throttle Defense — v0.39.0<br/>R491相关功能的实现。<br/>文件: resilience/self_api_throttle_defense.py<br/>(生产态 / production)"]
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_INFRA_RECOVERY,D_FRONTEND,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_SECURITY,D_GOV_AUDIT external_prod
```

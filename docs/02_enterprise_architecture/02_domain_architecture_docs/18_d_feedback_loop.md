...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FRONTEND,D_SECURITY external_prod
```

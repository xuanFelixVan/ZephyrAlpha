...
flowchart TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_SHARED,D_SECURITY,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_AUDIT,D_FRONTEND external_prod
```

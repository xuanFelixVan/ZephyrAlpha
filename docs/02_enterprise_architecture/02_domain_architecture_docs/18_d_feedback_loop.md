...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FRONTEND,D_AUTONOMY_CORE,D_SECURITY external_prod
```

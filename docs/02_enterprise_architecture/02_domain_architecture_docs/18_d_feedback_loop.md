...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_INTEGRATION,D_FBL_DIAGNOSERS,D_SHARED,D_GOVERNANCE,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_FRONTEND,D_SECURITY,D_GOV_AUDIT external_prod
```

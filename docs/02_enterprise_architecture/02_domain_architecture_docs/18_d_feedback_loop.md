...
flowchart TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INTEGRATION,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_AUDIT,D_ORCHESTRATOR,D_FRONTEND,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
```

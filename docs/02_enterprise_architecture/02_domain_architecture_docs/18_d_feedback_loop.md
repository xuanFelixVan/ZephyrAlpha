...
flowchart TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_INTEGRATION,D_FRONTEND,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_SECURITY external_prod
```

...
flowchart TD
    ...
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_FRONTEND,D_AUTONOMY_CORE external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_INTEGRATION,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_FRONTEND,D_SECURITY external_prod
```

...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_GOV_AUDIT,D_FRONTEND,D_AUTONOMY_CORE,D_SECURITY external_prod
```

...
flowchart TD
    ...
    src_zephyr_feedback_loop_gen_inherited_py["生成inherited<br/>反馈闭环包的生成inherited模块<br/>_gen_inherited<br/>文件: feedback_loop/_gen_inherited.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_eval_harness_py["评估harness<br/>反馈闭环包的评估harness模块<br/>eval_harness<br/>文件: feedback_loop/eval_harness.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_exceptions_py["异常<br/>反馈闭环包的异常模块<br/>exceptions<br/>文件: feedback_loop/exceptions.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_fitness_functions_py["适应度functions<br/>反馈闭环包的适应度functions模块<br/>fitness_functions<br/>文件: feedback_loop/fitness_functions.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_tests_e2e_init_py["tests/e2e 包入口<br/>tests/e2e 包入口，管理tests<br/>/e2e层子模块的统一加载和懒导入<br/>feedback-loop.tests.e2e — auto-generated<br/>package init.<br/>文件: e2e/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_validator_py["返回尚未生成的骨骼文件列表.<br/>反馈闭环包的返回尚未生成的骨骼文件列表.模块<br/>validator<br/>文件: feedback_loop/validator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_scheduler_act_py["调度器act<br/>调度器act，供调度器使用<br/>scheduler_act<br/>文件: feedback_loop/scheduler_act.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_action_selector_py["动作选择器<br/>反馈闭环/actors包的动作选择器模块<br/>action_selector<br/>文件: actors/action_selector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_feedback_collector_py["反馈收集器<br/>反馈闭环/collectors包的反馈收集器模块<br/>feedback_collector<br/>文件: collectors/feedback_collector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_oscillation_damping_py["振荡阻尼<br/>Oscillation Damping — v0.37.0 R450<br/>文件: resilience/oscillation_damping.py<br/>(生产态 / production)"]

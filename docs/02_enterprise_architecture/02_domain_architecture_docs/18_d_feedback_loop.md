...
flowchart TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_SECURITY,D_FBL_DETECTORS,D_GOV_AUDIT,D_FRONTEND,D_AUTONOMY_CORE external_prod
```

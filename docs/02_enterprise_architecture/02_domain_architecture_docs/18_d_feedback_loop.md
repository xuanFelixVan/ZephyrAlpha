...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FRONTEND,D_SECURITY external_prod
```

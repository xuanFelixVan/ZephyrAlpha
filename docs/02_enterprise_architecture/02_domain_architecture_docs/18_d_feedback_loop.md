...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_SHARED,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_FRONTEND,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_SECURITY,D_GOV_AUDIT external_prod
```

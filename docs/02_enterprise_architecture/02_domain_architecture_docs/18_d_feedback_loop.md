...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_AUDIT,D_FBL_DETECTORS,D_FRONTEND,D_AUTONOMY_CORE external_prod
```

...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_SHARED,D_GOV_OPS_RESILIENCE,D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FRONTEND external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_INTEGRATION,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FRONTEND,D_AUTONOMY_CORE,D_GOV_AUDIT,D_SECURITY external_prod
```

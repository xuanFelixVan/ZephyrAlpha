...
flowchart TD
    ...
    class D_FBL_DETECTORS,D_SHARED,D_AUTONOMY_CORE,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FRONTEND,D_GOV_AUDIT,D_GOVERNANCE,D_SECURITY external_prod
```

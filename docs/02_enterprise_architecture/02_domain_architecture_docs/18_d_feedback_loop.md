...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_SHARED,D_INTEGRATION,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_ORCHESTRATOR,D_FRONTEND,D_AUTONOMY_CORE,D_GOV_AUDIT,D_SECURITY external_prod
```

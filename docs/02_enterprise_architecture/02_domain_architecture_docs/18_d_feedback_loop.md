...
flowchart TD
    src_zephyr_feedback_loop_init_py["zephyr/feedback_loop 包入口<br/>管理zephyr.feedback_loop子包加载<br/>Feedback Loop Engine — MOD-FEEDBACK_LOOP.<br/>文件: feedback_loop/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_init_py["feedback_loop/actors 包入口<br/>管理feedback_loop.actors子包加载<br/>feedback-loop.actors — auto-generated package<br/>init.<br/>文件: actors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_init_py["feedback_loop/collectors 包入口<br/>管理feedback_loop.collectors子包加载<br/>feedback-loop.collectors — auto-generated<br/>package init.<br/>文件: collectors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_docs_init_py["feedback_loop/docs 包入口<br/>管理feedback_loop.docs子包加载<br/>feedback-loop.docs — auto-generated package<br/>init.<br/>文件: docs/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_init_py["feedback_loop/evolution 包入口<br/>管理feedback_loop.evolution子包加载<br/>feedback-loop.evolution — auto-generated<br/>package init.<br/>文件: evolution/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_init_py["feedback_loop/forensic 包入口<br/>管理feedback_loop.forensic子包加载<br/>feedback-loop.forensic — auto-generated package<br/>init.<br/>文件: forensic/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_init_py["feedback_loop/gates 包入口<br/>管理feedback_loop.gates子包加载<br/>feedback-loop.gates — auto-generated package<br/>init.<br/>文件: gates/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_init_py["feedback_loop/resilience 包入口<br/>管理feedback_loop.resilience子包加载<br/>feedback-loop.resilience — auto-generated<br/>package init.<br/>文件: resilience/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_init_py["feedback_loop/security 包入口<br/>管理feedback_loop.security子包加载<br/>feedback-loop.security — auto-generated package<br/>init.<br/>文件: security/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_tests_e2e_init_py["tests/e2e 包入口<br/>管理tests.e2e子包加载<br/>feedback-loop.tests.e2e — auto-generated<br/>package init.<br/>文件: e2e/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_init_py["feedback_loop/verifiers 包入口<br/>管理feedback_loop.verifiers子包加载<br/>feedback-loop.verifiers — auto-generated<br/>package init.<br/>文件: verifiers/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_action_selector_py["动作选择器<br/>反馈闭环包的action_selector模块<br/>文件: actors/action_selector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_feedback_collector_py["反馈收集器<br/>反馈闭环包的feedback_collector模块<br/>文件: collectors/feedback_collector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_oscillation_damping_py["振荡阻尼<br/>反馈闭环包的oscillation_damping模块<br/>Oscillation Damping — v0.37.0 R450<br/>文件: resilience/oscillation_damping.py<br/>(生产态 / production)"]
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_FBL_DETECTORS,D_FRONTEND,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_SECURITY,D_GOV_AUDIT external_prod
```

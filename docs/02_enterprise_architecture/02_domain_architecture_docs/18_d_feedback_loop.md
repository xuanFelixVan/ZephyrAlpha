...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_SECURITY,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_ORCHESTRATOR,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_DRIFT,D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_INTEGRATION,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOVERNANCE,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FBL_VERIFICATION,D_FRONTEND,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_SECURITY external_prod
```

...
flowchart TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_AUDIT,D_FRONTEND,D_FBL_DETECTORS external_prod
```

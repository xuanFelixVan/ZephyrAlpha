...
flowchart TD
    ...
    class D_GOVERNANCE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SHARED,D_SECURITY,D_INTEGRATION,D_FBL_DETECTORS,D_FRONTEND,D_GOV_AUDIT,D_AUTONOMY_CORE external_prod
```

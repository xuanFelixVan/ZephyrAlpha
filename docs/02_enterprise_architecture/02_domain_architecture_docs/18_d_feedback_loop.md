...
flowchart TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_AUDIT,D_FRONTEND,D_SECURITY,D_AUTONOMY_CORE external_prod
```

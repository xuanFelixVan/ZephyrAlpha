...
flowchart TD
    src_zephyr_feedback_loop_init_py["zephyr/feedback_loop 包入口<br/>包入口。Feedback Loop Engine — MOD-FEEDBACK_LOOP<br/>Feedback Loop Engine — MOD-FEEDBACK_LOOP.<br/>文件: feedback_loop/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gen_inherited_py["生成inherited<br/>反馈闭环包的gen_inherited模块<br/>_gen_inherited<br/>文件: feedback_loop/_gen_inherited.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_init_py["feedback_loop/actors 包入口<br/>包入口。feedback-loop.actors — auto-generated<br/>package init<br/>feedback-loop.actors — auto-generated package<br/>init.<br/>文件: actors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_init_py["feedback_loop/collectors 包入口<br/>包入口。feedback-loop.collectors —<br/>auto-generated package init<br/>feedback-loop.collectors — auto-generated<br/>package init.<br/>文件: collectors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_docs_init_py["feedback_loop/docs 包入口<br/>包入口。feedback-loop.docs — auto-generated<br/>package init<br/>feedback-loop.docs — auto-generated package<br/>init.<br/>文件: docs/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_eval_harness_py["评估harness<br/>反馈闭环包的eval_harness模块<br/>文件: feedback_loop/eval_harness.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_init_py["feedback_loop/evolution 包入口<br/>包入口。feedback-loop.evolution —<br/>auto-generated package init<br/>feedback-loop.evolution — auto-generated<br/>package init.<br/>文件: evolution/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_exceptions_py["异常<br/>反馈闭环包的exceptions模块<br/>文件: feedback_loop/exceptions.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_fitness_functions_py["适应度functions<br/>反馈闭环包的fitness_functions模块<br/>文件: feedback_loop/fitness_functions.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_init_py["feedback_loop/forensic 包入口<br/>包入口。feedback-loop.forensic — auto-generated<br/>package init<br/>feedback-loop.forensic — auto-generated package<br/>init.<br/>文件: forensic/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_init_py["feedback_loop/gates 包入口<br/>包入口。feedback-loop.gates — auto-generated<br/>package init<br/>feedback-loop.gates — auto-generated package<br/>init.<br/>文件: gates/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_metrics_collector_py["指标收集器<br/>指标收集器。MetricsCollector: append-only<br/>metrics recording<br/>MetricsCollector: append-only metrics recording.<br/>文件: feedback_loop/metrics_collector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_init_py["feedback_loop/resilience 包入口<br/>包入口。feedback-loop.resilience —<br/>auto-generated package init<br/>feedback-loop.resilience — auto-generated<br/>package init.<br/>文件: resilience/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_init_py["feedback_loop/security 包入口<br/>包入口。feedback-loop.security — auto-generated<br/>package init<br/>feedback-loop.security — auto-generated package<br/>init.<br/>文件: security/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_tests_e2e_init_py["tests/e2e 包入口<br/>包入口。feedback-loop.tests.e2e —<br/>auto-generated package init<br/>feedback-loop.tests.e2e — auto-generated<br/>package init.<br/>文件: e2e/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_validator_py["返回尚未生成的骨骼文件列表<br/>反馈闭环包的validator模块<br/>文件: feedback_loop/validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_init_py["feedback_loop/verifiers 包入口<br/>包入口。feedback-loop.verifiers —<br/>auto-generated package init<br/>feedback-loop.verifiers — auto-generated<br/>package init.<br/>文件: verifiers/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_agent_lifecycle_py["代理生命周期<br/>反馈闭环/actors包的agent_lifecycle模块<br/>Agent Lifecycle Manager — v0.12.0 R159c<br/>文件: actors/agent_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_api_version_contract_py["API版本契约<br/>反馈闭环/actors包的api_version_contract模块<br/>API Version Contract — v0.14.0 R188<br/>文件: actors/api_version_contract.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_global_action_scheduler_py["全局动作调度器<br/>反馈闭环/actors包的global_action_scheduler模块<br/>Global Action Scheduler — v0.16.0 R226<br/>文件: actors/global_action_scheduler.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_intent_driven_ops_py["intentdriven运维<br/>反馈闭环/actors包的intent_driven_ops模块<br/>Intent-Driven Ops — v0.12.0 R159<br/>文件: actors/intent_driven_ops.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_multi_agent_orchestrator_py["多代理编排器<br/>反馈闭环/actors包的multi_agent_orchestrator模块<br/>Multi-Agent Orchestrator — v0.12.0 R159b<br/>文件: actors/multi_agent_orchestrator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_actors_notification_personalizer_py["通知personalizer<br/>反馈闭环/actors包的notification_personalizer模块<br/>Notification Personalizer — v0.6.0 R67<br/>文件: actors/notification_personalizer.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_secondary_alert_channel_py["secondary告警通道<br/>反馈闭环/actors包的secondary_alert_channel模块<br/>Secondary Alert Channel — v0.37.0 R461<br/>文件: actors/secondary_alert_channel.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_config_timeline_py["配置timeline<br/>反馈闭环/collectors包的config_timeline模块<br/>Config Timeline — v0.8.0 R99<br/>文件: collectors/config_timeline.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_data_quality_validator_py["数据质量校验器<br/>反馈闭环/collectors包的data_quality_<br/>validator模块<br/>Data Quality Validator — v0.9.0 R110<br/>文件: collectors/data_quality_validator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_knowledge_capture_py["知识capture<br/>反馈闭环/collectors包的knowledge_capture模块<br/>Knowledge Capture — v0.4.0 R30<br/>文件: collectors/knowledge_capture.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_knowledge_freshness_py["知识freshness<br/>反馈闭环/collectors包的knowledge_freshness模块<br/>Knowledge Freshness — v0.5.0 R47<br/>文件: collectors/knowledge_freshness.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_knowledge_packaging_py["知识packaging<br/>反馈闭环/collectors包的knowledge_packaging模块<br/>Knowledge Packaging — v0.9.0 R123<br/>文件: collectors/knowledge_packaging.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_known_unknown_registry_py["knownunknown注册表<br/>反馈闭环/collectors包的known_unknown_<br/>registry模块<br/>Known-Unknown Registry — v0.16.0 R229<br/>文件: collectors/known_unknown_registry.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_temporal_event_store_py["temporal事件存储<br/>反馈闭环/collectors包的temporal_event_store模块<br/>Temporal Event Store — v0.3.0 R9<br/>文件: collectors/temporal_event_store.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_collectors_token_finops_py["令牌finops<br/>反馈闭环/collectors包的token_finops模块<br/>Token FinOps — v0.12.0 R162<br/>文件: collectors/token_finops.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_conformal_prediction_py["conformal预测<br/>反馈闭环/evolution包的conformal_prediction模块<br/>Conformal Prediction — v0.7.0 R74<br/>文件: evolution/conformal_prediction.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_evolution_cross_gen_validation_py["跨gen验证<br/>反馈闭环/evolution包的cross_gen_validation模块<br/>Cross-Gen Validation — v0.7.0 R78<br/>文件: evolution/cross_gen_validation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_graduated_activation_protocol_py["graduatedactivation协议<br/>反馈闭环/evolution包的graduated_activation_<br/>protocol模块<br/>Graduated Activation Protocol — v0.38.0 R485<br/>文件: evolution/graduated_activation_protocol.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_knowledge_distillation_py["知识distillation<br/>反馈闭环/evolution包的knowledge_distillation模块<br/>Knowledge Distillation — v0.6.0 R52<br/>文件: evolution/knowledge_distillation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_prompt_factory_governance_py["提示工厂治理<br/>反馈闭环/evolution包的prompt_factory_<br/>governance模块<br/>Prompt Factory Governance — v0.16.0 R224<br/>文件: evolution/prompt_factory_governance.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_self_reflection_py["自reflection<br/>反馈闭环/evolution包的self_reflection模块<br/>Self Reflection — v0.7.0 R75<br/>文件: evolution/self_reflection.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_semantic_intent_preservation_guard_py["semanticintentpreservation守卫<br/>反馈闭环/evolution包的semantic_intent_<br/>preservation_guard模块<br/>R505: SemanticIntentPreservationGuard<br/>文件: evolution/semantic_intent_preservation_<br/>guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_automated_rca_postmortem_generator_py["automatedrcapostmortem生成器<br/>反馈闭环/forensic包的automated_rca_postmortem_<br/>generator模块<br/>Automated RCA Postmortem Generator — v0.38.0<br/>R486<br/>文件: forensic/automated_rca_postmortem_<br/>generator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_fle_upgrade_safety_validator_py["fleupgrade安全校验器<br/>反馈闭环/forensic包的fle_upgrade_safety_<br/>validator模块<br/>R529: FLEUpgradeSafetyValidator<br/>文件: forensic/fle_upgrade_safety_validator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_point_in_time_reconstructor_py["点入时间reconstructor<br/>反馈闭环/forensic包的point_in_time_<br/>reconstructor模块<br/>Point-in-Time Reconstructor — v0.37.0 R465<br/>文件: forensic/point_in_time_reconstructor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_serialization_format_tracker_py["serializationformat追踪器<br/>反馈闭环/forensic包的serialization_format_<br/>tracker模块<br/>Serialization Format Tracker — v0.39.0 R488<br/>文件: forensic/serialization_format_tracker.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_forensic_state_migration_validator_py["状态迁移校验器<br/>反馈闭环/forensic包的state_migration_<br/>validator模块<br/>State Migration Validator — v0.40.0 R497<br/>文件: forensic/state_migration_validator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_worm_write_integrity_py["wormwrite完整性<br/>反馈闭环/forensic包的worm_write_integrity模块<br/>WORM Write Integrity — v0.15.0 R216<br/>文件: forensic/worm_write_integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_deadman_switch_py["deadman开关<br/>反馈闭环/resilience包的deadman_switch模块<br/>Deadman Switch — v0.15.0 R212<br/>文件: resilience/deadman_switch.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_multi_instance_coord_py["多instancecoord<br/>反馈闭环/resilience包的multi_instance_coord模块<br/>Multi-Instance Coordinator — v0.14.0 R199<br/>文件: resilience/multi_instance_coord.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_split_brain_quorum_py["拆分brainquorum<br/>反馈闭环/resilience包的split_brain_quorum模块<br/>Split-Brain Quorum — v0.37.0 R451<br/>文件: resilience/split_brain_quorum.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_scheduler_act_py["调度器act<br/>反馈闭环包的scheduler_act模块<br/>文件: feedback_loop/scheduler_act.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_scheduler_collect_detect_py["调度器collectdetect<br/>调度器collect检测，主要提供运行collect、运行检测<br/>、运行diagnose等功能<br/>scheduler_collect_detect<br/>文件: feedback_loop/scheduler_collect_detect.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_scheduler_health_py["调度器健康<br/>调度器健康，主要提供报告等功能<br/>scheduler_health<br/>文件: feedback_loop/scheduler_health.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_scheduler_safety_py["调度器安全<br/>调度器安全，主要提供运行安全门禁、fle门禁缓存、f<br/>le门禁缓存等功能<br/>scheduler_safety<br/>文件: feedback_loop/scheduler_safety.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_security_agent_skill_guard_py["代理技能守卫<br/>反馈闭环/安全包的agent_skill_guard模块<br/>Agent Skill Guard — v0.14.0 R201<br/>文件: security/agent_skill_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_metric_prompt_scanner_py["指标提示扫描器<br/>反馈闭环/安全包的metric_prompt_scanner模块<br/>Metric-Prompt Scanner — v0.15.0 R215<br/>文件: security/metric_prompt_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_security_remote_attestation_py["远程attestation<br/>反馈闭环/安全包的remote_attestation模块<br/>Remote Attestation — v0.15.0 R211<br/>文件: security/remote_attestation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_security_secret_rotation_py["密钥rotation<br/>反馈闭环/安全包的secret_rotation模块<br/>Secret Rotation — v0.14.0 R189<br/>文件: security/secret_rotation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_template_py["模板<br/>反馈闭环包的template模块<br/>文件: feedback_loop/template.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_tests_e2e_integration_test_pipeline_py["集成测试管线<br/>反馈闭环/e2e包的integration_test_pipeline模块<br/>E2E Integration Test Pipeline —<br/>TASK-MOD-FEEDBACK_LOOP-0028 (Phase43-87)<br/>文件: e2e/integration_test_pipeline.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_action_selector_py["动作选择器<br/>反馈闭环/actors包的action_selector模块<br/>文件: actors/action_selector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_feedback_collector_py["反馈收集器<br/>反馈闭环/collectors包的feedback_collector模块<br/>文件: collectors/feedback_collector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_guard_complexity_budget_py["守卫complexity预算<br/>反馈闭环/forensic包的guard_complexity_budget模块<br/>R523: GuardComplexityBudget<br/>文件: forensic/guard_complexity_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_resilience_config_hot_reload_guard_py["配置hotreload守卫<br/>反馈闭环/resilience包的config_hot_reload_<br/>guard模块<br/>Config Hot-Reload Guard — v0.40.0 R498<br/>文件: resilience/config_hot_reload_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_oscillation_damping_py["振荡阻尼<br/>反馈闭环/resilience包的oscillation_damping模块<br/>Oscillation Damping — v0.37.0 R450<br/>文件: resilience/oscillation_damping.py<br/>(生产态 / production)"]
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RECOVERY,D_FRONTEND,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_SECURITY,D_ORCHESTRATOR,D_GOV_AUDIT external_prod
```

...
flowchart TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_ORCHESTRATOR,D_SHARED,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FRONTEND,D_GOV_AUDIT,D_SECURITY,D_AUTONOMY_CORE external_prod
```

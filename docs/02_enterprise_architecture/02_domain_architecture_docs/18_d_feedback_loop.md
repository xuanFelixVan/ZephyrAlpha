...
flowchart TD
    src_zephyr_feedback_loop_init_py["zephyr/feedback_loop 包入口<br/>包入口。Feedback Loop Engine —<br/>MOD-FEEDBACK_LOOP.<br/>文件: feedback_loop/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_actors_init_py["feedback_loop/actors 包入口<br/>包入口。feedback-loop.actors — auto-generated<br/>package init.<br/>文件: actors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_collectors_init_py["feedback_loop/collectors 包入口<br/>包入口。feedback-loop.collectors —<br/>auto-generated package init.<br/>文件: collectors/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_docs_init_py["feedback_loop/docs 包入口<br/>包入口。feedback-loop.docs — auto-generated<br/>package init.<br/>文件: docs/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_init_py["feedback_loop/evolution 包入口<br/>包入口。feedback-loop.evolution —<br/>auto-generated package init.<br/>文件: evolution/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_init_py["feedback_loop/forensic 包入口<br/>包入口。feedback-loop.forensic — auto-generated<br/>package init.<br/>文件: forensic/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_init_py["feedback_loop/gates 包入口<br/>包入口。feedback-loop.gates — auto-generated<br/>package init.<br/>文件: gates/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_resilience_init_py["feedback_loop/resilience 包入口<br/>包入口。feedback-loop.resilience —<br/>auto-generated package init.<br/>文件: resilience/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_security_init_py["feedback_loop/security 包入口<br/>包入口。feedback-loop.security — auto-generated<br/>package init.<br/>文件: security/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_validator_py["返回尚未生成的骨骼文件列表.<br/>feedback loop包的validator模块<br/>文件: feedback_loop/validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_init_py["feedback_loop/verifiers 包入口<br/>包入口。feedback-loop.verifiers —<br/>auto-generated package init.<br/>文件: verifiers/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_prompt_optimization_regression_detector_py["提示优化回归检测器<br/>提示optimization回归检测器。R514:<br/>PromptOptimizationRegressionDetector<br/>文件: evolution<br/>/prompt_optimization_regression_detector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_semantic_intent_preservation_guard_py["semanticintentpreservation守卫<br/>R505: SemanticIntentPreservationGuard<br/>文件: evolution<br/>/semantic_intent_preservation_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_automated_rca_postmortem_generator_py["automatedrcapostmortem生成器<br/>Automated RCA Postmortem Generator — v0.38.0<br/>R486<br/>文件: forensic<br/>/automated_rca_postmortem_generator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_guard_configuration_drift_monitor_py["守卫配置漂移监控<br/>守卫configuration漂移监控。R521:<br/>GuardConfigurationDriftMonitor<br/>文件: forensic<br/>/guard_configuration_drift_monitor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_forensic_knowledge_injection_pre_flight_verifier_py["知识注入preflight验证器<br/>知识injection预flight验证器。R515:<br/>KnowledgeInjectionPreFlightVerifier<br/>文件: forensic<br/>/knowledge_injection_pre_flight_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_evolution_self_modification_rate_limiter_py["selfmodification速率限制器<br/>自modification率限制器。R522:<br/>SelfModificationRateLimiter<br/>文件: evolution<br/>/self_modification_rate_limiter.py<br/>(生产态 / production)"]
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_INFRA_RECOVERY,D_FRONTEND,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_SECURITY,D_ORCHESTRATOR,D_GOV_AUDIT external_prod
```

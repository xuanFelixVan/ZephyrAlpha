...
flowchart TD
    ...
    src_zephyr_compliance_behavioral_auditor_init_py["compliance/behavioral_auditor 包入口<br/>管理compliance.behavioral_<br/>auditor子包的加载和懒导入<br/>文件: behavioral_auditor/__init__.py<br/>(生产态 / production)"]

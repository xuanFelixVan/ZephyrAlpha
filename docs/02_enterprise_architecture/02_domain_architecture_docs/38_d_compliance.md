...
flowchart TD
    src_zephyr_compliance_async_intercept_queue_py["(设计态 / design) compliance/async_intercept_queue.py<br/>文件: compliance/async_intercept_queue.py"]
    src_zephyr_compliance_behavioral_auditor_init_py["(生产态 / production) behavioral_auditor/__init__.py<br/>文件: behavioral_auditor/__init__.py"]

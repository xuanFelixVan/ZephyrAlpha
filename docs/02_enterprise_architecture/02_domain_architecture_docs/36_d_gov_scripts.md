...
graph TD
    ...
    class D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED external_prod
    class D_INTEGRATION external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
    class D_INTEGRATION external_design
```

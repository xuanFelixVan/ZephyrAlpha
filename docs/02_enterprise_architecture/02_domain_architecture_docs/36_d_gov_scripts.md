...
graph TD
    ...
    scripts_governance_archive_one_off_check_rule_coverage_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_list_phase0_tasks_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_group_orphan_modules_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_migrate_domain_id_hyphen_to_underscore_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_migrate_clean_build_status_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_phase_a_backup_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_rename_whitelist_cleanup_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_rename_kebab_to_snake_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_verify_final_delivery_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_test_lock_scenarios_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py
    scripts_governance_archive_one_off_verify_rule_yaml_migration_py -.->|config_depends| scripts_governance_archive_one_off_audit_session_07_py

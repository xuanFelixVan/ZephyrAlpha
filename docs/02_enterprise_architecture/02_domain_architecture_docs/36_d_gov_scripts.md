...
graph TD
    ...
    scripts_governance_archive_prototype_adversarial_log_py -.->|config_depends| scripts_governance_archive_prototype_audit_domain_nodes_py
    scripts_governance_archive_prototype_check_audit_rbac_isolation_py -.->|config_depends| scripts_governance_archive_prototype_audit_domain_nodes_py
    scripts_governance_archive_prototype_changelog_py -.->|config_depends| scripts_governance_archive_prototype_audit_domain_nodes_py
    scripts_governance_archive_prototype_generate_asset_index_py -.->|config_depends| scripts_governance_archive_prototype_audit_domain_nodes_py
    scripts_governance_archive_prototype_generate_nav_table_py -.->|config_depends| scripts_governance_archive_prototype_audit_domain_nodes_py
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_SHARED,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    scripts_governance_tasks_init_py -.->|config_depends| scripts_governance_tasks_task_show_py
...
graph TD
    ...
    scripts_governance_repair_audit_design_completeness_py -.->|config_depends| scripts_governance_repair_apply_verification_results_py
    D_GOVERNANCE["D_GOVERNANCE production"]

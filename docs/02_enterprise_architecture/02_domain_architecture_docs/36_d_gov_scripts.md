...
graph TD
    ...
    scripts_governance_d2_links_init_py -.->|config_depends| scripts_governance_d2_links_detect_relative_references_py
...
│   __init__.py → detect_relative_reference...                     │

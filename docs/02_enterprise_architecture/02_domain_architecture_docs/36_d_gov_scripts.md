...
graph TD
    ...
    scripts_governance_repair_audit_design_completeness_py -.->|config_depends| scripts_governance_repair_concurrent_write_test_py
    scripts_governance_repair_apply_verification_results_py -.->|config_depends| scripts_governance_repair_concurrent_write_test_py
    D_GOVERNANCE["D_GOVERNANCE production"]

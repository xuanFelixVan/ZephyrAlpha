...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_GOV_REPAIR,D_INTELLIGENCE external_prod
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_SECURITY,D_KNOWLEDGE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod

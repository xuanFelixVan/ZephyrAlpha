...
graph TD
    ...
    class D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOV_REPAIR external_prod
    class D_KNOWLEDGE external_design
```

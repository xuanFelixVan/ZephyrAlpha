...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_AUTONOMY_CORE external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 13 个，3 条域内依赖）。

...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_SHARED,D_GOV_RULE,D_GOV_REPAIR,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_GOV_REPAIR,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE external_prod
    class D_KNOWLEDGE,D_SECURITY external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | __init__.py | → | D_AUTONOMY_CORE 自治核心: fragmentation_index.py — 知识碎片化指数 (DD108... | config_depends / config_depends |

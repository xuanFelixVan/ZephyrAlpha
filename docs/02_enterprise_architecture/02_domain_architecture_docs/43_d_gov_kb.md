...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_GOV_RULE,D_GOV_REPAIR external_prod
    class D_GOV_OPS_RESILIENCE,D_SECURITY,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_AUTONOMY_CORE external_prod
    class D_SECURITY,D_KNOWLEDGE external_design
```

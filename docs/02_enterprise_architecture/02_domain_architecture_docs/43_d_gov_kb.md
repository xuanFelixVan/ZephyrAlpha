...
graph TD
    ...
    src_zephyr_gov_kb_init_py -.->|config_depends / config_depends| src_zephyr_gov_kb_backend_protocol_py
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_INTELLIGENCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
```

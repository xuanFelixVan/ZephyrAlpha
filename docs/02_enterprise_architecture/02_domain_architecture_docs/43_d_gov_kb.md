...
graph TD
    ...
    src_zephyr_gov_kb_init_py -.->|config_depends / config_depends| src_zephyr_gov_kb_freeze_py
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_INTEGRATION,D_INTELLIGENCE,D_GOV_REPAIR external_prod

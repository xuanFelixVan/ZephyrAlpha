...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_INTEGRATION,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
    class D_KNOWLEDGE,D_SECURITY,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_design
```
...
| 32 | Re-export shim — 真源在 zephyr.intelligence.mo... | → | D_SHARED 共享服务: CBAC 能力检查器 (Capability-Based Access Contro... | 导入依赖 / import_depends |
...
| 6 | D_GOVERNANCE 生命周期管理: kb.storage — auto-generated package init. (__i... | → | Re-export shim — 真源在 zephyr.intelligence.mo... | config_depends / config_depends |

...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_INTELLIGENCE external_prod
    class D_KNOWLEDGE,D_SECURITY external_design
```

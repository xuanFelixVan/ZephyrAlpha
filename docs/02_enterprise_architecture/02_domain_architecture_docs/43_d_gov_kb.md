...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_INTEGRATION,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_AUTONOMY_CORE external_prod
    class D_KNOWLEDGE,D_SECURITY external_design
```

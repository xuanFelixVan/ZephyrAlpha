...
# 44_d_gov_repair / 治理修复 / Governance Repair
...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/governance/financial_governance/budget_enforce... | budget_enforcement.py | 生产态 / production | [MOD-INF-024](../../03_modules/_domain_autonomy_perm/budget_enforcer/blueprint.md) |
...
graph TD
    ...
    class D_OPS,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
...
> 本域与 5 个外部域直接连接（出边 8 条 + 入边 1 条 = 9 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_GOVERNANCE,D_FACTOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_OPS external_prod
...
| 43 | __init__.py | → | D_GOVERNANCE 生命周期管理: paper_live_transition.py | config_depends / config_depends |

...
| 跨域出边 | 170 | Cross-domain Outgoing | 170 |
...
graph TD
    ...
    src_zephyr_governance_init_py -->|导入依赖 / import_depends| D_GOV_RULE
    src_zephyr_governance_init_py -->|导入依赖 / import_depends| D_GOV_AUDIT
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_FACTOR,D_GOVERNANCE,D_GOV_RULE,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_DATA,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    src_zephyr_governance_init_py -->|导入依赖 / import_depends| D_GOV_KB
    src_zephyr_governance_init_py -->|导入依赖 / import_depends| D_GOVERNANCE
    src_zephyr_governance_init_py -->|导入依赖 / import_depends| D_GOV_OPS_RESILIENCE
    src_zephyr_governance_init_py -->|导入依赖 / import_depends| D_GOV_OPS_RESILIENCE
    ...
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_governance_init_py,src_zephyr_governance_financial_governance_budget_enforcement_py,src_zephyr_governance_observability_governance_init_py,src_zephyr_governance_persistence_init_py production
    class D_FACTOR,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_KB external_prod
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    src_zephyr_governance_trading_contracts_init_py -.->|导入依赖 / import_depends| D_TRADING
    src_zephyr_governance_trading_contracts_portfolio_contracts_init_py -.->|导入依赖 / import_depends| D_GOVERNANCE
    src_zephyr_governance_trading_contracts_portfolio_contracts_init_py -.->|导入依赖 / import_depends| D_GOVERNANCE
    src_zephyr_governance_trading_contracts_portfolio_contracts_init_py -.->|导入依赖 / import_depends| D_GOVERNANCE
    ...
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_governance_adapters_init_py,src_zephyr_governance_agent_spec_init_py,src_zephyr_governance_architecture_governance_init_py,src_zephyr_governance_bridges_init_py,src_zephyr_governance_context_governance_init_py,src_zephyr_governance_data_governance_init_py,src_zephyr_governance_engine_init_py,src_zephyr_governance_financial_governance_init_py,src_zephyr_governance_intelligence_governance_init_py,src_zephyr_governance_lifecycle_governance_init_py,src_zephyr_governance_services_init_py,src_zephyr_governance_strategies_init_py,src_zephyr_governance_trading_contracts_init_py,src_zephyr_governance_trading_contracts_execution_init_py,src_zephyr_governance_trading_contracts_market_init_py,src_zephyr_governance_trading_contracts_portfolio_contracts_init_py,src_zephyr_governance_trading_contracts_risk_init_py design
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_GOVERNANCE,D_TRADING external_prod
```
...
| 36 | __init__.py | → | D_GOVERNANCE 生命周期管理: G-CT-006 — BudgetAlert re-exported from shared... | config_depends / config_depends |
...
| 40 | __init__.py | → | D_GOVERNANCE 生命周期管理: agent_debate.py | config_depends / config_depends |
| 41 | __init__.py | → | D_GOVERNANCE 生命周期管理: api_lifecycle.py | config_depends / config_depends |
| 42 | __init__.py | → | D_GOVERNANCE 生命周期管理: dataflowgraph Schema DDL + 连接入口 (dataflowgr... | 导入依赖 / import_depends |
| 43 | __init__.py | → | D_GOVERNANCE 生命周期管理: Cross-Session Correlator — v0.9.0 跨会话Corese... | config_depends / config_depends |
| 44 | Re-export wrapper: true source is zephyr.pf_cor... | → | D_GOVERNANCE 生命周期管理: D_PORTFOLIO_CORE — StrategyBase + StrategyMeta... | config_depends / config_depends |
| 45 | __init__.py | → | D_GOVERNANCE 生命周期管理: Re-export shim — 真源已合并至 zephyr.trading.t... | 导入依赖 / import_depends |
| 46 | __init__.py | → | D_GOVERNANCE 生命周期管理: Re-export shim — 真源已合并至 zephyr.trading.t... | 导入依赖 / import_depends |
...
| 68 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: audit-trail.agent_signer — MOD-INF-020 · Agen... | 导入依赖 / import_depends |
| 69 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: changelog_manager.py | 导入依赖 / import_depends |
| 70 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: code_archaeology.py | 导入依赖 / import_depends |
| 71 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: audit-trail.compliance_map — MOD-INF-020 · 合... | 导入依赖 / import_depends |
| 72 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: corporate_actions.py | 导入依赖 / import_depends |
| 73 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: dora_metrics.py | 导入依赖 / import_depends |
| 74 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: audit-trail.feedback_self_audit — MOD-INF-020 ... | 导入依赖 / import_depends |
| 75 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: glossary_matrix.py | 导入依赖 / import_depends |
| 76 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: audit-trail.kb_gate — MOD-INF-020 · KB 审计门... | 导入依赖 / import_depends |
| 77 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: audit-trail.privacy — MOD-INF-020 · PII 检测... | 导入依赖 / import_depends |
| 78 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: LicenseType 枚举——许可证类型定义（P3 价值审判... | 导入依赖 / import_depends |
| 79 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: spec_auditor.py | 导入依赖 / import_depends |
| 80 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: audit-trail.supply_chain — MOD-INF-020 · 供应... | 导入依赖 / import_depends |
| 81 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: wqa_scorer.py | 导入依赖 / import_depends |
| 82 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: ai_code_standards.py | 导入依赖 / import_depends |
| 83 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: mcp_result_push.py | 导入依赖 / import_depends |
| 84 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: post_process.py —— AI 生成代码后处理管道（Pha... | 导入依赖 / import_depends |
| 85 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: vibe_coding_enforcer.py | 导入依赖 / import_depends |
| 86 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: SnapshotManager — Event Sourcing 快照管理（DW-... | 导入依赖 / import_depends |
| 87 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: financial_compliance.py | 导入依赖 / import_depends |
| 88 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: fix_prioritizer — MOD-INF-028 §3.1 Stage 8 (f... | 导入依赖 / import_depends |
| 89 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: Stage 7 自愈闭环 — 修复->自测->回滚. (self_hea... | 导入依赖 / import_depends |
| 90 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_AUDIT 审计追踪: 7 SLI + 5 容量 SLI + 退化检测。定时自检,输出 HE... | 导入依赖 / import_depends |
| 91 | __init__.py | → | D_GOV_AUDIT 审计追踪: financial_compliance.py | config_depends / config_depends |
| 92 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | 导入依赖 / import_depends |
| 93 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_CODE_QUALITY 代码质量治理: code-dedup-engine CLI——子命令映射+退出码+扫描... | 导入依赖 / import_depends |
| 94 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_CODE_QUALITY 代码质量治理: 6Phase施工执行器 — Phase 0~5 执行状态追踪. (ph... | 导入依赖 / import_depends |
| 95 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_CODE_QUALITY 代码质量治理: 盲点关闭追踪器 — 自动验证各轮盲点是否已覆盖. (... | 导入依赖 / import_depends |
| 96 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_DRIFT 漂移检测: benchmark_integrity.py | 导入依赖 / import_depends |
| 97 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_DRIFT 漂移检测: model_drift_monitor.py | 导入依赖 / import_depends |
| 98 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_DRIFT 漂移检测: performance_baseline.py | 导入依赖 / import_depends |
| 99 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_DRIFT 漂移检测: regime_detector.py | 导入依赖 / import_depends |
| 100 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_DRIFT 漂移检测: Drift Detector — 兼容别名，SSoT已迁移至 zephyr... | 导入依赖 / import_depends |
| 101 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_ENFORCEMENT 规则执行: admission_response.py | 导入依赖 / import_depends |
| 102 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_ENFORCEMENT 规则执行: code_review_ai.py | 导入依赖 / import_depends |
| 103 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | 导入依赖 / import_depends |
| 104 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_ENFORCEMENT 规则执行: DLQ 重试策略 — 指数退避自动重试 (dlq_retry_pol... | 导入依赖 / import_depends |
| 105 | zephyr.trading.trading_contracts — trading-dom... | → | D_GOV_ENFORCEMENT 规则执行: Re-export shim — ComplianceRule 真源已合并至 z... | 导入依赖 / import_depends |
| 106 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_KB 知识库治理: knowledge_engine.py | 导入依赖 / import_depends |
| 107 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: consequence_manager.py | 导入依赖 / import_depends |
| 108 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: Escalation Engine — MOD-INF-022 (escalation_en... | 导入依赖 / import_depends |
| 109 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: incident_response.py | 导入依赖 / import_depends |
| 110 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: spof_checker.py | 导入依赖 / import_depends |
| 111 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: agent_dispatch.py | 导入依赖 / import_depends |
| 112 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: bandwidth_optimizer.py | 导入依赖 / import_depends |
| 113 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: environment_manager.py | 导入依赖 / import_depends |
| 114 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: ops_foundation.py | 导入依赖 / import_depends |
| 115 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: PhaseManager->GateEngine 检查注册表桥梁 — 44 .... | 导入依赖 / import_depends |
| 116 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: Phase Manager — ZephyrAlpha 施工阶段门控引擎. ... | 导入依赖 / import_depends |
| 117 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: startup_shutdown_cli.py | 导入依赖 / import_depends |
| 118 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: broker_resilience.py | 导入依赖 / import_depends |
| 119 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: bus_factor_defense.py | 导入依赖 / import_depends |
| 120 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: decision_fatigue.py | 导入依赖 / import_depends |
| 121 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: decision_fatigue_cli.py | 导入依赖 / import_depends |
| 122 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: fault_tolerance.py | 导入依赖 / import_depends |
| 123 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: offline_autonomy.py | 导入依赖 / import_depends |
| 124 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: offline_resilience.py | 导入依赖 / import_depends |
| 125 | budget_enforcement.py | → | D_GOV_OPS_RESILIENCE 运维弹性治理: Burn Rate Monitor — MOD-INF-024 (burn_rate_mon... | 导入依赖 / import_depends |
| 126 | budget_enforcement.py | → | D_GOV_OPS_RESILIENCE 运维弹性治理: degradation_manager.py | 导入依赖 / import_depends |
| 127 | budget_enforcement.py | → | D_GOV_OPS_RESILIENCE 运维弹性治理: timeout_guard.py | 导入依赖 / import_depends |
| 128 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOV_RULE 规则治理: constitutional_update.py —— 宪法自愈（Phase 1... | 导入依赖 / import_depends |
| 129 | zephyr.trading.trading_contracts — trading-dom... | → | D_INFRASTRUCTURE: capital_allocation_result.py | 导入依赖 / import_depends |
| 130 | zephyr.trading.trading_contracts — trading-dom... | → | D_INFRASTRUCTURE: execution_report.py | 导入依赖 / import_depends |
| 131 | zephyr.trading.trading_contracts — trading-dom... | → | D_INFRASTRUCTURE: fill.py | 导入依赖 / import_depends |
| 132 | zephyr.trading.trading_contracts — trading-dom... | → | D_INFRASTRUCTURE: model_serving_request.py | 导入依赖 / import_depends |
| 133 | zephyr.trading.trading_contracts — trading-dom... | → | D_INFRASTRUCTURE: order.py | 导入依赖 / import_depends |
| 134 | zephyr.trading.trading_contracts — trading-dom... | → | D_INFRASTRUCTURE: performance_attribution_report.py | 导入依赖 / import_depends |
| 135 | zephyr.trading.trading_contracts — trading-dom... | → | D_INFRASTRUCTURE: position.py | 导入依赖 / import_depends |
| 136 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_A2A A2A通信: 基础设施 Infrastructure — A2A Protocol 模块 (M... | 导入依赖 / import_depends |
| 137 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RECOVERY 回滚恢复: MOD-INF-021 Rollback System — ZephyrAlpha 回滚... | 导入依赖 / import_depends |
| 138 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RECOVERY 回滚恢复: ComplexityBudget — 回滚复杂度元 Budget 监控。 ... | 导入依赖 / import_depends |
| 139 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: AssetClassifier — MOD-INF-026 L2 资产自动分类... | 导入依赖 / import_depends |
| 140 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: AssetDashboard — MOD-INF-026 资产健康仪表盘生... | 导入依赖 / import_depends |
| 141 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: MOD-INF-026 §18 — 资产依赖图。 (dependency.py) | 导入依赖 / import_depends |
| 142 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: UnifiedAssetIndex — MOD-INF-026 L3 统一资产索.... | 导入依赖 / import_depends |
| 143 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: AssetLifecycle — MOD-INF-026 L5 ITIL生命周期自... | 导入依赖 / import_depends |
| 144 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: MOD-INF-026 §24-25 — Git 历史元数据提取 + 多 ... | 导入依赖 / import_depends |
| 145 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: AssetInventoryModels — MOD-INF-026 Pydantic V2... | 导入依赖 / import_depends |
| 146 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: ReconciliationEngine — MOD-INF-026 L4 注册表 v... | 导入依赖 / import_depends |
| 147 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: MOD-INF-026 §17 — 24 个异构注册表统一解析适配... | 导入依赖 / import_depends |
| 148 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: MOD-INF-026 §26 — 三重信任锚验证门 R20。 (tru... | 导入依赖 / import_depends |
| 149 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_INFRA_RUNTIME 运行时集成: startup_shutdown.py | 导入依赖 / import_depends |
| 150 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_OPS 反馈循环: token_budget.py | 导入依赖 / import_depends |
| 151 | budget_enforcement.py | → | D_OPS 反馈循环: Budget Enforcer core engine — MOD-INF-024 (bud... | 导入依赖 / import_depends |
| 152 | budget_enforcement.py | → | D_OPS 反馈循环: Budget Enforcer data models — MOD-INF-024 (bud... | 导入依赖 / import_depends |
| 153 | budget_enforcement.py | → | D_OPS 反馈循环: budget_tracker.py | 导入依赖 / import_depends |
| 154 | zephyr.trading.trading_contracts — trading-dom... | → | D_SHARED 共享服务: OrderSide/OrderStatus/OrderType — 交易枚举真源... | 导入依赖 / import_depends |
| 155 | zephyr.trading.trading_contracts — trading-dom... | → | D_SHARED 共享服务: execution_rejection_error.py | 导入依赖 / import_depends |
| 156 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: zephyr.trading.trading_contracts — trading-dom... | 导入依赖 / import_depends |
| 157 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: factor_monitor_report.py | 导入依赖 / import_depends |
| 158 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: factor_signal.py | 导入依赖 / import_depends |
| 159 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: instrument.py | 导入依赖 / import_depends |
| 160 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: macro_factor_signal.py | 导入依赖 / import_depends |
| 161 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: market_data.py | 导入依赖 / import_depends |
| 162 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: signal_degradation_warning.py | 导入依赖 / import_depends |
| 163 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: synthesized_signal.py | 导入依赖 / import_depends |
| 164 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: money.py | 导入依赖 / import_depends |
| 165 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: strategy_lifecycle_event.py | 导入依赖 / import_depends |
| 166 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: risk_dashboard_snapshot.py | 导入依赖 / import_depends |
| 167 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: risk_limit_violation_error.py | 导入依赖 / import_depends |
| 168 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: risk_limits.py | 导入依赖 / import_depends |
| 169 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: risk_metrics.py | 导入依赖 / import_depends |
| 170 | zephyr.trading.trading_contracts — trading-dom... | → | D_TRADING 交易运营: risk_validator_protocol.py | 导入依赖 / import_depends |
...
| 4 | D_GOVERNANCE 生命周期管理: VMS Cron 监控器 — MOD-INF-011 · TASK-INF-0224... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 5 | D_GOVERNANCE 生命周期管理: VMS Health Check 脚本 — MOD-INF-011 · Phase 3... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 6 | D_GOVERNANCE 生命周期管理: VMS Phase 2 数据迁移脚本 — MOD-INF-011 (vms_mi... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 7 | D_GOVERNANCE 生命周期管理: VMS 迁移 dry-run 脚本 — MOD-INF-011 Phase 2 前... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 8 | D_GOVERNANCE 生命周期管理: verify_schema_health.py — depgraph (PostgreSQL... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 9 | D_GOVERNANCE 生命周期管理: [INVARIANTS] 预算健康检查不可跳过;检查结果必须.... | → | budget_enforcement.py | 导入依赖 / import_depends |
| 10 | D_GOVERNANCE 生命周期管理: VMS Cron 监控器 — MOD-INF-011 · TASK-INF-0224... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 11 | D_GOVERNANCE 生命周期管理: VMS Health Check 脚本 — MOD-INF-011 · Phase 3... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 12 | D_GOVERNANCE 生命周期管理: VMS Phase 2 数据迁移脚本 — MOD-INF-011 (vms_mi... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 13 | D_GOVERNANCE 生命周期管理: VMS 迁移 dry-run 脚本 — MOD-INF-011 Phase 2 前... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 14 | D_GOVERNANCE 生命周期管理: scaffold.py — ZephyrAlpha 唯一创建入口（RULE-T... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 导入依赖 / import_depends |
| 15 | D_GOVERNANCE 生命周期管理: test_ssot_redefinition_gate.py — SSoT 符号重复... | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 测试依赖 / test_depends |
| 16 | D_GOVERNANCE 生命周期管理: test_governance_result_types.py | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 测试依赖 / test_depends |
| 17 | D_INFRA_RUNTIME 运行时集成: test_temporal_drift_tracker.py | → | Agent 治理八件套 · Governance Domain — DOM-GO... | 测试依赖 / test_depends |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 18 个外部域直接连接（出边 170 条 + 入边 17 条 = 187 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_DATA["D_DATA"]
    D_GOV_REPAIR -->|65条 config_depends / config_depends, 导入依赖 / import_depends| D_GOVERNANCE
    ...
    D_GOVERNANCE -->|14条 导入依赖 / import_depends, 测试依赖 / test_depends| D_GOV_REPAIR

...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_KB external_prod
...
| 36 | __init__.py | → | D_GOVERNANCE 生命周期管理: context_recycling.py | config_depends / config_depends |

...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_KB external_prod
...
graph TD
    ...
    src_zephyr_governance_lifecycle_governance_init_py -.->|config_depends / config_depends| D_GOVERNANCE
    src_zephyr_governance_intelligence_governance_init_py -.->|config_depends / config_depends| D_GOVERNANCE
    src_zephyr_governance_trading_contracts_init_py -.->|导入依赖 / import_depends| D_GOVERNANCE
...
| 2 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: architecture_contracts.py | 导入依赖 / import_depends |
| 3 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: architecture_principles.py | 导入依赖 / import_depends |
| 4 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | 导入依赖 / import_depends |
| 5 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: cross_env_consistency.py | 导入依赖 / import_depends |
| 6 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: dependency_manager.py | 导入依赖 / import_depends |
| 7 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: LLMImpactAnalyzer — LLM-based commit 语义影响.... | 导入依赖 / import_depends |
| 8 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: local_first_arch.py | 导入依赖 / import_depends |
| 9 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: PathResolver — 模块路径解析器 (path_resolver.py) | 导入依赖 / import_depends |
| 10 | Agent 治理八件套 · Governance Domain — DOM-GO... | → | D_GOVERNANCE 生命周期管理: ZephyrAlpha — governance.base re-export shim. ... | 导入依赖 / import_depends |
...
| 46 | zephyr.trading.trading_contracts — trading-dom... | → | D_GOVERNANCE 生命周期管理: performance_attribution_report.py | 导入依赖 / import_depends |
...
> 本域与 17 个外部域直接连接（出边 170 条 + 入边 17 条 = 187 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_KB external_prod
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_DATA,D_INFRA_RUNTIME external_design
```

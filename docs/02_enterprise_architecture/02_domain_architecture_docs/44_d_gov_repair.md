...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_DRIFT external_prod
...
| 41 | __init__.py | → | D_GOVERNANCE 生命周期管理: Autonomy Dashboard — AI 自主感知健康仪表。 (au... | config_depends / config_depends |

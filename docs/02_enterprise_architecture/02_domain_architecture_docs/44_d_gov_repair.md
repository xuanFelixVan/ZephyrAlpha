...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
...
| 36 | __init__.py | → | D_GOVERNANCE 生命周期管理: context_manager.py | config_depends / config_depends |

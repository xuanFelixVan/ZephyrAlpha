...
graph TD
    ...
    D_FUNDAMENTAL_SIGNAL -.->|contract / contract| src_zephyr_factor_base_py
...
|:--:|---------|:--:|---------|---------|
| 1 | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL Signal Domain (__init__.py) | → | ZephyrAlpha — factor.base re-export shim. (bas... | contract / contract |

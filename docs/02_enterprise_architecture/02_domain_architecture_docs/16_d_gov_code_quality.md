...
> 展示全部 127 个模块（生产态 110 + 设计态 0 + 原型态 17），标签标注成熟度。
...
graph TD
    ...
    src_zephyr_gov_enforcement_commit_gates_depgraph_freshness_gate_py -.->|config_depends / config_depends| src_zephyr_gov_enforcement_commit_gates_init_py

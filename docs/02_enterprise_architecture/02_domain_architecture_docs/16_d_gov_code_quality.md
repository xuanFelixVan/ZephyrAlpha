...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_INTELLIGENCE,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_DATA,D_GOV_SCRIPTS external_design
```

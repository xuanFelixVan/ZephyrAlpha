...
graph TD
    ...
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_RISK external_design
```
...
graph TD
    ...
    src_zephyr_gov_enforcement_commit_gates_init_py -.->|config_depends / config_depends| src_zephyr_gov_enforcement_commit_gates_blueprint_format_gate_py

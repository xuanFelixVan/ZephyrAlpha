...
graph TD
    ...
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_INFRASTRUCTURE,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_GOVERNANCE,D_SHARED external_prod
```

...
graph TD
    ...
    docs_03_modules_domain_knowledge_vector_memory_blueprint_md -.->|runtime / runtime| D_TRADING
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_TRADING 交易运营: 全局容量预算控制器（Capacity Budget Controller... | runtime / runtime |

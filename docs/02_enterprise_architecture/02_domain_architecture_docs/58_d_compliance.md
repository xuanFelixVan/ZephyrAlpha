...
# 58_d_compliance / compliance_gate / 合规 / Compliance
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_DOCS,D_AUTONOMY_CORE external_design
```
...
| 14 | Re-export wrapper: merkle_hourly has migrated t... | → | D_GOV_AUDIT 审计追踪: merkle_hourly.py | 导入依赖 / import_depends |
| 15 | Audit Trail — MOD-INF-020 (__init__.py) | → | D_GOV_DOCS 架构文档治理: blueprint.md | runtime / runtime |
...
graph LR
    ...
    D_COMPLIANCE -->|2条 contract / contract, runtime / runtime| D_GOV_DOCS

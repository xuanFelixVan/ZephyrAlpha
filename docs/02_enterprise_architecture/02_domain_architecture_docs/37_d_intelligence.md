...
graph TD
    ...
    class D_TRADING,D_BACKTEST,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_SHARED,D_ML_TRAIN,D_AUDITTEST external_design
```

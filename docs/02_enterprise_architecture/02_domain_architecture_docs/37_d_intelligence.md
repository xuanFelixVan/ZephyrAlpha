...
graph TD
    ...
    src_zephyr_intelligence_model_profiling_deepseek_v4_chat_py -->|import_depends| D_SHARED
    ...
    class D_SHARED,D_BACKTEST,D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_TRADING,D_AUTONOMY_CORE external_prod

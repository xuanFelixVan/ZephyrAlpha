...
graph TD
    ...
    src_zephyr_intelligence_model_evaluation_init_py -.->|config_depends| src_zephyr_intelligence_model_evaluation_unified_memory_api_py
...
│   __init__.py → unified_memory_api.py                            │
└──────────────────────────────────────────────────────────────────┘

...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_intelligence_model_profiling_deepseek_v4_chat_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_intelligence_model_profiling_model_discovery_py
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION,D_BACKTEST,D_SHARED,D_GOV_ENFORCEMENT,D_TRADING external_prod

...
flowchart TD
    ...
    src_zephyr_orchestrator_governance_path_index_py ~~~ src_zephyr_orchestrator_lifecycle_session_conflict_py
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_TRADING external_prod

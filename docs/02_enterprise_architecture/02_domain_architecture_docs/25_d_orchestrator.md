...
flowchart TD
    ...
    src_zephyr_orchestrator_contracts_construction_guide_py["施工指南引擎（Construction Guide）<br/>编排/契约包的construction_guide模块<br/>文件: contracts/construction_guide.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_contracts_finding_bridge_py["CT-ORC-SCRIPT-001 运行时桥接<br/>编排/契约包的finding_bridge模块<br/>文件: contracts/finding_bridge.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_deferred_queue_py["deferred队列<br/>DeferredQueue: WAITING -> READY task scheduler<br/>文件: orchestrator/deferred_queue.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_lifecycle_state_propagation_py["状态propagation<br/>全局状态传播链（State Propagation Chain）<br/>state_propagation<br/>文件: lifecycle/state_propagation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_resilience_init_py["orchestrator/resilience 包入口<br/>包入口。orchestrator.resilience —<br/>auto-generated package init.<br/>文件: resilience/__init__.py<br/>(生产态 / production)"]

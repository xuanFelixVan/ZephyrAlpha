...
> 展示全部 70 个模块（生产态 70 + 设计态 0），节点含成熟度+中英文名+大白话+文件路径。
...
flowchart TD
    ...
    src_zephyr_orchestrator_governance_model_registry_py ~~~ src_zephyr_orchestrator_lifecycle_session_conflict_py

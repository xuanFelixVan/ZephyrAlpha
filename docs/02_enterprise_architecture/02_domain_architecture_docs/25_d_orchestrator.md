...
flowchart TD
    ...
    src_zephyr_orchestrator_execution_dlq_manager_py ~~~ src_zephyr_orchestrator_execution_reconciliation_loop_py
    ...
    src_zephyr_orchestrator_execution_memory_writer_py ~~~ src_zephyr_orchestrator_execution_phase_executor_py
    src_zephyr_orchestrator_execution_phase_executor_py ~~~ src_zephyr_orchestrator_execution_script_runner_py
    ...
    src_zephyr_orchestrator_execution_init_py -->|config_depends / config_depends| src_zephyr_orchestrator_execution_phase_executor_py
    ...
    class D_SECURITY,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_SCRIPTS,D_TRADING,D_AUTONOMY_CORE,D_FEEDBACK_LOOP external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_TRADING,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod
```

...
flowchart TD
    ...
    src_zephyr_orchestrator_contracts_init_py["orchestrator/contracts 包入口<br/>管理orchestrator.contracts子包的加载和懒导入<br/>文件: contracts/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_core_init_py["orchestrator/core 包入口<br/>管理orchestrator.core子包的加载和懒导入<br/>文件: core/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_execution_init_py["orchestrator/execution 包入口<br/>管理orchestrator.execution子包的加载和懒导入<br/>文件: execution/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_fault_tolerance_init_py["orchestrator/fault_tolerance 包入口<br/>管理orchestrator.fault_tolerance子包的加载和懒导<br/>入<br/>文件: fault_tolerance/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_governance_init_py["orchestrator/governance 包入口<br/>管理orchestrator.governance子包的加载和懒导入<br/>文件: governance/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_lifecycle_init_py["orchestrator/lifecycle 包入口<br/>管理orchestrator.lifecycle子包的加载和懒导入<br/>文件: lifecycle/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_fault_tolerance_fault_types_py["故障类型定义<br/>fault类型定义模块<br/>文件: fault_tolerance/fault_types.py<br/>(生产态 / production)"]
    ...
    src_zephyr_orchestrator_quality_init_py["orchestrator/quality 包入口<br/>管理orchestrator.quality子包的加载和懒导入<br/>文件: quality/__init__.py<br/>(生产态 / production)"]

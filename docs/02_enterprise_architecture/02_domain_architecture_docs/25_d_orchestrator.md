...
flowchart TD
    ...
    src_zephyr_orchestrator_quality_init_py ~~~ src_zephyr_orchestrator_resilience_failure_matcher_py
    ...
    src_zephyr_orchestrator_execution_task_context_builder_py ~~~ src_zephyr_orchestrator_quality_blueprint_scorer_py
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_DRIFT,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_FEEDBACK_LOOP,D_TRADING external_prod

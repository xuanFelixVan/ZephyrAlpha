...
flowchart TD
    src_zephyr_feedback_loop_diagnosers_init_py["feedback_loop/diagnosers 包入口<br/>feedback-loop.diagnosers — GOV-DOC-018:<br/>71个叶子模块拆分为4个逻辑子包(cognit...<br/>文件: diagnosers/__init__.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_adaptive_param_tuning_py["cognitive/adaptive_param_tuning<br/>Adaptive Parameter Tuning — v0.37.0 R452<br/>文件: cognitive/adaptive_param_tuning.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_cognitive_load_py["cognitive/cognitive_load<br/>Cognitive Load Estimator — v0.6.0 R68<br/>文件: cognitive/cognitive_load.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_cognitive_load_budget_py["cognitive/cognitive_load_budget<br/>Cognitive Load Budget — v0.16.0 R223<br/>文件: cognitive/cognitive_load_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_collaborative_learning_py["cognitive/collaborative_learning<br/>Collaborative Learning — v0.7.0 R82<br/>文件: cognitive/collaborative_learning.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_confidence_decomposer_py["cognitive/confidence_decomposer<br/>Confidence Decomposer — v0.7.0 R83<br/>文件: cognitive/confidence_decomposer.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_gamification_py["cognitive/gamification<br/>Gamification — v0.8.0 R101<br/>文件: cognitive/gamification.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_meta_guard_latency_budget_py["cognitive/meta_guard_latency_budget<br/>R516: MetaGuardLatencyBudget<br/>文件: cognitive/meta_guard_latency_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_socratic_questions_py["cognitive/socratic_questions<br/>Socratic Questions — v0.7.0 R81<br/>文件: cognitive/socratic_questions.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_tone_adapter_py["cognitive/tone_adapter<br/>Tone Adapter — v0.9.0 R127<br/>文件: cognitive/tone_adapter.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_cognitive_tone_adapter_v2_py["cognitive/tone_adapter_v2<br/>Tone Adapter v2 — v0.10.0 R141<br/>文件: cognitive/tone_adapter_v2.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_auto_diagnosis_py["diagnosis/auto_diagnosis<br/>Auto Diagnosis — v0.3.0 R16<br/>文件: diagnosis/auto_diagnosis.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_causal_inference_engine_py["diagnosis/causal_inference_engine<br/>Causal Inference Engine — v0.3.0 R5-R7<br/>文件: diagnosis/causal_inference_engine.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_counterfactual_py["diagnosis/counterfactual<br/>Counterfactual Engine — v0.6.0 R60<br/>文件: diagnosis/counterfactual.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_diagnosis_engine_py["diagnosis/diagnosis_engine<br/>diagnosis包的diagnosis_engine模块<br/>文件: diagnosis/diagnosis_engine.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_diagnosis_kpi_py["diagnosis/diagnosis_kpi<br/>Diagnosis KPI — v0.9.0 R116<br/>文件: diagnosis/diagnosis_kpi.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_impact_predictor_py["diagnosis/impact_predictor<br/>Impact Predictor — v0.9.0 R121<br/>文件: diagnosis/impact_predictor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_incident_knowledge_injector_py["diagnosis/incident_knowledge_injector<br/>R504: IncidentKnowledgeInjector<br/>文件: diagnosis/incident_knowledge_injector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_interactive_diagnosis_py["diagnosis/interactive_diagnosis<br/>Interactive Diagnosis — v0.7.0 R80<br/>文件: diagnosis/interactive_diagnosis.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_knowledge_bus_factor_monitor_py["diagnosis/knowledge_bus_factor_monitor<br/>Knowledge Bus Factor Monitor — v0.38.0 R481<br/>文件: diagnosis/knowledge_bus_factor_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_knowledge_market_py["diagnosis/knowledge_market<br/>Knowledge Market — v0.9.0 R126<br/>文件: diagnosis/knowledge_market.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_mtti_tracker_py["diagnosis/mtti_tracker<br/>MTTI Tracker — v0.16.0 R221<br/>文件: diagnosis/mtti_tracker.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_nonstationary_effectiveness_py["diagnosis/nonstationary_effectiveness<br/>Nonstationary Effectiveness — v0.37.0 R455<br/>文件: diagnosis/nonstationary_effectiveness.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_statistical_hygiene_auditor_py["diagnosis/statistical_hygiene_auditor<br/>Statistical Hygiene Auditor — v0.38.0 R476<br/>文件: diagnosis/statistical_hygiene_auditor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_vertical_self_assessment_py["diagnosis/vertical_self_assessment<br/>Vertical Self Assessment — v0.10.0 R137<br/>文件: diagnosis/vertical_self_assessment.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_action_composition_health_monitor_py["health/action_composition_health_monitor<br/>R511: ActionCompositionHealthMonitor<br/>文件: health<br/>/action_composition_health_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_dr_resilience_metrics_py["health/dr_resilience_metrics<br/>DR Resilience Metrics — v0.17.0+ R231-R236<br/>文件: health/dr_resilience_metrics.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_e2e_integration_health_py["health/e2e_integration_health<br/>E2E Integration Health Monitor — v0.39.0 R489<br/>文件: health/e2e_integration_health.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_fle_dogfood_monitor_py["health/fle_dogfood_monitor<br/>FLE Dogfood Monitor — v0.38.0 R480<br/>文件: health/fle_dogfood_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_fle_self_slo_metrics_py["health/fle_self_slo_metrics<br/>FLE Self SLO Metrics — v0.17.0+ R249-R254<br/>文件: health/fle_self_slo_metrics.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_global_health_map_py["health/global_health_map<br/>Global Health Map — v0.8.0 R103<br/>文件: health/global_health_map.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_memory_self_check_py["health/memory_self_check<br/>Memory Self Check — v0.8.0 R105<br/>文件: health/memory_self_check.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_model_health_py["health/model_health<br/>Model Health Monitor — v0.5.0 R40<br/>文件: health/model_health.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_self_benchmark_py["health/self_benchmark<br/>Self Benchmark — v0.9.0 R115<br/>文件: health/self_benchmark.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_self_bottleneck_detector_py["health/self_bottleneck_detector<br/>Self-Bottleneck Detector — v0.38.0 R479<br/>文件: health/self_bottleneck_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_self_health_monitor_py["health/self_health_monitor<br/>Self Health Monitor — v0.4.0 R29<br/>文件: health/self_health_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_health_self_llm_observability_py["health/self_llm_observability<br/>Self LLM Observability — v0.12.0 R160<br/>文件: health/self_llm_observability.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_amplification_guard_py["reliability/amplification_guard<br/>Amplification Guard — v0.10.0 R134<br/>文件: reliability/amplification_guard.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_api_dependency_metrics_py["reliability/api_dependency_metrics<br/>API Dependency Metrics — v0.17.0+ R237-R242<br/>文件: reliability/api_dependency_metrics.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_burn_rate_alerter_py["reliability/burn_rate_alerter<br/>Burn Rate Alerter — v0.14.0 R200<br/>文件: reliability/burn_rate_alerter.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_burnout_alarm_py["reliability/burnout_alarm<br/>Burnout Alarm — v0.8.0 R100<br/>文件: reliability/burnout_alarm.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_capacity_aware_repair_py["reliability/capacity_aware_repair<br/>Capacity Aware Repair — v0.9.0 R120<br/>文件: reliability/capacity_aware_repair.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_cold_start_conservative_mode_py["reliability/cold_start_conservative_mode<br/>R509: ColdStartConservativeMode<br/>文件: reliability<br/>/cold_start_conservative_mode.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_context_truncation_py["reliability/context_truncation<br/>Context Truncation Detector — v0.9.0 R122<br/>文件: reliability/context_truncation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_context_window_pressure_manager_py["reliability/context_window_pressure_manager<br/>R506: ContextWindowPressureManager<br/>文件: reliability<br/>/context_window_pressure_manager.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_cross_guard_conflict_detector_py["reliability/cross_guard_conflict_detector<br/>R513: CrossGuardConflictDetector<br/>文件: reliability<br/>/cross_guard_conflict_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_cross_session_consistency_validator_py["reliability/cross_session_consistency_validator<br/>R510: CrossSessionConsistencyValidator<br/>文件: reliability<br/>/cross_session_consistency_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_data_volume_growth_monitor_py["reliability/data_volume_growth_monitor<br/>Data Volume Growth Monitor — v0.39.0 R492<br/>文件: reliability/data_volume_growth_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_feedback_delay_compensator_py["reliability/feedback_delay_compensator<br/>Feedback Delay Compensator — v0.38.0 R477<br/>文件: reliability/feedback_delay_compensator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_guard_interaction_topology_mapper_py["reliability/guard_interaction_topology_mapper<br/>R518: GuardInteractionTopologyMapper<br/>文件: reliability<br/>/guard_interaction_topology_mapper.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_guard_self_consistency_auditor_py["reliability/guard_self_consistency_auditor<br/>R512: GuardSelfConsistencyAuditor<br/>文件: reliability<br/>/guard_self_consistency_auditor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_human_anomaly_flood_detector_py["reliability/human_anomaly_flood_detector<br/>Human Anomaly Flood Detector — v0.40.0 R500<br/>文件: reliability<br/>/human_anomaly_flood_detector.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_latency_slo_py["reliability/latency_slo<br/>Latency SLO Monitor — v0.14.0 R192<br/>文件: reliability/latency_slo.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_llm_provider_integrity_py["reliability/llm_provider_integrity<br/>LLM Provider Integrity — v0.15.0 R217<br/>文件: reliability/llm_provider_integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_llm_quality_regression_py["reliability/llm_quality_regression<br/>LLM Quality Regression — v0.12.0 R161<br/>文件: reliability/llm_quality_regression.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_model_rotation_py["reliability/model_rotation<br/>Model Rotation — v0.9.0 R125<br/>文件: reliability/model_rotation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_model_rotation_v2_py["reliability/model_rotation_v2<br/>Model Rotation v2 — v0.10.0 R140<br/>文件: reliability/model_rotation_v2.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_model_version_semantic_drift_py["reliability/model_version_semantic_drift<br/>Model Version Semantic Drift Monitor — v0.39.0<br/>R493<br/>文件: reliability<br/>/model_version_semantic_drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_numerical_stability_guard_py["reliability/numerical_stability_guard<br/>Numerical Stability Guard — v0.38.0 R475<br/>文件: reliability/numerical_stability_guard.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_operational_seasonality_py["reliability/operational_seasonality<br/>Operational Seasonality — v0.16.0 R228<br/>文件: reliability/operational_seasonality.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_prompt_fingerprint_py["reliability/prompt_fingerprint<br/>Prompt Fingerprint — v0.3.0 R14<br/>文件: reliability/prompt_fingerprint.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_prompt_sanitizer_py["reliability/prompt_sanitizer<br/>Prompt Sanitizer — v0.10.0 R133<br/>文件: reliability/prompt_sanitizer.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_recovery_time_stats_py["reliability/recovery_time_stats<br/>Recovery Time Statistics — v0.37.0 R454<br/>文件: reliability/recovery_time_stats.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_regime_gain_scheduling_py["reliability/regime_gain_scheduling<br/>Regime Gain Scheduling — v0.37.0 R453<br/>文件: reliability/regime_gain_scheduling.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_retirement_planner_py["reliability/retirement_planner<br/>Retirement Planner — v0.10.0 R139<br/>文件: reliability/retirement_planner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_slo_capacity_metrics_py["reliability/slo_capacity_metrics<br/>SLO Capacity Metrics — v0.17.0+ R243-R248<br/>文件: reliability/slo_capacity_metrics.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_system_entropy_monitor_py["reliability/system_entropy_monitor<br/>R527: SystemEntropyMonitor<br/>文件: reliability/system_entropy_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_temporal_integrity_guard_py["reliability/temporal_integrity_guard<br/>Temporal Integrity Guard — v0.38.0 R478<br/>文件: reliability/temporal_integrity_guard.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_timezone_semantic_reasoner_py["reliability/timezone_semantic_reasoner<br/>Timezone Semantic Reasoner — v0.37.0 R456<br/>文件: reliability/timezone_semantic_reasoner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_toil_quantification_py["reliability/toil_quantification<br/>Toil Quantification — v0.37.0 R457<br/>文件: reliability/toil_quantification.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_value_added_baseline_py["reliability/value_added_baseline<br/>Value Added Baseline — v0.10.0 R138<br/>文件: reliability/value_added_baseline.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_diagnosers_reliability_zombie_fle_detector_py["reliability/zombie_fle_detector<br/>Zombie FLE Detector — v0.16.0 R222<br/>文件: reliability/zombie_fle_detector.py<br/>(生产态 / production)"]

...
flowchart TD
    src_zephyr_feedback_loop_diagnosers_init_py["(生产态 / production) 包入口 / __init__<br/>包入口.diagnosers — GOV-DOC-018: 71个叶子模块拆分为4个逻辑子包(cognitive/diagnosis/health/reliability)。<br/>文件: diagnosers/__init__.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_adaptive_param_tuning_py["(生产态 / production) 自适应参数调优 / Adaptive Parameter Tuning — v0.37.0 R452<br/>自适应参数调优，提供包入口和模块加载功能<br/>文件: cognitive/adaptive_param_tuning.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_cognitive_load_py["(生产态 / production) 认知load / Cognitive Load Estimator — v0.6.0 R68<br/>cognitive加载。Cognitive Load Estimator — v0.6.0 R68<br/>文件: cognitive/cognitive_load.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_cognitive_load_budget_py["(生产态 / production) 认知load预算 / Cognitive Load Budget — v0.16.0 R223<br/>cognitive加载预算。Cognitive Load Budget — v0.16.0 R223<br/>文件: cognitive/cognitive_load_budget.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_collaborative_learning_py["(生产态 / production) 协同学习 / Collaborative Learning — v0.7.0 R82<br/>协同学习，提供share等方法<br/>文件: cognitive/collaborative_learning.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_confidence_decomposer_py["(生产态 / production) 置信度分解器 / Confidence Decomposer — v0.7.0 R83<br/>置信度分解器，提供decompose等方法<br/>文件: cognitive/confidence_decomposer.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_gamification_py["(生产态 / production) 游戏化 / Gamification — v0.8.0 R101<br/>游戏化，提供reward等方法<br/>文件: cognitive/gamification.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_cognitive_socratic_questions_py["(生产态 / production) 苏格拉底式提问 / Socratic Questions — v0.7.0 R81<br/>苏格拉底式提问，提供生成等方法<br/>文件: cognitive/socratic_questions.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_diagnosis_causal_inference_engine_py["(生产态 / production) causalinference引擎 / Causal Inference Engine — v0.3.0 R5-R7<br/>causal推理引擎。Causal Inference Engine — v0.3.0 R5-R7<br/>文件: diagnosis/causal_inference_engine.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_diagnosis_diagnosis_engine_py["(生产态 / production) 诊断引擎 / diagnosis_engine<br/>诊断引擎，提供包入口和模块加载功能<br/>文件: diagnosis/diagnosis_engine.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_diagnosis_impact_predictor_py["(生产态 / production) 冲击预测器 / Impact Predictor — v0.9.0 R121<br/>冲击predictor。Impact Predictor — v0.9.0 R121<br/>文件: diagnosis/impact_predictor.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_health_action_composition_health_monitor_py["(生产态 / production) 行为composition健康监控器 / R511: ActionCompositionHealthMonitor<br/>动作composition健康监控。R511: ActionCompositionHealthMonitor<br/>文件: health/action_composition_health_monitor.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_health_fle_dogfood_monitor_py["(生产态 / production) fledogfood监控器 / FLE Dogfood Monitor — v0.38.0 R480<br/>fledogfood监控。FLE Dogfood Monitor — v0.38.0 R480<br/>文件: health/fle_dogfood_monitor.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_health_self_benchmark_py["(生产态 / production) 自基准 / Self Benchmark — v0.9.0 R115<br/>自benchmark。Self Benchmark — v0.9.0 R115<br/>文件: health/self_benchmark.py"]
    src_zephyr_feedback_loop_diagnosers_health_self_bottleneck_detector_py["(生产态 / production) selfbottleneck检测器 / Self-Bottleneck Detector — v0.38.0 R479<br/>自bottleneck检测器。Self-Bottleneck Detector — v0.38.0 R479<br/>文件: health/self_bottleneck_detector.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_health_self_llm_observability_py["(生产态 / production) 自LLM可观测性 / Self LLM Observability — v0.12.0 R160<br/>自llmobservability。Self LLM Observability — v0.12.0 R160<br/>文件: health/self_llm_observability.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_burn_rate_alerter_py["(生产态 / production) burn速率告警器 / Burn Rate Alerter — v0.14.0 R200<br/>burn率alerter。Burn Rate Alerter — v0.14.0 R200<br/>文件: reliability/burn_rate_alerter.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_burnout_alarm_py["(生产态 / production) 倦怠告警 / Burnout Alarm — v0.8.0 R100<br/>倦怠告警，提供alarm等方法<br/>文件: reliability/burnout_alarm.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_capacity_aware_repair_py["(生产态 / production) 容量感知修复 / Capacity Aware Repair — v0.9.0 R120<br/>容量awarerepair。Capacity Aware Repair — v0.9.0 R120<br/>文件: reliability/capacity_aware_repair.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_cross_guard_conflict_detector_py["(生产态 / production) 跨守卫冲突检测器 / R513: CrossGuardConflictDetector<br/>跨守卫conflict检测器。R513: CrossGuardConflictDetector<br/>文件: reliability/cross_guard_conflict_detector.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_data_volume_growth_monitor_py["(生产态 / production) 数据volumegrowth监控器 / Data Volume Growth Monitor — v0.39.0 R492<br/>数据成交量growth监控。Data Volume Growth Monitor — v0.39.0 R492<br/>文件: reliability/data_volume_growth_monitor.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_feedback_delay_compensator_py["(生产态 / production) 反馈延迟补偿器 / Feedback Delay Compensator — v0.38.0 R477<br/>反馈延迟compensator。Feedback Delay Compensator — v0.38.0 R477<br/>文件: reliability/feedback_delay_compensator.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_latency_slo_py["(生产态 / production) 延迟SLO / Latency SLO Monitor — v0.14.0 R192<br/>延迟SLO，提供包入口和模块加载功能<br/>文件: reliability/latency_slo.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_operational_seasonality_py["(生产态 / production) 运营季节性 / Operational Seasonality — v0.16.0 R228<br/>运营季节性，提供包入口和模块加载功能<br/>文件: reliability/operational_seasonality.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_prompt_fingerprint_py["(生产态 / production) 提示指纹 / Prompt Fingerprint — v0.3.0 R14<br/>提示fingerprint。Prompt Fingerprint — v0.3.0 R14<br/>文件: reliability/prompt_fingerprint.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_prompt_sanitizer_py["(生产态 / production) 提示清洗器 / Prompt Sanitizer — v0.10.0 R133<br/>提示sanitizer。Prompt Sanitizer — v0.10.0 R133<br/>文件: reliability/prompt_sanitizer.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_recovery_time_stats_py["(生产态 / production) 恢复timestats / Recovery Time Statistics — v0.37.0 R454<br/>恢复时间stats。Recovery Time Statistics — v0.37.0 R454<br/>文件: reliability/recovery_time_stats.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_regime_gain_scheduling_py["(生产态 / production) 市场状态增益调度 / Regime Gain Scheduling — v0.37.0 R453<br/>市场状态增益调度，诊断器的调度器，按时间或优先级安排任务。<br/>文件: reliability/regime_gain_scheduling.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_retirement_planner_py["(生产态 / production) 退役规划器 / Retirement Planner — v0.10.0 R139<br/>退役规划器，提供markforretirement等方法<br/>文件: reliability/retirement_planner.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_system_entropy_monitor_py["(生产态 / production) 系统熵监控 / R527: SystemEntropyMonitor<br/>system熵监控。R527: SystemEntropyMonitor<br/>文件: reliability/system_entropy_monitor.py"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_timezone_semantic_reasoner_py["(生产态 / production) 时区语义推理器 / Timezone Semantic Reasoner — v0.37.0 R456<br/>时区语义推理器，提供包入口和模块加载功能<br/>文件: reliability/timezone_semantic_reasoner.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_toil_quantification_py["(生产态 / production) 苦力量化 / Toil Quantification — v0.37.0 R457<br/>苦力量化，提供包入口和模块加载功能<br/>文件: reliability/toil_quantification.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_value_added_baseline_py["(生产态 / production) valueadded基线 / Value Added Baseline — v0.10.0 R138<br/>价值added基线。Value Added Baseline — v0.10.0 R138<br/>文件: reliability/value_added_baseline.py"]

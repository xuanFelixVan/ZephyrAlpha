...
flowchart TD
    ...
    src_zephyr_feedback_loop_diagnosers_health_dr_resilience_metrics_py["dr韧性指标<br/>- R231 dr_drill_pass_rate: 最近 N 次 drill<br/>的通过率<br/>文件: health/dr_resilience_metrics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_diagnosers_health_fle_self_slo_metrics_py["fle自SLO指标<br/>- MTTD: Mean-Time-To-Detect (异常发生->FLE检测)<br/>文件: health/fle_self_slo_metrics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_api_dependency_metrics_py["API依赖指标<br/>- dep_count: 总受监控依赖数<br/>文件: reliability/api_dependency_metrics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_diagnosers_reliability_slo_capacity_metrics_py["SLO容量指标<br/>- error_budget_remaining_pct: 剩余错误预算 %<br/>文件: reliability/slo_capacity_metrics.py<br/>(生产态 / production)"]

...
> 展示全部 76 个模块（生产态 76 + 设计态 0），节点含成熟度+中英文名+大白话+文件路径。
...
flowchart TD
    ...
    src_zephyr_feedback_loop_diagnosers_cognitive_adaptive_param_tuning_py["(生产态 / production) 自适应paramtuning / Adaptive Param Tuning<br/>Adaptive Parameter Tuning — v0.37.0 R452<br/>文件: cognitive/adaptive_param_tuning.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_cognitive_load_py["(生产态 / production) cognitiveload / Cognitive Load<br/>Cognitive Load Estimator — v0.6.0 R68<br/>文件: cognitive/cognitive_load.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_cognitive_load_budget_py["(生产态 / production) cognitiveload预算 / Cognitive Load Budget<br/>Cognitive Load Budget — v0.16.0 R223<br/>文件: cognitive/cognitive_load_budget.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_collaborative_learning_py["(生产态 / production) collaborativelearning / Collaborative Learning<br/>Collaborative Learning — v0.7.0 R82<br/>文件: cognitive/collaborative_learning.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_confidence_decomposer_py["(生产态 / production) confidencedecomposer / Confidence Decomposer<br/>Confidence Decomposer — v0.7.0 R83<br/>文件: cognitive/confidence_decomposer.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_gamification_py["(生产态 / production) gamification / Gamification<br/>Gamification — v0.8.0 R101<br/>文件: cognitive/gamification.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_meta_guard_latency_budget_py["(生产态 / production) meta守卫latency预算 / Meta Guard Latency Budget<br/>R516: MetaGuardLatencyBudget<br/>文件: cognitive/meta_guard_latency_budget.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_socratic_questions_py["(生产态 / production) socraticquestions / Socratic Questions<br/>Socratic Questions — v0.7.0 R81<br/>文件: cognitive/socratic_questions.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_tone_adapter_py["(生产态 / production) tone适配器 / Tone Adapter<br/>Tone Adapter — v0.9.0 R127<br/>文件: cognitive/tone_adapter.py"]
    src_zephyr_feedback_loop_diagnosers_cognitive_tone_adapter_v2_py["(生产态 / production) tone适配器v2 / Tone Adapter V2<br/>Tone Adapter v2 — v0.10.0 R141<br/>文件: cognitive/tone_adapter_v2.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_auto_diagnosis_py["(生产态 / production) 自动诊断 / Auto Diagnosis<br/>Auto Diagnosis — v0.3.0 R16<br/>文件: diagnosis/auto_diagnosis.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_causal_inference_engine_py["(生产态 / production) causalinference引擎 / Causal Inference Engine<br/>Causal Inference Engine — v0.3.0 R5-R7<br/>文件: diagnosis/causal_inference_engine.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_counterfactual_py["(生产态 / production) counterfactual / Counterfactual<br/>Counterfactual Engine — v0.6.0 R60<br/>文件: diagnosis/counterfactual.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_diagnosis_engine_py["(生产态 / production) 诊断引擎 / Diagnosis Engine<br/>定义 Diagnosis、DiagnosisEngine 等类型。<br/>文件: diagnosis/diagnosis_engine.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_diagnosis_kpi_py["(生产态 / production) 诊断kpi / Diagnosis Kpi<br/>Diagnosis KPI — v0.9.0 R116<br/>文件: diagnosis/diagnosis_kpi.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_impact_predictor_py["(生产态 / production) impactpredictor / Impact Predictor<br/>Impact Predictor — v0.9.0 R121<br/>文件: diagnosis/impact_predictor.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_incident_knowledge_injector_py["(生产态 / production) 事件knowledgeinjector / Incident Knowledge Injector<br/>R504: IncidentKnowledgeInjector<br/>文件: diagnosis/incident_knowledge_injector.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_interactive_diagnosis_py["(生产态 / production) interactive诊断 / Interactive Diagnosis<br/>Interactive Diagnosis — v0.7.0 R80<br/>文件: diagnosis/interactive_diagnosis.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_knowledge_bus_factor_monitor_py["(生产态 / production) knowledge总线因子监控器 / Knowledge Bus Factor Monitor<br/>Knowledge Bus Factor Monitor — v0.38.0 R481<br/>文件: diagnosis/knowledge_bus_factor_monitor.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_knowledge_market_py["(生产态 / production) knowledgemarket / Knowledge Market<br/>Knowledge Market — v0.9.0 R126<br/>文件: diagnosis/knowledge_market.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_mtti_tracker_py["(生产态 / production) mtti追踪器 / Mtti Tracker<br/>MTTI Tracker — v0.16.0 R221<br/>文件: diagnosis/mtti_tracker.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_nonstationary_effectiveness_py["(生产态 / production) nonstationaryeffectiveness / Nonstationary Effectiveness<br/>Nonstationary Effectiveness — v0.37.0 R455<br/>文件: diagnosis/nonstationary_effectiveness.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_statistical_hygiene_auditor_py["(生产态 / production) statisticalhygiene审计器 / Statistical Hygiene Auditor<br/>Statistical Hygiene Auditor — v0.38.0 R476<br/>文件: diagnosis/statistical_hygiene_auditor.py"]
    src_zephyr_feedback_loop_diagnosers_diagnosis_vertical_self_assessment_py["(生产态 / production) vertical自我assessment / Vertical Self Assessment<br/>Vertical Self Assessment — v0.10.0 R137<br/>文件: diagnosis/vertical_self_assessment.py"]
    src_zephyr_feedback_loop_diagnosers_health_action_composition_health_monitor_py["(生产态 / production) 动作composition健康监控器 / Action Composition Health Monitor<br/>R511: ActionCompositionHealthMonitor<br/>文件: health/action_composition_health_monitor.py"]
    src_zephyr_feedback_loop_diagnosers_health_dr_resilience_metrics_py["(生产态 / production) dr韧性指标 / Dr Resilience Metrics<br/>DR Resilience Metrics — v0.17.0+ R231-R236<br/>文件: health/dr_resilience_metrics.py"]
    src_zephyr_feedback_loop_diagnosers_health_e2e_integration_health_py["(生产态 / production) 端到端集成健康 / E2E Integration Health<br/>E2E Integration Health Monitor — v0.39.0 R489<br/>文件: health/e2e_integration_health.py"]
    src_zephyr_feedback_loop_diagnosers_health_fle_dogfood_monitor_py["(生产态 / production) fledogfood监控器 / Fle Dogfood Monitor<br/>FLE Dogfood Monitor — v0.38.0 R480<br/>文件: health/fle_dogfood_monitor.py"]
    src_zephyr_feedback_loop_diagnosers_health_fle_self_slo_metrics_py["(生产态 / production) fle自我SLO指标 / Fle Self SLO Metrics<br/>FLE Self SLO Metrics — v0.17.0+ R249-R254<br/>文件: health/fle_self_slo_metrics.py"]
    src_zephyr_feedback_loop_diagnosers_health_global_health_map_py["(生产态 / production) global健康map / Global Health Map<br/>Global Health Map — v0.8.0 R103<br/>文件: health/global_health_map.py"]
    src_zephyr_feedback_loop_diagnosers_health_memory_self_check_py["(生产态 / production) memory自我检查 / Memory Self Check<br/>Memory Self Check — v0.8.0 R105<br/>文件: health/memory_self_check.py"]
    src_zephyr_feedback_loop_diagnosers_health_model_health_py["(生产态 / production) 模型健康 / Model Health<br/>Model Health Monitor — v0.5.0 R40<br/>文件: health/model_health.py"]
    src_zephyr_feedback_loop_diagnosers_health_self_benchmark_py["(生产态 / production) 自我基准 / Self Benchmark<br/>Self Benchmark — v0.9.0 R115<br/>文件: health/self_benchmark.py"]
    src_zephyr_feedback_loop_diagnosers_health_self_bottleneck_detector_py["(生产态 / production) 自我bottleneck检测器 / Self Bottleneck Detector<br/>Self-Bottleneck Detector — v0.38.0 R479<br/>文件: health/self_bottleneck_detector.py"]
    src_zephyr_feedback_loop_diagnosers_health_self_health_monitor_py["(生产态 / production) 自我健康监控器 / Self Health Monitor<br/>Self Health Monitor — v0.4.0 R29<br/>文件: health/self_health_monitor.py"]
    src_zephyr_feedback_loop_diagnosers_health_self_llm_observability_py["(生产态 / production) 自我LLM可观测性 / Self LLM Observability<br/>Self LLM Observability — v0.12.0 R160<br/>文件: health/self_llm_observability.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_amplification_guard_py["(生产态 / production) amplification守卫 / Amplification Guard<br/>Amplification Guard — v0.10.0 R134<br/>文件: reliability/amplification_guard.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_api_dependency_metrics_py["(生产态 / production) API依赖指标 / API Dependency Metrics<br/>API Dependency Metrics — v0.17.0+ R237-R242<br/>文件: reliability/api_dependency_metrics.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_burn_rate_alerter_py["(生产态 / production) burnratealerter / Burn Rate Alerter<br/>Burn Rate Alerter — v0.14.0 R200<br/>文件: reliability/burn_rate_alerter.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_burnout_alarm_py["(生产态 / production) burnoutalarm / Burnout Alarm<br/>Burnout Alarm — v0.8.0 R100<br/>文件: reliability/burnout_alarm.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_capacity_aware_repair_py["(生产态 / production) 容量感知repair / Capacity Aware Repair<br/>Capacity Aware Repair — v0.9.0 R120<br/>文件: reliability/capacity_aware_repair.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_cold_start_conservative_mode_py["(生产态 / production) 冷启动conservative模式 / Cold Start Conservative Mode<br/>R509: ColdStartConservativeMode<br/>文件: reliability/cold_start_conservative_mode.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_context_truncation_py["(生产态 / production) 上下文truncation / Context Truncation<br/>Context Truncation Detector — v0.9.0 R122<br/>文件: reliability/context_truncation.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_context_window_pressure_manager_py["(生产态 / production) 上下文windowpressure管理器 / Context Window Pressure Manager<br/>R506: ContextWindowPressureManager<br/>文件: reliability/context_window_pressure_manager.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_cross_guard_conflict_detector_py["(生产态 / production) 跨守卫conflict检测器 / Cross Guard Conflict Detector<br/>R513: CrossGuardConflictDetector<br/>文件: reliability/cross_guard_conflict_detector.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_cross_session_consistency_validator_py["(生产态 / production) 跨会话一致性校验器 / Cross Session Consistency Validator<br/>R510: CrossSessionConsistencyValidator<br/>文件: reliability/cross_session_consistency_validator.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_data_volume_growth_monitor_py["(生产态 / production) 数据volumegrowth监控器 / Data Volume Growth Monitor<br/>Data Volume Growth Monitor — v0.39.0 R492<br/>文件: reliability/data_volume_growth_monitor.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_feedback_delay_compensator_py["(生产态 / production) 反馈delaycompensator / Feedback Delay Compensator<br/>Feedback Delay Compensator — v0.38.0 R477<br/>文件: reliability/feedback_delay_compensator.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_guard_interaction_topology_mapper_py["(生产态 / production) 守卫interactiontopologymapper / Guard Interaction Topology Mapper<br/>R518: GuardInteractionTopologyMapper<br/>文件: reliability/guard_interaction_topology_mapper.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_guard_self_consistency_auditor_py["(生产态 / production) 守卫自我一致性审计器 / Guard Self Consistency Auditor<br/>R512: GuardSelfConsistencyAuditor<br/>文件: reliability/guard_self_consistency_auditor.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_human_anomaly_flood_detector_py["(生产态 / production) human异常flood检测器 / Human Anomaly Flood Detector<br/>Human Anomaly Flood Detector — v0.40.0 R500<br/>文件: reliability/human_anomaly_flood_detector.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_latency_slo_py["(生产态 / production) latencySLO / Latency SLO<br/>Latency SLO Monitor — v0.14.0 R192<br/>文件: reliability/latency_slo.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_llm_provider_integrity_py["(生产态 / production) LLM提供者完整性 / LLM Provider Integrity<br/>LLM Provider Integrity — v0.15.0 R217<br/>文件: reliability/llm_provider_integrity.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_llm_quality_regression_py["(生产态 / production) LLM质量regression / LLM Quality Regression<br/>LLM Quality Regression — v0.12.0 R161<br/>文件: reliability/llm_quality_regression.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_model_rotation_py["(生产态 / production) 模型rotation / Model Rotation<br/>Model Rotation — v0.9.0 R125<br/>文件: reliability/model_rotation.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_model_rotation_v2_py["(生产态 / production) 模型rotationv2 / Model Rotation V2<br/>Model Rotation v2 — v0.10.0 R140<br/>文件: reliability/model_rotation_v2.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_model_version_semantic_drift_py["(生产态 / production) 模型版本语义漂移 / Model Version Semantic Drift<br/>Model Version Semantic Drift Monitor — v0.39.0 R493<br/>文件: reliability/model_version_semantic_drift.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_numerical_stability_guard_py["(生产态 / production) numericalstability守卫 / Numerical Stability Guard<br/>Numerical Stability Guard — v0.38.0 R475<br/>文件: reliability/numerical_stability_guard.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_operational_seasonality_py["(生产态 / production) 运营seasonality / Operational Seasonality<br/>Operational Seasonality — v0.16.0 R228<br/>文件: reliability/operational_seasonality.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_prompt_fingerprint_py["(生产态 / production) 提示词指纹 / Prompt Fingerprint<br/>Prompt Fingerprint — v0.3.0 R14<br/>文件: reliability/prompt_fingerprint.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_prompt_sanitizer_py["(生产态 / production) 提示词sanitizer / Prompt Sanitizer<br/>Prompt Sanitizer — v0.10.0 R133<br/>文件: reliability/prompt_sanitizer.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_recovery_time_stats_py["(生产态 / production) recovery时间stats / Recovery Time Stats<br/>Recovery Time Statistics — v0.37.0 R454<br/>文件: reliability/recovery_time_stats.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_regime_gain_scheduling_py["(生产态 / production) 状态gainscheduling / Regime Gain Scheduling<br/>Regime Gain Scheduling — v0.37.0 R453<br/>文件: reliability/regime_gain_scheduling.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_retirement_planner_py["(生产态 / production) retirementplanner / Retirement Planner<br/>Retirement Planner — v0.10.0 R139<br/>文件: reliability/retirement_planner.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_slo_capacity_metrics_py["(生产态 / production) SLO容量指标 / SLO Capacity Metrics<br/>SLO Capacity Metrics — v0.17.0+ R243-R248<br/>文件: reliability/slo_capacity_metrics.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_system_entropy_monitor_py["(生产态 / production) 系统entropy监控器 / System Entropy Monitor<br/>R527: SystemEntropyMonitor<br/>文件: reliability/system_entropy_monitor.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_temporal_integrity_guard_py["(生产态 / production) temporal完整性守卫 / Temporal Integrity Guard<br/>Temporal Integrity Guard — v0.38.0 R478<br/>文件: reliability/temporal_integrity_guard.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_timezone_semantic_reasoner_py["(生产态 / production) timezone语义reasoner / Timezone Semantic Reasoner<br/>Timezone Semantic Reasoner — v0.37.0 R456<br/>文件: reliability/timezone_semantic_reasoner.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_toil_quantification_py["(生产态 / production) toilquantification / Toil Quantification<br/>Toil Quantification — v0.37.0 R457<br/>文件: reliability/toil_quantification.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_value_added_baseline_py["(生产态 / production) valueadded基线 / Value Added Baseline<br/>Value Added Baseline — v0.10.0 R138<br/>文件: reliability/value_added_baseline.py"]
    src_zephyr_feedback_loop_diagnosers_reliability_zombie_fle_detector_py["(生产态 / production) zombiefle检测器 / Zombie Fle Detector<br/>Zombie FLE Detector — v0.16.0 R222<br/>文件: reliability/zombie_fle_detector.py"]
...
|:--:|---------|:--:|---------|---------|
| 1 | 运营seasonality / Operational Seasonality (reliability/op... | → | D_SHARED 共享服务: 时间utils / Time Utils (utils/time_utils.py) | 导入依赖 / import_depends |

### 依赖本域的其他域（入边）/ Depended By

| # | 外部域-源模块 / Source Module | → | 本域模块 / Target Module | 依赖类型 / Type |
|:--:|---------|:--:|---------|---------|
| 1 | D_FEEDBACK_LOOP 反馈循环引擎: 调度器 / Scheduler (feedback_loop/scheduler.py) | → | 反馈诊断器域包 / Diagnosers Domain Package (diagnosers/__... | 导入依赖 / import_depends |
| 2 | D_FEEDBACK_LOOP 反馈循环引擎: 调度器 / Scheduler (feedback_loop/scheduler.py) | → | 诊断引擎 / Diagnosis Engine (diagnosis/diagnosis_engine.py) | 导入依赖 / import_depends |
| 3 | D_FEEDBACK_LOOP 反馈循环引擎: 调度器执行 / Scheduler Act (feedback_loop/scheduler_act.py) | → | 反馈诊断器域包 / Diagnosers Domain Package (diagnosers/__... | 导入依赖 / import_depends |
| 4 | D_FEEDBACK_LOOP 反馈循环引擎: 调度器收集检测 / Scheduler Collect Detect (feedback_loop/... | → | 反馈诊断器域包 / Diagnosers Domain Package (diagnosers/__... | 导入依赖 / import_depends |
| 5 | D_FEEDBACK_LOOP 反馈循环引擎: 调度器健康 / Scheduler Health (feedback_loop/scheduler_he... | → | 反馈诊断器域包 / Diagnosers Domain Package (diagnosers/__... | 导入依赖 / import_depends |
| 6 | D_FEEDBACK_LOOP 反馈循环引擎: 调度器安全 / Scheduler Safety (feedback_loop/scheduler_sa... | → | 反馈诊断器域包 / Diagnosers Domain Package (diagnosers/__... | 导入依赖 / import_depends |
| 7 | D_FEEDBACK_LOOP 反馈循环引擎: 集成测试流水线 / Integration Test Pipeline (e2e/integrati... | → | 反馈诊断器域包 / Diagnosers Domain Package (diagnosers/__... | 导入依赖 / import_depends |

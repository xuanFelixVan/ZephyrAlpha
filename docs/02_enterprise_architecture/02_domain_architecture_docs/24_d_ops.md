...
flowchart TD
    scripts_governance_observability_gate_cache_py["门禁缓存<br/>门禁缓存模块<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: observability/gate_cache.py<br/>(生产态 / production)"]

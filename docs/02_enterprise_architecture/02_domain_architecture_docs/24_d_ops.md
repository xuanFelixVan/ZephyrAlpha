...
flowchart TD
    ...
    src_zephyr_governance_ops_governance_budget_profile_manager_py["预算档案管理器<br/>治理/ops_governance包的预算档案管理器模块<br/>budget_profile_manager<br/>文件: ops_governance/budget_profile_manager.py<br/>(生产态 / production)"]

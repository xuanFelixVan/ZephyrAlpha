...
flowchart TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_GOV_REPAIR,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
```

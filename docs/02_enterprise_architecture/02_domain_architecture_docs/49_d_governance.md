...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_GOV_RULE,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED,D_GOV_OPS_RESILIENCE,D_EX_CORE,D_PF_CORE,D_PF_ALLOC external_prod
```
...
| 56 | D_GOV_ENFORCEMENT 规则执行: 重置网关 (rule_bridge/reset_gateway.py) | → | Git守卫 / git_guard (scripts/git_guard.py) | 导入依赖 / import_depends |

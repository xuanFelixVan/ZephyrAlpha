...
flowchart TD
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_governance_capability_lookup_py
    D_GOV_ENFORCEMENT -->|导入依赖 / import_depends| src_zephyr_governance_capability_lookup_py
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_governance_capability_lookup_py
    ...
    class D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_INFRASTRUCTURE,D_TRADING,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_EX_CORE,D_GOV_SCRIPTS external_prod
```

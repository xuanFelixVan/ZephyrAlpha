...
flowchart TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_TRADING,D_INFRASTRUCTURE,D_GOV_OPS_RESILIENCE,D_SECURITY,D_EX_CORE,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_FRONTEND,D_GOV_AUDIT,D_OPS external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_SECURITY,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_EX_CORE,D_PF_CORE external_prod

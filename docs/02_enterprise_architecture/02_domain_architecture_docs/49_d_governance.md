...
flowchart TD
    ...
    tests_governance_code_quality_test_evals_unit_py -->|测试依赖 / test_depends| D_INTEGRATION
    ...
    tests_governance_ops_test_incident_response_py -->|测试依赖 / test_depends| D_GOV_OPS_RESILIENCE
    ...
    class D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_EX_CORE,D_PF_CORE,D_PF_ALLOC external_prod
```

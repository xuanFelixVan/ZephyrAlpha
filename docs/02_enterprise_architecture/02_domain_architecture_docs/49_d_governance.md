...
flowchart TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_INTELLIGENCE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_BACKTEST,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_EX_CORE,D_PF_CORE,D_GOV_AUDIT external_prod
```

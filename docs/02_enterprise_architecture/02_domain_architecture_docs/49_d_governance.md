...
flowchart TD
    ...
    tests_governance_shared_test_capability_checker_py -->|测试依赖 / test_depends| D_GOV_RULE
    tests_governance_shared_test_capability_checker_py -->|测试依赖 / test_depends| D_GOV_RULE
    ...
    class D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_GOV_RULE,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_SHARED,D_GOV_OPS_RESILIENCE,D_EX_CORE,D_PF_CORE,D_PF_ALLOC external_prod
```

...
flowchart TD
    docs_01_policies_and_standards_registry_catalogs_rule_registry_collection_yaml["规则注册表收集<br/>catalogs包的规则注册表收集模块<br/>rule_registry_collection<br/>文件: catalogs/rule_registry_collection.yaml<br/>(生产态 / production)"]
    ...
    scripts_construction_e2e_check_py["端到端检查<br/>construction包的端到端检查模块<br/>_e2e_check<br/>文件: construction/_e2e_check.py<br/>(生产态 / production)"]
    ...
    scripts_construction_check_transition_code_py["检查转换代码<br/>construction包的检查转换代码模块<br/>check_transition_code<br/>文件: construction/check_transition_code.py<br/>(生产态 / production)"]
    ...
    scripts_construction_demo_a2a_coordination_py["A2A 协议协调任务演示<br/>construction包的A2A 协议协调任务演示模块<br/>demo_a2a_coordination<br/>文件: construction/demo_a2a_coordination.py<br/>(生产态 / production)"]
    ...
    scripts_mcp_launcher_py["MCP DAG 编排启动器（MOD-INF-013 §14 拓扑排序 +<br/>Pro<br/>launcher<br/>文件: mcp/launcher.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_a2a_init_py["governance/a2a 包入口<br/>文件: a2a/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_agent_spec_init_py["governance/agent-spec 包入口<br/>文件: agent-spec/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_architecture_contracts_py["架构契约<br/>治理/architecture_governance包的架构契约模块<br/>architecture_contracts<br/>文件: architecture_governance/architecture_<br/>contracts.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_cross_env_consistency_py["跨环境一致性<br/>治理/architecture_governance包的跨环境一致性模块<br/>cross_env_consistency<br/>文件: architecture_governance/cross_env_<br/>consistency.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_local_first_arch_py["本地首架构<br/>治理/architecture_governance包的本地首架构模块<br/>local_first_arch<br/>文件: architecture_governance/local_first_<br/>arch.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_bridges_alerts_py["告警<br/>告警，依赖预算告警工作<br/>G-CT-006 — BudgetAlert re-exported from<br/>shared.contracts.esc<br/>文件: bridges/alerts.py<br/>(生产态 / production)"]
    src_zephyr_governance_bridges_spec_auditor_py["spec审计器<br/>治理/bridges包的spec审计器模块<br/>spec_auditor<br/>文件: bridges/spec_auditor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_conversation_tax_detector_py["conversationtax检测器<br/>conversation_tax_detector<br/>文件: context_governance/conversation_tax_<br/>detector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_prompt_lifecycle_py["提示生命周期<br/>治理/context_governance包的提示生命周期模块<br/>prompt_lifecycle<br/>文件: context_governance/prompt_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_think_time_model_py["thinktime模型<br/>治理/context_governance包的thinktime模型模块<br/>think_time_model<br/>文件: context_governance/think_time_model.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_data_lifecycle_py["数据生命周期<br/>治理/数据治理包的数据生命周期模块<br/>data_lifecycle<br/>文件: data_governance/data_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_data_quality_py["数据质量<br/>治理/数据治理包的数据质量模块<br/>data_quality<br/>文件: data_governance/data_quality.py<br/>(生产态 / production)"]
    src_zephyr_governance_data_governance_data_source_reliability_py["数据源可靠性<br/>治理/数据治理包的数据源可靠性模块<br/>data_source_reliability<br/>文件: data_governance/data_source_reliability.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_pricing_sync_py["pricing同步<br/>治理/数据治理包的pricing同步模块<br/>pricing_sync<br/>文件: data_governance/pricing_sync.py<br/>(生产态 / production)"]
    src_zephyr_governance_data_governance_realtime_streaming_py["实时流式<br/>治理/数据治理包的实时流式模块<br/>realtime_streaming<br/>文件: data_governance/realtime_streaming.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_financial_governance_fsm_verifier_py["fsm验证器<br/>治理/financial_governance包的fsm验证器模块<br/>fsm_verifier<br/>文件: financial_governance/fsm_verifier.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_instrument_py["标的合约<br/>治理/financial_governance包的标的合约模块<br/>instrument<br/>文件: financial_governance/instrument.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_microstructure_defense_py["microstructure防御<br/>microstructure_defense<br/>文件: financial_governance/microstructure_<br/>defense.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_oms_risk_engine_py["oms风险引擎<br/>治理/financial_governance包的oms风险引擎模块<br/>oms_risk_engine<br/>文件: financial_governance/oms_risk_engine.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_risk_matrix_py["风险矩阵<br/>治理/financial_governance包的风险矩阵模块<br/>risk_matrix<br/>文件: financial_governance/risk_matrix.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_strategy_portfolio_py["策略组合<br/>治理/financial_governance包的策略组合模块<br/>strategy_portfolio<br/>文件: financial_governance/strategy_portfolio.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_implementations_default_experiment_pipeline_py["默认实验管线<br/>治理/implementations包的默认实验管线模块<br/>default_experiment_pipeline<br/>文件: implementations/default_experiment_<br/>pipeline.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_intelligence_governance_ai_self_diagnosis_py["AI自诊断<br/>治理/intelligence_governance包的AI自诊断模块<br/>ai_self_diagnosis<br/>文件: intelligence_governance/ai_self_<br/>diagnosis.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_intelligence_governance_multi_model_consensus_py["多模型共识<br/>治理/intelligence_governance包的多模型共识模块<br/>multi_model_consensus<br/>文件: intelligence_governance/multi_model_<br/>consensus.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_lifecycle_governance_api_lifecycle_py["API生命周期<br/>治理/lifecycle_governance包的API生命周期模块<br/>api_lifecycle<br/>文件: lifecycle_governance/api_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_governance_lifecycle_governance_migration_strategy_py["迁移策略<br/>治理/lifecycle_governance包的迁移策略模块<br/>migration_strategy<br/>文件: lifecycle_governance/migration_strategy.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_lifecycle_governance_post_live_verification_py["提交实时验证<br/>治理/lifecycle_governance包的提交实时验证模块<br/>post_live_verification<br/>文件: lifecycle_governance/post_live_<br/>verification.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_governance_phase_hold_py["阶段hold<br/>治理包的阶段hold模块<br/>phase_hold<br/>文件: governance/phase_hold.py<br/>(生产态 / production)"]
    ...
    tests_governance_test_ast_import_rewriter_py["测试astimportrewriter<br/>Tests for scripts/governance/ast_import_<br/>rewriter.py.<br/>文件: governance/test_ast_import_rewriter.py<br/>(生产态 / production)"]
    ...
    tests_test_align_panoramas_py["测试alignpanoramas<br/>test_align_panoramas<br/>文件: tests/test_align_panoramas.py<br/>(生产态 / production)"]
    ...
    scripts_check_naming_convention_py["检查namingconvention<br/>check_naming_convention<br/>文件: scripts/check_naming_convention.py<br/>(生产态 / production)"]
    scripts_construction_check_statuses_py["检查statuses<br/>construction包的检查statuses模块<br/>check_statuses<br/>文件: construction/check_statuses.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_engine_pipeline_base_py["管线基类<br/>治理/engine包的管线基类模块<br/>pipeline_base<br/>文件: engine/pipeline_base.py<br/>(生产态 / production)"]
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_SCRIPTS,D_SECURITY,D_RISK,D_INFRASTRUCTURE,D_TRADING external_prod

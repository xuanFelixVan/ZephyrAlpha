...
flowchart TD
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_SCRIPTS,D_SECURITY,D_RISK,D_BACKTEST,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod

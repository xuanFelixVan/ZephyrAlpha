...
flowchart TD
    ...
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_SHARED,D_DATA,D_EX_CORE,D_PF_CORE,D_PF_ALLOC external_prod
```

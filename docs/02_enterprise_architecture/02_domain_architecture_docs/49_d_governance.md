...
flowchart TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_SHARED,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_EX_CORE,D_GOV_AUDIT,D_GOV_RULE,D_PF_CORE external_prod
```

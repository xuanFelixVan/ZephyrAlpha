...
flowchart TD
    ...
    tests_governance_shared_test_enforcer_unit_py -->|测试依赖 / test_depends| D_SHARED
    ...
    D_GOV_OPS_RESILIENCE -->|测试依赖 / test_depends| src_zephyr_governance_intelligence_governance_model_router_py
    ...
    class D_OPS,D_INTELLIGENCE,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_SHARED,D_INFRASTRUCTURE,D_TRADING,D_GOV_REPAIR,D_INFRA_RUNTIME,D_EX_CORE,D_PF_CORE external_prod

...
flowchart TD
    ...
    src_zephyr_governance_a2a_init_py["governance/a2a 包入口<br/>治理域a2a包入口，归集子模块按需懒加载<br/>文件: a2a/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_agent_spec_init_py["governance/agent-spec 包入口<br/>治理域agent-spec包入口，归集子模块按需懒加载<br/>文件: agent-spec/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_cross_env_consistency_py["跨环境一致性<br/>architecture_governance/cross_env_consistency<br/>模块<br/>文件: architecture_governance/cross_env_<br/>consistency.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_local_first_arch_py["本地首架构<br/>architecture_governance/local_first_arch 模块<br/>文件: architecture_governance/local_first_<br/>arch.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_bridges_alerts_py["告警<br/>依赖预算告警工作<br/>G-CT-006 — BudgetAlert re-exported from<br/>shared.contracts.esc<br/>文件: bridges/alerts.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_prompt_lifecycle_py["提示生命周期<br/>context_governance/prompt_lifecycle 模块<br/>文件: context_governance/prompt_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_think_time_model_py["thinktime模型<br/>context_governance/think_time_model 模块<br/>文件: context_governance/think_time_model.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_data_lifecycle_py["数据生命周期<br/>data_governance/data_lifecycle 模块<br/>文件: data_governance/data_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_data_quality_py["数据质量<br/>data_governance/data_quality 模块<br/>文件: data_governance/data_quality.py<br/>(生产态 / production)"]
    src_zephyr_governance_data_governance_data_source_reliability_py["数据源可靠性<br/>data_governance/data_source_reliability 模块<br/>文件: data_governance/data_source_reliability.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_pricing_sync_py["pricing同步<br/>data_governance/pricing_sync 模块<br/>文件: data_governance/pricing_sync.py<br/>(生产态 / production)"]
    src_zephyr_governance_data_governance_realtime_streaming_py["实时流式<br/>data_governance/realtime_streaming 模块<br/>文件: data_governance/realtime_streaming.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_financial_governance_oms_risk_engine_py["oms风险引擎<br/>financial_governance/oms_risk_engine 模块<br/>文件: financial_governance/oms_risk_engine.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_risk_matrix_py["风险矩阵<br/>financial_governance/risk_matrix 模块<br/>文件: financial_governance/risk_matrix.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_strategy_portfolio_py["策略组合<br/>financial_governance/strategy_portfolio 模块<br/>文件: financial_governance/strategy_portfolio.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_intelligence_governance_ai_self_diagnosis_py["AI自诊断<br/>intelligence_governance/ai_self_diagnosis 模块<br/>文件: intelligence_governance/ai_self_<br/>diagnosis.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_intelligence_governance_multi_model_consensus_py["多模型共识<br/>intelligence_governance/multi_model_consensus<br/>模块<br/>文件: intelligence_governance/multi_model_<br/>consensus.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_lifecycle_governance_migration_strategy_py["迁移策略<br/>lifecycle_governance/migration_strategy 模块<br/>文件: lifecycle_governance/migration_strategy.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_governance_integration_py["治理集成<br/>layer3_coordination/_governance_integration 模块<br/>Re-export bridge for layer3_coordination<br/>governance integrat<br/>文件: layer3_coordination/_governance_<br/>integration.py<br/>(生产态 / production)"]

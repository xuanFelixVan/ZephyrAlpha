...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOV_REPAIR,D_ORCHESTRATOR,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_INTELLIGENCE,D_RISK,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_PF_CORE,D_GOV_SCRIPTS,D_GOV_RULE,D_GOV_OPS_RESILIENCE external_prod
    class D_EX_CORE external_design
```

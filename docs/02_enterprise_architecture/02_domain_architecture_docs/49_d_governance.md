...
flowchart TD
    ...
    D_GOV_OPS_RESILIENCE -->|测试依赖 / test_depends| src_zephyr_governance_context_governance_command_chain_length_gate_py
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_EX_CORE,D_GOV_SCRIPTS,D_PF_CORE external_prod
```

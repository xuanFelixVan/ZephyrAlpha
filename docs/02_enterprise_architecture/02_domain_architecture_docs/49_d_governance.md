...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_OPS,D_GOV_OPS_RESILIENCE,D_INFRASTRUCTURE,D_TRADING,D_GOV_SCRIPTS,D_GOV_AUDIT,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SECURITY,D_FRONTEND,D_FEEDBACK_LOOP external_prod
```

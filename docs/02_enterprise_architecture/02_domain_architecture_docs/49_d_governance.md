...
flowchart TD
    ...
    src_zephyr_governance_a2a_init_py["governance/a2a 包入口<br/>governance/a2a<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: a2a/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_agent_spec_init_py["governance/agent-spec 包入口<br/>governance/agent-spec<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: agent-spec/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_data_source_reliability_py["数据源可靠性<br/>治理/data governance包的data_source_<br/>reliability模块<br/>文件: data_governance/data_source_reliability.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_governance_integration_py["治理集成<br/>基础设施/layer3 coordination包的governance_<br/>integration模块<br/>Re-export bridge for layer3_coordination<br/>governance integration symbols.<br/>文件: layer3_coordination/_governance_<br/>integration.py<br/>(生产态 / production)"]
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_SCRIPTS,D_SECURITY,D_RISK,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_EX_CORE external_prod
```

...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_GOV_REPAIR,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_INTEGRATION,D_GOV_DRIFT,D_SHARED,D_GOV_ENFORCEMENT,D_OPS,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
    class D_EX_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INFRA_RECOVERY,D_INTEGRATION,D_RISK,D_INTELLIGENCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_RULE,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE external_prod
    class D_EX_CORE external_design
```

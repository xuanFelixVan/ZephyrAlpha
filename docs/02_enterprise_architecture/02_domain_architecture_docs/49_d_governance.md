...
flowchart TD
    ...
    tests_governance_governance_e2e_test_p0_i1_depends_on_integration_py -->|测试依赖 / test_depends| D_SHARED
    ...
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_governance_persistence_depgraph_reader_py
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_INFRASTRUCTURE,D_TRADING,D_EX_CORE,D_PF_CORE external_prod

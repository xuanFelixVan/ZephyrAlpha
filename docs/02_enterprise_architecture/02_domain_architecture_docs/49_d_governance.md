...
flowchart TD
    ...
    scripts_arch_guard_check_hot_path_purity_py["检查hot路径purity<br/>check_hot_path_purity.py — INV-012 Hot 路径<br/>Python 禁 asyncio（配置驱动）<br/>文件: arch_guard/check_hot_path_purity.py<br/>(生产态 / production)"]
    ...
    scripts_dm90971_add_test_headers_py["dm90971add测试headers<br/>dm90971新增测试headers模块<br/>文件: scripts/dm90971_add_test_headers.py<br/>(生产态 / production)"]
    ...
    scripts_migration_governance_root_split_py["治理根拆分<br/>migration包的governance_root_split模块<br/>文件: migration/governance_root_split.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_adapters_risk_validation_bridge_py["风险验证桥接<br/>治理/适配器包的risk_validation_bridge模块<br/>文件: adapters/risk_validation_bridge.py<br/>(生产态 / production)"]

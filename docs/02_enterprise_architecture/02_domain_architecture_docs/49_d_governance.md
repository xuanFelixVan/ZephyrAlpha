...
graph TD
    ...
    class D_SECURITY,D_GOV_OPS_RESILIENCE,D_SHARED,D_INTELLIGENCE,D_INFRA_RECOVERY,D_TRADING,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod
...
graph TD
    ...
    D_GOV_CODE_QUALITY["(生产态 / production) D_GOV_CODE_QUALITY"]
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_governance_depgraph_schema_py
    D_INFRA_RUNTIME["(生产态 / production) D_INFRA_RUNTIME"]
    ...
    class D_SHARED,D_DATA,D_SECURITY,D_OPS,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_RULE,D_GOV_DRIFT,D_FRONTEND,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_BACKTEST,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_OPS,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_PF_CORE,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY external_prod
    class D_EX_CORE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_OPS_RESILIENCE,D_SHARED,D_INFRA_A2A,D_GOV_DRIFT,D_FRONTEND,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_BACKTEST external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_EX_CORE,D_GOV_OPS_RESILIENCE external_prod
```

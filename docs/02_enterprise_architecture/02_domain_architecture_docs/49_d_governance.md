...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_RISK,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_INTEGRATION,D_GOV_DRIFT,D_SHARED,D_OPS,D_GOV_AUDIT,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
    class D_EX_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INTEGRATION,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_OPS,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_SCRIPTS,D_GOV_RULE external_prod
    class D_EX_CORE external_design
```
...
> 本域与 28 个外部域直接连接（出边 164 条 + 入边 128 条 = 292 条）。只显示直接连接的域，不展开具体节点。

...
flowchart TD
    ...
    tests_governance_security_test_gct_001_rbac_to_audit_py -->|测试依赖 / test_depends| D_GOV_AUDIT
    D_SECURITY["对抗验证<br/>对抗验证，负责系统安全对抗测试、漏洞扫描和攻防验<br/>证<br/>Adversarial Validation<br/>跨域节点 / cross-domain<br/>(生产态 / production)"]
    tests_governance_security_test_gct_001_rbac_to_audit_py -->|测试依赖 / test_depends| D_SECURITY
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_DRIFT,D_GOV_AUDIT,D_SECURITY,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_EX_CORE,D_GOV_OPS_RESILIENCE,D_PF_CORE,D_PF_ALLOC external_prod
```

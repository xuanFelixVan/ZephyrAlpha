...
flowchart TD
    ...
    scripts_arch_guard_fitness_functions_check_pit_compliance_py -->|导入依赖 / import_depends| D_GOV_SCRIPTS
    ...
    class D_GOV_SCRIPTS,D_INTELLIGENCE,D_SHARED,D_EX_CORE,D_PF_CORE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_DATA,D_INTELLIGENCE,D_REPORTING,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_PF_ALLOC,D_FRONTEND,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_AUDIT external_prod
```

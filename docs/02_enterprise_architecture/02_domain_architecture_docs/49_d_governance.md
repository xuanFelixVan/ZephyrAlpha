...
flowchart TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_CODE_QUALITY,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED,D_GOV_OPS_RESILIENCE,D_DATA,D_GOV_SCRIPTS,D_EX_CORE,D_PF_CORE external_prod
```

...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_INFRA_RECOVERY,D_TRADING,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_RULE,D_FRONTEND,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_BACKTEST,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_INFRA_A2A,D_FRONTEND,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_BACKTEST external_prod
```

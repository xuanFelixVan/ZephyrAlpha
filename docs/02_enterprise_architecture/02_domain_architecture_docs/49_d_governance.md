...
flowchart TD
    ...
    tests_governance_shared_test_phase4_gate_check_py -->|测试依赖 / test_depends| D_AUTONOMY_CORE
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_TRADING,D_INTEGRATION,D_GOV_SCRIPTS,D_EX_CORE external_prod

...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_SHARED,D_INFRA_RECOVERY,D_INTELLIGENCE,D_TRADING,D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
...
flowchart TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_GOV_REPAIR external_prod
```
...
flowchart TD
    ...
    class D_INFRA_A2A,D_OPS,D_SHARED,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_SCRIPTS,D_SECURITY,D_PF_CORE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
    class D_EX_CORE external_design
```
...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_PF_CORE,D_GOV_RULE external_prod
    class D_EX_CORE external_design
```

...
graph TD
    ...
    class D_SHARED,D_RISK,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RECOVERY,D_TRADING,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_INTEGRATION,D_OPS,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_PF_CORE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
    class D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_INTELLIGENCE,D_RISK,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_PF_CORE,D_GOV_RULE,D_GOV_SCRIPTS external_prod
    class D_EX_CORE external_design
```

...
flowchart TD
    ...
    scripts_governance_d5_architecture_generators_zoomable_html_py["可缩放 Mermaid HTML 生成器（共享模块）。<br/>generators包的zoomable_html模块<br/>文件: generators/zoomable_html.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_a2a_init_py["governance/a2a 包入口<br/>管理governance.a2a子包加载<br/>文件: a2a/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_agent_spec_init_py["governance/agent-spec 包入口<br/>管理governance.agent-spec子包加载<br/>文件: agent-spec/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_architecture_contracts_py["架构契约<br/>治理包的architecture_contracts模块<br/>文件: architecture_governance/architecture_<br/>contracts.py<br/>(生产态 / production)"]
    src_zephyr_governance_architecture_governance_architecture_principles_py["装饰器：为函数标记适用的架构原则。<br/>治理包的architecture_principles模块<br/>文件: architecture_governance/architecture_<br/>principles.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_cross_env_consistency_py["跨环境一致性<br/>治理包的cross_env_consistency模块<br/>文件: architecture_governance/cross_env_<br/>consistency.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_architecture_governance_local_first_arch_py["本地首架构<br/>治理包的local_first_arch模块<br/>文件: architecture_governance/local_first_<br/>arch.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_bridges_spec_auditor_py["spec审计器<br/>治理包的spec_auditor模块<br/>文件: bridges/spec_auditor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_conversation_tax_detector_py["conversationtax检测器<br/>治理包的conversation_tax_detector模块<br/>文件: context_governance/conversation_tax_<br/>detector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_prompt_lifecycle_py["提示生命周期<br/>治理包的prompt_lifecycle模块<br/>文件: context_governance/prompt_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_context_governance_think_time_model_py["thinktime模型<br/>治理包的think_time_model模块<br/>文件: context_governance/think_time_model.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_data_lifecycle_py["数据生命周期<br/>治理/数据治理包的data_lifecycle模块<br/>文件: data_governance/data_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_data_quality_py["数据质量<br/>治理/数据治理包的data_quality模块<br/>文件: data_governance/data_quality.py<br/>(生产态 / production)"]
    src_zephyr_governance_data_governance_data_source_reliability_py["数据源可靠性<br/>治理/数据治理包的data_source_reliability模块<br/>文件: data_governance/data_source_reliability.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_data_governance_pricing_sync_py["pricing同步<br/>治理/数据治理包的pricing_sync模块<br/>文件: data_governance/pricing_sync.py<br/>(生产态 / production)"]
    src_zephyr_governance_data_governance_realtime_streaming_py["实时流式<br/>治理/数据治理包的realtime_streaming模块<br/>文件: data_governance/realtime_streaming.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_financial_governance_fsm_verifier_py["fsm验证器<br/>治理包的fsm_verifier模块<br/>文件: financial_governance/fsm_verifier.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_instrument_py["标的合约<br/>治理包的instrument模块<br/>文件: financial_governance/instrument.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_microstructure_defense_py["microstructure防御<br/>治理包的microstructure_defense模块<br/>文件: financial_governance/microstructure_<br/>defense.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_oms_risk_engine_py["oms风险引擎<br/>治理包的oms_risk_engine模块<br/>文件: financial_governance/oms_risk_engine.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_risk_matrix_py["风险矩阵<br/>治理包的risk_matrix模块<br/>文件: financial_governance/risk_matrix.py<br/>(生产态 / production)"]
    src_zephyr_governance_financial_governance_strategy_portfolio_py["策略组合<br/>治理包的strategy_portfolio模块<br/>文件: financial_governance/strategy_portfolio.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_implementations_default_experiment_pipeline_py["默认实验管线<br/>治理包的default_experiment_pipeline模块<br/>文件: implementations/default_experiment_<br/>pipeline.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_intelligence_governance_ai_self_diagnosis_py["AI自诊断<br/>治理包的ai_self_diagnosis模块<br/>文件: intelligence_governance/ai_self_<br/>diagnosis.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_intelligence_governance_confidence_quantifier_py["ConfidenceQuantifier — AI 置信度量化。<br/>治理包的confidence_quantifier模块<br/>文件: intelligence_governance/confidence_<br/>quantifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_intelligence_governance_multi_model_consensus_py["多模型共识<br/>治理包的multi_model_consensus模块<br/>文件: intelligence_governance/multi_model_<br/>consensus.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_lifecycle_governance_api_lifecycle_py["API生命周期<br/>治理包的api_lifecycle模块<br/>文件: lifecycle_governance/api_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_governance_lifecycle_governance_migration_strategy_py["迁移策略<br/>治理包的migration_strategy模块<br/>文件: lifecycle_governance/migration_strategy.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_lifecycle_governance_post_live_verification_py["提交实时验证<br/>治理包的post_live_verification模块<br/>文件: lifecycle_governance/post_live_<br/>verification.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_governance_integration_py["治理集成<br/>基础设施包的governance_integration模块<br/>文件: layer3_coordination/_governance_<br/>integration.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_engine_pipeline_base_py["管线基类<br/>治理包的pipeline_base模块<br/>文件: engine/pipeline_base.py<br/>(生产态 / production)"]

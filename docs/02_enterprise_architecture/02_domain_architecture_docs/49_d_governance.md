...
flowchart TD
    ...
    class D_SHARED,D_TRADING,D_INFRASTRUCTURE,D_GOV_OPS_RESILIENCE,D_SECURITY,D_EX_CORE,D_GOV_CODE_QUALITY,D_BACKTEST,D_FEEDBACK_LOOP,D_FRONTEND external_prod
```

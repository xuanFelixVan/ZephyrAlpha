...
flowchart TD
    ...
    tests_governance_conftest_py -->|测试依赖 / test_depends| D_SHARED
    ...
    tests_governance_trading_test_bus_factor_defense_py -->|测试依赖 / test_depends| D_FACTOR
    ...
    D_GOV_OPS_RESILIENCE -->|测试依赖 / test_depends| src_zephyr_governance_intelligence_governance_mvep_orchestrator_py
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_INFRA_A2A,D_FACTOR,D_INFRASTRUCTURE,D_TRADING,D_EX_CORE,D_PF_CORE,D_PF_ALLOC external_prod

...
flowchart TD
    ...
    class D_SECURITY,D_SHARED,D_INFRA_A2A,D_GOV_RULE,D_OPS,D_RISK,D_GOV_ENFORCEMENT,D_TRADING,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_PF_CORE external_prod

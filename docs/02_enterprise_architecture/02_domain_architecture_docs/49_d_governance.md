...
flowchart TD
    ...
    tests_governance_ops_test_ops_foundation_py -->|测试依赖 / test_depends| D_GOV_OPS_RESILIENCE
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INFRASTRUCTURE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_EX_CORE,D_PF_CORE external_prod
```

...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_AUDIT,D_INFRASTRUCTURE,D_FRONTEND external_prod

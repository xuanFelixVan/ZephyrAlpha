...
flowchart TD
    scripts_arch_guard_fitness_functions_check_kill_switch_latency_py["(生产态 / production)<br/>检查终止开关latency / check_kill_switch_<br/>latency<br/>Kill Switch 延迟门禁<br/>文件: fitness_functions/check_kill_<br/>switch_latency.py"]
    scripts_governance_meta_manage_kill_switch_py["(生产态 / production) 管理终止开关 /<br/>manage_kill_switch<br/>Kill Switch 管理工具<br/>文件: meta/manage_kill_switch.py"]

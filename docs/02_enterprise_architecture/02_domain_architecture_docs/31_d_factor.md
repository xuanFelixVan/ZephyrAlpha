...
> 按 architecture_layer 分层显示 因子（D_FACTOR）的模块分布。共 7 个模块 / 7 modules。
...
| 2 | src/zephyr/factor/alpha_signal_pipeline.py | src/zephyr/factor/alpha_signal_pipeli... | prototype | generated |
| 3 | src/zephyr/factor/base.py | src/zephyr/factor/base.py | production | generated |
| 4 | src/zephyr/factor/factor_base.py | src/zephyr/factor/factor_base.py | production | generated |
| 5 | src/zephyr/factor/momentum_factor.py | src/zephyr/factor/momentum_factor.py | prototype | generated |
| 6 | src/zephyr/factor/value_factor.py | src/zephyr/factor/value_factor.py | prototype | generated |

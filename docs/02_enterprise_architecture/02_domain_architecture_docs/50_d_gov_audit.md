...
| 域内依赖 | 173 | Internal Dependencies | 173 |
...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_FEEDBACK_LOOP,D_SHARED,D_GOV_DRIFT,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOV_RULE external_prod
```

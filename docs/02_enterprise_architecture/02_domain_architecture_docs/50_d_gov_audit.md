...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_SHARED,D_SECURITY,D_GOV_DRIFT,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE,D_INTEGRATION external_prod
```

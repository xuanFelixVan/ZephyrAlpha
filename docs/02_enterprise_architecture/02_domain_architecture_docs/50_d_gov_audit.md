...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_INTEGRATION,D_GOVERNANCE external_prod
```

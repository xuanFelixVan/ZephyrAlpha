...
flowchart TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_REPORTING,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_FBL_VERIFICATION external_prod
```

...
flowchart TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_RULE,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_SECURITY,D_INFRA_OPS external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_RULE,D_INFRA_RECOVERY,D_REPORTING,D_GOV_ENFORCEMENT,D_SECURITY,D_INFRA_OPS,D_GOVERNANCE,D_GOV_DRIFT,D_INTEGRATION external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_GOV_RULE,D_INFRA_OPS,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_prod
```

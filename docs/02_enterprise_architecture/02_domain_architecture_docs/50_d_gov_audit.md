...
flowchart TD
    ...
    tests_governance_audit_test_undefined_name_baseline_reconciler_py -->|测试依赖 / test_depends| D_GOV_CODE_QUALITY
    ...
    scripts_governance_repair_red_blue_test_py -->|导入依赖 / import_depends| D_GOV_SCRIPTS
    ...
    class D_GOV_ENFORCEMENT,D_REPORTING,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOVERNANCE,D_GOV_RULE,D_INFRA_OPS,D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_SECURITY,D_INTEGRATION external_prod
```

...
flowchart TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_DRIFT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_TRADING,D_INTEGRATION external_prod
```

...
flowchart TD
    ...
    src_zephyr_governance_audit_commit_gateway_abuse_monitor_reconciler_py -->|导入依赖 / import_depends| D_GOV_RULE
    ...
    class D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_RULE,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
```

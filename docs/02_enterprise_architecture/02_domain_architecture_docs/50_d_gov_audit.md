...
flowchart TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOVERNANCE,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_TRADING,D_AUTONOMY_CORE external_prod
```

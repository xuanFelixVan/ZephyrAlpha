...
flowchart TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_INFRA_OPS,D_GOV_SCRIPTS,D_GOV_RULE,D_AUTONOMY_CORE,D_FBL_VERIFICATION external_prod
```

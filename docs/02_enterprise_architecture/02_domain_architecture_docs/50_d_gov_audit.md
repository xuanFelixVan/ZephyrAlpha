...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_RULE external_prod
```

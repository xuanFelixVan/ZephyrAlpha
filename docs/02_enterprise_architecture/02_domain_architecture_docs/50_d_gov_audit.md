...
flowchart TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING,D_GOV_DRIFT,D_GOVERNANCE external_prod
```
...
flowchart TD
    ...
    class D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_SECURITY,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_RULE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_GOVERNANCE,D_INTEGRATION external_prod
```
...
flowchart TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_RULE,D_AUTONOMY_CORE,D_INTEGRATION,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```

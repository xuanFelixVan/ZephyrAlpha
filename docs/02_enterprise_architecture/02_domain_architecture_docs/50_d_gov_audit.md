...
flowchart TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_RULE,D_SHARED,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOVERNANCE,D_SECURITY,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY external_prod
```

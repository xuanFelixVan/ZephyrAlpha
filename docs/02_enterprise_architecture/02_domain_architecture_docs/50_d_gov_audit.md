...
flowchart TD
    ...
    src_zephyr_gov_audit_query_py -->|导入依赖 / import_depends| D_SHARED
    ...
    class D_GOV_SCRIPTS,D_SECURITY,D_SHARED,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOV_RULE,D_GOV_DRIFT external_prod
```

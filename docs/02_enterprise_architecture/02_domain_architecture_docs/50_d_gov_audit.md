...
flowchart TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_GOV_RULE,D_GOV_ENFORCEMENT,D_SECURITY,D_GOVERNANCE,D_GOV_DRIFT,D_TRADING,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
```

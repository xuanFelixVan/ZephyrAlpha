...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_SCRIPTS,D_INFRA_OPS,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_prod
```
...
| 35 | —真源优先级裁决器 / Test Truth Source Validator (audit/t... | → | D_GOV_DRIFT 漂移检测: Truth源验证器 / Truth Source Validator (rule_enforcement/... | 测试依赖 / test_depends |

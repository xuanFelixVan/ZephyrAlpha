...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_REPORTING,D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_INFRA_OPS,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_INFRASTRUCTURE external_prod
```

...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_GOV_RULE,D_SHARED,D_REPORTING,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_INFRA_OPS,D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_INTEGRATION external_prod
```

...
flowchart TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_GOV_RULE,D_INFRA_OPS,D_AUTONOMY_CORE,D_FBL_VERIFICATION,D_INFRA_RECOVERY external_prod
```

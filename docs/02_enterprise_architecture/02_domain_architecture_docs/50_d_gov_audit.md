...
flowchart TD
    ...
    class D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_REPORTING,D_SHARED,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_RULE,D_INFRA_RECOVERY,D_INFRA_OPS,D_SECURITY,D_GOVERNANCE,D_GOV_DRIFT external_prod
```

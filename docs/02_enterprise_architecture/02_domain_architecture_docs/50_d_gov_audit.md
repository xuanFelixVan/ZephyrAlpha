...
flowchart TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_REPORTING,D_SECURITY,D_GOV_RULE,D_INFRA_OPS,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_FBL_VERIFICATION,D_INFRASTRUCTURE,D_INTEGRATION external_prod
```

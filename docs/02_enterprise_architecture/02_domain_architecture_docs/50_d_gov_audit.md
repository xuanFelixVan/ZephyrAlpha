...
flowchart TD
    docs_03_modules_cross_layer_audit_orchestrator_blueprint_md["(设计态 / design) audit_orchestrator/blueprint.md<br/>文件: audit_orchestrator/blueprint.md"]
    docs_03_modules_domain_governance_audit_trail_blueprint_md["(设计态 / design) audit_trail/blueprint.md<br/>文件: audit_trail/blueprint.md"]
    ...
    src_zephyr_gov_audit_api_lifecycle_py["(生产态 / production) gov_audit/api_lifecycle.py<br/>文件: gov_audit/api_lifecycle.py"]
    ...
    src_zephyr_gov_audit_changelog_manager_py["(生产态 / production) gov_audit/changelog_manager.py<br/>文件: gov_audit/changelog_manager.py"]
    src_zephyr_gov_audit_cli_py["(生产态 / production) gov_audit/cli.py<br/>文件: gov_audit/cli.py"]
    src_zephyr_gov_audit_code_archaeology_py["(生产态 / production) gov_audit/code_archaeology.py<br/>文件: gov_audit/code_archaeology.py"]
    ...
    src_zephyr_gov_audit_corporate_actions_py["(生产态 / production) gov_audit/corporate_actions.py<br/>文件: gov_audit/corporate_actions.py"]
    src_zephyr_gov_audit_delegation_auditor_py["(生产态 / production) gov_audit/delegation_auditor.py<br/>文件: gov_audit/delegation_auditor.py"]
    src_zephyr_gov_audit_dora_metrics_py["(生产态 / production) gov_audit/dora_metrics.py<br/>文件: gov_audit/dora_metrics.py"]
    ...
    src_zephyr_gov_audit_external_tool_audit_py["(生产态 / production) gov_audit/external_tool_audit.py<br/>文件: gov_audit/external_tool_audit.py"]
    ...
    src_zephyr_gov_audit_glossary_matrix_py["(生产态 / production) gov_audit/glossary_matrix.py<br/>文件: gov_audit/glossary_matrix.py"]
    src_zephyr_gov_audit_incremental_review_py["(生产态 / production) gov_audit/incremental_review.py<br/>文件: gov_audit/incremental_review.py"]
    ...
    src_zephyr_gov_audit_log_rotation_py["(生产态 / production) gov_audit/log_rotation.py<br/>文件: gov_audit/log_rotation.py"]
    ...
    src_zephyr_gov_audit_observability_dashboard_py["(生产态 / production) gov_audit/observability_dashboard.py<br/>文件: gov_audit/observability_dashboard.py"]
    src_zephyr_gov_audit_pipeline_runner_py["(生产态 / production) gov_audit/pipeline_runner.py<br/>文件: gov_audit/pipeline_runner.py"]
    src_zephyr_gov_audit_privacy_py["(生产态 / production) audit-trail.privacy — MOD-INF-020 · PII 检测与脱敏<br/>文件: gov_audit/privacy.py"]
    src_zephyr_gov_audit_provenance_tracker_py["(生产态 / production) gov_audit/provenance_tracker.py<br/>文件: gov_audit/provenance_tracker.py"]
    src_zephyr_gov_audit_replay_engine_py["(生产态 / production) gov_audit/replay_engine.py<br/>文件: gov_audit/replay_engine.py"]
    src_zephyr_gov_audit_retention_py["(生产态 / production) gov_audit/retention.py<br/>文件: gov_audit/retention.py"]
    ...
    src_zephyr_gov_audit_spec_auditor_py["(生产态 / production) gov_audit/spec_auditor.py<br/>文件: gov_audit/spec_auditor.py"]
    ...
    src_zephyr_gov_audit_supply_chain_security_py["(生产态 / production) gov_audit/supply_chain_security.py<br/>文件: gov_audit/supply_chain_security.py"]
    src_zephyr_gov_audit_trust_ring_manager_py["(生产态 / production) gov_audit/trust_ring_manager.py<br/>文件: gov_audit/trust_ring_manager.py"]
    src_zephyr_gov_audit_wqa_scorer_py["(生产态 / production) gov_audit/wqa_scorer.py<br/>文件: gov_audit/wqa_scorer.py"]
    src_zephyr_gov_enforcement_behavioral_admission_ai_code_standards_py["(生产态 / production) behavioral_admission/ai_code_standards.py<br/>文件: behavioral_admission/ai_code_standards.py"]
    src_zephyr_gov_enforcement_behavioral_admission_mcp_result_push_py["(生产态 / production) behavioral_admission/mcp_result_push.py<br/>文件: behavioral_admission/mcp_result_push.py"]
    ...
    src_zephyr_gov_enforcement_behavioral_admission_vibe_coding_enforcer_py["(生产态 / production) behavioral_admission/vibe_coding_enforcer.py<br/>文件: behavioral_admission/vibe_coding_enforcer.py"]
    ...
    src_zephyr_governance_financial_governance_financial_compliance_py["(生产态 / production) financial_governance/financial_compliance.py<br/>文件: financial_governance/financial_compliance.py"]
    ...
    src_zephyr_governance_semantic_audit_semantic_cache_py["(生产态 / production) semantic_audit/semantic_cache.py<br/>文件: semantic_audit/semantic_cache.py"]
    ...
    src_zephyr_gov_audit_anomaly_py["(生产态 / production) gov_audit/anomaly.py<br/>文件: gov_audit/anomaly.py"]
    src_zephyr_gov_audit_audit_admission_controller_py["(生产态 / production) gov_audit/audit_admission_controller.py<br/>文件: gov_audit/audit_admission_controller.py"]
    src_zephyr_gov_audit_bridge_py["(生产态 / production) gov_audit/bridge.py<br/>文件: gov_audit/bridge.py"]
    ...
    src_zephyr_gov_audit_query_py["(生产态 / production) gov_audit/query.py<br/>文件: gov_audit/query.py"]
    src_zephyr_gov_audit_resource_aware_pool_py["(生产态 / production) gov_audit/resource_aware_pool.py<br/>文件: gov_audit/resource_aware_pool.py"]
    src_zephyr_gov_audit_text_to_finding_adapter_py["(生产态 / production) gov_audit/text_to_finding_adapter.py<br/>文件: gov_audit/text_to_finding_adapter.py"]
    ...
    src_zephyr_gov_audit_delegation_bridge_py["(生产态 / production) gov_audit/delegation_bridge.py<br/>文件: gov_audit/delegation_bridge.py"]
    src_zephyr_gov_audit_feedback_bridge_py["(生产态 / production) gov_audit/feedback_bridge.py<br/>文件: gov_audit/feedback_bridge.py"]
    src_zephyr_gov_audit_finding_ingest_py["(生产态 / production) gov_audit/finding_ingest.py<br/>文件: gov_audit/finding_ingest.py"]
    src_zephyr_gov_audit_indexer_py["(生产态 / production) gov_audit/indexer.py<br/>文件: gov_audit/indexer.py"]
    ...
    src_zephyr_gov_audit_models_py["(生产态 / production) gov_audit/models.py<br/>文件: gov_audit/models.py"]
    src_zephyr_gov_audit_tiered_storage_bridge_py["(生产态 / production) gov_audit/tiered_storage_bridge.py<br/>文件: gov_audit/tiered_storage_bridge.py"]
    src_zephyr_gov_audit_trust_bridge_py["(生产态 / production) gov_audit/trust_bridge.py<br/>文件: gov_audit/trust_bridge.py"]
    ...
    src_zephyr_gov_audit_contracts_py["(生产态 / production) gov_audit/contracts.py<br/>文件: gov_audit/contracts.py"]
    src_zephyr_gov_audit_finding_model_py["(生产态 / production) gov_audit/finding_model.py<br/>文件: gov_audit/finding_model.py"]
    ...
    src_zephyr_gov_audit_tiered_storage_py["(生产态 / production) gov_audit/tiered_storage.py<br/>文件: gov_audit/tiered_storage.py"]
    src_zephyr_gov_audit_trust_engine_py["(生产态 / production) gov_audit/trust_engine.py<br/>文件: gov_audit/trust_engine.py"]
    src_zephyr_gov_audit_writer_py["(生产态 / production) gov_audit/writer.py<br/>文件: gov_audit/writer.py"]
...
| 30 | D_GOV_ENFORCEMENT 规则执行: GitCommitGateway — 全项目唯一合法 git commit 入口（OPS-2... | → | error_pattern_consumer_reconciler.py — AI 行为遥测 JSONL... | 导入依赖 / import_depends |
| 31 | D_GOV_ENFORCEMENT 规则执行: GitCommitGateway — 全项目唯一合法 git commit 入口（OPS-2... | → | git_performance_monitor_reconciler.py — git 性能持续监控... | 导入依赖 / import_depends |
| 32 | D_GOV_ENFORCEMENT 规则执行: GitCommitGateway — 全项目唯一合法 git commit 入口（OPS-2... | → | reconcile_runner.py — Reconciler 链路异步化（Ruling:100P... | 导入依赖 / import_depends |
| 33 | D_GOV_ENFORCEMENT 规则执行: GitCommitGateway — 全项目唯一合法 git commit 入口（OPS-2... | → | reconciliation_registry.py — GitCommitGateway post-commi... | 导入依赖 / import_depends |
| 34 | D_GOV_ENFORCEMENT 规则执行: GitCommitGateway — 全项目唯一合法 git commit 入口（OPS-2... | → | remediation_progress_reconciler.py — 治本进度持久化 + 新... | 导入依赖 / import_depends |
| 35 | D_GOV_ENFORCEMENT 规则执行: GitCommitGateway — 全项目唯一合法 git commit 入口（OPS-2... | → | runtime_violation_snapshot_reconciler.py — trae_060 §5 ... | 导入依赖 / import_depends |
| 36 | D_GOV_ENFORCEMENT 规则执行: GitCommitGateway — 全项目唯一合法 git commit 入口（OPS-2... | → | workspace_hygiene_reconciler.py — 工作区卫生自动清理 rec... | 导入依赖 / import_depends |
| 37 | D_GOV_ENFORCEMENT 规则执行: session_worktree.py — AI 对话 worktree 物理隔离 helper（... | → | ai_error_pattern_library.py — AI 错误模式库（只读查询接... | 导入依赖 / import_depends |
| 38 | D_GOV_ENFORCEMENT 规则执行: session_worktree.py — AI 对话 worktree 物理隔离 helper（... | → | reconcile_runner.py — Reconciler 链路异步化（Ruling:100P... | 导入依赖 / import_depends |
| 39 | D_GOV_ENFORCEMENT 规则执行: session_worktree.py — AI 对话 worktree 物理隔离 helper（... | → | reconciliation_registry.py — GitCommitGateway post-commi... | 导入依赖 / import_depends |
| 40 | D_GOV_ENFORCEMENT 规则执行: session_worktree.py — AI 对话 worktree 物理隔离 helper（... | → | workspace_hygiene_reconciler.py — 工作区卫生自动清理 rec... | 导入依赖 / import_depends |
| 41 | D_GOV_OPS_RESILIENCE 运维弹性治理: PhaseManager->GateEngine 检查注册表桥梁 — 44 个阶段门控... | → | audit-trail.integrity — MOD-INF-020 · 密码学完整性验证... | 导入依赖 / import_depends |
| 42 | D_GOV_OPS_RESILIENCE 运维弹性治理: PhaseManager->GateEngine 检查注册表桥梁 — 44 个阶段门控... | → | gov_audit/query.py | 导入依赖 / import_depends |
| 43 | D_GOV_OPS_RESILIENCE 运维弹性治理: PhaseManager->GateEngine 检查注册表桥梁 — 44 个阶段门控... | → | gov_audit/writer.py | 导入依赖 / import_depends |
| 44 | D_GOV_OPS_RESILIENCE 运维弹性治理: PhaseManager->GateEngine 检查注册表桥梁 — 44 个阶段门控... | → | SYS-MASTER-001 Compliance Checker (rule_enforcement/sys_m... | 导入依赖 / import_depends |
| 45 | D_GOV_OPS_RESILIENCE 运维弹性治理: blast_radius — MOD-INF-028 §3.1 Stage 9 (resilience_gov... | → | 语义审计管线数据模型 — MOD-INF-028 §4.2 (semantic_audit... | 导入依赖 / import_depends |
| 46 | D_GOV_OPS_RESILIENCE 运维弹性治理: security_governance/tamper_evident_log.py | → | gov_audit/writer.py | 导入依赖 / import_depends |
| 47 | D_GOV_RULE 规则治理: 能力检查器 / Capability Checker (rule_enforcement/capabil... | → | gov_audit/bridge.py | 导入依赖 / import_depends |
| 48 | D_GOV_RULE 规则治理: 门禁紧急旁路 / Gate Override (gate_engine/gate_override.py) | → | gov_audit/bridge.py | 导入依赖 / import_depends |
| 49 | D_GOV_SCRIPTS 脚本治理: Red/Blue Team Adversarial Test v3: SYS-MASTER-001 + MOD-M... | → | SYS-MASTER-001 Compliance Checker (rule_enforcement/sys_m... | 导入依赖 / import_depends |
| 50 | D_GOV_SCRIPTS 脚本治理: scripts/governance/rebuild_audit_index.py — 重建 audit-t... | → | gov_audit/indexer.py | 导入依赖 / import_depends |
| 51 | D_GOV_SCRIPTS 脚本治理: architecture_health_dashboard.py — 架构健康度仪表盘（自... | → | runtime_violation_snapshot.py — trae_060 §5 evidence 运... | 导入依赖 / import_depends |
| 52 | D_GOV_SCRIPTS 脚本治理: session_startup_health_check.py — AI session 启动健康度... | → | reconciliation_registry.py — GitCommitGateway post-commi... | 导入依赖 / import_depends |
| 53 | D_INFRASTRUCTURE 跨层契约基础设施: backup_reconciler.py — 灾备备份系统事件触发器（post-comm... | → | reconciliation_registry.py — GitCommitGateway post-commi... | 导入依赖 / import_depends |
| 54 | D_INFRA_RECOVERY 回滚恢复: G-CT-004 契约：Rollback -> Audit 记录回滚操作. (rollback/... | → | gov_audit/contracts.py | 导入依赖 / import_depends |
| 55 | D_INFRA_RECOVERY 回滚恢复: RollbackAbuseDetector — 回滚滥用检测。 (rollback/rollbac... | → | gov_audit/query.py | 导入依赖 / import_depends |
| 56 | D_INFRA_RECOVERY 回滚恢复: RollbackAuditNexus — 回滚审计记录聚合到 Nexus AuditLog. ... | → | gov_audit/writer.py | 导入依赖 / import_depends |
| 57 | D_INFRA_RECOVERY 回滚恢复: RollbackExecutor — 回滚执行器核心封装。 (rollback/rollba... | → | gov_audit/writer.py | 导入依赖 / import_depends |
| 58 | D_INFRA_RUNTIME 运行时集成: AssetLifecycle — MOD-INF-026 L5 ITIL生命周期自动化管理器... | → | gov_audit/writer.py | 导入依赖 / import_depends |
| 59 | D_INFRA_RUNTIME 运行时集成: auto_fix_engine/engine.py | → | gov_audit/finding_model.py | 导入依赖 / import_depends |
| 60 | D_INFRA_RUNTIME 运行时集成: resource_optimization.py - MAPE-K autonomic resource opti... | → | gov_audit/bridge.py | 导入依赖 / import_depends |
| 61 | D_INTEGRATION 管线路由: 接收 RED 问题,生成修复文本。LLM 只润色不做判断。不可用时... | → | 语义审计管线数据模型 — MOD-INF-028 §4.2 (semantic_audit... | 导入依赖 / import_depends |
| 62 | D_INTEGRATION 管线路由: MCP 全量工具调用审计日志（MOD-INF-013 §12 Step 4）。 (mc... | → | gov_audit/writer.py | 导入依赖 / import_depends |
| 63 | D_INTEGRATION 管线路由: PipelineOrchestrator — M1-M11 管线协调器 (integration/pi... | → | gov_audit/writer.py | 导入依赖 / import_depends |
| 64 | D_SECURITY 对抗验证: G-CT-001 RBAC->Audit 桥接契约 - RBACAuditBridge. (access_... | → | gov_audit/contracts.py | 导入依赖 / import_depends |
| 65 | D_SECURITY 对抗验证: orphan_judge/judge.py | → | gov_audit/finding_model.py | 导入依赖 / import_depends |
| 66 | D_SECURITY 对抗验证: adversarial_validation/defense_runner.py | → | gov_audit/finding_model.py | 导入依赖 / import_depends |
| 67 | D_SECURITY 对抗验证: llm_security/behavior_audit_logger.py | → | gov_audit/bridge.py | 导入依赖 / import_depends |
| 68 | D_SECURITY 对抗验证: self_protection/isolation.py | → | gov_audit/bridge.py | 导入依赖 / import_depends |
| 69 | D_TRADING 交易运营: trading/verdict_engine.py | → | gov_audit/models.py | 导入依赖 / import_depends |

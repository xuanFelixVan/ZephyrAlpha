...
flowchart TD
    ...
    class D_GOV_RULE,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_SECURITY,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_OPS,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_prod
```

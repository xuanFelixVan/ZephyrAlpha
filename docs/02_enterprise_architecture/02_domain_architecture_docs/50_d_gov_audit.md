...
flowchart TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_RULE,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_INTEGRATION,D_INFRASTRUCTURE external_prod
```

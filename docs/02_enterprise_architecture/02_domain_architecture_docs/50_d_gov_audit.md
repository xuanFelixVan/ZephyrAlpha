...
flowchart TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_GOV_RULE,D_FEEDBACK_LOOP,D_INFRA_OPS,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_INFRASTRUCTURE external_prod
```

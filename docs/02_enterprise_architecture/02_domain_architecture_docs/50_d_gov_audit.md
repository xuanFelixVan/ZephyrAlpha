...
flowchart TD
    ...
    class D_GOV_RULE,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_SECURITY,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_INTEGRATION,D_GOVERNANCE,D_GOV_SCRIPTS external_prod
```

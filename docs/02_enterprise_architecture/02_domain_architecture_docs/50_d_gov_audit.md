...
flowchart TD
    docs_03_modules_cross_layer_audit_orchestrator_blueprint_md["蓝图<br/>audit_orchestrator/blueprint 模块<br/>⛔ 该域，设计已就绪，等待开发排期<br/>文件: audit_orchestrator/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_audit_trail_blueprint_md["蓝图<br/>audit_trail/blueprint 模块<br/>⛔ 该域，设计已就绪，等待开发排期<br/>文件: audit_trail/blueprint.md<br/>(设计态 / design)"]
    ...
    src_zephyr_gov_audit_dora_metrics_py["dora指标<br/>gov_audit/dora_metrics 模块<br/>文件: gov_audit/dora_metrics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_audit_glossary_matrix_py["词汇表矩阵<br/>gov_audit/glossary_matrix 模块<br/>文件: gov_audit/glossary_matrix.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_audit_observability_dashboard_py["可观测性仪表盘<br/>gov_audit/observability_dashboard 模块<br/>文件: gov_audit/observability_dashboard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_audit_spec_auditor_py["spec审计器<br/>gov_audit/spec_auditor 模块<br/>文件: gov_audit/spec_auditor.py<br/>(生产态 / production)"]

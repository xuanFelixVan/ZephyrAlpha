...
graph TD
    ...
    class D_SHARED,D_REPORTING,D_SECURITY,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_RULE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_GOVERNANCE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_RULE,D_AUTONOMY_CORE,D_SECURITY,D_GOV_SCRIPTS,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```

...
flowchart TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_FEEDBACK_LOOP,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
```

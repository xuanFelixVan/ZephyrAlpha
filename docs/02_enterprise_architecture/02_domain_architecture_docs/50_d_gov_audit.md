...
flowchart TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_CODE_QUALITY,D_SECURITY,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_INTEGRATION,D_AUTONOMY_CORE,D_SECURITY,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_prod
```

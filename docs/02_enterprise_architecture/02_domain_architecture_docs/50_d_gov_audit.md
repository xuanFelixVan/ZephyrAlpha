...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOV_DRIFT,D_SECURITY,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_TRADING,D_AUTONOMY_CORE external_prod
```

...
flowchart TD
    ...
    scripts_governance_repair_red_blue_test_py ~~~ scripts_governance_test_remediation_progress_smoke_py
    ...
    scripts_governance_repair_rollback_depgraph_py ~~~ src_zephyr_gov_audit_anomaly_py
    ...
    scripts_governance_repair_audit_design_completeness_py -->|config_depends / config_depends| scripts_governance_repair_rollback_depgraph_py
...
flowchart TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_INTEGRATION,D_GOVERNANCE,D_INFRASTRUCTURE external_prod
```

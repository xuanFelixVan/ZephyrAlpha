...
graph TD
    ...
    D_SECURITY -.->|import_depends| src_zephyr_security_llm_defense_llm_security_gateway_py
    ...
    class D_AUDITTEST,D_SECURITY external_design
```

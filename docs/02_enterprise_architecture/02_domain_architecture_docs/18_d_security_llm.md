...
graph TD
    ...
    D_GOVERNANCE -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_alignment_scorer_py
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | runtime / runtime |
...
| 42 | D_AUTONOMY_CORE 自治核心: MOD-INF-019: Agent Spec — Agent Observability ... | → | alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | runtime / runtime |
...
| 45 | D_GOVERNANCE 生命周期管理: blueprint.md | → | alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | contract / contract |

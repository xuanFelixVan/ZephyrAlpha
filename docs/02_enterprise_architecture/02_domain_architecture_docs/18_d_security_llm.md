...
graph TD
    ...
    D_GOVERNANCE -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
    D_GOVERNANCE -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
    D_AUTONOMY_CORE["(原型态 / prototype) D_AUTONOMY_CORE"]
    D_AUTONOMY_CORE -.->|runtime / runtime| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
    D_AUDITTEST["(原型态 / prototype) D_AUDITTEST"]
    D_AUDITTEST -.->|runtime / runtime| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | LLM Security Gateway Dashboard Module. (__init_... | runtime / runtime |
...
| 43 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | LLM Security Gateway Dashboard Module. (__init_... | runtime / runtime |
| 44 | D_GOVERNANCE 生命周期管理: blueprint.md | → | LLM Security Gateway Dashboard Module. (__init_... | contract / contract |
| 45 | D_GOVERNANCE 生命周期管理: blueprint.md | → | LLM Security Gateway Dashboard Module. (__init_... | contract / contract |

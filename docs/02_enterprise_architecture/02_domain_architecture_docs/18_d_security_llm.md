...
graph TD
    ...
    D_GOVERNANCE -.->|contract| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
    D_GOVERNANCE -.->|contract| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
    D_AUTONOMY_CORE["D_AUTONOMY_CORE prototype"]
    D_AUTONOMY_CORE -.->|runtime| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|runtime| src_zephyr_security_llm_defense_llm_security_dashboard_init_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_llm_defense_llm_security_gateway_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_llm_defense_llm_security_gateway_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_llm_defense_llm_security_patterns_injection_patterns_py
    ...
    class D_AUTONOMY_CORE,D_AUDITTEST external_design
```
...
|------|:---:|---------|
| D_AUDITTEST | 41 | runtime,test_depends |

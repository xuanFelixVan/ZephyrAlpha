...
graph TD
    ...
    D_GOVERNANCE -.->|contract| src_zephyr_security_llm_defense_llm_security_adversarial_robustness_py
    D_GOVERNANCE -.->|contract| src_zephyr_security_llm_defense_llm_security_adversarial_robustness_py
    D_AUTONOMY_CORE["D_AUTONOMY_CORE prototype"]
    D_AUTONOMY_CORE -.->|runtime| src_zephyr_security_llm_defense_llm_security_adversarial_robustness_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|runtime| src_zephyr_security_llm_defense_llm_security_adversarial_robustness_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_security_llm_defense_llm_security_layers_l2_prompt_protection_py
    D_AUDITTEST -.->|test_depends| src_zephyr_security_llm_defense_llm_security_layers_l6_observability_py

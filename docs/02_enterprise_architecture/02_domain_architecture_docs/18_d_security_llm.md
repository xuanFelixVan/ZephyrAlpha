...
| 42 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | runtime / runtime |
| 43 | D_GOVERNANCE 生命周期管理: blueprint.md | → | alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | contract / contract |
| 44 | D_GOVERNANCE 生命周期管理: blueprint.md | → | alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | contract / contract |
...
| 50 | D_INFRA_TELEMETRY 可观测性: health subsystem — 模块健康注册与 LifecycleMan... | → | alignment_scorer.py — 对齐评分 (B11, DD85, TAS... | runtime / runtime |

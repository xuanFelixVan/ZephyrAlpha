...
graph TD
    ...
    src_zephyr_governance_kb_pipeline_extract_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_governance_kb_pipeline_ingest_py -.->|import_depends| D_GOV_ENFORCEMENT
    src_zephyr_governance_kb_pipeline_ingest_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_governance_kb_sentiment_engine_analyze_py -.->|import_depends| D_GOV_ENFORCEMENT
    D_INTEGRATION["D_INTEGRATION prototype"]
    src_zephyr_governance_kb_sentiment_engine_analyze_py -.->|import_depends| D_INTEGRATION
    src_zephyr_governance_kb_sentiment_engine_analyze_py -.->|import_depends| D_GOVERNANCE
    D_INTELLIGENCE["D_INTELLIGENCE production"]
    src_zephyr_governance_kb_sentiment_engine_analyze_py -.->|import_depends| D_INTELLIGENCE
...
> 按 architecture_layer 分层显示 架构文档治理（D_GOV_DOCS）的模块分布。共 49 个模块 / 49 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (49 modules)             │
├──────────────────────────────────────────────────────────────────┤
...
│   src/zephyr/governance/kb/kb_engine/chromadb_init.py  [proto... │
...
| 17 | src/zephyr/governance/kb/kb_engine/chromadb_init.py | src/zephyr/governance/kb/kb_engine/ch... | prototype | generated |
| 18 | src/zephyr/governance/kb/kb_engine/embedding_migrate.py | src/zephyr/governance/kb/kb_engine/em... | prototype | generated |
| 19 | src/zephyr/governance/kb/kb_engine/kb_gate_task.py | src/zephyr/governance/kb/kb_engine/kb... | prototype | generated |
| 20 | src/zephyr/governance/kb/kb_gate_task.py | src/zephyr/governance/kb/kb_gate_task.py | prototype | generated |
| 21 | src/zephyr/governance/kb/kb_repo.py | src/zephyr/governance/kb/kb_repo.py | prototype | generated |
| 22 | src/zephyr/governance/kb/ke_tombstone.py | src/zephyr/governance/kb/ke_tombstone.py | prototype | generated |
| 23 | src/zephyr/governance/kb/load_bearing.py | src/zephyr/governance/kb/load_bearing.py | prototype | generated |
| 24 | src/zephyr/governance/kb/migration/__init__.py | src/zephyr/governance/kb/migration/__... | prototype | generated |
| 25 | src/zephyr/governance/kb/migration/embedding_migrate.py | src/zephyr/governance/kb/migration/em... | prototype | generated |
| 26 | src/zephyr/governance/kb/migration/kb_gate_task.py | src/zephyr/governance/kb/migration/kb... | prototype | generated |
| 27 | src/zephyr/governance/kb/pipeline/__init__.py | src/zephyr/governance/kb/pipeline/__i... | prototype | generated |
| 28 | src/zephyr/governance/kb/pipeline/activate.py | src/zephyr/governance/kb/pipeline/act... | prototype | generated |
| 29 | src/zephyr/governance/kb/pipeline/analyze.py | src/zephyr/governance/kb/pipeline/ana... | prototype | generated |
| 30 | src/zephyr/governance/kb/pipeline/batch_ingest.py | src/zephyr/governance/kb/pipeline/bat... | prototype | generated |
| 31 | src/zephyr/governance/kb/pipeline/extract.py | src/zephyr/governance/kb/pipeline/ext... | prototype | generated |
| 32 | src/zephyr/governance/kb/pipeline/ingest.py | src/zephyr/governance/kb/pipeline/ing... | prototype | generated |
| 33 | src/zephyr/governance/kb/quiet_period_monitor.py | src/zephyr/governance/kb/quiet_period... | prototype | generated |
| 34 | src/zephyr/governance/kb/reranker.py | src/zephyr/governance/kb/reranker.py | prototype | generated |
| 35 | src/zephyr/governance/kb/safety_brake.py | src/zephyr/governance/kb/safety_brake.py | prototype | generated |
| 36 | src/zephyr/governance/kb/self_test.py | src/zephyr/governance/kb/self_test.py | prototype | generated |
| 37 | src/zephyr/governance/kb/sentiment_engine/__init__.py | src/zephyr/governance/kb/sentiment_en... | prototype | generated |
| 38 | src/zephyr/governance/kb/sentiment_engine/analyze.py | src/zephyr/governance/kb/sentiment_en... | prototype | generated |
| 39 | src/zephyr/governance/kb/storage/__init__.py | src/zephyr/governance/kb/storage/__in... | prototype | generated |
| 40 | src/zephyr/governance/kb/storage/_backend_protocol.py | src/zephyr/governance/kb/storage/_bac... | prototype | generated |
| 41 | src/zephyr/governance/kb/storage/chromadb_init.py | src/zephyr/governance/kb/storage/chro... | prototype | generated |
| 42 | src/zephyr/governance/kb/storage/graph_validator.py | src/zephyr/governance/kb/storage/grap... | prototype | generated |
| 43 | src/zephyr/governance/kb/storage/kb_repo.py | src/zephyr/governance/kb/storage/kb_r... | prototype | generated |
| 44 | src/zephyr/governance/kb/storage/unified_memory_api.py | src/zephyr/governance/kb/storage/unif... | prototype | generated |
| 45 | src/zephyr/governance/kb/supply_chain_graph_engine/__init... | src/zephyr/governance/kb/supply_chain... | prototype | generated |
| 46 | src/zephyr/governance/kb/supply_chain_graph_engine/graph_... | src/zephyr/governance/kb/supply_chain... | prototype | generated |
| 47 | src/zephyr/governance/kb/unified_memory_api.py | src/zephyr/governance/kb/unified_memo... | prototype | generated |
| 48 | src/zephyr/governance/kb/verify.py | src/zephyr/governance/kb/verify.py | prototype | generated |
| 49 | src/zephyr/governance/kb/vms_memory_backend.py | src/zephyr/governance/kb/vms_memory_b... | prototype | generated |

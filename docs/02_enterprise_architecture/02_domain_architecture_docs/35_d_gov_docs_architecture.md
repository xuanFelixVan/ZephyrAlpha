...
title: D-GOV_DOCS architecture_docs架构图
version: "1.0"
status: active
date: 2026-06-27
...
# 35_d_gov_docs / architecture_docs 架构图

> **文档作用 / Purpose**: 以ASCII art可视化展示architecture_docs（D-GOV_DOCS）功能域的模块分层架构和依赖关系。
...
- **文件名规则 / File Naming**: `{编号:02d}_{域ID小写}_architecture.md`，如 `35_d_gov_docs_architecture.md`

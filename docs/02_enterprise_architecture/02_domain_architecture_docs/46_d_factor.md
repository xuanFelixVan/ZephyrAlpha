...
flowchart TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_DATA,D_FUNDAMENTAL_SIGNAL,D_PF_CORE,D_BACKTEST,D_GOV_OPS_RESILIENCE,D_EX_CORE,D_GOVERNANCE external_prod

...
flowchart TD
    ...
    class D_DATA,D_INFRASTRUCTURE,D_SHARED,D_INFRA_RUNTIME,D_PF_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_EX_CORE,D_BACKTEST,D_FUNDAMENTAL_SIGNAL external_prod

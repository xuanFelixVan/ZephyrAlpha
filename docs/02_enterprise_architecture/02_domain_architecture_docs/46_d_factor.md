...
flowchart TD
    src_zephyr_factor_alpha_signal_pipeline_py["(生产态 / production) factor/alpha_signal_pipeline.py<br/>文件: factor/alpha_signal_pipeline.py"]
    ...
    src_zephyr_factor_bus_factor_defense_py["(生产态 / production) factor/bus_factor_defense.py<br/>文件: factor/bus_factor_defense.py"]
...
| 4 | factor/alpha_signal_pipeline.py | → | D_FUNDAMENTAL_SIGNAL 基本面信号: Alpha信号管线 / Alpha Signal Pipeline (signal_fundamental... | 导入依赖 / import_depends |
...
| 4 | D_FUNDAMENTAL_SIGNAL 基本面信号: Alpha信号管线 / Alpha Signal Pipeline (signal_fundamental... | → | ZephyrAlpha — D_FACTOR Alpha Factor Layer (factor/factor... | 导入依赖 / import_depends |

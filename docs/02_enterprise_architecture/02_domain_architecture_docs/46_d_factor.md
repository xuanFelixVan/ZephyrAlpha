...
flowchart TD
    ...
    src_zephyr_factor_core_evaluation_init_py["D-FACTOR-03 因子评估包——IC/IR/OOS 正率<br/>/过拟合检测。<br/>core/evaluation<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: evaluation/__init__.py<br/>(生产态 / production)"]

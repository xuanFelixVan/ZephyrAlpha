...
flowchart TD
    ...
    class D_FUNDAMENTAL_SIGNAL,D_SHARED,D_DATA,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_PF_CORE,D_EX_CORE,D_BACKTEST,D_GOVERNANCE external_prod

...
flowchart TD
    ...
    class D_DATA,D_INFRA_RUNTIME,D_SHARED,D_INFRASTRUCTURE,D_PF_CORE,D_EX_CORE,D_GOVERNANCE,D_BACKTEST,D_GOV_OPS_RESILIENCE,D_FUNDAMENTAL_SIGNAL external_prod

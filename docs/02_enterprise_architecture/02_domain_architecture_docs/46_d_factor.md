...
flowchart TD
    ...
    class D_DATA,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_PF_CORE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod

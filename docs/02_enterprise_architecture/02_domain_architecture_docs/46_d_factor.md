...
flowchart TD
    ...
    class D_DATA,D_INFRASTRUCTURE,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_BACKTEST,D_GOVERNANCE,D_PF_CORE,D_INFRA_RUNTIME,D_EX_CORE,D_GOV_OPS_RESILIENCE external_prod

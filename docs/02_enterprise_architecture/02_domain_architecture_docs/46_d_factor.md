...
flowchart TD
    ...
    class D_DATA,D_INFRASTRUCTURE,D_SHARED,D_INFRA_RUNTIME,D_BACKTEST,D_GOVERNANCE,D_PF_CORE,D_EX_CORE,D_GOV_OPS_RESILIENCE,D_FUNDAMENTAL_SIGNAL external_prod

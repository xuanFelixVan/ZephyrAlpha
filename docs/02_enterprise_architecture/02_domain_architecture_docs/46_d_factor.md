...
flowchart TD
    ...
    src_zephyr_factor_bus_factor_defense_py["总线因子防御<br/>bus_factor_defense<br/>文件: factor/bus_factor_defense.py<br/>(生产态 / production)"]
    ...
    src_zephyr_factor_core_ctr001_consumer_init_py["core/ctr001_consumer 包入口<br/>CTR-001 NormalizedMarketData 消费者包入口<br/>文件: ctr001_consumer/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_factor_core_evaluation_init_py["D-FACTOR-03 因子评估包——IC/IR/OOS 正率<br/>/过拟合检测。<br/>文件: evaluation/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_factor_core_ctr001_consumer_converter_py["转换器<br/>CTR-001 NormalizedMarketData 消费者——数据适配层<br/>converter<br/>文件: ctr001_consumer/converter.py<br/>(生产态 / production)"]
    ...
    src_zephyr_factor_governance_init_py["factor/governance 包入口<br/>D_FACTOR governance 子包——因子生命周期治理工具链<br/>文件: governance/__init__.py<br/>(生产态 / production)"]

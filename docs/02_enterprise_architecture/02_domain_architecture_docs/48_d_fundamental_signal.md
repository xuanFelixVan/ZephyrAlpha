...
flowchart TD
    ...
    src_zephyr_signal_fundamental_audit_init_py -->|config_depends / config_depends| src_zephyr_signal_fundamental_audit_signal_audit_logger_py
    ...
    class D_TRADING,D_INFRASTRUCTURE,D_SHARED,D_GOVERNANCE,D_FACTOR external_prod

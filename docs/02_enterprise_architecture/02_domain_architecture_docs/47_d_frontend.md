...
flowchart TD
    ...
    src_zephyr_frontend_implementations_default_approval_gateway_py["(设计态 / design) 默认审批网关 / default_approval_gateway<br/>默认approval网关，前端的门禁，在关键节点检查是否放行。<br/>文件: implementations/default_approval_gateway.py"]

...
graph TD
    ...
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| D_SECURITY_LLM
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| D_INFRA_RUNTIME
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY_LLM,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    ...
    D_INTELLIGENCE -.->|import_depends| src_zephyr_integration_vector_memory_in_memory_fake_vms_py
    D_TRADING -->|import_depends| src_zephyr_integration_shared_schema_schemas_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    ...
    class D_SHARED,D_TRADING,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE,D_INTEGRATION_GATEWAY,D_INTELLIGENCE external_design
```
...
| D_INTEGRATION_GATEWAY | 3 | import_depends |

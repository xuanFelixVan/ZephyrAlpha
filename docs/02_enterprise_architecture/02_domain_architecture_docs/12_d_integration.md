...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INFRA_RECOVERY,D_TRADING,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE,D_AUDITTEST,D_SECURITY,D_INTELLIGENCE external_design
```

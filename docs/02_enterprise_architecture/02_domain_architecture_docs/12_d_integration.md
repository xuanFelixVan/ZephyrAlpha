...
graph TD
    ...
    D_INFRA_RUNTIME -->|import_depends| src_zephyr_integration_shared_schema_schemas_py
    D_AUDITTEST -.->|test_depends| src_zephyr_integration_vector_memory_hybrid_retriever_py
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING external_prod
    class D_GOVERNANCE,D_AUDITTEST,D_SECURITY external_design
```

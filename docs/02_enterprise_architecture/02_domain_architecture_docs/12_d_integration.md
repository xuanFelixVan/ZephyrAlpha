...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY_LLM,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING external_prod
...
│   in_process_vector_memory.py → vector_bridge.py                 │

...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    ...
    src_zephyr_integration_shared_schema_init_py -.->|config_depends| src_zephyr_integration_shared_schema_schemas_py
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING external_prod

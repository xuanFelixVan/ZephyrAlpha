...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_TRADING,D_AUDITTEST external_design
```

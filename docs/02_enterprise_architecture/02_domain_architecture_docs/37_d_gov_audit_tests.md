...
title: D-GOV_AUDIT_TESTS audit_test_suite架构文档
version: "1.0"
status: active
date: 2026-06-25
...
# 37_d_gov_audit_tests / audit_test_suite

> **文档作用 / Purpose**: 展示 audit_test_suite（D-GOV_AUDIT_TESTS）功能域的模块清单、域内依赖关系和跨域依赖关系，供架构审查和域治理参考。
...
|------|------|-------|-------|
| 编号 | 37 | Number | 37 |
| 域ID | D-GOV_AUDIT_TESTS | Domain ID | D-GOV_AUDIT_TESTS |
...
共 152 个模块（按路径排序，全部显示）

| 模块路径 / Module Path | 模块名称 / Module Name | 设计成熟度 / Maturity | 构建状态 / Build Status |
|---------|---------|-----------|---------|
| tests/agent_rbac/test_rbac_auto_lifecycle.py |  | production | generated |
| tests/e2e/test_mcp_full_lifecycle_e2e.py |  | production | generated |
| tests/test_adversarial_extreme.py |  | production | generated |
| tests/test_arbiter.py |  | production | generated |
| tests/test_audit_chain_verifier.py |  | prototype | generated |
| tests/test_audit_orchestrator_e2e.py |  | prototype | deprecated |
| tests/test_audit_self_healer_e2e.py |  | prototype | deprecated |
| tests/test_auto_fix_autopilot.py |  | production | generated |
| tests/test_auto_fix_phase_manager.py |  | production | generated |
| tests/test_auto_fix_red_blue.py |  | production | generated |
| tests/test_auto_runtime_e2e.py |  | production | generated |
| tests/test_auto_runtime_fle_integration.py |  | production | generated |
| tests/test_budget_event_driven.py |  | production | generated |
| tests/test_budget_lifecycle_e2e.py |  | production | generated |
| tests/test_budget_shutdown.py |  | production | generated |
| tests/test_circadian_red_blue_drill.py |  | production | generated |
| tests/test_conductor.py |  | production | generated |
| tests/test_f10_red_blue.py |  | production | generated |
| tests/test_f18_automation.py |  | production | generated |
| tests/test_f18_redblue.py |  | production | generated |
| tests/test_f1_event_trigger.py |  | production | generated |
| tests/test_f21_auto_run.py |  | production | generated |
| tests/test_f21_auto_shutdown.py |  | production | generated |
| tests/test_f21_auto_startup.py |  | production | generated |
| tests/test_f21_event_driven.py |  | production | generated |
| tests/test_f5_auto_shutdown.py |  | production | generated |
| tests/test_f5_auto_startup.py |  | production | generated |
| tests/test_f5_e2e_lifecycle.py |  | production | generated |
| tests/test_f5_event_startup.py |  | production | generated |
| tests/test_f5_red_team_extreme.py |  | production | generated |
| tests/test_fl_safety_gate_l28_l29.py |  | production | generated |
| tests/test_fl_safety_gate_l36_l37.py |  | production | generated |
| tests/test_fl_safety_gate_l38_l39.py |  | production | generated |
| tests/test_fl_safety_gate_l40_l41.py |  | production | generated |
| tests/test_fl_safety_gate_l42_l43.py |  | production | generated |
| tests/test_fl_safety_gate_l44_l45.py |  | production | generated |
| tests/test_fl_safety_gate_l46_l47.py |  | production | generated |
| tests/test_fl_safety_gate_l48_l49.py |  | production | generated |
| tests/test_fl_safety_gate_l50_l51.py |  | production | generated |
| tests/test_fl_safety_gate_l52_l53.py |  | production | generated |
| tests/test_fl_safety_gate_l54_l55.py |  | production | generated |
| tests/test_fl_safety_gate_l56_l57.py |  | production | generated |
| tests/test_fl_safety_gate_l58_l59.py |  | production | generated |
| tests/test_fl_safety_gate_l60_l61.py |  | production | generated |
| tests/test_fl_safety_gate_l62_l63.py |  | production | generated |
| tests/test_fl_safety_gate_l64_l65.py |  | production | generated |
| tests/test_fl_safety_gate_l66_l67.py |  | production | generated |
| tests/test_g_trae_003.py |  | production | generated |
| tests/test_g_trae_004.py |  | production | generated |
| tests/test_g_trae_006.py |  | production | generated |
| tests/test_g_trae_007.py |  | production | generated |
| tests/test_g_trae_008.py |  | production | generated |
| tests/test_g_trae_009.py |  | production | generated |
| tests/test_g_trae_010.py |  | production | generated |
| tests/test_g_trae_011.py |  | production | generated |
| tests/test_g_trae_012.py |  | production | generated |
| tests/test_g_trae_016.py |  | production | generated |
| tests/test_g_trae_017.py |  | production | generated |
| tests/test_g_trae_018.py |  | production | generated |
| tests/test_g_trae_020.py |  | production | generated |
| tests/test_g_trae_021.py |  | production | generated |
| tests/test_g_trae_022.py |  | production | generated |
| tests/test_g_trae_023.py |  | production | generated |
| tests/test_g_trae_024.py |  | production | generated |
| tests/test_g_trae_025.py |  | production | generated |
| tests/test_g_trae_026.py |  | production | generated |
| tests/test_g_trae_027.py |  | production | generated |
| tests/test_g_trae_028.py |  | production | generated |
| tests/test_g_trae_029.py |  | production | generated |
| tests/test_g_trae_030.py |  | production | generated |
| tests/test_g_trae_031.py |  | production | generated |
| tests/test_g_trae_032.py |  | production | generated |
| tests/test_g_trae_033.py |  | production | generated |
| tests/test_g_trae_034.py |  | production | generated |
| tests/test_g_trae_035.py |  | production | generated |
| tests/test_g_trae_036.py |  | production | generated |
| tests/test_g_trae_037.py |  | production | generated |
| tests/test_g_trae_038.py |  | production | generated |
| tests/test_g_trae_039.py |  | production | generated |
| tests/test_g_trae_040.py |  | production | generated |
| tests/test_g_trae_041.py |  | production | generated |
| tests/test_g_trae_042.py |  | production | generated |
| tests/test_g_trae_043.py |  | production | generated |
| tests/test_g_trae_044.py |  | production | generated |
| tests/test_g_trae_045.py |  | production | generated |
| tests/test_g_trae_046.py |  | production | generated |
| tests/test_g_trae_047.py |  | production | generated |
| tests/test_g_trae_048.py |  | production | generated |
| tests/test_g_trae_049.py |  | production | generated |
| tests/test_g_trae_050.py |  | production | generated |
| tests/test_g_trae_051.py |  | production | generated |
| tests/test_g_trae_052.py |  | production | generated |
| tests/test_g_trae_053.py |  | production | generated |
| tests/test_g_trae_054.py |  | production | generated |
| tests/test_g_trae_055.py |  | production | generated |
| tests/test_ide_health_daemon.py |  | production | generated |
| tests/test_l00_data_source.py |  | production | generated |
| tests/test_l02_alpha_factor.py |  | production | generated |
| tests/test_l03_signal_generation.py |  | production | generated |
| tests/test_l04_risk_management.py |  | production | generated |
| tests/test_l05_portfolio_construction.py |  | production | generated |
| tests/test_l06_trade_execution.py |  | production | generated |
| tests/test_l07_post_trade_analytics.py |  | production | generated |
| tests/test_l08_human_ai_interface.py |  | production | generated |
| tests/test_l09_research_innovation.py |  | production | generated |
| tests/test_l10_compliance.py |  | production | generated |
| tests/test_l11_ml_platform.py |  | production | generated |
| tests/test_l13_experimentation.py |  | production | generated |
| tests/test_legal_audit_chain.py |  | prototype | generated |
| tests/test_lock_release_uncommitted.py |  | production | generated |
| tests/test_mcp_launcher.py |  | production | generated |
| tests/test_phase_executor_rule_enforcement.py |  | production | generated |
| tests/test_pipeline_orchestrator_auto.py |  | production | generated |
| tests/test_post_doc_review.py |  | production | generated |
| tests/test_red_blue_validator_tests.py |  | production | generated |
| tests/test_safety_gate_l28_l29.py |  | production | generated |
| tests/test_safety_gate_l36_l37.py |  | production | generated |
| tests/test_safety_gate_l38_l39.py |  | production | generated |
| tests/test_safety_gate_l40_l41.py |  | production | generated |
| tests/test_safety_gate_l42_l43.py |  | production | generated |
| tests/test_safety_gate_l44_l45.py |  | production | generated |
| tests/test_safety_gate_l46_l47.py |  | production | generated |
| tests/test_safety_gate_l48_l49.py |  | production | generated |
| tests/test_safety_gate_l50_l51.py |  | production | generated |
| tests/test_safety_gate_l52_l53.py |  | production | generated |
| tests/test_safety_gate_l54_l55.py |  | production | generated |
| tests/test_safety_gate_l56_l57.py |  | production | generated |
| tests/test_safety_gate_l58_l59.py |  | production | generated |
| tests/test_safety_gate_l60_l61.py |  | production | generated |
| tests/test_safety_gate_l62_l63.py |  | production | generated |
| tests/test_safety_gate_l64_l65.py |  | production | generated |
| tests/test_safety_gate_l66_l67.py |  | production | generated |
| tests/test_self_heal_agent.py |  | prototype | generated |
| tests/test_self_health_monitor.py |  | prototype | generated |
| tests/test_task_repo_auto_commit.py |  | production | generated |
| tests/test_trading_session_lifecycle.py |  | production | generated |
| tests/test_validate_rule_frontmatter_red_blue.py |  | production | generated |
| tests/unit/audit_trail/__init__.py |  | prototype | deprecated |
| tests/unit/audit_trail/test_audit_core.py |  | prototype | generated |
| tests/unit/audit_trail/test_import_smoke_audit_trail.py |  | prototype | generated |
| tests/unit/feedback_loop/test_scheduler_integration.py |  | production | generated |
| tests/unit/pipeline/conftest.py |  | production | generated |
| tests/unit/resource_optimization/test_self_healing.py |  | prototype | generated |
| tests/unit/telemetry/test_l12_telemetry.py |  | production | generated |
| tests/unit/test_concurrency_guard.py |  | production | generated |
| tests/unit/test_context_pipeline_auto.py |  | production | generated |
| tests/unit/test_l08_interface.py |  | production | generated |
| tests/unit/test_l12_telemetry_unit.py |  | production | generated |
| tests/unit/vector_memory/test_vms_adversarial_hijack.py |  | production | generated |
| tests/unit/vector_memory/test_vms_adversarial_injection.py |  | production | generated |
| tests/unit/vector_memory/test_vms_automation.py |  | production | generated |
| tests/unit/vector_memory/test_vms_lifecycle.py |  | production | generated |
...
```mermaid
graph TD
    subgraph D_GOV_AUDIT_TESTS["D-GOV_AUDIT_TESTS audit_test_suite"]
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_test_g_trae_021_py,tests_test_g_trae_022_py,tests_test_g_trae_023_py,tests_test_g_trae_024_py,tests_test_g_trae_025_py,tests_test_g_trae_026_py,tests_test_g_trae_027_py,tests_test_g_trae_028_py,tests_test_g_trae_029_py,tests_test_g_trae_030_py,tests_test_g_trae_031_py,tests_test_g_trae_032_py,tests_test_g_trae_033_py,tests_test_g_trae_034_py,tests_test_g_trae_035_py,tests_test_g_trae_036_py,tests_test_g_trae_037_py,tests_test_g_trae_038_py,tests_test_g_trae_039_py,tests_test_g_trae_040_py,tests_test_g_trae_041_py,tests_test_g_trae_042_py,tests_test_g_trae_043_py,tests_test_g_trae_044_py,tests_test_g_trae_045_py,tests_test_g_trae_046_py,tests_test_g_trae_047_py,tests_test_g_trae_048_py,tests_test_g_trae_049_py,tests_test_g_trae_050_py production
```
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_unit_vector_memory_test_vms_automation_py,tests_unit_vector_memory_test_vms_lifecycle_py production
```
...
| D-GOV-ENFORCEMENT | 2 | test_depends |

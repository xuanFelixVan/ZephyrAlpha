...
graph TD
    ...
    class D_GOV_RULE,D_INTELLIGENCE,D_GOV_KB,D_GOV_AUDIT,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_GOV_KB,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
```
...
|:--:|---------|:--:|---------|---------|
| 1 | D_AUTONOMY_CORE 自治核心: Agent Spec -> Pipeline 集成桥接层 (__init__.py) | → | blueprint.md | contract / contract |

...
flowchart TD
    ...
    docs_03_modules_cross_layer_auto_runtime_core_blueprint_md["蓝图<br/>auto_runtime_core 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: auto_runtime_core/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_behavioral_auditor_blueprint_md["蓝图<br/>behavioral_auditor 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: behavioral_auditor/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_context_engine_blueprint_md["蓝图<br/>context_engine 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: context_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_database_blueprint_md["蓝图<br/>database 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: database/blueprint.md<br/>(设计态 / design)"]
    ...
    docs_03_modules_cross_layer_feedback_loop_blueprint_md["蓝图<br/>feedback_loop 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: feedback_loop/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_gate_engine_blueprint_md["蓝图<br/>gate_engine 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: gate_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_model_capability_exam_blueprint_md["蓝图<br/>model_capability_exam 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: model_capability_exam/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_orphan_judge_blueprint_md["蓝图<br/>orphan_judge 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: orphan_judge/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_pipeline_blueprint_md["蓝图<br/>pipeline 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: pipeline/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md["蓝图<br/>red_blue_validator 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: red_blue_validator/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md["资源优化引擎蓝图<br/>资源优化引擎蓝图（blueprint.md）<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: resource_optimization_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_semantic_auditor_blueprint_md["蓝图<br/>semantic_auditor 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: semantic_auditor/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_shared_core_blueprint_md["蓝图<br/>shared_core 模块蓝图（_cross_<br/>layer），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: shared_core/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_core_agent_spec_blueprint_md["蓝图<br/>agent_spec 模块蓝图（_domain_autonomy_<br/>core），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: agent_spec/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_core_rollback_system_blueprint_md["蓝图<br/>rollback_system 模块蓝图（_domain_autonomy_<br/>core），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: rollback_system/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md["蓝图<br/>budget_enforcer 模块蓝图（_domain_autonomy_<br/>perm），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: budget_enforcer/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_perm_escalation_protocol_blueprint_md["蓝图<br/>escalation_protocol 模块蓝图（_domain_autonomy_<br/>perm），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: escalation_protocol/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_blueprint_md["蓝图<br/>_domain_governance 模块蓝图（03_<br/>modules），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: _domain_governance/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md["蓝图<br/>code_dedup_engine 模块蓝图（_domain_<br/>governance），描述该模块的设计意图与架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: code_dedup_engine/blueprint.md<br/>(设计态 / design)"]
...
|:--:|---------|:--:|---------|---------|
| 1 | D_INFRA_RUNTIME 运行时集成: Redis热数据缓存 (infrastructure/h1_redis_hot) | → | 业务数据架构文档 (database/business_data_architecture.md) | import / import |

...
flowchart TD
    docs_03_modules_cross_layer_auto_fix_engine_blueprint_md["蓝图<br/>蓝图，自动修复引擎的模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: auto_fix_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_auto_runtime_core_blueprint_md["蓝图<br/>auto_runtime_<br/>core模块蓝图文档，描述该模块的设计意图和架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: auto_runtime_core/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_behavioral_auditor_blueprint_md["蓝图<br/>behavioral_<br/>auditor模块蓝图文档，描述该模块的设计意图和架构<br/>决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: behavioral_auditor/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_context_engine_blueprint_md["蓝图<br/>context_<br/>engine模块蓝图文档，描述该模块的设计意图和架构决<br/>策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: context_engine/blueprint.md<br/>(设计态 / design)"]
    ...
    docs_03_modules_cross_layer_feedback_loop_blueprint_md["蓝图<br/>feedback_<br/>loop模块蓝图文档，描述该模块的设计意图和架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: feedback_loop/blueprint.md<br/>(设计态 / design)"]
    ...
    docs_03_modules_cross_layer_model_capability_exam_blueprint_md["蓝图<br/>model_capability_<br/>exam模块蓝图文档，描述该模块的设计意图和架构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: model_capability_exam/blueprint.md<br/>(设计态 / design)"]
    ...
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md["蓝图<br/>red_blue_<br/>validator模块蓝图文档，描述该模块的设计意图和架<br/>构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: red_blue_validator/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md["资源优化引擎蓝图<br/>resource_optimization_<br/>engine模块蓝图文档，描述该模块的设计意图和架构决<br/>策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: resource_optimization_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_semantic_auditor_blueprint_md["蓝图<br/>semantic_<br/>auditor模块蓝图文档，描述该模块的设计意图和架构<br/>决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: semantic_auditor/blueprint.md<br/>(设计态 / design)"]
    ...
    docs_03_modules_domain_autonomy_core_rollback_system_blueprint_md["蓝图<br/>rollback_<br/>system模块蓝图文档，描述该模块的设计意图和架构决<br/>策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: rollback_system/blueprint.md<br/>(设计态 / design)"]
    ...
    docs_03_modules_domain_autonomy_perm_escalation_protocol_blueprint_md["蓝图<br/>escalation_<br/>protocol模块蓝图文档，描述该模块的设计意图和架构<br/>决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: escalation_protocol/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_blueprint_md["蓝图<br/>_domain_<br/>governance模块蓝图文档，描述该模块的设计意图和架<br/>构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: _domain_governance/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md["蓝图<br/>code_dedup_<br/>engine模块蓝图文档，描述该模块的设计意图和架构决<br/>策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: code_dedup_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_governance_automation_blueprint_md["脚本系统蓝图 — 第三条生产线的自动化审计与门禁<br/>governance_<br/>automation模块蓝图文档，描述该模块的设计意图和架<br/>构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: governance_automation/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_registry_governance_blueprint_md["注册表治理<br/>registry_<br/>governance模块蓝图文档，描述该模块的设计意图和架<br/>构决策<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: registry_governance/blueprint.md<br/>(设计态 / design)"]
    ...
    tests_governance_d8_doc_sync_test_sync_savepoint_isolation_py["测试syncsavepointisolation<br/>() 级联失败隔离验证（#ARCH-GUC-TRIGGER-FIX-001<br/>裁定 B / P1）<br/>test_sync_savepoint_isolation<br/>文件: d8_doc_sync/test_sync_savepoint_<br/>isolation.py<br/>(生产态 / production)"]

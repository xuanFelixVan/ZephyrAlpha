...
flowchart TD
    ...
    docs_03_modules_cross_layer_auto_runtime_core_blueprint_md["蓝图<br/>auto runtime core包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: auto_runtime_core/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_behavioral_auditor_blueprint_md["蓝图<br/>behavioral auditor包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: behavioral_auditor/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_context_engine_blueprint_md["蓝图<br/>context engine包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: context_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_database_blueprint_md["蓝图<br/>database包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: database/blueprint.md<br/>(设计态 / design)"]
    ...
    docs_03_modules_cross_layer_feedback_loop_blueprint_md["蓝图<br/>反馈闭环包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: feedback_loop/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_gate_engine_blueprint_md["蓝图<br/>gate engine包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: gate_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_model_capability_exam_blueprint_md["蓝图<br/>model capability exam包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: model_capability_exam/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_orphan_judge_blueprint_md["蓝图<br/>孤儿判定包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: orphan_judge/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_pipeline_blueprint_md["蓝图<br/>pipeline包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: pipeline/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md["蓝图<br/>红蓝验证包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: red_blue_validator/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md["资源优化引擎蓝图<br/>resource optimization engine包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: resource_optimization_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_semantic_auditor_blueprint_md["蓝图<br/>semantic auditor包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: semantic_auditor/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_cross_layer_shared_core_blueprint_md["蓝图<br/>shared core包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: shared_core/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_core_agent_spec_blueprint_md["蓝图<br/>agent spec包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: agent_spec/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_core_rollback_system_blueprint_md["蓝图<br/>rollback system包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: rollback_system/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md["蓝图<br/>budget enforcer包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: budget_enforcer/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_autonomy_perm_escalation_protocol_blueprint_md["蓝图<br/>escalation protocol包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: escalation_protocol/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_blueprint_md["蓝图<br/>domain governance包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: _domain_governance/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md["蓝图<br/>code dedup engine包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: code_dedup_engine/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_governance_automation_blueprint_md["脚本系统蓝图 — 第三条生产线的自动化审计与门禁<br/>governance automation包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: governance_automation/blueprint.md<br/>(设计态 / design)"]
    docs_03_modules_domain_governance_registry_governance_blueprint_md["注册表治理<br/>registry governance包的blueprint模块<br/>⛔ 治理文档域，设计已就绪，等待开发排期<br/>文件: registry_governance/blueprint.md<br/>(设计态 / design)"]
    ...
    class D_GOV_SCRIPTS,D_INFRA_RUNTIME external_prod
```

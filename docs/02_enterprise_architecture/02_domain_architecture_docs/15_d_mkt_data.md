...
> 按 architecture_layer 分层显示 行情数据（D_MKT_DATA）的模块分布。共 8 个模块 / 8 modules。
...
| 6 | src/zephyr/market_data/market_data.py | src/zephyr/market_data/market_data.py | prototype | generated |
| 7 | src/zephyr/market_data/models/__init__.py | src/zephyr/market_data/models/__init_... | prototype | generated |
| 8 | src/zephyr/market_data/services/__init__.py | src/zephyr/market_data/services/__ini... | prototype | generated |

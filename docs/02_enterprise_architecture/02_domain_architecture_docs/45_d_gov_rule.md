...
graph TD
    ...
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_end_to_end_walkthrough_py
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_GOV_SCRIPTS,D_SECURITY_LLM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_REPAIR,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE external_prod

...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_GOV_KB,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_KNOWLEDGE,D_SECURITY_LLM,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_KB,D_INTELLIGENCE external_prod
    class D_KNOWLEDGE,D_SECURITY_LLM,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_init_py -.->|config_depends / config_depends| src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_pipeline_py
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_KB external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
...
| 7 | rule_engine package — 规则引擎模块集合（ARCH-0... | → | D_GOV_ENFORCEMENT 规则执行: Rule Shadow Runner — v0.10.0 规则影子模式: 新.... | config_depends / config_depends |

...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
    class D_GOV_SCRIPTS external_design
```

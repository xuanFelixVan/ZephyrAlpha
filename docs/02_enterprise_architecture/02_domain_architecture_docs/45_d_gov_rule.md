...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_SHARED,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod
    class D_GOV_SCRIPTS,D_RISK,D_KNOWLEDGE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod

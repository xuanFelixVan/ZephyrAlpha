...
graph TD
    ...
    D_GOV_ENFORCEMENT -->|导入依赖 / import_depends| src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_override_py
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
    class D_GOV_SCRIPTS,D_GOV_KB,D_RISK external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_KNOWLEDGE,D_SECURITY_LLM,D_SECURITY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
    class D_GOV_KB,D_GOV_SCRIPTS,D_KNOWLEDGE,D_SECURITY_LLM external_design
```

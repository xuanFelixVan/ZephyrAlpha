...
graph TD
    ...
    class D_INTEGRATION,D_GOV_DRIFT,D_SHARED,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_DRIFT,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
    class D_GOV_ENFORCEMENT,D_KNOWLEDGE external_design
```

...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_INTEGRATION,D_GOV_ENFORCEMENT,D_SECURITY,D_AUTONOMY_CORE external_prod
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
    class D_GOV_SCRIPTS external_design
```

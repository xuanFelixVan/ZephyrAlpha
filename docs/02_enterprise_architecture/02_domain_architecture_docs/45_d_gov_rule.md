...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_KB external_prod
    class D_GOV_SCRIPTS,D_RISK,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_SECURITY,D_KNOWLEDGE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_INTEGRATION external_prod

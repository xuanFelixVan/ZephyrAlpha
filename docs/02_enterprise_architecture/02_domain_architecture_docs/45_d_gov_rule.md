...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
    class D_GOV_SCRIPTS,D_RISK,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_SHARED external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
    class D_GOV_SCRIPTS,D_RISK,D_KNOWLEDGE external_design
```

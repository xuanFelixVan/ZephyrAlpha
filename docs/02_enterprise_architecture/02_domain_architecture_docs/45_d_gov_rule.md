...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOV_DRIFT,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_KB,D_INTELLIGENCE external_prod
    class D_GOV_SCRIPTS,D_KNOWLEDGE,D_RISK external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_DRIFT,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_KB external_prod
    class D_GOV_SCRIPTS,D_KNOWLEDGE,D_RISK external_design
```

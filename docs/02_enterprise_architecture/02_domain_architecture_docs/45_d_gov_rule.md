...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_SECURITY,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_SECURITY external_prod
    class D_GOV_SCRIPTS external_design
```

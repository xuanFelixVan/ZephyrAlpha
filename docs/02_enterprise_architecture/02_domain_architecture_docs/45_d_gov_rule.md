...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_KB external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_INTEGRATION external_prod

...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOVERNANCE external_prod
    class D_GOV_SCRIPTS,D_GOV_KB external_design
```

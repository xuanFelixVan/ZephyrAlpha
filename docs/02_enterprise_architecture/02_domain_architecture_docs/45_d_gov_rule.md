...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE external_prod
    class D_KNOWLEDGE,D_RISK,D_GOV_SCRIPTS external_design
```

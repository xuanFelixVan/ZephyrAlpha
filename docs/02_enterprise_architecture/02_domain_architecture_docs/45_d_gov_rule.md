...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_INTEGRATION,D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_GOV_SCRIPTS external_design
```

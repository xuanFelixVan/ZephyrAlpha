...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOV_KB external_prod
    class D_GOV_SCRIPTS,D_SECURITY,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_SECURITY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_KB,D_GOV_REPAIR external_prod
    class D_GOV_SCRIPTS,D_SECURITY,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```

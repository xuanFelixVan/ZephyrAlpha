...
graph TD
    ...
    D_GOV_ENFORCEMENT -->|导入依赖 / import_depends| src_zephyr_gov_enforcement_rule_enforcement_integration_test_runner_py
    ...
    class D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_GOV_REPAIR external_prod
    class D_SECURITY,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_DATA external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT external_prod
```

...
graph TD
    ...
    class D_GOV_SCRIPTS,D_KNOWLEDGE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_INTEGRATION,D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod

...
graph TD
    ...
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_init_py -.->|config_depends / config_depends| src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_simulator_py
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOV_KB external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
| 7 | rule_engine package — 规则引擎模块集合（ARCH-0... | → | D_GOV_ENFORCEMENT 规则执行: RuleWatcher — YAML 规则文件变更检测与自动同步 ... | config_depends / config_depends |

...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_RISK external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    D_SIGLEGACY -.->|contract / contract| src_zephyr_factor_value_factor_py
...
| 4 | D_SIGLEGACY 信号遗留设计态: D_SIGNAL Signal Domain (__init__.py) | → | D_FACTOR — Value Factor (value_factor.py) | contract / contract |

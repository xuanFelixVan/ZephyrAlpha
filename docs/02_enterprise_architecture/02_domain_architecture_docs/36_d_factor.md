...
graph TD
    ...
    D_SIGLEGACY -.->|contract / contract| src_zephyr_factor_factor_base_py
...
| 4 | D_SIGLEGACY 信号遗留设计态: D_SIGNAL Signal Domain (__init__.py) | → | ZephyrAlpha — D_FACTOR Alpha Factor Layer (fac... | contract / contract |

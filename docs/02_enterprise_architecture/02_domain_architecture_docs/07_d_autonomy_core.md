...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_EX_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_FBL_DIAGNOSERS,D_ORCHESTRATOR,D_SECURITY,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_TRADING,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INTEGRATION,D_SHARED,D_FBL_DETECTORS,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_SECURITY,D_INTEGRATION,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_RULE external_prod
```

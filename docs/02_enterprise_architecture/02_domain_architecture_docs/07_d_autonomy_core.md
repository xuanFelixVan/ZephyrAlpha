...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_ORCHESTRATOR,D_EX_CORE,D_INTELLIGENCE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOV_KB,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_REPAIR,D_FEEDBACK_LOOP,D_SHARED,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_SHARED,D_FBL_VERIFICATION,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_INTEGRATION,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

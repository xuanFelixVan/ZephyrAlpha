...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY,D_GOV_CODE_QUALITY external_prod
    class D_SHARED,D_GOV_AUDIT,D_GOV_SCRIPTS,D_GOVERNANCE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_AUDIT,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_ORCHESTRATOR,D_GOV_AUDIT,D_INTEGRATION,D_SECURITY,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_TRADING,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_SHARED,D_INFRA_RUNTIME,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SHARED,D_FBL_VERIFICATION,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOVERNANCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INTEGRATION,D_FEEDBACK_LOOP,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_SCRIPTS,D_GOVERNANCE,D_INTELLIGENCE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_SECURITY,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

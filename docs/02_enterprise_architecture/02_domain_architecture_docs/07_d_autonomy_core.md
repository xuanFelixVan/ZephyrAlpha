...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_SHARED,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_TRADING,D_FBL_DIAGNOSERS,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_OPS,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_INTEGRATION,D_SECURITY,D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_CODE_QUALITY,D_GOV_REPAIR external_prod
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE external_design
```

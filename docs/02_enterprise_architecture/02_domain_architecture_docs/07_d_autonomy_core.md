...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_EX_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_AUDIT,D_INTEGRATION,D_SHARED,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_TRADING,D_INFRA_RUNTIME,D_GOV_REPAIR,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_OPS,D_SHARED,D_INTEGRATION,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

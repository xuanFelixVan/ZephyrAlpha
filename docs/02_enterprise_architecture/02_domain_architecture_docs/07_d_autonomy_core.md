...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_INTEGRATION,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_AUDIT,D_INTELLIGENCE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INTELLIGENCE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_SHARED,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_INFRASTRUCTURE,D_EX_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_INFRA_RUNTIME,D_INTEGRATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_SHARED,D_FBL_DIAGNOSERS,D_TRADING,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_EX_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_SECURITY,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOVERNANCE,D_OPS external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_INTEGRATION,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```
...
> 本域与 26 个外部域直接连接（出边 317 条 + 入边 48 条 = 365 条）。只显示直接连接的域，不展开具体节点。

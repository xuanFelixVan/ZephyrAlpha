...
graph TD
    ...
    class D_EX_CORE,D_GOV_AUDIT,D_ORCHESTRATOR,D_GOVERNANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_ORCHESTRATOR,D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INFRA_RECOVERY,D_SECURITY,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_INTEGRATION,D_ORCHESTRATOR,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_EX_CORE,D_SHARED,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_INTEGRATION,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_ORCHESTRATOR external_prod
```

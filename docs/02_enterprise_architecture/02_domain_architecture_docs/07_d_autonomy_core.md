...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_ORCHESTRATOR,D_INTELLIGENCE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_SECURITY external_prod
    class D_EX_CORE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INFRA_RECOVERY,D_TRADING,D_GOV_OPS_RESILIENCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FBL_DETECTORS,D_SECURITY,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOVERNANCE,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_RULE,D_GOV_REPAIR,D_GOV_CODE_QUALITY external_prod
    class D_INTEGRATION,D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_ORCHESTRATOR,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE,D_GOVERNANCE,D_SECURITY_LLM external_prod
...
graph TD
    ...
    src_zephyr_autonomy_core_skills_init_py -.->|config_depends| src_zephyr_autonomy_core_skills_skill_canary_py
    D_SHARED["D_SHARED production"]

...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INTEGRATION,D_TRADING external_prod
    class D_AUDITTEST external_design
```

...
graph TD
    ...
    src_zephyr_autonomy_core_all_skill_modules_py -.->|runtime / runtime| D_GOV_ENFORCEMENT
    ...
    src_zephyr_autonomy_core_all_skill_modules_py -.->|runtime / runtime| D_INFRA_A2A
    src_zephyr_autonomy_core_all_skill_modules_py -.->|contract / contract| D_GOVERNANCE
    src_zephyr_autonomy_core_all_skill_modules_py -.->|runtime / runtime| D_GOVERNANCE
    src_zephyr_autonomy_core_all_skill_modules_py -.->|data / data| D_GOVERNANCE
    D_SECURITY_LLM["(原型态 / prototype) D_SECURITY_LLM"]
    src_zephyr_autonomy_core_all_skill_modules_py -.->|runtime / runtime| D_SECURITY_LLM
    src_zephyr_autonomy_core_all_skill_modules_py -.->|runtime / runtime| D_GOVERNANCE
    src_zephyr_autonomy_core_all_skill_modules_py -.->|runtime / runtime| D_GOVERNANCE
    src_zephyr_autonomy_core_all_skill_modules_py -.->|runtime / runtime| D_GOVERNANCE
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_INFRA_A2A,D_SECURITY_LLM,D_KNOWLEDGE,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 2 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 3 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | data / data |
| 4 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 5 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 6 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 7 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 8 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 9 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: blueprint.md | contract / contract |
| 10 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | runtime / runtime |
...
| 15 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOV_DRIFT 漂移检测: blueprint.md | runtime / runtime |
| 16 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | runtime / runtime |
| 17 | skill_executor.py | → | D_GOV_ENFORCEMENT 规则执行: GateEngine — KMS G1-G6 + Orc G0/G7 + 交易 G10-... | 导入依赖 / import_depends |
| 18 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_INFRA_A2A A2A通信: G-CT-008 契约：A2A -> Audit 审计 Agent 间通信. ... | runtime / runtime |
...
| 34 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_KNOWLEDGE 知识管理: blueprint.md | contract / contract |
| 35 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_SECURITY 对抗验证: DryRun — 权限模拟与影响分析. (dry_run.py) | runtime / runtime |
| 36 | MOD-INF-019: Agent Spec — All Skill Modules (a... | → | D_SECURITY_LLM LLM防御: LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
...
| 128 | D_GOVERNANCE 生命周期管理: blueprint.md | → | MOD-INF-019: Agent Spec — All Skill Modules (a... | contract / contract |

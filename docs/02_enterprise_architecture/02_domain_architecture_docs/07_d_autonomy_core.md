...
graph TD
    ...
    src_zephyr_autonomy_core_agent_observability_py -.->|runtime| D_GOV_AUDIT
...
graph TD
    ...
    D_TRADING -->|import_depends| src_zephyr_autonomy_core_skills_skill_freshness_ext_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    src_zephyr_autonomy_core_skills_skill_postmortem_py -->|import_depends| src_zephyr_autonomy_core_skills_skill_loader_py
    src_zephyr_autonomy_core_skills_skill_prompt_opt_py -->|import_depends| src_zephyr_autonomy_core_skills_skill_loader_py
    D_GOVERNANCE["D_GOVERNANCE production"]
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_guardrails_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_idempotency_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_kya_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_kill_switch_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_model_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_knowledge_base_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_learning_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skills_skill_lineage_py
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_autonomy_core_skills_skill_tokenomics_py,src_zephyr_autonomy_core_skills_skill_translator_py,src_zephyr_autonomy_core_skills_skill_workflow_py,src_zephyr_autonomy_core_spec_engine_py,src_zephyr_autonomy_core_trigger_router_py,src_zephyr_autonomy_core_vibe_coding_quality_gate_py production
...
> 按 architecture_layer 分层显示 自治核心（D_AUTONOMY_CORE）的模块分布。共 96 个模块 / 96 modules。
...
│   src/zephyr/autonomy_core/context/context_evaluator.py  [pro... │
│   src/zephyr/autonomy_core/context/context_evictor.py  [produ... │
│   src/zephyr/autonomy_core/context/context_health_score.py  [... │
│   src/zephyr/autonomy_core/context/context_injector.py  [prod... │
│   src/zephyr/autonomy_core/context/context_model_strategy.py ... │
...
> 按 architecture_layer 分组的模块清单（共 96 个模块 / 96 modules）。
...
| 6 | src/zephyr/autonomy_core/context/ce_bootstrap.py | src/zephyr/autonomy_core/context/ce_b... | production | generated |
| 7 | src/zephyr/autonomy_core/context/ce_explain_cli.py | src/zephyr/autonomy_core/context/ce_e... | production | generated |
| 8 | src/zephyr/autonomy_core/context/ce_playground_v2.py | src/zephyr/autonomy_core/context/ce_p... | production | generated |
| 9 | src/zephyr/autonomy_core/context/ce_vibe_shortcuts.py | src/zephyr/autonomy_core/context/ce_v... | production | generated |
| 10 | src/zephyr/autonomy_core/context/context_assembler.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 11 | src/zephyr/autonomy_core/context/context_budget.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 12 | src/zephyr/autonomy_core/context/context_budget_tracker.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 13 | src/zephyr/autonomy_core/context/context_debt_score.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 14 | src/zephyr/autonomy_core/context/context_evaluator.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 15 | src/zephyr/autonomy_core/context/context_evictor.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 16 | src/zephyr/autonomy_core/context/context_health_score.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 17 | src/zephyr/autonomy_core/context/context_injector.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 18 | src/zephyr/autonomy_core/context/context_model_strategy.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 19 | src/zephyr/autonomy_core/context/context_outcome_tracker.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 20 | src/zephyr/autonomy_core/context/context_pipeline.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 21 | src/zephyr/autonomy_core/context/context_pipeline_auto.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 22 | src/zephyr/autonomy_core/context/context_playground.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 23 | src/zephyr/autonomy_core/context/context_rot_model.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 24 | src/zephyr/autonomy_core/context/context_rule_registry.py | src/zephyr/autonomy_core/context/cont... | production | generated |
| 25 | src/zephyr/autonomy_core/context/context_value_attributio... | src/zephyr/autonomy_core/context/cont... | production | generated |
| 26 | src/zephyr/autonomy_core/file_autoregister.py | src/zephyr/autonomy_core/file_autoreg... | prototype | generated |
| 27 | src/zephyr/autonomy_core/ide_watcher.py | src/zephyr/autonomy_core/ide_watcher.py | production | generated |
| 28 | src/zephyr/autonomy_core/integration/__init__.py | src/zephyr/autonomy_core/integration/... | prototype | generated |
| 29 | src/zephyr/autonomy_core/integration/pipeline_bridge.py | src/zephyr/autonomy_core/integration/... | production | generated |
| 30 | src/zephyr/autonomy_core/phase_planner.py | src/zephyr/autonomy_core/phase_planne... | production | generated |
| 31 | src/zephyr/autonomy_core/progressive_disclosure_injector.py | src/zephyr/autonomy_core/progressive_... | production | generated |
| 32 | src/zephyr/autonomy_core/prompt_registry.py | src/zephyr/autonomy_core/prompt_regis... | production | generated |
| 33 | src/zephyr/autonomy_core/self_evolution_fidelity_gate.py | src/zephyr/autonomy_core/self_evoluti... | production | generated |
| 34 | src/zephyr/autonomy_core/skill_rbac_registry.py | src/zephyr/autonomy_core/skill_rbac_r... | production | generated |
| 35 | src/zephyr/autonomy_core/skills/__init__.py | src/zephyr/autonomy_core/skills/__ini... | prototype | generated |
| 36 | src/zephyr/autonomy_core/skills/skill_attention.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 37 | src/zephyr/autonomy_core/skills/skill_breakage_checker.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 38 | src/zephyr/autonomy_core/skills/skill_cache_provider.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 39 | src/zephyr/autonomy_core/skills/skill_calibration.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 40 | src/zephyr/autonomy_core/skills/skill_canary.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 41 | src/zephyr/autonomy_core/skills/skill_cognitive_preservat... | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 42 | src/zephyr/autonomy_core/skills/skill_compliance.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 43 | src/zephyr/autonomy_core/skills/skill_consensus.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 44 | src/zephyr/autonomy_core/skills/skill_constructor.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 45 | src/zephyr/autonomy_core/skills/skill_context_isolation.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 46 | src/zephyr/autonomy_core/skills/skill_contract.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 47 | src/zephyr/autonomy_core/skills/skill_cross_model.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 48 | src/zephyr/autonomy_core/skills/skill_di.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 49 | src/zephyr/autonomy_core/skills/skill_discovery.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 50 | src/zephyr/autonomy_core/skills/skill_durable.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 51 | src/zephyr/autonomy_core/skills/skill_economics.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 52 | src/zephyr/autonomy_core/skills/skill_efficacy_calibrator.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 53 | src/zephyr/autonomy_core/skills/skill_evaluator.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 54 | src/zephyr/autonomy_core/skills/skill_executor.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 55 | src/zephyr/autonomy_core/skills/skill_explain.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 56 | src/zephyr/autonomy_core/skills/skill_factory.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 57 | src/zephyr/autonomy_core/skills/skill_feature_flags.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 58 | src/zephyr/autonomy_core/skills/skill_feedback.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 59 | src/zephyr/autonomy_core/skills/skill_freshness.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 60 | src/zephyr/autonomy_core/skills/skill_freshness_ext.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 61 | src/zephyr/autonomy_core/skills/skill_gitops.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 62 | src/zephyr/autonomy_core/skills/skill_guardrails.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 63 | src/zephyr/autonomy_core/skills/skill_idempotency.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 64 | src/zephyr/autonomy_core/skills/skill_kill_switch.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 65 | src/zephyr/autonomy_core/skills/skill_knowledge_base.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 66 | src/zephyr/autonomy_core/skills/skill_kya.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 67 | src/zephyr/autonomy_core/skills/skill_learning.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 68 | src/zephyr/autonomy_core/skills/skill_lifecycle.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 69 | src/zephyr/autonomy_core/skills/skill_lineage.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 70 | src/zephyr/autonomy_core/skills/skill_loader.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 71 | src/zephyr/autonomy_core/skills/skill_locking.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 72 | src/zephyr/autonomy_core/skills/skill_model.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 73 | src/zephyr/autonomy_core/skills/skill_model_evolution.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 74 | src/zephyr/autonomy_core/skills/skill_observability.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 75 | src/zephyr/autonomy_core/skills/skill_ontology.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 76 | src/zephyr/autonomy_core/skills/skill_postmortem.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 77 | src/zephyr/autonomy_core/skills/skill_prompt_cache.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 78 | src/zephyr/autonomy_core/skills/skill_prompt_opt.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 79 | src/zephyr/autonomy_core/skills/skill_registry.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 80 | src/zephyr/autonomy_core/skills/skill_resilience.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 81 | src/zephyr/autonomy_core/skills/skill_risk_mitigator.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 82 | src/zephyr/autonomy_core/skills/skill_router.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 83 | src/zephyr/autonomy_core/skills/skill_sandbox.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 84 | src/zephyr/autonomy_core/skills/skill_schema_registry.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 85 | src/zephyr/autonomy_core/skills/skill_security.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 86 | src/zephyr/autonomy_core/skills/skill_shadow.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 87 | src/zephyr/autonomy_core/skills/skill_silent_failure.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 88 | src/zephyr/autonomy_core/skills/skill_team_optimizer.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 89 | src/zephyr/autonomy_core/skills/skill_telemetry.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 90 | src/zephyr/autonomy_core/skills/skill_temperature.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 91 | src/zephyr/autonomy_core/skills/skill_tokenomics.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 92 | src/zephyr/autonomy_core/skills/skill_translator.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 93 | src/zephyr/autonomy_core/skills/skill_workflow.py | src/zephyr/autonomy_core/skills/skill... | production | generated |
| 94 | src/zephyr/autonomy_core/spec_engine.py | src/zephyr/autonomy_core/spec_engine.py | production | generated |
| 95 | src/zephyr/autonomy_core/trigger_router.py | src/zephyr/autonomy_core/trigger_rout... | production | generated |
| 96 | src/zephyr/autonomy_core/vibe_coding_quality_gate.py | src/zephyr/autonomy_core/vibe_coding_... | production | generated |

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY,D_TRADING external_prod
    class D_GOVERNANCE,D_COMPLIANCE,D_GOV_DRIFT,D_INFRA_A2A,D_SECURITY_LLM,D_INTELLIGENCE,D_AUDITTEST external_design
```

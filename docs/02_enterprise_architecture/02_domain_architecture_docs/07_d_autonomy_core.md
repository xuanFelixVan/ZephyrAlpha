...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_INTELLIGENCE,D_SHARED external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_autonomy_core_skills_skill_tokenomics_py

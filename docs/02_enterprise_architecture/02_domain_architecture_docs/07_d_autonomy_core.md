...
graph TD
    ...
    src_zephyr_autonomy_core_agent_observability_py -->|runtime| src_zephyr_autonomy_core_context_atomic_injector_py
    ...
    src_zephyr_autonomy_core_agent_observability_py -->|runtime| D_SECURITY
    ...
    src_zephyr_autonomy_core_agent_observability_py -->|runtime| D_INFRA_A2A
    ...
    src_zephyr_autonomy_core_agent_observability_py -->|runtime| D_SECURITY_LLM
    src_zephyr_autonomy_core_agent_observability_py -.->|runtime| D_GOVERNANCE
    src_zephyr_autonomy_core_agent_observability_py -.->|runtime| D_GOVERNANCE
    src_zephyr_autonomy_core_agent_observability_py -.->|runtime| D_GOVERNANCE
    ...
    src_zephyr_autonomy_core_agent_observability_py -.->|runtime| D_GOVERNANCE
    D_GOVERNANCE -.->|contract| src_zephyr_autonomy_core_context_atomic_injector_py
    D_GOVERNANCE -.->|contract| src_zephyr_autonomy_core_agent_observability_py
    D_GOVERNANCE -.->|runtime| src_zephyr_autonomy_core_context_atomic_injector_py
    D_GOVERNANCE -->|runtime| src_zephyr_autonomy_core_context_atomic_injector_py
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_DRIFT,D_KNOWLEDGE,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
| D_GOVERNANCE | 9 | contract,import_depends,runtime |
...
│                     [runtime] (1 条 / edges)                     │
├──────────────────────────────────────────────────────────────────┤
│   agent_observability.py → atomic_injector.py                    │
└──────────────────────────────────────────────────────────────────┘

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE,D_GOVERNANCE,D_SHARED,D_SECURITY_LLM external_prod
...
graph TD
    ...
    src_zephyr_autonomy_core_file_autoregister_py -.->|runtime| D_COMPLIANCE
    ...
    class D_GOVERNANCE,D_COMPLIANCE,D_GOV_DRIFT,D_INFRA_A2A,D_SECURITY_LLM,D_KNOWLEDGE,D_INTELLIGENCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_autonomy_core_skills_skill_security_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
| D_GOVERNANCE | 4 | contract,import_depends,runtime |

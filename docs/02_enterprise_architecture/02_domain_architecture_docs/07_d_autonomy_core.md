...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_INTEGRATION,D_GOV_KB,D_GOV_CODE_QUALITY external_prod
    class D_SHARED,D_GOVERNANCE,D_EX_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_ORCHESTRATOR,D_INTELLIGENCE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_SECURITY external_prod
    class D_SHARED,D_EX_CORE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FBL_DETECTORS,D_SECURITY,D_GOV_REPAIR,D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RECOVERY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE,D_INTEGRATION,D_INTELLIGENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_AUDIT,D_INTELLIGENCE,D_GOV_KB,D_SECURITY,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
...
> 本域与 25 个外部域直接连接（出边 308 条 + 入边 49 条 = 357 条）。只显示直接连接的域，不展开具体节点。

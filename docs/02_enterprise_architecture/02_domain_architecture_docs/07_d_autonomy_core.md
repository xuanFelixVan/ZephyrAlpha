...
graph TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_EX_CORE,D_GOVERNANCE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_GOVERNANCE,D_ORCHESTRATOR,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RECOVERY external_prod
    class D_SHARED,D_EX_CORE,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_SECURITY,D_FEEDBACK_LOOP,D_GOVERNANCE,D_SHARED,D_ORCHESTRATOR,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_OPS,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT,D_EX_CORE,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_SCRIPTS,D_EX_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_SECURITY,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

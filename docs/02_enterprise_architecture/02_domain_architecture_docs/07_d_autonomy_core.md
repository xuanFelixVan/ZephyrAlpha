...
graph TD
    ...
    class D_GOVERNANCE,D_EX_CORE,D_GOV_AUDIT,D_ORCHESTRATOR,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_SECURITY external_prod
    class D_SHARED,D_INTEGRATION,D_GOV_SCRIPTS,D_EX_CORE,D_INFRASTRUCTURE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SHARED,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_KB,D_INTELLIGENCE external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

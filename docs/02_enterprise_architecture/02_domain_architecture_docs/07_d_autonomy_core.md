...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_KNOWLEDGE,D_INTELLIGENCE,D_GOV_KB external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_AUDIT,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_OPS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_AUDIT,D_GOV_KB,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_GOV_CODE_QUALITY external_prod
    class D_SHARED,D_ORCHESTRATOR,D_GOV_SCRIPTS,D_GOVERNANCE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RECOVERY external_prod

...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_SECURITY,D_ORCHESTRATOR,D_SHARED,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_TRADING,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTEGRATION,D_GOV_RULE external_prod
```

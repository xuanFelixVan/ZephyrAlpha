...
graph TD
    ...
    class D_SECURITY_LLM,D_INTEGRATION,D_TRADING external_prod
    class D_GOVERNANCE,D_AUDITTEST,D_COMPLIANCE,D_GOV_DRIFT,D_INFRA_A2A,D_KNOWLEDGE,D_INTELLIGENCE external_design
```

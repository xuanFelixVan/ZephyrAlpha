...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_ORCHESTRATOR,D_EX_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOV_AUDIT,D_ORCHESTRATOR,D_FBL_DETECTORS,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SHARED,D_GOV_REPAIR,D_FBL_DETECTORS,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_DRIFT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_OPS,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_SHARED,D_INTEGRATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_INTEGRATION,D_FBL_DIAGNOSERS,D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTEGRATION,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_AUDIT,D_SECURITY,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```
...
> 本域与 26 个外部域直接连接（出边 317 条 + 入边 47 条 = 364 条）。只显示直接连接的域，不展开具体节点。

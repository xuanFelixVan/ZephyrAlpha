...
graph TD
    ...
    class D_SHARED,D_EX_CORE,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_INTELLIGENCE,D_EX_CORE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_GOV_AUDIT,D_FBL_DETECTORS,D_SHARED,D_INFRA_RUNTIME,D_SECURITY external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_FBL_DIAGNOSERS,D_INTEGRATION,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_EX_CORE,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_KB,D_INTELLIGENCE,D_GOV_REPAIR external_prod
    class D_INTEGRATION,D_SHARED,D_EX_CORE,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT external_prod
    class D_INTEGRATION external_design
```

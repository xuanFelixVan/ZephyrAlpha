...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOVERNANCE,D_EX_CORE,D_GOV_AUDIT,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_SHARED,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_ORCHESTRATOR,D_SECURITY external_prod
    class D_INTEGRATION,D_EX_CORE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SECURITY,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_INTEGRATION,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_SHARED,D_SECURITY,D_OPS,D_FEEDBACK_LOOP,D_EX_CORE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

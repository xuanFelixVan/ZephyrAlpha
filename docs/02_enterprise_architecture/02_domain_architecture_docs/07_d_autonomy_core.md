...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_AUDIT,D_EX_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    D_GOV_KB -.->|config_depends / config_depends| src_zephyr_gov_kb_fragmentation_index_py
    ...
    class D_SHARED,D_GOV_KB,D_KNOWLEDGE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_SECURITY,D_ORCHESTRATOR,D_SHARED external_prod
    class D_INTEGRATION,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SHARED,D_OPS,D_GOVERNANCE,D_FEEDBACK_LOOP,D_EX_CORE,D_SECURITY,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_EX_CORE,D_GOV_SCRIPTS,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```
...
| 31 | D_GOV_KB 知识库治理: __init__.py | → | fragmentation_index.py — 知识碎片化指数 (DD108... | config_depends / config_depends |

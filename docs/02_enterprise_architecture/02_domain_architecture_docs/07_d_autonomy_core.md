...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DOCS,D_INFRA_A2A,D_COMPLIANCE,D_GOV_DRIFT,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INTELLIGENCE,D_ORCHESTRATOR,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_EX_CORE,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_GOV_DOCS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_EX_CORE,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_SECURITY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_INTEGRATION external_prod
```

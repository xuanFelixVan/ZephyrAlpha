...
graph TD
    ...
    class D_GOV_AUDIT,D_ORCHESTRATOR,D_GOVERNANCE,D_EX_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_SHARED,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_FBL_VERIFICATION,D_SECURITY,D_GOV_AUDIT,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FBL_DETECTORS,D_SECURITY,D_INTEGRATION,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_INTEGRATION,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_FBL_DIAGNOSERS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOV_RULE,D_GOVERNANCE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_SECURITY,D_FBL_VERIFICATION,D_GOV_AUDIT,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

...
graph TD
    ...
    class D_GOV_KB,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INTEGRATION,D_SECURITY,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_GOVERNANCE,D_EX_CORE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_OPS,D_FEEDBACK_LOOP,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_SECURITY,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_RULE,D_INTEGRATION,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_KB,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY external_prod
    class D_SHARED,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_SCRIPTS,D_INFRASTRUCTURE external_design
```

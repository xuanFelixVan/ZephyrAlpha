...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_INTELLIGENCE,D_GOV_AUDIT,D_GOVERNANCE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_AUDIT external_prod
    class D_SHARED,D_INFRASTRUCTURE,D_EX_CORE,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DIAGNOSERS,D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_REPAIR,D_FEEDBACK_LOOP,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_DRIFT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_SECURITY,D_OPS,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
```
...
| 37 | D_INFRA_RUNTIME 运行时集成: shared.io — auto-generated package init. (__in... | → | DocCompressor — 文档压缩服务（CL-018 RI 扩展模... | config_depends / config_depends |

...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_context_context_value_attribution_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_context_context_injector_py
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE external_prod
...
graph TD
    ...
    src_zephyr_autonomy_core_file_autoregister_py -.->|runtime| D_SECURITY
    ...
    src_zephyr_autonomy_core_file_autoregister_py -.->|runtime| D_FACTOR
    src_zephyr_autonomy_core_file_autoregister_py -.->|runtime| D_GOVERNANCE
    D_KNOWLEDGE["D_KNOWLEDGE design"]
    src_zephyr_autonomy_core_file_autoregister_py -.->|contract| D_KNOWLEDGE
    D_GOVERNANCE -.->|contract| src_zephyr_autonomy_core_file_autoregister_py
    D_INTEGRATION["D_INTEGRATION production"]
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_context_staleness_manager_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_prompt_registry_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_context_vector_bridge_py
    D_AUDITTEST -.->|test_depends| src_zephyr_autonomy_core_skill_rbac_registry_py
    ...
    class D_SECURITY,D_FACTOR,D_INTEGRATION,D_TRADING external_prod
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_INFRA_A2A,D_SECURITY_LLM,D_KNOWLEDGE,D_AUDITTEST,D_INTELLIGENCE external_design
```

...
graph TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_EX_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_EX_CORE,D_GOVERNANCE,D_GOV_AUDIT,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION,D_GOV_DOCS,D_EX_CORE,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_DRIFT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SHARED,D_OPS,D_GOVERNANCE,D_FEEDBACK_LOOP,D_EX_CORE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
    class D_SHARED,D_GOV_DOCS,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_SCRIPTS,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_AUDIT,D_SECURITY,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_ORCHESTRATOR external_prod
...
| 43 | D_INFRA_RUNTIME 运行时集成: 遥测 · ai_behavior/event_sink — AI 行为遥测事... | → | adversarial_robustness.py — 对抗鲁棒性 (B8, DD... | runtime / runtime |
...
> 本域与 27 个外部域直接连接（出边 317 条 + 入边 56 条 = 373 条）。只显示直接连接的域，不展开具体节点。

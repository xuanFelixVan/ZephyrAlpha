...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_EX_CORE,D_GOVERNANCE,D_ORCHESTRATOR external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_GOV_AUDIT,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_INTEGRATION,D_TRADING,D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SHARED,D_FBL_VERIFICATION,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_GOV_AUDIT,D_EX_CORE external_design
```

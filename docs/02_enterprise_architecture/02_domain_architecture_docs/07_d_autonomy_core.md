...
graph TD
    ...
    D_INFRA_RUNTIME -.->|config_depends / config_depends| src_zephyr_shared_blueprint_tools_architecture_context_loader_py
    ...
    class D_ORCHESTRATOR,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_GOV_AUDIT,D_SHARED,D_FBL_DIAGNOSERS,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY external_prod
```
...
graph TD
    ...
    tests_escalation_test_owner_absence_escalation_py -.->|测试依赖 / test_depends| D_FEEDBACK_LOOP
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SECURITY,D_EX_CORE,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SHARED,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_SECURITY,D_INFRA_RECOVERY,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_INTEGRATION,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|测试依赖 / test_depends| src_zephyr_autonomy_core_context_cold_start_booster_py
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_autonomy_core_context_context_evaluator_py
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_autonomy_core_context_context_evictor_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```
...
| 36 | D_INFRA_RUNTIME 运行时集成: 包 shared.blueprint_tools 的初始化文件。 (__ini... | → | architecture_context_loader — 加载 ``generate_... | config_depends / config_depends |

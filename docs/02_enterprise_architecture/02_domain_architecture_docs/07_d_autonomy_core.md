...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_KB,D_KNOWLEDGE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_GOV_AUDIT,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_SECURITY external_prod
...
graph TD
    ...
    class D_SECURITY,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_EX_CORE,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_SECURITY,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```
...
| 31 | D_GOV_KB 知识库治理: __init__.py | → | embedding_version_lock.py — 嵌入模型版本锁 (B1... | config_depends / config_depends |

...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_EX_CORE,D_ORCHESTRATOR,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_KNOWLEDGE,D_GOV_KB,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_FBL_DETECTORS,D_SECURITY,D_ORCHESTRATOR,D_SHARED,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_SECURITY,D_ORCHESTRATOR,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_TRADING,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SHARED,D_OPS,D_FEEDBACK_LOOP,D_EX_CORE,D_SECURITY,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_INTEGRATION external_prod
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_KB,D_INTELLIGENCE,D_INTEGRATION,D_SECURITY external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_EX_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DOCS,D_INFRA_A2A,D_COMPLIANCE,D_GOV_DRIFT,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_GOV_AUDIT,D_ORCHESTRATOR,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_lsg_pattern_tracker_py
    D_GOVERNANCE["(原型态 / prototype) D_GOVERNANCE"]
    D_GOVERNANCE -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_lsg_pattern_tracker_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_FBL_DETECTORS,D_SECURITY external_prod
    class D_SHARED,D_EX_CORE,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_GOV_DOCS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    tests_automation_test_auto_runtime_fle_integration_py -.->|测试依赖 / test_depends| D_FEEDBACK_LOOP
    ...
    tests_automation_test_auto_split_py -.->|测试依赖 / test_depends| D_GOVERNANCE
    D_SHARED["(生产态 / production) D_SHARED"]
    ...
    class D_INFRA_RUNTIME,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_SECURITY,D_FEEDBACK_LOOP,D_GOVERNANCE,D_SHARED,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SHARED,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_FEEDBACK_LOOP,D_OPS,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_INTEGRATION,D_FBL_DETECTORS,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_INTEGRATION,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_KB,D_INTELLIGENCE,D_GOV_REPAIR external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_SCRIPTS,D_EX_CORE external_design
```
...
| 159 | Agent Spec -> Pipeline 集成桥接层 (__init__.py) | → | D_GOVERNANCE 生命周期管理: audit_logger.py | runtime / runtime |
...
| 12 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | lsg_pattern_tracker.py — LSG 模式逃逸追踪 (B20... | contract / contract |
...
| 37 | D_GOV_DOCS 架构文档治理: blueprint.md | → | lsg_pattern_tracker.py — LSG 模式逃逸追踪 (B20... | contract / contract |

...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_INTELLIGENCE,D_GOVERNANCE,D_EX_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_FBL_VERIFICATION external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_AUDIT,D_INTEGRATION,D_FBL_DIAGNOSERS,D_TRADING,D_INFRA_RUNTIME,D_GOV_REPAIR,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_DRIFT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SECURITY,D_OPS external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INTEGRATION,D_GOVERNANCE,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

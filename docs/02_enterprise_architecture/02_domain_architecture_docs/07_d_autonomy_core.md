...
graph TD
    ...
    class D_GOV_AUDIT,D_ORCHESTRATOR,D_EX_CORE,D_GOVERNANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SECURITY,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SHARED,D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_ORCHESTRATOR,D_INTEGRATION,D_SECURITY,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_FBL_VERIFICATION,D_INTEGRATION,D_FEEDBACK_LOOP,D_OPS,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INTEGRATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_RULE,D_INTEGRATION,D_INFRA_RUNTIME,D_INTELLIGENCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_AUDIT,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```
...
| 50 | D_SECURITY 对抗验证: Agent capability scope verification — 拒绝受限... | → | G-CT-003: Agent Spec -> RBAC capability check. ... | 导入依赖 / import_depends |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 26 个外部域直接连接（出边 312 条 + 入边 50 条 = 362 条）。只显示直接连接的域，不展开具体节点。

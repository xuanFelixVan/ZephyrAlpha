...
graph TD
    ...
    class D_FBL_DETECTORS,D_ORCHESTRATOR,D_SHARED,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_SECURITY,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOVERNANCE,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SECURITY,D_ORCHESTRATOR external_prod
    class D_INTEGRATION external_design
```

...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INTEGRATION,D_SECURITY,D_INFRA_RUNTIME,D_GOV_KB,D_GOV_CODE_QUALITY external_prod
    class D_GOV_AUDIT,D_GOVERNANCE,D_GOV_SCRIPTS,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_EX_CORE,D_GOV_AUDIT,D_ORCHESTRATOR,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_FBL_DETECTORS,D_SHARED,D_SECURITY,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_FEEDBACK_LOOP,D_EX_CORE,D_SHARED,D_SECURITY,D_OPS,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_SECURITY,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INTEGRATION,D_INTELLIGENCE,D_GOV_RULE external_prod
```

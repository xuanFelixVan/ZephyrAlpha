...
graph TD
    ...
    class src_zephyr_pf_alloc,src_zephyr_pf_alloc_init_py,src_zephyr_pf_alloc_strategy_lifecycle_event_py,src_zephyr_pf_core_default_equity_strategy_py design
...
> 按 architecture_layer 分层显示 组合分配（D_PF_ALLOC）的模块分布。共 4 个模块 / 4 modules。

...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOVERNANCE,D_FBL_VERIFICATION,D_SHARED,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_SECURITY,D_GOV_RULE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY,D_GOVERNANCE,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_PF_CORE external_prod

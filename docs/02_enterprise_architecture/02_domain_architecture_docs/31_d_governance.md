...
graph TD
    ...
    class D_FRONTEND,D_INTELLIGENCE,D_BACKTEST,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_FACTOR,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INFRA_TELEMETRY external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SHARED,D_SECURITY_LLM,D_INFRA_A2A,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_OPS,D_REPORTING,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_TRADING external_prod
    class D_INFRA_RECOVERY,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_AUDITTEST,D_SECURITY,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_SECURITY,D_SECURITY_LLM external_prod

...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INFRA_RUNTIME,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_BACKTEST,D_FRONTEND,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_AUDITTEST,D_INFRA_A2A,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_audit_trail_retention_py
    ...
    class D_INTEGRATION,D_TRADING,D_SHARED,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_FACTOR,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_AUDITTEST,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    src_zephyr_governance_kb_pipeline_init_py -.->|config_depends| src_zephyr_governance_kb_pipeline_batch_ingest_py
...
graph TD
    ...
    class D_SHARED,D_OPS,D_INTEGRATION,D_REPORTING,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_AUDITTEST,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_SECURITY external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_resilience_governance_last_resort_watchdog_py
...
graph TD
    ...
    class D_TRADING,D_GOV_ENFORCEMENT,D_AUDITTEST,D_EX_CORE,D_PF_CORE external_design
```

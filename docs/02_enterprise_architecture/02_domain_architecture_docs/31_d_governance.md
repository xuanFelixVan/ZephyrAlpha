...
| 域内依赖 | 604 | Internal Dependencies | 604 |
| 跨域入边 | 693 | Cross-domain Incoming | 693 |
...
graph TD
    ...
    scripts_archive_governance_d3_metadata_check_frontmatter_metadata_py -.->|config_depends| scripts_archive_governance_d3_metadata_check_template_compliance_py
...
graph TD
    ...
    class D_INTEGRATION,D_SIMULATION,D_SECURITY_LLM,D_FUNDAMENTAL_SIGNAL,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INTELLIGENCE,D_INFRA_RECOVERY external_prod
    class D_INTEGRATION,D_EX_CORE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING external_prod
    class D_SHARED,D_REPORTING,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INTEGRATION external_prod
    class D_SECURITY,D_GOV_ENFORCEMENT,D_AUDITTEST,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_FACTOR,D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    src_zephyr_governance_code_dedup_trackers_init_py -.->|config_depends| src_zephyr_governance_code_dedup_trackers_import_surface_tracker_py
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INFRA_TELEMETRY external_prod
    class D_INTEGRATION_GATEWAY,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_governance_kb_init_py -.->|config_depends| src_zephyr_governance_kb_embedding_migrate_py
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING external_prod
    class D_INTEGRATION_GATEWAY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_A2A external_prod
    class D_SECURITY,D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SECURITY,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_EX_CORE,D_INTEGRATION,D_PF_CORE,D_AUDITTEST external_design
```
...
> 域内模块依赖关系（共 604 条 / 604 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 604 条 / 604 edges)       │
├──────────────────────────────────────────────────────────────────┤

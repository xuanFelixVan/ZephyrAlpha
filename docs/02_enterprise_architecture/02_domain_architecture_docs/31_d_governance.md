...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_FRONTEND,D_INFRA_RUNTIME external_prod
    class D_BACKTEST,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FACTOR,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_drift_detection_drift_training_py
    D_INTEGRATION_GATEWAY["D_INTEGRATION_GATEWAY prototype"]
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_AUTONOMY_CORE,D_SECURITY_LLM,D_INFRA_A2A,D_TRADING external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_INTEGRATION,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_SECURITY_LLM,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_AUDITTEST,D_EX_CORE external_design
```

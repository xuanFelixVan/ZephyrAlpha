...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_EX_CORE external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY_LLM external_prod
    class D_REPORTING,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
    class D_GOV_ENFORCEMENT,D_INFRA_A2A,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_FACTOR,D_INTEGRATION,D_SHARED,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_A2A,D_SECURITY,D_FRONTEND,D_INFRA_RECOVERY external_prod
    class D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_PF_CORE,D_EX_CORE,D_INFRA_RUNTIME external_prod

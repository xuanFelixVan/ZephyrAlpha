...
| 域内依赖 | 637 | Internal Dependencies | 637 |
| 跨域入边 | 703 | Cross-domain Incoming | 703 |
...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_SECURITY,D_TRADING,D_INFRA_RUNTIME,D_RISK external_prod
    class D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_INTELLIGENCE external_prod
    class D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_SECURITY,D_INFRA_RUNTIME external_prod
    class D_REPORTING,D_EX_CORE,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUDITTEST,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_FACTOR,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_TRADING external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_REPORTING,D_OPS,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RECOVERY external_prod
    class D_GOV_SCRIPTS,D_AUDITTEST,D_INFRA_RUNTIME external_design
```
...
> 域内模块依赖关系（共 637 条 / 637 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 637 条 / 637 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [import_depends]: 482 条 / edges                               │

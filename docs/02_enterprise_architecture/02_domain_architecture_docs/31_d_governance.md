...
graph TD
    ...
    class D_INTELLIGENCE,D_BACKTEST,D_SHARED,D_FRONTEND,D_INFRA_RUNTIME external_prod
    class D_GOV_SCRIPTS,D_INTEGRATION,D_INTEGRATION_GATEWAY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FACTOR,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_TRADING external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SHARED,D_SECURITY_LLM,D_INFRA_A2A,D_INFRA_RUNTIME external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY_LLM,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_OPS,D_REPORTING,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_persistence_intent_keyword_mapper_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_persistence_intent_parser_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INTEGRATION,D_TRADING,D_FRONTEND external_prod

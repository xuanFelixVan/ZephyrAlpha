...
| 域内依赖 | 655 | Internal Dependencies | 655 |
| 跨域入边 | 726 | Cross-domain Incoming | 726 |
| 跨域出边 | 340 | Cross-domain Outgoing | 340 |
| 设计态模块 | 26 | Design Modules | 26 |
| 原型态模块 | 345 | Prototype Modules | 345 |
| 生产态模块 | 479 | Production Modules | 479 |
| 容量 | 479/150 (超容) | Capacity | 479/150 (超容) |
...
graph TD
    ...
    D_INFRA_TELEMETRY -.->|data| docs_03_modules_cross_layer_database_blueprint_md
    ...
    D_INFRA_TELEMETRY -.->|runtime| docs_03_modules_cross_layer_feedback_loop_blueprint_md
    D_INFRA_TELEMETRY -.->|runtime| docs_03_modules_cross_layer_context_engine_blueprint_md
    ...
    class D_AUDITTEST,D_TRADING,D_SECURITY,D_GOV_ENFORCEMENT,D_SHARED,D_GOV_DRIFT,D_INFRA_TELEMETRY,D_AUTONOMY_CORE,D_KNOWLEDGE,D_FACTOR external_design
```
...
graph TD
    ...
    D_INFRA_TELEMETRY["D_INFRA_TELEMETRY prototype"]
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md -.->|runtime| D_INFRA_TELEMETRY
    ...
    D_INFRA_TELEMETRY -.->|runtime| docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md
    ...
    D_INFRA_TELEMETRY -.->|contract| docs_03_modules_cross_layer_shared_core_blueprint_md
    D_INFRA_TELEMETRY -.->|runtime| docs_03_modules_domain_autonomy_core_rollback_system_blueprint_md
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_AUDITTEST,D_GOV_DRIFT,D_SECURITY_LLM,D_INFRA_TELEMETRY,D_AUTONOMY_CORE,D_FRONTEND,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    scripts_archive_governance_d3_metadata_detect_stale_version_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_fix_dm411_bare_relative_imports_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_fix_n06_module_id_prefix_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_fix_n12_ke_naming_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_fix_dm413_duplicate_test_names_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_fix_n15_blueprint_path_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_scan_deep_content_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_generate_rule_catalog_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_blueprint_registry_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_cross_module_dependencies_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_frontmatter_values_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_derived_from_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_enum_consistency_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_ssot_status_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_no_duplicate_files_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    scripts_archive_governance_d3_metadata_validate_superseded_by_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_RISK,D_SHARED,D_TRADING,D_SECURITY external_prod
    class D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_AUDITTEST,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_SHARED,D_FACTOR,D_INTEGRATION,D_INFRA_RUNTIME,D_TRADING external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_code_dedup_doom_loop_guard_py
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INFRA_TELEMETRY external_prod
    class D_SHARED,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_escalation_escalation_fatigue_manager_py
    ...
    class D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_INFRA_RUNTIME,D_TRADING external_prod
    class D_SHARED,D_SECURITY,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_SECURITY_LLM,D_INTELLIGENCE,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_REPORTING,D_INTEGRATION,D_OPS,D_GOV_ENFORCEMENT external_prod
    class D_SHARED,D_INFRA_RECOVERY,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRA_RECOVERY,D_TRADING external_prod
    class D_AUDITTEST,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_resilience_governance_fail_mode_manager_py
    ...
    class D_SECURITY_LLM,D_SECURITY,D_SHARED,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_TRADING,D_AUDITTEST,D_EX_CORE external_design
```
...
|--------|:---:|---------|
| D_SHARED | 137 | import_depends,runtime |
...
| D_AUDITTEST | 6 | contract,runtime |
...
| D_INFRA_TELEMETRY | 8 | contract,data,import_depends,runtime |
...
> 按 architecture_layer 分层显示 registry_management（D_GOVERNANCE）的模块分布。共 850 个模块 / 850 modules。
...
> 域内模块依赖关系（共 655 条 / 655 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 655 条 / 655 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [import_depends]: 483 条 / edges                               │

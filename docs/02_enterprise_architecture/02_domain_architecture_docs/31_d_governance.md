...
| 模块数 | 839 | Module Count | 839 |
| 域内依赖 | 612 | Internal Dependencies | 612 |
| 跨域入边 | 697 | Cross-domain Incoming | 697 |
| 跨域出边 | 264 | Cross-domain Outgoing | 264 |
| 设计态模块 | 26 | Design Modules | 26 |
| 原型态模块 | 339 | Prototype Modules | 339 |
| 生产态模块 | 474 | Production Modules | 474 |
| 容量 | 474/150 (超容) | Capacity | 474/150 (超容) |
...
graph TD
    ...
    scripts_archive_governance_d3_metadata_detect_stale_version_py -.->|config_depends| scripts_archive_governance_d3_metadata_check_template_compliance_py
    scripts_archive_governance_d3_metadata_detect_skip_active_status_py -.->|config_depends| scripts_archive_governance_d3_metadata_check_template_compliance_py
    D_GOV_DRIFT["D_GOV_DRIFT design"]
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_TRADING,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    src_zephyr_data_ch_writer_py -.->|import_depends| src_zephyr_data_provider_base_py
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class scripts_registry_scope_yaml,scripts_scaffold_py,src_zephyr_data_init_py,src_zephyr_data_config_policies_yaml,src_zephyr_data_config_schedule_yaml,src_zephyr_data_config_tasks_yaml production
    class scripts_post_checkout_guard_py,scripts_pre_commit_verify_dedup_py,scripts_print_exam_summary_py,scripts_quick_profile_py,scripts_record_session_start_commit_py,scripts_rollback_py,scripts_run_deepseek_v4_exam_py,scripts_run_ollama_exam_py,scripts_setup_git_guard_aliases_py,scripts_test_exam_scoring_unit_py,scripts_tests_test_event_driven_engine_py,scripts_tests_test_frontend_components_py,scripts_tests_test_matching_engine_v1_1_0_py,scripts_tests_test_miniqmt_broker_py,scripts_tests_test_tick_replay_data_handler_py,src_zephyr_data_alerter_py,src_zephyr_data_ch_writer_py,src_zephyr_data_implementations_init_py,src_zephyr_data_implementations_akshare_provider_py,src_zephyr_data_implementations_ifind_provider_py,src_zephyr_data_implementations_miniqmt_provider_py,src_zephyr_data_policy_registry_py,src_zephyr_data_progress_store_py,src_zephyr_data_provider_base_py design
    class D_SHARED,D_FRONTEND,D_TRADING,D_INTELLIGENCE external_prod
    class D_BACKTEST,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_bridges_alerts_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_audit_trail_wqa_scorer_py
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FACTOR,D_INFRA_RECOVERY external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_governance_commit_gates_init_py -.->|config_depends| src_zephyr_governance_commit_gates_claim_required_gate_py
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_context_governance_think_time_model_py
...
graph TD
    ...
    src_zephyr_governance_intelligence_governance_delegation_engine_py -->|import_depends| src_zephyr_governance_escalation_escalation_models_py
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_AUTONOMY_CORE,D_SECURITY_LLM,D_INFRA_RUNTIME external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INTEGRATION external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_REPORTING,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_persistence_decision_graph_reader_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_persistence_decisiongraph_schema_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_persistence_decisiongraph_schema_py
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRA_A2A,D_SHARED,D_BACKTEST external_prod
...
> 按 architecture_layer 分层显示 registry_management（D_GOVERNANCE）的模块分布。共 839 个模块 / 839 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (814 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 839 个模块 / 839 modules）。
...
> (仅显示前 200 个模块，共 814 个)

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 612 条 / 612 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 612 条 / 612 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [import_depends]: 459 条 / edges                               │

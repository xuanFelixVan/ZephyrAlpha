...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_INTELLIGENCE,D_INTEGRATION,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    src_zephyr_governance_drift_detector_core_init_py -.->|config_depends / config_depends| src_zephyr_governance_drift_detector_core_performance_baseline_py
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT,D_INTEGRATION,D_AUTONOMY_CORE,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```

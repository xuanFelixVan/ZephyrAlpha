...
| 跨域出边 | 298 | Cross-domain Outgoing | 298 |
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_REPORTING,D_GOV_ENFORCEMENT,D_OPS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING external_prod

...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_FRONTEND,D_TRADING,D_SHARED external_prod
    class D_GOV_SCRIPTS,D_BACKTEST,D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_REPORTING,D_AUDITTEST,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_TRADING,D_SHARED external_prod
...
graph TD
    ...
    class D_FACTOR,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    src_zephyr_governance_code_dedup_trackers_init_py -.->|config_depends| src_zephyr_governance_code_dedup_trackers_question_tracker_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    class D_SHARED external_prod
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_drift_detection_file_attr_checker_py
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SHARED,D_SECURITY_LLM,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY_LLM,D_INTEGRATION external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_OPS,D_INTEGRATION,D_REPORTING,D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RUNTIME,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_AUDITTEST,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    src_zephyr_governance_security_governance_init_py -.->|config_depends| src_zephyr_governance_security_governance_api_response_sanitizer_py
    D_SHARED["D_SHARED production"]
    ...
    class D_SHARED,D_SECURITY,D_INFRA_A2A,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_EX_CORE,D_AUDITTEST external_design
```

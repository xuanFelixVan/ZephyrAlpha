...
| 域内依赖 | 636 | Internal Dependencies | 636 |
| 跨域入边 | 699 | Cross-domain Incoming | 699 |
...
graph TD
    ...
    class D_GOV_DRIFT,D_ML_TRAIN,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_TRADING,D_INFRA_RUNTIME,D_EX_CORE external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOV_ENFORCEMENT,D_TRADING external_prod
    class D_SHARED,D_AUDITTEST,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_FACTOR,D_INTEGRATION,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_INFRA_RUNTIME,D_TRADING external_prod
    class D_SHARED,D_AUDITTEST,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_SECURITY_LLM,D_INTELLIGENCE,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_OPS,D_REPORTING,D_GOV_ENFORCEMENT external_prod
    class D_SHARED,D_INFRA_RECOVERY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_rule_bridge_commit_gate_registry_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_resilience_governance_witness_isolation_py
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
> 域内模块依赖关系（共 636 条 / 636 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 636 条 / 636 edges)       │
├──────────────────────────────────────────────────────────────────┤

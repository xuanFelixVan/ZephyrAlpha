...
| 跨域入边 | 695 | Cross-domain Incoming | 695 |
| 跨域出边 | 300 | Cross-domain Outgoing | 300 |
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod

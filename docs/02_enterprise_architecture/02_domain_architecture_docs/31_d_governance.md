...
| 域内依赖 | 645 | Internal Dependencies | 645 |
...
graph TD
    ...
    data_asset_index_archive_migration_scripts_domain_prefix_import_fix_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_execute_move_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_inject_domain_fields_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_generate_migration_registry_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_lock_batch_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_preflight_check_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_generate_path_migration_mapping_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_rollback_batch_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_test_import_fix_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_update_non_import_refs_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_shared_import_fix_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_unnest_from_mcp_server_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_update_imports_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_scan_import_impact_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    data_asset_index_archive_migration_scripts_verify_batch_py -.->|config_depends| data_asset_index_archive_migration_scripts_cross_domain_import_fix_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_INTEGRATION,D_SIMULATION,D_FUNDAMENTAL_SIGNAL,D_SECURITY_LLM,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_SECURITY,D_TRADING external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_INFRA_RECOVERY,D_SHARED,D_BACKTEST,D_TRADING external_prod
...
graph TD
    ...
    class D_REPORTING,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_A2A,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_audit_trail_trust_engine_py
    ...
    class D_FACTOR,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    src_zephyr_governance_context_governance_init_py -.->|config_depends| src_zephyr_governance_context_governance_context_manager_py
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_drift_detection_correlation_engine_py
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INFRA_TELEMETRY,D_TRADING external_prod
...
graph TD
    ...
    src_zephyr_governance_drift_detector_core_init_py -.->|config_depends| src_zephyr_governance_drift_detector_core_model_drift_monitor_py
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_SECURITY_LLM,D_INFRA_A2A,D_INFRA_RUNTIME,D_TRADING external_prod
...
graph TD
    ...
    src_zephyr_governance_kb_pipeline_init_py -.->|config_depends| src_zephyr_governance_kb_pipeline_analyze_py
...
graph TD
    ...
    class D_REPORTING,D_OPS,D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_FRONTEND external_prod
    class D_AUDITTEST,D_TRADING,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    src_zephyr_governance_security_governance_init_py -.->|config_depends| src_zephyr_governance_security_governance_bare_repo_scanner_py
    D_SHARED["D_SHARED production"]
    ...
    class D_SHARED,D_SECURITY,D_SECURITY_LLM,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_EX_CORE,D_PF_CORE,D_AUDITTEST external_design
```
...
> 域内模块依赖关系（共 645 条 / 645 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 645 条 / 645 edges)       │
├──────────────────────────────────────────────────────────────────┤

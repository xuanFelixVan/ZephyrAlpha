...
| 域内依赖 | 652 | Internal Dependencies | 652 |
| 跨域入边 | 718 | Cross-domain Incoming | 718 |
...
graph TD
    ...
    config_ai_capability_matrix_yaml -.->|runtime| D_AUDITTEST
...
graph TD
    ...
    docs_03_modules_cross_layer_feedback_loop_blueprint_md -.->|runtime| D_DATA_SEC
    ...
    class D_TRADING,D_SECURITY,D_DATA_SEC,D_SHARED,D_AUDITTEST,D_GOV_DRIFT,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md -.->|runtime| D_GOV_ENFORCEMENT
    ...
    D_AUDITTEST -.->|runtime| docs_03_modules_domain_autonomy_perm_escalation_protocol_blueprint_md
    ...
    class D_GOV_AUDIT,D_AUDITTEST,D_GOV_DRIFT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_RISK,D_INTELLIGENCE,D_EX_CORE,D_SHARED external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY,D_TRADING,D_INFRA_RUNTIME,D_SHARED external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_INFRA_RECOVERY,D_SHARED external_prod
    class D_INTEGRATION,D_BACKTEST,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SECURITY,D_SECURITY_LLM,D_TRADING external_prod
    class D_SHARED,D_AUDITTEST,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY,D_TRADING external_prod
...
graph TD
    ...
    D_GOV_SCRIPTS["D_GOV_SCRIPTS prototype"]
    src_zephyr_governance_code_dedup_canary_manager_py -.->|contract| D_GOV_SCRIPTS
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    src_zephyr_governance_code_dedup_canary_manager_py -.->|runtime| D_GOV_ENFORCEMENT
    D_AUDITTEST["D_AUDITTEST prototype"]
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRA_TELEMETRY external_prod
    class D_SHARED,D_AUDITTEST,D_GOV_ENFORCEMENT,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_INTELLIGENCE external_prod
    class D_SHARED,D_INTEGRATION_GATEWAY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_REPORTING,D_INTEGRATION,D_OPS,D_GOV_ENFORCEMENT,D_TRADING external_prod
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
| D_GOV_ENFORCEMENT | 21 | contract,import_depends,runtime |
| D_INTEGRATION | 20 | import_depends |
| D_INTELLIGENCE | 17 | import_depends |
| D_AUDITTEST | 14 | contract,runtime |
| D_INFRA_RUNTIME | 13 | config_depends,import_depends,runtime |
...
| D_GOV_SCRIPTS | 3 | contract,import_depends |
...
| D_GOV_AUDIT | 3 | contract,runtime |
...
> 域内模块依赖关系（共 652 条 / 652 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 652 条 / 652 edges)       │
├──────────────────────────────────────────────────────────────────┤

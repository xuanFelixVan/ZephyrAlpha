...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_TRADING,D_EX_CORE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SHARED,D_FACTOR,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_INTEGRATION,D_AUTONOMY_CORE,D_TRADING external_prod
    class D_GOV_ENFORCEMENT,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_REPORTING,D_SHARED,D_OPS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_BACKTEST,D_FRONTEND,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_SECURITY,D_SHARED,D_SECURITY_LLM external_prod

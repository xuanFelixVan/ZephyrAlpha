...
| 跨域出边 | 351 | Cross-domain Outgoing | 351 |
...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_AUDITTEST,D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md -.->|contract| D_AUDITTEST
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md -.->|runtime| D_AUDITTEST
    ...
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md -.->|contract| D_AUDITTEST
    docs_03_modules_domain_autonomy_core_agent_spec_blueprint_md -.->|runtime| D_AUDITTEST
    docs_03_modules_domain_autonomy_core_agent_spec_blueprint_md -.->|runtime| D_AUDITTEST
    ...
    class D_GOV_AUDIT,D_AUDITTEST,D_GOV_DRIFT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_REPORTING,D_GOV_ENFORCEMENT,D_OPS,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    src_zephyr_governance_persistence_base_repo_py -.->|runtime| D_AUDITTEST
    D_INFRA_RUNTIME["D_INFRA_RUNTIME prototype"]
    src_zephyr_governance_persistence_base_repo_py -.->|runtime| D_INFRA_RUNTIME
    src_zephyr_governance_persistence_base_repo_py -.->|runtime| D_AUDITTEST
    src_zephyr_governance_persistence_base_repo_py -.->|runtime| D_INFRA_RUNTIME
    ...
    class D_AUDITTEST,D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_SECURITY,D_TRADING external_design
```
...
| D_TRADING | 59 | import_depends,runtime |
| D_AUDITTEST | 24 | contract,runtime |
| D_INTEGRATION | 20 | import_depends |
| D_INTELLIGENCE | 17 | import_depends |
| D_GOV_ENFORCEMENT | 17 | import_depends |
| D_INFRA_RUNTIME | 14 | config_depends,import_depends,runtime |
| D_SECURITY | 11 | import_depends,runtime |

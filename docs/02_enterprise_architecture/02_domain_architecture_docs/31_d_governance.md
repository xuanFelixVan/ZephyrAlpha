...
graph TD
    ...
    class D_GOV_SCRIPTS,D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_AUDITTEST,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_TRADING external_prod
...
graph TD
    ...
    src_zephyr_governance_intelligence_governance_init_py -.->|config_depends| src_zephyr_governance_intelligence_governance_confidence_estimator_py
...
graph TD
    ...
    class D_SHARED,D_REPORTING,D_OPS,D_INTEGRATION,D_GOV_ENFORCEMENT,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_FRONTEND external_prod
    class D_TRADING,D_AUDITTEST,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_AUDITTEST,D_GOV_SCRIPTS external_design
```

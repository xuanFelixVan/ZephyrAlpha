...
graph TD
    ...
    docs_03_modules_domain_autonomy_perm_budget_enforcer_blueprint_md -.->|data| D_SHARED
    ...
    docs_03_modules_domain_governance_code_dedup_engine_blueprint_md -.->|data| D_SHARED
    ...
    class D_GOV_DRIFT,D_SHARED,D_ML_TRAIN,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_SECURITY,D_EX_CORE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_REPORTING,D_GOV_ENFORCEMENT,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_REPORTING,D_OPS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING external_prod
...
|--------|:---:|---------|
| D_SHARED | 141 | data,import_depends |
| D_TRADING | 51 | import_depends |
...
**[runtime]** (13 条 / edges) — 已达显示上限，省略 / limit reached

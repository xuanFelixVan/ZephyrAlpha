...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_AUTONOMY_PERM,D_GOV_DRIFT,D_OPS,D_AUTONOMY_CORE,D_COMPLIANCE,D_REPORTING,D_SIGNAL,D_PF_CORE,D_KNOWLEDGE,D_GOV_DOCS,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_MKT_DATA,D_FACTOR,D_SIGNAL_FUNDAMENTAL,D_RISK,D_EX_CORE,D_PF_CORE,D_SIMULATION,D_GOV_AUDIT external_prod
```

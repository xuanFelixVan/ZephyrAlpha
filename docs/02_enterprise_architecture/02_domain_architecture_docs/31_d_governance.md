...
graph TD
    ...
    class D_REPORTING,D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_REPORTING,D_GOV_ENFORCEMENT,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_SECURITY external_prod
...
graph TD
    ...
    class D_TRADING,D_EX_CORE,D_INFRA_RUNTIME,D_PF_CORE external_prod

...
| 模块数 | 829 | Module Count | 829 |
| 域内依赖 | 591 | Internal Dependencies | 591 |
| 跨域入边 | 689 | Cross-domain Incoming | 689 |
| 跨域出边 | 257 | Cross-domain Outgoing | 257 |
| 设计态模块 | 26 | Design Modules | 26 |
| 原型态模块 | 335 | Prototype Modules | 335 |
| 生产态模块 | 468 | Production Modules | 468 |
| 容量 | 468/150 (超容) | Capacity | 468/150 (超容) |
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    scripts_archive_migration_create_target_dirs_py -.->|config_depends| scripts_archive_migration_comprehensive_import_fix_py
    scripts_archive_migration_cross_domain_import_fix_py -.->|config_depends| scripts_archive_migration_comprehensive_import_fix_py
    scripts_archive_migration_domain_prefix_import_fix_py -.->|config_depends| scripts_archive_migration_comprehensive_import_fix_py
    scripts_archive_migration_verify_manifest_py -.->|config_depends| scripts_archive_migration_comprehensive_import_fix_py
    scripts_archive_migration_migration_shared_py -.->|config_depends| scripts_archive_migration_comprehensive_import_fix_py
    scripts_archive_migration_verify_step4_py -.->|config_depends| scripts_archive_migration_comprehensive_import_fix_py
...
graph TD
    ...
    class D_INTELLIGENCE,D_RISK,D_EX_CORE,D_SHARED external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE external_prod
...
graph TD
    ...
    scripts_tests_test_miniqmt_broker_py -.->|import_depends| D_TRADING
    scripts_tests_test_tick_replay_data_handler_py -.->|import_depends| D_BACKTEST
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_audit_trail_orchestrator_compat_py
    ...
    class D_SHARED,D_REPORTING,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_audit_trail_genesis_py
    ...
    class D_SHARED,D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_SECURITY,D_AUDITTEST,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_audit_trail_trust_ring_manager_py
    ...
    class D_FACTOR,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_drift_detection_rollback_bridge_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_escalation_escalation_loop_detector_py
...
graph TD
    ...
    class D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_TRADING external_prod
...
graph TD
    ...
    src_zephyr_governance_kb_init_py -.->|config_depends| src_zephyr_governance_kb_citation_walker_py
    ...
    class D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_ops_governance_bandwidth_optimizer_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_kb_vms_memory_backend_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_ops_governance_budget_engine_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_ops_governance_budget_engine_py
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_ops_governance_budget_models_py
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_REPORTING,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_ops_governance_meta_observability_py
    ...
    class src_zephyr_governance_ops_governance_token_budget_py,src_zephyr_governance_persistence_base_repo_py,src_zephyr_governance_persistence_dataflowgraph_schema_py,src_zephyr_governance_persistence_decisiongraph_schema_py,src_zephyr_governance_persistence_depgraph_reader_py design
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_A2A,D_GOV_ENFORCEMENT external_prod
    class D_SHARED,D_SECURITY,D_AUDITTEST,D_INTELLIGENCE,D_TRADING,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_security_governance_api_response_sanitizer_py
    ...
    class D_GOV_ENFORCEMENT,D_SECURITY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_PF_CORE,D_EX_CORE,D_AUDITTEST,D_INTEGRATION external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_PF_CORE,D_GOV_ENFORCEMENT external_design
```
...
| D_GOV_SCRIPTS | 26 | import_depends |
...
> 按 architecture_layer 分层显示 registry_management（D_GOVERNANCE）的模块分布。共 829 个模块 / 829 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (804 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 829 个模块 / 829 modules）。
...
> (仅显示前 200 个模块，共 804 个)

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 591 条 / 591 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 591 条 / 591 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 4                               │
│   [import_depends]: 443 条 / edges                               │

...
graph TD
    ...
    class D_FACTOR,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_REPORTING,D_SHARED,D_GOV_ENFORCEMENT,D_OPS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_BACKTEST,D_FRONTEND,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_SECURITY_LLM external_prod
...
> 域内模块依赖关系（共 647 条 / 647 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 647 条 / 647 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [import_depends]: 481 条 / edges                               │
│   [config_depends]: 143 条 / edges                               │
│   [runtime]: 14 条 / edges                                       │
│   [contract]: 5 条 / edges                                       │
│   [data]: 4 条 / edges                                           │
└──────────────────────────────────────────────────────────────────┘
...
**[config_depends]** (143 条 / edges) — 已达显示上限，省略 / limit reached

...
graph TD
    ...
    class D_REPORTING,D_AUDITTEST,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_SHARED external_prod
...
graph TD
    ...
    class D_FACTOR,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_REPORTING,D_OPS,D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_EX_CORE,D_AUDITTEST,D_PF_CORE external_design
```

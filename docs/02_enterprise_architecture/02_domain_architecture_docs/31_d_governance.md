...
graph TD
    ...
    scripts_archive_governance_dm101_blueprint_domain_mapping_py -.->|config_depends / config_depends| scripts_archive_governance_dm106_p2b_verification_py
    scripts_archive_governance_list_no_consumer_orphans_py -.->|config_depends / config_depends| scripts_archive_governance_dm106_p2b_verification_py
    scripts_archive_governance_merge_domain_nodes_py -.->|config_depends / config_depends| scripts_archive_governance_dm106_p2b_verification_py
...
graph TD
    ...
    class D_SHARED,D_PF_CORE,D_EX_CORE,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_TRADING,D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_ML_TRAIN,D_GOV_AUDIT,D_FRONTEND,D_BACKTEST,D_EX_CORE external_design
```

### 原型态子图（仅 design_maturity=prototype 的模块和依赖）

> 仅展示代码已写、验证中未稳定上线的原型态模块（共 329 个，222 条域内依赖）。
...
graph TD
    ...
    scripts_archive_construction_create_db_alignment_tasks_py -.->|config_depends / config_depends| scripts_archive_construction_dm014_orphan_edge_repair_py
    scripts_archive_governance_dm101_blueprint_domain_mapping_py -.->|config_depends / config_depends| scripts_archive_governance_dm106_p2b_verification_py
    scripts_archive_governance_create_depgraph_task_cards_py -.->|config_depends / config_depends| scripts_archive_governance_dm106_p2b_verification_py
    scripts_archive_governance_list_no_consumer_orphans_py -.->|config_depends / config_depends| scripts_archive_governance_dm106_p2b_verification_py
...
> 本域与 28 个外部域直接连接（出边 310 条 + 入边 752 条 = 1062 条）。只显示直接连接的域，不展开具体节点。

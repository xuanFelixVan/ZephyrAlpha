...
| 生产态模块 | 480 | Production Modules | 480 |
| 容量 | 480/150 (超容) | Capacity | 480/150 (超容) |
...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_SHARED,D_AUDITTEST,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_KNOWLEDGE,D_FACTOR external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUDITTEST,D_GOV_DRIFT,D_SECURITY_LLM,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    src_zephyr_data_scheduler_py -.->|import_depends| src_zephyr_data_implementations_baostock_provider_py
    ...
    src_zephyr_data_implementations_baostock_provider_py -.->|import_depends| src_zephyr_data_policy_registry_py
    src_zephyr_data_implementations_baostock_provider_py -.->|import_depends| src_zephyr_data_provider_base_py
...
graph TD
    ...
    class D_FACTOR,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_BACKTEST,D_FRONTEND external_prod
    class D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_SECURITY,D_TRADING external_design
```
...
graph TD
    ...
    src_zephyr_governance_rule_bridge_init_py -.->|config_depends| src_zephyr_governance_rule_bridge_session_worktree_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_resilience_governance_circuit_breaker_py
...
|--------|:---:|---------|
| D_SHARED | 139 | import_depends,runtime |
...
> 按 architecture_layer 分层显示 registry_management（D_GOVERNANCE）的模块分布。共 852 个模块 / 852 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (826 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 852 个模块 / 852 modules）。

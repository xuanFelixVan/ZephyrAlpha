...
| 域内依赖 | 635 | Internal Dependencies | 635 |
...
graph TD
    ...
    class D_REPORTING,D_EX_CORE,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_TRADING,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_AUDITTEST,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    class D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY_LLM,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_TRADING external_prod
    class D_GOV_ENFORCEMENT,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_REPORTING,D_SHARED,D_OPS,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_SECURITY,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
> 域内模块依赖关系（共 635 条 / 635 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 635 条 / 635 edges)       │
├──────────────────────────────────────────────────────────────────┤

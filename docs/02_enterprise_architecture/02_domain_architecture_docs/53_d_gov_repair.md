...
title: D-GOV-REPAIR rollback架构文档
version: "1.0"
status: active
date: 2026-06-29
...
# 53_d_gov_repair / rollback

> **文档作用 / Purpose**: 展示 rollback（D-GOV-REPAIR）功能域的模块清单、域内依赖关系、跨域依赖关系、架构全景图，供架构审查和域治理参考。
...
```mermaid
graph TD
    subgraph D_GOV_REPAIR["D-GOV-REPAIR rollback"]
    end

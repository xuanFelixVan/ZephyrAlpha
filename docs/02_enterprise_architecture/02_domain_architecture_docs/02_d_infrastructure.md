...
flowchart TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_EX_CORE,D_REPORTING,D_FUNDAMENTAL_SIGNAL,D_PF_ALLOC,D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_FACTOR,D_SIGQC external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_PF_CORE,D_EX_CORE,D_MKT_DATA,D_TRADING,D_POSITION,D_FUNDAMENTAL_SIGNAL,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_RISK external_prod
```

...
flowchart TD
    ...
    src_zephyr_infrastructure_config_init_py["infrastructure/config 包入口<br/>管理infrastructure.config子包加载<br/>文件: config/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_shared_contracts_factor_monitor_report_py["因子监控报告<br/>contracts的监控器，持续监视某项指标，异常时上报<br/>。<br/>factor_monitor_report<br/>文件: contracts/factor_monitor_report.py<br/>(生产态 / production)"]
    ...
    src_zephyr_shared_contracts_macro_factor_signal_py["macro因子信号<br/>contracts的核心类，封装MacroFactorSignal相关逻辑<br/>。<br/>macro_factor_signal<br/>文件: contracts/macro_factor_signal.py<br/>(生产态 / production)"]
    ...
    src_zephyr_shared_contracts_position_py["持仓<br/>contracts的核心类，封装PositionSnapshot相关逻辑<br/>。<br/>文件: contracts/position.py<br/>(生产态 / production)"]
    ...
    src_zephyr_shared_contracts_synthesized_signal_py["synthesized信号<br/>contracts的核心类，封装SynthesizedSignal相关逻辑<br/>。<br/>synthesized_signal<br/>文件: contracts/synthesized_signal.py<br/>(生产态 / production)"]

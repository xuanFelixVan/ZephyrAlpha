...
flowchart TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_PF_CORE,D_EX_CORE,D_GOV_CODE_QUALITY,D_FUNDAMENTAL_SIGNAL,D_REPORTING,D_EX_SOR,D_TRADING,D_RISK,D_POSITION,D_MKT_DATA external_prod
```

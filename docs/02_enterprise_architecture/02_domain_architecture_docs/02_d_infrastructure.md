...
flowchart TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_PF_CORE,D_EX_CORE,D_EX_SOR,D_MKT_DATA,D_TRADING,D_GOVERNANCE,D_FACTOR external_prod
```
...
| 67 | D_PF_CORE 组合核心: Strategy Engine — 策略引擎 (MOD-PF-001) (core/strategy_e... | → | contracts/strategy_lifecycle_event.py | contract / contract |

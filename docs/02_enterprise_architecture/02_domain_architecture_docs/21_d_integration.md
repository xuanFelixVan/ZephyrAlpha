...
flowchart TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_SECURITY,D_GOV_AUDIT,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
```

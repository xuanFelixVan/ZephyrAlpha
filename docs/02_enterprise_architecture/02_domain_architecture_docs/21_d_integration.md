...
flowchart TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_GOV_DRIFT external_prod
```

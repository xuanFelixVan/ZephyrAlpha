...
flowchart TD
    ...
    class D_SHARED,D_OPS,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_ORCHESTRATOR external_prod
```

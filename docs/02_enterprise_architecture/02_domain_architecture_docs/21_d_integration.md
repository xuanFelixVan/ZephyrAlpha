...
flowchart TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_GOV_AUDIT,D_TRADING,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_ORCHESTRATOR external_prod
```

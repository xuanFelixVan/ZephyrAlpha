...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_AUTONOMY_CORE,D_SHARED,D_OPS,D_GOV_AUDIT,D_TRADING,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_SCRIPTS external_prod
```

...
flowchart TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_OPS,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_SCRIPTS external_prod
```

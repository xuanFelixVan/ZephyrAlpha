...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_RULE,D_OPS,D_GOVERNANCE,D_INTELLIGENCE,D_TRADING,D_AUTONOMY_CORE external_prod
```

...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_AUTONOMY_CORE,D_SHARED,D_SECURITY,D_GOVERNANCE,D_OPS,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
```

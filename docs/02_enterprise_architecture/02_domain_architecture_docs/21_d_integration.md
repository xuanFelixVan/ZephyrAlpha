...
flowchart TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_SECURITY,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT external_prod
```

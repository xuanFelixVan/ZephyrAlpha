...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_OPS,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_SCRIPTS external_prod
```

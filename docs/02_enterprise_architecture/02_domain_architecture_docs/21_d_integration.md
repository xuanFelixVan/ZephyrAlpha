...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_GOVERNANCE,D_SHARED,D_GOV_AUDIT,D_INTELLIGENCE,D_AUTONOMY_CORE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_GOV_RULE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_GOVERNANCE,D_SHARED,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS external_prod
```

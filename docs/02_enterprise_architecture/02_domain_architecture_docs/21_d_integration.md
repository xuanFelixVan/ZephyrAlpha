...
flowchart TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_SECURITY,D_OPS,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR external_prod
```

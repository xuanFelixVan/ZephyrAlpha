...
flowchart TD
    ...
    class D_SHARED,D_POSITION,D_EX_CORE,D_INFRASTRUCTURE,D_REPORTING,D_RISK,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_SIGQC,D_GOVERNANCE external_prod
```

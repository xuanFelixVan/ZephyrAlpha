...
flowchart TD
    ...
    class D_POSITION,D_EX_CORE,D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_ORCHESTRATOR,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_RISK,D_SIGQC,D_ML_TRAIN external_prod
```

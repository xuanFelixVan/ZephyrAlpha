...
flowchart TD
    ...
    class D_INFRASTRUCTURE,D_POSITION,D_EX_CORE,D_SHARED,D_INFRA_RUNTIME,D_REPORTING,D_RISK,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_INTEGRATION,D_ML_TRAIN external_prod
```

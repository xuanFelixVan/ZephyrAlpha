...
flowchart TD
    ...
    class D_POSITION,D_EX_CORE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_INTEGRATION,D_ML_TRAIN,D_REPORTING,D_RISK external_prod
```

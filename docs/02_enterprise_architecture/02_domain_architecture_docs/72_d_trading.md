...
flowchart TD
    ...
    class D_SHARED,D_POSITION,D_GOV_AUDIT,D_GOVERNANCE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_FRONTEND,D_RISK,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN external_prod

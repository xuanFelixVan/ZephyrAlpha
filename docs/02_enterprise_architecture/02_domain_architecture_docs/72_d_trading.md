...
flowchart TD
    ...
    D_GOV_AUDIT -->|测试依赖 / test_depends| src_zephyr_trading_verdict_engine_py
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_GOV_AUDIT,D_REPORTING,D_RISK external_prod
```

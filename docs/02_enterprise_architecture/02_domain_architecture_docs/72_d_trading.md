...
flowchart TD
    ...
    src_zephyr_trading_trading_contracts_portfolio_contracts_money_py -->|导入依赖 / import_depends| D_SHARED
    ...
    class D_POSITION,D_EX_CORE,D_INFRASTRUCTURE,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_INTEGRATION,D_ML_TRAIN,D_REPORTING,D_RISK,D_INFRA_RUNTIME external_prod
```

...
flowchart TD
    ...
    class D_POSITION,D_EX_CORE,D_INFRASTRUCTURE,D_SHARED,D_INFRA_RUNTIME,D_RISK,D_FRONTEND,D_GOVERNANCE,D_INTELLIGENCE,D_ML_TRAIN,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL external_prod
```

...
flowchart TD
    ...
    class D_POSITION,D_EX_CORE,D_SHARED,D_INFRASTRUCTURE,D_GOV_AUDIT,D_REPORTING,D_RISK,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_SIGQC,D_GOVERNANCE,D_ML_TRAIN external_prod
```

...
flowchart TD
    src_zephyr_trading_action_dispatcher_init_py["trading/action_dispatcher 包入口<br/>管理trading.action_dispatcher子包加载<br/>文件: action_dispatcher/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_trading_trading_contracts_market_instrument_py["标的合约<br/>交易包的instrument模块<br/>文件: market/instrument.py<br/>(生产态 / production)"]

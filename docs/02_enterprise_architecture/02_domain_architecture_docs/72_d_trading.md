...
flowchart TD
    ...
    class D_POSITION,D_EX_CORE,D_SHARED,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE,D_ML_TRAIN,D_REPORTING,D_RISK,D_FUNDAMENTAL_SIGNAL,D_FRONTEND external_prod
```

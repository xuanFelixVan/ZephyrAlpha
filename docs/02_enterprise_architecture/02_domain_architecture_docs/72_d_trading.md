...
flowchart TD
    ...
    class D_SHARED,D_POSITION,D_GOV_AUDIT,D_GOVERNANCE,D_ORCHESTRATOR,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_RISK,D_ML_TRAIN,D_SIGQC external_prod

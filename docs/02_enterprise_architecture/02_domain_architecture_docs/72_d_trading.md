...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOVERNANCE,D_INTELLIGENCE,D_EX_CORE,D_FRONTEND,D_ML_TRAIN,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_prod
```

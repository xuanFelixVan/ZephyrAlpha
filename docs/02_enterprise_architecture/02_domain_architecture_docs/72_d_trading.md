...
flowchart TD
    ...
    class D_POSITION,D_EX_CORE,D_SHARED,D_INFRASTRUCTURE,D_GOVERNANCE,D_INFRA_RUNTIME,D_FRONTEND,D_REPORTING,D_RISK,D_INTELLIGENCE,D_ML_TRAIN,D_INTEGRATION external_prod
```

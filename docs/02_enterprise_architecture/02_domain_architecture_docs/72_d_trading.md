...
flowchart TD
    ...
    class D_POSITION,D_EX_CORE,D_SHARED,D_INFRASTRUCTURE,D_GOV_AUDIT,D_INTELLIGENCE,D_FRONTEND,D_REPORTING,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_RISK external_prod
```

...
flowchart TD
    ...
    class D_INFRASTRUCTURE,D_POSITION,D_EX_CORE,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_RISK,D_INTELLIGENCE,D_REPORTING external_prod
```

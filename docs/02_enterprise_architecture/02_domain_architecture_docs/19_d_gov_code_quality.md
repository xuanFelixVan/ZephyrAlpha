...
flowchart TD
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_blueprint_amodule_consistency_gate_py
    ...
    class D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOV_RULE,D_SHARED,D_DATA,D_GOVERNANCE,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_prod
```

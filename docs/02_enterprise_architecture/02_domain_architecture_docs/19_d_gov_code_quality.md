...
flowchart TD
    ...
    src_zephyr_gov_enforcement_commit_gates_translation_coverage_gate_py -->|导入依赖 / import_depends| D_SHARED
    ...
    class D_GOV_ENFORCEMENT,D_DATA,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_GOV_AUDIT external_prod
```

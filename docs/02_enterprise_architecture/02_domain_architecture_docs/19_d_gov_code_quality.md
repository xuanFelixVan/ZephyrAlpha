...
flowchart TD
    ...
    src_zephyr_gov_enforcement_commit_gates_manual_only_permanent_gate_py["手册onlypermanent门禁<br/>永久系统脚本 manual 触发无事件订阅阻断门禁<br/>（MANUAL-ONLY-PERMANENT，#ARCH-GOV-CONVERGENCE-META Phase 3.6 补齐<br/>manual_only_permanent_gate<br/>文件: commit_gates/manual_only_permanent_gate.py<br/>(生产态 / production)"]
    ...
    tests_governance_code_dedup_test_atomic_fixer_py["Atomic修复器测试<br/>code dedup包的test_atomic_fixer模块<br/>Test Atomic Fixer<br/>文件: code_dedup/test_atomic_fixer.py<br/>(生产态 / production)"]
    tests_governance_code_dedup_test_grandfather_manager_py["Grandfather管理器测试<br/>code dedup包的test_grandfather_manager模块<br/>Test Grandfather Manager<br/>文件: code_dedup/test_grandfather_manager.py<br/>(生产态 / production)"]
    tests_governance_code_dedup_test_policy_tree_validator_py["策略Tree验证器测试<br/>code dedup包的test_policy_tree_validator模块<br/>Test Policy Tree Validator<br/>文件: code_dedup/test_policy_tree_validator.py<br/>(生产态 / production)"]
    tests_governance_code_dedup_test_pre_apply_integrity_gate_py["PreApply完整性门禁测试<br/>code dedup包的test_pre_apply_integrity_gate模块<br/>Test Pre Apply Integrity Gate<br/>文件: code_dedup<br/>/test_pre_apply_integrity_gate.py<br/>(生产态 / production)"]
    tests_governance_code_dedup_test_ssot_registrar_py["SSoT注册器测试<br/>code dedup包的test_ssot_registrar模块<br/>Test Ssot Registrar<br/>文件: code_dedup/test_ssot_registrar.py<br/>(生产态 / production)"]
    ...
    tests_governance_governance_misc_test_annotations_py["Annotations测试<br/>governance misc包的test_annotations模块<br/>Test Annotations<br/>文件: governance_misc/test_annotations.py<br/>(生产态 / production)"]
    tests_governance_governance_misc_test_atomic_transaction_manager_unit_py["AtomicTransaction管理器单元测试<br/>单元测试：src/zephyr/db<br/>/atomic_transaction_manager.py（T-2-30）<br/>Test Atomic Transaction Manager Unit<br/>文件: governance_misc<br/>/test_atomic_transaction_manager_unit.py<br/>(生产态 / production)"]
    tests_governance_governance_misc_test_bare_repo_scanner_py["BareRepo扫描器测试<br/>governance misc包的test_bare_repo_scanner模块<br/>Test Bare Repo Scanner<br/>文件: governance_misc/test_bare_repo_scanner.py<br/>(生产态 / production)"]
    tests_governance_governance_misc_test_governance_result_types_py["治理结果类型定义测试<br/>governance<br/>misc包的test_governance_result_types模块<br/>Test Governance Result Types<br/>文件: governance_misc<br/>/test_governance_result_types.py<br/>(生产态 / production)"]
    tests_governance_governance_misc_test_mock_duplicate_generator_py["MockDuplicate生成器测试<br/>governance<br/>misc包的test_mock_duplicate_generator模块<br/>Test Mock Duplicate Generator<br/>文件: governance_misc<br/>/test_mock_duplicate_generator.py<br/>(生产态 / production)"]
    tests_governance_governance_misc_test_question_tracker_py["Question跟踪器测试<br/>governance misc包的test_question_tracker模块<br/>Test Question Tracker<br/>文件: governance_misc/test_question_tracker.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_gate_engine_test_adversarial_gate_integration_py["对抗门禁集成测试<br/>gate engine包的test_adversarial_gate_integration<br/>模块<br/>Test Adversarial Gate Integration<br/>文件: gate_engine<br/>/test_adversarial_gate_integration.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_gate_engine_test_adversarial_validation_py["对抗验证测试<br/>gate engine包的test_adversarial_validation模块<br/>Test Adversarial Validation<br/>文件: gate_engine/test_adversarial_validation.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_gate_engine_test_adversarial_validation_gate_py["对抗验证门禁测试<br/>gate engine包的test_adversarial_validation_gate<br/>模块<br/>Test Adversarial Validation Gate<br/>文件: gate_engine<br/>/test_adversarial_validation_gate.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_invariants_test_en_001_circular_dependency_py["En 001 Circular Dependency测试<br/>invariants包的test_en_001_circular_dependency模<br/>块<br/>Test En 001 Circular Dependency<br/>文件: invariants<br/>/test_en_001_circular_dependency.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_invariants_test_en_002_enforcement_validator_py["En002执行验证器测试<br/>invariants包的test_en_002_enforcement_validator<br/>模块<br/>Test En 002 Enforcement Validator<br/>文件: invariants<br/>/test_en_002_enforcement_validator.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_invariants_test_en_003_contract_compatibility_py["En003契约Compatibility测试<br/>invariants包的test_en_003_contract_compatibility<br/>模块<br/>Test En 003 Contract Compatibility<br/>文件: invariants<br/>/test_en_003_contract_compatibility.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_invariants_test_en_process_lifecycle_gateway_py["En流程生命周期网关测试<br/>invariants包的test_en_process_lifecycle_gateway<br/>模块<br/>Test En Process Lifecycle Gateway<br/>文件: invariants<br/>/test_en_process_lifecycle_gateway.py<br/>(生产态 / production)"]
    ...
    tests_governance_rule_enforcement_invariants_test_zero_residue_check_py["Zero残留检查测试<br/>invariants包的test_zero_residue_check模块<br/>Test Zero Residue Check<br/>文件: invariants/test_zero_residue_check.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_adaptive_threshold_py["Adaptive Threshold测试<br/>rule enforcement包的test_adaptive_threshold模块<br/>Test Adaptive Threshold<br/>文件: rule_enforcement<br/>/test_adaptive_threshold.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_adversarial_strategies_py["对抗策略测试<br/>rule enforcement包的test_adversarial_strategies<br/>模块<br/>Test Adversarial Strategies<br/>文件: rule_enforcement<br/>/test_adversarial_strategies.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_breaking_change_detector_py["BreakingChange检测器测试<br/>rule enforcement包的test_breaking_change_detecto<br/>r模块<br/>Test Breaking Change Detector<br/>文件: rule_enforcement<br/>/test_breaking_change_detector.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_integration_test_runner_py["集成测试运行器测试<br/>rule enforcement包的test_integration_test_runner<br/>模块<br/>Test Integration Test Runner<br/>文件: rule_enforcement<br/>/test_integration_test_runner.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_kiss_enforcer_py["Kiss Enforcer测试<br/>rule enforcement包的test_kiss_enforcer模块<br/>Test Kiss Enforcer<br/>文件: rule_enforcement/test_kiss_enforcer.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_output_quality_gate_py["OutputQuality门禁测试<br/>rule enforcement包的test_output_quality_gate模块<br/>Test Output Quality Gate<br/>文件: rule_enforcement<br/>/test_output_quality_gate.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_secrets_guard_py["Secrets守卫测试<br/>rule enforcement包的test_secrets_guard模块<br/>Test Secrets Guard<br/>文件: rule_enforcement/test_secrets_guard.py<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_test_triple_alignment_py["Triple对齐测试<br/>rule enforcement包的test_triple_alignment模块<br/>Test Triple Alignment<br/>文件: rule_enforcement/test_triple_alignment.py<br/>(生产态 / production)"]
    tests_governance_test_apply_dataflowgraph_smoke_py["Apply Dataflowgraph Smoke测试<br/>test_apply_dataflowgraph_smoke.py —<br/>apply_dataflowgraph.py end-to-end smoke test<br/>Test Apply Dataflowgraph Smoke<br/>文件: governance<br/>/test_apply_dataflowgraph_smoke.py<br/>(生产态 / production)"]
    tests_governance_test_apply_decisiongraph_smoke_py["Apply Decisiongraph Smoke测试<br/>test_apply_decisiongraph_smoke.py —<br/>apply_decisiongraph.py end-to-end smoke test<br/>Test Apply Decisiongraph Smoke<br/>文件: governance<br/>/test_apply_decisiongraph_smoke.py<br/>(生产态 / production)"]
    tests_governance_test_apply_depgraph_smoke_py["Apply依赖图Smoke测试<br/>test_apply_depgraph_smoke.py —<br/>apply_depgraph.py end-to-end smoke test<br/>Test Apply Depgraph Smoke<br/>文件: governance/test_apply_depgraph_smoke.py<br/>(生产态 / production)"]
    ...
    tests_governance_test_generate_project_depgraph_smoke_py["生成Project依赖图Smoke测试<br/>test_generate_project_depgraph_smoke.py —<br/>generate_project_depgraph.py e2e s...<br/>Test Generate Project Depgraph Smoke<br/>文件: governance<br/>/test_generate_project_depgraph_smoke.py<br/>(生产态 / production)"]
    ...
    tests_governance_test_reconcile_generators_py["Reconcile Generators测试<br/>test_reconcile_generators.py —<br/>reconcile_generators.py e2e smoke test<br/>Test Reconcile Generators<br/>文件: governance/test_reconcile_generators.py<br/>(生产态 / production)"]
    ...
    tests_governance_test_sync_yaml_to_depgraph_smoke_py["同步YamlTo依赖图Smoke测试<br/>test_sync_yaml_to_depgraph_smoke.py —<br/>sync_yaml_to_depgraph.py e2e smoke test<br/>Test Sync Yaml To Depgraph Smoke<br/>文件: governance<br/>/test_sync_yaml_to_depgraph_smoke.py<br/>(生产态 / production)"]
    ...
    tests_governance_test_battle_map_research_incubation_py -->|测试依赖 / test_depends| D_GOVERNANCE
    D_GOV_RULE["规则治理<br/>规则治理，负责规则注册、规则版本和规则依赖管理<br/>Rule Governance<br/>跨域节点 / cross-domain<br/>(生产态 / production)"]
    tests_governance_rule_enforcement_gate_engine_test_adversarial_gate_integration_py -->|测试依赖 / test_depends| D_GOV_RULE
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_asyncio_run_in_context_gate_py
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_derived_file_deletion_gate_py
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_ch_version_col_gate_py
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_depgraph_freshness_gate_py
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_DATA,D_INFRASTRUCTURE,D_GOVERNANCE,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod
```
...
| 5 | 对抗验证测试 / Test Adversarial Validation (gate_engine/t... | → | D_FBL_VERIFICATION 反馈验证: 对抗验证 / Adversarial Validation Gate — FLE-ADVERSARIAL... | 测试依赖 / test_depends |
...
| 14 | AtomicTransaction管理器单元测试 / Test Atomic Transaction... | → | D_GOVERNANCE 生命周期管理: atomic交易管理器 / atomic_transaction_manager (financial_... | 测试依赖 / test_depends |
...
| 19 | 同步YamlTo依赖图Smoke测试 / Test Sync Yaml To Depgraph Sm... | → | D_GOVERNANCE 生命周期管理: 依赖图模式 / depgraph_schema (governance/depgraph_schema.py) | 测试依赖 / test_depends |
...
| 23 | En002执行验证器测试 / Test En 002 Enforcement Validator (... | → | D_GOV_DRIFT 漂移检测: 从 YAML 真源加载契约文件路径 / En 002 Enforcement Validat... | 测试依赖 / test_depends |
| 24 | BreakingChange检测器测试 / Test Breaking Change Detector ... | → | D_GOV_DRIFT 漂移检测: 字段删除/类型变更->CI FAIL / Breaking Change Detector (ru... | 测试依赖 / test_depends |
...
| 122 | OutputQuality门禁测试 / Test Output Quality Gate (rule_en... | → | D_GOV_ENFORCEMENT 规则执行: 只读：rules / Output Quality Gate (rule_enforcement/outpu... | 测试依赖 / test_depends |
| 123 | worktree_ops_log 遥测完整性审计测试 / Test Audit Worktree... | → | D_GOV_ENFORCEMENT 规则执行: 会话Worktree / Session Worktree (rule_bridge/session_work... | 测试依赖 / test_depends |
| 124 | BareRepo扫描器测试 / Test Bare Repo Scanner (governance_m... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: BareRepo扫描器 / Bare Repo Scanner (security_governance/b... | 测试依赖 / test_depends |
| 125 | 治理结果类型定义测试 / Test Governance Result Types (gove... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: 结果类型定义 / Result Types (escalation/result_types.py) | 测试依赖 / test_depends |
| 126 | 对抗门禁集成测试 / Test Adversarial Gate Integration (gat... | → | D_GOV_RULE 规则治理: 对抗样本生成器 / Adversarial Strategies (rule_enforcement... | 测试依赖 / test_depends |
| 127 | 对抗门禁集成测试 / Test Adversarial Gate Integration (gat... | → | D_GOV_RULE 规则治理: 对抗验证门禁 / Adversarial Validation (gate_engine/advers... | 测试依赖 / test_depends |
| 128 | 对抗验证门禁测试 / Test Adversarial Validation Gate (gate... | → | D_GOV_RULE 规则治理: 对抗验证门禁 / Adversarial Validation (gate_engine/advers... | 测试依赖 / test_depends |
| 129 | En 001 Circular Dependency测试 / Test En 001 Circular Dep... | → | D_GOV_RULE 规则治理: 循环依赖扫描器 / Circular Dependency Scanner (invariants/... | 测试依赖 / test_depends |
| 130 | En003契约Compatibility测试 / Test En 003 Contract Compati... | → | D_GOV_RULE 规则治理: 契约兼容性检查器 / Contract Compatibility Checker (invari... | 测试依赖 / test_depends |
| 131 | En流程生命周期网关测试 / Test En Process Lifecycle Gatewa... | → | D_GOV_RULE 规则治理: 进程生命周期网关 / Process Lifecycle Gateway (invariants/... | 测试依赖 / test_depends |
| 132 | Zero残留检查测试 / Test Zero Residue Check (invariants/te... | → | D_GOV_RULE 规则治理: 零残留检查器 / Zero Residue Check (invariants/zero_residu... | 测试依赖 / test_depends |
| 133 | Adaptive Threshold测试 / Test Adaptive Threshold (rule_en... | → | D_GOV_RULE 规则治理: 自适应阈值 / Adaptive Threshold (rule_enforcement/adaptiv... | 测试依赖 / test_depends |
| 134 | 对抗策略测试 / Test Adversarial Strategies (rule_enforcem... | → | D_GOV_RULE 规则治理: 对抗样本生成器 / Adversarial Strategies (rule_enforcement... | 测试依赖 / test_depends |
| 135 | 集成测试运行器测试 / Test Integration Test Runner (rule_e... | → | D_GOV_RULE 规则治理: 集成测试运行器 / Integration Test Runner (rule_enforcemen... | 测试依赖 / test_depends |
| 136 | Kiss Enforcer测试 / Test Kiss Enforcer (rule_enforcement/... | → | D_GOV_RULE 规则治理: KISS 约束执行器 / KISS Enforcer (rule_enforcement/kiss_en... | 测试依赖 / test_depends |
| 137 | Secrets守卫测试 / Test Secrets Guard (rule_enforcement/te... | → | D_GOV_RULE 规则治理: 密钥守卫 / Secrets Guard (rule_enforcement/secrets_guard.py) | 测试依赖 / test_depends |
| 138 | Triple对齐测试 / Test Triple Alignment (rule_enforcement/... | → | D_GOV_RULE 规则治理: 三方对齐门禁 / Triple Alignment (rule_enforcement/triple_... | 测试依赖 / test_depends |
...
| 148 | baregetenv门禁 / bare_getenv_gate (commit_gates/bare_gete... | → | D_SHARED 共享服务: 密钥 / Secrets (security/secrets.py) | 导入依赖 / import_depends |
...
| 4 | D_GOVERNANCE 生命周期管理: 影子验证器测试 / Test Shadow Verifier (adversarial/test_s... | → | 影子验证器 / shadow_verifier (code_dedup/shadow_verifier.py) | 测试依赖 / test_depends |
| 5 | D_GOVERNANCE 生命周期管理: Ast Comparator测试 / Test Ast Comparator (code_quality/te... | → | ast比较器 / ast_comparator (code_dedup/ast_comparator.py) | 测试依赖 / test_depends |
| 6 | D_GOVERNANCE 生命周期管理: 代码分析器运行器测试 / Test Code Analyzer Runner (code_qu... | → | 代码分析器运行器 / code_analyzer_runner (code_dedup/code_... | 测试依赖 / test_depends |
| 7 | D_GOVERNANCE 生命周期管理: 代码去重引擎测试 / Test Code Dedup Engine (code_quality/t... | → | 安全自动修复引擎——五直接开关+五间接约束. / auto_fixer (... | 测试依赖 / test_depends |
| 8 | D_GOVERNANCE 生命周期管理: 代码去重引擎测试 / Test Code Dedup Engine (code_quality/t... | → | monoculture守卫 / monoculture_guard (code_dedup/monocultu... | 测试依赖 / test_depends |
| 9 | D_GOVERNANCE 生命周期管理: 代码去重引擎RedTeam测试 / Test Code Dedup Engine Red Team... | → | 决策审计器 / decision_auditor (code_dedup/decision_audito... | 测试依赖 / test_depends |
| 10 | D_GOVERNANCE 生命周期管理: 代码去重引擎RedTeam测试 / Test Code Dedup Engine Red Team... | → | 退出codes / exit_codes (code_dedup/exit_codes.py) | 测试依赖 / test_depends |
| 11 | D_GOVERNANCE 生命周期管理: 代码去重引擎RedTeam测试 / Test Code Dedup Engine Red Team... | → | 集成hub / integration_hub (code_dedup/integration_hub.py) | 测试依赖 / test_depends |
| 12 | D_GOVERNANCE 生命周期管理: 代码去重引擎RedTeam测试 / Test Code Dedup Engine Red Team... | → | monoculture守卫 / monoculture_guard (code_dedup/monocultu... | 测试依赖 / test_depends |
| 13 | D_GOVERNANCE 生命周期管理: 代码去重引擎RedTeam测试 / Test Code Dedup Engine Red Team... | → | 自扫描器 / self_scanner (code_dedup/self_scanner.py) | 测试依赖 / test_depends |
| 14 | D_GOVERNANCE 生命周期管理: 代码Simulator测试 / Test Code Simulator (code_quality/tes... | → | 代码模拟器 / code_simulator (code_dedup/code_simulator.py) | 测试依赖 / test_depends |
| 15 | D_GOVERNANCE 生命周期管理: Function发现测试 / Test Function Discovery (code_quality/... | → | 共享函数主动发现 — 签名+语义双通道从被动到主动. / functi... | 测试依赖 / test_depends |
| 16 | D_GOVERNANCE 生命周期管理: Simplicity审计器测试 / Test Simplicity Auditor (code_qual... | → | 引擎成本效益自审计器 — SAS 0-100 月度审计 + Tax 报告. / ... | 测试依赖 / test_depends |
...
| 18 | D_GOVERNANCE 生命周期管理: Thematic Clusterer测试 / Test Thematic Clusterer (complia... | → | 主题聚类器 — 噪声信号比·告警疲劳缓解. / thematic_cluste... | 测试依赖 / test_depends |
| 19 | D_GOVERNANCE 生命周期管理: 去重缓存管理器测试 / Test Dedup Cache Manager (data_layer... | → | 缓存管理器 / cache_manager (code_dedup/cache_manager.py) | 测试依赖 / test_depends |
| 20 | D_GOVERNANCE 生命周期管理: Symbol索引测试 / Test Symbol Index (data_layer/test_symbo... | → | symbol索引 / symbol_index (code_dedup/symbol_index.py) | 测试依赖 / test_depends |
| 21 | D_GOVERNANCE 生命周期管理: Behavioral采样器测试 / Test Behavioral Sampler (delegatio... | → | behavioral采样器 / behavioral_sampler (code_dedup/behavio... | 测试依赖 / test_depends |
| 22 | D_GOVERNANCE 生命周期管理: BehavioralTrust检查器测试 / Test Behavioral Trust Checker... | → | 行为信任检查器 — 行为漂移DIVERGED检测. / behavioral_trus... | 测试依赖 / test_depends |
| 23 | D_GOVERNANCE 生命周期管理: Consequence跟踪器测试 / Test Consequence Tracker (delegat... | → | 后果追踪——记录每次修复操作对依赖方的影响. / consequence... | 测试依赖 / test_depends |
| 24 | D_GOVERNANCE 生命周期管理: 影子Trust验证器测试 / Test Shadow Trust Validator (delega... | → | 影子信任校验器 / shadow_trust_validator (code_dedup/shado... | 测试依赖 / test_depends |
| 25 | D_GOVERNANCE 生命周期管理: 死Module检测器测试 / Test Dead Module Detector (drift/tes... | → | deadmodule检测器 / dead_module_detector (code_dedup/dead_... | 测试依赖 / test_depends |
| 26 | D_GOVERNANCE 生命周期管理: 差异检测器测试 / Test Diff Detector (drift/test_diff_dete... | → | 差异检测器 / diff_detector (code_dedup/diff_detector.py) | 测试依赖 / test_depends |
| 27 | D_GOVERNANCE 生命周期管理: MicroClone检测器测试 / Test Micro Clone Detector (drift/t... | → | microclone检测器 / micro_clone_detector (code_dedup/micro... | 测试依赖 / test_depends |
| 28 | D_GOVERNANCE 生命周期管理: Stale共享检测器测试 / Test Stale Shared Detector (drift/t... | → | stale共享检测器 / stale_shared_detector (code_dedup/stale... | 测试依赖 / test_depends |
| 29 | D_GOVERNANCE 生命周期管理: 集成Hub测试 / Test Integration Hub (integration/test_inte... | → | 集成hub / integration_hub (code_dedup/integration_hub.py) | 测试依赖 / test_depends |
| 30 | D_GOVERNANCE 生命周期管理: Integrations测试 / Test Integrations (integration/test_in... | → | 集成管理——预提交钩子+CI-only 扫描+超时边界. / integrati... | 测试依赖 / test_depends |
| 31 | D_GOVERNANCE 生命周期管理: Hotspot跟踪器测试 / Test Hotspot Tracker (observability/t... | → | 热点追踪器 — 90天滑动窗口 + 高频变动检测 + 新项目预热清... | 测试依赖 / test_depends |
| 32 | D_GOVERNANCE 生命周期管理: 报告测试 / Test Report (observability/test_report.py) | → | 报告 / report (code_dedup/report.py) | 测试依赖 / test_depends |
| 33 | D_GOVERNANCE 生命周期管理: Exit Codes测试 / Test Exit Codes (ops/test_exit_codes.py) | → | 退出codes / exit_codes (code_dedup/exit_codes.py) | 测试依赖 / test_depends |
| 34 | D_GOVERNANCE 生命周期管理: Health监控器测试 / Test Health Monitor (ops/test_health_m... | → | 健康监控 / health_monitor (code_dedup/health_monitor.py) | 测试依赖 / test_depends |
| 35 | D_GOVERNANCE 生命周期管理: Success验证器测试 / Test Success Validator (ops/test_succ... | → | 成功验证——判断一次去重操作是否真正消灭了克隆. / success... | 测试依赖 / test_depends |
| 36 | D_GOVERNANCE 生命周期管理: 验证器测试 / Test Verifier (ops/test_verifier.py) | → | 验证器 / verifier (code_dedup/verifier.py) | 测试依赖 / test_depends |
| 37 | D_GOVERNANCE 生命周期管理: DoomLoop守卫测试 / Test Doom Loop Guard (resilience/test_... | → | doom循环守卫 / doom_loop_guard (code_dedup/doom_loop_guar... | 测试依赖 / test_depends |
| 38 | D_GOVERNANCE 生命周期管理: ObservationWindow守卫测试 / Test Observation Window Guard... | → | 提取后稳定观察期守护 — 对标SDP 14天观察. / observation_w... | 测试依赖 / test_depends |
| 39 | D_GOVERNANCE 生命周期管理: Recovery清单写入器测试 / Test Recovery Manifest Writer (r... | → | 恢复清单写入器 / recovery_manifest_writer (code_dedup/rec... | 测试依赖 / test_depends |
| 40 | D_GOVERNANCE 生命周期管理: Extraction安全测试 / Test Extraction Safety (security/tes... | → | extraction安全 / extraction_safety (code_dedup/extraction... | 测试依赖 / test_depends |
| 41 | D_GOVERNANCE 生命周期管理: ImportSurface跟踪器测试 / Test Import Surface Tracker (se... | → | importsurface追踪器 / import_surface_tracker (trackers/im... | 测试依赖 / test_depends |
| 42 | D_GOVERNANCE 生命周期管理: Monoculture守卫测试 / Test Monoculture Guard (security/te... | → | monoculture守卫 / monoculture_guard (code_dedup/monocultu... | 测试依赖 / test_depends |
| 43 | D_GOVERNANCE 生命周期管理: Sensitivity Sweeper测试 / Test Sensitivity Sweeper (secur... | → | sensitivity清扫器 / sensitivity_sweeper (code_dedup/sensi... | 测试依赖 / test_depends |
| 44 | D_GOVERNANCE 生命周期管理: Signature Matcher测试 / Test Signature Matcher (security/... | → | signature匹配器 / signature_matcher (code_dedup/signature... | 测试依赖 / test_depends |
| 45 | D_GOVERNANCE 生命周期管理: YAML + 环境变量覆盖 / Test App Config Yaml (shared/test_a... | → | 配置 / config (code_dedup/config.py) | 测试依赖 / test_depends |
| 46 | D_GOVERNANCE 生命周期管理: 共享Evolver测试 / Test Shared Evolver (shared/test_shared... | → | 共享函数自我进化引擎 — 自动升降级 + 行为漂移锁定. / shar... | 测试依赖 / test_depends |
| 47 | D_GOVERNANCE 生命周期管理: 共享生命周期管理器测试 / Test Shared Lifecycle Manager (s... | → | 共享生命周期管理器 / shared_lifecycle_manager (code_dedup... | 测试依赖 / test_depends |
...
| 54 | D_GOV_AUDIT 审计追踪: FalseNegative审计器测试 / Test False Negative Auditor (au... | → | falsenegative审计器 / false_negative_auditor (code_dedup/... | 测试依赖 / test_depends |
| 55 | D_GOV_AUDIT 审计追踪: FifteenDimension审计器测试 / Test Fifteen Dimension Audit... | → | 15维超综合审计首页 — 逐项证明"做过且做对". / fifteen_dim... | 测试依赖 / test_depends |
...
| 59 | D_GOV_ENFORCEMENT 规则执行: 会话Worktree / Session Worktree (rule_bridge/session_work... | → | 包入口 / __init__ (commit_gates/__init__.py) | 导入依赖 / import_depends |
| 60 | D_GOV_ENFORCEMENT 规则执行: 会话Worktree / Session Worktree (rule_bridge/session_work... | → | capabilitylookuprequired门禁 / capability_lookup_required... | 导入依赖 / import_depends |
| 61 | D_GOV_ENFORCEMENT 规则执行: 会话Worktree / Session Worktree (rule_bridge/session_work... | → | 测试-源码符号一致性门禁 / Test Source Consistency Gate (c... | 导入依赖 / import_depends |
...
| 111 | D_GOV_ENFORCEMENT 规则执行: OpenWithoutWith门禁测试 / Test Open Without With Gate (co... | → | openwithoutwith门禁 / open_without_with_gate (commit_gate... | 测试依赖 / test_depends |
...
| 120 | D_GOV_ENFORCEMENT 规则执行: 规则执行Pairing门禁测试 / Test Rule Execution Pairing Gat... | → | 规则-执行配对门禁 / Rule Execution Pairing Gate (commit_g... | 测试依赖 / test_depends |
...
| 139 | D_GOV_OPS_RESILIENCE 运维弹性治理: Debt Projector测试 / Test Debt Projector (budget/test_deb... | → | debt投影器 / debt_projector (code_dedup/debt_projector.py) | 测试依赖 / test_depends |
| 140 | D_GOV_OPS_RESILIENCE 运维弹性治理: Degradation测试 / Test Degradation (budget/test_degradati... | → | 退化 / degradation (code_dedup/degradation.py) | 测试依赖 / test_depends |
| 141 | D_GOV_OPS_RESILIENCE 运维弹性治理: Prioritizer测试 / Test Prioritizer (orchestrator/test_pri... | → | 修复优先级排序器 — 置信度×Impact×适配性 三因子排序. / ... | 测试依赖 / test_depends |

...
flowchart TD
    ...
    src_zephyr_gov_enforcement_commit_gates_new_file_depgraph_gate_py -->|导入依赖 / import_depends| D_GOV_ENFORCEMENT
    src_zephyr_gov_enforcement_commit_gates_import_integrity_gate_py -->|导入依赖 / import_depends| D_GOV_ENFORCEMENT
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_long_param_list_gate_py
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_manual_only_permanent_gate_py
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_precommit_offline_gate_py
    ...
    class D_GOV_ENFORCEMENT,D_GOV_RULE,D_SHARED,D_DATA,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_AUDIT external_prod
```

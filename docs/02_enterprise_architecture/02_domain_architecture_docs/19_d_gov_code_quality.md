...
flowchart TD
    ...
    src_zephyr_gov_enforcement_commit_gates_issue_resolved_integrity_gate_py -->|导入依赖 / import_depends| D_GOV_ENFORCEMENT
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SHARED,D_GOV_SCRIPTS,D_GOV_AUDIT external_prod
```

...
flowchart TD
    ...
    src_zephyr_gov_code_quality_code_dedup_shared_evolver_py["共享函数自我进化引擎 — 自动升降级 + 行为漂移锁定<br/>code dedup包的shared_evolver模块<br/>文件: code_dedup/shared_evolver.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_code_quality_code_dedup_atomic_fixer_py["原子性修复引擎 — WAL 式 PREFLIGHT -> CHECKPOINT<br/>code dedup包的atomic_fixer模块<br/>文件: code_dedup/atomic_fixer.py<br/>(生产态 / production)"]

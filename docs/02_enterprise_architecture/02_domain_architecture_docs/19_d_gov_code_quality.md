...
flowchart TD
    ...
    src_zephyr_gov_enforcement_commit_gates_depgraph_pre_registration_gate_py -->|导入依赖 / import_depends| D_GOV_ENFORCEMENT
    ...
    src_zephyr_gov_enforcement_commit_gates_file_copy_gate_py -->|导入依赖 / import_depends| D_GOV_ENFORCEMENT
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
```

...
flowchart TD
    ...
    src_zephyr_gov_enforcement_commit_gates_translation_coverage_gate_py -->|导入依赖 / import_depends| D_GOV_SCRIPTS
    ...
    tests_governance_rule_enforcement_gate_engine_test_adversarial_validation_py -->|测试依赖 / test_depends| D_FBL_VERIFICATION
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_dangling_reference_gate_py
    ...
    class D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_AUDIT,D_SECURITY,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_RULE external_prod
```

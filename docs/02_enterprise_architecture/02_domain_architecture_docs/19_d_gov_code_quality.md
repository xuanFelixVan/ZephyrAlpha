...
flowchart TD
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_diff_helpers_py
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_hardcoded_url_gate_py
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_RULE,D_SHARED,D_GOV_AUDIT external_prod
```

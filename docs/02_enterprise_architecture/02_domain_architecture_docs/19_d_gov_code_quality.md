...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_DATA,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_DATA,D_GOV_AUDIT external_prod
```

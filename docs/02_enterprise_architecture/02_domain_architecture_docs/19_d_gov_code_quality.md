...
flowchart TD
    ...
    src_zephyr_gov_code_quality_code_dedup_trackers_hotspot_tracker_py ~~~ src_zephyr_gov_code_quality_code_dedup_trackers_risk_mitigation_tracker_py
    ...
    src_zephyr_gov_code_quality_code_dedup_ssot_registrar_py ~~~ src_zephyr_gov_code_quality_code_dedup_trackers_import_surface_tracker_py
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_DATA,D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
```

...
flowchart TD
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_ruling_reference_gate_py
    ...
    class D_SHARED,D_DATA,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_RULE external_prod
```

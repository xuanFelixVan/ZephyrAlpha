...
flowchart TD
    ...
    tests_governance_rule_enforcement_gate_engine_test_adversarial_validation_gate_py -->|测试依赖 / test_depends| D_GOV_RULE
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_ruling_commit_verified_gate_py
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_unsafe_dict_spread_gate_py
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_ssot_redefinition_gate_py
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_GOVERNANCE external_prod
```

...
flowchart TD
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_module_id_consistency_gate_py
    ...
    class D_GOV_RULE,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOVERNANCE external_prod
```

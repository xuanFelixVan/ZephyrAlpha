...
flowchart TD
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_capability_lookup_required_gate_py
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
```

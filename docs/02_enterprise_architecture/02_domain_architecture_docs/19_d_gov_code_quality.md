...
flowchart TD
    ...
    src_zephyr_gov_enforcement_commit_gates_translation_coverage_gate_py -->|导入依赖 / import_depends| D_GOV_ENFORCEMENT
    ...
    D_GOV_ENFORCEMENT -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_commit_gates_capability_lookup_bypass_policy_py
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod
```

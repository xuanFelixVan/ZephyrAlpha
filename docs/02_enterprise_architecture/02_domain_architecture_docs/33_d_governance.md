...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_EX_CORE,D_GOV_DRIFT,D_AUTONOMY_CORE external_design
```
...
> 按 architecture_layer 分层显示 生命周期管理（D_GOVERNANCE）的模块分布。共 590 个模块 / 590 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (545 modules)            │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 590 个模块 / 590 modules）。
...
| 189 | src/zephyr/governance/bridges/rbac_bridge.py | src/zephyr/governance/bridges/rbac_br... | prototype | generated |
| 190 | src/zephyr/governance/bridges/spec_auditor.py | src/zephyr/governance/bridges/spec_au... | prototype | generated |
| 191 | src/zephyr/governance/broker_interface.py | src/zephyr/governance/broker_interfac... | prototype | generated |
| 192 | src/zephyr/governance/broker_resilience.py | src/zephyr/governance/broker_resilien... | prototype | generated |
| 193 | src/zephyr/governance/cache_manager.py | src/zephyr/governance/cache_manager.py | prototype | generated |
| 194 | src/zephyr/governance/canary_manager.py | src/zephyr/governance/canary_manager.py | prototype | generated |
| 195 | src/zephyr/governance/canary_register.py | src/zephyr/governance/canary_register.py | prototype | generated |
| 196 | src/zephyr/governance/cli.py | src/zephyr/governance/cli.py | prototype | generated |
| 197 | src/zephyr/governance/code_analyzer_runner.py | src/zephyr/governance/code_analyzer_r... | prototype | generated |
| 198 | src/zephyr/governance/code_simulator.py | src/zephyr/governance/code_simulator.py | prototype | generated |
| 199 | src/zephyr/governance/compliance_gate_a6/__init__.py | src/zephyr/governance/compliance_gate... | prototype | generated |
| 200 | src/zephyr/governance/compliance_rule.py | src/zephyr/governance/compliance_rule.py | prototype | generated |

> (仅显示前 200 个模块，共 545 个)
...
> 域内模块依赖关系（共 382 条 / 382 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 382 条 / 382 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [config_depends]: 218 条 / edges                               │
│   [import_depends]: 138 条 / edges                               │
...
│   ...还有 169 条 / 169 more edges                                │
└──────────────────────────────────────────────────────────────────┘

**[import_depends]** (138 条 / edges) — 已达显示上限，省略 / limit reached

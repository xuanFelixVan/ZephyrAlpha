...
graph TD
    ...
    class tests_ml_experiment_test_adversarial_ml_py,tests_ml_experiment_test_adversarial_ml_experiment_py,tests_semantic_auditor_init_py,tests_semantic_auditor_test_blast_radius_py,tests_semantic_auditor_test_blast_radius_red_team_py,tests_zephyr_shared_infra_test_process_lifecycle_gateway_py design
    class D_CROSS_ASSET,D_INTELLIGENCE,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
> 按 architecture_layer 分层显示 生命周期管理（D_GOVERNANCE）的模块分布。共 578 个模块 / 578 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (533 modules)            │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 578 个模块 / 578 modules）。
...
| 161 | src/zephyr/governance/alt_data_connector/provider_base.py | src/zephyr/governance/alt_data_connec... | prototype | generated |
| 162 | src/zephyr/governance/annotations.py | src/zephyr/governance/annotations.py | prototype | generated |
| 163 | src/zephyr/governance/architecture_governance/__init__.py | src/zephyr/governance/architecture_go... | prototype | generated |
| 164 | src/zephyr/governance/architecture_governance/architectur... | src/zephyr/governance/architecture_go... | prototype | generated |
| 165 | src/zephyr/governance/architecture_governance/architectur... | src/zephyr/governance/architecture_go... | prototype | generated |
| 166 | src/zephyr/governance/architecture_governance/cross_env_c... | src/zephyr/governance/architecture_go... | prototype | generated |
| 167 | src/zephyr/governance/architecture_governance/dependency_... | src/zephyr/governance/architecture_go... | prototype | generated |
| 168 | src/zephyr/governance/architecture_governance/local_first... | src/zephyr/governance/architecture_go... | prototype | generated |
| 169 | src/zephyr/governance/architecture_governance/path_resolv... | src/zephyr/governance/architecture_go... | production | generated |
| 170 | src/zephyr/governance/architecture_governance/system_topo... | src/zephyr/governance/architecture_go... | prototype | generated |
| 171 | src/zephyr/governance/ast_comparator.py | src/zephyr/governance/ast_comparator.py | prototype | generated |
| 172 | src/zephyr/governance/atomic_fixer.py | src/zephyr/governance/atomic_fixer.py | prototype | generated |
| 173 | src/zephyr/governance/audit_trail/orchestrator.py | src/zephyr/governance/audit_trail/orc... | prototype | generated |
| 174 | src/zephyr/governance/auto_fixer.py | src/zephyr/governance/auto_fixer.py | prototype | generated |
| 175 | src/zephyr/governance/base.py | src/zephyr/governance/base.py | prototype | generated |
| 176 | src/zephyr/governance/behavioral_admission/__init__.py | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 177 | src/zephyr/governance/behavioral_admission/admission_cont... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 178 | src/zephyr/governance/behavioral_admission/admission_resp... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 179 | src/zephyr/governance/behavioral_admission/code_review_ai.py | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 180 | src/zephyr/governance/behavioral_admission/gpu_consensus_... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 181 | src/zephyr/governance/behavioral_admission/protection_ind... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 182 | src/zephyr/governance/behavioral_admission/session_lifecy... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 183 | src/zephyr/governance/behavioral_admission/verdict_engine.py | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 184 | src/zephyr/governance/behavioral_sampler.py | src/zephyr/governance/behavioral_samp... | prototype | generated |
| 185 | src/zephyr/governance/behavioral_trust_checker.py | src/zephyr/governance/behavioral_trus... | prototype | generated |
| 186 | src/zephyr/governance/blind_spot_tracker.py | src/zephyr/governance/blind_spot_trac... | prototype | generated |
| 187 | src/zephyr/governance/bridges/__init__.py | src/zephyr/governance/bridges/__init_... | prototype | generated |
| 188 | src/zephyr/governance/bridges/alerts.py | src/zephyr/governance/bridges/alerts.py | prototype | generated |
| 189 | src/zephyr/governance/bridges/spec_auditor.py | src/zephyr/governance/bridges/spec_au... | prototype | generated |
| 190 | src/zephyr/governance/broker_interface.py | src/zephyr/governance/broker_interfac... | prototype | generated |
| 191 | src/zephyr/governance/broker_resilience.py | src/zephyr/governance/broker_resilien... | prototype | generated |
| 192 | src/zephyr/governance/cache_manager.py | src/zephyr/governance/cache_manager.py | prototype | generated |
| 193 | src/zephyr/governance/canary_manager.py | src/zephyr/governance/canary_manager.py | prototype | generated |
| 194 | src/zephyr/governance/canary_register.py | src/zephyr/governance/canary_register.py | prototype | generated |
| 195 | src/zephyr/governance/cli.py | src/zephyr/governance/cli.py | prototype | generated |
| 196 | src/zephyr/governance/code_analyzer_runner.py | src/zephyr/governance/code_analyzer_r... | prototype | generated |
| 197 | src/zephyr/governance/code_simulator.py | src/zephyr/governance/code_simulator.py | prototype | generated |
| 198 | src/zephyr/governance/compliance_gate_a6/__init__.py | src/zephyr/governance/compliance_gate... | prototype | generated |
| 199 | src/zephyr/governance/compliance_rule.py | src/zephyr/governance/compliance_rule.py | prototype | generated |
| 200 | src/zephyr/governance/config.py | src/zephyr/governance/config.py | prototype | generated |

> (仅显示前 200 个模块，共 533 个)
...
> 域内模块依赖关系（共 370 条 / 370 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 370 条 / 370 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [config_depends]: 207 条 / edges                               │

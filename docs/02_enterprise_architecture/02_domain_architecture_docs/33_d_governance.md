...
| 域内依赖 | 597 | Internal Dependencies | 597 |
...
graph TD
    ...
    scripts_archive_construction_create_dm_phase9_tasks_py -.->|config_depends| scripts_archive_construction_dm014_orphan_edge_repair_py
...
graph TD
    ...
    scripts_mcp_start_all_py -.->|config_depends| scripts_mcp_status_all_py
    ...
    class D_INTELLIGENCE,D_SECURITY,D_INFRA_RECOVERY,D_SHARED,D_TRADING,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    src_zephyr_governance_architecture_governance_init_py -.->|config_depends| src_zephyr_governance_architecture_governance_blueprint_reconciler_py
    D_TRADING["D_TRADING production"]
    ...
    class D_TRADING,D_SHARED,D_SECURITY,D_INFRA_RECOVERY,D_INTELLIGENCE,D_INFRA_RUNTIME,D_EX_CORE external_prod
...
graph TD
    ...
    class D_REPORTING,D_SHARED,D_TRADING,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    src_zephyr_governance_data_governance_init_py -.->|config_depends| src_zephyr_governance_data_governance_data_pipeline_guard_py
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_INTELLIGENCE external_prod
    class D_AUDITTEST external_design
```
...
> 域内模块依赖关系（共 597 条 / 597 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 597 条 / 597 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [import_depends]: 398 条 / edges                               │
│   [config_depends]: 176 条 / edges                               │
│   [runtime]: 14 条 / edges                                       │
│   [contract]: 5 条 / edges                                       │
│   [data]: 4 条 / edges                                           │
└──────────────────────────────────────────────────────────────────┘
...
**[config_depends]** (176 条 / edges) — 已达显示上限，省略 / limit reached

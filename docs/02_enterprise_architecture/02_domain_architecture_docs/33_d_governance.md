...
| 原型态模块 | 384 | Prototype Modules | 384 |
...
graph TD
    ...
    scripts_archive_governance_d3_metadata_check_template_compliance_py -.->|config_depends| scripts_archive_governance_d3_metadata_detect_skip_active_status_py
    ...
    scripts_archive_governance_d3_metadata_fix_dm411_bare_relative_imports_py -.->|config_depends| scripts_archive_governance_d3_metadata_check_template_compliance_py
    D_GOV_DRIFT["D_GOV_DRIFT design"]
...
graph TD
    ...
    scripts_construction_demo_a2a_chat_py -.->|config_depends| scripts_construction_demo_a2a_coordination_py
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_SECURITY,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_TRADING,D_INFRA_RECOVERY,D_INTELLIGENCE,D_EX_CORE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_INTELLIGENCE external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_governance_observability_governance_projection_engine_py
    ...
    class D_COMPLIANCE,D_INTEGRATION_GATEWAY,D_REPORTING,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_A2A,D_FRONTEND,D_INFRA_RECOVERY,D_TRADING external_prod
    class D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_INTELLIGENCE,D_SECURITY external_design
```
...
graph TD
    ...
    class src_zephyr_governance_trading_contracts_risk_risk_validator_protocol_py,src_zephyr_governance_zero_knowledge_audit_stub_init_py design
...
> 按 architecture_layer 分层显示 生命周期管理（D_GOVERNANCE）的模块分布。共 873 个模块 / 873 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (848 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 873 个模块 / 873 modules）。

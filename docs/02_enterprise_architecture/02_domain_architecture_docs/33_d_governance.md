...
graph TD
    ...
    src_zephyr_governance_ast_comparator_py -.->|config_depends| src_zephyr_governance_init_py
    src_zephyr_governance_atomic_fixer_py -.->|config_depends| src_zephyr_governance_init_py
    src_zephyr_governance_auto_fixer_py -.->|config_depends| src_zephyr_governance_init_py
...
graph TD
    ...
    class src_zephyr_governance_behavioral_admission_gpu_consensus_scheduler_py,src_zephyr_governance_behavioral_admission_protection_index_py,src_zephyr_governance_behavioral_admission_session_lifecycle_py,src_zephyr_governance_behavioral_admission_verdict_engine_py,src_zephyr_governance_behavioral_sampler_py,src_zephyr_governance_behavioral_trust_checker_py,src_zephyr_governance_blind_spot_tracker_py,src_zephyr_governance_bridges_init_py,src_zephyr_governance_bridges_alerts_py,src_zephyr_governance_bridges_spec_auditor_py,src_zephyr_governance_broker_interface_py,src_zephyr_governance_broker_resilience_py,src_zephyr_governance_cache_manager_py,src_zephyr_governance_canary_manager_py,src_zephyr_governance_canary_register_py,src_zephyr_governance_cli_py,src_zephyr_governance_code_analyzer_runner_py,src_zephyr_governance_code_simulator_py,src_zephyr_governance_compliance_gate_a6_init_py,src_zephyr_governance_compliance_rule_py,src_zephyr_governance_config_py,src_zephyr_governance_consequence_tracker_py,src_zephyr_governance_constitutional_update_init_py,src_zephyr_governance_context_governance_init_py,src_zephyr_governance_context_governance_prompt_lifecycle_py,src_zephyr_governance_context_manager_py,src_zephyr_governance_context_recycling_py,src_zephyr_governance_contract_consistency_checker_py design
    class D_TRADING,D_GOV_AUDIT,D_SHARED,D_GOV_RULE,D_PF_CORE external_prod
    class D_COMPLIANCE,D_EX_CORE external_design
```

### 第 9 页 / 共 20 页 / Page 9 of 20
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_governance_core_init_py,src_zephyr_governance_cross_boundary_detector_py,src_zephyr_governance_data_governance_init_py,src_zephyr_governance_data_governance_data_classification_py,src_zephyr_governance_data_governance_data_lifecycle_py,src_zephyr_governance_data_governance_data_quality_py,src_zephyr_governance_data_governance_data_source_reliability_py,src_zephyr_governance_data_lifecycle_py,src_zephyr_governance_database_manager_py,src_zephyr_governance_dead_module_detector_py,src_zephyr_governance_debt_projector_py,src_zephyr_governance_decision_auditor_py,src_zephyr_governance_decision_fatigue_py,src_zephyr_governance_decision_fatigue_cli_py,src_zephyr_governance_default_attribution_engine_py,src_zephyr_governance_default_tca_engine_py,src_zephyr_governance_degradation_py,src_zephyr_governance_depgraph_schema_py,src_zephyr_governance_diff_detector_py,src_zephyr_governance_doom_loop_guard_py,src_zephyr_governance_drift_detection_init_py,src_zephyr_governance_drift_detection_main_py,src_zephyr_governance_drift_detection_absence_manager_py,src_zephyr_governance_drift_detection_ai_construction_detectors_py,src_zephyr_governance_drift_detection_ai_context_injector_py,src_zephyr_governance_drift_detection_alert_router_py,src_zephyr_governance_drift_detection_backcompat_checker_py,src_zephyr_governance_drift_detection_baseline_poisoning_guard_py,src_zephyr_governance_drift_detection_brain_integration_py,src_zephyr_governance_drift_detection_bridges_init_py design
    class D_TRADING,D_PF_CORE external_prod
    class D_REPORTING,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_GOV_SCRIPTS external_design
```

### 第 10 页 / 共 20 页 / Page 10 of 20
...
graph TD
    ...
    class src_zephyr_governance_drift_detection_self_check_py,src_zephyr_governance_drift_detection_self_test_verifier_py,src_zephyr_governance_drift_detection_state_machine_py,src_zephyr_governance_drift_detection_suppression_learner_py,src_zephyr_governance_drift_detection_symlink_checker_py,src_zephyr_governance_drift_detection_tamper_proof_audit_py,src_zephyr_governance_drift_detection_test_fixture_checker_py,src_zephyr_governance_drift_detection_trend_analyzer_py,src_zephyr_governance_evidence_pack_py,src_zephyr_governance_exit_codes_py,src_zephyr_governance_extraction_safety_py,src_zephyr_governance_false_negative_auditor_py,src_zephyr_governance_fifteen_dimension_auditor_py,src_zephyr_governance_file_creator_py,src_zephyr_governance_financial_governance_init_py,src_zephyr_governance_financial_governance_financial_compliance_py,src_zephyr_governance_financial_governance_fsm_verifier_py,src_zephyr_governance_financial_governance_market_data_pipeline_py,src_zephyr_governance_financial_governance_microstructure_defense_py,src_zephyr_governance_financial_governance_oms_risk_engine_py,src_zephyr_governance_financial_governance_strategy_portfolio_py,src_zephyr_governance_finding_ingest_py,src_zephyr_governance_function_discovery_py,src_zephyr_governance_gate_repo_py,src_zephyr_governance_grandfather_manager_py,src_zephyr_governance_health_monitor_py design
    class D_GOV_AUDIT,D_SHARED,D_COMPLIANCE external_design
```

### 第 12 页 / 共 20 页 / Page 12 of 20
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_governance_intelligence_governance_agent_debate_py,src_zephyr_governance_lifecycle_governance_api_lifecycle_py,src_zephyr_governance_ops_governance_agent_dispatch_py,src_zephyr_governance_ops_governance_event_hook_py production
    class src_zephyr_governance_hotspot_tracker_py,src_zephyr_governance_implementations_init_py,src_zephyr_governance_implementations_default_experiment_pipeline_py,src_zephyr_governance_implementations_default_security_gateway_py,src_zephyr_governance_import_surface_tracker_py,src_zephyr_governance_integration_hub_py,src_zephyr_governance_integrations_py,src_zephyr_governance_intelligence_governance_init_py,src_zephyr_governance_intelligence_governance_ai_self_diagnosis_py,src_zephyr_governance_intelligence_governance_knowledge_engine_py,src_zephyr_governance_intelligence_governance_multi_model_consensus_py,src_zephyr_governance_lifecycle_governance_init_py,src_zephyr_governance_lifecycle_governance_migration_strategy_py,src_zephyr_governance_lifecycle_governance_paper_live_transition_py,src_zephyr_governance_lifecycle_governance_post_live_verification_py,src_zephyr_governance_micro_clone_detector_py,src_zephyr_governance_mock_duplicate_generator_py,src_zephyr_governance_monoculture_guard_py,src_zephyr_governance_observation_window_guard_py,src_zephyr_governance_ops_foundation_py,src_zephyr_governance_ops_governance_init_py,src_zephyr_governance_ops_governance_decision_fatigue_py,src_zephyr_governance_ops_governance_environment_manager_py,src_zephyr_governance_ops_governance_phase_check_registry_py,src_zephyr_governance_ops_governance_phase_manager_py,src_zephyr_governance_ops_governance_realtime_streaming_py design
    class D_AUTONOMY_CORE,D_SECURITY,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_GOV_AUDIT,D_GOV_DRIFT,D_COMPLIANCE,D_TRADING,D_GOV_SCRIPTS external_design
```

### 第 13 页 / 共 20 页 / Page 13 of 20
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_governance_persistence_init_py,src_zephyr_governance_rule_bridge_commit_gate_registry_py,src_zephyr_governance_rule_bridge_git_commit_gateway_py,src_zephyr_governance_rule_enforcement_invariants_post_doc_review_check_py,src_zephyr_governance_rule_enforcement_phase_executor_py,src_zephyr_governance_security_governance_supply_chain_security_py production
    class src_zephyr_governance_ops_governance_startup_shutdown_py,src_zephyr_governance_ops_governance_startup_shutdown_cli_py,src_zephyr_governance_path_index_validator_py,src_zephyr_governance_performance_attribution_report_py,src_zephyr_governance_phase_executor_py,src_zephyr_governance_pipeline_base_py,src_zephyr_governance_policy_tree_validator_py,src_zephyr_governance_pre_apply_integrity_gate_py,src_zephyr_governance_prioritizer_py,src_zephyr_governance_question_tracker_py,src_zephyr_governance_recovery_manifest_writer_py,src_zephyr_governance_red_blue_validator_init_py,src_zephyr_governance_report_py,src_zephyr_governance_resilience_governance_init_py,src_zephyr_governance_resilience_governance_bus_factor_defense_py,src_zephyr_governance_resilience_governance_fault_tolerance_py,src_zephyr_governance_resilience_governance_offline_autonomy_py,src_zephyr_governance_resilience_governance_offline_resilience_py,src_zephyr_governance_risk_mitigation_tracker_py,src_zephyr_governance_risk_mitigator_py,src_zephyr_governance_satellite_geospatial_engine_init_py,src_zephyr_governance_security_governance_init_py,src_zephyr_governance_self_scanner_py,src_zephyr_governance_semantic_audit_init_py design
    class D_PF_CORE external_prod
    class D_SHARED,D_GOV_AUDIT,D_REPORTING,D_TRADING external_design
```

### 第 14 页 / 共 20 页 / Page 14 of 20
...
graph TD
    ...
    class tests_ml_experiment_test_adversarial_ml_experiment_py,tests_semantic_auditor_init_py,tests_semantic_auditor_test_blast_radius_py,tests_semantic_auditor_test_blast_radius_red_team_py,tests_zephyr_shared_infra_test_process_lifecycle_gateway_py design
...
> 按 architecture_layer 分层显示 生命周期管理（D_GOVERNANCE）的模块分布。共 577 个模块 / 577 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (532 modules)            │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 577 个模块 / 577 modules）。
...
| 155 | src/zephyr/governance/adapters/__init__.py | src/zephyr/governance/adapters/__init... | prototype | generated |
| 156 | src/zephyr/governance/adapters/risk_validation_bridge.py | src/zephyr/governance/adapters/risk_v... | prototype | generated |
| 157 | src/zephyr/governance/adapters/simulation_broker.py | src/zephyr/governance/adapters/simula... | prototype | generated |
| 158 | src/zephyr/governance/agent_spec/__init__.py | src/zephyr/governance/agent_spec/__in... | prototype | generated |
| 159 | src/zephyr/governance/agent_spec/registry.py | src/zephyr/governance/agent_spec/regi... | prototype | generated |
| 160 | src/zephyr/governance/alt_data_connector/__init__.py | src/zephyr/governance/alt_data_connec... | prototype | generated |
| 161 | src/zephyr/governance/annotations.py | src/zephyr/governance/annotations.py | prototype | generated |
| 162 | src/zephyr/governance/architecture_governance/__init__.py | src/zephyr/governance/architecture_go... | prototype | generated |
| 163 | src/zephyr/governance/architecture_governance/architectur... | src/zephyr/governance/architecture_go... | prototype | generated |
| 164 | src/zephyr/governance/architecture_governance/architectur... | src/zephyr/governance/architecture_go... | prototype | generated |
| 165 | src/zephyr/governance/architecture_governance/cross_env_c... | src/zephyr/governance/architecture_go... | prototype | generated |
| 166 | src/zephyr/governance/architecture_governance/dependency_... | src/zephyr/governance/architecture_go... | prototype | generated |
| 167 | src/zephyr/governance/architecture_governance/local_first... | src/zephyr/governance/architecture_go... | prototype | generated |
| 168 | src/zephyr/governance/architecture_governance/path_resolv... | src/zephyr/governance/architecture_go... | production | generated |
| 169 | src/zephyr/governance/architecture_governance/system_topo... | src/zephyr/governance/architecture_go... | prototype | generated |
| 170 | src/zephyr/governance/ast_comparator.py | src/zephyr/governance/ast_comparator.py | prototype | generated |
| 171 | src/zephyr/governance/atomic_fixer.py | src/zephyr/governance/atomic_fixer.py | prototype | generated |
| 172 | src/zephyr/governance/audit_trail/orchestrator.py | src/zephyr/governance/audit_trail/orc... | prototype | generated |
| 173 | src/zephyr/governance/auto_fixer.py | src/zephyr/governance/auto_fixer.py | prototype | generated |
| 174 | src/zephyr/governance/base.py | src/zephyr/governance/base.py | prototype | generated |
| 175 | src/zephyr/governance/behavioral_admission/__init__.py | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 176 | src/zephyr/governance/behavioral_admission/admission_cont... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 177 | src/zephyr/governance/behavioral_admission/admission_resp... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 178 | src/zephyr/governance/behavioral_admission/code_review_ai.py | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 179 | src/zephyr/governance/behavioral_admission/gpu_consensus_... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 180 | src/zephyr/governance/behavioral_admission/protection_ind... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 181 | src/zephyr/governance/behavioral_admission/session_lifecy... | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 182 | src/zephyr/governance/behavioral_admission/verdict_engine.py | src/zephyr/governance/behavioral_admi... | prototype | generated |
| 183 | src/zephyr/governance/behavioral_sampler.py | src/zephyr/governance/behavioral_samp... | prototype | generated |
| 184 | src/zephyr/governance/behavioral_trust_checker.py | src/zephyr/governance/behavioral_trus... | prototype | generated |
| 185 | src/zephyr/governance/blind_spot_tracker.py | src/zephyr/governance/blind_spot_trac... | prototype | generated |
| 186 | src/zephyr/governance/bridges/__init__.py | src/zephyr/governance/bridges/__init_... | prototype | generated |
| 187 | src/zephyr/governance/bridges/alerts.py | src/zephyr/governance/bridges/alerts.py | prototype | generated |
| 188 | src/zephyr/governance/bridges/spec_auditor.py | src/zephyr/governance/bridges/spec_au... | prototype | generated |
| 189 | src/zephyr/governance/broker_interface.py | src/zephyr/governance/broker_interfac... | prototype | generated |
| 190 | src/zephyr/governance/broker_resilience.py | src/zephyr/governance/broker_resilien... | prototype | generated |
| 191 | src/zephyr/governance/cache_manager.py | src/zephyr/governance/cache_manager.py | prototype | generated |
| 192 | src/zephyr/governance/canary_manager.py | src/zephyr/governance/canary_manager.py | prototype | generated |
| 193 | src/zephyr/governance/canary_register.py | src/zephyr/governance/canary_register.py | prototype | generated |
| 194 | src/zephyr/governance/cli.py | src/zephyr/governance/cli.py | prototype | generated |
| 195 | src/zephyr/governance/code_analyzer_runner.py | src/zephyr/governance/code_analyzer_r... | prototype | generated |
| 196 | src/zephyr/governance/code_simulator.py | src/zephyr/governance/code_simulator.py | prototype | generated |
| 197 | src/zephyr/governance/compliance_gate_a6/__init__.py | src/zephyr/governance/compliance_gate... | prototype | generated |
| 198 | src/zephyr/governance/compliance_rule.py | src/zephyr/governance/compliance_rule.py | prototype | generated |
| 199 | src/zephyr/governance/config.py | src/zephyr/governance/config.py | prototype | generated |
| 200 | src/zephyr/governance/consequence_tracker.py | src/zephyr/governance/consequence_tra... | prototype | generated |

> (仅显示前 200 个模块，共 532 个)
...
| 41 | src/zephyr/governance/rule_enforcement/phase_executor.py | src/zephyr/governance/rule_enforcemen... | production | generated |
| 42 | src/zephyr/governance/semantic_audit/orchestrator.py | src/zephyr/governance/semantic_audit/... | production | generated |

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 369 条 / 369 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 369 条 / 369 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [config_depends]: 206 条 / edges                               │
...
│   dead_module_detector.py → __init__.py                          │
│   debt_projector.py → __init__.py                                │
│   decision_auditor.py → __init__.py                              │
│   degradation.py → __init__.py                                   │
│   diff_detector.py → __init__.py                                 │
│   doom_loop_guard.py → __init__.py                               │
│   exit_codes.py → __init__.py                                    │
│   extraction_safety.py → __init__.py                             │
│   false_negative_auditor.py → __init__.py                        │
│   file_creator.py → __init__.py                                  │
│   fifteen_dimension_auditor.py → __init__.py                     │
│   function_discovery.py → __init__.py                            │
│   grandfather_manager.py → __init__.py                           │
│   health_monitor.py → __init__.py                                │
│   hotspot_tracker.py → __init__.py                               │
│   import_surface_tracker.py → __init__.py                        │
│   integrations.py → __init__.py                                  │
│   micro_clone_detector.py → __init__.py                          │
│   mock_duplicate_generator.py → __init__.py                      │
│   monoculture_guard.py → __init__.py                             │
│   ops_foundation.py → __init__.py                                │
│   observation_window_guard.py → __init__.py                      │
│   path_index_validator.py → __init__.py                          │
│   phase_executor.py → __init__.py                                │
│   pre_apply_integrity_gate.py → __init__.py                      │
│   prioritizer.py → __init__.py                                   │
│   question_tracker.py → __init__.py                              │
│   recovery_manifest_writer.py → __init__.py                      │
│   ...还有 157 条 / 157 more edges                                │
└──────────────────────────────────────────────────────────────────┘

**[import_depends]** (137 条 / edges) — 已达显示上限，省略 / limit reached

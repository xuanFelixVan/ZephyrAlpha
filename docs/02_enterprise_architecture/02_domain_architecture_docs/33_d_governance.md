...
| 模块数 | 880 | Module Count | 880 |
| 域内依赖 | 605 | Internal Dependencies | 605 |
| 跨域入边 | 685 | Cross-domain Incoming | 685 |
| 跨域出边 | 289 | Cross-domain Outgoing | 289 |
| 设计态模块 | 25 | Design Modules | 25 |
| 原型态模块 | 389 | Prototype Modules | 389 |
| 生产态模块 | 466 | Production Modules | 466 |
| 容量 | 466/150 (超容) | Capacity | 466/150 (超容) |
...
graph TD
    ...
    docs_03_modules_cross_layer_resource_optimization_engine_blueprint_md -.->|contract| docs_03_modules_domain_autonomy_core_agent_spec_blueprint_md
    ...
    scripts_archive_construction_dm014_orphan_edge_repair_py -.->|config_depends| scripts_archive_construction_create_dm_phase9_tasks_py
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_KNOWLEDGE,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY,D_SHARED,D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    src_zephyr_governance_architecture_governance_init_py -.->|config_depends| src_zephyr_governance_architecture_governance_blueprint_bloat_monitor_py
...
graph TD
    ...
    src_zephyr_governance_audit_trail_orchestrator_py -->|import_depends| src_zephyr_governance_audit_trail_contracts_py
    ...
    class D_SHARED,D_TRADING,D_INTEGRATION,D_INFRA_RECOVERY,D_INFRA_A2A,D_INFRA_RUNTIME,D_SECURITY external_prod
    class D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_governance_context_governance_init_py -.->|config_depends| src_zephyr_governance_context_governance_context_package_py
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    src_zephyr_governance_intelligence_governance_init_py -.->|config_depends| src_zephyr_governance_intelligence_governance_aisg_sandbox_py
    D_SHARED["D_SHARED production"]
    ...
    class D_SHARED,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INFRA_A2A,D_TRADING external_prod
    class D_COMPLIANCE,D_INTEGRATION_GATEWAY,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class src_zephyr_governance_intelligence_governance_model_provider_data_py,src_zephyr_governance_intelligence_governance_self_benchmark_py,src_zephyr_governance_kb_init_py,src_zephyr_governance_kb_batch_ingest_py,src_zephyr_governance_kb_filing_nlp_engine_init_py,src_zephyr_governance_kb_integrity_py,src_zephyr_governance_kb_kb_engine_init_py,src_zephyr_governance_kb_kb_engine_kb_gate_task_py design
    class D_SECURITY_LLM,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    src_zephyr_governance_ops_governance_auto_runner_py -->|import_depends| D_INFRA_RECOVERY
    src_zephyr_governance_ops_governance_auto_runner_py -->|import_depends| D_INFRA_RECOVERY
    ...
    class D_TRADING,D_SHARED,D_INFRA_RECOVERY,D_OPS,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    src_zephyr_governance_persistence_market_schema_py -.->|config_depends| src_zephyr_governance_persistence_init_py
...
graph TD
    subgraph D_GOVERNANCE["D_GOVERNANCE 生命周期管理"]
        ...
        src_zephyr_governance_rule_patterns_py["src/zephyr/governance/rule_patterns.py prototype"]
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_COMPLIANCE,D_SECURITY,D_INTEGRATION,D_AUDITTEST external_design
```
...
|------|:---:|---------|
| D_AUDITTEST | 497 | test_depends |
| D_TRADING | 26 | import_depends |
| D_GOV_SCRIPTS | 21 | import_depends |
...
> 按 architecture_layer 分层显示 生命周期管理（D_GOVERNANCE）的模块分布。共 880 个模块 / 880 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (855 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 880 个模块 / 880 modules）。
...
> (仅显示前 200 个模块，共 855 个)

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 605 条 / 605 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 605 条 / 605 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [import_depends]: 390 条 / edges                               │
│   [config_depends]: 178 条 / edges                               │
│   [runtime]: 23 条 / edges                                       │
│   [contract]: 9 条 / edges                                       │
│   [data]: 5 条 / edges                                           │
└──────────────────────────────────────────────────────────────────┘
...
│   ...还有 341 条 / 341 more edges                                │
└──────────────────────────────────────────────────────────────────┘

**[config_depends]** (178 条 / edges) — 已达显示上限，省略 / limit reached

**[runtime]** (23 条 / edges) — 已达显示上限，省略 / limit reached

**[contract]** (9 条 / edges) — 已达显示上限，省略 / limit reached

**[data]** (5 条 / edges) — 已达显示上限，省略 / limit reached

> (最多显示前 50 条依赖边，共 605 条)

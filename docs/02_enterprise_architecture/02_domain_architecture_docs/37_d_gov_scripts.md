...
graph TD
    ...
    scripts_governance_d5_architecture_detectors_init_py -.->|config_depends| scripts_governance_d5_architecture_detectors_analyze_same_name_module_relations_py
...
> 按 architecture_layer 分层显示 script_governance（D_GOV_SCRIPTS）的模块分布。共 426 个模块 / 426 modules。

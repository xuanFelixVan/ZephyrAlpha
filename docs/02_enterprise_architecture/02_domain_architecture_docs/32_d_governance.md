...
graph TD
    ...
    class D_INTEGRATION,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY,D_EX_CORE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_TRADING,D_REPORTING,D_SHARED,D_INFRA_RUNTIME external_prod

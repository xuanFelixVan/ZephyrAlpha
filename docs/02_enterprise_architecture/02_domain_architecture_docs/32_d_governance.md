...
graph TD
    ...
    class D_TRADING,D_SHARED,D_SECURITY,D_INTELLIGENCE,D_EX_CORE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_TRADING,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_COMPLIANCE,D_AUDITTEST,D_GOV_ENFORCEMENT,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_TRADING,D_OPS,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_COMPLIANCE,D_INTEGRATION,D_AUDITTEST,D_SECURITY external_design
```

...
graph TD
    ...
    scripts_archive_migration_cross_domain_import_fix_py -.->|config_depends| scripts_archive_migration_create_target_dirs_py
    ...
    scripts_archive_migration_domain_prefix_import_fix_py -.->|config_depends| scripts_archive_migration_create_target_dirs_py
    scripts_archive_migration_execute_move_py -.->|config_depends| scripts_archive_migration_create_target_dirs_py
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY,D_TRADING,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_INTELLIGENCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_TRADING,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_FACTOR,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_SHARED,D_COMPLIANCE,D_SECURITY,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_TRADING,D_OPS,D_INFRA_RUNTIME external_prod
    class D_INFRA_RECOVERY,D_COMPLIANCE,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_PF_CORE,D_TRADING external_prod
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (850 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> (仅显示前 200 个模块，共 850 个)

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 613 条 / 613 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 613 条 / 613 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 5                               │
│   [import_depends]: 415 条 / edges                               │

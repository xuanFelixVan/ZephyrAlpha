...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY,D_TRADING external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
    class D_FRONTEND,D_INTEGRATION,D_GOV_SCRIPTS,D_INTEGRATION_GATEWAY,D_EX_CORE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_REPORTING,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_TRADING external_prod
    class D_SECURITY,D_INFRA_A2A,D_INFRA_RECOVERY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_FACTOR,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING,D_AUTONOMY_CORE external_prod
    class D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INFRA_TELEMETRY,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INTEGRATION_GATEWAY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE,D_SECURITY_LLM,D_TRADING,D_AUTONOMY_CORE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_TRADING,D_OPS,D_INFRA_RUNTIME,D_INTELLIGENCE external_prod
    class D_INFRA_RECOVERY,D_INTEGRATION_GATEWAY,D_REPORTING external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SECURITY,D_INTEGRATION,D_AUDITTEST,D_COMPLIANCE external_design
```

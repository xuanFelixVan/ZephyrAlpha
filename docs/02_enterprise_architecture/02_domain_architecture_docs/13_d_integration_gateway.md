...
graph TD
    ...
    src_zephyr_integration_mcp_governance_server_py -.->|import_depends| D_INFRA_RECOVERY
    src_zephyr_integration_mcp_governance_server_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_integration_mcp_sentinel_server_py -.->|import_depends| D_GOVERNANCE
    D_GOVERNANCE -.->|runtime| src_zephyr_integration_mcp_audit_logger_py
    D_GOVERNANCE -.->|contract| src_zephyr_integration_mcp_audit_logger_py
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY_LLM,D_INTEGRATION,D_SECURITY,D_INFRA_RECOVERY external_prod
```

...
graph TD
    ...
    src_zephyr_integration_mcp_governance_server_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_integration_mcp_telemetry_server_py -.->|import_depends| D_SHARED
    src_zephyr_integration_mcp_governance_server_py -.->|import_depends| D_GOVERNANCE
    ...
    src_zephyr_integration_mcp_governance_server_py -.->|import_depends| D_GOVERNANCE
    D_GOVERNANCE -.->|runtime| src_zephyr_integration_mcp_blueprint_search_server_py
    D_GOVERNANCE -.->|contract| src_zephyr_integration_mcp_blueprint_search_server_py

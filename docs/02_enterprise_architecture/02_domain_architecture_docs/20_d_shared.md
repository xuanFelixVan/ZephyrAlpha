...
| 跨域入边 | 554 | Cross-domain Incoming | 554 |
...
graph TD
    ...
    src_zephyr_shared_blueprint_tools_blueprint_scorer_py -.->|config_depends| src_zephyr_shared_blueprint_tools_architecture_context_loader_py
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_shared_protocols_module_birth_registry_py
...
| D_GOVERNANCE | 110 | import_depends,runtime |

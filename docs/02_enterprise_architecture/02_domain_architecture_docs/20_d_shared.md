...
| 跨域入边 | 453 | Cross-domain Incoming | 453 |
| 跨域出边 | 27 | Cross-domain Outgoing | 27 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 202 | Prototype Modules | 202 |
...
graph TD
    ...
    class src_zephyr_shared_lock_py,src_zephyr_shared_logging_py,src_zephyr_shared_maintenance_dogfooding_py,src_zephyr_shared_maintenance_handbook_py,src_zephyr_shared_maintenance_zero_config_py,src_zephyr_shared_migration_py,src_zephyr_shared_models_py,src_zephyr_shared_observability_02_logging_py,src_zephyr_shared_observability_02_tracing_py,src_zephyr_shared_observer_py,src_zephyr_shared_outbox_py,src_zephyr_shared_pagination_py,src_zephyr_shared_paths_py,src_zephyr_shared_ports_py,src_zephyr_shared_protocols_init_py,src_zephyr_shared_protocols_a2a_init_py,src_zephyr_shared_protocols_a2a_a2a_coordination_py,src_zephyr_shared_protocols_a2a_a2a_protocol_py,src_zephyr_shared_protocols_a2a_a2a_registry_py design
...
graph TD
    ...
    D_AUTONOMY_CORE -.->|import_depends| src_zephyr_shared_shared_services_infra_06_observer_py
    D_GOVERNANCE["D_GOVERNANCE prototype"]
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_shared_services_observability_02_token_utils_py_2
    D_OPS -.->|import_depends| src_zephyr_shared_shared_services_observability_02_metrics_py
    ...
    D_GOV_RULE -->|import_depends| src_zephyr_shared_shared_services_observability_02_session_audit_py
    D_GOVERNANCE -.->|import_depends| src_zephyr_shared_shared_services_session_continuity_py
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    D_GOV_ENFORCEMENT -->|import_depends| src_zephyr_shared_shared_services_lifecycle_task_lifecycle_manager_py
...
|------|:---:|---------|
| D_GOVERNANCE | 181 | import_depends,test_depends |
| D_INTEGRATION | 69 | import_depends |
| D_TRADING | 41 | contract,import_depends |
| D_GOV_AUDIT | 35 | import_depends |
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (208 modules)            │
├──────────────────────────────────────────────────────────────────┤
...
| 161 | src/zephyr/shared/shared_services/__init__.py | src/zephyr/shared/shared_services/__i... | production | deprecated |
| 162 | src/zephyr/shared/shared_services/blueprint_decomposer.py | src/zephyr/shared/shared_services/blu... | production | deprecated |
| 163 | src/zephyr/shared/shared_services/events/__init__.py | src/zephyr/shared/shared_services/eve... | production | deprecated |
| 164 | src/zephyr/shared/shared_services/infra_06/__init__.py | src/zephyr/shared/shared_services/inf... | prototype | deprecated |
| 165 | src/zephyr/shared/shared_services/infra_06/cache.py | src/zephyr/shared/shared_services/inf... | production | deprecated |
| 166 | src/zephyr/shared/shared_services/infra_06/idempotency.py | src/zephyr/shared/shared_services/inf... | production | deprecated |
| 167 | src/zephyr/shared/shared_services/infra_06/limiter.py | src/zephyr/shared/shared_services/inf... | prototype | deprecated |
| 168 | src/zephyr/shared/shared_services/infra_06/lock.py | src/zephyr/shared/shared_services/inf... | production | deprecated |
| 169 | src/zephyr/shared/shared_services/infra_06/observer.py | src/zephyr/shared/shared_services/inf... | production | deprecated |
| 170 | src/zephyr/shared/shared_services/infra_06/outbox.py | src/zephyr/shared/shared_services/inf... | production | deprecated |
| 171 | src/zephyr/shared/shared_services/lifecycle/__init__.py | src/zephyr/shared/shared_services/lif... | production | deprecated |
| 172 | src/zephyr/shared/shared_services/lifecycle/daemon_regist... | src/zephyr/shared/shared_services/lif... | production | deprecated |
| 173 | src/zephyr/shared/shared_services/lifecycle/task_lifecycl... | src/zephyr/shared/shared_services/lif... | production | deprecated |
| 174 | src/zephyr/shared/shared_services/models.py | src/zephyr/shared/shared_services/mod... | production | deprecated |
| 175 | src/zephyr/shared/shared_services/observability_02/__init... | src/zephyr/shared/shared_services/obs... | prototype | deprecated |
| 176 | src/zephyr/shared/shared_services/observability_02/health.py | src/zephyr/shared/shared_services/obs... | production | deprecated |
...
| 186 | src/zephyr/shared/shared_services/session_continuity.py | src/zephyr/shared/shared_services/ses... | production | deprecated |
| 187 | src/zephyr/shared/shared_util/__init__.py | src/zephyr/shared/shared_util/__init_... | prototype | deprecated |
| 188 | src/zephyr/shared/sla/sla_monitor.py | sla_monitor | production | stable |
| 189 | src/zephyr/shared/slo_review_assistant.py | src/zephyr/shared/slo_review_assistan... | production | generated |
| 190 | src/zephyr/shared/ssot_guard.py | src/zephyr/shared/ssot_guard.py | prototype | generated |
| 191 | src/zephyr/shared/state_machine.py | src/zephyr/shared/state_machine.py | prototype | generated |
| 192 | src/zephyr/shared/task_heartbeat.py | src/zephyr/shared/task_heartbeat.py | production | generated |
| 193 | src/zephyr/shared/task_types.py | src/zephyr/shared/task_types.py | prototype | generated |
| 194 | src/zephyr/shared/testing.py | src/zephyr/shared/testing.py | prototype | generated |
| 195 | src/zephyr/shared/time_utils.py | src/zephyr/shared/time_utils.py | prototype | generated |
| 196 | src/zephyr/shared/tracing.py | src/zephyr/shared/tracing.py | prototype | generated |
| 197 | src/zephyr/shared/ttl_cleanup_engine.py | src/zephyr/shared/ttl_cleanup_engine.py | production | generated |
| 198 | src/zephyr/shared/types.py | src/zephyr/shared/types.py | prototype | generated |
| 199 | src/zephyr/shared/utils/__init__.py | src/zephyr/shared/utils/__init__.py | prototype | generated |
| 200 | src/zephyr/shared/utils/context.py | src/zephyr/shared/utils/context.py | prototype | generated |

> (仅显示前 200 个模块，共 208 个)

...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_A2A,D_INTEGRATION external_prod
...
graph TD
    ...
    src_zephyr_shared_security_init_py -.->|config_depends| src_zephyr_shared_security_sandbox_executor_py
...
> 按 architecture_layer 分层显示 共享服务（D_SHARED）的模块分布。共 229 个模块 / 229 modules。
...
| 188 | src/zephyr/shared/queue/task_scheduler.py | src/zephyr/shared/queue/task_schedule... | production | generated |
| 189 | src/zephyr/shared/reliability/__init__.py | src/zephyr/shared/reliability/__init_... | prototype | generated |
| 190 | src/zephyr/shared/reliability/context_guard.py | src/zephyr/shared/reliability/context... | production | generated |
| 191 | src/zephyr/shared/resilience/__init__.py | src/zephyr/shared/resilience/__init__.py | production | generated |
| 192 | src/zephyr/shared/resilience/circuit_breaker.py | src/zephyr/shared/resilience/circuit_... | production | generated |
...
| 195 | src/zephyr/shared/resilience/fallback.py | src/zephyr/shared/resilience/fallback.py | production | generated |
| 196 | src/zephyr/shared/resilience/fault_isolator.py | src/zephyr/shared/resilience/fault_is... | production | generated |
| 197 | src/zephyr/shared/resilience/limiter.py | src/zephyr/shared/resilience/limiter.py | production | generated |
| 198 | src/zephyr/shared/resilience/retry.py | src/zephyr/shared/resilience/retry.py | production | generated |
| 199 | src/zephyr/shared/schema/__init__.py | src/zephyr/shared/schema/__init__.py | prototype | generated |

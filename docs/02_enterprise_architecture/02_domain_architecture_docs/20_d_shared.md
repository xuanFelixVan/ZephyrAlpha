...
| 生产态模块 | 62 | Production Modules | 62 |
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_shared_contracts_escalation_budget_alert_py,src_zephyr_shared_contracts_market_factor_monitor_report_py,src_zephyr_shared_contracts_portfolio_money_py production
    ...
    class D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_INTELLIGENCE external_prod
    class D_OPS,D_GOVERNANCE,D_INTEGRATION,D_ML_TRAIN external_design
```
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_shared_owner_trust_gauge_py,src_zephyr_shared_queue_init_py,src_zephyr_shared_queue_task_scheduler_py,src_zephyr_shared_reasoning_spans_py,src_zephyr_shared_reliability_init_py,src_zephyr_shared_reliability_context_guard_py,src_zephyr_shared_sandbox_executor_py production
    class src_zephyr_shared_pagination_py,src_zephyr_shared_ports_py,src_zephyr_shared_protocols_init_py,src_zephyr_shared_protocols_a2a_init_py,src_zephyr_shared_protocols_a2a_a2a_coordination_py,src_zephyr_shared_protocols_a2a_a2a_protocol_py,src_zephyr_shared_protocols_a2a_a2a_registry_py,src_zephyr_shared_protocols_a2a_a2a_schemas_py,src_zephyr_shared_protocols_a2a_layer3_coordination_init_py,src_zephyr_shared_registry_py,src_zephyr_shared_reliability_diff_planner_py,src_zephyr_shared_reliability_retry_handler_py,src_zephyr_shared_resilience_init_py,src_zephyr_shared_resilience_circuit_breaker_py,src_zephyr_shared_resilience_fallback_py,src_zephyr_shared_resilience_retry_py,src_zephyr_shared_schema_init_py,src_zephyr_shared_schema_base_config_py,src_zephyr_shared_schema_schema_registry_py,src_zephyr_shared_schema_schemas_py,src_zephyr_shared_schema_severity_types_py,src_zephyr_shared_schema_registry_py,src_zephyr_shared_schemas_py design
    class D_INFRA_RUNTIME,D_INFRA_A2A external_prod
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_DOCS external_design
```
...
> 按 architecture_layer 分层显示 共享服务（D_SHARED）的模块分布。共 240 个模块 / 240 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (160 modules)            │
├──────────────────────────────────────────────────────────────────┤
...
│   ...还有 142 个模块 / 142 more modules                          │
└──────────────────────────────────────────────────────────────────┘
                                  │
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│                未分类 / Unclassified (13 modules)                │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 240 个模块 / 240 modules）。
...
| 2 | src/zephyr/shared/__version__.py | src/zephyr/shared/__version__.py | prototype | generated |
...
| 5 | src/zephyr/shared/adaptation/execution_tuner.py | src/zephyr/shared/adaptation/executio... | prototype | generated |
| 6 | src/zephyr/shared/adaptation/prompt_version_manager.py | src/zephyr/shared/adaptation/prompt_v... | prototype | generated |
| 7 | src/zephyr/shared/adaptive_sampler.py | src/zephyr/shared/adaptive_sampler.py | production | generated |
| 8 | src/zephyr/shared/ai_audit_guard.py | src/zephyr/shared/ai_audit_guard.py | production | generated |
| 9 | src/zephyr/shared/ai_understandability_constraint.py | src/zephyr/shared/ai_understandabilit... | production | generated |
| 10 | src/zephyr/shared/alert_escalation.py | src/zephyr/shared/alert_escalation.py | production | generated |
| 11 | src/zephyr/shared/alert_manager.py | src/zephyr/shared/alert_manager.py | production | generated |
| 12 | src/zephyr/shared/alert_precision_tracker.py | src/zephyr/shared/alert_precision_tra... | production | generated |
| 13 | src/zephyr/shared/api/__init__.py | src/zephyr/shared/api/__init__.py | prototype | generated |
| 14 | src/zephyr/shared/api/api_client.py | src/zephyr/shared/api/api_client.py | prototype | generated |
| 15 | src/zephyr/shared/api/api_index.py | src/zephyr/shared/api/api_index.py | prototype | generated |
| 16 | src/zephyr/shared/api/dos_launcher.py | src/zephyr/shared/api/dos_launcher.py | prototype | generated |
...
| 19 | src/zephyr/shared/blueprint_decomposer.py | src/zephyr/shared/blueprint_decompose... | prototype | generated |
| 20 | src/zephyr/shared/blueprint_scorer.py | src/zephyr/shared/blueprint_scorer.py | prototype | generated |
| 21 | src/zephyr/shared/budget_aware_prompt.py | src/zephyr/shared/budget_aware_prompt.py | production | generated |
| 22 | src/zephyr/shared/cache.py | src/zephyr/shared/cache.py | prototype | generated |
| 23 | src/zephyr/shared/capability.py | src/zephyr/shared/capability.py | prototype | generated |
| 24 | src/zephyr/shared/capacity_calibrator.py | src/zephyr/shared/capacity_calibrator.py | production | generated |
| 25 | src/zephyr/shared/capacity_digital_twin.py | src/zephyr/shared/capacity_digital_tw... | production | generated |
| 26 | src/zephyr/shared/capacity_fingerprint.py | src/zephyr/shared/capacity_fingerprin... | production | generated |
...
| 30 | src/zephyr/shared/constants.py | src/zephyr/shared/constants.py | prototype | generated |
| 31 | src/zephyr/shared/content_fingerprint.py | src/zephyr/shared/content_fingerprint.py | prototype | generated |
| 32 | src/zephyr/shared/context_engine.py | src/zephyr/shared/context_engine.py | prototype | generated |
...
| 35 | src/zephyr/shared/core_integrity_guard.py | src/zephyr/shared/core_integrity_guar... | production | generated |
| 36 | src/zephyr/shared/cost_estimator.py | src/zephyr/shared/cost_estimator.py | production | generated |
| 37 | src/zephyr/shared/degradation_chain.py | src/zephyr/shared/degradation_chain.py | production | generated |
| 38 | src/zephyr/shared/dependency_capacity_guard.py | src/zephyr/shared/dependency_capacity... | production | generated |
| 39 | src/zephyr/shared/deprecation.py | src/zephyr/shared/deprecation.py | prototype | generated |
| 40 | src/zephyr/shared/diff_utils.py | src/zephyr/shared/diff_utils.py | prototype | generated |
| 41 | src/zephyr/shared/dual_channel_alert.py | src/zephyr/shared/dual_channel_alert.py | production | generated |
| 42 | src/zephyr/shared/env.py | src/zephyr/shared/env.py | prototype | generated |
| 43 | src/zephyr/shared/error_budget_tracker.py | src/zephyr/shared/error_budget_tracke... | production | generated |
| 44 | src/zephyr/shared/errors.py | src/zephyr/shared/errors.py | prototype | generated |
| 45 | src/zephyr/shared/event_bus.py | src/zephyr/shared/event_bus.py | production | stable |
| 46 | src/zephyr/shared/event_bus.py | src/zephyr/shared/event_bus.py | production | generated |
| 47 | src/zephyr/shared/events/__init__.py | src/zephyr/shared/events/__init__.py | prototype | generated |
| 48 | src/zephyr/shared/events/dlq.py | src/zephyr/shared/events/dlq.py | prototype | generated |
| 49 | src/zephyr/shared/events/dlq_bridge.py | src/zephyr/shared/events/dlq_bridge.py | prototype | generated |
| 50 | src/zephyr/shared/events/event_bus.py | src/zephyr/shared/events/event_bus.py | production | stable |
| 51 | src/zephyr/shared/events/event_bus_upgrade.py | src/zephyr/shared/events/event_bus_up... | production | generated |
| 52 | src/zephyr/shared/events/event_reactor.py | src/zephyr/shared/events/event_reacto... | prototype | generated |
| 53 | src/zephyr/shared/events/event_schemas.py | src/zephyr/shared/events/event_schema... | prototype | generated |
| 54 | src/zephyr/shared/events/hook_dispatcher.py | src/zephyr/shared/events/hook_dispatc... | prototype | generated |
| 55 | src/zephyr/shared/events/upgrade_strategy.py | src/zephyr/shared/events/upgrade_stra... | prototype | generated |
| 56 | src/zephyr/shared/fault_isolator.py | src/zephyr/shared/fault_isolator.py | production | generated |
| 57 | src/zephyr/shared/file_utils.py | src/zephyr/shared/file_utils.py | prototype | generated |
| 58 | src/zephyr/shared/flags.py | src/zephyr/shared/flags.py | prototype | generated |
| 59 | src/zephyr/shared/foundation/__init__.py | src/zephyr/shared/foundation/__init__.py | prototype | generated |
| 60 | src/zephyr/shared/foundation/constants.py | src/zephyr/shared/foundation/constant... | prototype | generated |
| 61 | src/zephyr/shared/foundation/deprecation.py | src/zephyr/shared/foundation/deprecat... | prototype | generated |
| 62 | src/zephyr/shared/foundation/env.py | src/zephyr/shared/foundation/env.py | prototype | generated |
| 63 | src/zephyr/shared/foundation/errors.py | src/zephyr/shared/foundation/errors.py | prototype | generated |
| 64 | src/zephyr/shared/foundation/flags.py | src/zephyr/shared/foundation/flags.py | prototype | generated |
| 65 | src/zephyr/shared/foundation/types.py | src/zephyr/shared/foundation/types.py | prototype | generated |
| 66 | src/zephyr/shared/frontmatter_utils.py | src/zephyr/shared/frontmatter_utils.py | prototype | generated |
| 67 | src/zephyr/shared/health.py | src/zephyr/shared/health.py | production | stable |
| 68 | src/zephyr/shared/healthcheck_service.py | src/zephyr/shared/healthcheck_service.py | production | stable |
| 69 | src/zephyr/shared/heartbeat_server.py | src/zephyr/shared/heartbeat_server.py | production | generated |
| 70 | src/zephyr/shared/idempotency.py | src/zephyr/shared/idempotency.py | prototype | generated |
| 71 | src/zephyr/shared/infra/__init__.py | src/zephyr/shared/infra/__init__.py | prototype | generated |
| 72 | src/zephyr/shared/infra/cache.py | src/zephyr/shared/infra/cache.py | prototype | generated |
| 73 | src/zephyr/shared/infra/idempotency.py | src/zephyr/shared/infra/idempotency.py | prototype | generated |
| 74 | src/zephyr/shared/infra/limiter.py | src/zephyr/shared/infra/limiter.py | prototype | generated |
| 75 | src/zephyr/shared/infra/lock.py | src/zephyr/shared/infra/lock.py | prototype | generated |
| 76 | src/zephyr/shared/infra/observer.py | src/zephyr/shared/infra/observer.py | prototype | generated |
...
| 104 | src/zephyr/shared/observer.py | src/zephyr/shared/observer.py | prototype | generated |
| 105 | src/zephyr/shared/outbox.py | src/zephyr/shared/outbox.py | prototype | generated |
| 106 | src/zephyr/shared/owner_trust_gauge.py | src/zephyr/shared/owner_trust_gauge.py | production | generated |
| 107 | src/zephyr/shared/pagination.py | src/zephyr/shared/pagination.py | prototype | generated |
| 108 | src/zephyr/shared/ports.py | src/zephyr/shared/ports.py | prototype | generated |
| 109 | src/zephyr/shared/protocols/__init__.py | src/zephyr/shared/protocols/__init__.py | prototype | generated |
| 110 | src/zephyr/shared/protocols/a2a/__init__.py | src/zephyr/shared/protocols/a2a/__ini... | prototype | generated |
| 111 | src/zephyr/shared/protocols/a2a/a2a_coordination.py | src/zephyr/shared/protocols/a2a/a2a_c... | prototype | generated |
| 112 | src/zephyr/shared/protocols/a2a/a2a_protocol.py | src/zephyr/shared/protocols/a2a/a2a_p... | prototype | generated |
| 113 | src/zephyr/shared/protocols/a2a/a2a_registry.py | src/zephyr/shared/protocols/a2a/a2a_r... | prototype | generated |
| 114 | src/zephyr/shared/protocols/a2a/a2a_schemas.py | src/zephyr/shared/protocols/a2a/a2a_s... | prototype | generated |
| 115 | src/zephyr/shared/protocols/a2a/layer3_coordination/__ini... | src/zephyr/shared/protocols/a2a/layer... | prototype | generated |
| 116 | src/zephyr/shared/reasoning_spans.py | src/zephyr/shared/reasoning_spans.py | production | generated |
| 117 | src/zephyr/shared/registry.py | src/zephyr/shared/registry.py | prototype | generated |
| 118 | src/zephyr/shared/reliability/diff_planner.py | src/zephyr/shared/reliability/diff_pl... | prototype | generated |
| 119 | src/zephyr/shared/reliability/retry_handler.py | src/zephyr/shared/reliability/retry_h... | prototype | generated |
| 120 | src/zephyr/shared/resilience/__init__.py | src/zephyr/shared/resilience/__init__.py | prototype | generated |
| 121 | src/zephyr/shared/resilience/circuit_breaker.py | src/zephyr/shared/resilience/circuit_... | prototype | generated |
| 122 | src/zephyr/shared/resilience/fallback.py | src/zephyr/shared/resilience/fallback.py | prototype | generated |
| 123 | src/zephyr/shared/resilience/retry.py | src/zephyr/shared/resilience/retry.py | prototype | generated |
| 124 | src/zephyr/shared/sandbox_executor.py | src/zephyr/shared/sandbox_executor.py | production | generated |
| 125 | src/zephyr/shared/schema/__init__.py | src/zephyr/shared/schema/__init__.py | prototype | generated |
| 126 | src/zephyr/shared/schema/base_config.py | src/zephyr/shared/schema/base_config.py | prototype | generated |
| 127 | src/zephyr/shared/schema/schema_registry.py | src/zephyr/shared/schema/schema_regis... | prototype | generated |
| 128 | src/zephyr/shared/schema/schemas.py | src/zephyr/shared/schema/schemas.py | prototype | generated |
| 129 | src/zephyr/shared/schema/severity_types.py | src/zephyr/shared/schema/severity_typ... | prototype | generated |
| 130 | src/zephyr/shared/schema_registry.py | src/zephyr/shared/schema_registry.py | prototype | generated |
| 131 | src/zephyr/shared/schemas.py | src/zephyr/shared/schemas.py | prototype | generated |
| 132 | src/zephyr/shared/secrets.py | src/zephyr/shared/secrets.py | prototype | generated |
| 133 | src/zephyr/shared/security/__init__.py | src/zephyr/shared/security/__init__.py | prototype | generated |
| 134 | src/zephyr/shared/security/capability.py | src/zephyr/shared/security/capability.py | prototype | generated |
| 135 | src/zephyr/shared/security/secrets.py | src/zephyr/shared/security/secrets.py | prototype | generated |
| 136 | src/zephyr/shared/security/ssot_guard.py | src/zephyr/shared/security/ssot_guard.py | prototype | generated |
| 137 | src/zephyr/shared/serialization.py | src/zephyr/shared/serialization.py | prototype | generated |
| 138 | src/zephyr/shared/session/session_boundary.py | src/zephyr/shared/session/session_bou... | prototype | generated |
| 139 | src/zephyr/shared/session_audit.py | src/zephyr/shared/session_audit.py | prototype | generated |
| 140 | src/zephyr/shared/session_continuity.py | src/zephyr/shared/session_continuity.py | prototype | generated |
| 141 | src/zephyr/shared/slo_review_assistant.py | src/zephyr/shared/slo_review_assistan... | production | generated |
| 142 | src/zephyr/shared/ssot_guard.py | src/zephyr/shared/ssot_guard.py | prototype | generated |
| 143 | src/zephyr/shared/state_machine.py | src/zephyr/shared/state_machine.py | prototype | generated |
| 144 | src/zephyr/shared/task_heartbeat.py | src/zephyr/shared/task_heartbeat.py | production | generated |
| 145 | src/zephyr/shared/task_types.py | src/zephyr/shared/task_types.py | prototype | generated |
| 146 | src/zephyr/shared/testing.py | src/zephyr/shared/testing.py | prototype | generated |
| 147 | src/zephyr/shared/time_utils.py | src/zephyr/shared/time_utils.py | prototype | generated |
| 148 | src/zephyr/shared/tracing.py | src/zephyr/shared/tracing.py | prototype | generated |
| 149 | src/zephyr/shared/ttl_cleanup_engine.py | src/zephyr/shared/ttl_cleanup_engine.py | production | generated |
| 150 | src/zephyr/shared/types.py | src/zephyr/shared/types.py | prototype | generated |
| 151 | src/zephyr/shared/utils/__init__.py | src/zephyr/shared/utils/__init__.py | prototype | generated |
| 152 | src/zephyr/shared/utils/context.py | src/zephyr/shared/utils/context.py | prototype | generated |
| 153 | src/zephyr/shared/utils/db_utils.py | src/zephyr/shared/utils/db_utils.py | prototype | generated |
| 154 | src/zephyr/shared/utils/diff_utils.py | src/zephyr/shared/utils/diff_utils.py | prototype | generated |
| 155 | src/zephyr/shared/utils/migration.py | src/zephyr/shared/utils/migration.py | prototype | generated |
| 156 | src/zephyr/shared/utils/pagination.py | src/zephyr/shared/utils/pagination.py | prototype | generated |
| 157 | src/zephyr/shared/utils/testing.py | src/zephyr/shared/utils/testing.py | prototype | generated |
| 158 | src/zephyr/shared/utils/time_utils.py | src/zephyr/shared/utils/time_utils.py | prototype | generated |
| 159 | src/zephyr/shared/vibe_experiment_tracker.py | src/zephyr/shared/vibe_experiment_tra... | production | generated |
| 160 | src/zephyr/shared/zephyr_logger.py | src/zephyr/shared/zephyr_logger.py | production | generated |
...
| 9 | src/zephyr/shared/queue/__init__.py | src/zephyr/shared/queue/__init__.py | production | generated |
| 10 | src/zephyr/shared/queue/task_scheduler.py | src/zephyr/shared/queue/task_schedule... | production | generated |
| 11 | src/zephyr/shared/reliability/__init__.py | src/zephyr/shared/reliability/__init_... | production | generated |
| 12 | src/zephyr/shared/reliability/context_guard.py | src/zephyr/shared/reliability/context... | production | generated |
| 13 | src/zephyr/shared/session/__init__.py | src/zephyr/shared/session/__init__.py | production | generated |

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 159 条 / 159 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 159 条 / 159 edges)       │
├──────────────────────────────────────────────────────────────────┤

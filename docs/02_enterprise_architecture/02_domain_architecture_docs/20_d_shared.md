...
| 模块数 | 262 | Module Count | 262 |
| 域内依赖 | 167 | Internal Dependencies | 167 |
| 跨域入边 | 292 | Cross-domain Incoming | 292 |
| 跨域出边 | 23 | Cross-domain Outgoing | 23 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 191 | Prototype Modules | 191 |
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_shared_capacity_runbook_generator_py,src_zephyr_shared_code_economy_analyzer_py,src_zephyr_shared_combinatorial_gate_py,src_zephyr_shared_compensation_init_py,src_zephyr_shared_contracts_core_telemetry_emitter_py production
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INFRA_A2A,D_INFRA_TELEMETRY,D_TRADING external_prod
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_shared_event_bus_py,src_zephyr_shared_event_bus_py_1,src_zephyr_shared_events_event_bus_py,src_zephyr_shared_events_event_bus_upgrade_py,src_zephyr_shared_fault_isolator_py,src_zephyr_shared_health_py,src_zephyr_shared_healthcheck_service_py,src_zephyr_shared_heartbeat_server_py production
    ...
    class D_OPS,D_AUTONOMY_CORE,D_TRADING external_design
```
...
graph TD
    ...
    class D_OPS,D_INTEGRATION,D_GOV_AUDIT,D_GOV_DOCS external_design
```
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_shared_sla_init_py,src_zephyr_shared_sla_sla_monitor_py,src_zephyr_shared_slo_review_assistant_py,src_zephyr_shared_task_heartbeat_py,src_zephyr_shared_ttl_cleanup_engine_py,src_zephyr_shared_vibe_experiment_tracker_py,src_zephyr_shared_zephyr_logger_py production
    class src_zephyr_shared_ssot_guard_py,src_zephyr_shared_state_machine_py,src_zephyr_shared_task_types_py,src_zephyr_shared_testing_py,src_zephyr_shared_time_utils_py,src_zephyr_shared_tracing_py,src_zephyr_shared_types_py,src_zephyr_shared_utils_init_py,src_zephyr_shared_utils_context_py,src_zephyr_shared_utils_db_utils_py,src_zephyr_shared_utils_diff_utils_py,src_zephyr_shared_utils_migration_py,src_zephyr_shared_utils_pagination_py,src_zephyr_shared_utils_testing_py,src_zephyr_shared_utils_time_utils_py design
...
|------|:---:|---------|
| D_GOVERNANCE | 77 | import_depends,test_depends |
| D_INTEGRATION | 47 | import_depends |
| D_GOV_AUDIT | 33 | import_depends |
| D_TRADING | 31 | contract,import_depends |
| D_INFRA_RUNTIME | 29 | import_depends |
| D_GOV_DOCS | 19 | import_depends |
| D_INFRA_A2A | 16 | import_depends |
| D_OPS | 8 | import_depends |
...
> 按 architecture_layer 分层显示 共享服务（D_SHARED）的模块分布。共 262 个模块 / 262 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (177 modules)            │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 262 个模块 / 262 modules）。
...
| 19 | src/zephyr/shared/api_client.py | src/zephyr/shared/api_client.py | prototype | generated |
| 20 | src/zephyr/shared/blueprint_code_auditor.py | src/zephyr/shared/blueprint_code_audi... | production | generated |
| 21 | src/zephyr/shared/blueprint_decomposer.py | src/zephyr/shared/blueprint_decompose... | prototype | generated |
| 22 | src/zephyr/shared/blueprint_scorer.py | src/zephyr/shared/blueprint_scorer.py | prototype | generated |
| 23 | src/zephyr/shared/budget_aware_prompt.py | src/zephyr/shared/budget_aware_prompt.py | production | generated |
| 24 | src/zephyr/shared/cache.py | src/zephyr/shared/cache.py | prototype | generated |
| 25 | src/zephyr/shared/capability.py | src/zephyr/shared/capability.py | prototype | generated |
| 26 | src/zephyr/shared/capacity_calibrator.py | src/zephyr/shared/capacity_calibrator.py | production | generated |
| 27 | src/zephyr/shared/capacity_digital_twin.py | src/zephyr/shared/capacity_digital_tw... | production | generated |
| 28 | src/zephyr/shared/capacity_fingerprint.py | src/zephyr/shared/capacity_fingerprin... | production | generated |
| 29 | src/zephyr/shared/capacity_runbook_generator.py | src/zephyr/shared/capacity_runbook_ge... | production | generated |
| 30 | src/zephyr/shared/code_economy_analyzer.py | src/zephyr/shared/code_economy_analyz... | production | generated |
| 31 | src/zephyr/shared/combinatorial_gate.py | src/zephyr/shared/combinatorial_gate.py | production | generated |
| 32 | src/zephyr/shared/config/__init__.py | src/zephyr/shared/config/__init__.py | prototype | generated |
| 33 | src/zephyr/shared/config/loader.py | src/zephyr/shared/config/loader.py | prototype | generated |
| 34 | src/zephyr/shared/constants.py | src/zephyr/shared/constants.py | prototype | generated |
| 35 | src/zephyr/shared/content_fingerprint.py | src/zephyr/shared/content_fingerprint.py | prototype | generated |
| 36 | src/zephyr/shared/context_engine.py | src/zephyr/shared/context_engine.py | prototype | generated |
| 37 | src/zephyr/shared/contract_bus.py | src/zephyr/shared/contract_bus.py | prototype | generated |
| 38 | src/zephyr/shared/contract_tester.py | src/zephyr/shared/contract_tester.py | prototype | generated |
| 39 | src/zephyr/shared/core_integrity_guard.py | src/zephyr/shared/core_integrity_guar... | production | generated |
| 40 | src/zephyr/shared/cost_estimator.py | src/zephyr/shared/cost_estimator.py | production | generated |
| 41 | src/zephyr/shared/degradation_chain.py | src/zephyr/shared/degradation_chain.py | production | generated |
| 42 | src/zephyr/shared/dependency_capacity_guard.py | src/zephyr/shared/dependency_capacity... | production | generated |
| 43 | src/zephyr/shared/deprecation.py | src/zephyr/shared/deprecation.py | prototype | generated |
| 44 | src/zephyr/shared/diff_utils.py | src/zephyr/shared/diff_utils.py | prototype | generated |
| 45 | src/zephyr/shared/dual_channel_alert.py | src/zephyr/shared/dual_channel_alert.py | production | generated |
| 46 | src/zephyr/shared/env.py | src/zephyr/shared/env.py | prototype | generated |
| 47 | src/zephyr/shared/error_budget_tracker.py | src/zephyr/shared/error_budget_tracke... | production | generated |
| 48 | src/zephyr/shared/errors.py | src/zephyr/shared/errors.py | prototype | generated |
| 49 | src/zephyr/shared/event_bus.py | src/zephyr/shared/event_bus.py | production | stable |
| 50 | src/zephyr/shared/event_bus.py | src/zephyr/shared/event_bus.py | production | generated |
| 51 | src/zephyr/shared/events/__init__.py | src/zephyr/shared/events/__init__.py | prototype | generated |
| 52 | src/zephyr/shared/events/dlq.py | src/zephyr/shared/events/dlq.py | prototype | generated |
| 53 | src/zephyr/shared/events/dlq_bridge.py | src/zephyr/shared/events/dlq_bridge.py | prototype | generated |
| 54 | src/zephyr/shared/events/event_bus.py | src/zephyr/shared/events/event_bus.py | production | stable |
| 55 | src/zephyr/shared/events/event_bus_upgrade.py | src/zephyr/shared/events/event_bus_up... | production | generated |
| 56 | src/zephyr/shared/events/event_reactor.py | src/zephyr/shared/events/event_reacto... | prototype | generated |
| 57 | src/zephyr/shared/events/event_schemas.py | src/zephyr/shared/events/event_schema... | prototype | generated |
| 58 | src/zephyr/shared/events/hook_dispatcher.py | src/zephyr/shared/events/hook_dispatc... | prototype | generated |
| 59 | src/zephyr/shared/events/upgrade_strategy.py | src/zephyr/shared/events/upgrade_stra... | prototype | generated |
| 60 | src/zephyr/shared/fault_isolator.py | src/zephyr/shared/fault_isolator.py | production | generated |
| 61 | src/zephyr/shared/file_utils.py | src/zephyr/shared/file_utils.py | prototype | generated |
| 62 | src/zephyr/shared/flags.py | src/zephyr/shared/flags.py | prototype | generated |
| 63 | src/zephyr/shared/foundation/__init__.py | src/zephyr/shared/foundation/__init__.py | prototype | generated |
| 64 | src/zephyr/shared/foundation/constants.py | src/zephyr/shared/foundation/constant... | prototype | generated |
| 65 | src/zephyr/shared/foundation/deprecation.py | src/zephyr/shared/foundation/deprecat... | prototype | generated |
| 66 | src/zephyr/shared/foundation/env.py | src/zephyr/shared/foundation/env.py | prototype | generated |
| 67 | src/zephyr/shared/foundation/errors.py | src/zephyr/shared/foundation/errors.py | prototype | generated |
| 68 | src/zephyr/shared/foundation/flags.py | src/zephyr/shared/foundation/flags.py | prototype | generated |
| 69 | src/zephyr/shared/foundation/types.py | src/zephyr/shared/foundation/types.py | prototype | generated |
| 70 | src/zephyr/shared/frontmatter_utils.py | src/zephyr/shared/frontmatter_utils.py | prototype | generated |
| 71 | src/zephyr/shared/health.py | src/zephyr/shared/health.py | production | stable |
| 72 | src/zephyr/shared/healthcheck_service.py | src/zephyr/shared/healthcheck_service.py | production | stable |
| 73 | src/zephyr/shared/heartbeat_server.py | src/zephyr/shared/heartbeat_server.py | production | generated |
| 74 | src/zephyr/shared/idempotency.py | src/zephyr/shared/idempotency.py | prototype | generated |
| 75 | src/zephyr/shared/infra/__init__.py | src/zephyr/shared/infra/__init__.py | prototype | generated |
| 76 | src/zephyr/shared/infra/cache.py | src/zephyr/shared/infra/cache.py | prototype | generated |
| 77 | src/zephyr/shared/infra/idempotency.py | src/zephyr/shared/infra/idempotency.py | prototype | generated |
| 78 | src/zephyr/shared/infra/limiter.py | src/zephyr/shared/infra/limiter.py | prototype | generated |
| 79 | src/zephyr/shared/infra/lock.py | src/zephyr/shared/infra/lock.py | prototype | generated |
| 80 | src/zephyr/shared/infra/observer.py | src/zephyr/shared/infra/observer.py | prototype | generated |
| 81 | src/zephyr/shared/infra/outbox.py | src/zephyr/shared/infra/outbox.py | prototype | generated |
| 82 | src/zephyr/shared/infra/process_lifecycle_gateway.py | src/zephyr/shared/infra/process_lifec... | production | generated |
| 83 | src/zephyr/shared/infra/process_pool.py | src/zephyr/shared/infra/process_pool.py | prototype | generated |
| 84 | src/zephyr/shared/infra_06/idempotency.py | src/zephyr/shared/infra_06/idempotenc... | prototype | generated |
| 85 | src/zephyr/shared/infra_06/limiter.py | src/zephyr/shared/infra_06/limiter.py | prototype | generated |
| 86 | src/zephyr/shared/infra_06/lock.py | src/zephyr/shared/infra_06/lock.py | prototype | generated |
| 87 | src/zephyr/shared/infra_06/observer.py | src/zephyr/shared/infra_06/observer.py | prototype | generated |
| 88 | src/zephyr/shared/infra_06/outbox.py | src/zephyr/shared/infra_06/outbox.py | prototype | generated |
| 89 | src/zephyr/shared/io/__init__.py | src/zephyr/shared/io/__init__.py | prototype | generated |
| 90 | src/zephyr/shared/io/content_fingerprint.py | src/zephyr/shared/io/content_fingerpr... | prototype | generated |
| 91 | src/zephyr/shared/io/file_utils.py | src/zephyr/shared/io/file_utils.py | prototype | generated |
| 92 | src/zephyr/shared/io/frontmatter_utils.py | src/zephyr/shared/io/frontmatter_util... | prototype | generated |
| 93 | src/zephyr/shared/io/io_cache.py | src/zephyr/shared/io/io_cache.py | prototype | generated |
| 94 | src/zephyr/shared/io/paths.py | src/zephyr/shared/io/paths.py | prototype | generated |
| 95 | src/zephyr/shared/io/serialization.py | src/zephyr/shared/io/serialization.py | prototype | generated |
| 96 | src/zephyr/shared/io/streaming_reader.py | src/zephyr/shared/io/streaming_reader.py | prototype | generated |
| 97 | src/zephyr/shared/knowledge/ke_linker.py | src/zephyr/shared/knowledge/ke_linker.py | prototype | generated |
| 98 | src/zephyr/shared/knowledge/ke_structurer.py | src/zephyr/shared/knowledge/ke_struct... | prototype | generated |
| 99 | src/zephyr/shared/knowledge/kms_interface.py | src/zephyr/shared/knowledge/kms_inter... | prototype | generated |
| 100 | src/zephyr/shared/limiter.py | src/zephyr/shared/limiter.py | prototype | generated |
| 101 | src/zephyr/shared/lock.py | src/zephyr/shared/lock.py | prototype | generated |
| 102 | src/zephyr/shared/logging.py | src/zephyr/shared/logging.py | prototype | generated |
| 103 | src/zephyr/shared/longevity_monitor.py | src/zephyr/shared/longevity_monitor.py | production | generated |
| 104 | src/zephyr/shared/maintenance/autonomy_monitor.py | src/zephyr/shared/maintenance/autonom... | production | stable |
| 105 | src/zephyr/shared/maintenance/dogfooding.py | src/zephyr/shared/maintenance/dogfood... | prototype | generated |
| 106 | src/zephyr/shared/maintenance/handbook.py | src/zephyr/shared/maintenance/handboo... | prototype | generated |
| 107 | src/zephyr/shared/maintenance/zero_config.py | src/zephyr/shared/maintenance/zero_co... | prototype | generated |
| 108 | src/zephyr/shared/metrics.py | src/zephyr/shared/metrics.py | production | stable |
| 109 | src/zephyr/shared/migration.py | src/zephyr/shared/migration.py | prototype | generated |
| 110 | src/zephyr/shared/model_capacity_probe.py | src/zephyr/shared/model_capacity_prob... | production | generated |
| 111 | src/zephyr/shared/models.py | src/zephyr/shared/models.py | prototype | generated |
| 112 | src/zephyr/shared/module_birth_registry.py | src/zephyr/shared/module_birth_regist... | production | generated |
| 113 | src/zephyr/shared/observability_02/health.py | src/zephyr/shared/observability_02/he... | production | stable |
| 114 | src/zephyr/shared/observability_02/health_discovery.py | src/zephyr/shared/observability_02/he... | production | stable |
| 115 | src/zephyr/shared/observability_02/logging.py | src/zephyr/shared/observability_02/lo... | prototype | generated |
| 116 | src/zephyr/shared/observability_02/metrics.py | src/zephyr/shared/observability_02/me... | production | stable |
| 117 | src/zephyr/shared/observability_02/tracing.py | src/zephyr/shared/observability_02/tr... | prototype | generated |
| 118 | src/zephyr/shared/observer.py | src/zephyr/shared/observer.py | prototype | generated |
| 119 | src/zephyr/shared/outbox.py | src/zephyr/shared/outbox.py | prototype | generated |
| 120 | src/zephyr/shared/owner_trust_gauge.py | src/zephyr/shared/owner_trust_gauge.py | production | generated |
| 121 | src/zephyr/shared/pagination.py | src/zephyr/shared/pagination.py | prototype | generated |
| 122 | src/zephyr/shared/paths.py | src/zephyr/shared/paths.py | prototype | generated |
| 123 | src/zephyr/shared/ports.py | src/zephyr/shared/ports.py | prototype | generated |
| 124 | src/zephyr/shared/protocols/__init__.py | src/zephyr/shared/protocols/__init__.py | prototype | generated |
| 125 | src/zephyr/shared/protocols/a2a/__init__.py | src/zephyr/shared/protocols/a2a/__ini... | prototype | generated |
| 126 | src/zephyr/shared/protocols/a2a/a2a_coordination.py | src/zephyr/shared/protocols/a2a/a2a_c... | prototype | generated |
| 127 | src/zephyr/shared/protocols/a2a/a2a_protocol.py | src/zephyr/shared/protocols/a2a/a2a_p... | prototype | generated |
| 128 | src/zephyr/shared/protocols/a2a/a2a_registry.py | src/zephyr/shared/protocols/a2a/a2a_r... | prototype | generated |
| 129 | src/zephyr/shared/protocols/a2a/a2a_schemas.py | src/zephyr/shared/protocols/a2a/a2a_s... | prototype | generated |
| 130 | src/zephyr/shared/protocols/a2a/layer3_coordination/__ini... | src/zephyr/shared/protocols/a2a/layer... | prototype | generated |
| 131 | src/zephyr/shared/quality/quality_monitor.py | quality_monitor | production | stable |
| 132 | src/zephyr/shared/reasoning_spans.py | src/zephyr/shared/reasoning_spans.py | production | generated |
| 133 | src/zephyr/shared/registry.py | src/zephyr/shared/registry.py | prototype | generated |
| 134 | src/zephyr/shared/reliability/diff_planner.py | src/zephyr/shared/reliability/diff_pl... | prototype | generated |
| 135 | src/zephyr/shared/reliability/retry_handler.py | src/zephyr/shared/reliability/retry_h... | prototype | generated |
| 136 | src/zephyr/shared/resilience/__init__.py | src/zephyr/shared/resilience/__init__.py | prototype | generated |
| 137 | src/zephyr/shared/resilience/circuit_breaker.py | src/zephyr/shared/resilience/circuit_... | prototype | generated |
| 138 | src/zephyr/shared/resilience/fallback.py | src/zephyr/shared/resilience/fallback.py | prototype | generated |
| 139 | src/zephyr/shared/resilience/retry.py | src/zephyr/shared/resilience/retry.py | prototype | generated |
| 140 | src/zephyr/shared/sandbox_executor.py | src/zephyr/shared/sandbox_executor.py | production | generated |
| 141 | src/zephyr/shared/schema/__init__.py | src/zephyr/shared/schema/__init__.py | prototype | generated |
| 142 | src/zephyr/shared/schema/base_config.py | src/zephyr/shared/schema/base_config.py | prototype | generated |
| 143 | src/zephyr/shared/schema/schema_registry.py | src/zephyr/shared/schema/schema_regis... | prototype | generated |
| 144 | src/zephyr/shared/schema/schemas.py | src/zephyr/shared/schema/schemas.py | prototype | generated |
| 145 | src/zephyr/shared/schema/severity_types.py | src/zephyr/shared/schema/severity_typ... | prototype | generated |
| 146 | src/zephyr/shared/schema_registry.py | src/zephyr/shared/schema_registry.py | prototype | generated |
| 147 | src/zephyr/shared/schemas.py | src/zephyr/shared/schemas.py | prototype | generated |
| 148 | src/zephyr/shared/secrets.py | src/zephyr/shared/secrets.py | prototype | generated |
| 149 | src/zephyr/shared/security/__init__.py | src/zephyr/shared/security/__init__.py | prototype | generated |
| 150 | src/zephyr/shared/security/capability.py | src/zephyr/shared/security/capability.py | prototype | generated |
| 151 | src/zephyr/shared/security/secrets.py | src/zephyr/shared/security/secrets.py | prototype | generated |
| 152 | src/zephyr/shared/security/ssot_guard.py | src/zephyr/shared/security/ssot_guard.py | prototype | generated |
| 153 | src/zephyr/shared/serialization.py | src/zephyr/shared/serialization.py | prototype | generated |
| 154 | src/zephyr/shared/session/session_boundary.py | src/zephyr/shared/session/session_bou... | prototype | generated |
| 155 | src/zephyr/shared/session_audit.py | src/zephyr/shared/session_audit.py | prototype | generated |
| 156 | src/zephyr/shared/session_continuity.py | src/zephyr/shared/session_continuity.py | prototype | generated |
| 157 | src/zephyr/shared/sla/sla_monitor.py | sla_monitor | production | stable |
| 158 | src/zephyr/shared/slo_review_assistant.py | src/zephyr/shared/slo_review_assistan... | production | generated |
| 159 | src/zephyr/shared/ssot_guard.py | src/zephyr/shared/ssot_guard.py | prototype | generated |
| 160 | src/zephyr/shared/state_machine.py | src/zephyr/shared/state_machine.py | prototype | generated |
| 161 | src/zephyr/shared/task_heartbeat.py | src/zephyr/shared/task_heartbeat.py | production | generated |
| 162 | src/zephyr/shared/task_types.py | src/zephyr/shared/task_types.py | prototype | generated |
| 163 | src/zephyr/shared/testing.py | src/zephyr/shared/testing.py | prototype | generated |
| 164 | src/zephyr/shared/time_utils.py | src/zephyr/shared/time_utils.py | prototype | generated |
| 165 | src/zephyr/shared/tracing.py | src/zephyr/shared/tracing.py | prototype | generated |
| 166 | src/zephyr/shared/ttl_cleanup_engine.py | src/zephyr/shared/ttl_cleanup_engine.py | production | generated |
| 167 | src/zephyr/shared/types.py | src/zephyr/shared/types.py | prototype | generated |
| 168 | src/zephyr/shared/utils/__init__.py | src/zephyr/shared/utils/__init__.py | prototype | generated |
| 169 | src/zephyr/shared/utils/context.py | src/zephyr/shared/utils/context.py | prototype | generated |
| 170 | src/zephyr/shared/utils/db_utils.py | src/zephyr/shared/utils/db_utils.py | prototype | generated |
| 171 | src/zephyr/shared/utils/diff_utils.py | src/zephyr/shared/utils/diff_utils.py | prototype | generated |
| 172 | src/zephyr/shared/utils/migration.py | src/zephyr/shared/utils/migration.py | prototype | generated |
| 173 | src/zephyr/shared/utils/pagination.py | src/zephyr/shared/utils/pagination.py | prototype | generated |
| 174 | src/zephyr/shared/utils/testing.py | src/zephyr/shared/utils/testing.py | prototype | generated |
| 175 | src/zephyr/shared/utils/time_utils.py | src/zephyr/shared/utils/time_utils.py | prototype | generated |
| 176 | src/zephyr/shared/vibe_experiment_tracker.py | src/zephyr/shared/vibe_experiment_tra... | production | generated |
| 177 | src/zephyr/shared/zephyr_logger.py | src/zephyr/shared/zephyr_logger.py | production | generated |

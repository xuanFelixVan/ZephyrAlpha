...
| 跨域出边 | 2239 | Cross-domain Outgoing | 2239 |
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_TRADING,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_federated_learning_test_fl_scope_creep_monitor_py -.->|测试依赖 / test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    tests_governance_commit_gates_test_foreign_change_gate_py -.->|测试依赖 / test_depends| D_GOVERNANCE
    tests_governance_commit_gates_test_msg_style_gate_py -.->|测试依赖 / test_depends| D_GOVERNANCE
    tests_governance_commit_gates_test_msg_style_gate_py -.->|测试依赖 / test_depends| D_GOVERNANCE
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY_LLM,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_INFRA_A2A,D_SECURITY,D_GOVERNANCE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_RISK,D_POSITION,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_SECURITY,D_GOVERNANCE external_prod
```
...
> 本域与 25 个外部域直接连接（出边 2239 条 + 入边 0 条 = 2239 条）。只显示直接连接的域，不展开具体节点。

...
| 跨域出边 | 2203 | Cross-domain Outgoing | 2203 |
...
graph TD
    ...
    class D_INFRA_A2A,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_FACTOR
    D_SECURITY["D_SECURITY production"]
    ...
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOV_ENFORCEMENT
    ...
    class D_FACTOR,D_SECURITY,D_TRADING external_prod
...
graph TD
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE,D_SECURITY,D_INTELLIGENCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY,D_GOVERNANCE,D_TRADING,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_SHARED,D_SECURITY,D_INTEGRATION,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SIMULATION,D_SHARED,D_SECURITY,D_TRADING,D_INTELLIGENCE,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_escalation_test_escalation_gov_rbac_bridge_py -.->|test_depends| D_SHARED
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_TRADING,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    tests_feedback_test_ensemble_drift_py -.->|test_depends| D_TRADING
    tests_feedback_test_eval_harness_root_py -.->|test_depends| D_TRADING
    tests_feedback_test_evolution_engine_root_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    tests_governance_audit_test_retention_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    tests_governance_observability_test_hotspot_tracker_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    tests_governance_resilience_test_policy_sandbox_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    D_INFRA_A2A["D_INFRA_A2A production"]
    tests_llm_security_test_cross_module_integration_llm_security_py -.->|test_depends| D_INFRA_A2A
    tests_llm_security_test_cross_module_integration_llm_security_py -.->|test_depends| D_INFRA_A2A
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_llm_security_test_interrupt_guard_py -.->|test_depends| D_INFRA_RUNTIME
...
graph TD
    ...
    D_INTELLIGENCE["D_INTELLIGENCE production"]
    tests_model_test_benchmark_suite_py -.->|test_depends| D_INTELLIGENCE
...
graph TD
    ...
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    tests_pipeline_test_pipeline_roadmap_py -.->|test_depends| D_INFRA_RUNTIME
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_trae_rules_test_g_trae_012_py -.->|test_depends| D_SHARED
    D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT production"]
    tests_trae_rules_test_g_trae_003_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_010_py -.->|test_depends| D_SHARED
    ...
    tests_trae_rules_test_g_trae_011_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_011_py -.->|test_depends| D_GOV_ENFORCEMENT
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_utils_test_version_py design
...
| D_GOVERNANCE | 510 | contract,data,runtime,test_depends |
| D_GOV_ENFORCEMENT | 222 | runtime,test_depends |
| D_SECURITY | 169 | contract,test_depends |
...
| D_SECURITY_LLM | 42 | runtime,test_depends |
...
> 按 architecture_layer 分层显示 audit_test_suite（D_AUDITTEST）的模块分布。共 1651 个模块 / 1651 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│             L2 领域层 / Domain Layer (1651 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 1651 个模块 / 1651 modules）。

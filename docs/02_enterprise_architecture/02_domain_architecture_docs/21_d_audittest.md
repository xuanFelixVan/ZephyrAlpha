...
| 跨域出边 | 2136 | Cross-domain Outgoing | 2136 |
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION_GATEWAY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    D_INTEGRATION_GATEWAY["D_INTEGRATION_GATEWAY production"]
    tests_llm_security_test_cross_module_integration_llm_security_py -.->|test_depends| D_INTEGRATION_GATEWAY
    D_INTEGRATION["D_INTEGRATION production"]
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_SHARED,D_INTEGRATION_GATEWAY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_OPS,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY,D_TRADING external_prod
```

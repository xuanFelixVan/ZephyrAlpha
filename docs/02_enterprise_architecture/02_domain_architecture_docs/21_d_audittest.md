...
| 跨域出边 | 2222 | Cross-domain Outgoing | 2222 |
...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_TRADING,D_SHARED,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_TRADING,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_BACKTEST,D_GOV_ENFORCEMENT,D_INTEGRATION,D_TRADING,D_INFRA_RECOVERY external_prod
```

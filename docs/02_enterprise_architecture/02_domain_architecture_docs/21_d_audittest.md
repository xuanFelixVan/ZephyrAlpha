...
| 跨域出边 | 2134 | Cross-domain Outgoing | 2134 |
...
graph TD
    ...
    class D_INFRA_A2A,D_TRADING,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_TELEMETRY,D_SECURITY_LLM,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_TRADING,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_TRADING,D_INFRA_RUNTIME,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SECURITY,D_OPS,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOVERNANCE,D_TRADING,D_POSITION,D_INFRA_RECOVERY external_prod
```
...
> 按 architecture_layer 分层显示 audit_test_suite（D_AUDITTEST）的模块分布。共 1676 个模块 / 1676 modules。

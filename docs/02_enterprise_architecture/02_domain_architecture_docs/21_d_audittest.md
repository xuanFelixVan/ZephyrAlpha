...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_GOVERNANCE,D_SECURITY_LLM,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_SHARED,D_INTEGRATION,D_INTEGRATION_GATEWAY external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SHARED,D_SECURITY,D_OPS external_prod
```

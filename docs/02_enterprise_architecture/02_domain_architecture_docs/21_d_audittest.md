...
| 跨域出边 | 2221 | Cross-domain Outgoing | 2221 |
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_TRADING,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RECOVERY,D_SECURITY_LLM,D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_TRADING,D_SHARED,D_SECURITY_LLM external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_SECURITY,D_SHARED,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_TRADING,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    tests_fix_test_fix_budget_py -.->|test_depends| D_INFRA_RUNTIME
    tests_fix_test_fix_reliability_py -.->|test_depends| D_INFRA_RUNTIME
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_FRONTEND,D_SHARED,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_TRADING,D_INFRA_A2A,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_INFRA_RUNTIME,D_INTEGRATION,D_TRADING,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_SECURITY_LLM,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_INTELLIGENCE,D_INTEGRATION,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SHARED,D_OPS,D_INFRA_TELEMETRY external_prod
```
...
graph TD
    ...
    class D_FUNDAMENTAL_SIGNAL,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING external_prod
```

...
| 跨域出边 | 2117 | Cross-domain Outgoing | 2117 |
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SECURITY,D_INFRA_RECOVERY,D_TRADING external_prod
```
...
graph TD
    ...
    tests_audit_test_audit_red_blue_e2e_py -.->|test_depends| D_SHARED
    ...
    class D_GOVERNANCE,D_SECURITY,D_SHARED,D_GOV_ENFORCEMENT,D_TRADING external_prod
```
...
graph TD
    ...
    D_TRADING["D_TRADING production"]
    tests_automation_test_auto_runtime_core_py -.->|test_depends| D_TRADING
    ...
    D_INFRA_RECOVERY["D_INFRA_RECOVERY production"]
    tests_automation_test_auto_rollback_trigger_py -.->|test_depends| D_INFRA_RECOVERY
    tests_automation_test_auto_runtime_e2e_py -.->|test_depends| D_TRADING
    tests_automation_test_auto_runtime_e2e_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_SECURITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_INFRA_TELEMETRY,D_SECURITY_LLM external_prod
```
...
graph TD
    ...
    tests_bridges_test_bridges_tiered_storage_bridge_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SECURITY,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    tests_contracts_test_alerts_bridge_py -.->|test_depends| D_SHARED
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_TRADING,D_SECURITY,D_GOV_ENFORCEMENT,D_SHARED external_prod
```
...
graph TD
    ...
    tests_contracts_test_ct_enforcement_mode_check_py -.->|test_depends| D_INTEGRATION
    tests_contracts_test_ct_encoding_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_encoding_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_encoding_py -.->|test_depends| D_INTEGRATION
    tests_contracts_test_ct_field_presence_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_fle_gate_py -.->|test_depends| D_INTEGRATION
...
graph TD
    ...
    tests_data_test_data_lifecycle_py -.->|test_depends| D_GOVERNANCE
    ...
    class D_FUNDAMENTAL_SIGNAL,D_TRADING,D_GOVERNANCE,D_SIMULATION,D_SECURITY,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_TRADING,D_SHARED,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    tests_e_test_e_merkle_audit_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    tests_event_test_event_bus_upgrade_py -.->|test_depends| D_INFRA_RUNTIME
    tests_event_test_event_hook_py -.->|test_depends| D_GOVERNANCE
    tests_event_test_event_hooks_py -.->|test_depends| D_INFRA_RUNTIME
    tests_event_test_event_hooks_py -.->|test_depends| D_INFRA_RUNTIME
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY,D_SHARED external_prod
```
...
graph TD
    ...
    tests_f_lifecycle_test_f21_auto_shutdown_py -.->|test_depends| D_TRADING
    tests_f_lifecycle_test_f21_event_driven_py -.->|test_depends| D_INFRA_RUNTIME
    D_OPS["D_OPS production"]
    tests_f_lifecycle_test_f21_event_driven_py -.->|test_depends| D_OPS
    ...
    class D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_INFRA_RUNTIME,D_OPS external_prod
```
...
graph TD
    ...
    tests_federated_learning_test_fl_scheduler_act_py -.->|test_depends| D_TRADING
    tests_federated_learning_test_fl_scheduler_collect_detect_py -.->|test_depends| D_TRADING
    tests_federated_learning_test_fl_scheduler_collect_detect_py -.->|test_depends| D_TRADING
    tests_federated_learning_test_fl_scheduler_collect_detect_py -.->|test_depends| D_TRADING
    tests_federated_learning_test_fl_scheduler_collect_detect_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    tests_feedback_test_impact_predictor_py -.->|test_depends| D_TRADING
    tests_feedback_test_hypernetwork_py -.->|test_depends| D_TRADING
    tests_feedback_test_incident_knowledge_injector_py -.->|test_depends| D_TRADING
    tests_feedback_test_interrupt_coherence_validator_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    tests_gate_test_merkle_audit_root_py -.->|test_depends| D_TRADING
    tests_gate_test_meta_performance_gate_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
...
graph TD
    ...
    tests_governance_adversarial_test_reward_hacking_rebound_detector_py -.->|test_depends| D_GOVERNANCE
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    tests_governance_governance_misc_test_annotations_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    tests_governance_ops_test_clock_guard_py -.->|test_depends| D_GOVERNANCE
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_TRADING,D_SECURITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_SHARED,D_INFRA_A2A,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_intent_test_intent_parser_root_py -.->|test_depends| D_GOVERNANCE
    tests_io_test_io_file_utils_py -.->|test_depends| D_SHARED
    D_INFRA_A2A["D_INFRA_A2A production"]
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    tests_llm_security_test_code_integrity_py -.->|test_depends| D_SECURITY_LLM
    ...
    class D_INFRA_RUNTIME,D_SECURITY_LLM,D_SHARED,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY,D_GOVERNANCE,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_TRADING,D_OPS,D_SHARED,D_GOVERNANCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_GOV_ENFORCEMENT,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_GOVERNANCE,D_BACKTEST,D_INTEGRATION,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_trae_rules_test_g_trae_018_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_016_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_016_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_016_py -.->|test_depends| D_GOV_ENFORCEMENT
...
graph TD
    ...
    tests_trae_rules_test_g_trae_040_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_044_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_044_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_044_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_047_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_050_py -.->|test_depends| D_SHARED
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT external_prod
```

...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_TRADING,D_GOVERNANCE,D_INFRA_RECOVERY,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_SHARED,D_SECURITY,D_OPS,D_INFRA_TELEMETRY,D_INFRA_RUNTIME external_prod
```

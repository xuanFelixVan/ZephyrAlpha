...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_INTEGRATION,D_INTEGRATION_GATEWAY,D_INFRA_RUNTIME external_prod
```

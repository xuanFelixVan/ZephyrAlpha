...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_TRADING,D_GOVERNANCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_SECURITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_GOVERNANCE,D_SECURITY_LLM,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_TRADING,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY,D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED,D_SECURITY,D_TRADING,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_SHARED,D_INFRA_RECOVERY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_TRADING,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_INTEGRATION,D_INFRA_RUNTIME,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_TELEMETRY,D_SHARED,D_OPS,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_BACKTEST,D_INTEGRATION,D_INFRA_RECOVERY,D_TRADING,D_INFRA_RUNTIME external_prod
```
...
> 按 architecture_layer 分层显示 audit_test_suite（D_AUDITTEST）的模块分布。共 1668 个模块 / 1668 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│             L2 领域层 / Domain Layer (1668 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 1668 个模块 / 1668 modules）。

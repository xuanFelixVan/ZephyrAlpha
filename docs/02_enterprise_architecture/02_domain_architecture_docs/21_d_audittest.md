...
graph TD
    ...
    class D_TRADING,D_SECURITY_LLM external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_TELEMETRY,D_AUTONOMY_CORE,D_SECURITY_LLM,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_TRADING,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST audit_test_suite"]
        ...
        tests_governance_commit_gates_test_msg_exposure_gate_py["tests/governance/commit_gates/test_msg_exposure... prototype"]
        tests_governance_commit_gates_test_msg_style_gate_py["tests/governance/commit_gates/test_msg_style_ga... prototype"]
    ...
    tests_governance_commit_gates_test_msg_exposure_gate_py -.->|test_depends| D_GOVERNANCE
    tests_governance_commit_gates_test_msg_exposure_gate_py -.->|test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RECOVERY,D_FRONTEND external_prod
```
...
graph TD
    ...
    tests_io_test_mcp_task_claim_py -.->|test_depends| D_INTEGRATION_GATEWAY
...
graph TD
    subgraph D_AUDITTEST["D_AUDITTEST audit_test_suite"]
        ...
        tests_test_event_driven_engine_py["tests/test_event_driven_engine.py prototype"]
        ...
        tests_test_matching_engine_py["tests/test_matching_engine.py prototype"]
        tests_test_miniqmt_broker_py["tests/test_miniqmt_broker.py prototype"]
        tests_test_tick_replay_data_handler_py["tests/test_tick_replay_data_handler.py prototype"]
    ...
    tests_test_decision_graph_reader_py -.->|test_depends| D_GOVERNANCE
    tests_test_event_driven_engine_py -.->|test_depends| D_BACKTEST
    tests_test_event_driven_engine_py -.->|test_depends| D_BACKTEST
    tests_test_event_driven_engine_py -.->|test_depends| D_BACKTEST
    tests_test_event_driven_engine_py -.->|test_depends| D_BACKTEST
    tests_test_extract_decisiongraph_py -.->|test_depends| D_GOVERNANCE
    tests_test_miniqmt_broker_py -.->|test_depends| D_BACKTEST
    D_TRADING["D_TRADING production"]
    tests_test_miniqmt_broker_py -.->|test_depends| D_TRADING
    tests_test_matching_engine_py -.->|test_depends| D_BACKTEST
    tests_test_matching_engine_py -.->|test_depends| D_BACKTEST
    tests_test_matching_engine_py -.->|test_depends| D_BACKTEST
    tests_test_tick_replay_data_handler_py -.->|test_depends| D_BACKTEST
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
|--------|:---:|---------|
| D_TRADING | 561 | test_depends |
| D_GOVERNANCE | 523 | contract,data,runtime,test_depends |
...
> 按 architecture_layer 分层显示 audit_test_suite（D_AUDITTEST）的模块分布。共 1677 个模块 / 1677 modules。

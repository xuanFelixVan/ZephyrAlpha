...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOVERNANCE,D_TRADING,D_FUNDAMENTAL_SIGNAL,D_INTELLIGENCE,D_SIMULATION external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SHARED,D_SECURITY,D_TRADING,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_SCRIPTS,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY_LLM,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY,D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_OPS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_POSITION external_prod
```

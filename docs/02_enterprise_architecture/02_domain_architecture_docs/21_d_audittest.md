...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SECURITY,D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_OPS,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SECURITY,D_SHARED external_prod
```

...
graph TD
    ...
    tests_audit_test_events_ba_py -.->|测试依赖 / test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY_LLM external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_TRADING,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```

...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    tests_governance_audit_test_merkle_hourly_py -.->|测试依赖 / test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_SECURITY,D_INFRA_A2A,D_GOVERNANCE,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_OPS external_prod
```

...
| 模块数 | 1658 | Module Count | 1658 |
| 域内依赖 | 5 | Internal Dependencies | 5 |
| 跨域入边 | 10 | Cross-domain Incoming | 10 |
| 跨域出边 | 2212 | Cross-domain Outgoing | 2212 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 1610 | Prototype Modules | 1610 |
...
graph TD
    ...
    tests_agent_rbac_test_enhanced_security_py -.->|test_depends| D_SECURITY
    tests_agent_rbac_test_enhanced_security_py -.->|test_depends| D_SECURITY
    tests_agent_rbac_test_exceptions_agent_rbac_py -.->|test_depends| D_SECURITY
    tests_agent_rbac_test_forensic_b_py -.->|test_depends| D_SECURITY
    ...
    class D_GOVERNANCE,D_SECURITY,D_INFRA_RECOVERY,D_TRADING external_prod
```
...
graph TD
    ...
    class D_TRADING,D_SHARED,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SECURITY_LLM,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_GOV_ENFORCEMENT,D_SECURITY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RECOVERY,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_INTEGRATION,D_AUTONOMY_CORE,D_SECURITY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    tests_contracts_test_ct_restructuring_safety_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_restructuring_safety_py -.->|test_depends| D_GOV_ENFORCEMENT
    ...
    tests_contracts_test_ct_rollback_exit_code_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_contracts_test_ct_reference_check_py -.->|test_depends| D_INTEGRATION
    tests_contracts_test_ct_position_limit_py -.->|test_depends| D_INTEGRATION
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INTELLIGENCE,D_SHARED,D_SECURITY,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_TRADING,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_TRADING,D_SECURITY,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    tests_f_lifecycle_test_f18_automation_py -.->|test_depends| D_GOVERNANCE
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    tests_feedback_test_dr_resilience_metrics_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_governance_code_quality_test_code_analyzer_runner_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_FRONTEND,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_TRADING,D_INFRA_A2A,D_SECURITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_SHARED,D_INFRA_RUNTIME,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    tests_intent_test_intent_driven_ops_py -.->|test_depends| D_TRADING
    ...
    class D_SHARED,D_TRADING,D_INFRA_RUNTIME,D_INFRA_A2A,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_TRADING,D_SHARED external_prod
```
...
graph TD
    ...
    D_INTEGRATION["D_INTEGRATION production"]
    tests_llm_security_test_db_py -.->|test_depends| D_INTEGRATION
    tests_llm_security_test_db_py -.->|test_depends| D_INTEGRATION
    ...
    class D_INFRA_RUNTIME,D_SECURITY_LLM,D_TRADING,D_GOVERNANCE,D_SHARED,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_TRADING,D_SHARED,D_SECURITY_LLM external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_TRADING,D_INTELLIGENCE,D_GOVERNANCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_TRADING,D_GOVERNANCE,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_RISK external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_SECURITY,D_TRADING,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_trading_test_reconciliation_loop_py -.->|test_depends| D_TRADING
    ...
    tests_trading_test_module_onboarding_scanner_py -.->|test_depends| D_TRADING
    tests_trading_test_lifecycle_manager_py -.->|test_depends| D_TRADING
    tests_trading_test_night_shift_queue_py -.->|test_depends| D_TRADING
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    tests_trae_rules_test_g_trae_047_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_047_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_046_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_048_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_048_py -.->|test_depends| D_GOV_ENFORCEMENT
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_utils_test_utils_pagination_py,tests_utils_test_utils_testing_py,tests_utils_test_utils_time_utils_py,tests_utils_test_version_py,tests_zephyr_data_init_py,tests_zephyr_data_test_policy_registry_py,tests_zephyr_data_test_provider_base_py,tests_zephyr_data_test_providers_py design
...
| D_GOVERNANCE | 511 | contract,data,runtime,test_depends |
...
| D_SECURITY_LLM | 41 | runtime,test_depends |
...
> 按 architecture_layer 分层显示 audit_test_suite（D_AUDITTEST）的模块分布。共 1658 个模块 / 1658 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│             L2 领域层 / Domain Layer (1658 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 1658 个模块 / 1658 modules）。

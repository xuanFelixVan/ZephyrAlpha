...
graph TD
    ...
    tests_autonomy_test_doc_compressor_root_py -.->|测试依赖 / test_depends| D_SHARED
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    tests_e_test_e_integrity_verifier_py -.->|测试依赖 / test_depends| D_GOVERNANCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INFRA_A2A,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY_LLM,D_INTEGRATION,D_INTEGRATION_GATEWAY,D_INFRA_RUNTIME,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_SHARED,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_TRADING,D_SECURITY,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_FUNDAMENTAL_SIGNAL,D_INFRA_RUNTIME,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY,D_TRADING external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 1657 个，11 条域内依赖）。
...
| 527 | test_panorama_alignment_gate.py — 三图模块对齐... | → | D_GOVERNANCE 生命周期管理: panorama_alignment_gate.py — 三图模块对齐门禁.... | 测试依赖 / test_depends |

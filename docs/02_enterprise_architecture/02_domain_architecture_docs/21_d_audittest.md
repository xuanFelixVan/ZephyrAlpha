...
graph TD
    ...
    D_AUTONOMY_CORE["D_AUTONOMY_CORE production"]
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_AUTONOMY_CORE
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOVERNANCE
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_GOVERNANCE,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_TRADING,D_GOVERNANCE,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY_LLM,D_INTEGRATION,D_INFRA_RUNTIME external_prod
```
...
| D_GOVERNANCE | 518 | contract,data,runtime,test_depends |

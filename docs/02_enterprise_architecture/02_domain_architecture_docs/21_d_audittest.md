...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_TRADING,D_GOVERNANCE,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_OPS,D_SECURITY external_prod
```

...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_SECURITY_LLM,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY,D_INTELLIGENCE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_TRADING,D_INFRA_A2A,D_INTEGRATION,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY_LLM,D_SHARED,D_TRADING external_prod
```
...
graph TD
    ...
    tests_memory_test_vms_lifecycle_py -.->|test_depends| D_INTEGRATION
    tests_memory_test_vms_lifecycle_py -.->|test_depends| D_INTEGRATION
    tests_model_test_cli_py -.->|test_depends| D_INTELLIGENCE
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_GOVERNANCE,D_INFRA_A2A,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_OPS external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_GOV_ENFORCEMENT external_prod
```

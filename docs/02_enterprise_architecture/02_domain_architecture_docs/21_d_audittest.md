...
| 跨域出边 | 2200 | Cross-domain Outgoing | 2200 |
...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SIMULATION,D_SHARED,D_GOVERNANCE,D_SECURITY,D_TRADING,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_SECURITY,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY,D_TRADING,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_OPS,D_INTELLIGENCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_FRONTEND,D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_SECURITY,D_TRADING,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_INFRA_A2A,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_llm_security_test_l0_supply_chain_py -.->|test_depends| D_SHARED
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_A2A,D_SHARED,D_SECURITY_LLM,D_TRADING external_prod
```
...
graph TD
    ...
    class D_TRADING,D_SECURITY_LLM,D_INFRA_RUNTIME,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_TELEMETRY,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_TRADING,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_GOV_ENFORCEMENT,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    tests_trading_test_f14_pipeline_extreme_py -.->|test_depends| D_INFRA_RUNTIME
    tests_trading_test_bulkhead_manager_py -.->|test_depends| D_TRADING

...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_AUTONOMY_CORE,D_GOVERNANCE,D_SECURITY_LLM external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_TRADING,D_AUTONOMY_CORE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INTELLIGENCE,D_SECURITY,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_governance_trading_test_exchange_partition_detector_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    class D_INFRA_A2A,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_SHARED,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INFRA_A2A,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SECURITY,D_OPS external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_POSITION,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING external_prod
```

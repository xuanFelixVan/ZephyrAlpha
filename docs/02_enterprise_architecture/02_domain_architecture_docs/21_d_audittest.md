...
| 模块数 | 1653 | Module Count | 1653 |
| 域内依赖 | 1 | Internal Dependencies | 1 |
| 跨域入边 | 0 | Cross-domain Incoming | 0 |
| 跨域出边 | 2102 | Cross-domain Outgoing | 2102 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 1605 | Prototype Modules | 1605 |
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_agent_rbac_test_vibe_coding_py -.->|test_depends| D_SECURITY
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_agent_rbac_test_session_aware_stash_red_blue_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY_LLM,D_AUTONOMY_CORE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY_LLM,D_AUTONOMY_CORE,D_SHARED,D_INFRA_TELEMETRY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY,D_INTELLIGENCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    D_INTEGRATION["D_INTEGRATION production"]
    tests_contracts_test_ct_leverage_limit_py -.->|test_depends| D_INTEGRATION
    ...
    tests_contracts_test_ct_frontmatter_py -.->|test_depends| D_INTEGRATION
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_SIMULATION,D_SECURITY external_prod
```
...
graph TD
    ...
    tests_e_test_e_position_reconciler_py -.->|test_depends| D_POSITION
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_TRADING,D_GOV_ENFORCEMENT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_OPS,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    D_INTEGRATION["D_INTEGRATION production"]
    tests_gate_test_gate_types_py -.->|test_depends| D_INTEGRATION
    ...
    class D_GOV_ENFORCEMENT,D_TRADING,D_INTEGRATION,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_TRADING,D_INFRA_A2A,D_INTEGRATION,D_INFRA_RECOVERY,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_A2A,D_SECURITY_LLM,D_GOV_ENFORCEMENT,D_INTEGRATION,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_SECURITY_LLM,D_AUTONOMY_CORE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_EX_CORE,D_INTELLIGENCE,D_INTEGRATION,D_SECURITY,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    tests_observability_test_observability_metrics_py -.->|test_depends| D_INFRA_TELEMETRY
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_TRADING,D_GOVERNANCE,D_POSITION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_utils_test_utils_testing_py,tests_utils_test_utils_time_utils_py,tests_utils_test_version_py design
...
| D_INFRA_RECOVERY | 53 | test_depends |
...
> 按 architecture_layer 分层显示 audit_test_suite（D_AUDITTEST）的模块分布。共 1653 个模块 / 1653 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│             L2 领域层 / Domain Layer (1653 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 1653 个模块 / 1653 modules）。

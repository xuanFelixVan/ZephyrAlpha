...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_TRADING,D_GOVERNANCE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SECURITY,D_SHARED,D_OPS external_prod
```

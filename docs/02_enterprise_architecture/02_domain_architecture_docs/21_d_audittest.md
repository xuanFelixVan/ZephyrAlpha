...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SECURITY,D_OPS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_GOV_ENFORCEMENT,D_POSITION,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_BACKTEST,D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RECOVERY external_prod
```

...
graph TD
    ...
    tests_a2a_test_a2a_failure_py -.->|runtime| tests_a2a_test_a2a_check_py
    ...
    tests_a2a_test_a2a_failure_py -.->|contract| D_GOV_AUDIT
    tests_a2a_test_a2a_failure_py -.->|runtime| D_GOVERNANCE
    tests_a2a_test_a2a_failure_py -.->|contract| D_GOVERNANCE
    tests_a2a_test_a2a_governance_py -.->|test_depends| D_INFRA_A2A
    tests_a2a_test_a2a_governance_py -.->|test_depends| D_INFRA_A2A
    tests_a2a_test_a2a_governance_py -.->|test_depends| D_INFRA_A2A
    D_GOVERNANCE -.->|contract| tests_a2a_test_a2a_failure_py
    D_GOV_DRIFT["D_GOV_DRIFT design"]
    D_GOV_DRIFT -.->|runtime| tests_a2a_test_a2a_failure_py
    ...
    D_GOVERNANCE -.->|runtime| tests_a2a_test_a2a_behavior_fingerprint_py
    D_GOVERNANCE -.->|runtime| tests_a2a_test_a2a_failure_py
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| tests_a2a_test_a2a_security_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_TRADING,D_INFRA_RECOVERY,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOVERNANCE
    D_GOV_AUDIT["D_GOV_AUDIT design"]
    tests_automation_test_auto_bootstrap_py -.->|runtime| D_GOV_AUDIT
    D_GOV_DRIFT["D_GOV_DRIFT design"]
...
graph TD
    ...
    D_INFRA_RUNTIME -.->|runtime| tests_capacity_test_batch1_infra_py
    D_GOVERNANCE -.->|runtime| tests_capacity_test_batch1_infra_py
    D_GOVERNANCE -.->|runtime| tests_capacity_test_batch1_infra_py
    D_GOVERNANCE -.->|runtime| tests_capacity_test_batch1_infra_py
    D_GOVERNANCE -.->|contract| tests_ce_test_ce_bootstrap_py
    D_GOVERNANCE -.->|runtime| tests_capacity_test_batch1_infra_py
    D_GOVERNANCE -.->|runtime| tests_ce_test_ce_bootstrap_py
    D_GOVERNANCE -.->|runtime| tests_ce_test_ce_bootstrap_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_GOVERNANCE,D_TRADING,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| tests_io_test_mcp_launcher_py
    D_GOVERNANCE -.->|contract| tests_io_test_mcp_launcher_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_INTELLIGENCE,D_INFRA_A2A,D_GOVERNANCE,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_OPS external_prod
```
...
graph TD
    ...
    D_GOVERNANCE -.->|contract| tests_safety_test_circuit_breaker_py
    D_GOVERNANCE -.->|contract| tests_safety_test_circuit_breaker_py
    D_GOVERNANCE -.->|runtime| tests_safety_test_circuit_breaker_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    class D_BACKTEST,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_TRADING,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_trae_rules_test_g_trae_031_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_033_py -.->|test_depends| D_SHARED
...
| D_GOVERNANCE | 519 | contract,data,runtime,test_depends |
...
| D_GOV_AUDIT | 2 | contract,runtime |
...
|------|:---:|---------|
| D_GOVERNANCE | 24 | contract,runtime |
| D_GOV_DRIFT | 2 | runtime |
...
│                     [runtime] (5 条 / edges)                     │
├──────────────────────────────────────────────────────────────────┤
│   test_a2a_failure.py → test_a2a_check.py                        │
│   test_auto_bootstrap.py → test_a2a_failure.py                   │
│   test_auto_bootstrap.py → test_batch1_infra.py                  │
│   test_auto_bootstrap.py → test_ce_bootstrap.py                  │
│   test_auto_bootstrap.py → test_circuit_breaker.py               │
└──────────────────────────────────────────────────────────────────┘

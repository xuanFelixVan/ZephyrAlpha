...
| 跨域出边 | 2122 | Cross-domain Outgoing | 2122 |
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY_LLM,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME external_prod
```

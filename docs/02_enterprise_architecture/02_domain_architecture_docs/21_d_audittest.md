...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_TRADING,D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_SECURITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RUNTIME,D_SECURITY,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_SECURITY,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_GOVERNANCE,D_SECURITY,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_SHARED,D_OPS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_SHARED,D_POSITION external_prod
```

...
| 模块数 | 1654 | Module Count | 1654 |
| 域内依赖 | 1 | Internal Dependencies | 1 |
| 跨域入边 | 0 | Cross-domain Incoming | 0 |
| 跨域出边 | 2109 | Cross-domain Outgoing | 2109 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 1606 | Prototype Modules | 1606 |
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_TRADING external_prod
```
...
graph TD
    ...
    tests_agent_rbac_test_risk_mitigation_agent_rbac_py -.->|test_depends| D_SECURITY
    ...
    D_TRADING["D_TRADING production"]
    tests_audit_test_ab_test_py -.->|test_depends| D_TRADING
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_ai_test_ai_construction_detectors_py -.->|test_depends| D_GOVERNANCE
    tests_ai_test_ai_comment_veracity_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_TRADING,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_automation_test_auto_split_py -.->|test_depends| D_SHARED
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOVERNANCE,D_TRADING,D_SHARED external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_SECURITY,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_SHARED,D_SECURITY,D_TRADING,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_SIMULATION,D_SECURITY,D_INTELLIGENCE,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_SECURITY,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    tests_feedback_test_stochastic_diagnosis_verifier_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    tests_gate_test_gate_persistence_py -.->|test_depends| D_GOVERNANCE
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    tests_governance_audit_test_bridge_py -.->|test_depends| D_GOVERNANCE
...
graph TD
    ...
    class D_FRONTEND,D_GOVERNANCE,D_INFRA_RECOVERY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_TRADING,D_SECURITY,D_INFRA_A2A,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INFRA_RECOVERY,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRA_A2A,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_knowledge_engine_test_knowledge_bus_factor_monitor_py -.->|test_depends| D_TRADING
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_TRADING,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    tests_llm_security_test_l2a_process_sandbox_py -.->|test_depends| D_SECURITY_LLM
    tests_llm_security_test_l2_prompt_protection_py -.->|test_depends| D_SECURITY_LLM
    ...
    class D_SECURITY_LLM,D_INFRA_RUNTIME,D_SHARED,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_SECURITY_LLM,D_TRADING,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_TRADING,D_SECURITY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_SECURITY,D_OPS,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_TRADING,D_SECURITY,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    tests_skill_test_skill_security_py -.->|test_depends| D_AUTONOMY_CORE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
```
...
graph TD
    ...
    D_SHARED["D_SHARED production"]
    tests_trae_rules_test_g_trae_008_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_008_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_008_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_009_py -.->|test_depends| D_SHARED
...
graph TD
    ...
    tests_trae_rules_test_g_trae_051_py -.->|test_depends| D_GOV_ENFORCEMENT
    tests_trae_rules_test_g_trae_051_py -.->|test_depends| D_GOV_ENFORCEMENT
...
> 按 architecture_layer 分层显示 audit_test_suite（D_AUDITTEST）的模块分布。共 1654 个模块 / 1654 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│             L2 领域层 / Domain Layer (1654 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 1654 个模块 / 1654 modules）。

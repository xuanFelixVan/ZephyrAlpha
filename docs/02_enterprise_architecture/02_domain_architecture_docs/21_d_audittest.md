...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_TRADING,D_INFRA_RECOVERY,D_INTELLIGENCE,D_SIMULATION,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_SECURITY,D_GOVERNANCE,D_AUTONOMY_CORE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INTELLIGENCE,D_INFRA_A2A,D_SECURITY,D_GOVERNANCE,D_SHARED,D_INFRA_TELEMETRY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_RISK,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RECOVERY,D_POSITION external_prod
```

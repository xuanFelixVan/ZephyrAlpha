...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    tests_autonomy_test_assembly_context_assembler_py -.->|test_depends| D_AUTONOMY_CORE
    ...
    class D_TRADING,D_AUTONOMY_CORE,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY_LLM,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_SECURITY external_prod
```
...
graph TD
    ...
    tests_context_test_context_debt_score_py -.->|test_depends| D_AUTONOMY_CORE
    ...
    class D_TRADING,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INTEGRATION,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    tests_contracts_test_ct_restructuring_safety_py -.->|test_depends| D_INTEGRATION
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_FUNDAMENTAL_SIGNAL,D_TRADING,D_GOVERNANCE,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY,D_TRADING,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    tests_feedback_test_diagnosis_engine_py -.->|test_depends| D_TRADING
    tests_feedback_test_collectors_py -.->|test_depends| D_TRADING
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_FRONTEND,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_TRADING,D_INFRA_A2A,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_SHARED,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    tests_llm_security_test_code_integrity_py -.->|test_depends| D_SHARED
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    ...
    class D_SHARED,D_INFRA_A2A,D_SECURITY_LLM,D_INFRA_RUNTIME,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_SECURITY_LLM,D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE production"]
    tests_model_test_calibrate_model_diff_py -.->|test_depends| D_GOVERNANCE
    ...
    tests_model_test_model_discovery_py -.->|test_depends| D_INTELLIGENCE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INTEGRATION,D_SECURITY,D_INTELLIGENCE,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SHARED,D_OPS,D_INFRA_RUNTIME,D_INFRA_A2A,D_INFRA_TELEMETRY external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_GOVERNANCE,D_RISK,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_TRADING,D_AUTONOMY_CORE,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_TRADING external_prod
```
...
graph TD
    ...
    tests_trae_rules_test_g_trae_048_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_049_py -.->|test_depends| D_GOV_ENFORCEMENT

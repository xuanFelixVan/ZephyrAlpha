...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    tests_agent_rbac_test_forensic_b_py -.->|test_depends| D_SECURITY
    tests_agent_rbac_test_forensic_b_py -.->|test_depends| D_SECURITY
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_TRADING,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_TELEMETRY,D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_SECURITY_LLM external_prod
```
...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE,D_SECURITY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_TRADING,D_SECURITY,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    tests_f_lifecycle_test_f5_auto_startup_py -.->|test_depends| D_GOVERNANCE
    D_SHARED["D_SHARED production"]
    tests_f_lifecycle_test_f18_automation_py -.->|test_depends| D_SHARED
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_INFRA_A2A,D_TRADING,D_INFRA_RUNTIME,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    tests_governance_security_test_governance_approver_check_py -.->|test_depends| D_SECURITY
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_TRADING,D_INFRA_A2A,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SHARED,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED external_prod
```
...
graph TD
    ...
    class D_FUNDAMENTAL_SIGNAL,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_BACKTEST external_prod
```
...
graph TD
    ...
    tests_trae_rules_test_g_trae_009_py -.->|test_depends| D_GOV_ENFORCEMENT
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    tests_trae_rules_test_g_trae_043_py -.->|test_depends| D_SHARED
    tests_trae_rules_test_g_trae_043_py -.->|test_depends| D_GOV_ENFORCEMENT

...
graph TD
    ...
    class D_TRADING,D_GOVERNANCE,D_SECURITY,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SECURITY_LLM,D_SHARED,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_TRADING,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_A2A,D_SECURITY,D_INTELLIGENCE,D_GOVERNANCE,D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_OPS,D_SHARED external_prod
```

...
graph TD
    ...
    class D_SHARED,D_ML_TRAIN,D_FUNDAMENTAL_SIGNAL,D_AUDITTEST,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SHARED,D_EX_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_AUDIT external_prod
    class D_SHARED,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_EX_CORE external_design
```

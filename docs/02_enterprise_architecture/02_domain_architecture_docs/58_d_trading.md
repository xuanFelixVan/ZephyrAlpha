...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_SHARED,D_GOV_AUDIT,D_ML_TRAIN,D_EX_CORE,D_AUDITTEST,D_FUNDAMENTAL_SIGNAL external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_INTEGRATION,D_EX_CORE,D_GOV_AUDIT,D_PF_CORE,D_ORCHESTRATOR,D_RISK external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRASTRUCTURE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT external_prod

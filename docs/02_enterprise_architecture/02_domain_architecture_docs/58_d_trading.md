...
graph TD
    ...
    class D_GOVERNANCE,D_INFRASTRUCTURE,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL,D_RISK external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL,D_RISK,D_INFRA_RUNTIME external_prod

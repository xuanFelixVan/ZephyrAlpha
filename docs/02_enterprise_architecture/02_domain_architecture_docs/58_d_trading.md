...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_SHARED,D_EX_CORE,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL,D_INFRA_RUNTIME,D_GOV_AUDIT,D_ML_TRAIN,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_EX_CORE,D_INTEGRATION,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_PF_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RUNTIME,D_RISK external_prod
    class D_INFRASTRUCTURE,D_SHARED,D_EX_CORE,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_EX_CORE,D_INFRASTRUCTURE external_prod

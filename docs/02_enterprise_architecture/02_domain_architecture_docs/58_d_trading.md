...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_RISK external_prod
    class D_INFRASTRUCTURE,D_SHARED,D_ORCHESTRATOR,D_EX_CORE,D_ML_TRAIN,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_RISK,D_INFRA_RUNTIME external_prod
    class D_INFRASTRUCTURE,D_EX_CORE,D_ML_TRAIN,D_FUNDAMENTAL_SIGNAL external_design
```

...
graph TD
    ...
    class D_SHARED,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_ML_TRAIN,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_EX_CORE,D_GOV_AUDIT,D_RISK external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_EX_CORE external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_SHARED external_prod

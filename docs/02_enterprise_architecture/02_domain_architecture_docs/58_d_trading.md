...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_GOV_AUDIT,D_ML_TRAIN,D_EX_CORE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INTEGRATION,D_EX_CORE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_RISK external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRASTRUCTURE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_EX_CORE external_prod
    class D_SHARED,D_GOV_REPAIR,D_FUNDAMENTAL_SIGNAL,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod

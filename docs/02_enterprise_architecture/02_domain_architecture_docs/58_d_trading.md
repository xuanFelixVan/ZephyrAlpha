...
graph TD
    ...
    class D_GOVERNANCE,D_EX_CORE,D_RISK,D_INTEGRATION external_prod
    class D_INFRASTRUCTURE,D_SHARED,D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_EX_CORE,D_RISK,D_INTEGRATION external_prod

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_RISK external_prod
    class D_ORCHESTRATOR,D_SHARED,D_ML_TRAIN,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_SIGQC external_design
```

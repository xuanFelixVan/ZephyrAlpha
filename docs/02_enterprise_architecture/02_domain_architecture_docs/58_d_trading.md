...
graph TD
    ...
    class D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_SHARED,D_GOV_ENFORCEMENT,D_EX_CORE,D_GOV_REPAIR,D_GOV_AUDIT,D_ML_TRAIN,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FUNDAMENTAL_SIGNAL,D_SIGLEGACY,D_RISK external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_EX_CORE,D_PF_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRASTRUCTURE,D_FUNDAMENTAL_SIGNAL,D_SIGLEGACY,D_RISK external_prod
    class D_SHARED,D_GOV_REPAIR,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_EX_CORE external_prod
    class D_ORCHESTRATOR,D_GOV_REPAIR,D_SIGQC external_design
```

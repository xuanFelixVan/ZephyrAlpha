...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRASTRUCTURE,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_ML_TRAIN,D_EX_CORE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_EX_CORE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_ORCHESTRATOR,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_SHARED,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRASTRUCTURE external_prod

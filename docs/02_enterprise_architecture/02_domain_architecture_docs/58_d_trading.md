...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_RISK,D_INTEGRATION external_prod
    class D_INFRASTRUCTURE,D_EX_CORE,D_ML_TRAIN external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_FRONTEND external_prod
    class D_SHARED,D_ORCHESTRATOR,D_EX_CORE,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_AUDIT,D_SHARED,D_INFRASTRUCTURE,D_PF_CORE,D_EX_CORE,D_REPORTING external_prod
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_SHARED,D_EX_CORE,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRASTRUCTURE external_prod
    class D_SHARED,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_design
```

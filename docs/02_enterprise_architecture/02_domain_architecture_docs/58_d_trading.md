...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOV_REPAIR,D_ML_TRAIN,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_FUNDAMENTAL_SIGNAL external_prod
    class D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOVERNANCE,D_SIGQC,D_RISK external_design
```
...
graph TD
    ...
    D_INFRASTRUCTURE["(生产态 / production) D_INFRASTRUCTURE"]
    tests_trading_test_l07_post_trade_analytics_py -.->|测试依赖 / test_depends| D_INFRASTRUCTURE
    ...
    class D_INFRASTRUCTURE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_PF_CORE,D_EX_CORE,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL external_prod
    class D_SHARED,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_GOV_REPAIR,D_SIGQC,D_RISK external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_PF_CORE,D_EX_CORE external_prod
    class D_SHARED,D_GOV_REPAIR,D_GOVERNANCE,D_SIGQC external_design
```
...
> 本域与 22 个外部域直接连接（出边 107 条 + 入边 79 条 = 186 条）。只显示直接连接的域，不展开具体节点。

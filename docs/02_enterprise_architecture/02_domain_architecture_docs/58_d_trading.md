...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRASTRUCTURE,D_INTEGRATION,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL external_prod
    class D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_EX_CORE,D_GOV_REPAIR,D_AUDITTEST,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_SIGLEGACY external_prod
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_REPAIR,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_PF_CORE,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_SIGLEGACY,D_INFRA_RUNTIME external_prod
    class D_INFRASTRUCTURE,D_EX_CORE,D_GOV_REPAIR,D_FUNDAMENTAL_SIGNAL external_design
```

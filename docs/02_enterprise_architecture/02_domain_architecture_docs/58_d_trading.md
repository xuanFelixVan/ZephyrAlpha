...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_GOVERNANCE,D_RISK,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_ML_TRAIN,D_EX_CORE,D_SIGQC,D_FUNDAMENTAL_SIGNAL external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ML_TRAIN,D_EX_CORE,D_FUNDAMENTAL_SIGNAL external_design
```

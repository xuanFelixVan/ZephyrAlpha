...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_EX_CORE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_INFRASTRUCTURE,D_GOV_REPAIR,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INTEGRATION,D_EX_CORE,D_REPORTING,D_GOV_AUDIT,D_SHARED,D_PF_CORE,D_RISK external_prod
    class D_GOV_ENFORCEMENT,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_SIGLEGACY,D_SIGQC external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_EX_CORE,D_RISK,D_INFRA_RUNTIME external_prod
    class D_INFRASTRUCTURE,D_GOV_REPAIR,D_FUNDAMENTAL_SIGNAL external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SHARED external_prod
    class D_GOV_ENFORCEMENT,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```

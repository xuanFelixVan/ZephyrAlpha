...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_FUNDAMENTAL_SIGNAL,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOVERNANCE,D_EX_CORE,D_AUTONOMY_CORE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_EX_CORE external_prod
    class D_SHARED,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_REPAIR external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_SHARED,D_ORCHESTRATOR,D_EX_CORE,D_FUNDAMENTAL_SIGNAL,D_GOV_AUDIT,D_ML_TRAIN,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_EX_CORE,D_INTEGRATION,D_RISK external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_EX_CORE external_prod

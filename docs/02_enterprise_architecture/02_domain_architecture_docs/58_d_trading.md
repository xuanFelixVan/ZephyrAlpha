...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_FRONTEND,D_INTELLIGENCE external_prod
    class D_SHARED,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_ML_TRAIN,D_GOV_REPAIR,D_EX_CORE,D_FUNDAMENTAL_SIGNAL external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SIGLEGACY,D_RISK external_prod
    class D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_AUDIT,D_FRONTEND,D_INTELLIGENCE external_prod
    class D_SHARED,D_ML_TRAIN,D_GOV_REPAIR,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_SIGQC,D_FUNDAMENTAL_SIGNAL external_design
```

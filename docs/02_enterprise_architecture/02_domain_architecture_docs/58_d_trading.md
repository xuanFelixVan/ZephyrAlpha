...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_RISK external_prod
    class D_SHARED,D_ORCHESTRATOR,D_EX_CORE,D_ML_TRAIN,D_SIGQC external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_RISK,D_INFRA_RUNTIME external_prod
    class D_INFRASTRUCTURE,D_SHARED,D_EX_CORE,D_ML_TRAIN external_design
```

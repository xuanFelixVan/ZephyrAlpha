...
graph TD
    ...
    class D_GOVERNANCE,D_INFRASTRUCTURE,D_SHARED,D_RISK,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_SIGQC,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_RISK,D_INTEGRATION external_prod
    class D_SHARED,D_INFRASTRUCTURE,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_EX_CORE external_design
```

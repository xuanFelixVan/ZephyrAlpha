...
graph TD
    ...
    class D_ORCHESTRATOR,D_EX_CORE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INTEGRATION,D_RISK external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_EX_CORE,D_INFRASTRUCTURE,D_GOVERNANCE external_prod

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_INTEGRATION,D_EX_CORE external_prod
    class D_SHARED,D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_REPAIR,D_ML_TRAIN,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_EX_CORE,D_PF_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL external_design
```

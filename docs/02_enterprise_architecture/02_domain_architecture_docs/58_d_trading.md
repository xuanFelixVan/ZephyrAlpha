...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_AUDITTEST,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_EX_CORE,D_INFRASTRUCTURE,D_INTEGRATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_RISK external_prod
    class D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE,D_SIGQC external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_INFRASTRUCTURE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_EX_CORE,D_INFRASTRUCTURE external_prod

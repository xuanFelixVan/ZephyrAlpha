...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_EX_CORE,D_GOV_REPAIR,D_ML_TRAIN,D_GOV_AUDIT,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRASTRUCTURE,D_SIGLEGACY,D_FUNDAMENTAL_SIGNAL,D_RISK external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_EX_CORE,D_GOVERNANCE,D_SHARED external_prod

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_SHARED,D_GOVERNANCE,D_EX_CORE,D_GOV_AUDIT,D_ML_TRAIN,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_EX_CORE,D_ORCHESTRATOR,D_INFRASTRUCTURE,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RUNTIME,D_PF_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_ORCHESTRATOR,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_EX_CORE external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_EX_CORE,D_INFRA_RUNTIME,D_INFRASTRUCTURE external_prod
    class D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```

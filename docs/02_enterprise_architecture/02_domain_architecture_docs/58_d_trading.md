...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_RISK external_prod
    class D_ORCHESTRATOR,D_ML_TRAIN,D_EX_CORE,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```

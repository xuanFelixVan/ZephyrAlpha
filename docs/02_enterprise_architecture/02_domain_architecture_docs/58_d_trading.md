...
graph TD
    ...
    class D_GOVERNANCE,D_INFRASTRUCTURE,D_SHARED,D_INFRA_RUNTIME,D_RISK,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL external_prod
    class D_ORCHESTRATOR,D_ML_TRAIN,D_EX_CORE,D_SIGQC external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_RISK,D_FUNDAMENTAL_SIGNAL,D_INFRA_RUNTIME external_prod
    class D_INFRASTRUCTURE,D_ML_TRAIN,D_EX_CORE external_design
```

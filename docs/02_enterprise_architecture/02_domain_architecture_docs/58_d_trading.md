...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_GOV_AUDIT,D_EX_CORE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRASTRUCTURE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTEGRATION,D_EX_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_INTEGRATION,D_INFRASTRUCTURE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_EX_CORE,D_AUTONOMY_CORE,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod

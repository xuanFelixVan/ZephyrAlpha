...
graph TD
    ...
    class D_GOVERNANCE,D_INFRASTRUCTURE,D_FUNDAMENTAL_SIGNAL external_prod
    class D_ORCHESTRATOR,D_SHARED,D_AUDITTEST,D_ML_TRAIN,D_EX_CORE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_EX_CORE,D_INFRA_RUNTIME,D_PF_CORE,D_ORCHESTRATOR,D_INFRASTRUCTURE external_prod
    class D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_RISK,D_SIGQC external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RUNTIME,D_EX_CORE external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_EX_CORE,D_GOVERNANCE,D_INTEGRATION,D_PF_CORE external_prod

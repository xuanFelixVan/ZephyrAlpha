...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL external_prod
    class D_ORCHESTRATOR,D_EX_CORE,D_GOV_REPAIR,D_GOV_AUDIT,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SIGLEGACY,D_FUNDAMENTAL_SIGNAL,D_RISK external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_EX_CORE,D_PF_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRASTRUCTURE,D_INTEGRATION,D_SIGLEGACY,D_FUNDAMENTAL_SIGNAL,D_RISK,D_INFRA_RUNTIME external_prod
    class D_GOV_REPAIR,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_EX_CORE,D_GOVERNANCE external_prod
    class D_GOV_REPAIR,D_SIGQC external_design
```

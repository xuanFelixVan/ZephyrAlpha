...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_SHARED,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_GOV_AUDIT,D_ML_TRAIN,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_EX_CORE,D_GOV_AUDIT,D_INTEGRATION,D_RISK external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTEGRATION,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_ORCHESTRATOR,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_INTELLIGENCE external_prod
    class D_SHARED,D_ML_TRAIN,D_AUTONOMY_CORE,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_EX_CORE,D_INTEGRATION external_prod
    class D_SHARED,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```

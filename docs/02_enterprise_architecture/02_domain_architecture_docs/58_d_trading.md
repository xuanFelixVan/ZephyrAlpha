...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_GOVERNANCE,D_INFRA_RUNTIME,D_RISK,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_ML_TRAIN,D_SIGQC external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```

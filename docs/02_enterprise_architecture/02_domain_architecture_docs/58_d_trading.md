...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE external_prod
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_EX_CORE,D_GOV_REPAIR,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_RISK external_prod
    class D_INFRASTRUCTURE,D_SHARED,D_EX_CORE,D_GOV_REPAIR,D_FUNDAMENTAL_SIGNAL,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_SHARED,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod

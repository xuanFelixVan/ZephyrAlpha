...
graph TD
    ...
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_trading_trading_contracts_market_synthesized_signal_py
    ...
    class D_SHARED,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRASTRUCTURE external_prod
    class D_RISK,D_GOV_REPAIR,D_EX_CORE,D_ML_TRAIN external_design
```

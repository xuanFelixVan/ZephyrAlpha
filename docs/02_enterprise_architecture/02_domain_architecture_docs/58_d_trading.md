...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_RISK external_prod
    class D_SHARED,D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_ML_TRAIN,D_SIGQC external_design
```

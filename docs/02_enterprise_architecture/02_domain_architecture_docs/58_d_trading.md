...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRASTRUCTURE,D_RISK,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_EX_CORE,D_SIGQC external_design
```
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_SIGQC,D_FUNDAMENTAL_SIGNAL external_design
```

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_SHARED,D_FUNDAMENTAL_SIGNAL,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_GOV_AUDIT,D_ML_TRAIN,D_EX_CORE,D_INFRA_RUNTIME,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRASTRUCTURE,D_GOV_AUDIT,D_EX_CORE,D_INTEGRATION,D_INFRA_RUNTIME,D_PF_CORE,D_RISK external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SHARED external_prod

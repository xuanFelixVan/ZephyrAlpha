...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL external_prod
    class D_SHARED,D_EX_CORE,D_ML_TRAIN,D_GOV_AUDIT,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_EX_CORE,D_ORCHESTRATOR,D_INTEGRATION,D_RISK external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_EX_CORE external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SHARED,D_EX_CORE,D_INFRASTRUCTURE,D_INTEGRATION external_prod

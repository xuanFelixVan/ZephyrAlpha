...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_GOV_AUDIT,D_EX_CORE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_AUTONOMY_CORE,D_AUDITTEST,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_EX_CORE,D_PF_CORE,D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_AUDIT,D_RISK external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_EX_CORE external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_SHARED,D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```

...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_INTEGRATION,D_RISK,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_SIGQC,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_RISK external_prod

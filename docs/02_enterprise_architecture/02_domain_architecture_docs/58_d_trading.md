...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL external_prod
    class D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_ML_TRAIN,D_AUTONOMY_CORE,D_AUDITTEST,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_RISK,D_SIGLEGACY,D_FUNDAMENTAL_SIGNAL external_prod
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_REPAIR,D_SIGQC external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_RISK,D_SIGLEGACY,D_FUNDAMENTAL_SIGNAL external_prod
    class D_INFRASTRUCTURE,D_GOV_REPAIR,D_ML_TRAIN external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOVERNANCE,D_SHARED external_prod
    class D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_SIGQC external_design
```

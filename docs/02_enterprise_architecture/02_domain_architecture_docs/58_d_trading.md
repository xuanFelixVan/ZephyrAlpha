...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SHARED,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_GOV_AUDIT,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL,D_AUDITTEST,D_ML_TRAIN,D_EX_CORE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_EX_CORE,D_PF_CORE,D_ORCHESTRATOR,D_INFRASTRUCTURE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_INTEGRATION,D_EX_CORE external_prod
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME external_prod

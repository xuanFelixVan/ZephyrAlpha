...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL external_prod
    class D_ORCHESTRATOR,D_EX_CORE,D_GOV_AUDIT,D_ML_TRAIN,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_EX_CORE,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INTEGRATION,D_RISK external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_EX_CORE external_prod
    class D_AUTONOMY_CORE,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_EX_CORE,D_GOVERNANCE external_prod

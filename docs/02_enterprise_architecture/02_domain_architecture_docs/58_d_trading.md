...
graph TD
    ...
    class D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_GOV_AUDIT,D_ML_TRAIN,D_INFRA_RUNTIME,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_EX_CORE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INTEGRATION,D_ORCHESTRATOR,D_RISK external_prod
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_SIGQC external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_INFRASTRUCTURE,D_FUNDAMENTAL_SIGNAL,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_EX_CORE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOVERNANCE external_prod

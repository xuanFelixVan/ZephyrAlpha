...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_RISK,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_EX_CORE,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_SIGQC external_design
```

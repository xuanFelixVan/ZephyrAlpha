...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_REPAIR,D_ML_TRAIN,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
    class D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_SIGQC,D_RISK external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_EX_CORE,D_PF_CORE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_GOV_REPAIR,D_FUNDAMENTAL_SIGNAL,D_SIGQC,D_RISK external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_EX_CORE,D_PF_CORE external_prod
    class D_SHARED,D_GOV_REPAIR,D_GOVERNANCE external_design
```

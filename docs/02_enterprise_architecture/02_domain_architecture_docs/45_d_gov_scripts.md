...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_REPAIR,D_GOVERNANCE,D_GOV_AUDIT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT external_prod
```

...
> 按 architecture_layer 分层显示 信号质量控制（D_SIGQC）的模块分布。共 7 个模块 / 7 modules。
...
| 5 | src/zephyr/signal_quality/infrastructure/__init__.py | src/zephyr/signal_quality/infrastruct... | prototype | generated |
| 6 | src/zephyr/signal_quality/models/__init__.py | src/zephyr/signal_quality/models/__in... | prototype | generated |
| 7 | src/zephyr/signal_quality/services/__init__.py | src/zephyr/signal_quality/services/__... | prototype | generated |

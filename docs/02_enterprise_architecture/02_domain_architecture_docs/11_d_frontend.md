...
graph TD
    subgraph D_FRONTEND["D_FRONTEND 前端"]
        ...
        src_zephyr_frontend_dashboard_app_py["(生产态 / production) app.py"]
        src_zephyr_frontend_dashboard_app_panel_py["(生产态 / production) app_panel.py"]
        src_zephyr_frontend_dashboard_components_init_py["(原型态 / prototype) __init__.py"]
        src_zephyr_frontend_dashboard_components_backtest_performance_py["(原型态 / prototype) backtest_performance.py"]
        src_zephyr_frontend_dashboard_components_backtest_results_py["(生产态 / production) backtest_results.py"]
        src_zephyr_frontend_dashboard_components_backtest_results_py_1["(设计态 / design) "]
        src_zephyr_frontend_dashboard_components_chart_factory_py["(原型态 / prototype) chart_factory.py"]
        src_zephyr_frontend_dashboard_components_chart_factory_py_1["(设计态 / design) "]
        src_zephyr_frontend_dashboard_components_fitness_functions_py["(生产态 / production) fitness_functions.py"]
        src_zephyr_frontend_dashboard_components_gate_statistics_py["(生产态 / production) gate_statistics.py"]
        src_zephyr_frontend_dashboard_components_knowledge_overview_py["(生产态 / production) knowledge_overview.py"]
        src_zephyr_frontend_dashboard_components_olap_trend_py["(生产态 / production) olap_trend.py"]
        src_zephyr_frontend_dashboard_components_order_book_py["(生产态 / production) order_book.py"]
        src_zephyr_frontend_dashboard_components_order_book_py_1["(设计态 / design) "]
        src_zephyr_frontend_dashboard_components_position_monitor_py["(生产态 / production) position_monitor.py"]
        src_zephyr_frontend_dashboard_components_position_monitor_py_1["(设计态 / design) "]
        src_zephyr_frontend_dashboard_components_task_progress_py["(生产态 / production) task_progress.py"]
        src_zephyr_frontend_dashboard_components_tick_replay_py["(生产态 / production) tick_replay.py"]
        src_zephyr_frontend_dashboard_components_tick_replay_py_1["(设计态 / design) "]
        src_zephyr_frontend_dashboard_components_trade_panel_py["(生产态 / production) trade_panel.py"]
        ...
        src_zephyr_frontend_interface_base_py["(生产态 / production) interface_base.py"]
...
|--------|:---:|---------|
| D_GOVERNANCE | 7 | import_depends,runtime / import_depends,runtime |
| D_BACKTEST | 2 | import,import_depends / import,import_depends |
...
|------|:---:|---------|
| D_AUDITTEST | 8 | 测试依赖 / test_depends |
...
┌──────────────────────────────────────────────────────────────────┐
│    L1 基础层 / Foundation Layer（共 30 个模块 / 30 modules）     │
├──────────────────────────────────────────────────────────────────┤
...
│   __init__.py [原型态 / prototype]                               │
│   __init__.py [原型态 / prototype]                               │
│   app.py [生产态 / production]                                   │
│   app_panel.py [生产态 / production]                             │
│   __init__.py [原型态 / prototype]                               │
│   backtest_performance.py [原型态 / prototype]                   │
│   backtest_results.py [生产态 / production]                      │
│    [设计态 / design]                                             │
│   chart_factory.py [原型态 / prototype]                          │
│    [设计态 / design]                                             │
│   fitness_functions.py [生产态 / production]                     │
│   gate_statistics.py [生产态 / production]                       │
│   knowledge_overview.py [生产态 / production]                    │
│   olap_trend.py [生产态 / production]                            │
│   order_book.py [生产态 / production]                            │
...
┌──────────────────────────────────────────────────────────────────┐
│           [导入依赖 / import_depends]（29 条 / edges）           │
├──────────────────────────────────────────────────────────────────┤
│    →                                                             │
│    →                                                             │
│    →                                                             │

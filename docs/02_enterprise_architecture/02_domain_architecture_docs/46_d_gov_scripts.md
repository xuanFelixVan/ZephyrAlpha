...
| 2 | scripts/governance/d5_architecture/generators/generate_da... | G-inventory: 扫描 ClickHouse 生成业务数据清单 MD | 原型态 / prototype |  |
...
| 2 | scripts/_archive/governance/migrate_arch_f_functions.py | 阶段1迁移脚本：创建37个F功能设计态节点 + 56条依... | 原型态 / prototype |  |
| 3 | scripts/governance/_archive/one_off/audit_post_sync_comma... | audit_post_sync_commands.py — post_sync_standa... | 原型态 / prototype |  |
| 4 | scripts/governance/_archive/one_off/check_exam_case_consi... | 考试题库一致性检查——根因治本，防止"定义-注册... | 原型态 / prototype |  |
| 5 | scripts/governance/_archive/one_off/create_alignment_task... | # [BLUEPRINT] MOD-INF-005 | scripts/governance/... | 原型态 / prototype |  |
| 6 | scripts/governance/_archive/one_off/dm105_depgraph_triage.py | DM-105: depgraph 未分配节点三策略处理脚本 | 原型态 / prototype |  |
| 7 | scripts/governance/_archive/one_off/fix_broken_post_sync.py | fix_broken_post_sync.py — 批量修复历史 broken ... | 原型态 / prototype |  |
...
| 11 | scripts/governance/_archive/one_off/rename_whitelist_clea... | 命名规范白名单清理 - 全文替换脚本。 | 原型态 / prototype |  |
| 12 | scripts/governance/_archive/one_off/test_lock_scenarios.py | test_lock_scenarios.py — RULE-ZERO 锁协议场景 ... | 原型态 / prototype |  |
...
| 15 | scripts/governance/_archive/prototype/adversarial_log.py | 红白对抗闭环记录——攻击→根源分析→修复→回归... | 原型态 / prototype |  |
| 16 | scripts/governance/_archive/prototype/adversarial_sys_mas... | Red/Blue Team Adversarial Test v3: SYS-MASTER-0... | 原型态 / prototype |  |
...
| 18 | scripts/governance/_archive/prototype/changelog.py | changelog.py — 治理域变更日志生成/追加工具. | 原型态 / prototype |  |
| 19 | scripts/governance/_archive/prototype/check_audit_rbac_is... | check_audit_rbac_isolation.py — 静态分析 audit... | 原型态 / prototype |  |
| 20 | scripts/governance/_archive/prototype/construction_gate.py | Construction Gate — 施工前路径校验门禁 | 原型态 / prototype |  |
| 21 | scripts/governance/_archive/prototype/generate_asset_inde... | 全项目资产索引生成器 | 原型态 / prototype |  |
| 22 | scripts/governance/_archive/prototype/generate_nav_table.py | generate_nav_table.py — 全流程导航表自动生成器... | 原型态 / prototype |  |
| 23 | scripts/governance/_archive/prototype/rebuild_audit_index.py | scripts/governance/rebuild_audit_index.py — 重... | 原型态 / prototype |  |
| 24 | scripts/governance/_archive/prototype/scan_ground_truth_d... | # [BLUEPRINT] MOD-INF-005 | scripts/governance/... | 原型态 / prototype |  |
| 25 | scripts/governance/_archive/prototype/session_simulator.py | session_simulator — 30 个模拟开发 session 的蓝... | 原型态 / prototype |  |
| 26 | scripts/governance/_archive/prototype/sync_blueprint_stat... | 机械强制：construction_plan=phase_2_complete →... | 原型态 / prototype |  |
| 27 | scripts/governance/_archive/vms_ri/ri_boundary_check.py | Runtime Integration 边界验证脚本 — MOD-INF-002 | 原型态 / prototype |  |
| 28 | scripts/governance/_archive/vms_ri/ri_build_completion_ch... | Runtime Integration Phase 2 完工验证 — MOD-INF-002 | 原型态 / prototype |  |
| 29 | scripts/governance/_archive/vms_ri/vms_blindspot_check.py | VMS 盲点闭合检查器 — MOD-INF-011 · R1(33) + R... | 原型态 / prototype |  |
| 30 | scripts/governance/_archive/vms_ri/vms_build_completion_c... | VMS Build Completion Check — MOD-INF-011 · TA... | 原型态 / prototype |  |
| 31 | scripts/governance/_archive/vms_ri/vms_cron_monitor.py | VMS Cron 监控器 — MOD-INF-011 · TASK-INF-0224 | 原型态 / prototype |  |
| 32 | scripts/governance/_archive/vms_ri/vms_cross_file_check.py | VMS 跨文件内容一致性检查器 — MOD-INF-011 · TA... | 原型态 / prototype |  |
| 33 | scripts/governance/_archive/vms_ri/vms_health_check.py | VMS Health Check 脚本 — MOD-INF-011 · Phase 3... | 原型态 / prototype |  |
| 34 | scripts/governance/_archive/vms_ri/vms_migrate.py | VMS Phase 2 数据迁移脚本 — MOD-INF-011 | 原型态 / prototype |  |
| 35 | scripts/governance/_archive/vms_ri/vms_migration_dry_run.py | VMS 迁移 dry-run 脚本 — MOD-INF-011 Phase 2 前... | 原型态 / prototype |  |
| 36 | scripts/governance/_archive/vms_ri/vms_phase_rollback.py | VMS Phase 回滚方案 — MOD-INF-011 · TASK-INF-0217 | 原型态 / prototype |  |
| 37 | scripts/governance/_archive/vms_ri/vms_version_sync_check.py | VMS 版本同步检查器 — MOD-INF-011 · TASK-INF-0222 | 原型态 / prototype |  |
| 38 | scripts/governance/_shared/base.py | base.py — 审计脚本基类 | 原型态 / prototype |  |
| 39 | scripts/governance/_shared/constants.py | constants.py — 审计脚本共享常量 | 生产态 / production |  |
| 40 | scripts/governance/_shared/encoding.py | encoding.py — UTF-8 编码安全工具 | 原型态 / prototype |  |
| 41 | scripts/governance/_shared/file_utils.py | _shared/file_utils.py — 原子写入共享工具（ARCH... | 原型态 / prototype |  |
| 42 | scripts/governance/_shared/frontmatter.py | 文件头部格式解析 SSoT（Single Source of Truth） | 生产态 / production |  |
| 43 | scripts/governance/_shared/libcst_docstring_adder.py | libcst_docstring_adder.py — Lossless docstring... | 原型态 / prototype |  |
| 44 | scripts/governance/_shared/registry_entry_count.py | 登记表主条目计数——与 generate_registry_master... | 原型态 / prototype |  |
| 45 | scripts/governance/_shared/thresholds.py | thresholds.py — 阈值集中配置加载器 | 原型态 / prototype |  |
| 46 | scripts/governance/_shared/walk.py | walk.py — 目录遍历共享工具 | 原型态 / prototype |  |
| 47 | scripts/governance/_shared/yaml_utils.py | _shared/yaml_utils.py — YAML 文件加载共享工具 | 原型态 / prototype |  |
| 48 | scripts/governance/_sync/check_p0_status.py | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 49 | scripts/governance/_sync/cleanup_p0_auto_bridged.py | 清理历史 P0 自动桥接任务 | 原型态 / prototype |  |
| 50 | scripts/governance/_sync/cleanup_p0_ops_pending.py | cleanup_p0_ops_pending.py - 一次性：将所有 OPS-... | 原型态 / prototype |  |
| 51 | scripts/governance/_sync/fix_orphan_deps.py | fix_orphan_deps.py — 一次性修复孤儿依赖引用 | 原型态 / prototype |  |
| 52 | scripts/governance/_tasks/list_phase0_tasks.py | [INVARIANTS] 仅查询不修改; 连接失败→exit 1 | 原型态 / prototype |  |
| 53 | scripts/governance/_tasks/task_show.py | governance/task_show 脚本 — 任务卡详情查询 CLI。 | 原型态 / prototype |  |
| 54 | scripts/governance/_tasks/task_summary.py | task_summary.py — 任务系统全局摘要 CLI | 原型态 / prototype |  |
...
| 58 | scripts/governance/architecture_health_dashboard.py | architecture_health_dashboard.py — 架构健康度... | 原型态 / prototype |  |
| 59 | scripts/governance/ast_import_rewriter.py | AST-based import rewriter for governance direct... | 原型态 / prototype |  |
| 60 | scripts/governance/audit_return_contract_usage.py | audit_return_contract_usage.py — 返回契约 ok ... | 原型态 / prototype |  |
| 61 | scripts/governance/audit_worktree_ops_telemetry.py | audit_worktree_ops_telemetry.py — 主工作区文件... | 原型态 / prototype |  |
| 62 | scripts/governance/check_commit_message.py | check_commit_message.py — GitHub Actions PR co... | 原型态 / prototype |  |
| 63 | scripts/governance/check_ssot_gate.py | GATE-SSOT: SSoT 创建门禁（pre-commit hook 双保... | 生产态 / production |  |
| 64 | scripts/governance/d10_performance/collect_system_threads.py | collect_system_threads.py — 全系统线程数快照采集器 | 原型态 / prototype |  |
| 65 | scripts/governance/d11_compliance/audit_registration.py | audit_registration.py — 孤儿注册检测（RULE-TWO... | 原型态 / prototype |  |
| 66 | scripts/governance/d11_compliance/ci_self_check.py | CI Entry: Self-Check — Drift Detector 自身完整... | 原型态 / prototype |  |
| 67 | scripts/governance/d11_compliance/fix_shared_bypass.py | fix_shared_bypass.py - D-D-07 auto-fix tool (va... | 原型态 / prototype |  |
| 68 | scripts/governance/d11_compliance/g9_compliance_check.py | G9 四蓝图跨模块集成合规门禁执行器. | 原型态 / prototype |  |
| 69 | scripts/governance/d11_compliance/task_self_check.py | task_self_check.py — 任务系统自身健康检查 | 原型态 / prototype |  |
| 70 | scripts/governance/d11_compliance/validate_commit_gateway.py | validate_commit_gateway.py — GATE-COMMIT-GW 门... | 原型态 / prototype |  |
| 71 | scripts/governance/d11_compliance/validate_commit_message.py | validate_commit_message.py — Conventional Comm... | 原型态 / prototype |  |
| 72 | scripts/governance/d11_compliance/validate_exit_codes.py | validate_exit_codes.py — 审计脚本退出码规范门禁 | 原型态 / prototype |  |
| 73 | scripts/governance/d11_compliance/validate_frozen_require... | validate_frozen_requirements.py — 依赖版本锁定... | 原型态 / prototype |  |
| 74 | scripts/governance/d11_compliance/validate_manifest_admis... | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 75 | scripts/governance/d11_compliance/validate_no_utf8_bom.py | validate_no_utf8_bom.py — UTF-8 BOM 检测门禁 | 原型态 / prototype |  |
| 76 | scripts/governance/d11_compliance/validate_script_naming.py | validate_script_naming.py — 审计脚本命名规范门禁 | 原型态 / prototype |  |
| 77 | scripts/governance/d11_compliance/validate_script_quality.py | validate_script_quality.py — 治理脚本质量合规检查 | 原型态 / prototype |  |
| 78 | scripts/governance/d11_compliance/validate_task_decomposi... | validate_task_decomposition_bypass.py — Task D... | 原型态 / prototype |  |
| 79 | scripts/governance/d11_compliance/validate_vocabulary_cov... | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 80 | scripts/governance/d11_compliance/verify_audit_integrity.py | verify_audit_integrity.py — MOD-INF-020 · 零... | 原型态 / prototype |  |
| 81 | scripts/governance/d11_compliance/verify_schema_health.py | verify_schema_health.py — depgraph (PostgreSQL... | 原型态 / prototype |  |
| 82 | scripts/governance/d12_ai_hallucination/check_logger_kwar... | ===============================================... | 原型态 / prototype |  |
| 83 | scripts/governance/d12_ai_hallucination/validate_gate_pro... | validate_gate_prompt_conflict.py — Gate-Prompt... | 原型态 / prototype |  |
| 84 | scripts/governance/d12_ai_hallucination/validate_session_... | validate_session_budget.py — Session 操作预算... | 原型态 / prototype |  |
| 85 | scripts/governance/d12_ai_hallucination/validate_session_... | validate_session_gate_check.py — Session 门禁... | 原型态 / prototype |  |
| 86 | scripts/governance/d1_structure/archive_drafts_zone.py | 草稿区生命周期归档器——扫描 arbitrated 草稿，... | 生产态 / production |  |
| 87 | scripts/governance/d1_structure/audit_config_format.py | audit_config_format.py — config/ 目录格式/注释... | 原型态 / prototype |  |
| 88 | scripts/governance/d1_structure/audit_directory_integrity.py | audit_directory_integrity.py — 01_policies_and... | 原型态 / prototype |  |
| 89 | scripts/governance/d1_structure/audit_directory_scalabili... | audit_directory_scalability.py -- 物理结构可扩... | 原型态 / prototype |  |
| 90 | scripts/governance/d1_structure/audit_findings_by_scope.py | audit_findings_by_scope.py — 按目录范围筛选 Fi... | 原型态 / prototype |  |
| 91 | scripts/governance/d1_structure/batch_create_index_md.py | Batch create index.md for all directories under... | 原型态 / prototype |  |
| 92 | scripts/governance/d1_structure/cbg_reset.py | CBG 熔断器重置 CLI (CircuitBreakerGateway Reset... | 原型态 / prototype |  |
| 93 | scripts/governance/d1_structure/check_directory_contract.py | GATE-DIRECTORY-CONTRACT: Directory Contract val... | 原型态 / prototype |  |
| 94 | scripts/governance/d1_structure/check_handoff_manifests.py | check_handoff_manifests.py — AI Session Handof... | 原型态 / prototype |  |
| 95 | scripts/governance/d1_structure/check_index_integrity.py | check_index_integrity.py — 索引完整性校验 | 原型态 / prototype |  |
| 96 | scripts/governance/d1_structure/cleanup_stash.py | cleanup_stash.py — git stash 堆积治理（OPS-202... | 原型态 / prototype |  |
| 97 | scripts/governance/d1_structure/detect_orphan_py.py | detect_orphan_py.py — 项目根目录孤儿 .py 文件检测 | 原型态 / prototype |  |
| 98 | scripts/governance/d1_structure/detect_residual_files.py | detect_residual_files.py — 残留物检测 | 原型态 / prototype |  |
| 99 | scripts/governance/d1_structure/detect_temp_files.py | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 100 | scripts/governance/d1_structure/drafts_zone_archiver.py | 草稿区生命周期归档器 (Drafts Zone Lifecycle Arc... | 原型态 / prototype |  |
| 101 | scripts/governance/d1_structure/generate_missing_index_md.py | generate_missing_index_md.py — 扫描目录树，为... | 原型态 / prototype |  |
| 102 | scripts/governance/d1_structure/reset_cbg.py | CBG 熔断器重置 CLI (CircuitBreakerGateway Reset... | 原型态 / prototype |  |
| 103 | scripts/governance/d1_structure/run_script_smoke_test.py | run_script_smoke_test.py — 治理脚本冒烟测试运行器 | 原型态 / prototype |  |
| 104 | scripts/governance/d1_structure/sync_index_from_manifest.py | sync_index_from_manifest.py — 从 script_manife... | 原型态 / prototype |  |
| 105 | scripts/governance/d1_structure/sync_policies_index.py | sync_policies_index.py — 从磁盘实际扫描，自动... | 原型态 / prototype |  |
| 106 | scripts/governance/d1_structure/validate_config_integrity.py | validate_config_integrity.py — 运行时配置完整... | 原型态 / prototype |  |
| 107 | scripts/governance/d1_structure/validate_d1_output_sanity.py | validate_d1_output_sanity.py — D1 产出物合理性... | 原型态 / prototype |  |
| 108 | scripts/governance/d1_structure/validate_immutable_core.py | validate_immutable_core.py — immutable_core 文... | 原型态 / prototype |  |
| 109 | scripts/governance/d1_structure/validate_index_reality.py | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 110 | scripts/governance/d1_structure/validate_read_before_writ... | validate_read_before_write.py — 先读后写校验（... | 原型态 / prototype |  |
| 111 | scripts/governance/d2_links/audit_broken_links.py | 检测文档/数据文件中的断链与幽灵引用。 | 原型态 / prototype |  |
| 112 | scripts/governance/d2_links/detect_relative_references.py | detect_relative_references.py — 相对路径引用检测 | 原型态 / prototype |  |
| 113 | scripts/governance/d3_metadata/auto_generate_index.py | GATE-INDEX: Validate and auto-fix index.md fact... | 原型态 / prototype |  |
| 114 | scripts/governance/d3_metadata/backfill_doctype_metadata.py | 批量回填 frontmatter doc_type 字段（doc_type 存... | 原型态 / prototype |  |
| 115 | scripts/governance/d3_metadata/backfill_ttl_metadata.py | 批量回填/重判 ttl 字段（6 格式统一入口，GATE-15... | 原型态 / prototype |  |
| 116 | scripts/governance/d3_metadata/check_blueprint_compliance.py | [INVARIANTS] REQUIRED_SECTIONS 必须与蓝图+施工... | 原型态 / prototype |  |
...
| 118 | scripts/governance/d3_metadata/check_module_singlesource.py | GATE-SSOT-SINGLESOURCE: SSoT 单一真源门禁（Phas... | 原型态 / prototype |  |
| 119 | scripts/governance/d3_metadata/check_naming_convention.py | GATE-11 命名规范门禁 — 全类型命名检测。 | 原型态 / prototype |  |
| 120 | scripts/governance/d3_metadata/check_registry_consistency.py | check_registry_consistency — 跨登记表一致性校验。 | 原型态 / prototype |  |
| 121 | scripts/governance/d3_metadata/check_schema_version_write... | G_TRAE_059 验证脚本：_schema_version 写入保护 +... | 原型态 / prototype |  |
| 122 | scripts/governance/d3_metadata/check_vocab_hardcode.py | GATE-VOCAB: 词表合法值硬编码检测（trae_060 §2） | 原型态 / prototype |  |
| 123 | scripts/governance/d3_metadata/classify_ttl_by_content.py | 基于内容关键词的 ttl 精细分类审查脚本。 | 原型态 / prototype |  |
| 124 | scripts/governance/d3_metadata/deep_content_scanner.py | deep_content_scanner.py — 深度内容扫描器 | 原型态 / prototype |  |
| 125 | scripts/governance/d3_metadata/generate_derived_files.py | generate_derived_files.py — 枚举自动派生生成器... | 原型态 / prototype |  |
| 126 | scripts/governance/d3_metadata/generate_rule_catalog.py | Scan docs/01_policies_and_standards and emit _r... | 原型态 / prototype |  |
| 127 | scripts/governance/d3_metadata/migrate_illegal_doctype.py | 批量迁移非法 doc_type 值（doc_type 存量治理 Sta... | 原型态 / prototype |  |
| 128 | scripts/governance/d3_metadata/validate_architecture.py | validate_architecture.py - Validate rule files ... | 原型态 / prototype |  |
| 129 | scripts/governance/d3_metadata/validate_blueprint_provena... | Blueprint Provenance Gate - V-12: validate prov... | 原型态 / prototype |  |
| 130 | scripts/governance/d3_metadata/validate_module_id.py | GATE-MODULEID: Validate module_id uniqueness an... | 原型态 / prototype |  |
| 131 | scripts/governance/d3_metadata/validate_module_id_naming.py | module_id / domain_id / submodule_id 格式校验真... | 原型态 / prototype |  |
| 132 | scripts/governance/d3_metadata/validate_registry_master_i... | 登记表总索引自校验门禁 (Registry Master Index S... | 原型态 / prototype |  |
| 133 | scripts/governance/d3_metadata/validate_tool_contracts_co... | Tool Contract 一致性校验脚本（MOD-INF-013 §9 R... | 原型态 / prototype |  |
| 134 | scripts/governance/d4_paths/detect_deprecated_path_writes.py | detect_deprecated_path_writes.py — 废弃路径写... | 原型态 / prototype |  |
| 135 | scripts/governance/d4_paths/detect_excessive_file_moves.py | detect_excessive_file_moves.py — 文件过度搬迁检测 | 原型态 / prototype |  |
| 136 | scripts/governance/d4_paths/detect_ruins_references.py | detect_ruins_references.py — 残骸/废弃路径引用检测 | 原型态 / prototype |  |
| 137 | scripts/governance/d4_paths/detect_split_delete_ref_commi... | detect_split_delete_ref_commit.py — 删除引用分... | 原型态 / prototype |  |
| 138 | scripts/governance/d5_architecture/analyze_change_impact.py | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 139 | scripts/governance/d5_architecture/analyzers/analyze_cont... | analyze_contract_impact.py — 契约变更影响分析器 | 原型态 / prototype |  |
| 140 | scripts/governance/d5_architecture/analyzers/audit_depend... | audit_depends_on_chain_depth.py — depends_on ... | 原型态 / prototype |  |
| 141 | scripts/governance/d5_architecture/analyzers/measure_depr... | measure_deprecation_cascade.py — 废弃级联影响度量 | 原型态 / prototype |  |
| 142 | scripts/governance/d5_architecture/audit_agent_spec.py | [INVARIANTS] agent-spec 审计完整性 | 原型态 / prototype |  |
| 143 | scripts/governance/d5_architecture/check_budget_health.py | [INVARIANTS] 预算健康检查不可跳过;检查结果必须... | 原型态 / prototype |  |
| 144 | scripts/governance/d5_architecture/check_drift_e2e.py | CI Entry: Drift Detector E2E Pipeline Check | 原型态 / prototype |  |
| 145 | scripts/governance/d5_architecture/checkers/check_archite... | v2.4.0 — 2026-05-03 | 原型态 / prototype |  |
| 146 | scripts/governance/d5_architecture/checkers/check_bluepri... | [INVARIANTS] 蓝图§5.5自动化触发机制状态列必须... | 原型态 / prototype |  |
| 147 | scripts/governance/d5_architecture/checkers/check_bluepri... | [INVARIANTS] 代码[BLUEPRINT]头部module_id必须与... | 原型态 / prototype |  |
| 148 | scripts/governance/d5_architecture/checkers/check_bluepri... | [INVARIANTS] 蓝图模板合规检查不可绕过;52项检查... | 原型态 / prototype |  |
| 149 | scripts/governance/d5_architecture/checkers/check_code_du... | [INVARIANTS] 扫描 src/zephyr/ 下所有包; 检测跨... | 原型态 / prototype |  |
| 150 | scripts/governance/d5_architecture/checkers/check_contrac... | check_contract_code_drift.py —— 契约-代码双写... | 原型态 / prototype |  |
| 151 | scripts/governance/d5_architecture/checkers/check_contrac... | check_contract_physical_path.py — GATE-CONTRAC... | 原型态 / prototype |  |
| 152 | scripts/governance/d5_architecture/checkers/check_depende... | check_dependency_direction.py — 依赖方向校验（... | 原型态 / prototype |  |
| 153 | scripts/governance/d5_architecture/checkers/check_g6_ctr_... | check_g6_ctr_compliance.py - G6 CTR Contract Co... | 原型态 / prototype |  |
| 154 | scripts/governance/d5_architecture/checkers/check_orphan_... | [INVARIANTS] 扫描蓝图 §11 产出物 consumer_min;... | 原型态 / prototype |  |
| 155 | scripts/governance/d5_architecture/checkers/check_precomm... | check_precommit_id_uniqueness.py — GATE-ID-UNIQ | 原型态 / prototype |  |
| 156 | scripts/governance/d5_architecture/checkers/check_rule_fo... | check_rule_four_way_alignment.py —— 规则四方... | 原型态 / prototype |  |
| 157 | scripts/governance/d5_architecture/checkers/check_ssot_un... | [INVARIANTS] 扫描所有蓝图 ssot_claims 字段; 检... | 原型态 / prototype |  |
| 158 | scripts/governance/d5_architecture/checkers/check_trace_c... | check_trace_context_propagation.py — TraceCont... | 原型态 / prototype |  |
| 159 | scripts/governance/d5_architecture/checkers/check_vms_sso... | GATE-VMS-SSOT: VMS 单一真源门禁——三重检测。 | 原型态 / prototype |  |
| 160 | scripts/governance/d5_architecture/dependency_graph.py | 治理域有向依赖图 — 扫描 governance/ 下所有 imp... | 生产态 / production |  |
| 161 | scripts/governance/d5_architecture/detect_causal_conflict... | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 162 | scripts/governance/d5_architecture/detect_constraint_viol... | G9-Detect: 架构约束违规检测器（对照 depgraph 实... | 原型态 / prototype |  |
| 163 | scripts/governance/d5_architecture/detectors/analyze_same... | analyze_same_name_module_relations.py --- 同名... | 原型态 / prototype |  |
| 164 | scripts/governance/d5_architecture/detectors/detect_depen... | detect_depends_on_cycles.py - depends_on 环检测. | 原型态 / prototype |  |
| 165 | scripts/governance/d5_architecture/detectors/detect_depre... | detect_deprecated_adr_references.py — 废弃 ADR... | 原型态 / prototype |  |
| 166 | scripts/governance/d5_architecture/detectors/detect_dupli... | detect_duplicate_module_names.py --- 同名模块语... | 原型态 / prototype |  |
| 167 | scripts/governance/d5_architecture/diagnose_depgraph.py | # [BLUEPRINT] MOD-INF-005 | scripts/governance/... | 原型态 / prototype |  |
| 168 | scripts/governance/d5_architecture/generators/_common.py | 生成器公共工具（向内收：消除重复）。 | 原型态 / prototype |  |
| 169 | scripts/governance/d5_architecture/generators/align_panor... | G-panorama-align: 四图对齐检测器（ARCH-053 + AR... | 原型态 / prototype |  |
| 170 | scripts/governance/d5_architecture/generators/generate_as... | G13: 从 depgraph (PostgreSQL) 生成资产清单全景图 | 原型态 / prototype |  |
| 171 | scripts/governance/d5_architecture/generators/generate_bl... | G-panorama-gen: 蓝图 §0.6 四图对齐视图生成器（... | 生产态 / production |  |
| 172 | scripts/governance/d5_architecture/generators/generate_co... | Code Wiki 统计数据生成器（半自动维护机制）。 | 原型态 / prototype |  |
| 173 | scripts/governance/d5_architecture/generators/generate_co... | G12: 从 depgraph (PostgreSQL) 生成契约目录全景图 | 原型态 / prototype |  |
| 174 | scripts/governance/d5_architecture/generators/generate_co... | generate_contracts.py -- SSoT to Codegen pipeline | 原型态 / prototype |  |
| 175 | scripts/governance/d5_architecture/generators/generate_da... | G-dataflow: 从 dataflowgraph (PostgreSQL) 生成... | 原型态 / prototype |  |
| 176 | scripts/governance/d5_architecture/generators/generate_de... | G-decision: 从 decisiongraph (PostgreSQL) 生成... | 原型态 / prototype |  |
| 177 | scripts/governance/d5_architecture/generators/generate_pa... | G-panorama-registry: 自动生成全景图清单总表 | 原型态 / prototype |  |
| 178 | scripts/governance/d5_architecture/generators/generate_po... | #183: 从 data_sources_registry.yaml 派生 polici... | 原型态 / prototype |  |
| 179 | scripts/governance/d5_architecture/panorama_common.py | panorama_common.py — 四图投票共享工具（ARCH-05... | 原型态 / prototype |  |
| 180 | scripts/governance/d5_architecture/pre_delete_safety_chec... | 安全删除门禁脚本——RULE-THREE 强制执行器。 | 原型态 / prototype |  |
| 181 | scripts/governance/d5_architecture/pre_write_gate.py | AI写入前强制门禁钩子: lock协议检查+GateEngine P... | 原型态 / prototype |  |
| 182 | scripts/governance/d5_architecture/syncers/archive_ration... | 对标 HDEBT-01：rationale-log.md 体积 >150KB / ... | 原型态 / prototype |  |
| 183 | scripts/governance/d5_architecture/syncers/blueprint_fron... | blueprint_frontmatter_reconciler.py — 蓝图 fro... | 生产态 / production |  |
| 184 | scripts/governance/d5_architecture/syncers/merge_readme_t... | Strategy: | 原型态 / prototype |  |
| 185 | scripts/governance/d5_architecture/syncers/sync_blueprint... | 对标：AGENTS.md §6.1 蓝图-代码同步强制约定 | 原型态 / prototype |  |
| 186 | scripts/governance/d5_architecture/syncers/sync_registry_... | sync_registry_from_blueprints.py -- 从 blueprin... | 原型态 / prototype |  |
| 187 | scripts/governance/d5_architecture/validators/blueprint/v... | AGENTS.md §6.1 蓝图-代码同步强制约定的 CI 门禁... | 原型态 / prototype |  |
| 188 | scripts/governance/d5_architecture/validators/blueprint/v... | AGENTS.md 6.4 铁律五 + 铁律六：蓝图中声称的文件... | 原型态 / prototype |  |
| 189 | scripts/governance/d5_architecture/validators/blueprint/v... | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 190 | scripts/governance/d5_architecture/validators/blueprint/v... | 蓝图物理位置与归属链完整性校验器 (Blueprint Pla... | 原型态 / prototype |  |
| 191 | scripts/governance/d5_architecture/validators/blueprint/v... | GATE-TAG-UNIQUE - Blueprint tag uniqueness vali... | 原型态 / prototype |  |
| 192 | scripts/governance/d5_architecture/validators/lifecycle/v... | validate_lifecycle_refs.py — 生命周期引用约束... | 原型态 / prototype |  |
| 193 | scripts/governance/d5_architecture/validators/lifecycle/v... | validate_module_lifecycle.py — 模块生命周期校验 | 原型态 / prototype |  |
| 194 | scripts/governance/d5_architecture/validators/session/val... | Module docstring — see module-level docstring ... | 原型态 / prototype |  |
| 195 | scripts/governance/d5_architecture/validators/session/val... | validate_session_log_updated.py — Session Log ... | 原型态 / prototype |  |
| 196 | scripts/governance/d5_architecture/validators/validate_ad... | validate_adr_frontmatter_consistency.py — ADR ... | 原型态 / prototype |  |
| 197 | scripts/governance/d5_architecture/validators/validate_ar... | validate_arch_review_gate.py — 架构评审门控校验 | 原型态 / prototype |  |
| 198 | scripts/governance/d5_architecture/validators/validate_ar... | GATE-CONTRACT: CI gate for architecture_contrac... | 原型态 / prototype |  |
| 199 | scripts/governance/d5_architecture/validators/validate_au... | validate_autonomy_gate.py — 变更级别 vs AI 自... | 原型态 / prototype |  |
| 200 | scripts/governance/d5_architecture/validators/validate_b_... | validate_b_track_packages.py — B 轨包完整性校验 | 原型态 / prototype |  |
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_archive_governance_migrate_arch_f_functions_py["(原型态 / prototype) 阶段1迁移脚本：创建37个F功能设计态节点 + 56条依...<br/>文件: migrate_arch_f_functions.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_governance_sync_check_p0_status_py["(原型态 / prototype) Module docstring — see module-level docstring ...<br/>文件: check_p0_status.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        scripts_governance_audit_return_contract_usage_py["(原型态 / prototype) audit_return_contract_usage.py — 返回契约 ok ...<br/>文件: audit_return_contract_usage.py"]
        scripts_governance_audit_worktree_ops_telemetry_py["(原型态 / prototype) audit_worktree_ops_telemetry.py — 主工作区文件...<br/>文件: audit_worktree_ops_telemetry.py"]
        scripts_governance_check_commit_message_py["(原型态 / prototype) check_commit_message.py — GitHub Actions PR co...<br/>文件: check_commit_message.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_governance_d1_structure_detect_temp_files_py["(原型态 / prototype) Module docstring — see module-level docstring ...<br/>文件: detect_temp_files.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_governance_d5_architecture_analyze_change_impact_py["(原型态 / prototype) Module docstring — see module-level docstring ...<br/>文件: analyze_change_impact.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_governance_d5_architecture_detect_causal_conflicts_py["(原型态 / prototype) Module docstring — see module-level docstring ...<br/>文件: detect_causal_conflicts.py"]
        ...
        scripts_governance_d5_architecture_generators_common_py["(原型态 / prototype) 生成器公共工具（向内收：消除重复）。<br/>文件: _common.py"]
        ...
        scripts_governance_d5_architecture_generators_generate_code_wiki_stats_py["(原型态 / prototype) Code Wiki 统计数据生成器（半自动维护机制）。<br/>文件: generate_code_wiki_stats.py"]
        ...
        scripts_governance_d5_architecture_generators_generate_dataflow_diagram_py["(原型态 / prototype) G-dataflow: 从 dataflowgraph (PostgreSQL) 生成...<br/>文件: generate_dataflow_diagram.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_governance_d7_code_any_type_inferrer_py["(原型态 / prototype) 裸 Any 类型推断辅助工具 —...<br/>文件: any_type_inferrer.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        scripts_governance_d7_code_check_any_abuse_py["(原型态 / prototype) 类型注解 Any 滥用扫描器 — 5.145 维度防御门闸（...<br/>文件: check_any_abuse.py"]
        ...
        scripts_governance_d7_code_check_merge_conflict_py["(原型态 / prototype) check_merge_conflict.py — 合并冲突标记检测（lo...<br/>文件: check_merge_conflict.py"]
        scripts_governance_d7_code_check_no_tests_unit_py["(原型态 / prototype) check_no_tests_unit.py — 禁止 tests/unit/ 旧路...<br/>文件: check_no_tests_unit.py"]
        ...
        scripts_governance_d7_code_detect_private_key_py["(原型态 / prototype) detect_private_key.py — 私钥意外提交检测（loca...<br/>文件: detect_private_key.py"]
        ...
        scripts_governance_d7_code_scan_consumers_accuracy_py["(原型态 / prototype) scan_consumers_accuracy.py — CONSUMERS 字段准...<br/>文件: scan_consumers_accuracy.py"]
        scripts_governance_d7_code_scan_debt_py["(原型态 / prototype) 架构债务扫描器 — 5.96 维度防御门闸（R67 引入）。<br/>文件: scan_debt.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_governance_meta_concurrency_py["(原型态 / prototype) Module docstring — see module-level docstring ...<br/>文件: _concurrency.py"]
        ...
        scripts_governance_meta_governance_watchdog_py["(原型态 / prototype) Module docstring — see module-level docstring ...<br/>文件: governance_watchdog.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        scripts_governance_run_silent_failure_regression_py["(原型态 / prototype) run_silent_failure_regression.py — silent-fail...<br/>文件: run_silent_failure_regression.py"]
...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS 脚本治理"]
        ...
        tests_governance_scripts_governance_test_any_type_inferrer_py["(原型态 / prototype) test_any_type_inferrer.py — any_type_inferrer....<br/>文件: test_any_type_inferrer.py"]

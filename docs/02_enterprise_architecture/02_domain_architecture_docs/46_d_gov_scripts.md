...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_RULE,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_DATA,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_GOV_AUDIT,D_SECURITY external_prod
    class D_SHARED external_design
```

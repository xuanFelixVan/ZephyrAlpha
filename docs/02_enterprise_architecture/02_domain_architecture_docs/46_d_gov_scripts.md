...
graph TD
    ...
    class D_FBL_DETECTORS,D_SECURITY,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_RULE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE external_prod
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_CODE_QUALITY external_design
```

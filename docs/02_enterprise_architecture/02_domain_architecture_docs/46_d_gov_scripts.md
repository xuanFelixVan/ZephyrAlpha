...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_GOV_REPAIR,D_SHARED,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_GOV_REPAIR,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_DATA,D_SECURITY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_FBL_DETECTORS,D_INFRA_RUNTIME external_prod
```
...
| 112 | Module docstring — see module-level docstring ... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |

...
graph TD
    ...
    class D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_REPAIR,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_REPAIR,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_RULE,D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME external_prod
```

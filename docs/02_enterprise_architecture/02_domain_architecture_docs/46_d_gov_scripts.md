...
graph TD
    ...
    class D_GOV_REPAIR,D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_REPAIR,D_INFRA_RUNTIME,D_SHARED external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SHARED,D_GOV_RULE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE external_prod
```

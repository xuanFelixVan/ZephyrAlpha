...
graph TD
    ...
    class D_DATA,D_SHARED,D_GOVERNANCE,D_SECURITY external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 345 个，26 条域内依赖）。
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_REPAIR,D_DATA,D_INFRA_RUNTIME external_prod
```

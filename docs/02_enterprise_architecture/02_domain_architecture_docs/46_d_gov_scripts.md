...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_REPAIR,D_SHARED,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_SHARED external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_RULE,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOVERNANCE,D_ORCHESTRATOR external_prod
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_REPAIR,D_SHARED,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_SHARED,D_ORCHESTRATOR,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY external_prod
```

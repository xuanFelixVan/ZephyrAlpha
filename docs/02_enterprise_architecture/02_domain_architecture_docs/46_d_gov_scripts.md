...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_SHARED external_prod
...
graph TD
    ...
    class D_GOV_REPAIR,D_GOVERNANCE,D_GOV_RULE,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOV_REPAIR,D_AUTONOMY_CORE external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_DATA,D_SHARED,D_SECURITY external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_RULE,D_SHARED,D_SECURITY,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
```

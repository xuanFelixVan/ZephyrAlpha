...
graph TD
    ...
    class D_GOV_REPAIR,D_GOV_AUDIT,D_GOVERNANCE,D_SHARED,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_REPAIR,D_ORCHESTRATOR,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_REPAIR,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_GOV_DRIFT,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOVERNANCE,D_ORCHESTRATOR,D_SECURITY external_prod
```

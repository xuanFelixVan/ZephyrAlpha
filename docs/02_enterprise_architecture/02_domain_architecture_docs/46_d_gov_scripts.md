...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_RULE,D_GOVERNANCE,D_SHARED,D_ORCHESTRATOR,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_DRIFT external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 437 个，149 条域内依赖）。

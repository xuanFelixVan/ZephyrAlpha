...
graph TD
    ...
    D_GOVERNANCE -.->|config_depends / config_depends| scripts_archive_governance_dm106_p2b_verification_py
...
graph TD
    ...
    class D_GOV_RULE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SECURITY,D_FBL_DETECTORS,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_SHARED,D_GOV_RULE external_prod
```
...
| 5 | G-inventory: 扫描 ClickHouse 生成业务数据清单 M... | → | D_DATA: ClickHouse 写入器（MOD-L00-004 §3.2 数据流第6.... | 导入依赖 / import_depends |
...
|:--:|---------|:--:|---------|---------|
| 1 | D_GOVERNANCE 生命周期管理: 全量比对 governance/behavioral_auditor/ 和 secu... | → | DM-106: P2-B 迁移全量验证脚本 (dm106_p2b_verifi... | config_depends / config_depends |
| 2 | D_GOVERNANCE 生命周期管理: __init__.py | → | v1.0.0 -- 2026-05-03 (validate_yaml_summaries.py) | config_depends / config_depends |

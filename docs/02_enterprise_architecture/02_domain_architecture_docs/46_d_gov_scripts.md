...
graph TD
    ...
    class D_FBL_VERIFICATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_SECURITY,D_FBL_DETECTORS,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_SHARED,D_GOV_RULE external_prod
```

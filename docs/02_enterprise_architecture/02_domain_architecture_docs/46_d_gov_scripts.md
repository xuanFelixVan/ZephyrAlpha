...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_DATA external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_REPAIR,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_FBL_DETECTORS,D_SHARED,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_GOV_RULE,D_INFRA_RECOVERY external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 439 个，150 条域内依赖）。
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_GOV_RULE external_design
```

...
graph TD
    ...
    class D_GOV_REPAIR,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_DATA external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_REPAIR,D_FBL_VERIFICATION external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_RULE,D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod

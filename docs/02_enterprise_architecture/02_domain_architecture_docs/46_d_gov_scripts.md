...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_DATA,D_GOV_AUDIT,D_ORCHESTRATOR external_prod
    class D_SHARED external_design
```

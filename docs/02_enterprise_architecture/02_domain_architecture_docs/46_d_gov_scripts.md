...
graph TD
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_SHARED,D_GOV_AUDIT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_RULE,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_REPAIR,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_REPAIR external_prod
    class D_DATA,D_GOV_CODE_QUALITY,D_GOV_RULE external_design
```

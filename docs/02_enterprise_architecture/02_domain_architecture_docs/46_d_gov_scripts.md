...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_SHARED,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_REPAIR,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_REPAIR,D_SHARED,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_SHARED external_prod
```

...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_SHARED,D_DATA external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 347 个，19 条域内依赖）。
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_SECURITY external_prod
    class D_DATA external_design
```

...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_REPAIR,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_FBL_DETECTORS,D_SECURITY,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_RULE external_prod
```

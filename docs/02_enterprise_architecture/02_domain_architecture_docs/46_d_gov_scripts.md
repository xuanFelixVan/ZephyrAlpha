...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_DATA,D_SECURITY external_prod
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 346 个，19 条域内依赖）。
...
graph TD
    ...
    class D_GOV_REPAIR,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod

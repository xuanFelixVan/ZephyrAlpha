...
graph TD
    ...
    class D_GOV_REPAIR,D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_ORCHESTRATOR,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_RULE external_design
```

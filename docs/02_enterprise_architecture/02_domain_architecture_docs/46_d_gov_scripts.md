...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_GOV_REPAIR external_prod
```
...
> 本域与 20 个外部域直接连接（出边 395 条 + 入边 9 条 = 404 条）。只显示直接连接的域，不展开具体节点。

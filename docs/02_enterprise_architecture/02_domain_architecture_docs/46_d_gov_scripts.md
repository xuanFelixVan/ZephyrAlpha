...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_ORCHESTRATOR,D_GOVERNANCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_DATA,D_GOVERNANCE,D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_REPAIR,D_DATA,D_GOV_OPS_RESILIENCE,D_GOV_RULE external_prod
    class D_GOVERNANCE,D_GOV_AUDIT external_design
```

...
graph TD
    ...
    class D_GOV_REPAIR,D_GOV_RULE,D_GOVERNANCE,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    D_GOVERNANCE -.->|config_depends / config_depends| scripts_governance_d5_architecture_validators_lifecycle_validate_module_lifecycle_py
...
| 81 | AGENTS.md 6.4 铁律五 + 铁律六：construction_pro... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
| 82 | Module docstring — see module-level docstring ... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
| 83 | 蓝图物理位置与归属链完整性校验器 (Blueprint Pla... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
| 84 | GATE-TAG-UNIQUE - Blueprint tag uniqueness vali... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
| 85 | validate_lifecycle_refs.py — 生命周期引用约束.... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
...
| 111 | validate_md_yaml_number_drift.py — MD 视图与 Y... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
| 112 | validate_yaml_interface_uniqueness.py — YAML .... | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
| 113 | v1.0.0 -- 2026-05-03 (validate_yaml_summaries.py) | → | D_GOVERNANCE 生命周期管理: __init__.py | config_depends / config_depends |
...
|:--:|---------|:--:|---------|---------|
| 1 | D_GOVERNANCE 生命周期管理: __init__.py | → | AGENTS.md §6.1 蓝图-代码同步强制约定的 CI 门禁... | config_depends / config_depends |
| 2 | D_GOVERNANCE 生命周期管理: __init__.py | → | validate_module_lifecycle.py — 模块生命周期校... | config_depends / config_depends |

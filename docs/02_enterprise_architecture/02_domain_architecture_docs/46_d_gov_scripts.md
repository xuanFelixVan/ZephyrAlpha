...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_REPAIR,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_REPAIR,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_RULE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SECURITY,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_RULE external_prod
```
...
graph TD
    ...
    tests_trae_rules_test_g_trae_025_py -.->|测试依赖 / test_depends| D_GOV_RULE
    tests_trae_rules_test_g_trae_025_py -.->|测试依赖 / test_depends| D_GOV_RULE
    ...
    tests_trae_rules_test_g_trae_028_py -.->|测试依赖 / test_depends| D_GOV_RULE
    tests_trae_rules_test_g_trae_028_py -.->|测试依赖 / test_depends| D_GOV_RULE
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
...
| 7 | tick_data 表真重复检查工具（RULE-DATA-OPS 配套.... | → | D_DATA: ClickHouse 写入器（MOD-L00-004 §3.2 数据流第6.... | 导入依赖 / import_depends |

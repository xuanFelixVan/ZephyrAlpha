...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_SHARED,D_DATA external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_ORCHESTRATOR,D_GOV_RULE external_prod
    class D_SHARED external_design
```

...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_REPAIR,D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOV_DRIFT,D_GOV_RULE,D_SHARED external_prod
```

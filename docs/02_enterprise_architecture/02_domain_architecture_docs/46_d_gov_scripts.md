...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_REPAIR,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT external_prod
    class D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_FEEDBACK_LOOP,D_INFRA_RECOVERY external_prod
```

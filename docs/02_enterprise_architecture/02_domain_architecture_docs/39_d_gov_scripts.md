...
| 原型态模块 | 395 | Prototype Modules | 395 |
...
graph TD
    ...
    scripts_governance_meta_benchmark_test_fixtures_incomplete_module_py -.->|config_depends| scripts_governance_meta_benchmark_test_fixtures_orphan_file_without_module_registration_py
...
> 按 architecture_layer 分层显示 脚本治理（D_GOV_SCRIPTS）的模块分布。共 427 个模块 / 427 modules。

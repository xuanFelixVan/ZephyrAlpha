...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
...
graph TD
    ...
    scripts_governance_repair_red_blue_test_py -.->|config_depends| scripts_governance_repair_audit_design_completeness_py
    scripts_governance_repair_rollback_depgraph_py -.->|config_depends| scripts_governance_repair_audit_design_completeness_py
...
> 按 architecture_layer 分层显示 脚本治理（D_GOV_SCRIPTS）的模块分布。共 424 个模块 / 424 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (424 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 424 个模块 / 424 modules）。

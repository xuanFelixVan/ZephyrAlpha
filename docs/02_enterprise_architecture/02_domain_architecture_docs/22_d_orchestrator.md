...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_GOV_OPS_RESILIENCE external_prod
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_SECURITY_LLM,D_INFRASTRUCTURE,D_GOV_AUDIT,D_TRADING,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RECOVERY,D_SECURITY_LLM,D_TRADING,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_KNOWLEDGE,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```

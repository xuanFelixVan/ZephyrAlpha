...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_TRADING,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    src_zephyr_orchestrator_quality_init_py -.->|config_depends / config_depends| src_zephyr_orchestrator_quality_blueprint_scorer_py
    ...
    class D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_TRADING,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_SCRIPTS,D_TRADING,D_INFRASTRUCTURE,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_design
```

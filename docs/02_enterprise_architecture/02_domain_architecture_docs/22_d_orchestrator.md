...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_SECURITY_LLM,D_TRADING,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_RISK external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_SECURITY_LLM,D_TRADING external_design
```

...
graph TD
    ...
    class D_SECURITY,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_TRADING,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_RISK,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRASTRUCTURE,D_TRADING,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_RISK,D_AUTONOMY_CORE external_design
```

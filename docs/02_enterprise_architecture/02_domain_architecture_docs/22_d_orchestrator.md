...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_TRADING,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_TRADING,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_TRADING,D_AUTONOMY_CORE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_TRADING,D_INFRA_RECOVERY,D_KNOWLEDGE,D_GOV_ENFORCEMENT external_design
```

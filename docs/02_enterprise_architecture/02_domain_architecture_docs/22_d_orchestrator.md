...
graph TD
    ...
    class D_SECURITY,D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    D_TRADING -.->|测试依赖 / test_depends| src_zephyr_orchestrator_lifecycle_system_transfer_py
    ...
    class D_RISK,D_AUTONOMY_CORE,D_TRADING,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
    class D_INFRASTRUCTURE,D_RISK,D_AUTONOMY_CORE,D_TRADING external_design
```

...
graph TD
    ...
    class D_TRADING,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_DRIFT,D_TRADING,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_INFRA_RECOVERY external_design
```

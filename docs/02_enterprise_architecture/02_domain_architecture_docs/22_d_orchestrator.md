...
graph TD
    ...
    class D_GOV_SCRIPTS,D_TRADING,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_DRIFT,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_TRADING,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_design
```

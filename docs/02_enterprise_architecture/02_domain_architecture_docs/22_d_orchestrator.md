...
graph TD
    ...
    class D_TRADING,D_KNOWLEDGE,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INFRA_RUNTIME external_prod
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 23 个，3 条域内依赖）。

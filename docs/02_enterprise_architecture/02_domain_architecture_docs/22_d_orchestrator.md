...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_TRADING,D_GOV_SCRIPTS,D_FEEDBACK_LOOP external_design
```

...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_INFRA_RUNTIME external_prod
    class D_AUTONOMY_CORE,D_SHARED,D_SECURITY_LLM,D_GOV_SCRIPTS,D_TRADING,D_GOV_AUDIT,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_TRADING,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_RISK external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SECURITY external_prod
    class D_SHARED,D_SECURITY_LLM,D_GOV_SCRIPTS,D_TRADING,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_design
```

...
graph TD
    ...
    class D_INFRA_RECOVERY,D_TRADING,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INFRA_RECOVERY,D_TRADING,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_SECURITY_LLM,D_INFRASTRUCTURE,D_TRADING,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_TRADING,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RECOVERY,D_KNOWLEDGE,D_TRADING,D_SECURITY_LLM,D_INFRASTRUCTURE external_design
```

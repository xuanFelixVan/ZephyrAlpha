...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_GOV_SCRIPTS,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_INTEGRATION,D_GOVERNANCE external_prod
    class D_INFRA_RUNTIME,D_TRADING,D_FEEDBACK_LOOP external_design
```

...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_TRADING,D_GOV_SCRIPTS,D_SECURITY_LLM,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_TRADING,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_TRADING,D_GOV_SCRIPTS external_design
```

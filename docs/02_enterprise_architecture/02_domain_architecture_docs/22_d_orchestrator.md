...
graph TD
    ...
    src_zephyr_orchestrator_contracts_init_py -.->|config_depends / config_depends| src_zephyr_orchestrator_contracts_design_decisions_py
    ...
    class D_FEEDBACK_LOOP,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING,D_GOV_SCRIPTS external_design
```

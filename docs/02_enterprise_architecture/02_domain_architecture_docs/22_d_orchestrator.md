...
graph TD
    ...
    D_SECURITY_LLM -.->|测试依赖 / test_depends| src_zephyr_orchestrator_agent_orchestrator_py
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_FEEDBACK_LOOP,D_TRADING,D_GOV_AUDIT,D_INTELLIGENCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    D_TRADING -.->|测试依赖 / test_depends| src_zephyr_orchestrator_governance_version_manifest_py
    ...
    class D_TRADING,D_INFRA_RECOVERY,D_RISK,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_TRADING,D_GOV_SCRIPTS,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_SECURITY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRASTRUCTURE,D_TRADING,D_INFRA_RECOVERY,D_KNOWLEDGE,D_GOV_AUDIT,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_TRADING,D_FEEDBACK_LOOP external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_TRADING,D_RISK,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RECOVERY,D_TRADING,D_GOV_SCRIPTS,D_RISK,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_design
```

...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_TRADING,D_INFRASTRUCTURE,D_SECURITY_LLM,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_TRADING,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE external_design
```

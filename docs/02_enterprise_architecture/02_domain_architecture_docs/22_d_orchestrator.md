...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
    class D_AUTONOMY_CORE,D_GOV_DRIFT,D_GOV_SCRIPTS,D_TRADING,D_FEEDBACK_LOOP external_design
```

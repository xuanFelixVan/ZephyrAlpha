...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOV_DRIFT,D_TRADING,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RECOVERY,D_RISK external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRASTRUCTURE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_TRADING,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_RISK external_design
```

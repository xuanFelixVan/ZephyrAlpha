...
graph TD
    ...
    class D_OPS,D_GOV_AUDIT,D_INFRA_A2A,D_GOVERNANCE,D_SECURITY,D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_SHARED,D_INFRA_RECOVERY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_OPS,D_GOV_KB,D_GOV_AUDIT,D_GOV_RULE,D_INTEGRATION,D_INFRA_A2A,D_SECURITY,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
    class D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```

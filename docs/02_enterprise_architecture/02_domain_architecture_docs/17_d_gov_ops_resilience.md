...
graph TD
    ...
    class D_OPS,D_SHARED,D_INTEGRATION,D_SECURITY,D_GOV_KB,D_GOV_RULE,D_GOVERNANCE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_OPS,D_SECURITY,D_GOVERNANCE,D_SHARED,D_INFRA_A2A,D_GOV_AUDIT,D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_GOVERNANCE,D_SECURITY,D_OPS,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_OPS,D_SECURITY,D_INTEGRATION,D_SHARED,D_GOV_RULE,D_INFRA_A2A,D_GOV_AUDIT,D_ORCHESTRATOR,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RECOVERY external_design
```

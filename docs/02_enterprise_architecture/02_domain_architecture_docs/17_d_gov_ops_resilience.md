...
graph TD
    ...
    class D_INTELLIGENCE,D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_A2A,D_SHARED,D_ORCHESTRATOR,D_SECURITY,D_OPS,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOV_RULE,D_GOV_AUDIT,D_INTEGRATION,D_GOVERNANCE,D_INFRA_A2A,D_ORCHESTRATOR,D_OPS,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RECOVERY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_INFRA_A2A,D_GOVERNANCE,D_FACTOR,D_INTEGRATION external_prod

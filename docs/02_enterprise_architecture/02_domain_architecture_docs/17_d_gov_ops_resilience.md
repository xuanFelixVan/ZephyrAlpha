...
graph TD
    ...
    class D_GOVERNANCE,D_OPS,D_GOV_AUDIT,D_INFRA_A2A,D_SECURITY,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_GOVERNANCE,D_SECURITY,D_SHARED,D_OPS,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_OPS,D_GOV_KB,D_SECURITY,D_GOV_RULE,D_GOV_AUDIT,D_ORCHESTRATOR,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_FACTOR,D_INFRA_A2A external_prod

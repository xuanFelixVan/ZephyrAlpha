...
graph TD
    ...
    class D_GOVERNANCE,D_OPS,D_SHARED,D_GOV_AUDIT,D_INFRA_A2A,D_ORCHESTRATOR,D_SECURITY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_OPS,D_INTEGRATION,D_SHARED,D_GOV_AUDIT,D_GOV_KB,D_GOV_RULE,D_INFRA_A2A,D_SECURITY,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_SCRIPTS external_design
```

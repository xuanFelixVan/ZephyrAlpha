...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_SECURITY,D_GOV_KB,D_GOV_RULE,D_OPS,D_GOVERNANCE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_OPS,D_INFRA_A2A,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_GOV_AUDIT,D_GOVERNANCE,D_SECURITY,D_SHARED,D_OPS external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_OPS,D_INTEGRATION,D_INFRA_A2A,D_SHARED,D_GOV_KB,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOVERNANCE external_prod
    class D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOV_SCRIPTS external_design
```

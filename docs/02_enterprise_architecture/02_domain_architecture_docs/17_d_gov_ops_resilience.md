...
graph TD
    ...
    class D_INTELLIGENCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_A2A,D_ORCHESTRATOR,D_OPS,D_GOV_RULE,D_GOVERNANCE,D_SECURITY,D_INFRA_RUNTIME external_prod

...
graph TD
    ...
    class D_OPS,D_GOV_AUDIT,D_INFRA_A2A,D_SHARED,D_SECURITY,D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOV_RULE,D_OPS,D_GOV_AUDIT,D_INFRA_A2A,D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod

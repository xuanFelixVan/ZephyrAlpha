...
graph TD
    ...
    class D_SECURITY,D_GOV_AUDIT,D_SHARED,D_OPS,D_GOVERNANCE,D_INFRA_A2A,D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SECURITY,D_OPS,D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_AUDIT,D_GOV_KB,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod

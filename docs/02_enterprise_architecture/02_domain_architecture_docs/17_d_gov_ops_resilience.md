...
graph TD
    ...
    src_zephyr_governance_resilience_governance_init_py -.->|config_depends / config_depends| src_zephyr_governance_resilience_governance_decision_fatigue_py
    D_SHARED["(生产态 / production) D_SHARED"]
    ...
    class D_SHARED,D_GOV_AUDIT,D_OPS,D_GOVERNANCE,D_INFRA_A2A,D_ORCHESTRATOR,D_SECURITY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_SECURITY,D_GOVERNANCE,D_OPS,D_GOV_AUDIT external_prod
    class D_SHARED,D_GOV_ENFORCEMENT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_KB,D_SHARED,D_OPS,D_GOV_RULE,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
    class D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_SECURITY external_design
```

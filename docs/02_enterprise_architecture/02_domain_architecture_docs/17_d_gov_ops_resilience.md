...
graph TD
    ...
    class D_GOVERNANCE,D_OPS,D_SHARED,D_GOV_AUDIT,D_INFRA_A2A,D_SECURITY,D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod

...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_A2A,D_GOV_AUDIT,D_OPS,D_ORCHESTRATOR,D_SECURITY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_GOV_KB,D_SHARED,D_INFRA_A2A,D_OPS,D_GOV_RULE,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod
    class D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_SECURITY external_design
```

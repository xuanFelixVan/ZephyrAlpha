...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_FACTOR,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_GOV_KB,D_GOV_SCRIPTS external_design
```

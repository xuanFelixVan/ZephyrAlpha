...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_SECURITY,D_GOV_RULE,D_GOVERNANCE,D_OPS,D_GOV_REPAIR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_ORCHESTRATOR,D_GOVERNANCE,D_OPS,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_INTELLIGENCE,D_SHARED,D_GOV_SCRIPTS,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_OPS,D_GOV_RULE,D_GOV_AUDIT,D_ORCHESTRATOR,D_SECURITY,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOVERNANCE,D_INFRA_RECOVERY external_design
```

...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_FACTOR,D_SECURITY,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_ORCHESTRATOR,D_GOV_AUDIT,D_OPS,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_INFRA_A2A,D_FACTOR,D_INTEGRATION external_prod

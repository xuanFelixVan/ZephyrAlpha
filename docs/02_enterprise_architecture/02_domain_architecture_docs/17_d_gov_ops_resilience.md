...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_A2A,D_ORCHESTRATOR,D_OPS,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_INTELLIGENCE,D_GOV_SCRIPTS,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_SHARED,D_OPS,D_GOV_AUDIT,D_INFRA_A2A,D_GOV_RULE,D_ORCHESTRATOR,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_GOV_SCRIPTS,D_SECURITY,D_INFRA_RECOVERY external_design
```

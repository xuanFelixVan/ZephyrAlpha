...
graph TD
    ...
    class D_OPS,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_A2A,D_SECURITY,D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_OPS,D_GOV_KB,D_SECURITY,D_GOV_RULE,D_GOV_AUDIT,D_INFRA_A2A,D_GOV_REPAIR,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOVERNANCE external_prod

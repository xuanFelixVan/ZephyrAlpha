...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_RULE,D_GOV_KB,D_GOVERNANCE,D_OPS,D_FEEDBACK_LOOP,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_A2A,D_GOVERNANCE,D_OPS,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT external_prod
    class D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_SECURITY_LLM,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_KB,D_GOV_RULE,D_GOVERNANCE,D_OPS,D_GOV_AUDIT external_prod
```

...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY,D_SHARED,D_ORCHESTRATOR,D_OPS,D_GOVERNANCE,D_INFRA_A2A,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    src_zephyr_governance_security_governance_init_py -.->|config_depends / config_depends| src_zephyr_governance_security_governance_config_scanner_py
    D_INFRA_A2A["(生产态 / production) D_INFRA_A2A"]
    ...
    class D_INFRA_A2A,D_SHARED,D_GOVERNANCE,D_SECURITY,D_OPS,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOV_RULE,D_GOV_AUDIT,D_INTEGRATION,D_OPS,D_GOVERNANCE,D_ORCHESTRATOR,D_INFRA_RUNTIME external_prod

...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_RULE,D_GOV_KB,D_OPS,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_A2A,D_OPS,D_ORCHESTRATOR,D_GOV_REPAIR external_prod
    class D_INFRA_RECOVERY,D_AUTONOMY_PERM external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_AUDIT external_prod
    class D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_COMPLIANCE,D_SECURITY_LLM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_INFRA_A2A,D_OPS,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_KB,D_GOV_RULE,D_GOV_REPAIR,D_ORCHESTRATOR external_prod
    class D_SHARED,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```

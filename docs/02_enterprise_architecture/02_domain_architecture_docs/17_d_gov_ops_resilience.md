...
graph TD
    ...
    class D_GOV_AUDIT,D_ORCHESTRATOR,D_OPS,D_GOVERNANCE,D_INFRA_A2A,D_SHARED,D_SECURITY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT,D_OPS external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_GOV_KB,D_ORCHESTRATOR,D_GOV_RULE,D_OPS,D_INFRA_A2A,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_SECURITY,D_INFRA_RECOVERY external_design
```

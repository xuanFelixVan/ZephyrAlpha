...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_GOVERNANCE external_prod
...
| 13 | Re-export wrapper: financial_compliance has mig... | → | D_GOV_AUDIT 审计追踪: financial_compliance.py | 导入依赖 / import_depends |

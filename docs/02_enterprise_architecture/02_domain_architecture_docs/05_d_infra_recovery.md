...
flowchart TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_DRIFT,D_OPS,D_GOV_RULE external_prod
```
...
flowchart TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INTEGRATION,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_OPS,D_GOV_RULE external_prod
```

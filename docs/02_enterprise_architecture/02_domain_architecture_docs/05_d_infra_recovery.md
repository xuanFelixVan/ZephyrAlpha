...
flowchart TD
    ...
    src_zephyr_infrastructure_rollback_warm_standby_py["WarmStandby — 温备热切（git worktree 副本维护）<br/>基础设施/rollback包的warm_standby模块<br/>文件: rollback/warm_standby.py<br/>(生产态 / production)"]

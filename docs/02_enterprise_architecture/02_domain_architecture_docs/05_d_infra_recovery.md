...
flowchart TD
    ...
    class D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_OPS external_prod
```

...
flowchart TD
    ...
    src_zephyr_infrastructure_rollback_sqlite_dumper_py["SqliteDumper — SQLite 双轨 Checkpoint 的 DB<br/>sqlite_dumper<br/>文件: rollback/sqlite_dumper.py<br/>(生产态 / production)"]
    ...
    class D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_INTEGRATION,D_OPS external_prod
```

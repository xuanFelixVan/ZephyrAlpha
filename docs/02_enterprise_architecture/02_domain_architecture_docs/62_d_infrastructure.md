...
graph TD
    ...
    class D_SHARED,D_PF_ALLOC,D_EX_CORE,D_SIMULATION external_prod
    class D_GOVERNANCE,D_REPORTING,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_SECURITY,D_ORCHESTRATOR,D_TRADING,D_FUNDAMENTAL_SIGNAL external_prod
    class D_RISK,D_PF_ALLOC,D_SIGLEGACY external_design
```
...
graph TD
    ...
    class D_SHARED,D_FUNDAMENTAL_SIGNAL external_prod
    class D_PF_ALLOC,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_SHARED,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOVERNANCE,D_PF_ALLOC,D_TRADING,D_EX_CORE external_prod

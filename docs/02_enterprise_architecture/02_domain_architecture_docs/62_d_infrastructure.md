...
graph TD
    ...
    class D_SHARED,D_TRADING,D_EX_CORE,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_AUTONOMY_CORE,D_SECURITY,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_TRADING,D_EX_CORE,D_PF_ALLOC external_prod

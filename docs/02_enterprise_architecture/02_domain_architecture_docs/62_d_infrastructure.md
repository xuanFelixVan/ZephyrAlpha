...
graph TD
    ...
    class D_GOVERNANCE,D_MKT_DATA,D_REPORTING,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_SECURITY,D_ORCHESTRATOR,D_TRADING,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod
    class D_PF_ALLOC,D_SIGLEGACY external_design
```
...
graph TD
    ...
    class D_SHARED,D_FUNDAMENTAL_SIGNAL,D_SIMULATION external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_TRADING external_prod
    class D_SHARED,D_GOVERNANCE,D_REPORTING external_design
```

...
graph TD
    ...
    class D_REPORTING external_prod
    class D_SHARED,D_GOV_REPAIR,D_RISK,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_TRADING,D_INTEGRATION,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_SIMULATION,D_RISK external_prod
...
graph TD
    ...
    class D_REPORTING,D_PF_ALLOC external_prod

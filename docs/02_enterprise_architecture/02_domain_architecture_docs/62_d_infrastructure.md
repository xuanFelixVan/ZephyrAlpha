...
graph TD
    ...
    class D_SHARED,D_PF_ALLOC,D_EX_CORE external_prod
    class D_GOVERNANCE,D_REPORTING,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_PF_ALLOC,D_TRADING,D_RISK,D_REPORTING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SECURITY,D_PF_ALLOC,D_EX_CORE,D_INTEGRATION external_prod
    class D_GOVERNANCE,D_REPORTING,D_GOV_REPAIR external_design
```
...
| 50 | shared.contracts.experiment — auto-generated p... | → | D_SHARED 共享服务: experiment_result.py | config_depends / config_depends |

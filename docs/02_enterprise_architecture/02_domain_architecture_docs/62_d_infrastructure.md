...
graph TD
    ...
    class D_GOV_REPAIR,D_REPORTING,D_TRADING,D_GOVERNANCE,D_RISK external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_SECURITY,D_GOVERNANCE,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SIMULATION,D_RISK external_prod
    class D_GOVERNANCE,D_TRADING,D_REPORTING,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_DRIFT,D_FBL_DETECTORS,D_EX_CORE,D_REPORTING,D_TRADING,D_INTEGRATION external_prod
    class D_SHARED,D_GOV_REPAIR,D_GOVERNANCE,D_MKT_DATA,D_GOV_ENFORCEMENT external_design
```

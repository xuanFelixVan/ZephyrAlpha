...
graph TD
    ...
    class D_GOV_AUDIT,D_EX_CORE,D_TRADING,D_RISK,D_PF_ALLOC external_prod
    class D_SHARED,D_GOVERNANCE,D_REPORTING,D_MKT_DATA external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_MKT_DATA,D_TRADING,D_PF_ALLOC external_design
```

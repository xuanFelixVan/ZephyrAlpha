...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_RISK,D_FUNDAMENTAL_SIGNAL,D_EX_CORE,D_SIMULATION external_prod
    class D_SIGQC,D_PF_ALLOC,D_REPORTING,D_TRADING,D_GOVERNANCE,D_MKT_DATA external_design
```
...
graph TD
    ...
    class D_SIGQC,D_PF_ALLOC,D_TRADING,D_GOVERNANCE,D_MKT_DATA external_design
```

...
graph TD
    ...
    class D_SHARED,D_MKT_DATA,D_ML_TRAIN,D_TRADING,D_PF_ALLOC external_design
```
...
graph TD
    ...
    class D_MKT_DATA,D_GOVERNANCE,D_TRADING,D_GOV_ENFORCEMENT,D_ML_TRAIN,D_REPORTING external_design
```

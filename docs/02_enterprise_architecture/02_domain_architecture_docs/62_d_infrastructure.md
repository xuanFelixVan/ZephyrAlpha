...
graph TD
    ...
    class D_SHARED,D_SIMULATION,D_PF_ALLOC external_prod
    class D_TRADING,D_REPORTING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SECURITY,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL external_prod
    class D_TRADING,D_RISK,D_PF_ALLOC,D_SIGLEGACY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_FBL_DETECTORS,D_GOV_AUDIT,D_SECURITY,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_PF_ALLOC,D_EX_CORE external_prod

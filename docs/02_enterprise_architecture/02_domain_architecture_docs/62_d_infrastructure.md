...
graph TD
    ...
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_performance_attribution_report_py
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_capital_allocation_result_py
    ...
    class D_SHARED,D_EX_CORE external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_EX_CORE,D_REPORTING,D_RISK,D_SIMULATION,D_INFRA_RUNTIME external_prod
    class D_GOVERNANCE,D_GOV_REPAIR,D_PF_ALLOC,D_TRADING external_design
```
...
graph TD
    ...
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_execution_report_py
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_fill_py
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_model_serving_request_py
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_order_py
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_position_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5

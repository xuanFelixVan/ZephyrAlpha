...
graph TD
    ...
    class D_SHARED,D_SIMULATION,D_EX_CORE,D_TRADING,D_PF_ALLOC,D_RISK external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_SIMULATION,D_RISK,D_INFRA_RUNTIME,D_EX_CORE external_prod
    class D_PF_ALLOC,D_TRADING,D_REPORTING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_SECURITY,D_EX_CORE,D_PF_ALLOC external_prod
    class D_SHARED,D_GOVERNANCE,D_REPORTING,D_GOV_REPAIR external_design
```

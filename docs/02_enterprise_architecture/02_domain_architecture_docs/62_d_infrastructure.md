...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_PF_ALLOC,D_EX_CORE,D_RISK,D_SIMULATION external_prod
    class D_REPORTING,D_GOVERNANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_SIGQC external_design
```

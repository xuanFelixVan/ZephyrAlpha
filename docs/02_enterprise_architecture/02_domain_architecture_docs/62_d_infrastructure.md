...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_EX_CORE,D_PF_ALLOC,D_RISK external_prod
    class D_TRADING,D_REPORTING,D_MKT_DATA,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_TRADING,D_MKT_DATA,D_GOVERNANCE,D_PF_ALLOC external_design
```

...
graph TD
    ...
    class D_SHARED,D_PF_ALLOC,D_REPORTING,D_SIMULATION,D_EX_CORE external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY,D_TRADING,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class D_SIGQC,D_SIGLEGACY,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_PF_ALLOC,D_REPORTING,D_TRADING,D_EX_CORE external_prod

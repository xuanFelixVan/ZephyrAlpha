...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_EX_CORE,D_RISK external_prod
    class D_GOV_DOCS,D_INTEGRATION,D_GOVERNANCE,D_TRADING,D_PF_ALLOC,D_REPORTING,D_MKT_DATA external_design
```

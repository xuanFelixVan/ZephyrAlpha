...
graph TD
    ...
    class D_REPORTING,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_SECURITY,D_GOVERNANCE,D_TRADING,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_SHARED,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_TRADING,D_PF_ALLOC,D_EX_CORE external_prod

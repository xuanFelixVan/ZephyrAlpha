...
graph TD
    ...
    class D_SHARED,D_REPORTING,D_EX_CORE,D_SIMULATION external_prod
    class D_MKT_DATA,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_SECURITY,D_TRADING,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOVERNANCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_REPORTING,D_EX_CORE,D_TRADING,D_PF_ALLOC external_prod

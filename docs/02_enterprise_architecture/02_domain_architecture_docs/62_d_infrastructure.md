...
graph TD
    ...
    class D_TRADING,D_SIMULATION external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_SECURITY,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SIMULATION,D_REPORTING,D_RISK external_prod
    class D_GOVERNANCE,D_TRADING,D_GOV_REPAIR external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_EX_CORE external_prod
    class D_SHARED,D_REPORTING,D_GOVERNANCE,D_GOV_REPAIR external_design
```

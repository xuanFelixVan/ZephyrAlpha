...
graph TD
    ...
    class D_TRADING,D_EX_CORE external_prod
    class D_SHARED,D_GOV_REPAIR,D_REPORTING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_VERIFICATION,D_EX_CORE,D_INTEGRATION,D_ORCHESTRATOR external_prod
    class D_SHARED,D_REPORTING,D_GOV_REPAIR,D_MKT_DATA external_design
```

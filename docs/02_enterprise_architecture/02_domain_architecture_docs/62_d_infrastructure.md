...
graph TD
    ...
    class D_SHARED,D_EX_CORE,D_REPORTING external_prod
    class D_GOV_REPAIR,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOVERNANCE,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_REPORTING,D_SIMULATION,D_EX_CORE external_prod
    class D_TRADING,D_GOVERNANCE,D_GOV_REPAIR,D_RISK external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SHARED,D_EX_CORE,D_TRADING,D_REPORTING,D_INTEGRATION,D_PF_ALLOC external_prod

...
graph TD
    ...
    class D_REPORTING,D_GOVERNANCE,D_MKT_DATA,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SECURITY,D_GOVERNANCE,D_ORCHESTRATOR,D_TRADING,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_TRADING,D_EX_CORE,D_PF_ALLOC external_prod

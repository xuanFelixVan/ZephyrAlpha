...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_SECURITY,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION,D_EX_CORE external_prod
...
graph TD
    ...
    class D_SHARED,D_RISK,D_EX_CORE,D_TRADING,D_INFRA_RUNTIME,D_SIMULATION external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_TRADING,D_EX_CORE,D_PF_ALLOC external_prod

...
graph TD
    ...
    class D_SHARED,D_EX_CORE,D_TRADING,D_PF_ALLOC external_prod
    class D_GOV_ENFORCEMENT,D_REPORTING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_SHARED external_prod
```

...
graph TD
    ...
    class D_SIMULATION,D_TRADING external_prod
    class D_SHARED,D_REPORTING,D_GOV_REPAIR,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_SECURITY,D_TRADING,D_INTEGRATION,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SIMULATION,D_RISK,D_EX_CORE,D_TRADING external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_EX_CORE external_prod

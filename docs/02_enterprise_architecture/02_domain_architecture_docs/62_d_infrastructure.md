...
graph TD
    ...
    class D_REPORTING,D_MKT_DATA,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY,D_TRADING,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOVERNANCE,D_ORCHESTRATOR,D_EX_CORE,D_TRADING,D_PF_ALLOC external_prod
    class D_SHARED,D_REPORTING external_design
```

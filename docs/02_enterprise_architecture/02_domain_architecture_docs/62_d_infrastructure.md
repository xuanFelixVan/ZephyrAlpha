...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_TRADING,D_EX_CORE external_prod
    class D_GOV_DOCS,D_INTEGRATION,D_REPORTING,D_MKT_DATA,D_GOVERNANCE,D_PF_ALLOC external_design
```

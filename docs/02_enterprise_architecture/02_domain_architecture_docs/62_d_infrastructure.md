...
graph TD
    ...
    class D_SHARED,D_REPORTING,D_SIMULATION external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_SECURITY,D_ORCHESTRATOR,D_REPORTING,D_PF_ALLOC,D_EX_CORE,D_TRADING external_prod

...
graph TD
    ...
    class D_SHARED,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_SECURITY,D_FUNDAMENTAL_SIGNAL external_prod
    class D_TRADING,D_PF_ALLOC,D_RISK,D_SIGLEGACY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_SHARED,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_PF_ALLOC,D_TRADING external_prod

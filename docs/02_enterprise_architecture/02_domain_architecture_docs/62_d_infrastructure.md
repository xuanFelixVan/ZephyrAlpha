...
| 层级 |  | Layer |  |
| 模块数 | 61 | Module Count | 61 |
| 域内依赖 | 10 | Internal Dependencies | 10 |
| 跨域入边 | 63 | Cross-domain Incoming | 63 |
| 跨域出边 | 77 | Cross-domain Outgoing | 77 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 52 | Prototype Modules | 52 |
...
> 按 architecture_layer 分组的模块清单（共 61 个模块 / 61 modules）。
...
> 展示全部 61 个模块（生产态 9 + 设计态 0 + 原型态 52），标签标注成熟度。
...
graph TD
    ...
    D_SHARED -.->|config_depends / config_depends| src_zephyr_shared_contracts_init_py
    ...
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_execution_report_py
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_fill_py
    ...
    class src_zephyr_infrastructure_config_init_py,src_zephyr_shared_contracts_experiment_result_py,src_zephyr_shared_contracts_factor_monitor_report_py,src_zephyr_shared_contracts_macro_factor_signal_py,src_zephyr_shared_contracts_model_serving_response_py,src_zephyr_shared_contracts_performance_attribution_report_py,src_zephyr_shared_contracts_risk_limits_py production
    class src_zephyr_infrastructure_config_app_config_py,src_zephyr_shared_contracts_init_py,src_zephyr_shared_contracts_backpressure_init_py,src_zephyr_shared_contracts_capital_allocation_result_py,src_zephyr_shared_contracts_compliance_rule_py,src_zephyr_shared_contracts_core_init_py,src_zephyr_shared_contracts_errors_init_py,src_zephyr_shared_contracts_escalation_init_py,src_zephyr_shared_contracts_execution_init_py,src_zephyr_shared_contracts_execution_report_py,src_zephyr_shared_contracts_experiment_init_py,src_zephyr_shared_contracts_external_init_py,src_zephyr_shared_contracts_factor_signal_py,src_zephyr_shared_contracts_fill_py,src_zephyr_shared_contracts_identity_init_py,src_zephyr_shared_contracts_market_init_py,src_zephyr_shared_contracts_market_data_py,src_zephyr_shared_contracts_model_serving_request_py,src_zephyr_shared_contracts_order_py,src_zephyr_shared_contracts_portfolio_init_py,src_zephyr_shared_contracts_position_py,src_zephyr_shared_contracts_risk_init_py,src_zephyr_shared_contracts_risk_dashboard_snapshot_py design
    class D_SHARED,D_EX_CORE,D_SIMULATION external_prod
    class D_GOVERNANCE,D_GOV_REPAIR,D_RISK,D_REPORTING external_design
```
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_shared_contracts_strategy_lifecycle_event_py,src_zephyr_shared_contracts_telemetry_emitter_py production
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_contracts_test_rbac_guard_root_py design
    class D_SHARED,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_EX_CORE,D_SIMULATION,D_INFRA_RUNTIME external_prod
    class D_PF_ALLOC,D_RISK,D_REPORTING,D_TRADING,D_GOVERNANCE external_design
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 52 个，7 条域内依赖）。
...
graph TD
    ...
    src_zephyr_shared_contracts_init_py -.->|导入依赖 / import_depends| src_zephyr_shared_contracts_identity_init_py
    D_INFRA_RUNTIME["(生产态 / production) D_INFRA_RUNTIME"]
    tests_contracts_test_contract_tester_py -.->|测试依赖 / test_depends| D_INFRA_RUNTIME
    D_ORCHESTRATOR["(生产态 / production) D_ORCHESTRATOR"]
    tests_contracts_test_contract_router_root_py -.->|测试依赖 / test_depends| D_ORCHESTRATOR
    ...
    src_zephyr_shared_contracts_errors_init_py -.->|导入依赖 / import_depends| D_SHARED
    src_zephyr_shared_contracts_escalation_init_py -.->|导入依赖 / import_depends| D_SHARED
    ...
    class D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SHARED,D_SECURITY,D_EX_CORE,D_TRADING external_prod
    class D_GOVERNANCE,D_GOV_REPAIR external_design
```
...
| 12 | test_config_scanner.py | → | D_GOV_OPS_RESILIENCE 运维弹性治理: Config Scanner — v0.9.0 AI配置文件注入扫描器: ... | 测试依赖 / test_depends |
| 13 | test_config_validator.py | → | D_INFRA_RUNTIME 运行时集成: M-12 ConfigValidator — 配置参数校验器 (config_... | 测试依赖 / test_depends |
| 14 | test_contract_tester.py | → | D_INFRA_RUNTIME 运行时集成: M-11 ContractTester — 契约测试框架 (contract_t... | 测试依赖 / test_depends |
| 15 | test_ct_pipe_routing_root.py | → | D_INFRA_RUNTIME 运行时集成: CT-PIPE-ORC-001 — TaskCard -> 管线入口节点路由... | 测试依赖 / test_depends |
| 16 | test_ct_pipe_routing_root.py | → | D_INFRA_RUNTIME 运行时集成: Pipeline 数据模型 (models.py) | 测试依赖 / test_depends |
| 17 | test_contract_registry_root.py | → | D_ORCHESTRATOR 代理编排器: 集成契约注册表（Contract Registry） (contract_r... | 测试依赖 / test_depends |
| 18 | test_contract_router_root.py | → | D_ORCHESTRATOR 代理编排器: 集成契约注册表（Contract Registry） (contract_r... | 测试依赖 / test_depends |
| 19 | test_contract_router_root.py | → | D_ORCHESTRATOR 代理编排器: 契约路由（Contract Router） (contract_router.py) | 测试依赖 / test_depends |
| 20 | test_abac_guard_root.py | → | D_SECURITY 对抗验证: ABACGuard — 基于属性的权限守卫. (abac_guard.py) | 测试依赖 / test_depends |
| 21 | test_contract_verifier.py | → | D_SECURITY 对抗验证: ContractVerifier — 契约验证器. (contract_verif... | 测试依赖 / test_depends |
| 22 | test_rbac_guard_root.py | → | D_SECURITY 对抗验证: RBACGuard — 基于角色的权限守卫. (rbac_guard.py) | 测试依赖 / test_depends |
| 23 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: ZephyrAlpha — shared/contracts/enforcer.py (en... | 导入依赖 / import_depends |
| 24 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: shared/contracts/factories.py — 跨层数据契约工... | 导入依赖 / import_depends |
| 25 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: ZephyrAlpha — shared/contracts/registry.py (re... | 导入依赖 / import_depends |
| 26 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: ZephyrAlpha — shared/contracts/runtime_plane_t... | 导入依赖 / import_depends |
| 27 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: system_configuration.py | 导入依赖 / import_depends |
| 28 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: ZephyrAlpha — shared/contracts/timestamp.py (t... | 导入依赖 / import_depends |
| 29 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 30 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: experiment_result.py | 导入依赖 / import_depends |
| 31 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: model_serving_response.py | 导入依赖 / import_depends |
| 32 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: LLMGatewayProtocol — LLM 网关抽象接口 (llm_gat... | 导入依赖 / import_depends |
| 33 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: orchestration_protocol.py | 导入依赖 / import_depends |
| 34 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: money.py | 导入依赖 / import_depends |
| 35 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: Re-export shim — 真源已收敛至 zephyr.shared.co... | 导入依赖 / import_depends |
| 36 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: skill_protocol.py | 导入依赖 / import_depends |
| 37 | ZephyrAlpha — shared/contracts/ (__init__.py) | → | D_SHARED 共享服务: TaskRepositoryProtocol — TaskRepository 的 Pro... | 导入依赖 / import_depends |
| 38 | Auto-generated contracts package — backpressur... | → | D_SHARED 共享服务: pause.py | 导入依赖 / import_depends |
| 39 | Auto-generated contracts package — backpressur... | → | D_SHARED 共享服务: resume.py | 导入依赖 / import_depends |
| 40 | Auto-generated contracts package — backpressur... | → | D_SHARED 共享服务: throttle.py | 导入依赖 / import_depends |
| 41 | shared.contracts.core — auto-generated package... | → | D_SHARED 共享服务: BaseEvent — 跨层事件基类 (base_event.py) | 导入依赖 / import_depends |
| 42 | shared.contracts.core — auto-generated package... | → | D_SHARED 共享服务: gate_types.py | 导入依赖 / import_depends |
| 43 | Auto-generated contracts package — errors (__i... | → | D_SHARED 共享服务: contract_violation_error.py | 导入依赖 / import_depends |
| 44 | Auto-generated contracts package — errors (__i... | → | D_SHARED 共享服务: CTR-ERR-001: DataQualityError / 行情质量门禁不.... | 导入依赖 / import_depends |
| 45 | Auto-generated contracts package — errors (__i... | → | D_SHARED 共享服务: execution_rejection_error.py | 导入依赖 / import_depends |
| 46 | Auto-generated contracts package — errors (__i... | → | D_SHARED 共享服务: CTR-ERR-002: FactorComputationError / 因子计算.... | 导入依赖 / import_depends |
| 47 | Auto-generated contracts package — errors (__i... | → | D_SHARED 共享服务: risk_limit_violation_error.py | 导入依赖 / import_depends |
| 48 | Auto-generated contracts package — errors (__i... | → | D_SHARED 共享服务: signal_degradation_warning.py | 导入依赖 / import_depends |
| 49 | __init__.py | → | D_SHARED 共享服务: budget_alert.py | 导入依赖 / import_depends |
| 50 | shared.contracts.experiment — auto-generated p... | → | D_SHARED 共享服务: model_serving_response.py | config_depends / config_depends |
| 51 | experiment_result.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 52 | factor_signal.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 53 | fill.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 54 | __init__.py | → | D_SHARED 共享服务: agent_identity.py | 导入依赖 / import_depends |
| 55 | __init__.py | → | D_SHARED 共享服务: permission.py | 导入依赖 / import_depends |
| 56 | Backward-compat shim — canonical location is z... | → | D_SHARED 共享服务: Backward-compat shim — canonical location is z... | 导入依赖 / import_depends |
...
| 62 | market_data.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 63 | order.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 64 | order.py | → | D_SHARED 共享服务: OrderSide/OrderStatus/OrderType — 交易枚举真源... | 导入依赖 / import_depends |
| 65 | shared.contracts.portfolio — auto-generated pa... | → | D_SHARED 共享服务: Backward-compat shim — canonical location is z... | 导入依赖 / import_depends |
| 66 | position.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 67 | Backward-compat shim — canonical location is z... | → | D_SHARED 共享服务: Backward-compat shim — canonical location is z... | 导入依赖 / import_depends |
...
| 72 | risk_limits.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 73 | __init__.py | → | D_SHARED 共享服务: security_decision.py | 导入依赖 / import_depends |
| 74 | synthesized_signal.py | → | D_SHARED 共享服务: trace_context.py | 导入依赖 / import_depends |
| 75 | test_abac_guard_root.py | → | D_SHARED 共享服务: agent_identity.py | 测试依赖 / test_depends |
| 76 | test_alerts_bridge.py | → | D_SHARED 共享服务: budget_alert.py | 测试依赖 / test_depends |
| 77 | test_rbac_guard_root.py | → | D_SHARED 共享服务: agent_identity.py | 测试依赖 / test_depends |
...
| 6 | D_GOVERNANCE 生命周期管理: local_layer_daemon.py — L2 本地模型层守护进程.... | → | ZephyrAlpha — 基础设施 Infrastructure Layer —... | 导入依赖 / import_depends |
| 7 | D_GOVERNANCE 生命周期管理: C-track 端到端演示 —— 全流水线一次性运行 (dem... | → | factor_signal.py | 导入依赖 / import_depends |
| 8 | D_GOVERNANCE 生命周期管理: C-track 端到端演示 —— 全流水线一次性运行 (dem... | → | fill.py | 导入依赖 / import_depends |
| 9 | D_GOVERNANCE 生命周期管理: C-track 端到端演示 —— 全流水线一次性运行 (dem... | → | model_serving_request.py | 导入依赖 / import_depends |
| 10 | D_GOVERNANCE 生命周期管理: C-track 端到端演示 —— 全流水线一次性运行 (dem... | → | order.py | 导入依赖 / import_depends |
| 11 | D_GOVERNANCE 生命周期管理: D_EXECUTION_CORE — Risk Validation Bridge (DW-... | → | risk_limits.py | 导入依赖 / import_depends |
| 12 | D_GOVERNANCE 生命周期管理: D_EXECUTION_CORE — Simulation Broker Adapter (... | → | fill.py | 导入依赖 / import_depends |
| 13 | D_GOVERNANCE 生命周期管理: D_EXECUTION_CORE — Simulation Broker Adapter (... | → | order.py | 导入依赖 / import_depends |
| 14 | D_GOVERNANCE 生命周期管理: D_EXECUTION_CORE — Simulation Broker Adapter (... | → | position.py | 导入依赖 / import_depends |
| 15 | D_GOVERNANCE 生命周期管理: D_EXECUTION_CORE — BrokerInterface (broker_int... | → | fill.py | 导入依赖 / import_depends |
| 16 | D_GOVERNANCE 生命周期管理: D_EXECUTION_CORE — BrokerInterface (broker_int... | → | order.py | 导入依赖 / import_depends |
| 17 | D_GOVERNANCE 生命周期管理: D_EXECUTION_CORE — BrokerInterface (broker_int... | → | position.py | 导入依赖 / import_depends |
| 18 | D_GOV_ENFORCEMENT 规则执行: Re-export shim — ComplianceRule 真源已合并至 z... | → | compliance_rule.py | 导入依赖 / import_depends |
| 19 | D_GOV_REPAIR 治理修复: zephyr.trading.trading_contracts — trading-dom... | → | capital_allocation_result.py | 导入依赖 / import_depends |
| 20 | D_GOV_REPAIR 治理修复: zephyr.trading.trading_contracts — trading-dom... | → | execution_report.py | 导入依赖 / import_depends |
| 21 | D_GOV_REPAIR 治理修复: zephyr.trading.trading_contracts — trading-dom... | → | fill.py | 导入依赖 / import_depends |
| 22 | D_GOV_REPAIR 治理修复: zephyr.trading.trading_contracts — trading-dom... | → | model_serving_request.py | 导入依赖 / import_depends |
| 23 | D_GOV_REPAIR 治理修复: zephyr.trading.trading_contracts — trading-dom... | → | order.py | 导入依赖 / import_depends |
| 24 | D_GOV_REPAIR 治理修复: zephyr.trading.trading_contracts — trading-dom... | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 25 | D_GOV_REPAIR 治理修复: zephyr.trading.trading_contracts — trading-dom... | → | position.py | 导入依赖 / import_depends |
| 26 | D_INFRA_RUNTIME 运行时集成: HealthMonitor — 健康监控 + 自愈 (health_monito... | → | telemetry_emitter.py | 导入依赖 / import_depends |
| 27 | D_INTEGRATION 管线路由: PipelineOrchestrator — M1-M11 管线协调器 (pipe... | → | __init__.py | 导入依赖 / import_depends |
| 28 | D_MKT_DATA 行情数据: __init__.py | → | market_data.py | 导入依赖 / import_depends |
| 29 | D_ORCHESTRATOR 代理编排器: AgentOrchestrator · 多角色 Agent 路由、工具链.... | → | __init__.py | 导入依赖 / import_depends |
| 30 | D_PF_ALLOC 组合分配: strategy_lifecycle_event.py | → | strategy_lifecycle_event.py | 导入依赖 / import_depends |
| 31 | D_PF_ALLOC 组合分配: D_PORTFOLIO_CORE — Default Equity Long-Only St... | → | order.py | 导入依赖 / import_depends |
| 32 | D_REPORTING 报告: D_REPORTING Post-Trade Analytics (__init__.py) | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 33 | D_REPORTING 报告: D_REPORTING — Post-Trade Analytics Layer (anal... | → | execution_report.py | 导入依赖 / import_depends |
| 34 | D_REPORTING 报告: D_REPORTING — Post-Trade Analytics Layer (anal... | → | fill.py | 导入依赖 / import_depends |
| 35 | D_REPORTING 报告: D_REPORTING — Post-Trade Analytics Layer (anal... | → | order.py | 导入依赖 / import_depends |
| 36 | D_REPORTING 报告: D_REPORTING — Post-Trade Analytics Layer (anal... | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 37 | D_REPORTING 报告: D_REPORTING — Default Attribution Engine (defa... | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 38 | D_REPORTING 报告: D_REPORTING — Default TCA Engine (default_tca_... | → | execution_report.py | 导入依赖 / import_depends |
| 39 | D_REPORTING 报告: D_REPORTING — Default TCA Engine (default_tca_... | → | fill.py | 导入依赖 / import_depends |
| 40 | D_REPORTING 报告: D_REPORTING — Default TCA Engine (default_tca_... | → | order.py | 导入依赖 / import_depends |
| 41 | D_RISK 风控: D_RISK — Risk Limits Calculator (risk_limits.py) | → | risk_limits.py | 导入依赖 / import_depends |
| 42 | D_RISK 风控: ZephyrAlpha — D_RISK Risk Management Layer — ... | → | risk_limits.py | 导入依赖 / import_depends |
| 43 | D_RISK 风控: test_l04_risk_management.py | → | risk_limits.py | 测试依赖 / test_depends |
| 44 | D_SHARED 共享服务: ContractBus — 跨层通信抽象 + Pydantic v2 Schem... | → | ZephyrAlpha — shared/contracts/ (__init__.py) | config_depends / config_depends |
| 45 | D_SHARED 共享服务: ContractTester — 契约测试框架 (contract_tester.py) | → | ZephyrAlpha — shared/contracts/ (__init__.py) | config_depends / config_depends |
| 46 | D_SHARED 共享服务: Backward-compat shim — canonical location is z... | → | Backward-compat shim — canonical location is z... | config_depends / config_depends |
| 47 | D_SHARED 共享服务: Backward-compat shim — canonical location is z... | → | Backward-compat shim — canonical location is z... | config_depends / config_depends |
| 48 | D_SHARED 共享服务: Backward-compat shim — canonical location is z... | → | Backward-compat shim — canonical location is z... | config_depends / config_depends |
...
| 51 | D_SHARED 共享服务: ext_001.py | → | Auto-generated contracts package — external (_... | config_depends / config_depends |
| 52 | D_SHARED 共享服务: ext_002.py | → | Auto-generated contracts package — external (_... | config_depends / config_depends |
| 53 | D_SHARED 共享服务: ext_003.py | → | Auto-generated contracts package — external (_... | config_depends / config_depends |
| 54 | D_SHARED 共享服务: ext_004.py | → | Auto-generated contracts package — external (_... | config_depends / config_depends |
| 55 | D_SHARED 共享服务: Re-export shim — 真源已收敛至 zephyr.shared.co... | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 56 | D_SIMULATION 仿真: 实验 — Experimentation Pipeline Layer (pipelin... | → | experiment_result.py | 导入依赖 / import_depends |
| 57 | D_TRADING 交易运营: zephyr.trading.trading_contracts — trading-dom... | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 58 | D_TRADING 交易运营: __init__.py | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 59 | D_TRADING 交易运营: Re-export shim — 真源已收敛至 zephyr.shared.co... | → | performance_attribution_report.py | 导入依赖 / import_depends |
| 60 | D_TRADING 交易运营: strategy_lifecycle_event.py | → | strategy_lifecycle_event.py | 导入依赖 / import_depends |
| 61 | D_TRADING 交易运营: risk_limit_violation_error.py | → | trace_context.py | 导入依赖 / import_depends |
| 62 | D_TRADING 交易运营: risk_validator_protocol.py | → | risk_limits.py | 导入依赖 / import_depends |
| 63 | D_TRADING 交易运营: test_l07_post_trade_analytics.py | → | performance_attribution_report.py | 测试依赖 / test_depends |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 22 个外部域直接连接（出边 77 条 + 入边 63 条 = 140 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_GOV_REPAIR,D_TRADING,D_GOVERNANCE,D_RISK external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SECURITY,D_GOVERNANCE,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_EX_CORE,D_REPORTING external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_MKT_DATA external_design
```

...
graph TD
    ...
    class D_SIMULATION,D_EX_CORE external_prod
    class D_SHARED,D_GOV_REPAIR,D_REPORTING,D_GOVERNANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY,D_TRADING,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_VERIFICATION,D_EX_CORE external_prod
    class D_SHARED,D_REPORTING,D_GOV_REPAIR external_design
```

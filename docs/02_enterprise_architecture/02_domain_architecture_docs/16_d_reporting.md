...
|:--:|---------|:--:|---------|---------|
| 1 | D_REPORTING — Post-Trade Analytics Layer (anal... | → | D_TRADING 交易运营: execution_report.py | 导入依赖 / import_depends |
| 2 | D_REPORTING — Post-Trade Analytics Layer (anal... | → | D_TRADING 交易运营: fill.py | 导入依赖 / import_depends |
| 3 | D_REPORTING — Post-Trade Analytics Layer (anal... | → | D_TRADING 交易运营: order.py | 导入依赖 / import_depends |
| 4 | D_REPORTING — Default TCA Engine (default_tca_... | → | D_TRADING 交易运营: execution_report.py | 导入依赖 / import_depends |
| 5 | D_REPORTING — Default TCA Engine (default_tca_... | → | D_TRADING 交易运营: fill.py | 导入依赖 / import_depends |
| 6 | D_REPORTING — Default TCA Engine (default_tca_... | → | D_TRADING 交易运营: order.py | 导入依赖 / import_depends |

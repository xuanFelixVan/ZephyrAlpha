...
| src/zephyr/infrastructure/pipeline/pipeline_orchestrator.py |  | production | draft |
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_OPS,D_INTELLIGENCE external_design
```
...
graph TD
    subgraph D_INFRA_RUNTIME["D-INFRA_RUNTIME 运行时集成"]
        ...
        src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py["src/zephyr/infrastructure/pipeline/pipeline_orc... production"]
    ...
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -->|import_depends| D_SHARED
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -->|import_depends| D_SHARED
    D_GOVERNANCE["D-GOVERNANCE production"]
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -->|import_depends| D_GOVERNANCE
    D_GOV_AUDIT["D-GOV_AUDIT production"]
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -->|import_depends| D_GOV_AUDIT
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -.->|import_depends| D_INTEGRATION
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -->|import_depends| D_GOVERNANCE
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -.->|import_depends| D_SHARED
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -.->|import_depends| D_SHARED
    src_zephyr_infrastructure_pipeline_pipeline_orchestrator_py -.->|import_depends| D_INTEGRATION
...
| D-OPS | 58 | import_depends,test_depends,domain_dependency,data,contract,config_depends,event |

...
flowchart TD
    ...
    src_zephyr_feedback_loop_gates_action_reversibility_py["行为reversibility<br/>反馈环的动作reversibility。Action Reversibility<br/>— v0.15.0 R208，动作reversibility。Action<br/>Reversibility — v0.15.0 R208相关功能的实现。<br/>文件: gates/action_reversibility.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_adversarial_validation_py["对抗验证<br/>红方注入 -> 蓝方 Gate 判定 -> 绕过检测 -><br/>收敛验证 -> 宪法自进化。<br/>文件: gates/adversarial_validation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_blueprint_code_reconciler_py["蓝图代码协调器<br/>反馈环的蓝图代码协调器。Blueprint-Code<br/>Reconciler — v0.14.0<br/>R195，蓝图代码协调器。Blueprint-Code Reconciler<br/>— v0.14.0 R195相关功能的实现。<br/>文件: gates/blueprint_code_reconciler.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_blueprint_validator_py["蓝图校验器<br/>反馈环的蓝图校验器。Blueprint Validator —<br/>v0.8.0 R108，蓝图校验器。Blueprint Validator —<br/>v0.8.0 R108相关功能的实现。<br/>文件: gates/blueprint_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_checkpoint_manager_py["检查点管理器<br/>反馈环的检查点管理器。Checkpoint Manager —<br/>v0.3.0 R18，检查点管理器。Checkpoint Manager —<br/>v0.3.0 R18相关功能的实现。<br/>文件: gates/checkpoint_manager.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_ci_cd_pre_scanner_py["cicdpre扫描器<br/>反馈环的cicd预扫描器。CI/CD Pre-Scanner —<br/>v0.8.0 R107，cicd预扫描器。CI/CD Pre-Scanner —<br/>v0.8.0 R107相关功能的实现。<br/>文件: gates/ci_cd_pre_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_concurrent_change_deconfliction_py["并发变更deconfliction<br/>反馈环的并发变更deconfliction。Concurrent<br/>Change Deconfliction — v0.16.0<br/>R230，并发变更deconfliction。Concurrent Change<br/>Deconfliction — v0.16.0 R230相关功能的实现。<br/>文件: gates/concurrent_change_deconfliction.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_complexity_budget_py["配置complexity预算<br/>反馈环的配置complexity预算。Config Complexity<br/>Budget — v0.16.0<br/>R227，配置complexity预算。Config Complexity<br/>Budget — v0.16.0 R227相关功能的实现。<br/>文件: gates/config_complexity_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_governance_py["配置治理<br/>反馈环的配置治理。Config Governance — v0.3.0<br/>R8，配置治理。Config Governance — v0.3.0<br/>R8相关功能的实现。<br/>文件: gates/config_governance.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_cve_scanner_py["cve扫描器<br/>反馈环的cve扫描器。CVE Scanner — v0.8.0<br/>R106，cve扫描器。CVE Scanner — v0.8.0<br/>R106相关功能的实现。<br/>文件: gates/cve_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_data_quality_gate_py["数据质量门禁<br/>反馈环的数据质量门禁。Data Quality Gate —<br/>v0.11.0 R143，数据质量门禁。Data Quality Gate —<br/>v0.11.0 R143相关功能的实现。<br/>文件: gates/data_quality_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_db_integrity_py["数据库完整性<br/>反馈环的数据库完整性。DB Integrity Gate —<br/>v0.3.0 R17，数据库完整性。DB Integrity Gate —<br/>v0.3.0 R17相关功能的实现。<br/>文件: gates/db_integrity.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_dynamic_llm_cost_router_py["动态llm成本路由器<br/>反馈环的动态llm成本路由器。Dynamic LLM Cost<br/>Router — v0.8.0<br/>R109，动态llm成本路由器。Dynamic LLM Cost<br/>Router — v0.8.0 R109相关功能的实现。<br/>文件: gates/dynamic_llm_cost_router.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_emergency_takeover_py["紧急takeover<br/>反馈环的紧急takeover。Emergency Takeover —<br/>v0.7.0 R88，紧急takeover。Emergency Takeover —<br/>v0.7.0 R88相关功能的实现。<br/>文件: gates/emergency_takeover.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_federated_security_py["federated安全<br/>反馈环的federated安全。Federated Security —<br/>v0.10.0 R131，federated安全。Federated Security<br/>— v0.10.0 R131相关功能的实现。<br/>文件: gates/federated_security.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_license_compliance_py["license合规<br/>反馈环的license合规。License Compliance —<br/>v0.14.0 R198，license合规。License Compliance —<br/>v0.14.0 R198相关功能的实现。<br/>文件: gates/license_compliance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_llm_cost_router_py["llm成本路由器<br/>反馈环的llm成本路由器。LLM Cost Router — v0.3.0<br/>R20，llm成本路由器。LLM Cost Router — v0.3.0<br/>R20相关功能的实现。<br/>文件: gates/llm_cost_router.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_merkle_audit_root_py["merkle审计root<br/>反馈环的merkle审计根。Merkle Audit Root —<br/>v0.8.0 R104，merkle审计根。Merkle Audit Root —<br/>v0.8.0 R104相关功能的实现。<br/>文件: gates/merkle_audit_root.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_meta_performance_gate_py["元绩效门禁<br/>反馈环的元绩效门禁。Meta Performance Gate —<br/>v0.11.0 R158，元绩效门禁。Meta Performance Gate<br/>— v0.11.0 R158相关功能的实现。<br/>文件: gates/meta_performance_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_parameterized_safety_gate_py["parameterized安全门禁<br/>gates包的parameterized_safety_gate模块<br/>GateVerdict — GateVerdict<br/>文件: gates/parameterized_safety_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l28_l29_py["安全门禁l28l29<br/>反馈环的安全门禁l28l29。Safety Gates L28-L29 —<br/>DR Readiness + Supply Chain (MOD-FEEDBACK_LOOP<br/>§3 L28-L41)，安全门禁l28l29。Safety Gates<br/>L28-L29 — DR Readiness + Supply Chain<br/>(MOD-FEEDBACK_LOOP §3 L28-L41)相关功能的实现。<br/>文件: gates/safety_gate_l28_l29.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l36_l37_py["安全门禁l36l37<br/>反馈环的安全门禁l36l37。Safety Gates L36-L37 —<br/>AI Code Integrity + Vibe<br/>Maintainability，安全门禁l36l37。Safety Gates<br/>L36-L37 — AI Code Integrity + Vibe<br/>Maintainability相关功能的实现。<br/>文件: gates/safety_gate_l36_l37.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l38_l39_py["安全门禁l38l39<br/>反馈环的安全门禁l38l39。Safety Gates L38-L39 —<br/>Deterministic Safety + Architectural<br/>Integrity，安全门禁l38l39。Safety Gates L38-L39<br/>— Deterministic Safety + Architectural<br/>Integrity相关功能的实现。<br/>文件: gates/safety_gate_l38_l39.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l40_l41_py["安全门禁l40l41<br/>反馈环的安全门禁l40l41。Safety Gates L40-L41 —<br/>Self-Integrity + Container<br/>Immutability，安全门禁l40l41。Safety Gates<br/>L40-L41 — Self-Integrity + Container<br/>Immutability相关功能的实现。<br/>文件: gates/safety_gate_l40_l41.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l42_l43_py["安全门禁l42l43<br/>反馈环的安全门禁l42l43。Safety Gates L42-L43 —<br/>Causal Integrity +<br/>Survivability，安全门禁l42l43。Safety Gates<br/>L42-L43 — Causal Integrity +<br/>Survivability相关功能的实现。<br/>文件: gates/safety_gate_l42_l43.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l44_l45_py["安全门禁l44l45<br/>反馈环的安全门禁l44l45。Safety Gates L44-L45 —<br/>Operational Excellence + Causal<br/>Interrogability，安全门禁l44l45。Safety Gates<br/>L44-L45 — Operational Excellence + Causal<br/>Interrogability相关功能的实现。<br/>文件: gates/safety_gate_l44_l45.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l46_l47_py["安全门禁l46l47<br/>反馈环的安全门禁l46l47。Safety Gates L46-L47 —<br/>Systemic Emergence + Ontological<br/>Consistency，安全门禁l46l47。Safety Gates<br/>L46-L47 — Systemic Emergence + Ontological<br/>Consistency相关功能的实现。<br/>文件: gates/safety_gate_l46_l47.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l48_l49_py["安全门禁l48l49<br/>反馈环的安全门禁l48l49。Safety Gates L48-L49 —<br/>Supply Chain Integrity + Cognitive<br/>Safety，安全门禁l48l49。Safety Gates L48-L49 —<br/>Supply Chain Integrity + Cognitive<br/>Safety相关功能的实现。<br/>文件: gates/safety_gate_l48_l49.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l50_l51_py["安全门禁l50l51<br/>反馈环的安全门禁l50l51。Safety Gates L50-L55 —<br/>Coherence + Integrity Ladder (double-pair<br/>pattern)，安全门禁l50l51。Safety Gates L50-L55<br/>— Coherence + Integrity Ladder (double-pair<br/>pattern)相关功能的实现。<br/>文件: gates/safety_gate_l50_l51.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l52_l53_py["安全门禁l52l53<br/>反馈环的安全门禁l52l53。Safety Gates L52-L53 —<br/>Boot Integrity + OSS<br/>License，安全门禁l52l53。Safety Gates L52-L53 —<br/>Boot Integrity + OSS License相关功能的实现。<br/>文件: gates/safety_gate_l52_l53.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l54_l55_py["安全门禁l54l55<br/>反馈环的安全门禁l54l55。Safety Gates L54-L55 —<br/>Final Gate + Full<br/>Integration，安全门禁l54l55。Safety Gates<br/>L54-L55 — Final Gate + Full<br/>Integration相关功能的实现。<br/>文件: gates/safety_gate_l54_l55.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l56_l57_py["安全门禁l56l57<br/>反馈环的安全门禁l56l57。Safety Gates L56-L57 —<br/>Evolutionary Integrity + Cross-Generational<br/>Coherence，安全门禁l56l57。Safety Gates L56-L57<br/>— Evolutionary Integrity + Cross-Generational<br/>Coherence相关功能的实现。<br/>文件: gates/safety_gate_l56_l57.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l58_l59_py["安全门禁l58l59<br/>反馈环的安全门禁l58l59。Safety Gates L58-L59 —<br/>Over-the-Horizon + Temporal<br/>Integrity，安全门禁l58l59。Safety Gates L58-L59<br/>— Over-the-Horizon + Temporal<br/>Integrity相关功能的实现。<br/>文件: gates/safety_gate_l58_l59.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l60_l61_py["安全门禁l60l61<br/>反馈环的安全门禁l60l61。Safety Gates L60-L61 —<br/>Environmental Grounding + Meta-System<br/>Integrity，安全门禁l60l61。Safety Gates L60-L61<br/>— Environmental Grounding + Meta-System<br/>Integrity相关功能的实现。<br/>文件: gates/safety_gate_l60_l61.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l62_l63_py["安全门禁l62l63<br/>反馈环的安全门禁l62l63。Safety Gates L62-L63 —<br/>Infrastructure Reality + Market<br/>Reality，安全门禁l62l63。Safety Gates L62-L63 —<br/>Infrastructure Reality + Market<br/>Reality相关功能的实现。<br/>文件: gates/safety_gate_l62_l63.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l64_l65_py["安全门禁l64l65<br/>反馈环的安全门禁l64l65。Safety Gates L64-L65 —<br/>Financial Integrity +<br/>VibeOps:Solo，安全门禁l64l65。Safety Gates<br/>L64-L65 — Financial Integrity +<br/>VibeOps:Solo相关功能的实现。<br/>文件: gates/safety_gate_l64_l65.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l66_l67_py["安全门禁l66l67<br/>同时写入核心 zephyr.gov_audit.writer.AuditWriter<br/>不可变审计链。<br/>文件: gates/safety_gate_l66_l67.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_scope_creep_monitor_py["作用域creep监控器<br/>反馈环的作用域creep监控。Scope Creep Monitor —<br/>v0.15.0 R220，作用域creep监控。Scope Creep<br/>Monitor — v0.15.0 R220相关功能的实现。<br/>文件: gates/scope_creep_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_ab_test_py["ab测试<br/>反馈环的ab测试。A/B Test Verifier — v0.9.0<br/>R117，ab测试。A/B Test Verifier — v0.9.0<br/>R117相关功能的实现。<br/>文件: verifiers/ab_test.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_action_explainability_py["行为explainability<br/>反馈环的动作explainability。Action<br/>Explainability — v0.3.0<br/>R15，动作explainability。Action Explainability<br/>— v0.3.0 R15相关功能的实现。<br/>文件: verifiers/action_explainability.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_auto_rollback_py["自动回滚<br/>反馈环的自动回滚。Auto Rollback — v0.8.0<br/>R93，自动回滚。Auto Rollback — v0.8.0<br/>R93相关功能的实现。<br/>文件: verifiers/auto_rollback.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_build_reproducibility_verifier_py["buildreproducibility验证器<br/>反馈环的构建reproducibility验证器。Build<br/>Reproducibility Verifier — v0.38.0<br/>R484，构建reproducibility验证器。Build<br/>Reproducibility Verifier — v0.38.0<br/>R484相关功能的实现。<br/>文件: verifiers<br/>/build_reproducibility_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_cascading_rollback_analyzer_py["级联回滚分析器<br/>反馈环的cascading回滚分析器。Cascading Rollback<br/>Analyzer — v0.38.0<br/>R482，cascading回滚分析器。Cascading Rollback<br/>Analyzer — v0.38.0 R482相关功能的实现。<br/>文件: verifiers/cascading_rollback_analyzer.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_blueprint_contract_drift_py["跨蓝图契约漂移<br/>反馈环的跨蓝图契约漂移。Cross-Blueprint<br/>Contract Drift Monitor — v0.39.0<br/>R490，跨蓝图契约漂移。Cross-Blueprint Contract<br/>Drift Monitor — v0.39.0 R490相关功能的实现。<br/>文件: verifiers<br/>/cross_blueprint_contract_drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_module_integration_py["跨模块集成<br/>反馈环的跨模块集成。Cross-Module Integration<br/>Verifier — v0.5.0 R39，跨模块集成。Cross-Module<br/>Integration Verifier — v0.5.0<br/>R39相关功能的实现。<br/>文件: verifiers/cross_module_integration.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_dry_run_sandbox_py["dry运行沙箱<br/>反馈环的dry运行sandbox。Dry Run Sandbox —<br/>v0.3.0 R19，dry运行sandbox。Dry Run Sandbox —<br/>v0.3.0 R19相关功能的实现。<br/>文件: verifiers/dry_run_sandbox.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_federated_protocol_py["federated协议<br/>反馈环的federated协议。Federated Protocol —<br/>v0.10.0 R129，federated协议。Federated Protocol<br/>— v0.10.0 R129相关功能的实现。<br/>文件: verifiers/federated_protocol.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_golden_test_external_py["golden测试external<br/>反馈环的golden测试外部。Golden Test External —<br/>v0.15.0 R214，golden测试外部。Golden Test<br/>External — v0.15.0 R214相关功能的实现。<br/>文件: verifiers/golden_test_external.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_no_llm_degradation_py["noLLM退化<br/>反馈环的nollm退化。No-LLM Degradation Mode —<br/>v0.8.0 R94，nollm退化。No-LLM Degradation Mode<br/>— v0.8.0 R94相关功能的实现。<br/>文件: verifiers/no_llm_degradation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_pre_flight_simulator_py["preflight模拟器<br/>反馈环模块，实现preflight模拟器功能。<br/>Pre-Flight Simulator — v0.12.0 R169b<br/>文件: verifiers/pre_flight_simulator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_rollback_integrity_py["回滚完整性<br/>反馈环的回滚完整性。Rollback Integrity — v0.3.0<br/>R18b，回滚完整性。Rollback Integrity — v0.3.0<br/>R18b相关功能的实现。<br/>文件: verifiers/rollback_integrity.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_stochastic_diagnosis_verifier_py["stochastic诊断验证器<br/>反馈环的stochastic诊断验证器。Stochastic<br/>Diagnosis Verifier — v0.38.0<br/>R483，stochastic诊断验证器。Stochastic<br/>Diagnosis Verifier — v0.38.0<br/>R483相关功能的实现。<br/>文件: verifiers/stochastic_diagnosis_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py["安全门禁l1l27<br/>gates包的safety_gate_l1_l27模块<br/>文件: gates/safety_gate_l1_l27.py<br/>(生产态 / production)"]

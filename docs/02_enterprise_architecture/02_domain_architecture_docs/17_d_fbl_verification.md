...
flowchart TD
    src_zephyr_feedback_loop_gates_governance_gates_py["治理门禁<br/>治理门禁，门禁的门禁，在关键节点检查是否放行。<br/>_governance_gates<br/>文件: gates/_governance_gates.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_safety_gates_py["安全门禁<br/>安全门禁，门禁的门禁，在关键节点检查是否放行。<br/>_safety_gates<br/>文件: gates/_safety_gates.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_security_gates_py["安全门禁<br/>安全门禁，门禁的门禁，在关键节点检查是否放行。<br/>_security_gates<br/>文件: gates/_security_gates.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_action_reversibility_py["行为reversibility<br/>动作reversibility。Action Reversibility —<br/>v0.15.0 R208<br/>Action Reversibility — v0.15.0 R208<br/>Action Reversibility — v0.15.0 R208<br/>文件: gates/action_reversibility.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_adversarial_validation_py["对抗验证<br/>adversarial验证。Adversarial Validation Gate —<br/>FLE-ADVERSARIAL-VALIDATION + RED-BLUE-GATE<br/>bridge.<br/>Adversarial Validation Gate —<br/>FLE-ADVERSARIAL-VALIDATION + R<br/>Adversarial Validation Gate —<br/>FLE-ADVERSARIAL-VALIDATION + RED-BLUE-GATE<br/>bridge.<br/>文件: gates/adversarial_validation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_autonomy_credit_py["自治信用<br/>自治信用，提供包入口和模块加载功能<br/>Autonomy Credit System — v0.7.0 R87<br/>Autonomy Credit System — v0.7.0 R87<br/>文件: gates/autonomy_credit.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_autonomy_maturity_py["自治成熟度<br/>自治成熟度，提供包入口和模块加载功能<br/>Autonomy Maturity Ladder — v0.7.0 R86<br/>Autonomy Maturity Ladder — v0.7.0 R86<br/>文件: gates/autonomy_maturity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_blueprint_code_reconciler_py["蓝图代码协调器<br/>蓝图代码协调器。Blueprint-Code Reconciler —<br/>v0.14.0 R195<br/>Blueprint-Code Reconciler — v0.14.0 R195<br/>Blueprint-Code Reconciler — v0.14.0 R195<br/>文件: gates/blueprint_code_reconciler.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_blueprint_validator_py["蓝图校验器<br/>蓝图校验器。Blueprint Validator — v0.8.0 R108<br/>Blueprint Validator — v0.8.0 R108<br/>Blueprint Validator — v0.8.0 R108<br/>文件: gates/blueprint_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_checkpoint_manager_py["检查点管理器<br/>检查点管理器。Checkpoint Manager — v0.3.0 R18<br/>Checkpoint Manager — v0.3.0 R18<br/>Checkpoint Manager — v0.3.0 R18<br/>文件: gates/checkpoint_manager.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_ci_cd_pre_scanner_py["cicdpre扫描器<br/>cicd预扫描器。CI/CD Pre-Scanner — v0.8.0 R107<br/>CI/CD Pre-Scanner — v0.8.0 R107<br/>CI/CD Pre-Scanner — v0.8.0 R107<br/>文件: gates/ci_cd_pre_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_concurrent_change_deconfliction_py["并发变更deconfliction<br/>并发变更deconfliction。Concurrent Change<br/>Deconfliction — v0.16.0 R230<br/>Concurrent Change Deconfliction — v0.16.0 R230<br/>Concurrent Change Deconfliction — v0.16.0 R230<br/>文件: gates/concurrent_change_deconfliction.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_complexity_budget_py["配置complexity预算<br/>配置complexity预算。Config Complexity Budget —<br/>v0.16.0 R227<br/>Config Complexity Budget — v0.16.0 R227<br/>Config Complexity Budget — v0.16.0 R227<br/>文件: gates/config_complexity_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_governance_py["配置治理<br/>配置治理。Config Governance — v0.3.0 R8<br/>Config Governance — v0.3.0 R8<br/>Config Governance — v0.3.0 R8<br/>文件: gates/config_governance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_conflict_arbitration_py["冲突仲裁<br/>冲突仲裁，提供arbitrate等方法<br/>Conflict Arbitration — v0.10.0 R130<br/>Conflict Arbitration — v0.10.0 R130<br/>文件: gates/conflict_arbitration.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_cve_scanner_py["cve扫描器<br/>cve扫描器。CVE Scanner — v0.8.0 R106<br/>CVE Scanner — v0.8.0 R106<br/>CVE Scanner — v0.8.0 R106<br/>文件: gates/cve_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_data_quality_gate_py["数据质量门禁<br/>数据质量门禁。Data Quality Gate — v0.11.0 R143<br/>Data Quality Gate — v0.11.0 R143<br/>Data Quality Gate — v0.11.0 R143<br/>文件: gates/data_quality_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_db_integrity_py["数据库完整性<br/>数据库完整性。DB Integrity Gate — v0.3.0 R17<br/>DB Integrity Gate — v0.3.0 R17<br/>DB Integrity Gate — v0.3.0 R17<br/>文件: gates/db_integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_deployment_suppression_py["部署抑制<br/>部署抑制，门禁的门禁，在关键节点检查是否放行。<br/>Deployment Suppression — v0.37.0 R464<br/>Deployment Suppression — v0.37.0 R464<br/>文件: gates/deployment_suppression.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_dynamic_llm_cost_router_py["动态llm成本路由器<br/>动态llm成本路由器。Dynamic LLM Cost Router —<br/>v0.8.0 R109<br/>Dynamic LLM Cost Router — v0.8.0 R109<br/>Dynamic LLM Cost Router — v0.8.0 R109<br/>文件: gates/dynamic_llm_cost_router.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_emergency_takeover_py["紧急takeover<br/>紧急takeover。Emergency Takeover — v0.7.0 R88<br/>Emergency Takeover — v0.7.0 R88<br/>Emergency Takeover — v0.7.0 R88<br/>文件: gates/emergency_takeover.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_federated_security_py["federated安全<br/>federated安全。Federated Security — v0.10.0 R131<br/>Federated Security — v0.10.0 R131<br/>Federated Security — v0.10.0 R131<br/>文件: gates/federated_security.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_flag_lifecycle_manager_py["标志生命周期管理器<br/>标志生命周期管理器。Flag Lifecycle Manager —<br/>v0.3.0 R11<br/>Flag Lifecycle Manager — v0.3.0 R11<br/>Flag Lifecycle Manager — v0.3.0 R11<br/>文件: gates/flag_lifecycle_manager.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_license_compliance_py["license合规<br/>license合规。License Compliance — v0.14.0 R198<br/>License Compliance — v0.14.0 R198<br/>License Compliance — v0.14.0 R198<br/>文件: gates/license_compliance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_llm_cost_router_py["llm成本路由器<br/>llm成本路由器。LLM Cost Router — v0.3.0 R20<br/>LLM Cost Router — v0.3.0 R20<br/>LLM Cost Router — v0.3.0 R20<br/>文件: gates/llm_cost_router.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_merkle_audit_root_py["merkle审计root<br/>merkle审计根。Merkle Audit Root — v0.8.0 R104<br/>Merkle Audit Root — v0.8.0 R104<br/>Merkle Audit Root — v0.8.0 R104<br/>文件: gates/merkle_audit_root.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_meta_performance_gate_py["元绩效门禁<br/>元绩效门禁。Meta Performance Gate — v0.11.0 R158<br/>Meta Performance Gate — v0.11.0 R158<br/>Meta Performance Gate — v0.11.0 R158<br/>文件: gates/meta_performance_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_parameterized_safety_gate_py["parameterized安全门禁<br/>parameterized安全门禁。GateVerdict — GateVerdict<br/>GateVerdict — GateVerdict<br/>GateVerdict — GateVerdict<br/>文件: gates/parameterized_safety_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l28_l29_py["安全门禁l28l29<br/>安全门禁l28l29。Safety Gates L28-L29 — DR<br/>Readiness + Supply Chain (MOD-FEEDBACK_LOOP §3<br/>L28-L41)<br/>Safety Gates L28-L29 — DR Readiness + Supply<br/>Chain (MOD-FEED<br/>Safety Gates L28-L29 — DR Readiness + Supply<br/>Chain (MOD-FEEDBACK_LOOP §3 L28-L41)<br/>文件: gates/safety_gate_l28_l29.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l36_l37_py["安全门禁l36l37<br/>安全门禁l36l37。Safety Gates L36-L37 — AI Code<br/>Integrity + Vibe Maintainability<br/>Safety Gates L36-L37 — AI Code Integrity + Vibe<br/>Maintainabil<br/>Safety Gates L36-L37 — AI Code Integrity + Vibe<br/>Maintainability<br/>文件: gates/safety_gate_l36_l37.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l38_l39_py["安全门禁l38l39<br/>安全门禁l38l39。Safety Gates L38-L39 —<br/>Deterministic Safety + Architectural Integrity<br/>Safety Gates L38-L39 — Deterministic Safety +<br/>Architectural<br/>Safety Gates L38-L39 — Deterministic Safety +<br/>Architectural Integrity<br/>文件: gates/safety_gate_l38_l39.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l40_l41_py["安全门禁l40l41<br/>安全门禁l40l41。Safety Gates L40-L41 —<br/>Self-Integrity + Container Immutability<br/>Safety Gates L40-L41 — Self-Integrity +<br/>Container Immutabili<br/>Safety Gates L40-L41 — Self-Integrity +<br/>Container Immutability<br/>文件: gates/safety_gate_l40_l41.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l42_l43_py["安全门禁l42l43<br/>安全门禁l42l43。Safety Gates L42-L43 — Causal<br/>Integrity + Survivability<br/>Safety Gates L42-L43 — Causal Integrity +<br/>Survivability<br/>Safety Gates L42-L43 — Causal Integrity +<br/>Survivability<br/>文件: gates/safety_gate_l42_l43.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l44_l45_py["安全门禁l44l45<br/>安全门禁l44l45。Safety Gates L44-L45 —<br/>Operational Excellence + Causal Interrogability<br/>Safety Gates L44-L45 — Operational Excellence +<br/>Causal Inter<br/>Safety Gates L44-L45 — Operational Excellence +<br/>Causal Interrogability<br/>文件: gates/safety_gate_l44_l45.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l46_l47_py["安全门禁l46l47<br/>安全门禁l46l47。Safety Gates L46-L47 — Systemic<br/>Emergence + Ontological Consistency<br/>Safety Gates L46-L47 — Systemic Emergence +<br/>Ontological Cons<br/>Safety Gates L46-L47 — Systemic Emergence +<br/>Ontological Consistency<br/>文件: gates/safety_gate_l46_l47.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l48_l49_py["安全门禁l48l49<br/>安全门禁l48l49。Safety Gates L48-L49 — Supply<br/>Chain Integrity + Cognitive Safety<br/>Safety Gates L48-L49 — Supply Chain Integrity +<br/>Cognitive Sa<br/>Safety Gates L48-L49 — Supply Chain Integrity +<br/>Cognitive Safety<br/>文件: gates/safety_gate_l48_l49.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l50_l51_py["安全门禁l50l51<br/>安全门禁l50l51。Safety Gates L50-L55 —<br/>Coherence + Integrity Ladder (double-pair<br/>pattern)<br/>Safety Gates L50-L55 — Coherence + Integrity<br/>Ladder (double-<br/>Safety Gates L50-L55 — Coherence + Integrity<br/>Ladder (double-pair pattern)<br/>文件: gates/safety_gate_l50_l51.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l52_l53_py["安全门禁l52l53<br/>安全门禁l52l53。Safety Gates L52-L53 — Boot<br/>Integrity + OSS License<br/>Safety Gates L52-L53 — Boot Integrity + OSS<br/>License<br/>Safety Gates L52-L53 — Boot Integrity + OSS<br/>License<br/>文件: gates/safety_gate_l52_l53.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l54_l55_py["安全门禁l54l55<br/>安全门禁l54l55。Safety Gates L54-L55 — Final<br/>Gate + Full Integration<br/>Safety Gates L54-L55 — Final Gate + Full<br/>Integration<br/>Safety Gates L54-L55 — Final Gate + Full<br/>Integration<br/>文件: gates/safety_gate_l54_l55.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l56_l57_py["安全门禁l56l57<br/>安全门禁l56l57。Safety Gates L56-L57 —<br/>Evolutionary Integrity + Cross-Generational<br/>Coherence<br/>Safety Gates L56-L57 — Evolutionary Integrity +<br/>Cross-Genera<br/>Safety Gates L56-L57 — Evolutionary Integrity +<br/>Cross-Generational Coherence<br/>文件: gates/safety_gate_l56_l57.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l58_l59_py["安全门禁l58l59<br/>安全门禁l58l59。Safety Gates L58-L59 —<br/>Over-the-Horizon + Temporal Integrity<br/>Safety Gates L58-L59 — Over-the-Horizon +<br/>Temporal Integrity<br/>Safety Gates L58-L59 — Over-the-Horizon +<br/>Temporal Integrity<br/>文件: gates/safety_gate_l58_l59.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l60_l61_py["安全门禁l60l61<br/>安全门禁l60l61。Safety Gates L60-L61 —<br/>Environmental Grounding + Meta-System Integrity<br/>Safety Gates L60-L61 — Environmental Grounding<br/>+ Meta-System<br/>Safety Gates L60-L61 — Environmental Grounding<br/>+ Meta-System Integrity<br/>文件: gates/safety_gate_l60_l61.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l62_l63_py["安全门禁l62l63<br/>安全门禁l62l63。Safety Gates L62-L63 —<br/>Infrastructure Reality + Market Reality<br/>Safety Gates L62-L63 — Infrastructure Reality +<br/>Market Reali<br/>Safety Gates L62-L63 — Infrastructure Reality +<br/>Market Reality<br/>文件: gates/safety_gate_l62_l63.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l64_l65_py["安全门禁l64l65<br/>安全门禁l64l65。Safety Gates L64-L65 —<br/>Financial Integrity + VibeOps:Solo<br/>Safety Gates L64-L65 — Financial Integrity +<br/>VibeOps:Solo<br/>Safety Gates L64-L65 — Financial Integrity +<br/>VibeOps:Solo<br/>文件: gates/safety_gate_l64_l65.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l66_l67_py["安全门禁l66l67<br/>安全门禁l66l67。Safety Gates L66-L67 —<br/>Financial Prudence + Full Integration Audit<br/>Safety Gates L66-L67 — Financial Prudence +<br/>Full Integration<br/>Safety Gates L66-L67 — Financial Prudence +<br/>Full Integration Audit<br/>文件: gates/safety_gate_l66_l67.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_scope_creep_monitor_py["作用域creep监控器<br/>作用域creep监控。Scope Creep Monitor — v0.15.0<br/>R220<br/>Scope Creep Monitor — v0.15.0 R220<br/>Scope Creep Monitor — v0.15.0 R220<br/>文件: gates/scope_creep_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_ab_test_py["ab测试<br/>ab测试。A/B Test Verifier — v0.9.0 R117<br/>A/B Test Verifier — v0.9.0 R117<br/>A/B Test Verifier — v0.9.0 R117<br/>文件: verifiers/ab_test.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_action_explainability_py["行为explainability<br/>动作explainability。Action Explainability —<br/>v0.3.0 R15<br/>Action Explainability — v0.3.0 R15<br/>Action Explainability — v0.3.0 R15<br/>文件: verifiers/action_explainability.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_ai_comment_veracity_py["AI评论真实性<br/>AI评论真实性，验证器的核心类，封装VeracityLevel<br/>相关逻辑。<br/>AI Comment Veracity — v0.37.0 R459<br/>AI Comment Veracity — v0.37.0 R459<br/>文件: verifiers/ai_comment_veracity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_attack_simulator_py["攻击模拟器<br/>攻击simulator，验证器的核心类，封装AttackSimulat<br/>or相关逻辑。<br/>Attack Simulator — v0.6.0 R57<br/>Attack Simulator — v0.6.0 R57<br/>文件: verifiers/attack_simulator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_auto_rollback_py["自动回滚<br/>自动回滚。Auto Rollback — v0.8.0 R93<br/>Auto Rollback — v0.8.0 R93<br/>Auto Rollback — v0.8.0 R93<br/>文件: verifiers/auto_rollback.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_build_reproducibility_verifier_py["buildreproducibility验证器<br/>构建reproducibility验证器。Build<br/>Reproducibility Verifier — v0.38.0 R484<br/>Build Reproducibility Verifier — v0.38.0 R484<br/>Build Reproducibility Verifier — v0.38.0 R484<br/>文件: verifiers/build_reproducibility_<br/>verifier.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_canary_repair_py["金丝雀修复<br/>金丝雀修复，验证器的核心类，封装CanaryRepair相关<br/>逻辑。<br/>Canary Repair — v0.8.0 R104b<br/>Canary Repair — v0.8.0 R104b<br/>文件: verifiers/canary_repair.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cascading_rollback_analyzer_py["级联回滚分析器<br/>cascading回滚分析器。Cascading Rollback<br/>Analyzer — v0.38.0 R482<br/>Cascading Rollback Analyzer — v0.38.0 R482<br/>Cascading Rollback Analyzer — v0.38.0 R482<br/>文件: verifiers/cascading_rollback_analyzer.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_blueprint_contract_drift_py["跨蓝图契约漂移<br/>跨蓝图契约漂移。Cross-Blueprint Contract Drift<br/>Monitor — v0.39.0 R490<br/>Cross-Blueprint Contract Drift Monitor —<br/>v0.39.0 R490<br/>Cross-Blueprint Contract Drift Monitor —<br/>v0.39.0 R490<br/>文件: verifiers/cross_blueprint_contract_<br/>drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_module_integration_py["跨模块集成<br/>跨模块集成。Cross-Module Integration Verifier —<br/>v0.5.0 R39<br/>Cross-Module Integration Verifier — v0.5.0 R39<br/>Cross-Module Integration Verifier — v0.5.0 R39<br/>文件: verifiers/cross_module_integration.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_session_knowledge_integrity_py["跨会话知识完整性<br/>跨会话知识完整性。Cross-Session Knowledge<br/>Integrity — v0.16.0 R225<br/>Cross-Session Knowledge Integrity — v0.16.0 R225<br/>Cross-Session Knowledge Integrity — v0.16.0 R225<br/>文件: verifiers/cross_session_knowledge_<br/>integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_digital_twin_sandbox_py["数字孪生沙箱<br/>数字孪生沙箱，反馈闭环的数据库，持久化存取结构化<br/>数据。<br/>Digital Twin Sandbox — v0.6.0 R55<br/>Digital Twin Sandbox — v0.6.0 R55<br/>文件: verifiers/digital_twin_sandbox.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_dry_run_sandbox_py["dry运行沙箱<br/>dry运行sandbox。Dry Run Sandbox — v0.3.0 R19<br/>Dry Run Sandbox — v0.3.0 R19<br/>Dry Run Sandbox — v0.3.0 R19<br/>文件: verifiers/dry_run_sandbox.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_federated_protocol_py["federated协议<br/>federated协议。Federated Protocol — v0.10.0 R129<br/>Federated Protocol — v0.10.0 R129<br/>Federated Protocol — v0.10.0 R129<br/>文件: verifiers/federated_protocol.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_golden_test_external_py["golden测试external<br/>golden测试外部。Golden Test External — v0.15.0<br/>R214<br/>Golden Test External — v0.15.0 R214<br/>Golden Test External — v0.15.0 R214<br/>文件: verifiers/golden_test_external.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_no_llm_degradation_py["noLLM退化<br/>nollm退化。No-LLM Degradation Mode — v0.8.0 R94<br/>No-LLM Degradation Mode — v0.8.0 R94<br/>No-LLM Degradation Mode — v0.8.0 R94<br/>文件: verifiers/no_llm_degradation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_pre_flight_simulator_py["preflight模拟器<br/>预flightsimulator。Pre-Flight Simulator —<br/>v0.12.0 R169b<br/>Pre-Flight Simulator — v0.12.0 R169b<br/>Pre-Flight Simulator — v0.12.0 R169b<br/>文件: verifiers/pre_flight_simulator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_preventive_repair_py["预防性修复<br/>预防性修复，反馈闭环的事件，定义和分发事件。<br/>Preventive Repair — v0.6.0 R69<br/>Preventive Repair — v0.6.0 R69<br/>文件: verifiers/preventive_repair.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_rollback_integrity_py["回滚完整性<br/>回滚完整性。Rollback Integrity — v0.3.0 R18b<br/>Rollback Integrity — v0.3.0 R18b<br/>Rollback Integrity — v0.3.0 R18b<br/>文件: verifiers/rollback_integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_sim2real_calibration_py["仿真到实盘校准<br/>仿真到实盘校准，验证器的核心类，封装Sim2RealCali<br/>bration相关逻辑。<br/>Sim2Real Calibration — v0.6.0 R56<br/>Sim2Real Calibration — v0.6.0 R56<br/>文件: verifiers/sim2real_calibration.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_stochastic_diagnosis_verifier_py["stochastic诊断验证器<br/>stochastic诊断验证器。Stochastic Diagnosis<br/>Verifier — v0.38.0 R483<br/>Stochastic Diagnosis Verifier — v0.38.0 R483<br/>Stochastic Diagnosis Verifier — v0.38.0 R483<br/>文件: verifiers/stochastic_diagnosis_verifier.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_toctou_revalidation_py["TOCTOU重新验证<br/>TOCTOU重新验证，反馈闭环的结果，封装操作结果的数<br/>据结构。<br/>TOCTOU Revalidation — v0.37.0 R458<br/>TOCTOU Revalidation — v0.37.0 R458<br/>文件: verifiers/toctou_revalidation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_verification_engine_py["验证引擎<br/>验证引擎，反馈闭环的核心类，封装Verdict相关逻辑<br/>。<br/>verification_engine<br/>文件: verifiers/verification_engine.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py["安全门禁l1l27<br/>安全门禁l1l27。Safety Gates L1-L27 — Unified<br/>Pipeline (MOD-FEEDBACK_LOOP §3)<br/>Safety Gates L1-L27 — Unified Pipeline<br/>(MOD-FEEDBACK_LOOP §3<br/>Safety Gates L1-L27 — Unified Pipeline<br/>(MOD-FEEDBACK_LOOP §3)<br/>文件: gates/safety_gate_l1_l27.py<br/>(生产态 / production)"]

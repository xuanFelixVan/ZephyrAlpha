...
flowchart TD
    src_zephyr_feedback_loop_gates_governance_gates_py["治理门禁<br/>反馈闭环/gates包的governance_gates模块<br/>_governance_gates<br/>文件: gates/_governance_gates.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_safety_gates_py["安全门禁<br/>反馈闭环/gates包的safety_gates模块<br/>_safety_gates<br/>文件: gates/_safety_gates.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_security_gates_py["安全门禁<br/>反馈闭环/gates包的security_gates模块<br/>_security_gates<br/>文件: gates/_security_gates.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_autonomy_credit_py["自治信用<br/>反馈闭环/gates包的autonomy_credit模块<br/>Autonomy Credit System — v0.7.0 R87<br/>文件: gates/autonomy_credit.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_autonomy_maturity_py["自治成熟度<br/>反馈闭环/gates包的autonomy_maturity模块<br/>Autonomy Maturity Ladder — v0.7.0 R86<br/>文件: gates/autonomy_maturity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_blueprint_code_reconciler_py["蓝图代码协调器<br/>反馈闭环/gates包的blueprint_code_reconciler模块<br/>Blueprint-Code Reconciler — v0.14.0 R195<br/>文件: gates/blueprint_code_reconciler.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_blueprint_validator_py["蓝图校验器<br/>蓝图校验器。Blueprint Validator — v0.8.0 R108<br/>文件: gates/blueprint_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_checkpoint_manager_py["检查点管理器<br/>反馈闭环/gates包的checkpoint_manager模块<br/>Checkpoint Manager — v0.3.0 R18<br/>文件: gates/checkpoint_manager.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_concurrent_change_deconfliction_py["并发变更deconfliction<br/>反馈闭环/gates包的concurrent_change_<br/>deconfliction模块<br/>Concurrent Change Deconfliction — v0.16.0 R230<br/>文件: gates/concurrent_change_deconfliction.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_complexity_budget_py["配置complexity预算<br/>反馈闭环/gates包的config_complexity_budget模块<br/>Config Complexity Budget — v0.16.0 R227<br/>文件: gates/config_complexity_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_governance_py["配置治理<br/>配置治理。Config Governance — v0.3.0 R8<br/>文件: gates/config_governance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_conflict_arbitration_py["冲突仲裁<br/>冲突仲裁，提供arbitrate等方法<br/>Conflict Arbitration — v0.10.0 R130<br/>文件: gates/conflict_arbitration.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_cve_scanner_py["cve扫描器<br/>反馈闭环/gates包的cve_scanner模块<br/>CVE Scanner — v0.8.0 R106<br/>文件: gates/cve_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_data_quality_gate_py["数据质量门禁<br/>反馈闭环/gates包的data_quality_gate模块<br/>Data Quality Gate — v0.11.0 R143<br/>文件: gates/data_quality_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_db_integrity_py["数据库完整性<br/>反馈闭环/gates包的db_integrity模块<br/>DB Integrity Gate — v0.3.0 R17<br/>文件: gates/db_integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_deployment_suppression_py["部署抑制<br/>反馈闭环/gates包的deployment_suppression模块<br/>Deployment Suppression — v0.37.0 R464<br/>文件: gates/deployment_suppression.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_dynamic_llm_cost_router_py["动态llm成本路由器<br/>反馈闭环/gates包的dynamic_llm_cost_router模块<br/>Dynamic LLM Cost Router — v0.8.0 R109<br/>文件: gates/dynamic_llm_cost_router.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_emergency_takeover_py["紧急takeover<br/>反馈闭环/gates包的emergency_takeover模块<br/>Emergency Takeover — v0.7.0 R88<br/>文件: gates/emergency_takeover.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_federated_security_py["federated安全<br/>反馈闭环/gates包的federated_security模块<br/>Federated Security — v0.10.0 R131<br/>文件: gates/federated_security.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_flag_lifecycle_manager_py["标志生命周期管理器<br/>反馈闭环/gates包的flag_lifecycle_manager模块<br/>Flag Lifecycle Manager — v0.3.0 R11<br/>文件: gates/flag_lifecycle_manager.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_license_compliance_py["license合规<br/>反馈闭环/gates包的license_compliance模块<br/>License Compliance — v0.14.0 R198<br/>文件: gates/license_compliance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_llm_cost_router_py["llm成本路由器<br/>反馈闭环/gates包的llm_cost_router模块<br/>LLM Cost Router — v0.3.0 R20<br/>文件: gates/llm_cost_router.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_meta_performance_gate_py["元绩效门禁<br/>元绩效门禁。Meta Performance Gate — v0.11.0 R158<br/>文件: gates/meta_performance_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_parameterized_safety_gate_py["parameterized安全门禁<br/>反馈闭环/gates包的parameterized_safety_gate模块<br/>GateVerdict — GateVerdict<br/>文件: gates/parameterized_safety_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l28_l29_py["安全门禁l28l29<br/>反馈闭环/gates包的safety_gate_l28_l29模块<br/>Safety Gates L28-L29 — DR Readiness + Supply<br/>Chain (MOD-FEEDBACK_LOOP §3 L28-L41)<br/>文件: gates/safety_gate_l28_l29.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l36_l37_py["安全门禁l36l37<br/>反馈闭环/gates包的safety_gate_l36_l37模块<br/>Safety Gates L36-L37 — AI Code Integrity + Vibe<br/>Maintainability<br/>文件: gates/safety_gate_l36_l37.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l38_l39_py["安全门禁l38l39<br/>反馈闭环/gates包的safety_gate_l38_l39模块<br/>Safety Gates L38-L39 — Deterministic Safety +<br/>Architectural Integrity<br/>文件: gates/safety_gate_l38_l39.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l40_l41_py["安全门禁l40l41<br/>反馈闭环/gates包的safety_gate_l40_l41模块<br/>Safety Gates L40-L41 — Self-Integrity +<br/>Container Immutability<br/>文件: gates/safety_gate_l40_l41.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l42_l43_py["安全门禁l42l43<br/>反馈闭环/gates包的safety_gate_l42_l43模块<br/>Safety Gates L42-L43 — Causal Integrity +<br/>Survivability<br/>文件: gates/safety_gate_l42_l43.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l44_l45_py["安全门禁l44l45<br/>反馈闭环/gates包的safety_gate_l44_l45模块<br/>Safety Gates L44-L45 — Operational Excellence +<br/>Causal Interrogability<br/>文件: gates/safety_gate_l44_l45.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l46_l47_py["安全门禁l46l47<br/>反馈闭环/gates包的safety_gate_l46_l47模块<br/>Safety Gates L46-L47 — Systemic Emergence +<br/>Ontological Consistency<br/>文件: gates/safety_gate_l46_l47.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l48_l49_py["安全门禁l48l49<br/>反馈闭环/gates包的safety_gate_l48_l49模块<br/>Safety Gates L48-L49 — Supply Chain Integrity +<br/>Cognitive Safety<br/>文件: gates/safety_gate_l48_l49.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l50_l51_py["安全门禁l50l51<br/>反馈闭环/gates包的safety_gate_l50_l51模块<br/>Safety Gates L50-L55 — Coherence + Integrity<br/>Ladder (double-pair pattern)<br/>文件: gates/safety_gate_l50_l51.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l52_l53_py["安全门禁l52l53<br/>反馈闭环/gates包的safety_gate_l52_l53模块<br/>Safety Gates L52-L53 — Boot Integrity + OSS<br/>License<br/>文件: gates/safety_gate_l52_l53.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l54_l55_py["安全门禁l54l55<br/>反馈闭环/gates包的safety_gate_l54_l55模块<br/>Safety Gates L54-L55 — Final Gate + Full<br/>Integration<br/>文件: gates/safety_gate_l54_l55.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l56_l57_py["安全门禁l56l57<br/>反馈闭环/gates包的safety_gate_l56_l57模块<br/>Safety Gates L56-L57 — Evolutionary Integrity +<br/>Cross-Generational Coherence<br/>文件: gates/safety_gate_l56_l57.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l58_l59_py["安全门禁l58l59<br/>反馈闭环/gates包的safety_gate_l58_l59模块<br/>Safety Gates L58-L59 — Over-the-Horizon +<br/>Temporal Integrity<br/>文件: gates/safety_gate_l58_l59.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l60_l61_py["安全门禁l60l61<br/>反馈闭环/gates包的safety_gate_l60_l61模块<br/>Safety Gates L60-L61 — Environmental Grounding<br/>+ Meta-System Integrity<br/>文件: gates/safety_gate_l60_l61.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l62_l63_py["安全门禁l62l63<br/>反馈闭环/gates包的safety_gate_l62_l63模块<br/>Safety Gates L62-L63 — Infrastructure Reality +<br/>Market Reality<br/>文件: gates/safety_gate_l62_l63.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l64_l65_py["安全门禁l64l65<br/>反馈闭环/gates包的safety_gate_l64_l65模块<br/>Safety Gates L64-L65 — Financial Integrity +<br/>VibeOps:Solo<br/>文件: gates/safety_gate_l64_l65.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l66_l67_py["安全门禁l66l67<br/>反馈闭环/gates包的safety_gate_l66_l67模块<br/>Safety Gates L66-L67 — Financial Prudence +<br/>Full Integration Audit<br/>文件: gates/safety_gate_l66_l67.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_ab_test_py["ab测试<br/>ab测试。A/B Test Verifier — v0.9.0 R117<br/>文件: verifiers/ab_test.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_auto_rollback_py["自动回滚<br/>自动回滚。Auto Rollback — v0.8.0 R93<br/>文件: verifiers/auto_rollback.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_build_reproducibility_verifier_py["buildreproducibility验证器<br/>构建reproducibility验证器。Build<br/>Reproducibility Verifier — v0.38.0 R484<br/>文件: verifiers/build_reproducibility_<br/>verifier.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_canary_repair_py["金丝雀修复<br/>金丝雀修复，验证器的核心类，封装CanaryRepair相关<br/>逻辑<br/>Canary Repair — v0.8.0 R104b<br/>文件: verifiers/canary_repair.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_cross_blueprint_contract_drift_py["跨蓝图契约漂移<br/>反馈闭环/验证器包的cross_blueprint_contract_<br/>drift模块<br/>Cross-Blueprint Contract Drift Monitor —<br/>v0.39.0 R490<br/>文件: verifiers/cross_blueprint_contract_<br/>drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_module_integration_py["跨模块集成<br/>跨模块集成。Cross-Module Integration Verifier —<br/>v0.5.0 R39<br/>文件: verifiers/cross_module_integration.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_session_knowledge_integrity_py["跨会话知识完整性<br/>反馈闭环/验证器包的cross_session_knowledge_<br/>integrity模块<br/>Cross-Session Knowledge Integrity — v0.16.0 R225<br/>文件: verifiers/cross_session_knowledge_<br/>integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_digital_twin_sandbox_py["数字孪生沙箱<br/>反馈闭环/验证器包的digital_twin_sandbox模块<br/>Digital Twin Sandbox — v0.6.0 R55<br/>文件: verifiers/digital_twin_sandbox.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_federated_protocol_py["federated协议<br/>反馈闭环/验证器包的federated_protocol模块<br/>Federated Protocol — v0.10.0 R129<br/>文件: verifiers/federated_protocol.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_preventive_repair_py["预防性修复<br/>预防性修复，反馈闭环的事件，定义和分发事件<br/>Preventive Repair — v0.6.0 R69<br/>文件: verifiers/preventive_repair.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_rollback_integrity_py["回滚完整性<br/>回滚完整性。Rollback Integrity — v0.3.0 R18b<br/>文件: verifiers/rollback_integrity.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_stochastic_diagnosis_verifier_py["stochastic诊断验证器<br/>反馈闭环/验证器包的stochastic_diagnosis_<br/>verifier模块<br/>Stochastic Diagnosis Verifier — v0.38.0 R483<br/>文件: verifiers/stochastic_diagnosis_verifier.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_toctou_revalidation_py["TOCTOU重新验证<br/>反馈闭环/验证器包的toctou_revalidation模块<br/>TOCTOU Revalidation — v0.37.0 R458<br/>文件: verifiers/toctou_revalidation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_verification_engine_py["验证引擎<br/>验证引擎，反馈闭环的核心类，封装Verdict相关逻辑<br/>verification_engine<br/>文件: verifiers/verification_engine.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py["安全门禁l1l27<br/>反馈闭环/gates包的safety_gate_l1_l27模块<br/>Safety Gates L1-L27 — Unified Pipeline<br/>(MOD-FEEDBACK_LOOP §3)<br/>文件: gates/safety_gate_l1_l27.py<br/>(生产态 / production)"]

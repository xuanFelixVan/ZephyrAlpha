...
flowchart TD
    src_zephyr_feedback_loop_gates_governance_gates_py["(生产态 / production) 治理门禁 / _<br/>governance_gates<br/>治理门禁，门禁的门禁，在关键节点检查是否<br/>放行。<br/>文件: gates/_governance_gates.py"]
    src_zephyr_feedback_loop_gates_operational_gates_py["(生产态 / production) 运营门禁 / _<br/>operational_gates<br/>operational门禁，门禁的门禁，在关键节点<br/>检查是否放行。<br/>文件: gates/_operational_gates.py"]
    src_zephyr_feedback_loop_gates_safety_gates_py["(生产态 / production) 安全门禁 / _<br/>safety_gates<br/>安全门禁，门禁的门禁，在关键节点检查是否<br/>放行。<br/>文件: gates/_safety_gates.py"]
    src_zephyr_feedback_loop_gates_security_gates_py["(生产态 / production) 安全门禁 / _<br/>security_gates<br/>安全门禁，门禁的门禁，在关键节点检查是否<br/>放行。<br/>文件: gates/_security_gates.py"]
    src_zephyr_feedback_loop_gates_action_reversibility_py["(生产态 / production) 行为reversibility<br/>/ Action Reversibility — v0.15.0 R208<br/>动作reversibility。Action Reversibility<br/>— v0.15.0 R208<br/>文件: gates/action_reversibility.py"]
    src_zephyr_feedback_loop_gates_adversarial_validation_py["(生产态 / production) 对抗验证 /<br/>Adversarial Validation Gate —<br/>FLE-ADVERSARIAL-VALIDATION + R<br/>adversarial验证。Adversarial Validation<br/>Gate — FLE-ADVERSARIAL-VALIDATION +<br/>RED-BLUE-GATE bridge.<br/>文件: gates/adversarial_validation.py"]
    src_zephyr_feedback_loop_gates_autonomy_credit_py["(生产态 / production) 自治信用 /<br/>Autonomy Credit System — v0.7.0 R87<br/>自治信用，提供包入口和模块加载功能<br/>文件: gates/autonomy_credit.py"]
    src_zephyr_feedback_loop_gates_autonomy_maturity_py["(生产态 / production) 自治成熟度 /<br/>Autonomy Maturity Ladder — v0.7.0 R86<br/>自治成熟度，提供包入口和模块加载功能<br/>文件: gates/autonomy_maturity.py"]
    src_zephyr_feedback_loop_gates_blueprint_code_reconciler_py["(生产态 / production) 蓝图代码协调器 /<br/>Blueprint-Code Reconciler — v0.14.0 R195<br/>蓝图代码协调器。Blueprint-Code<br/>Reconciler — v0.14.0 R195<br/>文件: gates/blueprint_code_reconciler.py"]
    src_zephyr_feedback_loop_gates_blueprint_validator_py["(生产态 / production) 蓝图校验器 /<br/>Blueprint Validator — v0.8.0 R108<br/>蓝图校验器。Blueprint Validator —<br/>v0.8.0 R108<br/>文件: gates/blueprint_validator.py"]
    src_zephyr_feedback_loop_gates_checkpoint_manager_py["(生产态 / production) 检查点管理器 /<br/>Checkpoint Manager — v0.3.0 R18<br/>检查点管理器。Checkpoint Manager —<br/>v0.3.0 R18<br/>文件: gates/checkpoint_manager.py"]
    src_zephyr_feedback_loop_gates_ci_cd_pre_scanner_py["(生产态 / production) cicdpre扫描器 /<br/>CI/CD Pre-Scanner — v0.8.0 R107<br/>cicd预扫描器。CI/CD Pre-Scanner —<br/>v0.8.0 R107<br/>文件: gates/ci_cd_pre_scanner.py"]
    src_zephyr_feedback_loop_gates_concurrent_change_deconfliction_py["(生产态 / production)<br/>并发变更deconfliction / Concurrent<br/>Change Deconfliction — v0.16.0 R230<br/>并发变更deconfliction。Concurrent<br/>Change Deconfliction — v0.16.0 R230<br/>文件: gates/concurrent_change_<br/>deconfliction.py"]
    src_zephyr_feedback_loop_gates_config_complexity_budget_py["(生产态 / production)<br/>配置complexity预算 / Config Complexity<br/>Budget — v0.16.0 R227<br/>配置complexity预算。Config Complexity<br/>Budget — v0.16.0 R227<br/>文件: gates/config_complexity_budget.py"]
    src_zephyr_feedback_loop_gates_config_governance_py["(生产态 / production) 配置治理 / Config<br/>Governance — v0.3.0 R8<br/>配置治理。Config Governance — v0.3.0 R8<br/>文件: gates/config_governance.py"]
    src_zephyr_feedback_loop_gates_conflict_arbitration_py["(生产态 / production) 冲突仲裁 /<br/>Conflict Arbitration — v0.10.0 R130<br/>冲突仲裁，提供arbitrate等方法<br/>文件: gates/conflict_arbitration.py"]
    src_zephyr_feedback_loop_gates_cve_scanner_py["(生产态 / production) cve扫描器 / CVE<br/>Scanner — v0.8.0 R106<br/>cve扫描器。CVE Scanner — v0.8.0 R106<br/>文件: gates/cve_scanner.py"]
    src_zephyr_feedback_loop_gates_data_quality_gate_py["(生产态 / production) 数据质量门禁 /<br/>Data Quality Gate — v0.11.0 R143<br/>数据质量门禁。Data Quality Gate —<br/>v0.11.0 R143<br/>文件: gates/data_quality_gate.py"]
    src_zephyr_feedback_loop_gates_db_integrity_py["(生产态 / production) 数据库完整性 / DB<br/>Integrity Gate — v0.3.0 R17<br/>数据库完整性。DB Integrity Gate —<br/>v0.3.0 R17<br/>文件: gates/db_integrity.py"]
    src_zephyr_feedback_loop_gates_deployment_suppression_py["(生产态 / production) 部署抑制 /<br/>Deployment Suppression — v0.37.0 R464<br/>部署抑制，门禁的门禁，在关键节点检查是否<br/>放行。<br/>文件: gates/deployment_suppression.py"]
    src_zephyr_feedback_loop_gates_dynamic_llm_cost_router_py["(生产态 / production) 动态llm成本路由器<br/>/ Dynamic LLM Cost Router — v0.8.0 R109<br/>动态llm成本路由器。Dynamic LLM Cost<br/>Router — v0.8.0 R109<br/>文件: gates/dynamic_llm_cost_router.py"]
    src_zephyr_feedback_loop_gates_emergency_takeover_py["(生产态 / production) 紧急takeover /<br/>Emergency Takeover — v0.7.0 R88<br/>紧急takeover。Emergency Takeover —<br/>v0.7.0 R88<br/>文件: gates/emergency_takeover.py"]
    src_zephyr_feedback_loop_gates_federated_security_py["(生产态 / production) federated安全 /<br/>Federated Security — v0.10.0 R131<br/>federated安全。Federated Security —<br/>v0.10.0 R131<br/>文件: gates/federated_security.py"]
    src_zephyr_feedback_loop_gates_flag_lifecycle_manager_py["(生产态 / production)<br/>标志生命周期管理器 / Flag Lifecycle<br/>Manager — v0.3.0 R11<br/>标志生命周期管理器。Flag Lifecycle<br/>Manager — v0.3.0 R11<br/>文件: gates/flag_lifecycle_manager.py"]
    src_zephyr_feedback_loop_gates_license_compliance_py["(生产态 / production) license合规 /<br/>License Compliance — v0.14.0 R198<br/>license合规。License Compliance —<br/>v0.14.0 R198<br/>文件: gates/license_compliance.py"]
    src_zephyr_feedback_loop_gates_llm_cost_router_py["(生产态 / production) llm成本路由器 /<br/>LLM Cost Router — v0.3.0 R20<br/>llm成本路由器。LLM Cost Router — v0.3.0<br/>R20<br/>文件: gates/llm_cost_router.py"]
    src_zephyr_feedback_loop_gates_merkle_audit_root_py["(生产态 / production) merkle审计root /<br/>Merkle Audit Root — v0.8.0 R104<br/>merkle审计根。Merkle Audit Root —<br/>v0.8.0 R104<br/>文件: gates/merkle_audit_root.py"]
    src_zephyr_feedback_loop_gates_meta_performance_gate_py["(生产态 / production) 元绩效门禁 / Meta<br/>Performance Gate — v0.11.0 R158<br/>元绩效门禁。Meta Performance Gate —<br/>v0.11.0 R158<br/>文件: gates/meta_performance_gate.py"]
    src_zephyr_feedback_loop_gates_parameterized_safety_gate_py["(生产态 / production)<br/>parameterized安全门禁 / GateVerdict —<br/>GateVerdict<br/>parameterized安全门禁。GateVerdict —<br/>GateVerdict<br/>文件: gates/parameterized_safety_gate.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l28_l29_py["(生产态 / production) 安全门禁l28l29 /<br/>Safety Gates L28-L29 — DR Readiness +<br/>Supply Chain (MOD-FEED<br/>安全门禁l28l29。Safety Gates L28-L29 —<br/>DR Readiness + Supply Chain<br/>(MOD-FEEDBACK_LOOP §3 L28-L41)<br/>文件: gates/safety_gate_l28_l29.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l36_l37_py["(生产态 / production) 安全门禁l36l37 /<br/>Safety Gates L36-L37 — AI Code<br/>Integrity + Vibe Maintainabil<br/>安全门禁l36l37。Safety Gates L36-L37 —<br/>AI Code Integrity + Vibe Maintainability<br/>文件: gates/safety_gate_l36_l37.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l38_l39_py["(生产态 / production) 安全门禁l38l39 /<br/>Safety Gates L38-L39 — Deterministic<br/>Safety + Architectural<br/>安全门禁l38l39。Safety Gates L38-L39 —<br/>Deterministic Safety + Architectural<br/>Integrity<br/>文件: gates/safety_gate_l38_l39.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l40_l41_py["(生产态 / production) 安全门禁l40l41 /<br/>Safety Gates L40-L41 — Self-Integrity +<br/>Container Immutabili<br/>安全门禁l40l41。Safety Gates L40-L41 —<br/>Self-Integrity + Container Immutability<br/>文件: gates/safety_gate_l40_l41.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l42_l43_py["(生产态 / production) 安全门禁l42l43 /<br/>Safety Gates L42-L43 — Causal Integrity<br/>+ Survivability<br/>安全门禁l42l43。Safety Gates L42-L43 —<br/>Causal Integrity + Survivability<br/>文件: gates/safety_gate_l42_l43.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l44_l45_py["(生产态 / production) 安全门禁l44l45 /<br/>Safety Gates L44-L45 — Operational<br/>Excellence + Causal Inter<br/>安全门禁l44l45。Safety Gates L44-L45 —<br/>Operational Excellence + Causal<br/>Interrogability<br/>文件: gates/safety_gate_l44_l45.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l46_l47_py["(生产态 / production) 安全门禁l46l47 /<br/>Safety Gates L46-L47 — Systemic<br/>Emergence + Ontological Cons<br/>安全门禁l46l47。Safety Gates L46-L47 —<br/>Systemic Emergence + Ontological<br/>Consistency<br/>文件: gates/safety_gate_l46_l47.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l48_l49_py["(生产态 / production) 安全门禁l48l49 /<br/>Safety Gates L48-L49 — Supply Chain<br/>Integrity + Cognitive Sa<br/>安全门禁l48l49。Safety Gates L48-L49 —<br/>Supply Chain Integrity + Cognitive<br/>Safety<br/>文件: gates/safety_gate_l48_l49.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l50_l51_py["(生产态 / production) 安全门禁l50l51 /<br/>Safety Gates L50-L55 — Coherence +<br/>Integrity Ladder (double-<br/>安全门禁l50l51。Safety Gates L50-L55 —<br/>Coherence + Integrity Ladder<br/>(double-pair pattern)<br/>文件: gates/safety_gate_l50_l51.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l52_l53_py["(生产态 / production) 安全门禁l52l53 /<br/>Safety Gates L52-L53 — Boot Integrity +<br/>OSS License<br/>安全门禁l52l53。Safety Gates L52-L53 —<br/>Boot Integrity + OSS License<br/>文件: gates/safety_gate_l52_l53.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l54_l55_py["(生产态 / production) 安全门禁l54l55 /<br/>Safety Gates L54-L55 — Final Gate +<br/>Full Integration<br/>安全门禁l54l55。Safety Gates L54-L55 —<br/>Final Gate + Full Integration<br/>文件: gates/safety_gate_l54_l55.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l56_l57_py["(生产态 / production) 安全门禁l56l57 /<br/>Safety Gates L56-L57 — Evolutionary<br/>Integrity + Cross-Genera<br/>安全门禁l56l57。Safety Gates L56-L57 —<br/>Evolutionary Integrity +<br/>Cross-Generational Coherence<br/>文件: gates/safety_gate_l56_l57.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l58_l59_py["(生产态 / production) 安全门禁l58l59 /<br/>Safety Gates L58-L59 — Over-the-Horizon<br/>+ Temporal Integrity<br/>安全门禁l58l59。Safety Gates L58-L59 —<br/>Over-the-Horizon + Temporal Integrity<br/>文件: gates/safety_gate_l58_l59.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l60_l61_py["(生产态 / production) 安全门禁l60l61 /<br/>Safety Gates L60-L61 — Environmental<br/>Grounding + Meta-System<br/>安全门禁l60l61。Safety Gates L60-L61 —<br/>Environmental Grounding + Meta-System<br/>Integrity<br/>文件: gates/safety_gate_l60_l61.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l62_l63_py["(生产态 / production) 安全门禁l62l63 /<br/>Safety Gates L62-L63 — Infrastructure<br/>Reality + Market Reali<br/>安全门禁l62l63。Safety Gates L62-L63 —<br/>Infrastructure Reality + Market Reality<br/>文件: gates/safety_gate_l62_l63.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l64_l65_py["(生产态 / production) 安全门禁l64l65 /<br/>Safety Gates L64-L65 — Financial<br/>Integrity + VibeOps:Solo<br/>安全门禁l64l65。Safety Gates L64-L65 —<br/>Financial Integrity + VibeOps:Solo<br/>文件: gates/safety_gate_l64_l65.py"]
    src_zephyr_feedback_loop_gates_safety_gate_l66_l67_py["(生产态 / production) 安全门禁l66l67 /<br/>Safety Gates L66-L67 — Financial<br/>Prudence + Full Integration<br/>安全门禁l66l67。Safety Gates L66-L67 —<br/>Financial Prudence + Full Integration<br/>Audit<br/>文件: gates/safety_gate_l66_l67.py"]
    src_zephyr_feedback_loop_gates_scope_creep_monitor_py["(生产态 / production) 作用域creep监控器<br/>/ Scope Creep Monitor — v0.15.0 R220<br/>作用域creep监控。Scope Creep Monitor —<br/>v0.15.0 R220<br/>文件: gates/scope_creep_monitor.py"]
    src_zephyr_feedback_loop_verifiers_ab_test_py["(生产态 / production) ab测试 / A/B Test<br/>Verifier — v0.9.0 R117<br/>ab测试。A/B Test Verifier — v0.9.0 R117<br/>文件: verifiers/ab_test.py"]
    src_zephyr_feedback_loop_verifiers_action_explainability_py["(生产态 / production)<br/>行为explainability / Action<br/>Explainability — v0.3.0 R15<br/>动作explainability。Action<br/>Explainability — v0.3.0 R15<br/>文件: verifiers/action_explainability.py"]
    src_zephyr_feedback_loop_verifiers_ai_comment_veracity_py["(生产态 / production) AI评论真实性 / AI<br/>Comment Veracity — v0.37.0 R459<br/>AI评论真实性，验证器的核心类，封装Veraci<br/>tyLevel相关逻辑。<br/>文件: verifiers/ai_comment_veracity.py"]
    src_zephyr_feedback_loop_verifiers_attack_simulator_py["(生产态 / production) 攻击模拟器 /<br/>Attack Simulator — v0.6.0 R57<br/>攻击simulator，验证器的核心类，封装Attac<br/>kSimulator相关逻辑。<br/>文件: verifiers/attack_simulator.py"]
    src_zephyr_feedback_loop_verifiers_auto_rollback_py["(生产态 / production) 自动回滚 / Auto<br/>Rollback — v0.8.0 R93<br/>自动回滚。Auto Rollback — v0.8.0 R93<br/>文件: verifiers/auto_rollback.py"]
    src_zephyr_feedback_loop_verifiers_build_reproducibility_verifier_py["(生产态 / production)<br/>buildreproducibility验证器 / Build<br/>Reproducibility Verifier — v0.38.0 R484<br/>构建reproducibility验证器。Build<br/>Reproducibility Verifier — v0.38.0 R484<br/>文件: verifiers/build_reproducibility_<br/>verifier.py"]
    src_zephyr_feedback_loop_verifiers_canary_repair_py["(生产态 / production) 金丝雀修复 /<br/>Canary Repair — v0.8.0 R104b<br/>金丝雀修复，验证器的核心类，封装CanaryRe<br/>pair相关逻辑。<br/>文件: verifiers/canary_repair.py"]
    src_zephyr_feedback_loop_verifiers_cascading_rollback_analyzer_py["(生产态 / production) 级联回滚分析器 /<br/>Cascading Rollback Analyzer — v0.38.0<br/>R482<br/>cascading回滚分析器。Cascading Rollback<br/>Analyzer — v0.38.0 R482<br/>文件: verifiers/cascading_rollback_<br/>analyzer.py"]
    src_zephyr_feedback_loop_verifiers_cross_blueprint_contract_drift_py["(生产态 / production) 跨蓝图契约漂移 /<br/>Cross-Blueprint Contract Drift Monitor<br/>— v0.39.0 R490<br/>跨蓝图契约漂移。Cross-Blueprint<br/>Contract Drift Monitor — v0.39.0 R490<br/>文件: verifiers/cross_blueprint_<br/>contract_drift.py"]
    src_zephyr_feedback_loop_verifiers_cross_module_integration_py["(生产态 / production) 跨模块集成 /<br/>Cross-Module Integration Verifier —<br/>v0.5.0 R39<br/>跨模块集成。Cross-Module Integration<br/>Verifier — v0.5.0 R39<br/>文件: verifiers/cross_module_<br/>integration.py"]
    src_zephyr_feedback_loop_verifiers_cross_session_knowledge_integrity_py["(生产态 / production) 跨会话知识完整性<br/>/ Cross-Session Knowledge Integrity —<br/>v0.16.0 R225<br/>跨会话知识完整性。Cross-Session<br/>Knowledge Integrity — v0.16.0 R225<br/>文件: verifiers/cross_session_knowledge_<br/>integrity.py"]
    src_zephyr_feedback_loop_verifiers_digital_twin_sandbox_py["(生产态 / production) 数字孪生沙箱 /<br/>Digital Twin Sandbox — v0.6.0 R55<br/>数字孪生沙箱，反馈闭环的数据库，持久化存<br/>取结构化数据。<br/>文件: verifiers/digital_twin_sandbox.py"]
    src_zephyr_feedback_loop_verifiers_dry_run_sandbox_py["(生产态 / production) dry运行沙箱 / Dry<br/>Run Sandbox — v0.3.0 R19<br/>dry运行sandbox。Dry Run Sandbox —<br/>v0.3.0 R19<br/>文件: verifiers/dry_run_sandbox.py"]
    src_zephyr_feedback_loop_verifiers_federated_protocol_py["(生产态 / production) federated协议 /<br/>Federated Protocol — v0.10.0 R129<br/>federated协议。Federated Protocol —<br/>v0.10.0 R129<br/>文件: verifiers/federated_protocol.py"]
    src_zephyr_feedback_loop_verifiers_golden_test_external_py["(生产态 / production)<br/>golden测试external / Golden Test<br/>External — v0.15.0 R214<br/>golden测试外部。Golden Test External —<br/>v0.15.0 R214<br/>文件: verifiers/golden_test_external.py"]
    src_zephyr_feedback_loop_verifiers_no_llm_degradation_py["(生产态 / production) noLLM退化 /<br/>No-LLM Degradation Mode — v0.8.0 R94<br/>nollm退化。No-LLM Degradation Mode —<br/>v0.8.0 R94<br/>文件: verifiers/no_llm_degradation.py"]
    src_zephyr_feedback_loop_verifiers_pre_flight_simulator_py["(生产态 / production) preflight模拟器 /<br/>Pre-Flight Simulator — v0.12.0 R169b<br/>预flightsimulator。Pre-Flight Simulator<br/>— v0.12.0 R169b<br/>文件: verifiers/pre_flight_simulator.py"]
    src_zephyr_feedback_loop_verifiers_preventive_repair_py["(生产态 / production) 预防性修复 /<br/>Preventive Repair — v0.6.0 R69<br/>预防性修复，反馈闭环的事件，定义和分发事<br/>件。<br/>文件: verifiers/preventive_repair.py"]
    src_zephyr_feedback_loop_verifiers_rollback_integrity_py["(生产态 / production) 回滚完整性 /<br/>Rollback Integrity — v0.3.0 R18b<br/>回滚完整性。Rollback Integrity — v0.3.0<br/>R18b<br/>文件: verifiers/rollback_integrity.py"]
    src_zephyr_feedback_loop_verifiers_sim2real_calibration_py["(生产态 / production) 仿真到实盘校准 /<br/>Sim2Real Calibration — v0.6.0 R56<br/>仿真到实盘校准，验证器的核心类，封装Sim2<br/>RealCalibration相关逻辑。<br/>文件: verifiers/sim2real_calibration.py"]
    src_zephyr_feedback_loop_verifiers_stochastic_diagnosis_verifier_py["(生产态 / production)<br/>stochastic诊断验证器 / Stochastic<br/>Diagnosis Verifier — v0.38.0 R483<br/>stochastic诊断验证器。Stochastic<br/>Diagnosis Verifier — v0.38.0 R483<br/>文件: verifiers/stochastic_diagnosis_<br/>verifier.py"]
    src_zephyr_feedback_loop_verifiers_toctou_revalidation_py["(生产态 / production) TOCTOU重新验证 /<br/>TOCTOU Revalidation — v0.37.0 R458<br/>TOCTOU重新验证，反馈闭环的结果，封装操作<br/>结果的数据结构。<br/>文件: verifiers/toctou_revalidation.py"]
    src_zephyr_feedback_loop_verifiers_verification_engine_py["(生产态 / production) 验证引擎 /<br/>verification_engine<br/>验证引擎，反馈闭环的核心类，封装Verdict<br/>相关逻辑。<br/>文件: verifiers/verification_engine.py"]
    ...
    src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py["(生产态 / production) 安全门禁l1l27 /<br/>Safety Gates L1-L27 — Unified Pipeline<br/>(MOD-FEEDBACK_LOOP §3<br/>安全门禁l1l27。Safety Gates L1-L27 —<br/>Unified Pipeline (MOD-FEEDBACK_LOOP §3)<br/>文件: gates/safety_gate_l1_l27.py"]

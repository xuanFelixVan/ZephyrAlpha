...
flowchart TD
    src_zephyr_feedback_loop_gates_governance_gates_py["治理门禁<br/>门禁的门禁，在关键节点检查是否放行（governance<br/>gates）<br/>_governance_gates<br/>文件: gates/_governance_gates.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_safety_gates_py["安全门禁<br/>门禁的门禁，在关键节点检查是否放行（safety<br/>gates）<br/>_safety_gates<br/>文件: gates/_safety_gates.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_security_gates_py["安全门禁<br/>门禁的门禁，在关键节点检查是否放行（security<br/>gates）<br/>_security_gates<br/>文件: gates/_security_gates.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_action_reversibility_py["行为reversibility<br/>所有破坏性动作门禁：必须先验证有可回滚路径才放行<br/>，防止执行不可逆操作（如误删生产数据）。<br/>Action Reversibility — v0.15.0 R208<br/>文件: gates/action_reversibility.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_autonomy_credit_py["自治信用<br/>门禁校验（autonomy credit）<br/>Autonomy Credit System — v0.7.0 R87<br/>文件: gates/autonomy_credit.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_autonomy_maturity_py["自治成熟度<br/>门禁校验（autonomy maturity）<br/>Autonomy Maturity Ladder — v0.7.0 R86<br/>文件: gates/autonomy_maturity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_blueprint_code_reconciler_py["蓝图代码协调器<br/>门禁校验（blueprint code reconciler）<br/>Blueprint-Code Reconciler — v0.14.0 R195<br/>文件: gates/blueprint_code_reconciler.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_blueprint_validator_py["蓝图校验器<br/>校验反馈闭环一致性（blueprint）<br/>Blueprint Validator — v0.8.0 R108<br/>文件: gates/blueprint_validator.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_checkpoint_manager_py["检查点管理器<br/>门禁校验（checkpoint）<br/>Checkpoint Manager — v0.3.0 R18<br/>文件: gates/checkpoint_manager.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_ci_cd_pre_scanner_py["cicdpre扫描器<br/>cicd预扫描器。CI/CD<br/>Pre-Scanner，校验反馈闭环一致性<br/>CI/CD Pre-Scanner — v0.8.0 R107<br/>文件: gates/ci_cd_pre_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_concurrent_change_deconfliction_py["并发变更deconfliction<br/>校验反馈闭环一致性（concurrent change<br/>deconfliction）<br/>文件: gates/concurrent_change_deconfliction.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_complexity_budget_py["配置complexity预算<br/>Config Complexity Budget，校验反馈闭环一致性<br/>Config Complexity Budget — v0.16.0 R227<br/>文件: gates/config_complexity_budget.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_config_governance_py["配置治理<br/>校验反馈闭环一致性（config governance）<br/>Config Governance — v0.3.0 R8<br/>文件: gates/config_governance.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_cve_scanner_py["cve扫描器<br/>校验反馈闭环一致性（cve）<br/>CVE Scanner — v0.8.0 R106<br/>文件: gates/cve_scanner.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_data_quality_gate_py["数据质量门禁<br/>门禁校验（data quality）<br/>Data Quality Gate — v0.11.0 R143<br/>文件: gates/data_quality_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_db_integrity_py["数据库完整性<br/>门禁校验（db integrity）<br/>DB Integrity Gate — v0.3.0 R17<br/>文件: gates/db_integrity.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_deployment_suppression_py["部署抑制<br/>门禁的门禁，在关键节点检查是否放行（deployment<br/>suppression）<br/>Deployment Suppression — v0.37.0 R464<br/>文件: gates/deployment_suppression.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_dynamic_llm_cost_router_py["动态llm成本路由器<br/>门禁校验（dynamic llm cost）<br/>Dynamic LLM Cost Router — v0.8.0 R109<br/>文件: gates/dynamic_llm_cost_router.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_emergency_takeover_py["紧急takeover<br/>提供人工紧急接管机制，自主修复循环失控时能强制叫<br/>停。<br/>Emergency Takeover — v0.7.0 R88<br/>文件: gates/emergency_takeover.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_federated_security_py["federated安全<br/>多实例 FLE<br/>部署共享安全上下文与可信对等方集合，防止一个实例<br/>被攻陷毒化整个联邦。<br/>Federated Security — v0.10.0 R131<br/>文件: gates/federated_security.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_license_compliance_py["license合规<br/>对第三方库做 SPDX 许可审计并执行依赖策略，发现<br/>copyleft 污染专有代码时告警，避免法律风险。<br/>License Compliance — v0.14.0 R198<br/>文件: gates/license_compliance.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_llm_cost_router_py["llm成本路由器<br/>校验反馈闭环一致性（llm cost）<br/>LLM Cost Router — v0.3.0 R20<br/>文件: gates/llm_cost_router.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_merkle_audit_root_py["merkle审计root<br/>merkle审计根。Merkle Audit<br/>Root，校验反馈闭环一致性<br/>Merkle Audit Root — v0.8.0 R104<br/>文件: gates/merkle_audit_root.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_meta_performance_gate_py["元绩效门禁<br/>校验反馈闭环一致性（meta performance）<br/>Meta Performance Gate — v0.11.0 R158<br/>文件: gates/meta_performance_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_parameterized_safety_gate_py["parameterized安全门禁<br/>GateVerdict — GateVerdict，校验反馈闭环一致性<br/>文件: gates/parameterized_safety_gate.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l28_l29_py["安全门禁l28l29<br/>校验反馈闭环一致性（safety gate l28 l29）<br/>文件: gates/safety_gate_l28_l29.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l36_l37_py["安全门禁l36l37<br/>校验反馈闭环一致性（safety gate l36 l37）<br/>文件: gates/safety_gate_l36_l37.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l38_l39_py["安全门禁l38l39<br/>校验反馈闭环一致性（safety gate l38 l39）<br/>文件: gates/safety_gate_l38_l39.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l40_l41_py["安全门禁l40l41<br/>校验反馈闭环一致性（safety gate l40 l41）<br/>文件: gates/safety_gate_l40_l41.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l42_l43_py["安全门禁l42l43<br/>校验反馈闭环一致性（safety gate l42 l43）<br/>文件: gates/safety_gate_l42_l43.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l44_l45_py["安全门禁l44l45<br/>校验反馈闭环一致性（safety gate l44 l45）<br/>文件: gates/safety_gate_l44_l45.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l46_l47_py["安全门禁l46l47<br/>校验反馈闭环一致性（safety gate l46 l47）<br/>文件: gates/safety_gate_l46_l47.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l48_l49_py["安全门禁l48l49<br/>校验反馈闭环一致性（safety gate l48 l49）<br/>文件: gates/safety_gate_l48_l49.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l50_l51_py["安全门禁l50l51<br/>校验反馈闭环一致性（safety gate l50 l51）<br/>文件: gates/safety_gate_l50_l51.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l52_l53_py["安全门禁l52l53<br/>校验反馈闭环一致性（safety gate l52 l53）<br/>文件: gates/safety_gate_l52_l53.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l54_l55_py["安全门禁l54l55<br/>校验反馈闭环一致性（safety gate l54 l55）<br/>文件: gates/safety_gate_l54_l55.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l56_l57_py["安全门禁l56l57<br/>校验反馈闭环一致性（safety gate l56 l57）<br/>文件: gates/safety_gate_l56_l57.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l58_l59_py["安全门禁l58l59<br/>校验反馈闭环一致性（safety gate l58 l59）<br/>文件: gates/safety_gate_l58_l59.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l60_l61_py["安全门禁l60l61<br/>校验反馈闭环一致性（safety gate l60 l61）<br/>文件: gates/safety_gate_l60_l61.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l62_l63_py["安全门禁l62l63<br/>校验反馈闭环一致性（safety gate l62 l63）<br/>文件: gates/safety_gate_l62_l63.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_gates_safety_gate_l64_l65_py["安全门禁l64l65<br/>校验反馈闭环一致性（safety gate l64 l65）<br/>文件: gates/safety_gate_l64_l65.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_scope_creep_monitor_py["作用域creep监控器<br/>门禁校验（scope creep）<br/>Scope Creep Monitor — v0.15.0 R220<br/>文件: gates/scope_creep_monitor.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_ab_test_py["ab测试<br/>用对照组和实验组 A/B<br/>验证修复是否真的带来改善，而不是自愈造成的假象。<br/>A/B Test Verifier — v0.9.0 R117<br/>文件: verifiers/ab_test.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_action_explainability_py["行为explainability<br/>为每个修复动作生成可解释说明，让运维能理解为何选<br/>这个修复，避免因不透明而误否正确修复。<br/>Action Explainability — v0.3.0 R15<br/>文件: verifiers/action_explainability.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_auto_rollback_py["自动回滚<br/>校验反馈闭环一致性（auto rollback）<br/>Auto Rollback — v0.8.0 R93<br/>文件: verifiers/auto_rollback.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_build_reproducibility_verifier_py["buildreproducibility验证器<br/>构建reproducibility验证器。Build<br/>Reproducibility Verifier，校验一致性<br/>文件: verifiers<br/>/build_reproducibility_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_cascading_rollback_analyzer_py["级联回滚分析器<br/>校验一致性（cascading rollback）<br/>文件: verifiers/cascading_rollback_analyzer.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_blueprint_contract_drift_py["跨蓝图契约漂移<br/>校验一致性（cross blueprint contract drift）<br/>文件: verifiers<br/>/cross_blueprint_contract_drift.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_cross_module_integration_py["跨模块集成<br/>校验一致性（cross module integration）<br/>文件: verifiers/cross_module_integration.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_digital_twin_sandbox_py["数字孪生沙箱<br/>反馈闭环的数据库，持久化存取结构化数据（digital<br/>twin sandbox）<br/>Digital Twin Sandbox — v0.6.0 R55<br/>文件: verifiers/digital_twin_sandbox.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_dry_run_sandbox_py["dry运行沙箱<br/>在沙箱里先模拟运行修复动作预览效果，通过验证后再<br/>上生产，防止破坏性修复直接打到生产。<br/>Dry Run Sandbox — v0.3.0 R19<br/>文件: verifiers/dry_run_sandbox.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_federated_protocol_py["federated协议<br/>为多 FLE 实例提供协同协议，避免无协调各自为政。<br/>Federated Protocol — v0.10.0 R129<br/>文件: verifiers/federated_protocol.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_golden_test_external_py["golden测试external<br/>golden测试外部。Golden Test<br/>External，校验反馈闭环一致性<br/>Golden Test External — v0.15.0 R214<br/>文件: verifiers/golden_test_external.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_no_llm_degradation_py["noLLM退化<br/>LLM 不可用时降级到规则引擎继续诊断修复，防止<br/>LLM 宕机导致 FLE 整体瘫痪。<br/>No-LLM Degradation Mode — v0.8.0 R94<br/>文件: verifiers/no_llm_degradation.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_pre_flight_simulator_py["preflight模拟器<br/>修复执行前先跑起飞前检查清单，清单全过才放行，防<br/>止未经验证直接上线。<br/>Pre-Flight Simulator — v0.12.0 R169b<br/>文件: verifiers/pre_flight_simulator.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_rollback_integrity_py["回滚完整性<br/>校验一致性（rollback integrity）<br/>Rollback Integrity — v0.3.0 R18b<br/>文件: verifiers/rollback_integrity.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_verifiers_stochastic_diagnosis_verifier_py["stochastic诊断验证器<br/>Stochastic Diagnosis Verifier，校验一致性<br/>文件: verifiers/stochastic_diagnosis_verifier.py<br/>(生产态 / production)"]
    src_zephyr_feedback_loop_verifiers_toctou_revalidation_py["TOCTOU重新验证<br/>反馈闭环的结果，封装操作结果的数据结构（toctou<br/>revalidation）<br/>TOCTOU Revalidation — v0.37.0 R458<br/>文件: verifiers/toctou_revalidation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_feedback_loop_gates_safety_gate_l1_l27_py["安全门禁l1l27<br/>校验反馈闭环一致性（safety gate l1 l27）<br/>文件: gates/safety_gate_l1_l27.py<br/>(生产态 / production)"]
    ...
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_feedback_loop_gates_adversarial_validation_py
    D_FEEDBACK_LOOP -->|导入依赖 / import_depends| src_zephyr_feedback_loop_verifiers_stochastic_diagnosis_verifier_py
    ...
    class D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
```
...
| 36 | D_GOV_CODE_QUALITY 代码质量治理: Test Adversarial Validation / Test Adversarial Validation... | → | 对抗验证 / Adversarial Validation Gate — FLE-ADVERSARIAL... | 测试依赖 / test_depends |

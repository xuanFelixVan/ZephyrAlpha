...
flowchart TD
    ...
    class D_FACTOR,D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_INTELLIGENCE,D_SECURITY,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_REPAIR,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_GOV_ENFORCEMENT external_prod
```

...
flowchart TD
    ...
    class D_SECURITY,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_OPS,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_FACTOR,D_INFRA_A2A,D_GOV_SCRIPTS external_prod

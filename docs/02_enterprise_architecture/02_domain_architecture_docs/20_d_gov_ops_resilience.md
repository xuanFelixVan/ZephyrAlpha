...
flowchart TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_FACTOR,D_INFRA_RUNTIME,D_INFRA_A2A,D_OPS,D_GOV_REPAIR,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_ORCHESTRATOR external_prod

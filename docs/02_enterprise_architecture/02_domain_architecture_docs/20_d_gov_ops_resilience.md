...
flowchart TD
    ...
    src_zephyr_governance_resilience_governance_engine_sandbox_py ~~~ src_zephyr_governance_security_governance_bare_repo_scanner_py
    ...
    class D_INFRA_A2A,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_OPS,D_GOV_REPAIR,D_INTEGRATION,D_SHARED,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod

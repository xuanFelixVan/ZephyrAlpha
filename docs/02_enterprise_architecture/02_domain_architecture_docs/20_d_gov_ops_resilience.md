...
flowchart TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_OPS,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod

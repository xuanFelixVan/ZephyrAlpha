...
flowchart TD
    ...
    tests_governance_orchestrator_test_verify_b54_b56_b59_deep_py -->|测试依赖 / test_depends| D_GOV_RULE
    ...
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_governance_escalation_escalation_engine_py
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_OPS,D_GOV_RULE,D_GOV_REPAIR,D_INFRA_A2A,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod

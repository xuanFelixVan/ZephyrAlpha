...
flowchart TD
    ...
    class D_OPS,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_RULE,D_INFRA_A2A,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SECURITY,D_GOV_REPAIR external_prod

...
flowchart TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_GOV_AUDIT,D_INFRA_A2A,D_INFRA_RECOVERY,D_SHARED,D_GOV_REPAIR,D_GOV_ENFORCEMENT,D_OPS,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INFRA_RUNTIME external_prod

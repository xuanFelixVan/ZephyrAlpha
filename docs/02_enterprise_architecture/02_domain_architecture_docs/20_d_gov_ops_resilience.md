...
flowchart TD
    ...
    tests_governance_orchestrator_test_gate_engine_unit_py -->|测试依赖 / test_depends| D_GOVERNANCE
    ...
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_governance_escalation_triage_py
    ...
    class D_OPS,D_INTEGRATION,D_INFRA_A2A,D_GOVERNANCE,D_SECURITY,D_GOV_REPAIR,D_SHARED,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_prod

...
flowchart TD
    ...
    class D_GOV_AUDIT,D_INFRA_A2A,D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_SHARED,D_GOV_RULE,D_OPS,D_GOV_REPAIR,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod

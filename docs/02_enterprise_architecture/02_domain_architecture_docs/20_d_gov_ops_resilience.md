...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_INTEGRATION,D_SECURITY,D_GOV_RULE,D_GOVERNANCE,D_OPS,D_GOV_REPAIR,D_INFRA_A2A,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FACTOR,D_INFRA_RUNTIME,D_SHARED,D_INFRA_A2A,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_AUDIT,D_SECURITY,D_GOV_REPAIR,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_A2A,D_OPS,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FACTOR,D_INFRA_RUNTIME,D_SHARED,D_INFRA_A2A,D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_OPS,D_GOV_REPAIR,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_SECURITY external_prod
```

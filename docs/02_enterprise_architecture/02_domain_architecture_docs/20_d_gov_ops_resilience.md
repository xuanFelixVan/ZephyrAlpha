...
flowchart TD
    ...
    src_zephyr_governance_resilience_governance_engine_sandbox_py ~~~ src_zephyr_governance_security_governance_compositional_safety_tester_py
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_OPS,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_GOV_AUDIT external_prod

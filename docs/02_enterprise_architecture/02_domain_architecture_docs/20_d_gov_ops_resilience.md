...
flowchart TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_GOVERNANCE,D_INFRA_A2A,D_SECURITY,D_INFRA_RECOVERY,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOV_SCRIPTS,D_OPS,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP external_prod

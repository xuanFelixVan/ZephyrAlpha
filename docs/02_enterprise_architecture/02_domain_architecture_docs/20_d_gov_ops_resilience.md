...
flowchart TD
    ...
    src_zephyr_governance_escalation_incident_response_py["incident响应<br/>治理/escalation包的incident_response模块<br/>文件: escalation/incident_response.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_escalation_result_types_py["结果类型定义<br/>治理/escalation包的result_types模块<br/>G-CT-003 — RollbackResult backward-compat<br/>re-export facade.<br/>文件: escalation/result_types.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_ops_governance_daily_ops_py["daily运维<br/>治理/ops governance包的daily_ops模块<br/>文件: ops_governance/daily_ops.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_ops_governance_ops_foundation_py["运维foundation<br/>治理/ops governance包的ops_foundation模块<br/>文件: ops_governance/ops_foundation.py<br/>(生产态 / production)"]
    src_zephyr_governance_ops_governance_parent_child_attributor_py["父子attributor<br/>治理/ops governance包的parent_child_<br/>attributor模块<br/>文件: ops_governance/parent_child_attributor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_ops_governance_startup_shutdown_py["启动关机<br/>治理/ops governance包的startup_shutdown模块<br/>文件: ops_governance/startup_shutdown.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_init_py["governance/resilience_governance 包入口<br/>管理governance.resilience_<br/>governance子包的加载和懒导入<br/>文件: resilience_governance/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_broker_resilience_py["经纪人韧性<br/>治理/resilience governance包的broker_<br/>resilience模块<br/>文件: resilience_governance/broker_resilience.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_decision_fatigue_cli_py["决策疲劳命令行<br/>治理/resilience governance包的decision_fatigue_<br/>cli模块<br/>文件: resilience_governance/decision_fatigue_<br/>cli.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_fail_mode_manager_py["failmode管理器<br/>治理/resilience governance包的fail_mode_<br/>manager模块<br/>文件: resilience_governance/fail_mode_manager.py<br/>(生产态 / production)"]
    src_zephyr_governance_resilience_governance_fault_tolerance_py["故障容错<br/>治理/resilience governance包的fault_<br/>tolerance模块<br/>文件: resilience_governance/fault_tolerance.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_security_governance_init_py["governance/security_governance 包入口<br/>管理governance.security_<br/>governance子包的加载和懒导入<br/>文件: security_governance/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_security_governance_anti_automation_bias_py["anti自动化bias<br/>治理/security governance包的anti_automation_<br/>bias模块<br/>Anti-Automation Bias — D-022-09 mandatory human<br/>oversight enforcement.<br/>文件: security_governance/anti_automation_<br/>bias.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_decision_fatigue_py["决策疲劳<br/>治理/resilience governance包的decision_<br/>fatigue模块<br/>文件: resilience_governance/decision_fatigue.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_security_governance_security_gateway_base_py["安全网关基类<br/>治理/security governance包的security_gateway_<br/>base模块<br/>D_COMPLIANCE — Governance & Compliance Layer<br/>文件: security_governance/security_gateway_<br/>base.py<br/>(生产态 / production)"]
    ...
    class D_GOV_AUDIT,D_INFRA_A2A,D_GOVERNANCE,D_SECURITY,D_SHARED,D_INTEGRATION,D_OPS,D_GOV_REPAIR,D_ORCHESTRATOR,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_INFRA_RUNTIME external_prod

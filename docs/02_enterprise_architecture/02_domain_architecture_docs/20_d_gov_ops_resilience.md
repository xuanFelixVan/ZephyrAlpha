...
flowchart TD
    src_zephyr_governance_budget_enforcer_init_py["governance/budget-enforcer 包入口<br/>治理域包入口，归集子模块按需懒加载<br/>文件: budget-enforcer/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_escalation_result_types_py["结果类型定义<br/>结果类型定义。G-CT-003 — RollbackResult<br/>backward-compat re-export facade<br/>G-CT-003 — RollbackResult backward-compat<br/>re-export facade.<br/>文件: escalation/result_types.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_ops_governance_startup_shutdown_py["启动关机<br/>startup_shutdown<br/>文件: ops_governance/startup_shutdown.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_init_py["governance/resilience_governance 包入口<br/>治理域包入口，归集子模块按需懒加载<br/>文件: resilience_governance/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_security_governance_init_py["governance/security_governance 包入口<br/>治理域包入口，归集子模块按需懒加载<br/>文件: security_governance/__init__.py<br/>(生产态 / production)"]
    src_zephyr_governance_security_governance_anti_automation_bias_py["anti自动化bias<br/>anti自动化bias，提供包入口和模块加载功能<br/>Anti-Automation Bias — D-022-09 mandatory human<br/>oversight enforcement.<br/>文件: security_governance/anti_automation_<br/>bias.py<br/>(生产态 / production)"]

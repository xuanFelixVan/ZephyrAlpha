...
flowchart TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_OPS,D_INFRA_A2A,D_GOV_AUDIT,D_SECURITY,D_SHARED,D_GOV_REPAIR,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_ORCHESTRATOR external_prod

...
flowchart TD
    ...
    class D_OPS,D_INFRA_A2A,D_GOVERNANCE,D_INTEGRATION,D_GOV_RULE,D_SHARED,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod

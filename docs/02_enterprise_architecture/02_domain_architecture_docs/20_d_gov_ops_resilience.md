...
flowchart TD
    ...
    D_GOV_AUDIT -->|测试依赖 / test_depends| src_zephyr_governance_security_governance_tamper_evident_log_py
    ...
    class D_INTELLIGENCE,D_GOVERNANCE,D_OPS,D_INTEGRATION,D_INFRA_A2A,D_GOV_AUDIT,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_REPAIR external_prod

...
flowchart TD
    ...
    class D_OPS,D_INFRA_A2A,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOVERNANCE,D_FACTOR,D_INTEGRATION,D_GOV_RULE,D_SHARED,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_INFRA_RUNTIME external_prod

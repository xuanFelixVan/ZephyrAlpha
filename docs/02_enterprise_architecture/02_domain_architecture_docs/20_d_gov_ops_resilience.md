...
flowchart TD
    ...
    class D_GOVERNANCE,D_OPS,D_GOV_AUDIT,D_SECURITY,D_INFRA_A2A,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_INFRA_RUNTIME external_prod

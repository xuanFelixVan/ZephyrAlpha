...
flowchart TD
    src_zephyr_governance_budget_enforcer_init_py["governance/budget-enforcer 包入口<br/>__init__<br/>文件: budget-enforcer/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_escalation_consequence_manager_py["consequence管理器<br/>consequence_manager<br/>文件: escalation/consequence_manager.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_ops_governance_cost_attributor_py["成本attributor<br/>cost_attributor<br/>文件: ops_governance/cost_attributor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_init_py["governance/resilience_governance 包入口<br/>__init__<br/>文件: resilience_governance/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_fail_mode_manager_py["failmode管理器<br/>fail_mode_manager<br/>文件: resilience_governance/fail_mode_manager.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_security_governance_init_py["governance/security_governance 包入口<br/>__init__<br/>文件: security_governance/__init__.py<br/>(生产态 / production)"]
    src_zephyr_governance_security_governance_anti_automation_bias_py["anti自动化bias<br/>Anti-Automation Bias — D-022-09 mandatory human<br/>oversight en<br/>文件: security_governance/anti_automation_<br/>bias.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_security_governance_poison_cascade_detector_py["poison级联检测器<br/>poison_cascade_detector<br/>文件: security_governance/poison_cascade_<br/>detector.py<br/>(生产态 / production)"]

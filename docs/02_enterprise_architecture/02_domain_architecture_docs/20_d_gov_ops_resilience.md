...
flowchart TD
    ...
    src_zephyr_governance_ops_governance_tco_model_py ~~~ src_zephyr_governance_resilience_governance_deadlock_detector_py
    ...
    class D_SHARED,D_GOVERNANCE,D_OPS,D_GOV_ENFORCEMENT,D_INFRA_A2A,D_INFRA_RECOVERY,D_FEEDBACK_LOOP external_prod

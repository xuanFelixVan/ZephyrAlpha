...
flowchart TD
    ...
    class D_SHARED,D_FACTOR,D_INFRA_RUNTIME,D_INFRA_A2A,D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_OPS,D_GOV_SCRIPTS external_prod

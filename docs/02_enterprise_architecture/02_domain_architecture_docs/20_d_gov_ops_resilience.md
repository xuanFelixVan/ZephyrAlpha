...
flowchart TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_OPS,D_INFRA_RUNTIME,D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_A2A,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_INFRA_RECOVERY external_prod

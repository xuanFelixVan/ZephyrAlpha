...
flowchart TD
    ...
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_governance_ops_governance_ops_foundation_py
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_governance_escalation_contracts_py
    ...
    class D_SHARED,D_OPS,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_INFRA_A2A external_prod

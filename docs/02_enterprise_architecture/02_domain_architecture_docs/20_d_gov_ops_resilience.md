...
flowchart TD
    ...
    tests_governance_orchestrator_test_verify_b54_b56_b59_deep_py -->|测试依赖 / test_depends| D_SHARED
    tests_governance_orchestrator_test_verify_b54_b56_b59_deep_py -->|测试依赖 / test_depends| D_SHARED
    ...
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_governance_escalation_result_types_py
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_governance_security_governance_bare_repo_scanner_py
    ...
    class D_GOVERNANCE,D_FACTOR,D_OPS,D_GOV_CODE_QUALITY,D_SHARED,D_GOV_RULE,D_INFRA_RECOVERY,D_SECURITY,D_INTEGRATION,D_INFRA_RUNTIME external_prod

...
flowchart TD
    ...
    class D_GOV_REPAIR,D_GOVERNANCE,D_INFRA_A2A,D_INTEGRATION,D_OPS,D_SHARED,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod

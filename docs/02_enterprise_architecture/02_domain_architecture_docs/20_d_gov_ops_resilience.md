...
flowchart TD
    ...
    class D_INFRA_A2A,D_INTEGRATION,D_SECURITY,D_GOV_AUDIT,D_GOVERNANCE,D_SHARED,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_GOV_SCRIPTS,D_OPS,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod

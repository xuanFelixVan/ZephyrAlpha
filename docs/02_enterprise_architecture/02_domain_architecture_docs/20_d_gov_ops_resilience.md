...
flowchart TD
    ...
    class D_INFRA_RECOVERY,D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_OPS,D_FEEDBACK_LOOP,D_SECURITY,D_GOV_REPAIR,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_prod
```

...
flowchart TD
    ...
    class D_OPS,D_SHARED,D_SECURITY,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_RULE,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INFRA_A2A external_prod
```

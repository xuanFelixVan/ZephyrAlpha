...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_RULE,D_GOVERNANCE,D_OPS,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_GOV_AUDIT,D_INFRA_RUNTIME,D_INFRA_A2A external_prod
```
...
flowchart TD
    ...
    src_zephyr_governance_ops_governance_phase_check_registry_py ~~~ src_zephyr_governance_resilience_governance_blast_radius_py
    ...
    class D_INFRA_RECOVERY,D_GOV_AUDIT,D_SHARED,D_INTELLIGENCE,D_GOVERNANCE,D_OPS,D_INTEGRATION,D_INFRA_A2A,D_SECURITY,D_INFRA_RUNTIME,D_GOV_REPAIR,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_GOV_ENFORCEMENT external_prod
```

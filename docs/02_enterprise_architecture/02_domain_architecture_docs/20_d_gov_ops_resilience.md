...
flowchart TD
    ...
    src_zephyr_governance_security_governance_config_scanner_py ~~~ src_zephyr_governance_security_governance_default_security_gateway_py
    ...
    src_zephyr_governance_resilience_governance_decision_fatigue_py ~~~ src_zephyr_governance_security_governance_credential_guard_py
    src_zephyr_governance_security_governance_credential_guard_py ~~~ src_zephyr_governance_security_governance_ipi_defense_py
    ...
    src_zephyr_governance_security_governance_init_py -->|config_depends / config_depends| src_zephyr_governance_security_governance_credential_guard_py
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_OPS,D_SECURITY,D_GOV_AUDIT,D_INFRA_A2A,D_SHARED,D_GOV_REPAIR,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INFRA_RUNTIME external_prod

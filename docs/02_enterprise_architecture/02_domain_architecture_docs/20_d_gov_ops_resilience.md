...
flowchart TD
    src_zephyr_governance_budget_enforcer_init_py["包入口<br/>governance/budget-enforcer<br/>包入口，管理该层子模块的统一加载和懒导入<br/>__init__<br/>文件: budget-enforcer/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_resilience_governance_init_py["包入口<br/>governance/resilience_governance<br/>包入口，管理该层子模块的统一加载和懒导入<br/>__init__<br/>文件: resilience_governance/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_security_governance_init_py["包入口<br/>governance/security_governance<br/>包入口，管理该层子模块的统一加载和懒导入<br/>__init__<br/>文件: security_governance/__init__.py<br/>(生产态 / production)"]

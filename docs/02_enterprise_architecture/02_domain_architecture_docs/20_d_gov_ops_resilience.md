...
flowchart TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_OPS,D_INFRA_A2A,D_GOVERNANCE,D_GOV_RULE,D_SECURITY,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod

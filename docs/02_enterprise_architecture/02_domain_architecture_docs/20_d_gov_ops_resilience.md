...
flowchart TD
    ...
    class D_OPS,D_SECURITY,D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_A2A,D_INTEGRATION,D_SHARED,D_GOV_REPAIR,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod

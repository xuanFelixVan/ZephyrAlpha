...
flowchart TD
    ...
    src_zephyr_governance_ops_governance_stream_abort_guard_py ~~~ src_zephyr_governance_resilience_governance_deadlock_detector_py
    ...
    class D_GOV_AUDIT,D_INFRA_A2A,D_INTEGRATION,D_GOVERNANCE,D_SECURITY,D_SHARED,D_OPS,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INFRA_RUNTIME external_prod

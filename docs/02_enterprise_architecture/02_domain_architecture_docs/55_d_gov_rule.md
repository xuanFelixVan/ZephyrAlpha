...
flowchart TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_INTEGRATION,D_SECURITY external_prod
```

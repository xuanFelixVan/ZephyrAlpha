...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INTELLIGENCE,D_SECURITY external_prod
```

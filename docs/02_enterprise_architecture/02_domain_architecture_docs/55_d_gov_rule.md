...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_SECURITY,D_INTELLIGENCE,D_INTEGRATION,D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_INFRA_RUNTIME,D_SECURITY,D_INTELLIGENCE,D_INTEGRATION,D_GOV_SCRIPTS external_prod
```

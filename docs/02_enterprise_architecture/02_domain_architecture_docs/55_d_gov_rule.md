...
flowchart TD
    ...
    src_zephyr_gov_enforcement_rule_enforcement_cbac_matrix_py ~~~ src_zephyr_gov_enforcement_rule_enforcement_end_to_end_walkthrough_py
    src_zephyr_gov_enforcement_rule_enforcement_end_to_end_walkthrough_py ~~~ src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_engine_py
    ...
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_kiss_enforcer_py
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_SECURITY,D_INFRA_RUNTIME external_prod

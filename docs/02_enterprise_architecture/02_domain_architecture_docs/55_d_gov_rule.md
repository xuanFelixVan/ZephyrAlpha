...
|:--:|---------|---------|:---:|:---:|
| 1 | scripts/governance/generators/generate_script_manifest.py | 脚本清单自动生成器 / Script Manifest Generator | 生产态 / production | [MOD-INF-005](../../03_modules/_domain_governance/governance_automation/blueprint.md) |
| 2 | src/zephyr/gov_enforcement/rule_enforcement/adaptive_thre... | 自适应阈值 / Adaptive Threshold | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 3 | src/zephyr/gov_enforcement/rule_enforcement/adversarial_s... | 对抗样本生成器 / Adversarial Strategies | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 4 | src/zephyr/gov_enforcement/rule_enforcement/ai_capability... | AI 能力边界守卫 / AI Capability Guard | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 5 | src/zephyr/gov_enforcement/rule_enforcement/anti_pattern_... | 反模式防护引擎 / Anti-Pattern Guard | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 6 | src/zephyr/gov_enforcement/rule_enforcement/can_i_deploy.py | 预部署门禁 / Can-I-Deploy | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
...
| 8 | src/zephyr/gov_enforcement/rule_enforcement/cbac_matrix.py | CBAC 能力矩阵 / CBAC Matrix | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 9 | src/zephyr/gov_enforcement/rule_enforcement/cdc_broker.py | CDC 契约经纪人 / CDC Broker | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 10 | src/zephyr/gov_enforcement/rule_enforcement/circuit_break... | 单向熔断器 / Circuit Breaker | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 11 | src/zephyr/gov_enforcement/rule_enforcement/contract_temp... | 契约模板管理器 / Contract Template Manager | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 12 | src/zephyr/gov_enforcement/rule_enforcement/end_to_end_wa... | 端到端走查验证器 / End-to-End Walkthrough | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 13 | src/zephyr/gov_enforcement/rule_enforcement/gate_engine/_... | 门禁引擎模块集 / Gate Engine Package | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 14 | src/zephyr/gov_enforcement/rule_enforcement/gate_engine/a... | 对抗验证门禁 / Adversarial Validation | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 15 | src/zephyr/gov_enforcement/rule_enforcement/gate_engine/g... | 门禁上下文传播 / Gate Context | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 16 | src/zephyr/gov_enforcement/rule_enforcement/gate_engine/g... | 门禁裁决引擎 / Gate Engine | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 17 | src/zephyr/gov_enforcement/rule_enforcement/gate_engine/g... | 门禁紧急旁路 / Gate Override | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 18 | src/zephyr/gov_enforcement/rule_enforcement/gate_engine/g... | 门禁评估管线 / Gate Pipeline | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 19 | src/zephyr/gov_enforcement/rule_enforcement/gate_engine/g... | 门禁模拟器 / Gate Simulator | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 20 | src/zephyr/gov_enforcement/rule_enforcement/gate_types.py | 门禁类型定义 / Gate Types | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
...
| 22 | src/zephyr/gov_enforcement/rule_enforcement/invariants/en... | 循环依赖扫描器 / Circular Dependency Scanner | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 23 | src/zephyr/gov_enforcement/rule_enforcement/invariants/en... | 契约兼容性检查器 / Contract Compatibility Checker | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 24 | src/zephyr/gov_enforcement/rule_enforcement/invariants/en... | 进程生命周期网关 / Process Lifecycle Gateway | 生产态 / production | [MOD-INF-016](../../03_modules/_cross_layer/shared_core/blueprint.md) |
| 25 | src/zephyr/gov_enforcement/rule_enforcement/invariants/ze... | 零残留检查器 / Zero Residue Check | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 26 | src/zephyr/gov_enforcement/rule_enforcement/kiss_enforcer.py | KISS 约束执行器 / KISS Enforcer | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 27 | src/zephyr/gov_enforcement/rule_enforcement/risk_ssot.py | 风险真源加载器 / Risk SSoT | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
...
| 30 | src/zephyr/gov_enforcement/rule_enforcement/secrets_guard.py | Secrets 守护 / Secrets Guard | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 31 | src/zephyr/gov_enforcement/rule_enforcement/task_completi... | 任务完成门禁 / Task Completion Gate | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 32 | src/zephyr/gov_enforcement/rule_enforcement/task_types.py | 任务类型定义 / Task Types | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 33 | src/zephyr/gov_enforcement/rule_enforcement/triple_alignm... | 三方对齐门禁 / Triple Alignment | 生产态 / production | [MOD-GATE_ENGINE](../../03_modules/_cross_layer/gate_engine/blueprint.md) |
| 34 | src/zephyr/gov_rule/__init__.py | 规则治理域包 / Gov Rule Package | 生产态 / production |  |
| 35 | src/zephyr/gov_rule/constitutional_update/constitutional_... | 宪法自愈 / Constitutional Update | 生产态 / production | [MOD-GOVERNANCE](../../03_modules/_domain_governance/blueprint.md) |
...
flowchart TD
    scripts_governance_generators_generate_script_manifest_py["(生产态 / production) 脚本清单自动生成器 / Script Manifest Generator<br/>generate_script_manifest.py — 脚本清单自动生成器<br/>文件: generators/generate_script_manifest.py"]
    src_zephyr_gov_enforcement_rule_enforcement_adaptive_threshold_py["(生产态 / production) 自适应阈值 / Adaptive Threshold<br/>自适应阈值——双模式：概率型（PASS/FAIL outcome 调节）+ 次数型（EWMA 基线 × ...<br/>文件: rule_enforcement/adaptive_threshold.py"]
    src_zephyr_gov_enforcement_rule_enforcement_adversarial_strategies_py["(生产态 / production) 对抗样本生成器 / Adversarial Strategies<br/>对抗样本生成器——5 种攻击策略用于门禁验证（Adversarial sample generator with...<br/>文件: rule_enforcement/adversarial_strategies.py"]
    src_zephyr_gov_enforcement_rule_enforcement_ai_capability_guard_py["(生产态 / production) AI 能力边界守卫 / AI Capability Guard<br/>AI 能力边界守卫——@require_capability 装饰器运行时检查（AI capability bounda...<br/>文件: rule_enforcement/ai_capability_guard.py"]
    src_zephyr_gov_enforcement_rule_enforcement_anti_pattern_guard_py["(生产态 / production) 反模式防护引擎 / Anti-Pattern Guard<br/>Anti-Patterns 防护引擎（Anti-Pattern Guard）<br/>文件: rule_enforcement/anti_pattern_guard.py"]
    src_zephyr_gov_enforcement_rule_enforcement_can_i_deploy_py["(生产态 / production) 预部署门禁 / Can-I-Deploy<br/>Can-I-Deploy 预部署门禁（GATE-CDC-1）<br/>文件: rule_enforcement/can_i_deploy.py"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_cdc_broker_py["(生产态 / production) CDC 契约经纪人 / CDC Broker<br/>CDC 契约经纪人（Consumer-Driven Contract Broker — CT-CDC-001）<br/>文件: rule_enforcement/cdc_broker.py"]
    src_zephyr_gov_enforcement_rule_enforcement_contract_template_manager_py["(生产态 / production) 契约模板管理器 / Contract Template Manager<br/>契约模板管理器——管理 MCP 工具契约模板（Contract template manager for MCP to...<br/>文件: rule_enforcement/contract_template_manager.py"]
    src_zephyr_gov_enforcement_rule_enforcement_end_to_end_walkthrough_py["(生产态 / production) 端到端走查验证器 / End-to-End Walkthrough<br/>端到端场景走查验证器（End-to-End Walkthrough Validator）。<br/>文件: rule_enforcement/end_to_end_walkthrough.py"]
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_init_py["(生产态 / production) 门禁引擎模块集 / Gate Engine Package<br/>gate_engine package — 门禁引擎模块集合（ARCH-042 阶段1 拆分产物）。<br/>文件: gate_engine/__init__.py"]
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_engine_py["(生产态 / production) 门禁裁决引擎 / Gate Engine<br/>GateEngine — KMS G1-G6 + Orc G0/G7 + 交易 G10-G12 门禁裁决引擎（T-2-17）<br/>文件: gate_engine/gate_engine.py"]
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_override_py["(生产态 / production) 门禁紧急旁路 / Gate Override<br/>Owner 紧急旁路——时间限定的门禁临时绕过 + 审计追踪（beta）<br/>文件: gate_engine/gate_override.py"]
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_simulator_py["(生产态 / production) 门禁模拟器 / Gate Simulator<br/>门禁模拟器——dry-run 全链路门禁演练，不修改任何状态（beta）<br/>文件: gate_engine/gate_simulator.py"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_invariants_en_process_lifecycle_gateway_py["(生产态 / production) 进程生命周期网关 / Process Lifecycle Gateway<br/>EN-process-lifecycle-gateway — 进程创建入口校验门禁<br/>文件: invariants/en_process_lifecycle_gateway.py"]
    src_zephyr_gov_enforcement_rule_enforcement_kiss_enforcer_py["(生产态 / production) KISS 约束执行器 / KISS Enforcer<br/>KISS 约束执行器（CT-KISS-001）——AI产出复杂度检测+bloat check。<br/>文件: rule_enforcement/kiss_enforcer.py"]
    src_zephyr_gov_enforcement_rule_enforcement_rule_engine_init_py["(生产态 / production) 规则引擎模块集 / Rule Engine Package<br/>rule_engine package — 规则引擎模块集合（ARCH-042 阶段1 拆分产物）。<br/>文件: rule_engine/__init__.py"]
    src_zephyr_gov_enforcement_rule_enforcement_rule_engine_rule_engine_py["(生产态 / production) 规则加载器 / Rule Loader<br/>RuleLoader — 规则加载核心 API<br/>文件: rule_engine/rule_engine.py"]
    src_zephyr_gov_enforcement_rule_enforcement_secrets_guard_py["(生产态 / production) Secrets 守护 / Secrets Guard<br/>Secrets 守护（CT-SECRETS-001）——.env校验+git log扫描+日志脱敏。<br/>文件: rule_enforcement/secrets_guard.py"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_cbac_matrix_py["(生产态 / production) CBAC 能力矩阵 / CBAC Matrix<br/>CBAC 能力矩阵（Capability-Based Access Control Matrix — CT-CBAC-001）<br/>文件: rule_enforcement/cbac_matrix.py"]
    src_zephyr_gov_enforcement_rule_enforcement_circuit_breaker_py["(生产态 / production) 单向熔断器 / Circuit Breaker<br/>CircuitBreakerGateway (CBG) — 模块间调用单向熔断器<br/>文件: rule_enforcement/circuit_breaker.py"]
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_adversarial_validation_py["(生产态 / production) 对抗验证门禁 / Adversarial Validation<br/>对抗验证门禁——验证输出对抗对抗性攻击（AdversarialValidationGate: validates ...<br/>文件: gate_engine/adversarial_validation.py"]
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_pipeline_py["(生产态 / production) 门禁评估管线 / Gate Pipeline<br/>门禁评估管线——排序解析、组合逻辑（AND/OR/NOT）、并行调度（beta）<br/>文件: gate_engine/gate_pipeline.py"]
    src_zephyr_gov_enforcement_rule_enforcement_gate_types_py["(生产态 / production) 门禁类型定义 / Gate Types<br/>门禁类型定义——GateType 枚举与 gate 相关 dataclass（GateContext/GateResult 等）。<br/>文件: rule_enforcement/gate_types.py"]
    src_zephyr_gov_enforcement_rule_enforcement_invariants_en_001_circular_dependency_py["(生产态 / production) 循环依赖扫描器 / Circular Dependency Scanner<br/>EN-001 循环依赖扫描器——Kahn 拓扑排序检测模块导入环（Circular Dependency Sca...<br/>文件: invariants/en_001_circular_dependency.py"]
    src_zephyr_gov_enforcement_rule_enforcement_invariants_en_003_contract_compatibility_py["(生产态 / production) 契约兼容性检查器 / Contract Compatibility Checker<br/>EN-003 契约兼容性检查器——字段/类型/必填对齐差异比对（Contract Compatibility...<br/>文件: invariants/en_003_contract_compatibility.py"]
    src_zephyr_gov_enforcement_rule_enforcement_invariants_zero_residue_check_py["(生产态 / production) 零残留检查器 / Zero Residue Check<br/>零残留检查器——验证治理操作后无残留文件/目录/引用。<br/>文件: invariants/zero_residue_check.py"]
    src_zephyr_gov_enforcement_rule_enforcement_risk_ssot_py["(生产态 / production) 风险真源加载器 / Risk SSoT<br/>risk_ssot — 从 ``config/risk_params.yaml`` 加载风险真源（INV-002 等）<br/>文件: rule_enforcement/risk_ssot.py"]
    ...
    src_zephyr_gov_enforcement_rule_enforcement_gate_engine_gate_context_py["(生产态 / production) 门禁上下文传播 / Gate Context<br/>门禁上下文传播——GateContext 构建/序列化/跨模块注入（beta）<br/>文件: gate_engine/gate_context.py"]
...
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#eaeaea', 'primaryTextColor': '#333333', 'primaryBorderColor': '#666666', 'lineColor': '#666666', 'secondaryColor': '#eaeaea', 'tertiaryColor': '#eaeaea', 'fontSize': '14px'}}}%%
flowchart TD
    src_zephyr_gov_enforcement_rule_enforcement_task_completion_gate_py["(生产态 / production) 任务完成门禁 / Task Completion Gate<br/>TaskCompletionGate: scan for residual files outside files_in_scope<br/>文件: rule_enforcement/task_completion_gate.py"]
    src_zephyr_gov_enforcement_rule_enforcement_task_types_py["(生产态 / production) 任务类型定义 / Task Types<br/>任务类型定义——Task model 是任务卡字段的 SSoT（SQLite tasks 表对齐）。<br/>文件: rule_enforcement/task_types.py"]
    src_zephyr_gov_enforcement_rule_enforcement_triple_alignment_py["(生产态 / production) 三方对齐门禁 / Triple Alignment<br/>G-TRIPLE-ALIGN: 蓝图↔代码↔依赖图三方对齐门禁<br/>文件: rule_enforcement/triple_alignment.py"]
    src_zephyr_gov_rule_init_py["(生产态 / production) 规则治理域包 / Gov Rule Package<br/>gov_rule domain package — rule governance (D_GOV_RULE).<br/>文件: gov_rule/__init__.py"]
    src_zephyr_gov_rule_constitutional_update_constitutional_update_py["(生产态 / production) 宪法自愈 / Constitutional Update<br/>constitutional_update.py —— 宪法自愈（Phase 14 / 盲点 B27）<br/>文件: constitutional_update/constitutional_update.py"]

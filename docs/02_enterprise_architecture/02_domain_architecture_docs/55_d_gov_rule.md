...
flowchart TD
    ...
    src_zephyr_gov_enforcement_rule_enforcement_circuit_breaker_py -->|导入依赖 / import_depends| D_SHARED
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_circuit_breaker_py
    ...
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_invariants_en_process_lifecycle_gateway_py
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_integration_test_runner_py
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_INTEGRATION,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
```

...
flowchart TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_SCRIPTS,D_GOV_DRIFT,D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY external_prod
...
| 8 | 规则引擎模块集 / Rule Engine Package (rule_engine/__init_... | → | D_GOV_ENFORCEMENT 规则执行: mtime 轮询 + 自动同步 + 验证 / Rule Watcher (rule_engine/... | config_depends / config_depends |

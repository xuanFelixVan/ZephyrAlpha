...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_SHARED,D_GOV_DRIFT,D_INTELLIGENCE,D_INTEGRATION,D_GOV_SCRIPTS,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
```

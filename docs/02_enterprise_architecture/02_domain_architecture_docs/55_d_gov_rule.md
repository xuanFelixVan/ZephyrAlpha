...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INTEGRATION,D_AUTONOMY_CORE,D_SECURITY external_prod
```
...
| 8 | 规则引擎模块集 / Rule Engine Package (rule_engine/__init_... | → | D_GOV_ENFORCEMENT 规则执行: 规则影子运行器 / Rule Shadow Runner (rule_engine/rule_sha... | config_depends / config_depends |

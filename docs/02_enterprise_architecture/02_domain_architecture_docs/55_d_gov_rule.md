...
flowchart TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SECURITY,D_INTELLIGENCE external_prod
```

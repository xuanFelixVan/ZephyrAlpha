...
flowchart TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INTELLIGENCE external_prod
...
| 6 | 门禁引擎模块集 / Gate Engine Package (gate_engine/__init_... | → | D_GOV_DRIFT 漂移检测: 自检SHA-256校验+trust root自验证 / Gate Integrity Guard (... | config_depends / config_depends |

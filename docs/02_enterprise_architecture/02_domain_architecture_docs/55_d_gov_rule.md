...
flowchart TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_SECURITY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_AUDIT,D_INTELLIGENCE external_prod
```

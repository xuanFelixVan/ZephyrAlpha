...
flowchart TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
```
...
| 8 | 规则引擎模块集 / Rule Engine Package (rule_engine/__init_... | → | D_GOV_ENFORCEMENT 规则执行: Rule Shadow Runner — v0.10.0 规则影子模式: 新规则shadow... | config_depends / config_depends |

...
flowchart TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_SECURITY,D_GOV_SCRIPTS external_prod
```

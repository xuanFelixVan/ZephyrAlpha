...
> 按 architecture_layer 分层显示 报告（D_REPORTING）的模块分布。共 5 个模块 / 5 modules。
...
| 2 | src/zephyr/reporting/analytics_base.py | src/zephyr/reporting/analytics_base.py | prototype | generated |
| 3 | src/zephyr/reporting/default_attribution_engine.py | src/zephyr/reporting/default_attribut... | prototype | generated |
| 4 | src/zephyr/reporting/default_tca_engine.py | src/zephyr/reporting/default_tca_engi... | prototype | generated |

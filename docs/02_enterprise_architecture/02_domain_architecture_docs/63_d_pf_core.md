...
flowchart TD
    ...
    src_zephyr_pf_core_core_strategy_engine_py -->|导入依赖 / import_depends| D_SHARED
    ...
    class D_POSITION,D_RISK,D_INFRASTRUCTURE,D_PF_ALLOC,D_REPORTING,D_GOVERNANCE,D_SHARED,D_EX_CORE external_prod
```

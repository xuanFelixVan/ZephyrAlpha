...
flowchart TD
    ...
    src_zephyr_pf_core_strategy_engine_init_py["pf_core/strategy_engine 包入口<br/>管理pf_core.strategy_engine子包加载<br/>D_PORTFOLIO_CORE — Portfolio Construction<br/>Strategies<br/>文件: strategy_engine/__init__.py<br/>(生产态 / production)"]

...
flowchart TD
    ...
    src_zephyr_pf_core_strategy_engine_init_py["包入口<br/>包入口。D_PORTFOLIO_CORE — Portfolio<br/>Construction Strategies<br/>文件: strategy_engine/__init__.py<br/>(生产态 / production)"]

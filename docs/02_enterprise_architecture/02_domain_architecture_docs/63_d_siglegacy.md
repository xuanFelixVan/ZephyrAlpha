...
graph TD
    ...
    src_zephyr_signal_fundamental_combiner_init_py -.->|导入依赖 / import_depends| D_SIGQC
    ...
    src_zephyr_signal_fundamental_combiner_init_py -.->|导入依赖 / import_depends| D_INFRASTRUCTURE
    ...
    class D_SIGQC,D_FUNDAMENTAL_SIGNAL external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | Signal Capital Allocation sub-package (__init__... | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_FUNDAMENTAL_SIGNAL — CapitalAllocationResult... | 导入依赖 / import_depends |
| 2 | Signal Capital Allocation sub-package (__init__... | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Capital Allocator（兼容 re-export s... | 导入依赖 / import_depends |
| 3 | Signal Capital Allocation sub-package (__init__... | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Default Capital Allocator（兼容 re-... | 导入依赖 / import_depends |
| 4 | D_SIGNAL Signal Combiner (__init__.py) | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Signal Generation Layer (aggregator... | 导入依赖 / import_depends |
| 5 | D_SIGNAL Signal Combiner (__init__.py) | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_FUNDAMENTAL_SIGNAL — Capital Allocator（兼容... | 导入依赖 / import_depends |
| 6 | D_SIGNAL Signal Combiner (__init__.py) | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Signal Synthesizer (signal_synthesi... | 导入依赖 / import_depends |
| 7 | D_SIGNAL — Signal Combiner Concrete Implementa... | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Default Signal Aggregator (default_... | 导入依赖 / import_depends |
| 8 | D_SIGNAL — Signal Combiner Concrete Implementa... | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Default Capital Allocator (default_... | 导入依赖 / import_depends |
| 9 | Signal Generation sub-package (__init__.py) | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Signal Generation Layer (aggregator... | config_depends / config_depends |
| 10 | D_SIGNAL — Signal Generation Concrete Implemen... | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Default Signal Aggregator (default_... | 导入依赖 / import_depends |
| 11 | Signal Strategy sub-package (__init__.py) | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_FUNDAMENTAL_SIGNAL — Capital Allocator（兼容... | 导入依赖 / import_depends |
| 12 | Signal Strategy Concrete Implementations (__ini... | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Default Capital Allocator (default_... | 导入依赖 / import_depends |
| 13 | Signal Synthesis sub-package (__init__.py) | → | D_FUNDAMENTAL_SIGNAL 基本面信号: D_SIGNAL — Signal Synthesizer (signal_synthesi... | 导入依赖 / import_depends |
| 14 | D_SIGNAL Signal Combiner (__init__.py) | → | D_INFRASTRUCTURE: synthesized_signal.py | 导入依赖 / import_depends |
| 15 | D_SIGNAL Signal Combiner (__init__.py) | → | D_SIGQC 信号质量控制: D_SIGQC — Signal Quality Degradation Monitor B... | 导入依赖 / import_depends |

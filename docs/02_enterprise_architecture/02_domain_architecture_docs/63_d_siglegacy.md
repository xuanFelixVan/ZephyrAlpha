...
graph TD
    ...
    class D_FACTOR,D_FUNDAMENTAL_SIGNAL,D_INTELLIGENCE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_signal_fundamental_pipeline_py production
    class D_TRADING,D_FUNDAMENTAL_SIGNAL,D_FACTOR,D_SHARED external_prod
...
graph TD
    ...
    class D_FACTOR,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | D_SIGNAL Signal Domain (__init__.py) | → | D_FACTOR 因子: D_FACTOR — Momentum Factor (momentum_factor.py) | contract / contract |

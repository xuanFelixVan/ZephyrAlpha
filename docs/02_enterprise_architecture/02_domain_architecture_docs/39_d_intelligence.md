...
# 39_d_intelligence / context_management / Context Management
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_INTEGRATION,D_BACKTEST,D_TRADING external_prod

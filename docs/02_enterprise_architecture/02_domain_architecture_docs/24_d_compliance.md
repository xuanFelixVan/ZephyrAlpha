...
graph TD
    ...
    src_zephyr_compliance_init_py -.->|config_depends| src_zephyr_compliance_security_gateway_base_py
...
> 按 architecture_layer 分层显示 合规（D_COMPLIANCE）的模块分布。共 24 个模块 / 24 modules。
...
│                 [config_depends] (1 条 / edges)                  │
├──────────────────────────────────────────────────────────────────┤
│   __init__.py → security_gateway_base.py                         │
└──────────────────────────────────────────────────────────────────┘

...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_SECURITY external_prod
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_evolution_engine_py
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_forensic_deterministic_replay_py
...
graph TD
    ...
    class D_OPS,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_SECURITY external_prod

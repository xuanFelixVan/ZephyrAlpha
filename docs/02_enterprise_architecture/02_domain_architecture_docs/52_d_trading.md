...
| 跨域入边 | 747 | Cross-domain Incoming | 747 |
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_diagnosers_cognitive_cognitive_load_budget_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_evolution_init_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_execution_init_py -.->|config_depends| src_zephyr_trading_orchestrator_execution_context_bridge_py
...
| D_GOVERNANCE | 61 | import_depends,runtime |

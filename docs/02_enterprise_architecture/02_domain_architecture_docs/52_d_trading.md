...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_A2A,D_SECURITY external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INFRA_TELEMETRY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_INFRA_TELEMETRY,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
    class D_AUDITTEST external_design
```

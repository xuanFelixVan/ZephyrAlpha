...
| 跨域入边 | 748 | Cross-domain Incoming | 748 |
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_collectors_feedback_collector_py
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_actors_saga_compensator_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_diagnosers_cognitive_adaptive_param_tuning_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_evolution_online_feature_importance_py
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_forensic_toctou_guard_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    ...
    class D_SECURITY,D_GOVERNANCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_SHARED,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_INFRA_RUNTIME,D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_OPS,D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_SECURITY_LLM,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_trading_orchestrator_state_init_py -.->|config_depends| src_zephyr_trading_orchestrator_state_file_task_mapper_py
...
| D_GOVERNANCE | 62 | import_depends,runtime |
...
│   protection_index.py → verdict_engine.py                        │

...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_SECURITY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_execution_init_py -.->|config_depends| src_zephyr_trading_orchestrator_execution_memory_writer_py

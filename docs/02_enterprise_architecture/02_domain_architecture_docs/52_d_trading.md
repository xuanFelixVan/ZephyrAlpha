...
| 跨域入边 | 743 | Cross-domain Incoming | 743 |
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_SECURITY_LLM,D_INFRA_RUNTIME external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED external_prod

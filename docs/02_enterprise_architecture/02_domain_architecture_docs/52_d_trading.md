...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_contracts_init_py -.->|config_depends| src_zephyr_trading_orchestrator_contracts_contract_registry_py
    D_SHARED["D_SHARED production"]
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_SECURITY_LLM,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_GOVERNANCE,D_EX_CORE external_prod
```

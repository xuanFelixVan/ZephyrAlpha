...
| 跨域入边 | 749 | Cross-domain Incoming | 749 |
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_INFRA_TELEMETRY external_prod
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_diagnosers_cognitive_collaborative_learning_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_SHARED,D_INFRA_RUNTIME,D_INFRA_TELEMETRY,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_trading_orchestrator_execution_init_py -.->|config_depends| src_zephyr_trading_orchestrator_execution_dlq_manager_py
...
| D_GOVERNANCE | 28 | import_depends |

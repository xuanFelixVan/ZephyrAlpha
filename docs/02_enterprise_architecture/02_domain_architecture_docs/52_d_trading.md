...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
    class D_SECURITY,D_INTELLIGENCE,D_AUDITTEST external_design
```

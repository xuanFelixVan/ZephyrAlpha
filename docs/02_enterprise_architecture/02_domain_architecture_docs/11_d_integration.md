...
| 模块数 | 716 | Module Count | 716 |
| 域内依赖 | 731 | Internal Dependencies | 731 |
| 跨域入边 | 834 | Cross-domain Incoming | 834 |
| 跨域出边 | 493 | Cross-domain Outgoing | 493 |
| 设计态模块 | 419 | Design Modules | 419 |
...
| src/zephyr/integration/local_model/deepseek_chat.py |  | production | draft |
...
| src/zephyr/integration/pipeline_routing.py |  | production | draft |
...
| tests/integration/test_f3_auto_integration.py |  | production | draft |
| tests/integration/test_mcp_boot_hooks_integration.py |  | production | draft |
| tests/integration/test_mcp_health_check_cron.py |  | production | draft |
| tests/integration/test_mcp_health_check_recovery.py |  | production | draft |
| tests/integration/test_mcp_idle_timeout.py |  | production | draft |
| tests/integration/test_mcp_signal_shutdown.py |  | production | draft |
...
graph TD
    ...
    src_zephyr_integration_shared_08_blueprint_scorer_py -.->|config_depends| src_zephyr_integration_shared_08_init_py
    ...
    D_GOV_RULE["D-GOV_RULE production"]
    src_zephyr_integration_shared_schema_schemas_py -->|import_depends| D_GOV_RULE
    D_SHARED["D-SHARED production"]
    ...
    D_GOV_RULE -->|import_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_SECURITY["D-SECURITY prototype"]
    D_SECURITY -.->|import_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_SHARED -.->|import_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_TRADING["D-TRADING prototype"]
    D_TRADING -.->|import_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_GOVERNANCE["D-GOVERNANCE prototype"]
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_schema_execution_model_py
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_schema_execution_model_py
    ...
    class D_SECURITY,D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    D_GOVERNANCE["D-GOVERNANCE prototype"]
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_08_file_utils_py
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_08_flags_py
    ...
    D_INFRA_RUNTIME["D-INFRA_RUNTIME production"]
    D_INFRA_RUNTIME -.->|import_depends| src_zephyr_integration_shared_08_foundation_constants_py
    ...
    D_SHARED -.->|import_depends| src_zephyr_integration_shared_08_foundation_errors_py
    D_SHARED -.->|import_depends| src_zephyr_integration_shared_08_foundation_errors_py
    D_GOVERNANCE -.->|test_depends| src_zephyr_integration_shared_08_foundation_init_py
    D_AUTONOMY_CORE["D-AUTONOMY_CORE prototype"]
    ...
    class D_SHARED,D_TRADING,D_GOV_RULE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class src_zephyr_integration_vector_memory_sqlite_metadata_store_py,src_zephyr_integration_vector_memory_vector_bridge_py,src_zephyr_integration_vector_memory_vms_errors_py,src_zephyr_integration_vector_memory_vms_schemas_py,src_zephyr_shared_shared_services_observability_02_token_utils_py,L0_D_INTEGRATION_39,L1_D_INTEGRATION_16,L1_D_INTEGRATION_24,L2_D_INTEGRATION_09,L2_D_INTEGRATION_14,L2_D_INTEGRATION_18,L2_D_INTEGRATION_20,L2_D_INTEGRATION_22,L2_D_INTEGRATION_26,L3_D_INTEGRATION_31,L3_D_INTEGRATION_37,L3_D_INTEGRATION_29,L3_D_INTEGRATION_41,L3_D_INTEGRATION_34 design
...
|--------|:---:|---------|
| D-SHARED | 74 | import_depends,contract,event,data,runtime |
| D-RISK | 69 | contract,data,event,config_depends |
| D-SECURITY | 61 | import_depends,contract,event,data,config_depends |
...
| D-GOV_RULE | 3 | import_depends,runtime |
...
|------|:---:|---------|
| D-GOVERNANCE | 328 | contract,import_depends,test_depends,config_depends,event,data |
| D-COMPLIANCE | 118 | event,data,config_depends,contract |
| D-AUTONOMY_CORE | 77 | import_depends,contract,data,config_depends,event |
| D-TRADING | 56 | import_depends,event |
| D-INFRA_OPS | 39 | data,contract,config_depends,event |
...
| D-GOV_DRIFT | 4 | import_depends,data |

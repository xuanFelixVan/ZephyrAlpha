...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_RISK,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_prod
```

...
flowchart TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_DRIFT,D_RISK,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_INTEGRATION,D_COMPLIANCE external_prod

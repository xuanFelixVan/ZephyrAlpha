...
flowchart TD
    ...
    src_zephyr_gov_drift_analysis_py["(生产态 / production) gov_drift/_analysis.py<br/>文件: gov_drift/_analysis.py"]
    src_zephyr_gov_drift_core_py["(生产态 / production) gov_drift/_core.py<br/>文件: gov_drift/_core.py"]
    src_zephyr_gov_drift_drift_py["(生产态 / production) gov_drift/_drift.py<br/>文件: gov_drift/_drift.py"]
    src_zephyr_gov_drift_infrastructure_py["(生产态 / production) gov_drift/_infrastructure.py<br/>文件: gov_drift/_infrastructure.py"]
    src_zephyr_gov_drift_scanners_py["(生产态 / production) gov_drift/_scanners.py<br/>文件: gov_drift/_scanners.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_main_py["(生产态 / production) orphan_judge/__main__.py<br/>文件: orphan_judge/__main__.py"]
    src_zephyr_security_access_control_orphan_judge_config_loader_py["(生产态 / production) orphan_judge/config_loader.py<br/>文件: orphan_judge/config_loader.py"]
    src_zephyr_security_access_control_orphan_judge_drift_bridge_py["(生产态 / production) orphan_judge/drift_bridge.py<br/>文件: orphan_judge/drift_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_escalation_bridge_py["(生产态 / production) orphan_judge/escalation_bridge.py<br/>文件: orphan_judge/escalation_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_feedback_bridge_py["(生产态 / production) orphan_judge/feedback_bridge.py<br/>文件: orphan_judge/feedback_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_kb_bridge_py["(生产态 / production) orphan_judge/kb_bridge.py<br/>文件: orphan_judge/kb_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_mcp_integration_py["(生产态 / production) orphan_judge/mcp_integration.py<br/>文件: orphan_judge/mcp_integration.py"]
    src_zephyr_security_access_control_orphan_judge_orphan_collector_py["(生产态 / production) orphan_judge/orphan_collector.py<br/>文件: orphan_judge/orphan_collector.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_rbac_bridge_py["(生产态 / production) orphan_judge/rbac_bridge.py<br/>文件: orphan_judge/rbac_bridge.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_report_generator_py["(生产态 / production) orphan_judge/report_generator.py<br/>文件: orphan_judge/report_generator.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_swid_tag_py["(生产态 / production) orphan_judge/swid_tag.py<br/>文件: orphan_judge/swid_tag.py"]
    ...
    src_zephyr_security_access_control_phase_executor_py["(生产态 / production) access_control/phase_executor.py<br/>文件: access_control/phase_executor.py"]
    ...
    src_zephyr_security_adversarial_validation_main_py["(生产态 / production) adversarial_validation/__main__.py<br/>文件: adversarial_validation/__main__.py"]
    src_zephyr_security_adversarial_validation_ai_attack_generator_py["(生产态 / production) adversarial_validation/ai_attack_generator.py<br/>文件: adversarial_validation/ai_attack_generator.py"]
    src_zephyr_security_adversarial_validation_async_monitor_py["(生产态 / production) adversarial_validation/async_monitor.py<br/>文件: adversarial_validation/async_monitor.py"]
    src_zephyr_security_adversarial_validation_attack_registry_py["(生产态 / production) adversarial_validation/attack_registry.py<br/>文件: adversarial_validation/attack_registry.py"]
    ...
    src_zephyr_security_adversarial_validation_constitution_engine_py["(生产态 / production) adversarial_validation/constitution_engine.py<br/>文件: adversarial_validation/constitution_engine.py"]
    src_zephyr_security_adversarial_validation_game_day_scheduler_py["(生产态 / production) adversarial_validation/game_day_scheduler.py<br/>文件: adversarial_validation/game_day_scheduler.py"]
    src_zephyr_security_adversarial_validation_injection_engine_py["(生产态 / production) adversarial_validation/injection_engine.py<br/>文件: adversarial_validation/injection_engine.py"]
    src_zephyr_security_adversarial_validation_mcp_endpoints_py["(生产态 / production) adversarial_validation/mcp_endpoints.py<br/>文件: adversarial_validation/mcp_endpoints.py"]
    ...
    src_zephyr_security_llm_defense_llm_security_layers_l6_data_flow_py["(生产态 / production) layers/l6_data_flow.py<br/>文件: layers/l6_data_flow.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l8_compliance_py["(生产态 / production) layers/l8_compliance.py<br/>文件: layers/l8_compliance.py"]
    ...
    src_zephyr_security_llm_defense_llm_security_self_protection_adversarial_mutator_py["(生产态 / production) self_protection/adversarial_mutator.py<br/>文件: self_protection/adversarial_mutator.py"]
    src_zephyr_security_llm_defense_llm_security_self_protection_red_team_scanner_py["(生产态 / production) self_protection/red_team_scanner.py<br/>文件: self_protection/red_team_scanner.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_cascade_analyzer_py["(生产态 / production) orphan_judge/cascade_analyzer.py<br/>文件: orphan_judge/cascade_analyzer.py"]
    src_zephyr_security_access_control_orphan_judge_db_py["(生产态 / production) orphan_judge/db.py<br/>文件: orphan_judge/db.py"]
    src_zephyr_security_access_control_orphan_judge_decision_table_py["(生产态 / production) orphan_judge/decision_table.py<br/>文件: orphan_judge/decision_table.py"]
    src_zephyr_security_access_control_orphan_judge_deprecation_tracker_py["(生产态 / production) orphan_judge/deprecation_tracker.py<br/>文件: orphan_judge/deprecation_tracker.py"]
    src_zephyr_security_access_control_orphan_judge_safety_fence_py["(生产态 / production) orphan_judge/safety_fence.py<br/>文件: orphan_judge/safety_fence.py"]
    src_zephyr_security_adversarial_validation_circuit_breaker_py["(生产态 / production) adversarial_validation/circuit_breaker.py<br/>文件: adversarial_validation/circuit_breaker.py"]
    src_zephyr_security_adversarial_validation_cli_py["(生产态 / production) adversarial_validation/cli.py<br/>文件: adversarial_validation/cli.py"]
    src_zephyr_security_adversarial_validation_constitution_guard_py["(生产态 / production) adversarial_validation/constitution_guard.py<br/>文件: adversarial_validation/constitution_guard.py"]
    src_zephyr_security_adversarial_validation_convergence_checker_py["(生产态 / production) adversarial_validation/convergence_checker.py<br/>文件: adversarial_validation/convergence_checker.py"]
    src_zephyr_security_llm_defense_llm_security_behavior_audit_logger_py["(生产态 / production) llm_security/behavior_audit_logger.py<br/>文件: llm_security/behavior_audit_logger.py"]
    src_zephyr_security_llm_defense_llm_security_gateway_py["(生产态 / production) llm_security/gateway.py<br/>文件: llm_security/gateway.py"]
    ...
    src_zephyr_security_llm_defense_llm_security_patterns_injection_patterns_py["(生产态 / production) patterns/injection_patterns.py<br/>文件: patterns/injection_patterns.py"]
    src_zephyr_security_llm_defense_llm_security_patterns_secrets_py["(生产态 / production) patterns/secrets.py<br/>文件: patterns/secrets.py"]
    src_zephyr_security_llm_defense_llm_security_self_protection_isolation_py["(生产态 / production) self_protection/isolation.py<br/>文件: self_protection/isolation.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_models_py["(生产态 / production) orphan_judge/models.py<br/>文件: orphan_judge/models.py"]
    src_zephyr_security_adversarial_validation_cold_start_py["(生产态 / production) adversarial_validation/cold_start.py<br/>文件: adversarial_validation/cold_start.py"]
    src_zephyr_security_adversarial_validation_game_day_runner_py["(生产态 / production) adversarial_validation/game_day_runner.py<br/>文件: adversarial_validation/game_day_runner.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l0_supply_chain_py["(生产态 / production) layers/l0_supply_chain.py<br/>文件: layers/l0_supply_chain.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l1_input_py["(生产态 / production) layers/l1_input.py<br/>文件: layers/l1_input.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l2_prompt_protection_py["(生产态 / production) layers/l2_prompt_protection.py<br/>文件: layers/l2_prompt_protection.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l2a_process_sandbox_py["(生产态 / production) layers/l2a_process_sandbox.py<br/>文件: layers/l2a_process_sandbox.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l3_output_py["(生产态 / production) layers/l3_output.py<br/>文件: layers/l3_output.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l4_agent_py["(生产态 / production) layers/l4_agent.py<br/>文件: layers/l4_agent.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l5_resource_protection_py["(生产态 / production) layers/l5_resource_protection.py<br/>文件: layers/l5_resource_protection.py"]
    ...
    src_zephyr_security_llm_defense_llm_security_layers_l8_multi_agent_py["(生产态 / production) layers/l8_multi_agent.py<br/>文件: layers/l8_multi_agent.py"]
    ...
    src_zephyr_security_llm_defense_llm_security_self_protection_l7_validation_py["(生产态 / production) self_protection/l7_validation.py<br/>文件: self_protection/l7_validation.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_judge_py["(生产态 / production) orphan_judge/judge.py<br/>文件: orphan_judge/judge.py"]
    src_zephyr_security_adversarial_validation_validator_py["(生产态 / production) adversarial_validation/validator.py<br/>文件: adversarial_validation/validator.py"]
    src_zephyr_security_llm_defense_llm_security_protocol_py["(生产态 / production) llm_security/protocol.py<br/>文件: llm_security/protocol.py"]
    src_zephyr_security_llm_defense_llm_security_self_protection_code_integrity_py["(生产态 / production) self_protection/code_integrity.py<br/>文件: self_protection/code_integrity.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_duplicate_detector_py["(生产态 / production) orphan_judge/duplicate_detector.py<br/>文件: orphan_judge/duplicate_detector.py"]
    src_zephyr_security_adversarial_validation_blast_radius_py["(生产态 / production) adversarial_validation/blast_radius.py<br/>文件: adversarial_validation/blast_radius.py"]
    src_zephyr_security_adversarial_validation_bypass_recorder_py["(生产态 / production) adversarial_validation/bypass_recorder.py<br/>文件: adversarial_validation/bypass_recorder.py"]
    src_zephyr_security_adversarial_validation_cleanup_py["(生产态 / production) adversarial_validation/cleanup.py<br/>文件: adversarial_validation/cleanup.py"]
    src_zephyr_security_adversarial_validation_defense_runner_py["(生产态 / production) adversarial_validation/defense_runner.py<br/>文件: adversarial_validation/defense_runner.py"]
    src_zephyr_security_adversarial_validation_scenario_loader_py["(生产态 / production) adversarial_validation/scenario_loader.py<br/>文件: adversarial_validation/scenario_loader.py"]
    src_zephyr_security_adversarial_validation_steady_state_py["(生产态 / production) adversarial_validation/steady_state.py<br/>文件: adversarial_validation/steady_state.py"]
    ...
    src_zephyr_security_adversarial_validation_models_py["(生产态 / production) adversarial_validation/models.py<br/>文件: adversarial_validation/models.py"]

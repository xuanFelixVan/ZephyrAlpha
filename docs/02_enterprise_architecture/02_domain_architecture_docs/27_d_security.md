...
flowchart TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_SHARED,D_GOV_DRIFT,D_GOV_RULE,D_RISK,D_GOV_CODE_QUALITY,D_COMPLIANCE,D_GOVERNANCE,D_INFRA_RECOVERY,D_INTEGRATION,D_ORCHESTRATOR external_prod

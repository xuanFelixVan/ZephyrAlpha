...
flowchart TD
    ...
    src_zephyr_security_access_control_decision_registry_py["决策注册表<br/>安全/access control包的decision_registry模块<br/>文件: access_control/decision_registry.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_llm_defense_llm_security_layers_l8_multi_agent_py["l8多代理<br/>安全/layers包的l8_multi_agent模块<br/>文件: layers/l8_multi_agent.py<br/>(生产态 / production)"]

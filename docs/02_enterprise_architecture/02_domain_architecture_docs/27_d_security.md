...
flowchart TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY external_prod
```

...
flowchart TD
    src_zephyr_gov_drift_main_py["(生产态 / production) 主入口 / __main__<br/>Drift Detector MOD-INF-023 CLI —<br/>漂移扫描入口。<br/>文件: gov_drift/__main__.py"]
    ...
    src_zephyr_gov_drift_infrastructure_py["(生产态 / production) 基础设施 / _<br/>infrastructure<br/>基础设施，供zephyr.gov_drift.__init__<br/>使用<br/>文件: gov_drift/_infrastructure.py"]
    ...
    src_zephyr_governance_agent_rbac_contracts_py["(生产态 / production) 契约 / contracts<br/>契约.py — G-CT-001 RBAC 契约<br/>（re-export）。<br/>文件: agent-rbac/contracts.py"]
    src_zephyr_red_blue_validator_init_py["(生产态 / production) 包入口 / red_blue_<br/>validator — re-export shim for<br/>zephyr.security.adve<br/>包入口。red_blue_validator — re-export<br/>shim for zephyr.security.adversarial_<br/>validation.<br/>文件: red_blue_validator/__init__.py"]
    src_zephyr_security_access_control_a2a_check_py["(生产态 / production) A2A检查 / a2a_<br/>check<br/>A2A 通信对验证——校验两个 agent<br/>之间是否允许通信。<br/>文件: access_control/a2a_check.py"]
    src_zephyr_security_access_control_adversarial_resilience_py["(生产态 / production) 对抗韧性 /<br/>AdversarialResilience - adversarial<br/>resilience & OWASP cover<br/>adversarial韧性。AdversarialResilience<br/>- adversarial resilience & OWASP<br/>coverage.<br/>文件: access_control/adversarial_<br/>resilience.py"]
    src_zephyr_security_access_control_agent_creation_policy_py["(生产态 / production) 代理creation策略<br/>/ agent_creation_policy<br/>AgentCreationPolicy — Agent 创建策略.<br/>文件: access_control/agent_creation_<br/>policy.py"]
    src_zephyr_security_access_control_approver_check_py["(生产态 / production) 审批器check /<br/>approver_check<br/>Approver authorization verifier —<br/>校验审批人是否有权执行请求的动作。<br/>文件: access_control/approver_check.py"]
    src_zephyr_security_access_control_asymmetric_audit_py["(生产态 / production) asymmetric审计 /<br/>AsymmetricAudit - quorum-based approval<br/>for high-risk operat<br/>asymmetric审计。AsymmetricAudit -<br/>quorum-based approval for high-risk<br/>operations.<br/>文件: access_control/asymmetric_audit.py"]
    src_zephyr_security_access_control_auto_maintenance_py["(生产态 / production) 自动maintenance /<br/>auto_maintenance<br/>AutoMaintenance —<br/>自动维护与规则健康仪表盘.<br/>文件: access_control/auto_maintenance.py"]
    src_zephyr_security_access_control_blueprint_fidelity_py["(生产态 / production) 蓝图fidelity /<br/>blueprint_fidelity<br/>BlueprintFidelity — 蓝图保真度检查.<br/>文件: access_control/blueprint_<br/>fidelity.py"]
    src_zephyr_security_access_control_build_sanitizer_py["(生产态 / production) 构建清洗器 / Stub<br/>module: zephyr.security.access_<br/>control.build_sanitizer<br/>构建sanitizer。Stub module:<br/>zephyr.security.access_control.build_<br/>sanitizer — implementation pending.<br/>文件: access_control/build_sanitizer.py"]
    src_zephyr_security_access_control_cache_invalidation_py["(生产态 / production) 缓存invalidation<br/>/ cache_invalidation<br/>CacheInvalidation — 缓存失效事件管理.<br/>文件: access_control/cache_<br/>invalidation.py"]
    src_zephyr_security_access_control_canary_rollout_manager_py["(生产态 / production)<br/>金丝雀rollout管理器 / canary_rollout_<br/>manager<br/>CanaryRolloutManager — 灰度发布管理器.<br/>文件: access_control/canary_rollout_<br/>manager.py"]
    src_zephyr_security_access_control_capability_check_py["(生产态 / production) 能力检查 /<br/>capability_check<br/>Agent capability scope verification —<br/>拒绝受限能力声明、空能力声明及能力数量超<br/>限。<br/>文件: access_control/capability_check.py"]
    src_zephyr_security_access_control_cascading_failure_isolator_py["(生产态 / production) 级联故障隔离器 /<br/>Stub module: zephyr.security.access_<br/>control.cascading_failur<br/>级联故障隔离器，访问控制的隔离器，隔离故<br/>障防止扩散。<br/>文件: access_control/cascading_failure_<br/>isolator.py"]
    src_zephyr_security_access_control_compliance_matrix_py["(生产态 / production) 合规矩阵 / Stub<br/>module: zephyr.security.access_<br/>control.compliance_matri<br/>合规矩阵。Stub module:<br/>zephyr.security.access_<br/>control.compliance_matrix —<br/>implementation pending.<br/>文件: access_control/compliance_<br/>matrix.py"]
    src_zephyr_security_access_control_cross_cutting_py["(生产态 / production) 跨cutting / cross_<br/>cutting<br/>CrossCutting — 横切面权限组件.<br/>文件: access_control/cross_cutting.py"]
    src_zephyr_security_access_control_decision_explainer_py["(生产态 / production) 决策explainer /<br/>decision_explainer<br/>DecisionExplainer —<br/>拒绝决策的结构化解释器.<br/>文件: access_control/decision_<br/>explainer.py"]
    src_zephyr_security_access_control_decision_registry_py["(生产态 / production) 决策注册表 /<br/>DecisionRegistry - decision log with<br/>query and stats.<br/>决策注册表。DecisionRegistry - decision<br/>log with query and stats.<br/>文件: access_control/decision_<br/>registry.py"]
    src_zephyr_security_access_control_defense_depth_py["(生产态 / production) 防御深度 / Stub<br/>module: zephyr.security.access_<br/>control.defense_depth —<br/>防御深度。Stub module:<br/>zephyr.security.access_control.defense_<br/>depth — implementation pending.<br/>文件: access_control/defense_depth.py"]
    src_zephyr_security_access_control_dependency_auditor_py["(生产态 / production) 依赖审计器 / Stub<br/>module: zephyr.security.access_<br/>control.dependency_audit<br/>依赖审计器。Stub module:<br/>zephyr.security.access_<br/>control.dependency_auditor —<br/>implementation pending.<br/>文件: access_control/dependency_<br/>auditor.py"]
    src_zephyr_security_access_control_derive_rbac_roles_py["(生产态 / production) RBACRoleDeriver —<br/>RBAC 角色派生器. / derive_rbac_roles<br/>RBACRoleDeriver — RBAC 角色派生器.<br/>文件: access_control/derive_rbac_<br/>roles.py"]
    src_zephyr_security_access_control_detectors_anomaly_detector_py["(生产态 / production) 异常检测器 /<br/>AnomalyDetector - rolling z-score<br/>anomaly detection per fiel<br/>异常检测器。AnomalyDetector - rolling<br/>z-score anomaly detection per field.<br/>文件: detectors/anomaly_detector.py"]
    src_zephyr_security_access_control_detectors_context_drift_detector_py["(生产态 / production) 上下文漂移检测器<br/>/ context_drift_detector<br/>ContextDriftDetector —<br/>上下文漂移与范围蔓延检测.<br/>文件: detectors/context_drift_<br/>detector.py"]
    src_zephyr_security_access_control_detectors_cross_session_detector_py["(生产态 / production) 跨会话检测器 /<br/>cross_session_detector<br/>CrossSessionDetector — 跨 Session<br/>检测器.<br/>文件: detectors/cross_session_<br/>detector.py"]
    src_zephyr_security_access_control_detectors_false_completion_detector_py["(生产态 / production)<br/>falsecompletion检测器 / false_<br/>completion_detector<br/>FalseCompletionDetector — 虚假完成检测.<br/>文件: detectors/false_completion_<br/>detector.py"]
    src_zephyr_security_access_control_detectors_multi_agent_collusion_detector_py["(生产态 / production)<br/>多代理collusion检测器 / multi_agent_<br/>collusion_detector<br/>MultiAgentCollusionDetector — 多 agent<br/>合谋检测.<br/>文件: detectors/multi_agent_collusion_<br/>detector.py"]
    src_zephyr_security_access_control_detectors_shell_dialect_detector_py["(生产态 / production)<br/>shelldialect检测器 / shell_dialect_<br/>detector<br/>ShellDialectDetector — Shell 方言检测器.<br/>文件: detectors/shell_dialect_<br/>detector.py"]
    ...
    src_zephyr_security_access_control_emergency_override_py["(生产态 / production) 紧急override /<br/>emergency_override<br/>EmergencyOverride — 紧急覆盖令牌管理.<br/>文件: access_control/emergency_<br/>override.py"]
    src_zephyr_security_access_control_environment_manager_py["(生产态 / production) 环境管理器 / Stub<br/>module: zephyr.security.access_<br/>control.environment_mana<br/>环境管理器。Stub module:<br/>zephyr.security.access_<br/>control.environment_manager —<br/>implementation pending.<br/>文件: access_control/environment_<br/>manager.py"]
    src_zephyr_security_access_control_escalation_handler_py["(生产态 / production) 升级处理器 / Stub<br/>module: zephyr.security.access_<br/>control.escalation_handl<br/>escalation处理器。Stub module:<br/>zephyr.security.access_<br/>control.escalation_handler —<br/>implementation pending.<br/>文件: access_control/escalation_<br/>handler.py"]
    ...
    src_zephyr_security_access_control_genesis_bootstrap_py["(生产态 / production) genesis自举 /<br/>genesis_bootstrap<br/>GenesisBootstrap — RBAC系统启动引导器.<br/>文件: access_control/genesis_<br/>bootstrap.py"]
    src_zephyr_security_access_control_guard_layers_py["(生产态 / production) 守卫layers /<br/>guard_layers<br/>GuardLayers — 权限守卫层组件.<br/>文件: access_control/guard_layers.py"]
    src_zephyr_security_access_control_guards_abac_guard_py["(生产态 / production) abac守卫 / abac_<br/>guard<br/>ABACGuard — 基于属性的权限守卫.<br/>文件: guards/abac_guard.py"]
    src_zephyr_security_access_control_guards_anti_pattern_guard_py["(生产态 / production) antipattern守卫 /<br/>Stub module: zephyr.security.access_<br/>control.guards.anti_patt<br/>anti模式守卫。Stub module:<br/>zephyr.security.access_<br/>control.guards.anti_pattern_guard —<br/>implementation pending.<br/>文件: guards/anti_pattern_guard.py"]
    src_zephyr_security_access_control_guards_audit_log_guard_py["(生产态 / production) 审计日志守卫 /<br/>audit_log_guard<br/>审计日志注入防护守卫<br/>文件: guards/audit_log_guard.py"]
    src_zephyr_security_access_control_guards_cybersec_2026_guard_py["(生产态 / production) cybersec2026守卫<br/>/ cybersec_2026_guard<br/>Cybersec2026Guard — 2026<br/>网络安全威胁检测.<br/>文件: guards/cybersec_2026_guard.py"]
    src_zephyr_security_access_control_guards_input_guard_py["(生产态 / production) 输入守卫 / input_<br/>guard<br/>InputGuard — 输入参数守卫.<br/>文件: guards/input_guard.py"]
    src_zephyr_security_access_control_guards_memory_guard_py["(生产态 / production) 记忆守卫 / memory_<br/>guard<br/>MemoryGuard — 内存访问守卫.<br/>文件: guards/memory_guard.py"]
    src_zephyr_security_access_control_guards_memory_provenance_guard_py["(生产态 / production) 记忆溯源守卫 /<br/>memory_provenance_guard<br/>MemoryProvenanceGuard —<br/>记忆来源溯源守卫.<br/>文件: guards/memory_provenance_guard.py"]
    src_zephyr_security_access_control_guards_native_api_guard_py["(生产态 / production) nativeAPI守卫 /<br/>native_api_guard<br/>NativeApiGuard — 原生 API 守卫.<br/>文件: guards/native_api_guard.py"]
    src_zephyr_security_access_control_guards_novel_attack_guard_py["(生产态 / production) novel攻击守卫 /<br/>novel_attack_guard<br/>NovelAttackGuard — 新型攻击行为画像.<br/>文件: guards/novel_attack_guard.py"]
    src_zephyr_security_access_control_guards_output_guard_py["(生产态 / production) output守卫 /<br/>output_guard<br/>OutputGuard — 输出内容守卫.<br/>文件: guards/output_guard.py"]
    src_zephyr_security_access_control_guards_path_guard_py["(生产态 / production) 路径守卫 / path_<br/>guard<br/>PathGuard — 路径守卫.<br/>文件: guards/path_guard.py"]
    src_zephyr_security_access_control_guards_replay_attack_guard_py["(生产态 / production) replay攻击守卫 /<br/>replay_attack_guard<br/>ReplayAttackGuard — 重放攻击防护.<br/>文件: guards/replay_attack_guard.py"]
    src_zephyr_security_access_control_guards_rule_injection_guard_py["(生产态 / production) 规则注入守卫 /<br/>rule_injection_guard<br/>RuleInjectionGuard — 规则注入守卫.<br/>文件: guards/rule_injection_guard.py"]
    src_zephyr_security_access_control_guards_sequence_guard_py["(生产态 / production) sequence守卫 /<br/>sequence_guard<br/>SequenceGuard — 操作序列守卫.<br/>文件: guards/sequence_guard.py"]
    src_zephyr_security_access_control_guards_toctou_guard_py["(生产态 / production) TOCTOU守卫 /<br/>toctou_guard<br/>TOCTOUGuard — TOCTOU (Time-of-Check to<br/>Time-of-Use) 防护.<br/>文件: guards/toctou_guard.py"]
    src_zephyr_security_access_control_guards_vibe_coding_guard_py["(生产态 / production) vibecoding守卫 /<br/>vibe_coding_guard<br/>VibeCodingGuard — Vibe Coding<br/>攻击面检测.<br/>文件: guards/vibe_coding_guard.py"]
    src_zephyr_security_access_control_integration_py["(生产态 / production) 集成 /<br/>IntegrationManager - system integration<br/>registry & health ch<br/>集成。IntegrationManager - system<br/>integration registry & health check.<br/>文件: access_control/integration.py"]
    src_zephyr_security_access_control_integrity_self_check_py["(生产态 / production) 完整性自检查 /<br/>integrity_self_check<br/>IntegritySelfCheck — 完整性自检.<br/>文件: access_control/integrity_self_<br/>check.py"]
    ...
    src_zephyr_security_access_control_key_hierarchy_py["(生产态 / production) 密钥hierarchy /<br/>Stub module: zephyr.security.access_<br/>control.key_hierarchy —<br/>密钥hierarchy。Stub module:<br/>zephyr.security.access_control.key_<br/>hierarchy — implementation pending.<br/>文件: access_control/key_hierarchy.py"]
    src_zephyr_security_access_control_legal_audit_chain_py["(生产态 / production) legal审计chain /<br/>LegalAuditChain - append-only<br/>hash-chained legal audit log.<br/>legal审计链。LegalAuditChain -<br/>append-only hash-chained legal audit<br/>log.<br/>文件: access_control/legal_audit_<br/>chain.py"]
    src_zephyr_security_access_control_microstructure_defense_py["(生产态 / production)<br/>微结构防御——对抗做市<br/>/交易微结构攻击的策略与保真度因子。 /<br/>microstructure_defense<br/>微结构防御——对抗做市<br/>/交易微结构攻击的策略与保真度因子。<br/>文件: access_control/microstructure_<br/>defense.py"]
    ...
    src_zephyr_security_access_control_observability_py["(生产态 / production) 可观测性 /<br/>observability<br/>ObservabilityReporter —<br/>指标上报与异常检测.<br/>文件: access_control/observability.py"]
    src_zephyr_security_access_control_orphan_judge_main_py["(生产态 / production) 主入口 / __main__<br/>孤儿判定的命令行入口，可以直接 python<br/>-m 跑起来执行主流程。<br/>文件: orphan_judge/__main__.py"]
    src_zephyr_security_access_control_orphan_judge_config_loader_py["(生产态 / production) 配置加载器 /<br/>config_loader<br/>配置加载器，主要提供加载、save、配置等功<br/>能，供orphan-judge.judge.OrphanJudge使用<br/>文件: orphan_judge/config_loader.py"]
    src_zephyr_security_access_control_orphan_judge_drift_bridge_py["(生产态 / production) 漂移桥接 / drift_<br/>bridge<br/>漂移桥接，主要提供notify变更、isavailabl<br/>e等功能，供orphan-judge.judge.OrphanJudg<br/>e使用<br/>文件: orphan_judge/drift_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_escalation_bridge_py["(生产态 / production) 升级桥接 /<br/>escalation_bridge<br/>escalation桥接，主要提供escalatejudgment<br/>、评估风险、isavailable等功能，供orphan-<br/>judge.judge.OrphanJudge使用<br/>文件: orphan_judge/escalation_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_feedback_bridge_py["(生产态 / production) 反馈桥接 /<br/>feedback_bridge<br/>反馈桥接，主要提供报告misjudgment、isava<br/>ilable等功能，供orphan-judge.judge.Orpha<br/>nJudge使用<br/>文件: orphan_judge/feedback_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_kb_bridge_py["(生产态 / production) kb桥接 / kb_bridge<br/>kb桥接，主要提供writejudgment、search历<br/>史、isavailable等功能，供orphan-judge.__<br/>main__._cmd_rep使用<br/>文件: orphan_judge/kb_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_mcp_integration_py["(生产态 / production) MCP集成 / mcp_<br/>integration<br/>MCP集成，供MCP Server Tool Registry;<br/>Fast使用<br/>文件: orphan_judge/mcp_integration.py"]
    src_zephyr_security_access_control_orphan_judge_orphan_collector_py["(生产态 / production) 孤儿采集器 /<br/>orphan_collector<br/>孤儿文件收集与处置器——整合 SafetyFence<br/>安全检查后执行处置动作。<br/>文件: orphan_judge/orphan_collector.py"]
    src_zephyr_security_access_control_orphan_judge_orphan_detector_py["(生产态 / production) (INVARIANTS) 蓝图<br/>§4 文件清单与代码双向对齐 / orphan_<br/>detector<br/>(INVARIANTS) 蓝图 §4<br/>文件清单与代码双向对齐<br/>文件: orphan_judge/orphan_detector.py"]
    src_zephyr_security_access_control_orphan_judge_rbac_bridge_py["(生产态 / production) RBAC桥接 / rbac_<br/>bridge<br/>rbac桥接，主要提供检查删除权限、isavaila<br/>ble等功能，供orphan-judge.judge.OrphanJu<br/>dge使用<br/>文件: orphan_judge/rbac_bridge.py"]
    src_zephyr_security_access_control_orphan_judge_reference_graph_engine_py["(生产态 / production)<br/>referencegraph引擎 / reference_graph_<br/>engine<br/>AST解析+import链遍历，判断文件是否被其他<br/>文件引用。<br/>文件: orphan_judge/reference_graph_<br/>engine.py"]
    src_zephyr_security_access_control_orphan_judge_registration_checker_py["(生产态 / production)<br/>扫描项目注册表，判断文件是否已登记在册。<br/>/ registration_checker<br/>扫描项目注册表，判断文件是否已登记在册。<br/>文件: orphan_judge/registration_<br/>checker.py"]
    src_zephyr_security_access_control_orphan_judge_report_generator_py["(生产态 / production) 报告生成器 /<br/>report_generator<br/>报告生成器，主要提供生成、摘要text等功能<br/>，供orphan-judge.__main__._cmd_rep使用<br/>文件: orphan_judge/report_generator.py"]
    src_zephyr_security_access_control_orphan_judge_standalone_evaluator_py["(生产态 / production) 六指标加权评分:<br/>文件大小(15%) + 代码行数(20%) + 定义数<br/>(20% / standalone_evaluator<br/>六指标加权评分: 文件大小(15%) +<br/>代码行数(20%) + 定义数(20%)<br/>文件: orphan_judge/standalone_<br/>evaluator.py"]
    src_zephyr_security_access_control_orphan_judge_swid_tag_py["(生产态 / production) SWID标签 / swid_<br/>tag<br/>swid标签，主要提供构建等功能，供orphan-j<br/>udge.db.JudgmentDB; re使用<br/>文件: orphan_judge/swid_tag.py"]
    src_zephyr_security_access_control_orphan_judge_unique_analyzer_py["(生产态 / production)<br/>AST节点比对，检测文件中的独特代码元素<br/>(类/函数/常量定义等)。 / unique_analyzer<br/>AST节点比对，检测文件中的独特代码元素<br/>(类/函数/常量定义等)。<br/>文件: orphan_judge/unique_analyzer.py"]
    src_zephyr_security_access_control_permission_hooks_py["(生产态 / production) 权限钩子 /<br/>permission_hooks<br/>PermissionHooks — 权限钩子注册表.<br/>文件: access_control/permission_hooks.py"]
    src_zephyr_security_access_control_permission_mode_manager_py["(生产态 / production) 权限mode管理器 /<br/>Stub module: zephyr.security.access_<br/>control.permission_mode_<br/>权限mode管理器。Stub module:<br/>zephyr.security.access_<br/>control.permission_mode_manager —<br/>implementation pending.<br/>文件: access_control/permission_mode_<br/>manager.py"]
    src_zephyr_security_access_control_phase_executor_py["(生产态 / production) 阶段执行器 /<br/>phase_executor<br/>阶段执行器，提供包入口和模块加载功能<br/>文件: access_control/phase_executor.py"]
    src_zephyr_security_access_control_risk_mitigation_py["(生产态 / production) 风险mitigation /<br/>risk_mitigation<br/>RiskMitigation — 风险评估与缓解策略.<br/>文件: access_control/risk_mitigation.py"]
    src_zephyr_security_access_control_rollback_sandbox_py["(生产态 / production) 回滚沙箱 /<br/>RollbackSandbox - isolate/execute<br/>/rollback pattern for rever<br/>回滚sandbox。RollbackSandbox - isolate<br/>/execute/rollback pattern for<br/>reversible operations.<br/>文件: access_control/rollback_sandbox.py"]
    src_zephyr_security_access_control_secrets_lifecycle_py["(生产态 / production) 密钥生命周期 /<br/>Stub module: zephyr.security.access_<br/>control.secrets_lifecycl<br/>secrets生命周期。Stub module:<br/>zephyr.security.access_control.secrets_<br/>lifecycle — implementation pending.<br/>文件: access_control/secrets_<br/>lifecycle.py"]
    src_zephyr_security_access_control_session_concurrency_py["(生产态 / production) 会话并发 /<br/>session_concurrency<br/>Session 级并发协调模块（P2-SES 落地）。<br/>文件: access_control/session_<br/>concurrency.py"]
    src_zephyr_security_access_control_session_lifecycle_py["(生产态 / production) 会话生命周期 /<br/>Stub module: zephyr.security.access_<br/>control.session_lifecycl<br/>会话生命周期。Stub module:<br/>zephyr.security.access_control.session_<br/>lifecycle — implementation pending.<br/>文件: access_control/session_<br/>lifecycle.py"]
    src_zephyr_security_access_control_verifiers_bootstrap_verifier_py["(生产态 / production) 自举验证器 / Stub<br/>module: zephyr.security.access_<br/>control.verifiers.bootst<br/>bootstrap验证器。Stub module:<br/>zephyr.security.access_<br/>control.verifiers.bootstrap_verifier —<br/>implementation pending.<br/>文件: verifiers/bootstrap_verifier.py"]
    src_zephyr_security_access_control_verifiers_continuous_verifier_py["(生产态 / production) continuous验证器<br/>/ Stub module: zephyr.security.access_<br/>control.verifiers.contin<br/>continuous验证器。Stub module:<br/>zephyr.security.access_<br/>control.verifiers.continuous_verifier —<br/>implementation pending.<br/>文件: verifiers/continuous_verifier.py"]
    src_zephyr_security_access_control_verifiers_contract_verifier_py["(生产态 / production) 契约验证器 /<br/>contract_verifier<br/>ContractVerifier — 契约验证器.<br/>文件: verifiers/contract_verifier.py"]
    src_zephyr_security_access_control_verifiers_micro_verifier_py["(生产态 / production) micro验证器 /<br/>Stub module: zephyr.security.access_<br/>control.verifiers.micro_<br/>micro验证器。Stub module:<br/>zephyr.security.access_<br/>control.verifiers.micro_verifier —<br/>implementation pending.<br/>文件: verifiers/micro_verifier.py"]
    src_zephyr_security_access_control_verifiers_post_action_verifier_py["(生产态 / production) 提交动作验证器 /<br/>Stub module: zephyr.security.access_<br/>control.verifiers.post_a<br/>提交动作验证器。Stub module:<br/>zephyr.security.access_<br/>control.verifiers.post_action_verifier<br/>— implementation pending.<br/>文件: verifiers/post_action_verifier.py"]
    src_zephyr_security_adversarial_validation_main_py["(生产态 / production) 主入口 / __main__<br/>对抗验证的命令行入口，可以直接 python<br/>-m 跑起来执行主流程。<br/>文件: adversarial_validation/__main__.py"]
    src_zephyr_security_adversarial_validation_ai_attack_generator_py["(生产态 / production) ai攻击generator /<br/>ai_attack_generator<br/>AIattack生成器，对抗验证的异常，定义本模<br/>块的异常类型。<br/>文件: adversarial_validation/ai_attack_<br/>generator.py"]
    src_zephyr_security_adversarial_validation_async_monitor_py["(生产态 / production) 异步监控 / async_<br/>monitor<br/>异步监控，对抗验证的监控器，持续监视某项<br/>指标，异常时上报。<br/>文件: adversarial_validation/async_<br/>monitor.py"]
    src_zephyr_security_adversarial_validation_attack_registry_py["(生产态 / production) 攻击注册表 /<br/>attack_registry<br/>attack注册表，主要提供注册、查询by层、数<br/>量等功能，供见蓝图 §4 接口契约使用<br/>文件: adversarial_validation/attack_<br/>registry.py"]
    src_zephyr_security_adversarial_validation_commit_trigger_py["(生产态 / production) 提交触发器 /<br/>commit_trigger<br/>CommitTrigger — 事件驱动红蓝对抗触发器<br/>(MOD-INF-030).<br/>文件: adversarial_validation/commit_<br/>trigger.py"]
    src_zephyr_security_adversarial_validation_constitution_engine_py["(生产态 / production) constitution引擎<br/>/ constitution_engine<br/>constitution引擎，对抗验证的注册表，登记<br/>和查询已注册的条目。<br/>文件: adversarial_validation<br/>/constitution_engine.py"]
    src_zephyr_security_adversarial_validation_game_day_scheduler_py["(生产态 / production) gameday调度器 /<br/>game_day_scheduler<br/>gameday调度器，对抗验证的调度器，按时间<br/>或优先级安排任务执行。<br/>文件: adversarial_validation/game_day_<br/>scheduler.py"]
    src_zephyr_security_adversarial_validation_injection_engine_py["(生产态 / production) 注入引擎 /<br/>injection_engine<br/>注入引擎，提供blastradius、blastradius、<br/>inject等方法，供validator.py ; game_day_<br/>r使用<br/>文件: adversarial_validation/injection_<br/>engine.py"]
    src_zephyr_security_adversarial_validation_mcp_endpoints_py["(生产态 / production) MCP端点 / mcp_<br/>endpoints<br/>MCP端点，对抗验证的异常，定义本模块的异<br/>常类型。<br/>文件: adversarial_validation/mcp_<br/>endpoints.py"]
    src_zephyr_security_adversarial_validation_validator_event_bridge_py["(生产态 / production) 校验器事件桥接 /<br/>validator_event_bridge<br/>ValidatorEventBridge —<br/>红蓝验证器事件桥接 (MOD-SEC-030).<br/>文件: adversarial_validation/validator_<br/>event_bridge.py"]
    src_zephyr_security_llm_defense_llm_security_dashboard_app_py["(生产态 / production) 应用 / LLM<br/>Security Gateway - Streamlit Dashboard.<br/>提供实时安全监控、攻击检测统计、载荷分析<br/>、系统健康状态的可视化界面。<br/>文件: dashboard/app.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l6_data_flow_py["(生产态 / production) l6数据流 / l6_<br/>data_flow<br/>l6数据流，主要提供校验、检查pii、执行enc<br/>ryption等功能<br/>文件: layers/l6_data_flow.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l8_compliance_py["(生产态 / production) l8合规 / l8_<br/>compliance<br/>l8合规，主要提供校验、检查策略、执行合规<br/>等功能<br/>文件: layers/l8_compliance.py"]
    src_zephyr_security_llm_defense_llm_security_process_sandbox_py["(生产态 / production) 进程沙箱 /<br/>process_sandbox<br/>L2a ProcessSandbox — subprocess<br/>路径白名单沙箱<br/>文件: llm_security/process_sandbox.py"]
    src_zephyr_security_llm_defense_llm_security_self_protection_adversarial_mutator_py["(生产态 / production) 对抗变更器 /<br/>adversarial_mutator<br/>对抗变异生成器 — 对 Red Team 载荷施加<br/>10 种变异技术，检验 LSG 抗干扰能力.<br/>文件: self_protection/adversarial_<br/>mutator.py"]
    src_zephyr_security_llm_defense_llm_security_self_protection_red_team_scanner_py["(生产态 / production) red团队扫描器 /<br/>red_team_scanner<br/>L7 Red Team 对抗扫描器.<br/>文件: self_protection/red_team_<br/>scanner.py"]
    ...
    src_zephyr_gov_drift_alert_router_py["(生产态 / production) 告警路由器 /<br/>Alert Router — alert_router.py<br/>告警路由器，治理漂移检测的路由器，按规则<br/>分发请求到处理方。<br/>文件: gov_drift/alert_router.py"]
    src_zephyr_gov_drift_cold_start_py["(生产态 / production) 冷启动 / cold_<br/>start<br/>Cold Start Bootstrapper — 冷启动引导<br/>§6.31。<br/>文件: gov_drift/cold_start.py"]
    src_zephyr_gov_drift_events_py["(生产态 / production) 事件 / events<br/>G-CT-005 — ManagedDriftEvent Pydantic<br/>V2 BaseModel 漂移事件定义.<br/>文件: gov_drift/events.py"]
    src_zephyr_gov_drift_reconciler_py["(生产态 / production) 协调器 / Auto<br/>Reconciler — reconciler.py<br/>自动对账引擎：pre-fix 快照 -> 自动修复<br/>-> 验证 -> 回滚闭环。<br/>文件: gov_drift/reconciler.py"]
    src_zephyr_gov_drift_runbook_generator_py["(生产态 / production) runbook生成器 /<br/>runbook_generator<br/>Drift Runbook Generator —<br/>漂移演练手册自动生成。<br/>文件: gov_drift/runbook_generator.py"]
    src_zephyr_gov_drift_state_machine_py["(生产态 / production) 状态machine /<br/>Drift State Machine — state_machine.py<br/>状态machine，治理漂移检测的异常，定义本<br/>模块的异常类型。<br/>文件: gov_drift/state_machine.py"]
    src_zephyr_security_access_control_bootstrap_superadmin_py["(生产态 / production) 自举superadmin /<br/>bootstrap_superadmin<br/>BootstrapSuperadmin — Superadmin<br/>账户启动器.<br/>文件: access_control/bootstrap_<br/>superadmin.py"]
    src_zephyr_security_access_control_cold_start_lock_py["(生产态 / production) 冷启动锁 / cold_<br/>start_lock<br/>ColdStartLock — 冷启动锁.<br/>文件: access_control/cold_start_lock.py"]
    src_zephyr_security_access_control_contracts_py["(生产态 / production) 契约 / contracts<br/>G-CT-001 RBAC->Audit 桥接契约 -<br/>RBACAuditBridge.<br/>文件: access_control/contracts.py"]
    src_zephyr_security_access_control_engine_degradation_py["(生产态 / production) 引擎退化 / engine_<br/>degradation<br/>EngineDegradation — 引擎降级管理.<br/>文件: access_control/engine_<br/>degradation.py"]
    src_zephyr_security_access_control_guards_permission_guard_py["(生产态 / production) 权限守卫 /<br/>permission_guard<br/>PermissionGuard — 七层权限编排器.<br/>文件: guards/permission_guard.py"]
    src_zephyr_security_access_control_kill_switch_py["(生产态 / production) 终止开关 / kill_<br/>switch<br/>KillSwitch — 熔断器.<br/>文件: access_control/kill_switch.py"]
    src_zephyr_security_access_control_orphan_judge_cascade_analyzer_py["(生产态 / production)<br/>删除级联分析器——分析删除文件对项目的影响<br/>。 / cascade_analyzer<br/>删除级联分析器——分析删除文件对项目的影响<br/>。<br/>文件: orphan_judge/cascade_analyzer.py"]
    src_zephyr_security_access_control_orphan_judge_db_py["(生产态 / production) 数据库 / db<br/>数据库，主要提供insert、获取、列表byverd<br/>ict等功能，供orphan-judge.__main__._cmd_<br/>rep使用<br/>文件: orphan_judge/db.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_deprecation_tracker_py["(生产态 / production)<br/>废弃文件追踪器——标记和追踪废弃文件的生命<br/>周期。 / deprecation_tracker<br/>废弃文件追踪器——标记和追踪废弃文件的生命<br/>周期。<br/>文件: orphan_judge/deprecation_<br/>tracker.py"]
    src_zephyr_security_access_control_orphan_judge_safety_fence_py["(生产态 / production) 安全护栏 / safety_<br/>fence<br/>安全围栏——阻止删除 frozen/immutable_<br/>core 文件。<br/>文件: orphan_judge/safety_fence.py"]
    src_zephyr_security_adversarial_validation_circuit_breaker_py["(生产态 / production) 熔断断路器 /<br/>circuit_breaker<br/>熔断断路器，对抗验证的状态机，管理状态流<br/>转。<br/>文件: adversarial_validation/circuit_<br/>breaker.py"]
    src_zephyr_security_adversarial_validation_cli_py["(生产态 / production) 命令行 / cli<br/>命令行，供End users; CI/CD; MCP tool<br/>wra使用<br/>文件: adversarial_validation/cli.py"]
    src_zephyr_security_adversarial_validation_constitution_guard_py["(生产态 / production) constitution守卫<br/>/ constitution_guard<br/>constitution守卫，对抗验证的异常，定义本<br/>模块的异常类型。<br/>文件: adversarial_validation<br/>/constitution_guard.py"]
    src_zephyr_security_adversarial_validation_convergence_checker_py["(生产态 / production) convergence检查器<br/>/ convergence_checker<br/>convergence检查器，对抗验证的异常，定义<br/>本模块的异常类型。<br/>文件: adversarial_validation<br/>/convergence_checker.py"]
    src_zephyr_security_llm_defense_llm_security_behavior_audit_logger_py["(生产态 / production) 行为审计日志器 /<br/>behavior_audit_logger<br/>行为审计日志器。Append-only AI behavior<br/>audit logger.<br/>文件: llm_security/behavior_audit_<br/>logger.py"]
    ...
    src_zephyr_security_llm_defense_llm_security_input_sanitizer_py["(生产态 / production) 输入清洗器 /<br/>InputSanitizer: path whitelist +<br/>command whitelist + token b<br/>输入清洗器基础设施异常基类<br/>（InputSanitizer 所有异常由此派生）。<br/>文件: llm_security/input_sanitizer.py"]
    src_zephyr_security_llm_defense_llm_security_patterns_injection_patterns_py["(生产态 / production) 注入模式 /<br/>injection_patterns<br/>注入模式，提供match等方法，供tests.llm_<br/>security.test_i使用<br/>文件: patterns/injection_patterns.py"]
    ...
    src_zephyr_security_access_control_guards_rbac_guard_py["(生产态 / production) RBAC守卫 / rbac_<br/>guard<br/>RBACGuard — 基于角色的权限守卫.<br/>文件: guards/rbac_guard.py"]
    ...
    src_zephyr_security_adversarial_validation_cold_start_py["(生产态 / production) 冷启动 / cold_<br/>start<br/>冷启动，供game_day_runner.py;<br/>validator.使用<br/>文件: adversarial_validation/cold_<br/>start.py"]
    src_zephyr_security_adversarial_validation_game_day_runner_py["(生产态 / production) gameday运行器 /<br/>game_day_runner<br/>gameday运行器，提供tier、blastradius等方<br/>法，供game_day_scheduler.py; cl使用<br/>文件: adversarial_validation/game_day_<br/>runner.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l0_supply_chain_py["(生产态 / production) l0supply链 / l0_<br/>supply_chain<br/>l0supply链。Result of a supply chain<br/>audit check.<br/>文件: layers/l0_supply_chain.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l1_input_py["(生产态 / production) 输入来源类型。 /<br/>l1_input<br/>输入来源类型。<br/>文件: layers/l1_input.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l2_prompt_protection_py["(生产态 / production) l2提示保护 / l2_<br/>prompt_protection<br/>提示 泄露扫描结果。<br/>文件: layers/l2_prompt_protection.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l2a_process_sandbox_py["(生产态 / production) l2a进程沙箱 / l2a_<br/>process_sandbox<br/>l2a进程sandbox。Status of a sandbox<br/>execution.<br/>文件: layers/l2a_process_sandbox.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l3_output_py["(生产态 / production)<br/>兼容旧接口的输出过滤层。 / l3_output<br/>兼容旧接口的输出过滤层。<br/>文件: layers/l3_output.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l4_agent_py["(生产态 / production) 风险等级。 / l4_<br/>agent<br/>风险等级。<br/>文件: layers/l4_agent.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l5_resource_protection_py["(生产态 / production) l5资源保护 / l5_<br/>resource_protection<br/>L5 资源保护层：token/cost/rate 限额 +<br/>成本不对称检测。<br/>文件: layers/l5_resource_protection.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l6_observability_py["(生产态 / production) l6可观测性 / L6<br/>Observability Layer — security event<br/>logging, alerting, a<br/>l6可观测性，供zephyr.security.llm_<br/>defense.ll使用<br/>文件: layers/l6_observability.py"]
    src_zephyr_security_llm_defense_llm_security_layers_l8_multi_agent_py["(生产态 / production) l8多代理 / l8_<br/>multi_agent<br/>l8多代理。Represents a communication<br/>item between agents.<br/>文件: layers/l8_multi_agent.py"]
    src_zephyr_security_llm_defense_llm_security_runtime_interceptor_py["(生产态 / production) 运行时拦截器 /<br/>runtime_interceptor<br/>运行时 LLM 裸调拦截器（GATE-20<br/>后备防线）<br/>文件: llm_security/runtime_<br/>interceptor.py"]
    src_zephyr_security_llm_defense_llm_security_self_protection_l7_validation_py["(生产态 / production) l7验证 / l7_<br/>validation<br/>l7验证。Manages special risks for<br/>DeepSeek models.<br/>文件: self_protection/l7_validation.py"]
    ...
    src_zephyr_security_access_control_immutable_core_py["(生产态 / production) 不可变核心 /<br/>immutable_core<br/>ImmutableCore — 不可变核心验证器.<br/>文件: access_control/immutable_core.py"]
    ...
    src_zephyr_security_adversarial_validation_validator_py["(生产态 / production) 校验器 / validator<br/>校验器，对抗验证的异常，定义本模块的异常<br/>类型。<br/>文件: adversarial_validation<br/>/validator.py"]
    src_zephyr_security_llm_defense_llm_security_protocol_py["(生产态 / production) 协议 / protocol<br/>LLM Security Gateway<br/>九层防御统一接口契约（L0-L8）。<br/>文件: llm_security/protocol.py"]
    src_zephyr_security_llm_defense_llm_security_self_protection_code_integrity_py["(生产态 / production) 代码完整性 / code_<br/>integrity<br/>代码完整性，安全的核心类，封装IntegrityS<br/>tatus相关逻辑。<br/>文件: self_protection/code_integrity.py"]
    ...
    src_zephyr_security_access_control_orphan_judge_duplicate_detector_py["(生产态 / production) 重复检测器 /<br/>duplicate_detector<br/>L2 功能重复检测器——基于 AST 哈希的<br/>Jaccard 相似度检测模块间功能重叠。<br/>文件: orphan_judge/duplicate_detector.py"]
    src_zephyr_security_adversarial_validation_blast_radius_py["(生产态 / production) 爆炸半径 / blast_<br/>radius<br/>爆炸半径，对抗验证的异常，定义本模块的异<br/>常类型。<br/>文件: adversarial_validation/blast_<br/>radius.py"]
    src_zephyr_security_adversarial_validation_bypass_recorder_py["(生产态 / production) 绕过记录器 /<br/>bypass_recorder<br/>绕过记录器，提供recordbypass、querybypas<br/>ses、escalatedentries等方法，供validator<br/>.py ; convergenc使用<br/>文件: adversarial_validation/bypass_<br/>recorder.py"]
    src_zephyr_security_adversarial_validation_cleanup_py["(生产态 / production) 清理 / cleanup<br/>清理，对抗验证的异常，定义本模块的异常类<br/>型。<br/>文件: adversarial_validation/cleanup.py"]
    src_zephyr_security_adversarial_validation_defense_runner_py["(生产态 / production) 防御运行器 /<br/>defense_runner<br/>防御运行器，对抗验证的异常，定义本模块的<br/>异常类型。<br/>文件: adversarial_validation/defense_<br/>runner.py"]
    src_zephyr_security_adversarial_validation_scenario_loader_py["(生产态 / production) 场景加载器 /<br/>scenario_loader<br/>场景加载器，提供scenariocount、加载、获<br/>取等方法，供validator.py; attack_<br/>regi使用<br/>文件: adversarial_validation/scenario_<br/>loader.py"]
    src_zephyr_security_adversarial_validation_steady_state_py["(生产态 / production) steady状态 /<br/>steady_state<br/>steady状态，对抗验证的异常，定义本模块的<br/>异常类型。<br/>文件: adversarial_validation/steady_<br/>state.py"]
    ...
    src_zephyr_security_adversarial_validation_models_py["(生产态 / production) 模型 / models<br/>模型，对抗验证的模型，定义数据结构和字段<br/>。<br/>文件: adversarial_validation/models.py"]
    ...
    D_COMPLIANCE["(生产态 / production) 合规 / Compliance<br/>合规，负责交易合规检查、规则引擎和合规报<br/>告<br/>跨域节点 / cross-domain"]

...
flowchart TD
    ...
    src_zephyr_security_access_control_asymmetric_audit_py["asymmetric审计<br/>AsymmetricAudit - quorum-based approval for<br/>high-risk operations<br/>文件: access_control/asymmetric_audit.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_key_hierarchy_py["密钥hierarchy<br/>Stub module: zephyr.security.access_control.key_<br/>hierarchy — implementation pending<br/>文件: access_control/key_hierarchy.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_permission_mode_manager_py["权限mode管理器<br/>Stub module: zephyr.security.access_<br/>control.permission_mode_manager —<br/>implementation pending<br/>文件: access_control/permission_mode_manager.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_session_lifecycle_py["会话生命周期<br/>Stub module: zephyr.security.access_<br/>control.session_lifecycle — implementation<br/>pending<br/>文件: access_control/session_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_verifiers_continuous_verifier_py["continuous验证器<br/>Stub module: zephyr.security.access_<br/>control.verifiers.continuous_verifier —<br/>implementation pending<br/>文件: verifiers/continuous_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_verifiers_micro_verifier_py["micro验证器<br/>Stub module: zephyr.security.access_<br/>control.verifiers.micro_verifier —<br/>implementation pending<br/>文件: verifiers/micro_verifier.py<br/>(生产态 / production)"]
    src_zephyr_security_access_control_verifiers_post_action_verifier_py["提交动作验证器<br/>Stub module: zephyr.security.access_<br/>control.verifiers.post_action_verifier —<br/>implementation pending<br/>文件: verifiers/post_action_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_llm_defense_llm_security_behavior_audit_logger_py["行为审计日志器<br/>Append-only AI behavior audit logger<br/>behavior_audit_logger<br/>文件: llm_security/behavior_audit_logger.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_llm_defense_llm_security_layers_l0_supply_chain_py["l0supply链<br/>Result of a supply chain audit check<br/>l0_supply_chain<br/>文件: layers/l0_supply_chain.py<br/>(生产态 / production)"]

...
flowchart TD
    ...
    class D_SHARED,D_RISK,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_AUDIT,D_COMPLIANCE,D_GOVERNANCE,D_GOV_SCRIPTS external_prod
```

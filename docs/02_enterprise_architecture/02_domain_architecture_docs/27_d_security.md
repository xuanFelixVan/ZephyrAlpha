...
flowchart TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_RULE,D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_ORCHESTRATOR,D_COMPLIANCE,D_RISK,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME external_prod
```

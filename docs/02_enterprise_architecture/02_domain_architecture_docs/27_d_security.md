...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_RISK,D_GOV_OPS_RESILIENCE,D_COMPLIANCE,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTEGRATION external_prod
```

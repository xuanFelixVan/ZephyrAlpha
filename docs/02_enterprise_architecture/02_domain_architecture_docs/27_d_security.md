...
flowchart TD
    ...
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_security_access_control_contracts_py
    ...
    class D_AUTONOMY_CORE,D_GOV_DRIFT,D_SHARED,D_GOV_AUDIT,D_GOV_RULE,D_INTELLIGENCE,D_RISK,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY external_prod

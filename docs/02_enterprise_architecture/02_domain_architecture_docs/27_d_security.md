...
graph TD
    ...
    class D_GOV_DRIFT,D_COMPLIANCE,D_INFRA_RECOVERY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_RULE,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_RULE,D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_ORCHESTRATOR,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_prod
```

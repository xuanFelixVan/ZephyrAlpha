...
flowchart TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOV_AUDIT,D_ORCHESTRATOR,D_COMPLIANCE,D_RISK,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_CODE_QUALITY external_prod
```

...
flowchart TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_AUDIT,D_INTEGRATION,D_ORCHESTRATOR,D_COMPLIANCE,D_GOV_OPS_RESILIENCE external_prod
```

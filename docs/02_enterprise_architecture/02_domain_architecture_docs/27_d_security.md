...
flowchart TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_INFRA_RUNTIME,D_RISK,D_GOV_AUDIT,D_COMPLIANCE,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod

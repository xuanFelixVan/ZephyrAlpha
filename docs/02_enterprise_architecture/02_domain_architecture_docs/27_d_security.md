...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_COMPLIANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_INTEGRATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP external_prod
```

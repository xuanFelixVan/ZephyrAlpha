...
flowchart TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_DRIFT,D_INTELLIGENCE,D_GOV_RULE,D_AUTONOMY_CORE,D_RISK,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_COMPLIANCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY external_prod

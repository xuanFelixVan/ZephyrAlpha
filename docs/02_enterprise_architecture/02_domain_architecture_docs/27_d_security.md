...
flowchart TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_RULE,D_INTELLIGENCE,D_RISK,D_GOVERNANCE,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_INTEGRATION external_prod

...
flowchart TD
    ...
    class D_GOV_RULE,D_SHARED,D_GOV_DRIFT,D_RISK,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_GOVERNANCE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_SCRIPTS external_prod

...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_RULE,D_SHARED,D_INTEGRATION,D_ORCHESTRATOR,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_prod
```

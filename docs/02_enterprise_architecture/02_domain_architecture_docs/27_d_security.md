...
flowchart TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_AUTONOMY_CORE,D_GOV_DRIFT,D_RISK,D_INFRA_RECOVERY,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_INTEGRATION,D_COMPLIANCE external_prod

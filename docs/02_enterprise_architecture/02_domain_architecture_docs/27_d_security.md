...
flowchart TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_SHARED,D_INFRA_RUNTIME,D_RISK,D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_prod

...
flowchart TD
    ...
    src_zephyr_gov_drift_analysis_py["分析<br/>gov_drift/_analysis 模块<br/>文件: gov_drift/_analysis.py<br/>(生产态 / production)"]
    src_zephyr_gov_drift_core_py["核心<br/>gov_drift/_core 模块<br/>文件: gov_drift/_core.py<br/>(生产态 / production)"]
    src_zephyr_gov_drift_drift_py["漂移<br/>gov_drift/_drift 模块<br/>文件: gov_drift/_drift.py<br/>(生产态 / production)"]
    src_zephyr_gov_drift_infrastructure_py["基础设施<br/>gov_drift/_infrastructure 模块<br/>文件: gov_drift/_infrastructure.py<br/>(生产态 / production)"]
    src_zephyr_gov_drift_scanners_py["扫描器<br/>gov_drift/_scanners 模块<br/>文件: gov_drift/_scanners.py<br/>(生产态 / production)"]
    ...
    src_zephyr_red_blue_validator_init_py["zephyr/red_blue_validator 包入口<br/>包入口。red_blue_validator —<br/>red_blue_validator — re-export shim for<br/>zephyr.security.adve<br/>文件: red_blue_validator/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_build_sanitizer_py["构建清洗器<br/>构建sanitizer<br/>Stub module: zephyr.security.access_<br/>control.build_sanitizer<br/>文件: access_control/build_sanitizer.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_cascading_failure_isolator_py["级联故障隔离器<br/>访问控制的隔离器，隔离故障防止扩散<br/>Stub module: zephyr.security.access_<br/>control.cascading_failur<br/>文件: access_control/cascading_failure_<br/>isolator.py<br/>(生产态 / production)"]
    src_zephyr_security_access_control_compliance_matrix_py["合规矩阵<br/>access_control/compliance_matrix 模块<br/>Stub module: zephyr.security.access_<br/>control.compliance_matri<br/>文件: access_control/compliance_matrix.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_defense_depth_py["防御深度<br/>access_control/defense_depth 模块<br/>Stub module: zephyr.security.access_<br/>control.defense_depth —<br/>文件: access_control/defense_depth.py<br/>(生产态 / production)"]
    src_zephyr_security_access_control_dependency_auditor_py["依赖审计器<br/>access_control/dependency_auditor 模块<br/>Stub module: zephyr.security.access_<br/>control.dependency_audit<br/>文件: access_control/dependency_auditor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_environment_manager_py["环境管理器<br/>access_control/environment_manager 模块<br/>Stub module: zephyr.security.access_<br/>control.environment_mana<br/>文件: access_control/environment_manager.py<br/>(生产态 / production)"]
    src_zephyr_security_access_control_escalation_handler_py["升级处理器<br/>escalation处理器<br/>Stub module: zephyr.security.access_<br/>control.escalation_handl<br/>文件: access_control/escalation_handler.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_guards_anti_pattern_guard_py["antipattern守卫<br/>anti模式守卫<br/>Stub module: zephyr.security.access_<br/>control.guards.anti_patt<br/>文件: guards/anti_pattern_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_key_hierarchy_py["密钥hierarchy<br/>access_control/key_hierarchy 模块<br/>Stub module: zephyr.security.access_control.key_<br/>hierarchy —<br/>文件: access_control/key_hierarchy.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_permission_mode_manager_py["权限mode管理器<br/>access_control/permission_mode_manager 模块<br/>Stub module: zephyr.security.access_<br/>control.permission_mode_<br/>文件: access_control/permission_mode_manager.py<br/>(生产态 / production)"]
    src_zephyr_security_access_control_phase_executor_py["阶段执行器<br/>access_control/phase_executor 模块<br/>文件: access_control/phase_executor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_secrets_lifecycle_py["密钥生命周期<br/>secrets生命周期<br/>Stub module: zephyr.security.access_<br/>control.secrets_lifecycl<br/>文件: access_control/secrets_lifecycle.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_session_lifecycle_py["会话生命周期<br/>access_control/session_lifecycle 模块<br/>Stub module: zephyr.security.access_<br/>control.session_lifecycl<br/>文件: access_control/session_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_security_access_control_verifiers_bootstrap_verifier_py["自举验证器<br/>bootstrap验证器<br/>Stub module: zephyr.security.access_<br/>control.verifiers.bootst<br/>文件: verifiers/bootstrap_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_access_control_verifiers_micro_verifier_py["micro验证器<br/>verifiers/micro_verifier 模块<br/>Stub module: zephyr.security.access_<br/>control.verifiers.micro_<br/>文件: verifiers/micro_verifier.py<br/>(生产态 / production)"]
    src_zephyr_security_access_control_verifiers_post_action_verifier_py["提交动作验证器<br/>verifiers/post_action_verifier 模块<br/>Stub module: zephyr.security.access_<br/>control.verifiers.post_a<br/>文件: verifiers/post_action_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_llm_defense_llm_security_input_sanitizer_py["输入清洗器<br/>基础设施异常基类（InputSanitizer<br/>所有异常由此派生）<br/>InputSanitizer: path whitelist + command<br/>whitelist + token b<br/>文件: llm_security/input_sanitizer.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_llm_defense_llm_security_self_protection_isolation_py["LSG 自身隔离策略.<br/>self_protection/isolation 模块<br/>文件: self_protection/isolation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_llm_defense_llm_security_layers_l1_input_py["输入来源类型。<br/>layers/l1_input 模块<br/>文件: layers/l1_input.py<br/>(生产态 / production)"]
    ...
    src_zephyr_security_llm_defense_llm_security_layers_l4_agent_py["风险等级。<br/>layers/l4_agent 模块<br/>文件: layers/l4_agent.py<br/>(生产态 / production)"]
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
```

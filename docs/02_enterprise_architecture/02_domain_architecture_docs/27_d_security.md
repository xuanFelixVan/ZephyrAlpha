...
flowchart TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOV_RULE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_RISK,D_GOV_AUDIT,D_GOVERNANCE,D_COMPLIANCE,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY external_prod

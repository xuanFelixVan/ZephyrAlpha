...
flowchart TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SHARED,D_GOV_RULE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_RISK,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY external_prod

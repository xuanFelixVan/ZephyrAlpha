...
flowchart TD
    ...
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_security_access_control_bootstrap_superadmin_py
    ...
    class D_GOV_AUDIT,D_GOV_RULE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_RISK,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_COMPLIANCE external_prod

...
flowchart TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_SHARED,D_RISK,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_INTEGRATION external_prod
```

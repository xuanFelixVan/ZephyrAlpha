...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FEEDBACK_LOOP external_prod
```

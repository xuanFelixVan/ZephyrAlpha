...
graph TD
    ...
    D_FACTOR -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    ...
    class D_GOVERNANCE,D_FACTOR,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_AUDITTEST,D_TRADING external_design
```
...
|------|:---:|---------|
| D_AUDITTEST | 127 | runtime,test_depends |

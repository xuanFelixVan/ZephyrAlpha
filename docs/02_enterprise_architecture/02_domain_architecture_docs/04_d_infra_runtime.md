...
graph TD
    ...
    class D_SECURITY_LLM,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_BACKTEST external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY_LLM,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_INTEGRATION,D_GOV_DRIFT external_prod
    class D_INFRA_A2A,D_TRADING,D_GOVERNANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_SECURITY,D_INFRA_A2A,D_GOVERNANCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_INFRA_TELEMETRY,D_GOV_DRIFT,D_GOV_REPAIR,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_REPAIR,D_FEEDBACK_LOOP external_prod
    class D_TRADING,D_SECURITY_LLM,D_INTELLIGENCE,D_GOVERNANCE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_INTEGRATION,D_ORCHESTRATOR external_design
```
...
| 215 | 包 shared.maintenance 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: code_economy_analyzer.py | config_depends / config_depends |

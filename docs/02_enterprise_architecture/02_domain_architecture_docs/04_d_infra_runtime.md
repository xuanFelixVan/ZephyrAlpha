...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_INFRA_TELEMETRY,D_SHARED,D_SECURITY,D_FBL_DETECTORS,D_GOV_DRIFT external_prod
```
...
| 195 | shared.security — auto-generated package init.... | → | D_SHARED 共享服务: idempotency.py —— Re-export wrapper -> canoni... | config_depends / config_depends |

...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_DRIFT,D_INTEGRATION,D_INFRA_A2A,D_TRADING,D_SECURITY external_prod
    class D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_RULE,D_INTELLIGENCE,D_TRADING,D_INTEGRATION external_prod
    class D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_COMPLIANCE,D_GOV_SCRIPTS external_design
```

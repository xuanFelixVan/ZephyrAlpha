...
graph TD
    ...
    class D_SHARED,D_INFRA_TELEMETRY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_TRADING,D_AUTONOMY_CORE external_prod
    class D_AUDITTEST,D_BACKTEST,D_GOV_SCRIPTS external_design
```

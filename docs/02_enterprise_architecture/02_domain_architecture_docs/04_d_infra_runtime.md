...
graph TD
    ...
    class D_GOV_RULE,D_GOVERNANCE,D_BACKTEST,D_INTEGRATION,D_ORCHESTRATOR external_prod
    class D_SHARED,D_DATA,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_AUTONOMY_CORE,D_TRADING,D_SECURITY external_prod
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOVERNANCE,D_TRADING external_prod
    class D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_COMPLIANCE external_design
```

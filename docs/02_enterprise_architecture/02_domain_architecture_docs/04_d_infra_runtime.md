...
graph TD
    ...
    class D_SECURITY_LLM,D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRASTRUCTURE,D_INFRA_A2A,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_GOV_AUDIT,D_AUTONOMY_CORE,D_SECURITY external_prod
...
graph TD
    ...
    class D_SECURITY,D_FBL_DETECTORS,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_SHARED,D_INFRA_TELEMETRY,D_GOV_REPAIR,D_INFRA_RECOVERY,D_INFRA_A2A,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_REPAIR external_prod
    class D_SECURITY_LLM,D_TRADING external_design
```
...
| 205 | 包 shared.adaptation 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: Prompt Version Manager — 版本化 Prompt 治理。 ... | config_depends / config_depends |
| 206 | 包 shared.blueprint_tools 的初始化文件。 (__ini... | → | D_SHARED 共享服务: blueprint_code_auditor.py | config_depends / config_depends |

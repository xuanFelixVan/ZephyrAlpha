...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_REPAIR,D_COMPLIANCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_RULE,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_SCRIPTS,D_INTEGRATION,D_AUTONOMY_CORE,D_TRADING,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_TRADING,D_INTEGRATION,D_AUTONOMY_CORE,D_SECURITY,D_GOV_SCRIPTS,D_GOVERNANCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_INTEGRATION,D_INTELLIGENCE,D_TRADING,D_GOV_AUDIT,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_TRADING external_prod
```

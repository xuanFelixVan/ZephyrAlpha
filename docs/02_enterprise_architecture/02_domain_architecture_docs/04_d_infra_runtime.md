...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_BACKTEST,D_INTELLIGENCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_INTEGRATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
    class D_ORCHESTRATOR,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INTEGRATION,D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_INTEGRATION,D_SECURITY,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE external_prod
    class D_COMPLIANCE,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS external_design
```

...
graph TD
    ...
    class D_AUDITTEST,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_INTEGRATION,D_TRADING,D_AUTONOMY_CORE external_prod

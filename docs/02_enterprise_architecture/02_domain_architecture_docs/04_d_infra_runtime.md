...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_AUTONOMY_CORE,D_BACKTEST external_prod
...
> 本域与 12 个外部域直接连接（出边 83 条 + 入边 191 条 = 274 条）。只显示直接连接的域，不展开具体节点。

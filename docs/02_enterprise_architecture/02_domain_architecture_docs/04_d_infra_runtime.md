...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_REPAIR,D_FEEDBACK_LOOP external_prod
    class D_SHARED,D_GOV_CODE_QUALITY,D_SECURITY_LLM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY_LLM,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_SCRIPTS,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_TELEMETRY,D_SHARED,D_INTEGRATION,D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_INFRASTRUCTURE,D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_RULE external_prod
    class D_INFRA_RECOVERY,D_AUTONOMY_PERM,D_INTELLIGENCE,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_SHARED,D_SECURITY,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOVERNANCE,D_FBL_DIAGNOSERS external_prod
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INFRA_A2A,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_SHARED,D_INFRA_TELEMETRY,D_GOV_REPAIR,D_INFRA_RECOVERY,D_INFRA_A2A,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INFRASTRUCTURE external_design
```
...
| 207 | 包 shared.capacity_governance 的初始化文件。 (_... | → | D_SHARED 共享服务: capacity_calibrator.py | config_depends / config_depends |
...
| 214 | __init__.py | → | D_SHARED 共享服务: CT-HEALTH-001: System-wide Health Discovery Reg... | config_depends / config_depends |
...
| 221 | 包 shared.reliability 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: Diff Planner — 最小增量变更规划器。 (diff_plan... | config_depends / config_depends |
| 222 | shared.schema — auto-generated package init. (... | → | D_SHARED 共享服务: base_config.py | config_depends / config_depends |
| 223 | shared.security — auto-generated package init.... | → | D_SHARED 共享服务: lock.py —— Re-export wrapper -> canonical: ze... | config_depends / config_depends |
...
> 本域与 30 个外部域直接连接（出边 308 条 + 入边 243 条 = 551 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_INFRA_RUNTIME -->|186条 config_depends / config_depends, 导入依赖 / import_depends, 测试依赖 / test_depends| D_SHARED

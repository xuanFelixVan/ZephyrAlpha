...
graph TD
    ...
    class D_DATA,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_DRIFT,D_INTEGRATION,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_SECURITY,D_AUTONOMY_CORE,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INTEGRATION external_prod

...
graph TD
    ...
    class D_INTEGRATION,D_GOV_RULE,D_SHARED,D_GOVERNANCE,D_SECURITY,D_TRADING external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_RULE,D_SHARED,D_GOV_DRIFT,D_GOV_AUDIT,D_GOVERNANCE external_prod
    class D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY external_design
```

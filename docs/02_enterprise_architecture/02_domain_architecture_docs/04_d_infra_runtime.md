...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_INTEGRATION,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_TRADING external_prod
    class D_GOV_SCRIPTS,D_GOVERNANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INTELLIGENCE external_prod
    class D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_COMPLIANCE,D_GOVERNANCE external_design
```

...
| 容量 | 97/150 (正常) | Capacity | 97/150 (正常) |
...
graph TD
    subgraph D_INFRA_RUNTIME["D_INFRA_RUNTIME 运行时集成"]
        ...
        src_zephyr_infrastructure_auto_fix_engine_init_py["src/zephyr/infrastructure/auto_fix_engine/__ini... prototype"]
...
graph TD
    ...
    src_zephyr_shared_lifecycle_init_py -.->|config_depends| src_zephyr_shared_lifecycle_hooks_py
    D_SHARED["D_SHARED production"]
...
| 23 | src/zephyr/infrastructure/auto_fix_engine/__init__.py | src/zephyr/infrastructure/auto_fix_en... | prototype | generated |

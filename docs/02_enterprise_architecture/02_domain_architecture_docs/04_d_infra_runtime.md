...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_GOVERNANCE,D_INTEGRATION external_prod

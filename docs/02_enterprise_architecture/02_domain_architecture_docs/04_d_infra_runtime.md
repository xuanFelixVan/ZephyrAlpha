...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_RULE,D_BACKTEST,D_INTEGRATION,D_ORCHESTRATOR external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_GOVERNANCE,D_GOV_RULE external_prod
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_BACKTEST,D_INTEGRATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
    class D_DATA,D_ORCHESTRATOR,D_SECURITY external_design
```

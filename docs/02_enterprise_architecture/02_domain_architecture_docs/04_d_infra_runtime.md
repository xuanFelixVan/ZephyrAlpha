...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_AUDITTEST,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    src_zephyr_shared_lifecycle_init_py -.->|config_depends| src_zephyr_shared_lifecycle_longevity_monitor_py
    D_INTEGRATION["D_INTEGRATION production"]

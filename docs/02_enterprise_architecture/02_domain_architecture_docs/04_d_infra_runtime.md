...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_INTEGRATION,D_INTELLIGENCE external_prod
    class D_ORCHESTRATOR,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_RULE,D_SECURITY,D_GOVERNANCE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_RULE,D_INTELLIGENCE external_prod
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_COMPLIANCE,D_GOV_SCRIPTS external_design
```

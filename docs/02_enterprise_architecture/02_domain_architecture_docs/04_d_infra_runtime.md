...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_INFRA_TELEMETRY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RECOVERY,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_INFRA_TELEMETRY,D_GOV_OPS_RESILIENCE external_prod

...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_INFRA_A2A,D_TRADING,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_A2A,D_SECURITY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_REPAIR,D_INFRA_TELEMETRY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_A2A,D_GOVERNANCE,D_BACKTEST external_prod
...
| 47 | phase_manager 命名空间桥——重导出 zephyr.gover... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: __init__.py | 导入依赖 / import_depends |
| 48 | phase_manager 命名空间桥——重导出 zephyr.gover... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: Phase Manager — ZephyrAlpha 施工阶段门控引擎. ... | 导入依赖 / import_depends |
...
| 214 | shared.api — auto-generated package init. (__i... | → | D_SHARED 共享服务: dos_launcher.py | config_depends / config_depends |
| 215 | 包 shared.blueprint_tools 的初始化文件。 (__ini... | → | D_SHARED 共享服务: ai_understandability_constraint.py | config_depends / config_depends |
...
| 223 | shared.io — auto-generated package init. (__in... | → | D_SHARED 共享服务: SHA-256 content fingerprint computation and ver... | config_depends / config_depends |
| 224 | 包 shared.knowledge 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: KE Linker — 知识条目关联图。 (ke_linker.py) | config_depends / config_depends |
...
| 231 | 包 shared.reliability 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: Retry Handler — 指数退避重试 + 可恢复/不可恢复... | config_depends / config_depends |
...
graph LR
    ...
    D_INFRA_RUNTIME -->|194条 config_depends / config_depends, 导入依赖 / import_depends, 测试依赖 / test_depends| D_SHARED

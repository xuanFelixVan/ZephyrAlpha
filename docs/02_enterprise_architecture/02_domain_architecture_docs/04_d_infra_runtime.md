...
graph TD
    ...
    class D_GOVERNANCE,D_BACKTEST,D_GOV_RULE,D_INTEGRATION,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_FEEDBACK_LOOP,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_COMPLIANCE external_design
```

...
graph TD
    ...
    class D_TRADING,D_INFRA_TELEMETRY,D_SHARED,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_TRADING,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_AUDITTEST,D_GOV_SCRIPTS,D_TRADING,D_GOVERNANCE external_design
```

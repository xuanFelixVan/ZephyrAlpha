...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    src_zephyr_infrastructure_governance_server_py -.->|import_depends| D_SHARED
    src_zephyr_infrastructure_capacity_assurance_risk_mitigation_py -.->|import_depends| D_SHARED
    src_zephyr_infrastructure_capacity_assurance_schema_py -.->|import_depends| D_SHARED
    D_AUDITTEST["D_AUDITTEST prototype"]
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_TRADING,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_AUDITTEST,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```

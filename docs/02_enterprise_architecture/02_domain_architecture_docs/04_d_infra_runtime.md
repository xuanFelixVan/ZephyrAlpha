...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_DOCS,D_FACTOR external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_REPAIR,D_FEEDBACK_LOOP external_prod
    class D_SECURITY,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_AUTONOMY_CORE,D_GOVERNANCE,D_ORCHESTRATOR,D_BACKTEST external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SECURITY_LLM,D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_DRIFT,D_INFRA_TELEMETRY,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_INTEGRATION,D_INFRA_A2A,D_TRADING external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_TRADING,D_INTEGRATION,D_SECURITY external_prod
    class D_INTELLIGENCE,D_INFRA_A2A,D_AUTONOMY_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INFRA_A2A,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_SECURITY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
| 206 | 包 shared.capacity_governance 的初始化文件。 (_... | → | D_SHARED 共享服务: adaptive_sampler.py | config_depends / config_depends |
| 207 | 包 shared.compensation 的初始化文件。 (__init__... | → | D_SHARED 共享服务: Saga Compensator — 补偿事务：多步操作任一失败 ... | config_depends / config_depends |
| 208 | 包 shared.dependency 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: Dependency Graph — 任务卡依赖关系管理。 (depen... | config_depends / config_depends |
...
> 本域与 31 个外部域直接连接（出边 307 条 + 入边 245 条 = 552 条）。只显示直接连接的域，不展开具体节点。

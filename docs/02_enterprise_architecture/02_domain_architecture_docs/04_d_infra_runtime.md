...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_RULE,D_SECURITY,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_FEEDBACK_LOOP,D_TRADING,D_INTELLIGENCE,D_GOV_RULE external_prod

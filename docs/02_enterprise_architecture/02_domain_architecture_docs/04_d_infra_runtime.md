...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INTEGRATION,D_BACKTEST,D_GOVERNANCE,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INTEGRATION,D_TRADING external_prod
    class D_ORCHESTRATOR,D_INTELLIGENCE,D_GOV_SCRIPTS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_RULE,D_INTEGRATION,D_TRADING external_prod
    class D_ORCHESTRATOR,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_GOVERNANCE external_design
```

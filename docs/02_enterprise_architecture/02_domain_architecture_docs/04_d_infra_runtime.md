...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_SECURITY,D_GOV_DRIFT,D_TRADING,D_INTEGRATION external_prod
    class D_INTELLIGENCE,D_GOV_SCRIPTS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_TRADING external_prod

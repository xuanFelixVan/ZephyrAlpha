...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_DOCS,D_FACTOR,D_GOV_SCRIPTS,D_SECURITY_LLM,D_GOV_CODE_QUALITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_AUTONOMY_CORE,D_BACKTEST,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_TRADING,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_TRADING,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SECURITY,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_A2A external_prod
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_TRADING external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_SHARED,D_GOVERNANCE,D_INFRA_A2A,D_SECURITY,D_INTEGRATION,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_FBL_DETECTORS external_prod
```
...
> 本域与 31 个外部域直接连接（出边 317 条 + 入边 246 条 = 563 条）。只显示直接连接的域，不展开具体节点。

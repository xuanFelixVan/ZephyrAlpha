...
graph TD
    ...
    D_INFRASTRUCTURE -.->|runtime / runtime| src_zephyr_infrastructure_asset_inventory_classifier_py
    ...
    class D_KNOWLEDGE,D_GOV_DOCS,D_FACTOR,D_INFRASTRUCTURE,D_GOV_CODE_QUALITY,D_SECURITY,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_SHARED,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
    class D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_COMPLIANCE external_design
```
...
| 47 | D_INFRASTRUCTURE: TCP relay: expose localhost-only MinIO to the C... | → | AssetClassifier — MOD-INF-026 L2 资产自动分类... | runtime / runtime |

...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    ...
    src_zephyr_shared_lifecycle_init_py -.->|config_depends| src_zephyr_shared_lifecycle_health_discovery_py
    D_SHARED["D_SHARED production"]

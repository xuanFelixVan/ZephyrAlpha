...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_BACKTEST,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOVERNANCE external_prod
    class D_ORCHESTRATOR,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS external_design
```

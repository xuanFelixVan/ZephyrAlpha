...
graph TD
    ...
    class D_SECURITY_LLM,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY_LLM,D_COMPLIANCE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_BACKTEST external_prod
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_TELEMETRY,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INFRA_TELEMETRY,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
    class D_SECURITY,D_INTELLIGENCE,D_TRADING,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_A2A,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_GOVERNANCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_INFRA_TELEMETRY,D_GOV_DRIFT,D_GOV_REPAIR,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_INFRA_A2A,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_REPAIR,D_FEEDBACK_LOOP external_prod
    class D_SECURITY_LLM,D_INTELLIGENCE,D_COMPLIANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SECURITY,D_INFRA_TELEMETRY,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_REPAIR,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_INTEGRATION,D_ORCHESTRATOR external_design
```
...
| 205 | shared.api — auto-generated package init. (__i... | → | D_SHARED 共享服务: api_client.py —— 统一 API Client 基类（Phase ... | config_depends / config_depends |
...
| 213 | shared.io — auto-generated package init. (__in... | → | D_SHARED 共享服务: file_utils.py —— 安全文件操作工具（Phase 3 新... | config_depends / config_depends |
...
> 本域与 29 个外部域直接连接（出边 308 条 + 入边 244 条 = 552 条）。只显示直接连接的域，不展开具体节点。

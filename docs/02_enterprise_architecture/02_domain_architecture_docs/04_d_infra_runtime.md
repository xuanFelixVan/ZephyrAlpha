...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_GOVERNANCE,D_BACKTEST,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_INTEGRATION,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_ORCHESTRATOR,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INTELLIGENCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_TRADING,D_SECURITY external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_RULE,D_GOVERNANCE,D_INTEGRATION,D_TRADING external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY external_design
```

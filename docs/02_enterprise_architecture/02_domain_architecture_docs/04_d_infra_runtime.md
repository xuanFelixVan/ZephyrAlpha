...
| 68 | src/zephyr/infrastructure/git_batcher.py | GitCommandBatcher — 批量化 git 子进程调用（ARC... | 原型态 / prototype |  |
...
> 展示全部 156 个模块（生产态 114 + 设计态 1 + 原型态 41），标签标注成熟度。
...
graph TD
    subgraph D_INFRA_RUNTIME["D_INFRA_RUNTIME 运行时集成"]
        ...
        src_zephyr_infrastructure_git_batcher_py["(原型态 / prototype) GitCommandBatcher — 批量化 git 子进程调用（ARC...<br/>文件: git_batcher.py"]
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_infrastructure_pipeline_pipeline_roadmap_py,src_zephyr_infrastructure_pipeline_preemption_manager_py,src_zephyr_infrastructure_pipeline_routing_plugins_py,src_zephyr_infrastructure_pydantic_v2_migrator_py,src_zephyr_infrastructure_quality_quality_monitor_py,src_zephyr_infrastructure_queue_task_queue_py,src_zephyr_infrastructure_queue_task_scheduler_py,src_zephyr_infrastructure_reliability_context_guard_py,src_zephyr_infrastructure_runtime_concurrency_guard_py,src_zephyr_infrastructure_runtime_sandbox_enforcer_py,src_zephyr_infrastructure_runtime_startup_shutdown_py,src_zephyr_infrastructure_script_system_finding_py,src_zephyr_infrastructure_sla_sla_monitor_py,src_zephyr_infrastructure_system_telemetry_auto_bootstrap_py,src_zephyr_infrastructure_system_telemetry_contract_metrics_py,src_zephyr_infrastructure_system_telemetry_health_aggregator_py,src_zephyr_infrastructure_system_telemetry_health_probes_py,src_zephyr_infrastructure_system_telemetry_logs_init_py,src_zephyr_infrastructure_system_telemetry_metrics_blueprint_metrics_py production
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_INTEGRATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class src_zephyr_infrastructure_system_telemetry_traces_span_stub_py,src_zephyr_infrastructure_system_telemetry_watchdog_py,src_zephyr_trading_main_py,src_zephyr_trading_orphan_detector_py,src_zephyr_trading_ports_py design
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_AUTONOMY_CORE,D_GOV_RULE,D_SECURITY,D_TRADING,D_INTEGRATION external_prod
    class D_INTELLIGENCE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_RULE external_prod
    class D_AUTONOMY_CORE external_design
```

### 运营态子图（仅 design_maturity=production 的模块和依赖）

> 仅展示已上线运行的模块（共 114 个，101 条域内依赖）。
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOV_RULE,D_GOVERNANCE,D_INTELLIGENCE,D_TRADING external_prod

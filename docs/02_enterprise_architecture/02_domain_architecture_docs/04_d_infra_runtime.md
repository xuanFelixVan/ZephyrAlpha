...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_INTEGRATION,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOV_DRIFT,D_INTEGRATION,D_TRADING,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_INTEGRATION external_prod

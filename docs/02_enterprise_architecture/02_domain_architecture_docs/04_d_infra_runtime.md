...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_INTELLIGENCE,D_INTEGRATION external_prod
    class D_SHARED,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_INFRA_A2A,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_RULE,D_AUTONOMY_CORE,D_INTEGRATION,D_TRADING,D_SECURITY external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INTELLIGENCE,D_SHARED,D_GOV_RULE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_GOV_DRIFT,D_INFRA_A2A,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_DATA,D_GOVERNANCE,D_ORCHESTRATOR,D_SECURITY external_design
```

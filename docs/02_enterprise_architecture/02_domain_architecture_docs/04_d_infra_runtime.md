...
| 跨域入边 | 196 | Cross-domain Incoming | 196 |
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_TELEMETRY external_prod
    class D_AUDITTEST,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_infrastructure_auto_fix_engine_interrupt_guard_py
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_SHARED,D_INTEGRATION,D_TRADING,D_AUTONOMY_CORE external_prod
...
| D_GOVERNANCE | 21 | config_depends,import_depends,runtime |

...
graph TD
    ...
    class D_GOV_REPAIR,D_FEEDBACK_LOOP external_prod
    class D_SHARED,D_GOVERNANCE,D_SECURITY_LLM,D_GOV_CODE_QUALITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_SECURITY_LLM,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_TELEMETRY,D_INTEGRATION,D_GOV_DRIFT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    src_zephyr_shared_lifecycle_init_py -.->|config_depends / config_depends| src_zephyr_shared_lifecycle_lazy_loader_py
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_TRADING,D_INFRA_TELEMETRY,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_RULE external_prod
    class D_INTELLIGENCE,D_INFRA_A2A,D_SECURITY,D_ORCHESTRATOR,D_TRADING,D_GOVERNANCE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_A2A,D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INTEGRATION,D_INTELLIGENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_INFRA_A2A,D_GOV_DRIFT,D_SHARED,D_FBL_DETECTORS,D_INFRA_TELEMETRY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_REPAIR,D_GOV_RULE,D_INFRA_TELEMETRY external_prod
    class D_AUTONOMY_CORE,D_INTELLIGENCE,D_TRADING,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INFRA_A2A,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_INFRA_TELEMETRY external_prod
    class D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_GOVERNANCE,D_INTEGRATION external_design
```
...
| 205 | 包 shared.blueprint_tools 的初始化文件。 (__ini... | → | D_SHARED 共享服务: blueprint_code_auditor.py | config_depends / config_depends |
...
| 213 | 包 shared.maintenance 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: Autonomy Monitor — AI 自主等级监控与降级。 (au... | config_depends / config_depends |
...
| 222 | 包 shared.session 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: SessionContinuity — Session 交接包自动生成与恢... | config_depends / config_depends |

...
| 跨域入边 | 185 | Cross-domain Incoming | 185 |
...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_SECURITY,D_GOV_SCRIPTS,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_TRADING,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_TRADING,D_INTEGRATION external_prod
...
| D_GOVERNANCE | 13 | config_depends,import_depends,runtime |

...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_INFRA_TELEMETRY["D_INFRA_TELEMETRY prototype"]
    D_INFRA_TELEMETRY -.->|runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_AUDITTEST["D_AUDITTEST prototype"]
    ...
    class D_GOVERNANCE,D_FACTOR,D_INFRA_TELEMETRY,D_AUDITTEST external_design
```

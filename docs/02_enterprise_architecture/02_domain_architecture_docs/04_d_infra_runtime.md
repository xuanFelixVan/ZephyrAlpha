...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_INTEGRATION,D_GOVERNANCE,D_TRADING external_prod
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_GOV_SCRIPTS,D_COMPLIANCE,D_GOVERNANCE,D_AUTONOMY_CORE external_design
```

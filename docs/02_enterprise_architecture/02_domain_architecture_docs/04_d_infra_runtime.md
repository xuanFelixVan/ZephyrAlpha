...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_SECURITY_LLM,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_ORCHESTRATOR external_prod
    class D_DATA,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_TRADING,D_INFRA_TELEMETRY,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_TRADING,D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_INFRASTRUCTURE external_prod
    class D_ORCHESTRATOR,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT,D_AUTONOMY_PERM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_INTELLIGENCE,D_SECURITY,D_INFRA_A2A,D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SHARED,D_INFRA_A2A,D_GOVERNANCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_INFRA_RECOVERY,D_SECURITY,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_SHARED,D_INFRA_TELEMETRY external_prod
```
...
| 204 | 包 shared.adaptation 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: Execution Tuner — 执行调谐器（token/timeout 自... | config_depends / config_depends |
| 205 | 包 shared.capacity_governance 的初始化文件。 (_... | → | D_SHARED 共享服务: budget_aware_prompt.py | config_depends / config_depends |

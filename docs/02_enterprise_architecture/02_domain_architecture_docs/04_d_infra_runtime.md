...
graph TD
    ...
    class D_GOV_SCRIPTS,D_ORCHESTRATOR,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_DRIFT,D_TRADING,D_INTEGRATION,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_RULE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INTEGRATION,D_TRADING,D_INTELLIGENCE external_prod

...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_BACKTEST,D_GOVERNANCE,D_INTEGRATION,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SECURITY,D_INTELLIGENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_RULE,D_INTELLIGENCE,D_SHARED,D_TRADING,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE,D_INTELLIGENCE,D_INTEGRATION external_prod
    class D_GOV_CODE_QUALITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_INTEGRATION,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
    class D_DATA,D_GOVERNANCE,D_SHARED,D_ORCHESTRATOR,D_SECURITY external_design
```

...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_DOCS,D_FACTOR,D_SECURITY_LLM,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY external_design
```
...
> 本域与 31 个外部域直接连接（出边 315 条 + 入边 246 条 = 561 条）。只显示直接连接的域，不展开具体节点。

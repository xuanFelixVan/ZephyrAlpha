...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_REPAIR external_prod
    class D_GOV_OPS_RESILIENCE,D_SECURITY_LLM,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SECURITY_LLM,D_INTELLIGENCE,D_COMPLIANCE,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SECURITY_LLM,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_TELEMETRY,D_GOV_SCRIPTS,D_ORCHESTRATOR,D_GOVERNANCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
    class D_SHARED,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_SECURITY external_prod
    class D_INTELLIGENCE,D_ORCHESTRATOR,D_GOVERNANCE,D_AUTONOMY_CORE,D_TRADING,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_TRADING,D_GOV_OPS_RESILIENCE,D_INFRA_A2A,D_INFRA_RECOVERY,D_GOV_AUDIT,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INFRA_A2A,D_FBL_DETECTORS,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_TELEMETRY,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_GOV_REPAIR external_prod
    class D_INTELLIGENCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_SECURITY_LLM,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_INFRA_TELEMETRY,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
    class D_ORCHESTRATOR,D_GOV_SCRIPTS,D_GOVERNANCE,D_SECURITY external_design
```
...
| 208 | 包 shared.capacity_governance 的初始化文件。 (_... | → | D_SHARED 共享服务: capacity_digital_twin.py | config_depends / config_depends |

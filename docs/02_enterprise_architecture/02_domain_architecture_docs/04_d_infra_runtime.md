...
graph TD
    ...
    class D_INFRA_TELEMETRY,D_TRADING,D_GOVERNANCE external_prod
    class D_SHARED,D_AUDITTEST,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_infrastructure_resource_provider_py
    D_GOVERNANCE -.->|contract| src_zephyr_infrastructure_resource_provider_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_AUDITTEST,D_GOV_SCRIPTS external_design
```
...
| D_GOVERNANCE | 19 | config_depends,contract,import_depends,runtime |

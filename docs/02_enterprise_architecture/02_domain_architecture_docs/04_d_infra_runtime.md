...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_BACKTEST,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_AUTONOMY_CORE,D_INTEGRATION,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_RULE,D_INTELLIGENCE external_prod
    class D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_COMPLIANCE external_design
```

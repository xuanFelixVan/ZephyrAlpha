...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_AUTONOMY_CORE,D_INTEGRATION,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INFRA_A2A,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_INTEGRATION,D_GOVERNANCE external_prod

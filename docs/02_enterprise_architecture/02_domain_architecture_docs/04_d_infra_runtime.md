...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INTELLIGENCE,D_GOVERNANCE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INTEGRATION,D_TRADING,D_SECURITY external_prod

...
graph TD
    ...
    src_zephyr_infrastructure_asset_inventory_main_py -->|import_depends| D_SHARED
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_TRADING external_prod
```

...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_SECURITY_LLM,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTELLIGENCE,D_SECURITY_LLM,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_ORCHESTRATOR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_REPAIR external_prod
    class D_INFRA_TELEMETRY,D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_TELEMETRY,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP external_prod
    class D_SECURITY,D_TRADING,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_SECURITY external_prod
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DETECTORS,D_SECURITY,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_SHARED,D_INFRA_TELEMETRY,D_GOV_REPAIR,D_INFRA_A2A,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_REPAIR external_prod
    class D_TRADING,D_INTELLIGENCE,D_SECURITY_LLM,D_GOVERNANCE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_TELEMETRY,D_FEEDBACK_LOOP external_prod
    class D_GOVERNANCE,D_ORCHESTRATOR,D_GOV_SCRIPTS,D_INTEGRATION,D_SECURITY external_design
```
...
| 205 | 包 shared.blueprint_tools 的初始化文件。 (__ini... | → | D_SHARED 共享服务: ai_understandability_constraint.py | config_depends / config_depends |
| 206 | 包 shared.capacity_governance 的初始化文件。 (_... | → | D_SHARED 共享服务: budget_aware_prompt.py | config_depends / config_depends |
...
| 215 | __init__.py | → | D_SHARED 共享服务: Healthcheck Service — 运行时健康检查服务。 (he... | config_depends / config_depends |
...
| 223 | shared.schema — auto-generated package init. (... | → | D_SHARED 共享服务: base_config.py | config_depends / config_depends |
...
| 225 | 包 shared.session 的初始化文件。 (__init__.py) | → | D_SHARED 共享服务: session_audit.py —— Session 审计轨迹（Phase 1... | config_depends / config_depends |

...
flowchart TD
    ...
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_trigger_monitor_py["触发监控器<br/>基础设施/layer2 communication包的trigger_<br/>monitor模块<br/>文件: layer2_communication/trigger_monitor.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_consensus_py["共识<br/>基础设施/layer3 coordination包的consensus模块<br/>Re-export bridge for layer3_coordination<br/>consensus symbols.<br/>文件: layer3_coordination/_consensus.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_core_coordination_py["核心coordination<br/>基础设施/layer3 coordination包的core_<br/>coordination模块<br/>Re-export bridge for layer3_coordination core<br/>coordination symbols.<br/>文件: layer3_coordination/_core_coordination.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_intelligence_py["智能<br/>基础设施/layer3 coordination包的intelligence模块<br/>Re-export bridge for layer3_coordination<br/>intelligence symbols.<br/>文件: layer3_coordination/_intelligence.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_security_and_economics_py["安全andeconomics<br/>基础设施/layer3 coordination包的security_and_<br/>economics模块<br/>Re-export bridge for layer3_coordination<br/>security and economics symbols.<br/>文件: layer3_coordination/_security_and_<br/>economics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_checkpoint_py["A2A 检查点管理器<br/>基础设施/layer3 coordination包的a2a_<br/>checkpoint模块<br/>文件: layer3_coordination/a2a_checkpoint.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_constitutional_py["P2: 宪法性Agent管理<br/>基础设施/layer3 coordination包的a2a_<br/>constitutional模块<br/>文件: layer3_coordination/a2a_constitutional.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_context_rot_py["上下文腐烂检测<br/>基础设施/layer3 coordination包的a2a_context_<br/>rot模块<br/>文件: layer3_coordination/a2a_context_rot.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_formal_verification_py["A2A 形式化验证 — 协议属性模型检查<br/>基础设施/layer3 coordination包的a2a_formal_<br/>verification模块<br/>文件: layer3_coordination/a2a_formal_<br/>verification.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_hardware_router_py["A2A 硬件路由器——GPU/CPU 调度<br/>基础设施/layer3 coordination包的a2a_hardware_<br/>router模块<br/>文件: layer3_coordination/a2a_hardware_router.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_hibernate_py["P2: Agent休眠管理<br/>基础设施/layer3 coordination包的a2a_<br/>hibernate模块<br/>文件: layer3_coordination/a2a_hibernate.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_vector_reputation_py["向量化信誉系统<br/>基础设施/layer3 coordination包的a2a_vector_<br/>reputation模块<br/>文件: layer3_coordination/a2a_vector_<br/>reputation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_anomaly_detector_py["A2A 统计异常检测引擎 — 基线学习 + 实时异常判断<br/>基础设施/layer3 coordination包的a2a_anomaly_<br/>detector模块<br/>文件: layer3_coordination/a2a_anomaly_<br/>detector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_blame_attribution_py["A2A 责任归属引擎 — 因果链分析 + 责任分配<br/>基础设施/layer3 coordination包的a2a_blame_<br/>attribution模块<br/>文件: layer3_coordination/a2a_blame_<br/>attribution.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_economics_py["A2A 经济学——Token/API成本追踪<br/>基础设施/layer3 coordination包的a2a_<br/>economics模块<br/>文件: layer3_coordination/a2a_economics.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_forgetting_py["A2A 遗忘机制<br/>基础设施/layer3 coordination包的a2a_<br/>forgetting模块<br/>文件: layer3_coordination/a2a_forgetting.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_idempotency_py["A2A 幂等性保证<br/>基础设施/layer3 coordination包的a2a_<br/>idempotency模块<br/>文件: layer3_coordination/a2a_idempotency.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_idle_guard_py["A2A 空闲守卫<br/>基础设施/layer3 coordination包的a2a_idle_<br/>guard模块<br/>文件: layer3_coordination/a2a_idle_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_latent_comm_py["A2A 隐性通信检测 — 检测 Agent 通过副作用隐式通信<br/>基础设施/layer3 coordination包的a2a_latent_<br/>comm模块<br/>文件: layer3_coordination/a2a_latent_comm.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_negotiation_py["A2A 协商协议 — Agent 间资源/任务分配协商<br/>基础设施/layer3 coordination包的a2a_<br/>negotiation模块<br/>文件: layer3_coordination/a2a_negotiation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_temporal_admission_py["时序准入控制<br/>基础设施/layer3 coordination包的a2a_temporal_<br/>admission模块<br/>文件: layer3_coordination/a2a_temporal_<br/>admission.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_work_steal_py["A2A 工作窃取调度器 — 跨 Agent 负载均衡<br/>基础设施/layer3 coordination包的a2a_work_<br/>steal模块<br/>文件: layer3_coordination/a2a_work_steal.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_conflict_detector_py["A2A 冲突检测引擎 — 语义+文本+资源三维冲突检测<br/>基础设施/layer3 coordination包的conflict_<br/>detector模块<br/>文件: layer3_coordination/conflict_detector.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_construction_verifier_py["施工后验证器 —<br/>自指悖论防御：不橡胶图章，真正验证 A2A<br/>协议模块的施工完整<br/>基础设施/layer3 coordination包的construction_<br/>verifier模块<br/>文件: layer3_coordination/construction_<br/>verifier.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_deadlock_guard_py["P2: 死锁守卫<br/>基础设施/layer3 coordination包的deadlock_<br/>guard模块<br/>文件: layer3_coordination/deadlock_guard.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_livelock_detector_py["P2: 活锁检测器<br/>基础设施/layer3 coordination包的livelock_<br/>detector模块<br/>文件: layer3_coordination/livelock_detector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_delegation_chain_py["委托链<br/>基础设施/layer3 coordination包的a2a_delegation_<br/>chain模块<br/>文件: layer3_coordination/a2a_delegation_<br/>chain.py<br/>(生产态 / production)"]

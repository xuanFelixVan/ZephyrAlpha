...
flowchart TD
    src_zephyr_infrastructure_a2a_protocol_a2a_card_registry_py["(生产态 / production) A2Acard注册表 /<br/>a2a_card_registry<br/>A2A Card Registry — 全局 Agent Card<br/>注册单例<br/>文件: a2a_protocol/a2a_card_registry.py"]
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_context_package_py["(生产态 / production) 上下文包 /<br/>context_package<br/>Context Package — A2A 上下文包<br/>文件: layer2_communication/context_<br/>package.py"]
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_handoff_manager_py["(生产态 / production) handoff管理器 /<br/>handoff_manager<br/>Handoff Manager — Agent 间任务交接<br/>文件: layer2_communication/handoff_<br/>manager.py"]
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_message_router_py["(生产态 / production) message路由器 /<br/>message_router<br/>Message Router — A2A 消息路由<br/>文件: layer2_communication/message_<br/>router.py"]
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_push_notifier_py["(生产态 / production) push通知器 / push_<br/>notifier<br/>Push Notifier — A2A 推送通知<br/>文件: layer2_communication/push_<br/>notifier.py"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_trigger_monitor_py["(生产态 / production) 触发监控器 /<br/>trigger_monitor<br/>触发监控器<br/>文件: layer2_communication/trigger_<br/>monitor.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_consensus_py["(生产态 / production) 共识 / Re-export<br/>bridge for layer3_coordination<br/>consensus symbols.<br/>共识。Re-export bridge for layer3_<br/>coordination consensus symbols.<br/>文件: layer3_coordination/_consensus.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_core_coordination_py["(生产态 / production) 核心coordination<br/>/ Re-export bridge for layer3_<br/>coordination core coordination s<br/>核心coordination。Re-export bridge for<br/>layer3_coordination core coordination<br/>symbols.<br/>文件: layer3_coordination/_core_<br/>coordination.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_intelligence_py["(生产态 / production) 智能 / Re-export<br/>bridge for layer3_coordination<br/>intelligence symbol<br/>智能。Re-export bridge for layer3_<br/>coordination intelligence symbols.<br/>文件: layer3_coordination/_<br/>intelligence.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_security_and_economics_py["(生产态 / production) 安全andeconomics<br/>/ Re-export bridge for layer3_<br/>coordination security and econom<br/>安全andeconomics。Re-export bridge for<br/>layer3_coordination security and<br/>economics symbols.<br/>文件: layer3_coordination/_security_and_<br/>economics.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_agent_blocklist_py["(生产态 / production) A2A代理blocklist<br/>/ a2a_agent_blocklist<br/>A2A Agent 黑名单管理（重命名自 a2a_<br/>protocol_security.py，AI-14 审计 P5<br/>修复）<br/>文件: layer3_coordination/a2a_agent_<br/>blocklist.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_carbon_py["(生产态 / production) A2A 碳足迹追踪 /<br/>a2a_carbon<br/>A2A 碳足迹追踪<br/>文件: layer3_coordination/a2a_carbon.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_checkpoint_py["(生产态 / production) A2A 检查点管理器<br/>/ a2a_checkpoint<br/>A2A 检查点管理器<br/>文件: layer3_coordination/a2a_<br/>checkpoint.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_consent_py["(生产态 / production) P2: Agent同意管理<br/>/ a2a_consent<br/>P2: Agent同意管理<br/>文件: layer3_coordination/a2a_consent.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_constitutional_py["(生产态 / production) P2:<br/>宪法性Agent管理 / a2a_constitutional<br/>P2: 宪法性Agent管理<br/>文件: layer3_coordination/a2a_<br/>constitutional.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_context_rot_py["(生产态 / production) 上下文腐烂检测 /<br/>a2a_context_rot<br/>上下文腐烂检测<br/>文件: layer3_coordination/a2a_context_<br/>rot.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_dashboard_py["(生产态 / production) A2A仪表盘 / a2a_<br/>dashboard<br/>A2A 监控仪表盘 — Agent<br/>集群运行状态可视化面板<br/>文件: layer3_coordination/a2a_<br/>dashboard.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_formal_verification_py["(生产态 / production) A2A 形式化验证 —<br/>协议属性模型检查 / a2a_formal_<br/>verification<br/>A2A 形式化验证 — 协议属性模型检查<br/>文件: layer3_coordination/a2a_formal_<br/>verification.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_frame_negotiation_py["(生产态 / production) A2A帧negotiation<br/>/ a2a_frame_negotiation<br/>A2A ANP 帧协商协议 — Agent Negotiation<br/>Protocol 帧层协商<br/>文件: layer3_coordination/a2a_frame_<br/>negotiation.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_hardware_router_py["(生产态 / production) A2A<br/>硬件路由器——GPU/CPU 调度 / a2a_hardware_<br/>router<br/>A2A 硬件路由器——GPU/CPU 调度<br/>文件: layer3_coordination/a2a_hardware_<br/>router.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_hibernate_py["(生产态 / production) P2: Agent休眠管理<br/>/ a2a_hibernate<br/>P2: Agent休眠管理<br/>文件: layer3_coordination/a2a_<br/>hibernate.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_immune_py["(生产态 / production) A2A 免疫系统 /<br/>a2a_immune<br/>A2A 免疫系统<br/>文件: layer3_coordination/a2a_immune.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_metrics_py["(生产态 / production) A2A 指标收集 /<br/>a2a_metrics<br/>A2A 指标收集<br/>文件: layer3_coordination/a2a_metrics.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_protocol_gateway_py["(生产态 / production) A2A协议网关 / a2a_<br/>protocol_gateway<br/>A2A 协议网关 — Agent<br/>间请求分发与协议转换<br/>文件: layer3_coordination/a2a_protocol_<br/>gateway.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_tracing_py["(生产态 / production) A2A 分布式追踪 —<br/>跨 Agent 请求链追踪 (Span-based) / a2a_<br/>tracing<br/>A2A 分布式追踪 — 跨 Agent 请求链追踪<br/>(Span-based)<br/>文件: layer3_coordination/a2a_tracing.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_vector_reputation_py["(生产态 / production) 向量化信誉系统 /<br/>a2a_vector_reputation<br/>向量化信誉系统<br/>文件: layer3_coordination/a2a_vector_<br/>reputation.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_spec_sync_py["(生产态 / production) spec同步 / spec_<br/>sync<br/>A2A Living Spec 同步 —<br/>蓝图与实现的双向漂移管理<br/>文件: layer3_coordination/spec_sync.py"]
    src_zephyr_infrastructure_a2a_protocol_local_first_arch_py["(生产态 / production) 本地首架构 /<br/>local_first_arch<br/>本地首架构，供MOD-INF-027;MOD-INF-018;MO<br/>D-IN使用<br/>文件: a2a_protocol/local_first_arch.py"]
    src_zephyr_infrastructure_a2a_protocol_migration_strategy_py["(生产态 / production) 迁移策略 /<br/>migration_strategy<br/>迁移策略，供MOD-INF-027;MOD-INF-018;MOD-<br/>IN使用<br/>文件: a2a_protocol/migration_strategy.py"]
    src_zephyr_infrastructure_a2a_protocol_multi_agent_py["(生产态 / production) 多代理 / multi_<br/>agent<br/>— Multi-Agent 编排基座（Phase 14 / 盲点<br/>B33）<br/>文件: a2a_protocol/multi_agent.py"]
    src_zephyr_infrastructure_a2a_protocol_multi_model_consensus_py["(生产态 / production) 多模型共识 /<br/>multi_model_consensus<br/>多模型共识，基础设施的模型，定义数据结构<br/>和字段。<br/>文件: a2a_protocol/multi_model_<br/>consensus.py"]
    src_zephyr_infrastructure_a2a_protocol_offline_autonomy_py["(生产态 / production) 离线autonomy /<br/>offline_autonomy<br/>离线autonomy，供MOD-INF-027;MOD-INF-018;<br/>MOD-IN使用<br/>文件: a2a_protocol/offline_autonomy.py"]
    src_zephyr_infrastructure_a2a_protocol_offline_resilience_py["(生产态 / production) 离线韧性 /<br/>offline_resilience<br/>离线韧性，供MOD-INF-027;MOD-INF-018;MOD-<br/>IN使用<br/>文件: a2a_protocol/offline_resilience.py"]
    src_zephyr_infrastructure_a2a_protocol_phase_hold_py["(生产态 / production) 阶段hold / phase_<br/>hold<br/>Phase 4 Hold — A2A Phase 4 锁定标记模块<br/>与其他 Phase 3 模块不可并发施工.<br/>文件: a2a_protocol/phase_hold.py"]
    src_zephyr_infrastructure_a2a_protocol_prompt_lifecycle_py["(生产态 / production) 提示生命周期 /<br/>prompt_lifecycle<br/>提示生命周期，供MOD-INF-027;MOD-INF-018;<br/>MOD-IN使用<br/>文件: a2a_protocol/prompt_lifecycle.py"]
    src_zephyr_infrastructure_a2a_protocol_realtime_streaming_py["(生产态 / production) 实时流式 /<br/>realtime_streaming<br/>实时流式，供MOD-INF-027;MOD-INF-018;MOD-<br/>IN使用<br/>文件: a2a_protocol/realtime_streaming.py"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_a2a_schemas_py["(生产态 / production) A2A模式 / a2a_<br/>schemas<br/>A2A Message/Part 系统 — Layer 2<br/>Communication<br/>文件: layer2_communication/a2a_<br/>schemas.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_anomaly_detector_py["(生产态 / production) A2A<br/>统计异常检测引擎 — 基线学习 +<br/>实时异常判断 / a2a_anomaly_detector<br/>A2A 统计异常检测引擎 — 基线学习 +<br/>实时异常判断<br/>文件: layer3_coordination/a2a_anomaly_<br/>detector.py"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_blame_attribution_py["(生产态 / production) A2A 责任归属引擎<br/>— 因果链分析 + 责任分配 / a2a_blame_<br/>attribution<br/>A2A 责任归属引擎 — 因果链分析 + 责任分配<br/>文件: layer3_coordination/a2a_blame_<br/>attribution.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_causal_trace_py["(生产态 / production) A2Acausal追踪 /<br/>a2a_causal_trace<br/>A2A 因果追踪 — 跨 Agent 操作因果链图谱<br/>文件: layer3_coordination/a2a_causal_<br/>trace.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_collusion_detector_py["(生产态 / production)<br/>A2Acollusion检测器 / a2a_collusion_<br/>detector<br/>A2A 合谋检测器 — Agent 间串通模式识别<br/>文件: layer3_coordination/a2a_collusion_<br/>detector.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_cross_agent_semantic_flow_py["(生产态 / production)<br/>A2A跨代理semantic流程 / a2a_cross_agent_<br/>semantic_flow<br/>A2A 跨 Agent 语义流追踪 — 知识+意图在<br/>Agent 间传递<br/>文件: layer3_coordination/a2a_cross_<br/>agent_semantic_flow.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_debate_py["(生产态 / production) A2A<br/>结构化辩论协议 — 多轮主张->反驳->合成 /<br/>a2a_debate<br/>A2A 结构化辩论协议 —<br/>多轮主张->反驳->合成<br/>文件: layer3_coordination/a2a_debate.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_economics_py["(生产态 / production) A2A 经济学——Token<br/>/API成本追踪 / a2a_economics<br/>A2A 经济学——Token/API成本追踪<br/>文件: layer3_coordination/a2a_<br/>economics.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_forgetting_py["(生产态 / production) A2A 遗忘机制 /<br/>a2a_forgetting<br/>A2A 遗忘机制<br/>文件: layer3_coordination/a2a_<br/>forgetting.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_idempotency_py["(生产态 / production) A2A 幂等性保证 /<br/>a2a_idempotency<br/>A2A 幂等性保证<br/>文件: layer3_coordination/a2a_<br/>idempotency.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_idle_guard_py["(生产态 / production) A2A 空闲守卫 /<br/>a2a_idle_guard<br/>A2A 空闲守卫<br/>文件: layer3_coordination/a2a_idle_<br/>guard.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_knowledge_distill_py["(生产态 / production) A2A知识distill /<br/>a2a_knowledge_distill<br/>A2A 知识蒸馏 — 跨 Agent 经验提炼与共享<br/>文件: layer3_coordination/a2a_knowledge_<br/>distill.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_latent_comm_py["(生产态 / production) A2A 隐性通信检测<br/>— 检测 Agent 通过副作用隐式通信 / a2a_<br/>latent_comm<br/>A2A 隐性通信检测 — 检测 Agent<br/>通过副作用隐式通信<br/>文件: layer3_coordination/a2a_latent_<br/>comm.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_negotiation_py["(生产态 / production) A2A 协商协议 —<br/>Agent 间资源/任务分配协商 / a2a_<br/>negotiation<br/>A2A 协商协议 — Agent 间资源/任务分配协商<br/>文件: layer3_coordination/a2a_<br/>negotiation.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_red_team_py["(生产态 / production) A2A 红队测试 —<br/>攻击向量定义与执行框架 / a2a_red_team<br/>A2A 红队测试 — 攻击向量定义与执行框架<br/>文件: layer3_coordination/a2a_red_<br/>team.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_saga_py["(生产态 / production) A2A Saga 事务协议<br/>— 多 Agent 跨步分布式事务 / a2a_saga<br/>A2A Saga 事务协议 — 多 Agent<br/>跨步分布式事务<br/>文件: layer3_coordination/a2a_saga.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_temporal_admission_py["(生产态 / production) 时序准入控制 /<br/>a2a_temporal_admission<br/>时序准入控制<br/>文件: layer3_coordination/a2a_temporal_<br/>admission.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_voting_py["(生产态 / production) A2A 加权投票协议<br/>— 多 Agent 共识达成机制 / a2a_voting<br/>A2A 加权投票协议 — 多 Agent 共识达成机制<br/>文件: layer3_coordination/a2a_voting.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_work_steal_py["(生产态 / production) A2A<br/>工作窃取调度器 — 跨 Agent 负载均衡 /<br/>a2a_work_steal<br/>A2A 工作窃取调度器 — 跨 Agent 负载均衡<br/>文件: layer3_coordination/a2a_work_<br/>steal.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_arbitrator_py["(生产态 / production) 仲裁器 /<br/>arbitrator<br/>A2A 三级仲裁引擎 — priority -> rule -><br/>escalation<br/>文件: layer3_coordination/arbitrator.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_cascade_guard_py["(生产态 / production) 级联守卫 /<br/>cascade_guard<br/>级联守卫——防止失败在Agent间级联<br/>文件: layer3_coordination/cascade_<br/>guard.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_conflict_detector_py["(生产态 / production) A2A 冲突检测引擎<br/>— 语义+文本+资源三维冲突检测 / conflict_<br/>detector<br/>A2A 冲突检测引擎 —<br/>语义+文本+资源三维冲突检测<br/>文件: layer3_coordination/conflict_<br/>detector.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_construction_verifier_py["(生产态 / production) 施工后验证器 —<br/>自指悖论防御：不橡胶图章，真正验证 A2A<br/>协议模块的施工完整 / construction_<br/>verifier<br/>施工后验证器 —<br/>自指悖论防御：不橡胶图章，真正验证 A2A<br/>协议模块的施工完整性<br/>文件: layer3_coordination/construction_<br/>verifier.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_deadlock_guard_py["(生产态 / production) P2: 死锁守卫 /<br/>deadlock_guard<br/>P2: 死锁守卫<br/>文件: layer3_coordination/deadlock_<br/>guard.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_livelock_detector_py["(生产态 / production) P2: 活锁检测器 /<br/>livelock_detector<br/>P2: 活锁检测器<br/>文件: layer3_coordination/livelock_<br/>detector.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_semantic_diff_py["(生产态 / production) semantic差异 /<br/>semantic_diff<br/>A2A 语义差异引擎 — 结构感知的 Agent<br/>间差异检测<br/>文件: layer3_coordination/semantic_<br/>diff.py"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer1_discovery_a2a_registry_py["(生产态 / production) A2A注册表 / a2a_<br/>registry<br/>A2A Registry — Agent Card 注册与发现<br/>文件: layer1_discovery/a2a_registry.py"]
    src_zephyr_infrastructure_a2a_protocol_layer1_discovery_identity_verifier_py["(生产态 / production) identity验证器 /<br/>identity_verifier<br/>Identity Verifier — JWT 身份验证器<br/>文件: layer1_discovery/identity_<br/>verifier.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_delegation_chain_py["(生产态 / production) 委托链 / a2a_<br/>delegation_chain<br/>委托链<br/>文件: layer3_coordination/a2a_<br/>delegation_chain.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_security_py["(生产态 / production) A2A<br/>安全内容扫描器 — 六大类威胁检测 / a2a_<br/>security<br/>A2A 安全内容扫描器 — 六大类威胁检测<br/>文件: layer3_coordination/a2a_<br/>security.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_session_smuggling_defense_py["(生产态 / production) 会话smuggling防御<br/>/ session_smuggling_defense<br/>A2A Session 走私防御 — 防止跨 Agent<br/>session 上下文伪造<br/>文件: layer3_coordination/session_<br/>smuggling_defense.py"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_supervisor_py["(生产态 / production) 监督器 /<br/>Supervisor — A2A Layer 3 Coordination<br/>监督者——任务分配、死锁检测、超时管理<br/>文件: layer3_coordination/supervisor.py"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer1_discovery_agent_card_py["(生产态 / production) 代理card / agent_<br/>card<br/>Agent Card 模型 — A2A Layer 1 Discovery<br/>文件: layer1_discovery/agent_card.py"]
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_a2a_state_py["(生产态 / production) A2A状态 / a2a_<br/>state<br/>A2A Task 状态机 — Layer 2 Communication<br/>文件: layer2_communication/a2a_state.py"]

...
flowchart TD
    ...
    src_zephyr_infrastructure_a2a_protocol_layer2_communication_trigger_monitor_py["触发监控器<br/>layer2_communication/trigger_monitor 模块<br/>文件: layer2_communication/trigger_monitor.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_consensus_py["共识<br/>layer3_coordination/_consensus 模块<br/>Re-export bridge for layer3_coordination<br/>consensus symbols.<br/>文件: layer3_coordination/_consensus.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_core_coordination_py["核心coordination<br/>Re-export bridge for layer3_coordination core<br/>coordination s<br/>文件: layer3_coordination/_core_coordination.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_intelligence_py["智能<br/>layer3_coordination/_intelligence 模块<br/>Re-export bridge for layer3_coordination<br/>intelligence symbol<br/>文件: layer3_coordination/_intelligence.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_security_and_economics_py["安全andeconomics<br/>Re-export bridge for layer3_coordination<br/>security and econom<br/>文件: layer3_coordination/_security_and_<br/>economics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_carbon_py["A2A 碳足迹追踪<br/>layer3_coordination/a2a_carbon 模块<br/>文件: layer3_coordination/a2a_carbon.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_checkpoint_py["A2A 检查点管理器<br/>layer3_coordination/a2a_checkpoint 模块<br/>文件: layer3_coordination/a2a_checkpoint.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_consent_py["P2: Agent同意管理<br/>a2a_consent<br/>文件: layer3_coordination/a2a_consent.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_constitutional_py["P2: 宪法性Agent管理<br/>a2a_constitutional<br/>文件: layer3_coordination/a2a_constitutional.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_context_rot_py["上下文腐烂检测<br/>layer3_coordination/a2a_context_rot 模块<br/>文件: layer3_coordination/a2a_context_rot.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_hibernate_py["P2: Agent休眠管理<br/>a2a_hibernate<br/>文件: layer3_coordination/a2a_hibernate.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_immune_py["A2A 免疫系统<br/>layer3_coordination/a2a_immune 模块<br/>文件: layer3_coordination/a2a_immune.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_metrics_py["A2A 指标收集<br/>layer3_coordination/a2a_metrics 模块<br/>文件: layer3_coordination/a2a_metrics.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_vector_reputation_py["向量化信誉系统<br/>layer3_coordination/a2a_vector_reputation 模块<br/>文件: layer3_coordination/a2a_vector_<br/>reputation.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_local_first_arch_py["本地首架构<br/>a2a_protocol/local_first_arch 模块<br/>文件: a2a_protocol/local_first_arch.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_migration_strategy_py["迁移策略<br/>a2a_protocol/migration_strategy 模块<br/>文件: a2a_protocol/migration_strategy.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_offline_autonomy_py["离线autonomy<br/>a2a_protocol/offline_autonomy 模块<br/>文件: a2a_protocol/offline_autonomy.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_offline_resilience_py["离线韧性<br/>a2a_protocol/offline_resilience 模块<br/>文件: a2a_protocol/offline_resilience.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_prompt_lifecycle_py["提示生命周期<br/>a2a_protocol/prompt_lifecycle 模块<br/>文件: a2a_protocol/prompt_lifecycle.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_realtime_streaming_py["实时流式<br/>a2a_protocol/realtime_streaming 模块<br/>文件: a2a_protocol/realtime_streaming.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_forgetting_py["A2A 遗忘机制<br/>layer3_coordination/a2a_forgetting 模块<br/>文件: layer3_coordination/a2a_forgetting.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_idempotency_py["A2A 幂等性保证<br/>layer3_coordination/a2a_idempotency 模块<br/>文件: layer3_coordination/a2a_idempotency.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_idle_guard_py["A2A 空闲守卫<br/>layer3_coordination/a2a_idle_guard 模块<br/>文件: layer3_coordination/a2a_idle_guard.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_temporal_admission_py["时序准入控制<br/>layer3_coordination/a2a_temporal_admission 模块<br/>文件: layer3_coordination/a2a_temporal_<br/>admission.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_deadlock_guard_py["P2: 死锁守卫<br/>layer3_coordination/deadlock_guard 模块<br/>文件: layer3_coordination/deadlock_guard.py<br/>(生产态 / production)"]
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_livelock_detector_py["P2: 活锁检测器<br/>layer3_coordination/livelock_detector 模块<br/>文件: layer3_coordination/livelock_detector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_delegation_chain_py["委托链<br/>layer3_coordination/a2a_delegation_chain 模块<br/>文件: layer3_coordination/a2a_delegation_<br/>chain.py<br/>(生产态 / production)"]

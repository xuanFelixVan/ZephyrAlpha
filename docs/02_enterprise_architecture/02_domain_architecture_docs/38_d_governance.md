...
graph TD
    ...
    class D_OPS,D_SHARED,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_TRADING,D_FEEDBACK_LOOP,D_OPS external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_INTELLIGENCE,D_OPS,D_INTEGRATION,D_GOV_AUDIT external_prod
    class D_GOV_SCRIPTS,D_EX_CORE external_design
```

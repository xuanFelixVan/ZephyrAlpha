...
graph TD
    ...
    class D_INFRA_RUNTIME,D_TRADING,D_INTEGRATION,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_SECURITY,D_GOV_AUDIT external_prod
    class D_SHARED,D_INFRA_A2A,D_EX_CORE external_design
```

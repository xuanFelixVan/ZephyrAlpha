...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_SECURITY,D_INTELLIGENCE,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_OPS,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_KB,D_GOV_SCRIPTS,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_SCRIPTS,D_GOV_DRIFT,D_OPS,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
    class D_SHARED,D_FACTOR,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INTEGRATION,D_GOV_DRIFT,D_GOV_RULE,D_OPS,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_KB,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_OPS,D_SECURITY,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_SCRIPTS external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_GOV_CODE_QUALITY,D_EX_CORE external_design
```

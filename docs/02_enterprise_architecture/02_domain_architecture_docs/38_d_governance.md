...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_TRADING external_prod
...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_infrastructure_a2a_protocol_layer3_coordination_a2a_governance_adapter_py
    D_INFRA_RUNTIME["(生产态 / production) D_INFRA_RUNTIME"]
    ...
    class D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_OPS,D_GOV_SCRIPTS,D_GOV_DRIFT,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_RULE,D_OPS,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_TRADING external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRASTRUCTURE,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS external_prod
...
| 36 | D_GOV_DOCS 架构文档治理: blueprint.md | → | A2A 治理适配器 — 连接 A2A 协议与 Governance 层... | runtime / runtime |

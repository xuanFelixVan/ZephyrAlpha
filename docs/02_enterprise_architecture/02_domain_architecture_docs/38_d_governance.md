...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY external_prod
    class D_INTEGRATION,D_INFRASTRUCTURE,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_GOV_REPAIR external_prod
    class D_GOV_KB,D_INTELLIGENCE,D_INFRASTRUCTURE,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_EX_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_DATA,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_DATA,D_GOV_ENFORCEMENT,D_RISK,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_RULE,D_SECURITY,D_GOV_REPAIR,D_GOV_SCRIPTS external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_KB,D_TRADING external_prod
    class D_INFRA_A2A,D_GOV_SCRIPTS,D_GOV_AUDIT,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FBL_DIAGNOSERS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_AUDIT,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_SHARED,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_OPS,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_TRADING,D_GOV_AUDIT,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOV_KB external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_FRONTEND,D_INFRA_RECOVERY,D_SHARED,D_GOV_DRIFT,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_GOV_SCRIPTS,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_SECURITY,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_AUDIT,D_SECURITY,D_GOV_REPAIR external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_DATA,D_GOV_ENFORCEMENT external_design
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 556 个，102 条域内依赖）。
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_OPS,D_INTEGRATION external_prod

...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_SECURITY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    D_GOV_SCRIPTS["(原型态 / prototype) D_GOV_SCRIPTS"]
    scripts_governance_repair_apply_verification_results_py -.->|config_depends / config_depends| D_GOV_SCRIPTS
    scripts_ide_health_service_py -.->|导入依赖 / import_depends| D_SHARED
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_TRADING,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_GOV_KB,D_INTELLIGENCE,D_INFRASTRUCTURE,D_INTEGRATION_GATEWAY,D_GOV_SCRIPTS,D_GOV_AUDIT,D_EX_CORE,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_DATA,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_DATA,D_RISK,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_CODE_QUALITY,D_OPS,D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_SECURITY external_prod
...
graph TD
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_governance_services_adapter_py
    D_TRADING -.->|导入依赖 / import_depends| src_zephyr_governance_persistence_task_repo_py
    D_GOV_ENFORCEMENT["(原型态 / prototype) D_GOV_ENFORCEMENT"]
    ...
    class D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_TRADING,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
    class D_SHARED,D_INFRA_A2A,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_DATA,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FBL_DETECTORS,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_KB,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_SHARED,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_SHARED,D_INFRA_RECOVERY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INTEGRATION,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_FRONTEND,D_GOV_RULE,D_FEEDBACK_LOOP,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_RULE,D_SHARED,D_GOV_ENFORCEMENT,D_SECURITY,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SECURITY,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_INTEGRATION,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_REPAIR,D_TRADING external_prod
    class D_SHARED,D_DATA,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_GOV_RULE,D_SHARED,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_REPAIR external_prod
    class D_GOV_SCRIPTS,D_AUTONOMY_PERM external_design
```
...
| 48 | test_blueprint_frontmatter_reconciler_post_comm... | → | D_GOV_AUDIT 审计追踪: reconciliation_registry.py — GitCommitGateway ... | 测试依赖 / test_depends |
...
| 252 | kb.pipeline — auto-generated package init. (__... | → | D_GOV_KB 知识库治理: G3 Evaluate 门禁 — 深度评估（T-2-13-C） (analy... | config_depends / config_depends |
| 253 | kb.storage — auto-generated package init. (__i... | → | D_GOV_KB 知识库治理: UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | config_depends / config_depends |
...
| 346 | apply_verification_results.py — 第32轮验证结果... | → | D_GOV_SCRIPTS 脚本治理: concurrent_commit_test.py — 幽灵提交红蓝对抗脚... | config_depends / config_depends |
...
| 130 | D_GOV_REPAIR 治理修复: __init__.py | → | context_budget.py —— 上下文预算管理与超预算截... | config_depends / config_depends |
...
| 135 | D_GOV_REPAIR 治理修复: __init__.py | → | agent_debate.py | config_depends / config_depends |
| 136 | D_GOV_REPAIR 治理修复: __init__.py | → | api_lifecycle.py | config_depends / config_depends |
| 137 | D_GOV_REPAIR 治理修复: __init__.py | → | Objective Tracker — v0.9.0 目标漂移检测器: age... | config_depends / config_depends |
...
| 140 | D_GOV_REPAIR 治理修复: Re-export wrapper: true source is zephyr.pf_cor... | → | D_PORTFOLIO_CORE — StrategyBase + StrategyMeta... | config_depends / config_depends |
...
| 216 | D_GOV_SCRIPTS 脚本治理: AGENTS.md 6.4 铁律五 + 铁律六：蓝图中声称的文件... | → | __init__.py | config_depends / config_depends |
...
| 243 | D_GOV_SCRIPTS 脚本治理: validate_static_manifest_drift.py — GATE-21 静... | → | __init__.py | config_depends / config_depends |
...
> 本域与 40 个外部域直接连接（出边 578 条 + 入边 376 条 = 954 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOVERNANCE -->|46条 导入依赖 / import_depends, 测试依赖 / test_depends| D_GOV_AUDIT

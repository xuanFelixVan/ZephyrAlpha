...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_SECURITY,D_DATA external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_OPS,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_SCRIPTS,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_OPS,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_SCRIPTS,D_INTEGRATION,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP external_prod
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE external_prod

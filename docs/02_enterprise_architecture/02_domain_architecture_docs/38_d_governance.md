...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INTELLIGENCE,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME,D_SHARED,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_FEEDBACK_LOOP external_prod
    class D_SHARED,D_INFRA_RUNTIME,D_SECURITY,D_GOV_SCRIPTS,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INTEGRATION,D_SECURITY,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE,D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_INTEGRATION,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_TRADING,D_OPS,D_INTEGRATION,D_INFRASTRUCTURE,D_INTELLIGENCE,D_GOV_AUDIT external_prod
    class D_EX_CORE,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY external_design
```

...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRASTRUCTURE,D_SECURITY,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_TRADING,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_SECURITY,D_OPS,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_RULE,D_TRADING,D_GOV_AUDIT external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_FEEDBACK_LOOP,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SHARED,D_GOV_SCRIPTS,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_OPS,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SECURITY,D_INTEGRATION,D_SHARED,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_TRADING,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_INTEGRATION,D_INTELLIGENCE,D_TRADING,D_OPS,D_GOV_SCRIPTS,D_GOV_AUDIT external_prod
    class D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_EX_CORE external_design
```
...
> 本域与 28 个外部域直接连接（出边 145 条 + 入边 123 条 = 268 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_INTELLIGENCE,D_SECURITY,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTEGRATION,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_SECURITY,D_OPS,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_OPS,D_GOV_DRIFT,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_SECURITY,D_INTEGRATION,D_GOV_SCRIPTS,D_GOV_DRIFT,D_OPS,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INTEGRATION,D_GOV_RULE,D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_OPS external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRASTRUCTURE,D_INTELLIGENCE,D_SECURITY external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_GOV_SCRIPTS,D_EX_CORE,D_INFRA_RUNTIME external_design
```
...
| 4 | D_DATA: ClickHouse 写入器（MOD-L00-004 §3.2 数据流第6.... | → |  | contract / contract |
...
| 37 | D_GOV_DOCS 架构文档治理: blueprint.md | → | error_codes.py | runtime / runtime |

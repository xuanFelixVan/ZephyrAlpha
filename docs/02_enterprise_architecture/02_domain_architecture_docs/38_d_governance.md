...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRASTRUCTURE,D_SECURITY,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_INFRASTRUCTURE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_TRADING,D_OPS,D_GOV_AUDIT external_prod

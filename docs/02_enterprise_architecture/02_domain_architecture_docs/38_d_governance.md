...
> 按 architecture_layer 分组的模块清单（共 700 个模块 / 700 modules）。
...
### L2 领域层 / Domain Layer (678 modules)
...
> 展示全部 700 个模块（生产态 143 + 设计态 1 + 原型态 556），标签标注成熟度。
...
graph TD
    ...
    class D_SECURITY,D_INTELLIGENCE,D_SHARED,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_KB,D_INTELLIGENCE,D_INFRASTRUCTURE,D_INTEGRATION_GATEWAY,D_EX_CORE,D_GOV_AUDIT,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_CODE_QUALITY external_prod
    class D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_REPAIR,D_DATA,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_OPS,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_RULE,D_SHARED,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_SCRIPTS,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_AUTONOMY_CORE,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_INTEGRATION,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_OPS,D_GOV_OPS_RESILIENCE,D_TRADING,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_GOV_KB external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_FRONTEND,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_SHARED,D_INTEGRATION,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_DRIFT,D_GOV_SCRIPTS external_prod
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_SECURITY,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_GOV_REPAIR,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_TRADING,D_DATA,D_INTELLIGENCE external_design
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 556 个，103 条域内依赖）。
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_FRONTEND,D_INFRA_RECOVERY external_prod

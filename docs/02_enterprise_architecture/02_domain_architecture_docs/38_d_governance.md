...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_EX_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRASTRUCTURE,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_GOV_AUDIT external_prod
    class D_SHARED,D_INFRA_A2A,D_EX_CORE,D_INFRA_RUNTIME external_design
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_SHARED,D_INTEGRATION,D_INFRASTRUCTURE,D_SECURITY,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_AUDIT,D_SECURITY,D_TRADING,D_GOV_DRIFT,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INTEGRATION,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_TRADING,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INTELLIGENCE,D_GOV_AUDIT external_prod
    class D_INFRA_A2A,D_GOV_CODE_QUALITY,D_EX_CORE external_design
```

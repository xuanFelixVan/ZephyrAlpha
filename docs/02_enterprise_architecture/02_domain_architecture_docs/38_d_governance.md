...
graph TD
    ...
    class D_INFRASTRUCTURE,D_SHARED,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_SECURITY,D_INTEGRATION,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_OPS,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_BACKTEST,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_KB,D_OPS external_prod
    class D_GOV_SCRIPTS,D_SECURITY,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_OPS,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_PF_ALLOC,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_RULE,D_GOV_DRIFT,D_SECURITY,D_BACKTEST,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_INFRA_A2A,D_EX_CORE,D_INFRA_RUNTIME external_design
```
...
> 本域与 31 个外部域直接连接（出边 149 条 + 入边 129 条 = 278 条）。只显示直接连接的域，不展开具体节点。

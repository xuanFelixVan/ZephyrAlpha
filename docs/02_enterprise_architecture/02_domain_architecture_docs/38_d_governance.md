...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_RULE,D_FEEDBACK_LOOP,D_TRADING,D_FRONTEND external_prod
...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_infrastructure_capacity_assurance_contracts_batch2_governance_py
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_infrastructure_a2a_protocol_governance_base_server_py
    D_INFRA_RUNTIME["(生产态 / production) D_INFRA_RUNTIME"]
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_OPS,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_PF_ALLOC,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP,D_TRADING external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRASTRUCTURE external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_GOV_SCRIPTS,D_EX_CORE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY external_design
```
...
| 36 | D_GOV_DOCS 架构文档治理: blueprint.md | → | _base_server.py | runtime / runtime |

...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRASTRUCTURE,D_SECURITY,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_SCRIPTS external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod
    class D_INFRA_RUNTIME,D_SHARED,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_PF_ALLOC,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_TRADING,D_OPS,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_SCRIPTS external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_EX_CORE,D_GOV_CODE_QUALITY external_design
```

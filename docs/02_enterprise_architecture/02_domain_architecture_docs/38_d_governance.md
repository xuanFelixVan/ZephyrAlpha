...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_INTELLIGENCE,D_OPS external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_GOV_SCRIPTS,D_EX_CORE external_design
```

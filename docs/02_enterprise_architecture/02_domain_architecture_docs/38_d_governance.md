...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INTELLIGENCE,D_SECURITY,D_DATA external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_TRADING,D_SHARED,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_OPS,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_SCRIPTS,D_GOV_DRIFT,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_OPS,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOV_CODE_QUALITY,D_INTEGRATION,D_INFRASTRUCTURE,D_TRADING,D_GOV_AUDIT external_prod
    class D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_EX_CORE external_design
```

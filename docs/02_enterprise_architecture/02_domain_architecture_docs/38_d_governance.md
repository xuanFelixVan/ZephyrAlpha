...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_GOV_DRIFT,D_SECURITY,D_PF_ALLOC external_prod

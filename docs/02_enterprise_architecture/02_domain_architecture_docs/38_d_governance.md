...
| 跨域出边 | 557 | Cross-domain Outgoing | 557 |
...
graph TD
    ...
    class D_INTEGRATION_GATEWAY,D_GOV_KB,D_INFRASTRUCTURE,D_SHARED,D_INTELLIGENCE,D_GOV_SCRIPTS,D_EX_CORE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTEGRATION,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_DATA external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_SECURITY,D_GOV_RULE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_SCRIPTS,D_DATA external_design
```
...
graph TD
    ...
    class D_INFRA_A2A,D_INFRA_RUNTIME,D_DATA,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_DRIFT,D_GOV_RULE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_KB,D_GOV_REPAIR external_prod
    class D_INFRA_RUNTIME,D_INTEGRATION_GATEWAY,D_DATA,D_INFRASTRUCTURE,D_INFRA_A2A,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
...
| 394 | DatabaseService 真源收敛（AI-14 审计 P1 修复） ... | → | D_INFRA_RUNTIME 运行时集成: DatabaseService: 统一管理数据库的连接池、生命周... | 导入依赖 / import_depends |
...
| 123 | D_GOV_REPAIR 治理修复: Agent 治理八件套 · Governance Domain — DOM-GO... | → | DatabaseService 真源收敛（AI-14 审计 P1 修复） ... | 导入依赖 / import_depends |
...
> 本域与 40 个外部域直接连接（出边 557 条 + 入边 375 条 = 932 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_TRADING,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
    class D_SHARED,D_INFRASTRUCTURE,D_EX_CORE,D_GOV_SCRIPTS,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_SHARED,D_TRADING,D_GOV_ENFORCEMENT,D_OPS,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INTELLIGENCE,D_GOV_AUDIT external_prod
    class D_EX_CORE,D_INFRA_RUNTIME external_design
```

...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_INTELLIGENCE,D_SECURITY external_prod
    class D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY external_design
```
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOV_KB,D_SHARED,D_INTELLIGENCE,D_INTEGRATION_GATEWAY,D_EX_CORE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_GOV_REPAIR,D_GOV_SCRIPTS,D_RISK external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_OPS,D_GOV_CODE_QUALITY,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_KB,D_TRADING external_prod
    class D_INFRA_A2A,D_DATA,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_INTEGRATION_GATEWAY,D_SECURITY external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_SHARED,D_FBL_DETECTORS,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_SHARED,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_OPS,D_GOV_OPS_RESILIENCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_SHARED,D_GOV_SCRIPTS,D_GOV_REPAIR external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_FRONTEND,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_GOV_OPS_RESILIENCE,D_SHARED,D_SECURITY,D_INTEGRATION,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_DRIFT,D_GOV_RULE,D_GOV_AUDIT,D_GOV_REPAIR,D_GOV_KB,D_GOV_CODE_QUALITY external_prod
    class D_INFRA_RUNTIME,D_DATA,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_SHARED,D_INFRA_RUNTIME external_prod
    class D_GOV_REPAIR,D_EX_CORE,D_INFRA_A2A external_design
```
...
| 132 | D_GOV_REPAIR 治理修复: __init__.py | → | AtomicTransactionManager — SQLite + 文件系统的... | config_depends / config_depends |
...
| 135 | D_GOV_REPAIR 治理修复: __init__.py | → | paper_live_transition.py | config_depends / config_depends |

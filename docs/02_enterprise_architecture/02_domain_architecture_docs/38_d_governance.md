...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SECURITY,D_INTEGRATION,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_TRADING,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_FRONTEND,D_GOV_DRIFT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_GOV_DRIFT,D_INTEGRATION,D_GOV_ENFORCEMENT,D_OPS,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_AUDIT,D_SECURITY,D_GOV_DRIFT,D_INTEGRATION,D_GOV_CODE_QUALITY,D_FRONTEND,D_GOV_RULE external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_INTELLIGENCE,D_GOV_AUDIT external_prod

...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRASTRUCTURE,D_INTELLIGENCE,D_SECURITY,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_TRADING,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_TRADING external_prod
    class D_INFRA_RUNTIME,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_OPS,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_CODE_QUALITY,D_GOV_AUDIT external_prod

...
graph TD
    ...
    class D_SHARED,D_TRADING,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY,D_INTELLIGENCE,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_AUDIT,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INTELLIGENCE,D_TRADING,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_OPS,D_INFRASTRUCTURE,D_GOV_AUDIT external_prod
    class D_GOV_SCRIPTS,D_EX_CORE,D_INFRA_RUNTIME external_design
```

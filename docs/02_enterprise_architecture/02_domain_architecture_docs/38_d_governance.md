...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INFRASTRUCTURE,D_SECURITY,D_INTEGRATION,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_OPS,D_GOV_OPS_RESILIENCE,D_SHARED,D_SECURITY,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_TRADING,D_FEEDBACK_LOOP external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_PF_ALLOC,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_TRADING,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_INTELLIGENCE external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_INFRASTRUCTURE,D_INTEGRATION,D_GOV_SCRIPTS,D_EX_CORE external_design
```

...
graph TD
    ...
    class D_INTELLIGENCE,D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_INFRASTRUCTURE,D_SECURITY,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_AUDIT,D_SECURITY,D_TRADING external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_SECURITY,D_GOV_SCRIPTS,D_PF_ALLOC external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_AUDIT,D_GOV_CODE_QUALITY external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_INFRASTRUCTURE,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod

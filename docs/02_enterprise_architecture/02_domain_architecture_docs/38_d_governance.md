...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_GOV_AUDIT external_prod
    class D_INFRA_A2A,D_EX_CORE,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY external_design
```

...
graph TD
    ...
    class D_SECURITY,D_RISK,D_DATA,D_INTELLIGENCE,D_SHARED,D_GOV_ENFORCEMENT external_prod
    class D_INTEGRATION,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_governance_agent_spec_registry_py
    D_GOV_SCRIPTS["(原型态 / prototype) D_GOV_SCRIPTS"]
    D_GOV_SCRIPTS -.->|测试依赖 / test_depends| src_zephyr_governance_architecture_governance_blueprint_code_consistency_py
    D_INTELLIGENCE -.->|测试依赖 / test_depends| src_zephyr_governance_agent_spec_rbac_bridge_py
    ...
    class D_INTELLIGENCE,D_SECURITY,D_SHARED,D_INFRA_RECOVERY,D_GOV_REPAIR,D_GOV_AUDIT,D_INTEGRATION external_prod
    class D_GOV_KB,D_INFRASTRUCTURE,D_INFRA_A2A,D_GOV_SCRIPTS,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOV_ENFORCEMENT,D_BACKTEST,D_EX_CORE,D_FRONTEND,D_DATA,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_SCRIPTS,D_GOV_REPAIR external_prod
    class D_SHARED,D_DATA,D_COMPLIANCE,D_INFRA_RUNTIME,D_RISK,D_GOV_ENFORCEMENT,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    D_GOV_REPAIR -.->|config_depends / config_depends| src_zephyr_governance_lifecycle_governance_paper_live_transition_py
    ...
    class D_SHARED,D_OPS,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_AUDIT,D_REPORTING,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_DRIFT,D_GOV_SCRIPTS,D_GOV_KB,D_BACKTEST external_prod
    class D_GOV_REPAIR,D_SECURITY,D_FEEDBACK_LOOP,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_GOV_RULE,D_ORCHESTRATOR external_prod
    class D_TRADING,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_DATA,D_GOV_AUDIT,D_GOV_REPAIR,D_PF_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_INTEGRATION,D_OPS,D_GOV_DRIFT,D_GOV_ENFORCEMENT external_prod
    class D_INFRA_A2A,D_INFRA_RUNTIME,D_GOV_REPAIR,D_INTEGRATION_GATEWAY external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_AUDIT external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_OPS,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_GOV_KB external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_INTEGRATION,D_SHARED,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_FRONTEND,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_OPS,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_SCRIPTS,D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_ENFORCEMENT,D_SECURITY,D_INTEGRATION,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_SECURITY,D_OPS,D_GOV_ENFORCEMENT,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_CODE_QUALITY external_prod
    class D_GOV_REPAIR,D_COMPLIANCE,D_GOV_SCRIPTS,D_DATA external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_FRONTEND,D_GOV_CODE_QUALITY,D_INFRA_RECOVERY,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INTELLIGENCE,D_OPS,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_INTEGRATION,D_TRADING,D_GOV_SCRIPTS,D_INFRA_A2A external_design
```
...
| 140 | D_GOV_REPAIR 治理修复: __init__.py | → | paper_live_transition.py | config_depends / config_depends |

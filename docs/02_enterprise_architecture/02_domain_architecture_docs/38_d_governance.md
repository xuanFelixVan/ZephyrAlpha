...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INTEGRATION,D_INTELLIGENCE,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT,D_DATA external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_SHARED,D_GOV_RULE,D_FRONTEND,D_GOV_AUDIT,D_OPS,D_TRADING external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_OPS,D_INTEGRATION,D_GOV_DRIFT,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_PF_ALLOC external_prod
    class D_INFRA_A2A,D_FACTOR,D_GOV_DOCS,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_SECURITY,D_OPS,D_INTEGRATION,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_FRONTEND,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_TRADING,D_SECURITY,D_INTELLIGENCE,D_GOV_CODE_QUALITY external_prod
    class D_FACTOR,D_GOV_DOCS,D_SHARED,D_INFRA_A2A,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_EX_CORE external_design
```
...
| 84 | D_GOV_SCRIPTS 脚本治理: G-dataflow: 从 dataflowgraph (PostgreSQL) 生成.... | → | dataflowgraph Schema DDL + 连接入口 (dataflowgr... | 导入依赖 / import_depends |
| 85 | D_GOV_SCRIPTS 脚本治理: G-decision: 从 decisiongraph (PostgreSQL) 生成.... | → | decisiongraph Schema DDL + 不变量声明 (decision... | 导入依赖 / import_depends |
...
> 本域与 30 个外部域直接连接（出边 148 条 + 入边 130 条 = 278 条）。只显示直接连接的域，不展开具体节点。

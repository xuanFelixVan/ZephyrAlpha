...
> 展示全部 30 个模块（生产态 16 + 设计态 14），含跨域依赖外部节点。节点含成熟度+名称+大白话/简介+文件路径。
...
flowchart TD
    ...
    src_zephyr_signal_ashare_adjustment_cycle_tracker_py["signal_ashare/adjustment_cycle_tracker<br/>signal ashare包的adjustment_cycle_tracker模块<br/>文件: signal_ashare/adjustment_cycle_tracker.py<br/>(设计态 / design)"]
    ...
    src_zephyr_signal_ashare_causal_inference_engine_py["signal_ashare/causal_inference_engine<br/>signal ashare包的causal_inference_engine模块<br/>文件: signal_ashare/causal_inference_engine.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_coarse_screening_funnel_py["signal_ashare/coarse_screening_funnel<br/>signal ashare包的coarse_screening_funnel模块<br/>文件: signal_ashare/coarse_screening_funnel.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_conditional_density_predictor_py["signal_ashare/conditional_density_predictor<br/>signal ashare包的conditional_density_predictor模<br/>块<br/>文件: signal_ashare<br/>/conditional_density_predictor.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_conformal_predictor_py["signal_ashare/conformal_predictor<br/>signal ashare包的conformal_predictor模块<br/>文件: signal_ashare/conformal_predictor.py<br/>(设计态 / design)"]
    ...
    src_zephyr_signal_ashare_cross_market_conduction_sensor_py["signal_ashare/cross_market_conduction_sensor<br/>signal ashare包的cross_market_conduction_sensor<br/>模块<br/>文件: signal_ashare<br/>/cross_market_conduction_sensor.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_event_driven_screener_py["signal_ashare/event_driven_screener<br/>signal ashare包的event_driven_screener模块<br/>文件: signal_ashare/event_driven_screener.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_fine_scoring_engine_py["signal_ashare/fine_scoring_engine<br/>signal ashare包的fine_scoring_engine模块<br/>文件: signal_ashare/fine_scoring_engine.py<br/>(设计态 / design)"]
    ...
    src_zephyr_signal_ashare_market_lifecycle_phase_py["signal_ashare/market_lifecycle_phase<br/>signal ashare包的market_lifecycle_phase模块<br/>文件: signal_ashare/market_lifecycle_phase.py<br/>(设计态 / design)"]
    ...
    src_zephyr_signal_ashare_market_state_sensor_py["signal_ashare/market_state_sensor<br/>signal ashare包的market_state_sensor模块<br/>文件: signal_ashare/market_state_sensor.py<br/>(设计态 / design)"]
    ...
    src_zephyr_signal_ashare_next_day_8state_forecast_py["signal_ashare/next_day_8state_forecast<br/>signal ashare包的next_day_8state_forecast模块<br/>文件: signal_ashare/next_day_8state_forecast.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_regime_change_detector_py["signal_ashare/regime_change_detector<br/>signal ashare包的regime_change_detector模块<br/>文件: signal_ashare/regime_change_detector.py<br/>(设计态 / design)"]
    ...
    src_zephyr_signal_ashare_survival_time_predictor_py["signal_ashare/survival_time_predictor<br/>signal ashare包的survival_time_predictor模块<br/>文件: signal_ashare/survival_time_predictor.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_tiered_screening_filter_py["signal_ashare/tiered_screening_filter<br/>signal ashare包的tiered_screening_filter模块<br/>文件: signal_ashare/tiered_screening_filter.py<br/>(设计态 / design)"]
    src_zephyr_signal_ashare_init_py ~~~ src_zephyr_signal_ashare_extensions_init_py
    src_zephyr_signal_ashare_extensions_init_py ~~~ src_zephyr_signal_ashare_adjustment_cycle_tracker_py
    ...
    src_zephyr_signal_ashare_coarse_screening_funnel_py ~~~ src_zephyr_signal_ashare_conditional_density_predictor_py
    src_zephyr_signal_ashare_conditional_density_predictor_py ~~~ src_zephyr_signal_ashare_conformal_predictor_py
    src_zephyr_signal_ashare_conformal_predictor_py ~~~ src_zephyr_signal_ashare_core_init_py
    src_zephyr_signal_ashare_core_init_py ~~~ src_zephyr_signal_ashare_cross_market_conduction_sensor_py
    src_zephyr_signal_ashare_cross_market_conduction_sensor_py ~~~ src_zephyr_signal_ashare_event_driven_screener_py
    src_zephyr_signal_ashare_event_driven_screener_py ~~~ src_zephyr_signal_ashare_fine_scoring_engine_py
    src_zephyr_signal_ashare_fine_scoring_engine_py ~~~ src_zephyr_signal_ashare_infrastructure_init_py
    ...
    src_zephyr_signal_ashare_regime_change_detector_py ~~~ src_zephyr_signal_ashare_sector_analyzer_py
    ...
    src_zephyr_signal_ashare_short_term_stock_selector_py ~~~ src_zephyr_signal_ashare_survival_time_predictor_py
    src_zephyr_signal_ashare_survival_time_predictor_py ~~~ src_zephyr_signal_ashare_tiered_screening_filter_py
    ...
    class src_zephyr_signal_ashare_adjustment_cycle_tracker_py,src_zephyr_signal_ashare_causal_inference_engine_py,src_zephyr_signal_ashare_coarse_screening_funnel_py,src_zephyr_signal_ashare_conditional_density_predictor_py,src_zephyr_signal_ashare_conformal_predictor_py,src_zephyr_signal_ashare_cross_market_conduction_sensor_py,src_zephyr_signal_ashare_event_driven_screener_py,src_zephyr_signal_ashare_fine_scoring_engine_py,src_zephyr_signal_ashare_market_lifecycle_phase_py,src_zephyr_signal_ashare_market_state_sensor_py,src_zephyr_signal_ashare_next_day_8state_forecast_py,src_zephyr_signal_ashare_regime_change_detector_py,src_zephyr_signal_ashare_survival_time_predictor_py,src_zephyr_signal_ashare_tiered_screening_filter_py design
...
flowchart TD
    ...
    src_zephyr_signal_ashare_cross_market_conduction_sensor_py ~~~ src_zephyr_signal_ashare_event_driven_screener_py
    src_zephyr_signal_ashare_event_driven_screener_py ~~~ src_zephyr_signal_ashare_fine_scoring_engine_py
    src_zephyr_signal_ashare_fine_scoring_engine_py ~~~ src_zephyr_signal_ashare_market_lifecycle_phase_py
...
| 2 | D_SELL_DECISION 卖出决策: core/t_trade_coordinator.py | → | 机构行为分析器 / institutional_behavior_analyzer (signal_... | 导入依赖 / import_depends |

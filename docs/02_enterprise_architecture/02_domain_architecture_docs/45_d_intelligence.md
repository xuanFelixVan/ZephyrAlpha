...
graph TD
    ...
    class D_SHARED,D_GOV_KB,D_GOV_RULE,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION,D_BACKTEST,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SIGLEGACY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION,D_BACKTEST,D_SHARED,D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_DRIFT external_prod

...
graph TD
    ...
    scripts_governance_d4_paths_init_py -.->|config_depends / config_depends| scripts_governance_d4_paths_detect_deprecated_path_writes_py
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 404 个，274 条域内依赖）。

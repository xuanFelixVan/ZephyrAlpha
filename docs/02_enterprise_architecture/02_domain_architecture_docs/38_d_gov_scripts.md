...
graph TD
    subgraph D_GOV_SCRIPTS["D_GOV_SCRIPTS script_governance"]
        ...
        scripts_governance_d5_architecture_generators_generate_asset_catalog_py["scripts/governance/d5_architecture/generators/g... prototype"]
        ...
        scripts_governance_d5_architecture_generators_generate_contract_catalog_py["scripts/governance/d5_architecture/generators/g... prototype"]
    ...
    scripts_governance_d5_architecture_generators_generate_asset_catalog_py -.->|import_depends| D_SHARED
    ...
    scripts_governance_d5_architecture_generators_generate_contract_catalog_py -.->|import_depends| D_SHARED
    D_GOVERNANCE["D_GOVERNANCE production"]
...
graph TD
    ...
    scripts_governance_repair_apply_verification_results_py -.->|config_depends| scripts_governance_repair_concurrent_commit_test_py
...
> 按 architecture_layer 分层显示 script_governance（D_GOV_SCRIPTS）的模块分布。共 436 个模块 / 436 modules。
...
└──────────────────────────────────────────────────────────────────┘
                                  ...
                                  ▼
┌──────────────────────────────────────────────────────────────────┐
│              L2 领域层 / Domain Layer (435 modules)              │
├──────────────────────────────────────────────────────────────────┤
...
> 按 architecture_layer 分组的模块清单（共 436 个模块 / 436 modules）。
...
| 195 | scripts/governance/d5_architecture/generators/generate_as... | scripts/governance/d5_architecture/ge... | G13: 从 depgraph (PostgreSQL) 生成资产清单全景图 | prototype | generated |
| 196 | scripts/governance/d5_architecture/generators/generate_ca... | scripts/governance/d5_architecture/ge... | G11: 从 depgraph (PostgreSQL) 生成能力热力图 | prototype | generated |
| 197 | scripts/governance/d5_architecture/generators/generate_ca... | scripts/governance/d5_architecture/ge... | G7: 从 depgraph (PostgreSQL) domains 表生成域容量报告MD文档 | prototype | generated |
| 198 | scripts/governance/d5_architecture/generators/generate_co... | scripts/governance/d5_architecture/ge... | G9: 从 depgraph (PostgreSQL) arch_constraints 表生成架构约束违规报告MD文档 | prototype | generated |
| 199 | scripts/governance/d5_architecture/generators/generate_co... | scripts/governance/d5_architecture/ge... | G12: 从 depgraph (PostgreSQL) 生成契约目录全景图 | prototype | generated |
| 200 | scripts/governance/d5_architecture/generators/generate_co... | scripts/governance/d5_architecture/ge... | generate_contracts.py -- SSoT to Codegen pipeline | prototype | generated |

> (仅显示前 200 个模块，共 435 个)

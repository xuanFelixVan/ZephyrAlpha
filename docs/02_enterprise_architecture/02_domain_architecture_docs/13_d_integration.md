...
| 域内依赖 | 97 | Internal Dependencies | 97 |
| 跨域入边 | 173 | Cross-domain Incoming | 173 |
...
graph TD
    subgraph D_INTEGRATION["D_INTEGRATION 管线路由"]
        ...
        src_zephyr_integration_backpressure_manager_py["src/zephyr/integration/backpressure_manager.py production"]
        src_zephyr_integration_backpressure_types_py["src/zephyr/integration/backpressure_types.py production"]
        ...
        src_zephyr_integration_circuit_breaker_manager_py["src/zephyr/integration/circuit_breaker_manager.py production"]
        src_zephyr_integration_core_init_py["src/zephyr/integration/core/__init__.py prototype"]
        src_zephyr_integration_cost_tracker_py["src/zephyr/integration/cost_tracker.py production"]
        src_zephyr_integration_ct_pipe_routing_py["src/zephyr/integration/ct_pipe_routing.py production"]
        src_zephyr_integration_dead_letter_queue_py["src/zephyr/integration/dead_letter_queue.py production"]
        ...
        src_zephyr_integration_layer_consumer_registry_py["src/zephyr/integration/layer_consumer_registry.py production"]
        src_zephyr_integration_layer_router_py["src/zephyr/integration/layer_router.py production"]
        src_zephyr_integration_llm_bridge_py["src/zephyr/integration/llm_bridge.py prototype"]
        src_zephyr_integration_llm_gateway_py["src/zephyr/integration/llm_gateway.py production"]
    ...
    src_zephyr_integration_backpressure_manager_py -->|import_depends| src_zephyr_integration_backpressure_types_py
    src_zephyr_integration_layer_consumer_registry_py -->|import_depends| src_zephyr_integration_layer_router_py
    ...
    src_zephyr_integration_backpressure_types_py -->|import_depends| D_SHARED
    D_GOVERNANCE["D_GOVERNANCE production"]
    src_zephyr_integration_llm_bridge_py -.->|import_depends| D_GOVERNANCE
    src_zephyr_integration_layer_router_py -->|import_depends| D_SHARED
    src_zephyr_integration_llm_gateway_py -.->|import_depends| D_SHARED
    D_SECURITY_LLM["D_SECURITY_LLM production"]
    src_zephyr_integration_llm_gateway_py -->|import_depends| D_SECURITY_LLM
    src_zephyr_integration_llm_gateway_py -.->|import_depends| D_SHARED
    ...
    D_TRADING -->|import_depends| src_zephyr_integration_backpressure_manager_py
    ...
    class src_zephyr_integration_init_py,src_zephyr_integration_backpressure_manager_py,src_zephyr_integration_backpressure_types_py,src_zephyr_integration_circuit_breaker_manager_py,src_zephyr_integration_cost_tracker_py,src_zephyr_integration_ct_pipe_routing_py,src_zephyr_integration_dead_letter_queue_py,src_zephyr_integration_layer_consumer_registry_py,src_zephyr_integration_layer_router_py,src_zephyr_integration_llm_gateway_py,src_zephyr_integration_local_model_cache_layer_py,src_zephyr_integration_local_model_deepseek_chat_py,src_zephyr_integration_local_model_embedding_router_py production
    class src_zephyr_integration_extensions_init_py,src_zephyr_integration_api_init_py,src_zephyr_integration_behavioral_admission_init_py,src_zephyr_integration_budget_enforcer_init_py,src_zephyr_integration_budget_enforcer_degradation_spiral_detector_py,src_zephyr_integration_core_init_py,src_zephyr_integration_governance_init_py,src_zephyr_integration_governance_data_source_router_init_py,src_zephyr_integration_governance_data_source_router_embedding_router_py,src_zephyr_integration_governance_embedding_router_py,src_zephyr_integration_infrastructure_init_py,src_zephyr_integration_layer1_discovery_init_py,src_zephyr_integration_layer2_communication_init_py,src_zephyr_integration_layer3_coordination_init_py,src_zephyr_integration_llm_bridge_py,src_zephyr_integration_local_model_init_py,src_zephyr_integration_local_model_local_model_scheduler_py design
    class D_SHARED,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_TRADING external_prod
...
graph TD
    subgraph D_INTEGRATION["D_INTEGRATION 管线路由"]
        ...
        src_zephyr_integration_model_router_py["src/zephyr/integration/model_router.py production"]
        src_zephyr_integration_models_py["src/zephyr/integration/models.py production"]
        src_zephyr_integration_pipeline_agent_bridge_py["src/zephyr/integration/pipeline_agent_bridge.py production"]
        src_zephyr_integration_pipeline_lock_py["src/zephyr/integration/pipeline_lock.py production"]
        ...
        src_zephyr_integration_preemption_manager_py["src/zephyr/integration/preemption_manager.py production"]
        src_zephyr_integration_routing_plugins_py["src/zephyr/integration/routing_plugins.py production"]
    ...
    src_zephyr_integration_models_py -->|import_depends| src_zephyr_integration_shared_schema_schemas_py
    src_zephyr_integration_pipeline_routing_py -->|import_depends| src_zephyr_integration_models_py
    src_zephyr_integration_pipeline_routing_py -->|import_depends| src_zephyr_integration_pipeline_orchestrator_py
    src_zephyr_integration_pipeline_agent_bridge_py -->|import_depends| src_zephyr_integration_models_py
    src_zephyr_integration_preemption_manager_py -->|import_depends| src_zephyr_integration_models_py
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| src_zephyr_integration_models_py
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| src_zephyr_integration_model_router_py
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| src_zephyr_integration_pipeline_lock_py
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| src_zephyr_integration_pipeline_agent_bridge_py
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| src_zephyr_integration_preemption_manager_py
    src_zephyr_integration_pipeline_orchestrator_py -->|import_depends| src_zephyr_integration_routing_plugins_py
    src_zephyr_integration_routing_plugins_py -->|import_depends| src_zephyr_integration_models_py
...
graph TD
    ...
    src_zephyr_integration_vector_memory_vector_writer_py -.->|import_depends| src_zephyr_integration_vector_memory_context_ingest_py
    ...
    D_TRADING -.->|import_depends| src_zephyr_integration_vector_memory_ollama_chat_py
    D_TRADING -->|import_depends| src_zephyr_integration_vector_memory_in_process_vector_memory_py
    D_TRADING -.->|import_depends| src_zephyr_integration_vector_memory_vector_writer_py
    D_TRADING -.->|import_depends| src_zephyr_integration_vector_memory_in_memory_fake_vms_py
...
|------|:---:|---------|
| D_AUDITTEST | 91 | test_depends |
| D_TRADING | 29 | import_depends |
| D_GOVERNANCE | 20 | import_depends |
| D_INFRA_RUNTIME | 8 | import_depends |
...
> 按 architecture_layer 分层显示 管线路由（D_INTEGRATION）的模块分布。共 89 个模块 / 89 modules。

```

┌──────────────────────────────────────────────────────────────────┐
│            L1 基础层 / Foundation Layer (89 modules)             │
├──────────────────────────────────────────────────────────────────┤
...
│   src/zephyr/integration/backpressure_manager.py  [production]   │
│   src/zephyr/integration/backpressure_types.py  [production]     │
...
│   src/zephyr/integration/circuit_breaker_manager.py  [product... │
│   src/zephyr/integration/core/__init__.py  [prototype]           │
│   src/zephyr/integration/cost_tracker.py  [production]           │
│   src/zephyr/integration/ct_pipe_routing.py  [production]        │
│   src/zephyr/integration/dead_letter_queue.py  [production]      │
...
| 4 | src/zephyr/integration/backpressure_manager.py | src/zephyr/integration/backpressure_m... | production | generated |
| 5 | src/zephyr/integration/backpressure_types.py | src/zephyr/integration/backpressure_t... | production | generated |
| 6 | src/zephyr/integration/behavioral_admission/__init__.py | src/zephyr/integration/behavioral_adm... | prototype | generated |
| 7 | src/zephyr/integration/budget_enforcer/__init__.py | src/zephyr/integration/budget_enforce... | prototype | generated |
| 8 | src/zephyr/integration/budget_enforcer/degradation_spiral... | src/zephyr/integration/budget_enforce... | prototype | generated |
| 9 | src/zephyr/integration/circuit_breaker_manager.py | src/zephyr/integration/circuit_breake... | production | generated |
| 10 | src/zephyr/integration/core/__init__.py | src/zephyr/integration/core/__init__.py | prototype | generated |
| 11 | src/zephyr/integration/cost_tracker.py | src/zephyr/integration/cost_tracker.py | production | generated |
| 12 | src/zephyr/integration/ct_pipe_routing.py | src/zephyr/integration/ct_pipe_routin... | production | generated |
| 13 | src/zephyr/integration/dead_letter_queue.py | src/zephyr/integration/dead_letter_qu... | production | generated |
| 14 | src/zephyr/integration/governance/__init__.py | src/zephyr/integration/governance/__i... | prototype | generated |
| 15 | src/zephyr/integration/governance/data_source_router/__in... | src/zephyr/integration/governance/dat... | prototype | generated |
| 16 | src/zephyr/integration/governance/data_source_router/embe... | src/zephyr/integration/governance/dat... | prototype | generated |
| 17 | src/zephyr/integration/governance/embedding_router.py | src/zephyr/integration/governance/emb... | prototype | generated |
| 18 | src/zephyr/integration/infrastructure/__init__.py | src/zephyr/integration/infrastructure... | prototype | generated |
| 19 | src/zephyr/integration/layer1_discovery/__init__.py | src/zephyr/integration/layer1_discove... | prototype | generated |
| 20 | src/zephyr/integration/layer2_communication/__init__.py | src/zephyr/integration/layer2_communi... | prototype | generated |
| 21 | src/zephyr/integration/layer3_coordination/__init__.py | src/zephyr/integration/layer3_coordin... | prototype | generated |
| 22 | src/zephyr/integration/layer_consumer_registry.py | src/zephyr/integration/layer_consumer... | production | generated |
| 23 | src/zephyr/integration/layer_router.py | src/zephyr/integration/layer_router.py | production | generated |
| 24 | src/zephyr/integration/llm_bridge.py | src/zephyr/integration/llm_bridge.py | prototype | generated |
| 25 | src/zephyr/integration/llm_gateway.py | src/zephyr/integration/llm_gateway.py | production | generated |
| 26 | src/zephyr/integration/local_model/__init__.py | src/zephyr/integration/local_model/__... | prototype | generated |
| 27 | src/zephyr/integration/local_model/cache_layer.py | src/zephyr/integration/local_model/ca... | production | generated |
| 28 | src/zephyr/integration/local_model/deepseek_chat.py | src/zephyr/integration/local_model/de... | production | generated |
| 29 | src/zephyr/integration/local_model/embedding_router.py | src/zephyr/integration/local_model/em... | production | generated |
| 30 | src/zephyr/integration/local_model/local_model_scheduler.py | src/zephyr/integration/local_model/lo... | prototype | generated |
| 31 | src/zephyr/integration/local_model/ollama_chat.py | src/zephyr/integration/local_model/ol... | prototype | generated |
| 32 | src/zephyr/integration/local_model/ollama_embedding.py | src/zephyr/integration/local_model/ol... | prototype | generated |
| 33 | src/zephyr/integration/mcp_server.py | src/zephyr/integration/mcp_server.py | prototype | generated |
| 34 | src/zephyr/integration/model_router.py | src/zephyr/integration/model_router.py | production | generated |
| 35 | src/zephyr/integration/models.py | src/zephyr/integration/models.py | production | generated |
| 36 | src/zephyr/integration/pipeline_agent_bridge.py | src/zephyr/integration/pipeline_agent... | production | generated |
| 37 | src/zephyr/integration/pipeline_lock.py | src/zephyr/integration/pipeline_lock.py | production | generated |
| 38 | src/zephyr/integration/pipeline_orchestrator.py | src/zephyr/integration/pipeline_orche... | production | generated |
| 39 | src/zephyr/integration/pipeline_routing.py | src/zephyr/integration/pipeline_routi... | production | generated |
| 40 | src/zephyr/integration/ports.py | src/zephyr/integration/ports.py | prototype | generated |
| 41 | src/zephyr/integration/preemption_manager.py | src/zephyr/integration/preemption_man... | production | generated |
| 42 | src/zephyr/integration/routing_plugins.py | src/zephyr/integration/routing_plugin... | production | generated |
| 43 | src/zephyr/integration/services/__init__.py | src/zephyr/integration/services/__ini... | prototype | generated |
| 44 | src/zephyr/integration/shared/contracts/errors/__init__.py | src/zephyr/integration/shared/contrac... | prototype | generated |
| 45 | src/zephyr/integration/shared/contracts/errors/execution_... | src/zephyr/integration/shared/contrac... | prototype | generated |
| 46 | src/zephyr/integration/shared/contracts/errors/risk_limit... | src/zephyr/integration/shared/contrac... | prototype | generated |
| 47 | src/zephyr/integration/shared/contracts/errors/signal_deg... | src/zephyr/integration/shared/contrac... | production | generated |
| 48 | src/zephyr/integration/shared/events/__init__.py | src/zephyr/integration/shared/events/... | prototype | generated |
| 49 | src/zephyr/integration/shared/events/dlq.py | src/zephyr/integration/shared/events/... | prototype | generated |
| 50 | src/zephyr/integration/shared/events/dlq_bridge.py | src/zephyr/integration/shared/events/... | prototype | generated |
| 51 | src/zephyr/integration/shared/events/event_bus_upgrade.py | src/zephyr/integration/shared/events/... | prototype | generated |
| 52 | src/zephyr/integration/shared/events/event_schemas.py | src/zephyr/integration/shared/events/... | prototype | generated |
| 53 | src/zephyr/integration/shared/events/upgrade_strategy.py | src/zephyr/integration/shared/events/... | production | generated |
| 54 | src/zephyr/integration/shared/schema/__init__.py | src/zephyr/integration/shared/schema/... | prototype | generated |
| 55 | src/zephyr/integration/shared/schema/base_config.py | src/zephyr/integration/shared/schema/... | production | generated |
| 56 | src/zephyr/integration/shared/schema/execution_model.py | src/zephyr/integration/shared/schema/... | production | generated |
| 57 | src/zephyr/integration/shared/schema/schema_registry.py | src/zephyr/integration/shared/schema/... | production | generated |
| 58 | src/zephyr/integration/shared/schema/schemas.py | src/zephyr/integration/shared/schema/... | production | generated |
| 59 | src/zephyr/integration/shared/schema/severity_types.py | src/zephyr/integration/shared/schema/... | production | generated |
| 60 | src/zephyr/integration/vector_memory/__init__.py | src/zephyr/integration/vector_memory/... | production | generated |
| 61 | src/zephyr/integration/vector_memory/bm25_index.py | src/zephyr/integration/vector_memory/... | production | generated |
| 62 | src/zephyr/integration/vector_memory/bridge_layer.py | src/zephyr/integration/vector_memory/... | production | generated |
| 63 | src/zephyr/integration/vector_memory/cache_layer.py | src/zephyr/integration/vector_memory/... | production | generated |
| 64 | src/zephyr/integration/vector_memory/chunk_strategy_route... | src/zephyr/integration/vector_memory/... | production | generated |
| 65 | src/zephyr/integration/vector_memory/collection_manager.py | src/zephyr/integration/vector_memory/... | production | generated |
| 66 | src/zephyr/integration/vector_memory/collection_schemas.py | src/zephyr/integration/vector_memory/... | production | generated |
| 67 | src/zephyr/integration/vector_memory/context_ingest.py | src/zephyr/integration/vector_memory/... | prototype | generated |
| 68 | src/zephyr/integration/vector_memory/cross_collection_ret... | src/zephyr/integration/vector_memory/... | prototype | generated |
| 69 | src/zephyr/integration/vector_memory/delegated_vector_mem... | src/zephyr/integration/vector_memory/... | prototype | generated |
| 70 | src/zephyr/integration/vector_memory/design_principles.py | src/zephyr/integration/vector_memory/... | production | generated |
| 71 | src/zephyr/integration/vector_memory/embedding_router.py | src/zephyr/integration/vector_memory/... | prototype | generated |
| 72 | src/zephyr/integration/vector_memory/faiss_collection_man... | src/zephyr/integration/vector_memory/... | production | generated |
| 73 | src/zephyr/integration/vector_memory/hybrid_retriever.py | src/zephyr/integration/vector_memory/... | production | generated |
| 74 | src/zephyr/integration/vector_memory/in_memory_fake_vms.py | src/zephyr/integration/vector_memory/... | production | generated |
| 75 | src/zephyr/integration/vector_memory/in_memory_memory_bac... | src/zephyr/integration/vector_memory/... | production | generated |
| 76 | src/zephyr/integration/vector_memory/in_process_vector_me... | src/zephyr/integration/vector_memory/... | production | generated |
| 77 | src/zephyr/integration/vector_memory/index_health_monitor.py | src/zephyr/integration/vector_memory/... | production | generated |
| 78 | src/zephyr/integration/vector_memory/interface.py | src/zephyr/integration/vector_memory/... | production | generated |
| 79 | src/zephyr/integration/vector_memory/migrate_chroma_to_fa... | src/zephyr/integration/vector_memory/... | prototype | generated |
| 80 | src/zephyr/integration/vector_memory/ollama_chat.py | src/zephyr/integration/vector_memory/... | prototype | generated |
| 81 | src/zephyr/integration/vector_memory/ollama_embedding.py | src/zephyr/integration/vector_memory/... | prototype | generated |
| 82 | src/zephyr/integration/vector_memory/provenance_enforcer.py | src/zephyr/integration/vector_memory/... | production | generated |
| 83 | src/zephyr/integration/vector_memory/retrieval_feedback.py | src/zephyr/integration/vector_memory/... | production | generated |
| 84 | src/zephyr/integration/vector_memory/sqlite_metadata_stor... | src/zephyr/integration/vector_memory/... | production | generated |
| 85 | src/zephyr/integration/vector_memory/vector_bridge.py | src/zephyr/integration/vector_memory/... | prototype | generated |
| 86 | src/zephyr/integration/vector_memory/vector_writer.py | src/zephyr/integration/vector_memory/... | prototype | generated |
| 87 | src/zephyr/integration/vector_memory/vms_config.yaml | src/zephyr/integration/vector_memory/... | production | generated |
| 88 | src/zephyr/integration/vector_memory/vms_errors.py | src/zephyr/integration/vector_memory/... | production | generated |
| 89 | src/zephyr/integration/vector_memory/vms_schemas.py | src/zephyr/integration/vector_memory/... | production | generated |

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 97 条 / 97 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│       依赖关系图 / Dependency Graph (共 97 条 / 97 edges)        │
├──────────────────────────────────────────────────────────────────┤
...
│                 [import_depends] (91 条 / edges)                 │
├──────────────────────────────────────────────────────────────────┤
│   circuit_breaker_manager.py → models.py                         │
│   backpressure_manager.py → backpressure_types.py                │
│   cost_tracker.py → models.py                                    │
│   cost_tracker.py → model_router.py                              │
│   dead_letter_queue.py → models.py                               │
│   ct_pipe_routing.py → models.py                                 │
│   ct_pipe_routing.py → schemas.py                                │
│   layer_consumer_registry.py → layer_router.py                   │
│   models.py → schemas.py                                         │
│   pipeline_routing.py → ct_pipe_routing.py                       │
│   pipeline_routing.py → models.py                                │
│   pipeline_routing.py → pipeline_orchestrator.py                 │
│   pipeline_agent_bridge.py → models.py                           │
│   preemption_manager.py → models.py                              │
│   __init__.py → mcp_server.py                                    │
│   __init__.py → llm_bridge.py                                    │
│   pipeline_orchestrator.py → circuit_breaker_manager.py          │
│   pipeline_orchestrator.py → cost_tracker.py                     │
│   pipeline_orchestrator.py → dead_letter_queue.py                │
│   pipeline_orchestrator.py → ct_pipe_routing.py                  │
│   pipeline_orchestrator.py → models.py                           │
│   pipeline_orchestrator.py → model_router.py                     │
│   pipeline_orchestrator.py → pipeline_lock.py                    │
│   pipeline_orchestrator.py → pipeline_agent_bridge.py            │
│   pipeline_orchestrator.py → preemption_manager.py               │
│   pipeline_orchestrator.py → routing_plugins.py                  │
│   pipeline_orchestrator.py → local_model_scheduler.py            │
│   pipeline_orchestrator.py → embedding_router.py                 │
│   routing_plugins.py → ct_pipe_routing.py                        │
│   routing_plugins.py → models.py                                 │

...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/cross_asset/__init__.py | __init__.py | 生产态 / production |  |
| 2 | src/zephyr/cross_asset/_extensions/__init__.py | __init__.py | 生产态 / production |  |
| 3 | src/zephyr/cross_asset/api/__init__.py | __init__.py | 生产态 / production |  |
| 4 | src/zephyr/cross_asset/core/__init__.py | __init__.py | 生产态 / production |  |
| 5 | src/zephyr/cross_asset/infrastructure/__init__.py | __init__.py | 生产态 / production |  |
| 6 | src/zephyr/cross_asset/models/__init__.py | __init__.py | 生产态 / production |  |
| 7 | src/zephyr/cross_asset/services/__init__.py | __init__.py | 生产态 / production |  |
...
graph TD
    subgraph D_CROSS_ASSET["D_CROSS_ASSET 跨资产"]
        ...
        src_zephyr_cross_asset_extensions_init_py["(生产态 / production) __init__.py"]
        src_zephyr_cross_asset_api_init_py["(生产态 / production) __init__.py"]
        src_zephyr_cross_asset_core_init_py["(生产态 / production) __init__.py"]
        src_zephyr_cross_asset_infrastructure_init_py["(生产态 / production) __init__.py"]
        src_zephyr_cross_asset_models_init_py["(生产态 / production) __init__.py"]
        src_zephyr_cross_asset_services_init_py["(生产态 / production) __init__.py"]
    end

...
flowchart TD
    ...
    src_zephyr_cross_asset_infrastructure_init_py["cross_asset/infrastructure 包入口<br/>管理cross_asset.infrastructure子包的加载和懒导入<br/>文件: infrastructure/__init__.py<br/>(生产态 / production)"]
    src_zephyr_cross_asset_models_init_py["cross_asset/models 包入口<br/>管理cross_asset.models子包的加载和懒导入<br/>文件: models/__init__.py<br/>(生产态 / production)"]
    src_zephyr_cross_asset_services_init_py["cross_asset/services 包入口<br/>管理cross_asset.services子包的加载和懒导入<br/>文件: services/__init__.py<br/>(生产态 / production)"]

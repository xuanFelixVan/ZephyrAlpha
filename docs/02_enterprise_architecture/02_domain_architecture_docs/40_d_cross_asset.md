...
flowchart TD
    ...
    src_zephyr_cross_asset_extensions_init_py["cross_asset/_extensions 包入口<br/>cross_asset/_extensions<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: _extensions/__init__.py<br/>(生产态 / production)"]
    src_zephyr_cross_asset_api_init_py["cross_asset/api 包入口<br/>cross_asset/api<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: api/__init__.py<br/>(生产态 / production)"]
    src_zephyr_cross_asset_core_init_py["cross_asset/core 包入口<br/>cross_asset/core<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: core/__init__.py<br/>(生产态 / production)"]
    src_zephyr_cross_asset_infrastructure_init_py["cross_asset/infrastructure 包入口<br/>cross_asset/infrastructure<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: infrastructure/__init__.py<br/>(生产态 / production)"]
    src_zephyr_cross_asset_models_init_py["cross_asset/models 包入口<br/>cross_asset/models<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: models/__init__.py<br/>(生产态 / production)"]
    src_zephyr_cross_asset_services_init_py["cross_asset/services 包入口<br/>cross_asset/services<br/>包入口，管理该层子模块的统一加载和懒导入<br/>文件: services/__init__.py<br/>(生产态 / production)"]

...
# 40_d_cross_asset / 跨资产 / Cross Asset
...
> **[可缩放 HTML 版 / Zoomable HTML](http://localhost:8765/docs/02_enterprise_architecture/02_domain_architecture_docs/40_d_cross_asset.html)** — Ctrl+滚轮缩放 ｜ 双击重置 ｜ Ctrl+Shift+D 切换拖动/选择模式
...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/cross_asset/__init__.py | cross_asset/__init__.py | 生产态 / production |  |
| 2 | src/zephyr/cross_asset/_extensions/__init__.py | _extensions/__init__.py | 生产态 / production |  |
| 3 | src/zephyr/cross_asset/api/__init__.py | api/__init__.py | 生产态 / production |  |
| 4 | src/zephyr/cross_asset/core/__init__.py | core/__init__.py | 生产态 / production |  |
| 5 | src/zephyr/cross_asset/infrastructure/__init__.py | infrastructure/__init__.py | 生产态 / production |  |
| 6 | src/zephyr/cross_asset/models/__init__.py | models/__init__.py | 生产态 / production |  |
| 7 | src/zephyr/cross_asset/services/__init__.py | services/__init__.py | 生产态 / production |  |
...
flowchart TD
    src_zephyr_cross_asset_init_py["(生产态 / production) cross_asset/__init__.py"]
    src_zephyr_cross_asset_extensions_init_py["(生产态 / production) _extensions/__init__.py"]
    src_zephyr_cross_asset_api_init_py["(生产态 / production) api/__init__.py"]
    src_zephyr_cross_asset_core_init_py["(生产态 / production) core/__init__.py"]
    src_zephyr_cross_asset_infrastructure_init_py["(生产态 / production) infrastructure/__init__.py"]
    src_zephyr_cross_asset_models_init_py["(生产态 / production) models/__init__.py"]
    src_zephyr_cross_asset_services_init_py["(生产态 / production) services/__init__.py"]

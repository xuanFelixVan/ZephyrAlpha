...
graph TD
    ...
    class D_SHARED,D_GOV_KB,D_GOVERNANCE,D_BACKTEST,D_INTEGRATION,D_GOV_RULE,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_OPS,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTEGRATION,D_SIGLEGACY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_KB,D_INFRA_RUNTIME,D_GOV_RULE,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTEGRATION,D_BACKTEST,D_SHARED,D_GOV_RULE external_prod

...
graph TD
    ...
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOV_SCRIPTS,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_CODE_QUALITY,D_OPS,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_BACKTEST,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_KB,D_GOV_RULE,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_BACKTEST,D_OPS,D_SECURITY,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RUNTIME external_prod

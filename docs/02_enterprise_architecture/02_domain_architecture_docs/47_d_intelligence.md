...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_RULE,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_OPS,D_FBL_DETECTORS,D_SECURITY,D_BACKTEST,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_GOV_KB,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_SCRIPTS,D_KNOWLEDGE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_OPS,D_GOV_RULE,D_BACKTEST,D_FBL_DETECTORS,D_SECURITY,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
```

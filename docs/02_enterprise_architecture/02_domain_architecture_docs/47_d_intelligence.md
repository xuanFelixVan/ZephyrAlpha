...
graph TD
    ...
    class D_GOV_DRIFT,D_OPS,D_SHARED,D_GOV_OPS_RESILIENCE,D_BACKTEST,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_KB,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_GOVERNANCE,D_GOV_AUDIT,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INTEGRATION,D_OPS,D_SHARED,D_GOV_OPS_RESILIENCE,D_BACKTEST,D_INFRA_RUNTIME external_prod

...
graph TD
    ...
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOV_SCRIPTS,D_SECURITY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_OPS,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_INTEGRATION,D_SIGLEGACY external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_KB,D_SHARED,D_INFRA_RUNTIME,D_TRADING,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_GOVERNANCE,D_KNOWLEDGE,D_GOV_SCRIPTS,D_SECURITY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_OPS,D_INFRA_RUNTIME,D_SHARED,D_GOV_DRIFT,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod

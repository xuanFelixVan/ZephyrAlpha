...
graph TD
    ...
    class D_BACKTEST,D_GOV_RULE,D_GOV_KB,D_INTEGRATION,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_KNOWLEDGE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FRONTEND,D_OPS,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_RULE,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_BACKTEST,D_FBL_DIAGNOSERS,D_OPS,D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_INTEGRATION,D_FUNDAMENTAL_SIGNAL,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_KB,D_INFRA_RUNTIME,D_TRADING,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_KNOWLEDGE,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FRONTEND,D_OPS,D_INFRA_RUNTIME external_prod

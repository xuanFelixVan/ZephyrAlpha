...
graph TD
    ...
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_FBL_VERIFICATION,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_SHARED,D_OPS,D_GOV_DRIFT,D_FBL_DETECTORS,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_BACKTEST external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_KB,D_SHARED,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_GOV_AUDIT,D_GOVERNANCE,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_SHARED,D_GOV_DRIFT,D_OPS,D_GOVERNANCE,D_FBL_DETECTORS,D_INTEGRATION,D_SECURITY,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME external_prod
```

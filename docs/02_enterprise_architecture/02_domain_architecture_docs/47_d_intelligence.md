...
graph TD
    ...
    class D_GOV_AUDIT,D_KNOWLEDGE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_RULE,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_SHARED,D_OPS,D_BACKTEST,D_SECURITY,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_GOV_KB,D_SHARED,D_INFRA_RUNTIME,D_GOV_RULE,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_GOV_AUDIT,D_GOVERNANCE,D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_GOV_DRIFT,D_SHARED,D_FBL_VERIFICATION,D_GOV_RULE,D_OPS,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_INFRA_RUNTIME external_prod
```

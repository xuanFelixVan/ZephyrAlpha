...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_RULE,D_FBL_VERIFICATION,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_OPS,D_FBL_DETECTORS,D_SECURITY,D_GOV_DRIFT,D_BACKTEST,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_SHARED external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOVERNANCE,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_ML_TRAIN,D_GOVERNANCE,D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_OPS,D_FBL_DETECTORS,D_SECURITY,D_INTEGRATION,D_GOV_DRIFT,D_GOV_RULE,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME external_prod

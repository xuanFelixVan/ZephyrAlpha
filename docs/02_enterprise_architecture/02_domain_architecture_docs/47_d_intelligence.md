...
graph TD
    ...
    D_ML_TRAIN -.->|config_depends / config_depends| src_zephyr_intelligence_model_evaluation_activate_py
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_AUTONOMY_CORE,D_BACKTEST,D_SHARED,D_GOV_KB,D_GOV_RULE,D_TRADING,D_INFRA_RUNTIME external_prod
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_RULE,D_GOVERNANCE,D_OPS,D_GOV_DRIFT,D_FRONTEND,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_OPS,D_INFRA_RUNTIME,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_ORCHESTRATOR,D_GOVERNANCE,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_GOV_KB,D_TRADING,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOVERNANCE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_OPS,D_INFRA_RUNTIME,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_ORCHESTRATOR,D_INTEGRATION,D_BACKTEST,D_SHARED,D_FBL_VERIFICATION external_prod
```

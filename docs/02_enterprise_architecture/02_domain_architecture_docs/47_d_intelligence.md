...
graph TD
    ...
    class D_SHARED,D_GOV_KB,D_GOV_RULE,D_BACKTEST,D_TRADING,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_ML_TRAIN,D_GOV_AUDIT,D_KNOWLEDGE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_DRIFT,D_GOVERNANCE,D_OPS,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_OPS,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SIGLEGACY,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_BACKTEST,D_SHARED,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_INFRA_RUNTIME,D_SIGLEGACY external_prod
...
| 36 | D_ML_TRAIN 训练: Intelligence — Model Evaluation Domain (__init... | → | UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | config_depends / config_depends |

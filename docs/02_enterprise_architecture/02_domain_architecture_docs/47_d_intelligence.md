...
graph TD
    ...
    class D_OPS,D_SHARED,D_FBL_DETECTORS,D_SECURITY,D_BACKTEST,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE external_prod
```

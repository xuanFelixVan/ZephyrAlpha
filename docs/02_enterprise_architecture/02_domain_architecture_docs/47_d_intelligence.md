...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_INFRA_RUNTIME,D_GOV_RULE,D_FBL_VERIFICATION,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_OPS,D_FBL_DETECTORS,D_SECURITY,D_GOV_DRIFT,D_SHARED,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_BACKTEST external_prod
```
...
graph TD
    ...
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_GOV_DRIFT,D_OPS,D_FBL_DETECTORS,D_SECURITY,D_FBL_DIAGNOSERS,D_INTEGRATION,D_INFRA_RUNTIME,D_SHARED external_prod

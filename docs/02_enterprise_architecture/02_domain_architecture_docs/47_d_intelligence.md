...
graph TD
    ...
    class D_INTEGRATION,D_GOV_RULE,D_GOV_KB,D_BACKTEST,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_ML_TRAIN,D_GOVERNANCE,D_KNOWLEDGE,D_SECURITY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_RULE,D_FBL_VERIFICATION,D_FRONTEND,D_GOVERNANCE,D_OPS,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_OPS,D_FEEDBACK_LOOP,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SIGLEGACY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_KB,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_SHARED,D_ML_TRAIN,D_GOVERNANCE,D_KNOWLEDGE,D_SECURITY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FRONTEND,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_GOV_RULE,D_GOV_DRIFT,D_OPS external_prod

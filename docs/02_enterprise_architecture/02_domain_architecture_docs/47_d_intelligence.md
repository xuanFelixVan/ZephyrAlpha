...
graph TD
    ...
    class D_GOV_KB,D_GOV_RULE,D_SHARED,D_BACKTEST,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_ML_TRAIN,D_KNOWLEDGE,D_SECURITY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_OPS,D_SHARED,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FEEDBACK_LOOP,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_KB,D_GOV_RULE,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_ML_TRAIN,D_KNOWLEDGE,D_SECURITY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FEEDBACK_LOOP,D_OPS,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_FBL_DETECTORS external_prod
```

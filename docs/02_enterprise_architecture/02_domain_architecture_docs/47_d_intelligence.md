...
graph TD
    ...
    class D_GOV_KB,D_SHARED,D_AUTONOMY_CORE,D_GOVERNANCE,D_TRADING,D_BACKTEST,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_OPS,D_SHARED,D_FBL_VERIFICATION,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_DRIFT,D_FRONTEND,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_BACKTEST,D_OPS,D_FEEDBACK_LOOP,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_INFRA_RUNTIME,D_SIGLEGACY,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_GOV_KB,D_SHARED,D_TRADING,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_BACKTEST,D_OPS,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_INFRA_RUNTIME,D_SIGLEGACY external_prod
```

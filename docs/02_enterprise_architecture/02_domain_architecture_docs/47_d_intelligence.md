...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_GOV_KB,D_INTEGRATION,D_BACKTEST,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_DRIFT,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_OPS,D_BACKTEST external_prod
```
...
graph TD
    ...
    class D_ML_TRAIN,D_GOVERNANCE,D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SECURITY,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_GOV_RULE,D_FEEDBACK_LOOP external_prod

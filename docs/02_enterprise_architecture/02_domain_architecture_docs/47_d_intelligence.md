...
graph TD
    ...
    class D_SHARED,D_GOV_KB,D_BACKTEST,D_GOV_RULE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_OPS,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_INTEGRATION,D_FEEDBACK_LOOP,D_SIGLEGACY external_prod
```
...
graph TD
    ...
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_DRIFT,D_OPS,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_BACKTEST external_prod
```

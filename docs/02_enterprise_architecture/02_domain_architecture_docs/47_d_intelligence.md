...
graph TD
    ...
    class D_INTEGRATION,D_BACKTEST,D_SHARED,D_GOV_KB,D_GOV_RULE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_GOV_SCRIPTS,D_GOV_AUDIT,D_KNOWLEDGE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_ML_TRAIN,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_AUDIT,D_KNOWLEDGE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_BACKTEST,D_GOV_RULE,D_GOV_DRIFT,D_FBL_VERIFICATION,D_OPS,D_SHARED,D_INFRA_RUNTIME external_prod

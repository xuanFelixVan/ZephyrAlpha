...
graph TD
    ...
    class D_SHARED,D_OPS,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FEEDBACK_LOOP,D_FRONTEND,D_GOV_OPS_RESILIENCE,D_OPS,D_SHARED,D_FBL_DIAGNOSERS external_prod

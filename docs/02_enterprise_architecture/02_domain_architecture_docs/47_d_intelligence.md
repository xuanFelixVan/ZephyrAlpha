...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_OPS,D_BACKTEST,D_SECURITY,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_ML_TRAIN,D_GOVERNANCE,D_GOV_AUDIT,D_KNOWLEDGE,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_DIAGNOSERS,D_BACKTEST,D_FBL_DETECTORS,D_OPS,D_SECURITY,D_GOV_DRIFT,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod

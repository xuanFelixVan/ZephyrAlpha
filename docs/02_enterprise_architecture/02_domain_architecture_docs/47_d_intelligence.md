...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_BACKTEST,D_GOV_KB,D_GOV_RULE,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_DRIFT,D_FRONTEND,D_OPS,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SIGLEGACY,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_ML_TRAIN,D_SECURITY,D_GOV_AUDIT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_FRONTEND,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_OPS,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT external_prod
...
| 29 | UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | → | D_GOV_KB 知识库治理: Re-export shim — 真源在 zephyr.governance.kb.s... | 导入依赖 / import_depends |

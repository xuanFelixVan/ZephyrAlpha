...
graph TD
    ...
    class D_GOV_RULE,D_GOV_KB,D_BACKTEST,D_INTEGRATION,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_ML_TRAIN,D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_FRONTEND,D_GOVERNANCE,D_OPS,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_KB,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_SHARED,D_ML_TRAIN,D_SECURITY,D_GOV_AUDIT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_FRONTEND,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_GOV_RULE,D_OPS,D_GOV_DRIFT,D_FBL_VERIFICATION external_prod

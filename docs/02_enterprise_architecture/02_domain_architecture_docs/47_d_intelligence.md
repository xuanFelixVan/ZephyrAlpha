...
graph TD
    ...
    D_ML_TRAIN -.->|config_depends / config_depends| src_zephyr_intelligence_model_evaluation_reranker_py
    ...
    class D_ML_TRAIN,D_GOV_AUDIT,D_GOV_SCRIPTS,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_RULE,D_INFRA_RUNTIME,D_SHARED,D_FBL_VERIFICATION,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_FBL_DETECTORS,D_OPS,D_BACKTEST,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_SECURITY,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOV_KB,D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_BACKTEST,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_OPS,D_GOV_RULE,D_INFRA_RUNTIME external_prod

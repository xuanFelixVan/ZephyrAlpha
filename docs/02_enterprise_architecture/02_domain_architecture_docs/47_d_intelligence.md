...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_DRIFT,D_FRONTEND,D_GOVERNANCE,D_OPS,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_INTEGRATION,D_SIGLEGACY external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_DRIFT,D_SHARED,D_OPS,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY external_prod
```

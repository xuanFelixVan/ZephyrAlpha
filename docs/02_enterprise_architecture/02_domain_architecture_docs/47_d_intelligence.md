...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_RULE,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_FBL_DIAGNOSERS,D_OPS,D_GOV_DRIFT,D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_BACKTEST,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_ML_TRAIN,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_AUDIT,D_KNOWLEDGE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_SECURITY,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_BACKTEST,D_GOV_DRIFT,D_OPS,D_GOVERNANCE,D_FBL_VERIFICATION,D_FBL_DETECTORS external_prod
```

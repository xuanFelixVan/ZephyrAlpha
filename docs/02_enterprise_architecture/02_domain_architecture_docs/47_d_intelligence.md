...
graph TD
    ...
    class D_SHARED,D_BACKTEST,D_GOV_KB,D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_OPS,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_BACKTEST,D_SECURITY,D_FBL_DETECTORS,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_KB,D_GOV_RULE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_FBL_VERIFICATION,D_GOV_RULE,D_OPS,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_BACKTEST external_prod

...
graph TD
    ...
    class D_OPS,D_FBL_DETECTORS,D_SECURITY,D_BACKTEST,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_SHARED,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_INFRA_RUNTIME,D_GOV_KB,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_KNOWLEDGE,D_GOVERNANCE,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_OPS,D_INTEGRATION,D_GOV_DRIFT,D_GOV_RULE,D_FBL_DIAGNOSERS,D_BACKTEST,D_FBL_DETECTORS,D_SECURITY,D_INFRA_RUNTIME external_prod

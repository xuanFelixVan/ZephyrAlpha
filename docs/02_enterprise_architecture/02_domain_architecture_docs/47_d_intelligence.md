...
graph TD
    ...
    class D_ML_TRAIN,D_GOV_SCRIPTS,D_KNOWLEDGE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_GOV_DRIFT,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_OPS,D_FRONTEND,D_INTEGRATION,D_GOVERNANCE external_prod
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_OPS,D_SHARED,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_BACKTEST,D_SECURITY,D_GOV_DRIFT,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_FUNDAMENTAL_SIGNAL external_prod
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_INFRA_RUNTIME,D_GOV_KB,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_GOVERNANCE,D_GOV_SCRIPTS,D_KNOWLEDGE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_OPS,D_SHARED,D_BACKTEST,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_INTEGRATION,D_GOV_RULE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_FBL_DETECTORS external_prod
```

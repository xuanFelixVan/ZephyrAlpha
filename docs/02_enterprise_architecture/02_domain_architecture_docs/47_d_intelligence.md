...
graph TD
    ...
    class D_GOV_KB,D_GOV_RULE,D_BACKTEST,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_ML_TRAIN,D_SECURITY,D_GOV_AUDIT,D_KNOWLEDGE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_RULE,D_FRONTEND,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOVERNANCE,D_OPS,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_INTEGRATION,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_GOV_KB,D_GOV_RULE,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_ML_TRAIN,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_INTEGRATION,D_FBL_DIAGNOSERS,D_OPS,D_SHARED,D_AUTONOMY_CORE external_prod
```

...
graph TD
    ...
    class D_OPS,D_SHARED,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_SIGLEGACY,D_AUTONOMY_CORE,D_INTEGRATION external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION,D_BACKTEST,D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME external_prod

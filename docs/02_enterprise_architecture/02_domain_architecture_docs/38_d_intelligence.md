...
# 38_d_intelligence / context_management
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_AUTONOMY_CORE,D_SHARED,D_GOV_ENFORCEMENT,D_TRADING external_prod
    class D_ML_TRAIN,D_BACKTEST external_design
```

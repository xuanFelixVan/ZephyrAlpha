...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_OPS,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_SHARED,D_AUDITTEST external_design
```

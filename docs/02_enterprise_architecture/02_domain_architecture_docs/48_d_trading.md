...
graph TD
    ...
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_diagnosers_cognitive_cognitive_load_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    src_zephyr_trading_feedback_loop_feedback_collector_py -->|import_depends| D_SHARED
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_forensic_init_py

...
| 原型态模块 | 200 | Prototype Modules | 200 |
| 生产态模块 | 264 | Production Modules | 264 |
| 容量 | 281/150 (超容) | Capacity | 281/150 (超容) |
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_INTEGRATION,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_OPS,D_SECURITY_LLM,D_GOVERNANCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL external_prod

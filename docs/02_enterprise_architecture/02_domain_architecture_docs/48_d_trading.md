...
| 跨域出边 | 185 | Cross-domain Outgoing | 185 |
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_collectors_knowledge_capture_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_collectors_knowledge_freshness_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_actors_secondary_alert_channel_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_online_feature_importance_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_engine_py
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
    class D_SHARED,D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_contracts_design_decisions_py
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_trading_orchestrator_lifecycle_init_py -.->|config_depends| src_zephyr_trading_orchestrator_lifecycle_session_conflict_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_lifecycle_system_transfer_py
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_AUDITTEST,D_SIGQC external_design
```
...
| D_GOVERNANCE | 57 | import_depends,runtime |

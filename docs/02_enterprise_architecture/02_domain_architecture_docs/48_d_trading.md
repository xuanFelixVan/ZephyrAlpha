...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_INFRA_A2A,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_collectors_temporal_event_store_py
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE,D_SECURITY_LLM external_prod
    class D_SHARED,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_INTEGRATION,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_SIGQC -.->|import_depends| src_zephyr_trading_trading_contracts_market_signal_degradation_warning_py
    ...
    class D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_REPORTING external_prod
    class D_FUNDAMENTAL_SIGNAL,D_AUDITTEST,D_GOV_SCRIPTS,D_SIGQC external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod

...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_OPS,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod
    class D_GOV_ENFORCEMENT,D_SIGQC external_design
```

...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_INTEGRATION,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_SECURITY_LLM external_prod
    class D_AUDITTEST external_design
```
...
│   status_dashboard.py → capability_registry.py                   │
│   status_dashboard.py → night_shift_queue.py                     │
│   status_dashboard.py → orphan_detector.py                       │
│   status_dashboard.py → health_monitor.py                        │
│   status_dashboard.py → work_orchestrator.py                     │

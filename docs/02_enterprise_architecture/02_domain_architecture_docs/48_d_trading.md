...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTELLIGENCE,D_EX_CORE,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_FUNDAMENTAL_SIGNAL external_prod

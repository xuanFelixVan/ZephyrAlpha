...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY external_prod
    class D_INTEGRATION,D_INTELLIGENCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTEGRATION,D_SHARED external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_SECURITY_LLM,D_INFRA_RUNTIME,D_OPS external_prod
...
graph TD
    ...
    class D_EX_CORE,D_AUDITTEST,D_FUNDAMENTAL_SIGNAL external_design
```

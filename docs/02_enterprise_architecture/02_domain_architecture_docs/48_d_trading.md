...
graph TD
    ...
    class D_AUTONOMY_CORE,D_INTEGRATION,D_SHARED,D_SECURITY,D_OPS,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_teacher_transfer_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_forensic_fle_upgrade_safety_validator_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_scheduler_collect_detect_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED,D_AUTONOMY_CORE external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_session_learner_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_security_remote_attestation_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_contracts_finding_bridge_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_finalizer_py
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_SHARED,D_OPS,D_SECURITY_LLM,D_GOVERNANCE,D_SECURITY external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    D_REPORTING -->|import_depends| src_zephyr_trading_trading_contracts_execution_order_py
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTELLIGENCE,D_REPORTING external_prod
    class D_AUDITTEST,D_FUNDAMENTAL_SIGNAL external_design
```

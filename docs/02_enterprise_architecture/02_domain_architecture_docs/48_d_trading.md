...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
    class D_SHARED,D_INTEGRATION,D_INTELLIGENCE,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_GOVERNANCE["D_GOVERNANCE design"]
    D_GOVERNANCE -.->|runtime| src_zephyr_trading_feedback_loop_evolution_prompt_optimization_regression_detector_py
    D_AUDITTEST["D_AUDITTEST prototype"]
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_protocols_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_protocols_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_resilience_graceful_degradation_planner_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_protocols_py
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_ide_health_daemon_py
    ...
    class D_INTEGRATION,D_OPS,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_status_dashboard_py
    ...
    class D_FUNDAMENTAL_SIGNAL,D_AUDITTEST,D_EX_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_RISK,D_FUNDAMENTAL_SIGNAL external_prod
    class D_GOV_ENFORCEMENT,D_AUDITTEST,D_SIGQC external_design
```

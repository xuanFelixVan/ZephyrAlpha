...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_boot_cron_jobs_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_boot_hooks_py
    ...
    class D_INTELLIGENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SHARED external_prod
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_INTEGRATION,D_AUTONOMY_CORE,D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY_LLM,D_SECURITY external_prod
...
graph TD
    ...
    src_zephyr_trading_orchestrator_resilience_hallucination_detector_py -.->|import_depends| D_SHARED
    src_zephyr_trading_resource_optimization_py -->|import_depends| D_SHARED
    D_INFRA_RUNTIME["D_INFRA_RUNTIME production"]
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_INTEGRATION external_prod
    class D_AUDITTEST,D_FUNDAMENTAL_SIGNAL,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUDITTEST,D_RISK,D_FUNDAMENTAL_SIGNAL external_design
```

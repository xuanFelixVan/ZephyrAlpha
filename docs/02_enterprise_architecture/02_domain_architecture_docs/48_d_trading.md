...
graph TD
    ...
    src_zephyr_trading_capability_registry_py -.->|import_depends| D_SHARED
...
graph TD
    ...
    class D_OPS,D_INTEGRATION,D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_AUDITTEST,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SIGQC,D_AUDITTEST external_design
```

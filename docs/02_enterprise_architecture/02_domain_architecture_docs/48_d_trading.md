...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SECURITY external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_SECURITY_LLM,D_OPS,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE,D_INTELLIGENCE,D_FUNDAMENTAL_SIGNAL external_prod

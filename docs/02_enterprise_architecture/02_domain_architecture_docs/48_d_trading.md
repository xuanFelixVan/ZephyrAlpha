...
graph TD
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE external_prod
    class D_INTELLIGENCE,D_SHARED,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SHARED,D_INTEGRATION external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_SECURITY_LLM,D_OPS external_prod
...
graph TD
    ...
    D_PF_CORE -->|import_depends| src_zephyr_trading_trading_contracts_execution_order_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_REPORTING,D_FUNDAMENTAL_SIGNAL,D_PF_CORE external_prod
    class D_AUDITTEST external_design
```

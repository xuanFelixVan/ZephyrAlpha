...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_SECURITY external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION,D_SECURITY_LLM external_prod

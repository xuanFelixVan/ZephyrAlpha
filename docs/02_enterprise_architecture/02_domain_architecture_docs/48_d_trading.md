...
| 跨域入边 | 670 | Cross-domain Incoming | 670 |
| 跨域出边 | 150 | Cross-domain Outgoing | 150 |
| 设计态模块 | 0 | Design Modules | 0 |
| 原型态模块 | 199 | Prototype Modules | 199 |
| 生产态模块 | 265 | Production Modules | 265 |
| 容量 | 282/150 (超容) | Capacity | 282/150 (超容) |
...
graph TD
    ...
    src_zephyr_trading_auto_runtime_core_py -->|import_depends| D_INFRA_RUNTIME
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_init_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_admission_controller_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_actors_intent_driven_ops_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_actors_notification_personalizer_py
    ...
    class D_AUTONOMY_CORE,D_SECURITY,D_OPS,D_GOV_ENFORCEMENT,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_collectors_schema_migration_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_collectors_token_finops_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_collectors_data_quality_validator_py
...
graph TD
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_hypernetwork_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_self_reflection_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_failure_replay_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_prompt_optimization_regression_detector_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_semantic_intent_preservation_guard_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_knowledge_distillation_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_gates_concurrent_change_deconfliction_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_scheduler_act_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_scheduler_health_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_metrics_collector_py
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_INTEGRATION,D_AUTONOMY_CORE external_prod
    class D_INFRA_TELEMETRY,D_AUDITTEST external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_tests_e2e_integration_test_pipeline_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_verifiers_no_llm_degradation_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_security_secret_rotation_py
...
graph TD
    ...
    src_zephyr_trading_orchestrator_contracts_finding_bridge_py -->|import_depends| D_SHARED
    ...
    D_AUDITTEST["D_AUDITTEST prototype"]
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_gpu_consensus_scheduler_py
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_OPS,D_INFRA_RUNTIME,D_SECURITY external_prod
    class D_AUDITTEST external_design
```
...
graph TD
    ...
    src_zephyr_trading_orchestrator_fault_tolerance_init_py -.->|config_depends| src_zephyr_trading_orchestrator_fault_tolerance_chaos_hooks_py
    src_zephyr_trading_orchestrator_governance_init_py -.->|config_depends| src_zephyr_trading_orchestrator_governance_dependency_lock_py
    D_SHARED["D_SHARED production"]
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_orchestrator_execution_reconciliation_loop_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_resource_optimization_py
    ...
    D_FUNDAMENTAL_SIGNAL -.->|import_depends| src_zephyr_trading_trading_contracts_market_factor_signal_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_staging_area_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL external_prod
...
graph TD
    ...
    class src_zephyr_trading_trading_contracts_portfolio_contracts_init_py,src_zephyr_trading_trading_contracts_risk_init_py,src_zephyr_trading_trading_contracts_risk_compliance_rule_py,src_zephyr_trading_windows_service_py,src_zephyr_trading_zombie_scanner_py design
    class D_GOVERNANCE,D_INTEGRATION,D_RISK external_prod
    class D_SHARED,D_GOV_ENFORCEMENT,D_AUDITTEST,D_FUNDAMENTAL_SIGNAL external_design
```

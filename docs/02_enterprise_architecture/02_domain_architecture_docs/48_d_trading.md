...
| 域内依赖 | 436 | Internal Dependencies | 436 |
...
graph TD
    ...
    src_zephyr_trading_capability_card_py -->|import_depends| D_SHARED
    src_zephyr_trading_auto_runtime_core_py -.->|import_depends| D_INTEGRATION
    src_zephyr_trading_feedback_loop_actors_api_version_contract_py -->|import_depends| D_SHARED
    ...
    class D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY external_prod
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_self_modification_rate_limiter_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_evolution_training_data_gov_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_forensic_state_migration_validator_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_gates_autonomy_maturity_py
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_protocols_py
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_feedback_loop_resilience_dr_automation_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SECURITY_LLM,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
    class D_SHARED,D_AUDITTEST external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOVERNANCE,D_INFRA_RUNTIME,D_FUNDAMENTAL_SIGNAL,D_REPORTING external_prod
    class D_GOV_ENFORCEMENT,D_ML_TRAIN external_design
```
...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_trading_verdict_engine_py
    D_FUNDAMENTAL_SIGNAL -->|import_depends| src_zephyr_trading_trading_contracts_market_synthesized_signal_py
    D_SIGQC["D_SIGQC prototype"]
    D_SIGQC -.->|import_depends| src_zephyr_trading_trading_contracts_market_synthesized_signal_py
    ...
    class D_INTEGRATION,D_GOVERNANCE,D_FUNDAMENTAL_SIGNAL,D_RISK external_prod
    class D_SHARED,D_GOV_ENFORCEMENT,D_AUDITTEST,D_SIGQC external_design
```
...
> 域内模块依赖关系（共 436 条 / 436 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 436 条 / 436 edges)       │
├──────────────────────────────────────────────────────────────────┤
│   依赖类型数 / Dependency Types: 2                               │
│   [import_depends]: 302 条 / edges                               │
│   [config_depends]: 134 条 / edges                               │
└──────────────────────────────────────────────────────────────────┘
...
**[config_depends]** (134 条 / edges) — 已达显示上限，省略 / limit reached

> (最多显示前 50 条依赖边，共 436 条)

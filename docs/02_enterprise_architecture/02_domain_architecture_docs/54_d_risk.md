...
graph TD
    ...
    src_zephyr_risk_implementations_init_py -.->|config_depends / config_depends| src_zephyr_risk_implementations_default_stop_loss_engine_py
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 19 个，2 条域内依赖）。

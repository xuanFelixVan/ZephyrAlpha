...
graph TD
    ...
    class D_INTEGRATION,D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
    class D_SHARED,D_KNOWLEDGE external_design
```

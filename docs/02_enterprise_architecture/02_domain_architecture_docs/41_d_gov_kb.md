...
| 2 | src/zephyr/gov_kb/_backend_protocol.py | Re-export shim — 真源在 zephyr.governance.kb.s... | 生产态 / production | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 3 | src/zephyr/gov_kb/batch_ingest.py | Re-export shim — 真源在 zephyr.governance.kb.p... | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
...
| 11 | src/zephyr/gov_kb/kb_engine/kb_gate_task.py | Re-export shim — 真源在 zephyr.governance.kb.k... | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
...
| 14 | src/zephyr/gov_kb/load_bearing.py | 承重KE不可变性 + 承重墙自检 | 生产态 / production | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 15 | src/zephyr/gov_kb/migration/kb_gate_task.py | Re-export shim — 真源在 zephyr.governance.kb.k... | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 16 | src/zephyr/gov_kb/pipeline/activate.py | G4 Activate 门禁 — 人工激活（T-2-13-D） | 原型态 / prototype | [MOD-INF-009](../../03_modules/_cross_layer/pipeline/blueprint.md) |
| 17 | src/zephyr/gov_kb/pipeline/analyze.py | G3 Evaluate 门禁 — 深度评估（T-2-13-C） | 生产态 / production | [MOD-INF-009](../../03_modules/_cross_layer/pipeline/blueprint.md) |
| 18 | src/zephyr/gov_kb/pipeline/batch_ingest.py | 批量入库 — scaffold P0/P1 知识候选批量入库（T-... | 原型态 / prototype | [MOD-INF-009](../../03_modules/_cross_layer/pipeline/blueprint.md) |
| 19 | src/zephyr/gov_kb/pipeline/extract.py | G5 Extract 门禁 — 知识升格（T-2-13-E） | 生产态 / production | [MOD-INF-009](../../03_modules/_cross_layer/pipeline/blueprint.md) |
| 20 | src/zephyr/gov_kb/quiet_period_monitor.py | 每日静默期检测 + 管道健康自检 | 生产态 / production | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 21 | src/zephyr/gov_kb/reranker.py | Cross-Encoder 重排序层 — BGE-reranker-v2-m3（T... | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 22 | src/zephyr/gov_kb/safety_brake.py | 冷静期引擎 + 魔鬼代言人 + 影响评估 | 生产态 / production | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 23 | src/zephyr/gov_kb/self_test.py | KB 13项一键体检 + --self-test入口 | 生产态 / production | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 24 | src/zephyr/gov_kb/sentiment_engine/__init__.py | __init__.py | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 25 | src/zephyr/gov_kb/storage/_backend_protocol.py | Backend protocol & shared data classes for the ... | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 26 | src/zephyr/gov_kb/storage/unified_memory_api.py | UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 27 | src/zephyr/gov_kb/supply_chain_graph_engine/__init__.py | __init__.py | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 28 | src/zephyr/gov_kb/unified_memory_api.py | SRC-0042: Re-export shim -> 真源在 kb/storage/u... | 原型态 / prototype | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 29 | src/zephyr/gov_kb/verify.py | 确定性事实核查 — 取代AI猜测 | 生产态 / production | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
| 30 | src/zephyr/gov_kb/vms_memory_backend.py | VMSMemoryBackend — UnifiedMemoryAPI 的 VMS 后... | 生产态 / production | [MOD-KB-001](../../03_modules/_domain_knowledge/knowledge_base/blueprint.md) |
...
> 展示全部 30 个模块（生产态 16 + 设计态 0 + 原型态 14），标签标注成熟度。

```mermaid
graph TD
    subgraph D_GOV_KB["D_GOV_KB 知识库治理"]
        src_zephyr_gov_kb_init_py["(原型态 / prototype) __init__.py"]
        src_zephyr_gov_kb_backend_protocol_py["(生产态 / production) Re-export shim — 真源在 zephyr.governance.kb.s...<br/>文件: _backend_protocol.py"]
        src_zephyr_gov_kb_batch_ingest_py["(原型态 / prototype) Re-export shim — 真源在 zephyr.governance.kb.p...<br/>文件: batch_ingest.py"]
        ...
        src_zephyr_gov_kb_kb_engine_kb_gate_task_py["(原型态 / prototype) Re-export shim — 真源在 zephyr.governance.kb.k...<br/>文件: kb_gate_task.py"]
        ...
        src_zephyr_gov_kb_migration_kb_gate_task_py["(原型态 / prototype) Re-export shim — 真源在 zephyr.governance.kb.k...<br/>文件: kb_gate_task.py"]
    ...
    src_zephyr_gov_kb_storage_unified_memory_api_py -.->|导入依赖 / import_depends| src_zephyr_gov_kb_vms_memory_backend_py
    ...
    D_AUTONOMY_CORE -->|导入依赖 / import_depends| src_zephyr_gov_kb_bootstrap_py
    D_GOV_OPS_RESILIENCE["(生产态 / production) D_GOV_OPS_RESILIENCE"]
    D_GOV_OPS_RESILIENCE -->|导入依赖 / import_depends| src_zephyr_gov_kb_ingest_py
    D_GOV_OPS_RESILIENCE -->|导入依赖 / import_depends| src_zephyr_gov_kb_kb_gate_task_py
    ...
    D_INTELLIGENCE -->|导入依赖 / import_depends| src_zephyr_gov_kb_backend_protocol_py
...
graph TD
    ...
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_gov_kb_bootstrap_py
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_gov_kb_embedding_migrate_py
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_gov_kb_pipeline_extract_py
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_gov_kb_freeze_py
    D_AUDITTEST -.->|测试依赖 / test_depends| src_zephyr_gov_kb_kb_gate_task_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
...
| 21 | SQLite墓碑表 + G2向量去重 (ke_tombstone.py) | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 22 | 承重KE不可变性 + 承重墙自检 (load_bearing.py) | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 23 | G4 Activate 门禁 — 人工激活（T-2-13-D） (activ... | → | D_SHARED 共享服务: schemas.py | 导入依赖 / import_depends |
| 24 | 批量入库 — scaffold P0/P1 知识候选批量入库（T-... | → | D_SHARED 共享服务: schemas.py | 导入依赖 / import_depends |
| 25 | 每日静默期检测 + 管道健康自检 (quiet_period_mon... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 26 | 每日静默期检测 + 管道健康自检 (quiet_period_mon... | → | D_SHARED 共享服务: time_utils.py —— 时间/日期工具（Phase 9 新增 ... | 导入依赖 / import_depends |
| 27 | 冷静期引擎 + 魔鬼代言人 + 影响评估 (safety_brak... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 28 | KB 13项一键体检 + --self-test入口 (self_test.py) | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 29 | KB 13项一键体检 + --self-test入口 (self_test.py) | → | D_SHARED 共享服务: time_utils.py —— 时间/日期工具（Phase 9 新增 ... | 导入依赖 / import_depends |
| 30 | UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | → | D_SHARED 共享服务: CBAC 能力检查器 (Capability-Based Access Contro... | 导入依赖 / import_depends |
| 31 | 确定性事实核查 — 取代AI猜测 (verify.py) | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
...
| 22 | D_GOVERNANCE 生命周期管理: __init__.py | → | Re-export shim — 真源在 zephyr.governance.kb.k... | config_depends / config_depends |
| 23 | D_GOVERNANCE 生命周期管理: kb.migration — auto-generated package init. (_... | → | Re-export shim — 真源在 zephyr.governance.kb.k... | config_depends / config_depends |
| 24 | D_GOVERNANCE 生命周期管理: kb.pipeline — auto-generated package init. (__... | → | G4 Activate 门禁 — 人工激活（T-2-13-D） (activ... | config_depends / config_depends |
| 25 | D_GOVERNANCE 生命周期管理: kb.storage — auto-generated package init. (__i... | → | UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | config_depends / config_depends |
| 26 | D_GOV_OPS_RESILIENCE 运维弹性治理: G2 Triage 门禁 — 知识分类评分（T-2-13-B） (tri... | → | G1 Ingest 门禁 — 知识流水线入口校验（T-2-13-A... | 导入依赖 / import_depends |
| 27 | D_GOV_OPS_RESILIENCE 运维弹性治理: G2 Triage 门禁 — 知识分类评分（T-2-13-B） (tri... | → | KB 五阶段门禁 evaluate 用的最小合法 Task（对齐 ... | 导入依赖 / import_depends |
| 28 | D_INTEGRATION 管线路由: KnowledgeBaseServer: 知识库语义检索 MCP Server ... | → | SRC-0042: Re-export shim -> 真源在 kb/storage/u... | 导入依赖 / import_depends |
| 29 | D_INTEGRATION 管线路由: Vector Memory Service (VMS) — MOD-INF-011 · v... | → | SRC-0042: Re-export shim -> 真源在 kb/storage/u... | 导入依赖 / import_depends |
| 30 | D_INTEGRATION 管线路由: DelegatedVectorMemory — VectorMemoryBase 的 RI... | → | SRC-0042: Re-export shim -> 真源在 kb/storage/u... | 导入依赖 / import_depends |
| 31 | D_INTELLIGENCE 上下文管理: G4 Activate 门禁 — 人工激活（T-2-13-D） (activ... | → | KB 五阶段门禁 evaluate 用的最小合法 Task（对齐 ... | 导入依赖 / import_depends |
| 32 | D_INTELLIGENCE 上下文管理: UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | → | Re-export shim — 真源在 zephyr.governance.kb.s... | 导入依赖 / import_depends |
| 33 | D_INTELLIGENCE 上下文管理: UnifiedMemoryAPI — RI-02 统一记忆 API（M2 跨模... | → | VMSMemoryBackend — UnifiedMemoryAPI 的 VMS 后.... | 导入依赖 / import_depends |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 8 个外部域直接连接（出边 31 条 + 入边 33 条 = 64 条）。只显示直接连接的域，不展开具体节点。
...
graph LR
    ...
    D_GOVERNANCE -->|5条 config_depends / config_depends, 导入依赖 / import_depends| D_GOV_KB

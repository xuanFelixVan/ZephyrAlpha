...
title: D-GOV_AUDIT_TESTS audit_test_suite架构图
version: "1.0"
status: active
date: 2026-06-25
...
# 37_d_gov_audit_tests / audit_test_suite 架构图

> **文档作用 / Purpose**: 以ASCII art可视化展示audit_test_suite（D-GOV_AUDIT_TESTS）功能域的模块分层架构和依赖关系。
...
> 按 architecture_layer 分层显示 audit_test_suite（D-GOV_AUDIT_TESTS）的模块分布。共 152 个模块 / 152 modules。
...
- **文件名规则 / File Naming**: `{编号:02d}_{域ID小写}_architecture.md`，如 `37_d_gov_audit_tests_architecture.md`

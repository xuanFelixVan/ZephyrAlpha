...
# 52_d_pf_core / 组合核心 / Portfolio Core
...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/pf_core/strategy_engine/__init__.py | D_PORTFOLIO_CORE — Portfolio Construction Stra... | 设计态 / design |  |
...
graph TD
    subgraph D_PF_CORE["D_PF_CORE 组合核心"]
        src_zephyr_pf_core_strategy_engine_init_py["(设计态 / design) D_PORTFOLIO_CORE — Portfolio Construction Stra...<br/>文件: __init__.py"]
    end

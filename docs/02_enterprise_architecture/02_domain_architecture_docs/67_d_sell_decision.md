...
flowchart TD
    src_zephyr_sell_decision_init_py["(生产态 / production) sell_decision/__init__.py<br/>文件: sell_decision/__init__.py"]
    src_zephyr_sell_decision_extensions_init_py["(生产态 / production) _extensions/__init__.py<br/>文件: _extensions/__init__.py"]
    src_zephyr_sell_decision_api_init_py["(生产态 / production) api/__init__.py<br/>文件: api/__init__.py"]
    src_zephyr_sell_decision_core_init_py["(生产态 / production) core/__init__.py<br/>文件: core/__init__.py"]
    src_zephyr_sell_decision_core_breakout_failure_detector_py["(设计态 / design) core/breakout_failure_detector.py<br/>文件: core/breakout_failure_detector.py"]
    src_zephyr_sell_decision_core_position_triage_py["(设计态 / design) core/position_triage.py<br/>文件: core/position_triage.py"]
    src_zephyr_sell_decision_core_replacement_rebalance_sell_py["(设计态 / design) core/replacement_rebalance_sell.py<br/>文件: core/replacement_rebalance_sell.py"]
    src_zephyr_sell_decision_core_sell_urgency_scorer_py["(设计态 / design) core/sell_urgency_scorer.py<br/>文件: core/sell_urgency_scorer.py"]
    src_zephyr_sell_decision_core_strategy_specific_stop_framework_py["(设计态 / design) core/strategy_specific_stop_framework.py<br/>文件: core/strategy_specific_stop_framework.py"]
    src_zephyr_sell_decision_core_take_profit_strategy_py["(设计态 / design) core/take_profit_strategy.py<br/>文件: core/take_profit_strategy.py"]
    src_zephyr_sell_decision_infrastructure_init_py["(生产态 / production) infrastructure/__init__.py<br/>文件: infrastructure/__init__.py"]
    src_zephyr_sell_decision_models_init_py["(生产态 / production) models/__init__.py<br/>文件: models/__init__.py"]
    src_zephyr_sell_decision_services_init_py["(生产态 / production) services/__init__.py<br/>文件: services/__init__.py"]
    ...
    src_zephyr_sell_decision_core_buy_sell_conflict_arbitrator_py["(设计态 / design) core/buy_sell_conflict_arbitrator.py<br/>文件: core/buy_sell_conflict_arbitrator.py"]
    src_zephyr_sell_decision_core_exit_scenario_planner_py["(设计态 / design) core/exit_scenario_planner.py<br/>文件: core/exit_scenario_planner.py"]
    src_zephyr_sell_decision_core_scaling_out_architect_py["(设计态 / design) core/scaling_out_architect.py<br/>文件: core/scaling_out_architect.py"]
    src_zephyr_sell_decision_core_stop_loss_strategy_py["(设计态 / design) core/stop_loss_strategy.py<br/>文件: core/stop_loss_strategy.py"]
    ...
    src_zephyr_sell_decision_core_sell_signal_fusion_engine_py["(设计态 / design) core/sell_signal_fusion_engine.py<br/>文件: core/sell_signal_fusion_engine.py"]
    src_zephyr_sell_decision_core_sell_signal_scorer_py["(设计态 / design) core/sell_signal_scorer.py<br/>文件: core/sell_signal_scorer.py"]
    src_zephyr_sell_decision_core_t_trade_coordinator_py["(设计态 / design) core/t_trade_coordinator.py<br/>文件: core/t_trade_coordinator.py"]
    src_zephyr_sell_decision_core_sell_signal_scorer_py ~~~ src_zephyr_sell_decision_core_t_trade_coordinator_py
    src_zephyr_sell_decision_core_sell_signal_collector_py["(设计态 / design) core/sell_signal_collector.py<br/>文件: core/sell_signal_collector.py"]
...
|:--:|---------|:--:|---------|---------|
| 1 | core/sell_signal_fusion_engine.py | → | D_POSITION 仓位管理: core/sell_position_link.py | runtime / runtime |

### 依赖本域的其他域（入边）/ Depended By

| # | 外部域-源模块 / Source Module | → | 本域模块 / Target Module | 依赖类型 / Type |
|:--:|---------|:--:|---------|---------|
| 1 | D_EX_CORE 执行核心: ex_core/sell_priority_scheduler.py | → | core/position_triage.py | runtime / runtime |
| 2 | D_EX_CORE 执行核心: ex_core/sell_priority_scheduler.py | → | core/position_triage.py | runtime / runtime |
| 3 | D_EX_CORE 执行核心: ex_core/stop_loss_take_profit_executor.py | → | core/position_triage.py | runtime / runtime |
| 4 | D_EX_CORE 执行核心: ex_core/stop_loss_take_profit_executor.py | → | core/position_triage.py | runtime / runtime |

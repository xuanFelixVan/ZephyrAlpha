...
flowchart TD
    docs_03_modules_domain_knowledge_vector_memory_blueprint_md["蓝图<br/>vector_memory/blueprint 模块<br/>⛔ 知识域，设计已就绪，等待开发排期<br/>文件: vector_memory/blueprint.md<br/>(设计态 / design)"]

...
flowchart TD
    docs_03_modules_domain_knowledge_vector_memory_blueprint_md["蓝图<br/>vector_memory模块蓝图文档，描述该模块的设计意图<br/>和架构决策<br/>⛔ 知识域，设计已就绪，等待开发排期<br/>Blueprint<br/>文件: vector_memory/blueprint.md<br/>(设计态 / design)"]

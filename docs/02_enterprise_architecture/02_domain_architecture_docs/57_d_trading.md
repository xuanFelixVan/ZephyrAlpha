...
# 57_d_trading / 交易运营 / Trading Operations
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INFRASTRUCTURE,D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_GOVERNANCE,D_SIGQC,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INFRASTRUCTURE,D_ORCHESTRATOR,D_FUNDAMENTAL_SIGNAL,D_ML_TRAIN,D_GOVERNANCE,D_SIGQC,D_EX_CORE,D_RISK external_prod
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SHARED,D_ORCHESTRATOR,D_ML_TRAIN,D_FUNDAMENTAL_SIGNAL,D_SIGQC,D_GOVERNANCE,D_EX_CORE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SHARED,D_ORCHESTRATOR,D_ML_TRAIN,D_FUNDAMENTAL_SIGNAL,D_SIGQC,D_GOVERNANCE,D_EX_CORE,D_RISK external_prod
```

...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_AUTONOMY_CORE external_prod
    class D_BACKTEST,D_GOVERNANCE,D_INFRASTRUCTURE,D_FRONTEND,D_TRADING,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_AUTONOMY_CORE,D_BACKTEST,D_TRADING external_prod

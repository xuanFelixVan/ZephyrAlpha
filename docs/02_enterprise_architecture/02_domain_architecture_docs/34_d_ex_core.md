...
graph TD
    ...
    class D_BACKTEST,D_GOVERNANCE,D_INFRASTRUCTURE,D_FRONTEND,D_INTELLIGENCE,D_TRADING external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_SHARED,D_BACKTEST external_prod

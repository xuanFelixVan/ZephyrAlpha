...
graph TD
    ...
    class D_TRADING,D_SHARED,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_INFRASTRUCTURE,D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_TRADING,D_SHARED,D_AUTONOMY_CORE,D_BACKTEST,D_INFRA_RECOVERY external_prod
...
| 25 | MiniQMT 实盘券商适配器（对接 xttrader，A股实盘.... | → | D_TRADING 交易运营: order.py | 导入依赖 / import_depends |

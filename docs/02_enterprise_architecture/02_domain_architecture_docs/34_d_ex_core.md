...
graph TD
    ...
    class D_INFRA_RECOVERY,D_AUTONOMY_CORE external_prod
    class D_BACKTEST,D_GOVERNANCE,D_INFRASTRUCTURE,D_SHARED,D_FRONTEND,D_INTELLIGENCE,D_TRADING external_design
```

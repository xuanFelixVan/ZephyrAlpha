...
graph TD
    ...
    class D_INFRASTRUCTURE,D_INFRA_RECOVERY external_prod
    class D_BACKTEST,D_GOVERNANCE,D_SHARED,D_FRONTEND,D_TRADING,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_TRADING,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```

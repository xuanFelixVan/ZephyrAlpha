...
flowchart TD
    ...
    class D_SECURITY,D_SHARED,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOVERNANCE,D_COMPLIANCE,D_ORCHESTRATOR,D_GOV_RULE,D_INFRA_RUNTIME external_prod
```

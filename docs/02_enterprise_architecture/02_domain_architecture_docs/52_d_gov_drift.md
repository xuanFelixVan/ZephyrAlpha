...
flowchart TD
    ...
    scripts_governance_d11_compliance_validate_blueprint_overlap_py["validate蓝图overlap<br/>校验蓝图overlap。Module docstring — see<br/>module-level docstring for details<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: d11_compliance/validate_blueprint_<br/>overlap.py<br/>(生产态 / production)"]
    ...
    scripts_governance_d5_architecture_validators_validate_authority_registry_py["validateauthority注册表<br/>校验authority注册表。Module docstring — see<br/>module-level docstring for details<br/>Module docstring — see module-level docstring<br/>for details.<br/>文件: validators/validate_authority_registry.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_audit_self_monitor_py["自监控<br/>自监控，主要提供increment、设置gauge、快照等功能<br/>self_monitor<br/>文件: gov_audit/self_monitor.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_baseline_manager_py["基线管理器<br/>治理漂移包的baseline_manager模块<br/>Baseline Manager — baseline_manager.py<br/>文件: gov_drift/baseline_manager.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_brain_integration_py["brain集成<br/>治理漂移包的brain_integration模块<br/>ProbeHierarchy - K8s 3-Probe + Terraform<br/>Reconciliation<br/>文件: gov_drift/brain_integration.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_chaos_injector_py["Drift Chaos Injector — 混沌工程主动漂移注入<br/>§6.13<br/>治理漂移包的chaos_injector模块<br/>文件: gov_drift/chaos_injector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_detector_core_benchmark_integrity_py["基准完整性<br/>治理漂移/detector core包的benchmark_<br/>integrity模块<br/>文件: detector_core/benchmark_integrity.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_git_bisector_py["Git二分器<br/>治理漂移包的git_bisector模块<br/>Git Bisector — git_bisector.py<br/>文件: gov_drift/git_bisector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_roi_engine_py["roi引擎<br/>roi引擎，治理漂移检测的功能模块<br/>ROI Engine — roi_engine.py<br/>文件: gov_drift/roi_engine.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_self_test_verifier_py["自测试验证器<br/>治理漂移包的self_test_verifier模块<br/>Self Test Verifier — self_test_verifier.py<br/>文件: gov_drift/self_test_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_spiral_ews_py["螺旋预警系统<br/>治理漂移包的spiral_ews模块<br/>文件: gov_drift/spiral_ews.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_integrity_py["完整性<br/>完整性，主要提供聚合、验证等功能<br/>integrity<br/>文件: governance/integrity.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_correlation_engine_py["相关性引擎<br/>治理漂移包的correlation_engine模块<br/>Correlation Engine — correlation_engine.py<br/>文件: gov_drift/correlation_engine.py<br/>(生产态 / production)"]
    src_zephyr_gov_drift_credibility_engine_py["credibility引擎<br/>治理漂移包的credibility_engine模块<br/>Credibility Engine — credibility_engine.py<br/>文件: gov_drift/credibility_engine.py<br/>(生产态 / production)"]

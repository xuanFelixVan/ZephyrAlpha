...
flowchart TD
    docs_03_modules_domain_governance_drift_detector_blueprint_md["(设计态 / design) drift_detector/blueprint.md<br/>文件: drift_detector/blueprint.md"]
    ...
    src_zephyr_gov_audit_self_monitor_py["(生产态 / production) gov_audit/self_monitor.py<br/>文件: gov_audit/self_monitor.py"]
    ...
    src_zephyr_gov_drift_bootstrapping_calibrator_py["(生产态 / production) gov_drift/bootstrapping_calibrator.py<br/>文件: gov_drift/bootstrapping_calibrator.py"]
    ...
    src_zephyr_gov_drift_detector_core_benchmark_integrity_py["(生产态 / production) detector_core/benchmark_integrity.py<br/>文件: detector_core/benchmark_integrity.py"]
    ...
    src_zephyr_gov_drift_detector_core_ml_engineering_py["(生产态 / production) detector_core/ml_engineering.py<br/>文件: detector_core/ml_engineering.py"]
    src_zephyr_gov_drift_detector_core_model_drift_monitor_py["(生产态 / production) detector_core/model_drift_monitor.py<br/>文件: detector_core/model_drift_monitor.py"]
    src_zephyr_gov_drift_detector_core_regime_detector_py["(生产态 / production) detector_core/regime_detector.py<br/>文件: detector_core/regime_detector.py"]
    ...
    src_zephyr_gov_drift_spiral_ews_py["(生产态 / production) gov_drift/spiral_ews.py<br/>文件: gov_drift/spiral_ews.py"]
    ...
    src_zephyr_governance_drift_detector_init_py["(生产态 / production) drift-detector/__init__.py<br/>文件: drift-detector/__init__.py"]
    src_zephyr_governance_integrity_py["(生产态 / production) governance/integrity.py<br/>文件: governance/integrity.py"]
    ...
    src_zephyr_gov_audit_drift_bridge_py["(生产态 / production) gov_audit/drift_bridge.py<br/>文件: gov_audit/drift_bridge.py"]
    ...
    src_zephyr_gov_drift_detector_core_performance_baseline_py["(生产态 / production) detector_core/performance_baseline.py<br/>文件: detector_core/performance_baseline.py"]
...
| 55 | D_GOV_RULE 规则治理: 门禁引擎模块集 / Gate Engine Package (gate_engine/__init_... | → | 门禁引擎完整性守卫——自检SHA-256校验+trust root自验证（b... | config_depends / config_depends |

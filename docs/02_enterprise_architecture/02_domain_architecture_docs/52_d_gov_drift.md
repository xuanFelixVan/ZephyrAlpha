...
flowchart TD
    docs_03_modules_domain_governance_drift_detector_blueprint_md["蓝图<br/>drift detector包的蓝图模块<br/>⛔ 漂移检测域，设计已就绪，等待开发排期<br/>blueprint<br/>文件: drift_detector/blueprint.md<br/>(设计态 / design)"]
    ...
    src_zephyr_gov_drift_baseline_manager_py["基线管理器<br/>Baseline Manager — baseline_manager.py<br/>文件: gov_drift/baseline_manager.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_git_bisector_py["Git二分器<br/>Git Bisector — git_bisector.py<br/>文件: gov_drift/git_bisector.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_roi_engine_py["roi引擎<br/>ROI Engine — roi_engine.py<br/>文件: gov_drift/roi_engine.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_self_test_verifier_py["自测试验证器<br/>Self Test Verifier — self_test_verifier.py<br/>文件: gov_drift/self_test_verifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_drift_detector_init_py["governance/drift-detector 包入口<br/>文件: drift-detector/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_correlation_engine_py["相关性引擎<br/>Correlation Engine — correlation_engine.py<br/>文件: gov_drift/correlation_engine.py<br/>(生产态 / production)"]
    src_zephyr_gov_drift_credibility_engine_py["credibility引擎<br/>credibility引擎模块<br/>Credibility Engine — credibility_engine.py<br/>文件: gov_drift/credibility_engine.py<br/>(生产态 / production)"]

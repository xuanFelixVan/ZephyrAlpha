...
graph TD
    ...
    D_SECURITY -->|导入依赖 / import_depends| src_zephyr_gov_drift_correlation_engine_py
...
graph TD
    ...
    D_SECURITY -->|导入依赖 / import_depends| src_zephyr_gov_drift_drift_training_py
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_COMPLIANCE,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY,D_INFRA_RECOVERY,D_FEEDBACK_LOOP,D_COMPLIANCE,D_OPS,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_SCRIPTS,D_INFRA_RECOVERY,D_COMPLIANCE external_prod
```
...
| 55 | D_GOV_RULE 规则治理: gate_engine package — 门禁引擎模块集合（ARCH-0... | → | 门禁健康仪表板——per-gate SLI 报告、误报率、延... | config_depends / config_depends |

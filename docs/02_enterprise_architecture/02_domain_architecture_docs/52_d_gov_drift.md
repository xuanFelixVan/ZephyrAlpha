...
flowchart TD
    ...
    D_GOVERNANCE -->|测试依赖 / test_depends| src_zephyr_gov_drift_artifact_scanner_py
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_prod
```

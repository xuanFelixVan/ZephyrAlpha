...
flowchart TD
    ...
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_invariants_en_002_enforcement_validator_py
    ...
    class D_GOV_SCRIPTS,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_GOV_AUDIT,D_COMPLIANCE,D_SECURITY,D_GOV_CODE_QUALITY external_prod
```

...
flowchart TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_AUDIT,D_INFRA_RECOVERY,D_COMPLIANCE,D_ORCHESTRATOR external_prod
```
...
| 64 | D_GOV_RULE 规则治理: 门禁引擎模块集 / Gate Engine Package (gate_engine/__init_... | → | 自检SHA-256校验+trust root自验证 / Gate Integrity Guard (... | config_depends / config_depends |

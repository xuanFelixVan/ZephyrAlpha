...
flowchart TD
    docs_03_modules_domain_governance_drift_detector_blueprint_md["蓝图<br/>drift detector包的blueprint模块<br/>⛔ 漂移检测域，设计已就绪，等待开发排期<br/>文件: drift_detector/blueprint.md<br/>(设计态 / design)"]
    ...
    src_zephyr_gov_drift_detector_core_init_py["gov_drift/detector_core 包入口<br/>管理gov_drift.detector_core子包加载<br/>MOD-INF-023 drift_detector core module.<br/>文件: detector_core/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_gov_drift_roi_engine_py["roi引擎<br/>治理漂移包的roi_engine模块<br/>ROI Engine — roi_engine.py<br/>文件: gov_drift/roi_engine.py<br/>(生产态 / production)"]
    ...
    src_zephyr_governance_drift_detector_init_py["governance/drift-detector 包入口<br/>管理governance.drift-detector子包加载<br/>文件: drift-detector/__init__.py<br/>(生产态 / production)"]

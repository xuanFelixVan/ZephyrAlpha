...
flowchart TD
    ...
    D_GOV_CODE_QUALITY -->|测试依赖 / test_depends| src_zephyr_gov_enforcement_rule_enforcement_breaking_change_detector_py
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_AUDIT,D_SECURITY,D_ORCHESTRATOR,D_GOV_CODE_QUALITY external_prod
```

...
flowchart TD
    ...
    src_zephyr_pf_alloc_core_multi_strategy_capital_allocator_py["Multi-Strategy Capital Allocator —<br/>多策略资金分配器 (MOD-PA-003)<br/>文件: core/multi_strategy_capital_allocator.py<br/>(生产态 / production)"]

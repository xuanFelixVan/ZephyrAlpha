...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_INTEGRATION,D_GOV_ENFORCEMENT,D_TRADING external_prod
    class D_ML_TRAIN,D_BACKTEST,D_SHARED,D_SECURITY external_design
```

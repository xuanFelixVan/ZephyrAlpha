...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_TRADING,D_AUTONOMY_CORE,D_INTEGRATION external_prod
    class D_ML_TRAIN,D_SHARED,D_BACKTEST,D_SECURITY external_design
```

...
graph TD
    ...
    src_zephyr_intelligence_model_evaluation_init_py -.->|config_depends| src_zephyr_intelligence_model_evaluation_inference_base_py
    ...
    class D_ML_TRAIN,D_BACKTEST,D_SECURITY external_design
```

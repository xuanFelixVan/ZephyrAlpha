...
| src/zephyr/intelligence/model_profiling/pipeline/__init__.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/benchmark_suite.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/capability_passport.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/cli.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/deepseek_v4_chat.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/exam_orchestrator.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/exam_test_cases.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/model_discovery.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/profiler.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/results_writer.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline/task_model_learner.py |  | prototype | generated |
...
| src/zephyr/intelligence/model_profiling/pipeline_routing/capability_passport.py |  | production | generated |
...
| src/zephyr/intelligence/model_profiling/pipeline_routing/exam_orchestrator.py |  | prototype | generated |
| src/zephyr/intelligence/model_profiling/pipeline_routing/exam_test_cases.py |  | prototype | generated |
...
graph TD
    ...
    D_GOVERNANCE -.->|test_depends| src_zephyr_intelligence_model_profiling_pipeline_routing_capability_passport_py
...
| D-GOV-ENFORCEMENT | 2 | contract,import_depends |
| D-TRADING | 1 | import_depends |
| D-SHARED | 1 | import_depends |
| D-SECURITY | 1 | runtime |
...
|------|:---:|---------|
| D-GOVERNANCE | 50 | test_depends,import_depends |
| D-INTEGRATION | 16 | import_depends |
| D-TRADING | 6 | import_depends |
| D-GOV-DOCS | 2 | import_depends |

...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_SHARED external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOV_OPS_RESILIENCE,D_INFRA_A2A,D_INTEGRATION,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_SHARED external_prod

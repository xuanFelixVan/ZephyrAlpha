...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_INTEGRATION,D_INFRA_A2A,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_ORCHESTRATOR,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INFRA_A2A,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
    class D_GOVERNANCE external_design
```

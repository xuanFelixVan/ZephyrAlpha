...
graph TD
    ...
    tests_llm_security_test_llm_provider_integrity_py -.->|测试依赖 / test_depends| D_FBL_DIAGNOSERS
    ...
    class D_INFRA_RUNTIME,D_INTEGRATION,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_SECURITY,D_SHARED external_prod

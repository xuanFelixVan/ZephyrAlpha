...
graph TD
    ...
    tests_llm_security_test_llm_cost_router_py -.->|测试依赖 / test_depends| D_FBL_VERIFICATION
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_SECURITY external_prod

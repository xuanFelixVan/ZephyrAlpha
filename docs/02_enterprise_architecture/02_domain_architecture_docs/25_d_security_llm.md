...
graph TD
    ...
    class D_INFRA_A2A,D_SHARED,D_FEEDBACK_LOOP,D_SECURITY,D_ORCHESTRATOR,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_RULE external_prod

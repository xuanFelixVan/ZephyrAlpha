...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTEGRATION,D_FEEDBACK_LOOP,D_SECURITY external_prod
...
| 5 | D_INFRA_RUNTIME 运行时集成: logs/structured_sink — 结构化日志管道（D_SYSTE... | → | LLM Security Gateway Dashboard Module. (__init_... | runtime / runtime |

...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_INTEGRATION,D_ORCHESTRATOR,D_GOV_RULE,D_INFRA_RUNTIME external_prod

...
graph TD
    ...
    class D_SECURITY,D_DATA,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    D_FEEDBACK_LOOP -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_verifiers_cascading_rollback_analyzer_py
    ...
    class D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_SECURITY external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP external_prod
    class D_SECURITY,D_DATA external_design
```

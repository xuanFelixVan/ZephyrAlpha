...
graph TD
    ...
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime| D_COMPLIANCE
    D_SECURITY["D_SECURITY production"]
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime| D_SECURITY
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime| D_GOVERNANCE
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime| D_GOVERNANCE
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime| D_GOVERNANCE
    D_COMPLIANCE -.->|runtime| docs_03_modules_domain_governance_drift_detector_blueprint_md
    ...
    class D_GOVERNANCE,D_COMPLIANCE,D_AUTONOMY_CORE,D_AUDITTEST external_design
```

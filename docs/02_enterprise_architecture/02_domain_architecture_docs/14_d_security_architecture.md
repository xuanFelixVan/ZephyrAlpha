...
> 按 architecture_layer 分层显示 对抗验证（D-SECURITY）的模块分布。共 853 个模块 / 853 modules。
...
> 按 architecture_layer 分组的模块清单（共 853 个模块 / 853 modules）。
...
> (仅显示前 200 个模块，共 579 个)

## 依赖关系图 / Dependency Graph

> 域内模块依赖关系（共 845 条 / 845 edges）。按依赖类型分组，使用 → 表示方向。

```

┌──────────────────────────────────────────────────────────────────┐
│      依赖关系图 / Dependency Graph (共 845 条 / 845 edges)       │
├──────────────────────────────────────────────────────────────────┤
...
**[contract]** (27 条 / edges) — 已达显示上限，省略 / limit reached

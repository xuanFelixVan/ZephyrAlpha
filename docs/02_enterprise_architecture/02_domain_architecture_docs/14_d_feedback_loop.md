...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_DOCS,D_TRADING,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOVERNANCE,D_KNOWLEDGE,D_GOV_ENFORCEMENT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
    class D_SHARED,D_INTEGRATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
    class D_SHARED,D_INTEGRATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_SECURITY_LLM,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_DOCS external_design
```
...
| 100 | FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | → | D_FBL_VERIFICATION 反馈验证: Federated Protocol — v0.10.0 R129 (federated_p... | runtime / runtime |

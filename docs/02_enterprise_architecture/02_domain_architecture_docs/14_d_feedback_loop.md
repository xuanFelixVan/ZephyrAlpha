...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_gates_init_py
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INTEGRATION,D_SECURITY external_design
```
...
| 11 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.gates — auto-generated package i... | runtime / runtime |
...
| 15 | D_INTEGRATION 管线路由: MCP Gateway 集中式治理节点（MOD-INF-013 §12 Ph... | → | API Version Contract — v0.14.0 R188 (api_versi... | 导入依赖 / import_depends |

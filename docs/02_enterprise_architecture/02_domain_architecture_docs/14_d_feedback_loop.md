...
graph TD
    ...
    src_zephyr_feedback_loop_alert_dispatcher_py -.->|runtime / runtime| src_zephyr_feedback_loop_actors_api_version_contract_py
    ...
    D_KNOWLEDGE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_collectors_knowledge_injection_py
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_FBL_VERIFICATION external_prod
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_SECURITY,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_FBL_DETECTORS external_prod
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_DATA,D_INTELLIGENCE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_resilience_graceful_degradation_planner_py
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_AUDIT,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_SHARED external_prod
    class D_GOV_DOCS,D_AUTONOMY_CORE external_design
```
...
| 99 | FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | → | D_FBL_VERIFICATION 反馈验证: Autonomy Credit System — v0.7.0 R87 (autonomy_... | runtime / runtime |

...
graph TD
    ...
    class D_ORCHESTRATOR,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_TRADING,D_SECURITY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_DRIFT external_prod
    class D_FBL_DETECTORS,D_SHARED,D_SECURITY_LLM,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_FBL_DETECTORS,D_SHARED,D_GOV_AUDIT,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_SECURITY_LLM,D_TRADING external_design
```

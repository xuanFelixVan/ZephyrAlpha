...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_ORCHESTRATOR external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_DOCS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_INTEGRATION external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_FRONTEND,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT external_prod
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SECURITY external_design
```
...
graph TD
    ...
    src_zephyr_feedback_loop_db_writer_py -.->|runtime / runtime| src_zephyr_feedback_loop_evolution_init_py
    src_zephyr_feedback_loop_db_writer_py -.->|runtime / runtime| src_zephyr_feedback_loop_forensic_init_py
...
| 3 | FLE 持久化写入器 — 写 metrics/alerts/dispatch_... | → | D_FBL_DETECTORS: __init__.py | runtime / runtime |
...
| 10 | FLE 持久化写入器 — 写 metrics/alerts/dispatch_... | → | D_FBL_DIAGNOSERS: __init__.py | runtime / runtime |
...
| 18 | FLE 持久化写入器 — 写 metrics/alerts/dispatch_... | → | D_FBL_VERIFICATION 反馈验证: Safety Gates L1-L27 — Unified Pipeline (MOD-FE... | runtime / runtime |

...
graph TD
    ...
    class D_ORCHESTRATOR,D_SECURITY,D_AUTONOMY_CORE,D_SECURITY_LLM,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FRONTEND,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_AUTONOMY_CORE,D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_AUDIT,D_FRONTEND,D_GOV_ENFORCEMENT,D_SECURITY,D_INFRA_RUNTIME,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_AUDIT external_prod

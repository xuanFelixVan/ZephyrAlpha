...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_SECURITY,D_TRADING,D_KNOWLEDGE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_ENFORCEMENT,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SHARED,D_SECURITY_LLM,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_DRIFT,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_FBL_VERIFICATION external_prod
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_SECURITY,D_TRADING,D_KNOWLEDGE,D_INTEGRATION,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INTEGRATION,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_SHARED external_prod
```

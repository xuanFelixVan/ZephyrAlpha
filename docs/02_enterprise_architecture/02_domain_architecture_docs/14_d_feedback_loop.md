...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_FBL_VERIFICATION external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_FRONTEND external_prod
...
| 9 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.forensic — auto-generated packag... | runtime / runtime |
| 10 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
...
> 本域与 16 个外部域直接连接（出边 84 条 + 入边 16 条 = 100 条）。只显示直接连接的域，不展开具体节点。

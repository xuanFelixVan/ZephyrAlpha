...
graph TD
    ...
    D_FBL_DIAGNOSERS["(原型态 / prototype) D_FBL_DIAGNOSERS"]
    D_FBL_DIAGNOSERS -.->|runtime / runtime| src_zephyr_feedback_loop_forensic_toctou_guard_py
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_INTEGRATION,D_FBL_DETECTORS external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_GOVERNANCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_FRONTEND external_prod
    class D_FBL_DIAGNOSERS,D_INTEGRATION,D_FBL_DETECTORS,D_SECURITY,D_AUTONOMY_CORE external_design
```
...
| 6 | D_FBL_DIAGNOSERS: __init__.py | → | feedback-loop.collectors — auto-generated pack... | runtime / runtime |
| 7 | D_FBL_DIAGNOSERS: __init__.py | → | feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 8 | D_FBL_DIAGNOSERS: __init__.py | → | TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |
| 9 | D_FBL_DIAGNOSERS: __init__.py | → | feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 10 | D_FBL_DIAGNOSERS: __init__.py | → | feedback-loop.verifiers — auto-generated packa... | runtime / runtime |

...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INTEGRATION external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_ORCHESTRATOR,D_FRONTEND external_prod
    class D_GOV_DRIFT,D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY,D_AUTONOMY_CORE external_design
```

...
| 跨域出边 | 181 | Cross-domain Outgoing | 181 |
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_DOCS,D_KNOWLEDGE,D_SECURITY_LLM,D_TRADING,D_SECURITY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_KNOWLEDGE,D_AUTONOMY_CORE,D_INTELLIGENCE,D_DATA,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_evolution_self_upgrade_canary_py
    D_AUTONOMY_CORE["(原型态 / prototype) D_AUTONOMY_CORE"]
    ...
    class D_SHARED,D_FRONTEND,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_KNOWLEDGE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    D_SECURITY_LLM -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_security_wireheading_prevention_py
    D_INFRA_RUNTIME -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_resilience_resource_starvation_aware_py
    D_SECURITY_LLM -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_security_secret_rotation_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
    class D_FBL_DIAGNOSERS,D_SHARED,D_FBL_DETECTORS,D_FRONTEND,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT external_prod
    class D_FBL_DIAGNOSERS,D_SHARED,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_FRONTEND,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_KNOWLEDGE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_DOCS external_design
```

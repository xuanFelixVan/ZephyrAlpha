...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_SHARED,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FRONTEND external_prod
...
| 9 | D_GOV_DOCS 架构文档治理: blueprint.md | → | TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |
| 10 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 11 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.verifiers — auto-generated packa... | runtime / runtime |

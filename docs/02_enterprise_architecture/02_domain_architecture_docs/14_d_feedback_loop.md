...
graph TD
    ...
    class D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_SECURITY_LLM,D_AUTONOMY_CORE,D_FRONTEND,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_AUDIT external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY_LLM,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INTEGRATION,D_GOVERNANCE,D_FBL_DETECTORS external_prod
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME external_design
```

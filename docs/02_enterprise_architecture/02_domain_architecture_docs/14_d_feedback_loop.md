...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_FRONTEND external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY,D_AUTONOMY_CORE external_design
```

...
# 14_d_feedback_loop / 反馈循环引擎 / Feedback Loop Engine
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INTEGRATION,D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_AUTONOMY_CORE,D_GOV_AUDIT,D_SECURITY,D_FRONTEND external_prod
```

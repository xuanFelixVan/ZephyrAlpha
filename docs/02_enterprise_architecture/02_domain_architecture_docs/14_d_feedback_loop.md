...
graph TD
    ...
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRA_A2A,D_INFRASTRUCTURE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_FRONTEND,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_FBL_VERIFICATION,D_ORCHESTRATOR external_prod
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_FRONTEND,D_DATA,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_FBL_DETECTORS external_prod

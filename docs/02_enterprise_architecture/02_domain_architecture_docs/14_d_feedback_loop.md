...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_FBL_VERIFICATION,D_INTEGRATION,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_SECURITY_LLM,D_KNOWLEDGE,D_INTELLIGENCE,D_DATA,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_FRONTEND external_design
```
...
graph TD
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_generator_py
    ...
    class D_INFRA_RECOVERY,D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_FBL_DETECTORS,D_INTEGRATION,D_FBL_DIAGNOSERS,D_SECURITY_LLM,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_AUTONOMY_CORE external_prod
    class D_FBL_DETECTORS,D_INTEGRATION,D_GOV_AUDIT,D_SECURITY_LLM,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    src_zephyr_feedback_loop_alert_dispatcher_py -.->|runtime / runtime| src_zephyr_feedback_loop_forensic_init_py
...
| 99 | FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | → | D_FBL_VERIFICATION 反馈验证: _governance_gates.py | runtime / runtime |

...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INTEGRATION,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_AUTONOMY_CORE,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FRONTEND external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY external_design
```

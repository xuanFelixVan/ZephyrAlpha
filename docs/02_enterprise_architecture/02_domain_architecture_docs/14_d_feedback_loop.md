...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_SECURITY,D_KNOWLEDGE,D_GOV_SCRIPTS,D_TRADING external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_KNOWLEDGE,D_DATA,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY external_prod
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_SECURITY_LLM,D_KNOWLEDGE,D_GOV_ENFORCEMENT,D_GOV_AUDIT external_design
```

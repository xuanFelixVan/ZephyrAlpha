...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_FBL_DETECTORS external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTELLIGENCE,D_KNOWLEDGE,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND,D_INFRA_A2A,D_SECURITY_LLM,D_SECURITY external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_FBL_VERIFICATION external_prod
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND,D_INFRA_A2A,D_TRADING external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_FBL_DETECTORS,D_GOVERNANCE external_prod

...
graph TD
    ...
    src_zephyr_feedback_loop_alert_dispatcher_py -.->|runtime / runtime| src_zephyr_feedback_loop_actors_action_selector_py
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_COMPLIANCE,D_FBL_VERIFICATION,D_INTEGRATION,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_DOCS,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_DATA,D_AUTONOMY_CORE,D_INTELLIGENCE,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    D_SECURITY -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_scheduler_safety_py
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_SHARED,D_FBL_DETECTORS,D_FRONTEND,D_SECURITY_LLM,D_AUTONOMY_CORE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_SHARED,D_FBL_DETECTORS,D_INTELLIGENCE,D_DATA,D_AUTONOMY_CORE,D_FRONTEND,D_SECURITY_LLM,D_GOV_SCRIPTS,D_SECURITY,D_GOV_AUDIT external_design
```

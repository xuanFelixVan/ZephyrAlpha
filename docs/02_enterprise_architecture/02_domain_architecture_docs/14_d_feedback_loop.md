...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_FBL_DETECTORS,D_INTEGRATION,D_SHARED,D_FBL_DIAGNOSERS external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RECOVERY,D_GOVERNANCE,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FRONTEND external_prod
    class D_FBL_DETECTORS,D_SHARED,D_INTEGRATION,D_FBL_DIAGNOSERS,D_SECURITY,D_AUTONOMY_CORE external_design
```

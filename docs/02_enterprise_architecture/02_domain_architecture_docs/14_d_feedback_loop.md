...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FRONTEND,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_INTELLIGENCE,D_AUTONOMY_CORE,D_INTEGRATION external_design
```

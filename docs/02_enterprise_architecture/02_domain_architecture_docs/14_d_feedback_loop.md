...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_TRADING,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_FRONTEND,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_AUDIT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_INFRA_RECOVERY,D_FBL_VERIFICATION external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_SHARED,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION external_prod
```

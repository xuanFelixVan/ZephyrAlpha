...
graph TD
    ...
    class D_INFRA_RUNTIME,D_DATA,D_AUTONOMY_CORE,D_INTELLIGENCE,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_AUTONOMY_CORE,D_KNOWLEDGE,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_SHARED,D_FBL_DETECTORS,D_FRONTEND,D_SECURITY_LLM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_SHARED,D_FBL_DETECTORS,D_INTELLIGENCE,D_DATA,D_FRONTEND,D_SECURITY_LLM,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION external_prod

...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_SECURITY,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_AUTONOMY_CORE,D_FRONTEND,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
    class D_FBL_VERIFICATION,D_INTEGRATION,D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY_LLM,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_FBL_VERIFICATION,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_INTEGRATION,D_SHARED,D_FBL_DETECTORS,D_SECURITY_LLM,D_FRONTEND,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_AUDIT external_prod
```
...
> 本域与 24 个外部域直接连接（出边 173 条 + 入边 147 条 = 320 条）。只显示直接连接的域，不展开具体节点。

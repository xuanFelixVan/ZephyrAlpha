...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_FBL_DETECTORS,D_ORCHESTRATOR external_prod
    class D_INFRA_RUNTIME,D_INTELLIGENCE,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INTEGRATION,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOVERNANCE external_prod
    class D_SHARED,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_FRONTEND,D_SECURITY,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INTEGRATION,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_INFRA_RUNTIME,D_SECURITY,D_GOVERNANCE external_prod
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND,D_INTELLIGENCE,D_GOV_ENFORCEMENT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOVERNANCE,D_FBL_VERIFICATION external_prod
```

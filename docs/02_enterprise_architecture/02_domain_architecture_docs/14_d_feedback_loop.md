...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_collectors_init_py
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INTEGRATION,D_GOV_DRIFT,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RECOVERY,D_ORCHESTRATOR,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FRONTEND external_prod
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_SECURITY external_design
```
...
| 8 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.collectors — auto-generated pack... | runtime / runtime |
| 9 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 10 | D_GOV_DOCS 架构文档治理: blueprint.md | → | TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |

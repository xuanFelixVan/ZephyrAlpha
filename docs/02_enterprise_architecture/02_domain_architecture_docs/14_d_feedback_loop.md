...
graph TD
    ...
    class D_INFRA_RUNTIME,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INTELLIGENCE,D_DATA external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_FRONTEND,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FRONTEND,D_SECURITY,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOV_AUDIT,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_FRONTEND,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT external_prod
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FRONTEND,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_SECURITY,D_KNOWLEDGE external_design
```

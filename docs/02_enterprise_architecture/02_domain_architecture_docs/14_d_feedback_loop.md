...
graph TD
    ...
    class D_ORCHESTRATOR,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_TRADING external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_KNOWLEDGE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_GOV_SCRIPTS,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOVERNANCE external_prod
```

...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_KNOWLEDGE,D_SECURITY_LLM,D_TRADING external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_FRONTEND,D_GOV_ENFORCEMENT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_INTEGRATION,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_SECURITY_LLM,D_FRONTEND,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RECOVERY,D_GOVERNANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_AUDIT,D_KNOWLEDGE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_SHARED,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_AUDIT external_prod
```

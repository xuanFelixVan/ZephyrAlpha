...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_SCRIPTS,D_SECURITY_LLM,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_AUTONOMY_CORE,D_KNOWLEDGE,D_GOV_ENFORCEMENT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_GOV_OPS_RESILIENCE external_prod
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_INFRA_A2A,D_SECURITY_LLM,D_INFRASTRUCTURE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_FBL_DETECTORS,D_SHARED,D_AUTONOMY_CORE,D_GOV_AUDIT,D_KNOWLEDGE,D_INFRA_A2A,D_SECURITY_LLM external_design
```

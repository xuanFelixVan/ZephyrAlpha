...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_GOV_AUDIT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_ORCHESTRATOR,D_FBL_DETECTORS external_prod
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTELLIGENCE,D_KNOWLEDGE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_INTEGRATION,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_AUDIT,D_INFRA_A2A,D_FRONTEND,D_INFRA_RUNTIME,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SECURITY,D_FBL_VERIFICATION,D_GOV_DRIFT,D_INTEGRATION,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_AUDIT,D_INFRA_A2A,D_TRADING,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOVERNANCE,D_SHARED external_prod

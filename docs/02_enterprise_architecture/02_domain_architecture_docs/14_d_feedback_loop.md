...
| 域内依赖 | 121 | Internal Dependencies | 121 |
...
> 展示全部 126 个模块（生产态 114 + 设计态 0 + 原型态 12），标签标注成熟度。
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_SECURITY,D_FRONTEND external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SHARED,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS external_design
```

### 运营态子图（仅 design_maturity=production 的模块和依赖）

> 仅展示已上线运行的模块（共 114 个，44 条域内依赖）。
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_SECURITY,D_FRONTEND,D_GOV_AUDIT,D_ORCHESTRATOR external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE external_design
```

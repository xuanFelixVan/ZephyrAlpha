...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_SHARED,D_FBL_DETECTORS external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTELLIGENCE,D_KNOWLEDGE,D_DATA external_design
```
...
graph TD
    ...
    class D_FRONTEND,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FRONTEND,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DETECTORS,D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RUNTIME,D_SECURITY external_prod
    class D_FBL_DIAGNOSERS,D_FRONTEND,D_AUTONOMY_CORE,D_INFRASTRUCTURE external_design
```

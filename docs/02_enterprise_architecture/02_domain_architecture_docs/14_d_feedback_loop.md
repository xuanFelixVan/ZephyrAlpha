...
graph TD
    ...
    D_DATA_SEC["(原型态 / prototype) D_DATA_SEC"]
    src_zephyr_feedback_loop_alert_dispatcher_py -.->|runtime / runtime| D_DATA_SEC
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_DATA_SEC,D_FBL_VERIFICATION,D_INTEGRATION,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_SECURITY,D_TRADING,D_INFRASTRUCTURE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_FBL_DETECTORS external_prod
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTELLIGENCE,D_DATA,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_SECURITY external_prod
    class D_AUTONOMY_CORE,D_FRONTEND,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    D_GOV_AUDIT["(原型态 / prototype) D_GOV_AUDIT"]
    D_GOV_AUDIT -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_self_diagnosis_py
    ...
    D_SHARED -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_resilience_multi_instance_coord_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_INFRA_A2A,D_GOV_AUDIT,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    D_FBL_DETECTORS["(生产态 / production) D_FBL_DETECTORS"]
    tests_feedback_test_anomaly_clustering_py -.->|测试依赖 / test_depends| D_FBL_DETECTORS
    ...
    tests_feedback_test_counterfactual_py -.->|测试依赖 / test_depends| D_FBL_DIAGNOSERS
    tests_feedback_test_diagnosis_engine_py -.->|测试依赖 / test_depends| D_FBL_DIAGNOSERS
    ...
    class D_AUTONOMY_CORE,D_INTELLIGENCE,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_SHARED external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_INTELLIGENCE,D_FRONTEND,D_INFRA_A2A external_design
```
...
| 6 | FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | → | D_DATA_SEC 数据安全与契约: __init__.py | runtime / runtime |
...
| 5 | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | → | FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | runtime / runtime |
...
| 85 | D_GOVERNANCE 生命周期管理: G-CT-003 契约：Agent Spec -> RBAC 能力检查. (re... | → | FLE->Orc 告警分派器 — dispatch() 生产者 (alert... | runtime / runtime |

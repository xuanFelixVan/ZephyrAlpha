...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_collectors_financial_stratification_py
    ...
    class D_ORCHESTRATOR,D_GOV_DOCS,D_SECURITY external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_DOCS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_forensic_init_py
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_prod
    class D_FBL_DETECTORS,D_INTEGRATION,D_SHARED,D_FBL_DIAGNOSERS,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_GOVERNANCE,D_FBL_VERIFICATION,D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FRONTEND external_prod
    class D_FBL_DETECTORS,D_INTEGRATION,D_FBL_DIAGNOSERS,D_GOV_DOCS,D_AUTONOMY_CORE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_SHARED external_prod
    class D_ORCHESTRATOR,D_GOV_DOCS external_design
```
...
| 8 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Financial Stratification — v0.5.0 R50 (financi... | runtime / runtime |
| 9 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.evolution — auto-generated packa... | runtime / runtime |
| 10 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.forensic — auto-generated packag... | runtime / runtime |
| 11 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.resilience — auto-generated pack... | runtime / runtime |
| 12 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback-loop.verifiers — auto-generated packa... | runtime / runtime |
...
> 本域与 16 个外部域直接连接（出边 84 条 + 入边 18 条 = 102 条）。只显示直接连接的域，不展开具体节点。

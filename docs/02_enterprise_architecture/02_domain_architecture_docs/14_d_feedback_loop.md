...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_AUDIT external_prod
...
graph TD
    ...
    D_FRONTEND -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_config_py
    ...
    class D_INFRA_RUNTIME,D_DATA,D_AUTONOMY_CORE,D_INTELLIGENCE,D_FRONTEND,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_AUTONOMY_CORE,D_FRONTEND,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    D_SECURITY_LLM -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_security_wireheading_prevention_py
    D_FRONTEND -.->|测试依赖 / test_depends| src_zephyr_feedback_loop_generator_py
    ...
    class D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_SHARED,D_FBL_DETECTORS,D_FRONTEND,D_SECURITY_LLM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
    class D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_SHARED,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_INTELLIGENCE,D_DATA,D_FRONTEND,D_SECURITY_LLM,D_GOV_SCRIPTS,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION external_prod

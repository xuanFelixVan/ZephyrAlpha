...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_DRIFT external_prod
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SECURITY_LLM,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_DRIFT external_prod
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_TRADING,D_SECURITY_LLM external_design
```

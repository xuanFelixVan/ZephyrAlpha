...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOVERNANCE,D_FBL_DETECTORS,D_GOV_AUDIT external_prod
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_SECURITY,D_KNOWLEDGE,D_GOV_SCRIPTS,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_KNOWLEDGE,D_INTELLIGENCE,D_DATA,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_KNOWLEDGE,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_GOVERNANCE external_prod
    class D_FBL_DETECTORS,D_INFRA_RUNTIME,D_SECURITY_LLM,D_AUTONOMY_CORE,D_SECURITY,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_INTELLIGENCE,D_AUTONOMY_CORE,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME,D_GOV_DRIFT external_prod
    class D_FBL_DETECTORS,D_SECURITY_LLM,D_AUTONOMY_CORE,D_SECURITY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_DETECTORS external_prod
```

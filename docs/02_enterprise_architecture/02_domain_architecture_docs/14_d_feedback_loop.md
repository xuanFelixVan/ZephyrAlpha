...
graph TD
    ...
    class D_INFRA_RUNTIME,D_DATA,D_INTELLIGENCE,D_AUTONOMY_CORE,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_FRONTEND,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FRONTEND,D_AUTONOMY_CORE,D_SECURITY_LLM,D_SECURITY external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOVERNANCE external_prod
    class D_FBL_DIAGNOSERS,D_SHARED,D_FRONTEND,D_AUTONOMY_CORE,D_GOV_AUDIT,D_DATA,D_GOV_SCRIPTS,D_INTELLIGENCE,D_SECURITY_LLM external_design
```

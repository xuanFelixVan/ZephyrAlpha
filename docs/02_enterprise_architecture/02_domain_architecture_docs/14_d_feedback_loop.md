...
| 120 | src/zephyr/feedback_loop/subdir/test_file.py | test_file.py | 原型态 / prototype |  |
| 121 | src/zephyr/feedback_loop/template.py | template.py | 生产态 / production | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
| 122 | src/zephyr/feedback_loop/tests/e2e/__init__.py | feedback-loop.tests.e2e — auto-generated packa... | 原型态 / prototype | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
| 123 | src/zephyr/feedback_loop/tests/e2e/integration_test_pipel... | E2E Integration Test Pipeline — TASK-MOD-FEEDB... | 生产态 / production | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
| 124 | src/zephyr/feedback_loop/validator.py | validator.py | 生产态 / production | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
| 125 | src/zephyr/feedback_loop/verifiers/__init__.py | feedback-loop.verifiers — auto-generated packa... | 原型态 / prototype | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
...
> 展示全部 230 个模块（生产态 110 + 设计态 0 + 原型态 120），标签标注成熟度。
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_SHARED,D_FBL_DETECTORS external_prod
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_KNOWLEDGE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_FRONTEND,D_KNOWLEDGE external_design
```
...
graph TD
    subgraph D_FEEDBACK_LOOP["D_FEEDBACK_LOOP 反馈循环引擎"]
        ...
        src_zephyr_feedback_loop_subdir_test_file_py["(原型态 / prototype) test_file.py"]
    end
    ...
    class src_zephyr_feedback_loop_gates_init_py,src_zephyr_feedback_loop_resilience_init_py,src_zephyr_feedback_loop_security_init_py,src_zephyr_feedback_loop_subdir_test_file_py design
    class D_SHARED,D_INFRA_RECOVERY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_INTEGRATION,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class src_zephyr_feedback_loop_template_py,src_zephyr_feedback_loop_tests_e2e_integration_test_pipeline_py,src_zephyr_feedback_loop_validator_py production
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_GOVERNANCE,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_KNOWLEDGE,D_SECURITY_LLM external_design
```

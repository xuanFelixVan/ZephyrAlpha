...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE external_prod
    class D_FBL_DETECTORS,D_INFRA_RUNTIME,D_SECURITY,D_SECURITY_LLM,D_AUTONOMY_CORE,D_GOV_AUDIT,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS external_prod
    class D_FBL_DETECTORS,D_SECURITY,D_SECURITY_LLM,D_INTEGRATION,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOVERNANCE,D_FBL_DETECTORS external_prod
```

...
graph TD
    ...
    class D_ORCHESTRATOR,D_AUTONOMY_CORE,D_INFRASTRUCTURE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_DATA,D_KNOWLEDGE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_INTEGRATION,D_FRONTEND external_prod
    class D_GOV_ENFORCEMENT,D_GOV_AUDIT,D_AUTONOMY_CORE,D_KNOWLEDGE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_INFRA_RUNTIME,D_INTEGRATION,D_SECURITY external_prod
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY_LLM,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOVERNANCE,D_FBL_DIAGNOSERS external_prod

...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_feedback_loop_forensic_deterministic_replay_py
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_GOV_DOCS,D_SECURITY,D_AUTONOMY_CORE external_design
```
...
| 10 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Deterministic Replay — v0.15.0 R206 (determini... | runtime / runtime |

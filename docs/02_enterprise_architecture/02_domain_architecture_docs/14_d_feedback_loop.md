...
graph TD
    ...
    class D_SHARED,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_INTEGRATION,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_INFRA_RECOVERY,D_GOVERNANCE,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FRONTEND external_prod
    class D_SHARED,D_FBL_DETECTORS,D_SECURITY external_design
```

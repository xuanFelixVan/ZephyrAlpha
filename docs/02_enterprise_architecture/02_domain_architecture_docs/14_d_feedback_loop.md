...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_AUDIT,D_FRONTEND external_prod
    class D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_INTEGRATION,D_SECURITY,D_AUTONOMY_CORE external_design
```

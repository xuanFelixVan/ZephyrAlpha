...
graph TD
    ...
    class D_ORCHESTRATOR,D_TRADING,D_KNOWLEDGE,D_AUTONOMY_CORE,D_SECURITY external_design
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_KNOWLEDGE,D_GOVERNANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_INTEGRATION,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_SECURITY_LLM,D_FRONTEND,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_AUTONOMY_CORE external_prod
    class D_INTEGRATION,D_FBL_DETECTORS,D_GOV_DRIFT,D_SECURITY_LLM,D_TRADING,D_KNOWLEDGE,D_GOV_AUDIT,D_FRONTEND external_design
```

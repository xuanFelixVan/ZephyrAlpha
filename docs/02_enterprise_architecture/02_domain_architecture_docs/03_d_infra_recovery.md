...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_ORCHESTRATOR,D_GOV_DRIFT,D_POSITION,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_RULE external_prod
    class D_AUTONOMY_CORE,D_GOVERNANCE,D_EX_CORE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_SECURITY,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_REPAIR external_prod
```

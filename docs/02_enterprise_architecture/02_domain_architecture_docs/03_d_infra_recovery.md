...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SECURITY,D_GOV_RULE,D_OPS external_prod
    class D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOVERNANCE,D_EX_CORE,D_INTEGRATION,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_RULE,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_GOV_DRIFT,D_AUTONOMY_CORE,D_EX_CORE,D_INTEGRATION,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_SECURITY,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_OPS,D_GOV_REPAIR external_prod
```

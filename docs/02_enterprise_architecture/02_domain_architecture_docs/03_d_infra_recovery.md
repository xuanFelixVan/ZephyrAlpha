...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOVERNANCE,D_GOV_DRIFT,D_POSITION,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_SECURITY,D_GOVERNANCE,D_POSITION,D_OPS,D_INFRA_RUNTIME external_prod
```

...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE,D_OPS external_prod
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_INTEGRATION,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_SECURITY,D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_POSITION,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_INTEGRATION external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_SHARED,D_GOV_CODE_QUALITY,D_SECURITY,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_REPAIR external_prod
```

...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE,D_GOV_REPAIR,D_OPS external_prod
    class D_GOVERNANCE,D_EX_CORE,D_GOV_SCRIPTS,D_INTEGRATION,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOVERNANCE,D_EX_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SECURITY,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_SHARED,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_OPS external_prod
```

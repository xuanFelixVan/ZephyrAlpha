...
graph TD
    ...
    src_zephyr_governance_rollback_init_py -.->|config_depends / config_depends| src_zephyr_governance_rollback_contracts_py
    ...
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE,D_GOV_REPAIR external_prod
    class D_SHARED,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_SECURITY,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_OPS external_prod
```

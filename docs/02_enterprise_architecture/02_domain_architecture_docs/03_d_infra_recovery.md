...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_FBL_VERIFICATION,D_SECURITY,D_FBL_DETECTORS,D_GOV_REPAIR,D_OPS external_prod
```

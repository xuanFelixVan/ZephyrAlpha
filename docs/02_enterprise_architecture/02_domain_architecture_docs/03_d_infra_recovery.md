...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE,D_GOV_REPAIR,D_OPS external_prod
    class D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_ORCHESTRATOR,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_GOV_DRIFT,D_INFRA_RUNTIME,D_POSITION,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_SHARED,D_FBL_VERIFICATION,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_OPS external_prod
```

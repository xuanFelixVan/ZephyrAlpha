...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_REPAIR,D_OPS external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SECURITY,D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_POSITION,D_GOV_REPAIR,D_OPS external_prod
```

...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_RULE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOVERNANCE external_prod
    class D_SHARED,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_OPS,D_INFRA_RUNTIME external_prod
```

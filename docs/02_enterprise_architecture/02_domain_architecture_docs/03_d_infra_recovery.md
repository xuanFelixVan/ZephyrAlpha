...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_SECURITY,D_GOV_REPAIR,D_OPS,D_GOV_RULE,D_INTEGRATION external_prod
    class D_SHARED,D_AUTONOMY_CORE,D_EX_CORE,D_GOV_SCRIPTS,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE,D_INTEGRATION,D_GOVERNANCE external_prod
    class D_SHARED,D_AUTONOMY_CORE,D_EX_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_DRIFT,D_SECURITY,D_FBL_DETECTORS,D_POSITION,D_GOV_REPAIR,D_OPS external_prod
```

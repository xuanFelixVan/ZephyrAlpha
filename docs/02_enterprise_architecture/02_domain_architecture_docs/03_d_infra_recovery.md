...
graph TD
    ...
    class D_FBL_VERIFICATION,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_EX_CORE,D_GOV_SCRIPTS,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_DRIFT,D_SECURITY,D_POSITION,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_GOV_REPAIR,D_OPS external_prod
```

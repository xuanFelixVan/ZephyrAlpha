...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_OPS,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_SHARED,D_INFRA_RUNTIME,D_GOV_DRIFT,D_SECURITY,D_GOV_AUDIT,D_OPS,D_GOV_REPAIR external_prod
```

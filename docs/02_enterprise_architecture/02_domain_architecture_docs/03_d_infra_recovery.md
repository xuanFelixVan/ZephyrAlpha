...
# 03_d_infra_recovery / 回滚恢复 / Rollback Recovery
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOVERNANCE,D_INTEGRATION,D_OPS,D_FEEDBACK_LOOP,D_GOV_RULE,D_INFRA_RUNTIME external_prod
```

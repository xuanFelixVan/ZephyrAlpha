...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_AUTONOMY_CORE,D_EX_CORE,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
    class D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_SHARED,D_GOV_AUDIT,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_POSITION,D_GOV_REPAIR,D_OPS external_prod
```

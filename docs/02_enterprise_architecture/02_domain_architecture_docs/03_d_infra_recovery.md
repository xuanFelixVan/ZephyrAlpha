...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_REPAIR,D_OPS external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_SECURITY,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_SECURITY,D_POSITION,D_GOV_REPAIR,D_OPS external_prod
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE,D_OPS,D_GOV_REPAIR external_prod
    class D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_SECURITY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_DRIFT,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_CODE_QUALITY,D_SHARED,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_REPAIR external_prod
```

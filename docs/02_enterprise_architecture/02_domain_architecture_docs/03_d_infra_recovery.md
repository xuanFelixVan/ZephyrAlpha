...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME,D_SECURITY,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_REPAIR,D_INTEGRATION external_prod
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_DRIFT,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_GOV_DRIFT,D_SECURITY,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SECURITY,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_AUTONOMY_CORE,D_GOV_DRIFT,D_EX_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_ORCHESTRATOR,D_POSITION,D_FBL_VERIFICATION,D_SECURITY,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_OPS,D_GOV_REPAIR external_prod
```

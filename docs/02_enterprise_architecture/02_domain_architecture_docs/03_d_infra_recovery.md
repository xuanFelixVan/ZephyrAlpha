...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_SECURITY,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_GOV_AUDIT,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_ORCHESTRATOR,D_GOV_DRIFT,D_POSITION,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_SECURITY,D_FBL_VERIFICATION,D_ORCHESTRATOR,D_FBL_DETECTORS,D_POSITION,D_OPS,D_INFRA_RUNTIME external_prod
```

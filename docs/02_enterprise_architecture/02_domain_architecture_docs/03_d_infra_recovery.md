...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_OPS,D_GOV_RULE external_prod
    class D_INTEGRATION,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_SHARED,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_REPAIR external_prod
```

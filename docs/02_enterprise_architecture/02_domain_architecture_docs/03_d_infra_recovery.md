...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_OPS,D_INFRA_RUNTIME,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOVERNANCE external_prod
    class D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOV_AUDIT,D_OPS,D_INFRA_RUNTIME external_prod
```
...
> 本域与 11 个外部域直接连接（出边 26 条 + 入边 11 条 = 37 条）。只显示直接连接的域，不展开具体节点。

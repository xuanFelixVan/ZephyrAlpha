...
graph TD
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_infrastructure_rollback_git_infra_snapshot_py
    ...
    D_AUDITTEST -.->|test_depends| src_zephyr_infrastructure_rollback_intent_archiver_py
    D_AUDITTEST -.->|test_depends| src_zephyr_infrastructure_rollback_rollback_bootstrap_py
    D_AUDITTEST -.->|test_depends| src_zephyr_infrastructure_rollback_rollback_budget_py
    D_AUDITTEST -.->|test_depends| src_zephyr_infrastructure_rollback_rollback_abuse_detector_py
    D_AUDITTEST -.->|test_depends| src_zephyr_infrastructure_rollback_rollback_context_restorer_py

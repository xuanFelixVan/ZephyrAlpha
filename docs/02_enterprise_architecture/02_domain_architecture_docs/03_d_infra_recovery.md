...
| 域内依赖 | 72 | Internal Dependencies | 72 |
...
| 37 | src/zephyr/infrastructure/rollback/rollback_scheduler.py | RollbackScheduler — 回滚系统事件驱动调度器 (MO... | 生产态 / production | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
...
| # | 模块路径 / Module Path | 模块名称 / Module Name (功能简介 / Description) | 成熟度 / Maturity | 蓝图 / Blueprint |
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/governance/rollback/__init__.py | __init__.py | 原型态 / prototype |  |
| 2 | src/zephyr/governance/rollback/contracts.py | contracts.py | 原型态 / prototype |  |
| 3 | tests/canary/test_canary_controller.py | test_canary_controller.py | 原型态 / prototype | [MOD-INF-033](../../03_modules/_cross_layer/behavioral_auditor/blueprint.md) |
| 4 | tests/canary/test_canary_manager.py | test_canary_manager.py | 原型态 / prototype | [MOD-INF-039](../../03_modules/_cross_layer/agent_orchestrator/blueprint.md) |
| 5 | tests/canary/test_canary_register.py | test_canary_register.py | 原型态 / prototype | [MOD-INF-017](../../03_modules/_domain_governance/code_dedup_engine/blueprint.md) |
| 6 | tests/canary/test_canary_repair.py | test_canary_repair.py | 原型态 / prototype | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
| 7 | tests/canary/test_canary_rollout_manager.py | test_canary_rollout_manager.py | 原型态 / prototype | [MOD-INF-018](../../03_modules/_domain_autonomy_core/agent_role_based_access_control/blueprint.md) |
| 8 | tests/chaos/test_chaos_engine.py | test_chaos_engine.py | 原型态 / prototype | [MOD-INF-039](../../03_modules/_cross_layer/agent_orchestrator/blueprint.md) |
| 9 | tests/chaos/test_chaos_engine_ops.py | test_chaos_engine_ops.py | 原型态 / prototype | [MOD-INF-039](../../03_modules/_cross_layer/agent_orchestrator/blueprint.md) |
| 10 | tests/chaos/test_chaos_engineering.py | test_chaos_engineering.py | 原型态 / prototype | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
| 11 | tests/chaos/test_chaos_hooks.py | test_chaos_hooks.py | 原型态 / prototype | [MOD-INF-039](../../03_modules/_cross_layer/agent_orchestrator/blueprint.md) |
| 12 | tests/chaos/test_chaos_injector.py | test_chaos_injector.py | 原型态 / prototype | [MOD-INF-033](../../03_modules/_cross_layer/behavioral_auditor/blueprint.md) |
| 13 | tests/rollback/conftest.py | conftest.py | 原型态 / prototype |  |
| 14 | tests/rollback/test_concurrency_guard.py | test_concurrency_guard.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 15 | tests/rollback/test_position_reconciler.py | test_position_reconciler.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 16 | tests/rollback/test_rollback_abuse_detector.py | test_rollback_abuse_detector.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 17 | tests/rollback/test_rollback_audit_nexus.py | test_rollback_audit_nexus.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 18 | tests/rollback/test_rollback_bootstrap.py | test_rollback_bootstrap.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 19 | tests/rollback/test_rollback_bridge.py | test_rollback_bridge.py | 原型态 / prototype | [MOD-INF-033](../../03_modules/_cross_layer/behavioral_auditor/blueprint.md) |
| 20 | tests/rollback/test_rollback_budget.py | test_rollback_budget.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 21 | tests/rollback/test_rollback_concurrent_extreme.py | Extreme tests for concurrent rollback (MOD-INF-... | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 22 | tests/rollback/test_rollback_context_restorer.py | test_rollback_context_restorer.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 23 | tests/rollback/test_rollback_dashboard.py | test_rollback_dashboard.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 24 | tests/rollback/test_rollback_drill.py | test_rollback_drill.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 25 | tests/rollback/test_rollback_executor_root.py | test_rollback_executor_root.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 26 | tests/rollback/test_rollback_integration.py | test_rollback_integration.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 27 | tests/rollback/test_rollback_integrity.py | test_rollback_integrity.py | 原型态 / prototype | [MOD-FEEDBACK_LOOP](../../03_modules/_cross_layer/feedback_loop/blueprint.md) |
| 28 | tests/rollback/test_rollback_lock.py | test_rollback_lock.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 29 | tests/rollback/test_rollback_loop_detector.py | test_rollback_loop_detector.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 30 | tests/rollback/test_rollback_partial_extreme.py | Extreme tests for partial_revert (MOD-INF-021 B... | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 31 | tests/rollback/test_rollback_sandbox.py | test_rollback_sandbox.py | 原型态 / prototype | [MOD-INF-018](../../03_modules/_domain_autonomy_core/agent_role_based_access_control/blueprint.md) |
| 32 | tests/rollback/test_rollback_scheduler.py | DM-201911 红蓝对抗极端测试: RollbackScheduler ... | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 33 | tests/rollback/test_rollback_simulator.py | test_rollback_simulator.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 34 | tests/rollback/test_rollback_state_machine.py | test_rollback_state_machine.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 35 | tests/rollback/test_rollback_target_staleness.py | test_rollback_target_staleness.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 36 | tests/rollback/test_rollback_verifier_root.py | test_rollback_verifier_root.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
| 37 | tests/rollback/test_rollback_wal.py | test_rollback_wal.py | 原型态 / prototype | [MOD-INF-021](../../03_modules/_domain_autonomy_core/rollback_system/blueprint.md) |
...
> 展示全部 91 个模块（生产态 48 + 设计态 0 + 原型态 43），标签标注成熟度。
...
graph TD
    subgraph D_INFRA_RECOVERY["D_INFRA_RECOVERY 回滚恢复"]
        src_zephyr_governance_rollback_init_py["(原型态 / prototype) __init__.py"]
        src_zephyr_governance_rollback_contracts_py["(原型态 / prototype) contracts.py"]
    ...
    src_zephyr_governance_rollback_contracts_py -.->|config_depends / config_depends| src_zephyr_governance_rollback_init_py
    ...
    src_zephyr_infrastructure_rollback_init_py -.->|导入依赖 / import_depends| D_INFRA_RUNTIME
    ...
    D_INFRA_RUNTIME -.->|测试依赖 / test_depends| src_zephyr_infrastructure_rollback_commit_quality_gate_py
    D_INFRA_RUNTIME -.->|测试依赖 / test_depends| src_zephyr_infrastructure_rollback_forward_fix_runner_py
    ...
    D_AUTONOMY_CORE -.->|测试依赖 / test_depends| src_zephyr_infrastructure_rollback_intent_archiver_py
    ...
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_infrastructure_rollback_contract_py
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_infrastructure_rollback_forensic_py
...
graph TD
    subgraph D_INFRA_RECOVERY["D_INFRA_RECOVERY 回滚恢复"]
        ...
        src_zephyr_infrastructure_rollback_rollback_scheduler_py["(生产态 / production) RollbackScheduler — 回滚系统事件驱动调度器 (MO...<br/>文件: rollback_scheduler.py"]
    ...
    D_INFRA_RUNTIME -.->|测试依赖 / test_depends| src_zephyr_infrastructure_rollback_temporal_context_adapter_py
...
graph TD
    ...
    tests_chaos_test_chaos_engineering_py -.->|测试依赖 / test_depends| D_FBL_DETECTORS
    D_ORCHESTRATOR["(生产态 / production) D_ORCHESTRATOR"]
    ...
    D_INFRA_RUNTIME["(生产态 / production) D_INFRA_RUNTIME"]
    tests_rollback_test_concurrency_guard_py -.->|测试依赖 / test_depends| D_INFRA_RUNTIME
...
graph TD
    ...
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    class tests_rollback_test_rollback_wal_py design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_RULE,D_FEEDBACK_LOOP external_prod
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 43 个，5 条域内依赖）。
...
graph TD
    ...
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_infrastructure_rollback_complexity_budget_py
    D_INFRA_RUNTIME -.->|导入依赖 / import_depends| src_zephyr_infrastructure_rollback_rollback_boot_integration_py
    D_GOV_REPAIR -.->|导入依赖 / import_depends| src_zephyr_infrastructure_rollback_init_py
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_ORCHESTRATOR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_SECURITY,D_FBL_VERIFICATION,D_SHARED,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_REPAIR external_prod
```
...
|:--:|---------|:--:|---------|---------|
| 1 | test_chaos_engineering.py | → | D_FBL_DETECTORS: Chaos Engineering — v0.13.0 R172 (chaos_engine... | 测试依赖 / test_depends |
| 2 | test_canary_repair.py | → | D_FBL_VERIFICATION 反馈验证: Canary Repair — v0.8.0 R104b (canary_repair.py) | 测试依赖 / test_depends |
| 3 | test_rollback_integrity.py | → | D_FBL_VERIFICATION 反馈验证: Rollback Integrity — v0.3.0 R18b (rollback_int... | 测试依赖 / test_depends |
| 4 | G-CT-004 契约：Rollback -> Audit 记录回滚操作. ... | → | D_GOV_AUDIT 审计追踪: contracts.py | 导入依赖 / import_depends |
| 5 | G-CT-002 Rollback 消费端 — on_audit_anomaly() ... | → | D_GOV_AUDIT 审计追踪: anomaly.py | 导入依赖 / import_depends |
| 6 | RollbackAbuseDetector — 回滚滥用检测。 (rollba... | → | D_GOV_AUDIT 审计追踪: query.py | 导入依赖 / import_depends |
| 7 | RollbackAuditNexus — 回滚审计记录聚合到 Nexus ... | → | D_GOV_AUDIT 审计追踪: writer.py | 导入依赖 / import_depends |
| 8 | RollbackExecutor — 回滚执行器核心封装。 (rollb... | → | D_GOV_AUDIT 审计追踪: writer.py | 导入依赖 / import_depends |
| 9 | test_canary_register.py | → | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀注册表维护器 — 注册/过期/腐败检测. (cana... | 测试依赖 / test_depends |
| 10 | test_canary_controller.py | → | D_GOV_DRIFT 漂移检测: Detector Canary Controller — 检测器金丝雀部署 ... | 测试依赖 / test_depends |
| 11 | test_chaos_injector.py | → | D_GOV_DRIFT 漂移检测: Drift Chaos Injector — 混沌工程主动漂移注入 §... | 测试依赖 / test_depends |
| 12 | test_rollback_bridge.py | → | D_GOV_DRIFT 漂移检测: G-CT-006 契约：Drift -> Rollback 漂移触发回滚. ... | 测试依赖 / test_depends |
| 13 | RollbackBootIntegration — 回滚系统自动启动/关.... | → | D_GOV_OPS_RESILIENCE 运维弹性治理: EventHook — 声明式任务系统事件订阅 (event_hook.py) | 导入依赖 / import_depends |
| 14 | MOD-INF-021 Rollback System — ZephyrAlpha 回滚... | → | D_INFRA_RUNTIME 运行时集成: concurrency_guard — 回滚操作并发安全守卫。 (co... | 导入依赖 / import_depends |
| 15 | RollbackExecutor — 回滚执行器核心封装。 (rollb... | → | D_INFRA_RUNTIME 运行时集成: concurrency_guard — 回滚操作并发安全守卫。 (co... | 导入依赖 / import_depends |
| 16 | test_concurrency_guard.py | → | D_INFRA_RUNTIME 运行时集成: concurrency_guard — 回滚操作并发安全守卫。 (co... | 测试依赖 / test_depends |
| 17 | test_canary_manager.py | → | D_ORCHESTRATOR 代理编排器: 金丝雀发布管理器（CT-CANARY）——权重分流+指标.... | 测试依赖 / test_depends |
| 18 | test_chaos_engine.py | → | D_ORCHESTRATOR 代理编排器: Chaos 故障注入引擎（CT-CHAOS-001）——4注入点×... | 测试依赖 / test_depends |
| 19 | test_chaos_engine_ops.py | → | D_ORCHESTRATOR 代理编排器: Chaos 故障注入引擎（CT-CHAOS-001）——4注入点×... | 测试依赖 / test_depends |
| 20 | test_chaos_hooks.py | → | D_ORCHESTRATOR 代理编排器: Chaos 故障注入引擎（CT-CHAOS-001）——4注入点×... | 测试依赖 / test_depends |
| 21 | test_chaos_hooks.py | → | D_ORCHESTRATOR 代理编排器: ChaosHook — integrates ChaosEngine with the or... | 测试依赖 / test_depends |
| 22 | test_position_reconciler.py | → | D_POSITION 仓位管理: Position Reconciler — v0.10.1 持仓对账: execut... | 测试依赖 / test_depends |
| 23 | drift_fix.py | → | D_SECURITY 对抗验证: G-CT-005 — ManagedDriftEvent Pydantic V2 BaseM... | 导入依赖 / import_depends |
| 24 | test_canary_rollout_manager.py | → | D_SECURITY 对抗验证: CanaryRolloutManager — 灰度发布管理器. (canary... | 测试依赖 / test_depends |
| 25 | test_rollback_sandbox.py | → | D_SECURITY 对抗验证: Stub module: zephyr.security.access_control.rol... | 测试依赖 / test_depends |
| 26 | AgentCooldown — Agent 冷却隔离器。 (agent_cool... | → | D_SHARED 共享服务: SQLite 连接工厂真源（SSoT） (sqlite_factory.py) | 导入依赖 / import_depends |
| 27 | External Merkle Proof — 外部可验证回滚完整性证... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 28 | Forensic Engine — 取证基础设施（Phase 8 完整实... | → | D_SHARED 共享服务: file_utils.py —— 安全文件操作工具（Phase 3 新... | 导入依赖 / import_depends |
| 29 | ForwardFixRunner — Forward-Fix 执行器。 (forwa... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 30 | Right to be Forgotten — GDPR 遗忘权合规检查器... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 31 | RollbackBootIntegration — 回滚系统自动启动/关.... | → | D_SHARED 共享服务: EventBus — 事件总线（带背压控制）(M-07) (event... | 导入依赖 / import_depends |
| 32 | RollbackDrill — 定期回滚演练调度器 (DiRT-style... | → | D_SHARED 共享服务: SQLite 连接工厂真源（SSoT） (sqlite_factory.py) | 导入依赖 / import_depends |
| 33 | RollbackExecutor — 回滚执行器核心封装。 (rollb... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 34 | RollbackExecutor — 回滚执行器核心封装。 (rollb... | → | D_SHARED 共享服务: async_utils.py — async/sync 边界桥接（5.12.8 .... | 导入依赖 / import_depends |
| 35 | Rollback Integration — executor 集成增强层。 (... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 36 | Rollback Integration — executor 集成增强层。 (... | → | D_SHARED 共享服务: SQLite 连接工厂真源（SSoT） (sqlite_factory.py) | 导入依赖 / import_depends |
| 37 | Rollback Integration — executor 集成增强层。 (... | → | D_SHARED 共享服务: secrets.py —— Secrets 管理抽象（Phase 7 新增 ... | 导入依赖 / import_depends |
| 38 | RollbackVerifier — 回滚后验证器。 (rollback_ve... | → | D_SHARED 共享服务: SQLite 连接工厂真源（SSoT） (sqlite_factory.py) | 导入依赖 / import_depends |
| 39 | S3 Snapshot Lifecycle Manager — 快照防生命周期... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 40 | SqliteDumper — SQLite 双轨 Checkpoint 的 DB 层... | → | D_SHARED 共享服务: paths.py — 项目路径常量 SSoT（Single Source of... | 导入依赖 / import_depends |
| 41 | SqliteDumper — SQLite 双轨 Checkpoint 的 DB 层... | → | D_SHARED 共享服务: SQLite 连接工厂真源（SSoT） (sqlite_factory.py) | 导入依赖 / import_depends |
| 42 | SqliteDumper — SQLite 双轨 Checkpoint 的 DB 层... | → | D_SHARED 共享服务: time_utils.py —— 时间/日期工具（Phase 9 新增 ... | 导入依赖 / import_depends |
| 43 | WarmStandby — 温备热切（git worktree 副本维护... | → | D_SHARED 共享服务: serialization.py —— 统一序列化/反序列化基础设... | 导入依赖 / import_depends |
...
| 18 | D_GOVERNANCE 生命周期管理: test_governance_drift_fix.py | → | drift_fix.py | 测试依赖 / test_depends |
| 19 | D_GOVERNANCE 生命周期管理: test_contract.py | → | CT-RBK-GATE-001 集成契约落地——Rollback System... | 测试依赖 / test_depends |
| 20 | D_GOVERNANCE 生命周期管理: test_submodule_sync.py | → | Submodule Sync — Submodule/Monorepo 多仓库同步... | 测试依赖 / test_depends |
| 21 | D_GOVERNANCE 生命周期管理: test_checkpoint_gc.py | → | CheckpointGC — Checkpoint 垃圾回收。 (checkpoi... | 测试依赖 / test_depends |
| 22 | D_GOVERNANCE 生命周期管理: test_venv_sync.py | → | VenvSync — venv/conda 版本同步保障。 (venv_syn... | 测试依赖 / test_depends |
| 23 | D_GOVERNANCE 生命周期管理: test_env_watcher.py | → | EnvWatcher — 环境变量热重载监控器。 (env_watch... | 测试依赖 / test_depends |
| 24 | D_GOVERNANCE 生命周期管理: test_runbook_generator.py | → | RunbookGenerator — 回滚操作 Runbook 自动生成。... | 测试依赖 / test_depends |
| 25 | D_GOVERNANCE 生命周期管理: test_knowngoodstate_ledger.py | → | KnowngoodstateLedger — 已验证正确状态收据。 (k... | 测试依赖 / test_depends |
| 26 | D_GOVERNANCE 生命周期管理: test_warm_standby.py | → | WarmStandby — 温备热切（git worktree 副本维护... | 测试依赖 / test_depends |
| 27 | D_GOVERNANCE 生命周期管理: test_vulnerability_rescanner.py | → | VulnerabilityRescanner — 依赖漏洞复扫。 (vulne... | 测试依赖 / test_depends |
| 28 | D_GOV_AUDIT 审计追踪: test_drift_fix.py | → | drift_fix.py | 测试依赖 / test_depends |
| 29 | D_GOV_AUDIT 审计追踪: test_semantic_rollback_tag.py | → | SemanticRollbackTag — 语义化 Rollback Tag 管理... | 测试依赖 / test_depends |
| 30 | D_GOV_AUDIT 审计追踪: test_semantic_similar_detector.py | → | SemanticSimilarDetector — 语义变形攻击检测。 (... | 测试依赖 / test_depends |
| 31 | D_GOV_DRIFT 漂移检测: Gate-side Drift Detector Recovery — zephyr.gov... | → | drift_fix.py | 导入依赖 / import_depends |
| 32 | D_GOV_OPS_RESILIENCE 运维弹性治理: PhaseManager->GateEngine 检查注册表桥梁 — 44 .... | → | KillSwitchManager — 三级 Kill Switch 管理器。 ... | 导入依赖 / import_depends |
| 33 | D_GOV_OPS_RESILIENCE 运维弹性治理: PhaseManager->GateEngine 检查注册表桥梁 — 44 .... | → | RollbackExecutor — 回滚执行器核心封装。 (rollb... | 导入依赖 / import_depends |
| 34 | D_GOV_REPAIR 治理修复: Agent 治理八件套 · Governance Domain — DOM-GO... | → | MOD-INF-021 Rollback System — ZephyrAlpha 回滚... | 导入依赖 / import_depends |
| 35 | D_GOV_REPAIR 治理修复: Agent 治理八件套 · Governance Domain — DOM-GO... | → | ComplexityBudget — 回滚复杂度元 Budget 监控。 ... | 导入依赖 / import_depends |
| 36 | D_GOV_RULE 规则治理: GateEngine — KMS G1-G6 + Orc G0/G7 + 交易 G10-... | → | CT-RBK-GATE-001 集成契约落地——Rollback System... | 导入依赖 / import_depends |
| 37 | D_GOV_SCRIPTS 脚本治理: test_git_infra_snapshot.py | → | GitInfraSnapshot — Git 基础设施快照与污染防护... | 测试依赖 / test_depends |
| 38 | D_INFRA_RUNTIME 运行时集成: boot_hooks.py | → | RollbackBootIntegration — 回滚系统自动启动/关.... | 导入依赖 / import_depends |
| 39 | D_INFRA_RUNTIME 运行时集成: test_commit_quality_gate.py | → | CommitQualityGate — Commit 质量基础设施。 (com... | 测试依赖 / test_depends |
| 40 | D_INFRA_RUNTIME 运行时集成: test_forward_fix_runner.py | → | ForwardFixRunner — Forward-Fix 执行器。 (forwa... | 测试依赖 / test_depends |
| 41 | D_INFRA_RUNTIME 运行时集成: test_topology_change_log.py | → | TopologyChangeLog — 分支拓扑变更日志。 (topolo... | 测试依赖 / test_depends |
| 42 | D_INFRA_RUNTIME 运行时集成: test_temporal_context_adapter.py | → | TemporalContextAdapter — AI 时间上下文断裂修复... | 测试依赖 / test_depends |
| 43 | D_INTEGRATION 管线路由: PipelineOrchestrator — M1-M11 管线协调器 (pipe... | → | CT-RBK-GATE-001 集成契约落地——Rollback System... | 导入依赖 / import_depends |
| 44 | D_INTEGRATION 管线路由: test_external_merkle_proof.py | → | External Merkle Proof — 外部可验证回滚完整性证... | 测试依赖 / test_depends |
| 45 | D_OPS 反馈循环: budget_tracker.py | → | G-CT-009 契约：Rollback -> Budget 回滚成本计入.... | 导入依赖 / import_depends |
| 46 | D_SHARED 共享服务: test_cross_platform_shell.py | → | CrossPlatformShell — 跨平台 Shell 脚本双输出。... | 测试依赖 / test_depends |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 20 个外部域直接连接（出边 43 条 + 入边 46 条 = 89 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_RULE,D_OPS,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOVERNANCE external_prod
    class D_SHARED,D_GOV_DRIFT external_design
```

...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_FBL_DETECTORS,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_SHARED,D_INFRA_RUNTIME,D_SECURITY,D_POSITION,D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_REPAIR,D_OPS external_prod
```

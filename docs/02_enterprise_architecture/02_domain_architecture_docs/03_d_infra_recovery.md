...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_SECURITY,D_OPS external_prod
    class D_EX_CORE,D_GOVERNANCE,D_INTEGRATION,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_FEEDBACK_LOOP external_prod
    class D_EX_CORE,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_SECURITY,D_SHARED,D_INFRA_RUNTIME,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_OPS,D_GOV_REPAIR external_prod
```

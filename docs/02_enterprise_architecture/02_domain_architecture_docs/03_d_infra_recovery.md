...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE external_prod
    class D_GOVERNANCE,D_INTEGRATION,D_EX_CORE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_ORCHESTRATOR,D_FBL_VERIFICATION,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_EX_CORE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_FBL_DETECTORS,D_FBL_VERIFICATION,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_OPS external_prod
```

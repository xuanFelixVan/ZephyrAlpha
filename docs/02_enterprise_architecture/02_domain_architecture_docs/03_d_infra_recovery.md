...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_GOVERNANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_ORCHESTRATOR,D_GOV_CODE_QUALITY,D_FBL_VERIFICATION,D_SECURITY,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOV_RULE external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_SECURITY,D_ORCHESTRATOR,D_INFRA_RUNTIME,D_POSITION,D_SHARED,D_FBL_DETECTORS,D_OPS,D_GOV_REPAIR external_prod
```

...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_GOV_RULE,D_GOV_KB,D_OPS,D_FEEDBACK_LOOP,D_GOV_AUDIT,D_INFRA_A2A external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_AUDIT,D_OPS external_prod
    class D_GOV_ENFORCEMENT,D_INFRASTRUCTURE,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_GOV_KB,D_GOV_RULE,D_OPS,D_GOV_AUDIT,D_FEEDBACK_LOOP external_prod

...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_RULE,D_GOV_KB,D_GOVERNANCE,D_OPS,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOVERNANCE,D_OPS external_prod

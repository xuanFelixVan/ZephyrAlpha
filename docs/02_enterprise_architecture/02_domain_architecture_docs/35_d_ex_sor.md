...
|:--:|---------|---------|:---:|:---:|
| 1 | src/zephyr/ex_sor/__init__.py | __init__.py | 设计态 / design |  |
| 2 | src/zephyr/ex_sor/_extensions/__init__.py | __init__.py | 设计态 / design |  |
| 3 | src/zephyr/ex_sor/api/__init__.py | __init__.py | 设计态 / design |  |
| 4 | src/zephyr/ex_sor/core/__init__.py | __init__.py | 设计态 / design |  |
| 5 | src/zephyr/ex_sor/infrastructure/__init__.py | __init__.py | 设计态 / design |  |
| 6 | src/zephyr/ex_sor/models/__init__.py | __init__.py | 设计态 / design |  |
| 7 | src/zephyr/ex_sor/services/__init__.py | __init__.py | 设计态 / design |  |
...
graph TD
    subgraph D_EX_SOR["D_EX_SOR 执行路由"]
        src_zephyr_ex_sor_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ex_sor_extensions_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ex_sor_api_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ex_sor_core_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ex_sor_infrastructure_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ex_sor_models_init_py["(设计态 / design) __init__.py"]
        src_zephyr_ex_sor_services_init_py["(设计态 / design) __init__.py"]
    end

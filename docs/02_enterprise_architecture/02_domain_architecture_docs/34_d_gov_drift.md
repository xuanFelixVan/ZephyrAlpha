...
graph TD
    ...
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime / runtime| D_GOV_AUDIT
    D_AUDITTEST["(原型态 / prototype) D_AUDITTEST"]
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime / runtime| D_AUDITTEST
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime / runtime| D_GOVERNANCE
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime / runtime| D_GOVERNANCE
    docs_03_modules_domain_governance_drift_detector_blueprint_md -.->|runtime / runtime| D_GOVERNANCE
    D_GOV_AUDIT -.->|runtime / runtime| docs_03_modules_domain_governance_drift_detector_blueprint_md
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_AUDITTEST external_design
```
...
| 6 | blueprint.md | → | D_GOVERNANCE 生命周期管理: blueprint.md | runtime / runtime |
| 7 | blueprint.md | → | D_GOV_AUDIT 审计追踪: blueprint.md | runtime / runtime |
...
| 6 | D_INFRA_TELEMETRY 可观测性: otel_instrumentation.py — 全链路 OTel (B12, DD... | → | blueprint.md | runtime / runtime |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 5 个外部域直接连接（出边 7 条 + 入边 6 条 = 13 条）。只显示直接连接的域，不展开具体节点。

...
flowchart TD
    ...
    src_zephyr_simulation_risk_simulator_py["风险模拟器<br/>仿真的风险模拟器<br/>（risk_simulator.py），风险模拟器<br/>（risk_simulator.py）相关功能的实现。<br/>⛔ 仿真域，设计已就绪，等待开发排期<br/>文件: simulation/risk_simulator.py<br/>(设计态 / design)"]
    src_zephyr_simulation_strategy_simulator_py["策略模拟器<br/>仿真的策略模拟器<br/>（strategy_simulator.py），策略模拟器<br/>（strategy_simulator.py）相关功能的实现。<br/>⛔ 仿真域，设计已就绪，等待开发排期<br/>文件: simulation/strategy_simulator.py<br/>(设计态 / design)"]
    ...
    src_zephyr_simulation_sharpe_calculator_fixer_py["夏普计算器修复器<br/>仿真包的sharpe_calculator_fixer模块<br/>⛔ 仿真域，设计已就绪，等待开发排期<br/>文件: simulation/sharpe_calculator_fixer.py<br/>(设计态 / design)"]

...
flowchart TD
    src_zephyr_simulation_implementations_default_experiment_pipeline_py["默认实验管线<br/>implementations包的默认实验管线模块<br/>default_experiment_pipeline<br/>文件: implementations/default_experiment_<br/>pipeline.py<br/>(生产态 / production)"]
    ...
    src_zephyr_simulation_pipeline_base_py["管线基类<br/>simulation包的管线基类模块<br/>pipeline_base<br/>文件: simulation/pipeline_base.py<br/>(生产态 / production)"]

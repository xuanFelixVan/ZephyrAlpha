...
|:--:|---------|---------|:---:|:---:|
| 1 | docs/02_enterprise_architecture/migration-registry.yaml | migration-registry.yaml | 生产态 / production |  |
| 2 | docs/03_modules/_cross_layer/database/business_data_categ... | business_data_categories.yaml | 生产态 / production |  |

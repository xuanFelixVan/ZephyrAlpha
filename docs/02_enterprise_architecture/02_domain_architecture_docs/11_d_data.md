...
flowchart TD
    ...
    schemas_categories_fundamental_cashflow_statement_py["fundamentalcashflow报表<br/>（现金流量表）DDL-as-Code（category_id:<br/>fundamental_cashflow_statement, calc_mode:<br/>preload）<br/>文件: categories<br/>/fundamental_cashflow_statement.py<br/>(生产态 / production)"]
    schemas_categories_fundamental_disclosure_plan_py["fundamentaldisclosure计划<br/>（披露计划）DDL-as-Code（category_id:<br/>fundamental_disclosure_plan, calc_mode:<br/>preload）<br/>文件: categories/fundamental_disclosure_plan.py<br/>(生产态 / production)"]
    ...
    schemas_categories_fundamental_income_statement_py["fundamentalincome报表<br/>（利润表）DDL-as-Code（category_id:<br/>fundamental_income_statement, calc_mode:<br/>preload）<br/>文件: categories/fundamental_income_statement.py<br/>(生产态 / production)"]
    ...
    schemas_categories_fundamental_industry_class_suppl_py["fundamentalindustry类suppl<br/>（补充行业分类）DDL-as-Code（category_id:<br/>fundamental_industry_class_suppl）<br/>文件: categories<br/>/fundamental_industry_class_suppl.py<br/>(生产态 / production)"]
    ...
    schemas_categories_fundamental_share_unlock_py["fundamental股票unlock<br/>（解除限售）DDL-as-Code（category_id:<br/>fundamental_share_unlock）<br/>文件: categories/fundamental_share_unlock.py<br/>(生产态 / production)"]
    schemas_categories_macro_edb_data_py["macroedb数据<br/>edb_data 表 DDL-as-Code（category_id:<br/>macro_edb_data, calc_mode: lazy）。<br/>文件: categories/macro_edb_data.py<br/>(生产态 / production)"]
    schemas_categories_macro_macro_data_py["macromacro数据<br/>macro_data 表 DDL-as-Code（category_id:<br/>macro_macro_data, calc_mode: lazy）。<br/>文件: categories/macro_macro_data.py<br/>(生产态 / production)"]
    schemas_categories_market_adj_factor_py["行情adj因子<br/>adj_factor 表 DDL-as-Code（category_id:<br/>market_adj_factor, calc_mode: lazy）。<br/>文件: categories/market_adj_factor.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_block_trade_py["行情块交易<br/>block_trade 表 DDL-as-Code（category_id:<br/>market_block_trade, calc_mode: lazy）。<br/>文件: categories/market_block_trade.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_cb_iv_py["行情cb隐含波动率<br/>convertible_bond_iv 表 DDL-as-Code<br/>（category_id: market_cb_iv, calc_mode:<br/>preload）。<br/>文件: categories/market_cb_iv.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_concept_board_constituent_py["行情conceptboardconstituent<br/>concept_board_constituent 表 DDL-as-Code<br/>（category_id:<br/>market_concept_board_constituent, calc_mode:<br/>preload）.<br/>文件: categories<br/>/market_concept_board_constituent.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_convertible_bond_list_py["行情convertiblebondlist<br/>convertible_bond_list 表 DDL-as-Code<br/>（category_id: market_convertible_bond_list,<br/>calc_mode: preload）.<br/>文件: categories/market_convertible_bond_list.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_etf_list_py["行情etf列表<br/>etf_list 表 DDL-as-Code（category_id:<br/>market_etf_list, calc_mode: preload）.<br/>文件: categories/market_etf_list.py<br/>(生产态 / production)"]
    schemas_categories_market_etf_nav_py["行情etfnav<br/>etf_nav 表 DDL-as-Code（category_id:<br/>market_etf_nav, calc_mode: lazy）。<br/>文件: categories/market_etf_nav.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_futures_term_py["行情futures期限<br/>futures_term_structure 表 DDL-as-Code<br/>（category_id: market_futures_term, calc_mode:<br/>preload）。<br/>文件: categories/market_futures_term.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_hk_kline_py["行情hkkline<br/>hk_kline 表 DDL-as-Code（category_id:<br/>market_hk_kline, calc_mode: lazy）。<br/>文件: categories/market_hk_kline.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_index_py["行情索引<br/>index_quote 表 DDL-as-Code（category_id:<br/>market_index_quote, calc_mode: replay）。<br/>文件: categories/market_index.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_index_list_py["行情索引列表<br/>index_list 表 DDL-as-Code（category_id:<br/>market_index_list, calc_mode: preload）.<br/>文件: categories/market_index_list.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_kline_15min_py["行情kline15min<br/>kline_15min 表 DDL-as-Code（category_id:<br/>market_kline_15min, calc_mode: lazy）。<br/>文件: categories/market_kline_15min.py<br/>(生产态 / production)"]
    schemas_categories_market_kline_1min_py["行情kline1min<br/>kline_1min 表 DDL-as-Code（category_id:<br/>market_kline_1min, calc_mode: lazy）。<br/>文件: categories/market_kline_1min.py<br/>(生产态 / production)"]
    schemas_categories_market_kline_30min_py["行情kline30min<br/>kline_30min 表 DDL-as-Code（category_id:<br/>market_kline_30min, calc_mode: lazy）。<br/>文件: categories/market_kline_30min.py<br/>(生产态 / production)"]
    schemas_categories_market_kline_5min_py["行情kline5min<br/>kline_5min 表 DDL-as-Code（category_id:<br/>market_kline_5min, calc_mode: lazy）。<br/>文件: categories/market_kline_5min.py<br/>(生产态 / production)"]
    schemas_categories_market_kline_60min_py["行情kline60min<br/>kline_60min 表 DDL-as-Code（category_id:<br/>market_kline_60min, calc_mode: lazy）。<br/>文件: categories/market_kline_60min.py<br/>(生产态 / production)"]
    schemas_categories_market_kline_cb_py["行情klinecb<br/>kline_cb 表 DDL-as-Code（category_id:<br/>market_kline_cb, calc_mode: lazy）。<br/>文件: categories/market_kline_cb.py<br/>(生产态 / production)"]
    schemas_categories_market_kline_daily_py["行情klinedaily<br/>kline_daily 表 DDL-as-Code（category_id:<br/>market_kline_daily, calc_mode: preload）。<br/>文件: categories/market_kline_daily.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_kline_index_py["行情kline索引<br/>kline_index 表 DDL-as-Code（category_id:<br/>market_kline_index, calc_mode: lazy）。<br/>文件: categories/market_kline_index.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_kline_sector_intraday_py["行情klinesectorintraday<br/>kline_sector_intraday 表 DDL-as-Code<br/>（category_id: market_kline_sector_intraday,<br/>calc_mode: lazy）。<br/>文件: categories/market_kline_sector_intraday.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_l2_tick_py["行情l2逐笔<br/>l2_tick 表 DDL-as-Code（category_id:<br/>market_l2_tick, calc_mode: replay）。<br/>文件: categories/market_l2_tick.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_lof_list_py["行情lof列表<br/>lof_list 表 DDL-as-Code（category_id:<br/>market_lof_list, calc_mode: preload）.<br/>文件: categories/market_lof_list.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_money_flow_py["行情money流程<br/>money_flow 表 DDL-as-Code（category_id:<br/>market_money_flow, calc_mode: lazy）。<br/>文件: categories/market_money_flow.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_sector_list_py["行情板块列表<br/>sector_list 表 DDL-as-Code（category_id:<br/>market_sector_list, calc_mode: none）。<br/>文件: categories/market_sector_list.py<br/>(生产态 / production)"]
    schemas_categories_market_sector_meta_py["行情板块元<br/>sector_meta 表 DDL-as-Code（category_id:<br/>market_sector_meta, calc_mode: none）。<br/>文件: categories/market_sector_meta.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_stock_list_py["行情股票列表<br/>stock_list 表 DDL-as-Code（category_id:<br/>market_stock_list, calc_mode: preload）。<br/>文件: categories/market_stock_list.py<br/>(生产态 / production)"]
    schemas_categories_market_tick_py["行情逐笔<br/>tick_data 表 DDL-as-Code（category_id:<br/>market_tick, calc_mode: replay）。<br/>文件: categories/market_tick.py<br/>(生产态 / production)"]
    ...
    schemas_categories_market_us_index_py["行情us索引<br/>us_index 表 DDL-as-Code（category_id:<br/>market_us_index, calc_mode: lazy）。<br/>文件: categories/market_us_index.py<br/>(生产态 / production)"]
    scripts_ch_data_inventory_py["全库数据盘点：逐表审计行数/日期范围/空表<br/>/缺失日期/引擎/大小。<br/>ch包的data_inventory模块<br/>_data_inventory<br/>文件: ch/_data_inventory.py<br/>(生产态 / production)"]
    scripts_ch_recovery_drill_py["恢复演练：轮询备份完成 → 恢复小表到临时库 →<br/>行数校验 → 清理。<br/>ch包的recovery_drill模块<br/>_recovery_drill<br/>文件: ch/_recovery_drill.py<br/>(生产态 / production)"]
    ...
    scripts_ch_lint_symbol_convention_py["Symbol 约定 lint 门禁（TRAE-082 GATE-SYMBOL-C<br/>ONVENTION）<br/>lint_symbol_convention<br/>文件: ch/lint_symbol_convention.py<br/>(生产态 / production)"]
    ...
    scripts_ops_verify_alert_channels_py["告警通道端到端验证<br/>（B2，#ARCH-CH-023，2026-07-25）。<br/>运维包的verify_alert_channels模块<br/>文件: ops/verify_alert_channels.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_redundant_source_init_py["数据源冗余与热切换模块（MOD-L00-005）。<br/>管理data.redundant_source子包的加载和懒导入<br/>文件: redundant_source/__init__.py<br/>(生产态 / production)"]
    src_zephyr_data_satellite_geospatial_engine_init_py["data/satellite_geospatial_engine 包入口<br/>包入口。D_DATA Data Source<br/>文件: satellite_geospatial_engine/__init__.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_wal_codec_init_py["WAL 段编解码模块（MOD-L00-006）。<br/>管理data.wal_codec子包的加载和懒导入<br/>文件: wal_codec/__init__.py<br/>(生产态 / production)"]
    tests_data_test_market_quality_validator_py["#ARCH-CH-021 P0-4:<br/>写入路径异常值校验器四门禁测试。<br/>数据包的test_market_quality_validator模块<br/>文件: data/test_market_quality_validator.py<br/>(生产态 / production)"]
    tests_data_test_pit_query_py["#ARCH-CH-021 P0-5: 财报 PIT 查询能力测试。<br/>数据包的test_pit_query模块<br/>文件: data/test_pit_query.py<br/>(生产态 / production)"]
    ...
    schemas_categories_cross_validation_log_py ~~~ schemas_categories_fundamental_cashflow_statement_py
    ...
    src_zephyr_data_sector_ranking_engine_py["880xxx 板块动态排名引擎——5因子复合排名调整99只推<br/>送池。<br/>数据包的sector_ranking_engine模块<br/>文件: data/sector_ranking_engine.py<br/>(生产态 / production)"]
    ...
    schemas_categories_fundamental_balance_sheet_py ~~~ scripts_ch_apply_exchange_columns_py
    ...
    schemas_categories_fundamental_analyst_forecast_py["fundamentalanalyst预测<br/>（分析师预测）DDL-as-Code（category_id:<br/>fundamental_analyst_forecast, calc_mode:<br/>preload）<br/>文件: categories/fundamental_analyst_forecast.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_progress_store_py["统一进度存储（MOD-L00-004 §7）。<br/>数据包的progress_store模块<br/>文件: data/progress_store.py<br/>(生产态 / production)"]
    src_zephyr_data_scheduler_py["数据源调度编排层（MOD-L00-004 §6）。<br/>数据包的scheduler模块<br/>文件: data/scheduler.py<br/>(生产态 / production)"]
    src_zephyr_data_speed_tester_py["数据源测速器（MOD-L00-004 §8.5）。<br/>数据包的speed_tester模块<br/>文件: data/speed_tester.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_backfill_checker_py["L10 周末补下载检测器——检测过去N天缺失数据并精准<br/>补下载。<br/>数据包的backfill_checker模块<br/>文件: data/backfill_checker.py<br/>(生产态 / production)"]
    src_zephyr_data_buffered_writer_py["批量聚合写入器（MOD-L00-004 §18.3 裁定<br/>#ARCH-CH-003<br/>数据包的buffered_writer模块<br/>文件: data/buffered_writer.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_error_classifier_py["数据源错误分类器——根据错误字符串判断可恢复性。<br/>数据包的error_classifier模块<br/>文件: data/error_classifier.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_integrity_checker_py["数据完整性巡检器——每天盘后检测全表当日数据是否达<br/>标。<br/>数据包的integrity_checker模块<br/>文件: data/integrity_checker.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_metrics_py["可观测性指标采集（MOD-L00-004 §11）。<br/>数据包的metrics模块<br/>文件: data/metrics.py<br/>(生产态 / production)"]
    src_zephyr_data_news_dedup_py["新闻数据去重模块（MOD-L00-004 §4.3）。<br/>数据包的news_dedup模块<br/>文件: data/news_dedup.py<br/>(生产态 / production)"]
    ...
    src_zephyr_data_trading_calendar_py["A 股交易日历守卫（MOD-L00-004）。<br/>数据包的trading_calendar模块<br/>文件: data/trading_calendar.py<br/>(生产态 / production)"]
    ...
    schemas_categories_fundamental_cashflow_statement_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_fundamental_industry_class_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_macro_macro_data_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_macro_edb_data_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_adj_factor_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_block_trade_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_block_trade_detail_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_daily_valuation_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_dragon_tiger_seat_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_dragon_tiger_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_futures_kline_qmt_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_etf_nav_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_hk_connect_flow_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_hk_kline_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_kline_15min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_kline_30min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_5min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_1min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_index_weight_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_index_meta_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_60min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_cb_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_daily_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_etf_1min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_etf_30min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_etf_15min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_daily_hfq_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_etf_60min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_futures_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_hk_daily_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_lof_15min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_etf_5min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_lof_60min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_index_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_lof_5min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_lof_1min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_monthly_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_monthly_hfq_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_lof_30min_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_sector_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_limit_up_down_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_weekly_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_sector_880_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_us_daily_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_weekly_hfq_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_lof_list_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_l2_tick_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_margin_trading_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_kline_sector_intraday_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_money_flow_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_option_greeks_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_option_kline_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_option_iv_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_realtime_snapshot_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_sector_list_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    schemas_categories_market_stock_indicator_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
    ...
    schemas_categories_market_us_index_py -->|config_depends / config_depends| schemas_categories_fundamental_balance_sheet_py
...
| 23 | D_ML_TRAIN 训练: 训练管线 (training_pipeline/) | → | pit查询 / pit_query (data/pit_query.py) | data / data |

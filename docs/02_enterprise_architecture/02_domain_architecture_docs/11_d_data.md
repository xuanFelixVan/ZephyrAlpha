...
flowchart TD
    ...
    schemas_categories_fundamental_income_statement_py ~~~ schemas_categories_fundamental_industry_class_suppl_py
    ...
    schemas_categories_fundamental_industry_class_py ~~~ src_zephyr_data_ch_config_py
    ...
    schemas_categories_fundamental_analyst_forecast_py -->|config_depends / config_depends| schemas_categories_fundamental_industry_class_py
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_MKT_DATA,D_FACTOR,D_BACKTEST,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_INFRA_RUNTIME external_prod

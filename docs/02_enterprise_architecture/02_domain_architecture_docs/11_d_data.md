...
flowchart TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_MKT_DATA,D_INFRA_OPS,D_BACKTEST,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_SCRIPTS,D_FACTOR,D_INFRA_RUNTIME external_prod

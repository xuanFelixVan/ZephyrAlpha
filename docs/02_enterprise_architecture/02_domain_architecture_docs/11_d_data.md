...
flowchart TD
    ...
    schemas_categories_market_concept_board_constituent_py["行情conceptboardconstituent<br/>concept_board_constituent 表 DDL-as-Code<br/>（category_id:<br/>market_concept_board_constituent, calc_mode: pr<br/>文件: categories<br/>/market_concept_board_constituent.py<br/>(生产态 / production)"]

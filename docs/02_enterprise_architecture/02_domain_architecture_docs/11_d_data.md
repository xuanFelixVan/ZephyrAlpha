...
flowchart TD
    ...
    schemas_categories_market_hog_futures_core_py -->|config_depends / config_depends| schemas_categories_fundamental_cashflow_statement_py
    ...
    schemas_categories_market_hog_province_spot_py -->|config_depends / config_depends| schemas_categories_fundamental_cashflow_statement_py
    schemas_categories_market_hog_spot_index_py -->|config_depends / config_depends| schemas_categories_fundamental_cashflow_statement_py
    ...
    schemas_categories_market_kline_etf_daily_py -->|config_depends / config_depends| schemas_categories_fundamental_cashflow_statement_py
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_MKT_DATA,D_INFRA_RUNTIME,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_GOV_SCRIPTS,D_FACTOR external_prod

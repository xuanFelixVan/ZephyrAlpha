...
flowchart TD
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_MKT_DATA,D_INFRA_OPS,D_INFRA_RUNTIME,D_FACTOR,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_BACKTEST external_prod

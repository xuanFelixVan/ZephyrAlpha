...
flowchart TD
    ...
    schemas_categories_fundamental_cashflow_statement_py -->|config_depends / config_depends| schemas_categories_fundamental_industry_class_py
    ...
    class D_SHARED,D_GOV_ENFORCEMENT,D_MKT_DATA,D_BACKTEST,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_CODE_QUALITY external_prod

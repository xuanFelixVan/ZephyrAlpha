...
flowchart TD
    ...
    scripts_ops_ch_health_probe_py -->|导入依赖 / import_depends| D_SHARED
    ...
    class D_GOV_ENFORCEMENT,D_SHARED,D_GOV_CODE_QUALITY,D_MKT_DATA,D_FACTOR,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```

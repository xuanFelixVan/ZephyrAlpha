...
flowchart TD
    ...
    src_zephyr_ex_core_aggregate_root_manager_py -->|导入依赖 / import_depends| D_INFRASTRUCTURE
    ...
    class D_PF_CORE,D_BACKTEST,D_TRADING,D_GOVERNANCE,D_RISK,D_SHARED,D_INFRASTRUCTURE,D_EX_SOR,D_REPORTING external_prod

...
flowchart TD
    ...
    src_zephyr_ex_core_aggregate_root_manager_py -->|导入依赖 / import_depends| D_INFRASTRUCTURE
    src_zephyr_ex_core_aggregate_root_manager_py -->|导入依赖 / import_depends| D_INFRASTRUCTURE
    src_zephyr_ex_core_multi_contract_adapter_py -->|导入依赖 / import_depends| D_SHARED
    ...
    class D_BACKTEST,D_TRADING,D_RISK,D_SHARED,D_INFRASTRUCTURE,D_EX_SOR,D_REPORTING external_prod

...
flowchart TD
    ...
    class D_TRADING,D_PF_CORE,D_BACKTEST,D_GOVERNANCE,D_RISK external_prod
    class D_SELL_DECISION,D_REPORTING,D_EX_SOR external_design
```
...
| 42 | 交易会话 / trading_session (ex_core/trading_session.py) | → | D_TRADING 交易运营: 经纪人接口 / D_EXECUTION_CORE — BrokerInterface (trading... | 导入依赖 / import_depends |

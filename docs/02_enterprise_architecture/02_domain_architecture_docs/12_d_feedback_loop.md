...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_trading_feedback_loop_evolution_knowledge_distillation_py
    D_AUDITTEST["(原型态 / prototype) D_AUDITTEST"]
    ...
    class D_SHARED,D_GOV_DOCS,D_AUDITTEST external_design
```
...
| 348 | D_GOV_DOCS 架构文档治理: blueprint.md | → | feedback_collector.py | runtime / runtime |
| 349 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Adaptive Parameter Tuning — v0.37.0 R452 (adap... | runtime / runtime |
| 350 | D_GOV_DOCS 架构文档治理: blueprint.md | → | Knowledge Distillation — v0.6.0 R52 (knowledge... | runtime / runtime |

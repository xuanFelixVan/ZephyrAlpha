...
# 30_d_fundamental_signal / fundamental_signal
...
| 域名称 | fundamental_signal | Domain Name | fundamental_signal |
...
graph TD
    ...
    src_zephyr_signal_fundamental_capital_capital_allocator_py -.->|contract| D_FACTOR
    ...
    class D_FACTOR,D_AUDITTEST,D_GOVERNANCE external_design
```

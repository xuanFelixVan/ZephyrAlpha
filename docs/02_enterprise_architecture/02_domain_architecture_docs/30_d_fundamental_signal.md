...
graph TD
    ...
    src_zephyr_signal_fundamental_pipeline_py -->|导入依赖 / import_depends| D_TRADING
    src_zephyr_signal_fundamental_capital_capital_allocator_py -.->|contract / contract| D_FACTOR
...
|:--:|---------|:--:|---------|---------|
| 1 | D_SIGNAL — Capital Allocator（兼容 re-export s... | → | D_FACTOR 因子: D_FACTOR — Momentum Factor (momentum_factor.py) | contract / contract |

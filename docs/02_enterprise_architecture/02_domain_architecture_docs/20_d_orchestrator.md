...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_SECURITY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_TRADING,D_GOV_SCRIPTS,D_KNOWLEDGE,D_GOVERNANCE external_design
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 21 个，2 条域内依赖）。

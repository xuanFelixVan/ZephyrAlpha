...
# 38_d_gov_docs / architecture_docs / 架构文档治理 / Architecture Docs Governance
...
graph TD
    ...
    D_GOV_CODE_QUALITY -.->|contract / contract| docs_03_modules_domain_governance_governance_automation_blueprint_md
    D_GOV_CODE_QUALITY -.->|contract / contract| docs_03_modules_cross_layer_context_engine_blueprint_md
    D_GOV_CODE_QUALITY -.->|runtime / runtime| docs_03_modules_cross_layer_feedback_loop_blueprint_md
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_AUDITTEST,D_SHARED external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_SHARED,D_AUDITTEST,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
| 5 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: poisoning_monitor.py — Embed 污染检测 (DD97, T... | contract / contract |
| 6 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: file_autoregister.py | contract / contract |
| 7 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: otel_instrumentation.py — 全链路 OTel (B12, DD... | runtime / runtime |
| 8 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Saga Compensator — v0.3.0 R19b (saga_compensat... | runtime / runtime |
| 9 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback_collector.py | runtime / runtime |
| 10 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Adaptive Parameter Tuning — v0.37.0 R452 (adap... | runtime / runtime |
| 11 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Knowledge Distillation — v0.6.0 R52 (knowledge... | runtime / runtime |
| 12 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |
| 13 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | runtime / runtime |
| 14 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | data / data |
| 15 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | runtime / runtime |
...
| 18 | blueprint.md | → | D_GOV_AUDIT 审计追踪: 三元对齐检测：蓝图声明清单 vs 磁盘实际文件 vs i... | runtime / runtime |
| 19 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: module_id_consistency_gate.py — module_id 三声... | runtime / runtime |
| 20 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | runtime / runtime |
| 21 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: module_id_consistency_gate.py — module_id 三声... | runtime / runtime |
| 22 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: module_id_consistency_gate.py — module_id 三声... | contract / contract |
| 23 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: module_id_consistency_gate.py — module_id 三声... | runtime / runtime |
...
| 29 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: Re-export shim — ComplianceRule 真源已合并至 z... | runtime / runtime |
| 30 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | contract / contract |
| 31 | blueprint.md | → | D_GOV_KB 知识库治理: G4 Activate 门禁 — 人工激活（T-2-13-D） (activ... | runtime / runtime |
| 32 | blueprint.md | → | D_GOV_OPS_RESILIENCE 运维弹性治理: __init__.py | runtime / runtime |
| 33 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | runtime / runtime |
| 34 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | contract / contract |
| 35 | blueprint.md | → | D_SECURITY 对抗验证: __init__.py | runtime / runtime |
| 36 | blueprint.md | → | D_SECURITY 对抗验证: __init__.py | runtime / runtime |
| 37 | blueprint.md | → | D_SECURITY 对抗验证: PathGuard — 路径守卫. (path_guard.py) | contract / contract |
| 38 | blueprint.md | → | D_SECURITY 对抗验证: PathGuard — 路径守卫. (path_guard.py) | runtime / runtime |
| 39 | blueprint.md | → | D_SHARED 共享服务: capability.py —— Re-export wrapper -> canonic... | runtime / runtime |
...
| 3 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | runtime / runtime |
| 4 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | contract / contract |
| 5 | D_AUTONOMY_CORE 自治核心: otel_instrumentation.py — 全链路 OTel (B12, DD... | → | blueprint.md | runtime / runtime |
| 6 | D_AUTONOMY_CORE 自治核心: otel_instrumentation.py — 全链路 OTel (B12, DD... | → | blueprint.md | runtime / runtime |
| 7 | D_AUTONOMY_CORE 自治核心: otel_instrumentation.py — 全链路 OTel (B12, DD... | → | blueprint.md | runtime / runtime |
...
| 13 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 14 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | runtime / runtime |
| 15 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 16 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 14 个外部域直接连接（出边 39 条 + 入边 16 条 = 55 条）。只显示直接连接的域，不展开具体节点。

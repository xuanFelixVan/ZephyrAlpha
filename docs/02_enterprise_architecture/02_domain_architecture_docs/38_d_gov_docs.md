...
graph TD
    ...
    D_COMPLIANCE -.->|runtime / runtime| docs_03_modules_cross_layer_database_blueprint_md
    ...
    D_GOVERNANCE -.->|data / data| docs_03_modules_cross_layer_database_blueprint_md
    classDef production fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#000
    classDef design fill:#fff3e0,stroke:#e65100,stroke-width:2px,color:#000,stroke-dasharray: 5 5
    classDef external_prod fill:#e8f5e9,stroke:#1b5e20,stroke-width:1px,color:#000
    classDef external_design fill:#fce4ec,stroke:#880e4f,stroke-width:1px,color:#000,stroke-dasharray: 5 5
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_GOV_DRIFT,D_INFRA_A2A,D_GOV_CODE_QUALITY,D_COMPLIANCE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_COMPLIANCE,D_GOV_CODE_QUALITY,D_INFRA_A2A,D_GOV_DRIFT,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_AUDIT external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: trigger_router.py | contract / contract |
...
| 15 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | runtime / runtime |
...
| 2 | D_AUTONOMY_CORE 自治核心: trigger_router.py | → | blueprint.md | data / data |
| 3 | D_AUTONOMY_CORE 自治核心: trigger_router.py | → | blueprint.md | runtime / runtime |
| 4 | D_AUTONOMY_CORE 自治核心: trigger_router.py | → | blueprint.md | runtime / runtime |
| 5 | D_AUTONOMY_CORE 自治核心: trigger_router.py | → | blueprint.md | contract / contract |
| 6 | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | → | blueprint.md | runtime / runtime |
| 7 | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | → | blueprint.md | data / data |
| 8 | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | → | blueprint.md | contract / contract |
| 9 | D_AUTONOMY_CORE 自治核心: test_auto_bootstrap.py | → | blueprint.md | runtime / runtime |
| 10 | D_COMPLIANCE 合规: Audit Trail — MOD-INF-020 (__init__.py) | → | blueprint.md | runtime / runtime |
| 11 | D_COMPLIANCE 合规: Audit Trail — MOD-INF-020 (__init__.py) | → | blueprint.md | contract / contract |
...
| 15 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | blueprint.md | runtime / runtime |
| 16 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | blueprint.md | data / data |
| 17 | D_GOVERNANCE 生命周期管理: model_provider_data.py | → | blueprint.md | data / data |
| 18 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 19 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 20 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | data / data |
| 21 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 22 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 23 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
| 24 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
| 25 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 13 个外部域直接连接（出边 23 条 + 入边 25 条 = 48 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    docs_03_modules_cross_layer_red_blue_validator_blueprint_md -.->|runtime / runtime| D_GOV_ENFORCEMENT
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_GOV_DRIFT,D_AUDITTEST,D_GOV_CODE_QUALITY,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_SHARED,D_AUTONOMY_CORE,D_FRONTEND external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_SHARED,D_AUDITTEST,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_AUDIT,D_AUTONOMY_CORE,D_FRONTEND external_design
```
...
| 8 | blueprint.md | → | D_AUTONOMY_CORE 自治核心: file_autoregister.py | contract / contract |
| 9 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Saga Compensator — v0.3.0 R19b (saga_compensat... | runtime / runtime |
| 10 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: auto_evolution.py | runtime / runtime |
| 11 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: feedback_collector.py | runtime / runtime |
| 12 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: Adaptive Parameter Tuning — v0.37.0 R452 (adap... | runtime / runtime |
| 13 | blueprint.md | → | D_FEEDBACK_LOOP 反馈循环引擎: TOCTOU Guard — v0.15.0 R207 (toctou_guard.py) | runtime / runtime |
| 14 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | runtime / runtime |
| 15 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | data / data |
| 16 | blueprint.md | → | D_GOVERNANCE 生命周期管理: model_provider_data.py | runtime / runtime |
| 17 | blueprint.md | → | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | runtime / runtime |
| 18 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Batch2 治理层契约 — 15条 Pydantic v2 Schema（P... | runtime / runtime |
| 19 | blueprint.md | → | D_GOV_AUDIT 审计追踪: 三元对齐检测：蓝图声明清单 vs 磁盘实际文件 vs i... | runtime / runtime |
| 20 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: file_copy_gate.py — 新增 .py 文件复制检测阻断.... | runtime / runtime |
| 21 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | runtime / runtime |
...
| 28 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | contract / contract |
...
| 31 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: GateEventAdapter — GateRepo 事件适配器（DW-000... | runtime / runtime |
| 32 | blueprint.md | → | D_GOV_KB 知识库治理: G4 Activate 门禁 — 人工激活（T-2-13-D） (activ... | runtime / runtime |
| 33 | blueprint.md | → | D_GOV_OPS_RESILIENCE 运维弹性治理: __init__.py | runtime / runtime |
| 34 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | runtime / runtime |
| 35 | blueprint.md | → | D_INTEGRATION 管线路由: MCP Prompt 模板提供者（MOD-INF-013 Phase 6 — .... | contract / contract |
| 36 | blueprint.md | → | D_SECURITY 对抗验证: __init__.py | runtime / runtime |
| 37 | blueprint.md | → | D_SECURITY 对抗验证: __init__.py | runtime / runtime |
...
| 2 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | blueprint.md | runtime / runtime |
| 3 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | runtime / runtime |
| 4 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | runtime / runtime |
| 5 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | contract / contract |
| 6 | D_FRONTEND 前端:  | → | blueprint.md | runtime / runtime |
...
| 9 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 10 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | runtime / runtime |
| 11 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 12 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 14 个外部域直接连接（出边 39 条 + 入边 12 条 = 51 条）。只显示直接连接的域，不展开具体节点。

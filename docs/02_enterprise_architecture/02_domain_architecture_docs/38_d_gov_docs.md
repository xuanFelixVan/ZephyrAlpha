...
graph TD
    ...
    D_GOV_CODE_QUALITY -.->|contract / contract| docs_03_modules_cross_layer_shared_core_blueprint_md
    D_GOV_CODE_QUALITY -.->|data / data| docs_03_modules_cross_layer_database_blueprint_md
    ...
    class D_INTEGRATION,D_SECURITY,D_GOVERNANCE,D_GOV_DRIFT,D_AUDITTEST,D_GOV_CODE_QUALITY,D_GOV_ENFORCEMENT,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_AUDIT external_design
```
...
> 仅展示蓝图阶段、代码未写的设计态模块（共 26 个，10 条域内依赖）。
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_ENFORCEMENT,D_GOV_CODE_QUALITY,D_AUDITTEST,D_GOV_DRIFT,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
|:--:|---------|:--:|---------|---------|
| 1 | blueprint.md | → | D_AUDITTEST 审计测试套件: test_a2a_check.py | contract / contract |
| 2 | blueprint.md | → | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | runtime / runtime |
| 3 | blueprint.md | → | D_AUDITTEST 审计测试套件: test_a2a_check.py | runtime / runtime |
| 4 | blueprint.md | → | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | runtime / runtime |
...
| 11 | blueprint.md | → | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | contract / contract |
...
| 16 | blueprint.md | → | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | runtime / runtime |
...
| 19 | blueprint.md | → | D_GOV_DRIFT 漂移检测: blueprint.md | contract / contract |
| 20 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | contract / contract |
| 21 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | contract / contract |
| 22 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | contract / contract |
| 23 | blueprint.md | → | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | runtime / runtime |
| 24 | blueprint.md | → | D_INFRA_RUNTIME 运行时集成: blueprint.md | runtime / runtime |
| 25 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | runtime / runtime |
| 26 | blueprint.md | → | D_INTEGRATION 管线路由: Handoff 自动加载器——从 handoff 包恢复 AI sess... | contract / contract |
| 27 | blueprint.md | → | D_ML_TRAIN 训练: blueprint.md | data / data |
| 28 | blueprint.md | → | D_SECURITY 对抗验证: LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
...
| 2 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | blueprint.md | data / data |
| 3 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | blueprint.md | contract / contract |
| 4 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | blueprint.md | runtime / runtime |
| 5 | D_AUDITTEST 审计测试套件: test_auto_bootstrap.py | → | blueprint.md | runtime / runtime |
| 6 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | runtime / runtime |
| 7 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | data / data |
| 8 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | runtime / runtime |
| 9 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | runtime / runtime |
| 10 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | runtime / runtime |
| 11 | D_AUTONOMY_CORE 自治核心: file_autoregister.py | → | blueprint.md | contract / contract |
| 12 | D_FRONTEND 前端:  | → | blueprint.md | runtime / runtime |
| 13 | D_GOVERNANCE 生命周期管理: Construction Verifier — 施工验证器: 任务卡完成... | → | blueprint.md | contract / contract |
| 14 | D_GOVERNANCE 生命周期管理: post_sync_validator — post_sync_standard 命令.... | → | blueprint.md | contract / contract |
| 15 | D_GOV_AUDIT 审计追踪: blueprint.md | → | blueprint.md | runtime / runtime |
| 16 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 17 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | data / data |
| 18 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 19 | D_GOV_CODE_QUALITY 代码质量治理: 金丝雀工厂——生成已知oracle 文件 用于引擎检出+... | → | blueprint.md | contract / contract |
| 20 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
| 21 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
| 22 | D_GOV_DRIFT 漂移检测: blueprint.md | → | blueprint.md | runtime / runtime |
| 23 | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | → | blueprint.md | runtime / runtime |
| 24 | D_GOV_ENFORCEMENT 规则执行: Audit Trail — MOD-INF-020 (__init__.py) | → | blueprint.md | contract / contract |

### 跨域依赖图 / Cross-domain Dependency Diagram

> 本域与 14 个外部域直接连接（出边 29 条 + 入边 24 条 = 53 条）。只显示直接连接的域，不展开具体节点。

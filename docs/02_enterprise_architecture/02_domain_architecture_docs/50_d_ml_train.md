...
| 8 | D_INTELLIGENCE 上下文管理: D_ML_TRAIN — ML Training Domain (__init__.py) | → | D_ML_TRAIN — ML Training Base (trainer_base.py) | config_depends / config_depends |
...
| 10 | D_ML_SERVE 推理: __init__.py | → | D_ML_TRAIN — ML Training Base (trainer_base.py) | runtime / runtime |

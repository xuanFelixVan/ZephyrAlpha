...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_AUDIT,D_AUTONOMY_PERM,D_COMPLIANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOVERNANCE,D_AUTONOMY_PERM,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
    class D_GOV_AUDIT,D_AUTONOMY_PERM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_GOV_KB,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
...
> 本域与 22 个外部域直接连接（出边 139 条 + 入边 248 条 = 387 条）。只显示直接连接的域，不展开具体节点。

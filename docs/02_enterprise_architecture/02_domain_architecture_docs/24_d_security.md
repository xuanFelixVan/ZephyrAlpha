...
graph TD
    ...
    class D_INFRA_A2A,D_AUTONOMY_PERM,D_GOVERNANCE,D_COMPLIANCE,D_GOV_AUDIT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    D_GOVERNANCE["(原型态 / prototype) D_GOVERNANCE"]
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_security_access_control_detectors_context_drift_detector_py
    ...
    class D_AUTONOMY_PERM,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
    class D_GOV_DRIFT,D_GOV_AUDIT,D_GOV_SCRIPTS,D_GOVERNANCE,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_SHARED,D_INTEGRATION,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_INTEGRATION,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
    class D_SECURITY_LLM,D_INFRA_A2A,D_AUTONOMY_PERM external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
    class D_COMPLIANCE,D_GOVERNANCE,D_SECURITY_LLM external_design
```

...
graph TD
    ...
    class D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_access_control_exceptions_py
    D_GOV_DRIFT["(设计态 / design) D_GOV_DRIFT"]
    D_GOV_DRIFT -.->|runtime / runtime| src_zephyr_security_access_control_exceptions_py
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_access_control_exceptions_py
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_access_control_exceptions_py
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_GOV_AUDIT,D_GOV_DOCS,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
...
| 17 | D_GOV_DOCS 架构文档治理: blueprint.md | → | AgentRbac 异常类型. (exceptions.py) | contract / contract |
| 18 | D_GOV_DOCS 架构文档治理: blueprint.md | → | LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 19 | D_GOV_DOCS 架构文档治理: blueprint.md | → | AgentRbac 异常类型. (exceptions.py) | runtime / runtime |
| 20 | D_GOV_DOCS 架构文档治理: blueprint.md | → | LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
| 21 | D_GOV_DOCS 架构文档治理: blueprint.md | → | AgentRbac 异常类型. (exceptions.py) | runtime / runtime |
| 22 | D_GOV_DOCS 架构文档治理: blueprint.md | → | LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 23 | D_GOV_DRIFT 漂移检测: blueprint.md | → | AgentRbac 异常类型. (exceptions.py) | runtime / runtime |

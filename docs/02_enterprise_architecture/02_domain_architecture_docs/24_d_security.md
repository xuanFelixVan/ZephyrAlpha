...
graph TD
    ...
    class D_GOV_SCRIPTS,D_COMPLIANCE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_AUTONOMY_PERM external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_AUTONOMY_PERM,D_GOVERNANCE,D_INTELLIGENCE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_INFRA_RUNTIME,D_SHARED,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_PERM,D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_INTEGRATION,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_RULE,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_AUTONOMY_PERM,D_GOV_SCRIPTS,D_COMPLIANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INTELLIGENCE,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod

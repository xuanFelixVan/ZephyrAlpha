...
# 24_d_security / 对抗验证 / Adversarial Validation
...
| 41 | src/zephyr/security/access_control/detectors/shell_dialec... | ShellDialectDetector — Shell 方言检测器. | 生产态 / production | [MOD-INF-018](../../03_modules/_domain_autonomy_core/agent_role_based_access_control/blueprint.md) |
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_GOVERNANCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_RULE,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod

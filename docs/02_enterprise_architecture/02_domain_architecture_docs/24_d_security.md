...
graph TD
    ...
    class D_COMPLIANCE,D_AUTONOMY_PERM,D_INFRA_A2A,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_AUDIT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    src_zephyr_security_access_control_detectors_init_py -.->|config_depends / config_depends| src_zephyr_security_access_control_detectors_cross_session_detector_py
    ...
    class D_GOV_SCRIPTS,D_AUTONOMY_PERM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_PERM,D_SECURITY_LLM,D_GOV_SCRIPTS,D_GOVERNANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
    class D_SECURITY_LLM,D_GOV_SCRIPTS,D_AUTONOMY_PERM external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_INTELLIGENCE,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod

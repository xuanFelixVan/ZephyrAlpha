...
graph TD
    ...
    class D_SHARED,D_AUTONOMY_CORE,D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RUNTIME,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_AUDIT,D_GOV_SCRIPTS,D_COMPLIANCE,D_GOV_ENFORCEMENT external_design
```

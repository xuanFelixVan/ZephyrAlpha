...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOV_SCRIPTS,D_AUTONOMY_PERM,D_SECURITY_LLM,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_ORCHESTRATOR,D_FEEDBACK_LOOP,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR external_prod
    class D_GOVERNANCE,D_SECURITY_LLM,D_AUTONOMY_CORE,D_AUTONOMY_PERM,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod

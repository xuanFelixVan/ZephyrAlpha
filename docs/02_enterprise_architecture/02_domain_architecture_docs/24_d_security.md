...
graph TD
    ...
    class D_COMPLIANCE,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_AUTONOMY_PERM,D_GOVERNANCE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_KB,D_SHARED,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SECURITY_LLM,D_AUTONOMY_PERM,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_KB,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod

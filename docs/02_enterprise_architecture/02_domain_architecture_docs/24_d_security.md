...
graph TD
    ...
    class D_COMPLIANCE,D_AUTONOMY_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOVERNANCE,D_INFRA_RECOVERY,D_AUTONOMY_PERM external_design
```
...
graph TD
    ...
    class D_ORCHESTRATOR,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_RULE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_INTEGRATION external_prod
    class D_GOV_AUDIT,D_SHARED,D_SECURITY_LLM,D_AUTONOMY_CORE,D_AUTONOMY_PERM,D_GOVERNANCE,D_COMPLIANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod

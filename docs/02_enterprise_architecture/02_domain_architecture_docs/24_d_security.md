...
graph TD
    ...
    class D_COMPLIANCE,D_INFRA_RECOVERY,D_AUTONOMY_PERM external_design
```
...
graph TD
    ...
    D_GOV_ENFORCEMENT -.->|测试依赖 / test_depends| src_zephyr_security_access_control_guard_layers_py
    D_AUTONOMY_PERM["(原型态 / prototype) D_AUTONOMY_PERM"]
    ...
    class D_GOV_ENFORCEMENT,D_AUTONOMY_PERM,D_GOVERNANCE,D_INTELLIGENCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    D_AUTONOMY_PERM -.->|测试依赖 / test_depends| src_zephyr_security_access_control_guards_input_guard_py
    D_AUTONOMY_PERM -.->|测试依赖 / test_depends| src_zephyr_security_access_control_intent_binder_py
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_ENFORCEMENT,D_AUTONOMY_PERM,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_GOV_KB,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod
    class D_SECURITY_LLM,D_COMPLIANCE external_design
```

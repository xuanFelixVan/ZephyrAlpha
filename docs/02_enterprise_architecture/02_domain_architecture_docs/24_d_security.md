...
graph TD
    ...
    class D_COMPLIANCE,D_AUTONOMY_PERM,D_INFRA_RECOVERY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    D_INFRASTRUCTURE -.->|测试依赖 / test_depends| src_zephyr_security_access_control_guards_abac_guard_py
    ...
    class D_AUTONOMY_PERM,D_GOVERNANCE,D_INFRASTRUCTURE,D_AUTONOMY_CORE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_SCRIPTS,D_AUTONOMY_PERM,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_SHARED,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOV_KB,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RUNTIME external_prod
    class D_AUTONOMY_PERM,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_KB,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
...
| 184 | D_INFRA_A2A A2A通信: test_a2a_check.py | → | Stub module: zephyr.security.access_control.a2a... | 测试依赖 / test_depends |
...
> 本域与 22 个外部域直接连接（出边 140 条 + 入边 247 条 = 387 条）。只显示直接连接的域，不展开具体节点。

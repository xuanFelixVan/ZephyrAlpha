...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_access_control_cross_cutting_py
    D_GOV_DRIFT -.->|runtime / runtime| src_zephyr_security_access_control_cross_cutting_py
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_access_control_cross_cutting_py
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_access_control_cross_cutting_py
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_layers_l6_data_flow_py
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_layers_l6_data_flow_py
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_llm_defense_llm_security_layers_l6_data_flow_py
    D_INTEGRATION["(生产态 / production) D_INTEGRATION"]
    ...
    class D_SHARED,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTEGRATION external_prod
    class D_SHARED,D_GOV_DOCS,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
    class D_GOV_DOCS,D_COMPLIANCE external_design
```
...
| 17 | D_GOV_DOCS 架构文档治理: blueprint.md | → | CrossCutting — 横切面权限组件. (cross_cutting.py) | contract / contract |
| 18 | D_GOV_DOCS 架构文档治理: blueprint.md | → | l6_data_flow.py | contract / contract |
| 19 | D_GOV_DOCS 架构文档治理: blueprint.md | → | CrossCutting — 横切面权限组件. (cross_cutting.py) | runtime / runtime |
| 20 | D_GOV_DOCS 架构文档治理: blueprint.md | → | l6_data_flow.py | runtime / runtime |
| 21 | D_GOV_DOCS 架构文档治理: blueprint.md | → | CrossCutting — 横切面权限组件. (cross_cutting.py) | runtime / runtime |
| 22 | D_GOV_DOCS 架构文档治理: blueprint.md | → | l6_data_flow.py | contract / contract |
| 23 | D_GOV_DRIFT 漂移检测: blueprint.md | → | CrossCutting — 横切面权限组件. (cross_cutting.py) | runtime / runtime |

...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_AUTONOMY_PERM,D_INFRA_RECOVERY,D_GOV_AUDIT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    src_zephyr_security_access_control_detectors_init_py -.->|config_depends / config_depends| src_zephyr_security_access_control_detectors_false_completion_detector_py
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_SCRIPTS,D_GOVERNANCE,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_GOV_ENFORCEMENT,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE external_prod
    class D_GOV_AUDIT,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_AUTONOMY_PERM external_design
```

...
graph TD
    ...
    class D_COMPLIANCE,D_AUTONOMY_PERM,D_GOV_SCRIPTS,D_INFRA_A2A,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_INTELLIGENCE,D_SHARED,D_INFRA_RUNTIME,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_SCRIPTS,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOV_RULE,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_INTEGRATION,D_FEEDBACK_LOOP,D_SHARED,D_INTELLIGENCE,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod

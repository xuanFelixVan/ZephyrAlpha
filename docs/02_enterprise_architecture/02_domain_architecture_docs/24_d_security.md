...
graph TD
    ...
    D_AUTONOMY_PERM -.->|测试依赖 / test_depends| src_zephyr_security_access_control_guards_novel_attack_guard_py
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    D_SECURITY_LLM -.->|测试依赖 / test_depends| src_zephyr_security_llm_defense_llm_security_layers_l6_observability_py
    ...
    class D_SHARED,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_GOV_AUDIT,D_SHARED,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOVERNANCE,D_GOV_ENFORCEMENT external_prod

...
graph TD
    ...
    class D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOVERNANCE,D_AUTONOMY_PERM external_design
```
...
graph TD
    ...
    class D_SHARED,D_FBL_VERIFICATION,D_GOV_KB,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_GOVERNANCE,D_COMPLIANCE,D_GOV_DRIFT external_design
```

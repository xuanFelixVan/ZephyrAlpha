...
graph TD
    ...
    class D_GOVERNANCE,D_COMPLIANCE,D_GOV_AUDIT,D_AUTONOMY_PERM,D_INFRA_A2A,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_SHARED,D_INTELLIGENCE,D_GOV_ENFORCEMENT external_prod
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_DRIFT,D_AUTONOMY_PERM,D_GOVERNANCE,D_SECURITY_LLM,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_RULE,D_SHARED,D_INFRA_RECOVERY external_prod
    class D_SECURITY_LLM,D_GOV_DRIFT,D_AUTONOMY_PERM,D_INFRA_A2A,D_GOVERNANCE,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
    class D_COMPLIANCE,D_GOV_DRIFT,D_SECURITY_LLM external_design
```
...
> 本域与 22 个外部域直接连接（出边 138 条 + 入边 248 条 = 386 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_GOVERNANCE,D_COMPLIANCE,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_GOV_AUDIT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_PERM,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_SECURITY_LLM,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_SHARED,D_ORCHESTRATOR,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_KB,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_KB,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_AUDIT external_prod

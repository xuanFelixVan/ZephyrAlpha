...
graph TD
    ...
    class D_AUTONOMY_PERM,D_GOVERNANCE,D_GOV_AUDIT,D_INFRA_RECOVERY,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_GOV_RULE external_prod
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT,D_AUTONOMY_PERM,D_GOVERNANCE,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOVERNANCE,D_AUTONOMY_PERM,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_GOV_AUDIT,D_FEEDBACK_LOOP,D_GOVERNANCE external_prod
    class D_GOV_ENFORCEMENT,D_AUTONOMY_PERM,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod

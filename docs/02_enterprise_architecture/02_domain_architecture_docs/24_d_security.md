...
graph TD
    ...
    class D_AUTONOMY_PERM,D_COMPLIANCE,D_GOV_AUDIT,D_INFRA_A2A,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_GOV_AUDIT,D_INTELLIGENCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_INFRA_RECOVERY,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_INFRA_RUNTIME,D_GOVERNANCE external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOVERNANCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_KB,D_GOV_RULE,D_INFRA_RUNTIME external_prod

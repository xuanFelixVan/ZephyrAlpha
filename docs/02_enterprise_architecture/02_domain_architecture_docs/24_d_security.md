...
graph TD
    ...
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_access_control_dry_run_py
    D_GOV_DRIFT["(设计态 / design) D_GOV_DRIFT"]
    D_GOV_DRIFT -.->|runtime / runtime| src_zephyr_security_access_control_dry_run_py
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_access_control_dry_run_py
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_access_control_dry_run_py
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
...
| 17 | D_GOV_DOCS 架构文档治理: blueprint.md | → | DryRun — 权限模拟与影响分析. (dry_run.py) | contract / contract |
| 18 | D_GOV_DOCS 架构文档治理: blueprint.md | → | LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 19 | D_GOV_DOCS 架构文档治理: blueprint.md | → | DryRun — 权限模拟与影响分析. (dry_run.py) | runtime / runtime |
| 20 | D_GOV_DOCS 架构文档治理: blueprint.md | → | LLM Security Gateway - Streamlit Dashboard. (ap... | runtime / runtime |
| 21 | D_GOV_DOCS 架构文档治理: blueprint.md | → | DryRun — 权限模拟与影响分析. (dry_run.py) | runtime / runtime |
| 22 | D_GOV_DOCS 架构文档治理: blueprint.md | → | LLM Security Gateway - Streamlit Dashboard. (ap... | contract / contract |
| 23 | D_GOV_DRIFT 漂移检测: blueprint.md | → | DryRun — 权限模拟与影响分析. (dry_run.py) | runtime / runtime |

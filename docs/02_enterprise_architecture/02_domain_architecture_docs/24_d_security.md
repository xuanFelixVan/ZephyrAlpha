...
graph TD
    ...
    class D_GOVERNANCE,D_INFRA_RECOVERY,D_COMPLIANCE,D_AUTONOMY_PERM,D_GOV_AUDIT,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_GOV_SCRIPTS,D_GOV_AUDIT,D_GOVERNANCE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_KB,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_RECOVERY,D_AUTONOMY_PERM,D_GOV_SCRIPTS,D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_KB,D_SHARED,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
    class D_GOVERNANCE,D_COMPLIANCE,D_SECURITY_LLM external_design
```

...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_INTEGRATION,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_process_sandbox_py
    D_GOV_DOCS -.->|contract / contract| src_zephyr_security_llm_defense_llm_security_process_sandbox_py
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_security_llm_defense_llm_security_process_sandbox_py
    D_INTEGRATION["(生产态 / production) D_INTEGRATION"]
...
graph TD
    ...
    class D_GOV_DOCS,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_design
```
...
| 18 | D_GOV_DOCS 架构文档治理: blueprint.md | → | L2a ProcessSandbox — subprocess 路径白名单沙箱... | contract / contract |
| 19 | D_GOV_DOCS 架构文档治理: blueprint.md | → | phase_executor.py | runtime / runtime |
| 20 | D_GOV_DOCS 架构文档治理: blueprint.md | → | L2a ProcessSandbox — subprocess 路径白名单沙箱... | runtime / runtime |
| 21 | D_GOV_DOCS 架构文档治理: blueprint.md | → | phase_executor.py | runtime / runtime |
| 22 | D_GOV_DOCS 架构文档治理: blueprint.md | → | L2a ProcessSandbox — subprocess 路径白名单沙箱... | contract / contract |

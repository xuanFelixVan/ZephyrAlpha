...
graph TD
    ...
    class D_GOV_AUDIT,D_COMPLIANCE,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_SCRIPTS,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_INTELLIGENCE external_design
```
...
graph TD
    ...
    class D_INTELLIGENCE,D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP external_prod
    class D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_INFRA_RECOVERY,D_GOV_SCRIPTS,D_GOVERNANCE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_GOV_RULE,D_INTEGRATION,D_SHARED,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_ORCHESTRATOR,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_AUDIT,D_SHARED,D_GOV_RULE,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
    class D_AUTONOMY_PERM,D_GOVERNANCE,D_SECURITY_LLM,D_GOV_SCRIPTS,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INTELLIGENCE,D_GOV_AUDIT,D_INFRA_RUNTIME external_prod

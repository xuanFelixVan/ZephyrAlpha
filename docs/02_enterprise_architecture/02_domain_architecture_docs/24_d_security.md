...
graph TD
    ...
    class D_AUTONOMY_CORE,D_AUTONOMY_PERM,D_INFRA_RECOVERY,D_GOV_AUDIT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOVERNANCE,D_AUTONOMY_PERM,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_AUTONOMY_CORE,D_AUTONOMY_PERM external_design
```

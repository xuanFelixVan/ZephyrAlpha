...
graph TD
    ...
    class D_GOV_DRIFT,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_AUDIT,D_GOV_OPS_RESILIENCE external_prod
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_GOV_DOCS,D_GOV_DRIFT external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_AUDIT,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_ORCHESTRATOR,D_GOV_ENFORCEMENT,D_FEEDBACK_LOOP external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_AUDIT,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
    class D_SHARED,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_FEEDBACK_LOOP,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod
    class D_COMPLIANCE,D_GOV_DOCS external_design
```

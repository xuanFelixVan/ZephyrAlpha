...
graph TD
    ...
    class D_AUTONOMY_PERM,D_INFRA_RECOVERY,D_GOV_AUDIT,D_AUTONOMY_CORE,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_INTELLIGENCE,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_GOV_AUDIT,D_GOV_DRIFT,D_AUTONOMY_PERM,D_GOVERNANCE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT,D_AUTONOMY_CORE,D_SECURITY_LLM external_design
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOV_DRIFT,D_SHARED,D_GOV_KB,D_GOVERNANCE,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod

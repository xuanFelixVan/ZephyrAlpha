...
graph TD
    ...
    class D_AUTONOMY_PERM,D_COMPLIANCE,D_INFRA_A2A,D_AUTONOMY_CORE,D_GOV_AUDIT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_AUTONOMY_PERM,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_AUTONOMY_PERM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
    class D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_DRIFT,D_GOVERNANCE,D_AUTONOMY_PERM,D_GOV_SCRIPTS,D_SECURITY_LLM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOV_RULE,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_AUDIT,D_GOVERNANCE,D_INTEGRATION external_prod
    class D_SECURITY_LLM,D_INFRA_RUNTIME,D_AUTONOMY_PERM,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_FBL_VERIFICATION,D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_AUDIT,D_GOV_ENFORCEMENT external_prod

...
graph TD
    ...
    D_GOV_RULE -->|导入依赖 / import_depends| src_zephyr_gov_audit_bridge_py
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_gov_audit_compliance_map_py
    ...
    class D_GOV_DRIFT,D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_RULE,D_INFRA_RUNTIME external_prod
    class D_GOV_DOCS,D_COMPLIANCE,D_INFRA_RECOVERY,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_REPAIR external_prod
    class D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_SECURITY,D_INTEGRATION,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_DIAGNOSERS,D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_SHARED,D_GOV_RULE,D_GOV_ENFORCEMENT,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SECURITY,D_INFRA_RUNTIME,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_DRIFT,D_INFRA_RUNTIME,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_FBL_DETECTORS,D_SECURITY,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE,D_SECURITY,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod

...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_GOVERNANCE,D_INFRA_RUNTIME,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_REPAIR,D_AUTONOMY_CORE external_prod
    class D_SHARED,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_SECURITY,D_INTEGRATION,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_FBL_VERIFICATION,D_SHARED,D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_SECURITY,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_SECURITY,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_FBL_VERIFICATION external_prod
    class D_SHARED,D_REPORTING,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_SHARED,D_FBL_DETECTORS,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
    class D_SECURITY,D_COMPLIANCE,D_GOVERNANCE,D_GOV_DOCS external_design
```

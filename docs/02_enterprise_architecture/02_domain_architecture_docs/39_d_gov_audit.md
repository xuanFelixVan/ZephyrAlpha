...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_RULE,D_INFRA_RUNTIME external_prod
    class D_GOV_DOCS,D_SHARED,D_COMPLIANCE,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_RULE,D_SECURITY,D_INTEGRATION,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
    class D_GOVERNANCE,D_REPORTING,D_GOV_ENFORCEMENT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_RULE,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_ENFORCEMENT,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INTELLIGENCE,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SECURITY,D_GOV_CODE_QUALITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_GOV_REPAIR,D_GOV_RULE,D_INFRA_RUNTIME external_prod
    class D_REPORTING,D_COMPLIANCE,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod

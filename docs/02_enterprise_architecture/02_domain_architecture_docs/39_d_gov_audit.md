...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_TRADING,D_SECURITY,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_RULE,D_INTEGRATION,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
    class D_REPORTING,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_SECURITY,D_GOV_ENFORCEMENT,D_FBL_DIAGNOSERS,D_SHARED external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_INFRA_RUNTIME,D_SHARED,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOVERNANCE,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_GOV_DRIFT,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOV_DRIFT,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_REPAIR,D_INTEGRATION,D_TRADING,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod

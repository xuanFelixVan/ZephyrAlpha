...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_RULE,D_SHARED,D_GOV_DRIFT,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_DRIFT,D_INFRA_RECOVERY,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_INFRA_RUNTIME external_prod
```

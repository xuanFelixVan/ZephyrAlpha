...
graph TD
    ...
    class D_SECURITY,D_INFRA_A2A,D_INFRA_RUNTIME,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_INTEGRATION,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_TRADING external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_RULE,D_SECURITY,D_INTEGRATION,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT external_prod
    class D_REPORTING,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE,D_SHARED,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_FBL_VERIFICATION,D_SECURITY,D_GOV_RULE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_AUTONOMY_CORE,D_INFRA_RUNTIME,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_INFRA_A2A,D_INFRA_RUNTIME,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_GOV_DRIFT,D_GOV_RULE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_REPAIR,D_SECURITY,D_INFRA_RUNTIME external_prod
...
| 107 | D_GOV_REPAIR 治理修复: __init__.py | → | financial_compliance.py | config_depends / config_depends |
...
> 本域与 26 个外部域直接连接（出边 266 条 + 入边 143 条 = 409 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_gov_audit_corporate_actions_py
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY external_prod
    class D_GOV_DOCS,D_AUTONOMY_CORE,D_INFRA_A2A,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_INTEGRATION,D_TRADING external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_GOV_RULE,D_AUTONOMY_CORE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE,D_FBL_VERIFICATION,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_RULE,D_SECURITY,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_RULE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_TRADING,D_INFRA_RUNTIME,D_GOV_DRIFT,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_CODE_QUALITY,D_GOVERNANCE,D_FBL_DETECTORS,D_SECURITY,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_ORCHESTRATOR,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_GOV_OPS_RESILIENCE external_prod
    class D_REPORTING,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
| 24 | D_GOVERNANCE 生命周期管理: GitCommitGateway — 全项目唯一合法 git commit .... | → | reconciliation_registry.py — GitCommitGateway ... | 导入依赖 / import_depends |
...
> 本域与 26 个外部域直接连接（出边 266 条 + 入边 142 条 = 408 条）。只显示直接连接的域，不展开具体节点。

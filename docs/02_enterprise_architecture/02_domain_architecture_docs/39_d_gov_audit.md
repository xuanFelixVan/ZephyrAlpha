...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_FEEDBACK_LOOP,D_TRADING,D_INFRA_RECOVERY,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_SECURITY,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_TRADING,D_GOV_RULE external_prod

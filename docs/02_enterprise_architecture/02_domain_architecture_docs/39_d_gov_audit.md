...
graph TD
    ...
    src_zephyr_gov_audit_cold_start_py -->|导入依赖 / import_depends| D_SHARED
    D_GOVERNANCE -.->|config_depends / config_depends| scripts_governance_repair_rollback_depgraph_py
...
| 21 | D_GOVERNANCE 生命周期管理: apply_verification_results.py — 第32轮验证结果... | → | [INVARIANTS] 仅接受depgraph.backup.*路径; 回滚.... | config_depends / config_depends |

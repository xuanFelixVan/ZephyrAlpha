...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_SECURITY,D_GOVERNANCE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_GOV_RULE external_prod
    class D_COMPLIANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_FEEDBACK_LOOP,D_INTEGRATION,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOV_ENFORCEMENT,D_FBL_DIAGNOSERS,D_GOV_RULE,D_GOV_DRIFT,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_INFRA_RUNTIME,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_SHARED,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOVERNANCE,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_SECURITY,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE,D_SECURITY,D_FEEDBACK_LOOP,D_INTEGRATION,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
    class D_REPORTING,D_COMPLIANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_INTELLIGENCE,D_SECURITY,D_FBL_DIAGNOSERS,D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod

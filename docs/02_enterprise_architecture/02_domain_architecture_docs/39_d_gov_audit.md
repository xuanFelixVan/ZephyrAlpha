...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_GOV_REPAIR,D_INFRA_RUNTIME,D_GOV_RULE,D_FBL_VERIFICATION external_prod
    class D_GOV_DOCS,D_SHARED,D_COMPLIANCE,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOVERNANCE,D_INTEGRATION,D_GOV_REPAIR external_prod
    class D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    D_GOV_DOCS["(设计态 / design) D_GOV_DOCS"]
    D_GOV_DOCS -.->|runtime / runtime| src_zephyr_governance_semantic_audit_feedback_self_audit_py
    D_GOV_REPAIR["(生产态 / production) D_GOV_REPAIR"]
    ...
    class D_GOVERNANCE,D_GOV_RULE,D_SHARED,D_SECURITY,D_INTEGRATION,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
    class D_REPORTING,D_GOV_DOCS,D_COMPLIANCE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_SHARED,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_RULE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_SHARED,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_SECURITY,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_RULE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_SECURITY,D_GOV_REPAIR external_prod
    class D_SHARED,D_REPORTING,D_GOV_ENFORCEMENT,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_DRIFT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
    class D_GOV_DOCS,D_COMPLIANCE,D_GOVERNANCE external_design
```
...
| 147 | F18 红蓝极限对抗测试. (test_f18_redblue.py) | → | D_GOV_OPS_RESILIENCE 运维弹性治理: Phase Manager — ZephyrAlpha 施工阶段门控引擎. ... | 测试依赖 / test_depends |
...
| 66 | D_GOV_DOCS 架构文档治理: blueprint.md | → | audit-trail.feedback_self_audit — MOD-INF-020 ... | runtime / runtime |
...
> 本域与 26 个外部域直接连接（出边 267 条 + 入边 142 条 = 409 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_RULE,D_INTEGRATION,D_GOV_REPAIR,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE external_prod
    class D_REPORTING,D_INFRASTRUCTURE,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_SECURITY,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_GOV_DRIFT,D_GOVERNANCE,D_INFRA_RUNTIME,D_TRADING external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DETECTORS,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_GOV_RULE external_prod

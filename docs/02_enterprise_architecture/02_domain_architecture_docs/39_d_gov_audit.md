...
graph TD
    ...
    class D_GOV_DRIFT,D_GOVERNANCE,D_SECURITY,D_SHARED,D_GOV_RULE external_prod
    class D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_A2A,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_SHARED,D_INTEGRATION,D_GOV_REPAIR,D_GOV_DRIFT external_prod
    class D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_SECURITY,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_RULE,D_INTEGRATION,D_SECURITY,D_SHARED,D_GOV_ENFORCEMENT,D_GOV_REPAIR,D_GOV_DRIFT,D_AUTONOMY_CORE,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_RULE,D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_SECURITY,D_SHARED,D_FBL_DIAGNOSERS,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_GOV_DRIFT,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_RULE,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_INFRA_A2A,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_GOV_CODE_QUALITY,D_GOV_DRIFT,D_ORCHESTRATOR,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_RULE,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_REPAIR external_prod
    class D_REPORTING,D_INTEGRATION,D_INFRA_RECOVERY,D_AUTONOMY_CORE,D_INFRA_A2A,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_GOV_REPAIR,D_INFRA_RUNTIME,D_SECURITY external_prod

...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_TRADING,D_INFRA_RECOVERY,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_GOV_ENFORCEMENT,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_RULE external_prod

...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_REPAIR,D_FBL_VERIFICATION external_prod
    class D_GOV_DOCS,D_SECURITY,D_INFRA_RUNTIME,D_INFRA_A2A,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_GOV_REPAIR,D_TRADING external_prod
    class D_GOV_ENFORCEMENT,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_GOV_RULE,D_SECURITY,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE,D_GOVERNANCE,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_ORCHESTRATOR,D_SECURITY,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_REPAIR,D_INFRA_RUNTIME,D_SECURITY external_prod

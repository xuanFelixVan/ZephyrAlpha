...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
    class D_INFRA_A2A,D_AUTONOMY_CORE,D_COMPLIANCE,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_SECURITY,D_GOV_RULE,D_GOV_REPAIR,D_GOV_DRIFT,D_INFRA_RUNTIME,D_AUTONOMY_CORE external_prod
    class D_GOVERNANCE,D_REPORTING,D_GOV_ENFORCEMENT,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_SHARED,D_GOV_DRIFT,D_GOV_RULE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOVERNANCE,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_INFRA_A2A,D_SHARED,D_TRADING,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_DETECTORS,D_SECURITY,D_GOV_DRIFT,D_ORCHESTRATOR external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
    class D_GOV_ENFORCEMENT,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_REPAIR,D_SECURITY,D_INFRA_RUNTIME external_prod

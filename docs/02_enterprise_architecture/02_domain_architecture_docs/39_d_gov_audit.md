...
graph TD
    ...
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_gov_audit_merkle_hourly_py
...
graph TD
    ...
    D_GOVERNANCE -.->|测试依赖 / test_depends| src_zephyr_gov_audit_tiered_storage_py
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_RULE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
    class D_REPORTING,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_RULE,D_GOV_DRIFT,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_SECURITY,D_SHARED,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    D_GOVERNANCE["(生产态 / production) D_GOVERNANCE"]
    tests_f_lifecycle_test_f5_red_team_extreme_py -.->|测试依赖 / test_depends| D_GOVERNANCE
    D_GOV_OPS_RESILIENCE["(生产态 / production) D_GOV_OPS_RESILIENCE"]
    ...
    tests_f_lifecycle_test_f5_e2e_lifecycle_py -.->|测试依赖 / test_depends| D_SHARED
    ...
    class D_GOV_DRIFT,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_SHARED,D_TRADING,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY external_prod
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_GOVERNANCE,D_GOV_DRIFT,D_SHARED,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_TRADING,D_GOV_RULE,D_GOV_REPAIR external_prod
    class D_INTEGRATION,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```

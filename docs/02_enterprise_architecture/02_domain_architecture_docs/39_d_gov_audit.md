...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_DRIFT,D_TRADING,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTEGRATION,D_INFRA_RECOVERY external_prod
    class D_REPORTING,D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INFRASTRUCTURE external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_TRADING,D_INFRA_RUNTIME external_prod
    class D_GOV_CODE_QUALITY,D_GOV_SCRIPTS,D_INTEGRATION external_design
```
...
> 本域与 19 个外部域直接连接（出边 70 条 + 入边 56 条 = 126 条）。只显示直接连接的域，不展开具体节点。

...
graph TD
    ...
    class D_SHARED,D_COMPLIANCE,D_AUTONOMY_CORE,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_SECURITY,D_FBL_DIAGNOSERS,D_GOV_RULE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_FBL_VERIFICATION,D_SHARED external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SECURITY,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_FBL_DETECTORS,D_SHARED,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_CODE_QUALITY,D_FBL_DIAGNOSERS,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_REPORTING,D_GOV_ENFORCEMENT,D_COMPLIANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_GOV_REPAIR external_prod
    class D_COMPLIANCE,D_SECURITY,D_GOVERNANCE,D_GOV_DOCS external_design
```
...
| 66 | D_GOV_DOCS 架构文档治理: blueprint.md | → | audit-trail.compliance_map — MOD-INF-020 · 合... | runtime / runtime |

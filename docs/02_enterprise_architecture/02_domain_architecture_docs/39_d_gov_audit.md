...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOV_RULE,D_GOV_REPAIR external_prod
    class D_GOV_DOCS,D_GOVERNANCE,D_SECURITY,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_REPORTING,D_INFRASTRUCTURE,D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_RULE,D_GOV_DRIFT,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_FBL_VERIFICATION,D_GOV_ENFORCEMENT,D_FBL_DIAGNOSERS,D_GOV_RULE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_INFRA_A2A,D_GOV_DRIFT,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_AUTONOMY_CORE,D_FBL_DETECTORS,D_GOV_DRIFT,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_SECURITY,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INTEGRATION external_prod
    class D_INFRA_RUNTIME,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_design
```
...
| 61 | [INVARIANTS] 按path精确匹配+按功能名模糊匹配; .... | → | D_GOVERNANCE 生命周期管理: P2-T6 PostgreSQL 40并发写入红蓝测试。 (p2_pg_co... | config_depends / config_depends |
...
> 本域与 27 个外部域直接连接（出边 270 条 + 入边 144 条 = 414 条）。只显示直接连接的域，不展开具体节点。

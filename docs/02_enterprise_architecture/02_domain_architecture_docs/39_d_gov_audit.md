...
graph TD
    ...
    class D_SECURITY,D_GOV_DRIFT,D_SHARED,D_GOV_RULE,D_FEEDBACK_LOOP,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FEEDBACK_LOOP,D_SECURITY,D_FBL_DIAGNOSERS,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_SECURITY,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_SHARED external_prod
```
...
graph TD
    ...
    class D_AUTONOMY_CORE,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_INFRA_RUNTIME,D_SECURITY external_prod
    class D_REPORTING,D_GOV_DOCS,D_COMPLIANCE external_design
```
...
| 63 | D_GOV_DOCS 架构文档治理: blueprint.md | → | 三元对齐检测：蓝图声明清单 vs 磁盘实际文件 vs i... | runtime / runtime |

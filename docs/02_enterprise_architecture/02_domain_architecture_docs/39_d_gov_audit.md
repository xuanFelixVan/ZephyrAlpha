...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_REPAIR external_prod
    class D_INFRA_RUNTIME,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_INFRA_RUNTIME external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INTELLIGENCE,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_INFRA_RECOVERY external_prod
...
> 本域与 27 个外部域直接连接（出边 269 条 + 入边 142 条 = 411 条）。只显示直接连接的域，不展开具体节点。

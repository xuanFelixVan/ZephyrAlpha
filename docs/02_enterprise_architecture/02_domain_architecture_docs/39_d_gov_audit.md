...
graph TD
    ...
    class D_SHARED,D_INTEGRATION,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_SECURITY,D_TRADING,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_SECURITY,D_INFRA_RECOVERY,D_GOV_RULE,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME external_prod

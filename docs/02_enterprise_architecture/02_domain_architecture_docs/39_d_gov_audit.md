...
graph TD
    ...
    class D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_GOV_REPAIR,D_GOV_RULE,D_INFRA_RUNTIME,D_FBL_VERIFICATION external_prod
    class D_GOV_DOCS,D_SHARED,D_AUTONOMY_CORE,D_INFRA_A2A,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_RULE,D_SECURITY,D_INTEGRATION,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_SECURITY,D_INFRA_RUNTIME,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_FEEDBACK_LOOP,D_SECURITY,D_GOV_DRIFT,D_GOV_REPAIR external_prod
    class D_REPORTING,D_SHARED,D_GOV_ENFORCEMENT,D_COMPLIANCE,D_AUTONOMY_CORE external_design
```
...
graph TD
    ...
    class D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_GOV_DRIFT,D_INFRA_RUNTIME,D_FEEDBACK_LOOP,D_SECURITY,D_FBL_VERIFICATION,D_GOV_REPAIR external_prod
    class D_COMPLIANCE,D_GOVERNANCE external_design
```
...
| 106 | D_GOV_REPAIR 治理修复: __init__.py | → | financial_compliance.py | config_depends / config_depends |

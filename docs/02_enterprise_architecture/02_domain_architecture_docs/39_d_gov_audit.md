...
graph TD
    ...
    scripts_governance_repair_red_blue_test_py -.->|config_depends / config_depends| scripts_governance_repair_rollback_depgraph_py
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_SECURITY,D_FEEDBACK_LOOP,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_GOV_RULE external_prod
    class D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_INTEGRATION external_design
```
...
> 仅展示代码已写、验证中未稳定上线的原型态模块（共 31 个，17 条域内依赖）。
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_SECURITY,D_INFRA_RUNTIME external_prod

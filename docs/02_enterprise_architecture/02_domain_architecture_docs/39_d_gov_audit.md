...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOV_RULE,D_GOV_ENFORCEMENT,D_GOVERNANCE,D_SECURITY,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_TRADING,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_INFRA_RUNTIME,D_INFRA_RECOVERY external_prod
    class D_REPORTING,D_SECURITY,D_INFRASTRUCTURE,D_GOV_SCRIPTS external_design
```

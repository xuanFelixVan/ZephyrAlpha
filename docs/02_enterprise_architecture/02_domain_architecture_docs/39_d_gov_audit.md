...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_RULE,D_INTEGRATION,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_VERIFICATION,D_GOVERNANCE,D_SHARED,D_FBL_DIAGNOSERS,D_GOV_RULE,D_GOV_DRIFT,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_SECURITY,D_SHARED,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INTELLIGENCE,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_GOV_DRIFT,D_INFRA_RUNTIME,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_FBL_DIAGNOSERS,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOVERNANCE,D_GOV_CODE_QUALITY,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_GOV_DRIFT,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_RULE,D_GOV_REPAIR,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
    class D_GOV_SCRIPTS external_design
```
...
> 本域与 27 个外部域直接连接（出边 268 条 + 入边 145 条 = 413 条）。只显示直接连接的域，不展开具体节点。

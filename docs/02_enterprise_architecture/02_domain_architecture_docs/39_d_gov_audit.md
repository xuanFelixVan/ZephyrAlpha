...
graph TD
    ...
    class D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE,D_GOV_REPAIR external_prod
    class D_SHARED,D_GOV_DOCS,D_SECURITY,D_AUTONOMY_CORE,D_INFRA_A2A,D_COMPLIANCE external_design
```
...
graph TD
    ...
    class D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_RULE,D_SHARED external_prod
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_AUTONOMY_CORE,D_GOV_RULE,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_INFRA_RUNTIME,D_SHARED,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_DETECTORS,D_SECURITY,D_AUTONOMY_CORE,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE external_prod
```
...
graph TD
    ...
    class D_SECURITY,D_GOV_DRIFT,D_GOVERNANCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_TRADING,D_INFRA_RECOVERY,D_GOV_RULE external_prod
    class D_AUTONOMY_CORE,D_INFRA_A2A,D_COMPLIANCE external_design
```

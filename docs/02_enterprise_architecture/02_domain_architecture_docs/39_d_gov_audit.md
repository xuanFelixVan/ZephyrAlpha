...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_TRADING,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_SECURITY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_SECURITY,D_GOV_CODE_QUALITY,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_INTEGRATION,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_GOV_CODE_QUALITY,D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_SECURITY,D_TRADING,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_ENFORCEMENT,D_SECURITY,D_INFRA_RUNTIME external_prod

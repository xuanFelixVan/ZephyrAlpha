...
graph TD
    ...
    class D_SHARED,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_TRADING,D_GOV_DRIFT,D_SECURITY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_GOV_ENFORCEMENT,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_INTEGRATION,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_ENFORCEMENT,D_GOV_DRIFT,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_RULE,D_INFRA_RUNTIME,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_TRADING external_prod
...
> 本域与 18 个外部域直接连接（出边 70 条 + 入边 54 条 = 124 条）。只显示直接连接的域，不展开具体节点。

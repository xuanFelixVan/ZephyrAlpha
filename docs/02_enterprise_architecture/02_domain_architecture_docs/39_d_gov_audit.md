...
graph TD
    ...
    class D_GOV_DRIFT,D_SHARED,D_GOVERNANCE,D_GOV_REPAIR,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_TRADING,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_RULE,D_INTEGRATION,D_GOV_REPAIR,D_INFRA_RECOVERY external_prod
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_SECURITY,D_FBL_VERIFICATION,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FBL_DETECTORS,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_DRIFT,D_AUTONOMY_CORE,D_FBL_DIAGNOSERS,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_INFRA_RECOVERY,D_TRADING external_prod
```

...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_REPAIR,D_GOV_RULE external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_GOV_REPAIR,D_SECURITY external_prod
    class D_INTEGRATION,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_GOV_RULE,D_INTEGRATION,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR external_prod
    class D_REPORTING,D_INFRA_RUNTIME,D_GOV_SCRIPTS external_design
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SECURITY,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_TRADING,D_GOV_DRIFT,D_SECURITY,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DETECTORS,D_AUTONOMY_CORE,D_SECURITY,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_INTEGRATION,D_INFRA_RECOVERY,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_DRIFT,D_FBL_VERIFICATION,D_GOV_REPAIR,D_INFRA_RUNTIME external_prod
...
| 203 | test_audit_log_guard.py | → | D_SECURITY 对抗验证: Stub module: zephyr.security.access_control.gua... | 测试依赖 / test_depends |

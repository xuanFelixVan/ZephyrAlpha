...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_GOV_REPAIR,D_TRADING external_prod
...
graph TD
    ...
    class D_SECURITY,D_GOVERNANCE,D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_REPAIR,D_INFRA_RECOVERY,D_GOV_OPS_RESILIENCE external_prod
    class D_REPORTING,D_GOV_SCRIPTS,D_INFRASTRUCTURE,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_SHARED,D_FBL_VERIFICATION,D_GOVERNANCE,D_GOV_RULE,D_GOV_DRIFT,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_GOV_ENFORCEMENT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_SHARED,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_FBL_DETECTORS,D_SECURITY,D_GOV_DRIFT,D_GOVERNANCE,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_SECURITY,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE,D_GOV_DRIFT,D_GOVERNANCE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_INTEGRATION external_prod

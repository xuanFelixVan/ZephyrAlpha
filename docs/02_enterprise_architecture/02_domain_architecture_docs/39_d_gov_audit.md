...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_TRADING,D_SECURITY,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_GOVERNANCE,D_SECURITY,D_SHARED,D_GOV_RULE,D_INTEGRATION,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
    class D_REPORTING,D_INFRASTRUCTURE,D_GOV_SCRIPTS,D_GOV_ENFORCEMENT external_design
```
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOV_DRIFT,D_SECURITY,D_FBL_VERIFICATION,D_SHARED,D_GOV_RULE,D_GOV_ENFORCEMENT external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION,D_FEEDBACK_LOOP,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_SHARED,D_INTELLIGENCE,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_INFRA_A2A external_prod
```
...
graph TD
    ...
    class D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS,D_GOV_CODE_QUALITY,D_AUTONOMY_CORE,D_FBL_DETECTORS,D_GOVERNANCE,D_GOV_DRIFT external_prod
```
...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_SECURITY,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_INTEGRATION,D_TRADING external_prod
...
| 67 | D_GOV_DOCS 架构文档治理: blueprint.md | → | audit-trail.compliance_map — MOD-INF-020 · 合... | runtime / runtime |
...
> 本域与 27 个外部域直接连接（出边 269 条 + 入边 146 条 = 415 条）。只显示直接连接的域，不展开具体节点。

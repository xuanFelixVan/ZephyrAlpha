...
graph TD
    ...
    class D_GOVERNANCE,D_SHARED,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_GOV_REPAIR,D_INFRA_RECOVERY,D_TRADING,D_SECURITY external_prod
    class D_GOV_ENFORCEMENT,D_KNOWLEDGE,D_GOV_SCRIPTS,D_INFRA_RUNTIME external_design
```
...
graph TD
    ...
    class D_REPORTING,D_GOV_ENFORCEMENT,D_GOV_SCRIPTS,D_INFRA_A2A external_design
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_SECURITY,D_SHARED,D_GOV_RULE,D_FBL_VERIFICATION external_prod
```
...
graph TD
    ...
    class D_FBL_DETECTORS,D_GOV_DRIFT,D_INFRA_RECOVERY,D_SECURITY,D_SHARED,D_GOV_OPS_RESILIENCE,D_INTELLIGENCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_SECURITY,D_GOV_DRIFT,D_FEEDBACK_LOOP,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
```

...
graph TD
    ...
    class D_INFRA_RUNTIME,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_GOV_OPS_RESILIENCE,D_AUTONOMY_CORE external_prod
```
...
> 本域与 27 个外部域直接连接（出边 270 条 + 入边 146 条 = 416 条）。只显示直接连接的域，不展开具体节点。

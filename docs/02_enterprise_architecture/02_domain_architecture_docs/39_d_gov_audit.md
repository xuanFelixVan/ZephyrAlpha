...
graph TD
    ...
    class D_GOV_DOCS,D_COMPLIANCE,D_AUTONOMY_CORE,D_INFRA_RECOVERY external_design
```
...
graph TD
    ...
    src_zephyr_gov_audit_indexer_py -->|导入依赖 / import_depends| D_SHARED
    D_FEEDBACK_LOOP -.->|测试依赖 / test_depends| src_zephyr_gov_audit_feedback_bridge_py
    ...
    class D_SHARED,D_GOV_OPS_RESILIENCE,D_FEEDBACK_LOOP,D_INTEGRATION,D_INFRA_RECOVERY,D_INFRA_RUNTIME,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_SHARED,D_SECURITY,D_GOVERNANCE,D_INTEGRATION,D_GOV_RULE,D_GOV_REPAIR external_prod
...
graph TD
    ...
    class D_FBL_DIAGNOSERS,D_GOVERNANCE,D_FBL_VERIFICATION,D_GOV_DRIFT,D_GOV_RULE,D_GOV_REPAIR,D_GOV_OPS_RESILIENCE external_prod
...
graph TD
    ...
    class D_GOV_DRIFT,D_GOV_RULE,D_FBL_DIAGNOSERS,D_FEEDBACK_LOOP,D_FBL_VERIFICATION,D_SECURITY external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DETECTORS,D_FEEDBACK_LOOP,D_FBL_DIAGNOSERS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_VERIFICATION,D_FBL_DIAGNOSERS,D_GOV_RULE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_INFRA_A2A,D_TRADING,D_INFRA_RUNTIME,D_GOV_OPS_RESILIENCE,D_GOV_DRIFT,D_FBL_DETECTORS external_prod
```
...
graph TD
    ...
    class D_GOV_DRIFT,D_FBL_DIAGNOSERS,D_AUTONOMY_CORE,D_FEEDBACK_LOOP,D_FBL_DETECTORS,D_GOV_OPS_RESILIENCE,D_GOVERNANCE external_prod
```
...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_SECURITY,D_FBL_VERIFICATION,D_GOV_REPAIR,D_INFRA_RECOVERY external_prod
    class D_REPORTING,D_FEEDBACK_LOOP,D_COMPLIANCE,D_AUTONOMY_CORE external_design
```
...
> 本域与 25 个外部域直接连接（出边 253 条 + 入边 127 条 = 380 条）。只显示直接连接的域，不展开具体节点。

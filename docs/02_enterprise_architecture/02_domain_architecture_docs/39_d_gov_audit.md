...
graph TD
    ...
    class D_SHARED,D_GOV_DRIFT,D_GOVERNANCE,D_GOV_RULE,D_INFRA_RUNTIME,D_AUTONOMY_CORE,D_FBL_VERIFICATION external_prod
    class D_SECURITY,D_INFRA_RECOVERY,D_GOV_DOCS external_design
```
...
graph TD
    ...
    class D_INTEGRATION,D_SHARED,D_FEEDBACK_LOOP,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_OPS_RESILIENCE,D_TRADING,D_INFRA_RECOVERY,D_SECURITY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_INTEGRATION,D_SECURITY,D_GOV_ENFORCEMENT,D_GOV_OPS_RESILIENCE,D_INFRA_RECOVERY,D_INFRA_RUNTIME external_prod
...
graph TD
    ...
    class D_SHARED,D_GOVERNANCE,D_GOV_DRIFT,D_GOV_ENFORCEMENT,D_SECURITY,D_FEEDBACK_LOOP,D_GOV_OPS_RESILIENCE,D_INTEGRATION,D_TRADING,D_INFRA_RECOVERY,D_GOV_RULE external_prod
...
| 29 | finding_model.py | → | D_INTEGRATION 管线路由: base_config.py | 导入依赖 / import_depends |
| 30 | pipeline_runner.py | → | D_INTEGRATION 管线路由: base_config.py | 导入依赖 / import_depends |
| 31 | text_to_finding_adapter.py | → | D_INTEGRATION 管线路由: base_config.py | 导入依赖 / import_depends |

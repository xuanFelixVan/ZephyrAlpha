...
flowchart TD
    ...
    src_zephyr_ex_sor_services_execution_quality_scorer_py["执行质量评分器<br/>执行智能编排/服务包的execution_quality_<br/>scorer模块<br/>⛔ 智能订单路由域，设计已就绪，等待开发排期<br/>文件: services/execution_quality_scorer.py<br/>(设计态 / design)"]
    ...
    src_zephyr_ex_sor_core_broker_api_connector_py["券商api连接器<br/>执行智能编排/核心包的broker_api_connector模块<br/>⛔ 智能订单路由域，设计已就绪，等待开发排期<br/>文件: core/broker_api_connector.py<br/>(设计态 / design)"]

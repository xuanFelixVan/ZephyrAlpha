...
flowchart TD
    subgraph track_model_driven["模型驱动轨（Model-Driven Track）"]
        ...
        N190("[design]signal: 末位淘汰 IC-Based Factor Replacement<br/>path: decision/factor/fc_01")
        LL2A --- N190
        N191("[design]signal: 批量裁剪 Batch Factor Pruning<br/>path: decision/factor/fc_02")
        LL2A --- N191

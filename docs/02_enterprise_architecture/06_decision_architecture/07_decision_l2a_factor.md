...
flowchart TD
    ...
    N190["(设计态 / design) 末位淘汰 / IC-Based Factor<br/>Replacement<br/>信号节点·末位淘汰<br/>文件: decision/factor/fc_01"]
    LL2A --- N190
    N191["(设计态 / design) 批量裁剪 / Batch Factor<br/>Pruning<br/>信号节点·批量裁剪<br/>文件: decision/factor/fc_02"]
    LL2A --- N191

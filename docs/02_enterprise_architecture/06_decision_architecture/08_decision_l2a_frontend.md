...
flowchart TD
    ...
    N200["(设计态 / design) Approval Workflow UI<br/>审批流程界面<br/>提供审批流程的可视化操作界面，让人工审批决策有可<br/>交互入口<br/>文件: decision/frontend/fe_12"]
    LL2A --- N200
    N201["(设计态 / design) Notification Router 通知路由<br/>按事件类型和接收人规则路由通知消息，确保关键信息<br/>触达正确的人<br/>文件: decision/frontend/fe_13"]
    LL2A --- N201
    N202["(设计态 / design) Real-time Dashboard 实时仪表盘<br/>实时展示交易和风控关键指标，让运维人员一眼掌握系<br/>统状态<br/>文件: decision/frontend/fe_09"]
    LL2A --- N202
    N203["(设计态 / design) 决策树可视化器 / ADR Decision<br/>Tree Visualizer<br/>将架构决策记录可视化为决策树，帮助理解决策演进脉<br/>络<br/>文件: decision/frontend/fe_m76"]
    LL2A --- N203
    N209["(设计态 / design) 服务降级管理 / Service<br/>Degradation Manager<br/>系统过载时按预案降级非核心功能，保住核心交易链路<br/>可用<br/>文件: decision/frontend/fe_14"]
    LL2A --- N209
    N210["(设计态 / design) 跨域运维事件链追踪 /<br/>Cross-Domain Event Chain<br/>追踪一个事件跨多个域的传播链路，定位跨域问题的根<br/>因<br/>文件: decision/frontend/fe_15"]
    LL2A --- N210

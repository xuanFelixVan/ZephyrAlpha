...
flowchart TD
    ...
    N32["(设计态 / design) 策略分配 / Strategy Allocation<br/>组合目标节点·策略分配<br/>文件: decision/pf_alloc/pa_01"]
    LL3 --- N32
    N33["(设计态 / design) 风险平价 / Risk Parity<br/>组合目标节点·风险平价<br/>文件: decision/pf_alloc/pa_02"]
    LL3 --- N33
    N34["(设计态 / design) 动态权重 / Dynamic Weighting<br/>组合目标节点·动态权重<br/>文件: decision/pf_alloc/pa_03"]
    LL3 --- N34
    N35["(设计态 / design) 策略权重再平衡 / Strategy<br/>Weight Rebalance<br/>组合目标节点·策略权重再平衡<br/>文件: decision/pf_alloc/pa_04"]
    LL3 --- N35
    N36["(设计态 / design) 多策略共识 / Multi-Strategy<br/>Consensus<br/>组合目标节点·多策略共识<br/>文件: decision/pf_alloc/pa_05"]
    LL3 --- N36
    N37["(设计态 / design) 元策略选择 / Meta-Strategy<br/>Selection<br/>组合目标节点·元策略选择<br/>文件: decision/pf_alloc/pa_06"]
    LL3 --- N37

...
flowchart TD
    subgraph track_model_driven["模型驱动轨（Model-Driven Track）"]
        LL0["L0: 数据接入与预处理层<br/>freq: tick<br/>build: stable"]:::bsStable
        LL1["L1: 因子计算层<br/>freq: daily<br/>build: stable"]:::bsStable
        LL2A["L2A: 信号层<br/>freq: daily<br/>build: planned"]:::bsPlanned
        LL2B["L2B: 主力行为层<br/>freq: daily<br/>build: planned"]:::bsPlanned
        LL2C["L2C: 市场状态与大盘预测层<br/>freq: daily<br/>build: planned"]:::bsPlanned
        LL2D["L2D: 知识图谱与因果推演层<br/>freq: daily<br/>build: planned"]:::bsPlanned
        LL3["L3: 策略组合层<br/>freq: daily<br/>build: planned"]:::bsPlanned
        LL4["L4: 风控层<br/>freq: realtime<br/>build: stable"]:::bsStable
        LL5["L5: 学习层<br/>freq: weekly<br/>build: planned"]:::bsPlanned
        LL6["L6: 自评估层<br/>freq: weekly<br/>build: planned"]:::bsPlanned
    end
...
```mermaid
flowchart LR
    LL0["L0 数据接入与预处理层<br/>Data Ingestion & Preprocessing<br/>频率: tick<br/>成熟度: production<br/>build: stable"]:::bsStable
    LL1["L1 因子计算层<br/>Factor Calculation<br/>频率: daily<br/>成熟度: production<br/>build: stable"]:::bsStable
    LL2A["L2A 信号层<br/>Signal Generation<br/>频率: daily<br/>成熟度: design<br/>build: planned"]:::bsPlanned
    LL2B["L2B 主力行为层<br/>Main Force Behavior Analysis<br/>频率: daily<br/>成熟度: design<br/>build: planned"]:::bsPlanned
    LL2C["L2C 市场状态与大盘预测层<br/>Market State & Index Prediction<br/>频率: daily<br/>成熟度: design<br/>build: planned"]:::bsPlanned
    LL2D["L2D 知识图谱与因果推演层<br/>Knowledge Graph & Causal Inference<br/>频率: daily<br/>成熟度: design<br/>build: planned"]:::bsPlanned
    LL3["L3 策略组合层<br/>Strategy & Portfolio Combination<br/>频率: daily<br/>成熟度: design<br/>build: planned"]:::bsPlanned
    LL4["L4 风控层<br/>Risk Control<br/>频率: realtime<br/>成熟度: production<br/>build: stable"]:::bsStable
    LL5["L5 学习层<br/>Learning & Optimization<br/>频率: weekly<br/>成熟度: design<br/>build: planned"]:::bsPlanned
    LL6["L6 自评估层<br/>Self Evaluation<br/>频率: weekly<br/>成熟度: design<br/>build: planned"]:::bsPlanned
    LL0 -->|triggering| LL1
    LL1 -->|triggering| LL2A
    LL2A -->|triggering| LL2B
    LL2B -->|triggering| LL2C

...
| D_AUTONOMY_CORE | 自治核心 | 130 | 125 | 0 | 5 | 0 | 96.2% |
| D_AUTONOMY_PERM | 自治保护 | 2 | 0 | 0 | 2 | 0 | 0.0% |
| D_BACKTEST | 回测 | 17 | 9 | 0 | 8 | 0 | 52.9% |
| D_BEHAVIORAL_AUDIT | 行为审计 | 0 | 0 | 0 | 0 | 0 | N/A |
| D_COMPLIANCE | 合规 | 2 | 0 | 0 | 2 | 0 | 0.0% |
| D_CROSS_ASSET | 跨资产 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_DATA | 数据接入层 | 62 | 14 | 5 | 43 | 0 | 22.6% |
| D_DATA_ENG | 数据工程 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_DATA_GOV | 数据治理 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_DATA_SEC | 数据安全与契约 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_DIGITAL_TWIN | 数字孪生 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_EXEC_SIM | 执行仿真 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_EX_CORE | 执行核心 | 7 | 4 | 0 | 3 | 0 | 57.1% |
| D_EX_SOR | 执行路由 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_FACTOR | 因子 | 5 | 2 | 0 | 3 | 0 | 40.0% |
| D_FBL_DETECTORS | 反馈检测器 | 65 | 59 | 0 | 6 | 0 | 90.8% |
| D_FBL_DIAGNOSERS | 反馈诊断器 | 76 | 69 | 0 | 7 | 0 | 90.8% |
| D_FBL_VERIFICATION | 反馈验证 | 71 | 67 | 0 | 4 | 0 | 94.4% |
| D_FEEDBACK_LOOP | 反馈循环引擎 | 125 | 111 | 0 | 14 | 0 | 88.8% |
| D_FRONTEND | 前端 | 12 | 9 | 0 | 3 | 0 | 75.0% |
| D_FUNDAMENTAL_SIGNAL | 基本面信号 | 10 | 4 | 0 | 6 | 0 | 40.0% |
| D_GOVERNANCE | 生命周期管理 | 218 | 97 | 1 | 120 | 0 | 44.5% |
| D_GOV_AUDIT | 审计追踪 | 124 | 72 | 8 | 44 | 0 | 58.1% |
| D_GOV_CODE_QUALITY | 代码质量治理 | 162 | 132 | 5 | 25 | 0 | 81.5% |
| D_GOV_DOCS | 架构文档治理 | 26 | 0 | 24 | 2 | 0 | 0.0% |
| D_GOV_DRIFT | 漂移检测 | 75 | 69 | 1 | 5 | 0 | 92.0% |
| D_GOV_ENFORCEMENT | 规则执行 | 40 | 15 | 2 | 23 | 0 | 37.5% |
| D_GOV_KB | Governance Knowledge Base | 0 | 0 | 0 | 0 | 0 | N/A |
| D_GOV_OPS_RESILIENCE | 运维弹性治理 | 91 | 81 | 0 | 10 | 0 | 89.0% |
| D_GOV_REPAIR | 治理修复 | 1 | 1 | 0 | 0 | 0 | 100.0% |
| D_GOV_RULE | 规则治理 | 35 | 31 | 0 | 4 | 0 | 88.6% |
| D_GOV_SCRIPTS | 脚本治理 | 377 | 11 | 1 | 365 | 0 | 2.9% |
| D_INFRASTRUCTURE | 跨层契约基础设施 | 26 | 12 | 0 | 14 | 0 | 46.2% |
| D_INFRA_A2A | A2A通信 | 72 | 28 | 0 | 44 | 0 | 38.9% |
| D_INFRA_OPS | 基础设施运维 | 0 | 0 | 0 | 0 | 0 | N/A |
| D_INFRA_RECOVERY | 回滚恢复 | 55 | 48 | 0 | 7 | 0 | 87.3% |
| D_INFRA_RUNTIME | 运行时集成 | 162 | 119 | 1 | 42 | 0 | 73.5% |
| D_INFRA_TELEMETRY | 可观测性 | 0 | 0 | 0 | 0 | 0 | N/A |
| D_INTEGRATION | 管线路由 | 72 | 39 | 0 | 33 | 0 | 54.2% |
| D_INTEGRATION_GATEWAY | 集成网关 | 0 | 0 | 0 | 0 | 0 | N/A |
| D_INTELLIGENCE | 上下文管理 | 31 | 19 | 0 | 12 | 0 | 61.3% |
| D_KNOWLEDGE | 知识管理 | 1 | 0 | 1 | 0 | 0 | 0.0% |
| D_MKT_DATA | 行情数据 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_ML_SERVE | 推理 | 7 | 0 | 0 | 7 | 0 | 0.0% |
| D_ML_TRAIN | 训练 | 4 | 0 | 1 | 3 | 0 | 0.0% |
| D_OPS | 反馈循环 | 11 | 8 | 0 | 3 | 0 | 72.7% |
| D_ORCHESTRATOR | 代理编排器 | 70 | 54 | 0 | 16 | 0 | 77.1% |
| D_PF_ALLOC | 组合分配 | 2 | 1 | 0 | 1 | 0 | 50.0% |
...
| D_COMPLIANCE | 合规 | 2 | 0 | 0.0% |
| D_CROSS_ASSET | 跨资产 | 7 | 0 | 0.0% |
| D_DATA_ENG | 数据工程 | 7 | 0 | 0.0% |
| D_DATA_GOV | 数据治理 | 7 | 0 | 0.0% |
| D_DATA_SEC | 数据安全与契约 | 7 | 0 | 0.0% |
| D_DIGITAL_TWIN | 数字孪生 | 7 | 0 | 0.0% |

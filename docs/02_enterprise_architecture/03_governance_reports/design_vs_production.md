...
|-----------|:---:|:---:|
| production（生产态） | 1528 | 57.7% |
| design（设计态） | 62 | 2.3% |
| prototype（原型态） | 1060 | 40.0% |
...
| D_AUTONOMY_CORE | 自治核心 | 131 | 126 | 0 | 5 | 0 | 96.2% |
...
| D_FEEDBACK_LOOP | 反馈循环引擎 | 124 | 110 | 0 | 14 | 0 | 88.7% |
| D_FRONTEND | 前端 | 18 | 9 | 6 | 3 | 0 | 50.0% |
| D_FUNDAMENTAL_SIGNAL | 基本面信号 | 10 | 4 | 0 | 6 | 0 | 40.0% |
| D_GOVERNANCE | 生命周期管理 | 212 | 96 | 1 | 115 | 0 | 45.3% |
| D_GOV_AUDIT | 审计追踪 | 102 | 66 | 2 | 34 | 0 | 64.7% |
| D_GOV_CODE_QUALITY | 代码质量治理 | 135 | 115 | 0 | 20 | 0 | 85.2% |
| D_GOV_DOCS | 架构文档治理 | 28 | 0 | 28 | 0 | 0 | 0.0% |
| D_GOV_DRIFT | 漂移检测 | 74 | 69 | 1 | 4 | 0 | 93.2% |
...
| D_INTEGRATION | 管线路由 | 72 | 40 | 0 | 32 | 0 | 55.6% |
...
| D_ORCHESTRATOR | 代理编排器 | 72 | 56 | 0 | 16 | 0 | 77.8% |
...
| D_SHARED | 共享服务 | 184 | 112 | 0 | 72 | 0 | 60.9% |

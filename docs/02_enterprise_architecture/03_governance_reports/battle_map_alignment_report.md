...
- 生成时间: 2026-08-04 17:40:12
- 数据源: depgraph (PostgreSQL)
- 三表统计: steps=285 / anchors=392 / edges=119 / 叙事真源=285
- 业务域模块: 1767（BM-INV-007 扫描范围，业务域白名单内 depgraph 节点）
- 问题总数: 1141
  ...
  - 孤儿模块（BM-INV-007，业务域模块无作战锚点=造出来没用上）: 1141
...
| MOD-ML-003 | Training Dataset Manager | D_ML_TRAIN | planned | src/zephyr/ml_train/training_dataset_manager/ |
...
| MOD-EX-051 | Value Objects | D_EX_CORE | planned | src/zephyr/ex_core/value_objects.py |
...
| MOD-POS-005 | Cross Strategy Position Merger | D_POSITION | planned | src/zephyr/position/core/cross_strategy_position_merger.py |
| MOD-POS-011 | Covariance Estimator | D_POSITION | planned | src/zephyr/position/core/covariance_estimator.py |
| MOD-H1_REDIS_HOT | H1 Factor Source | D_INFRA_RUNTIME | deprecated | src/zephyr/infrastructure/h1_redis_hot/h1_factor_source.py |
| MOD-POS-015 | Position Time Budget | D_POSITION | planned | src/zephyr/position/core/position_time_budget.py |
| MOD-EX-012 | Execution Tca | D_EX_CORE | planned | src/zephyr/ex_core/execution_tca.py |
| MOD-EX-021 | Deployment Consistency Manager | D_EX_CORE | planned | src/zephyr/ex_core/deployment_consistency_manager.py |
| MOD-EX-036 | Performance Monitor | D_EX_CORE | planned | src/zephyr/ex_core/performance_monitor.py |
| MOD-L00-005 | 连接器 | D_DATA | planned | src/zephyr/data/connectors/ |
| MOD-L00-007 | 存储 | D_DATA | planned | src/zephyr/data/storage/ |
| MOD-L00-004 | Data Lineage | D_DATA | deprecated | src/zephyr/data/data_lineage/ |
| MOD-L00-004 | Zephyr.data | D_DATA | deprecated | zephyr.data.kline_resampler |
| MOD-L00-004 | Zephyr.data | D_DATA | deprecated | zephyr.data.sector_snapshot_collector |
...
| MOD-RSK-009 | Ashare Stop Loss Rule Engine | D_RISK | deprecated | src/zephyr/risk/ashare_stop_loss_rule_engine.py |
...
| MOD-INF-034 | Blueprint | D_ML_TRAIN | planned | docs/03_modules/_cross_layer/model_profiler/blueprint.md |
...
| MOD-RISK-001 | Drawdown Tracker | D_RISK | deprecated | src/zephyr/risk/drawdown_tracker/ |
| MOD-PF-004 | Min Variance Strategy | D_PF_CORE | deprecated | src/zephyr/pf_core/strategies/min_variance_strategy.py |
...
| MOD-INF-034 | Benchmark Suite | D_INTELLIGENCE | generated | src/zephyr/intelligence/model_profiling/benchmark_suite.py |
| MOD-INF-029 | Db | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/db.py |
| MOD-INF-030 | Cleanup | D_SECURITY | generated | src/zephyr/security/adversarial_validation/cleanup.py |
| MOD-INF-011 | Blueprint | D_KNOWLEDGE | planned | docs/03_modules/_domain_knowledge/vector_memory/blueprint.md |
| MOD-RESOURCE_OPTIMIZATION_ENGINE | Gpu Monitor | D_TRADING | generated | src/zephyr/trading/gpu_monitor.py |
| MOD-INF-035 | —从情节记忆到语义记忆的转化 / Dream Cycle | D_INFRA_RUNTIME | stable | src/zephyr/trading/dream_cycle.py |
| MOD-PF-005 | Risk Parity Strategy | D_PF_CORE | deprecated | src/zephyr/pf_core/strategies/risk_parity_strategy.py |
...
| MOD-POS-012 | Correlation Regime Monitor | D_POSITION | planned | src/zephyr/position/core/correlation_regime_monitor.py |
| MOD-POS-013 | Position Risk Budget Allocator | D_POSITION | planned | src/zephyr/position/core/position_risk_budget_allocator.py |
| MOD-POS-018 | Intraday Position Constraint | D_POSITION | planned | src/zephyr/position/core/intraday_position_constraint.py |
| MOD-POS-019 | Position Behavior Classifier | D_POSITION | planned | src/zephyr/position/core/position_behavior_classifier.py |
| MOD-EX-052 | Factory | D_EX_CORE | planned | src/zephyr/ex_core/factory.py |
| MOD-EX-058 | Miniqmt Channel Manager | D_EX_CORE | planned | src/zephyr/ex_core/miniqmt_channel_manager.py |
| MOD-EX-037 | Blueprint Implementer | D_EX_CORE | planned | src/zephyr/ex_core/blueprint_implementer.py |
| MOD-EX-060 | Rl Optimal Executor | D_EX_CORE | planned | src/zephyr/ex_core/rl_optimal_executor.py |
| MOD-EX-061 | Microstructure Modeler | D_EX_CORE | planned | src/zephyr/ex_core/microstructure_modeler.py |
| MOD-RSK-011 | Drawdown Realtime Tracker | D_RISK | deprecated | src/zephyr/risk/drawdown_realtime_tracker.py |
| MOD-RSK-010 | Ashare Systemic Risk Detector | D_RISK | deprecated | src/zephyr/risk/ashare_systemic_risk_detector.py |
...
| MOD-INF-011 | Vms Schemas | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/vms_schemas.py |
| MOD-INF-034 | Provider Data | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/provider_data.py |
...
| MOD-LLM_SECURITY | L6 Data Flow | D_SECURITY | generated | src/zephyr/security/llm_defense/llm_security/layers/l6_data_flow.py |
| MOD-L13-001 | 当前 UTC 时间 / Pipeline Base | D_SIMULATION | stable | src/zephyr/simulation/pipeline_base.py |
| MOD-L13-001 | Default Experiment Pipeline | D_SIMULATION | stable | src/zephyr/simulation/implementations/default_experiment_pipeline.py |
...
| MOD-L00-001 | Strategy Lifecycle Event | D_TRADING | generated | src/zephyr/trading/trading_contracts/portfolio/contracts/strategy_lifecycle_event.py |
| MOD-L00-001 | Money | D_TRADING | generated | src/zephyr/trading/trading_contracts/portfolio/contracts/money.py |
...
| MOD-L00-004 | Start Ch Health Probe | D_DATA | generated | scripts/start_ch_health_probe.ps1 |
...
| MOD-EX-049 | Aggregate Root Manager | D_EX_CORE | stable | src/zephyr/ex_core/aggregate_root_manager.py |
| MOD-EX-050 | Repository Interface | D_EX_CORE | stable | src/zephyr/ex_core/repository_interface.py |
| MOD-EX-055 | Multi Contract Adapter | D_EX_CORE | stable | src/zephyr/ex_core/multi_contract_adapter.py |
...
| MOD-FEEDBACK_LOOP | OpenFeature Integration — v0.13.0 R181 | D_FBL_DETECTORS | stable | src/zephyr/feedback_loop/detectors/reliability/openfeature.py |
...
| MOD-GOVERNANCE | Observability Dashboard | D_OPS | stable | src/zephyr/governance/observability_governance/observability_dashboard.py |
| MOD-INF-022 | Budget Handler | D_OPS | stable | src/zephyr/governance/ops_governance/budget_handler.py |
| MOD-INF-024 | Budget Models | D_OPS | stable | src/zephyr/governance/ops_governance/budget_models.py |
| MOD-INF-024 | Budget Profile Manager | D_OPS | stable | src/zephyr/governance/ops_governance/budget_profile_manager.py |
| MOD-INF-024 | —5.133.2 DI 注入契约 / Budget Engine | D_OPS | stable | src/zephyr/governance/ops_governance/budget_engine.py |
| MOD-INF-024 | Budget Tracker | D_OPS | stable | src/zephyr/governance/ops_governance/budget_tracker.py |
...
| MOD-INF-023 | Alert Router | D_SECURITY | generated | src/zephyr/gov_drift/alert_router.py |
| MOD-INF-023 | Cold Start | D_SECURITY | stable | src/zephyr/gov_drift/cold_start.py |
| MOD-INF-023 | Reconciler | D_SECURITY | generated | src/zephyr/gov_drift/reconciler.py |
| MOD-INF-023 | 构造 YAML frontmatter / Runbook Generator | D_SECURITY | generated | src/zephyr/gov_drift/runbook_generator.py |
| MOD-INF-023 | State Machine | D_SECURITY | generated | src/zephyr/gov_drift/state_machine.py |
| MOD-INF-011 | Analysis | D_SECURITY | generated | src/zephyr/gov_drift/_analysis.py |
| MOD-INF-011 | Core | D_SECURITY | generated | src/zephyr/gov_drift/_core.py |
| MOD-INF-011 | Infrastructure | D_SECURITY | generated | src/zephyr/gov_drift/_infrastructure.py |
| MOD-INF-011 | Scanners | D_SECURITY | generated | src/zephyr/gov_drift/_scanners.py |
| MOD-INF-011 | Drift | D_SECURITY | generated | src/zephyr/gov_drift/_drift.py |
| MOD-INF-023 | Main | D_SECURITY | generated | src/zephyr/gov_drift/__main__.py |
...
| MOD-INF-031 | Alignment Syncer | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/auto_fix_engine/alignment_syncer.py |
...
| MOD-INF-031 | Drift Fixer | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/drift_fixer.py |
...
| MOD-INF-031 | Engine | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/engine.py |
| MOD-INF-031 | Escalation Bridge | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/escalation_bridge.py |
| MOD-INF-031 | Dep Version Fixer | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/dep_version_fixer.py |
| MOD-INF-031 | Fix Diff | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/fix_diff.py |
| MOD-INF-031 | Fix Budget | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/fix_budget.py |
...
| MOD-INF-031 | Fix Scheduler | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/fix_scheduler.py |
| MOD-INF-031 | Models | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/models.py |
| MOD-INF-031 | Import Fixer | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/auto_fix_engine/import_fixer.py |
...
| MOD-INF-031 | Shadow Workspace | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/shadow_workspace.py |
...
| MOD-INF-031 | Self Heal Agent | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/self_heal_agent.py |
...
| MOD-INF-031 | Main | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/auto_fix_engine/__main__.py |
...
| MOD-INF-031 | State Machine | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/auto_fix_engine/state_machine.py |
| MOD-INF-001 | Kill Switch | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/capacity_assurance/kill_switch.py |
...
| MOD-INF-001 | Token Budget | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/capacity_assurance/token_budget.py |
...
| MOD-INF-016 | Event Store | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/events/event_store.py |
...
| MOD-INF-035 | Health Aggregator | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/health_monitor/health_aggregator.py |
...
| MOD-INF-016 | Task Lifecycle Manager | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/lifecycle/task_lifecycle_manager.py |
...
| MOD-INF-009 | Backpressure Types | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/pipeline/backpressure_types.py |
| MOD-INF-016 | Trace Decorator | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/observability/trace_decorator.py |
| MOD-INF-009 | Backpressure Manager | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/pipeline/backpressure_manager.py |
...
| MOD-INF-009 | Llm Gateway | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/pipeline/llm_gateway.py |
...
| MOD-INF-009 | Models | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/pipeline/models.py |
| MOD-INF-009 | Ct Pipe Routing | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/pipeline/ct_pipe_routing.py |
| MOD-INF-009 | Routing Plugins | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/pipeline/routing_plugins.py |
| MOD-INF-016 | Quality Monitor | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/quality/quality_monitor.py |
| MOD-INF-009 | Pipeline Lock | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/pipeline/pipeline_lock.py |
...
| MOD-INF-016 | Circuit Breaker | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/reliability/circuit_breaker.py |
...
| MOD-GOVERNANCE | Startup Shutdown | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/runtime/startup_shutdown.py |
...
| MOD-INF-005 | Finding | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/script_system/finding.py |
| MOD-INF-015 | 全自动遥测注入钩子 / Auto Bootstrap | D_INFRA_RUNTIME | stable | src/zephyr/infrastructure/system_telemetry/auto_bootstrap.py |
| MOD-INF-015 | Metrics Bridge | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/system_telemetry/metrics_bridge.py |
| MOD-INF-015 | 系统遥测门面类 / Facade | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/system_telemetry/facade.py |
| MOD-INF-015 | Trace Bridge | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/system_telemetry/_trace_bridge.py |
| MOD-INF-005 | Gate Bridge | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/script_system/gate_bridge.py |
...
| MOD-INF-015 | Budget Telemetry Bridge | D_INFRA_RUNTIME | generated | src/zephyr/infrastructure/system_telemetry/_budget_telemetry_bridge.py |
...
| MOD-INF-009 | Pipeline Orchestrator | D_INTEGRATION | stable | src/zephyr/integration/pipeline_orchestrator.py |
| MOD-GOVERNANCE | Admission Response | D_INTEGRATION | stable | src/zephyr/integration/behavioral_admission/admission_response.py |
| MOD-INF-001 | Degradation Spiral Detector | D_INTEGRATION | generated | src/zephyr/integration/budget_enforcer/degradation_spiral_detector.py |
| MOD-INF-009 | Ports | D_INTEGRATION | generated | src/zephyr/integration/ports.py |
| MOD-INF-042 | Stage 4 公共化 / Cache Layer | D_INTEGRATION | stable | src/zephyr/integration/local_model/cache_layer.py |
| MOD-INF-042 | Local Model Scheduler | D_INTEGRATION | generated | src/zephyr/integration/local_model/local_model_scheduler.py |
| MOD-INF-042 | Ollama Chat | D_INTEGRATION | generated | src/zephyr/integration/local_model/ollama_chat.py |
...
| MOD-INF-013 | Blueprint Search Server | D_INTEGRATION | stable | src/zephyr/integration/mcp/blueprint_search_server.py |
...
| MOD-INF-013 | Task Manager Server | D_INTEGRATION | stable | src/zephyr/integration/mcp/task_manager_server.py |
| MOD-INF-014 | Rule Discovery Server | D_INTEGRATION | stable | src/zephyr/integration/mcp/rule_discovery_server.py |
| MOD-INF-013 | Vector Memory Server | D_INTEGRATION | generated | src/zephyr/integration/mcp/vector_memory_server.py |
| MOD-INF-013 | Stage 1 关键词匹配，返回 / Sentinel Server | D_INTEGRATION | stable | src/zephyr/integration/mcp/sentinel_server.py |
| MOD-INTEGRATION | Contract Violation Error | D_INTEGRATION | generated | src/zephyr/integration/shared/contracts/errors/contract_violation_error.py |
| MOD-INTEGRATION | Factor Computation Error | D_INTEGRATION | generated | src/zephyr/integration/shared/contracts/errors/factor_computation_error.py |
| MOD-INF-009 | Risk Limit Violation Error | D_INTEGRATION | generated | src/zephyr/integration/shared/contracts/errors/risk_limit_violation_error.py |
| MOD-INF-009 | Execution Rejection Error | D_INTEGRATION | generated | src/zephyr/integration/shared/contracts/errors/execution_rejection_error.py |
| MOD-INTEGRATION | Data Quality Error | D_INTEGRATION | generated | src/zephyr/integration/shared/contracts/errors/data_quality_error.py |
| MOD-INF-016 | Event Bus Upgrade | D_INTEGRATION | generated | src/zephyr/integration/shared/events/event_bus_upgrade.py |
| MOD-INF-016 | Dlq Bridge | D_INTEGRATION | generated | src/zephyr/integration/shared/events/dlq_bridge.py |
| MOD-INF-009 | Signal Degradation Warning | D_INTEGRATION | generated | src/zephyr/integration/shared/contracts/errors/signal_degradation_warning.py |
...
| MOD-INF-011 | Collection Manager | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/collection_manager.py |
| MOD-INF-011 | Collection Schemas | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/collection_schemas.py |
| MOD-INF-011 | Bridge Layer | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/bridge_layer.py |
| MOD-INF-011 | Design Principles | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/design_principles.py |
| MOD-INF-011 | Chunk Strategy Router | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/chunk_strategy_router.py |
| MOD-INF-011 | Context Ingest | D_INTEGRATION | generated | src/zephyr/integration/vector_memory/context_ingest.py |
| MOD-INF-028 | MOD-INF-011 稀疏检索组件 / Bm25 Index | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/bm25_index.py |
| MOD-INF-011 | Hybrid Retriever | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/hybrid_retriever.py |
...
| MOD-INF-011 | Cross Collection Retriever | D_INTEGRATION | generated | src/zephyr/integration/vector_memory/cross_collection_retriever.py |
| MOD-INF-011 | Index Health Monitor | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/index_health_monitor.py |
...
| MOD-INF-011 | In Memory Memory Backend | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/in_memory_memory_backend.py |
| MOD-INF-011 | 单条记忆条目 / Interface | D_INTEGRATION | generated | src/zephyr/integration/vector_memory/interface.py |
| MOD-INF-011 | Migrate Chroma To Faiss | D_INTEGRATION | generated | src/zephyr/integration/vector_memory/migrate_chroma_to_faiss.py |
...
| MOD-INF-011 | In Process Vector Memory | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/in_process_vector_memory.py |
| MOD-INF-011 | Sqlite Metadata Store | D_INTEGRATION | generated | src/zephyr/integration/vector_memory/sqlite_metadata_store.py |
...
| MOD-INF-011 | Vector Bridge | D_INTEGRATION | generated | src/zephyr/integration/vector_memory/vector_bridge.py |
| MOD-INF-011 | Faiss Collection Manager | D_INTEGRATION | generated | src/zephyr/integration/vector_memory/faiss_collection_manager.py |
...
| MOD-INF-011 | Vms Errors | D_INTEGRATION | stable | src/zephyr/integration/vector_memory/vms_errors.py |
| MOD-INF-036 | Activate | D_INTELLIGENCE | generated | src/zephyr/intelligence/model_evaluation/activate.py |
| MOD-INF-036 | Reranker | D_INTELLIGENCE | generated | src/zephyr/intelligence/model_evaluation/reranker.py |
| MOD-INF-036 | Default Inference Engine | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_evaluation/implementations/default_inference_engine.py |
| MOD-INF-036 | Inference Base | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_evaluation/inference_base.py |
...
| MOD-INF-036 | Memory Backend | D_INTELLIGENCE | generated | src/zephyr/intelligence/model_evaluation/_memory_backend.py |
...
| MOD-INF-034 | Cli | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/cli.py |
| MOD-INF-034 | Deepseek V4 Chat | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/deepseek_v4_chat.py |
...
| MOD-INF-034 | Exam Orchestrator | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/exam_orchestrator.py |
| MOD-INF-034 | Exam Test Cases | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/exam_test_cases.py |
...
| MOD-INF-034 | Profiler | D_INTELLIGENCE | generated | src/zephyr/intelligence/model_profiling/profiler.py |
| MOD-INF-034 | Benchmark Suite | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/pipeline_routing/benchmark_suite.py |
| MOD-INF-034 | Task Model Learner | D_INTELLIGENCE | generated | src/zephyr/intelligence/model_profiling/task_model_learner.py |
...
| MOD-INF-034 | Cli | D_INTELLIGENCE | generated | src/zephyr/intelligence/model_profiling/pipeline_routing/cli.py |
...
| MOD-INF-034 | Profiler | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/pipeline_routing/profiler.py |
| MOD-INF-034 | Task Model Learner | D_INTELLIGENCE | stable | src/zephyr/intelligence/model_profiling/pipeline_routing/task_model_learner.py |
| MOD-ML_SERVE | Init | D_ML_SERVE | generated | src/zephyr/ml_serve/__init__.py |
| MOD-ML_SERVE | Init | D_ML_SERVE | generated | src/zephyr/ml_serve/api/__init__.py |
| MOD-ML_SERVE | Init | D_ML_SERVE | generated | src/zephyr/ml_serve/infrastructure/__init__.py |
| MOD-ML_SERVE | Init | D_ML_SERVE | generated | src/zephyr/ml_serve/core/__init__.py |
| MOD-ML_SERVE | Init | D_ML_SERVE | generated | src/zephyr/ml_serve/models/__init__.py |
| MOD-ML_SERVE | Init | D_ML_SERVE | generated | src/zephyr/ml_serve/services/__init__.py |
| MOD-ML_SERVE | Init | D_ML_SERVE | generated | src/zephyr/ml_serve/_extensions/__init__.py |
| MOD-FEEDBACK_LOOP | Alert Handler | D_ORCHESTRATOR | generated | src/zephyr/orchestrator/contracts/alert_handler.py |
| MOD-INF-016 | Strategy Lifecycle Event | D_PF_ALLOC | generated | src/zephyr/pf_alloc/strategy_lifecycle_event.py |
| MOD-INF-022 | —事件驱动 / Position Reconciler | D_POSITION | stable | src/zephyr/position/position_reconciler.py |
| MOD-POS_SERVICES | Init | D_POSITION | generated | src/zephyr/position/services/__init__.py |
| MOD-INF-030 | Init | D_SECURITY | generated | src/zephyr/red_blue_validator/__init__.py |
| MOD-RPT-004 | Realtime Pnl Dashboard | D_REPORTING | stable | src/zephyr/reporting/realtime_pnl_dashboard.py |
| MOD-RPT-013 | Report Version Manager | D_REPORTING | stable | src/zephyr/reporting/report_version_manager.py |
| MOD-RPT-017 | Report Watermark Tracker | D_REPORTING | stable | src/zephyr/reporting/report_watermark_tracker.py |
| MOD-INF-029 | Config Loader | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/config_loader.py |
...
| MOD-INF-029 | Drift Bridge | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/drift_bridge.py |
| MOD-INF-029 | Kb Bridge | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/kb_bridge.py |
...
| MOD-INF-029 | Escalation Bridge | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/escalation_bridge.py |
| MOD-INF-029 | Feedback Bridge | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/feedback_bridge.py |
| MOD-INF-029 | Models | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/models.py |
| MOD-INF-029 | Mcp Integration | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/mcp_integration.py |
...
| MOD-INF-029 | Report Generator | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/report_generator.py |
| MOD-INF-029 | Rbac Bridge | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/rbac_bridge.py |
...
| MOD-INF-029 | Orphan Detector | D_SECURITY | stable | src/zephyr/security/access_control/orphan_judge/orphan_detector.py |
| MOD-INF-029 | Main | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/__main__.py |
| MOD-INF-029 | Swid Tag | D_SECURITY | generated | src/zephyr/security/access_control/orphan_judge/swid_tag.py |
| MOD-INF-030 | Ai Attack Generator | D_SECURITY | generated | src/zephyr/security/adversarial_validation/ai_attack_generator.py |
| MOD-INF-030 | Async Monitor | D_SECURITY | stable | src/zephyr/security/adversarial_validation/async_monitor.py |
| MOD-INF-030 | Blast Radius | D_SECURITY | generated | src/zephyr/security/adversarial_validation/blast_radius.py |
| MOD-INF-030 | 写入：state / Circuit Breaker | D_SECURITY | stable | src/zephyr/security/adversarial_validation/circuit_breaker.py |
| MOD-INF-030 | Attack Registry | D_SECURITY | generated | src/zephyr/security/adversarial_validation/attack_registry.py |
| MOD-INF-030 | Bypass Recorder | D_SECURITY | generated | src/zephyr/security/adversarial_validation/bypass_recorder.py |
| MOD-INF-030 | Commit Trigger | D_SECURITY | generated | src/zephyr/security/adversarial_validation/commit_trigger.py |
| MOD-INF-030 | Cli | D_SECURITY | generated | src/zephyr/security/adversarial_validation/cli.py |
| MOD-INF-030 | Constitution Guard | D_SECURITY | generated | src/zephyr/security/adversarial_validation/constitution_guard.py |
| MOD-INF-030 | Constitution Engine | D_SECURITY | stable | src/zephyr/security/adversarial_validation/constitution_engine.py |
| MOD-INF-030 | Defense Runner | D_SECURITY | generated | src/zephyr/security/adversarial_validation/defense_runner.py |
| MOD-INF-030 | Cold Start | D_SECURITY | generated | src/zephyr/security/adversarial_validation/cold_start.py |
| MOD-INF-030 | Game Day Runner | D_SECURITY | generated | src/zephyr/security/adversarial_validation/game_day_runner.py |
| MOD-INF-030 | Convergence Checker | D_SECURITY | generated | src/zephyr/security/adversarial_validation/convergence_checker.py |
| MOD-INF-030 | Game Day Scheduler | D_SECURITY | stable | src/zephyr/security/adversarial_validation/game_day_scheduler.py |
| MOD-INF-030 | Injection Engine | D_SECURITY | generated | src/zephyr/security/adversarial_validation/injection_engine.py |
| MOD-INF-030 | Scenario Loader | D_SECURITY | generated | src/zephyr/security/adversarial_validation/scenario_loader.py |
| MOD-INF-030 | Mcp Endpoints | D_SECURITY | generated | src/zephyr/security/adversarial_validation/mcp_endpoints.py |
| MOD-INF-030 | Steady State | D_SECURITY | generated | src/zephyr/security/adversarial_validation/steady_state.py |
| MOD-INF-030 | Models | D_SECURITY | stable | src/zephyr/security/adversarial_validation/models.py |
...
| MOD-INF-030 | Main | D_SECURITY | generated | src/zephyr/security/adversarial_validation/__main__.py |
| MOD-LLM_SECURITY | Behavior Audit Logger | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/behavior_audit_logger.py |
| MOD-LLM_SECURITY | Input Sanitizer | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/input_sanitizer.py |
| MOD-LLM_SECURITY | Gateway | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/gateway.py |
| MOD-LLM_SECURITY | Process Sandbox | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/process_sandbox.py |
...
| MOD-LLM_SECURITY | L0 Supply Chain | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/layers/l0_supply_chain.py |
| MOD-LLM_SECURITY | App | D_SECURITY | generated | src/zephyr/security/llm_defense/llm_security/dashboard/app.py |
...
| MOD-LLM_SECURITY | L2a Process Sandbox | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/layers/l2a_process_sandbox.py |
...
| MOD-LLM_SECURITY | L8 Compliance | D_SECURITY | generated | src/zephyr/security/llm_defense/llm_security/layers/l8_compliance.py |
| MOD-LLM_SECURITY | L8 Multi Agent | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/layers/l8_multi_agent.py |
...
| MOD-LLM_SECURITY | L6 Observability | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/layers/l6_observability.py |
| MOD-LLM_SECURITY | Secrets | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/patterns/secrets.py |
...
| MOD-LLM_SECURITY | Injection Patterns | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/patterns/injection_patterns.py |
...
| MOD-LLM_SECURITY | L7 Validation | D_SECURITY | stable | src/zephyr/security/llm_defense/llm_security/self_protection/l7_validation.py |
...
| MOD-SELL_DECISION | Init | D_SELL_DECISION | generated | src/zephyr/sell_decision/__init__.py |
| MOD-SELL_DECISION | Init | D_SELL_DECISION | generated | src/zephyr/sell_decision/api/__init__.py |
| MOD-SELL_DECISION | Init | D_SELL_DECISION | generated | src/zephyr/sell_decision/infrastructure/__init__.py |
| MOD-SELL_DECISION | Init | D_SELL_DECISION | generated | src/zephyr/sell_decision/models/__init__.py |
| MOD-SELL_DECISION | Init | D_SELL_DECISION | generated | src/zephyr/sell_decision/services/__init__.py |
| MOD-INF-016 | 任务生命周期事件类型 / Event Bus | D_SHARED | stable | src/zephyr/shared/event_bus.py |
| MOD-SELL_DECISION | Init | D_SELL_DECISION | generated | src/zephyr/sell_decision/_extensions/__init__.py |
| MOD-INF-016 | 只读：default_params / Execution Tuner | D_SHARED | stable | src/zephyr/shared/adaptation/execution_tuner.py |
| MOD-INF-016 | Combinatorial Gate | D_SHARED | stable | src/zephyr/shared/ai_guards/combinatorial_gate.py |
| MOD-INF-016 | Ai Audit Guard | D_SHARED | stable | src/zephyr/shared/ai_guards/ai_audit_guard.py |
| MOD-INF-016 | Core Integrity Guard | D_SHARED | stable | src/zephyr/shared/ai_guards/core_integrity_guard.py |
| MOD-INF-016 | 最低兼容的 Shared 版本 / Version | D_SHARED | stable | src/zephyr/shared/__version__.py |
| MOD-INF-016 | Alert Precision Tracker | D_SHARED | stable | src/zephyr/shared/alerts/alert_precision_tracker.py |
| MOD-INF-016 | Alert Escalation | D_SHARED | stable | src/zephyr/shared/alerts/alert_escalation.py |
| MOD-INF-016 | 只读：data_dir / Prompt Version Manager | D_SHARED | stable | src/zephyr/shared/adaptation/prompt_version_manager.py |
| MOD-INF-016 | Api Index | D_SHARED | generated | src/zephyr/shared/api/api_index.py |
| MOD-INF-016 | Dual Channel Alert | D_SHARED | stable | src/zephyr/shared/alerts/dual_channel_alert.py |
| MOD-INF-016 | Heartbeat Server | D_SHARED | stable | src/zephyr/shared/alerts/heartbeat_server.py |
| MOD-INF-016 | —HTTP 错误、超时、协议不匹配 / Api Client | D_SHARED | generated | src/zephyr/shared/api/api_client.py |
| MOD-INF-016 | Ai Understandability Constraint | D_SHARED | stable | src/zephyr/shared/blueprint_tools/ai_understandability_constraint.py |
| MOD-INF-016 | Alert Manager | D_SHARED | stable | src/zephyr/shared/alerts/alert_manager.py |
| MOD-INF-016 | Dos Launcher | D_SHARED | stable | src/zephyr/shared/api/dos_launcher.py |
| MOD-INF-016 | Blueprint Scorer | D_SHARED | generated | src/zephyr/shared/blueprint_tools/blueprint_scorer.py |
...
| MOD-INF-016 | Budget Aware Prompt | D_SHARED | stable | src/zephyr/shared/capacity_governance/budget_aware_prompt.py |
| MOD-INF-016 | Blueprint Code Auditor | D_SHARED | stable | src/zephyr/shared/blueprint_tools/blueprint_code_auditor.py |
| MOD-INF-016 | Capacity Digital Twin | D_SHARED | stable | src/zephyr/shared/capacity_governance/capacity_digital_twin.py |
| MOD-INF-016 | Dependency Capacity Guard | D_SHARED | stable | src/zephyr/shared/capacity_governance/dependency_capacity_guard.py |
| MOD-INF-016 | Cost Estimator | D_SHARED | stable | src/zephyr/shared/capacity_governance/cost_estimator.py |
| MOD-INF-016 | Capacity Fingerprint | D_SHARED | stable | src/zephyr/shared/capacity_governance/capacity_fingerprint.py |
| MOD-INF-016 | Capacity Calibrator | D_SHARED | stable | src/zephyr/shared/capacity_governance/capacity_calibrator.py |
| MOD-INF-016 | Capacity Runbook Generator | D_SHARED | stable | src/zephyr/shared/capacity_governance/capacity_runbook_generator.py |
| MOD-INF-016 | 只读：sagas / Saga Compensator | D_SHARED | stable | src/zephyr/shared/compensation/saga_compensator.py |
| MOD-INF-016 | Model Capacity Probe | D_SHARED | stable | src/zephyr/shared/capacity_governance/model_capacity_probe.py |
| MOD-INF-016 | Approval Types | D_INTEGRATION | stable | src/zephyr/shared/contracts/approval_types.py |
...
| MOD-INF-016 | Orchestration Protocol | D_SHARED | generated | src/zephyr/shared/contracts/orchestration_protocol.py |
| MOD-INF-016 | Protocols | D_INTEGRATION | generated | src/zephyr/shared/contracts/protocols.py |
| MOD-INF-035 | Runtime Types | D_INTEGRATION | stable | src/zephyr/shared/contracts/runtime_types.py |
| MOD-INF-016 | Rollback Types | D_INTEGRATION | stable | src/zephyr/shared/contracts/rollback_types.py |
...
| MOD-INF-016 | Types | D_SHARED | generated | src/zephyr/shared/contracts/backpressure/_types.py |
| MOD-INF-016 | Throttle | D_SHARED | generated | src/zephyr/shared/contracts/backpressure/throttle.py |
| MOD-INF-016 | Pause | D_SHARED | generated | src/zephyr/shared/contracts/backpressure/pause.py |
| MOD-INF-016 | Resume | D_SHARED | generated | src/zephyr/shared/contracts/backpressure/resume.py |
...
| MOD-INF-016 | Contract Violation Error | D_SHARED | generated | src/zephyr/shared/contracts/errors/contract_violation_error.py |
| MOD-INF-016 | Data Quality Error | D_SHARED | generated | src/zephyr/shared/contracts/errors/data_quality_error.py |
| MOD-INF-016 | Execution Rejection Error | D_SHARED | generated | src/zephyr/shared/contracts/errors/execution_rejection_error.py |
| MOD-INF-016 | Signal Degradation Warning | D_SHARED | generated | src/zephyr/shared/contracts/errors/signal_degradation_warning.py |
| MOD-INF-016 | Factor Computation Error | D_SHARED | generated | src/zephyr/shared/contracts/errors/factor_computation_error.py |
| MOD-INF-016 | Risk Limit Violation Error | D_SHARED | generated | src/zephyr/shared/contracts/errors/risk_limit_violation_error.py |
| MOD-INF-016 | Capital Allocation Result | D_SHARED | generated | src/zephyr/shared/contracts/execution/capital_allocation_result.py |
| MOD-INF-016 | Budget Alert | D_SHARED | stable | src/zephyr/shared/contracts/escalation/budget_alert.py |
| MOD-INF-016 | Execution Report | D_SHARED | generated | src/zephyr/shared/contracts/execution/execution_report.py |
| MOD-INF-016 | Fill | D_SHARED | generated | src/zephyr/shared/contracts/execution/fill.py |
| MOD-INF-016 | Order | D_SHARED | generated | src/zephyr/shared/contracts/execution/order.py |
| MOD-INF-016 | Model Serving Request | D_SHARED | generated | src/zephyr/shared/contracts/execution/model_serving_request.py |
| MOD-INF-016 | Model Serving Response | D_SHARED | generated | src/zephyr/shared/contracts/experiment/model_serving_response.py |
| MOD-INF-016 | Experiment Result | D_SHARED | generated | src/zephyr/shared/contracts/experiment/experiment_result.py |
| MOD-INF-016 | Ext 002 | D_SHARED | generated | src/zephyr/shared/contracts/external/ext_002.py |
| MOD-INF-016 | Ext 003 | D_SHARED | generated | src/zephyr/shared/contracts/external/ext_003.py |
| MOD-INF-016 | Ext 001 | D_SHARED | generated | src/zephyr/shared/contracts/external/ext_001.py |
| MOD-INF-016 | Permission | D_SHARED | stable | src/zephyr/shared/contracts/identity/permission.py |
| MOD-INF-016 | Instrument | D_SHARED | generated | src/zephyr/shared/contracts/market/instrument.py |
| MOD-INF-016 | Ext 004 | D_SHARED | generated | src/zephyr/shared/contracts/external/ext_004.py |
| MOD-INF-016 | Agent Identity | D_SHARED | stable | src/zephyr/shared/contracts/identity/agent_identity.py |
| MOD-INF-016 | Money | D_SHARED | stable | src/zephyr/shared/contracts/portfolio/money.py |
| MOD-INF-016 | Compliance Rule | D_SHARED | generated | src/zephyr/shared/contracts/risk/compliance_rule.py |
| MOD-INF-016 | Risk Dashboard Snapshot | D_SHARED | stable | src/zephyr/shared/contracts/risk/risk_dashboard_snapshot.py |
| MOD-INF-016 | Risk Metrics | D_SHARED | stable | src/zephyr/shared/contracts/risk/risk_metrics.py |
| MOD-INF-016 | Risk Limits | D_SHARED | generated | src/zephyr/shared/contracts/risk/risk_limits.py |
| MOD-INF-016 | Position | D_SHARED | generated | src/zephyr/shared/contracts/portfolio/position.py |
| MOD-INF-016 | Risk Validator Protocol | D_SHARED | generated | src/zephyr/shared/contracts/risk/risk_validator_protocol.py |
| MOD-INF-016 | Security Decision | D_SHARED | stable | src/zephyr/shared/contracts/security/security_decision.py |
...
| MOD-GOVERNANCE | Evals | D_INTEGRATION | stable | src/zephyr/shared/evaluation/evals.py |
| MOD-INF-016 | 事件版本错误 / Event Bus Upgrade | D_SHARED | stable | src/zephyr/shared/events/event_bus_upgrade.py |
| MOD-INF-016 | Dlq Bridge | D_SHARED | generated | src/zephyr/shared/events/dlq_bridge.py |
...
| MOD-INF-016 | Constants | D_SHARED | stable | src/zephyr/shared/foundation/constants.py |
...
| MOD-INF-016 | Observer | D_SHARED | stable | src/zephyr/shared/infra/observer.py |
...
| MOD-INF-016 | Content Fingerprint | D_SHARED | stable | src/zephyr/shared/io/content_fingerprint.py |
...
| MOD-INF-016 | Io Cache | D_SHARED | stable | src/zephyr/shared/io/io_cache.py |
...
| MOD-INF-016 | Health | D_SHARED | stable | src/zephyr/shared/lifecycle/health.py |
| MOD-INF-016 | —零侵入式 / Hooks | D_INFRA_RUNTIME | stable | src/zephyr/shared/lifecycle/hooks.py |
| MOD-INF-016 | Health Discovery | D_SHARED | stable | src/zephyr/shared/lifecycle/health_discovery.py |
| MOD-INF-016 | Streaming Reader | D_SHARED | stable | src/zephyr/shared/io/streaming_reader.py |
| MOD-INF-016 | Lazy Loader | D_INFRA_RUNTIME | stable | src/zephyr/shared/lifecycle/lazy_loader.py |
| MOD-INF-016 | Longevity Monitor | D_SHARED | stable | src/zephyr/shared/lifecycle/longevity_monitor.py |
| MOD-INF-016 | Daemon Registry | D_INFRA_RUNTIME | stable | src/zephyr/shared/lifecycle/daemon_registry.py |
| MOD-INF-016 | 只读：start_time / Healthcheck Service | D_SHARED | stable | src/zephyr/shared/lifecycle/healthcheck_service.py |
| MOD-INF-016 | Resource Optimization Models | D_INFRA_RUNTIME | stable | src/zephyr/shared/lifecycle/resource_optimization_models.py |
| MOD-INF-016 | Ttl Cleanup Engine | D_SHARED | stable | src/zephyr/shared/lifecycle/ttl_cleanup_engine.py |
| MOD-INF-038 | State Machine | D_SHARED | stable | src/zephyr/shared/lifecycle/state_machine.py |
| MOD-INF-016 | Task Heartbeat | D_SHARED | stable | src/zephyr/shared/lifecycle/task_heartbeat.py |
| MOD-INF-016 | Code Economy Analyzer | D_SHARED | stable | src/zephyr/shared/maintenance/code_economy_analyzer.py |
| SH-MAIN-001 | 只读：tasks / Dogfooding | D_SHARED | stable | src/zephyr/shared/maintenance/dogfooding.py |
| MOD-INF-016 | Slo Review Assistant | D_SHARED | stable | src/zephyr/shared/maintenance/slo_review_assistant.py |
| MOD-INF-016 | 只读：event_log / Autonomy Monitor | D_SHARED | stable | src/zephyr/shared/maintenance/autonomy_monitor.py |
| SH-MAIN-001 | Handbook | D_SHARED | stable | src/zephyr/shared/maintenance/handbook.py |
| MOD-INF-016 | Owner Trust Gauge | D_SHARED | stable | src/zephyr/shared/maintenance/owner_trust_gauge.py |
...
| MOD-INF-016 | Reasoning Spans | D_SHARED | stable | src/zephyr/shared/observability/reasoning_spans.py |
| MOD-INF-016 | Tracing | D_SHARED | stable | src/zephyr/shared/observability/tracing.py |
| MOD-INF-016 | Module Birth Registry | D_SHARED | stable | src/zephyr/shared/protocols/module_birth_registry.py |
...
| MOD-SHARED-001 | A2a Coordination | D_SHARED | generated | src/zephyr/shared/protocols/a2a/a2a_coordination.py |
| MOD-SHARED-001 | D-INFRA 通过此接口获取 DB 连接和路径 / Ports | D_SHARED | generated | src/zephyr/shared/protocols/ports.py |
| MOD-SHARED-001 | A2a Schemas | D_SHARED | generated | src/zephyr/shared/protocols/a2a/a2a_schemas.py |
| MOD-SHARED-001 | A2a Registry | D_SHARED | generated | src/zephyr/shared/protocols/a2a/a2a_registry.py |
| MOD-SHARED-001 | A2a Protocol | D_SHARED | generated | src/zephyr/shared/protocols/a2a/a2a_protocol.py |
...
| MOD-INF-016 | Base Config | D_SHARED | stable | src/zephyr/shared/schema/base_config.py |
| MOD-INF-016 | Error Budget Tracker | D_SHARED | stable | src/zephyr/shared/resilience/error_budget_tracker.py |
| MOD-GOVERNANCE | Durable Execution | D_INTEGRATION | stable | src/zephyr/shared/resilience/durable_execution.py |
| MOD-INF-016 | Degradation Chain | D_SHARED | stable | src/zephyr/shared/resilience/degradation_chain.py |
| MOD-INF-016 | Schemas | D_SHARED | stable | src/zephyr/shared/schema/schemas.py |
| MOD-INF-016 | Execution Model | D_SHARED | stable | src/zephyr/shared/schema/execution_model.py |
| MOD-INF-016 | —schema 不存在、版本冲突、兼容性违规 / Schema Registry | D_SHARED | stable | src/zephyr/shared/schema/schema_registry.py |
| MOD-INF-016 | Severity Types | D_SHARED | stable | src/zephyr/shared/schema/severity_types.py |
| MOD-INF-016 | —最后一次异常通过 __cause__ 链保留 / Retry | D_SHARED | stable | src/zephyr/shared/resilience/retry.py |
| MOD-INF-016 | Fault Isolator | D_SHARED | stable | src/zephyr/shared/resilience/fault_isolator.py |
| MOD-INF-016 | Task Types | D_SHARED | stable | src/zephyr/shared/schema/task_types.py |
| MOD-INF-016 | 全局审计写入器协议 / Session Audit | D_SHARED | stable | src/zephyr/shared/session/session_audit.py |
| MOD-INF-016 | Sandbox Executor | D_SHARED | stable | src/zephyr/shared/security/sandbox_executor.py |
...
| MOD-INF-016 | Secrets | D_SHARED | stable | src/zephyr/shared/security/secrets.py |
| MOD-INF-016 | Capability | D_SHARED | stable | src/zephyr/shared/security/capability.py |
| MOD-INF-016 | async/sync 边界桥接 / Async Utils | D_SHARED | generated | src/zephyr/shared/utils/async_utils.py |
| MOD-INF-016 | Session Continuity | D_SHARED | stable | src/zephyr/shared/session/session_continuity.py |
...
| MOD-INF-016 | Cli Summary | D_SHARED | stable | src/zephyr/shared/utils/cli_summary.py |
...
| MOD-INF-016 | Zephyr Logger | D_SHARED | stable | src/zephyr/shared/utils/zephyr_logger.py |
...
| MOD-INF-016 | Vibe Experiment Tracker | D_SHARED | stable | src/zephyr/shared/versioning/vibe_experiment_tracker.py |
...
| MOD-SIGQC-001 | Degradation Monitor Base | D_SIGQC | generated | src/zephyr/signal_quality/degradation_monitor_base.py |
| MOD-INF-040 | Init | D_SIGQC | generated | src/zephyr/signal_quality/__init__.py |
| MOD-SIM-024 | Deflated Sharpe Calculator | D_SIMULATION | stable | src/zephyr/simulation/deflated_sharpe_calculator.py |
| MOD-SIM-021 | Parameter Robustness Tester | D_SIMULATION | stable | src/zephyr/simulation/parameter_robustness_tester.py |
| MOD-SIM-022 | Look Ahead Bias Detector | D_SIMULATION | stable | src/zephyr/simulation/look_ahead_bias_detector.py |
| MOD-SIM-023 | Sharpe Calculator Fixer | D_SIMULATION | stable | src/zephyr/simulation/sharpe_calculator_fixer.py |
...
| MOD-INF-035 | Action Dispatcher | D_INFRA_RUNTIME | stable | src/zephyr/trading/action_dispatcher.py |
...
| MOD-INF-035 | Auto Runtime Core | D_INFRA_RUNTIME | stable | src/zephyr/trading/auto_runtime_core.py |
...
| MOD-INF-033 | Gpu Consensus Scheduler | D_TRADING | stable | src/zephyr/trading/gpu_consensus_scheduler.py |
...
| MOD-INF-035 | Lifecycle Manager | D_INFRA_RUNTIME | stable | src/zephyr/trading/lifecycle_manager.py |
...
| MOD-INF-033 | Protection Index | D_TRADING | stable | src/zephyr/trading/protection_index.py |
| MOD-INF-035 | —必填字段/类型/范围，失败 fail-fast / Runtime Config | D_INFRA_RUNTIME | stable | src/zephyr/trading/runtime_config.py |
| MOD-INF-035 | Resource Optimization | D_INFRA_RUNTIME | stable | src/zephyr/trading/resource_optimization.py |
| MOD-INF-035 | Ports | D_INFRA_RUNTIME | generated | src/zephyr/trading/ports.py |
| MOD-INF-035 | Staging Area | D_INFRA_RUNTIME | stable | src/zephyr/trading/staging_area.py |
| MOD-INF-035 | 根据当前时间返回系统节律阶段字符串 / Status Dashboard | D_INFRA_RUNTIME | stable | src/zephyr/trading/status_dashboard.py |
| MOD-RESOURCE_OPTIMIZATION_ENGINE | Speed Baseline Checker | D_TRADING | generated | src/zephyr/trading/speed_baseline_checker.py |
| MOD-INF-035 | 根据护照决定是否允许模型执行某个能力类型 / Task Gate | D_INFRA_RUNTIME | stable | src/zephyr/trading/task_gate.py |
| MOD-INF-033 | Verdict Engine | D_TRADING | stable | src/zephyr/trading/verdict_engine.py |
| MOD-INF-035 | —AI 不能空手退出 / Stop Gate | D_INFRA_RUNTIME | stable | src/zephyr/trading/stop_gate.py |
| MOD-INF-035 | Windows Service | D_INFRA_RUNTIME | generated | src/zephyr/trading/windows_service.py |
| MOD-INF-035 | Work Dag | D_INFRA_RUNTIME | stable | src/zephyr/trading/work_dag.py |
| MOD-RESOURCE_OPTIMIZATION_ENGINE | Zombie Scanner | D_INFRA_RUNTIME | generated | src/zephyr/trading/zombie_scanner.py |
...
| MOD-INF-016 | Execution Rejection Error | D_TRADING | generated | src/zephyr/trading/trading_contracts/execution/execution_rejection_error.py |
...
| MOD-INF-016 | Capital Allocation Result | D_TRADING | stable | src/zephyr/trading/trading_contracts/execution/capital_allocation_result.py |
...
| MOD-INF-016 | Model Serving Request | D_TRADING | stable | src/zephyr/trading/trading_contracts/execution/model_serving_request.py |
| MOD-INF-016 | Instrument | D_TRADING | generated | src/zephyr/trading/trading_contracts/market/instrument.py |
| MOD-INF-016 | Compliance Rule | D_TRADING | generated | src/zephyr/trading/trading_contracts/risk/compliance_rule.py |
| MOD-INF-016 | Signal Degradation Warning | D_TRADING | generated | src/zephyr/trading/trading_contracts/market/signal_degradation_warning.py |
| MOD-INF-016 | Risk Metrics | D_TRADING | stable | src/zephyr/trading/trading_contracts/risk/risk_metrics.py |
| MOD-INF-016 | Risk Limit Violation Error | D_TRADING | stable | src/zephyr/trading/trading_contracts/risk/risk_limit_violation_error.py |
| MOD-INF-016 | Risk Limits | D_TRADING | generated | src/zephyr/trading/trading_contracts/risk/risk_limits.py |
| MOD-INF-016 | Risk Dashboard Snapshot | D_TRADING | stable | src/zephyr/trading/trading_contracts/risk/risk_dashboard_snapshot.py |
| MOD-INF-016 | Risk Validator Protocol | D_TRADING | stable | src/zephyr/trading/trading_contracts/risk/risk_validator_protocol.py |
| MOD-INF-016 | Trading Kill Switch | D_TRADING | stable | src/zephyr/trading/trading_contracts/risk/trading_kill_switch.py |
...
| MOD-GOV_GATE_CACHE | Gate Cache | D_OPS | generated | scripts/governance/observability/gate_cache.py |
...
| MOD-DATA_ENG | Data Profiling | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/data_profiling/ |
| MOD-DATA_ENG | Training Data Manager | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/training_data_manager/ |
| MOD-DATA_ENG | Schema Evolution | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/schema_evolution/ |
| MOD-DATA_ENG | Stream Processing | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/stream_processing/ |
| MOD-L00-004 | Symbol Normalizer | D_DATA | deprecated | src/zephyr/data/symbol_normalizer/ |
| MOD-L00-004 | Tick Data Manager | D_DATA | deprecated | src/zephyr/data/tick_data_manager/ |
| MOD-DATA_ENG | Data Catalog | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/data_catalog/ |
| MOD-L00-004 | Data Observability | D_DATA | deprecated | src/zephyr/data/data_observability/ |
| MOD-DATA_ENG | Data Compression | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/data_compression/ |
| MOD-DATA_ENG | Synthetic Data | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/synthetic_data/ |
| MOD-DATA_ENG | Data Product Manager | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/data_product_manager/ |
| MOD-DATA_ENG | Data Lake Manager | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/data_lake_manager/ |
| MOD-L00-004 | Feature Store | D_DATA | deprecated | src/zephyr/data/feature_store/ |
| MOD-INF-038 | 包入口 / __init__ | D_ASHARE_SIGNAL | stable | src/zephyr/signal_ashare/__init__.py |
| MOD-INF-013 | Base Server | D_INTEGRATION | stable | src/zephyr/integration/mcp/_base_server.py |
...
| MOD-L00-004 | Realtime Push Manager | D_DATA | deprecated | src/zephyr/data/realtime_push_manager/ |
...
| MOD-DATA_ENG | Knowledge Cleaning | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/knowledge_cleaning/ |
| MOD-DATA_ENG | Data Replication | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/data_replication/ |
| MOD-DATA_ENG | Drift Aware Scheduler | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/drift_aware_scheduler/ |
| MOD-DATA_ENG | Gpu Resource Manager | D_DATA_ENG | deprecated | src/zephyr/data_eng/services/gpu_resource_manager/ |

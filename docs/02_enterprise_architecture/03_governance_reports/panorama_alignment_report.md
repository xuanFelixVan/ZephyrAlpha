...
- 生成时间: 2026-08-04 09:41:48
- 数据源: depgraph (PostgreSQL)
- 四图节点数: depgraph=907 / dataflow=270 / decision=693 / blueprint=164
- 问题总数: 50
  - 孤儿（仅一图）: 49
...
|---|---|---|---|
| MOD-H1-REDIS-HOT | dataflow | Mod H1 Redis Hot | MOD-H1-REDIS-HOT |
| CFG-rule-enforcement-registry | decision | Cfg Rule Enforcement Registry | layer:CFG-rule-enforcement-registry |
| CFG-rule-registry-collection | decision | Cfg Rule Registry Collection | layer:CFG-rule-registry-collection |
| CFG-scripts-registry | decision | Cfg Scripts Registry | layer:CFG-scripts-registry |
| CFG-test-suite-registry | decision | Cfg Test Suite Registry | layer:CFG-test-suite-registry |
| MOD-CFG_RULE_ENFORCEMENT | depgraph | Rule Enforcement Registry | docs/01_policies_and_standards/_registry/catalogs/rule_enforcement_registry.yaml |
...
| MOD-CFG_SCRIPTS | depgraph | Scripts Registry | docs/01_policies_and_standards/_registry/catalogs/scripts_registry.yaml |
...
| MOD-GOV_DIAGNOSE_DEPGRAPH | depgraph | Diagnose Depgraph | scripts/governance/d5_architecture/diagnose_depgraph.py |
...
| MOD-GOV_PHASE_A_BACKUP | depgraph | Phase A Backup | scripts/governance/_archive/one_off/phase_a_backup.py |
...
| MOD-POS_SERVICES | depgraph | Init | src/zephyr/position/services/__init__.py |

...
|------|------|------|------|------|------|------|
| 2026-11-30 | quarterly | CAND-HARVEST-0057 | Position Triage持仓分级器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0058 | Sell Signal Collector卖出信号收集器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0059 | Sell Signal Scorer卖出信号评分器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0060 | Breakout Failure Detector突破成败检测器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0061 | Take Profit Strategy Family止盈策略族 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0062 | Stop Loss Strategy Family止损策略族 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0063 | Replacement & Rebalance Sell置换与再平衡卖出 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0064 | Sell Signal Fusion Engine卖出信号融合引擎 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0065 | Buy-Sell Conflict Arbitrator买卖冲突仲裁器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0066 | Sell Urgency Scorer卖出紧迫度评分器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0067 | Sell Signal Accuracy Monitor卖出信号准确率监控 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0068 | Sell Strategy A/B Tester卖出策略A/B测试 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0069 | Sell Execution Quality Tracker卖出执行质量追踪 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0070 | Exit Scenario Planner卖出情景预案器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0071 | Strategy-Specific Stop Framework策略类型→止损范式映射 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0072 | Stop-Hunting Protector止损猎杀防护器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0073 | Stop Option Pricer止损期权定价器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0074 | Scaling Out Architect分批退出架构师 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0075 | T-Trade Coordinator做T决策协调器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0889 | Stop-Loss Decision Engine 止损决策引擎 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0890 | Take-Profit Decision Engine 止盈决策引擎 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0891 | Signal Reversal Detector 信号反转检测器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0892 | Risk-Based Sell Trigger 风险驱动卖出触发器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-0893 | Opportunity Cost Analyzer 机会成本分析器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0894 | Sell Execution Optimizer 卖出执行优化器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |
| 2026-11-30 | quarterly | CAND-HARVEST-4884 | StopLossTriggerReversalDetector 猎杀止损保护器 | D_SELL_DECISION | 候选待评（candidate） | harvest待评估（likely_planned） |

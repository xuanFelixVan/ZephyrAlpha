...
|------|------|------|------|------|------|:---:|------|------|
| CAND-HARVEST-4120 | Backtest Pipeline Process 回测管线进程 | Backtest Pipeline Process 回测管线进程（来源:运维架构.md, likely_implemented） | D_BACKTEST | 候选待评（candidate） | 待评估 | P2 | — | 2026-11-30 |
...
| ID | 名称 | 大白话（干什么用） | 域 | 卡点理由 | 替代方案 |
|------|------|------|------|------|------|
| CAND-HARVEST-4120 | Backtest Pipeline Process 回测管线进程 | Backtest Pipeline Process 回测管线进程（来源:运维架构.md, likely_implemented） | D_BACKTEST | harvest待评估（likely_implemented） |  |

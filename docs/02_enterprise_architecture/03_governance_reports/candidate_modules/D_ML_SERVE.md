...
> 本域候选 **36** 条（原有 0 + harvest 36）。
> harvest 去重四态: likely_new=32 / uncertain=4
...
|------|------|------|------|------|------|------|
| 2026-11-30 | quarterly | CAND-HARVEST-0008 | Market Prediction & Next-Day Trend Forecast 大盘预测与次日走势预判 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0249 | D-ML-02 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（uncertain） |
| 2026-11-30 | quarterly | CAND-HARVEST-0250 | MS-01 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（uncertain） |
| 2026-11-30 | quarterly | CAND-HARVEST-0251 | D-ML-03 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（uncertain） |
| 2026-11-30 | quarterly | CAND-HARVEST-0252 | MS-02 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（uncertain） |
| 2026-11-30 | quarterly | CAND-HARVEST-0253 | Model Validator 模型验证器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0254 | Model Drift Monitor 模型漂移监控器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0255 | Model Serving Manager 模型服务管理器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0442 | §30.4.2 D-ML-SERVE 推理域（46个模块，P0=5） | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0733 | DriftMonitor 漂移监控器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0734 | ServingManager 服务管理器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0735 | LLMGateway LLM网关 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0917 | Model Compression & Inference Acceleration 模型压缩与推理加速 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0989 | ModelRiskGovernor 模型风险治理器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-0990 | Model Adversarial Attack Detector 模型对抗攻击检测器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1778 | LLM API Integration LLM API集成 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1779 | KB Embedding BGE-M3-ONNX KB嵌入BGE-M3-ONNX | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1875 | ModelABTester 模型A/B测试器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1878 | ModelPerformanceMonitor 模型性能监控器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1880 | TSFM 时间序列基础模型 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1881 | Quantizer 量化器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1882 | Fairness 公平性 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1883 | Explanation 解释器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1884 | Impact 影响分析 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1885 | Adversarial 对抗 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1886 | Version 版本 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1891 | ModelDeploymentPipeline 模型部署管线 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-1892 | ModelPerformanceDriftMonitor 模型性能漂移监控器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4232 | Model Drift Monitor 模型漂移监控 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4790 | KB Embedding BGE-M3-ONNX 知识库嵌入(旧) | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4791 | MLflow Model Update MLflow模型更新(旧) | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4792 | AI Model A/B Tester AI模型A/B测试器(旧) | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4793 | AI Decision Explanation AI决策解释(旧) | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4794 | Hybrid Deployment AI Manager 混合部署AI管理器(旧) | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4795 | Model Lifecycle Manager 模型生命周期管理器(旧) | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |
| 2026-11-30 | quarterly | CAND-HARVEST-4799 | AI Construction Governor AI构建治理器 | D_ML_SERVE | 候选待评（candidate） | harvest待评估（likely_new） |

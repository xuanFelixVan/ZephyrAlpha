...
| D_GOV_SCRIPTS | 脚本治理 | 390 | 150 | +240 |
| D_INFRA_RUNTIME | 运行时集成 | 167 | 150 | +17 |
...
| D_EX_CORE | 执行核心 | L2_domain | 9 | 150 | 6.0% | 正常 |
| D_EX_SOR | 执行路由 | L2_domain | 11 | 150 | 7.3% | 正常 |
...
| D_GOV_SCRIPTS | 脚本治理 | L2_domain | 390 | 150 | 260.0% | 超容 |
...
| D_INFRA_RUNTIME | 运行时集成 | L0_infrastructure | 167 | 150 | 111.3% | 超容 |
...
| D_POSITION | 仓位管理 | L2_domain | 8 | 150 | 5.3% | 正常 |
...
| D_SELL_DECISION | 卖出决策 | L2_domain | 8 | 150 | 5.3% | 正常 |

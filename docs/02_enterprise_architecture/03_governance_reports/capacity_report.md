...
|------|--------|:---:|:---:|:---:|
| D_AUTONOMY_CORE | 自治核心 | 125 | 150 | 83.3% |
| D_GOV_CODE_QUALITY | 代码质量治理 | 132 | 150 | 88.0% |
...
| D_GOV_KB | Governance Knowledge Base | L2_domain | 150 |
...
| D_AUTONOMY_CORE | 自治核心 | L1_foundation | 125 | 150 | 83.3% | 接近超容 |
...
| D_FEEDBACK_LOOP | 反馈循环引擎 | L1_foundation | 111 | 150 | 74.0% | 正常 |
| D_FRONTEND | 前端 | L1_foundation | 9 | 150 | 6.0% | 正常 |
| D_FUNDAMENTAL_SIGNAL | 基本面信号 | L2_domain | 4 | 150 | 2.7% | 正常 |
| D_GOVERNANCE | 生命周期管理 | L2_domain | 97 | 150 | 64.7% | 正常 |
| D_GOV_AUDIT | 审计追踪 | L2_domain | 72 | 150 | 48.0% | 正常 |
| D_GOV_CODE_QUALITY | 代码质量治理 | L1_foundation | 132 | 150 | 88.0% | 接近超容 |
...
| D_GOV_KB | Governance Knowledge Base | L2_domain | 0 | 150 | 0.0% | 空 |
...
| D_GOV_SCRIPTS | 脚本治理 | L2_domain | 11 | 150 | 7.3% | 正常 |
...
| D_INFRA_RUNTIME | 运行时集成 | L0_infrastructure | 119 | 150 | 79.3% | 正常 |
| D_INFRA_TELEMETRY | 可观测性 | L0_infrastructure | 0 | 150 | 0.0% | 空 |
| D_INTEGRATION | 管线路由 | L1_foundation | 39 | 150 | 26.0% | 正常 |
...
| D_ORCHESTRATOR | 代理编排器 | L1_foundation | 54 | 150 | 36.0% | 正常 |

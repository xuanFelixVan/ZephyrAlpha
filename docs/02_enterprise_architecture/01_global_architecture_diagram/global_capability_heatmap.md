...
| D_FACTOR | 因子 | C2 | L2_domain | 50 | 5 | 45 | 2 | L3 🟢 | ✅ |
| D_FUNDAMENTAL_SIGNAL | 基本面信号 | C2 | L2_domain | 10 | 10 | 0 | 4 | L3 🟢 | ✅ |
| D_SIGLEGACY | 信号遗留设计态 | C2 |  | 0 | 0 | 0 | 0 | L0 ⚪ | ❌ |
| D_SIGQC | 信号质量控制 | C2 | L2_domain | 2 | 2 | 0 | 0 | L2 🟡 | 🟡 |
| D_COMPLIANCE | 合规 | C3 |  | 2 | 2 | 0 | 0 | L2 🟡 | 🟡 |
...
| D_BACKTEST | 回测 | C7 | L2_domain | 17 | 17 | 0 | 9 | L3 🟢 | ✅ |
...
| D_DATA_GOV | 数据治理 | CC1 | L1_foundation | 7 | 7 | 0 | 0 | L2 🟡 | 🟡 |
...
| D_BEHAVIORAL_AUDIT | 行为审计 | CC2 |  | 0 | 0 | 0 | 0 | L0 ⚪ | ❌ |
...
| D_FRONTEND | 前端 | CC3 | L1_foundation | 11 | 11 | 0 | 9 | L3 🟢 | ✅ |
| D_INFRASTRUCTURE | 跨层契约基础设施 | CC3 |  | 24 | 24 | 0 | 12 | L3 🟢 | ✅ |
...
| D_INTELLIGENCE | 上下文管理 | CC3 | L2_domain | 28 | 28 | 0 | 18 | L3 🟢 | ✅ |
...
| D_SHARED | 共享服务 | CC3 | L1_foundation | 183 | 183 | 0 | 117 | L3 🟢 | ✅ |
...
| 架构域 / Architecture Domain | 域名称 / Domain Name | 能力域 / Capability | 当前成熟度 / Current Maturity | 节点数 / Nodes |
|--------|--------|:---:|:---:|:---:|
| D_ALT_DATA | 另类数据 | C1 | L2 | 7 |
| D_DATA_ENG | 数据工程 | C1 | L2 | 7 |
| D_MKT_DATA | 行情数据 | C1 | L2 | 7 |
| D_ASHARE_SIGNAL | A股特色信号 | C2 | L2 | 7 |

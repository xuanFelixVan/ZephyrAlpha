...
|:---:|--------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| C1 | 数据接入 | 4 | 60 | 9 | 3 | 48 | 1.25 | 🟡 部分覆盖 / Partial |
...
| CC1 | 治理合规 | 15 | 1173 | 905 | 32 | 236 | 2.07 | 🟡 部分覆盖 / Partial |
| CC2 | 安全防护 | 5 | 200 | 106 | 0 | 94 | 1.00 | 🟡 部分覆盖 / Partial |
| CC3 | 基础设施 | 16 | 1016 | 641 | 11 | 364 | 1.94 | 🟡 部分覆盖 / Partial |
...
| D_DATA | data_source_integrator | C1 |  | 36 | 9 | 0 | 27 | 0 | L2 🟡 | 🟡 |
...
| D_GOVERNANCE | registry_management | CC1 | L2_domain | 208 | 140 | 1 | 67 | 1 | L3 🟢 | ✅ |
| D_GOV_AUDIT | audit_orchestration | CC1 | L2_domain | 102 | 69 | 2 | 31 | 0 | L2 🟡 | 🟡 |
| D_GOV_CODE_QUALITY | code_quality_governance | CC1 | L1_foundation | 114 | 102 | 0 | 12 | 0 | L2 🟡 | 🟡 |
...
| D_INFRA_RUNTIME | runtime_core | CC3 | L0_infrastructure | 246 | 149 | 1 | 96 | 4 | L3 🟢 | ✅ |
...
| D_SHARED | shared_services | CC3 | L1_foundation | 188 | 109 | 0 | 79 | 0 | L2 🟡 | 🟡 |
...
| 架构域 / Architecture Domain | 域名称 / Domain Name | 能力域 / Capability | 当前成熟度 / Current Maturity | 节点数 / Nodes |
|--------|--------|:---:|:---:|:---:|
| D_DATA | data_source_integrator | C1 | L2 | 36 |
...
| D_GOV_CODE_QUALITY | code_quality_governance | CC1 | L2 | 114 |
...
| D_SHARED | shared_services | CC3 | L2 | 188 |

### 已就绪（L3，生产已验证）/ Ready (L3, verified)

| 架构域 / Architecture Domain | 域名称 / Domain Name | 能力域 / Capability | 当前成熟度 / Current Maturity | 节点数 / Nodes |
|--------|--------|:---:|:---:|:---:|
| D_GOVERNANCE | registry_management | CC1 | L3 | 208 |
| D_GOV_ENFORCEMENT | rule_enforcement | CC1 | L3 | 34 |
| D_INFRA_RUNTIME | runtime_core | CC3 | L3 | 246 |

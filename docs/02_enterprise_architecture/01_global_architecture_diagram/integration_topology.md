...
graph LR
    ...
    subgraph L2_domain[L2_domain]
        ...
        D_TRADING["D_TRADING<br/>交易运营<br/>(41模块)"]
    end
    ...
    D_TRADING -->|26条 import_depends| D_SHARED
    ...
    D_INFRA_RUNTIME -->|4条 import_depends| D_DATA

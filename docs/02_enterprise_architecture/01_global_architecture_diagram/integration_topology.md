...
graph LR
    ...
    subgraph L2_domain[L2_domain]
        ...
        D_EX_CORE["D_EX_CORE<br/>执行核心<br/>(14模块)"]
        ...
        D_PF_CORE["D_PF_CORE<br/>组合核心<br/>(10模块)"]
    ...
    D_PF_CORE -->|5条 import_depends| D_BACKTEST
    ...
    D_EX_CORE -->|3条 import_depends| D_FACTOR

...
graph LR
    ...
    subgraph unknown[unknown]
        ...
        D_DATA["D_DATA<br/>数据接入层<br/>(80模块)"]
    ...
    D_GOV_AUDIT -->|3条 config_depends| D_GOV_SCRIPTS
    ...
    %% 7. D_GOV_SCRIPTS -> D_GOVERNANCE: 44 条

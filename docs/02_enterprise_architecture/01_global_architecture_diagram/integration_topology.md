...
graph LR
    ...
    subgraph L0_infrastructure[L0_infrastructure]
        ...
        D_INFRA_RUNTIME["D_INFRA_RUNTIME<br/>运行时集成<br/>(155模块)"]
    ...
    subgraph L1_foundation[L1_foundation]
        ...
        D_GOV_CODE_QUALITY["D_GOV_CODE_QUALITY<br/>代码质量治理<br/>(132模块)"]
    ...
    subgraph L2_domain[L2_domain]
        ...
        D_GOV_SCRIPTS["D_GOV_SCRIPTS<br/>脚本治理<br/>(358模块)"]
    ...
    D_GOV_ENFORCEMENT -->|60条 import_depends| D_GOV_CODE_QUALITY
    D_GOV_CODE_QUALITY -->|58条 import_depends| D_GOV_ENFORCEMENT
    ...
    D_AUTONOMY_CORE -->|23条 import_depends| D_INFRA_RUNTIME
    ...
    D_AUTONOMY_CORE -->|8条 contract| D_GOV_DOCS
    ...
    D_FBL_DIAGNOSERS -->|5条 runtime| D_FEEDBACK_LOOP
    ...
    D_AUTONOMY_CORE -->|4条 import_depends| D_GOV_AUDIT
    ...
    D_GOV_DOCS -->|4条 contract| D_SECURITY
    D_GOV_DOCS -->|4条 data| D_GOVERNANCE
    D_GOV_DOCS -->|4条 contract| D_GOV_AUDIT
    ...
    D_ORCHESTRATOR -->|3条 import_depends| D_INFRA_RUNTIME
    D_AUTONOMY_CORE -->|3条 import_depends| D_SECURITY
    ...
    %% 2. D_INTEGRATION -> D_SHARED: 61 条
    %% 3. D_GOV_ENFORCEMENT -> D_GOV_CODE_QUALITY: 60 条
    %% 4. D_GOV_CODE_QUALITY -> D_GOV_ENFORCEMENT: 58 条

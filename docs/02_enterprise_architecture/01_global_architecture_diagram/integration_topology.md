...
graph LR
    ...
    subgraph L1_foundation[L1_foundation]
        ...
        D_GOV_CODE_QUALITY["D_GOV_CODE_QUALITY<br/>code_quality_governance<br/>(128模块)"]
        ...
        D_SHARED["D_SHARED<br/>shared_services<br/>(184模块)"]
    end
    subgraph L2_domain[L2_domain]
        ...
        D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT<br/>rule_enforcement<br/>(32模块)"]
        ...
        D_GOV_SCRIPTS["D_GOV_SCRIPTS<br/>script_governance<br/>(358模块)"]
    ...
    D_INFRA_RUNTIME -->|151条 import_depends| D_SHARED
    D_INTEGRATION -->|63条 import_depends| D_SHARED
    D_GOV_ENFORCEMENT -->|59条 import_depends| D_GOV_CODE_QUALITY
    D_GOVERNANCE -->|58条 import_depends| D_SHARED
    D_GOV_CODE_QUALITY -->|57条 import_depends| D_GOV_ENFORCEMENT
    ...
    D_GOV_KB -->|20条 import_depends| D_SHARED
    ...
    D_GOV_ENFORCEMENT -->|8条 import_depends| D_GOV_AUDIT
    ...
    D_SECURITY -->|3条 import_depends| D_INFRA_RUNTIME
    ...
    D_GOV_OPS_RESILIENCE -->|3条 import_depends| D_ORCHESTRATOR
    ...
    %% Top 10 依赖对
    %% 1. D_INFRA_RUNTIME -> D_SHARED: 151 条
    %% 2. D_INTEGRATION -> D_SHARED: 63 条
    %% 3. D_GOV_ENFORCEMENT -> D_GOV_CODE_QUALITY: 59 条
    %% 4. D_GOVERNANCE -> D_SHARED: 58 条
    %% 5. D_GOV_CODE_QUALITY -> D_GOV_ENFORCEMENT: 57 条
    %% 6. D_SECURITY -> D_GOV_DRIFT: 44 条
    %% 7. D_COMPLIANCE -> D_GOV_DRIFT: 43 条
    %% 8. D_ORCHESTRATOR -> D_SHARED: 42 条
    %% 9. D_GOV_SCRIPTS -> D_GOVERNANCE: 39 条
    %% 10. D_GOV_AUDIT -> D_SHARED: 37 条

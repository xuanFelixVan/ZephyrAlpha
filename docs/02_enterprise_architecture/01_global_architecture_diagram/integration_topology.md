...
graph LR
    ...
    D_GOVERNANCE -->|62条 import_depends| D_SHARED
    ...
    D_GOV_DOCS -->|6条 data| D_GOVERNANCE
    ...
    %% 3. D_GOVERNANCE -> D_SHARED: 62 条
    %% 4. D_INTEGRATION -> D_SHARED: 60 条
    %% 5. D_GOV_AUDIT -> D_SHARED: 44 条

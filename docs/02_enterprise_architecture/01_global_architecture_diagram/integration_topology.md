...
graph LR
    ...
    subgraph L0_infrastructure[L0_infrastructure]
        ...
        D_INFRA_RUNTIME["D_INFRA_RUNTIME<br/>runtime_core<br/>(329模块)"]
    ...
    subgraph L1_foundation[L1_foundation]
        ...
        D_GOV_CODE_QUALITY["D_GOV_CODE_QUALITY<br/>code_quality_governance<br/>(115模块)"]
        ...
        D_SHARED["D_SHARED<br/>shared_services<br/>(297模块)"]
    end
    subgraph L2_domain[L2_domain]
        ...
        D_GOVERNANCE["D_GOVERNANCE<br/>registry_management<br/>(713模块)"]
    ...
    subgraph unknown[unknown]
        ...
        D_DATA["D_DATA<br/>data_source_integrator<br/>(62模块)"]
    ...
    D_INFRA_RUNTIME -->|186条 config_depends| D_SHARED
    D_GOV_SCRIPTS -->|163条 config_depends| D_GOVERNANCE
    ...
    D_GOVERNANCE -->|85条 import_depends| D_SHARED
    D_GOV_SCRIPTS -->|79条 import_depends| D_SHARED
    D_GOVERNANCE -->|67条 import_depends| D_GOV_OPS_RESILIENCE
    D_GOV_REPAIR -->|67条 config_depends| D_GOVERNANCE
    ...
    D_INFRASTRUCTURE -->|55条 config_depends| D_SHARED
    D_GOV_AUDIT -->|50条 import_depends| D_SHARED
    D_GOVERNANCE -->|50条 import_depends| D_GOV_ENFORCEMENT
    D_AUTONOMY_CORE -->|48条 import_depends| D_INFRA_RUNTIME
    D_GOV_ENFORCEMENT -->|47条 import_depends| D_GOV_CODE_QUALITY
    D_GOVERNANCE -->|45条 import_depends| D_GOV_AUDIT
    D_COMPLIANCE -->|45条 import_depends| D_GOV_DRIFT
    D_GOV_CODE_QUALITY -->|45条 import_depends| D_GOV_ENFORCEMENT
    ...
    D_INFRA_RUNTIME -->|19条 config_depends| D_INTEGRATION
    D_TRADING -->|19条 import_depends| D_SHARED
    D_GOVERNANCE -->|19条 import_depends| D_GOV_RULE
    D_GOVERNANCE -->|19条 test_depends| D_AUTONOMY_CORE
    ...
    %% Top 10 依赖对
    %% 1. D_INFRA_RUNTIME -> D_SHARED: 186 条
    %% 2. D_GOV_SCRIPTS -> D_GOVERNANCE: 163 条
    %% 3. D_AUTONOMY_PERM -> D_SECURITY: 118 条
    %% 4. D_GOV_SCRIPTS -> D_GOV_RULE: 102 条
    %% 5. D_GOVERNANCE -> D_GOV_CODE_QUALITY: 90 条
    %% 6. D_GOVERNANCE -> D_SHARED: 85 条
    %% 7. D_GOV_SCRIPTS -> D_SHARED: 79 条
    %% 8. D_GOVERNANCE -> D_GOV_OPS_RESILIENCE: 67 条
    %% 9. D_GOV_REPAIR -> D_GOVERNANCE: 67 条
    %% 10. D_AUTONOMY_CORE -> D_FBL_VERIFICATION: 66 条

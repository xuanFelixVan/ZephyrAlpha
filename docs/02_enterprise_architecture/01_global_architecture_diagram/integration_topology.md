...
graph LR
    ...
    subgraph L0_infrastructure[L0_infrastructure]
        ...
        D_INFRA_RUNTIME["D_INFRA_RUNTIME<br/>runtime_core<br/>(299模块)"]
    ...
    subgraph L2_domain[L2_domain]
        ...
        D_GOVERNANCE["D_GOVERNANCE<br/>registry_management<br/>(1029模块)"]
        D_GOV_AUDIT["D_GOV_AUDIT<br/>audit_orchestration<br/>(272模块)"]
        ...
        D_GOV_REPAIR["D_GOV_REPAIR<br/>rollback<br/>(20模块)"]
    ...
    D_GOVERNANCE -->|125条 config_depends| D_GOV_SCRIPTS
    D_GOVERNANCE -->|103条 import_depends| D_SHARED
    ...
    D_INFRASTRUCTURE -->|57条 config_depends| D_SHARED
    ...
    D_GOV_AUDIT -->|48条 import_depends| D_SHARED
    ...
    D_GOV_REPAIR -->|33条 config_depends| D_GOVERNANCE
    ...
    D_GOV_AUDIT -->|24条 import_depends| D_GOV_OPS_RESILIENCE
    ...
    D_GOV_REPAIR -->|13条 import_depends| D_TRADING
    D_GOV_SCRIPTS -->|13条 config_depends| D_GOVERNANCE
    ...
    D_SHARED -->|11条 config_depends| D_INFRASTRUCTURE
    ...
    D_GOV_DRIFT -->|8条 import_depends| D_GOVERNANCE
    ...
    %% 3. D_GOVERNANCE -> D_GOV_SCRIPTS: 125 条
    %% 4. D_GOVERNANCE -> D_SHARED: 103 条
    %% 5. D_GOV_SCRIPTS -> D_GOV_RULE: 96 条
    %% 6. D_GOVERNANCE -> D_GOV_CODE_QUALITY: 89 条
    %% 7. D_AUTONOMY_CORE -> D_FBL_VERIFICATION: 66 条
    %% 8. D_AUTONOMY_CORE -> D_FEEDBACK_LOOP: 64 条
    %% 9. D_GOVERNANCE -> D_GOV_OPS_RESILIENCE: 64 条

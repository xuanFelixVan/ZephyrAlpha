...
graph LR
    ...
    D_GOV_ENFORCEMENT -->|61条 import_depends| D_GOV_CODE_QUALITY
    ...
    D_GOV_AUDIT -->|3条 import_depends| D_SECURITY
    ...
    %% 3. D_GOV_ENFORCEMENT -> D_GOV_CODE_QUALITY: 61 条

...
graph LR
    ...
    subgraph L1_foundation[L1_foundation]
        ...
        D_GOV_CODE_QUALITY["D_GOV_CODE_QUALITY<br/>代码质量治理<br/>(206模块)"]
    ...
    subgraph L2_domain[L2_domain]
        ...
        D_GOV_ENFORCEMENT["D_GOV_ENFORCEMENT<br/>规则执行<br/>(115模块)"]
    ...
    D_GOVERNANCE -->|54条 import_depends| D_GOV_SCRIPTS
    ...
    D_GOV_CODE_QUALITY -->|12条 import_depends| D_GOVERNANCE
    ...
    D_GOV_SCRIPTS -->|8条 test_depends| D_GOV_DRIFT
    ...
    %% 9. D_GOVERNANCE -> D_GOV_SCRIPTS: 54 条

...
graph LR
    ...
    subgraph unknown[unknown]
        ...
        D_DATA["D_DATA<br/>数据接入层<br/>(67模块)"]
    ...
    D_GOV_SCRIPTS -->|3条 import_depends| D_GOV_AUDIT
    ...
    %% 5. D_SECURITY -> D_GOV_DRIFT: 44 条
    %% 6. D_GOV_AUDIT -> D_SHARED: 44 条

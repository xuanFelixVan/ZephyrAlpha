...
graph LR
    ...
    subgraph L1_foundation[L1_foundation]
        ...
        D_GOV_CODE_QUALITY["D_GOV_CODE_QUALITY<br/>code_quality_governance<br/>(114模块)"]
        ...
        D_SHARED["D_SHARED<br/>shared_services<br/>(298模块)"]
    end
    subgraph L2_domain[L2_domain]
        ...
        D_GOVERNANCE["D_GOVERNANCE<br/>registry_management<br/>(714模块)"]
        ...
        D_GOV_SCRIPTS["D_GOV_SCRIPTS<br/>script_governance<br/>(452模块)"]
    ...
    subgraph unknown[unknown]
        ...
        D_DATA["D_DATA<br/>data_source_integrator<br/>(59模块)"]
    ...
    D_INFRA_RUNTIME -->|190条 config_depends| D_SHARED
    D_GOV_SCRIPTS -->|162条 config_depends| D_GOVERNANCE
    ...
    D_GOV_ENFORCEMENT -->|46条 import_depends| D_GOV_CODE_QUALITY
    D_COMPLIANCE -->|45条 import_depends| D_GOV_DRIFT
    D_GOVERNANCE -->|44条 import_depends| D_GOV_AUDIT
    D_GOV_CODE_QUALITY -->|44条 import_depends| D_GOV_ENFORCEMENT
    ...
    D_GOVERNANCE -->|21条 config_depends| D_INTEGRATION
    ...
    D_INTEGRATION -->|15条 import_depends| D_INFRA_RUNTIME
    ...
    %% Top 10 依赖对
    %% 1. D_INFRA_RUNTIME -> D_SHARED: 190 条
    %% 2. D_GOV_SCRIPTS -> D_GOVERNANCE: 162 条
    %% 3. D_AUTONOMY_PERM -> D_SECURITY: 130 条
    %% 4. D_GOV_SCRIPTS -> D_GOV_RULE: 102 条
    %% 5. D_GOVERNANCE -> D_GOV_CODE_QUALITY: 90 条
    %% 6. D_GOVERNANCE -> D_SHARED: 83 条
    %% 7. D_GOV_SCRIPTS -> D_SHARED: 79 条
    %% 8. D_GOV_REPAIR -> D_GOVERNANCE: 67 条
    %% 9. D_INTEGRATION -> D_SHARED: 67 条
    %% 10. D_GOVERNANCE -> D_GOV_OPS_RESILIENCE: 66 条

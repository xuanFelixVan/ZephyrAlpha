...
| `D-SIGNAL` | 信号 | 476 | 信号生成、信号组合、信号过滤、信号优先级。交易信号引擎。 |
| `D-SIGNAL_ASHARE` | A股特色信号 | 27 | A股特色信号域。负责A股市场特有的信号生成，包括资金流向信号、龙虎榜信号、融资融券信号、限售股解禁信 |
| `D-SIGNAL_FUNDAMENTAL` | 基本面信号 | 24 | 基本面信号域。负责基本面分析信号生成，包括财务指标信号、估值信号、成长性信号、盈利能力信号。拆分自原 |
| `D-SIGNAL_QUALITY` | 信号质量 | 18 | 信号质量域。负责信号质量评估与监控，包括信号衰减检测、信号相关性分析、信号稳定性评估、信号噪声过滤。 |

...
| `D-INFRA_RUNTIME` | runtime_integration | `L0_infrastructure` | 726 | 409 | 311 | 0 | L3+ |
| `D-ALT_DATA` | 另类数据 | `L1_foundation` | 68 | 0 | 61 | 1 | L2 |
| `D-BEHAVIORAL_AUDIT` | 行为审计 | `L1_foundation` | 60 | 60 | 0 | 0 | L3+ |
...
| `D-GOVERNANCE` | lifecycle_management | `L2_domain` | 4289 | 138 | 611 | 3529 | L3+ |
| `D-GOV_AUDIT` | audit-trail | `L2_domain` | 69 | 69 | 0 | 0 | L3+ |
| `D-GOV_DRIFT` | drift_detection | `L2_domain` | 22 | 22 | 0 | 0 | L3+ |
| `D-GOV_RULE` | 规则治理 | `L2_domain` | 175 | 175 | 0 | 0 | L3+ |

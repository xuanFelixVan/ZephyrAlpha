...
# Target Architecture — Overview （被恢复）
# 目标架构总览
...
|------|------------|--------|----------|
| [01-BA 业务架构](../04_architecture_principles_decisions/business_principles.md) | Architecture Runway（原 §8，已迁移至 principles）| 5 条 | 战略层 |

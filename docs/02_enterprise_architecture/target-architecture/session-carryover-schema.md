---
module_id: STD-SESSION-CARRYOVER
...
- ❌ 6 大核心服务架构图 → 见 `03-application-architecture.md §4A`
...
- `"先跑 pytest tests/unit/context_engine/ 确认 M-01 没打断测试"`
  ...
  "open_tasks": [
    {
      ...
      "files_in_scope": [
        ...
        "tests/unit/vector_memory/test_in_process.py"
      ],
      "last_observation": "pytest tests/unit/vector_memory/ 3 passed, 2 failed: test_multi_search_rrf / test_bootstrap_resume",
    ...
    "recent_retrievals": [
      {
        ...
        "top_ids": ["KE-L12-VMS-0003", "ADR-0016", "KE-L12-VMS-0007"],

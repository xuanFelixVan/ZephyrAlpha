...
> **📊 数据流时序图**：
> - [`diagrams/data-flow.mmd`](diagrams/data-flow.mmd) — 跨域核心数据流（L00→L02→L03→L05→L06→L07 主链路）
> - [`diagrams/dataflow-terminal.mmd`](diagrams/dataflow-terminal.mmd) — 终端数据流详细时序

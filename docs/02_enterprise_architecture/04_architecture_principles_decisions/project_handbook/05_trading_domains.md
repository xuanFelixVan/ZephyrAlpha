...
| `D_AUDITTEST` | 审计测试套件 | L2_domain | 458 |
| `D_DATA` | 数据接入层 | L1_foundation | 448 |
| `D_SHARED` | 共享服务 | L0_infrastructure | 398 |
...
| `D_ASHARE_SIGNAL` | A股特色信号 | L2_domain | 165 |

...
| 域 ID | 域名 | 层 | 节点数 |
|-------|------|----|-------|
| `D_GOV_DOCS` | 架构文档治理 | L2_domain | 3368 |
| `D_GOVERNANCE` | 生命周期管理 | L2_domain | 792 |
| `D_GOV_SCRIPTS` | 脚本治理 | L2_domain | 574 |
| `D_AUDITTEST` | 审计测试套件 | L2_domain | 537 |
| `D_DATA` | 数据接入层 | L1_foundation | 534 |
| `D_AUTONOMY_CORE` | 自治核心 | L1_foundation | 512 |
| `D_INFRA_RUNTIME` | 运行时集成 | L0_infrastructure | 488 |
| `D_SHARED` | 共享服务 | L0_infrastructure | 405 |
| `D_GOV_AUDIT` | 审计追踪 | L2_domain | 400 |
| `D_BACKTEST` | 回测 | L2_domain | 319 |
| `D_GOV_CODE_QUALITY` | 代码质量治理 | L1_foundation | 269 |
| `D_FEEDBACK_LOOP` | 反馈循环引擎 | L1_foundation | 238 |
| `D_SECURITY` | 对抗验证 | L1_foundation | 237 |
| `D_GOV_ENFORCEMENT` | 规则执行 | L2_domain | 214 |
| `D_ASHARE_SIGNAL` | A股特色信号 | L2_domain | 195 |
| `D_TRADING` | 交易运营 | L2_domain | 190 |
| `D_FACTOR` | 因子 | L2_domain | 170 |
| `D_INTELLIGENCE` | 上下文管理 | L2_domain | 162 |
| `D_RISK` | 风控 | L2_domain | 148 |
| `D_INFRA_A2A` | A2A通信 | L0_infrastructure | 135 |
| `D_EX_CORE` | 执行核心 | L2_domain | 114 |
| `D_GOV_OPS_RESILIENCE` | 运维弹性治理 | L1_foundation | 113 |
...
| `D_PF_ALLOC` | 组合分配 | L2_domain | 37 |
| `D_ALT_DATA` | 另类数据 | L1_foundation | 36 |
...
| `D_ARCH_SCRIPTS` | 架构治理脚本 | L2_domain | 29 |
...
| `D_INFRA_OPS` | 基础设施运维 | L0_infrastructure | 13 |

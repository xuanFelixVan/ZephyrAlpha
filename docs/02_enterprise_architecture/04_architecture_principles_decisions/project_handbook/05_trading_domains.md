...
| 域 ID | 域名 | 层 | 节点数 |
|-------|------|----|-------|
| `D_GOVERNANCE` | 生命周期管理 | L2_domain | 774 |
...
| `D_DATA` | 数据接入层 | L1_foundation | 460 |
| `D_SHARED` | 共享服务 | L0_infrastructure | 400 |
...
| `D_FACTOR` | 因子 | L2_domain | 161 |
| `D_BACKTEST` | 回测 | L2_domain | 151 |

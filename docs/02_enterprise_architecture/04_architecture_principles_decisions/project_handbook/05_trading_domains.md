...
| `D_GOV_SCRIPTS` | 脚本治理 | L2_domain | 548 |
...
| `D_GOV_CODE_QUALITY` | 代码质量治理 | L1_foundation | 249 |
| `D_FEEDBACK_LOOP` | 反馈循环引擎 | L1_foundation | 242 |
| `D_SECURITY` | 对抗验证 | L1_foundation | 237 |
| `D_GOV_ENFORCEMENT` | 规则执行 | L2_domain | 202 |
| `D_TRADING` | 交易运营 | L2_domain | 179 |
...
| `D_FUNDAMENTAL_SIGNAL` | 基本面信号 | L2_domain | 34 |
...
| `D_ARCH_SCRIPTS` | 架构治理脚本 | L2_domain | 28 |

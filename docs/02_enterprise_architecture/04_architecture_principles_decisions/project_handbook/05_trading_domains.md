...
| `D_GOVERNANCE` | 生命周期管理 | L2_domain | 825 |
| `D_GOV_SCRIPTS` | 脚本治理 | L2_domain | 635 |
| `D_AUDITTEST` | 审计测试套件 | L2_domain | 587 |
| `D_DATA` | 数据接入层 | L1_foundation | 550 |
...
| `D_PLAN` | 预案引擎 | L2_domain | 41 |
| `D_INFRASTRUCTURE` | 跨层契约基础设施 | — | 39 |

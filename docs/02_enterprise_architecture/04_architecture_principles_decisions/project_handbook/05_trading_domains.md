...
| 域 ID | 域名 | 层 | 节点数 |
|-------|------|----|-------|
| `D_GOV_DOCS` | 架构文档治理 | L2_domain | 3367 |
| `D_GOVERNANCE` | 生命周期管理 | L2_domain | 829 |
| `D_GOV_SCRIPTS` | 脚本治理 | L2_domain | 637 |
| `D_AUDITTEST` | 审计测试套件 | L2_domain | 587 |
| `D_DATA` | 数据接入层 | L1_foundation | 551 |
| `D_AUTONOMY_CORE` | 自治核心 | L1_foundation | 512 |
| `D_INFRA_RUNTIME` | 运行时集成 | L0_infrastructure | 492 |
| `D_SHARED` | 共享服务 | L0_infrastructure | 410 |
| `D_GOV_AUDIT` | 审计追踪 | L2_domain | 403 |
| `D_BACKTEST` | 回测 | L2_domain | 337 |
| `D_GOV_CODE_QUALITY` | 代码质量治理 | L1_foundation | 274 |
| `D_FEEDBACK_LOOP` | 反馈循环引擎 | L1_foundation | 240 |
| `D_SECURITY` | 对抗验证 | L1_foundation | 239 |
| `D_GOV_ENFORCEMENT` | 规则执行 | L2_domain | 215 |
| `D_ASHARE_SIGNAL` | A股特色信号 | L2_domain | 214 |
| `D_TRADING` | 交易运营 | L2_domain | 190 |
| `D_FACTOR` | 因子 | L2_domain | 170 |
| `D_INTELLIGENCE` | 上下文管理 | L2_domain | 162 |
| `D_RISK` | 风控 | L2_domain | 151 |
| `D_INFRA_A2A` | A2A通信 | L0_infrastructure | 135 |
| `D_EX_CORE` | 执行核心 | L2_domain | 118 |
| `D_GOV_OPS_RESILIENCE` | 运维弹性治理 | L1_foundation | 116 |
| `D_INFRA_RECOVERY` | 回滚恢复 | L0_infrastructure | 100 |
| `D_ORCHESTRATOR` | 代理编排器 | L1_foundation | 94 |
| `D_INTEGRATION` | 管线路由 | L1_foundation | 91 |
| `D_FRONTEND` | 前端 | L2_domain | 79 |
| `D_REGIME` | 市场状态 | L2_domain | 79 |
| `D_SECURITY_LLM` | LLM防御 | L1_foundation | 79 |
| `D_GOV_DRIFT` | 漂移检测 | L2_domain | 78 |
| `D_FBL_DIAGNOSERS` | 反馈诊断器 | L1_foundation | 76 |
| `D_FBL_VERIFICATION` | 反馈验证 | L1_foundation | 71 |
| `D_FBL_DETECTORS` | 反馈检测器 | L1_foundation | 66 |
| `D_INFRA_OPS` | 基础设施运维 | L0_infrastructure | 61 |
| `D_REPORTING` | 报告 | L1_foundation | 58 |
| `D_COMPLIANCE` | 合规 | L2_domain | 50 |
| `D_ML_TRAIN` | 训练 | L2_domain | 47 |
| `D_PF_CORE` | 组合核心 | L2_domain | 47 |
| `D_POSITION` | 仓位管理 | L2_domain | 46 |
| `D_AUTONOMY_PERM` | 自治保护 | L2_domain | 44 |
| `D_PLAN` | 预案引擎 | L2_domain | 42 |
| `D_INFRASTRUCTURE` | 跨层契约基础设施 | — | 41 |
| `D_PF_ALLOC` | 组合分配 | L2_domain | 41 |
| `D_MKT_DATA` | 行情数据 | L1_foundation | 39 |
| `D_GOV_RULE` | 规则治理 | L2_domain | 38 |
| `D_ALT_DATA` | 另类数据 | L1_foundation | 37 |
| `D_FUNDAMENTAL_SIGNAL` | 基本面信号 | L2_domain | 37 |
| `D_DATA_ENG` | 数据工程 | L1_foundation | 32 |
| `D_INFRA_TELEMETRY` | 可观测性 | L0_infrastructure | 31 |
| `D_SELL_DECISION` | 卖出决策 | L2_domain | 31 |
| `D_SIMULATION` | 仿真 | L2_domain | 30 |
| `D_DATA_GOV` | 数据治理 | L1_foundation | 26 |
| `D_EX_SOR` | 执行路由 | L2_domain | 26 |
| `D_KNOWLEDGE` | 知识管理 | L2_domain | 22 |
| `D_ARCH_SCRIPTS` | 架构治理脚本 | L2_domain | 18 |
...
| `D_META_SCRIPTS` | 元治理脚本 | L2_domain | 3 |
| `D_ARCHIVE_SCRIPTS` | Archived Scripts | L2_domain | 2 |
| `D_COMPLIANCE_SCRIPTS` | 合规治理脚本 | L2_domain | 2 |
| `D_CONTRACTS` | 共享契约 | L0_infrastructure | 2 |
| `D_RESEARCH` | 研究域 | — | 2 |
| `D_CODE_SCRIPTS` | 代码质量脚本 | L2_domain | 1 |
| `D_DATA_SCRIPTS` | 元数据治理脚本 | L2_domain | 1 |

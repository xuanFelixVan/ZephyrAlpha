...
| 域 ID | 域名 | 层 | 节点数 |
|-------|------|----|-------|
| `D_GOV_SCRIPTS` | 脚本治理 | L2_domain | 385 |
| `D_GOVERNANCE` | 生命周期管理 | L2_domain | 222 |
| `D_SHARED` | 共享服务 | L0_infrastructure | 184 |
| `D_DATA` | 数据接入层 | L1_foundation | 179 |
...
| `D_PF_ALLOC` | 组合分配 | L2_domain | 5 |
| `D_COMPLIANCE` | 合规 | L2_domain | 3 |

...
| 域 ID | 域名 | 层 | 节点数 |
|-------|------|----|-------|
| `D_GOVERNANCE` | 生命周期管理 | L2_domain | 738 |
| `D_GOV_SCRIPTS` | 脚本治理 | L2_domain | 539 |
| `D_AUTONOMY_CORE` | 自治核心 | L1_foundation | 466 |
| `D_INFRA_RUNTIME` | 运行时集成 | L0_infrastructure | 424 |
| `D_GOV_AUDIT` | 审计追踪 | L2_domain | 389 |
| `D_SHARED` | 共享服务 | L0_infrastructure | 371 |
| `D_DATA` | 数据接入层 | L1_foundation | 298 |
| `D_GOV_CODE_QUALITY` | 代码质量治理 | L1_foundation | 244 |
| `D_AUDITTEST` | 审计测试套件 | L2_domain | 235 |
| `D_FEEDBACK_LOOP` | 反馈循环引擎 | L1_foundation | 235 |
| `D_SECURITY` | 对抗验证 | L1_foundation | 219 |
| `D_GOV_ENFORCEMENT` | 规则执行 | L2_domain | 189 |
| `D_TRADING` | 交易运营 | L2_domain | 159 |
| `D_FACTOR` | 因子 | L2_domain | 135 |
| `D_INTELLIGENCE` | 上下文管理 | L2_domain | 135 |
| `D_INFRA_A2A` | A2A通信 | L0_infrastructure | 132 |
| `D_GOV_DOCS` | 架构文档治理 | L2_domain | 118 |
| `D_GOV_OPS_RESILIENCE` | 运维弹性治理 | L1_foundation | 117 |
| `D_INFRA_RECOVERY` | 回滚恢复 | L0_infrastructure | 99 |
| `D_RISK` | 风控 | L2_domain | 96 |
| `D_ORCHESTRATOR` | 代理编排器 | L1_foundation | 88 |
| `D_EX_CORE` | 执行核心 | L2_domain | 81 |
| `D_INTEGRATION` | 管线路由 | L1_foundation | 79 |
| `D_GOV_DRIFT` | 漂移检测 | L2_domain | 77 |
| `D_FBL_DIAGNOSERS` | 反馈诊断器 | L1_foundation | 76 |
| `D_BACKTEST` | 回测 | L2_domain | 73 |
| `D_SECURITY_LLM` | LLM防御 | L1_foundation | 72 |
| `D_FBL_VERIFICATION` | 反馈验证 | L1_foundation | 71 |
| `D_INFRASTRUCTURE` | 跨层契约基础设施 | L0_infrastructure | 68 |
| `D_FBL_DETECTORS` | 反馈检测器 | L1_foundation | 65 |
| `D_ASHARE_SIGNAL` | A股特色信号 | L2_domain | 56 |
| `D_REGIME` | 市场状态 | L2_domain | 52 |
| `D_FRONTEND` | 前端 | L2_domain | 50 |
| `D_AUTONOMY_PERM` | 自治保护 | L2_domain | 44 |
| `D_REPORTING` | 报告 | L1_foundation | 40 |
| `D_GOV_RULE` | 规则治理 | L2_domain | 37 |
| `D_POSITION` | 仓位管理 | L2_domain | 35 |
| `D_COMPLIANCE` | 合规 | L2_domain | 32 |
| `D_PF_CORE` | 组合核心 | L2_domain | 32 |
| `D_SELL_DECISION` | 卖出决策 | L2_domain | 31 |
| `D_SIMULATION` | 仿真 | L2_domain | 29 |
| `D_FUNDAMENTAL_SIGNAL` | 基本面信号 | L2_domain | 28 |
| `D_ARCH_SCRIPTS` | 架构治理脚本 | L2_domain | 27 |
| `D_MKT_DATA` | 行情数据 | L1_foundation | 26 |
| `D_OPS` | 反馈循环 | L1_foundation | 23 |
| `D_ML_TRAIN` | 训练 | L2_domain | 22 |
| `D_DATA_ENG` | 数据工程 | L1_foundation | 20 |
| `D_META_SCRIPTS` | 元治理脚本 | L2_domain | 20 |
| `D_EX_SOR` | 执行路由 | L2_domain | 18 |
| `D_INFRA_TELEMETRY` | 可观测性 | L0_infrastructure | 17 |
| `D_GOV_REPAIR` | 治理修复 | L2_domain | 16 |
| `D_PF_ALLOC` | 组合分配 | L2_domain | 16 |
| `D_CONTRACTS` | 共享契约 | L0_infrastructure | 13 |
| `D_DATA_GOV` | 数据治理 | L1_foundation | 10 |
| `D_ALT_DATA` | 另类数据 | L1_foundation | 8 |
| `D_SIGQC` | 信号质量控制 | L2_domain | 8 |
| `D_CROSS_ASSET` | 跨资产 | L2_domain | 7 |
| `D_DATA_SEC` | 数据安全与契约 | L1_foundation | 7 |
| `D_DIGITAL_TWIN` | 数字孪生 | L2_domain | 7 |
| `D_EXEC_SIM` | 执行仿真 | L2_domain | 7 |
| `D_KNOWLEDGE` | 知识管理 | L2_domain | 7 |
| `D_ML_SERVE` | 推理 | L2_domain | 7 |
| `D_PLAN` | 预案引擎 | L2_domain | 7 |
| `D_ARCHIVE_SCRIPTS` | Archived Scripts | L2_domain | 6 |
| `D_ARCH_GUARD` | 架构守护脚本 | L2_domain | 3 |
| `D_COMPLIANCE_SCRIPTS` | 合规治理脚本 | L2_domain | 3 |
| `D_INTEGRATION_GATEWAY` | 集成网关 | L1_foundation | 3 |

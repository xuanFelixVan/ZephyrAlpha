...
> 最后更新 / Last updated: 2026-06-24 02:30:06
...
| D-DATA_ENG | 数据工程(增值+融合+知识) | L1_foundation | 10 | 1 | 136 | - | 147 |
| D-DATA_GOV | 数据治理(质量+血缘+参考) | L1_foundation | 1 | 1 | 36 | - | 38 |
...
| D-GOVERNANCE | lifecycle_management | L2_domain | 52 | 1715 | 2137 | 4 | 3908 |
| D-GOV_AUDIT | audit-trail | L2_domain | - | 253 | 15 | - | 268 |
| D-GOV_DRIFT | drift_detection | L2_domain | - | 23 | 15 | - | 38 |
| D-GOV_RULE | 规则治理 | L2_domain | 1 | 64 | 113 | - | 178 |
| D-INFRA_OPS | 基础设施运维 | L0_infrastructure | 3 | 10 | 405 | - | 418 |
| D-INFRA_RUNTIME | runtime_integration | L0_infrastructure | 22 | 407 | 297 | 1 | 727 |
| D-INTEGRATION | pipeline_routing | L1_platform | 38 | 4 | 664 | - | 706 |
| D-INTELLIGENCE | context_management | L2_domain | 9 | 2 | 262 | - | 273 |
| D-KNOWLEDGE | knowledge_management | L2_domain | 156 | 28 | 10 | - | 194 |
| D-MKT_DATA | 行情数据(接入+存储) | L1_foundation | 19 | 3 | 244 | - | 266 |
| D-ML_SERVE | 推理 | L2_domain | 6 | 1 | 62 | - | 69 |
| D-ML_TRAIN | 训练 | L2_domain | 12 | 1 | 106 | - | 119 |
| D-OPS | feedback-loop | L1_platform | 4 | 21 | 672 | - | 697 |
...
| D-SECURITY | adversarial_validation | L1_platform | 4 | 4 | 841 | - | 849 |
| D-SELL_DECISION | 卖出决策 | L2_domain | - | 1 | 63 | - | 64 |
| D-SHARED | shared_services | L1_platform | 10 | 3 | 277 | - | 290 |
...
| D-KNOWLEDGE | knowledge_management | 156 | 18.0% |
| D-SIMULATION | 仿真 | 127 | 14.7% |
| D-GOVERNANCE | lifecycle_management | 52 | 6.0% |
| D-INTEGRATION | pipeline_routing | 38 | 4.4% |
| D-INFRA_RUNTIME | runtime_integration | 22 | 2.5% |
| D-MKT_DATA | 行情数据(接入+存储) | 19 | 2.2% |
| D-RISK | 风控 | 13 | 1.5% |
| D-ML_TRAIN | 训练 | 12 | 1.4% |
| D-DATA_ENG | 数据工程(增值+融合+知识) | 10 | 1.2% |
| D-SHARED | shared_services | 10 | 1.2% |
| D-INTELLIGENCE | context_management | 9 | 1.0% |
| D-BACKTEST | 回测 | 8 | 0.9% |
...
| D-OPS | feedback-loop | 4 | 0.5% |
| D-SECURITY | adversarial_validation | 4 | 0.5% |
| D-INFRA_OPS | 基础设施运维 | 3 | 0.3% |
| D-PF_CORE | 组合核心 | 3 | 0.3% |
| D-CROSS_ASSET | 跨资产 | 2 | 0.2% |
| D-SIGNAL | 信号 | 2 | 0.2% |
| D-ALT_DATA | 另类数据 | 1 | 0.1% |
| D-DATA_GOV | 数据治理(质量+血缘+参考) | 1 | 0.1% |
...
| 域ID / Domain ID | 域名称 / Domain Name | 模块数 / Modules | 占比 / Ratio |
|------|------|:---:|:---:|
| D-GOVERNANCE | lifecycle_management | 1715 | 63.4% |
| D-INFRA_RUNTIME | runtime_integration | 407 | 15.1% |
| D-GOV_AUDIT | audit-trail | 253 | 9.4% |
| D-TRADING | 交易运营 | 92 | 3.4% |
| D-GOV_RULE | 规则治理 | 64 | 2.4% |
| D-KNOWLEDGE | knowledge_management | 28 | 1.0% |
| D-GOV_DRIFT | drift_detection | 23 | 0.9% |
| D-OPS | feedback-loop | 21 | 0.8% |
...
| D-RISK | 风控 | 9 | 0.3% |
| D-FRONTEND | 前端 | 4 | 0.1% |
| D-INTEGRATION | pipeline_routing | 4 | 0.1% |
| D-SECURITY | adversarial_validation | 4 | 0.1% |
| D-FACTOR | 因子 | 3 | 0.1% |
| D-MKT_DATA | 行情数据(接入+存储) | 3 | 0.1% |
| D-SHARED | shared_services | 3 | 0.1% |
| D-INTELLIGENCE | context_management | 2 | 0.1% |
| D-PF_CORE | 组合核心 | 2 | 0.1% |
| D-ALT_DATA | 另类数据 | 1 | 0.0% |
| D-BACKTEST | 回测 | 1 | 0.0% |
| D-CROSS_ASSET | 跨资产 | 1 | 0.0% |
| D-DATA_ENG | 数据工程(增值+融合+知识) | 1 | 0.0% |
| D-DATA_GOV | 数据治理(质量+血缘+参考) | 1 | 0.0% |
...
| 域ID / Domain ID | 域名称 / Domain Name | 模块数 / Modules | 占比 / Ratio |
|------|------|:---:|:---:|
| D-GOVERNANCE | lifecycle_management | 2137 | 19.7% |
| D-COMPLIANCE | 合规 | 900 | 8.3% |
| D-SECURITY | adversarial_validation | 841 | 7.8% |
| D-RISK | 风控 | 753 | 7.0% |
| D-OPS | feedback-loop | 672 | 6.2% |
| D-INTEGRATION | pipeline_routing | 664 | 6.1% |
| D-AUTONOMY_CORE | 自治核心 | 635 | 5.9% |
| D-SIGNAL | 信号 | 474 | 4.4% |
| D-INFRA_OPS | 基础设施运维 | 405 | 3.7% |
| D-INFRA_RUNTIME | runtime_integration | 297 | 2.7% |
| D-SHARED | shared_services | 277 | 2.6% |
| D-INTELLIGENCE | context_management | 262 | 2.4% |
| D-AUTONOMY_PERM | 自治保护 | 247 | 2.3% |
| D-MKT_DATA | 行情数据(接入+存储) | 244 | 2.3% |
| D-FRONTEND | 前端 | 228 | 2.1% |
| D-PF_CORE | 组合核心 | 197 | 1.8% |
| D-TRADING | 交易运营 | 156 | 1.4% |
| D-DATA_ENG | 数据工程(增值+融合+知识) | 136 | 1.3% |
...
| 域ID / Domain ID | 域名称 / Domain Name | 模块数 / Modules | 占比 / Ratio |
|------|------|:---:|:---:|
| D-GOVERNANCE | lifecycle_management | 4 | 80.0% |
| D-INFRA_RUNTIME | runtime_integration | 1 | 20.0% |

---
module_id: DEEP_LEARNING_SENTIMENT_001
version: 1.0.0
status: Active
...
# 验证安装
python --version  # 应显Python 3.9.x 或更高版
...
models/finbert/
├── config.json              # 模型配置KB
├── pytorch_model.bin        # 模型权重20MB
├── vocab.txt                # 词汇表（226KB
├── tokenizer_config.json    # Tokenizer配置01B
└── special_tokens_map.json  # 特殊token映射12B
```
...
##### 0.001. Aiwf Dlsa
- **模块ID**: AIWF_DLSA_001
- **蓝图文档**: [DEEP_LEARNING_SENTIMENT_ANALYZER_BLUEPRINT.md](./10_AI_WORKFLOW\DEEP_LEARNING_SENTIMENT_ANALYZER_BLUEPRINT.md)
- **技术规格书**: 待创建
- **职责**: 深度学习情感分析模块
- **状态**: Active
```

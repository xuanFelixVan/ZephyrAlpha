---
module_id: COMPLIANCE_MONITORING_BLUEPRINT_ALT
version: 1.0.0
status: Active
priority: P0
...
| 合规监控模块蓝图 | `docs/10_AI_WORKFLOW/COMPLIANCE_MONITORING_BLUEPRINT.md` | COMPLIANCE_MONITORING_001 | 1.0 | Active | 交易合规检查、风控合规检查、监管报告生成、审计追踪、违规预|
